...
public class UiDevice {
    ...
    public boolean isInWatcherContext() {
            ...
            for (String watcherName : this.mWatchers.keySet()) {
                ...
                if (watcher != null) {
                    try {
                        ...
                        String str = LOG_TAG;
                        Log.e(str, "Exceuting watcher: " + watcherName, e);
                    } catch (Throwable th) {
    ...
    public boolean waitForWindowUpdate(final String packageName, long timeout) {
        ...
        try {
            getAutomatorBridge().executeCommandAndWaitForAccessibilityEvent(new Runnable() {
                /* class com.android.uiautomator.core.UiDevice.AnonymousClass1 */

                public void run() {
                }
            }, new UiAutomation.AccessibilityEventFilter() {
                /* class com.android.uiautomator.core.UiDevice.AnonymousClass2 */
                ...
                public boolean accept(AccessibilityEvent t) {
                    ...
                    if (str == null || str.equals(t.getPackageName())) {
                        return true;
                    }
                    return false;
                }
