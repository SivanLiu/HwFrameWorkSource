...
public class UiSelector {
    ...
    public UiSelector cloneSelector() {
    ...
    public boolean isMatchFor(AccessibilityNodeInfo node, int index) {
        ...
        for (int x = SELECTOR_NIL; x < size; x++) {
            ...
            switch (criterion) {
                ...
                case SELECTOR_CONTAINS_TEXT /*{ENCODED_INT: 3}*/:
                ...
                case SELECTOR_CLASS /*{ENCODED_INT: 4}*/:
                    ...
                    break;
                case SELECTOR_DESCRIPTION /*{ENCODED_INT: 5}*/:
                    ...
                    break;
                case SELECTOR_START_DESCRIPTION /*{ENCODED_INT: 6}*/:
                    ...
                    break;
                case SELECTOR_CONTAINS_DESCRIPTION /*{ENCODED_INT: 7}*/:
                ...
                case SELECTOR_INDEX /*{ENCODED_INT: 8}*/:
                    if (index == getInt(criterion)) {
                        break;
                    } else {
                        return false;
                    }
                case SELECTOR_ENABLED /*{ENCODED_INT: 10}*/:
                    if (node.isEnabled() == getBoolean(criterion)) {
                        break;
                    } else {
                        return false;
                    }
                case SELECTOR_FOCUSED /*{ENCODED_INT: 11}*/:
                    if (node.isFocused() == getBoolean(criterion)) {
                        break;
                    } else {
                        return false;
                    }
                case SELECTOR_FOCUSABLE /*{ENCODED_INT: 12}*/:
                    if (node.isFocusable() == getBoolean(criterion)) {
                        break;
                    } else {
                        return false;
                    }
                case SELECTOR_SCROLLABLE /*{ENCODED_INT: 13}*/:
                    if (node.isScrollable() == getBoolean(criterion)) {
                        break;
                    } else {
                        return false;
                    }
                case SELECTOR_CLICKABLE /*{ENCODED_INT: 14}*/:
                    if (node.isClickable() == getBoolean(criterion)) {
                        break;
                    } else {
                        return false;
                    }
                case SELECTOR_CHECKED /*{ENCODED_INT: 15}*/:
                    if (node.isChecked() == getBoolean(criterion)) {
                        break;
                    } else {
                        return false;
                    }
                case SELECTOR_SELECTED /*{ENCODED_INT: 16}*/:
                    if (node.isSelected() == getBoolean(criterion)) {
                        break;
                    } else {
                        return false;
                    }
                case SELECTOR_PACKAGE_NAME /*{ENCODED_INT: 18}*/:
                ...
                case SELECTOR_LONG_CLICKABLE /*{ENCODED_INT: 24}*/:
                    if (node.isLongClickable() == getBoolean(criterion)) {
                        break;
                    } else {
                        return false;
                    }
                case SELECTOR_TEXT_REGEX /*{ENCODED_INT: 25}*/:
                ...
                case SELECTOR_CLASS_REGEX /*{ENCODED_INT: 26}*/:
                ...
                case SELECTOR_DESCRIPTION_REGEX /*{ENCODED_INT: 27}*/:
                    ...
                    break;
                case SELECTOR_PACKAGE_NAME_REGEX /*{ENCODED_INT: 28}*/:
                ...
                case SELECTOR_RESOURCE_ID /*{ENCODED_INT: 29}*/:
                ...
                case SELECTOR_CHECKABLE /*{ENCODED_INT: 30}*/:
                    if (node.isCheckable() == getBoolean(criterion)) {
                        break;
                    } else {
                        return false;
                    }
                case SELECTOR_RESOURCE_ID_REGEX /*{ENCODED_INT: 31}*/:
    ...
    public String dumpToString(boolean all) {
        ...
        for (int i = SELECTOR_NIL; i < criterionCount; i++) {
            ...
            switch (criterion) {
                case 1:
                    builder.append("TEXT=");
                    builder.append(this.mSelectorAttributes.valueAt(i));
                    break;
                case 2:
                    builder.append("START_TEXT=");
                    builder.append(this.mSelectorAttributes.valueAt(i));
                    break;
                case SELECTOR_CONTAINS_TEXT /*{ENCODED_INT: 3}*/:
                    builder.append("CONTAINS_TEXT=");
                    builder.append(this.mSelectorAttributes.valueAt(i));
                    break;
                case SELECTOR_CLASS /*{ENCODED_INT: 4}*/:
                ...
                case SELECTOR_DESCRIPTION /*{ENCODED_INT: 5}*/:
                    ...
                    break;
                case SELECTOR_START_DESCRIPTION /*{ENCODED_INT: 6}*/:
                    builder.append("START_DESCRIPTION=");
                    builder.append(this.mSelectorAttributes.valueAt(i));
                    break;
                case SELECTOR_CONTAINS_DESCRIPTION /*{ENCODED_INT: 7}*/:
                    builder.append("CONTAINS_DESCRIPTION=");
                    builder.append(this.mSelectorAttributes.valueAt(i));
                    break;
                case SELECTOR_INDEX /*{ENCODED_INT: 8}*/:
                    ...
                    builder.append(this.mSelectorAttributes.valueAt(i));
                    break;
                case SELECTOR_INSTANCE /*{ENCODED_INT: 9}*/:
                ...
                case SELECTOR_SELECTED /*{ENCODED_INT: 16}*/:
                    ...
                    builder.append(this.mSelectorAttributes.valueAt(i));
                    break;
                case SELECTOR_ID /*{ENCODED_INT: 17}*/:
                    builder.append("ID=");
                    builder.append(this.mSelectorAttributes.valueAt(i));
                    break;
                case SELECTOR_PACKAGE_NAME /*{ENCODED_INT: 18}*/:
                    ...
                    builder.append(this.mSelectorAttributes.valueAt(i));
                    break;
                case SELECTOR_CHILD /*{ENCODED_INT: 19}*/:
                    if (!all) {
                ...
                case SELECTOR_CONTAINER /*{ENCODED_INT: 20}*/:
                    if (!all) {
                ...
                case SELECTOR_PATTERN /*{ENCODED_INT: 21}*/:
                    if (!all) {
                ...
                case SELECTOR_PARENT /*{ENCODED_INT: 22}*/:
                    if (!all) {
                ...
                case SELECTOR_COUNT /*{ENCODED_INT: 23}*/:
                    builder.append("COUNT=");
                    builder.append(this.mSelectorAttributes.valueAt(i));
                    break;
                case SELECTOR_LONG_CLICKABLE /*{ENCODED_INT: 24}*/:
                    builder.append("LONG_CLICKABLE=");
                    builder.append(this.mSelectorAttributes.valueAt(i));
                    break;
                case SELECTOR_TEXT_REGEX /*{ENCODED_INT: 25}*/:
                    builder.append("TEXT_REGEX=");
                    builder.append(this.mSelectorAttributes.valueAt(i));
                    break;
                case SELECTOR_CLASS_REGEX /*{ENCODED_INT: 26}*/:
                    builder.append("CLASS_REGEX=");
                    builder.append(this.mSelectorAttributes.valueAt(i));
                    break;
                case SELECTOR_DESCRIPTION_REGEX /*{ENCODED_INT: 27}*/:
                    builder.append("DESCRIPTION_REGEX=");
                    builder.append(this.mSelectorAttributes.valueAt(i));
                    break;
                case SELECTOR_PACKAGE_NAME_REGEX /*{ENCODED_INT: 28}*/:
                    builder.append("PACKAGE_NAME_REGEX=");
                    builder.append(this.mSelectorAttributes.valueAt(i));
                    break;
                case SELECTOR_RESOURCE_ID /*{ENCODED_INT: 29}*/:
                ...
                case SELECTOR_CHECKABLE /*{ENCODED_INT: 30}*/:
                    ...
                    break;
                case SELECTOR_RESOURCE_ID_REGEX /*{ENCODED_INT: 31}*/:
                    builder.append("RESOURCE_ID_REGEX=");
                    builder.append(this.mSelectorAttributes.valueAt(i));
                    break;
                default:
                    builder.append("UNDEFINED=" + criterion + " ");
                    builder.append(this.mSelectorAttributes.valueAt(i));
                    break;
            }
        }
