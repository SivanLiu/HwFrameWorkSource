...
public class UiAutomatorTestRunner {
    ...
    public static final String LOGTAG = UiAutomatorTestRunner.class.getSimpleName();
    /* access modifiers changed from: private */
    public final IAutomationSupport mAutomationSupport = new IAutomationSupport() {
    ...
    /* access modifiers changed from: private */
    public final FakeInstrumentationWatcher mWatcher = new FakeInstrumentationWatcher();
    ...
    private class WatcherResultPrinter implements ResultReporter {
        ...
        public void addError(Test test, Throwable t) {
            ...
            objArr[UiAutomatorTestRunner.EXIT_OK] = ((TestCase) test).getName();
            objArr[1] = BaseTestRunner.getFilteredTrace(t);
        ...
        public void print(TestResult result, long runTime, Bundle testOutput) {
            ...
            Object[] objArr = new Object[2];
            objArr[UiAutomatorTestRunner.EXIT_OK] = getClass().getSimpleName();
            objArr[1] = this.mStream.toString();
            testOutput.putString("stream", String.format("\nTest results for %s=%s", objArr));
            this.mWriter.close();
    ...
    private class SimpleResultPrinter extends ResultPrinter implements ResultReporter {
        ...
        public void printUnexpectedError(Throwable t) {
            if (this.mFullOutput) {
                ...
                Object[] objArr = new Object[1];
                objArr[UiAutomatorTestRunner.EXIT_OK] = t.getMessage();
                writer.printf("Test run aborted due to unexpected exeption: %s", objArr);
