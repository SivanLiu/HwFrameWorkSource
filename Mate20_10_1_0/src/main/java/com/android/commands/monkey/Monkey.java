    ...
    private class ActivityController extends IActivityController.Stub {
        ...
        public boolean appCrashed(String processName, int pid, String shortMsg, String longMsg, long timeMillis, String stackTrace) {
            ...
            synchronized (Monkey.this) {
                ...
                if (Monkey.this.mRequestBugreport) {
                    ...
                    String unused3 = Monkey.this.mReportProcessName = processName;
                }
            }
        ...
        public int appNotResponding(String processName, int pid, String processStats) {
            ...
            if (Monkey.this.mMatchDescription == null || processStats.contains(Monkey.this.mMatchDescription)) {
                synchronized (Monkey.this) {
                    boolean unused = Monkey.this.mRequestAnrTraces = true;
                    boolean unused2 = Monkey.this.mRequestDumpsysMemInfo = true;
                    boolean unused3 = Monkey.this.mRequestProcRank = true;
                    if (Monkey.this.mRequestBugreport) {
                        boolean unused4 = Monkey.this.mRequestAnrBugreport = true;
                        String unused5 = Monkey.this.mReportProcessName = processName;
                    }
                }
                if (!Monkey.this.mIgnoreTimeouts) {
                    synchronized (Monkey.this) {
                        boolean unused6 = Monkey.this.mAbort = true;
                    }
                }
            }
        ...
        public int systemNotResponding(String message) {
            ...
            synchronized (Monkey.this) {
                if (Monkey.this.mMatchDescription == null || message.contains(Monkey.this.mMatchDescription)) {
                    ...
                    if (Monkey.this.mRequestBugreport) {
                        boolean unused2 = Monkey.this.mRequestWatchdogBugreport = true;
                    }
                }
                boolean unused3 = Monkey.this.mWatchdogWaiting = true;
            }
            synchronized (Monkey.this) {
