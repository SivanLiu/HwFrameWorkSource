...
public class MonkeySourceNetworkViews {
    ...
    public static final Map<String, ViewIntrospectionCommand> COMMAND_MAP = new HashMap();
    ...
    /* access modifiers changed from: private */
    public static IPackageManager sPm = IPackageManager.Stub.asInterface(ServiceManager.getService("package"));
