...
public class ConnectivityService extends AbstractConnectivityService implements IHwConnectivityServiceInner, PendingIntent.OnFinished {
    ...
    static class LegacyTypeTracker {
        ...
        private void maybeLogBroadcast(NetworkAgentInfo nai, NetworkInfo.DetailedState state, int type, boolean isDefaultNetwork) {
            ConnectivityService.log("Sending " + state + " broadcast for type " + type + HwLog.PREFIX + nai.name() + " isDefaultNetwork=" + isDefaultNetwork);
        }
        ...
        private String naiToString(NetworkAgentInfo nai) {
            ...
            return name + HwLog.PREFIX + state;
        }
                ...
                for (int type2 = 0; type2 < this.mTypeLists.length; type2++) {
                    if (this.mTypeLists[type2] != null) {
                        if (!this.mTypeLists[type2].isEmpty()) {
                            ...
                            while (it.hasNext()) {
                                pw.println(type2 + HwLog.PREFIX + naiToString(it.next()));
                            }
                        }
                    }
                }
    ...
    private void handleAlwaysOnNetworkRequest(NetworkRequest networkRequest, String settingName, boolean defaultValue) {
        ...
        if ("mobile_data_always_on".equals(settingName)) {
            enable = enable || this.mCust.mMobileDataAlwaysOnCust || toBool(Settings.Global.getInt(this.mContext.getContentResolver(), MOBILE_DATA_ALWAYS_ON_FOR_MPLINK, 0));
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x002a, code lost:
        r1 = r8.getInterfaceName();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x002e, code lost:
        r2 = false;
        r4 = true;
        r5 = r7.mHwCSEx.getCacheNetworkState(r9, r1);
        r6 = -1;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0036, code lost:
        ...
        r2.log(r0 + com.android.server.devicepolicy.HwLog.PREFIX + r7);
     */
    ...
    private void maybeLogBlockedStatusChanged(NetworkRequestInfo nri, Network net, boolean blocked) {
        if (nri != null && net != null) {
            ...
            localLog.log(action + HwLog.PREFIX + nri.mUid);
        }
    }
    ...
    private boolean addLegacyRouteToHost(LinkProperties lp, InetAddress addr, int netId, int uid) {
        ...
        RouteInfo routeInfo = this.mBestLegacyRoute;
        if (!(routeInfo == null || routeInfo.getDestination() == null || bestRoute == null || bestRoute.getDestination() == null || this.mBestLegacyRoute.getDestination().getAddress() == null || !this.mBestLegacyRoute.getDestination().getAddress().equals(bestRoute.getDestination().getAddress()))) {
    ...
    private void updateTcpBufferSizes(String tcpBufferSizes) {
        ...
        if (!tcpBufferSizes.equals(this.mCurrentTcpBufferSizes)) {
            try {
                ...
                this.mNetd.setTcpRWmemorySize(String.join(HwLog.PREFIX, values[0], values[1], values[2]), String.join(HwLog.PREFIX, values[3], values[4], values[5]));
    ...
    public void doDump(FileDescriptor fd, PrintWriter writer, String[] args, boolean asProto) {
        ...
        if (ArrayUtils.contains(args, DIAG_ARG)) {
            ...
            while (it.hasNext()) {
                pw.print(HwLog.PREFIX + it.next().name);
            }
            pw.println();
            pw.println();
                ...
                if (i == 9) {
                    ...
                    switch (i) {
                        ...
                        case 22:
                            ...
                            return;
                        case ConnectivityService.EVENT_UNREGISTER_NETWORK_FACTORY /*{ENCODED_INT: 23}*/:
                            ConnectivityService.this.handleUnregisterNetworkFactory((Messenger) msg.obj);
                            return;
                        case ConnectivityService.EVENT_EXPIRE_NET_TRANSITION_WAKELOCK /*{ENCODED_INT: 24}*/:
                            break;
                        case ConnectivityService.EVENT_SYSTEM_READY /*{ENCODED_INT: 25}*/:
                        ...
                        case 31:
                            ...
                            return;
                        case ConnectivityService.EVENT_RELEASE_NETWORK_REQUEST_WITH_INTENT /*{ENCODED_INT: 27}*/:
                            ConnectivityService.this.handleReleaseNetworkRequestWithIntent((PendingIntent) msg.obj, msg.arg1);
                            return;
                        case ConnectivityService.EVENT_SET_ACCEPT_UNVALIDATED /*{ENCODED_INT: 28}*/:
    ...
    public String getMobileProvisioningUrl() {
        ...
        if (TextUtils.isEmpty(url)) {
            url = this.mContext.getResources().getString(17040620);
    ...
    private void updateSignalStrengthThresholds(NetworkAgentInfo nai, String reason, NetworkRequest request) {
        ...
        if (request == null || !request.networkCapabilities.hasSignalStrength()) {
            ...
            detail = reason + HwLog.PREFIX + request.networkCapabilities.getSignalStrength();
        }
    ...
    private boolean updateRoutes(LinkProperties newLp, LinkProperties oldLp, int netId) {
        ...
        if (HW_DEBUGGABLE) {
            log("Adding Route to network " + netId);
        }
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:177:0x00c9 */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:179:0x00c9 */
    /* JADX DEBUG: Multi-variable search result rejected for r4v13, resolved type: com.android.server.ConnectivityService$LegacyTypeTracker */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: Multiple debug info for r15v16 'currentNetwork'  com.android.server.connectivity.NetworkAgentInfo: [D('satisfies' boolean), D('currentNetwork' com.android.server.connectivity.NetworkAgentInfo)] */
    ...
    public void rematchNetworkAndRequests(NetworkAgentInfo newNetwork, ReapUnvalidatedNetworks reapUnvalidatedNetworks, long now) {
        ...
        if (newNetwork.everConnected) {
            boolean keep3 = newNetwork.isVPN();
            ...
            if (newNetwork.getCurrentScore() != score2) {
                ...
                objArr[r6] = Integer.valueOf(score2);
            ...
            while (it3.hasNext()) {
                ...
                if (IS_SUPPORT_LINGER_DELAY || newNetwork.networkInfo.getType() != r6 || nai.networkInfo.getType() != 0 || !ENABLE_WIFI_LTE_CE) {
            ...
            if (isNewDefault) {
                if (oldDefaultNetwork2 != null) {
                    this.mLegacyTypeTracker.remove(oldDefaultNetwork2.networkInfo.getType(), oldDefaultNetwork2, r6);
                }
    ...
    public String getCaptivePortalServerUrl() {
        enforceConnectivityInternalPermission();
        String settingUrl = this.mContext.getResources().getString(17039877);
