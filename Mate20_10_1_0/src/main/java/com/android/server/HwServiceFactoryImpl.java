...
public class HwServiceFactoryImpl implements HwServiceFactory.Factory {
    ...
    /* JADX WARN: Type inference failed for: r6v1, types: [com.android.server.HwConnectivityExService, android.os.IBinder] */
    /* JADX WARN: Type inference failed for: r1v3, types: [com.android.server.display.DisplayEngineService, android.os.IBinder] */
    /* JADX WARN: Type inference failed for: r1v7, types: [com.android.server.aps.HwApsManagerService, android.os.IBinder] */
    /* JADX WARN: Type inference failed for: r0v6, types: [com.android.server.HwGeneralService, android.os.IBinder] */
    /* JADX WARN: Type inference failed for: r8v1, types: [com.android.server.HwSmartDisplayService, android.os.IBinder] */
    /* JADX WARN: Type inference failed for: r7v3, types: [com.android.server.HwGeneralService, android.os.IBinder] */
    ...
    public static class HwAttestationServiceImpl implements HwServiceFactory.IHwAttestationServiceFactory {
        /* JADX WARN: Type inference failed for: r0v0, types: [com.android.server.HwAttestationService, android.os.IBinder] */
    ...
    public static class MultiTaskManagerServiceImpl implements HwServiceFactory.IMultiTaskManagerServiceFactory {
        /* JADX WARN: Type inference failed for: r0v0, types: [com.android.server.mtm.MultiTaskManagerService, android.os.IBinder] */
        public IBinder getInstance(Context context) {
    ...
    public TaskStack createTaskStack(WindowManagerService service, int stackId, ActivityStack activityStack) {
        return new HwTaskStack(service, stackId, activityStack);
    }
    ...
    /* JADX WARN: Type inference failed for: r1v3, types: [com.huawei.server.pc.DefaultHwPCManagerService, android.os.IBinder] */
    ...
    /* JADX WARN: Type inference failed for: r0v1, types: [com.android.server.magicwin.HwMagicWindowService, android.os.IBinder] */
    public void addHwMagicWindowService(Context context, ActivityManagerService ams, WindowManagerService wms) {
        ...
        ServiceManager.addService("HwMagicWindowService", (IBinder) new HwMagicWindowService(context, ams, wms));
    }
