...
final class ConnectionRecord {
    private static final int[] BIND_ORIG_ENUMS = {1, 2, 4, DumpState.DUMP_VOLUMES, 8, 16, 32, 64, 128, DumpState.DUMP_APEX, DumpState.DUMP_HANDLE, 134217728, 268435456, 536870912, 1073741824, 256, 4096};
