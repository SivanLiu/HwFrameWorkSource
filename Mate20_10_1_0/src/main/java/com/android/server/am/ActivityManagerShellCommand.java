...
final class ActivityManagerShellCommand extends ShellCommand {
    ...
    public int onCommand(String cmd) {
        ...
        try {
            ...
            switch (c) {
                ...
                case 28:
                    return runHang(pw);
                case HdmiCecKeycode.CEC_KEYCODE_NUMBER_ENTRY_MODE /*{ENCODED_INT: 29}*/:
                    return runRestart(pw);
                case HdmiCecKeycode.CEC_KEYCODE_NUMBER_11 /*{ENCODED_INT: 30}*/:
                    return runIdleMaintenance(pw);
                case HdmiCecKeycode.CEC_KEYCODE_NUMBER_12 /*{ENCODED_INT: 31}*/:
                    return runScreenCompat(pw);
                case ' ':
                    return runPackageImportance(pw);
                case HdmiCecKeycode.CEC_KEYCODE_NUMBERS_1 /*{ENCODED_INT: 33}*/:
                ...
                case HdmiCecKeycode.CEC_KEYCODE_NUMBERS_5 /*{ENCODED_INT: 37}*/:
                    return runGetCurrentUser(pw);
                case HdmiCecKeycode.CEC_KEYCODE_NUMBERS_6 /*{ENCODED_INT: 38}*/:
                    return runStartUser(pw);
                case HdmiCecKeycode.CEC_KEYCODE_NUMBERS_7 /*{ENCODED_INT: 39}*/:
                ...
                case NetworkPolicyManagerService.TYPE_RAPID /*{ENCODED_INT: 45}*/:
                    return getUidState(pw);
                case '.':
                    return runGetConfig(pw);
                case HdmiCecKeycode.CEC_KEYCODE_NEXT_FAVORITE /*{ENCODED_INT: 47}*/:
                    return runSuppressResizeConfigChanges(pw);
                case '0':
                    return runSetInactive(pw);
                case HdmiCecKeycode.CEC_KEYCODE_CHANNEL_DOWN /*{ENCODED_INT: 49}*/:
                    return runGetInactive(pw);
                case HdmiCecKeycode.CEC_KEYCODE_PREVIOUS_CHANNEL /*{ENCODED_INT: 50}*/:
                    return runSetStandbyBucket(pw);
                case HdmiCecKeycode.CEC_KEYCODE_SOUND_SELECT /*{ENCODED_INT: 51}*/:
                    return runGetStandbyBucket(pw);
                case HdmiCecKeycode.CEC_KEYCODE_INPUT_SELECT /*{ENCODED_INT: 52}*/:
                    return runSendTrimMemory(pw);
                case '5':
                    return runDisplay(pw);
                case HdmiCecKeycode.CEC_KEYCODE_HELP /*{ENCODED_INT: 54}*/:
                    return runStack(pw);
                case HdmiCecKeycode.CEC_KEYCODE_PAGE_UP /*{ENCODED_INT: 55}*/:
                    return runTask(pw);
                case '8':
                    return runWrite(pw);
                case '9':
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v10, resolved type: android.app.ActivityOptions */
    /* JADX DEBUG: Multi-variable search result rejected for r3v19, resolved type: android.app.ActivityOptions */
    /* JADX DEBUG: Multi-variable search result rejected for r3v20, resolved type: android.app.ActivityOptions */
    /* JADX DEBUG: Multi-variable search result rejected for r3v21, resolved type: android.app.ActivityOptions */
    /* JADX DEBUG: Multi-variable search result rejected for r3v53, resolved type: android.app.ActivityOptions */
    /* JADX DEBUG: Multi-variable search result rejected for r3v54, resolved type: android.app.ActivityOptions */
    /* JADX DEBUG: Multi-variable search result rejected for r3v55, resolved type: android.app.ActivityOptions */
    /* JADX DEBUG: Multi-variable search result rejected for r3v56, resolved type: android.app.ActivityOptions */
    /* JADX DEBUG: Multi-variable search result rejected for r3v57, resolved type: android.app.ActivityOptions */
        ...
        try {
            ...
            while (true) {
                ...
                if (this.mWaitOption) {
                    ...
                    if (options != null) {
                        bundle2 = options.toBundle();
                    }
                    i = 0;
                    mimeType2 = mimeType;
                    i2 = i4;
                    WaitResult result3 = activityManagerService.startActivityAndWait(null, null, intent, mimeType, null, null, 0, i5, profilerInfo, bundle2, this.mUserId);
                    res = result3.result;
                    result2 = result3;
                } else {
                    i = 0;
                    ...
                    res = activityManagerService2.startActivityAsUser(null, null, intent, mimeType2, null, null, 0, i6, profilerInfo, bundle, this.mUserId);
                }
    ...
    private static void addExtensionsForConfig(EGL10 egl, EGLDisplay display, EGLConfig config, int[] surfaceSize, int[] contextAttribs, Set<String> glExtensions) {
        ...
        if (context != EGL10.EGL_NO_CONTEXT) {
            ...
            if (!TextUtils.isEmpty(extensionList)) {
                for (String extension : extensionList.split(HwLog.PREFIX)) {
    ...
    public int runNoHomeScreen(PrintWriter pw) throws RemoteException {
        ...
        pw.println(res.getBoolean(17891487));
        return 0;
    }
