...
public abstract class PersistentConnection<T> {
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            synchronized (PersistentConnection.this.mLock) {
                if (!PersistentConnection.this.mBound) {
                    ...
                    Log.w(access$200, "Connected: " + PersistentConnection.this.mComponentName.flattenToShortString() + " u" + PersistentConnection.this.mUserId + " but not bound, ignore.");
                    return;
                }
                String access$2002 = PersistentConnection.this.mTag;
                Log.i(access$2002, "Connected: " + PersistentConnection.this.mComponentName.flattenToShortString() + " u" + PersistentConnection.this.mUserId);
                PersistentConnection.access$508(PersistentConnection.this);
                boolean unused = PersistentConnection.this.mIsConnected = true;
                long unused2 = PersistentConnection.this.mLastConnectedTime = PersistentConnection.this.injectUptimeMillis();
                Object unused3 = PersistentConnection.this.mService = PersistentConnection.this.asInterface(service);
        ...
        public void onServiceDisconnected(ComponentName name) {
            synchronized (PersistentConnection.this.mLock) {
                String access$200 = PersistentConnection.this.mTag;
                Log.i(access$200, "Disconnected: " + PersistentConnection.this.mComponentName.flattenToShortString() + " u" + PersistentConnection.this.mUserId);
        ...
        public void onBindingDied(ComponentName name) {
            synchronized (PersistentConnection.this.mLock) {
                if (!PersistentConnection.this.mBound) {
                    String access$200 = PersistentConnection.this.mTag;
                    Log.w(access$200, "Binding died: " + PersistentConnection.this.mComponentName.flattenToShortString() + " u" + PersistentConnection.this.mUserId + " but not bound, ignore.");
                    return;
                }
                String access$2002 = PersistentConnection.this.mTag;
                Log.w(access$2002, "Binding died: " + PersistentConnection.this.mComponentName.flattenToShortString() + " u" + PersistentConnection.this.mUserId);
