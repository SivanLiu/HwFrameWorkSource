...
public class BroadcastDispatcher {
    ...
    public final ArrayList<Deferrals> mAlarmBroadcasts = new ArrayList<>();
    ...
    /* access modifiers changed from: private */
    public final BroadcastQueue mQueue;
    /* access modifiers changed from: private */
    ...
    final Runnable mScheduleRunnable = new Runnable() {
        ...
        public void run() {
            synchronized (BroadcastDispatcher.this.mLock) {
                ...
                boolean unused = BroadcastDispatcher.this.mRecheckScheduled = false;
            }
        }
    };
    ...
    class Dumper {
        ...
        public void setLabel(String label) {
            this.mLabel = "  " + label + HwLog.PREFIX + this.mQueueName + " #";
            this.mOrdinal = 0;
        }
