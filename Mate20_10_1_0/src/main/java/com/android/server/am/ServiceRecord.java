                        ...
                        try {
                            if (localForegroundNoti2.getSmallIcon() == null) {
                                ...
                                try {
                                    ...
                                    notiBuilder.setContentTitle(ServiceRecord.this.ams.mContext.getString(17039616, appName));
                                    notiBuilder.setContentText(ServiceRecord.this.ams.mContext.getString(17039615, appName));
                            ...
                            try {
                                ...
                                ServiceRecord.this.ams.setServiceForeground(ServiceRecord.this.instanceName, ServiceRecord.this, 0, null, 0, 0);
                                ActivityManagerService activityManagerService = ServiceRecord.this.ams;
                                int i = appUid;
                                int i2 = appPid;
                                String str = localPackageName;
                                activityManagerService.crashApplication(i, i2, str, -1, "Bad notification for startForeground: " + e);
                            }
                        } catch (RuntimeException e4) {
                            e = e4;
                            Slog.w("ActivityManager", "Error showing notification for service", e);
                            ServiceRecord.this.ams.setServiceForeground(ServiceRecord.this.instanceName, ServiceRecord.this, 0, null, 0, 0);
                            ActivityManagerService activityManagerService2 = ServiceRecord.this.ams;
                            int i3 = appUid;
                            int i22 = appPid;
                            String str2 = localPackageName;
                            activityManagerService2.crashApplication(i3, i22, str2, -1, "Bad notification for startForeground: " + e);
                        }
                    }
                }
            });
