...
final class AppErrorDialog extends BaseErrorDialog implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TextView restart = (TextView) findViewById(16908734);
        restart.setOnClickListener(this);
        int i = 8;
        restart.setVisibility(this.mIsRestartable ? 0 : 8);
        TextView report = (TextView) findViewById(16908733);
        report.setOnClickListener(this);
        report.setVisibility(hasReceiver ? 0 : 8);
        ((TextView) findViewById(16908731)).setOnClickListener(this);
        ((TextView) findViewById(16908730)).setOnClickListener(this);
        ...
        TextView mute = (TextView) findViewById(16908732);
        mute.setOnClickListener(this);
        if (showMute) {
            i = 0;
        }
        mute.setVisibility(i);
        findViewById(16908879).setVisibility(0);
    }
