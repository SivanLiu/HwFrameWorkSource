...
class AppErrors {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:116:?, code lost:
        r21.mContext.startActivityAsUser(r1, new android.os.UserHandle(r22.userId));
     */
    ...
    private boolean handleAppCrashInActivityController(ProcessRecord r, ApplicationErrorReport.CrashInfo crashInfo, String shortMsg, String longMsg, String stackTrace, long timeMillis, int callingPid, int callingUid) {
        ...
        return this.mService.mAtmInternal.handleAppCrashInActivityController(name, pid, shortMsg, longMsg, timeMillis, crashInfo.stackTrace, new Runnable(crashInfo, name, pid, r, shortMsg, longMsg, stackTrace, r != null ? r.info.uid : callingUid) {
            /* class com.android.server.am.$$Lambda$AppErrors$s1CeKlTYP9O4xRqISFOqsuWxcno */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:129:0x023c, code lost:
        android.util.Slog.i("ActivityManager", "Showing crash dialog for package " + r10 + " u" + r12);
        r7.show();
     */
                ...
                if (proc == null) {
                    ...
                    if (isDebuggable || !proc.forceCrashReport) {
                        ...
                        if (!isBackground2 || showBackground) {
                            ...
                            if (this.mAppResource != null) {
                                if ((proc.info.flags & 1) != 0 && (proc.info.hwFlags & DumpState.DUMP_APEX) == 0 && (proc.info.hwFlags & DumpState.DUMP_HANDLE) == 0) {
                                    processType = 2;
                                } else {
                                    processType = 0;
                                }
                                try {
                                    this.mAppResource.acquire(proc.uid, proc.info.packageName, processType);
                                } catch (Throwable th2) {
                                    th = th2;
                                    ActivityManagerService.resetPriorityAfterLockedSection();
                                    throw th;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:31:0x0090, code lost:
        r9.mPackageWatchdog.onPackageFailure(r1);
     */
