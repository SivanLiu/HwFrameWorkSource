...
final class CarUserSwitchingDialog extends UserSwitchingDialog {
    ...
    public void inflateContent() {
        ...
        if (bitmap != null) {
            ((ImageView) view.findViewById(16909572)).setImageDrawable(CircleFramedDrawable.getInstance(bitmap, res.getDimension(17104985)));
        }
        ((TextView) view.findViewById(16909571)).setText(res.getString(17039750));
        setView(view);
    }
