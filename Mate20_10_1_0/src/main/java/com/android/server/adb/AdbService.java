...
public class AdbService extends AbsAdbService {
    ...
    public AdbManagerInternalImpl mAdbManager;
    ...
    public static class Lifecycle extends SystemService {
        ...
        /* JADX WARN: Type inference failed for: r0v3, types: [com.android.server.adb.AdbService, android.os.IBinder] */
    ...
    protected final class AdbHandler extends Handler {
