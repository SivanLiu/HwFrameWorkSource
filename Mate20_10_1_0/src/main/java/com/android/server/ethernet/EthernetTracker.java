    ...
    public class InterfaceObserver extends BaseNetworkObserver {
        ...
        public void interfaceLinkStateChanged(String iface, boolean up) {
            ...
            EthernetTracker.this.mHandler.post(new Runnable(iface, up) {
                ...
                public final void run() {
                    InterfaceObserver.this.lambda$interfaceLinkStateChanged$0$EthernetTracker$InterfaceObserver(this.f$1, this.f$2);
                }
            });
        }
        ...
        public void interfaceAdded(String iface) {
            EthernetTracker.this.mHandler.post(new Runnable(iface) {
                ...
                public final void run() {
                    InterfaceObserver.this.lambda$interfaceAdded$1$EthernetTracker$InterfaceObserver(this.f$1);
                }
            });
        }
        ...
        public void interfaceRemoved(String iface) {
            EthernetTracker.this.mHandler.post(new Runnable(iface) {
                ...
                public final void run() {
                    InterfaceObserver.this.lambda$interfaceRemoved$2$EthernetTracker$InterfaceObserver(this.f$1);
                }
            });
        }
