...
public class EthernetNetworkFactory extends NetworkFactory {
    ...
    /* access modifiers changed from: private */
    public static boolean isTv = "tv".equals(SystemProperties.get("ro.build.characteristics", "default"));
    /* access modifiers changed from: private */
    public static boolean isWifiPriority = "wifi".equals(SystemProperties.get("persist.network.firstpriority", "ethernet"));
    ...
    public static class NetworkInterfaceState {
        ...
        /* access modifiers changed from: private */
        public volatile IIpClient mIpClient;
        private IpClientCallbacksImpl mIpClientCallback;
        /* access modifiers changed from: private */
        public IpConfiguration mIpConfig;
        ...
        public class IpClientCallbacksImpl extends IpClientCallbacks {
            ...
            public void onIpClientCreated(IIpClient ipClient) {
                IIpClient unused = NetworkInterfaceState.this.mIpClient = ipClient;
                this.mIpClientStartCv.open();
            }

            /* access modifiers changed from: private */
            public void awaitIpClientStart() {
                this.mIpClientStartCv.block();
            }

            /* access modifiers changed from: private */
            public void awaitIpClientShutdown() {
            ...
            public void onProvisioningSuccess(LinkProperties newLp) {
                NetworkInterfaceState.this.mHandler.post(new Runnable(newLp) {
                    ...
                    public final void run() {
                        IpClientCallbacksImpl.this.lambda$onProvisioningSuccess$0$EthernetNetworkFactory$NetworkInterfaceState$IpClientCallbacksImpl(this.f$1);
                    }
                });
            }
            ...
            public void onProvisioningFailure(LinkProperties newLp) {
                NetworkInterfaceState.this.mHandler.post(new Runnable(newLp) {
                    ...
                    public final void run() {
                        IpClientCallbacksImpl.this.lambda$onProvisioningFailure$1$EthernetNetworkFactory$NetworkInterfaceState$IpClientCallbacksImpl(this.f$1);
                    }
                });
            }
            ...
            public void onLinkPropertiesChange(LinkProperties newLp) {
                NetworkInterfaceState.this.mHandler.post(new Runnable(newLp) {
                    ...
                    public final void run() {
                        IpClientCallbacksImpl.this.lambda$onLinkPropertiesChange$2$EthernetNetworkFactory$NetworkInterfaceState$IpClientCallbacksImpl(this.f$1);
                    }
                });
            }

            public void onQuit() {
                IIpClient unused = NetworkInterfaceState.this.mIpClient = null;
        ...
        private int getNetworkScore() {
            ...
            if (transportTypes.length < EthernetNetworkFactory.IP_CONFLICT) {
                String access$500 = EthernetNetworkFactory.TAG;
                Log.w(access$500, "Network interface '" + this.mLinkProperties.getInterfaceName() + "' has no transport type associated with it. Score set to zero");
                return 0;
            }
        ...
        public void start() {
            ...
            objArr[0] = this.name;
            objArr[EthernetNetworkFactory.IP_CONFLICT] = this.mNetworkInfo;
            Log.i(access$500, String.format("starting IpClient(%s): mNetworkInfo=%s", objArr));
        ...
        private void updateAgent() {
            if (this.mNetworkAgent != null) {
                String access$500 = EthernetNetworkFactory.TAG;
                Log.i(access$500, "Updating mNetworkAgent with: " + this.mCapabilities + ", " + this.mNetworkInfo + ", " + this.mLinkProperties);
