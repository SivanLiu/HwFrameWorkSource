...
public class LegacyGlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener {
    ...
    public LegacyGlobalActions(Context context, WindowManagerPolicy.WindowManagerFuncs windowManagerFuncs, Runnable onDismiss) {
        ...
        this.mHasVibrator = z;
        this.mShowSilentToggle = !this.mContext.getResources().getBoolean(17891559);
    ...
    private ActionsDialog createDialog() {
        ...
        this.mAirplaneModeOn = new ToggleAction(17302459, 17302461, 17040217, 17040216, 17040215) {
    ...
    private class BugReportAction extends SinglePressAction implements LongPressAction {
        ...
        public String getStatus() {
            return LegacyGlobalActions.this.mContext.getString(17039731, Build.VERSION.RELEASE, Build.ID);
        }
    }

    private Action getSettingsAction() {
        return new SinglePressAction(17302807, 17040209) {
    ...
    private Action getEmergencyAction() {
        return new SinglePressAction(17302203, 17040202) {
    ...
    private Action getAssistAction() {
        return new SinglePressAction(17302284, 17040200) {
    ...
    private Action getVoiceAssistAction() {
        return new SinglePressAction(17302847, 17040213) {
    ...
    private Action getLockdownAction() {
        return new SinglePressAction(17301551, 17040204) {
        ...
        if (um.isUserSwitcherEnabled()) {
            ...
            for (final UserInfo user : users) {
                if (user.supportsSwitchToByUser()) {
                    ...
                    items.add(new SinglePressAction(17302682, icon, sb.toString()) {
    ...
    private class SilentModeToggleAction extends ToggleAction {
        public SilentModeToggleAction() {
            super(17302311, 17302309, 17040212, 17040211, 17040210);
        }
    ...
    private static class SilentModeTriStateAction implements Action, View.OnClickListener {
        private final int[] ITEM_IDS = {16909226, 16909227, 16909228};
