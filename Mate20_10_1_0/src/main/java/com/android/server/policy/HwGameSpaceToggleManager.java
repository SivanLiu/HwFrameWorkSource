...
public class HwGameSpaceToggleManager {
    ...
    public static boolean mIsDiviceProvisioned = false;
    /* access modifiers changed from: private */
    public static boolean mIsGameSpaceKeyDown = false;
    /* access modifiers changed from: private */
    public static boolean mIsKidsModeRunning = false;
    /* access modifiers changed from: private */
    public static boolean mIsScreenOff = true;
    /* access modifiers changed from: private */
    public GameSpaceObserverCallback mCallback;
    ...
    /* access modifiers changed from: private */
    public synchronized void handleGameSpaceOn() {
    ...
    /* access modifiers changed from: private */
    public synchronized void handleGameSpaceOff() {
        Intent intent = new Intent(GAMESPACE_ACTION);
        intent.setPackage(GAMESPACE_PACKAGE);
        intent.putExtra(KEY_START_FROM, VALUE_START_FROM_SPACE);
    ...
    /* access modifiers changed from: private */
    public boolean isKidsModeRunning() {
        return Settings.Global.getInt(this.mContext.getContentResolver(), "hwkidsmode_running", 0) == 1;
    }
    ...
    private void registerKidsModeStateObserver() {
        this.mContext.getContentResolver().registerContentObserver(Settings.Global.getUriFor("hwkidsmode_running"), true, this.mKidsModeObserver);
    }

    /* access modifiers changed from: private */
    public void unregisterKidsModeStateObserver() {
    ...
    /* access modifiers changed from: private */
    public boolean isGameSpaceRunning() {
