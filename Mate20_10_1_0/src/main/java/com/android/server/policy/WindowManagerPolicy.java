...
public interface WindowManagerPolicy extends WindowManagerPolicyConstants {
    ...
    public interface WindowState {
        ...
        void destroyInsetSurfaceImmediately(boolean z);
        ...
        void showInsetSurfaceImmediately();
    ...
    public interface WindowManagerFuncs {
        ...
        static default String lidStateToString(int lid) {
            if (lid == -1) {
                return "LID_ABSENT";
            }
            if (lid == 0) {
        ...
        static default String cameraLensStateToString(int lens) {
            if (lens == -1) {
    ...
    static default String userRotationModeToString(int mode) {
        if (mode == 0) {
