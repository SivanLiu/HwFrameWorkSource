...
public class SearchPanelView extends FrameLayout {
    ...
    public SearchPanelView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mNavigationBarHeight = context.getResources().getDimensionPixelSize(17105305);
    ...
    public boolean handleGesture(MotionEvent event) {
        ...
        if (action != 0) {
            ...
            if (!this.mDraggedFarEnough || mIsChina) {
                abortAnimation();
    ...
    public void showSearchPanelView() {
        Handler handler;
        if (hasHwAssist() && !mIsChina && (handler = this.mHandler) != null) {
