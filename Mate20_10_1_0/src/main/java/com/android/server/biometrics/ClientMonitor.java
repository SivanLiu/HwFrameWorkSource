...
public abstract class ClientMonitor extends LoggableMonitor implements IBinder.DeathRecipient {
    ...
    public boolean onAcquired(int acquiredInfo, int vendorCode) {
        ...
        String logTag = getLogTag();
        Slog.v(logTag, "Acquired: " + acquiredInfo + HwLog.PREFIX + vendorCode);
        try {
    ...
    public final void vibrateSuccess() {
        String logTag = getLogTag();
        Slog.w(logTag, "mIsSupportHwVibrator:" + this.mIsSupportHwVibrator);
        Context context = this.mContext;
        if (context == null) {
            Slog.w(getLogTag(), "mContext = null, return");
        } else if (this.mIsSupportHwVibrator) {
