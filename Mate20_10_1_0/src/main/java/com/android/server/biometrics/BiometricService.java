...
public class BiometricService extends SystemService {
    ...
    public IBiometricServiceReceiver mConfirmDeviceCredentialReceiver;
    ...
    /* access modifiers changed from: private */
    public IFaceService mFaceService;
    /* access modifiers changed from: private */
    public IFingerprintService mFingerprintService;
    /* access modifiers changed from: private */
    ...
    private final IBiometricServiceReceiverInternal mInternalReceiver = new IBiometricServiceReceiverInternal.Stub() {
        ...
        public void onAuthenticationFailed(int cookie, boolean requireConfirmation) throws RemoteException {
            BiometricService.this.mHandler.obtainMessage(3, BiometricService.this.getContext().getString(17039722)).sendToTarget();
        }
    ...
    public final class AuthSession implements IBinder.DeathRecipient {
        ...
        /* access modifiers changed from: private */
        public IBiometricConfirmDeviceCredentialCallback mConfirmDeviceCredentialCallback;
        ...
        public void binderDied() {
            BiometricService.this.mHandler.post(new Runnable() {
                ...
                public final void run() {
                    AuthSession.this.lambda$binderDied$0$BiometricService$AuthSession();
                }
            });
        }
    ...
    public final class BiometricServiceWrapper extends IBiometricService.Stub {
        ...
        public void authenticate(IBinder token, long sessionId, int userId, IBiometricServiceReceiver receiver, String opPackageName, Bundle bundle, IBiometricConfirmDeviceCredentialCallback callback) throws RemoteException {
            ...
            if (bundle.getBoolean("use_default_title", false)) {
                ...
                if (TextUtils.isEmpty(bundle.getCharSequence("title"))) {
                    bundle.putCharSequence("title", BiometricService.this.getContext().getString(17039717));
                }
            }
            if (bundle.getBoolean("allow_device_credential")) {
                BiometricService.this.mHandler.post(new Runnable(receiver, userId, bundle) {
                    ...
                    public final void run() {
                        BiometricServiceWrapper.this.lambda$authenticate$0$BiometricService$BiometricServiceWrapper(this.f$1, this.f$2, this.f$3);
                    }
                });
                return;
            }
        ...
        public /* synthetic */ void lambda$authenticate$0$BiometricService$BiometricServiceWrapper(IBiometricServiceReceiver receiver, int userId, Bundle bundle) {
            ...
            if (!kgm.isDeviceSecure()) {
                try {
                    receiver.onError(14, BiometricService.this.getContext().getString(17039719));
                } catch (RemoteException e) {
                    Slog.e(BiometricService.TAG, "Remote exception", e);
                }
            } else {
                IBiometricServiceReceiver unused = BiometricService.this.mConfirmDeviceCredentialReceiver = receiver;
        ...
        public void setActiveUser(int userId) {
            ...
            long ident = Binder.clearCallingIdentity();
            int i = 0;
            while (i < BiometricService.this.mAuthenticators.size()) {
                try {
        ...
        try {
            ...
            if (!runningTasks.isEmpty()) {
                ...
                if (this.mCurrentAuthSession != null && !topPackage.contentEquals(this.mCurrentAuthSession.mOpPackageName)) {
                    ...
                    int unused = this.mCurrentAuthSession.mState = 0;
    ...
    public void handleAuthenticationSucceeded(boolean requireConfirmation, byte[] token) {
        try {
            ...
            if (!requireConfirmation) {
                ...
                long unused2 = this.mCurrentAuthSession.mAuthenticatedTimeMs = System.currentTimeMillis();
                this.mCurrentAuthSession.mTokenEscrow = token;
                int unused3 = this.mCurrentAuthSession.mState = 5;
            }
    ...
    public void handleAuthenticationFailed(String failureReason) {
        try {
            ...
            if ((this.mCurrentAuthSession.mModality & 4) != 0) {
                int unused = this.mCurrentAuthSession.mState = 3;
            }
    ...
    public void handleOnConfirmDeviceCredentialError(int error, String message) {
        if (this.mConfirmDeviceCredentialReceiver == null) {
            Slog.w(TAG, "onCDCAError null! Error: " + error + HwLog.PREFIX + message);
            return;
        }
        try {
            this.mActivityTaskManager.unregisterTaskStackListener(this.mTaskStackListener);
    ...
    public void handleRegisterCancellationCallback(IBiometricConfirmDeviceCredentialCallback callback) {
        ...
        IBiometricConfirmDeviceCredentialCallback unused = this.mCurrentAuthSession.mConfirmDeviceCredentialCallback = callback;
    }

    /* access modifiers changed from: private */
    public void handleOnError(int cookie, int error, String message) {
            ...
            if (this.mCurrentAuthSession == null || !this.mCurrentAuthSession.containsCookie(cookie)) {
                if (this.mPendingAuthSession != null && this.mPendingAuthSession.containsCookie(cookie)) {
                    if (this.mPendingAuthSession.mState == 1) {
                        ...
                        int unused = this.mPendingAuthSession.mState = 0;
                ...
                int unused2 = this.mCurrentAuthSession.mState = 6;
                this.mStatusBarService.hideBiometricDialog();
                ...
                if (error == 5) {
                    this.mActivityTaskManager.unregisterTaskStackListener(this.mTaskStackListener);
                    this.mCurrentAuthSession.mClientReceiver.onError(error, message);
                    int unused3 = this.mCurrentAuthSession.mState = 0;
                    this.mCurrentAuthSession = null;
                    this.mStatusBarService.hideBiometricDialog();
                    return;
                }
                ...
                this.mStatusBarService.onBiometricError(message);
                this.mActivityTaskManager.unregisterTaskStackListener(this.mTaskStackListener);
                int unused4 = this.mCurrentAuthSession.mState = 0;
                this.mCurrentAuthSession = null;
            } else {
    ...
    public void handleOnDismissed(int reason) {
        ...
        if (reason == 3) {
            this.mCurrentAuthSession.mClientReceiver.onError(10, getContext().getString(17039721));
        } else if (reason == 1) {
    ...
    public void handleOnReadyForAuthentication(int cookie, boolean requireConfirmation, int userId) {
        ...
        if (this.mPendingAuthSession.mModalitiesWaiting.isEmpty()) {
            ...
            this.mPendingAuthSession = null;
            int unused = this.mCurrentAuthSession.mState = 2;
            int modality = 0;
            try {
    ...
    /* access modifiers changed from: private */
    public void handleAuthenticate(IBinder token, long sessionId, int userId, IBiometricServiceReceiver receiver, String opPackageName, Bundle bundle, int callingUid, int callingPid, int callingUserId, IBiometricConfirmDeviceCredentialCallback callback) {
    ...
    public /* synthetic */ void lambda$handleAuthenticate$1$BiometricService(int userId, IBiometricServiceReceiver receiver, IBinder token, long sessionId, String opPackageName, Bundle bundle, int callingUid, int callingPid, int callingUserId, IBiometricConfirmDeviceCredentialCallback callback) {
        ...
        if (error != 0) {
            try {
                String hardwareUnavailable = getContext().getString(17039720);
                if (error == 1) {
    ...
    private void authenticateInternal(IBinder token, long sessionId, int userId, IBiometricServiceReceiver receiver, String opPackageName, Bundle bundle, int callingUid, int callingPid, int callingUserId, int modality, IBiometricConfirmDeviceCredentialCallback callback) {
        ...
        try {
            ...
            try {
                ...
                int unused = this.mPendingAuthSession.mState = 1;
                if ((modality & 1) != 0) {
    ...
    public void handleCancelAuthentication(IBinder token, String opPackageName) {
        ...
        if (authSession == null || authSession.mState != 6) {
            ...
            try {
                this.mCurrentAuthSession.mClientReceiver.onError(5, getContext().getString(17039721));
                int unused = this.mCurrentAuthSession.mState = 0;
                this.mCurrentAuthSession = null;
                this.mStatusBarService.hideBiometricDialog();
            } catch (RemoteException e) {
            ...
            handleOnConfirmDeviceCredentialError(5, getContext().getString(17039718));
        }
    }
