...
public class LockdownVpnTracker {
    ...
    private BroadcastReceiver mResetReceiver = new BroadcastReceiver() {
        /* class com.android.server.net.LockdownVpnTracker.AnonymousClass1 */
    ...
    private void handleStateChangedLocked() {
        ...
        Slog.d(TAG, "handleStateChanged: egress=" + (egressInfo == null ? null : ConnectivityManager.getNetworkTypeName(egressInfo.getType())) + HwLog.PREFIX + this.mAcceptedEgressIface + "->" + (egressProp == null ? null : egressProp.getInterfaceName()));
        ...
        if (this.mErrorCount > 4) {
            showNotification(17041467, 17303800);
            ...
            if (vpnInfo.isConnected() && vpnConfig != null) {
                ...
                if (!TextUtils.equals(iface, this.mAcceptedIface) || !sourceAddrs.equals(this.mAcceptedSourceAddr)) {
                    ...
                    showNotification(17041464, 17303799);
            ...
            showNotification(17041465, 17303800);
