...
public class NetworkStatsService extends INetworkStatsService.Stub implements IHwNetworkStatsInner {
    ...
    private INetworkManagementEventObserver mAlertObserver = new BaseNetworkObserver() {
        /* class com.android.server.net.NetworkStatsService.AnonymousClass10 */
    ...
    private static final class NetworkStatsHandler extends Handler {
        NetworkStatsHandler(Looper looper, Callback callback) {
    ...
    public void handleWifiStateChanged(NetworkInfo.State state) {
        int i = AnonymousClass11.$SwitchMap$android$net$NetworkInfo$State[state.ordinal()];
        if (i != 1 && i != 2 && i != 3) {
            if (i == 4) {
    ...
    private static class DefaultNetworkStatsSettings implements NetworkStatsSettings {
        ...
        public Config getDevConfig() {
            return new Config(getGlobalLong("netstats_dev_bucket_duration", AppStandbyController.SettingsObserver.DEFAULT_STRONG_USAGE_TIMEOUT), getGlobalLong("netstats_dev_rotate_age", 1296000000), getGlobalLong("netstats_dev_delete_age", 7776000000L));
        }
        ...
        public Config getUidConfig() {
            return new Config(getGlobalLong("netstats_uid_bucket_duration", AppStandbyController.SettingsObserver.DEFAULT_SYSTEM_UPDATE_TIMEOUT), getGlobalLong("netstats_uid_rotate_age", 1296000000), getGlobalLong("netstats_uid_delete_age", 7776000000L));
        }

        @Override // com.android.server.net.NetworkStatsService.NetworkStatsSettings
        public Config getUidTagConfig() {
            return new Config(getGlobalLong("netstats_uid_tag_bucket_duration", AppStandbyController.SettingsObserver.DEFAULT_SYSTEM_UPDATE_TIMEOUT), getGlobalLong("netstats_uid_tag_rotate_age", 432000000), getGlobalLong("netstats_uid_tag_delete_age", 1296000000));
        }
