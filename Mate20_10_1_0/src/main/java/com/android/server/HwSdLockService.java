...
public final class HwSdLockService {
    ...
    private Runnable mEraseStateRunable = new Runnable() {
        ...
        public void run() {
            boolean unused = HwSdLockService.this.mErasingSDLock = false;
        }
    };
    /* access modifiers changed from: private */
    public boolean mErasingSDLock = false;
    private String mExternalStorageVolumeID = null;
    /* access modifiers changed from: private */
    public boolean mForceEraseCompleted = false;
    ...
    private StorageEventListener mStorageListener = new StorageEventListener() {
        ...
        public void onStorageStateChanged(String path, String oldState, String newState) {
            ...
            if (newState.equals("mounted") && HwSdLockService.this.mSystemReady) {
                boolean unused = HwSdLockService.this.autoUnlockSD();
            }
        }
    };
            ...
            try {
                binder.linkToDeath(new IBinder.DeathRecipient() {
                    ...
                    public void binderDied() {
                        ...
                        IVold unused = HwSdLockService.this.mVold = null;
            ...
            this.mHandler.post(new Runnable() {
                ...
                public void run() {
                    if (HwSdLockService.this.mProgressDialog == null) {
                        ...
                        HwSdLockService.this.mProgressDialog.setMessage(HwSdLockService.this.mContext.getText(17041078));
                    }
    ...
    /* access modifiers changed from: private */
    public void handleEraseSDLock(String key) {
        int code = -1;
    ...
    public int getSDLockState() {
        ...
        if (this.mErasingSDLock) {
            ...
            try {
                ...
                if (state2.equals(HwAPPQoEUserAction.DEFAULT_CHIP_TYPE)) {
