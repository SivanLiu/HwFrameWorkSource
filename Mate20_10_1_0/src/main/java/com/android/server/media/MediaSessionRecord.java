...
public class MediaSessionRecord implements IBinder.DeathRecipient {
    ...
    /* access modifiers changed from: private */
    public void setVolumeTo(String packageName, final String opPackageName, int pid, final int uid, ISessionControllerCallback caller, final int value, final int flags) {
        if (this.mVolumeType == 1) {
    ...
    public void dump(PrintWriter pw, String prefix) {
        pw.println(prefix + this.mTag + HwLog.PREFIX + this);
