...
public class MediaSessionService extends SystemService implements Watchdog.Monitor {
    ...
    public final class FullUserRecord implements MediaSessionStack.OnMediaButtonSessionChangedListener {
        ...
        /* access modifiers changed from: private */
        public IBinder.DeathRecipient mCallbackBinder;
        /* access modifiers changed from: private */
    ...
    class SessionManagerImpl extends ISessionManager.Stub {
                        ...
                        if (user != null) {
                            if (user.mFullUserId == userId) {
                                ...
                                if (user.mCallback != null) {
                                    ...
                                    IBinder.DeathRecipient unused = user.mCallbackBinder = null;
                                }
                                ICallback unused2 = user.mCallback = callback;
                                if (user.mCallback == null) {
                                    Binder.restoreCallingIdentity(token);
                                    return;
                                }
                                try {
                                    IBinder.DeathRecipient unused3 = user.mCallbackBinder = new IBinder.DeathRecipient() {
                                        ...
                                        public void binderDied() {
                                            synchronized (MediaSessionService.this.mLock) {
                                                ...
                                                IBinder.DeathRecipient unused2 = user.mCallbackBinder = null;
                                            }
                                        }
                                    };
                                    ...
                                    ICallback unused4 = user.mCallback = null;
                                    IBinder.DeathRecipient unused5 = user.mCallbackBinder = null;
                                }
                                Binder.restoreCallingIdentity(token);
                                return;
                            }
        ...
        public boolean isGlobalPriorityActive() {
            boolean access$1600;
            synchronized (MediaSessionService.this.mLock) {
                access$1600 = MediaSessionService.this.isGlobalPriorityActiveLocked();
            }
            return access$1600;
        }
            ...
            if (session != null) {
                ...
                try {
                    if (MediaSessionService.this.mCurrentFullUserRecord.mLastMediaButtonReceiver != null) {
                        ...
                        Context access$1800 = MediaSessionService.this.mContext;
                        if (needWakeLock) {
                            i = this.mKeyEventReceiver.mLastTimeoutId;
                        }
                        receiver.send(access$1800, i, mediaButtonIntent, this.mKeyEventReceiver, MediaSessionService.this.mHandler);
