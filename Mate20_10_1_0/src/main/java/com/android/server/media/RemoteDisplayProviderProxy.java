...
final class RemoteDisplayProviderProxy implements ServiceConnection {
    ...
    private final Runnable mDisplayStateChanged = new Runnable() {
        ...
        public void run() {
            boolean unused = RemoteDisplayProviderProxy.this.mScheduledDisplayStateChangedCallback = false;
            if (RemoteDisplayProviderProxy.this.mDisplayStateCallback != null) {
                Callback access$100 = RemoteDisplayProviderProxy.this.mDisplayStateCallback;
                RemoteDisplayProviderProxy remoteDisplayProviderProxy = RemoteDisplayProviderProxy.this;
                access$100.onDisplayStateChanged(remoteDisplayProviderProxy, remoteDisplayProviderProxy.mDisplayState);
            }
        }
    };
    /* access modifiers changed from: private */
