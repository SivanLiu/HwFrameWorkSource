...
public class StatusBarManagerService extends IStatusBarService.Stub implements DisplayManager.DisplayListener {
    ...
    private final GlobalActionsProvider mGlobalActionsProvider = new GlobalActionsProvider() {
        ...
        public void setGlobalActionsListener(GlobalActionsListener listener) {
            GlobalActionsListener unused = StatusBarManagerService.this.mGlobalActionListener = listener;
    ...
    private final StatusBarManagerInternal mInternalService = new StatusBarManagerInternal() {
        ...
        public boolean showShutdownUi(boolean isReboot, String reason) {
            if (StatusBarManagerService.this.mContext.getResources().getBoolean(17891514) && StatusBarManagerService.this.mBar != null) {
                try {
