...
public class LockSettingsService extends AbsLockSettingsService {
    ...
    public void showEncryptionNotificationForProfile(UserHandle user) {
        ...
        CharSequence title = r.getText(17041077);
        CharSequence message = r.getText(17041076);
        CharSequence detail = r.getText(17041075);
    ...
    public void showEncryptionNotification(UserHandle user, CharSequence title, CharSequence message, CharSequence detail, PendingIntent intent) {
        if (StorageManager.isFileEncryptedNativeOrEmulated()) {
            this.mNotificationManager.notifyAsUser(null, 9, new Notification.Builder(this.mContext, SystemNotificationChannels.DEVICE_ADMIN).setSmallIcon(17302844).setWhen(0).setOngoing(true).setTicker(title).setColor(this.mContext.getColor(17170460)).setContentTitle(title).setContentText(message).setSubText(detail).setVisibility(1).setContentIntent(intent).build(), user);
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x003f, code lost:
        if (r22 != -1) goto L_0x0074;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x0041, code lost:
        if (r14 == null) goto L_0x004a;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x0043, code lost:
        android.util.Slog.wtf(com.android.server.locksettings.LockSettingsService.TAG, "CredentialType is none, but credential is non-null.");
     */
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x004a, code lost:
        clearUserKeyProtection(r25);
        getGateKeeperService().clearSecureUserId(r25);
        r20.mStorage.writeCredentialHash(com.android.server.locksettings.LockSettingsStorage.CredentialHash.createEmptyHash(), r25);
        setKeystorePassword(null, r25);
        fixateNewestUserKeyAuth(r25);
        synchronizeUnifiedWorkChallengeForProfiles(r25, null);
        notifyActivePasswordMetricsAvailable(-1, null, r25);
        sendCredentialsOnChangeIfRequired(r22, r14, r25, r27);
        android.util.Slog.w(com.android.server.locksettings.LockSettingsService.TAG, "clear password finish");
     */
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x0073, code lost:
        return;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x0074, code lost:
        if (r14 == null) goto L_0x016e;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:27:0x0076, code lost:
        r8 = r20.mStorage.readCredentialHash(r25);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x0080, code lost:
        if (isManagedProfileWithUnifiedLock(r25) == false) goto L_0x009e;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x0082, code lost:
        if (r13 != null) goto L_0x00ad;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:32:0x0088, code lost:
        r13 = getDecryptedPasswordForTiedProfile(r25);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:34:0x008b, code lost:
        android.util.Slog.e(com.android.server.locksettings.LockSettingsService.TAG, "Failed to decrypt child profile key", r0);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:36:0x0094, code lost:
        android.util.Slog.i(com.android.server.locksettings.LockSettingsService.TAG, "Child profile key not found");
     */
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x00a0, code lost:
        if (r8.hash != null) goto L_0x00ad;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:40:0x00a4, code lost:
        android.util.Slog.w(com.android.server.locksettings.LockSettingsService.TAG, "Saved credential provided, but none stored");
     */
    ...
    public void setLockCredentialInternal(byte[] credential, int credentialType, byte[] savedCredential, int requestedQuality, int userId, boolean allowUntrustedChange, boolean isLockTiedToParent) throws RemoteException {
        ...
        byte[] credential2;
        LockSettingsStorage.CredentialHash currentHandle;
    ...
    private void spBasedSetLockCredentialInternalLocked(byte[] credential, int credentialType, byte[] savedCredential, int requestedQuality, int userId, boolean allowUntrustedChange, boolean isLockTiedToParent) throws RemoteException {
        ...
        if (isManagedProfileWithUnifiedLock(userId)) {
            ...
            if (auth2 == null) {
                ...
                setLockCredentialWithAuthTokenLocked(credential, credentialType, auth2, requestedQuality, userId);
