...
public class LockSettingsDbReport {
     ...
     */
    /* JADX WARNING: Removed duplicated region for block: B:21:0x0088 A[ExcHandler: SQLiteException | OperationCanceledException | SecurityException (r0v1 'ex' java.lang.RuntimeException A[CUSTOM_DECLARE]), Splitter:B:17:0x007e] */
    ...
    private String[] splitKey(String key) {
        int index;
        if (key == null || key.isEmpty() || key.charAt(0) != 'U' || (index = key.indexOf("_", 0)) < 0) {
            return null;
        }
