...
public class NsdService extends INsdManager.Stub {
    ...
    public class NsdStateMachine extends StateMachine {
        ...
        public class EnabledState extends State {
                ...
                switch (msg.what) {
                    ...
                    case 393217:
                        ...
                        if (NsdService.this.discoverServices(id, servInfo.getServiceType())) {
                            Slog.d(NsdService.TAG, "Discover " + msg.arg2 + HwLog.PREFIX + id + servInfo.getServiceType());
                    ...
                    case 393225:
                        ...
                        if (NsdService.this.registerService(id3, (NsdServiceInfo) msg.obj)) {
                            Slog.d(NsdService.TAG, "Register " + msg.arg2 + HwLog.PREFIX + id3);
            ...
            private boolean handleNativeEvent(int code, String raw, String[] cooked) {
                ...
                if (clientId < 0) {
                    Slog.d(NsdService.TAG, String.format("Notification %s for listener id %d that is no longer active", NativeResponseCode.nameOf(code), Integer.valueOf(id)));
                    return false;
                }
                Slog.d(NsdService.TAG, String.format("Native daemon message %s: %s", NativeResponseCode.nameOf(code), raw));
                switch (code) {
                    case NativeResponseCode.SERVICE_DISCOVERY_FAILED /*{ENCODED_INT: 602}*/:
                        clientInfo.mChannel.sendMessage(393219, 0, clientId);
                        break;
                    case NativeResponseCode.SERVICE_FOUND /*{ENCODED_INT: 603}*/:
                        clientInfo.mChannel.sendMessage(393220, 0, clientId, new NsdServiceInfo(cooked[2], cooked[3]));
                        break;
                    case NativeResponseCode.SERVICE_LOST /*{ENCODED_INT: 604}*/:
                        clientInfo.mChannel.sendMessage(393221, 0, clientId, new NsdServiceInfo(cooked[2], cooked[3]));
                        break;
                    case NativeResponseCode.SERVICE_REGISTRATION_FAILED /*{ENCODED_INT: 605}*/:
                        clientInfo.mChannel.sendMessage(393226, 0, clientId);
                        break;
                    case NativeResponseCode.SERVICE_REGISTERED /*{ENCODED_INT: 606}*/:
                        clientInfo.mChannel.sendMessage(393227, id, clientId, new NsdServiceInfo(cooked[2], null));
                        break;
                    case NativeResponseCode.SERVICE_RESOLUTION_FAILED /*{ENCODED_INT: 607}*/:
                        ...
                        break;
                    case NativeResponseCode.SERVICE_RESOLVED /*{ENCODED_INT: 608}*/:
                        int index = 0;
                        ...
                        break;
                    case NativeResponseCode.SERVICE_UPDATED /*{ENCODED_INT: 609}*/:
                    case NativeResponseCode.SERVICE_UPDATE_FAILED /*{ENCODED_INT: 610}*/:
                        break;
                    case NativeResponseCode.SERVICE_GET_ADDR_FAILED /*{ENCODED_INT: 611}*/:
                        boolean unused5 = NsdService.this.stopGetAddrInfo(id);
                        removeRequestMap(clientId, id, clientInfo);
                        NsdServiceInfo unused6 = clientInfo.mResolvedService = null;
                        clientInfo.mChannel.sendMessage(393235, 0, clientId);
                        break;
                    case NativeResponseCode.SERVICE_GET_ADDR_SUCCESS /*{ENCODED_INT: 612}*/:
                        try {
    ...
    public boolean registerService(int regId, NsdServiceInfo service) {
        Slog.d(TAG, "registerService: " + regId + HwLog.PREFIX + service);
    ...
    public interface NsdSettings {
        ...
        static default NsdSettings makeDefault(Context context) {
