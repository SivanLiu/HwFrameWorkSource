                ...
                this.mServiceConnection = new ServiceConnection() {
                    ...
                    public void onServiceConnected(ComponentName name, IBinder service) {
                        synchronized (FinancialSmsManager.this.mLock) {
                            IFinancialSmsService unused = FinancialSmsManager.this.mRemoteService = IFinancialSmsService.Stub.asInterface(service);
                            if (FinancialSmsManager.this.mQueuedCommands != null) {
                                ...
                                ArrayList unused2 = FinancialSmsManager.this.mQueuedCommands = null;
                            }
                        }
                    }
                    ...
                    public void onServiceDisconnected(ComponentName name) {
                        synchronized (FinancialSmsManager.this.mLock) {
                            IFinancialSmsService unused = FinancialSmsManager.this.mRemoteService = null;
                        }
                    }
