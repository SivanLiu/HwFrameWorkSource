        ...
        if (DumpUtils.checkDumpAndUsageStatsPermission(getContext(), TAG, pw)) {
            try {
                ...
                if (!searchArgs2.isEmpty()) {
                    ...
                    Iterator<String> it2 = searchArgs2.iterator();
                    while (it2.hasNext()) {
                        out.append(HwLog.PREFIX);
                        out.append(it2.next());
                    }
                    out.append("\n");
                }
                ...
                pw.println("Can't initialize: " + e12);
                Slog.e(TAG, "Can't init", e12);
            }
        }
    }
