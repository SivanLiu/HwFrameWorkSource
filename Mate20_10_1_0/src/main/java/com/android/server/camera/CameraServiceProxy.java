...
public class CameraServiceProxy extends SystemService implements Handler.Callback, IBinder.DeathRecipient {
    ...
    public static final boolean SHOULD_CLOSE_LED = SystemProperties.getBoolean("ro.config.led_close_by_camera", false);
    ...
    private final ICameraServiceProxy.Stub mCameraServiceProxy = new ICameraServiceProxy.Stub() {
        ...
        public void notifyCameraState(String cameraId, int newCameraState, int facing, String clientName, int apiLevel) {
            ...
            String unused = CameraServiceProxy.cameraStateToString(newCameraState);
            String unused2 = CameraServiceProxy.cameraFacingToString(facing);
            if (CameraServiceProxy.this.mHwCameraServiceProxy == null) {
                CameraServiceProxy cameraServiceProxy = CameraServiceProxy.this;
                IHwCameraServiceProxy unused3 = cameraServiceProxy.mHwCameraServiceProxy = HwServiceFactory.getHwCameraServiceProxy(cameraServiceProxy.mContext);
            }
            if (CameraServiceProxy.this.mHwCameraServiceProxy != null) {
    ...
    /* access modifiers changed from: private */
    public IHwCameraServiceProxy mHwCameraServiceProxy = null;
