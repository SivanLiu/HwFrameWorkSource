...
public class HwAccountHelper {
    ...
    private static boolean isPrivacyModeStateOn(Context context) {
        ...
        if (!(1 == Settings.Secure.getInt(context.getContentResolver(), HwDevicePolicyManagerService.PRIVACY_MODE_ON, 1) && 1 == Settings.Secure.getInt(context.getContentResolver(), "privacy_mode_state", 0))) {
