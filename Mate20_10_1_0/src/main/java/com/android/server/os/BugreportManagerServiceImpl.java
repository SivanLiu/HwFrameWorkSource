...
class BugreportManagerServiceImpl extends IDumpstate.Stub {
    ...
    private boolean isDumpstateBinderServiceRunningLocked() {
        return Stub.asInterface(ServiceManager.getService("dumpstate")) != null;
    }
    ...
    private IDumpstate startAndGetDumpstateBinderServiceLocked() {
        ...
        while (true) {
            ...
            ds = Stub.asInterface(ServiceManager.getService("dumpstate"));
            if (ds != null) {
    ...
    private final class DumpstateListener extends IDumpstateListener.Stub implements DeathRecipient {
