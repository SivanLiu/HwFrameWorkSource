...
final class WifiDisplayAdapter extends DisplayAdapter implements IWifiDisplayAdapterInner {
    ...
    public WifiDisplayAdapter(DisplayManagerService.SyncRoot syncRoot, Context context, Handler handler, Listener listener, PersistentDataStore persistentDataStore) {
        super(syncRoot, context, handler, listener, TAG);
        this.mHandler = new WifiDisplayHandler(handler.getLooper());
        this.mPersistentDataStore = persistentDataStore;
        this.mSupportsProtectedBuffers = context.getResources().getBoolean(17891573);
    ...
    public void registerLocked() {
        ...
        getHandler().post(new Runnable() {
            ...
            public void run() {
                ...
                WifiDisplayController unused = wifiDisplayAdapter.mDisplayController = new WifiDisplayController(wifiDisplayAdapter.getContext(), WifiDisplayAdapter.this.getHandler(), WifiDisplayAdapter.this.mWifiDisplayListener);
