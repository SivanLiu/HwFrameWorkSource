    ...
    private HWExtDeviceEventListener mHWListenerMove = new HWExtDeviceEventListener() {
        ...
        public void onDeviceDataChanged(HWExtDeviceEvent hwextDeviceEvent) {
            ...
            if (deviceValues == null) {
                ...
                HwInputManager.runHwTHPCommand("THP_SetSensorGestureWithTimeStamp", Long.toString(new Date().getTime()) + CPUCustBaseConfig.CPUCONFIG_INVALID_STR + String.format("%04X", Integer.valueOf(gestureValue)));
