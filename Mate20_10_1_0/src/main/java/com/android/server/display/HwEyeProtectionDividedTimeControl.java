...
public class HwEyeProtectionDividedTimeControl {
    ...
    public static final String[] ACTION_DIVIDED_TIME_CONTROL = {"com.android.server.action.DIVIDED_TIME_CONTROL_START", "com.android.server.action.DIVIDED_TIME_CONTROL_END"};
    ...
    /* access modifiers changed from: private */
    public HwEyeProtectionControllerImpl mEyeProtectionControlImpl = null;
    /* access modifiers changed from: private */
    public boolean mInDividedTimeFlag = false;
    /* access modifiers changed from: private */
    public boolean mInNextDay = false;
    ...
    public void cancelTimeControlAlarm(int type) {
        ...
        if (type < 2 && (pending = PendingIntent.getBroadcast(this.mContext, 0, new Intent(ACTION_DIVIDED_TIME_CONTROL[type]), 0)) != null) {
            this.mAlarmManager.cancel(pending);
        }
    }
            ...
            if (intent != null) {
                ...
                if (HwEyeProtectionDividedTimeControl.ACTION_DIVIDED_TIME_CONTROL[0].equals(intent.getAction())) {
                    ...
                    if (!isScreenOn) {
                        ...
                        boolean unused = HwEyeProtectionDividedTimeControl.this.mInDividedTimeFlag = true;
                    ...
                    boolean unused2 = HwEyeProtectionDividedTimeControl.this.mInDividedTimeFlag = false;
    ...
    public void setValidTime(boolean bValidFlg) {
        ...
        Settings.System.putLongForUser(this.mContext.getContentResolver(), Utils.KEY_EYE_COMFORT_VALID, validtime, -2);
