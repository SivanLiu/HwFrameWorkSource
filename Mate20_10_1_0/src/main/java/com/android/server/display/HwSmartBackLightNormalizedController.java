...
public class HwSmartBackLightNormalizedController implements HwLightSensorController.LightSensorCallbacks {
    ...
    /* access modifiers changed from: private */
    public void updateSBLBrightness() {
        if (this.mSmartBackLightOn) {
