...
public class AutomaticBrightnessController {
    ...
    protected long mCryogenicActiveScreenOffIntervalInMillis = 1800000;
    protected long mCryogenicLagTimeInMillis = 1800000;
    ...
    protected final SensorEventListener mLightSensorListener = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent event) {
            if (AutomaticBrightnessController.this.mLightSensorEnabled) {
                ...
                if ((!HwServiceFactory.shouldFilteInvalidSensorVal(lux) || AutomaticBrightnessController.INT_BRIGHTNESS_COVER_MODE != 0) && !AutomaticBrightnessController.this.isInValidLightSensorEvent(timeStamp, lux)) {
    ...
    protected boolean mWakeupForFirstAutoBrightness = false;
