...
public final class OverlayDisplayWindow implements DumpUtils.Dump {
    ...
    private void resize(int width, int height, int densityDpi, boolean doLayout) {
        ...
        this.mTitle = this.mContext.getResources().getString(17039995, this.mName, Integer.valueOf(this.mWidth), Integer.valueOf(this.mHeight), Integer.valueOf(this.mDensityDpi));
        if (this.mSecure) {
            this.mTitle += this.mContext.getResources().getString(17039994);
        }
        if (doLayout) {
            relayout();
        }
    ...
    private void createWindow() {
        this.mWindowContent = LayoutInflater.from(this.mContext).inflate(17367221, (ViewGroup) null);
        this.mWindowContent.setOnTouchListener(this.mOnTouchListener);
        this.mTextureView = (TextureView) this.mWindowContent.findViewById(16909238);
        ...
        this.mTitleTextView = (TextView) this.mWindowContent.findViewById(16909239);
