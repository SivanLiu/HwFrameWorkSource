...
public final class DisplayManagerService extends SystemService implements IHwDisplayManagerInner {
    ...
    public static final boolean IS_FOLDABEL;
    ...
    private static final long NEED_DELAY_TIME_DEFAULT = 1900;
    ...
    /* access modifiers changed from: private */
    public boolean mIsDisplayNeedDelaydefault;
    private boolean mIsDisplayRequest;
    /* access modifiers changed from: private */
    public boolean mIsForceUpdateDisplayInfo;
    ...
    /* access modifiers changed from: private */
    public long mNeedDelayTime;
    /* access modifiers changed from: private */
    public boolean mNeedHandleDisplayMode;
    /* access modifiers changed from: private */
    public boolean mNeedHandleDisplayRequest;
    ...
    /* access modifiers changed from: private */
    public void resetDisplayDelayImpl() {
        this.mIsDisplayNeedDelaydefault = false;
        this.mIsDisplayRequest = false;
        this.mNeedHandleDisplayMode = false;
        this.mNeedHandleDisplayRequest = false;
    ...
    /* access modifiers changed from: private */
    public boolean isDisplayNeedDelay(boolean wakeup, int newDisplaymode) {
    ...
    /* access modifiers changed from: private */
    public void performTraversalNow(SurfaceControl.Transaction t) {
    ...
    /* access modifiers changed from: private */
    public void performTraversalNeedDelay(SurfaceControl.Transaction t, long timeOld) {
        this.mTransaction = t;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x001c, code lost:
        if (r0.hasNext() == false) goto L_0x0028;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:35:0x00a0, code lost:
        if (r2 >= r6.mTempDisplayStateWorkQueue.size()) goto L_0x00b0;
     */
            ...
            if (!validatePackageName(callingUid, packageName)) {
                ...
                if (callingUid != 1000 && (flags4 & 16) != 0 && !canProjectVideo(projection)) {
                    ...
                    if (callingUid == 1000 || (flags4 & 512) == 0 || checkCallingPermission("android.permission.INTERNAL_SYSTEM_WINDOW", "createVirtualDisplay()")) {
                        ...
                        try {
                            try {
                                int access$3600 = DisplayManagerService.this.createVirtualDisplayInternal(callback, projection, callingUid, packageName, name, width, height, densityDpi, surface, flags4, uniqueId);
                                Binder.restoreCallingIdentity(token);
                                return access$3600;
                            } catch (Throwable th) {
                                th = th;
    ...
    private final class LocalService extends DisplayManagerInternal {
        ...
        public void performTraversal(SurfaceControl.Transaction t) {
            if (DisplayManagerService.IS_FOLDABEL) {
        ...
        public int setDisplayMode(int mode, int state, boolean wakeup) {
            ...
            if (DisplayManagerService.this.isDisplayNeedDelay(wakeup, mode)) {
                boolean unused = DisplayManagerService.this.mNeedHandleDisplayMode = true;
            }
            if (4 == DisplayManagerService.this.mDisplayMode || 4 == mode) {
                long unused2 = DisplayManagerService.this.mNeedDelayTime = 1900;
            } else {
                long unused3 = DisplayManagerService.this.mNeedDelayTime = 1900;
            }
            int unused4 = DisplayManagerService.this.mDisplayMode = mode;
        ...
        public void setDisplayModeChangeDelay(SurfaceControl.Transaction t, long time) {
            SurfaceControl.Transaction unused = DisplayManagerService.this.mTransaction = t;
            boolean unused2 = DisplayManagerService.this.mNeedHandleDisplayRequest = true;
            boolean unused3 = DisplayManagerService.this.mIsForceUpdateDisplayInfo = true;
            ...
            if (time != 0) {
                boolean unused4 = DisplayManagerService.this.mIsDisplayNeedDelaydefault = false;
            }
