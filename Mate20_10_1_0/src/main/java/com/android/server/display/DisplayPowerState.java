...
public final class DisplayPowerState {
    ...
    /* access modifiers changed from: private */
    public static boolean DEBUG_HWFLOW = (Log.HWINFO || (Log.HWModuleLog && Log.isLoggable(TAG, 4)));
    ...
    /* access modifiers changed from: private */
    public static final boolean mSupportAod = "1".equals(SystemProperties.get("ro.config.support_aod", (String) null));
    /* access modifiers changed from: private */
    public FingerprintDataInterface fpDataCollector;
    /* access modifiers changed from: private */
    public long mBacklightOffTime = 0;
    /* access modifiers changed from: private */
    public long mBacklightOnTime = 0;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public boolean mQuickBacklightOnOffDelayEnable = false;
    /* access modifiers changed from: private */
        ...
        private void addDelayForQuickBacklightOnOff(int pendingBacklight, int backlight) {
            if (DisplayPowerState.this.mQuickBacklightOnOffDelayEnable) {
                if (pendingBacklight > 0 && backlight == 0) {
                    long unused = DisplayPowerState.this.mBacklightOffTime = SystemClock.elapsedRealtime();
                }
                if (pendingBacklight == 0 && backlight > 0) {
                    long unused2 = DisplayPowerState.this.mBacklightOnTime = SystemClock.elapsedRealtime();
    ...
    /* access modifiers changed from: private */
    public boolean isSetBrightness(int brightness) {
