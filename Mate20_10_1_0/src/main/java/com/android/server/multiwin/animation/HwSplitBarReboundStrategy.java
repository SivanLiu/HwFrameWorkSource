...
public abstract class HwSplitBarReboundStrategy {
    ...
    public void afterRebound() {
        ...
        afterReboundAnimSets.playTogether(leftAlphaAnim, rightAlphaAnim, leftScaleAnims, rightScaleAnims);
    ...
    class AnimListener implements Animator.AnimatorListener {
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            if (i == 0) {
                ...
                HwMultiWindowSplitUI.getInstance(HwSplitBarReboundStrategy.this.mAtms.getUiContext(), HwSplitBarReboundStrategy.this.mAtms).updateSplitBarPosition(HwSplitBarReboundStrategy.this.mSplitRatio, HwSplitBarReboundStrategy.this.mCurPosition);
                Slog.i(HwSplitBarReboundStrategy.TAG, " end of all rebound animator ");
            } else if (i == 1) {
                HwMultiWindowSplitUI.getInstance(HwSplitBarReboundStrategy.this.mAtms.getUiContext(), HwSplitBarReboundStrategy.this.mAtms).setLayoutBackground();
