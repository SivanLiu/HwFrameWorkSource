...
public class HwMultiWinPushPendingDropView extends HwMultiWinHotAreaView {
    ...
    /* access modifiers changed from: private */
    public Rect mShadowClipRect = new Rect();
    private Path mShadowPath;
    private ValueAnimator mShadowPushAnimator;
    private float mShadowRoundCorner;
    /* access modifiers changed from: private */
    public float mShadowScaleX;
    /* access modifiers changed from: private */
    public float mShadowScaleY;
    ...
    public HwMultiWinPushPendingDropView(Context context, Rect pushAcceptBound, HwMultiWinClipImageView pushTarget, int splitMode, Point pendingDropSize) {
        ...
        this.mShadowShowAlpha = HwMultiWinUtils.isInNightMode(context) ? 0.1f : 0.55f;
    }
    ...
    private void initShadowClipRect(Point pendingDropSize) {
        ...
        int shadowLength = Math.round(2.0f * hwMultiWinClipImageView.getPrePushWidth()) - getContext().getResources().getDimensionPixelSize(34472536);
    ...
    @Override // com.android.server.multiwin.view.HwMultiWinClipImageView, com.android.server.multiwin.view.HwMultiWinHotAreaView
    ...
    public void playShadowShowAnimation() {
        ...
        this.mShadowShowAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                float unused = HwMultiWinPushPendingDropView.this.mShadowAlpha = shadowAlpha;
    ...
    public void playShadowPushAnimation() {
        ...
        Rect toShadowClipRect = new Rect(0, 0, getWidth(), getHeight());
        this.mShadowPushAnimator = ValueAnimator.ofPropertyValuesHolder(PropertyValuesHolder.ofObject("shadowClipRect", new RectTypeEvaluator(), this.mShadowClipRect, toShadowClipRect), PropertyValuesHolder.ofFloat("shadowScaleX", this.mShadowScaleX, 1.0f), PropertyValuesHolder.ofFloat("shadowScaleY", this.mShadowScaleY, 1.0f));
        ...
        this.mShadowPushAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (shadowClipRectObj instanceof Rect) {
                    Rect unused = HwMultiWinPushPendingDropView.this.mShadowClipRect = (Rect) shadowClipRectObj;
                }
                Object shadowScaleXObj = animation.getAnimatedValue("shadowScaleX");
                if (shadowScaleXObj instanceof Float) {
                    float unused2 = HwMultiWinPushPendingDropView.this.mShadowScaleX = ((Float) shadowScaleXObj).floatValue();
                }
                Object shadowScaleYObj = animation.getAnimatedValue("shadowScaleY");
                if (shadowScaleYObj instanceof Float) {
                    float unused3 = HwMultiWinPushPendingDropView.this.mShadowScaleY = ((Float) shadowScaleYObj).floatValue();
                }
                HwMultiWinPushPendingDropView.this.invalidate();
            }
        });
    ...
    private static class RectTypeEvaluator implements TypeEvaluator<Rect> {
