...
public class HwMultiWinClipImageView extends ImageView {
    ...
    private void init(Context context) {
        ...
        if (HwActivityManager.IS_PHONE) {
            ...
            f = (float) context.getResources().getDimensionPixelSize(34472527);
        }
        this.mRoundCornerRadius = f;
        int borderWidth = context.getResources().getDimensionPixelSize(34472523);
        if (borderWidth > 0) {
            this.mBorderPaint = new Paint();
            this.mBorderPaint.setColor(context.getResources().getColor(33882863));
    ...
    /* access modifiers changed from: private */
    public void updateBlurCoverAlpha(Object blurCoverAlphaObject) {
    ...
    /* access modifiers changed from: private */
    public void updateSwapScale(Object scaleObj) {
    ...
    /* access modifiers changed from: private */
    public void updateSwapTranslation(Object translationObj) {
    ...
    private float getPushScaleFactorWithSplitBar(float scaleFactorWithNoSplitBar) {
        ...
        if (((float) totalLength) > 0.0f) {
            return ((((float) totalLength) * scaleFactorWithNoSplitBar) - (((float) getContext().getResources().getDimensionPixelSize(34472536)) / 2.0f)) / ((float) totalLength);
        }
    ...
    /* access modifiers changed from: private */
    public void updatePushScaleX(Object scaleObjX) {
    ...
    /* access modifiers changed from: private */
    public void updatePushScaleY(Object scaleObjY) {
    ...
    /* access modifiers changed from: private */
    public void updatePushTranslation(Object translationObj) {
        if (translationObj instanceof Float) {
            float translation = ((Float) translationObj).floatValue();
            if (isLandScape()) {
                setTranslationX(translation);
