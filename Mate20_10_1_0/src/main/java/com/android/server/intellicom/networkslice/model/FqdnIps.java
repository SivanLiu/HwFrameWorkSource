...
public class FqdnIps {
    ...
    static {
        try {
            IPV4_MASK = new String(new byte[]{-1, -1, -1, -1}, "ISO_8859_1");
            IPV6_PREFIX = new String(new byte[]{Byte.MIN_VALUE}, "ISO_8859_1");
    ...
    public FqdnIps getNewFqdnIps(FqdnIps fqdnIps) {
        ...
        for (InetAddress fqdnIpv4 : fqdnIps.mIpv4Addr) {
            if (this.mIpv4Addr.size() > 32) {
                break;
            } else if (!this.mIpv4Addr.contains(fqdnIpv4)) {
                ipv4.add(fqdnIpv4);
            }
        }
        Set<InetAddress> ipv6 = new HashSet<>();
        for (InetAddress fqdnIpv6 : fqdnIps.mIpv6Addr) {
            if (this.mIpv6Addr.size() > 32) {
                break;
            } else if (!this.mIpv6Addr.contains(fqdnIpv6)) {
                ipv6.add(fqdnIpv6);
            }
        }
    ...
    public static final class Builder {
        ...
        public Set<InetAddress> mIpv4Addr;
        /* access modifiers changed from: private */
        public Set<InetAddress> mIpv6Addr;
    ...
    public String toString() {
        return "FqdnIps{Ipv4Num=" + this.mIpv4Addr.size() + ", Ipv6Num=" + this.mIpv4Addr.size() + '}';
    }
}
