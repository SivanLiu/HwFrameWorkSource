...
public class NetworkSlicesHandler extends Handler {
    ...
    private void handleAppAppearsForeground(Message msg) {
        if (msg != null && msg.obj != null) {
            ...
            if (ar.exception == null) {
                HwNetworkSliceManager.getInstance().requestNetworkSliceForPackageName(((Integer) ar.result).intValue());
            }
        }
    }
    ...
    private void handleAppGone(Message msg) {
        if (msg != null && msg.obj != null) {
            AsyncResult ar = (AsyncResult) msg.obj;
            if (ar.exception == null) {
                HwNetworkSliceManager.getInstance().handleUidGone(((Integer) ar.result).intValue());
            }
        }
    }
    ...
    private void handleAppRemoved(Message msg) {
        ...
        if (msg != null && msg.obj != null) {
            AsyncResult ar = (AsyncResult) msg.obj;
            if (ar.exception == null) {
                HwNetworkSliceManager.getInstance().handleUidRemoved((String) ar.result);
            }
        }
    }
