...
public class SyncJobService extends JobService {
    ...
    public void callJobFinishedInner(int jobId, boolean needsReschedule, String why) {
        synchronized (sLock) {
            ...
            sLogger.log("callJobFinished()", " jobid=", Integer.valueOf(jobId), " needsReschedule=", Boolean.valueOf(needsReschedule), HwLog.PREFIX, sLogger.jobParametersToString(params), " why=", why);
            if (params != null) {
