...
class PolicyDatabase {
    ...
    private JSONObject deepCopyJSONObject(JSONObject jsonObj) {
        if (jsonObj != null) {
            ...
            try {
                ...
                if (packagePath == null) {
                    ...
                    JSONObject selectedPolicy = resolveActiveDomainPolicy(packageName, new DigestHelper(packagePath) {
                        /* class com.android.server.security.securityprofile.$$Lambda$PolicyDatabase$LwcoExQ65OK6nDlpDPiI3sSHA2E */
                        ...
                        @Override // com.android.server.security.securityprofile.PolicyDatabase.DigestHelper
        ...
        if (digest != null) {
            try {
                activeDomainPolicy = resolveActiveDomainPolicy(packageName, new DigestHelper(digest) {
                    /* class com.android.server.security.securityprofile.$$Lambda$PolicyDatabase$BBm2hUsWXixteFSLn4sckREq5z4 */
