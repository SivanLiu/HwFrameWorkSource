...
class IDAnonymizationBroadcastReceiver {
    ...
    private final BroadcastReceiver mPackageBroadcastReceiver = new BroadcastReceiver() {
        /* class com.android.server.security.privacyability.IDAnonymizationBroadcastReceiver.AnonymousClass1 */
        ...
        public void onReceive(Context context, Intent intent) {
            if ("android.intent.action.PACKAGE_REMOVED".equals(intent.getAction()) && !intent.getBooleanExtra("android.intent.extra.REPLACING", false)) {
                ...
                int ret = IDAnonymizationDB.getInstance().removeCUID(UserHandle.getUserId(uid), packageName);
                if (ret != 0) {
    ...
    private final BroadcastReceiver mUserRemoveReceiver = new BroadcastReceiver() {
        /* class com.android.server.security.privacyability.IDAnonymizationBroadcastReceiver.AnonymousClass2 */
    ...
    public synchronized void onStart() {
        ...
        this.mContext.registerReceiverAsUser(this.mPackageBroadcastReceiver, UserHandle.ALL, packageFilter, null, null);
