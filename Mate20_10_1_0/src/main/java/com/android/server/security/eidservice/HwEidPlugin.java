...
public class HwEidPlugin extends IHwEidPlugin.Stub implements IHwSecurityPlugin {
    ...
    public static final Creator CREATOR = new Creator() {
        /* class com.android.server.security.eidservice.HwEidPlugin.AnonymousClass1 */
    ...
    /* access modifiers changed from: private */
    public String mEidGetVersionRet;
    /* access modifiers changed from: private */
    public IHwBinder.DeathRecipient mEidHidlDeamonDeathRecipient;
    /* access modifiers changed from: private */
    public int mEidHidlDeamonRegisterTryTimes;
    /* access modifiers changed from: private */
    public IEid mEidInstance;
    private int mHwEidGetCertificateRequestMessageRetValue;
    private int mHwEidGetFaceIsChangedRetValue;
    private int mHwEidGetIdentityInformationRetValue;
    /* access modifiers changed from: private */
    public int mHwEidGetImageRetValue;
    /* access modifiers changed from: private */
    public int mHwEidGetInfoSignRetValue;
    /* access modifiers changed from: private */
    public int mHwEidGetSecImageZipRetValue;
    /* access modifiers changed from: private */
    public int mHwEidGetUnSecImageZipRetValue;
    /* access modifiers changed from: private */
    public int mHwEidGetUnsecImageRetValue;
    /* access modifiers changed from: private */
    public HwEidHidlHandler mHwEidHidlHandler;
    private HandlerThread mHwEidThread;

    static /* synthetic */ int access$408(HwEidPlugin x0) {
    ...
    private HwEidPlugin(Context context) {
        this.mContext = null;
        this.mEidHidlDeamonRegisterTryTimes = 0;
        this.mHwEidGetImageRetValue = -1001;
        this.mHwEidGetUnsecImageRetValue = -1001;
        this.mHwEidGetCertificateRequestMessageRetValue = -1001;
        this.mHwEidGetInfoSignRetValue = -1001;
        this.mHwEidGetIdentityInformationRetValue = -1001;
        this.mHwEidGetFaceIsChangedRetValue = -1001;
        this.mHwEidGetSecImageZipRetValue = -1001;
        this.mHwEidGetUnSecImageZipRetValue = -1001;
        this.mEidGetVersionRet = "";
        this.mEidHidlDeamonDeathRecipient = new IHwBinder.DeathRecipient() {
            /* class com.android.server.security.eidservice.HwEidPlugin.AnonymousClass2 */
            ...
            public void serviceDied(long cookie) {
                if (HwEidPlugin.this.mHwEidHidlHandler != null) {
                    ...
                    IEid unused = HwEidPlugin.this.mEidInstance = null;
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: com.android.server.security.eidservice.HwEidPlugin */
    ...
    public final class HwEidHidlHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            try {
                IEid unused = HwEidPlugin.this.mEidInstance = IEid.getService(HwEidPlugin.EID_HIDL_SERVICE_NAME);
            } catch (RemoteException e) {
                Log.e(HwEidPlugin.TAG, "Try get eid hidl deamon servcie failed in handler message");
            }
            if (HwEidPlugin.this.mEidInstance != null) {
                int unused2 = HwEidPlugin.this.mEidHidlDeamonRegisterTryTimes = 0;
                try {
                    HwEidPlugin.this.mEidInstance.linkToDeath(HwEidPlugin.this.mEidHidlDeamonDeathRecipient, 0);
                } catch (RemoteException e2) {
                    Log.e(HwEidPlugin.TAG, "Exception occured when linkToDeath in handle message");
                }
            } else {
                HwEidPlugin.access$408(HwEidPlugin.this);
                if (HwEidPlugin.this.mEidHidlDeamonRegisterTryTimes < 10) {
                    Log.i(HwEidPlugin.TAG, "Eid hidl daemon service is not ready, try times: " + HwEidPlugin.this.mEidHidlDeamonRegisterTryTimes);
                    HwEidPlugin.this.mHwEidHidlHandler.sendEmptyMessageDelayed(1, 1000);
                } else {
    ...
    private void updateImage(ControlWordEntity controlWord, final EidInfoExtendEntity imageInfo, final EidInfoExtendEntity deSkeyInfo, final ENCRYPTION_FACTOR_S factor) throws RemoteException {
        ...
        this.mEidInstance.HWEidGetImage(factor, new IEid.HWEidGetImageCallback() {
            /* class com.android.server.security.eidservice.HwEidPlugin.AnonymousClass3 */
            ...
            public void onValues(int hwEidGetImageRet, SEC_IMAGE_S secImage) {
                ...
                int unused = HwEidPlugin.this.mHwEidGetImageRetValue = hwEidGetImageRet;
                if (HwEidPlugin.HW_DEBUG) {
                    Log.d(HwEidPlugin.TAG, "Eid get image call counter: " + factor.splitTimes + System.lineSeparator() + "Eid get image mHwEidGetImageRetValue: " + HwEidPlugin.this.mHwEidGetImageRetValue + " hwEidGetImageRet:" + hwEidGetImageRet);
                }
            }
        });
    }
    ...
    private void getUnsecImage(final EidInfoExtendEntity imageInfo, final EidInfoExtendEntity deSkeyInfo, IMAGE_CONTAINER_S container, final ENCRYPTION_FACTOR_S factor) throws RemoteException {
        this.mEidInstance.HWEidGetUnsecImage(container, factor, new IEid.HWEidGetUnsecImageCallback() {
            /* class com.android.server.security.eidservice.HwEidPlugin.AnonymousClass4 */
            ...
            public void onValues(int hwEidGetUnsecImageRet, SEC_IMAGE_S secImage) {
                HwEidPlugin.this.updateUnsecImages(factor, imageInfo, deSkeyInfo, secImage, hwEidGetUnsecImageRet);
                if (HwEidPlugin.HW_DEBUG) {
                    Log.d(HwEidPlugin.TAG, "Eid get unsec image call counter: " + factor.splitTimes);
                }
                int unused = HwEidPlugin.this.mHwEidGetUnsecImageRetValue = hwEidGetUnsecImageRet;
                if (HwEidPlugin.HW_DEBUG) {
                    Log.d(HwEidPlugin.TAG, "Eid get unsec image mHwEidGetUnsecImageRetValue : " + HwEidPlugin.this.mHwEidGetUnsecImageRetValue + " hwEidGetUnsecImageRet:" + hwEidGetUnsecImageRet);
                }
            }
        });
    }
    ...
    /* access modifiers changed from: private */
    public void updateUnsecImages(ENCRYPTION_FACTOR_S factor, EidInfoExtendEntity imageInfo, EidInfoExtendEntity deSkeyInfo, SEC_IMAGE_S secImage, int hwEidGetUnsecImageRet) {
    ...
    public int eidGetCertificateRequestMessage(final byte[] requestMessage, final int[] messageLen) {
        int ret;
        checkPermission(EID_MANAGER_PERMISSION);
        ...
        if (iEid != null) {
            try {
                iEid.HWEidGetCertificateRequestMessage(input, new IEid.HWEidGetCertificateRequestMessageCallback() {
                    /* class com.android.server.security.eidservice.HwEidPlugin.AnonymousClass5 */
                    ...
                    public void onValues(int hwEidGetCertificateRequestMessageRet, CERTIFICATE_REQUEST_MESSAGE_S certReqMsg) {
                        HwEidPlugin.this.updateCertificateInfo(certReqMsg, requestMessage, messageLen, hwEidGetCertificateRequestMessageRet);
                    }
                });
            } catch (RemoteException e) {
                isExecption = true;
    ...
    /* access modifiers changed from: private */
    public void updateCertificateInfo(CERTIFICATE_REQUEST_MESSAGE_S certReqMsg, byte[] requestMessage, int[] messageLen, int hwEidGetCertificateRequestMessageRet) {
    ...
    private void updateInfoSign(final EidInfoExtendEntity signEntity, final byte[] sign, final int[] signLen, final INFO_SIGN_INPUT_INFO_S input) throws RemoteException {
        this.mEidInstance.HWEidGetInfoSign(input, new IEid.HWEidGetInfoSignCallback() {
            /* class com.android.server.security.eidservice.HwEidPlugin.AnonymousClass6 */
            ...
            public void onValues(int hwEidGetInfoSignRet, INFO_SIGN_OUTPUT_INFO_S output) {
                ...
                int unused = HwEidPlugin.this.mHwEidGetInfoSignRetValue = hwEidGetInfoSignRet;
                if (HwEidPlugin.HW_DEBUG) {
                    Log.d(HwEidPlugin.TAG, "Eid sign info call counter: " + input.splitTimes + " Eid sign info mHwEidGetInfoSignRetValue: " + HwEidPlugin.this.mHwEidGetInfoSignRetValue + " hwEidGetInfoSignRet:" + hwEidGetInfoSignRet);
                }
            }
        });
    }

    public int eidGetIdentityInformation(final byte[] identityInfo, final int[] identityInfoLen) {
        int ret;
        checkPermission(EID_MANAGER_PERMISSION);
        ...
        if (iEid != null) {
            try {
                iEid.HWEidGetIdentityInformation(input, new IEid.HWEidGetIdentityInformationCallback() {
                    /* class com.android.server.security.eidservice.HwEidPlugin.AnonymousClass7 */
                    ...
                    public void onValues(int hwEidGetIdentityInformationRet, IDENTITY_INFORMATION_S idInfo) {
                        HwEidPlugin.this.updateIdentity(hwEidGetIdentityInformationRet, identityInfo, idInfo, identityInfoLen);
                    }
                });
            } catch (RemoteException e) {
                isExecption = true;
    ...
    /* access modifiers changed from: private */
    public void updateIdentity(int hwEidGetIdentityInformationRet, byte[] identityInfo, IDENTITY_INFORMATION_S idInfo, int[] identityInfoLen) {
        ...
        if (iEid != null) {
            try {
                iEid.HWEidGetFaceIsChanged(input, new IEid.HWEidGetFaceIsChangedCallback() {
                    /* class com.android.server.security.eidservice.HwEidPlugin.AnonymousClass8 */
                    ...
                    public void onValues(int hwEidGetFaceIsChangedRet, FACE_CHANGE_OUTPUT_INFO_S output) {
                        HwEidPlugin.this.updateFaceState(hwEidGetFaceIsChangedRet);
                    }
                });
            } catch (RemoteException e) {
                isExecption = true;
    ...
    /* access modifiers changed from: private */
    public void updateFaceState(int hwEidGetFaceIsChangedRet) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:45:0x00c6 A[Catch:{ RemoteException -> 0x00ce }, RETURN] */
    /* JADX WARNING: Removed duplicated region for block: B:46:0x00c7 A[Catch:{ RemoteException -> 0x00ce }] */
    ...
    private void getSecImageZip(List<EidInfoExtendEntity> eidInfoExtendEntityList, IMAGE_ZIP_CONTAINER_S container, CUT_COORDINATE_S coordinate, ENCRYPTION_FACTOR_S factor) throws RemoteException {
        ...
        if (deSkeyEntity != null) {
            ...
            this.mEidInstance.HWEidGetSecImageZip(container, coordinate, factor, new IEid.HWEidGetSecImageZipCallback() {
                /* class com.android.server.security.eidservice.HwEidPlugin.AnonymousClass9 */
                ...
                public void onValues(int hwEidGetSecImageZipRet, SEC_IMAGE_ZIP_S output) {
                    ...
                    int unused = HwEidPlugin.this.mHwEidGetSecImageZipRetValue = hwEidGetSecImageZipRet;
                }
            });
        }
    }
    ...
    private void getUnsecImageZip(List<EidInfoExtendEntity> eidInfoExtendEntityList, IMAGE_ZIP_CONTAINER_S container, ENCRYPTION_FACTOR_S factor) throws RemoteException {
        ...
        if (deSkeyEntity != null) {
            ...
            this.mEidInstance.HWEidGetUnsecImageZip(container, factor, new IEid.HWEidGetUnsecImageZipCallback() {
                /* class com.android.server.security.eidservice.HwEidPlugin.AnonymousClass10 */
                ...
                public void onValues(int hwEidGetUnSecImageZipRet, SEC_IMAGE_ZIP_S output) {
                    ...
                    int unused = HwEidPlugin.this.mHwEidGetUnSecImageZipRetValue = hwEidGetUnSecImageZipRet;
                }
            });
        }
    }
        ...
        if (iEid != null) {
            try {
                iEid.HWEidGetVersion(new IEid.HWEidGetVersionCallback() {
                    /* class com.android.server.security.eidservice.HwEidPlugin.AnonymousClass11 */
                    ...
                    public void onValues(int hwmEidGetVersionRet, HIDL_VERSION_S output) {
                        if (hwmEidGetVersionRet == 0) {
                            ...
                            String unused = hwEidPlugin.mEidGetVersionRet = output.main + "." + output.sub;
                        }
                    }
                });
