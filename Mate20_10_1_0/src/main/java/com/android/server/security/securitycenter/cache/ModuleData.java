package com.android.server.security.securitycenter.cache;
...
public class ModuleData {
    ...
    private ConcurrentHashMap<String, Bundle> mMethod2ArgsMap = new ConcurrentHashMap<>(6);
    ...
    public Bundle getMethodBundleArgs(String methodName) {
        ...
        Slog.w(TAG, "getMethodBundleArgs:no method:" + methodName + " in " + this.mModuleName);
        return null;
    }
