...
public class HwPowerManagerService extends PowerManagerService {
    ...
    public ServiceConnection connection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder binder) {
            ...
            IIntelliService unused = HwPowerManagerService.this.mIintelliService = IIntelliService.Stub.asInterface(binder);
    ...
    private IHwActivityNotifierEx mActivityNotifierEx = new IHwActivityNotifierEx() {
        ...
        public void call(Bundle extras) {
            ...
            int pid = extras.getInt(SceneRecogFeature.DATA_PID);
            ...
            synchronized (HwPowerManagerService.this.mLock) {
                ...
                for (int i = HwPowerManagerService.this.mWakeLocks.size() + -1; i >= 0; i--) {
                    WakeLock wakelock = (WakeLock) HwPowerManagerService.this.mWakeLocks.get(i);
                ...
                for (int i2 = HwPowerManagerService.this.mForceReleasedWakeLocks.size() - 1; i2 >= 0; i2--) {
                    WakeLock wl = (WakeLock) HwPowerManagerService.this.mForceReleasedWakeLocks.get(i2);
                ...
                for (int i3 = HwPowerManagerService.this.mProxyedWakeLocks.size() - 1; i3 >= 0; i3--) {
                    WakeLock wl2 = (WakeLock) HwPowerManagerService.this.mProxyedWakeLocks.get(i3);
    ...
    /* access modifiers changed from: private */
    public final List<WakeLock> mForceReleasedWakeLocks = new ArrayList();
    ...
    /* access modifiers changed from: private */
    public IIntelliService mIintelliService;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public boolean mIsFaceDetecting;
    /* access modifiers changed from: private */
    public boolean mIsIntelliServiceBound;
    ...
    /* access modifiers changed from: private */
    public final List<WakeLock> mProxyedWakeLocks = new ArrayList();
    /* access modifiers changed from: private */
    ...
    public void systemReady(IAppOpsService appOps) {
        ...
        this.mHwInputManagerInternal = (HwInputManagerService.HwInputManagerLocalService) getLocalService(HwInputManagerService.HwInputManagerLocalService.class);
        ...
        resolver.registerContentObserver(Settings.System.getUriFor(Utils.KEY_EYES_PROTECTION), false, this.mSettingsObserver, -2);
    ...
    private static final class FingerSenseObserver extends ContentObserver {
        ...
        FingerSenseObserver(Handler handler, ContentResolver resolver2) {
            super(handler);
    ...
    private final class HeadsetReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            synchronized (HwPowerManagerService.this.mLock) {
                ...
                Slog.i(HwPowerManagerService.TAG, "HeadsetReceiver, state:" + intent.getIntExtra(SceneRecogFeature.DATA_STATE, 0));
                if (intent.getIntExtra(SceneRecogFeature.DATA_STATE, 0) == 1) {
    ...
    private final class BluetoothReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Slog.i(HwPowerManagerService.TAG, "BluetoothReceiver, newState:" + newState + ", oldState:" + oldState + ", intent:" + intent.getAction());
            if (btDevice != null && newState == 2 && oldState == 1) {
                BluetoothClass btClass = btDevice.getBluetoothClass();
                Slog.i(HwPowerManagerService.TAG, "BluetoothReceiver btClass:" + btClass);
                if (btClass != null) {
                    ...
                    if (isNeedWakeUp) {
                        synchronized (HwPowerManagerService.this.mLock) {
                            HwPowerManagerService.this.wakeUpAndUserActiviyLocked(2, "bluetooth.connected");
                        }
                    }
                }
            }
    ...
    /* access modifiers changed from: private */
    public void wakeUpAndUserActiviyLocked(int reason, String details) {
    ...
    public void handleWakeLockDeath(WakeLock wakeLock) {
        synchronized (this.mLock) {
            ...
            for (int i = this.mForceReleasedWakeLocks.size() - 1; i >= 0; i--) {
                WakeLock wl = this.mForceReleasedWakeLocks.get(i);
            ...
            for (int i2 = this.mProxyedWakeLocks.size() - 1; i2 >= 0; i2--) {
                WakeLock wl2 = this.mProxyedWakeLocks.get(i2);
    ...
    private static final class ProxyWakeLockProcessInfo {
    ...
    private void restoreProxyWakeLockLocked(int pid, int uid) {
        for (int i = this.mProxyedWakeLocks.size() - 1; i >= 0; i--) {
            WakeLock wakelock = this.mProxyedWakeLocks.get(i);
            ...
            try {
                for (ProxyWakeLockProcessInfo pwi : this.mProxyWakeLockProcessList) {
                    ...
                    if (pwi.isSameProcess(tmpPid, tmpUid)) {
                        ...
                        obj = obj2;
                        try {
                            WakeLock wakelock = new WakeLock(this, lock, flags, tag, packageName, ws, historyTag, uid, pid, new UidState(uid));
                            try {
    ...
    public boolean updateProxyWakeLockWorkSource(IBinder lock, WorkSource ws, String historyTag, int callingUid) {
        synchronized (this.mLock) {
            ...
            WakeLock wakeLock = this.mProxyedWakeLocks.get(index);
            if (DEBUG) {
    ...
    private boolean releaseWakeLockFromListLocked(IBinder lock, List<WakeLock> list) {
        int length = list.size();
        boolean isRelease = false;
        for (int i = length - 1; i >= 0; i--) {
            WakeLock wakelock = list.get(i);
    ...
    private void acquireWakeLockInternalLocked(WakeLock wl) {
        int uid;
        WakeLock wakeLock;
        ...
        if (index >= 0) {
            ...
            WakeLock wakeLock2 = (WakeLock) this.mWakeLocks.get(index);
    ...
    private void forceReleaseWakeLockWithWorkSourceIfMatchPidUidLocked(WakeLock wakelock, int pid, int uid) {
        int j;
        int length;
        int length2;
        String str;
        ...
        if (length3 == 1) {
            ...
            while (j2 < length3) {
                if (wakelock.mWorkSource.get(j2) != i) {
                    ...
                    length = length3;
                    length2 = 0;
                    WakeLock cacheWakelock = new WakeLock(this, wakelock.mLock, wakelock.mFlags, wakelock.mTag, wakelock.mPackageName, workSource, wakelock.mHistoryTag, wakelock.mOwnerUid, wakelock.mOwnerPid, new UidState(i));
                    try {
    ...
    private void forceReleaseWakeLockWithoutWorkSourceIfMatchPidUidLocked(WakeLock wakelock, int pid, int uid) {
    ...
    public void forceRestoreWakeLockByPidUid(int pid, int uid) {
        ...
        synchronized (this.mLock) {
            for (int i = this.mForceReleasedWakeLocks.size() - 1; i >= 0; i--) {
                WakeLock wakelock = this.mForceReleasedWakeLocks.get(i);
                if (wakelock.mWorkSource == null) {
    ...
    private boolean forceRestoreWakeLockWithoutWorkSourceIfMatchPidUidLocked(WakeLock wakelock, int pid, int uid) {
    ...
    private boolean forceRestoreWakeLockWithWorkSourceIfMatchPidUidLocked(WakeLock wakelock, int pid, int uid) {
    ...
    public void dumpInternal(PrintWriter pw) {
        ...
        synchronized (this.mLock) {
            Iterator<WakeLock> it = this.mProxyedWakeLocks.iterator();
            while (it.hasNext()) {
                pw.println(" Proxyed WakeLocks :" + it.next());
            }
            Iterator<WakeLock> it2 = this.mForceReleasedWakeLocks.iterator();
            while (it2.hasNext()) {
    ...
    private boolean isWakeLockWithWorkSourceMatchUidAndFlag(WakeLock wl, int uid, int flag) {
    ...
    private boolean isWakeLockMatchUidAndFlag(WakeLock wl, int uid, int flag) {
        if (wl.mOwnerUid == uid) {
    ...
    public void sendTempBrightnessToMonitor(String paramType, int brightness) {
        if (this.mDisplayEffectMonitor != null) {
            ...
            if (packageNames.length != 0) {
                ...
                params.put("packageName", packageNames[0]);
    ...
    private void enableBrightnessWaitLocked() {
        if (!this.mBrightnessWaitModeEnabled) {
            ...
            this.mDirty |= AwarenessConstants.PHONE_STATE_CHANGED_ACTION;
    ...
    private void setWakeUpReasonByPackageName(String opPackageName) {
        ...
        if (opPackageName != null) {
            ...
            if (hashCode != -861391249) {
                if (hashCode == 1698344559 && opPackageName.equals(FingerViewController.PKGNAME_OF_KEYGUARD)) {
                    c = 0;
                }
            } else if (opPackageName.equals(AppStartupDataMgr.HWPUSH_PKGNAME)) {
                c = 1;
            }
            if (c == 0) {
    ...
    private boolean wakeUpNoUpdateWithoutInteractiveLocked(long eventTime, String reason, int uid, String opPackageName) {
        ...
        Trace.traceBegin(PermissionType.SMS_OTHERS, "wakeUpWithoutInteractive");
        try {
            ...
            Trace.traceEnd(PermissionType.SMS_OTHERS);
        }
    }
    ...
    public void startIntelliService() {
        ...
        if (!this.mIsIntelliServiceBound) {
            this.mHandler.post(new Runnable() {
                ...
                public void run() {
                    try {
                        boolean unused = HwPowerManagerService.this.mIsIntelliServiceBound = true;
    ...
    public void setMirrorLinkForVdrive() {
        if (this.isVdriveBackLightMode) {
            ...
            if (hwInputManagerLocalService != null) {
                hwInputManagerLocalService.setMirrorLinkInputStatus(false);
            }
        } else {
            ...
            HwInputManagerService.HwInputManagerLocalService hwInputManagerLocalService2 = this.mHwInputManagerInternal;
            if (hwInputManagerLocalService2 != null) {
                hwInputManagerLocalService2.setMirrorLinkInputStatus(true);
            }
        }
    ...
    public void bedTimeLog(boolean isKeepAwake, boolean isStayOn, boolean isScreenBrightnessBoostInProgress) {
        if (this.mScreenTimeoutFlag && isKeepAwake) {
            ...
            if ((this.mWakeLockSummary & 32) != 0) {
                ...
                Iterator it = this.mWakeLocks.iterator();
                while (it.hasNext()) {
                    Slog.i(TAG, "WakeLock:" + ((WakeLock) it.next()).toString());
                }
            }
        }
    ...
    public boolean isPhoneHeldWakeLock() {
        ...
        while (it.hasNext()) {
            WakeLock wl = (WakeLock) it.next();
            if (INCALLUI_PACKAGENAME.equals(wl.mPackageName) && (wl.mFlags & AwarenessConstants.BROADCAST_ACTION_MAX) == 32) {
                return true;
            }
        }
        return false;
    ...
    /* access modifiers changed from: private */
    public void unlinkToDeath(WakeLock wl) {
