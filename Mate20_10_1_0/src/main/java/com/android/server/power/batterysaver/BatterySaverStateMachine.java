...
public class BatterySaverStateMachine {
    ...
    public void triggerDynamicModeNotification() {
        ...
        ensureNotificationChannelExists(manager, DYNAMIC_MODE_NOTIF_CHANNEL_ID, 17040013);
        manager.notifyAsUser(TAG, DYNAMIC_MODE_NOTIFICATION_ID, buildNotification(DYNAMIC_MODE_NOTIF_CHANNEL_ID, this.mContext.getResources().getString(17040015), 17040014, "android.intent.action.POWER_USAGE_SUMMARY"), UserHandle.ALL);
    }
    ...
    public void triggerStickyDisabledNotification() {
        ...
        manager.notifyAsUser(TAG, STICKY_AUTO_DISABLED_NOTIFICATION_ID, buildNotification(BATTERY_SAVER_NOTIF_CHANNEL_ID, this.mContext.getResources().getString(17039704, percentage), 17039709, "android.settings.BATTERY_SAVER_SETTINGS"), UserHandle.ALL);
    }
