...
public class HwAutoPowerOffController {
    ...
    private AlertDialog createDialog(Context context, String message) {
        ...
        builder.setTitle(33685530);
        builder.setMessage(message);
        builder.setNegativeButton(17039360, (DialogInterface.OnClickListener) null);
        builder.setPositiveButton(33685529, new DialogInterface.OnClickListener() {
    ...
    private Notification createNotification(String message) {
        String notificationTitle = this.mContext.getResources().getString(33685530);
