...
public class TaskRecord extends AbsTaskRecord {
    ...
    IHwTaskRecordEx mHwTaskRecordEx = null;
    ...
    /* access modifiers changed from: package-private */
    /* JADX WARNING: Removed duplicated region for block: B:112:0x0183 A[Catch:{ all -> 0x02ea }] */
    /* JADX WARNING: Removed duplicated region for block: B:113:0x0186 A[Catch:{ all -> 0x02ea }] */
    /* JADX WARNING: Removed duplicated region for block: B:116:0x0190 A[SYNTHETIC, Splitter:B:116:0x0190] */
    /* JADX WARNING: Removed duplicated region for block: B:122:0x01aa A[SYNTHETIC, Splitter:B:122:0x01aa] */
    /* JADX WARNING: Removed duplicated region for block: B:126:0x01b7  */
    /* JADX WARNING: Removed duplicated region for block: B:132:0x01de A[Catch:{ all -> 0x01d1 }] */
    /* JADX WARNING: Removed duplicated region for block: B:134:0x01ef A[Catch:{ all -> 0x01d1 }] */
    /* JADX WARNING: Removed duplicated region for block: B:152:0x0224  */
    /* JADX WARNING: Removed duplicated region for block: B:157:0x0238  */
    /* JADX WARNING: Removed duplicated region for block: B:192:0x02a2  */
    /* JADX WARNING: Removed duplicated region for block: B:197:0x02af  */
    /* JADX WARNING: Removed duplicated region for block: B:199:0x02b3  */
    /* JADX WARNING: Removed duplicated region for block: B:203:0x02c3  */
    /* JADX WARNING: Removed duplicated region for block: B:206:0x02d3 A[RETURN, SYNTHETIC] */
    /* JADX WARNING: Removed duplicated region for block: B:207:0x02d6 A[ORIG_RETURN, RETURN, SYNTHETIC] */
    /* JADX WARNING: Removed duplicated region for block: B:215:0x02fc  */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:86:0x011e A[ADDED_TO_REGION] */
    ...
    public boolean reparent(ActivityStack preferredStack, int position, int moveStackMode, boolean animate, boolean deferResume, boolean schedulePictureInPictureModeChange, String reason) {
        ...
        try {
            ...
            if (r != null) {
                try {
                    if (root.isTopDisplayFocusedStack(sourceStack) && topRunningActivityLocked() == r) {
                        wasFocused = true;
                                                    ...
                                                    try {
                                                        if (sourceStack.getWindowingMode() != toStackWindowingMode2) {
                                                            ...
                                                            if (HwMwUtils.ENABLED || !isClearBounds) {
                                                                ...
                                                                objArr[1] = true;
                                                                i = 2;
                                                                objArr[2] = Integer.valueOf(toStackWindowingMode2);
                                                                c = 3;
                                                                objArr[3] = Integer.valueOf(this.taskId);
                                                                objArr[4] = r == null ? null : r.appToken;
                                                                HwMwUtils.performPolicy(13, objArr);
                                                            }
                                                            if (this.mTask != null) {
                                                                Task task = this.mTask;
                                                                TaskStack taskStack = toStack.getTaskStack();
                                                                if (moveStackMode == 0) {
                                                                ...
                                                                try {
                                                                    task.reparent(taskStack, position3, z);
                                                                    if (moveStackMode != 0) {
                                                                        z2 = true;
                                                                        if (moveStackMode == 1) {
                                                                            if (!wasFocused) {
                                                                        ...
                                                                        sourceStack.removeTask(this, reason, !moveStackToFront ? i : z2);
                                                                        ...
                                                                        boolean toStackSplitScreenPrimary = (position2 != 3 || WindowConfiguration.isHwSplitScreenPrimaryWindowingMode(position2)) ? i2 : false;
                                                                        configBounds = getRequestedOverrideBounds();
                                                                        if (position2 != i2 || position2 == 4 || WindowConfiguration.isHwMultiStackWindowingMode(position2)) {
                                                                            if (Objects.equals(configBounds, toStack.getRequestedOverrideBounds())) {
                                                                                kept = resize(toStack.getRequestedOverrideBounds(), 0, !mightReplaceWindow ? i2 : false, deferResume);
                                                                                ...
                                                                                supervisor.handleNonResizableTaskIfNeeded(this, preferredStack.getWindowingMode(), i3, toStack);
                                                                        ...
                                                                        if (position2 == 5) {
                                                                            ...
                                                                            if (!bounds.isEmpty()) {
                                                                                kept = resize(bounds, 2, !mightReplaceWindow ? i2 : false, deferResume);
                                                                            }
                                                                        } else if (toStackSplitScreenPrimary || position2 == 2) {
                                                                            if (toStackSplitScreenPrimary && moveStackMode == i2) {
                                                                                try {
            ...
            if (!r.finishing && r.mActivityComponent.equals(newR.mActivityComponent)) {
                while (true) {
                    ...
                    if (!r2.finishing) {
                        ...
                        if (HwMwUtils.ENABLED && r2.inHwMagicWindowingMode()) {
                            if (HwMwUtils.performPolicy(7, new Object[]{r.appToken, Integer.valueOf(newR.intent.getFlags()), r2.appToken}).getBoolean("RESULT_CLEAR_TASK", false)) {
                            }
                        }
                        ActivityStack activityStack = this.mStack;
    ...
    public boolean isResizeable(boolean checkSupportsPip) {
        if (!this.mService.mForceResizableActivities) {
            ...
            ComponentName componentName = this.realActivity;
            return iHwActivityTaskManagerServiceEx.isResizableApp(componentName == null ? null : componentName.getPackageName(), this.mResizeMode) || (checkSupportsPip && this.mSupportsPictureInPicture);
        }
    }
    ...
    public boolean supportsSplitScreenWindowingMode() {
        ...
        return (this.mService.mForceResizableActivities || (isResizeable(false) && !ActivityInfo.isPreserveOrientationMode(this.mResizeMode))) && !isTopInSplitAndNonResizable();
    }

    public boolean supportsHwSplitScreenWindowingMode() {
        if (!super.supportsSplitScreenWindowingMode() || !this.mService.mSupportsSplitScreenMultiWindow) {
            return false;
        }
        return (this.mService.mForceResizableActivities || (isHwResizeable(false) && !ActivityInfo.isPreserveOrientationMode(this.mResizeMode))) && !isTopInSplitAndNonResizable();
    }

    private boolean isHwResizeable(boolean checkSupportsPip) {
        if (!this.mService.mForceResizableActivities) {
            IHwActivityTaskManagerServiceEx iHwActivityTaskManagerServiceEx = this.mService.mHwATMSEx;
            ComponentName componentName = this.realActivity;
            return iHwActivityTaskManagerServiceEx.isHwResizableApp(componentName == null ? null : componentName.getPackageName(), this.mResizeMode) || (checkSupportsPip && this.mSupportsPictureInPicture);
        }
    }
    ...
    public void computeConfigResourceOverrides(Configuration inOutConfig, Configuration parentConfig, ActivityRecord.CompatDisplayInsets compatInsets) {
        ...
        if (!(!insideParentBounds || windowingMode == 5 || WindowConfiguration.isHwFreeFormWindowingMode(windowingMode) || windowingMode == 11 || windowingMode == 12 || (parentAppBounds = parentConfig.windowConfiguration.getAppBounds()) == null || parentAppBounds.isEmpty())) {
        ...
        if (inOutConfig.orientation == 0) {
            ...
            if (!HwMwUtils.IS_FOLD_SCREEN_DEVICE && inHwMagicWindowingMode()) {
                HwMwUtils.performPolicy(80, new Object[]{inOutConfig, Float.valueOf(density2)});
            }
        }
    ...
    public void resolveOverrideConfiguration(Configuration newParentConfig) {
        ...
        if (!outOverrideBounds.isEmpty()) {
            if (!inCoordinationWindowingMode()) {
    ...
    public void fillTaskInfo(TaskInfo info) {
        ...
        info.displayId = activityStack3 == null ? -1 : activityStack3.mDisplayId;
        ...
        info.supportsHwSplitScreenMultiWindow = supportsHwSplitScreenWindowingMode();
    }
            ...
            while (attrNdx >= 0) {
                ...
                switch (c) {
                    ...
                    case '\n':
                        ...
                        taskDescription = taskDescription2;
                        break;
                    case WindowManagerService.H.WINDOW_FREEZE_TIMEOUT /*{ENCODED_INT: 11}*/:
                        intent = intent2;
                    ...
                    case '\r':
                        ...
                        taskDescription = taskDescription2;
                        break;
                    case WindowManagerService.H.PERSIST_ANIMATION_SCALE /*{ENCODED_INT: 14}*/:
                        lastTimeOnTop = Long.parseLong(attrValue);
                        intent = intent2;
                        taskDescription = taskDescription2;
                        break;
                    case WindowManagerService.H.FORCE_GC /*{ENCODED_INT: 15}*/:
                        neverRelinquishIdentity = Boolean.parseBoolean(attrValue);
                        intent = intent2;
                        taskDescription = taskDescription2;
                        break;
                    case WindowManagerService.H.ENABLE_SCREEN /*{ENCODED_INT: 16}*/:
                        taskAffiliation = Integer.parseInt(attrValue);
                        intent = intent2;
                        taskDescription = taskDescription2;
                        break;
                    case WindowManagerService.H.APP_FREEZE_TIMEOUT /*{ENCODED_INT: 17}*/:
                        prevTaskId = Integer.parseInt(attrValue);
                        intent = intent2;
                        taskDescription = taskDescription2;
                        break;
                    case WindowManagerService.H.SEND_NEW_CONFIGURATION /*{ENCODED_INT: 18}*/:
                        nextTaskId = Integer.parseInt(attrValue);
                        intent = intent2;
                        taskDescription = taskDescription2;
                        break;
                    case WindowManagerService.H.REPORT_WINDOWS_CHANGE /*{ENCODED_INT: 19}*/:
                    ...
                    case 21:
                        ...
                        taskDescription = taskDescription2;
                        break;
                    case WindowManagerService.H.REPORT_HARD_KEYBOARD_STATUS_CHANGE /*{ENCODED_INT: 22}*/:
                        resizeMode2 = Integer.parseInt(attrValue);
                        intent = intent2;
                        taskDescription = taskDescription2;
                        break;
                    case WindowManagerService.H.BOOT_TIMEOUT /*{ENCODED_INT: 23}*/:
                        intent = intent2;
                        supportsPictureInPicture2 = Boolean.parseBoolean(attrValue);
                        taskDescription = taskDescription2;
                        break;
                    case WindowManagerService.H.WAITING_FOR_DRAWN_TIMEOUT /*{ENCODED_INT: 24}*/:
                        intent = intent2;
                        lastNonFullscreenBounds = Rect.unflattenFromString(attrValue);
                        taskDescription = taskDescription2;
                        break;
                    case WindowManagerService.H.SHOW_STRICT_MODE_VIOLATION /*{ENCODED_INT: 25}*/:
