...
public class AppTransition implements DumpUtils.Dump {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r4v1, resolved type: android.view.animation.AlphaAnimation */
    /* JADX DEBUG: Multi-variable search result rejected for r4v2, resolved type: android.view.animation.AlphaAnimation */
    /* JADX DEBUG: Multi-variable search result rejected for r4v3, resolved type: android.view.animation.AlphaAnimation */
    /* JADX DEBUG: Multi-variable search result rejected for r6v10, resolved type: android.view.animation.AnimationSet */
    /* JADX DEBUG: Multi-variable search result rejected for r4v5, resolved type: android.view.animation.AlphaAnimation */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r4v1, resolved type: android.view.animation.ScaleAnimation */
    /* JADX DEBUG: Multi-variable search result rejected for r4v3, resolved type: android.view.animation.ScaleAnimation */
    /* JADX DEBUG: Multi-variable search result rejected for r4v5, resolved type: android.view.animation.ScaleAnimation */
    /* JADX WARN: Multi-variable type inference failed */
    /* access modifiers changed from: package-private */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:142:0x038c  */
    /* JADX WARNING: Removed duplicated region for block: B:145:0x0396  */
                ...
                if (transit == 18) {
                    ...
                    if (i14 == 1) {
                        ...
                        if (i14 == 3) {
                                ...
                                if (i14 == NEXT_TRANSIT_TYPE_OPEN_CROSS_PROFILE_APPS && enter) {
                                    ...
                                    if (transit != 19) {
                                        if (transit != 24) {
                                            if (transit != 25) {
                                                switch (transit) {
                                                    case NEXT_TRANSIT_TYPE_OPEN_CROSS_PROFILE_APPS /*{ENCODED_INT: 9}*/:
                                                        if (enter) {
                                                        ...
                                                        animAttr = i4;
                                                        break;
                                                    case NEXT_TRANSIT_TYPE_REMOTE /*{ENCODED_INT: 10}*/:
                                                        if (enter) {
                                                            i5 = 12;
                                                        } else {
                                                            i5 = 13;
                            ...
                            this.mNextAppTransitionScaleUp = z3;
                            str2 = " transit=";
                            str = " isEntrance=";
    ...
    public static String appTransitionToString(int transition) {
        ...
        switch (transition) {
            case NEXT_TRANSIT_TYPE_THUMBNAIL_ASPECT_SCALE_DOWN /*{ENCODED_INT: 6}*/:
                return "TRANSIT_ACTIVITY_OPEN";
            case NEXT_TRANSIT_TYPE_CUSTOM_IN_PLACE /*{ENCODED_INT: 7}*/:
