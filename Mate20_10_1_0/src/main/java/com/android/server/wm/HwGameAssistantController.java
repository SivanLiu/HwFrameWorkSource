...
public final class HwGameAssistantController {
    ...
    private IHwActivityNotifierEx mActivityNotifierEx = new IHwActivityNotifierEx() {
        ...
        public void call(Bundle extras) {
            ...
            bundle.putInt("pid", extras.getInt("toPid"));
    ...
    private SynchronousUserSwitchObserver mUserSwitchObserver = new SynchronousUserSwitchObserver() {
        ...
        public void onUserSwitching(int newUserId) throws RemoteException {
            ...
            int unused = HwGameAssistantController.this.mCurrentUserId = newUserId;
        }
    };
                ...
                switch (msg.what) {
                    ...
                    case 104:
                        if (msg.obj instanceof Bundle) {
                            ...
                            HwGameAssistantController.this.handlePackageRemovedOrDataCleared(bundle3.getInt(PermConst.USER_ID), bundle3.getString("packageName"));
                            return;
                        }
                        return;
                }
    ...
    /* access modifiers changed from: private */
    public void updateForegroundActivityStateEx(int pid, int uid, String packageName, int windowingMode) {
    ...
    /* access modifiers changed from: private */
    public void handleForegroundActivityChangedEx() {
        int event = 0;
    ...
    public void onPackageRemovedOrDataCleared(Intent intent) {
        if (intent != null && intent.getData() != null) {
            ...
            Bundle bundle = new Bundle();
            bundle.putInt(PermConst.USER_ID, userId);
            bundle.putString("packageName", packageName);
