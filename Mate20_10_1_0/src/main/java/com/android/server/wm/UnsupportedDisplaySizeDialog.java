...
public class UnsupportedDisplaySizeDialog {
    ...
    public UnsupportedDisplaySizeDialog(AppWarnings manager, Context context, ApplicationInfo appInfo) {
        ...
        this.mDialog = new AlertDialog.Builder(context).setPositiveButton(17039370, (DialogInterface.OnClickListener) null).setMessage(context.getString(17041394, appInfo.loadSafeLabel(context.getPackageManager(), 500.0f, 5))).setView(17367337).create();
        this.mDialog.create();
