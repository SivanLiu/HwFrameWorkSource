...
class PinnedStackController {
    ...
    public class PinnedStackControllerCallback extends IPinnedStackController.Stub {
        ...
        public void setIsMinimized(boolean isMinimized) {
            PinnedStackController.this.mHandler.post(new Runnable(isMinimized) {
                ...
                public final void run() {
                    PinnedStackControllerCallback.this.lambda$setIsMinimized$0$PinnedStackController$PinnedStackControllerCallback(this.f$1);
                }
            });
        }
        ...
        public void setMinEdgeSize(int minEdgeSize) {
            PinnedStackController.this.mHandler.post(new Runnable(minEdgeSize) {
                ...
                public final void run() {
                    PinnedStackControllerCallback.this.lambda$setMinEdgeSize$1$PinnedStackController$PinnedStackControllerCallback(this.f$1);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$setMinEdgeSize$1$PinnedStackController$PinnedStackControllerCallback(int minEdgeSize) {
            ...
            int unused = pinnedStackController.mCurrentMinSize = Math.max(pinnedStackController.mDefaultMinSize, minEdgeSize);
        }
    ...
    private void reloadResources() {
        ...
        this.mDefaultMinSize = res.getDimensionPixelSize(17105122);
        this.mCurrentMinSize = this.mDefaultMinSize;
        this.mDefaultAspectRatio = res.getFloat(17105066);
        String screenEdgeInsetsDpString = res.getString(17039827);
