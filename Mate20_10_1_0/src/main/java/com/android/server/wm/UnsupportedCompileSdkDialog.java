...
public class UnsupportedCompileSdkDialog {
    ...
    public UnsupportedCompileSdkDialog(AppWarnings manager, Context context, ApplicationInfo appInfo) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(context).setPositiveButton(17039370, (DialogInterface.OnClickListener) null).setMessage(context.getString(17041392, appInfo.loadSafeLabel(context.getPackageManager(), 500.0f, 5))).setView(17367336);
        Intent installerIntent = AppInstallerUtil.createIntent(context, appInfo.packageName);
        if (installerIntent != null) {
            builder.setNeutralButton(17041391, new DialogInterface.OnClickListener(context, installerIntent) {
        ...
        CheckBox alwaysShow = (CheckBox) this.mDialog.findViewById(16908762);
