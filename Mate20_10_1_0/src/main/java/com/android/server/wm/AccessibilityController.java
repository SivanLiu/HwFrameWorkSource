...
final class AccessibilityController {
                ...
                if (!HwPCUtils.enabledInPad() || !HwPCUtils.isPcCastModeInServer() || DisplayMagnifier.this.mService.mRoot == null || DisplayMagnifier.this.mService.mRoot.getDisplayContent(HwPCUtils.getPCDisplayID()) != null) {
                    ...
                    DisplayMagnifier.this.mDisplayContent.forAllWindows((Consumer<WindowState>) new Consumer(outWindows) {
                        ...
                        public final void accept(Object obj) {
                            MagnifiedViewport.this.lambda$populateWindowsOnScreenLocked$0$AccessibilityController$DisplayMagnifier$MagnifiedViewport(this.f$1, (WindowState) obj);
                        }
                    }, false);
                    return;
                }
    ...
    public static final class WindowsForAccessibilityObserver {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:59:0x0129, code lost:
            r19.mCallback.onWindowsForAccessibilityChanged(r0);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:60:0x012e, code lost:
            clearAndRecycleWindows(r0);
         */
        ...
        private void populateVisibleWindowsOnScreenLocked(SparseArray<WindowState> outWindows) {
            ...
            if (!HwPCUtils.enabledInPad() || !HwPCUtils.isPcCastModeInServer() || this.mService.mRoot == null || (dc = this.mService.mRoot.getDisplayContent(HwPCUtils.getPCDisplayID())) != null) {
                ...
                dc.forAllWindows((Consumer<WindowState>) new Consumer(outWindows) {
                    ...
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                        WindowsForAccessibilityObserver.this.lambda$populateVisibleWindowsOnScreenLocked$0$AccessibilityController$WindowsForAccessibilityObserver(this.f$1, (WindowState) obj);
                    }
                }, false);
                this.mService.mRoot.forAllWindows((Consumer<WindowState>) new Consumer(outWindows) {
                    ...
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                        WindowsForAccessibilityObserver.this.lambda$populateVisibleWindowsOnScreenLocked$1$AccessibilityController$WindowsForAccessibilityObserver(this.f$1, (WindowState) obj);
                    }
                }, false);
                return;
            }
