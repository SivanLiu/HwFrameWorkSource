...
class WindowSurfacePlacer {
    ...
    private void performSurfacePlacementLoop() {
        ...
        } else if ((!HwFoldScreenState.isFoldScreenDevice() || !CoordinationModeUtils.getInstance(this.mService.mContext).isExitingCoordinationMode() || !this.mService.isKeyguardLocked()) && !this.mService.getDefaultDisplayContentLocked().mWaitingForConfig && this.mService.mDisplayReady) {
