...
public class HwRogEx implements IHwRogEx {
    ...
    private static final int OLD_DEFAULT_LCD_DENSITY = 480;
    ...
    private boolean isDensityChanged() {
        if (SystemProperties.get("ro.build.product", "").equals("ELS")) {
    ...
    private void initRogMode(WindowManagerService wm, Context context) {
        if (wm != null) {
            ...
            if (productName.equals("TAH") && isFoldableScreen) {
