...
public class ImmersiveModeConfirmation {
    ...
    public FrameLayout.LayoutParams getBubbleLayoutParams() {
        return new FrameLayout.LayoutParams(this.mContext.getResources().getDimensionPixelSize(17105208), -2, 49);
    }
    ...
    private class ClingWindowView extends FrameLayout {
        ...
        public void onAttachedToWindow() {
            ...
            ((Button) this.mClingLayout.findViewById(16909217)).setOnClickListener(new OnClickListener() {
            ...
            if (ActivityManager.isHighEndGfx()) {
                ...
                postOnAnimation(new Runnable() {
                    ...
                    public void run() {
                        ...
                        ValueAnimator unused = ClingWindowView.this.mColorAnim = ValueAnimator.ofObject(new ArgbEvaluator(), 0, Integer.valueOf((int) ClingWindowView.BGCOLOR));
