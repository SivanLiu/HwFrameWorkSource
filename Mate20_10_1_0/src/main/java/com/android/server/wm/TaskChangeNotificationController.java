...
public class TaskChangeNotificationController {
    ...
    public final TaskStackConsumer mNotifyActivityDismissingDockedStack = $$Lambda$TaskChangeNotificationController$0m_qN9QkcgkoWun2Biw8le4l1Y.INSTANCE;
    /* access modifiers changed from: private */
    public final TaskStackConsumer mNotifyActivityForcedResizable = $$Lambda$TaskChangeNotificationController$byMDuIFUN4cQ1lT9jVjMwLhaLDw.INSTANCE;
    /* access modifiers changed from: private */
    public final TaskStackConsumer mNotifyActivityLaunchOnSecondaryDisplayFailed = $$Lambda$TaskChangeNotificationController$yaW9HlZsz3L55CTQ4b7y33IGo94.INSTANCE;
    /* access modifiers changed from: private */
    public final TaskStackConsumer mNotifyActivityLaunchOnSecondaryDisplayRerouted = $$Lambda$TaskChangeNotificationController$wuBjs4dj7gB_MI4dIdt2gV2Osus.INSTANCE;
    /* access modifiers changed from: private */
    public final TaskStackConsumer mNotifyActivityPinned = $$Lambda$TaskChangeNotificationController$ncM_yje7m7HuiJvorBIH_C8Ou4.INSTANCE;
    /* access modifiers changed from: private */
    public final TaskStackConsumer mNotifyActivityRequestedOrientationChanged = $$Lambda$TaskChangeNotificationController$MS67FdGix7tWO0Od9imcaKVXL7I.INSTANCE;
    /* access modifiers changed from: private */
    public final TaskStackConsumer mNotifyActivityUnpinned = $$Lambda$TaskChangeNotificationController$qONfw3ssOxjb_iMuO2oMzCbXfrg.INSTANCE;
    /* access modifiers changed from: private */
    public final TaskStackConsumer mNotifyBackPressedOnTaskRoot = $$Lambda$TaskChangeNotificationController$SByuGj5tpcCpjTH9lf5zHHv2gNM.INSTANCE;
    /* access modifiers changed from: private */
    public final TaskStackConsumer mNotifyPinnedActivityRestartAttempt = $$Lambda$TaskChangeNotificationController$9ngbiJ2r3x2ASHwN59tUFO22BQ.INSTANCE;
    /* access modifiers changed from: private */
    public final TaskStackConsumer mNotifyPinnedStackAnimationEnded = $$Lambda$TaskChangeNotificationController$k0FXXCHcWJhmtm6Kruo6nGeXI.INSTANCE;
    /* access modifiers changed from: private */
    public final TaskStackConsumer mNotifyPinnedStackAnimationStarted = $$Lambda$TaskChangeNotificationController$M2NSB3SSVJR2Tu4vihNfsIL31s4.INSTANCE;
    /* access modifiers changed from: private */
    public final TaskStackConsumer mNotifyTaskCreated = $$Lambda$TaskChangeNotificationController$1ziXgnyLi0gQjqMGJAbSzs0dmE.INSTANCE;
    /* access modifiers changed from: private */
    public final TaskStackConsumer mNotifyTaskDescriptionChanged = $$Lambda$TaskChangeNotificationController$Ge3jFevRwpndz6qRSLDXODq2VjE.INSTANCE;
    /* access modifiers changed from: private */
    public final TaskStackConsumer mNotifyTaskDisplayChanged = $$Lambda$TaskChangeNotificationController$cFUeUwnRjuOQKcg2c4PnDS0ImTw.INSTANCE;
    /* access modifiers changed from: private */
    public final TaskStackConsumer mNotifyTaskMovedToFront = $$Lambda$TaskChangeNotificationController$ZLPZtiEvD_F4WUgH7BD4KPpdAWM.INSTANCE;
    /* access modifiers changed from: private */
    public final TaskStackConsumer mNotifyTaskProfileLocked = $$Lambda$TaskChangeNotificationController$Dvvt1gNNfFRVEKlSCdL_9VnilUE.INSTANCE;
    /* access modifiers changed from: private */
    public final TaskStackConsumer mNotifyTaskRemovalStarted = $$Lambda$TaskChangeNotificationController$NLoKy9SbVr1EJpEjznsKi7yAlpg.INSTANCE;
    /* access modifiers changed from: private */
    public final TaskStackConsumer mNotifyTaskRemoved = $$Lambda$TaskChangeNotificationController$kss8MGli3T9b_YQDzR2cB843y8.INSTANCE;
    /* access modifiers changed from: private */
    public final TaskStackConsumer mNotifyTaskSnapshotChanged = $$Lambda$TaskChangeNotificationController$UexNbaqPy0mc3VxTw2coCctHho8.INSTANCE;
    /* access modifiers changed from: private */
    public final TaskStackConsumer mNotifyTaskStackChanged = $$Lambda$TaskChangeNotificationController$SAbrujQOZNUflKs1FAg2mBnjx3A.INSTANCE;
    /* access modifiers changed from: private */
    public final TaskStackConsumer mOnSizeCompatModeActivityChanged = $$Lambda$TaskChangeNotificationController$sS6OHbZtuWHjzmkm8bleSWZWFqA.INSTANCE;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 5:
                    ...
                    return;
                case TaskChangeNotificationController.NOTIFY_FORCED_RESIZABLE_MSG /*{ENCODED_INT: 6}*/:
                    ...
                    return;
                case TaskChangeNotificationController.NOTIFY_ACTIVITY_DISMISSING_DOCKED_STACK_MSG /*{ENCODED_INT: 7}*/:
                    ...
                    return;
                case TaskChangeNotificationController.NOTIFY_TASK_ADDED_LISTENERS_MSG /*{ENCODED_INT: 8}*/:
                    ...
                    return;
                case TaskChangeNotificationController.NOTIFY_TASK_REMOVED_LISTENERS_MSG /*{ENCODED_INT: 9}*/:
                    ...
                    return;
                case TaskChangeNotificationController.NOTIFY_TASK_MOVED_TO_FRONT_LISTENERS_MSG /*{ENCODED_INT: 10}*/:
                ...
                case 11:
                    ...
                    return;
                case TaskChangeNotificationController.NOTIFY_ACTIVITY_REQUESTED_ORIENTATION_CHANGED_LISTENERS /*{ENCODED_INT: 12}*/:
                    ...
                    return;
                case TaskChangeNotificationController.NOTIFY_TASK_REMOVAL_STARTED_LISTENERS /*{ENCODED_INT: 13}*/:
                ...
                case 19:
                    ...
                    return;
                case TaskChangeNotificationController.NOTIFY_SIZE_COMPAT_MODE_ACTIVITY_CHANGED_MSG /*{ENCODED_INT: 20}*/:
                    ...
                    return;
                case TaskChangeNotificationController.NOTIFY_BACK_PRESSED_ON_TASK_ROOT /*{ENCODED_INT: 21}*/:
    ...
    public void notifyBackPressedOnTaskRoot(TaskInfo taskInfo) {
        Message msg = this.mHandler.obtainMessage(NOTIFY_BACK_PRESSED_ON_TASK_ROOT, taskInfo);
