            ...
            if (task != null && mainWindow != null && (remoteAnimationAdapterWrapper = this.mAdapter) != null) {
                if (remoteAnimationAdapterWrapper.mCapturedFinishCallback != null) {
                    if (this.mAdapter.mCapturedLeash != null) {
                        ...
                        Point access$500 = this.mAdapter.mPosition;
                        Rect access$600 = this.mAdapter.mStackBounds;
                        ...
                        this.mTarget = new RemoteAnimationTarget(i, mode, surfaceControl2, z, rect, insets, prefixOrderIndex, access$500, access$600, windowConfiguration, false, surfaceControl, this.mStartBounds);
                        return this.mTarget;
                    }
                }
            }
