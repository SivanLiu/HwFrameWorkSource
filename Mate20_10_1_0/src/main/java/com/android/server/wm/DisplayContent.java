...
public class DisplayContent extends AbsDisplayContent implements WindowManagerPolicy.DisplayContentInfo {
    ...
    public DisplayContent(Display display, WindowManagerService service, ActivityDisplay activityDisplay) {
        ...
        if (service.mRoot.getDisplayContent(display.getDisplayId()) == null) {
            ...
            super.addChild((WindowContainer) this.mBelowAppWindowsContainers, (Comparator) null);
            super.addChild((WindowContainer) this.mTaskStackContainers, (Comparator) null);
            super.addChild((WindowContainer) this.mAboveAppWindowsContainers, (Comparator) null);
            super.addChild((WindowContainer) this.mImeWindowsContainers, (Comparator) null);
    ...
    public boolean updateRotationUnchecked(boolean forceUpdate) {
        ...
        if (!HwPCUtils.enabledInPad() || (!HwPCUtils.isPcCastModeInServer() && (this.isDefaultDisplay || !"local:100000".equals(this.mDisplayInfo.uniqueId)))) {
            rotation = this.mDisplayRotation.rotationForOrientation(lastOrientation, oldRotation);
            if (HwMwUtils.ENABLED) {
                if (HwMwUtils.performPolicy(61, new Object[]{Integer.valueOf(rotation)}).getBoolean("BUNDLE_IS_ROTATION_180", false)) {
                    return false;
                }
            }
        } else {
    ...
    @Override // com.android.server.wm.WindowContainer, com.android.server.wm.AbsDisplayContent, com.android.server.wm.ConfigurationContainer
    ...
    public Task findTaskForResizePoint(int x, int y) {
        ...
        if (this.mTmpTaskForResizePointSearchResult.searchDone && this.mTmpTaskForResizePointSearchResult.taskForResize != null && this.mTmpTaskForResizePointSearchResult.taskForResize.inFreeformWindowingMode()) {
            for (int tokenNdx = this.mAboveAppWindowsContainers.getChildCount() - 1; tokenNdx >= 0; tokenNdx--) {
                WindowToken token = (WindowToken) this.mAboveAppWindowsContainers.getChildAt(tokenNdx);
                if (token != null) {
                    for (int winNdx = token.getChildCount() - 1; winNdx >= 0; winNdx--) {
                        WindowState window = (WindowState) token.getChildAt(winNdx);
                        if (window != null && window.isVisible() && window.getFrameLw().contains(x, y)) {
                            return null;
                        }
                    }
                    continue;
        ...
        if (imeVisible && dockVisible) {
            if (!imeOnTop && !imeOnBottom) {
                ...
                while (i4 >= 0) {
                    ...
                    if (stack.isVisible() && imeOnBottom && (stack.inSplitScreenWindowingMode() || stack.inHwSplitScreenWindowingMode())) {
    ...
    public /* synthetic */ boolean lambda$getTouchableWinAtPointLocked$13$DisplayContent(int x, int y, WindowState w) {
        ...
        if (!this.mTmpRect.contains(x, y) || this.mHwDisplayCotentEx.isPointOutsideMagicWindow(w, x, y)) {
            return false;
        }
    ...
    public boolean updateFocusedWindowLocked(int mode, boolean updateInputWindows, int topFocusedDisplayId) {
        ...
        if (!this.mWmService.mPerDisplayFocusEnabled) {
            ...
            if (hasOtherFocusedDisplay) {
                this.mHwDisplayCotentEx.focusWinZrHung(focusedContent.mCurrentFocus, focusedContent.mFocusedApp, focusedContent.getDisplayId());
            } else {
                this.mHwDisplayCotentEx.focusWinZrHung(this.mCurrentFocus, this.mFocusedApp, getDisplayId());
            }
        }
    ...
    private void updateSideScreenRoundCorner(WindowState win) {
        ...
        if (win == null) {
            ...
            if (focusedWindow != null && this.mInputMethodTarget != null && (focusedWindowTitle = focusedWindow.getAttrs().getTitle()) != null && focusedWindowTitle.equals(this.mInputMethodTarget.getAttrs().getTitle())) {
                Slog.d(TAG, "setInputMethodWindowLocked call notchControlFilletForSideScreen for inputMethod hide case");
                this.mWmService.getPolicy().notchControlFilletForSideScreen(this.mInputMethodTarget, true);
            }
            ...
            Slog.d(TAG, "setInputMethodWindowLocked call notchControlFilletForSideScreen for expand inputMethod show case");
            this.mWmService.getPolicy().notchControlFilletForSideScreen(win, true);
        }
    }
    ...
    public boolean checkWaitingForWindows() {
        ...
        boolean wallpaperEnabled = this.mWmService.mContext.getResources().getBoolean(17891450) && this.mWmService.mContext.getResources().getBoolean(17891393) && !this.mWmService.mOnlyCore;
    ...
    protected final class TaskStackContainers extends DisplayChildWindowContainer<TaskStack> {
        ...
        public void removeChild(TaskStack stack) {
            super.removeChild((WindowContainer) stack);
            removeStackReferenceIfNeeded(stack);
        }
        ...
        public void positionChildAt(int position, TaskStack child, boolean includingParents) {
            ...
            super.positionChildAt(this.mChildren.indexOf(child), (WindowContainer) child, false);
        }
            ...
            for (int state = 0; state <= 2; state++) {
                for (int i = 0; i < this.mChildren.size(); i++) {
                    ...
                    if ((state != 0 || s.isActivityTypeHome()) && ((state != 1 || (!s.isActivityTypeHome() && !notFreeform && !s.inHwFreeFormMoveBackState())) && (state != 2 || s.isAlwaysOnTop() || s.inHwFreeFormMoveBackState()))) {
                        ...
                        if ((s.inSplitScreenWindowingMode() || s.inHwSplitScreenWindowingMode() || s.inHwMagicWindowingMode()) && (surfaceControl = this.mSplitScreenDividerAnchor) != null) {
    ...
    public class NonAppWindowContainers extends DisplayChildWindowContainer<WindowToken> {
        ...
        private final Comparator<WindowToken> mWindowComparator = new Comparator() {
            ...
            public final int compare(Object obj, Object obj2) {
                return NonAppWindowContainers.this.lambda$new$0$DisplayContent$NonAppWindowContainers((WindowToken) obj, (WindowToken) obj2);
            }
        };
