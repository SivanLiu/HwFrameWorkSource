...
public class WindowProcessController extends ConfigurationContainer<ConfigurationContainer> implements ConfigurationContainerListener {
    ...
    public boolean updateTopResumingActivityInProcessIfNeeded(ActivityRecord activity) {
        ...
        if (display != topDisplay || !WindowConfiguration.isIncompatibleWindowingMode(this.mPreQTopResumedActivity.getWindowingMode(), activity.getWindowingMode())) {
            if (canUpdate) {
    ...
    @Override // com.android.server.wm.ConfigurationContainerListener, com.android.server.wm.ConfigurationContainer
