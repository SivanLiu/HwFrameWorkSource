...
public class DisplayRoundCorner {
    ...
    public static synchronized DisplayRoundCorner getInstance(WindowManagerService service) {
        DisplayRoundCorner displayRoundCorner;
        synchronized (DisplayRoundCorner.class) {
            if (sInstance == null) {
                sInstance = new DisplayRoundCorner(service);
            }
    ...
    public void setScreenSize(int width, int height) {
        if (width != this.mWidth || height != this.mHeight) {
            this.mWidth = width < height ? width : height;
            this.mHeight = width < height ? height : width;
