...
public final class InputMonitor {
    ...
    public boolean mApplyImmediately;
    /* access modifiers changed from: private */
        ...
        public void run() {
            synchronized (InputMonitor.this.mService.mGlobalLock) {
                try {
                    ...
                    boolean unused = InputMonitor.this.mUpdateInputWindowsPending = false;
                    boolean unused2 = InputMonitor.this.mUpdateInputWindowsNeeded = false;
    ...
    public final class UpdateInputForAllWindowsConsumer implements Consumer<WindowState> {
        ...
        public void updateInputWindows(boolean inDrag2) {
            ...
            boolean unused = InputMonitor.this.mDisableWallpaperTouchEvents = false;
            this.inDrag = inDrag2;
        ...
        public void accept(WindowState w) {
            ...
            if (inputChannel != null && inputWindowHandle != null && !w.mRemoved && !w.cantReceiveTouchInput()) {
                ...
                if ((privateFlags & 2048) != 0) {
                    boolean unused = InputMonitor.this.mDisableWallpaperTouchEvents = true;
                }
