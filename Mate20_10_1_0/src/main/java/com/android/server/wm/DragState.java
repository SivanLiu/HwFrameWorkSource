...
public class DragState {
    ...
    public void closeLocked() {
        ...
        if (this.mSurfaceControl != null) {
            if (this.mIsDropSuccessAnimEnabled) {
                Slog.i("WindowManager", "remove hw multi window drag surface");
                this.mDragDropController.sendTimeoutMessageDelayed(3, this.mSurfaceControl, REMOVE_HW_MULTI_WINDOW_DRAG_SURFACE_TIME_OUT_MS);
            } else if (HwPCUtils.isInSinkWindowsCastMode()) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:32:0x00c6, code lost:
        if (r9 != r13.mSession.mPid) goto L_0x00c8;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:41:0x00ee, code lost:
        if (r3 == r13.mSession.mPid) goto L_0x00f1;
     */
    ...
    public void notifyDropLocked(float x, float y) {
        ...
        if (this.mAnimator == null) {
            ...
            if (touchedWin.inMultiWindowMode() && HwPCUtils.isInSinkWindowsCastMode()) {
