...
public class RecentsAnimationController implements IBinder.DeathRecipient {
    ...
    private final IRecentsAnimationController mController = new IRecentsAnimationController.Stub() {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:12:0x0048, code lost:
            if (com.android.server.wm.utils.HwDisplaySizeUtil.hasSideInScreen() == false) goto L_0x006e;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:13:0x004a, code lost:
            if (r6 == false) goto L_0x006e;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:15:0x0056, code lost:
            if (com.android.server.wm.RecentsAnimationController.access$100(r5.this$0).getWallpaperWindowState() == null) goto L_0x006e;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:16:0x0058, code lost:
            com.android.server.wm.RecentsAnimationController.access$100(r5.this$0).clearAddValueState();
            com.android.server.wm.RecentsAnimationController.access$100(r5.this$0).getWallpaperWindowState().destroyInsetSurfaceImmediately(true);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:17:0x006e, code lost:
            r2 = com.android.server.wm.RecentsAnimationController.access$600(r5.this$0);
         */
    ...
    public class TaskAnimationAdapter implements AnimationAdapter {
        ...
        TaskAnimationAdapter(Task task, boolean isRecentTaskInvisible) {
            ...
            if (this.mTask.inHwMultiStackWindowingMode() && (lazyMode = RecentsAnimationController.this.mService.getLazyMode()) != 0) {
                this.mPosition = RecentsAnimationController.this.mService.updateLazyModePoint(lazyMode, this.mPosition);
            }
