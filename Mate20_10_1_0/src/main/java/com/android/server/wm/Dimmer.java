...
class Dimmer {
    ...
    class DimState {
        ...
        DimState(SurfaceControl dimLayer) {
            ...
            this.mSurfaceAnimator = new SurfaceAnimator(dimAnimatable, new Runnable(dimAnimatable) {
                ...
                private final /* synthetic */ DimAnimatable f$1;
                ...
                public final void run() {
                    DimState.this.lambda$new$0$Dimmer$DimState(this.f$1);
                }
    ...
    public boolean updateDims(SurfaceControl.Transaction t, Rect bounds) {
        ...
        if (!(windowContainer2 == null || !windowContainer2.inHwFreeFormWindowingMode() || this.mHost.mWmService == null || this.mHost.getDisplayContent() == null || this.mHost.getDisplayContent().getDisplayId() != 0)) {
            if (this.mHost.mWmService.getLazyMode() != 0) {
                float scale = this.mHost.getLazyScale();
                t.setMatrix(this.mDimState.mDimLayer, scale, 0.0f, 0.0f, scale);
            } else if (this.mHost.mWmService.isInSubFoldScaleMode()) {
                t.setMatrix(this.mDimState.mDimLayer, this.mHost.mWmService.mSubFoldModeScale, 0.0f, 0.0f, this.mHost.mWmService.mSubFoldModeScale);
            } else {
                t.setMatrix(this.mDimState.mDimLayer, 1.0f, 0.0f, 0.0f, 1.0f);
            }
        }
