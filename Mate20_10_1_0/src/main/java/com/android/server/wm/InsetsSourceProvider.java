...
class InsetsSourceProvider {
    ...
    /* access modifiers changed from: private */
    public WindowState mControllingWin;
    ...
    public class ControlAdapter implements AnimationAdapter {
        ...
        public void onAnimationCancelled(SurfaceControl animationLeash) {
            if (InsetsSourceProvider.this.mAdapter == this) {
                ...
                InsetsSourceControl unused = InsetsSourceProvider.this.mControl = null;
                WindowState unused2 = InsetsSourceProvider.this.mControllingWin = null;
                ControlAdapter unused3 = InsetsSourceProvider.this.mAdapter = null;
            }
        }
