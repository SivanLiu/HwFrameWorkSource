...
public class ActivityTaskManagerService extends IActivityTaskManager.Stub implements IHwActivityTaskManagerInner {
    ...
    private int mViSessionId = FREEZE_DELAY;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:43:0x00f1 A[Catch:{ all -> 0x0163 }] */
    /* JADX WARNING: Removed duplicated region for block: B:44:0x010a A[Catch:{ all -> 0x0163 }] */
    /* JADX WARNING: Removed duplicated region for block: B:47:0x012a A[Catch:{ all -> 0x0163 }] */
    /* JADX WARNING: Removed duplicated region for block: B:48:0x0139 A[Catch:{ all -> 0x0163 }] */
    /* JADX WARNING: Removed duplicated region for block: B:51:0x014c A[Catch:{ all -> 0x0163 }] */
    ...
    public IBinder requestStartActivityPermissionToken(IBinder delegatorToken) {
        ...
        if (UserHandle.getAppId(callingUid) == FREEZE_DELAY) {
            ...
            try {
                ...
                if (resultTo != null) {
                    ...
                    if (sourceRecord == null) {
                        ...
                        if (UserHandle.getAppId(sourceRecord.app.mUid) != FREEZE_DELAY) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:111:0x01a9  */
    /* JADX WARNING: Removed duplicated region for block: B:58:0x00bc A[Catch:{ all -> 0x00b2 }] */
    /* JADX WARNING: Removed duplicated region for block: B:61:0x00e4 A[Catch:{ all -> 0x00b2 }] */
    /* JADX WARNING: Removed duplicated region for block: B:77:0x010c A[Catch:{ all -> 0x00b2 }] */
    /* JADX WARNING: Removed duplicated region for block: B:78:0x0115 A[Catch:{ all -> 0x00b2 }] */
                        ...
                        try {
                            if (r.inSplitScreenPrimaryWindowingMode()) {
                                ...
                                if (this.mShouldFreeze) {
                                    ...
                                    this.mH.sendMessageDelayed(this.mH.obtainMessage(STOP_FREEZE_SCREEN), 1000);
                                ...
                                if (finishTask != 2) {
                                    if (!finishWithRootActivity || r != rootR) {
                                        ...
                                        if (tr.inHwMagicWindowingMode()) {
                                            if (HwMwUtils.performPolicy(28, new Object[]{token}).getBoolean("BUNDLE_RESULT_ONBACKPRESSED", false)) {
                                                Binder.restoreCallingIdentity(origId);
                                                WindowManagerService.resetPriorityAfterLockedSection();
                                                return false;
                                            }
    ...
    public final void activityDestroyed(IBinder token) {
        ...
        if (this.mShouldFreeze && isPrimary) {
            ...
            try {
                Slog.i("ActivityTaskManager", "stopFreezingScreen");
    ...
    public boolean isSameApp(int callingUid, String packageName) {
        if (callingUid == 0 || callingUid == FREEZE_DELAY) {
            return true;
        }
        if (packageName == null) {
            return false;
                    ...
                    if (task.isActivityTypeStandardOrUndefined()) {
                        ...
                        try {
                            ...
                            if (HwMwUtils.ENABLED) {
                                HwMwUtils.performPolicy(13, new Object[]{false, true, 3, Integer.valueOf(taskId), null});
                            }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x005f, code lost:
        ...
        r2.putBundle(com.android.server.wm.ActivityTaskManagerInternal.ASSIST_KEY_DATA, r0.extras);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:37:0x00c6, code lost:
        ...
        r9.mInternal.closeSystemDialogs("assist");
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:42:0x00a9, code lost:
        if (android.util.HwMwUtils.performPolicy(16, new java.lang.Object[]{java.lang.Integer.valueOf(r4.mStackId)}).getBoolean("RESULT_HWMULTISTACK", false) == false) goto L_0x00ab;
     */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r6v5, resolved type: com.android.server.wm.RootActivityContainer */
    /* JADX WARN: Multi-variable type inference failed */
                        ...
                        if (!secondaryTask2.isActivityTypeRecents()) {
                            ...
                            while (i < size) {
                                if (primaryTasks.get(i).taskId == secondaryTask2.taskId) {
                                    ...
                                    z2 = z3;
                                    secondaryTask = secondaryTask2;
                                    primaryTasks.get(i).reparent(secondarySplitScreenStack, true, 1, true, true, "swapDockedAndFullscreenStack - pss->sss");
                                }
                                i++;
                                z3 = z2;
                                r13 = z;
                            ...
                            this.mRootActivityContainer.ensureActivitiesVisible(null, r13, r13, z3);
                            this.mRootActivityContainer.resumeFocusedStacksTopActivities();
                            this.mWindowManager.stopFreezingScreen();
                            Binder.restoreCallingIdentity(ident);
                            WindowManagerService.resetPriorityAfterLockedSection();
        ...
        synchronized (this.mGlobalLock) {
            try {
                ...
                if (values == null && this.mWindowManager != null) {
                    ...
                    if (this.mVrMananger.isVRDeviceConnected() && this.mVrMananger.isVirtualScreenMode() && this.mVrMananger.isVrVirtualDisplay(displayId)) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x0027, code lost:
        r7 = new java.lang.String[(r28.length - r29)];
        java.lang.System.arraycopy(r28, r29, r7, 0, r28.length - r29);
        r1 = false;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x0042, code lost:
        r5 = r0.get(r6);
        android.util.Flog.i(101, "dumpActivity " + r5);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:32:0x00a6, code lost:
        com.android.server.wm.WindowManagerService.resetPriorityAfterLockedSection();
        dumpActivity("  ", r25, r26, r0.get(r6), r7, r30);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:33:0x00cf, code lost:
        if ((android.os.SystemClock.uptimeMillis() - r16) <= 1000) goto L_0x00db;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:34:0x00d1, code lost:
        android.util.Flog.e(101, "dumpActivity timeout, skip left");
     */
    ...
    public boolean dumpActivity(FileDescriptor fd, PrintWriter pw, String name, String[] args, int opti, boolean dumpAll, boolean dumpVisibleStacksOnly, boolean dumpFocusedStackOnly) {
        ...
        synchronized (activityTaskManagerService.mGlobalLock) {
            try {
                WindowManagerService.boostPriorityForLockedSection();
                try {
                    ArrayList<ActivityRecord> activities = activityTaskManagerService.mRootActivityContainer.getDumpActivities(name, dumpVisibleStacksOnly, dumpFocusedStackOnly);
                } catch (Throwable th) {
                    th = th;
                    WindowManagerService.resetPriorityAfterLockedSection();
                    throw th;
    ...
    public void setResumedActivityUncheckLocked(ActivityRecord r, String reason) {
        ...
        this.mHwATMSEx.setResumedActivityUncheckLocked(this.mLastResumedActivity, r);
        TaskRecord task = r.getTaskRecord();
    ...
    public Intent getSecondaryHomeIntent(String preferredPackage) {
        ...
        if (preferredPackage == null || useSystemProvidedLauncher) {
            intent.setComponent(ComponentName.unflattenFromString(this.mContext.getResources().getString(17039887)));
        } else {
    ...
    final class LocalService extends ActivityTaskManagerInternal {
                ...
                try {
                    ...
                    if (AppGlobals.getPackageManager().hasSystemUidErrors()) {
                        ...
                        ActivityTaskManagerService.this.mUiHandler.post(new Runnable() {
                            ...
                            public final void run() {
                                LocalService.this.lambda$showSystemReadyErrorDialogsIfNeeded$0$ActivityTaskManagerService$LocalService();
                            }
                        });
                    }
                } catch (RemoteException e) {
                ...
                try {
                    if (!Build.isBuildConsistent()) {
                        ...
                        ActivityTaskManagerService.this.mUiHandler.post(new Runnable() {
                            ...
                            public final void run() {
                                LocalService.this.lambda$showSystemReadyErrorDialogsIfNeeded$1$ActivityTaskManagerService$LocalService();
                            }
                        });
                    }
                } finally {
        ...
        public /* synthetic */ void lambda$showSystemReadyErrorDialogsIfNeeded$0$ActivityTaskManagerService$LocalService() {
            if (ActivityTaskManagerService.this.mShowDialogs) {
                ...
                d.setMessage(ActivityTaskManagerService.this.mUiContext.getText(17041350));
        ...
        public /* synthetic */ void lambda$showSystemReadyErrorDialogsIfNeeded$1$ActivityTaskManagerService$LocalService() {
            if (ActivityTaskManagerService.this.mShowDialogs) {
                ...
                d.setCancelable(false);
                d.setTitle(ActivityTaskManagerService.this.mUiContext.getText(17039593));
                d.setMessage(ActivityTaskManagerService.this.mUiContext.getText(17041349));
                d.setButton(-1, ActivityTaskManagerService.this.mUiContext.getText(17039370), ActivityTaskManagerService.this.mUiHandler.obtainMessage(1, d));
                d.show();
            }
        }
                    ...
                    if (ActivityTaskManagerService.this.mFactoryTest == 1) {
                        ...
                        if (ri != null) {
                            ...
                            if ((1 & app.flags) != 0) {
                                ...
                                errorMsg = ActivityTaskManagerService.this.mContext.getResources().getText(17040132);
                            }
                        } else {
                            errorMsg = ActivityTaskManagerService.this.mContext.getResources().getText(17040131);
                        }
                        if (errorMsg == null) {
                            WindowManagerService.resetPriorityAfterLockedSection();
                            return;
                        ...
                        ActivityTaskManagerService.this.mUiHandler.post(new Runnable(errorMsg) {
                            ...
                            public final void run() {
                                LocalService.this.lambda$updateTopComponentForFactoryTest$2$ActivityTaskManagerService$LocalService(this.f$1);
                            }
                        });
                        WindowManagerService.resetPriorityAfterLockedSection();
                    }
    ...
    public class HwInnerActivityTaskManagerService extends IHwActivityTaskManager.Stub {
        ...
        public ActivityInfo getLastResumedActivity() {
            ...
            if (callingUid != ActivityTaskManagerService.FREEZE_DELAY) {
                int callingPid = Binder.getCallingPid();
        ...
        private boolean checkPermissionForHAM() {
            ...
            if (uid == ActivityTaskManagerService.FREEZE_DELAY) {
                return true;
            }
        ...
        public boolean isResizableApp(ActivityInfo activityInfo) {
            ...
            return ActivityTaskManagerService.this.mHwATMSEx.isHwResizableApp(activityInfo.packageName, activityInfo.resizeMode);
        }
    ...
    public void applyUpdateSplitBarPos(int position) {
        this.mHwATMSEx.updateSplitBarPosForIm(position);
    }
}
