...
public class KeyButtonRipple extends Drawable {
    ...
    public boolean isDrawingHardwareGlow;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public final HashSet<Animator> mRunningAnimations = new HashSet<>(0);
    ...
    public KeyButtonRipple(Context ctx, View targetView) {
        this.mMaxWidth = ctx.getResources().getDimensionPixelSize(34472669);
        ...
        this.mAnimatorListener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (KeyButtonRipple.this.mRunningAnimations.isEmpty() && !KeyButtonRipple.this.isPressed) {
                    boolean unused = KeyButtonRipple.this.isVisible = false;
                    boolean unused2 = KeyButtonRipple.this.isDrawingHardwareGlow = false;
