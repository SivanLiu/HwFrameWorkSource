...
public class GnssNetworkConnectivityHandler {
    ...
    /* access modifiers changed from: private */
    public boolean mIsSuplEsConnected = false;
    /* access modifiers changed from: private */
    public boolean mNeedEmergencyApn = false;
    ...
    /* access modifiers changed from: private */
    public boolean isCustSuplSwitch() {
        ...
        return new ConnectivityManager.NetworkCallback() {
            ...
            public void onAvailable(Network network) {
                ...
                if (info != null) {
                    ...
                    Network unused = GnssNetworkConnectivityHandler.this.mNetworkEs = network;
                    if (isConnected) {
                        try {
                            ...
                            if (GnssNetworkConnectivityHandler.this.mNeedEmergencyApn) {
                                ...
                                InetAddress unused2 = GnssNetworkConnectivityHandler.this.mEsuplIpAddress = agpsDataConnectionIpAddr;
                            } else {
                            ...
                            if (agpsDataConnectionIpAddr != null) {
                                ...
                                boolean unused3 = GnssNetworkConnectivityHandler.this.mIsSuplEsConnected = true;
                            }
                        } catch (UnknownHostException e) {
