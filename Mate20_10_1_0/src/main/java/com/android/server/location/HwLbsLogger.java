...
public class HwLbsLogger implements IHwLbsLogger {
    ...
    public void saveSessionRecord(SessionRecord sessionRecord) {
            ...
            switch (msg.what) {
                ...
                case 101:
                    ...
                    if (action.equals(HwLbsLogger.SESSION_START)) {
                        sessionRecord = new SessionRecord(sessionBundle.getLong(HwLbsLogger.BUNDLE_PARAMETER_TIMESTAMP), action, sessionBundle.getString("pkgName"), sessionBundle.getString(HwLbsLogger.BUNDLE_PARAMETER_SESSION_PROVIDER), sessionBundle.getInt("interval"), sessionBundle.getInt(HwLbsLogger.BUNDLE_PARAMETER_SESSION_RECEIVER));
                    } else if (action.equals(HwLbsLogger.SESSION_STOP)) {
                        sessionRecord = new SessionRecord(sessionBundle.getLong(HwLbsLogger.BUNDLE_PARAMETER_TIMESTAMP), action, sessionBundle.getString("pkgName"), sessionBundle.getInt(HwLbsLogger.BUNDLE_PARAMETER_SESSION_RECEIVER));
                    }
