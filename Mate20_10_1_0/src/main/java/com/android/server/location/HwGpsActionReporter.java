...
public class HwGpsActionReporter implements IHwGpsActionReporter {
    ...
    private static final int VALID_TIME_RANGE = SystemProperties.getInt("ro.config.invalid_time", (int) AwareAppAssociate.ASSOC_DECAY_MIN_TIME);
    ...
    private final BroadcastReceiver mInjectedLocationReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            } else if (action.equals("action_inject_location")) {
    ...
    private HwGpsActionReporter(Context context, ILocationManager locationManager) {
        ...
        this.mContext.getContentResolver().registerContentObserver(Settings.Secure.getUriFor("location_providers_allowed"), true, new ContentObserver(null) {
            ...
            public void onChange(boolean selfChange) {
                ...
                ?? access$400 = hwGpsActionReporter2.isGpsProviderSettingOn(hwGpsActionReporter2.mCurrentUserId);
                if (access$400 != HwGpsActionReporter.this.mLastGpsSwitchStatus) {
                    HwGpsActionReporter.this.reportGpsSwitch(access$400 == true ? 1 : 0);
                    int unused = HwGpsActionReporter.this.mLastGpsSwitchStatus = access$400;
                }
    ...
    public void reportGpsSwitch(int gpsSwitchStatus) {
        ...
        if (HWFLOW) {
            LBSLog.i(TAG, false, "reportGpsSwitch: { ACT:%{public}d,RT:%{public}b }", Integer.valueOf(gpsSwitchStatus), Boolean.valueOf(checkResult));
        }
