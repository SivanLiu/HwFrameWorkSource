...
public class ContextHubService extends IContextHubService.Stub {
    ...
    public ContextHubService(Context context) {
        ...
        IContexthub iContexthub = this.mContextHubProxy;
        if (iContexthub == null) {
        ...
        this.mClientManager = new ContextHubClientManager(this.mContext, iContexthub);
        ...
        for (Integer num : this.mContextHubIdToInfoMap.keySet()) {
            ...
            defaultClientMap.put(Integer.valueOf(contextHubId), this.mClientManager.registerClient(this.mContextHubIdToInfoMap.get(Integer.valueOf(contextHubId)), createDefaultClientCallback(contextHubId)));
            try {
    ...
    private IContextHubClientCallback createDefaultClientCallback(final int contextHubId) {
        return new IContextHubClientCallback.Stub() {
            /* class com.android.server.location.ContextHubService.AnonymousClass1 */
    ...
    private IContextHubTransactionCallback createLoadTransactionCallback(final int contextHubId, final NanoAppBinary nanoAppBinary) {
        return new IContextHubTransactionCallback.Stub() {
            /* class com.android.server.location.ContextHubService.AnonymousClass2 */
    ...
    private IContextHubTransactionCallback createUnloadTransactionCallback(final int contextHubId) {
        return new IContextHubTransactionCallback.Stub() {
            /* class com.android.server.location.ContextHubService.AnonymousClass3 */
    ...
    private IContextHubTransactionCallback createQueryTransactionCallback(final int contextHubId) {
        return new IContextHubTransactionCallback.Stub() {
            /* class com.android.server.location.ContextHubService.AnonymousClass4 */
    ...
    public int[] findNanoAppOnHub(int contextHubHandle, NanoAppFilter filter) throws RemoteException {
        ...
        if (filter != null) {
            this.mNanoAppStateManager.foreachNanoAppInstanceInfo(new Consumer(filter, foundInstances) {
                /* class com.android.server.location.$$Lambda$ContextHubService$yrt4Ybb62ufyqsQQMJoTJ2JMw_4 */
                private final /* synthetic */ NanoAppFilter f$0;
                ...
                public final void accept(Object obj) {
                    ContextHubService.lambda$findNanoAppOnHub$0(this.f$0, this.f$1, (NanoAppInstanceInfo) obj);
                }
            });
        }
    ...
    static /* synthetic */ void lambda$findNanoAppOnHub$0(NanoAppFilter filter, ArrayList foundInstances, NanoAppInstanceInfo info) {
    ...
    public IContextHubClient createClient(int contextHubId, IContextHubClientCallback clientCallback) throws RemoteException {
        checkPermissions();
        if (!isValidContextHubId(contextHubId)) {
            throw new IllegalArgumentException("Invalid context hub ID " + contextHubId);
        } else if (clientCallback != null) {
            return this.mClientManager.registerClient(this.mContextHubIdToInfoMap.get(Integer.valueOf(contextHubId)), clientCallback);
        } else {
    ...
    public IContextHubClient createPendingIntentClient(int contextHubId, PendingIntent pendingIntent, long nanoAppId) throws RemoteException {
        checkPermissions();
        if (isValidContextHubId(contextHubId)) {
            return this.mClientManager.registerClient(this.mContextHubIdToInfoMap.get(Integer.valueOf(contextHubId)), pendingIntent, nanoAppId);
        }
        throw new IllegalArgumentException("Invalid context hub ID " + contextHubId);
    }
    ...
    public void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
        if (DumpUtils.checkDumpPermission(this.mContext, TAG, pw)) {
            ...
            pw.println("");
            pw.println("=================== NANOAPPS ====================");
            this.mNanoAppStateManager.foreachNanoAppInstanceInfo(new Consumer(pw) {
                /* class com.android.server.location.$$Lambda$ContextHubService$HPGvKluemttyVfAcSogeXiJyHE */
                ...
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    this.f$0.println((NanoAppInstanceInfo) obj);
                }
            });
        }
    }
