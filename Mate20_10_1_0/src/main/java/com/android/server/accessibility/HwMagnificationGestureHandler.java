...
public final class HwMagnificationGestureHandler extends MagnificationGestureHandler {
    ...
    public HwMagnificationGestureHandler(Context context, MagnificationController magnificationController, boolean detectControlGestures, boolean triggerable, int displayId) {
        super(context, magnificationController, detectControlGestures, triggerable, displayId);
    }
