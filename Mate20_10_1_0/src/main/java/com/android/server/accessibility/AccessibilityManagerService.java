...
public class AccessibilityManagerService extends IAccessibilityManager.Stub implements AbstractAccessibilityServiceConnection.SystemSupport {
    ...
    /* access modifiers changed from: private */
    public boolean mIsScreenReaderEnabled;
    /* access modifiers changed from: private */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x0049, code lost:
        android.util.Slog.e(com.android.server.accessibility.AccessibilityManagerService.LOG_TAG, "Error sending interrupt request to " + r4.get(r0), r2);
     */
    ...
    public void announceNewUserIfNeeded() {
        synchronized (this.mLock) {
            if (getCurrentUserStateLocked().isHandlingAccessibilityEvents()) {
                String message = this.mContext.getString(17041438, ((UserManager) this.mContext.getSystemService("user")).getUserInfo(this.mCurrentUserId).name);
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v8, resolved type: int */
    /* JADX WARN: Multi-variable type inference failed */
    private void notifyAccessibilityButtonClickedLocked(int displayId) {
        ...
        while (i >= 0) {
            if (state.mBoundServices.get(i).mRequestAccessibilityButton) {
                int potentialTargets2 = potentialTargets == true ? 1 : 0;
                int potentialTargets3 = potentialTargets == true ? 1 : 0;
                int potentialTargets4 = potentialTargets == true ? 1 : 0;
                potentialTargets = potentialTargets2 + 1;
            }
            i--;
    ...
    public /* synthetic */ void lambda$updateRelevantEventsLocked$1$AccessibilityManagerService(UserState userState) {
        broadcastToClients(userState, FunctionalUtils.ignoreRemoteException(new FunctionalUtils.RemoteExceptionIgnoringConsumer(userState) {
            ...
            public final void acceptOrThrow(Object obj) {
                AccessibilityManagerService.this.lambda$updateRelevantEventsLocked$0$AccessibilityManagerService(this.f$1, (Client) obj);
            }
        }));
    }
        ...
        synchronized (this.mLock) {
            ...
            if (!userState.mIsTouchExplorationEnabled) {
                if (this.mEnableTouchExplorationDialog == null || !this.mEnableTouchExplorationDialog.isShowing()) {
                    ...
                    }).setTitle(17040033).setMessage(this.mContext.getString(17040032, label)).create();
    ...
    /* access modifiers changed from: private */
    public boolean userHasMagnificationServicesLocked(UserState userState) {
        List<AccessibilityServiceConnection> services = userState.mBoundServices;
    ...
    /* access modifiers changed from: private */
    public boolean isScreenReaderService(ComponentName serviceName) {
    ...
    /* JADX INFO: finally extract failed */
    /* access modifiers changed from: private */
    public void setScreenReaderState(int value) {
        long identity = Binder.clearCallingIdentity();
        try {
    ...
    /* access modifiers changed from: private */
    public boolean getScreenReaderState() {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:37:?, code lost:
        r22.mPowerManager.userActivity(android.os.SystemClock.uptimeMillis(), 3, 0);
        notifyOutsideTouchIfNeeded(r23, r26);
     */
            ...
            if (!(windowType == 1 || windowType == 2 || windowType == 3 || windowType == 4 || windowType == 1005)) {
                if (!(windowType == 2014 || windowType == 2017 || windowType == 2024)) {
                    ...
                    if (!(windowType == 2036 || windowType == 2038 || windowType == 2019 || windowType == 2020)) {
                        switch (windowType) {
                            case 1000:
                            case NetworkAgentInfo.EVENT_NETWORK_LINGER_COMPLETE /*{ENCODED_INT: 1001}*/:
                            case 1002:
                            case 1003:
                                break;
                            default:
                                switch (windowType) {
                                    case IHwShutdownThread.SHUTDOWN_ANIMATION_WAIT_TIME /*{ENCODED_INT: 2000}*/:
                                    case 2001:
                                    case 2003:
                                        break;
                                    case 2002:
    ...
    public class SecurityPolicy {
        ...
        public boolean canDispatchAccessibilityEventLocked(AccessibilityEvent event) {
            switch (event.getEventType()) {
                ...
                case 512:
                case 1024:
                case DumpState.DUMP_KEYSETS /*{ENCODED_INT: 16384}*/:
                case DumpState.DUMP_DOMAIN_PREFERRED /*{ENCODED_INT: 262144}*/:
                case DumpState.DUMP_FROZEN /*{ENCODED_INT: 524288}*/:
                case DumpState.DUMP_DEXOPT /*{ENCODED_INT: 1048576}*/:
                case DumpState.DUMP_COMPILER_STATS /*{ENCODED_INT: 2097152}*/:
                case DumpState.DUMP_CHANGES /*{ENCODED_INT: 4194304}*/:
                case DumpState.DUMP_SERVICE_PERMISSIONS /*{ENCODED_INT: 16777216}*/:
                    return true;
                default:
    ...
    public class UserState {
        ...
        public void addServiceLocked(AccessibilityServiceConnection serviceConnection) {
            if (!this.mBoundServices.contains(serviceConnection)) {
                ...
                if (AccessibilityManagerService.this.isTalkBackService(serviceConnection.mComponentName)) {
                    boolean unused = AccessibilityManagerService.this.mIsTalkBackEnabled = true;
                } else if (AccessibilityManagerService.this.isScreenReaderService(serviceConnection.mComponentName)) {
                    boolean unused2 = AccessibilityManagerService.this.mIsScreenReaderEnabled = true;
                } else {
        ...
        public void removeServiceLocked(AccessibilityServiceConnection serviceConnection) {
            ...
            AccessibilityManagerService.this.scheduleNotifyClientsOfServicesStateChangeLocked(this);
            if (AccessibilityManagerService.this.isTalkBackService(serviceConnection.mComponentName)) {
                boolean unused = AccessibilityManagerService.this.mIsTalkBackEnabled = false;
            } else if (AccessibilityManagerService.this.isScreenReaderService(serviceConnection.mComponentName)) {
                boolean unused2 = AccessibilityManagerService.this.mIsScreenReaderEnabled = false;
            } else {
