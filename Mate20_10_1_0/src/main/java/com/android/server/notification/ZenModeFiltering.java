...
public class ZenModeFiltering {
    ...
    private boolean isDefaultPhoneApp(String pkg) {
        ...
        return pkg != null && this.mDefaultPhoneApp != null && RECORD_SBN_PACKAGENAME.equals(pkg) && (DEFAULT_PHONEAPP_PACKAGENAME.equals(this.mDefaultPhoneApp.getPackageName()) || DEFAULT_PHONEAPP_PACKAGENAME_HW.equals(this.mDefaultPhoneApp.getPackageName()));
    }
