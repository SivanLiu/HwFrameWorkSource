...
public class ZenModeHelper {
    ...
    public void readXml(XmlPullParser parser, boolean forRestore, int userId) throws XmlPullParserException, IOException {
        ...
        if (config != null) {
            ...
            if (config.automaticRules != null) {
                hasDefaultRules = config.automaticRules.containsAll(ZenModeConfig.DEFAULT_RULE_IDS);
            } else {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x0052, code lost:
        if (com.android.server.notification.ZenModeHelper.DEBUG == false) goto L_0x0070;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x0054, code lost:
        android.util.Log.d(com.android.server.notification.ZenModeHelper.TAG, "setConfigLocked reason=" + r10, new java.lang.Throwable());
     */
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x0070, code lost:
        com.android.server.notification.ZenLog.traceConfig(r10, r8.mConfig, r9);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x0083, code lost:
        if (java.util.Objects.equals(getNotificationPolicy(r8.mConfig), getNotificationPolicy(r9)) != false) goto L_0x0087;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:31:0x009b, code lost:
        r8.mConfig = r9;
        com.android.server.notification.ZenModeHelper.H.access$300(r8.mHandler, r9, r10, r11, r12);
    ...
    private void updateDefaultAutomaticRuleNames() {
        for (ZenModeConfig.ZenRule rule : this.mDefaultConfig.automaticRules.values()) {
            if ("EVENTS_DEFAULT_RULE".equals(rule.id)) {
                rule.name = this.mContext.getResources().getString(17041583);
            } else if ("EVERY_NIGHT_DEFAULT_RULE".equals(rule.id)) {
                rule.name = this.mContext.getResources().getString(17041584);
            }
        }
    }
    ...
    public Notification createZenUpgradeNotification() {
        ...
        extras.putString("android.substName", this.mContext.getResources().getString(17040209));
        int title = 17041594;
        int content = 17041593;
        int drawable = 17302863;
        ...
        private void emitZenMode() {
            ...
            if (this.mPreviousZenMode != ZenModeHelper.this.mZenMode || since > 60000) {
                if (this.mPreviousZenMode != -1) {
                    Context access$700 = ZenModeHelper.this.mContext;
                    MetricsLogger.count(access$700, COUNTER_MODE_PREFIX + this.mPreviousZenMode, (int) since);
                }
