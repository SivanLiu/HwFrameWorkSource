...
public class HwZenModeFiltering {
    ...
    private void buildAndSendZenmodeNotification() {
        ...
        builder.setContentTitle(this.mContext.getString(33686280)).setSmallIcon(33752154).setContentIntent(createToSettingsIntent()).setShowWhen(false).setAppName(this.mContext.getString(33686281)).setActions(createClosedAction());
    ...
    private Notification.Action createClosedAction() {
        ...
        return new Notification.Action.Builder((Icon) null, this.mContext.getString(33686279), PendingIntent.getBroadcast(this.mContext, 0, intent, 268435456)).build();
    }
