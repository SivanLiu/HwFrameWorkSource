        ...
        synchronized (this.mConnectedDevices) {
            ...
            this.mConnectedDevices.values().forEach(new Consumer(toRemove) {
                ...
                public final void accept(Object obj) {
                    AudioDeviceInventory.lambda$disconnectA2dp$0(this.f$0, (DeviceInfo) obj);
                }
            });
            if (toRemove.size() > 0) {
    ...
    public void disconnectA2dpSink() {
        synchronized (this.mConnectedDevices) {
            ...
            this.mConnectedDevices.values().forEach(new Consumer(toRemove) {
                ...
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    AudioDeviceInventory.lambda$disconnectA2dpSink$2(this.f$0, (DeviceInfo) obj);
                }
            });
    ...
    public void disconnectHearingAid() {
        synchronized (this.mConnectedDevices) {
            ...
            this.mConnectedDevices.values().forEach(new Consumer(toRemove) {
                ...
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    AudioDeviceInventory.lambda$disconnectHearingAid$4(this.f$0, (DeviceInfo) obj);
                }
            });
            if (toRemove.size() > 0) {
    ...
    private boolean isCurrentDeviceConnected() {
        return this.mConnectedDevices.values().stream().anyMatch(new Predicate() {
            ...
            public final boolean test(Object obj) {
                return AudioDeviceInventory.this.lambda$isCurrentDeviceConnected$6$AudioDeviceInventory((DeviceInfo) obj);
            }
        });
    }
