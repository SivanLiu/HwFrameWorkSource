...
public abstract class AbsAudioService extends IAudioService.Stub {
    ...
    protected static final boolean IS_SUPER_RECEIVER_ENABLED = SystemProperties.getBoolean("hw_mc.audio.super_receiver_enabled", false);
    ...
    protected static final int MSG_SUPER_RECEIVER = 10099;
    protected static final boolean SOUND_EFFECTS_SUPPORT = (SWS_SOUND_EFFECTS_SUPPORT || DOLBY_SOUND_EFFECTS_SUPPORT);
    ...
    protected static final int STATE_SUPER_RECEIVER_CHANGE = 1;
    protected static final int STATE_SUPER_RECEIVER_OFF = 0;
