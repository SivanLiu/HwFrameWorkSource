...
public class HwFocusRequester extends FocusRequester {
    ...
    private static boolean mIsRecgOptEnable = SystemProperties.getBoolean("persist.sys.iaware.switch.recogOpt", true);
    ...
    private void reportFocusLoss(int focusLoss, FocusRequester frWinner) {
        if (mIsRecgOptEnable && focusLoss != this.mFocusLoss) {
