...
public class AudioService extends AbsAudioService implements AccessibilityManager.TouchExplorationStateChangeListener, AccessibilityManager.AccessibilityServicesStateChangeListener, IHwAudioServiceInner {
    ...
    static /* synthetic */ int access$9208(AudioService x0) {
    ...
    public void onEnableSurroundFormats(ArrayList<Integer> enabledSurroundFormats) {
        ...
        for (int surroundFormat : iArr) {
            ...
            Log.i(TAG, "enable surround format:" + surroundFormat + HwLog.PREFIX + enabled + HwLog.PREFIX + AudioSystem.setSurroundFormatEnabled(surroundFormat, enabled));
        }
    }
    ...
    public void adjustSuggestedStreamVolume(int direction, int suggestedStreamType, int flags, String callingPackage, String caller, int uid) {
        ...
        if (iHwAudioServiceEx == null || !iHwAudioServiceEx.bypassVolumeProcessForTV(this.mActiveDevice, suggestedStreamType, direction, flags4)) {
            ...
            if (shouldStopAdjustVolume(uid)) {
                adjustStreamVolume(maybeActiveStreamType, 0, flags2, callingPackage, caller, uid);
            } else {
                adjustStreamVolume(maybeActiveStreamType, flags3, flags2, callingPackage, caller, uid);
            }
        }
    }
    ...
    /* access modifiers changed from: protected */
    /* JADX WARNING: Code restructure failed: missing block: B:210:0x03c1, code lost:
        r0 = th;
     */
    public void adjustStreamVolume(int streamType, int direction, int flags, String callingPackage, String caller, int uid) {
        ...
        if (checkEnbaleVolumeAdjust() && !this.mUseFixedVolume) {
            ...
            if (!isMuteAdjust || (!(streamType == 0 || streamType == 6) || this.mContext.checkCallingOrSelfPermission("android.permission.MODIFY_PHONE_STATE") == 0)) {
                ...
                int aliasIndex2 = streamState.getIndex(device);
                ...
                if ((device & 896) != 0 || (flags & 64) == 0) {
                    ...
                    if (this.mAppOps.noteOp(STREAM_VOLUME_OPS[streamTypeAlias], uid2, callingPackage) == 0) {
                        ...
                        if (streamTypeAlias != 3 || (this.mFixedVolumeDevices & device) == 0) {
                            ...
                            flags3 |= 32;
                            if (this.mSafeMediaVolumeState != 3 || (603979788 & device) == 0) {
                        ...
                        if ((flags3 & 2) != 0 || streamTypeAlias == getUiSoundsStreamType()) {
                            ...
                            i = 1;
                            int result = checkForRingerModeChange(aliasIndex, direction, step2, streamState.mIsMuted, callingPackage, flags3);
                        ...
                        if (!volumeAdjustmentAllowedByDnd(streamTypeAlias, uid3)) {
                            adjustVolume = false;
                        }
                        ...
                        if (!adjustVolume || direction == 0) {
                            ...
                            if (isMuteAdjust) {
                                if (direction == 101) {
                                    state = streamState.mIsMuted ^ i;
                                } else {
                                    state = direction == -100 ? i : false;
                                }
                                ...
                                flags2 = uid3;
                                i2 = 3;
                            } else if (direction == i && !checkSafeMediaVolume(streamTypeAlias, aliasIndex + step2, device)) {
                                Log.e(TAG, "adjustStreamVolume() safe volume index = " + oldIndex3);
                                this.mVolumeController.postDisplaySafeVolumeWarning(uid3);
                                oldIndex2 = oldIndex3;
                                flags2 = uid3;
                                i2 = 3;
                                ...
                                flags2 = uid3;
                                i2 = 3;
                            } else if (streamState.adjustIndex(direction * step2, device, caller) || streamState.mIsMuted) {
                                if (!streamState.mIsMuted) {
                                    ...
                                    oldIndex2 = oldIndex3;
                                    flags2 = uid3;
                                    sendMsg(this.mAudioHandler, 18, 2, streamTypeAlias, uid3, null, UNMUTE_STREAM_DELAY);
                                } else {
                                    oldIndex2 = oldIndex3;
                                    flags2 = uid3;
                                    i2 = 3;
                            ...
                            if (streamTypeAlias == i2 && (device & 896) != 0 && (flags2 & 64) == 0) {
                                Log.i(TAG, "adjustSreamVolume: postSetAvrcpAbsoluteVolumeIndex index=" + newIndex + "stream=" + streamType);
                        ...
                        if (LOUD_VOICE_MODE_SUPPORT) {
                            sendMsg(this.mAudioHandler, 10001, 0, 1, 0, new AbsAudioService.DeviceVolumeState(direction, device, oldIndex, streamType), 0);
                        }
                        if (IS_SUPER_RECEIVER_ENABLED) {
                            sendMsg(this.mAudioHandler, 10099, 0, 1, 0, new AbsAudioService.DeviceVolumeState(direction, device, oldIndex, streamType), 0);
                            return;
                        }
                        return;
                    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:102:0x01ee, code lost:
        ...
        r25.mHdmiAudioSystemClient.sendReportAudioStatusCecCommand(false, getStreamVolume(3), getStreamMaxVolume(3), isStreamMute(3));
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:104:0x0209, code lost:
        sendVolumeUpdate(r26, r0, r15, r16, r11);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:105:0x0217, code lost:
        if (com.android.server.audio.AudioService.LOUD_VOICE_MODE_SUPPORT == false) goto L_0x0238;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:106:0x0219, code lost:
        sendMsg(r25.mAudioHandler, 10001, 0, 1, 0, new com.android.server.audio.AbsAudioService.DeviceVolumeState(r25, 0, r11, r0, r26), 0);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:108:0x023a, code lost:
        if (com.android.server.audio.AudioService.IS_SUPER_RECEIVER_ENABLED == false) goto L_?;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:109:0x023c, code lost:
        sendMsg(r25.mAudioHandler, 10099, 0, 1, 0, new com.android.server.audio.AbsAudioService.DeviceVolumeState(r25, 0, r11, r0, r26), 0);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:94:0x01df, code lost:
        if (r25.mHdmiManager == null) goto L_0x0208;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:96:0x01e3, code lost:
        if (r25.mHdmiAudioSystemClient == null) goto L_0x0208;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:98:0x01e7, code lost:
        if (r25.mHdmiSystemAudioSupported == false) goto L_0x0208;
     */
    /* JADX WARNING: Removed duplicated region for block: B:84:0x019e A[Catch:{ all -> 0x0264 }] */
    /* JADX WARNING: Removed duplicated region for block: B:88:0x01bf A[Catch:{ all -> 0x025f }] */
                ...
                if (this.mAppOps.noteOp(STREAM_VOLUME_OPS[streamTypeAlias], uid2, callingPackage) != 0) {
                    ...
                    synchronized (this.mSafeMediaVolumeStateLock) {
                        try {
                            ...
                            int index3 = rescaleIndex(index * 10, streamType, streamTypeAlias);
                            if (streamTypeAlias == 3 && (device & 896) != 0 && (flags & 64) == 0) {
                                try {
                                    Log.i(TAG, "setStreamVolume postSetAvrcpAbsoluteVolumeIndex index=" + index3 + "stream=" + streamType);
                            ...
                            if ((134217728 & device) != 0 && streamType == getHearingAidStreamType()) {
                                Log.i(TAG, "setStreamVolume postSetHearingAidVolumeIndex index=" + index3 + " stream=" + streamType);
                                this.mDeviceBroker.postSetHearingAidVolumeIndex(index3, streamType);
                            }
                            if (streamTypeAlias == 3) {
                                setSystemAudioVolume(oldIndex, index3, getStreamMaxVolume(streamType), flags);
                            }
                            int flags4 = flags & -33;
                            if (streamTypeAlias == 3) {
                                try {
                                    if ((this.mFixedVolumeDevices & device) != 0) {
                                        ...
                                        if (checkSafeMediaVolume(streamTypeAlias, index2, device)) {
                                            ...
                                            flags3 = flags2;
                                            onSetStreamVolume(streamType, index2, flags3, device, caller);
    ...
    public boolean isStreamMute(int streamType) {
        ...
        synchronized (VolumeStreamState.class) {
            ensureValidStreamType(streamType);
            access$800 = this.mStreamStates[streamType].mIsMuted;
        }
        return access$800;
    }
    ...
    public int setModeInt(int mode, IBinder cb, int pid, String caller) {
        ...
        while (true) {
            ...
            if (mode3 != 0) {
                ...
                try {
                    cb3.linkToDeath(hdlr, i);
                } catch (RemoteException e) {
                    Log.w(TAG, "setMode() could not link to " + cb3 + " binder death");
                }
                this.mSetModeDeathHandlers.add(i, hdlr);
                hdlr.setMode(mode3);
                hdlr2 = hdlr;
                cb2 = cb3;
        ...
        synchronized (this.mSafeMediaVolumeStateLock) {
            ...
            if (this.mMcc != mcc || (this.mMcc == 0 && force)) {
                ...
                if (!SystemProperties.getBoolean("audio.safemedia.force", false)) {
                    if (!this.mContext.getResources().getBoolean(17891504)) {
    ...
    public class VolumeStreamState {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x0050, code lost:
            r8 = android.provider.Settings.System.getIntForUser(com.android.server.audio.AudioService.access$3000(r11.this$0), getSettingNameForDevice(r5), r7, -2);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:33:0x0060, code lost:
            if (r8 != -1) goto L_0x006e;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:35:0x0064, code lost:
            if (r11.mVSSCust == null) goto L_0x0079;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:36:0x0066, code lost:
            r11.mVSSCust.readSettings(r11.mStreamType, r5);
         */
        ...
        /* access modifiers changed from: private */
        public void initIndex(int device) {
            synchronized (VolumeStreamState.class) {
                    ...
                    if (i == 7) {
                        ...
                        switch (i) {
                            ...
                            case 22:
                                ...
                                return;
                            case AudioService.MSG_DISPATCH_AUDIO_SERVER_STATE /*{ENCODED_INT: 23}*/:
                                ...
                                return;
                            case AudioService.MSG_ENABLE_SURROUND_FORMATS /*{ENCODED_INT: 24}*/:
                                AudioService.this.onEnableSurroundFormats((ArrayList) msg.obj);
                                return;
                            case AudioService.MSG_UPDATE_RINGER_MODE /*{ENCODED_INT: 25}*/:
                                AudioService.this.onUpdateRingerModeServiceInt();
                                return;
                            case 26:
                                AudioService.this.onSetVolumeIndexOnDevice((DeviceVolumeUpdate) msg.obj);
                                return;
                            case AudioService.MSG_OBSERVE_DEVICES_FOR_ALL_STREAMS /*{ENCODED_INT: 27}*/:
                                AudioService.this.onObserveDevicesForAllStreams();
                                return;
                            case AudioService.MSG_HDMI_VOLUME_CHECK /*{ENCODED_INT: 28}*/:
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals("android.intent.action.DOCK_EVENT")) {
                ...
                if (!AudioService.this.mIsChineseZone && AudioService.this.mHasAlarm) {
                    ...
                    boolean unused2 = AudioService.this.mHasAlarm = false;
                ...
                if (action.equals("android.intent.action.CONFIGURATION_CHANGED")) {
                    ...
                    boolean unused3 = AudioService.this.mUserSwitchedReceived = true;
                ...
                } else if (!AudioService.this.mIsChineseZone && action.equals(AudioService.ACTION_CHECK_MUSIC_ACTIVE) && AudioSystem.isStreamActive(3, (int) AudioService.CHECK_MUSIC_ACTIVE_DELAY_MS)) {
                    AudioService audioService = AudioService.this;
    ...
    private boolean readCameraSoundForced() {
        if (SystemProperties.getBoolean("audio.camerasound.force", false) || this.mContext.getResources().getBoolean(17891385)) {
            return true;
        }
        return false;
    }
    ...
    public class AudioPolicyProxy extends AudioPolicyConfig implements IBinder.DeathRecipient {
        ...
        AudioPolicyProxy(AudioPolicyConfig config, IAudioPolicyCallback token, boolean hasFocusListener, boolean isFocusPolicy, boolean isTestFocusPolicy, boolean isVolumeController, IMediaProjection projection) {
            super(config);
            setRegistration(new String(config.hashCode() + ":ap:" + AudioService.access$9208(AudioService.this)));
