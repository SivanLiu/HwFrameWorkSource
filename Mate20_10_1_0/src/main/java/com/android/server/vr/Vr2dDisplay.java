...
class Vr2dDisplay {
    ...
    private final IPersistentVrStateCallbacks mVrStateCallbacks = new IPersistentVrStateCallbacks.Stub() {
        /* class com.android.server.vr.Vr2dDisplay.AnonymousClass1 */
    ...
    private void startVirtualDisplay() {
        ...
        synchronized (this.mVdLock) {
            ...
            this.mVirtualDisplay = this.mDisplayManager.createVirtualDisplay(null, DISPLAY_NAME, this.mVirtualDisplayWidth, this.mVirtualDisplayHeight, this.mVirtualDisplayDpi, null, 64 | 128 | 1 | 8 | 256 | 4, null, null, UNIQUE_DISPLAY_ID);
            if (this.mVirtualDisplay != null) {
    ...
    private void stopVirtualDisplay() {
        if (this.mStopVDRunnable == null) {
            this.mStopVDRunnable = new Runnable() {
                /* class com.android.server.vr.Vr2dDisplay.AnonymousClass3 */
