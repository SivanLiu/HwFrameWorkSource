    ...
    public final class SettingsObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            if (this.TRUST_AGENTS_EXTEND_UNLOCK.equals(uri)) {
                if (Settings.Secure.getIntForUser(this.mContentResolver, "trust_agents_extend_unlock", !this.mIsAutomotive, TrustManagerService.this.mCurrentUser) == 0) {
                    z = false;
                }
        ...
        for (int i = 0; i < userInfos.size(); i++) {
            ...
            if (info != null && !info.partial && info.isEnabled() && !info.guestToRemove) {
                ...
                if (info.supportsSwitchToByUser()) {
                    ...
                    Log.d(TAG, "refreshDeviceLockedForUser : " + deviceLocked + HwLog.PREFIX + showingKeyguard);
