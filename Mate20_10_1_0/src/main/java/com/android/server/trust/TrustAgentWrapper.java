...
public class TrustAgentWrapper {
    ...
    public ITrustAgentServiceCallback mCallback = new ITrustAgentServiceCallback.Stub() {
        ...
        public void addEscrowToken(byte[] token, int userId) {
            if (!TrustAgentWrapper.this.mContext.getResources().getBoolean(17891344)) {
                if (TrustAgentWrapper.DEBUG) {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    if (durationMs > 0) {
                        ...
                        TrustAgentWrapper trustAgentWrapper = TrustAgentWrapper.this;
                        PendingIntent unused3 = trustAgentWrapper.mAlarmPendingIntent = PendingIntent.getBroadcast(trustAgentWrapper.mContext, 0, TrustAgentWrapper.this.mAlarmIntent, 268435456);
                ...
                case 6:
                    ...
                    boolean unused6 = trustAgentWrapper2.mManagingTrust = z;
                ...
                case 9:
                    ...
                    try {
                        if (TrustAgentWrapper.this.mTrustAgentService != null) {
                            ...
                            access$1600.onTokenStateReceived(handle3, i);
                            return;
                        }
                        return;
