...
public final class RestrictionsManagerService extends SystemService {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: com.android.server.restrictions.RestrictionsManagerService */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r0v0, types: [com.android.server.restrictions.RestrictionsManagerService$RestrictionsManagerImpl, android.os.IBinder] */
            ...
            if (this.mDpm != null) {
                ...
                try {
                    ...
                    if (restrictionsProvider != null) {
                        ...
                        ResolveInfo ri = AppGlobals.getPackageManager().resolveIntent(intent, (String) null, 0, userHandle);
