...
class BluetoothManagerService extends IBluetoothManager.Stub implements IHwBluetoothManagerInner {
    ...
    private static final String TV_CHARACTERISTICS_PROP = "ro.build.characteristics";
    private static final String TV_CHARACTERISTICS_PROP_DEFAULT_VALUE = "default";
    private static final String TV_CHARACTERISTICS_PROP_TV_VALUE = "tv";
    private static final int USER_SWITCHED_TIME_MS = 200;
    private static final int WAITE_TIME = 20;
    /* access modifiers changed from: private */
    public boolean isBleServiceStarted = false;
    ...
    /* access modifiers changed from: private */
    public IHwBluetoothManagerServiceEx mHwBluetoothManagerServiceEx;
    ...
    BluetoothManagerService(Context context) {
        ...
        this.mWirelessConsentRequired = context.getResources().getBoolean(17891605);
        this.mCrashes = 0;
        ...
        this.mIsHearingAidProfileSupported = context.getResources().getBoolean(17891465);
        ...
        int systemUiUid = -1;
        try {
            systemUiUid = !this.mContext.getResources().getBoolean(17891487) ? this.mContext.getPackageManager().getPackageUidAsUser("com.android.systemui", DumpState.DUMP_DEXOPT, 0) : systemUiUid;
    ...
    public boolean enableNoAutoConnect(String packageName) {
        ...
        if (isCallerSystem || callingAppId == 1027) {
    ...
    public boolean enable(String packageName) throws RemoteException {
        ...
        if (isBluetoothDisallowed()) {
            ...
            HwLog.i(TAG, "enable(" + packageName + "):  mBluetooth =" + this.mBluetooth + " mBinding = " + this.mBinding + " mState = " + BluetoothAdapter.nameForState(this.mState) + ", needCheck = " + needCheck);
    ...
    public boolean disable(String packageName, boolean persist) throws RemoteException {
        ...
        HwLog.i(TAG, "disable(" + packageName + "): mBluetooth = " + this.mBluetooth + " mBinding = " + this.mBinding + ",needCheck = " + needCheck);
        if (isAirplaneModeOn()) {
            setUserSelectState(false);
        }
        this.mHwBluetoothManagerServiceEx.reportBtChrThirdPartApkCalling(false, packageName);
        synchronized (this.mReceiver) {
            if (persist) {
            ...
            if (i == 1) {
                ...
                if (i == 100) {
                    ...
                    if (BluetoothManagerService.this.mBluetooth != null && BluetoothManagerService.this.isEnabled()) {
                        ...
                        boolean unused16 = BluetoothManagerService.this.waitForOnOff(true, false);
                    ...
                    switch (i) {
                        case 40:
                            ...
                            try {
                                ...
                                if (msg.arg1 == 2) {
                                    ...
                                    boolean unused22 = BluetoothManagerService.this.isBleServiceStarted = true;
                                ...
                                BluetoothManagerService.this.mHandler.removeMessages(100);
                                boolean unused23 = BluetoothManagerService.this.mBinding = false;
                                IBinder unused24 = BluetoothManagerService.this.mBluetoothBinder = service;
                                IBluetooth unused25 = BluetoothManagerService.this.mBluetooth = IBluetooth.Stub.asInterface(Binder.allowBlocking(service));
                                ...
                                if (!BluetoothManagerService.this.mEnable) {
                                    boolean unused26 = BluetoothManagerService.this.waitForOnOff(true, false);
                                    BluetoothManagerService.this.handleDisable();
                                    boolean unused27 = BluetoothManagerService.this.waitForOnOff(false, false);
                                    return;
                                }
                                return;
                            } finally {
                        ...
                        case 41:
                            ...
                            try {
                                ...
                                if (msg.arg1 == 1) {
                                    if (BluetoothManagerService.this.mBluetooth != null) {
                                        IBluetooth unused28 = BluetoothManagerService.this.mBluetooth = null;
                                        BluetoothManagerService.this.mBluetoothLock.writeLock().unlock();
                                        ...
                                        if (BluetoothManagerService.this.mEnable) {
                                            boolean unused29 = BluetoothManagerService.this.mEnable = false;
                                        ...
                                        if (BluetoothManagerService.this.mState == 11 || BluetoothManagerService.this.mState == 12) {
                                            BluetoothManagerService.this.bluetoothStateChangeHandler(12, 13);
                                            int unused30 = BluetoothManagerService.this.mState = 13;
                                        }
                                        if (BluetoothManagerService.this.mState == 13) {
                                            BluetoothManagerService.this.bluetoothStateChangeHandler(13, 10);
                                        }
                                        BluetoothManagerService.this.mHandler.removeMessages(BluetoothManagerService.MESSAGE_BLUETOOTH_STATE_CHANGE);
                                        int unused31 = BluetoothManagerService.this.mState = 10;
                                        return;
                                    }
                                } else if (msg.arg1 == 2) {
                                    IBluetoothGatt unused32 = BluetoothManagerService.this.mBluetoothGatt = null;
                                } else {
                        ...
                        case 42:
                            ...
                            boolean unused33 = BluetoothManagerService.this.mEnable = true;
                    ...
                    if (psc2 != null) {
                        boolean unused34 = psc2.bindService();
                    }
                }
                ...
                boolean unused35 = BluetoothManagerService.this.mEnableExternal = false;
                ...
                boolean unused36 = BluetoothManagerService.this.mQuietEnableExternal = false;
                boolean unused37 = BluetoothManagerService.this.mEnableExternal = true;
    ...
    /* access modifiers changed from: private */
    public void sendBleServiceReadyBroadcast() {
        if (TV_CHARACTERISTICS_PROP_TV_VALUE.equals(SystemProperties.get(TV_CHARACTERISTICS_PROP, "default"))) {
    ...
    /* access modifiers changed from: private */
    public boolean userSwitchWaitForOnOff(boolean on, boolean off) {
        int index = 0;
        while (true) {
            if (index >= 20) {
                break;
    ...
    public void sendEnableMsg(boolean quietMode, int reason, String packageName) {
        if (!this.mHwBluetoothManagerServiceEx.shouldIgnoreExtraEnableMessage(quietMode, this.mQuietEnable)) {
            if (reason == 6) {
                BluetoothHandler bluetoothHandler = this.mHandler;
                bluetoothHandler.sendMessageDelayed(bluetoothHandler.obtainMessage(1, quietMode, 0), BackupAgentTimeoutParameters.DEFAULT_QUOTA_EXCEEDED_TIMEOUT_MILLIS);
                Slog.e(TAG, "MESSAGE_ENABLE delay 3s");
            } else {
