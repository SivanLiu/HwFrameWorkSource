...
public class SearchManagerService extends ISearchManager.Stub {
    ...
    public static class Lifecycle extends SystemService {
        ...
        /* JADX WARN: Type inference failed for: r0v1, types: [com.android.server.search.SearchManagerService, android.os.IBinder] */
        ...
        public void onUnlockUser(final int userId) {
            this.mService.mHandler.post(new Runnable() {
                /* class com.android.server.search.SearchManagerService.Lifecycle.AnonymousClass1 */
