...
public class UsbPortManager {
    ...
    private void updateContaminantNotification() {
        ...
        if (contaminantStatus == 3 && (i2 = this.mIsPortContaminatedNotificationId) != 52) {
            ...
            CharSequence title = r.getText(17041401);
            String channel = SystemNotificationChannels.ALERTS;
            CharSequence message = r.getText(17041400);
            ...
            if (contaminantStatus == 2) {
                ...
                CharSequence title2 = r.getText(17041403);
                String channel2 = SystemNotificationChannels.ALERTS;
                CharSequence message2 = r.getText(17041402);
                this.mNotificationManager.notifyAsUser(null, this.mIsPortContaminatedNotificationId, new Notification.Builder(this.mContext, channel2).setSmallIcon(17302843).setTicker(title2).setColor(this.mContext.getColor(17170460)).setContentTitle(title2).setContentText(message2).setVisibility(1).setStyle(new Notification.BigTextStyle().bigText(message2)).build(), UserHandle.ALL);
            }
        }
    }
    ...
    final class ServiceNotification extends IServiceNotification.Stub {
        ...
        public void onRegistration(String fqName, String name, boolean preexisting) {
            UsbPortManager.logAndPrint(4, null, "Usb hal service started " + fqName + HwLog.PREFIX + name);
