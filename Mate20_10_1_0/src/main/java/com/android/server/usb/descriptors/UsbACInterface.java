...
public abstract class UsbACInterface extends UsbDescriptor {
    ...
    @Override // com.android.server.usb.descriptors.report.Reporting, com.android.server.usb.descriptors.UsbDescriptor
    public void report(ReportCanvas canvas) {
        ...
        canvas.openList();
        canvas.writeListItem("Subclass: " + ReportCanvas.getHexString(subClass) + HwLog.PREFIX + subClassName);
        canvas.writeListItem("Subtype: " + ReportCanvas.getHexString(subtype) + HwLog.PREFIX + subTypeName);
        canvas.closeList();
    }
}
