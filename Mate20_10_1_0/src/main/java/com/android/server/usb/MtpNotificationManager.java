...
class MtpNotificationManager {
    ...
    public void showNotification(UsbDevice device) {
        ...
        Notification.Builder builder = new Notification.Builder(this.mContext, SystemNotificationChannels.USB).setContentTitle(resources.getString(17041409, device.getProductName())).setContentText(resources.getString(17041408)).setSmallIcon(17303576).setCategory("sys");
