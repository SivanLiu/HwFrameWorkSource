...
public class UsbHostManager {
    ...
    public UsbHostManager(Context context, UsbAlsaManager alsaManager, UsbSettingsManager settingsManager) {
        ...
        String deviceConnectionHandler = context.getResources().getString(17039788);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:58:0x0158, code lost:
        if (com.android.server.usb.UsbHostManager.DEBUG == false) goto L_0x0175;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:59:0x015a, code lost:
        r0 = com.android.server.usb.UsbHostManager.TAG;
        android.util.Slog.d(r0, "beginUsbDeviceAdded(" + r25 + ") end");
     */
