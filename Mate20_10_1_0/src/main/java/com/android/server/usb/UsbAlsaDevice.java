...
public final class UsbAlsaDevice {
    ...
    public synchronized String toShortString() {
        return "[card:" + this.mCardNum + " device:" + this.mDeviceNum + HwLog.PREFIX + this.mDeviceName + "]";
    }
    ...
    public int hashCode() {
        return (((((((((((1 * 31) + this.mCardNum) * 31) + this.mDeviceNum) * 31) + (!this.mHasOutput)) * 31) + (!this.mHasInput)) * 31) + (!this.mIsInputHeadset)) * 31) + (!this.mIsOutputHeadset);
    }
}
