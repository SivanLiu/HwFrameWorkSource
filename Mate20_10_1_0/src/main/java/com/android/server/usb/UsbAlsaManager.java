        ...
        if (cardRec != null) {
            ...
            if (hasMidi && this.mHasMidiFeature) {
                ...
                if (manufacturer == null || manufacturer.isEmpty()) {
                    ...
                    name = manufacturer + HwLog.PREFIX + product;
                }
    ...
    public void setPeripheralMidiState(boolean enabled, int card, int device) {
        ...
        if (this.mHasMidiFeature) {
            if (enabled && this.mPeripheralMidiDevice == null) {
                ...
                properties.putString(com.android.server.pm.Settings.ATTR_NAME, r.getString(17041406));
                properties.putString("manufacturer", r.getString(17041405));
                properties.putString("product", r.getString(17041407));
