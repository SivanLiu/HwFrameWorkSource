...
public final class MemoryConstant {
    ...
    public static final int DEFAULT_EXTRA_FREE_KBYTES = SystemProperties.getInt("sys.sysctl.extra_free_kbytes", (int) PROCESSLIST_EXTRA_FREE_KBYTES);
    ...
    private static long configCpuNormalThreshold = DEFAULT_CPU_NORMAL_THRESHOLD;
    ...
    private static long configIdleMemory = 1048576;
    ...
    private static long gpuMemoryLimit = 1048576;
    ...
    public static long getMiddleWater() {
        return (configEmergencyMemory + configCriticalMemory) / 2;
    }
    ...
    public static void setCameraPowerUpMem() {
        ...
        if (context != null) {
            ...
            CameraManager cameraManager = sCameraManager;
            if (cameraManager == null) {
                AwareLog.w(TAG, "sCameraManager is null!");
                return;
            }
            try {
