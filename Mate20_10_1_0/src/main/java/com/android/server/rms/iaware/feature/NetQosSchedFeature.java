...
public class NetQosSchedFeature extends RFeature {
    ...
    private void registerDataReport() {
        if (this.mIRDataRegister != null) {
            ...
            this.mIRDataRegister.subscribeData(AwareConstant.ResourceType.RESOURCE_VPN_CONN, this.mFeatureType);
    ...
    private void unregisterDataReport() {
        if (this.mIRDataRegister != null) {
            ...
            this.mIRDataRegister.unSubscribeData(AwareConstant.ResourceType.RESOURCE_VPN_CONN, this.mFeatureType);
