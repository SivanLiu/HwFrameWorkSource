...
public class MemoryFeature extends RFeature {
    ...
    private static long getTotalMem() {
        ...
        return memInfoReader.getTotalSize() / 1048576;
    }
            ...
            if (item == null || item.getProperties() == null) {
                ...
                if (appName != null) {
                    ...
                    if (!MemoryUtils.checkRamSize(ramSize, totalMemMb)) {
                        ...
                        AwareLog.d(TAG, "loadBigMemAppPolicyConfig success:ramsize: " + ramSize + " totalMemMb:" + totalMemMb);
    ...
    public static void loadBigMemActivityPolicyConfig(AwareConfig custConfigList) {
        ...
        for (AwareConfig.Item item : custConfigList.getConfigList()) {
            ...
            } else if (item.getProperties().get(BigMemoryConstant.BIGMEMINFO_ITEM_TAG) != null) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:20:0x0049 A[Catch:{ NumberFormatException -> 0x00a8 }] */
    /* JADX WARNING: Removed duplicated region for block: B:23:0x0086 A[Catch:{ NumberFormatException -> 0x00a8 }] */
