...
public class AwareMiddleware {
    ...
    private static final boolean HOSP_ENABLE = SystemProperties.getBoolean("ro.build.harmoney.enable", false);
    ...
    public volatile IAwareObserver mAwareObserver = null;
    ...
    /* access modifiers changed from: private */
    public void updateStateCacheIds(int stateType, int eventType, int pid, int uid) {
        if (stateType == 2) {
    ...
    /* access modifiers changed from: private */
    public void getDynamicProfie() {
        getDeviceName();
    }

    /* access modifiers changed from: private */
    public void onProfileNotify() {
        if (this.mAwareObserver == null) {
    ...
    /* JADX INFO: Multiple debug info for r2v3 int[]: [D('values' int[]), D('i' int)] */
    ...
    private class MiddlewareHandler extends Handler {
