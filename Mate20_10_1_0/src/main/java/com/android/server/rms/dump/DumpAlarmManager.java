...
import com.huawei.IntelliServer.intellilib.BuildConfig;
        ...
        if (pw != null) {
            ...
            synchronized (DumpAlarmManager.class) {
                if (consumers.isEmpty()) {
                    ...
                    consumers.put(BuildConfig.BUILD_TYPE, $$Lambda$DumpAlarmManager$TAuUJte3WTeURAu60wUGpaASTRk.INSTANCE);
    ...
    public static void delay(Context mContext, PrintWriter pw, String[] args) {
        if (pw != null) {
            ...
            try {
                ...
                pw.println("  Bad command because of NumberFormatException!");
            }
        }
    }
