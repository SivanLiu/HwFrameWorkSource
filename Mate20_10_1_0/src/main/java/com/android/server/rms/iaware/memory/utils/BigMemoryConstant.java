...
public class BigMemoryConstant {
    ...
    public static final String BIGMEMINFO_ITEM_TAG = "activity";
    ...
    public static final String MEM_POLICY_ACTIVITYMEMAPP = "ActivityMemApp";
    public static final String MEM_POLICY_ACTIVITY_MAX_MEM = "activity_max_mem";
    public static final String MEM_POLICY_BIGMEMSWITCH = "switch";
    public static final String MEM_POLICY_CAMERAACTIVITY = "CameraActivity";
