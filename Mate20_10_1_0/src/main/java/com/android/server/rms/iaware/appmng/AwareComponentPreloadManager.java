...
public final class AwareComponentPreloadManager {
    ...
    private int mStartServiceDelay = 1500;

    private class ComponentPreloadHandler extends Handler {
    ...
    public void handlerStartServicesMsg(Message msg) {
    ...
    private boolean isMainUserApp(int uid) {
        if (AwareAppAssociate.getInstance().getCurUserId() == 0 && UserHandle.getUserId(uid) == 0) {
            return true;
        }
        return false;
    }
                                ...
                                if (itemValue != null) {
                                    ...
                                    if (hashCode != -1805606060) {
                                        if (hashCode == 1534863056 && itemName.equals(DELAY_TIME_ITEM)) {
                                            c = 1;
                                            if (c == 0) {
                                                this.mServiceEnable = "1".equals(itemValue.trim());
                                            } else if (c == 1) {
    ...
    /* access modifiers changed from: private */
    public void handlerInitCompConfig() {
    ...
    /* access modifiers changed from: private */
    public void handlerUninstallApp(Message msg) {
    ...
    /* access modifiers changed from: private */
    public void handlerClearAppData(Message msg) {
        String pkg;
    ...
    /* access modifiers changed from: private */
    public void handlerInsertDb(Message msg) {
    ...
    /* access modifiers changed from: private */
    public void handlerServiceStart(Message message) {
        if (message != null) {
