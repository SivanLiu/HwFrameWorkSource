...
public class BigMemoryInfo {
    ...
    public volatile boolean mIsBigMemFeatureOn = false;
    ...
    private void initParas() {
        ...
        if (context != null && context.getSystemService("appops") != null) {
            ...
            if (appOpsManager != null) {
                appOpsManager.startWatchingActive(new int[]{26}, this.mAppOpsListener);
            }
        }
    }
    ...
    private class ActivityMemInfoHandler extends Handler {
    ...
    /* access modifiers changed from: private */
    public void learnCameraMemInfo(Bundle bundle) {
        if (bundle == null) {
            AwareLog.d(TAG, "learnCameraMemInfo bundle is null");
            return;
        }
        ...
        if (!this.mIsCameraClosed) {
            ...
            for (String cameraServerProc : this.mCameraServerProcs) {
                ...
                int temp = (int) ResourceCollector.getPss(MemoryUtils.getNativeRelatedPid(cameraServerProc), null, null);
    ...
    private int getMemSizeValid(int cameraTotalMemInfo, int uid, String activityName, String packageName) {
        if (cameraTotalMemInfo < this.mCameraMinMem || cameraTotalMemInfo > this.mCameraMaxMem) {
            AwareLog.d(TAG, "getMemSizeValid camera process mem is invalid ,cameraMinMem=" + this.mCameraMinMem);
            return 0;
        }
        ...
        AwareLog.d(TAG, "getMemSizeValid the total mem is invalid ,cameraTotalMemInfo =" + totalMemSize);
        return 0;
    }
    ...
    private static class ActivityMemInfo {
    ...
    private int getAppTotalMemInfo(int uid, String activityName, String appName) {
        ...
        for (int i = pids.size() - 1; i >= 0; i--) {
            totalMem += (int) ResourceCollector.getPss(pids.keyAt(i), null, null);
        }
        if (totalMem < 0) {
            return 0;
        }
    ...
    public String getCurrentActivityName() {
        ...
        return activityInfo.getComponentName().getClassName();
    }

    /* access modifiers changed from: private */
    public void processCameraOpen(String packageName, int uid, String activityName) {
    ...
    /* access modifiers changed from: private */
    public void handleCameraOpen(Bundle bundle) {
        AwareLog.d(TAG, "handleCameraOpen handle open camera event");
        if (bundle == null) {
            AwareLog.d(TAG, "handleCameraOpen bundle is null");
            return;
        }
        String packageName = bundle.getString("packageName");
        if (packageName == null || "".equals(packageName)) {
            AwareLog.d(TAG, "handleCameraOpen packageName is null or empty");
            return;
        }
        String activityName = bundle.getString("activityName");
        if (activityName == null || "".equals(activityName)) {
            AwareLog.d(TAG, "handleCameraOpen activityName is null or empty");
            return;
        }
        int uid = bundle.getInt("uid");
        if (uid <= 0) {
            AwareLog.d(TAG, "handleCameraOpen uid <=0");
            return;
        }
    ...
    private boolean checkOverTime(String activityName) {
        ...
        if (beginTime != 0) {
            ...
            if (duringTime > 500) {
                AwareLog.e(TAG, "the time between the activity and open camera: " + duringTime);
    ...
    /* access modifiers changed from: private */
    public void processCameraClose(String appName, int uid) {
    ...
    public void removeUidFromBigMemMap(int uninstallApkUid, String pkgName) {
        ...
        if (!this.mIsBigMemFeatureOn) {
            ...
            AwareLog.d(TAG, "removeUidFromBigMemMap paras error");
        } else {
            Bundle bundle = new Bundle();
    ...
    /* access modifiers changed from: private */
    public void handleRemoveUidFromBigMemMap(Bundle bundle) {
        if (bundle == null) {
            AwareLog.d(TAG, "handleRemoveUidFromBigMemMap bundle is null");
            return;
        }
    ...
    /* access modifiers changed from: private */
    public void handleActivityBegin(Bundle bundle) {
    ...
    /* access modifiers changed from: private */
    public void handleActivityFinish(Bundle bundle) {
        if (bundle == null) {
    ...
    class AppOpsListener implements AppOpsManager.OnOpActiveChangedListener {
        AppOpsListener() {
        }
