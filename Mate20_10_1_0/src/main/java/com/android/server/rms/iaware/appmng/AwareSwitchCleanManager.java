...
public class AwareSwitchCleanManager {
    ...
    public AtomicBoolean mFeatureEnable = new AtomicBoolean(false);
    ...
    IUserSwitchObserver mUserSwitchObserver = new IUserSwitchObserver.Stub() {
    ...
    private AwareSwitchCleanManager() {
    }
    ...
    public void enable(Context context) {
        ...
        Looper bgLooper = BackgroundThread.get().getLooper();
        if (bgLooper == null) {
            AwareLog.w(TAG, "bgLooper is null!");
            return;
        }
        if (this.mSwitchHandler == null) {
            this.mSwitchHandler = new SwitchHandler(bgLooper);
        }
    ...
    /* access modifiers changed from: private */
    public void sendMessage(int msgType, Object key, long delay) {
    ...
    private class SwitchHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            int i = msg.what;
            if (i == 1) {
                AwareSwitchCleanManager.this.initAppSwitch(msg.obj);
            } else if (i == 2) {
    ...
    /* access modifiers changed from: private */
    public void updateSwitchStatus(Object obj) {
        ...
        if (obj != null) {
            ...
            } else if ((obj instanceof Integer) && (procInfo = ProcessInfoCollector.getInstance().getProcessInfo(((Integer) obj).intValue())) != null && procInfo.mProcessName != null) {
                if ("com.android.settings".equals(procInfo.mProcessName)) {
                    this.mHasCleanApps = true;
                    sendMessage(2, null, 5000);
                    AwareLog.d(TAG, "updateSwitchStatus clean apps by fg change:" + procInfo.mProcessName);
                    return;
                }
                SwitchInfo switchInfo2 = this.mSwitchInfos.get(procInfo.mProcessName);
                if (switchInfo2 != null && switchInfo2.getHasActivity() == 1) {
                    this.mHasCleanApps = true;
                    sendMessage(2, null, 5000);
                    AwareLog.d(TAG, "updateSwitchStatus clean apps by fg change:" + procInfo.mProcessName);
                }
    ...
    private boolean isRecentTaskAssociate(SwitchInfo switchInfo) {
        ...
        if (hwActivityManagerService == null || (taskInfoList = hwActivityManagerService.getRecentTasks(100, 1, this.mCurSwitchUser).getList()) == null) {
            return true;
        }
    ...
    /* access modifiers changed from: private */
    public void initAppSwitch(Object obj) {
        if (obj != null && (obj instanceof Integer)) {
            this.mCurSwitchUser = ((Integer) obj).intValue();
    ...
    private boolean fetchSwitchStatus(int type, String name, String switchNum) {
        ...
        if (type == 1) {
            switchStatusStr = Settings.System.getStringForUser(context.getContentResolver(), name, this.mCurSwitchUser);
        } else if (type == 2) {
            switchStatusStr = Settings.Secure.getStringForUser(context.getContentResolver(), name, this.mCurSwitchUser);
        } else if (type == 3) {
            switchStatusStr = Settings.Global.getStringForUser(context.getContentResolver(), name, this.mCurSwitchUser);
        }
        ...
        if (this.mSettingsObserver != null && this.mContext != null) {
            ...
            for (SwitchInfo switchInfo : this.mSwitchInfos.values()) {
                if (!(switchInfo == null || (uri = fetchSwitchUri(switchInfo.getType(), switchInfo.getName())) == null || uriList.contains(uri.toString()))) {
                    ...
                    this.mContext.getContentResolver().registerContentObserver(uri, false, this.mSettingsObserver, this.mCurSwitchUser);
                }
            }
        }
    }
