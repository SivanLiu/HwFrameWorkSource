...
class AppHiberRadar {
    ...
    private static String sStatisticSubType = "apphibernation";
    private static int sStatisticTypeExec = 2;
    private ArrayList<DumpData> mDumpData = new ArrayList<>();
    private StatisticsData mStatisticsData = new StatisticsData(sAppHiberFeatureId, sStatisticTypeExec, sStatisticSubType, 0, 0, 0, 0, 0);
