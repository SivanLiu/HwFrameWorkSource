...
public class SceneRecogFeature extends RFeature {
    ...
    private IHwActivityNotifierEx mActivityNotifierEx = new IHwActivityNotifierEx() {
        ...
        public void call(Bundle extras) {
            if (SceneRecogFeature.mIsEnable && extras != null) {
    ...
    /* access modifiers changed from: private */
    public void activityStateChanged(int pid, int uid, ComponentName componentName, int event) {
        if (componentName != null) {
            Bundle bundle = new Bundle();
            bundle.putInt(DATA_PID, pid);
            bundle.putInt("uid", uid);
            bundle.putString("pkgName", componentName.getPackageName());
