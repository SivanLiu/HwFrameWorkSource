...
public class AbsMemoryExecutor {
    ...
    public void checkCPUStatus(MemoryScenePolicy policy, long mAvailable, Bundle extras) {
        CpuResult cpuResult = calculateCPUStatus(policy, mAvailable);
