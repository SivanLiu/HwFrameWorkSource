...
public final class BigDataStore extends BigDataSupervisor {
    ...
    public void getMeminfoAllocCount() {
        ...
        try {
            ...
            while (i < length) {
                try {
                    String[] temp = totalAllocCount[i].split(AwarenessInnerConstants.COLON_KEY);
                    if (temp.length == 2) {
    ...
    public String creatJsonStr() {
        ...
        return "[iAwareMemoryRTStatis_Start]" + MemoryConstant.LINE_SEPARATOR + "{" + MemoryConstant.LINE_SEPARATOR + "\"" + "memoryAllocateCount" + "\"" + AwarenessInnerConstants.COLON_KEY + memoryAllocateJson.toString() + "," + MemoryConstant.LINE_SEPARATOR + "\"" + "memoryControlAndLMKCount" + "\"" + AwarenessInnerConstants.COLON_KEY + memoryControlAndLMKJson.toString() + "," + MemoryConstant.LINE_SEPARATOR + "\"" + "availMemoryTimeCount" + "\"" + AwarenessInnerConstants.COLON_KEY + availMemoryTimeJson.toString() + "," + MemoryConstant.LINE_SEPARATOR + "}" + MemoryConstant.LINE_SEPARATOR + "[iAwareMemoryRTStatis_End]";
    }
