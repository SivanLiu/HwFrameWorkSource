...
public class AwareNetQosSchedManager {
    ...
    private static final int VPN_STOP = 0;
    private static final int VPN_WORKING = 1;
    private static AwareNetQosSchedManager mInstance = null;
    private static final Object mLock = new Object();
    private static boolean mNetQosSchedSwitch = false;
    ...
    public static AwareNetQosSchedManager getInstance() {
        ...
        synchronized (mLock) {
            if (mInstance == null) {
                mInstance = new AwareNetQosSchedManager();
            }
            awareNetQosSchedManager = mInstance;
        }
    ...
    /* access modifiers changed from: private */
    public void setNetQosLowLimit(boolean enable) {
    ...
    private class AwareNetQosSchedHandler extends Handler {
