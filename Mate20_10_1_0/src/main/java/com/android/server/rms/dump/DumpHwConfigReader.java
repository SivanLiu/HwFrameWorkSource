...
public final class DumpHwConfigReader extends Assert {
    ...
    /* JADX INFO: Multiple debug info for r3v6 android.rms.config.ResourceConfig[]: [D('expect1' android.rms.config.ResourceConfig[]), D('i' int)] */
    /* JADX INFO: Multiple debug info for r7v9 android.rms.config.ResourceConfig[]: [D('expect2' android.rms.config.ResourceConfig[]), D('i' int)] */
    /* JADX INFO: Multiple debug info for r8v11 android.rms.config.ResourceConfig[]: [D('expect3' android.rms.config.ResourceConfig[]), D('i' int)] */
    /* JADX INFO: Multiple debug info for r9v13 android.rms.config.ResourceConfig[]: [D('expect4' android.rms.config.ResourceConfig[]), D('i' int)] */
    /* JADX INFO: Multiple debug info for r10v12 android.rms.config.ResourceConfig[]: [D('expect6' android.rms.config.ResourceConfig[]), D('i' int)] */
    /* JADX INFO: Multiple debug info for r11v13 android.rms.config.ResourceConfig[]: [D('expect7' android.rms.config.ResourceConfig[]), D('i' int)] */
    private static final void dumpGetResConfig() {
        ResourceConfig[] expect = {new ResourceConfig(0, 20, 2, 0, 1000, "APP_THIRDPARTY", 30, 40, 50, 0), new ResourceConfig(1, 50, 2, 3, 1000, "APP_HW", 30, 40, 50, 0), new ResourceConfig(2, 200, 2, 1, 1000, "APP_SYS", 30, 40, 50, 0), new ResourceConfig(3, 300, 2, 2, 1000, "APP_TOTAL", 30, 40, 50, 0)};
        for (int i = 0; i < 4; i++) {
        ...
        ResourceConfig[] expect2 = {new ResourceConfig(0, 200, 2, 0, 1000, "APP_THIRDPARTY", 30, 40, 50, 0), new ResourceConfig(1, 500, 2, 0, 1000, "APP_HW", 30, 40, 50, 0), new ResourceConfig(2, 1000, 1, 0, 0, "APP_SYS", 30, 40, 50, 0), new ResourceConfig(3, 3000, 2, 0, 0, "APP_TOTAL", 30, 40, 50, 0)};
        ...
        ResourceConfig[] expect3 = {new ResourceConfig(0, 50, 1, 0, 5000, "APP_THIRDPARTY", 30, 40, 50, 0), new ResourceConfig(1, 100, 1, 0, 5000, "APP_HW", 30, 40, 50, 0), new ResourceConfig(2, 200, 1, 0, 5000, "APP_SYS", 30, 40, 50, 0), new ResourceConfig(3, 800, 1, 0, 5000, "APP_TOTAL", 30, 40, 50, 0)};
        ...
        ResourceConfig[] expect4 = {new ResourceConfig(0, 200, 1, 0, 0, "APP_THIRDPARTY", -1, -1, -1, 0)};
        ...
        ResourceConfig[] expect7 = {new ResourceConfig(0, 50, 2, 0, 60000, "APP_THIRDPARTY", 30, 40, 50, 0), new ResourceConfig(1, 50, 2, 0, 60000, "APP_HW", 30, 40, 50, 0), new ResourceConfig(2, 200, 1, 0, 60000, "APP_SYS", 30, 40, 50, 0), new ResourceConfig(3, 1000, 1, 0, 60000, "APP_TOTAL", 30, 40, 50, 0)};
