...
public class NetManager {
    ...
    private class AwareVisibleCallback implements AwareAppAssociate.IAwareVisibleCallback {
        ...
        @Override // com.android.server.rms.iaware.appmng.AwareAppAssociate.IAwareVisibleCallback
        public void onVisibleWindowsChanged(int type, int pid, int mode) {
            if (NetManager.this.mEnable) {
                ...
                data.putInt("pid", pid);
                data.putInt(NetManager.MODE_STR, mode);
                msg.setData(data);
    ...
    private class AwareToastCallback implements AwareIntelligentRecg.IAwareToastCallback {
        ...
        @Override // com.android.server.rms.iaware.appmng.AwareIntelligentRecg.IAwareToastCallback
    ...
    public class NetManagerHandler extends Handler {
        ...
        /* JADX INFO: Multiple debug info for r0v1 int: [D('bgPid' int), D('fgPid' int)] */
        /* JADX INFO: Multiple debug info for r0v2 int: [D('bgPid' int), D('diedPid' int)] */
        /* JADX INFO: Multiple debug info for r0v3 int: [D('dlUid' int), D('diedPid' int)] */
        /* JADX INFO: Multiple debug info for r0v4 int: [D('dlUid' int), D('audioUid' int)] */
        /* JADX INFO: Multiple debug info for r0v5 int: [D('visData' android.os.Bundle), D('audioUid' int)] */
        /* JADX INFO: Multiple debug info for r0v7 int: [D('enable' int), D('toastMsg' int)] */
        public void handleMessage(Message msg) {
            ...
            if (i == 0) {
                ...
                NetManager.this.appendVisiblePid(visData.getInt("type"), visData.getInt("pid"), visData.getInt(NetManager.MODE_STR), 1);
            } else if (i == 11) {
                NetManager.this.appendVisiblePid(msg.arg1, msg.arg2, -1, 2);
            } else if (i != 12) {
                AwareLog.e(NetManager.TAG, "error msg what = " + msg.what);
            } else if (NetManager.this.mEnable) {
                int enable = msg.arg1;
                int mode = msg.arg2;
