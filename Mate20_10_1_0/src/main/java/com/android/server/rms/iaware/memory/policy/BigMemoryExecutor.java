...
public class BigMemoryExecutor extends AbsMemoryExecutor {
    ...
    public BigMemoryExecutor() {
        ...
        this.mBigMemAppExecutor = new ThreadPoolExecutor(0, 1, (long) THREAD_POOL_ALIVE_TIME, TimeUnit.SECONDS, new LinkedBlockingQueue(1), new MemThreadFactory("iaware.mem.bigmem"));
    }
