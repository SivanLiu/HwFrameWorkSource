...
public final class AwareSceneRecognize {
    ...
    /* access modifiers changed from: private */
    public void notifyStateChange(int sceneType, int eventType, String pkgName) {
        if (sDebug) {
            AwareLog.d(TAG, "SceneRec sceneType :" + sceneType + ", eventType:" + eventType + ", pkg=" + pkgName);
        }
        synchronized (this.mCallbacks) {
            if (!this.mCallbacks.isEmpty()) {
                for (Map.Entry<IAwareSceneRecCallback, Integer> m : this.mCallbacks.entrySet()) {
                    IAwareSceneRecCallback callback = m.getKey();
                    int state = m.getValue().intValue();
    ...
    /* access modifiers changed from: private */
    public void handleActivityStartingFinish(String pkg) {
    ...
    /* access modifiers changed from: private */
    public void hanldeCameraOperation(Message msg) {
    ...
    /* access modifiers changed from: private */
    public void handleGalleryOperation(Message msg) {
        Bundle bundle = msg.getData();
        if (bundle != null) {
            int uid = bundle.getInt("uid", -1) % 100000;
            if (uid == -1 || !this.mValidApp.containsKey(Integer.valueOf(uid))) {
    ...
    /* access modifiers changed from: private */
    public void handleProximitySensor(Message msg) {
        Bundle bundle = msg.getData();
        if (bundle != null) {
    ...
    /* access modifiers changed from: private */
    public void handleSkippedFrame(Message msg) {
        if (msg.getData() != null) {
    ...
    /* access modifiers changed from: private */
    public void handleActivityBegin(Message msg) {
    ...
    /* access modifiers changed from: private */
    public void handleActivityFinish(Message msg) {
        Bundle data = msg.getData();
        if (data != null) {
    ...
    public static void enable() {
        mEnabled = true;
        AwareSceneRecognize awareSceneRecognize = mAwareSceneRecognize;
