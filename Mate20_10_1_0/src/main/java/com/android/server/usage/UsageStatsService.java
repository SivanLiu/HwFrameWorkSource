                                        ...
                                        if (!"file".equals(arg)) {
                                            if (!"database-info".equals(arg)) {
                                                ...
                                                if (i + 1 >= args.length) {
                                                    ...
                                                    for (int user = 0; user < numUsers; user++) {
                                                        ...
                                                        ipw.increaseIndent();
                                                        this.mUserState.valueAt(user).dumpDatabaseInfo(ipw);
                                                        ipw.decreaseIndent();
                                                    }
                                                } else {
                                                    try {
                                                        ...
                                                        this.mUserState.get(user2).dumpDatabaseInfo(ipw);
                                            ...
                                            if (i + 1 >= args.length) {
                                                ...
                                                for (int user3 = 0; user3 < numUsers2; user3++) {
                                                    ...
                                                    ipw2.increaseIndent();
                                                    this.mUserState.valueAt(user3).dumpFile(ipw2, null);
                                                    ipw2.decreaseIndent();
                                                }
                                            } else {
                                                try {
                                                    ...
                                                    if (this.mUserState.indexOfKey(user4) < 0) {
                                                        ...
                                                        this.mUserState.get(user4).dumpFile(ipw2, (String[]) Arrays.copyOfRange(args, i + 2, args.length));
                                                    }
                ...
                if (i == 1) {
                    ...
                    synchronized (UsageStatsService.this.mUidToKernelCounter) {
                        if (newCounter != UsageStatsService.this.mUidToKernelCounter.get(uid, 0)) {
                            ...
                            try {
                                FileUtils.stringToFile(UsageStatsService.KERNEL_COUNTER_FILE, uid + HwLog.PREFIX + newCounter);
                            } catch (IOException e) {
