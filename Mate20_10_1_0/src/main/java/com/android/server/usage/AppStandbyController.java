...
public class AppStandbyController {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r15v0, resolved type: int */
    /* JADX DEBUG: Multi-variable search result rejected for r15v1, resolved type: int */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r15v6, resolved type: int */
    /* JADX DEBUG: Multi-variable search result rejected for r15v7, resolved type: int */
    /* JADX DEBUG: Multi-variable search result rejected for r10v0, resolved type: com.android.server.usage.AppIdleHistory */
    /* JADX DEBUG: Multi-variable search result rejected for r15v9, resolved type: int */
    /* JADX DEBUG: Multi-variable search result rejected for r15v12, resolved type: int */
    ...
    /* JADX INFO: Multiple debug info for r2v7 int[]: [D('res' int[]), D('i' int)] */
    /* access modifiers changed from: package-private */
    ...
    static class Injector {
        ...
        public boolean isAppIdleEnabled() {
            return this.mContext.getResources().getBoolean(17891432) && (Settings.Global.getInt(this.mContext.getContentResolver(), "app_standby_enabled", 1) == 1 && Settings.Global.getInt(this.mContext.getContentResolver(), "adaptive_battery_management_enabled", 1) == 1);
        }
