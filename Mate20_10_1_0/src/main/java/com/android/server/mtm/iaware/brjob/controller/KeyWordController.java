...
public class KeyWordController extends AwareStateController {
    ...
    /* JADX INFO: Multiple debug info for r4v7 java.lang.String: [D('filterValue' java.lang.String), D('value' java.lang.String)] */
    private void checkKeyword(AwareJobStatus job) {
        String filterValue;
        String filterValue2 = job.getActionFilterValue("KeyWord");
        if (this.DEBUG) {
            AwareLog.i(TAG, "iaware_brjob checkKeyword: " + filterValue2);
        }
        ...
        String[] keywords = filterValue2.split("[\\[\\]]");
        ...
        while (i < keywords.length) {
            ...
            } else if (AwarenessInnerConstants.COLON_KEY.equals(keywords[i].trim())) {
                filterValue = filterValue2;
            } else {
    ...
    public static boolean matchReg(String key, String type, String value, Intent intent) {
        KeyWordController keyWordController;
        if (key == null || type == null || value == null || intent == null || (keyWordController = mSingleton) == null) {
            return false;
        }
