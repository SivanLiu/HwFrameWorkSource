...
public class BarStatusController extends AwareStateController {
    ...
    private BroadcastReceiver mBarStatusReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent != null && BarStatusController.INTENT_STATUSBAR_VISIBLE_CHANGE.equals(intent.getAction())) {
    ...
    public String mIsVisible = AwareJobSchedulerConstants.BAR_STATUS_OFF;
    /* access modifiers changed from: private */
    @GuardedBy({"mLock"})
    ...
    /* access modifiers changed from: private */
    public void updateBarVisible(Intent intent) {
        if (intent != null) {
