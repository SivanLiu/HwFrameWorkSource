...
public class AwareJobSchedulerService implements AwareStateChangedListener {
        ...
        public void handleMessage(Message message) {
            switch (message.what) {
                case 400:
                    ...
                    return;
                case AwareJobSchedulerService.MSG_JOB_EXPIRED /*{ENCODED_INT: 401}*/:
                    ...
                    return;
                case AwareJobSchedulerService.MSG_CHECK_JOB /*{ENCODED_INT: 402}*/:
                    AwareJobSchedulerService.this.maybeQueueReadyJobsForExecution();
                    return;
                case AwareJobSchedulerService.MSG_REMOVE_JOB /*{ENCODED_INT: 403}*/:
                    synchronized (AwareJobSchedulerService.this.mLock) {
                        AwareJobSchedulerService.this.stopTrackingJobLocked((AwareJobStatus) message.obj);
                    }
                    return;
                case AwareJobSchedulerService.MSG_CONTROLLER_CHANGED /*{ENCODED_INT: 404}*/:
    ...
    /* access modifiers changed from: private */
    public void scheduleJob(AwareJobStatus jobStatus) {
    ...
    /* access modifiers changed from: private */
    public void controllerStateChanged(List<AwareJobStatus> jobList) {
        if (this.DEBUG) {
        ...
        synchronized (this.mLock) {
            ...
            for (int i = 0; i < listSize; i++) {
                AwareJobStatus job = jobList.get(i);
    ...
    /* access modifiers changed from: private */
    public void cancelJobsForPkgLocked(String packageName) {
        synchronized (this.mLock) {
            ...
            for (int i = length; i > 0; i--) {
                AwareJobStatus jobStatus = this.mJobs.get(i - 1);
    ...
    /* access modifiers changed from: private */
    public void stopTrackingJobLocked(AwareJobStatus jobStatus) {
        if (this.DEBUG) {
    ...
    /* access modifiers changed from: private */
    public void maybeQueueReadyJobsForExecution() {
        if (this.DEBUG) {
    ...
    public void dump(PrintWriter pw, String[] args) {
        if (pw != null && args != null) {
            if (args.length < 3 || args[2] == null) {
                dumpAllJobs(pw);
            } else if (AwarenessConstants.DATA_ACTION_TYPE.equals(args[2])) {
