...
public class AwareNativeFreezeManager {
    ...
    /* access modifiers changed from: private */
    public AtomicBoolean mIsScreenOn = new AtomicBoolean(false);
    /* access modifiers changed from: private */
    public AtomicBoolean mIsSilde = new AtomicBoolean(false);
    ...
    /* access modifiers changed from: private */
    public void processNativeEvent(int eventType, CollectData data) {
        Bundle bundle;
    ...
    private void processInstallerEvent(int eventType, Bundle bundle) {
        ...
        if (eventId == 0 || eventId == 1) {
            ...
            int status = bundle.getInt(HwMultiWinConstants.STATUS_KEY_STR, 0);
    ...
    public void doFrozenForInstall(BaseInfo info) {
        if (info != null) {
            ...
            if (this.mLastSceneEvent != 13 || !this.mIsSilde.get() || !isUserActivity(this.mSlideFrozenDuration)) {
                int i = this.mLastSceneEvent;
                if (i == 0 || i == 13 || !isUserActivity(this.mShortFrozenDurtion)) {
