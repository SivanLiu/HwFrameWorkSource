...
public class AwareBroadcastSend {
    ...
    private void updateWifiSCConfigData(ArrayList<String> configs) {
        String cf0;
        if (configs.size() != 0 && (cf0 = configs.get(0)) != null) {
            try {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:57:0x00fd, code lost:
        android.rms.iaware.AwareLog.i(com.android.server.mtm.iaware.srms.AwareBroadcastSend.TAG, "battery br summary (skip,total,mainFactorChange,maxCVBigChange,volBigChange,abnormalTemp,normalTempBigChange): " + getBatteryStatisticsData());
     */
    ...
    public HashMap<String, String> getStatisticsData() {
        ...
        data.put(SmartDualCardConsts.SYSTEM_STATE_NAME_WIFI_NETWORK_STATE_CHANGED, getWifiStateChangeStatisticsData());
        return data;
    }
