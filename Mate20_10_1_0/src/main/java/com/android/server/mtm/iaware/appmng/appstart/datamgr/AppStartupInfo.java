...
public class AppStartupInfo {
    ...
    public WindowProcessController callerApp;
    ...
    public WindowProcessController targetApp;
    ...
    public AppStartupInfo setCallerApp(WindowProcessController callerApp2) {
    ...
    public AppStartupInfo setTargetApp(WindowProcessController targetApp2) {
