...
final class UiModeManagerService extends SystemService {
    ...
    /* access modifiers changed from: private */
    public boolean mCarModeEnabled = false;
    ...
    public final IUiModeManager.Stub mService = new IUiModeManager.Stub() {
        ...
        public boolean isUiModeLocked() {
            boolean access$1300;
            synchronized (UiModeManagerService.this.mLock) {
                access$1300 = UiModeManagerService.this.mUiModeLocked;
            }
            return access$1300;
        }
        ...
        public boolean isNightModeLocked() {
            boolean access$1400;
            synchronized (UiModeManagerService.this.mLock) {
                access$1400 = UiModeManagerService.this.mNightModeLocked;
            }
            return access$1400;
        }
    ...
    public void onStart() {
        ...
        this.mEnableCarDockLaunch = res.getBoolean(17891434);
        this.mUiModeLocked = res.getBoolean(17891475);
        this.mNightModeLocked = res.getBoolean(17891474);
    ...
    private void adjustStatusBarCarModeLocked() {
        ...
        if (this.mCarModeEnabled) {
            this.mNotificationManager.notifyAsUser(null, 10, new Notification.Builder(context, SystemNotificationChannels.CAR_MODE).setSmallIcon(17303532).setDefaults(4).setOngoing(true).setWhen(0).setColor(context.getColor(17170460)).setContentTitle(context.getString(17039752)).setContentText(context.getString(17039751)).setContentIntent(PendingIntent.getActivityAsUser(context, 0, new Intent(context, DisableCarModeActivity.class), 0, null, UserHandle.CURRENT)).build(), UserHandle.ALL);
            return;
        }
