...
abstract class HdmiCecLocalDevice {
        ...
        switch (opcode) {
            ...
            default:
                switch (opcode) {
                    ...
                    case HdmiCecKeycode.CEC_KEYCODE_F1_BLUE:
                        return handleGiveAudioStatus(message);
                    case HdmiCecKeycode.CEC_KEYCODE_F2_RED:
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v3, resolved type: java.util.List<T extends com.android.server.hdmi.HdmiCecFeatureAction> */
    /* JADX DEBUG: Multi-variable search result rejected for r0v7, resolved type: java.util.List<T extends com.android.server.hdmi.HdmiCecFeatureAction> */
    /* JADX DEBUG: Multi-variable search result rejected for r0v9, resolved type: java.util.ArrayList */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r2v2, types: [com.android.server.hdmi.HdmiCecFeatureAction, java.lang.Object] */
    /* access modifiers changed from: package-private */
    @HdmiAnnotations.ServiceThreadOnly
    public <T extends HdmiCecFeatureAction> List<T> getActions(Class<T> clazz) {
        List<T> actions;
        assertRunOnServiceThread();
        List<T> actions2 = Collections.emptyList();
        Iterator<HdmiCecFeatureAction> it = this.mActions.iterator();
        while (it.hasNext()) {
