...
public final class HdmiCecLocalDeviceTv extends HdmiCecLocalDevice {
    ...
    /* access modifiers changed from: package-private */
    @HdmiAnnotations.ServiceThreadOnly
    public void updateActiveSource(ActiveSource newActive) {
        assertRunOnServiceThread();
    ...
    public boolean handleReportPhysicalAddress(HdmiCecMessage message) {
        ...
        startNewDeviceAction(ActiveSource.of(address, path), b);
        return true;
    }
    ...
    /* access modifiers changed from: package-private */
    public void startNewDeviceAction(ActiveSource activeSource, int deviceType) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x003a, code lost:
        if (r2.isEmpty() == false) goto L_0x0050;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0038, code lost:
        ...
        sendUserControlPressedAndReleased(getAvrDeviceInfo().getLogicalAddress(), com.android.server.hdmi.HdmiCecKeycode.getMuteKey(r4));
     */
    ...
    @Override // com.android.server.hdmi.HdmiCecLocalDevice
    @HdmiAnnotations.ServiceThreadOnly
    public void disableDevice(boolean initiatedByCec, PendingActionClearedCallback callback) {
        assertRunOnServiceThread();
