...
public class HwLocationLockManager {
    ...
    private static HwLocationLockManager mInstance = null;
    ...
    private BroadcastReceiver mPackegeClearReceiver = new BroadcastReceiver() {
        ...
        private boolean explicitlyStopped(String packageName) {
            ...
            try {
                ...
                if (applicationInfo == null || (applicationInfo.flags & HighBitsCompModeID.MODE_EYE_PROTECT) == 0) {
                    return false;
                }
                return true;
    ...
    public static HwLocationLockManager getInstance(Context context) {
        ...
        synchronized (LOCK) {
            if (mInstance == null) {
                mInstance = new HwLocationLockManager(context);
            }
            hwLocationLockManager = mInstance;
        }
    ...
    private void finalCheck() {
        ...
        if (isNeedCheckAgain) {
            ...
            if (!locationHandler.hasMessages(7)) {
                locationHandler.sendEmptyMessageDelayed(7, 300000);
            }
        }
    }
