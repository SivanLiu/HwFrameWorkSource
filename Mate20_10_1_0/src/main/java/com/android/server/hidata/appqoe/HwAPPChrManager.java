    ...
    public void uploadAppChrInfo() {
        ...
        synchronized (this.mLock) {
            if (isCommercialUser()) {
                ...
                HwAPPQoEUtils.logD(HwAPPQoEUtils.TAG, false, "uploadAppChrInfo is a Commercial User ", new Object[0]);
            } else {
                uploadTime = 86400000;
                HwAPPQoEUtils.logD(HwAPPQoEUtils.TAG, false, "uploadAppChrInfo is a beta User ", new Object[0]);
            }
            ...
            if ((this.mLastUploadTime == 0 || System.currentTimeMillis() - this.mLastUploadTime > uploadTime) && this.mInfoList.size() > 0) {
                HwAPPQoEUtils.logD(HwAPPQoEUtils.TAG, false, "uploadAppChrInfo mInfoList.size() = %{public}d", Integer.valueOf(this.mInfoList.size()));
