...
public class HwAPPQoEGameCallback extends Binder implements IInterface {
    private static final long CACHE_WAR_TIME = 1000;
    ...
    public void resolveCallBackData(String info) {
        ...
        try {
            ...
            if (mGameStateInfo == null) {
                ...
                if (hashCode != 48) {
                    switch (hashCode) {
                        case TagID.TAG_COUNT /*{ENCODED_INT: 53}*/:
                        ...
                        case 54:
                            ...
                            break;
                        case WMStateCons.MSG_LEAVE_FREQ_LOCATION_TOOL /*{ENCODED_INT: 55}*/:
    ...
    public void handleGameStateChange(GameStateInfo gameStateInfo) {
        ...
        if (!this.lastAPPStateInfo.isObjectValueEqual(curAPPStateInfo) || gameStateInfo.prevState != gameStateInfo.curState) {
            ...
            if (tempState != -1) {
                if (isCurrentForegroundAppByUid(gameStateInfo.curUID)) {
    ...
    public static boolean isHasGameCacheWarInfo(int uid) {
        if (uid != sCacheWarUid || sCacheWarTime == 0 || SystemClock.elapsedRealtime() - sCacheWarTime > 1000) {
            return false;
        }
        return true;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0030, code lost:
        r2 = r7.mHwAPPQoEResourceManger.checkIsMonitorGameScence(r8);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x0036, code lost:
        if (r2 == null) goto L_0x005d;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0038, code lost:
        r0 = new com.android.server.hidata.appqoe.HwAPPQoEGameCallback.GameStateInfo(r2.mGameId, r8);
        com.android.server.hidata.appqoe.HwAPPQoEUtils.logD(com.android.server.hidata.appqoe.HwAPPQoEGameCallback.TAG, false, "getGameStateByName, generate new gamestateinfo instance", new java.lang.Object[0]);
        r0.setGameSpecialInfoSources(r2.getGameSpecialInfoSources());
        r5 = r7.mGameListLock;
     */
