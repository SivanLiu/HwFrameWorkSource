...
public class ParameterInfo {
    ...
    private int appThresholdDurationMin = 120000;
    ...
    private float minUnknownRatioUpd = 0.1f;
    ...
    public ParameterInfo(boolean isMainAp2) {
        ...
        this.mMaxRawDataCount = DEFAULT_TRAIN_MAX_RAW_DATA_COUNT;
    }
