                ...
                if (userExpValue != null) {
                    ...
                    if (this.historyUserExpEstream != null) {
                        if (this.spaceNetworkGroupEstream != null) {
                            ...
                            this.spaceNetworkGroupEstream.setParam("name", userExpValue.getString(KEY_NETWORK_NAME));
                ...
                if (appQoeValue != null) {
                    ...
                    if (this.historyAppQoeEstream != null) {
                        if (this.spaceNetworkGroupEstream != null) {
                            ...
                            this.spaceNetworkGroupEstream.setParam("name", appQoeValue.getString(KEY_NETWORK_NAME));
