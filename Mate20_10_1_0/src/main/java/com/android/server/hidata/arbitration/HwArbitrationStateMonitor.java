...
public class HwArbitrationStateMonitor {
    ...
    public boolean isMobileConnectState = false;
    ...
    /* access modifiers changed from: private */
    public Map<Integer, SignalStrength> mPhoneSignalStrength = new ArrayMap();
    /* access modifiers changed from: private */
    public Map<Integer, PhoneStateListener> mPhoneStateListeners = new ArrayMap();
    /* access modifiers changed from: private */
    ...
    private class StateBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("android.net.wifi.WIFI_STATE_CHANGED".equals(action)) {
                ...
                handleTelephonyDataConnectionChanged(intent.getStringExtra(SceneRecogFeature.DATA_STATE), intent.getIntExtra("subscription", -1));
                ...
                if (networkInfo == null) {
                    ...
                    if (800 == i2) {
                        ...
                        if (HwArbitrationStateMonitor.this.mCurrentActiveNetwork != 802) {
                            ...
                            int unused = hwArbitrationStateMonitor.mCurrentActiveNetwork = i;
                    ...
                    if (this.mActiveNetworkInfo.isConnected()) {
                        ...
                        if (800 != HwArbitrationStateMonitor.this.mCurrentActiveNetwork) {
                            int unused2 = HwArbitrationStateMonitor.this.mCurrentActiveNetwork = 800;
                            HwArbitrationStateMonitor.this.mHandler.sendMessage(HwArbitrationStateMonitor.this.mHandler.obtainMessage(HwArbitrationDEFS.MSG_NOTIFY_CURRENT_NETWORK, HwArbitrationStateMonitor.this.mCurrentActiveNetwork, 0));
                        }
        ...
        private void onReceiveDataStateChanged(Intent intent) {
            ...
            if (isDefaultApnType(apnType)) {
                ...
                PhoneConstants.DataState state = Enum.valueOf(PhoneConstants.DataState.class, intent.getStringExtra(SceneRecogFeature.DATA_STATE));
        ...
        private void handleTelephonyDataConnectionChanged(String state, int subId) {
            ...
            if (AwareJobSchedulerConstants.SERVICES_STATUS_CONNECTED.equals(state)) {
                boolean unused = HwArbitrationStateMonitor.this.isMobileConnectState = true;
                ...
                if (802 == HwArbitrationStateMonitor.this.mCurrentActiveNetwork) {
                    int unused2 = HwArbitrationStateMonitor.this.mCurrentActiveNetwork = 801;
                    HwArbitrationStateMonitor.this.mHandler.sendMessage(HwArbitrationStateMonitor.this.mHandler.obtainMessage(HwArbitrationDEFS.MSG_NOTIFY_CURRENT_NETWORK, HwArbitrationStateMonitor.this.mCurrentActiveNetwork, 0));
                }
            } else if ("DISCONNECTED".equals(state)) {
                boolean unused3 = HwArbitrationStateMonitor.this.isMobileConnectState = false;
                ...
                if (801 == HwArbitrationStateMonitor.this.mCurrentActiveNetwork) {
                    int unused4 = HwArbitrationStateMonitor.this.mCurrentActiveNetwork = 802;
                    HwArbitrationStateMonitor.this.mHandler.sendMessage(HwArbitrationStateMonitor.this.mHandler.obtainMessage(HwArbitrationDEFS.MSG_NOTIFY_CURRENT_NETWORK, HwArbitrationStateMonitor.this.mCurrentActiveNetwork, 0));
                }
            }
        }
    ...
    /* access modifiers changed from: private */
    public boolean containSubId(List<SubscriptionInfo> subInfos, int subId) {
        if (subInfos == null) {
