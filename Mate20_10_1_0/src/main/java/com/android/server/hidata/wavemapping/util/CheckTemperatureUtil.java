...
public class CheckTemperatureUtil {
    ...
    public int mCurTemperatureLevel = 0;
    /* access modifiers changed from: private */
    public SdkServiceHandler mHandler = new SdkServiceHandler();
    /* access modifiers changed from: private */
    public Handler mStateMachineHandler = null;
    ...
    /* access modifiers changed from: private */
    public void checkSdkService(int count) {
        if (count > 3) {
        ...
        this.mHandler.sendMessageDelayed(this.mHandler.obtainMessage(101, count + 1, 0), 5000);
    }
    ...
    private class ThermalCallback extends Binder implements IBinder.DeathRecipient {
        ...
        public void binderDied() {
            ...
            if (CheckTemperatureUtil.this.mHandler != null) {
                CheckTemperatureUtil.this.mHandler.sendMessageDelayed(CheckTemperatureUtil.this.mHandler.obtainMessage(101, 1, 0), 5000);
            }
        }
        ...
        private void reportThermalData(int level) {
            ...
            int unused = CheckTemperatureUtil.this.mCurTemperatureLevel = level;
