...
public class HwHiStreamUdpMonitor {
    ...
    public class LocalHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 1) {
                ...
                long unused = HwHiStreamUdpMonitor.this.mFirstRxBytes = this.rxBytesResult;
            }
    ...
    /* access modifiers changed from: private */
    public void sendToArbitration(int badTimes) {
    ...
    /* access modifiers changed from: private */
    public float computeRxRate(long startRxBytes, long endRxBytes) {
