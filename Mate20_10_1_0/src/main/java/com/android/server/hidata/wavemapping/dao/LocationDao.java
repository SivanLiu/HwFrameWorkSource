...
public class LocationDao {
    ...
    public Bundle findChrByFreqLoc(String freqLocation) {
        ...
        try {
            Cursor cursor4 = this.db.rawQuery(sql, args);
            while (cursor4.moveToNext()) {
                try {
                    firstReport = cursor4.getInt(cursor4.getColumnIndexOrThrow(str10));
                    entery = cursor4.getInt(cursor4.getColumnIndexOrThrow(str9));
                    leave = cursor4.getInt(cursor4.getColumnIndexOrThrow(str8));
                    try {
                        duration = cursor4.getInt(cursor4.getColumnIndexOrThrow(str7));
                    } catch (IllegalArgumentException e) {
                        e = e;
                        cursor3 = cursor4;
                ...
                try {
                    spaceChange = cursor4.getInt(cursor4.getColumnIndexOrThrow(str6));
                    spaceLeave = cursor4.getInt(cursor4.getColumnIndexOrThrow(str5));
                    upTotalSwitch = cursor4.getInt(cursor4.getColumnIndexOrThrow(str4));
                    upAutoSucc = cursor4.getInt(cursor4.getColumnIndexOrThrow(str3));
                    upManualSucc = cursor4.getInt(cursor4.getColumnIndexOrThrow(str2));
                    upAutoFail = cursor4.getInt(cursor4.getColumnIndexOrThrow(str));
                    upNoSwitchFail = cursor4.getInt(cursor4.getColumnIndexOrThrow(str12));
                    upQueryCnt = cursor4.getInt(cursor4.getColumnIndexOrThrow(KEY_UP_QUERY_CNT));
                    upResultCnt = cursor4.getInt(cursor4.getColumnIndexOrThrow(KEY_UP_RESULT_CNT));
                    upUnknownDb = cursor4.getInt(cursor4.getColumnIndexOrThrow(KEY_UP_UNKNOWN_DB));
                    upUnknownSpace = cursor4.getInt(cursor4.getColumnIndexOrThrow(str11));
                    lpTotalSwitch = cursor4.getInt(cursor4.getColumnIndexOrThrow(KEY_LP_TOTAL_SWITCH));
                    lpDataRx = cursor4.getInt(cursor4.getColumnIndexOrThrow(KEY_LP_DATA_RX));
                    lpDataTx = cursor4.getInt(cursor4.getColumnIndexOrThrow(KEY_LP_DATA_TX));
                    lpDuration = cursor4.getInt(cursor4.getColumnIndexOrThrow(KEY_LP_DURATION));
                    lpOffset = cursor4.getInt(cursor4.getColumnIndexOrThrow(KEY_LP_OFFSET));
                    lpAlreadyBest = cursor4.getInt(cursor4.getColumnIndexOrThrow(KEY_LP_ALREADY_BEST));
                    lpNotReach = cursor4.getInt(cursor4.getColumnIndexOrThrow(KEY_LP_NOT_REACH));
                    lpBack = cursor4.getInt(cursor4.getColumnIndexOrThrow(KEY_LP_BACK));
                    lpUnknownDb = cursor4.getInt(cursor4.getColumnIndexOrThrow(KEY_LP_UNKNOWN_DB));
                    lpUnknownSpace = cursor4.getInt(cursor4.getColumnIndexOrThrow(str11));
                    cursor = cursor4;
