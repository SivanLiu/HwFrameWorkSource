...
public class HwWMStateMachine extends StateMachine {
    ...
    /* access modifiers changed from: private */
    public RegularPlaceInfo curMainApPlaceInfo = null;
    /* access modifiers changed from: private */
    public RegularPlaceInfo curPlace = null;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public long mLastTrainingTime = 0;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public long mPowerConnectTime = 0;
    ...
    /* access modifiers changed from: private */
    public int substateActivity = 1;
    /* access modifiers changed from: private */
    public int substateLastrecg = 0;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public void setCurrentPreLable(RecognizeResult newResults) {
    ...
    /* access modifiers changed from: private */
    public void updateUserSpaceDbForOtherLoc(boolean isCheckPeriod) {
        ...
        if (isOtherLoc) {
            ...
            if ((now - this.mUpdateDbOtherTime > 86400000 || isCheckPeriod) && this.mCollectUserFingersHandler != null) {
    ...
    class DefaultState extends State {
        ...
        public boolean processMessage(Message message) {
            ...
            if (i == 20) {
                ...
                try {
                    ...
                    if (bundle2 != null) {
                        if (bundle2.get(HwWMStateMachine.KEY_LOCATION) != null) {
                            String curLocation = bundle2.get(HwWMStateMachine.KEY_LOCATION).toString();
                            ...
                            if (HwWMStateMachine.this.curPlace == null || HwWMStateMachine.this.curPlace.getPlace() == null) {
                                ...
                                } else if (HwWMStateMachine.this.curPlace.getPlace() == null) {
                                    HwWMStateMachine.this.transitionTo(HwWMStateMachine.this.mDefaultState);
                                } else if (!HwWMStateMachine.this.curPlace.getPlace().equals(curLocation)) {
                ...
                if (bundle3 == null) {
                    ...
                    HwWMStateMachine.this.mCollectUserFingersHandler.updateAppQoE(bundle3.getString("APPNAME"), bundle3.getInt("QOE"));
                }
            } else if (i == 150) {
                LogUtil.d(false, "into MSG_POWER_CONNECTED", new Object[0]);
                long unused3 = HwWMStateMachine.this.mPowerConnectTime = SystemClock.elapsedRealtime();
            } else if (i != 151) {
                switch (i) {
                    case WMStateCons.MSG_CONNECTIVITY_CHANGE:
                        processConnectivityChanged(message);
                        break;
                    case WMStateCons.MSG_SUPPLICANT_COMPLETE:
                        processSupplicantCompleted();
                        break;
                    case WMStateCons.MSG_CELL_CHANGE:
                    case WMStateCons.MSG_CELL_IN_SERVICE:
                        processCellChanged();
                        break;
                    case WMStateCons.MSG_SIM_STATE_CHANGE:
                        processSimStateChanged();
                        break;
                    case WMStateCons.MSG_CELL_OUT_OF_SERVICE:
                    ...
                    default:
                        switch (i) {
                            ...
                            case 201:
                                ...
                                HwWmpAppInfo mAppInfo2 = (HwWmpAppInfo) message.obj;
                                if (mAppInfo2 != null) {
                                    if (HwWMStateMachine.this.mCollectUserFingersHandler != null) {
                                        HwWMStateMachine.this.mCollectUserFingersHandler.endAppCollect(mAppInfo2);
                                    }
                            ...
                            case 202:
                                ...
                                HwWmpAppInfo mAppInfo3 = (HwWmpAppInfo) message.obj;
                                if (mAppInfo3 != null) {
                                    if (HwWMStateMachine.this.mCollectUserFingersHandler != null) {
                                        HwWMStateMachine.this.mCollectUserFingersHandler.updateAppNetwork(mAppInfo3.getAppName(), mAppInfo3.getConMgrNetworkType());
                                        break;
                                    }
                                } else {
                                    LogUtil.e(false, " no app messages", new Object[0]);
                ...
                long unused4 = HwWMStateMachine.this.mPowerConnectTime = 0;
            }
            return true;
        }
        ...
        private void processCurrentPlaceState() {
            ...
            HwWMStateMachine hwWMStateMachine = HwWMStateMachine.this;
            CollectFingersHandler unused = hwWMStateMachine.collectFingersHandler = new CollectFingersHandler(hwWMStateMachine.mCtx, HwWMStateMachine.this.curPlace.getPlace(), HwWMStateMachine.this.getHandler());
    ...
    /* access modifiers changed from: private */
    public boolean isSatisfiedPowerCondition() {
    ...
    class FrequentLocationState extends State {
        ...
        public void exit() {
            ...
            RegularPlaceInfo unused = HwWMStateMachine.this.curPlace = null;
            HwWMStateMachine.this.mCollectUserFingersHandler.assignSpaceExp2Space(HwWMStateMachine.this.lastSpaceIds, true);
    ...
    public class PositionState extends State {
        ...
        public void exit() {
            ...
            int unused = HwWMStateMachine.this.substateLastrecg = 1;
        }
    }
