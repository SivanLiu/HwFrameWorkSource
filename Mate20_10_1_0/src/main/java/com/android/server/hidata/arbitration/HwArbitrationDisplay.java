...
public class HwArbitrationDisplay {
    ...
    private Notification getNotification(long mobileDateSize, boolean isHigh) {
        ...
        String titleSrc = this.mContext.getResources().getString(33685722);
        String content = this.mContext.getResources().getString(33685721);
        String title = titleSrc.replace("%d", "" + mobileDateSize);
        String suitch = this.mContext.getResources().getString(33685720);
        ...
        Notification.Action action = new Notification.Action.Builder(33751990, suitch, roveInPendingIntent).build();
        if (isHigh) {
    ...
    private void showHiDataHighNotification(long mobileDateSize) {
        if (this.mNotificationManager == null) {
            ...
            if (this.noSetHighChanel) {
                ...
                NotificationChannel highNotificationChannel = new NotificationChannel(NotificationHighChannelTAG, this.mContext.getResources().getString(33685715), 4);
    ...
    private void showHiDataLowNotification(long mobileDateSize) {
        if (this.mNotificationManager == null) {
            ...
            if (this.noSetLowChanel) {
                ...
                this.mNotificationManager.createNotificationChannel(new NotificationChannel(NotificationLowChannelTAG, this.mContext.getResources().getString(33685715), 2));
            }
