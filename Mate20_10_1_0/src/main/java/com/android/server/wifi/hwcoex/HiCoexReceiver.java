...
public class HiCoexReceiver {
    ...
    public int mActiveNetworkType = HiCoexUtils.NETWORK_UNKNOWN;
    ...
    /* access modifiers changed from: private */
    public int mForegroundNetworkType = HiCoexUtils.NETWORK_UNKNOWN;
    /* access modifiers changed from: private */
    public Handler mHandler;
    /* access modifiers changed from: private */
    public List<HiCoexCellularState> mHiCoexCellStates = new ArrayList(5);
    ...
    /* access modifiers changed from: private */
    public Map<Integer, PhoneStateListener> mPhoneStateListeners = null;
    ...
    private class CoexBcastReceiver extends BroadcastReceiver {
        ...
        private void handleNetworkStateChanged(Intent intent) {
            ...
            if (state == NetworkInfo.DetailedState.CONNECTED) {
                ...
                boolean unused = HiCoexReceiver.this.mIsWifiConnected = true;
                ...
                boolean unused2 = HiCoexReceiver.this.mIsWifiConnected = false;
            } else {
        ...
        private void handleWiFiStateChanged(Intent intent) {
            ...
            if (state == 3) {
                boolean unused = HiCoexReceiver.this.mIsWifiConnected = false;
        ...
        private void handleMplinkStateChanged(Intent intent) {
            ...
            if (network == 801) {
                if (HiCoexReceiver.this.mActiveNetworkType == 800) {
                    int unused = HiCoexReceiver.this.mForegroundNetworkType = network;
                } else if (HiCoexReceiver.this.mActiveNetworkType == 801) {
                    int unused2 = HiCoexReceiver.this.mForegroundNetworkType = HiCoexUtils.NETWORK_UNKNOWN;
                } else {
                ...
                int unused3 = HiCoexReceiver.this.mForegroundNetworkType = HiCoexUtils.NETWORK_UNKNOWN;
            } else if (HiCoexReceiver.this.mActiveNetworkType == 801) {
                int unused4 = HiCoexReceiver.this.mForegroundNetworkType = network;
            } else {
                HiCoexUtils.logE(HiCoexReceiver.TAG, "handleMplinkStateChanged active network:" + HiCoexReceiver.this.mActiveNetworkType);
            }
    ...
    private class HiCoexPhoneStateListener extends PhoneStateListener {
            ...
            if (state == 0) {
                ...
                if (HiCoexReceiver.this.mDefaultSubId == this.mSubId.intValue()) {
                    if (HiCoexReceiver.this.mActiveNetworkType == 801) {
                        int unused = HiCoexReceiver.this.mActiveNetworkType = HiCoexUtils.NETWORK_UNKNOWN;
                    }
                    ...
                    synchronized (HiCoexReceiver.this.mLockObj) {
                        HiCoexReceiver.this.mHiCoexCellStates.removeIf(new Predicate(subId) {
                            ...
                            public final boolean test(Object obj) {
                                return CoexSubscriptionListener.lambda$removeDeactivateSubIdListeners$0(this.f$0, (HiCoexCellularState) obj);
                            }
                        });
                    }
                }
            ...
            for (SubscriptionInfo subInfo : subInfos) {
                ...
                if (!HiCoexReceiver.this.mPhoneStateListeners.containsKey(Integer.valueOf(subId))) {
                    if (!HiCoexUtils.isActiveSubId(subId)) {
                        ...
                        HiCoexReceiver.this.mTelephonyManager.listen(listener, 65);
    ...
    private class NrNetworkCallback extends ConnectivityManager.NetworkCallback {
        ...
        public void onCapabilitiesChanged(Network network, NetworkCapabilities networkCapabilities) {
            ...
            if (networkCapabilities.hasTransport(1) && isValidated) {
                ...
                int unused = HiCoexReceiver.this.mActiveNetworkType = HiCoexUtils.NETWORK_WIFI;
            } else if (networkCapabilities.hasTransport(0) && isValidated) {
                HiCoexReceiver hiCoexReceiver2 = HiCoexReceiver.this;
                int unused2 = hiCoexReceiver2.mDefaultSubId = hiCoexReceiver2.getDataSubscriptionId();
                HiCoexUtils.logD(HiCoexReceiver.TAG, "networkType:TRANSPORT_CELLULAR, network: " + network.toString());
                this.mDefaultNetwork = network;
                int unused3 = HiCoexReceiver.this.mActiveNetworkType = HiCoexUtils.NETWORK_CELL;
    ...
    /* access modifiers changed from: private */
    public void updateDataConnection(int subId, int state) {
