...
public class WifiNetworkFactory extends NetworkFactory {
    ...
    public class NetworkFactoryUserSelectionCallback extends INetworkRequestUserSelectionCallback.Stub {
        ...
        public void select(WifiConfiguration wifiConfiguration) {
            WifiNetworkFactory.this.mHandler.post(new Runnable(wifiConfiguration) {
                ...
                public final void run() {
                    NetworkFactoryUserSelectionCallback.this.lambda$select$0$WifiNetworkFactory$NetworkFactoryUserSelectionCallback(this.f$1);
                }
            });
        }
        ...
        public void reject() {
            WifiNetworkFactory.this.mHandler.post(new Runnable() {
                ...
                public final void run() {
                    NetworkFactoryUserSelectionCallback.this.lambda$reject$1$WifiNetworkFactory$NetworkFactoryUserSelectionCallback();
                }
            });
        }
    ...
    /* access modifiers changed from: private */
    public ScanResult findUserApprovedAccessPointForActiveRequestFromActiveMatchedScanResults() {
