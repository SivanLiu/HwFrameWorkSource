...
public class HwHilinkProxyController {
    ...
    public ArrayList<IHwHilinkCallback> mHilinkCallbackList = new ArrayList<>();
    /* access modifiers changed from: private */
    public HilinkServiceProxy mHilinkServiceProxy;
    /* access modifiers changed from: private */
    public boolean mIsConnectInterfaceCalled = false;
    /* access modifiers changed from: private */
    public boolean mIsEnterpriseRouter = false;
    /* access modifiers changed from: private */
    public boolean mIsHilinkAddrFound = false;
    /* access modifiers changed from: private */
    public boolean mIsMasterRouterConnected = false;
    /* access modifiers changed from: private */
    public boolean mIsSlaveRouterConnected = false;
    /* access modifiers changed from: private */
    public final Object mLock = new Object();
    /* access modifiers changed from: private */
    public Set<String> mReferenceSet = new HashSet();
    /* access modifiers changed from: private */
    ...
    private class HwHilinkServiceProxyState implements HilinkServiceProxyState {
        ...
        public void onProxyReady(int state) {
            ...
            boolean unused = hwHilinkProxyController.mIsMasterRouterConnected = z;
            if (state != 0) {
                synchronized (HwHilinkProxyController.this.mLock) {
                    if (HwHilinkProxyController.this.mHilinkServiceProxy != null) {
                        ...
                        HilinkServiceProxy unused2 = HwHilinkProxyController.this.mHilinkServiceProxy = null;
        ...
        private void resetParams() {
            boolean unused = HwHilinkProxyController.this.mIsMasterRouterConnected = false;
            boolean unused2 = HwHilinkProxyController.this.mIsSlaveRouterConnected = false;
            boolean unused3 = HwHilinkProxyController.this.mIsHilinkAddrFound = false;
            boolean unused4 = HwHilinkProxyController.this.mIsConnectInterfaceCalled = false;
            boolean unused5 = HwHilinkProxyController.this.mIsEnterpriseRouter = false;
            String unused6 = HwHilinkProxyController.this.mRemoteHilinkIp = "";
            int unused7 = HwHilinkProxyController.this.mRemoteHilinkPort = -1;
        }
        ...
        public void onProxyLost() {
            ...
            resetParams();
            synchronized (HwHilinkProxyController.this.mLock) {
                HilinkServiceProxy unused = HwHilinkProxyController.this.mHilinkServiceProxy = null;
                HwHilinkProxyController.this.mReferenceSet.clear();
            }
            synchronized (HwHilinkProxyController.this.mLock) {
                Iterator it = HwHilinkProxyController.this.mHilinkCallbackList.iterator();
    ...
    /* access modifiers changed from: private */
    public boolean isNeedConnectCoap(ServiceRecord serviceRecord, String bssid) {
    ...
    private class ConnectCallback extends ConnectResultCallbackWrapper {
        ...
        public void onConnectSuccess(int requestId) throws RemoteException {
            ...
            boolean unused = HwHilinkProxyController.this.mIsSlaveRouterConnected = true;
            boolean unused2 = HwHilinkProxyController.this.mIsConnectInterfaceCalled = false;
            synchronized (HwHilinkProxyController.this.mLock) {
                Iterator it = HwHilinkProxyController.this.mHilinkCallbackList.iterator();
                while (it.hasNext()) {
        ...
        public void onConnectFailed(int requestId, int errorCode) throws RemoteException {
            ...
            boolean unused = HwHilinkProxyController.this.mIsSlaveRouterConnected = false;
            boolean unused2 = HwHilinkProxyController.this.mIsConnectInterfaceCalled = false;
            synchronized (HwHilinkProxyController.this.mLock) {
                Iterator it = HwHilinkProxyController.this.mHilinkCallbackList.iterator();
                while (it.hasNext()) {
    ...
    /* access modifiers changed from: private */
    public int connect(int requestId, String serviceType) {
        ...
        public void onFoundError(int errorCode) throws RemoteException {
            ...
            if (HwHilinkProxyController.this.mIsSlaveRouterConnected || (HwHilinkProxyController.this.mIsHilinkAddrFound && HwHilinkProxyController.this.mIsMasterRouterConnected)) {
                ...
                if (HwHilinkProxyController.this.mIsEnterpriseRouter) {
                    ...
                    boolean unused = HwHilinkProxyController.this.mIsHilinkAddrFound = false;
                    return;
                }
                synchronized (HwHilinkProxyController.this.mLock) {
            ...
            boolean unused2 = HwHilinkProxyController.this.mIsHilinkAddrFound = false;
        }
