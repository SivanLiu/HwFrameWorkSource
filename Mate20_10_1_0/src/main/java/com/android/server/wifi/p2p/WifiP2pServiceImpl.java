...
public class WifiP2pServiceImpl extends AbsWifiP2pService implements IHwWifiP2pServiceInner {
    ...
    /* access modifiers changed from: private */
    public boolean mIsP2pEnabled = false;
    /* access modifiers changed from: private */
    public boolean mIsP2pNotDhcpExpected = false;
    /* access modifiers changed from: private */
    public boolean mIsUserRejectInvitation = false;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public IP2pNotDhcpCallback mP2pNotDhcpCallback = null;
    /* access modifiers changed from: private */
    ...
    static /* synthetic */ byte access$10904(WifiP2pServiceImpl x0) {
    ...
    public WifiP2pServiceImpl(Context context) {
        ...
        this.mThisDevice.primaryDeviceType = this.mContext.getResources().getString(17039895);
        ...
        public void onIpClientCreated(IIpClient ipClient) {
            this.mHandler.post(new Runnable(ipClient) {
                ...
                public final void run() {
                    IpClientCallbacksImpl.this.lambda$onIpClientCreated$0$WifiP2pServiceImpl$IpClientCallbacksImpl(this.f$1);
                }
            });
        }
    ...
    protected class P2pStateMachine extends StateMachine {
            ...
            if (p2pSupported) {
                ...
                this.mWifiNative.registerInterfaceAvailableListener(new HalDeviceManager.InterfaceAvailableForRequestListener() {
                    ...
                    public final void onAvailabilityChanged(boolean z) {
                        P2pStateMachine.this.lambda$new$0$WifiP2pServiceImpl$P2pStateMachine(z);
                    }
                }, getHandler());
                ...
                switch (message.what) {
                    ...
                    case 139287:
                        if (WifiP2pServiceImpl.this.mWifiPermissionsUtil.checkCanAccessWifiDirect(P2pStateMachine.this.getCallingPkgName(message.sendingUid, message.replyTo), message.sendingUid, false)) {
                            ...
                            P2pStateMachine.this.replyToMessage(message, 139288, null);
                            break;
                        }
                    case 139292:
                    ...
                    case 139349:
                        if (!WifiP2pServiceImpl.this.mWifiPermissionsUtil.checkNetworkStackPermission(message.sendingUid)) {
                            ...
                            P2pStateMachine.this.replyToMessage(message, 139350, null);
                            break;
                        } else {
                        ...
                        if (message.obj instanceof Bundle) {
                            ...
                            try {
                                ...
                                if (!(binder == null || message.replyTo == null)) {
                                    ...
                                    String unused4 = P2pStateMachine.this.getClientInfo(message.replyTo, true).mPackageName = pkgName;
                                    break;
                                }
                    ...
                    case 139361:
                        if (WifiP2pServiceImpl.this.mWifiPermissionsUtil.checkCanAccessWifiDirect(P2pStateMachine.this.getCallingPkgName(message.sendingUid, message.replyTo), message.sendingUid, false)) {
                            ...
                            P2pStateMachine.this.replyToMessage(message, 139362, null);
                            break;
                        }
                    case WifiP2pServiceImpl.BLOCK_DISCOVERY /*{ENCODED_INT: 143375}*/:
                        boolean unused5 = WifiP2pServiceImpl.this.mDiscoveryBlocked = message.arg1 == 1;
                        boolean unused6 = WifiP2pServiceImpl.this.mDiscoveryPostponed = false;
                    ...
                    case WifiP2pMonitor.P2P_GROUP_STARTED_EVENT:
                        if (message.obj != null) {
                            WifiP2pGroup unused7 = P2pStateMachine.this.mGroup = (WifiP2pGroup) message.obj;
        ...
        public class P2pDisabledState extends State {
            ...
            private void setupInterfaceFeatures(String interfaceName) {
                if (WifiP2pServiceImpl.this.mContext.getResources().getBoolean(17891592)) {
            ...
            public boolean processMessage(Message message) {
                ...
                if (i != 143376) {
                    ...
                    Map access$3500 = WifiP2pServiceImpl.this.mClientChannelList;
                    ClientInfo clientInfo = (ClientInfo) WifiP2pServiceImpl.this.mClientInfoList.remove((Messenger) access$3500.remove((IBinder) message.obj));
                    if (clientInfo == null) {
                        return true;
                    }
                    P2pStateMachine p2pStateMachine2 = P2pStateMachine.this;
                    ...
                    P2pStateMachine p2pStateMachine3 = P2pStateMachine.this;
                    String unused = p2pStateMachine3.mInterfaceName = p2pStateMachine3.mWifiNative.setupInterface(new HalDeviceManager.InterfaceDestroyedListener() {
                        ...
                        public final void onDestroyed(String str) {
                            P2pDisabledState.this.lambda$processMessage$0$WifiP2pServiceImpl$P2pStateMachine$P2pDisabledState(str);
                        }
            ...
            public boolean processMessage(Message message) {
                ...
                switch (message.what) {
                    ...
                    case WifiP2pServiceImpl.DISABLE_P2P /*{ENCODED_INT: 143377}*/:
                        ...
                        p2pStateMachine16.transitionTo(p2pStateMachine16.mP2pDisablingState);
                        break;
                    case WifiP2pServiceImpl.REMOVE_CLIENT_INFO /*{ENCODED_INT: 143378}*/:
                        if (message.obj instanceof IBinder) {
                            IBinder b = (IBinder) message.obj;
                            P2pStateMachine p2pStateMachine17 = P2pStateMachine.this;
                            p2pStateMachine17.clearClientInfo((Messenger) WifiP2pServiceImpl.this.mClientChannelList.get(b));
                    ...
                    case 147458:
                        ...
                        p2pStateMachine18.transitionTo(p2pStateMachine18.mP2pDisabledState);
                        break;
                    case WifiP2pMonitor.P2P_DEVICE_FOUND_EVENT:
                        if (message.obj != null) {
                    ...
                    case WifiP2pMonitor.P2P_SERV_DISC_RESP_EVENT:
                        if (WifiP2pServiceImpl.this.mVerboseLoggingEnabled) {
                            ...
                            p2pStateMachine19.logd(getName() + " receive service response");
                        }
                        if (message.obj != null) {
        ...
        public class InactiveState extends State {
            ...
            public void enter() {
                ...
                boolean unused = WifiP2pServiceImpl.this.mIsUserRejectInvitation = false;
                WifiP2pServiceImpl.this.setmMagicLinkDeviceFlag(false);
                P2pStateMachine.this.mSavedPeerConfig.invalidate();
                IP2pNotDhcpCallback unused2 = WifiP2pServiceImpl.this.mP2pNotDhcpCallback = null;
                boolean unused3 = WifiP2pServiceImpl.this.mIsP2pNotDhcpExpected = false;
            ...
            public boolean processMessage(Message message) {
                ...
                switch (message.what) {
                    ...
                    case 139277:
                        if (WifiP2pServiceImpl.this.mWifiPermissionsUtil.checkCanAccessWifiDirect(P2pStateMachine.this.getCallingPkgName(message.sendingUid, message.replyTo), message.sendingUid, false)) {
                            boolean unused4 = WifiP2pServiceImpl.this.mAutonomousGroup = true;
                    ...
                    case WifiP2pMonitor.P2P_GO_NEGOTIATION_REQUEST_EVENT:
                        ...
                        if (!P2pStateMachine.this.isConfigInvalid(config3)) {
                            ...
                            boolean unused5 = WifiP2pServiceImpl.this.mAutonomousGroup = false;
                            boolean unused6 = WifiP2pServiceImpl.this.mJoinExistingGroup = false;
                    ...
                    case WifiP2pMonitor.P2P_INVITATION_RECEIVED_EVENT:
                        if (message.obj != null) {
                            ...
                            if (!P2pStateMachine.this.isConfigInvalid(config4)) {
                                ...
                                boolean unused10 = WifiP2pServiceImpl.this.mJoinExistingGroup = true;
        ...
        public class GroupCreatingState extends State {
            ...
            public void enter() {
                ...
                P2pStateMachine p2pStateMachine = P2pStateMachine.this;
                p2pStateMachine.sendMessageDelayed(p2pStateMachine.obtainMessage(WifiP2pServiceImpl.GROUP_CREATING_TIMED_OUT, WifiP2pServiceImpl.access$8104(), 0), (long) groupCreatingWaitTime);
            }
            ...
            public boolean processMessage(Message message) {
                ...
                switch (message.what) {
                    ...
                    case WifiP2pServiceImpl.PEER_CONNECTION_USER_REJECT /*{ENCODED_INT: 143363}*/:
                        ...
                        boolean unused = WifiP2pServiceImpl.this.mIsUserRejectInvitation = true;
                        P2pStateMachine p2pStateMachine5 = P2pStateMachine.this;
            ...
            public boolean processMessage(Message message) {
                ...
                switch (i) {
                        ...
                        if (status != P2pStatus.SUCCESS) {
                            ...
                            if (status != P2pStatus.UNKNOWN_P2P_GROUP) {
                                ...
                                if (netId >= 0) {
                                    ...
                                    P2pStateMachine p2pStateMachine8 = P2pStateMachine.this;
                                    boolean unused = p2pStateMachine8.removeClientFromList(netId, p2pStateMachine8.mSavedPeerConfig.deviceAddress, true);
                                }
                                P2pStateMachine.this.mSavedPeerConfig.netId = -2;
                                P2pStateMachine p2pStateMachine9 = P2pStateMachine.this;
                                p2pStateMachine9.p2pConnectWithPinDisplay(p2pStateMachine9.mSavedPeerConfig);
                    ...
                    case WifiP2pMonitor.P2P_REMOVE_AND_REFORM_GROUP_EVENT:
                        ...
                        boolean unused2 = P2pStateMachine.this.mPendingReformGroupIndication = true;
                        break;
                    default:
                        switch (i) {
                            case WifiP2pMonitor.P2P_GO_NEGOTIATION_SUCCESS_EVENT:
                            ...
                            case WifiP2pMonitor.P2P_GROUP_STARTED_EVENT:
                                if (message.obj != null) {
                                    WifiP2pGroup unused3 = P2pStateMachine.this.mGroup = (WifiP2pGroup) message.obj;
                                    if (WifiP2pServiceImpl.this.mVerboseLoggingEnabled) {
                                        P2pStateMachine p2pStateMachine15 = P2pStateMachine.this;
                                    ...
                                    if (P2pStateMachine.this.mGroup.isGroupOwner()) {
                                        ...
                                        if (!WifiP2pServiceImpl.this.getMagicLinkDeviceFlag()) {
                                            P2pStateMachine.this.mWifiNative.setP2pGroupIdle(P2pStateMachine.this.mGroup.getInterface(), 10);
                                            if ((!WifiP2pServiceImpl.this.mIsP2pNotDhcpExpected || WifiP2pServiceImpl.this.mP2pNotDhcpCallback == null || !WifiP2pServiceImpl.this.mP2pNotDhcpCallback.isP2pNotDhcpRunning()) && !WifiP2pServiceImpl.this.shouldDisableP2pGcDhcp()) {
                                                WifiP2pServiceImpl.this.startIpClient(P2pStateMachine.this.mGroup.getInterface(), P2pStateMachine.this.getHandler());
                                            }
                                            boolean unused4 = WifiP2pServiceImpl.this.mIsP2pNotDhcpExpected = false;
                                            if (WifiP2pServiceImpl.this.mWifiInjector == null) {
                                                WifiInjector unused5 = WifiP2pServiceImpl.this.mWifiInjector = WifiInjector.getInstance();
                                            }
                                            WifiP2pServiceImpl.this.mWifiInjector.getWifiNative().setBluetoothCoexistenceMode(P2pStateMachine.this.mInterfaceName, 1);
                                            boolean unused6 = P2pStateMachine.this.mIsBTCoexDisabled = true;
                                        }
                                        ...
                                        if (groupOwner != null) {
                                            ...
                                            if (peer != null) {
                                                ...
                                                P2pStateMachine p2pStateMachine17 = P2pStateMachine.this;
                                                p2pStateMachine17.logw("Unknown group owner " + groupOwner);
                                            }
                                        } else {
                                    ...
                                    P2pStateMachine p2pStateMachine18 = P2pStateMachine.this;
                                    p2pStateMachine18.transitionTo(p2pStateMachine18.mGroupCreatedState);
                                    break;
                                } else {
                                    Log.e(WifiP2pServiceImpl.TAG, "Illegal argument(s)");
                                    break;
        ...
        public class FrequencyConflictState extends State {
            ...
            private void notifyFrequencyConflict() {
                ...
                P2pStateMachine p2pStateMachine = P2pStateMachine.this;
                AlertDialog dialog = builder.setMessage(r.getString(17041547, p2pStateMachine.getDeviceName(p2pStateMachine.mSavedPeerConfig.deviceAddress))).setPositiveButton(r.getString(17039999), new DialogInterface.OnClickListener() {
                ...
                }).setNegativeButton(r.getString(17039961), new DialogInterface.OnClickListener() {
                ...
                switch (message.what) {
                    case 139271:
                        if (WifiP2pServiceImpl.this.mWifiPermissionsUtil.checkCanAccessWifiDirect(P2pStateMachine.this.getCallingPkgName(message.sendingUid, message.replyTo), message.sendingUid, false)) {
                            ...
                            if (!P2pStateMachine.this.isConfigInvalid(config)) {
                                P2pStateMachine p2pStateMachine2 = P2pStateMachine.this;
                                p2pStateMachine2.logd("Inviting device : " + StringUtilEx.safeDisplayBssid(config.deviceAddress));
                                P2pStateMachine p2pStateMachine3 = P2pStateMachine.this;
                                p2pStateMachine3.mSavedPeerConfig = config;
                                if (!p2pStateMachine3.mWifiNative.p2pInvite(P2pStateMachine.this.mGroup, config.deviceAddress)) {
                    ...
                    case 139280:
                        ...
                        if (!P2pStateMachine.this.mWifiNative.p2pGroupRemove(P2pStateMachine.this.mGroup.getInterface())) {
                            ...
                            P2pStateMachine p2pStateMachine7 = P2pStateMachine.this;
                            p2pStateMachine7.transitionTo(p2pStateMachine7.mOngoingGroupRemovalState);
                    ...
                    case WifiP2pMonitor.P2P_INVITATION_RESULT_EVENT:
                        ...
                        if (status != P2pStatus.SUCCESS) {
                            ...
                            if (status == P2pStatus.UNKNOWN_P2P_GROUP && (netId = P2pStateMachine.this.mGroup.getNetworkId()) >= 0) {
                                ...
                                P2pStateMachine p2pStateMachine15 = P2pStateMachine.this;
                                boolean unused2 = p2pStateMachine15.removeClientFromList(netId, p2pStateMachine15.mSavedPeerConfig.deviceAddress, false);
                                P2pStateMachine p2pStateMachine16 = P2pStateMachine.this;
        ...
        private void sendP2pStateChangedBroadcast(boolean enabled) {
            ...
            boolean unused = WifiP2pServiceImpl.this.mIsP2pEnabled = enabled;
        ...
        private void notifyP2pEnableFailure() {
            Resources r = Resources.getSystem();
            AlertDialog dialog = new AlertDialog.Builder(WifiP2pServiceImpl.this.mContext).setTitle(r.getString(17041542)).setMessage(r.getString(17041546)).setPositiveButton(r.getString(17039370), (DialogInterface.OnClickListener) null).create();
            dialog.setCanceledOnTouchOutside(false);
            dialog.getWindow().setType(2003);
            WindowManager.LayoutParams attrs = dialog.getWindow().getAttributes();
            attrs.privateFlags = 16;
        ...
        private void addRowToDialog(ViewGroup group, int stringId, String value) {
            ...
            ((TextView) row.findViewById(16909165)).setText(r.getString(stringId));
            ((TextView) row.findViewById(16909574)).setText(value);
            group.addView(row);
        }
        ...
        public void notifyInvitationSent(String pin, String peerAddress) {
            Resources r = Resources.getSystem();
            View textEntryView = LayoutInflater.from(WifiP2pServiceImpl.this.mContext).inflate(17367346, (ViewGroup) null);
            ViewGroup group = (ViewGroup) textEntryView.findViewById(16909046);
            addRowToDialog(group, 17041552, getDeviceName(peerAddress));
            addRowToDialog(group, 17041551, pin);
            AlertDialog dialog = new AlertDialog.Builder(WifiP2pServiceImpl.this.mContext).setTitle(r.getString(17041549)).setView(textEntryView).setPositiveButton(r.getString(17039370), (DialogInterface.OnClickListener) null).create();
            dialog.setCanceledOnTouchOutside(false);
            dialog.getWindow().setType(2003);
            WindowManager.LayoutParams attrs = dialog.getWindow().getAttributes();
            attrs.privateFlags = 16;
        ...
        public void notifyP2pProvDiscShowPinRequest(String pin, String peerAddress) {
            ...
            addRowToDialog(group, 17041552, getDeviceName(peerAddress));
            addRowToDialog(group, 17041551, pin);
            AlertDialog dialog = new AlertDialog.Builder(WifiP2pServiceImpl.this.mContext).setTitle(r.getString(17041549)).setView(textEntryView).setPositiveButton(r.getString(17039531), new DialogInterface.OnClickListener() {
        ...
        public void notifyInvitationReceived() {
            if (!WifiP2pServiceImpl.this.autoAcceptConnection()) {
                if (!WifiCommonUtils.IS_TV || WifiP2pServiceImpl.this.mHwWifiP2pServiceTvEx == null) {
                    ...
                    View textEntryView = LayoutInflater.from(WifiP2pServiceImpl.this.mContext).inflate(17367346, (ViewGroup) null);
                    ViewGroup group = (ViewGroup) textEntryView.findViewById(16909046);
                    View row = LayoutInflater.from(WifiP2pServiceImpl.this.mContext).inflate(17367347, group, false);
                    ((TextView) row.findViewById(16909165)).setText(String.format(r.getString(33685699), getDeviceName(this.mSavedPeerConfig.deviceAddress)));
                    ...
                    if (isNightMode) {
                        ((TextView) row.findViewById(16909165)).setTextColor(WHITE_COLOR);
                    } else {
                        ((TextView) row.findViewById(16909165)).setTextColor(BLACK_COLOR);
                    }
                    group.addView(row);
                    final EditText pin = (EditText) textEntryView.findViewById(16909596);
                    ...
                    if (i == 1) {
                        ...
                        addRowToDialog(group, 17041551, wps.pin);
                    } else if (i == 2) {
                        if (WifiP2pServiceImpl.this.mVerboseLoggingEnabled) {
                            logd("Enter pin section visible");
                        }
                        textEntryView.findViewById(16908920).setVisibility(0);
                    }
                ...
                int access$8100 = WifiP2pServiceImpl.sGroupCreatingTimeoutIndex;
                WifiP2pConfig wifiP2pConfig = this.mSavedPeerConfig;
                iHwWifiP2pServiceTvEx.notifyP2pInvitationReceived(access$8100, wifiP2pConfig, getDeviceName(wifiP2pConfig.deviceAddress));
            }
        }
        ...
        public boolean reinvokePersistentGroup(WifiP2pConfig config) {
            ...
            if (join && dev.isGroupLimit()) {
                ...
                WifiP2pServiceImpl.this.updateP2pGoCreateStatus(true);
                WifiP2pServiceImpl.this.sendReinvokePGBroadcast(netId);
                return true;
            }
                ...
                if (!join && dev.isInvitationCapable()) {
                    ...
                    if (netId2 >= 0) {
                        if (this.mWifiNative.p2pReinvoke(netId2, dev.deviceAddress)) {
                            config.netId = netId2;
                            WifiP2pServiceImpl.this.sendReinvokePGBroadcast(netId2);
                            return true;
                        }
        ...
        private String getPersistedDeviceName() {
            String deviceName = WifiP2pServiceImpl.this.getCustomDeviceName(WifiP2pServiceImpl.this.mFrameworkFacade.getStringSetting(WifiP2pServiceImpl.this.mContext, "wifi_p2p_device_name"));
            if (deviceName != null) {
                return deviceName;
            }
            ...
            if (id == null || id.length() <= 4 || WifiCommonUtils.IS_ATT || WifiCommonUtils.IS_VERIZON) {
                return Build.MODEL;
            }
        ...
        public boolean addServiceRequest(Messenger m, WifiP2pServiceRequest req) {
            ...
            WifiP2pServiceImpl.access$10904(WifiP2pServiceImpl.this);
        ...
        public void clearClientInfo(Messenger m) {
            ...
            if (clientInfo != null) {
                ...
                if (WifiP2pServiceImpl.this.mWifiInjector != null) {
                    ...
                    if ((WifiCommonUtils.PACKAGE_NAME_PCASSISTANT.equals(clientInfo.mPackageName) && WifiCommonUtils.PACKAGE_NAME_ASSOCIATE_ASSISTANT.equals(wifiModeCallerPackageName)) || (WifiCommonUtils.PACKAGE_NAME_NEARBY.equals(clientInfo.mPackageName) && WifiCommonUtils.PACKAGE_NAME_INSTANTSHARE.equals(wifiModeCallerPackageName))) {
