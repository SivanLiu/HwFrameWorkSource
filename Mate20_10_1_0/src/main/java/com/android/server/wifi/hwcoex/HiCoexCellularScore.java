...
public class HiCoexCellularScore extends HiCoexScore {
    ...
    private void loadScoreConfiguration() {
        this.mSceneNames = new String[]{"scene_airplane_on", "scene_sim_absent", "scene_no_services", "scene_nsa_data_unconnected", "scene_nsa_data_connected", "scene_sa_data_unconnected", "scene_sa_data_connected", "scene_vowifi_calling", "scene_wifi_display", "scene_double_link", "scene_lowlatency"};
        ...
        this.mSceneScores = new int[]{2, 4, 4, 4, 16, 22, 24, 62, 25, 34, 52};
    }
