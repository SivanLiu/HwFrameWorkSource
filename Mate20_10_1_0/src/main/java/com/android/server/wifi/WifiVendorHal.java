...
public class WifiVendorHal {
    ...
    public class ChipEventCallback extends IWifiChipEventCallback.Stub {
        ...
        public void onDebugRingBufferDataAvailable(WifiDebugRingBufferStatus status, ArrayList<Byte> data) {
            WifiVendorHal.this.mHalEventHandler.post(new Runnable(status, data) {
                ...
                public final void run() {
                    ChipEventCallback.this.lambda$onDebugRingBufferDataAvailable$0$WifiVendorHal$ChipEventCallback(this.f$1, this.f$2);
                }
            });
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:12:?, code lost:
            r1.onRingBufferData(com.android.server.wifi.WifiVendorHal.access$1300(r6), com.android.server.wifi.util.NativeUtil.byteArrayFromArrayList(r7));
         */
        /* JADX WARNING: Code restructure failed: missing block: B:13:0x002e, code lost:
            if (r7.size() == r0) goto L_0x0034;
         */
        ...
        public void onDebugErrorAlert(int errorCode, ArrayList<Byte> debugData) {
            ...
            WifiVendorHal.this.mHalEventHandler.post(new Runnable(debugData, errorCode) {
                ...
                public final void run() {
                    ChipEventCallback.this.lambda$onDebugErrorAlert$1$WifiVendorHal$ChipEventCallback(this.f$1, this.f$2);
                }
            });
        }
    ...
    public class ChipEventCallbackV12 extends IWifiChipEventCallback.Stub {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:10:0x0034, code lost:
            if (r9.size() == 0) goto L_0x010c;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:12:0x003b, code lost:
            if (r9.size() <= 2) goto L_0x003f;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:13:0x003f, code lost:
            r3 = r9.get(0);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:14:0x004b, code lost:
            if (r9.size() != 2) goto L_0x0054;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:19:0x0063, code lost:
            if (r3.ifaceInfos.size() == r4.ifaceInfos.size()) goto L_0x0092;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:33:0x00bd, code lost:
            if (r3.bandInfo == r4.bandInfo) goto L_0x00c3;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:40:0x00e5, code lost:
            if (r3.ifaceInfos.get(0).channel == r3.ifaceInfos.get(1).channel) goto L_0x00ed;
         */
