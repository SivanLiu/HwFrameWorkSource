...
public class WifiAwareStateManager implements WifiAwareShellCommand.DelegatedShellCommand {
    ...
    class WifiAwareStateMachine extends StateMachine {
        ...
        /* JADX INFO: Multiple debug info for r2v7 int: [D('reason' int), D('transactionId' short)] */
        /* access modifiers changed from: private */
        ...
        public boolean processCommand(Message msg) {
            ...
            switch (msg.arg1) {
                ...
                default:
                    ...
                    break;
                case WifiAwareStateManager.COMMAND_TYPE_GET_CAPABILITIES /*{ENCODED_INT: 111}*/:
                ...
                case WifiAwareStateManager.COMMAND_TYPE_RESPOND_TO_DATA_PATH_SETUP_REQUEST /*{ENCODED_INT: 117}*/:
        ...
        public void processResponse(Message msg) {
            ...
            switch (msg.arg1) {
                case 200:
                    ...
                    break;
                case WifiAwareStateManager.RESPONSE_TYPE_ON_CONFIG_FAIL /*{ENCODED_INT: 201}*/:
                    WifiAwareStateManager.this.onConfigFailedLocal(this.mCurrentCommand, ((Integer) msg.obj).intValue());
                    break;
                case WifiAwareStateManager.RESPONSE_TYPE_ON_SESSION_CONFIG_SUCCESS /*{ENCODED_INT: 202}*/:
                    ...
                    break;
                case WifiAwareStateManager.RESPONSE_TYPE_ON_SESSION_CONFIG_FAIL /*{ENCODED_INT: 203}*/:
