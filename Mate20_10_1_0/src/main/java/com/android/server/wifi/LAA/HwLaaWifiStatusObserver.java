...
public class HwLaaWifiStatusObserver {
    ...
    public void handleWiFiNetworkChangeAction(Intent intent) {
    ...
    /* access modifiers changed from: private */
    public void handleWifiApStateChangeAction() {
    ...
    /* access modifiers changed from: private */
    public void handleWifiP2pConnectionChangedAction(Intent intent) {
        NetworkInfo networkInfo = (NetworkInfo) intent.getParcelableExtra("networkInfo");
