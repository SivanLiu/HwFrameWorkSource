...
public class HwPortalExceptionManager {
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    ...
                    case 102:
                        ...
                        Settings.Secure.putInt(HwPortalExceptionManager.this.mContentResolver, WifiProCommonUtils.PORTAL_NETWORK_FLAG, 0);
                        break;
                    case 103:
    ...
    public void handleUpdatePortalConnectedInfo(int firstDetect, int httpRespCode, Bundle bundle) {
        if (this.mCurrConfigKey == null) {
            ...
            if (bundle != null) {
                this.mCurrConfigKey = bundle.getString(WifiProCommonUtils.KEY_PORTAL_CONFIG_KEY);
                this.mRedirectedUrl = bundle.getString(WifiProCommonUtils.KEY_PORTAL_REDIRECTED_URL);
            }
    ...
    public void handleBroswerQueryPortalInfo() {
        ...
        int cellId = com.android.server.wifipro.WifiProCommonUtils.getCurrentCellId();
    ...
    public synchronized void notifyPortalConnectedInfo(String configKey, boolean firstDetect, int httpRespCode, String redirectedUrl) {
        ...
        bundle.putString(WifiProCommonUtils.KEY_PORTAL_CONFIG_KEY, configKey);
        bundle.putString(WifiProCommonUtils.KEY_PORTAL_REDIRECTED_URL, redirectedUrl);
