...
import com.huawei.hwwifiproservice.HwAutoConnectManager;
import com.huawei.hwwifiproservice.WifiHandover;
import com.huawei.hwwifiproservice.WifiProChrUploadManager;
import com.huawei.hwwifiproservice.WifiProCommonDefs;
import com.huawei.hwwifiproservice.WifiproUtils;
...
public class HwWifiStateMachine extends ClientModeImpl {
    ...
    private IHwActivityNotifierEx mActivityNotifierEx = new IHwActivityNotifierEx() {
        ...
        public void call(Bundle extras) {
            boolean unused = HwWifiStateMachine.this.mIsInWifiSettings = false;
            if (extras == null) {
            ...
            if (tempComponentName instanceof ComponentName) {
                ...
                if (componentName != null && uid != -1 && "com.android.settings.Settings$WifiSettingsActivity".equals(componentName.getClassName())) {
                    boolean unused2 = HwWifiStateMachine.this.mIsInWifiSettings = HwWifiStateMachine.ON_RESUME.equals(currentState);
                }
            }
        }
    };
            ...
            if (intent != null) {
                ...
                if (HwWifiStateMachine.BRCM_CHIP_4359.equals(chipName)) {
                    if ("android.intent.action.BATTERY_CHANGED".equals(action)) {
                        ...
                        if (networkInfo != null) {
                            int i = AnonymousClass7.$SwitchMap$android$net$NetworkInfo$DetailedState[networkInfo.getDetailedState().ordinal()];
                            if (i == 1) {
                                ...
                                hwWifiStateMachine2.setLowPwrMode(hwWifiStateMachine2.mWifiConnectState, HwWifiStateMachine.this.mSsid, isMobileAP, HwWifiStateMachine.this.mScreenState);
                            } else if (i == 2) {
                                ...
                                hwWifiStateMachine3.setLowPwrMode(hwWifiStateMachine3.mWifiConnectState, null, isMobileAP, HwWifiStateMachine.this.mScreenState);
                            }
                        }
                    } else if ("android.intent.action.SCREEN_ON".equals(action)) {
                        HwWifiStateMachine hwWifiStateMachine4 = HwWifiStateMachine.this;
                        hwWifiStateMachine4.logd("setpmlock:action = " + action);
    ...
    /* access modifiers changed from: private */
    public boolean mIsInWifiSettings = false;
    /* access modifiers changed from: private */
    ...
    static /* synthetic */ int access$1908(HwWifiStateMachine x0) {
        int i = x0.mPwrBoostOncnt;
        x0.mPwrBoostOncnt = i + 1;
        return i;
    }

    static /* synthetic */ int access$2008(HwWifiStateMachine x0) {
    ...
    public String getWpaSuppConfig() {
        ...
        if (packageName == null || packageName.equals("")) {
            ...
            return WifiInjector.getInstance().getWifiNative().mHwWifiNativeEx.getWpaSuppConfig();
        } else {
    ...
    public void startScreenOffScan() {
        int configNetworksSize = wifiStateMachineUtils.getWifiConfigManager(this).getSavedNetworks(1010).size();
    ...
    private void recordPortalHistory(WifiConfiguration config) {
        ...
        if (isHomeRouter || (!TextUtils.isEmpty(currentBssid) && ScanResultRecords.getDefault().getHiLinkAp(currentBssid) == 1)) {
            HwHiLog.d(TAG, false, "redirected by home router, do not record portal history", new Object[0]);
    ...
    private void registerReceiverInWifiPro(Context context) {
        context.registerReceiver(new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                WifiConfiguration newConfig = (WifiConfiguration) intent.getParcelableExtra(WifiProCommonDefs.EXTRA_FLAG_NEW_WIFI_CONFIG);
                ...
                int detectType = intent.getIntExtra(HwWifiStateMachine.EXTRA_FLAG_HILINK_DETECT_NOT_PORTAL, -1);
                if (detectType == 3) {
                ...
                if (newConfig != null && currentConfig != null && wifiConfigManager != null) {
                    ...
                    HwWifiStateMachine.this.updateHilinkDetectResult(detectType, newConfig);
        ...
        }, new IntentFilter(WifiProCommonDefs.ACTION_UPDATE_CONFIG_HISTORY), WifiProCommonDefs.NETWORK_CHECKER_RECV_PERMISSION, null);
        context.registerReceiver(new BroadcastReceiver() {
            /* class com.android.server.wifi.HwWifiStateMachine.AnonymousClass3 */

            public void onReceive(Context context, Intent intent) {
                int switchType = intent.getIntExtra("com.huawei.wifi.handover.switchtype", 1);
                WifiConfiguration changeConfig = (WifiConfiguration) intent.getParcelableExtra("com.huawei.wifi.handover.wificonfig");
                ...
                if (!HwWifiStateMachine.this.mWifiSwitchOnGoing && changeConfig != null) {
                    WifiProChrUploadManager.uploadDisconnectedEvent(HwWifiStateMachine.EVENT_DUALBAND_SWITCH);
                    ...
                    boolean unused = HwWifiStateMachine.this.saveCurrentConfig();
                    HwWifiStateMachine.this.mWifiSwitchOnGoing = true;
                }
            }
        }, new IntentFilter("com.huawei.wifi.action.REQUEST_DUAL_BAND_WIFI_HANDOVER"), "com.huawei.wifipro.permission.RECV.WIFI_HANDOVER", null);
    }

    /* access modifiers changed from: private */
    public void updateDualBandSwitchEvent() {
        WifiProChrUploadManager uploadManager = WifiProChrUploadManager.getInstance(this.myContext);
        if (uploadManager != null) {
            Bundle dualBandSwitch = new Bundle();
            dualBandSwitch.putInt(WifiproUtils.SWITCH_SUCCESS_INDEX, 2);
            uploadManager.addChrBundleStat(WifiproUtils.WIFI_SWITCH_EVENT, WifiproUtils.WIFI_SWITCH_CNT_EVENT, dualBandSwitch);
        }
    }
    ...
    public void getConfiguredNetworks(Message message) {
        wifiStateMachineUtils.replyToMessage((ClientModeImpl) this, message, message.what, (Object) wifiStateMachineUtils.getWifiConfigManager(this).getSavedNetworks(1010));
    }
    ...
    public void handleConnectedInWifiPro() {
        ...
        if (connectedConfig != null) {
            ...
            for (WifiConfiguration config2 : wifiConfigManager.getSavedNetworks(1010)) {
    ...
    private void sendWifiHandoverCompletedBroadcast(int statusCode, String bssid, String ssid, String configKey) {
        if (this.mWifiSwitchOnGoing) {
            ...
            if (this.mHwWifiProServiceManager.getNetwoksHandoverType() == 1) {
                intent.setAction("com.huawei.wifi.action.RESPONSE_WIFI_2_WIFI");
            } else {
                intent.setAction("com.huawei.wifi.action.RESPONSE_DUAL_BAND_WIFI_HANDOVER");
            }
            intent.putExtra("com.huawei.wifi.handover.status", statusCode);
            intent.putExtra("com.huawei.wifi.handover.bssid", bssid);
            intent.putExtra("com.huawei.wifi.handover.ssid", ssid);
            intent.putExtra("com.huawei.wifi.handover.configkey", configKey);
            this.myContext.sendBroadcastAsUser(intent, UserHandle.ALL, "com.huawei.wifipro.permission.RECV.WIFI_HANDOVER");
        }
    }
    ...
    public void notifyWifiConnectedBackgroundReady() {
        ...
        if (i == 1) {
            ...
            Intent intent = new Intent("com.huawei.wifipro.action.ACTION_NOTIFY_WIFI_CONNECTED_CONCURRENTLY");
            ...
            Intent intent2 = new Intent("com.huawei.wifipro.action.ACTION_NOTIFY_PORTAL_CONNECTED_BACKGROUND");
            ...
            Intent intent3 = new Intent("com.huawei.wifipro.action.ACTION_NOTIFY_NO_INTERNET_CONNECTED_BACKGROUND");
    ...
    public boolean ignoreNetworkStateChange(NetworkInfo networkInfo) {
        if (networkInfo == null || !this.mHwWifiProServiceManager.isWifiProServiceReady()) {
            return false;
        }
    ...
    public boolean selfCureIgnoreNetworkStateChange(NetworkInfo networkInfo) {
        ...
        HwHiLog.d("HwSelfCureEngine", false, "selfCureIgnoreNetworkStateChange, detailedState = %{public}d", new Object[]{networkInfo.getDetailedState()});
        return true;
    }
    ...
    private boolean disallowWifiScanForConnection() {
        ...
        if (now - j <= this.mTimeOutScanControlForAssoc) {
            ...
            return true;
        } else if (!ObtainingIpState.class.equals(getCurrentState().getClass())) {
        ...
        this.myContext.getContentResolver().registerContentObserver(Settings.Secure.getUriFor(WIFI_EVALUATE_TAG), false, new ContentObserver(null) {
            ...
            public void onChange(boolean selfChange) {
                ...
                if (HwWifiStateMachine.this.mBQEUid == 1000) {
                    HwWifiStateMachine hwWifiStateMachine = HwWifiStateMachine.this;
                    int unused = hwWifiStateMachine.mBQEUid = hwWifiStateMachine.getAppUid("com.huawei.wifiprobqeservice");
                }
                HwWifiStateMachine hwWifiStateMachine2 = HwWifiStateMachine.this;
    ...
    public boolean isWlanSettingsActivity() {
        ...
        if (runningTaskInfos == null || runningTaskInfos.isEmpty() || (cn = runningTaskInfos.get(0).topActivity) == null || cn.getClassName() == null || !cn.getClassName().startsWith("com.android.settings.Settings$WifiSettingsActivity")) {
            return false;
        }
        return true;
    }
    ...
    public void startSelfCureWifiReset() {
        ...
        WifiProChrUploadManager.uploadDisconnectedEvent(EVENT_CHIP_RECOVERY);
        this.mWifiSelfCuring.set(true);
        resetSelfCureCandidateLostCnt();
    ...
    public void startSelfCureWifiReassoc() {
        ...
        WifiProChrUploadManager.uploadDisconnectedEvent(EVENT_REASSOCIATION_RECOVERY);
        this.mWifiSelfCuring.set(true);
        resetSelfCureCandidateLostCnt();
    ...
    public String selectBestCandidate(WifiConfiguration config) {
        ...
        return candidate == null ? "any" : candidate.BSSID;
    }
    ...
    public void stopSelfCureWifi(int status) {
        ...
        if (status == -4) {
            ...
            WifiProChrUploadManager.uploadDisconnectedEvent(EVENT_RECOVERY_FINISHED);
            NetworkInfo networkInfo = wifiStateMachineUtils.getNetworkInfo(this);
            if (this.mWifiBackgroundConnected && networkInfo != null && networkInfo.getDetailedState() == NetworkInfo.DetailedState.CONNECTED) {
                ...
                sendMessage(HwAutoConnectManager.POOR_LINK_DETECTED);
            }
                ...
                if (result != null && result.BSSID != null && !result.BSSID.isEmpty() && currentBssid.equals(result.BSSID)) {
                    ...
                    if (stream1 != 0 || stream2 != 0 || stream3 != 0 || stream4 != 0) {
                        ...
                        if (hwWifiCHRService != null) {
                            hwWifiCHRService.updateWifiException(213, apData);
    ...
    public void handleSimAbsent(WifiConfiguration config) {
        ...
        if (PreconfiguredNetworkManager.IS_R1 && config.enterpriseConfig != null && TelephonyUtil.isSimEapMethod(config.enterpriseConfig.getEapMethod()) && PreconfiguredNetworkManager.getInstance().isPreconfiguredNetwork(config.SSID)) {
            ...
            this.wifiEapUIManager.showDialog(Resources.getSystem().getString(33686227), Resources.getSystem().getString(33686225));
        }
    }
    ...
    /* renamed from: com.android.server.wifi.HwWifiStateMachine$7  reason: invalid class name */
            ...
            if (i != 0) {
                ...
                if (HwWifiStateMachine.this.mIsChargePluggedin && !HwWifiStateMachine.this.mIsFinishLinkDetect) {
                    ...
                    if (!hwWifiStateMachine.mCurrentPwrBoostStat) {
                        ...
                        HwWifiStateMachine.access$1908(HwWifiStateMachine.this);
                    } else if (HwWifiStateMachine.this.mCurrentPwrBoostStat) {
                        WifiInjector.getInstance().getWifiNative().mHwWifiNativeEx.setPwrBoost(0);
                        boolean unused2 = HwWifiStateMachine.this.mCurrentPwrBoostStat = false;
                        HwWifiStateMachine hwWifiStateMachine3 = HwWifiStateMachine.this;
                        hwWifiStateMachine3.linkMeasureAndStatic(hwWifiStateMachine3.mCurrentPwrBoostStat);
                        HwWifiStateMachine.access$2008(HwWifiStateMachine.this);
                    }
                }
                if (HwWifiStateMachine.this.mPwrBoostOncnt < 3 || HwWifiStateMachine.this.mPwrBoostOffcnt < 3) {
                    boolean unused3 = HwWifiStateMachine.this.mIsFinishLinkDetect = false;
                } else {
                    boolean unused4 = HwWifiStateMachine.this.mIsFinishLinkDetect = true;
                }
            }
        }
    }
    ...
    public boolean reduceTxPower(int action) {
        ...
        if (wifiNative.mHwWifiNativeEx.sendCmdToDriver("wlan0", 113, new byte[]{(byte) action}) == 0) {
            return true;
        }
        return false;
    }
    ...
    public void updateRandomizedMacConfigWhenDisconnected(int networkId, int reasonCode) {
        ...
        } else if (!shouldRandomMacSelfCure(reasonCode)) {
            ...
            if (config == null) {
                ...
                if (this.mLastConnectNetworkId != config.networkId) {
                    ...
                    if (this.mConnectFailedCnt <= 2) {
                        startConnectToNetwork(config.networkId, 1010, "any");
                    } else {
                        this.mConnectFailedCnt = 0;
                    }
                }
    ...
    /* access modifiers changed from: private */
    public void updateHilinkDetectResult(int detectType, WifiConfiguration config) {
        HwWifiCHRHilink hwWifiCHRHilink = HwWifiCHRHilink.getInstance(this.myContext);
        if (hwWifiCHRHilink != null && config.internetHistory != null && config.internetHistory.lastIndexOf("/") != -1 && hwWifiCHRHilink.getHilinkDetectResult() == 3 && config.portalNetwork) {
            String internetHistory = config.internetHistory.substring(config.internetHistory.indexOf("/") + 1);
            config.internetHistory = String.valueOf(0) + "/" + internetHistory;
            StringBuilder sb = new StringBuilder();
            sb.append("updateHilinkDetectResult, detectType is not portal, newConfig.internetHistory = ");
            sb.append(config.internetHistory);
            Log.i(TAG, sb.toString());
        }
    }

    public boolean isInWifiSettings() {
        return this.mIsInWifiSettings;
    }
    ...
    public boolean setWifiMode(String packageName, int mode) {
        ...
        if ("android".equals(packageName) || ((mode & 7) == 0 && packageName.equals(this.mWifiModeCallerPackageName))) {
            if (!(this.mWifiConnectivityManager == null || (this.mWifiMode & 1) == 0)) {
