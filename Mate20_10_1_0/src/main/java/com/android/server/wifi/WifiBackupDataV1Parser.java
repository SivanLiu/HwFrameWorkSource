...
class WifiBackupDataV1Parser implements WifiBackupDataParser {
    ...
    public static final Set<String> WIFI_CONFIGURATION_MINOR_V0_SUPPORTED_TAGS = new HashSet(Arrays.asList(XmlUtil.WifiConfigurationXmlUtil.XML_TAG_CONFIG_KEY, XmlUtil.WifiConfigurationXmlUtil.XML_TAG_SSID, HwWifiConfigurationXmlUtil.XML_TAG_ORI_SSID, HwWifiConfigurationXmlUtil.XML_TAG_CONNECT_TO_CELLULAR_AND_WLAN, XmlUtil.WifiConfigurationXmlUtil.XML_TAG_NO_INTERNET_ACCESS_EXPECTED, XmlUtil.WifiConfigurationXmlUtil.XML_TAG_BSSID, XmlUtil.WifiConfigurationXmlUtil.XML_TAG_PRE_SHARED_KEY, XmlUtil.WifiConfigurationXmlUtil.XML_TAG_WEP_KEYS, XmlUtil.WifiConfigurationXmlUtil.XML_TAG_WEP_TX_KEY_INDEX, XmlUtil.WifiConfigurationXmlUtil.XML_TAG_HIDDEN_SSID, XmlUtil.WifiConfigurationXmlUtil.XML_TAG_REQUIRE_PMF, XmlUtil.WifiConfigurationXmlUtil.XML_TAG_ALLOWED_KEY_MGMT, XmlUtil.WifiConfigurationXmlUtil.XML_TAG_ALLOWED_PROTOCOLS, XmlUtil.WifiConfigurationXmlUtil.XML_TAG_ALLOWED_AUTH_ALGOS, XmlUtil.WifiConfigurationXmlUtil.XML_TAG_ALLOWED_GROUP_CIPHERS, XmlUtil.WifiConfigurationXmlUtil.XML_TAG_ALLOWED_PAIRWISE_CIPHERS, XmlUtil.WifiConfigurationXmlUtil.XML_TAG_SHARED, XmlUtil.WifiConfigurationXmlUtil.XML_TAG_MAC_RANDOMIZATION_SETTING, XmlUtil.WifiConfigurationXmlUtil.XML_TAG_SECURITY_COMP, HwWifiConfigurationXmlUtil.XML_TAG_INTERNET_HISTORY));
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:50:0x00e4, code lost:
        if (r8.equals(com.android.server.wifi.util.XmlUtil.WifiConfigurationXmlUtil.XML_TAG_SSID) != false) goto L_0x0133;
     */
