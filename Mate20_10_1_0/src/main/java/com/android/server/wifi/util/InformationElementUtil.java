...
public class InformationElementUtil {
    ...
    public static class Capabilities {
            ...
            try {
                if (buf.getShort() == 1) {
                    ...
                    for (int i2 = 0; i2 < akmCount; i2++) {
                        switch (buf.getInt()) {
                            case RSN_AKM_EAP /*{ENCODED_INT: 28053248}*/:
                            ...
                            case 44830464:
                                ...
                                break;
                            case RSN_AKM_FT_EAP /*{ENCODED_INT: 61607680}*/:
                            ...
                            case 78384896:
                                ...
                                break;
                            case RSN_AKM_EAP_SHA256 /*{ENCODED_INT: 95162112}*/:
                                rsnKeyManagement.add(6);
                                pmfKeyManagement.add(5);
                                break;
                            case RSN_AKM_PSK_SHA256 /*{ENCODED_INT: 111939328}*/:
                                rsnKeyManagement.add(5);
                                pmfKeyManagement.add(6);
                                break;
                            case RSN_AKM_SAE /*{ENCODED_INT: 145493760}*/:
                                rsnKeyManagement.add(8);
                                break;
                            case RSN_AKM_EAP_SUITE_B_192 /*{ENCODED_INT: 212602624}*/:
                                rsnKeyManagement.add(10);
                                break;
                            case RSN_AKM_OWE /*{ENCODED_INT: 313265920}*/:
        ...
        private static int parseRsnCipher(int cipher) {
            switch (cipher) {
                case RSN_CIPHER_NONE /*{ENCODED_INT: 11276032}*/:
                    return 0;
                case 44830464:
                    return 2;
                case 78384896:
                    return 3;
                case RSN_CIPHER_NO_GROUP_ADDRESSED /*{ENCODED_INT: 128716544}*/:
                    return 1;
                case 162270976:
                    return 4;
                default:
