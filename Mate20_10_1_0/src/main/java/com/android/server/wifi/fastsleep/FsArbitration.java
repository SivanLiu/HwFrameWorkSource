...
public class FsArbitration {
    ...
    private synchronized void checkFastSleepSwitch(int arbitraCond, boolean isFastSleepOn, boolean isConnectState) {
        ...
        if (arbitraCond != 0 || isFastSleepOn) {
            if (arbitraCond != 0 && isFastSleepOn) {
            ...
            if (arbitraCond != 0 && !isFastSleepOn && isConnectState) {
    ...
    private boolean isSupportFs(ScanResult.InformationElement ie) {
        ...
        int index = 0;
        while (index < FORMAT_1103_IE.length) {
            int element = ie.bytes[index] & HI1103_MASK;
    ...
    private boolean isSupportHuaweiRouter(ScanResult.InformationElement ie) {
        ...
        for (int index = 0; index < FORMAT_HUAWEI_ROUTER_IE.length; index++) {
            if ((ie.bytes[index] & HI1103_MASK) != FORMAT_HUAWEI_ROUTER_IE[index]) {
                this.mConnectedApType = BOOL_FALSE_TO_BYTE;
                this.mFeatureNum = -1;
                return false;
            }
    ...
    private boolean isInOuiBlackList(ScanResult.InformationElement ie) {
        if (ie.bytes != null && ie.bytes.length >= FORMAT_1103_IE.length) {
            return HwAPPQoEResourceManger.getInstance().isInRouterBlackList(ie);
        }
        HwHiLog.d(TAG, false, "ie.bytes.length is invalid!", new Object[0]);
        this.mConnectedApType = BOOL_FALSE_TO_BYTE;
        this.mFeatureNum = -1;
    ...
    /* access modifiers changed from: private */
    public void handleForegroundActivityChanged(Message msg) {
        if (IS_FS2_ENABLE) {
            ...
            int whiteListFlag = 0;
            try {
                whiteListFlag = Integer.parseInt(msg.obj.toString());
            } catch (NumberFormatException e) {
                HwHiLog.d(TAG, false, "whiteListFlag parse fail", new Object[0]);
            }
            if (whiteListFlag > 0) {
    ...
    /* access modifiers changed from: private */
    public void handleWifiDisconnectMsg() {
        this.mArbitraCond |= 1;
        this.mArbitraCond |= 8;
        checkFastSleepSwitch(this.mArbitraCond, this.mIsFastSleepOn, this.mIsConnectState);
    }
    ...
    /* access modifiers changed from: private */
    public void handleWifiConnectedMsg() {
    ...
    /* access modifiers changed from: private */
    public void handleP2pConnectdMsg(Message msg) {
        if (msg.arg1 > 0) {
            this.mArbitraCond |= 2;
    ...
    /* access modifiers changed from: private */
    public void handleInternetAccessMsg() {
        this.mArbitraCond &= -9;
        checkConnectedAp();
    ...
    /* access modifiers changed from: private */
    public void handleInternetDiscMsg() {
        this.mArbitraCond |= 8;
        checkFastSleepSwitch(this.mArbitraCond, this.mIsFastSleepOn, this.mIsConnectState);
    }

    /* access modifiers changed from: private */
    public void handleRoamingCompletedMsg() {
        checkConnectedAp();
        checkFastSleepSwitch(this.mArbitraCond, this.mIsFastSleepOn, this.mIsConnectState);
    }
