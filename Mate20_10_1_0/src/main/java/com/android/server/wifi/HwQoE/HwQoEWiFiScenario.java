...
public class HwQoEWiFiScenario {
    ...
    private void registerBroadcastReceiver() {
        if (!this.isRegister) {
            ...
            this.intentFilter.addAction(WifiProCommonDefs.ACTION_NETWOR_PROPERTY_NOTIFICATION);
            ...
            if (intent != null) {
                ...
                if ("android.net.wifi.WIFI_STATE_CHANGED".equals(action)) {
                    ...
                    if (wifiStatus == 1) {
                        ...
                        HwQoEWiFiScenario.this.mHandler.sendEmptyMessage(107);
                    }
                } else if ("android.net.wifi.STATE_CHANGE".equals(action)) {
                    HwQoEWiFiScenario.this.handleNetworkStateChange(intent);
                } else if (WifiProCommonDefs.ACTION_NETWOR_PROPERTY_NOTIFICATION.equals(action)) {
                    int property = intent.getIntExtra(WifiProCommonDefs.EXTRA_FLAG_NETWORK_PROPERTY, -101);
