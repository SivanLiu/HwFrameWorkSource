...
public class WifiRadioPowerController {
    ...
    private class BootCompleteReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent != null && "android.intent.action.BOOT_COMPLETED".equals(intent.getAction())) {
                ...
                TelephonyManager unused = wifiRadioPowerController.mTelephonyManager = (TelephonyManager) wifiRadioPowerController.mContext.getSystemService("phone");
    ...
    public class RadioPowerHandler extends Handler {
        ...
        private void checkCurrentState() {
            WifiRadioPowerController wifiRadioPowerController = WifiRadioPowerController.this;
            WifiManager unused = wifiRadioPowerController.mWifiManager = (WifiManager) wifiRadioPowerController.mContext.getApplicationContext().getSystemService("wifi");
