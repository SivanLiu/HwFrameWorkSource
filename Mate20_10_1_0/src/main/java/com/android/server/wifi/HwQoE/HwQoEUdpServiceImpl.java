...
public class HwQoEUdpServiceImpl {
    ...
    /* access modifiers changed from: private */
    public IHwQoEMonitorCallback mHwQoEMonitorCallback;
    /* access modifiers changed from: private */
    public Handler mHwQoEUdpServiceImplHandler;
    /* access modifiers changed from: private */
    public boolean mIsUDPAccessMonitorEnabled;
    HwQoEUdpNetWorkInfo mLastUdpInfoForMonitor;
    /* access modifiers changed from: private */
    public int mUDPMonitorInterval = 0;
    /* access modifiers changed from: private */
    public int mUdpNoAccessScore;
        ...
        this.mHwQoEUdpServiceImplHandler = new Handler(handlerThread.getLooper()) {
            ...
            public void handleMessage(Message msg) {
                ...
                if (i == 101) {
                    ...
                    int unused = hwQoEUdpServiceImpl2.mAddScore = hwQoEUdpServiceImpl2.calculateNewUdpAccessScore(hwQoEUdpServiceImpl2.mCurrUdpInfoForMonitor, HwQoEUdpServiceImpl.this.mLastUdpInfoForMonitor);
                    HwQoEUdpServiceImpl hwQoEUdpServiceImpl3 = HwQoEUdpServiceImpl.this;
                    int unused2 = hwQoEUdpServiceImpl3.mUdpNoAccessScore = hwQoEUdpServiceImpl3.mUdpNoAccessScore + HwQoEUdpServiceImpl.this.mAddScore;
                    HwQoEUdpServiceImpl hwQoEUdpServiceImpl4 = HwQoEUdpServiceImpl.this;
                    int unused3 = hwQoEUdpServiceImpl4.mUdpNoAccessScore = Math.max(0, hwQoEUdpServiceImpl4.mUdpNoAccessScore);
                    ...
                    hwQoEUdpServiceImpl5.mCurrUdpInfoForUID = hwQoEUdpServiceImpl5.mHwQoEJNIAdapter.getUdpNetworkStatsDetail(1000, 1);
                    if (HwQoEUdpServiceImpl.this.mLastUdpInfoForMonitor != null) {
                        HwQoEUdpServiceImpl hwQoEUdpServiceImpl6 = HwQoEUdpServiceImpl.this;
                        hwQoEUdpServiceImpl6.mCurrUdpSpeed = hwQoEUdpServiceImpl6.calculateUDPSpeed(hwQoEUdpServiceImpl6.mCurrUdpInfoForUID, HwQoEUdpServiceImpl.this.mLastUdpInfoForMonitor);
                    } else {
                        HwQoEUdpServiceImpl.this.mLastUdpInfoForMonitor = new HwQoEUdpNetWorkInfo();
                        HwQoEUdpServiceImpl.this.mLastUdpInfoForMonitor.setUdpNetWorkInfo(HwQoEUdpServiceImpl.this.mCurrUdpInfoForMonitor);
                    }
    ...
    /* access modifiers changed from: private */
    public int calculateNewUdpAccessScore(HwQoEUdpNetWorkInfo currUdpInfo, HwQoEUdpNetWorkInfo lastUdpInfo) {
        char c;
    ...
    /* access modifiers changed from: private */
    public UdpNetworkSpeed calculateUDPSpeed(HwQoEUdpNetWorkInfo currUdpInfo, HwQoEUdpNetWorkInfo lastUdpInfo) {
