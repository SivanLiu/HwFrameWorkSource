...
public class HwDfsMonitor {
    ...
    /* access modifiers changed from: private */
    public synchronized void locationStatusChanged() {
    ...
    public void handleP2pConnectionChange(Intent intent) {
        ...
        this.mP2pInterfase = this.mWifiP2pGroup.getInterface();
    ...
    private class DfsBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent != null) {
                ...
                if ("android.intent.action.BOOT_COMPLETED".equals(action)) {
                    boolean unused = HwDfsMonitor.this.mIsBootCompleted = true;
    ...
    /* access modifiers changed from: private */
    public void calculateGpsSatellite(GnssStatus status) {
        Handler handler;
    ...
    private int getP2pLinkSpeed() {
        ...
        WifiInjector wifiInjector = WifiInjector.getInstance();
        if (wifiInjector == null || TextUtils.isEmpty(this.mP2pInterfase)) {
            return 0;
        }
        return wifiInjector.getWifiP2pNative().mHwWifiP2pNativeEx.getP2pLinkSpeed(this.mP2pInterfase);
    }
