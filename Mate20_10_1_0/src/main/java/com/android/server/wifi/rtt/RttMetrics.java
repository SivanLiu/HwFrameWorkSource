...
public class RttMetrics {
    ...
    private static final int[] DISTANCE_MM_HISTOGRAM = {0, 5000, 15000, 30000, 60000, 100000};
    ...
    public void recordOverallStatus(int status) {
        SparseIntArray sparseIntArray = this.mOverallStatusHistogram;
        sparseIntArray.put(status, sparseIntArray.get(status) + 1);
    }
