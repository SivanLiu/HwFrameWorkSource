...
public class WifiRepeaterConfigStore extends StateMachine {
    ...
    class DefaultState extends State {
        ...
        public boolean processMessage(Message message) {
            switch (message.what) {
                case HwWifiP2pService.CMD_SET_REPEATER_CONFIG /*{ENCODED_INT: 143461}*/:
                case HwWifiP2pService.CMD_SET_REPEATER_CONFIG_COMPLETED /*{ENCODED_INT: 143462}*/:
                    HwHiLog.e(WifiRepeaterConfigStore.TAG, false, "%{public}s", new Object[]{"Unexpected message: " + message});
                    break;
                case HwWifiP2pService.CMD_REQUEST_REPEATER_CONFIG /*{ENCODED_INT: 143463}*/:
