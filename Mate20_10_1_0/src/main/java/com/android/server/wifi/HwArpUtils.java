...
public class HwArpUtils {
    ...
    public static String getIpRouteTable() {
        ...
        try {
            ...
            try {
                ...
                while (doneMessageCount == 0) {
                    try {
                        ...
                        objArr[r5] = "getIpRouteTable";
                        HwHiLog.e(TAG, (boolean) r5, "fail %{public}s", objArr);
                        return null;
                        ...
                        objArr2[r5] = "getIpRouteTable";
                        HwHiLog.e(TAG, (boolean) r5, "fail %{public}s", objArr2);
                        return null;
                        ...
                        objArr22[r5] = "getIpRouteTable";
                        HwHiLog.e(TAG, (boolean) r5, "fail %{public}s", objArr22);
                        return null;
                    }
                }
                IoUtils.closeQuietly(fd);
                ...
                objArr222[r5] = "getIpRouteTable";
                HwHiLog.e(TAG, (boolean) r5, "fail %{public}s", objArr222);
                return null;
                ...
                objArr2222[r5] = "getIpRouteTable";
                HwHiLog.e(TAG, (boolean) r5, "fail %{public}s", objArr2222);
                return null;
                ...
                objArr22222[r5] = "getIpRouteTable";
                HwHiLog.e(TAG, (boolean) r5, "fail %{public}s", objArr22222);
                return null;
            } catch (Throwable th) {
                th = th;
                IoUtils.closeQuietly(fd);
            ...
            objArr222222[r5] = "getIpRouteTable";
            HwHiLog.e(TAG, (boolean) r5, "fail %{public}s", objArr222222);
            return null;
            ...
            objArr2222222[r5] = "getIpRouteTable";
            HwHiLog.e(TAG, (boolean) r5, "fail %{public}s", objArr2222222);
            return null;
            ...
            objArr22222222[r5] = "getIpRouteTable";
            HwHiLog.e(TAG, (boolean) r5, "fail %{public}s", objArr22222222);
            return null;
        } catch (Throwable th2) {
            th = th2;
            IoUtils.closeQuietly(fd);
    ...
    public static String writeFile(String fileName, String ctrl) {
        String result = HwWifiCHRHilink.WEB_DELAY_NEEDUPLOAD;
        File file = new File(fileName);
