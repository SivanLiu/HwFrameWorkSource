...
public class SarManager {
    ...
    private void readSarConfigs() {
        this.mSupportSarTxPowerLimit = this.mContext.getResources().getBoolean(17891586);
        if (!this.mSupportSarTxPowerLimit) {
        ...
        this.mSupportSarSoftAp = this.mContext.getResources().getBoolean(17891587);
        this.mSupportSarSensor = this.mContext.getResources().getBoolean(17891585);
    ...
    private class SarSensorEventListener implements SensorEventListener {
        ...
        public boolean register() {
            String sensorType = SarManager.this.mContext.getResources().getString(17039897);
