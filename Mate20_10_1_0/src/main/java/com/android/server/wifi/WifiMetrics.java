...
public class WifiMetrics {
    ...
    /* JADX INFO: Multiple debug info for r3v20 'savedPasspointProviderProfiles'  java.util.Set<com.android.server.wifi.hotspot2.PasspointProvider>: [D('isOpen' boolean), D('savedPasspointProviderProfiles' java.util.Set<com.android.server.wifi.hotspot2.PasspointProvider>)] */
