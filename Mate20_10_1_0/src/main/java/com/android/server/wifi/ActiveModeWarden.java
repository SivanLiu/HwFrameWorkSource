    ...
    public class ModeStateMachine extends StateMachine {
        ...
        class ClientModeActiveState extends ModeActiveState {
            ...
            public boolean processMessage(Message message) {
                ...
                if (i != 0) {
                    switch (i) {
                        case ActiveModeWarden.CMD_CLIENT_MODE_STOPPED /*{ENCODED_INT: 131375}*/:
                        ...
                        case ActiveModeWarden.CMD_CLIENT_MODE_FAILED /*{ENCODED_INT: 131376}*/:
                            if (this.mListener == message.obj) {
        ...
        class ScanOnlyModeActiveState extends ModeActiveState {
            ...
            public boolean processMessage(Message message) {
                ...
                if (i != 1) {
                    switch (i) {
                        case ActiveModeWarden.CMD_SCAN_ONLY_MODE_STOPPED /*{ENCODED_INT: 131275}*/:
                            if (this.mListener == message.obj) {
                        ...
                        case ActiveModeWarden.CMD_SCAN_ONLY_MODE_FAILED /*{ENCODED_INT: 131276}*/:
                            if (this.mListener == message.obj) {
        ...
        public void onStatusChanged(boolean isReady) {
            if (!isReady) {
                ActiveModeWarden.this.mHandler.post(new Runnable() {
                    ...
                    public final void run() {
                        WifiNativeStatusListener.this.lambda$onStatusChanged$0$ActiveModeWarden$WifiNativeStatusListener();
                    }
                });
            }
        }
