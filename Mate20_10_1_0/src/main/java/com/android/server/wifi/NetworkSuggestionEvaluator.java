...
public class NetworkSuggestionEvaluator implements WifiNetworkSelector.NetworkEvaluator {
    ...
    @Override // com.android.server.wifi.WifiNetworkSelector.NetworkEvaluator
    public WifiConfiguration evaluateNetworks(List<ScanDetail> scanDetails, WifiConfiguration currentNetwork, String currentBssid, boolean connected, boolean untrustedNetworkAllowed, OnConnectableListener onConnectableListener) {
    ...
    public class MatchMetaInfo {
            ...
            for (WifiNetworkSuggestion wifiNetworkSuggestion : wifiNetworkSuggestions) {
                this.mAppInfos.computeIfAbsent(wifiNetworkSuggestion.suggestorPackageName, new Function() {
                    ...
                    public final Object apply(Object obj) {
                        return MatchMetaInfo.this.lambda$putAll$0$NetworkSuggestionEvaluator$MatchMetaInfo((String) obj);
                    }
        ...
        public PerNetworkSuggestionMatchMetaInfo findConnectableNetworksAndPickBest(OnConnectableListener onConnectableListener) {
