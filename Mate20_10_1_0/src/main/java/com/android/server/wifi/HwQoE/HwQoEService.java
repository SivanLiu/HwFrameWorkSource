...
public class HwQoEService implements IHwQoEContentAwareCallback, IGameCHRCallback, IHiDataCHRCallBack {
    ...
    /* access modifiers changed from: private */
    public void handleWifiConnectForQowAdapter(Message msg) {
        if (msg == null) {
    ...
    /* access modifiers changed from: private */
    public void handleWifiDisconnectForQowAdapter() {
        synchronized (this.mLock) {
    ...
    /* access modifiers changed from: private */
    public void handleWifiRssiChangedForQowAdapter() {
        this.mWifiInfo = this.mWifiManager.getConnectionInfo();
        if (this.mWifiInfo == null) {
        ...
        if (this.mIsInGameState) {
            if (rssiLevel < 2) {
                if (!this.mQoEHandler.hasMessages(HwQoEUtils.QOE_MSG_WIFI_DELAY_DISCONNECT)) {
                    this.mQoEHandler.sendEmptyMessageDelayed(HwQoEUtils.QOE_MSG_WIFI_DELAY_DISCONNECT, WifiHandover.HANDOVER_WAIT_SCAN_TIME_OUT);
                }
            } else if (this.mQoEHandler.hasMessages(HwQoEUtils.QOE_MSG_WIFI_DELAY_DISCONNECT)) {
                this.mQoEHandler.removeMessages(HwQoEUtils.QOE_MSG_WIFI_DELAY_DISCONNECT);
            }
    ...
    /* access modifiers changed from: private */
    public void handleWifiDisableForQowAdapter() {
    ...
    /* access modifiers changed from: private */
    public void handleWifiRoamingForQowAdapter() {
    ...
    /* access modifiers changed from: private */
    public void handleBootCompleteForQowAdapter() {
    ...
    /* access modifiers changed from: private */
    public void handleUpdateUidTcpRttForQowAdapter() {
    ...
    /* access modifiers changed from: private */
    public int getDataNetworkType(int subId, ServiceState ss) {
        int networkType = 0;
    ...
    /* access modifiers changed from: private */
    public PhoneStateListener getPhoneStateListener(final int subId) {
