...
public class WifiScoreCard {
    ...
    /* access modifiers changed from: private */
    public long mTsConnectionAttemptStart = -1;
    ...
    public void noteNetworkAgentCreated(ExtendedWifiInfo wifiInfo, int networkAgentId) {
        int unused = lookupBssid(wifiInfo.getSSID(), wifiInfo.getBSSID()).mNetworkAgentId = networkAgentId;
    }
    ...
    public final class PerBssid {
        ...
        /* access modifiers changed from: private */
        public int mNetworkAgentId = Integer.MIN_VALUE;
        /* access modifiers changed from: private */
        public int mNetworkConfigId = Integer.MIN_VALUE;
        private final AtomicReference<byte[]> mPendingReadFromStore = new AtomicReference<>();
        /* access modifiers changed from: private */
        public WifiScoreCardProto.SecurityType mSecurityType = null;
    ...
    /* access modifiers changed from: private */
    public long computeHashLong(String ssid, MacAddress mac) {
        try {
