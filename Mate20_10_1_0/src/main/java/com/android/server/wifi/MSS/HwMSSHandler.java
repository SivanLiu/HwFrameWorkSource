...
public class HwMSSHandler implements HwMSSHandlerManager, HwMSSArbitrager.IHwMSSObserver {
        ...
        this.mHandler = new Handler(handlerThread.getLooper()) {
            ...
            private void handleMessageForBrcm(Message msg) {
                ...
                if (i != 0) {
                    if (i == 1) {
                        ...
                        } else if (i == HwMSSHandler.WIFI_THERMAL_MIMO_TO_SISO && HwMSSHandler.this.mThermalLevel >= 1 && HwMSSHandler.this.mThermalLevel <= 5) {
            ...
            private void handleMessageForHisi(Message msg) {
                ...
                if (i != 0) {
                    if (i == 1) {
                        HwMSSHandler.this.mssArbi.setSisoFixFlag(false);
                        boolean unused = HwMSSHandler.this.doMssSwitchForHisi(2, true);
                    } else if (i == 2) {
                        HwMSSHandler.this.restoreCurrentChainStateForHisi();
                    } else if (i == 3) {
                        HwMSSHandler hwMSSHandler = HwMSSHandler.this;
                        boolean unused2 = hwMSSHandler.doMssSwitchForHisi(hwMSSHandler.mCellPhoneWIFIOperation, true);
                    } else if (i != 99 && i == HwMSSHandler.WIFI_THERMAL_MIMO_TO_SISO && HwMSSHandler.this.mThermalLevel >= 1 && HwMSSHandler.this.mThermalLevel <= 5) {
                        HwMSSHandler.access$1008(HwMSSHandler.this);
                        if (HwMSSHandler.this.mTempSISOCount == 3) {
                            HwMSSHandler.this.tempChangeWiFiState(HwMSSHandler.WIFI_THERMAL_MIMO_TO_SISO);
                            HwMSSHandler.this.clearTempCount(false);
                    ...
                    int unused3 = HwMSSHandler.this.mTriggerReason = msg.arg2;
                }
            }
        };
    }
    ...
    /* access modifiers changed from: private */
    public boolean mssSwitchSupportCheck() {
            ...
            if (intent != null) {
                ...
                if ("android.net.wifi.p2p.CONNECTION_STATE_CHANGE".equals(action)) {
                    ...
                    if (3 == state2) {
                        ...
                        boolean unused4 = HwMSSHandler.this.m2GHT40Enabled = false;
                        ...
                        boolean unused5 = HwMSSHandler.this.mWifiEnabled = false;
                        if (HwMSSHandler.this.mIs1103 || HwMSSHandler.this.mIs1105) {
                ...
                if (HwMSSHandler.THERMAL_TO_WIFI.equals(action)) {
                    int unused7 = HwMSSHandler.this.mThermalLevel = intent.getIntExtra("level", -1);
                    int unused8 = HwMSSHandler.this.mThermalTemp = intent.getIntExtra("temp", -1);
                    int unused9 = HwMSSHandler.this.mThermalScene = intent.getIntExtra("scene", -1);
                ...
                if ("android.net.wifi.WIFI_AP_STATE_CHANGED".equals(action)) {
                    ...
                    if (apState == 11) {
                        boolean unused10 = HwMSSHandler.this.mWiFiApMode = false;
                        HwMSSHandler.this.mssArbi.setSisoFixFlag(false);
                    } else if (apState == 13) {
                        boolean unused11 = HwMSSHandler.this.mWiFiApMode = true;
                    }
                }
            }
        }
