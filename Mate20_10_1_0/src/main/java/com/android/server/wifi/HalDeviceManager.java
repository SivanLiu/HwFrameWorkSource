...
public class HalDeviceManager {
    ...
    private class WifiChipInfo {
        ...
        public String toString() {
            ...
            int[] access$100 = HalDeviceManager.IFACE_TYPES_BY_PRIORITY;
            for (int type : access$100) {
            ...
            if (handler != null) {
                handler.post(new Runnable() {
                    ...
                    public final void run() {
                        ListenerProxy.this.lambda$trigger$0$HalDeviceManager$ListenerProxy();
                    }
                });
            } else {
        ...
        public void triggerWithArg(boolean arg) {
            ...
            if (handler != null) {
                handler.post(new Runnable(arg) {
                    ...
                    public final void run() {
                        ListenerProxy.this.lambda$triggerWithArg$1$HalDeviceManager$ListenerProxy(this.f$1);
                    }
                });
            } else {
    ...
    public class InterfaceRttControllerLifecycleCallbackProxy implements InterfaceRttControllerLifecycleCallback {
        ...
        public void onNewRttController(IWifiRttController controller) {
            this.mHandler.post(new Runnable(controller) {
                ...
                public final void run() {
                    InterfaceRttControllerLifecycleCallbackProxy.this.lambda$onNewRttController$0$HalDeviceManager$InterfaceRttControllerLifecycleCallbackProxy(this.f$1);
                }
            });
        }
        ...
        public void onRttControllerDestroyed() {
            this.mHandler.post(new Runnable() {
                ...
                public final void run() {
                    InterfaceRttControllerLifecycleCallbackProxy.this.lambda$onRttControllerDestroyed$1$HalDeviceManager$InterfaceRttControllerLifecycleCallbackProxy();
                }
            });
        }
    }
