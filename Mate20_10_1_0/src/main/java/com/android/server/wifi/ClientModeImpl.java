...
public class ClientModeImpl extends AbsWifiStateMachine implements IHwWifiStateMachineInner {
    ...
    public static final String CHIPSET_TYPE = SystemProperties.get("ro.connectivity.sub_chiptype", "none");
    ...
    /* access modifiers changed from: private */
    public boolean isRandomSelfCure = false;
    /* access modifiers changed from: private */
    public boolean isUseRandomMac = false;
    ...
    static /* synthetic */ int access$10108(ClientModeImpl x0) {
        int i = x0.mRssiPollToken;
        x0.mRssiPollToken = i + 1;
        return i;
    }

    static /* synthetic */ int access$13808(ClientModeImpl x0) {
        int i = x0.mRoamFailCount;
        x0.mRoamFailCount = i + 1;
        return i;
    }

    static /* synthetic */ int access$6808(ClientModeImpl x0) {
    ...
    public ClientModeImpl(Context context, FrameworkFacade facade, Looper looper, UserManager userManager, WifiInjector wifiInjector, BackupManagerProxy backupManagerProxy, WifiCountryCode countryCode, WifiNative wifiNative, WrongPasswordNotifier wrongPasswordNotifier, SarManager sarManager, WifiTrafficPoller wifiTrafficPoller, LinkProbeManager linkProbeManager) {
        ...
        this.mPrimaryDeviceType = this.mContext.getResources().getString(17039895);
        ...
        this.mFacade.registerContentObserver(this.mContext, Settings.Global.getUriFor("wifi_suspend_optimizations_enabled"), false, new ContentObserver(getHandler()) {
            ...
            public void onChange(boolean selfChange) {
                AtomicBoolean access$300 = ClientModeImpl.this.mUserWantsSuspendOpt;
                boolean z = true;
        ...
        this.mContext.registerReceiver(new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                boolean z = false;
                boolean unused = ClientModeImpl.this.mIsRunning = false;
                ClientModeImpl clientModeImpl = ClientModeImpl.this;
                if (getSendingUserId() == -1) {
                    z = true;
                }
                boolean unused2 = clientModeImpl.mIsRealReboot = z;
        ...
        this.mConnectedMacRandomzationSupported = (!this.mContext.getResources().getBoolean(17891576) || !WifiConfiguration.IS_WIFI_RANDOM_MAC_EN) ? false : z;
        ...
        this.mTcpBufferSizes = this.mContext.getResources().getString(17039899);
    ...
    public boolean setRandomMacOui() {
        String oui = this.mContext.getResources().getString(17039896);
    ...
    public void logStateAndMessage(Message message, State state) {
        ...
        if (mLogMessages) {
            switch (message.what) {
                ...
                case CMD_GET_SUPPORTED_FEATURES /*{ENCODED_INT: 131133}*/:
                case CMD_GET_LINK_LAYER_STATS /*{ENCODED_INT: 131135}*/:
    ...
    private void initializeWpsDetails() {
        String detail = this.mPropertyService.get(PRODUCT_NAME, "");
    ...
    public void fetchRssiLinkSpeedAndFrequencyNative() {
        if (SupplicantState.ASSOCIATED.compareTo((Enum) this.mWifiInfo.getSupplicantState()) > 0 || SupplicantState.COMPLETED.compareTo((Enum) this.mWifiInfo.getSupplicantState()) < 0) {
            ...
            switch (message.what) {
                ...
                case ClientModeImpl.CMD_GET_SUPPORTED_FEATURES /*{ENCODED_INT: 131133}*/:
                    if (ClientModeImpl.this.mFeatureSet <= 0) {
                        ...
                        long unused6 = clientModeImpl3.mFeatureSet = clientModeImpl3.mWifiNative.getSupportedFeatureSet(ClientModeImpl.this.mInterfaceName);
                        if (ClientModeImpl.DBG) {
                ...
                case ClientModeImpl.CMD_TEST_NETWORK_DISCONNECT /*{ENCODED_INT: 131161}*/:
                ...
                case ClientModeImpl.CMD_TRY_CACHED_IP /*{ENCODED_INT: 131330}*/:
                case ClientModeImpl.CMD_WPS_PIN_RETRY /*{ENCODED_INT: 131576}*/:
                case ClientModeImpl.CMD_SET_DETECTMODE_CONF /*{ENCODED_INT: 131772}*/:
                case ClientModeImpl.CMD_SET_DETECT_PERIOD /*{ENCODED_INT: 131773}*/:
                case WifiMonitor.NETWORK_CONNECTION_EVENT /*{ENCODED_INT: 147459}*/:
                case WifiMonitor.NETWORK_DISCONNECTION_EVENT /*{ENCODED_INT: 147460}*/:
                case WifiMonitor.AUTHENTICATION_FAILURE_EVENT /*{ENCODED_INT: 147463}*/:
                ...
                case 147474:
                case WifiMonitor.WAPI_CERTIFICATION_FAILURE_EVENT /*{ENCODED_INT: 147475}*/:
                case WifiMonitor.ASSOCIATION_REJECTION_EVENT /*{ENCODED_INT: 147499}*/:
                case WifiMonitor.VOWIFI_DETECT_IRQ_STR_EVENT /*{ENCODED_INT: 147520}*/:
                case WifiMonitor.WPS_START_OKC_EVENT /*{ENCODED_INT: 147656}*/:
                case WifiMonitor.WPA3_CONNECT_FAIL_EVENT /*{ENCODED_INT: 147666}*/:
                case WifiMonitor.EAP_ERRORCODE_REPORT_EVENT /*{ENCODED_INT: 147956}*/:
                case 151575:
                    int unused7 = ClientModeImpl.this.mMessageHandlingStatus = ClientModeImpl.MESSAGE_HANDLING_STATUS_DISCARD;
                    break;
                ...
                case ClientModeImpl.CMD_ENABLE_RSSI_POLL /*{ENCODED_INT: 131154}*/:
                    ...
                    boolean unused8 = clientModeImpl4.mEnableRssiPolling = disableOthers;
                    break;
                ...
                case ClientModeImpl.CMD_BOOT_COMPLETED /*{ENCODED_INT: 131206}*/:
                    boolean unused10 = ClientModeImpl.this.isBootCompleted = true;
                ...
                case ClientModeImpl.CMD_STOP_RSSI_MONITORING_OFFLOAD /*{ENCODED_INT: 131235}*/:
                    int unused13 = ClientModeImpl.this.mMessageHandlingStatus = ClientModeImpl.MESSAGE_HANDLING_STATUS_DISCARD;
                    break;
                ...
                case ClientModeImpl.CMD_START_SUBSCRIPTION_PROVISIONING /*{ENCODED_INT: 131326}*/:
                    ...
                    break;
                case ClientModeImpl.CMD_GET_CHANNEL_LIST_5G /*{ENCODED_INT: 131572}*/:
                    ClientModeImpl.this.replyToMessage(message, message.what, null);
                    break;
                case ClientModeImpl.CMD_PNO_PERIODIC_SCAN /*{ENCODED_INT: 131575}*/:
                    ClientModeImpl.this.deferMessage(message);
                    break;
                case ClientModeImpl.CMD_GET_SUPPORT_VOWIFI_DETECT /*{ENCODED_INT: 131774}*/:
                ...
                case WifiP2pServiceImpl.P2P_CONNECTION_CHANGED /*{ENCODED_INT: 143371}*/:
                    ...
                    if (info.getState() == NetworkInfo.State.DISCONNECTED) {
                        ClientModeImpl.this.setWifiMode(WifiCommonUtils.PACKAGE_NAME_FRAMEWORK, 0);
                        break;
                    }
                    break;
                case WifiP2pServiceImpl.DISCONNECT_WIFI_REQUEST /*{ENCODED_INT: 143372}*/:
                ...
                case WifiMonitor.EVENT_ANT_CORE_ROB /*{ENCODED_INT: 147757}*/:
    ...
    class ConnectModeState extends State {
        ...
        /* JADX INFO: Multiple debug info for r3v102 int: [D('reasonCode' int), D('networkUpdateResult' com.android.server.wifi.NetworkUpdateResult)] */
        /* JADX INFO: Multiple debug info for r3v129 int: [D('netId' int), D('requestData' com.android.server.wifi.util.TelephonyUtil$SimAuthRequestData)] */
        /* JADX WARNING: Code restructure failed: missing block: B:173:0x060f, code lost:
            if (com.android.server.wifi.ClientModeImpl.access$6600(r22.this$0).SSID.equals("\"" + r7 + "\"") != false) goto L_0x0611;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:344:0x0c6c, code lost:
            if (com.android.server.wifi.ClientModeImpl.FACTORY_MODE.equals(android.os.SystemProperties.get(com.android.server.wifi.ClientModeImpl.RO_RUN_MODE, com.android.server.wifi.ClientModeImpl.NORMAL_MODE)) != false) goto L_0x0c9b;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:351:0x0c97, code lost:
            if (com.android.server.wifi.ClientModeImpl.FACTORY_MODE.equals(android.os.SystemProperties.get(com.android.server.wifi.ClientModeImpl.RO_RUN_MODE, com.android.server.wifi.ClientModeImpl.NORMAL_MODE)) != false) goto L_0x0c9b;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:408:0x0f5f, code lost:
            if (com.android.server.wifi.ClientModeImpl.access$9300(r4, com.android.server.wifi.ClientModeImpl.access$4000(r4), r3) != false) goto L_0x0f61;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:419:0x0fcf, code lost:
            if (com.android.server.wifi.ClientModeImpl.access$9300(r6, com.android.server.wifi.ClientModeImpl.access$4000(r6), r5) != false) goto L_0x0fd1;
         */
        public boolean processMessage(Message message) {
            boolean ok;
            ...
            boolean z = true;
            z = true;
            if (clientModeImpl.handleWapiFailureEvent(message, clientModeImpl.mSupplicantStateTracker)) {
                return true;
            }
            int i = -1;
            int i2 = 2;
            ...
            switch (message.what) {
                case ClientModeImpl.CMD_BLUETOOTH_ADAPTER_STATE_CHANGE /*{ENCODED_INT: 131103}*/:
                    ...
                    boolean unused = clientModeImpl2.mBluetoothConnectionActive = z3;
                ...
                case ClientModeImpl.CMD_ENABLE_NETWORK /*{ENCODED_INT: 131126}*/:
                    ...
                    clientModeImpl3.replyToMessage(message, i3, i);
                    break;
                case ClientModeImpl.CMD_GET_LINK_LAYER_STATS /*{ENCODED_INT: 131135}*/:
                ...
                case ClientModeImpl.CMD_REASSOCIATE /*{ENCODED_INT: 131147}*/:
                    ClientModeImpl clientModeImpl4 = ClientModeImpl.this;
                    long unused4 = clientModeImpl4.mLastConnectAttemptTimestamp = clientModeImpl4.mClock.getWallClockMillis();
                ...
                case ClientModeImpl.CMD_GET_MATCHING_CONFIG /*{ENCODED_INT: 131171}*/:
                    break;
                case ClientModeImpl.CMD_RESET_SIM_NETWORKS /*{ENCODED_INT: 131173}*/:
                    if (message.arg1 == 1) {
                ...
                case ClientModeImpl.CMD_ADD_OR_UPDATE_PASSPOINT_CONFIG /*{ENCODED_INT: 131178}*/:
                    ...
                    if (bundle != null) {
                        ...
                        if (!ClientModeImpl.this.mPasspointManager.addOrUpdateProvider(passpointConfig, bundle.getInt(ClientModeImpl.EXTRA_UID), bundle.getString(ClientModeImpl.EXTRA_PACKAGE_NAME))) {
                            ...
                            ClientModeImpl clientModeImpl5 = ClientModeImpl.this;
                            if (!clientModeImpl5.isProviderOwnedNetwork(clientModeImpl5.mTargetNetworkId, fqdn)) {
                                ClientModeImpl clientModeImpl6 = ClientModeImpl.this;
                                break;
                            }
                ...
                case ClientModeImpl.CMD_REMOVE_PASSPOINT_CONFIG /*{ENCODED_INT: 131179}*/:
                    ...
                    if (!ClientModeImpl.this.mPasspointManager.removeProvider(fqdn2)) {
                        ...
                        ClientModeImpl clientModeImpl7 = ClientModeImpl.this;
                        if (!clientModeImpl7.isProviderOwnedNetwork(clientModeImpl7.mTargetNetworkId, fqdn2)) {
                                        ...
                                        if (!WifiCommonUtils.doesNotWifiConnectRejectByCust(config3.getNetworkSelectionStatus(), config3.SSID, ClientModeImpl.this.mContext)) {
                                            if (!HwWifiServiceFactory.getHwWifiDevicePolicy().isWifiRestricted(config3, false)) {
                                                ...
                                                if (ClientModeImpl.this.isEnterpriseHotspot(config3)) {
                                                    ...
                                                    String unused6 = ClientModeImpl.this.mTargetRoamBSSID = "any";
                                                }
                                                ClientModeImpl.this.mWifiScoreCard.noteConnectionAttempt(ClientModeImpl.this.mWifiInfo);
                                                int unused7 = ClientModeImpl.this.mTargetNetworkId = netId3;
                                                boolean unused8 = ClientModeImpl.this.setTargetBssid(config3, bssid);
                                                ClientModeImpl clientModeImpl9 = ClientModeImpl.this;
                                                clientModeImpl9.reportConnectionAttemptStart(config3, clientModeImpl9.mTargetRoamBSSID, 5);
                                                boolean unused9 = ClientModeImpl.this.isRandomSelfCure = false;
                                                boolean unused10 = ClientModeImpl.this.isUseRandomMac = true;
                                                if (config3.macRandomizationSetting != 1 || !ClientModeImpl.this.mConnectedMacRandomzationSupported) {
                                                    boolean unused11 = ClientModeImpl.this.isUseRandomMac = false;
                                                ...
                                                if (!ClientModeImpl.this.mWifiNative.connectToNetwork(ClientModeImpl.this.mInterfaceName, config3)) {
                                                    ...
                                                    long unused12 = clientModeImpl10.mLastConnectAttemptTimestamp = clientModeImpl10.mClock.getWallClockMillis();
                                                    WifiConfiguration unused13 = ClientModeImpl.this.mTargetWifiConfiguration = config3;
                                                    boolean unused14 = ClientModeImpl.this.mIsAutoRoaming = false;
                ...
                case WifiP2pServiceImpl.DISCONNECT_WIFI_REQUEST /*{ENCODED_INT: 143372}*/:
                    if (message.arg1 != 1) {
                        ...
                        boolean unused16 = ClientModeImpl.this.mTemporarilyDisconnectWifi = false;
                        break;
                    } else {
                        ...
                        boolean unused17 = ClientModeImpl.this.mTemporarilyDisconnectWifi = true;
                        break;
                    }
                case WifiMonitor.NETWORK_CONNECTION_EVENT /*{ENCODED_INT: 147459}*/:
                    ...
                    int unused18 = ClientModeImpl.this.mLastNetworkId = message.arg1;
                    ...
                    String unused19 = ClientModeImpl.this.mLastBssid = (String) message.obj;
                    if (ClientModeImpl.this.mLastNetworkId == -1) {
                        ClientModeImpl clientModeImpl12 = ClientModeImpl.this;
                        NetworkUpdateResult networkUpdateResult = clientModeImpl12.saveWpsOkcConfiguration(clientModeImpl12.mLastNetworkId, ClientModeImpl.this.mLastBssid);
                        if (networkUpdateResult != null) {
                            int unused20 = ClientModeImpl.this.mLastNetworkId = networkUpdateResult.getNetworkId();
                        }
                    }
                ...
                case WifiMonitor.AUTHENTICATION_FAILURE_EVENT /*{ENCODED_INT: 147463}*/:
                    ...
                    long unused21 = clientModeImpl19.mLastAuthFailureTimestamp = clientModeImpl19.mClock.getElapsedSinceBootMillis();
                    ...
                    if (!identitySent) {
                        ...
                        if (!(ClientModeImpl.this.mTargetWifiConfiguration == null || ssid == null || ClientModeImpl.this.mTargetWifiConfiguration.SSID == null)) {
                            ...
                            if (ClientModeImpl.this.mTrackEapAuthFailCount >= 3) {
                                ...
                                int unused22 = ClientModeImpl.this.mTrackEapAuthFailCount = 0;
                                ...
                                ClientModeImpl.this.mWifiConfigManager.updateNetworkSelectionStatus(ClientModeImpl.this.mTargetWifiConfiguration.networkId, 9);
                                int unused23 = ClientModeImpl.this.mTrackEapAuthFailCount = 0;
                            } else {
                                ...
                                ClientModeImpl.access$6808(ClientModeImpl.this);
                ...
                case WifiMonitor.ASSOCIATION_REJECTION_EVENT /*{ENCODED_INT: 147499}*/:
                    ...
                    boolean unused24 = ClientModeImpl.this.mDidBlackListBSSID = false;
                    ...
                    if (bssid2 != null) {
                        ...
                        boolean unused25 = clientModeImpl21.mDidBlackListBSSID = clientModeImpl21.mWifiConnectivityManager.trackBssid(bssid2, false, reasonCode3);
                    }
                ...
                case WifiMonitor.ANQP_DONE_EVENT /*{ENCODED_INT: 147500}*/:
                    ...
                    break;
                case WifiMonitor.AUTHENTICATION_TIMEOUT_EVENT /*{ENCODED_INT: 147501}*/:
                ...
                case 151553:
                    ...
                    if (config5 != null) {
                        boolean unused26 = ClientModeImpl.this.mIsFirstConnect = true;
                        ...
                        boolean unused28 = ClientModeImpl.this.mIsFirstConnect = false;
                    }
                    if (ClientModeImpl.this.mHwWifiCHRService != null) {
                    ...
                    if (clientModeImpl26.connectToUserSelectNetwork(netId5, i4, z)) {
                        ...
                        int unused29 = ClientModeImpl.this.mMessageHandlingStatus = -2;
                ...
                case 151569:
                    ...
                    if (!ClientModeImpl.this.mWifiConfigManager.disableNetwork(netId8, message.sendingUid)) {
                        ...
                        int unused30 = ClientModeImpl.this.mMessageHandlingStatus = -2;
    ...
    class WpsRunningState extends State {
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case ClientModeImpl.CMD_START_CONNECT /*{ENCODED_INT: 131215}*/:
                case ClientModeImpl.CMD_START_ROAM /*{ENCODED_INT: 131217}*/:
                    int unused2 = ClientModeImpl.this.mMessageHandlingStatus = ClientModeImpl.MESSAGE_HANDLING_STATUS_DISCARD;
                    return true;
                case ClientModeImpl.CMD_WPS_PIN_RETRY /*{ENCODED_INT: 131576}*/:
    ...
    class L2ConnectedState extends State {
        ...
        public void enter() {
            ...
            ClientModeImpl.access$10108(ClientModeImpl.this);
            ...
            synchronized (ClientModeImpl.this.mNetworkAgentLock) {
                WifiNetworkAgent unused3 = ClientModeImpl.this.mNetworkAgent = new WifiNetworkAgent(ClientModeImpl.this.getHandler().getLooper(), ClientModeImpl.this.mContext, "WifiNetworkAgent", ClientModeImpl.this.mNetworkInfo, nc, ClientModeImpl.this.mLinkProperties, ClientModeImpl.this.reportWifiScoreDelayed() ? 99 : 60, ClientModeImpl.this.mNetworkMisc);
            }
            ...
            switch (message.what) {
                ...
                case WifiMonitor.NETWORK_CONNECTION_EVENT /*{ENCODED_INT: 147459}*/:
                    ...
                    if (ClientModeImpl.this.mLastNetworkId == -1) {
                        ...
                        if (networkUpdateResult != null) {
                            int unused9 = ClientModeImpl.this.mLastNetworkId = networkUpdateResult.getNetworkId();
                        } else {
                            ...
                            if (!(config3 == null || config3.SSID == null || !config3.SSID.equals(ClientModeImpl.this.mWifiInfo.getSSID()))) {
                                int unused10 = ClientModeImpl.this.mLastNetworkId = config3.networkId;
                                ClientModeImpl.this.mWifiInfo.setNetworkId(ClientModeImpl.this.mLastNetworkId);
                            }
                        }
                    }
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case ClientModeImpl.CMD_START_ROAM /*{ENCODED_INT: 131217}*/:
                    int unused2 = ClientModeImpl.this.mMessageHandlingStatus = ClientModeImpl.MESSAGE_HANDLING_STATUS_DISCARD;
                    break;
                case ClientModeImpl.CMD_OBTAINING_IP_TIMEOUT /*{ENCODED_INT: 131331}*/:
                    ClientModeImpl.this.setMulticastFilter(true);
                    ClientModeImpl.this.sendMessage(ClientModeImpl.CMD_IP_CONFIGURATION_LOST);
                    break;
                case WifiMonitor.NETWORK_DISCONNECTION_EVENT /*{ENCODED_INT: 147460}*/:
            ...
            switch (message.what) {
                case ClientModeImpl.CMD_ROAM_WATCHDOG_TIMER /*{ENCODED_INT: 131166}*/:
                    if (ClientModeImpl.this.mRoamWatchdogCount == message.arg1) {
                        ...
                        ClientModeImpl.access$13808(ClientModeImpl.this);
                        ClientModeImpl.this.handleNetworkDisconnect();
                ...
                case WifiMonitor.NETWORK_CONNECTION_EVENT /*{ENCODED_INT: 147459}*/:
                    if (!this.mAssociated) {
                        ...
                        if (ClientModeImpl.this.mLastNetworkId == -1) {
                            ClientModeImpl clientModeImpl2 = ClientModeImpl.this;
                            NetworkUpdateResult networkUpdateResult = clientModeImpl2.saveWpsOkcConfiguration(clientModeImpl2.mLastNetworkId, ClientModeImpl.this.mLastBssid);
                            if (networkUpdateResult != null) {
                                int unused4 = ClientModeImpl.this.mLastNetworkId = networkUpdateResult.getNetworkId();
                            }
                        }
                        ClientModeImpl.this.mWifiInfo.setBSSID(ClientModeImpl.this.mLastBssid);
                        ClientModeImpl.this.mWifiInfo.setNetworkId(ClientModeImpl.this.mLastNetworkId);
                ...
                case WifiMonitor.NETWORK_DISCONNECTION_EVENT /*{ENCODED_INT: 147460}*/:
                    ...
                    ClientModeImpl clientModeImpl8 = ClientModeImpl.this;
                    clientModeImpl8.log("NETWORK_DISCONNECTION_EVENT in roaming state BSSID=" + StringUtilEx.safeDisplayBssid(bssid) + " target=" + target);
    ...
    public boolean isInWifiSettings() {
        return false;
    }
    ...
    /* access modifiers changed from: private */
    public void uploadDhcpState(DhcpResults dhcpResults) {
    ...
    /* access modifiers changed from: private */
    public void setSupportedWifiCategory() {
        if (this.mLastBssid != null) {
