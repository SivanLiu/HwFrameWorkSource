...
public class SupplicantHeartBeat extends StateMachine implements HwSupplicantHeartBeat {
    ...
    class EnterSupplicantStarted extends State {
        ...
        public void enter() {
            ...
            boolean unused = supplicantHeartBeat.mHeartBeatEnabled = supplicantHeartBeat.checkHeartBeatStatus();
        }
    }
    ...
    class DefaultState extends State {
        ...
        public boolean processMessage(Message msg) {
            ...
            switch (msg.what) {
                case SupplicantHeartBeat.CMD_ENTER_SUPPLICANT_STARTED /*{ENCODED_INT: 999901}*/:
                    SupplicantHeartBeat supplicantHeartBeat = SupplicantHeartBeat.this;
                    supplicantHeartBeat.transitionTo(supplicantHeartBeat.mHeartAckState);
                    break;
                case SupplicantHeartBeat.CMD_EXIT_SUPPLICANT_STARTED /*{ENCODED_INT: 999902}*/:
