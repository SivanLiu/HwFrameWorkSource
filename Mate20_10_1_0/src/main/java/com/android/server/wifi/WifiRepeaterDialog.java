...
public class WifiRepeaterDialog {
    ...
    /* access modifiers changed from: private */
    public Handler mConfirmWifiRepeaterHandler = new Handler() {
    ...
    /* access modifiers changed from: private */
    public AlertDialog mWifiRepeaterConfirmDialog = null;
    ...
    private AlertDialog.Builder getDialogBuilder(int msgType, DialogInterface.OnClickListener positiveListener, DialogInterface.OnClickListener negativeListener) {
        ...
        if (msgType == 2) {
            ...
            msgResId = 33686023;
            positiveTxtResId = 33686022;
        } else if (msgType == 1) {
            checkBox.setVisibility(8);
            msgResId = 33686016;
            positiveTxtResId = 33686014;
        } else if (msgType == 3) {
            checkBox.setVisibility(8);
            msgResId = 33686017;
            positiveTxtResId = 33686081;
        } else {
        ...
        builder.setNegativeButton(33685746, negativeListener);
        return builder;
    }
    ...
    private AlertDialog getDialog(final int msgType, final IWifiRepeaterConfirmListener listener) {
        ...
        AlertDialog.Builder builder = getDialogBuilder(msgType, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                boolean unused = WifiRepeaterDialog.this.isDialogShowing = false;
                try {
                    if (msgType == 2) {
    ...
    /* access modifiers changed from: private */
    public void showWifiRepeaterDialog(int msgType, IWifiRepeaterConfirmListener listener) {
        if (listener == null) {
