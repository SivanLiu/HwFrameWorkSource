...
public class WifiAwareDiscoverySessionState {
    ...
    /* JADX INFO: Multiple debug info for r0v2 int: [D('newPeerId' int), D('i' int)] */
    private int getPeerIdOrAddIfNew(int requestorInstanceId, byte[] peerMac) {
        ...
        int i2 = sNextPeerIdToBeAllocated;
        sNextPeerIdToBeAllocated = i2 + 1;
        this.mPeerInfoByRequestorInstanceId.put(i2, new PeerInfo(requestorInstanceId, peerMac));
        return i2;
    }
