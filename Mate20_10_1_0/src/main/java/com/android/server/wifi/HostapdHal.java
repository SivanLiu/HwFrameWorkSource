...
public class HostapdHal {
        ...
        public void serviceDied(long cookie) {
            HostapdHal.this.mEventHandler.post(new Runnable(cookie) {
                ...
                public final void run() {
                    ServiceManagerDeathRecipient.this.lambda$serviceDied$0$HostapdHal$ServiceManagerDeathRecipient(this.f$1);
                }
            });
        }
    ...
    public class HostapdDeathRecipient implements IHwBinder.DeathRecipient {
        ...
        public void serviceDied(long cookie) {
            HostapdHal.this.mEventHandler.post(new Runnable(cookie) {
                ...
                public final void run() {
                    HostapdDeathRecipient.this.lambda$serviceDied$0$HostapdHal$HostapdDeathRecipient(this.f$1);
                }
            });
        }
    ...
    public HostapdHal(Context context, Looper looper) {
        ...
        this.mEnableAcs = context.getResources().getBoolean(17891594);
        this.mEnableIeee80211AC = context.getResources().getBoolean(17891595);
        this.mAcsChannelRanges = toAcsChannelRanges(context.getResources().getString(17039898));
    ...
    /* access modifiers changed from: private */
    public void hostapdServiceDiedHandler(long cookie) {
        synchronized (this.mLock) {
