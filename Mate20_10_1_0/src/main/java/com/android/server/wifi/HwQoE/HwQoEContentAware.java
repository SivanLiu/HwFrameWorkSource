...
public class HwQoEContentAware {
    ...
    /* access modifiers changed from: private */
    public HwWifiProServiceManager mHwWifiProServiceManager;
    ...
    private class HwProcessObserver extends IProcessObserver.Stub {
        ...
        public void onForegroundActivitiesChanged(int pid, int uid, boolean foregroundActivities) {
            if (foregroundActivities) {
                ...
                String unused = hwQoEContentAware.mForegroundAppPackageName = hwQoEContentAware.getAppNameUid(uid);
            ...
            if (uid > 0 && !TextUtils.isEmpty(HwQoEContentAware.this.mPackageName)) {
                if (foregroundActivities && HwQoEContentAware.this.mPackageName.equals(HwQoEContentAware.this.getAppNameUid(uid))) {
                    ...
                    String unused4 = hwQoEContentAware5.mForegroundName = hwQoEContentAware5.getForegroundActivity();
                    ...
                    if (!TextUtils.isEmpty(HwQoEContentAware.this.mForegroundName)) {
                        String access$1100 = HwQoEContentAware.this.mForegroundName;
                        HwQoEContentAware hwQoEContentAware7 = HwQoEContentAware.this;
                        if (access$1100.equals(hwQoEContentAware7.getAppNameUid(hwQoEContentAware7.mCurrMoniorUid))) {
        ...
        public void onProcessDied(int pid, int uid) {
            if (HwQoEContentAware.this.isSensitiveApp && uid == HwQoEContentAware.this.mCurrMoniorUid) {
                HwQoEContentAware hwQoEContentAware = HwQoEContentAware.this;
                String unused = hwQoEContentAware.mForegroundName = hwQoEContentAware.getForegroundActivity();
            }
        }
    }
    ...
    /* JADX INFO: Multiple debug info for r4v4 long: [D('outSpeed' long), D('inSpeed' long)] */
        ...
        if (timestamp2 <= 0) {
            ...
            if (hwQoEContentAware2.mCallback != null && isWechartCalling()) {
                if (inSpeed != 0 || rxTcpBytes2 == 0) {
                    hwQoEContentAware2.mCallback.onPeriodSpeed(outSpeed, inSpeed);
                } else {
    ...
    /* access modifiers changed from: private */
    public void handleAppUdpMonitor() {
    ...
    /* access modifiers changed from: private */
    public void logD(boolean isFmtStrPrivate, String log, Object... args) {
