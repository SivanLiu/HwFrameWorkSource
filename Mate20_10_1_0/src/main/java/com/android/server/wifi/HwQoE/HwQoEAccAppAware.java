...
public class HwQoEAccAppAware {
    ...
    public final IHwActivityNotifierEx mActivityNotifierEx = new IHwActivityNotifierEx() {
    ...
    /* access modifiers changed from: private */
    public final HwQoEHilink.IAppListStateChangeCallback mAppListStateChangeCallback = new HwQoEHilink.IAppListStateChangeCallback() {
    ...
    /* access modifiers changed from: private */
    public void registerHiDataMonitor() {
    ...
    /* access modifiers changed from: private */
    public void registerAppListStateChangeCallback(HwQoEHilink.IAppListStateChangeCallback appListStateChangeCallback) {
    ...
    /* access modifiers changed from: private */
    public void updateAccAppListAndTriggerAcc(List<String> appList) {
        String accAppName = "";
        synchronized (this.mLock) {
    ...
    /* access modifiers changed from: private */
    public void handleActivityChange(String packageName, String className, int appUid) {
