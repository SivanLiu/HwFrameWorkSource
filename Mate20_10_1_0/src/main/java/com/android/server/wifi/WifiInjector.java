...
public class WifiInjector {
    ...
    public WifiInjector(Context context) {
        if (context == null) {
            ...
            this.mCountryCode = HwWifiServiceFactory.getHwWifiServiceManager().createHwWifiCountryCode(this.mContext, this.mWifiNative, SystemProperties.get(BOOT_DEFAULT_WIFI_COUNTRY_CODE), this.mContext.getResources().getBoolean(17891593));
    ...
    public void startHwWifiService() {
        ...
        this.mWifiController.createDCService(this.mContext);
