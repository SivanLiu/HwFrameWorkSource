...
public class WifiNative implements IHwWifiNativeInner {
        ...
        public void interfaceLinkStateChanged(String ifaceName, boolean unusedIsLinkUp) {
            WifiNative.this.mHandler.post(new Runnable(ifaceName) {
                ...
                public final void run() {
                    NetworkObserverInternal.this.lambda$interfaceLinkStateChanged$0$WifiNative$NetworkObserverInternal(this.f$1);
                }
            });
        }
    ...
    public String getClientInterfaceName() {
        String access$2200;
        synchronized (this.mLock) {
            access$2200 = this.mIfaceMgr.findAnyStaIfaceName();
        }
        return access$2200;
    }
    ...
    public String getSoftApInterfaceName() {
        String access$2300;
        synchronized (this.mLock) {
            access$2300 = this.mIfaceMgr.findAnyApIfaceName();
        }
        return access$2300;
    }
