...
public final class ContentCaptureManagerService extends AbstractMasterSystemService<ContentCaptureManagerService, ContentCapturePerUserService> {
    ...
    public void listSessions(int userId, IResultReceiver receiver) {
        ...
        synchronized (this.mLock) {
            if (userId != -1) {
                ...
                visitServicesLocked(new Visitor(sessions) {
    ...
    final class ContentCaptureManagerServiceStub extends IContentCaptureManager.Stub {
            ...
            synchronized (ContentCaptureManagerService.this.mLock) {
                if (!ContentCaptureManagerService.this.throwsSecurityException(result, new Runnable() {
                    ...
                    public final void run() {
                        ContentCaptureManagerServiceStub.this.lambda$isContentCaptureFeatureEnabled$0$ContentCaptureManagerService$ContentCaptureManagerServiceStub();
                    }
                })) {
                    int i = 1;
                    boolean enabled = !ContentCaptureManagerService.this.mDisabledByDeviceConfig && !ContentCaptureManagerService.this.isDisabledBySettingsLocked(UserHandle.getCallingUserId());
                }
            }
        }
        ...
        public void getServiceSettingsActivity(IResultReceiver result) {
            if (!ContentCaptureManagerService.this.throwsSecurityException(result, new Runnable() {
                ...
                public final void run() {
                    ContentCaptureManagerServiceStub.this.lambda$getServiceSettingsActivity$1$ContentCaptureManagerService$ContentCaptureManagerServiceStub();
                }
            })) {
                int userId = UserHandle.getCallingUserId();
                synchronized (ContentCaptureManagerService.this.mLock) {
        ...
        public void getContentCaptureConditions(String packageName, IResultReceiver result) {
            ...
            if (!ContentCaptureManagerService.this.throwsSecurityException(result, new Runnable(packageName) {
                ...
                public final void run() {
                    ContentCaptureManagerServiceStub.this.lambda$getContentCaptureConditions$2$ContentCaptureManagerService$ContentCaptureManagerServiceStub(this.f$1);
                }
            })) {
                int userId = UserHandle.getCallingUserId();
                synchronized (ContentCaptureManagerService.this.mLock) {
    ...
    final class GlobalContentCaptureOptions extends GlobalWhitelistState {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:30:0x00bb, code lost:
            r1 = new android.content.ContentCaptureOptions(r10.this$0.mDevCfgLoggingLevel, r10.this$0.mDevCfgMaxBufferSize, r10.this$0.mDevCfgIdleFlushingFrequencyMs, r10.this$0.mDevCfgTextChangeFlushingFrequencyMs, r10.this$0.mDevCfgLogHistorySize, r0);
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x00dc, code lost:
            ...
            android.util.Slog.v(r3, "getOptionsForPackage(" + r12 + "): " + r1);
         */
            ...
            synchronized (this.mGlobalWhitelistStateLock) {
                ...
                if (!packageWhitelisted && (whitelistedComponents = getWhitelistedComponents(userId, packageName)) == null && packageName.equals(this.mServicePackages.get(userId))) {
                    if (ContentCaptureManagerService.this.verbose) {
                        String access$3600 = ContentCaptureManagerService.this.mTag;
                        Slog.v(access$3600, "getOptionsForPackage() lite for " + packageName);
                    }
