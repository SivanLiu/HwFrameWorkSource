...
final class SaveUi {
    ...
    SaveUi(Context context, PendingUi pendingUi, CharSequence serviceLabel, Drawable serviceIcon, String servicePackageName, ComponentName componentName, SaveInfo info, ValueFinder valueFinder, OverlayControl overlayControl, OnSaveListener listener, boolean nightMode, boolean isUpdate, boolean compatMode) {
        ...
        TextView titleView = (TextView) view.findViewById(16908779);
        ...
        if (applyCustomDescription(context2, view, valueFinder, info)) {
            ...
            if (this.mSubTitle != null) {
                writeLog(1131, type);
                ViewGroup subtitleContainer = (ViewGroup) view.findViewById(16908776);
        ...
        TextView noButton = (TextView) view.findViewById(16908778);
        if (info.getNegativeActionStyle() == 1) {
            noButton.setText(17041160);
        } else {
        ...
        TextView yesButton = (TextView) view.findViewById(16908780);
        if (isUpdate) {
    ...
    private boolean applyCustomDescription(Context context, View saveUiView, ValueFinder valueFinder, SaveInfo info) {
        ...
        if (transformations3 == null || InternalTransformation.batchApply(valueFinder, template, transformations3)) {
            try {
                View customSubtitleView = template.applyWithTheme(context, null, new RemoteViews.OnClickHandler(type3) {
                ...
                try {
                    ViewGroup subtitleContainer = (ViewGroup) saveUiView.findViewById(16908776);
    ...
    private void setServiceIcon(Context context, View view, Drawable serviceIcon) {
        ImageView iconView = (ImageView) view.findViewById(16908777);
