...
final class FillUi {
    ...
    FillUi(Context context, FillResponse response, AutofillId focusedViewId, String filterText, OverlayControl overlayControl, CharSequence serviceLabel, Drawable serviceIcon, boolean nightMode, Callback callback) {
        ...
        TextView titleView = (TextView) decor.findViewById(16908774);
        if (titleView != null) {
            titleView.setText(this.mContext.getString(17039696, serviceLabel));
        }
        ImageView iconView = (ImageView) decor.findViewById(16908771);
        if (iconView != null) {
        ...
        if (response.getAuthentication() != null) {
            ...
            this.mFooter = null;
            this.mAdapter = null;
            ViewGroup container = (ViewGroup) decor.findViewById(16908773);
            try {
            ...
            if (headerPresentation2 != null) {
                ...
                LinearLayout headerContainer = (LinearLayout) decor.findViewById(16908770);
                if (Helper.sVerbose) {
            ...
            if (footerPresentation2 != null) {
                LinearLayout footerContainer2 = (LinearLayout) decor.findViewById(16908769);
            ...
            this.mListView = (ListView) decor.findViewById(16908772);
            ...
            if (iHwAutofillHelper != null && iHwAutofillHelper.isHwAutofillService(this.mContext)) {
                FrameLayout layout = (FrameLayout) decor.findViewById(16908773);
        ...
        public void show(WindowManager.LayoutParams p, Rect transitionEpicenter, boolean fitsSystemWindows, int layoutDirection) {
            ...
            UiThread.getHandler().post(new Runnable(p) {
                ...
                public final void run() {
                    AutofillWindowPresenter.this.lambda$show$0$FillUi$AutofillWindowPresenter(this.f$1);
                }
            });
        }
    ...
    private final class ItemsAdapter extends BaseAdapter implements Filterable {
        ...
        public Filter getFilter() {
            return new Filter() {
                ...
                public FilterResults performFiltering(CharSequence filterText) {
