...
public final class AutofillManagerService extends AbstractMasterSystemService<AutofillManagerService, AutofillManagerServiceImpl> {
    ...
    public AutofillManagerService(Context context) {
        ...
        this.mAugmentedAutofillResolver = new FrameworkResourcesServiceNameResolver(getContext(), 17039818);
    ...
    final class AutoFillManagerServiceStub extends IAutoFillManager.Stub {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:17:0x00ab, code lost:
            com.android.server.autofill.AutofillManagerService.access$2500(r23.this$0, r34, r0, r6);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:18:0x00b1, code lost:
            com.android.server.autofill.AutofillManagerService.access$1400(r23.this$0, r34, r0);
         */
        ...
        public void startSession(IBinder activityToken, IBinder appCallback, AutofillId autofillId, Rect bounds, AutofillValue value, int userId, boolean hasCallback, int flags, ComponentName componentName, boolean compatMode, IResultReceiver receiver) {
            ...
            try {
                ...
                synchronized (AutofillManagerService.this.mLock) {
                    try {
                        try {
                            long result = ((AutofillManagerServiceImpl) AutofillManagerService.this.getServiceForUserLocked(userId)).startSessionLocked(activityToken2, taskId, getCallingUid(), appCallback2, autofillId2, bounds, value, hasCallback, componentName2, compatMode, AutofillManagerService.this.mAllowInstantService, flags);
                        } catch (Throwable th) {
                            th = th;
                            throw th;
                        }
