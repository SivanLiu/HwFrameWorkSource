...
public final class Session implements RemoteFillService.FillServiceCallbacks, ViewState.Listener, AutoFillUI.AutoFillUiCallback, ValueFinder {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:27:0x0098, code lost:
        r19.mService.setLastResponse(r19.id, r21);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:31:0x00b2, code lost:
        r0 = r13;
        r19.mService.disableAutofillForActivity(r19.mComponentName, r14, r19.id, r19.mCompatMode);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:32:0x00c4, code lost:
        r0 = r13;
        r19.mService.disableAutofillForApp(r19.mComponentName.getPackageName(), r14, r19.id, r19.mCompatMode);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:34:0x00d9, code lost:
        if (triggerAugmentedAutofillLocked(r23) == null) goto L_0x0100;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:35:0x00db, code lost:
        r19.mForAugmentedAutofillOnly = true;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:37:0x00e2, code lost:
        android.util.Slog.d(com.android.server.autofill.Session.TAG, "Service disabled autofill for " + r19.mComponentName + ", but session is kept for augmented autofill only");
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:40:0x0104, code lost:
        ...
        r8.append(r19.mComponentName);
        r8.append(": flags=");
        r8.append(r0);
        r8 = r8.append(", duration=");
        android.util.TimeUtils.formatDuration(r14, r8);
        android.util.Slog.d(com.android.server.autofill.Session.TAG, r8.toString());
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:51:0x0149, code lost:
        notifyUnavailableToClient(r8, null);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:57:0x015f, code lost:
        r0.addTaggedData(909, java.lang.Integer.valueOf(r0));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:59:0x016a, code lost:
        r0.addTaggedData(1271, java.lang.Integer.valueOf(r7.length));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:63:?, code lost:
        processResponseLocked(r21, null, r23);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:31:0x00c9, code lost:
        getUiForShowing().showError(r10, r7);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0045, code lost:
        android.util.Slog.d(com.android.server.autofill.Session.TAG, "Starting intent sender on save()");
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x007e, code lost:
        getUiForShowing().showError(r7, r6);
     */
    ...
    public boolean showSaveLocked() {
        ...
        if (saveInfo == null) {
            ...
            boolean atLeastOneChanged5 = false;
            boolean isUpdate4 = false;
            if (requiredIds != null) {
                int i3 = 0;
                while (true) {
                    ...
                    if (id2 == null) {
                        ...
                        if (value == null || value.isEmpty()) {
                            ...
                            if (initialValue != null) {
                                ...
                                allRequiredAreNotEmpty = false;
                                atLeastOneChanged5 = atLeastOneChanged5;
                            }
                        } else {
                            allRequiredAreNotEmpty2 = allRequiredAreNotEmpty3;
                        }
                        ...
                        if (value2 == null) {
                            ...
                            if (!value2.equals(filledValue)) {
                                ...
                                if (changed) {
                                    ...
                                    atLeastOneChanged5 = atLeastOneChanged4;
                                }
                                i3++;
            ...
            if (allRequiredAreNotEmpty) {
                if (optionalIds == null || (atLeastOneChanged5 && isUpdate)) {
                    ...
                    for (AutofillId id3 : optionalIds) {
                        ...
                        if (viewState2 == null) {
                            ...
                            if (value3 != null) {
                                ...
                                atLeastOneChanged3 = atLeastOneChanged6;
                            } else if (Helper.sDebug) {
                                atLeastOneChanged2 = atLeastOneChanged5;
                        ...
                        atLeastOneChanged3 = atLeastOneChanged2;
                        isUpdate = isUpdate3;
                    }
                    atLeastOneChanged = atLeastOneChanged5;
                    isUpdate2 = isUpdate;
                ...
                if (atLeastOneChanged) {
                    ...
                    if (serviceLabel == null) {
                        ...
                        getUiForShowing().showSaveUi(serviceLabel, serviceIcon, this.mService.getServicePackageName(), saveInfo, this, this.mComponentName, this, this.mPendingSaveUi, isUpdate2, this.mCompatMode);
                        if (client != null) {
                            try {
            ...
            if (Helper.sDebug) {
                Slog.d(TAG, "showSaveLocked(" + this.id + "): with no changes, comes no responsibilities.allRequiredAreNotNull=" + allRequiredAreNotEmpty + ", atLeastOneChanged=" + atLeastOneChanged5);
            }
            return z;
        }
        while (true) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:?, code lost:
        r0 = r16.mService.getServiceLabelLocked();
        r0 = r16.mService.getServiceIconLocked();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x0055, code lost:
        getUiForShowing().showFillUi(r18, r17, r13, r16.mService.getServicePackageName(), r16.mComponentName, r0, r0, r16, r16.id, r16.mCompatMode);
        r1 = r16.mLock;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x007a, code lost:
        if (r16.mUiShownTime != 0) goto L_0x00eb;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:27:0x007c, code lost:
        r16.mUiShownTime = android.os.SystemClock.elapsedRealtime();
        r2 = r16.mUiShownTime - r16.mStartTime;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x008b, code lost:
        ...
        r0.append(r16.mActivityToken);
        r0.append(" shown in ");
        android.util.TimeUtils.formatDuration(r2, r0);
        android.util.Slog.d(com.android.server.autofill.Session.TAG, r0.toString());
     */
    /* JADX WARNING: Code restructure failed: missing block: B:30:0x00a8, code lost:
        ...
        r0.append(r16.mActivityToken);
        r0.append(" svc=");
        r0.append(r16.mService.getServicePackageName());
        r0.append(" latency=");
        android.util.TimeUtils.formatDuration(r2, r0);
        r16.mUiLatencyHistory.log(r0.toString());
