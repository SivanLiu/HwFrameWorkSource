...
public final class AutofillManagerServiceImpl extends AbstractPerUserSystemService<AutofillManagerServiceImpl, AutofillManagerService> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x004b, code lost:
        android.util.Slog.d(com.android.server.autofill.AutofillManagerServiceImpl.TAG, "No pending Save UI for token " + r7 + " and operation " + android.util.DebugUtils.flagsToString(android.view.autofill.AutofillManager.class, "PENDING_UI_OPERATION_", r6));
     */
    ...
    public void dumpLocked(String prefix, PrintWriter pw) {
        ...
        pw.println(getContext().getString(17039819));
        pw.print(prefix);
     ...
     */
    /* JADX WARNING: Code restructure failed: missing block: B:36:0x0040, code lost:
        r4 = r4 | 8;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:46:0x0053, code lost:
        r1.finishBroadcast();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:47:0x0056, code lost:
        throw r0;
     */
