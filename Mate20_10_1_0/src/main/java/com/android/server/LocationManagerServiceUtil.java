...
public class LocationManagerServiceUtil {
    ...
    private static final List<String> WHITE_LIST = new ArrayList(Arrays.asList(AppStartupDataMgr.HWPUSH_PKGNAME, "com.android.location.fused"));
    ...
    private final PackageMonitor mPackageMonitor = new PackageMonitor() {
        ...
        public void onPackageRemoved(String packageName, int uid) {
            if (LocationManagerServiceUtil.GOOGLE_MAP_PROCESS.equals(packageName)) {
                ...
                boolean unused = LocationManagerServiceUtil.this.shouldMonitorGmsProcess = false;
    ...
    public ConcurrentHashMap<Network, NetworkCapabilities> networkMap = new ConcurrentHashMap<>();
    /* access modifiers changed from: private */
    ...
    private LocationManagerServiceUtil(LocationManagerService service, Context context) {
        ...
        SystemProperties.set(SHOW_GOOGLE_NLP, "true");
        if (CHINA_SHORT_STR.equalsIgnoreCase(LOCALE_REGION)) {
            SystemProperties.set(SHOW_GOOGLE_NLP, "false");
    ...
    /* access modifiers changed from: private */
    public void serviceStateChanged(ServiceState state) {
    ...
    private boolean isGmsProcessRunning() {
        ...
        Object activityManagerObject = this.mContext.getSystemService(BigMemoryConstant.BIGMEMINFO_ITEM_TAG);
    ...
    public static boolean isForeGroundProc(Context context, String packageName) {
        return ((ActivityManager) context.getSystemService(BigMemoryConstant.BIGMEMINFO_ITEM_TAG)).getPackageImportance(packageName) <= 125;
    }
    ...
    /* access modifiers changed from: private */
    public boolean hasCapabilitiesChanged(NetworkCapabilities curCapabilities, NetworkCapabilities newCapabilities) {
