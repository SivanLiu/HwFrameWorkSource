...
public class HwBastetService extends SystemService {
    ...
    protected IBastetListener mIBastetListener = new IBastetListener.Stub() {
        ...
        public void onProxyIndicateMessage(int proxyId, int err, int ext) throws RemoteException {
            ...
            switch (err) {
                case ModelBaseService.DISCRIMINATE_RET_CODE_ERROR3 /*{ENCODED_INT: -23}*/:
                    cancelAlarm(ext);
                    return;
                case -22:
                    ...
                    return;
                case ModelBaseService.DISCRIMINATE_RET_CODE_ERROR1 /*{ENCODED_INT: -21}*/:
                    HwBastetService.this.removeHrtApp(ext);
                    return;
                case ModelBaseService.TRAINMODEL_RET_ERROR_CODE_20 /*{ENCODED_INT: -20}*/:
                    HwBastetService.this.addHrtApp(ext);
                    return;
                case ModelBaseService.TRAINMODEL_RET_ERROR_CODE_19 /*{ENCODED_INT: -19}*/:
                default:
                    return;
                case ModelBaseService.TRAINMODEL_RET_ERROR_CODE_18 /*{ENCODED_INT: -18}*/:
    ...
    public void parseAccAppList(Message msg) {
        ...
        String[] appList = appString.split(";");
    ...
    public void initPowerKit() {
        new Thread(new Runnable() {
            ...
            public void run() {
                int i = 0;
                while (i < 10) {
                    PowerKit unused = HwBastetService.this.mPowerKit = PowerKit.getInstance();
                    if (HwBastetService.this.mPowerKit == null) {
                        ...
                        try {
                            ...
                            PowerKit.Sink unused2 = HwBastetService.this.mStateRecognitionListener = new StateRecognitionListener();
    ...
    /* access modifiers changed from: private */
    public void updateLinkProperties(LinkProperties lp, Network network) {
    ...
    class HwBastetServiceNetworkCallback extends ConnectivityManager.NetworkCallback {
    ...
    /* access modifiers changed from: private */
    public void doNotifyIpAddressUpdate(Message msg) {
        int actionId = msg.arg1;
        Bundle bundle = msg.getData();
        if (bundle == null) {
            Log.e(TAG, "bundle is NULL");
