...
interface IHwDevicePolicyManager {
    ...
    Bundle getTopAppPackageName(ComponentName componentName, int i);
    ...
    void resetNetorkSetting(ComponentName componentName, int i);
    ...
    boolean setDefaultDataCard(ComponentName componentName, int i, Message message, int i2);
