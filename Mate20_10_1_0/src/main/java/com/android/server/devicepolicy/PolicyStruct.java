            ...
            if (newData != null && !newData.isEmpty() && rootItem != null) {
                ...
                for (String attrName : attributes2.keySet()) {
                    ...
                    if (i == 1) {
                        ...
                        ArrayList<String> currentConfigurationList = attributes2.getStringArrayList(attrName);
                        ...
                        attributes2.putStringArrayList(attrName, currentConfigurationList);
                    }
                }
            ...
            if (newData != null && !newData.isEmpty() && rootItem != null) {
                ...
                for (String attrName : attributes2.keySet()) {
                    ...
                    if (i == 1) {
                        ...
                        ArrayList<String> currentList = attributes2.getStringArrayList(attrName);
                        if (currentList == null) {
