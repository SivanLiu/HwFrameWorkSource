...
public class FrameworkTestPlugin extends DevicePolicyPlugin {
    ...
    public static final String TAG = FrameworkTestPlugin.class.getSimpleName();
    ...
    public PolicyStruct getPolicyStruct() {
        ...
        struct.addStruct(TEST_CONFIGURATION_LIST, PolicyStruct.PolicyType.CONFIGLIST, new String[]{"value"});
        struct.addStruct(TEST_MULTIUSERS, PolicyStruct.PolicyType.STATE, true, new String[]{"value"});
        return struct;
    }
    ...
    public boolean onInit(PolicyStruct struct) {
        addGetter(TEST_CONFIGURATION_LIST, new DevicePolicyPlugin.IPolicyItemKeyGetter() {
            ...
            public String getKey(String s) {
                try {
                    return new JSONObject(s).getString("accountName");
    ...
    public boolean checkCallingPermission(ComponentName componentName, String s) {
