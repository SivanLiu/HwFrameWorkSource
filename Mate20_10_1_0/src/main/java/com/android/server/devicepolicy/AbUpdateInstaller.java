...
class AbUpdateInstaller extends UpdateInstaller {
    ...
    private static class DelegatingUpdateEngineCallback extends UpdateEngineCallback {
        ...
        public void onPayloadApplicationComplete(int errorCode) {
            ...
            Map access$100 = AbUpdateInstaller.errorStringsMap;
            Integer valueOf = Integer.valueOf(errorCode);
            updateInstaller.notifyCallbackOnError(intValue, (String) access$100.getOrDefault(valueOf, AbUpdateInstaller.UNKNOWN_ERROR + errorCode));
        }
    }
}
