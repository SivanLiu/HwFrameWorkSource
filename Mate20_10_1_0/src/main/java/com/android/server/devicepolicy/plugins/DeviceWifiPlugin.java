...
public class DeviceWifiPlugin extends DevicePolicyPlugin {
    ...
    public PolicyStruct getPolicyStruct() {
        ...
        struct.addStruct("unavailable-ssid-list", PolicyStruct.PolicyType.LIST, new String[0]);
    ...
    public boolean onSetPolicy(ComponentName who, String policyName, Bundle policyData, boolean isChanged) {
        ...
        switch (policyName.hashCode()) {
            ...
            case 1167441671:
                ...
                break;
            case 1173183091:
                if (policyName.equals("unavailable-ssid-list")) {
                    c = 3;
                    break;
                }
                break;
            ...
            case 3:
                if (policyData != null) {
                    if (!isChanged) {
                        ...
                        notifyWifiPolicyChanged(7, policyData, 0);
                        break;
                    }
                } else {
                    return true;
            ...
            case 3:
                if (policyData != null) {
                    if (!isChanged) {
                        ...
                        notifyWifiPolicyChanged(7, policyData, 1);
                        break;
                    }
                } else {
                    return true;
            ...
            if (policy != null) {
                ...
                switch (c) {
                    ...
                    case 3:
                        ...
                        notifyWifiPolicyChanged(7, unavailableSsidListBundle, 2);
                        continue;
                    case 4:
    ...
    private void removeConfiguredNetworksInternal(ArrayList<String> modifyList) {
        ...
        Object object = this.mContext.getSystemService(DevSchedFeatureRT.WIFI_FEATURE);
