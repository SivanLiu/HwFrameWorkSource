    ...
    private Notification buildNotification(UserHandle userHandle, int pendingCertificateCount) {
        ...
        try {
            ...
            if (this.mService.getProfileOwner(userHandle.getIdentifier()) != null) {
                String contentText2 = resources.getString(17041288, this.mService.getProfileOwnerName(userHandle.getIdentifier()));
                ...
                String contentText3 = resources.getString(17041288, this.mService.getDeviceOwnerName());
                ...
                parentUserId = parentUserId2;
                contentText = resources.getString(17041287);
            ...
            return new Notification.Builder(userContext, SystemNotificationChannels.SECURITY).setSmallIcon(smallIconId).setContentTitle(resources.getQuantityText(18153498, pendingCertificateCount)).setContentText(contentText).setContentIntent(this.mInjector.pendingIntentGetActivityAsUser(userContext, 0, dialogIntent, 134217728, null, UserHandle.of(parentUserId))).setShowWhen(false).setColor(17170460).build();
