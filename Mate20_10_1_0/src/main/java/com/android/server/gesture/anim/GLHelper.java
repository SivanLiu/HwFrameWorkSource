...
public class GLHelper {
    ...
    private static int compileShader(int type, String shaderCode) {
        ...
        GLLogUtils.logD(TAG, "Results of compiling source:" + System.lineSeparator() + shaderCode + System.lineSeparator() + AwarenessInnerConstants.COLON_KEY + GLES30.glGetShaderInfoLog(shaderObjectId));
