...
public class SlideOutContainer extends FrameLayout {
    ...
    public void onFinishInflate() {
        ...
        this.mScrim = findViewById(34603471);
        this.mOrb = (HwGestureSideLayout) findViewById(34603468);
        this.mOrbLegacy = (SlideOutCircleView) findViewById(34603469);
    ...
    public void show(boolean isShow, boolean isAnimate) {
        if (isShow) {
            ...
            startExitAnimation(new Runnable() {
                ...
                public void run() {
                    boolean unused = SlideOutContainer.this.mIsAnimatingOut = false;
    ...
    public void startEnterAnimation() {
        if (!this.mIsAnimatingOut) {
            ...
            post(new Runnable() {
                ...
                public void run() {
                    SlideOutContainer.this.mScrim.animate().alpha(1.0f).setDuration(300).setStartDelay(0).setInterpolator(new PathInterpolator(0.0f, 0.0f, 0.2f, 1.0f));
                }
            });
        }
    }
    ...
    public void startExitAnimation(Runnable endRunnable, boolean isFastSlide, boolean isStartMaskAnimation) {
        if (!this.mIsAnimatingOut) {
            ...
            this.mScrim.animate().alpha(0.0f).setDuration(250).setStartDelay(EXIT_START_DELAY).setInterpolator(new PathInterpolator(0.4f, 0.0f, 0.2f, 1.0f));
