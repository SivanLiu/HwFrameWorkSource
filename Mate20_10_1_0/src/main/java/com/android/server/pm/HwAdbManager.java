...
public final class HwAdbManager {
    ...
    public static boolean startPackageInstallerForConfirm(Context context, int sessionId) {
        ...
        try {
            int j = ActivityManagerNative.getDefault().startActivity((IApplicationThread) null, "adb", intent, (String) null, (IBinder) null, (String) null, 0, 0, (ProfilerInfo) null, (Bundle) null);
            if (j == 0) {
                return true;
            }
