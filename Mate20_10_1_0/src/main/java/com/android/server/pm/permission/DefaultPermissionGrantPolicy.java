...
public class DefaultPermissionGrantPolicy extends AbsDefaultPermissionGrantPolicy {
    ...
    private void removeSystemFixedStorageFlagForPhoneUid(int userId) {
        ...
        for (PackageInfo pkg : this.mContext.getPackageManager().getInstalledPackagesAsUser(DEFAULT_PACKAGE_INFO_QUERY_FLAGS, userId)) {
            if (!(pkg == null || pkg.requestedPermissions == null || pkg.applicationInfo == null || pkg.applicationInfo.uid != 1001)) {
    ...
    public void grantCustSmsApplication(PackageParser.Package pkg, int userId) {
        ...
        String custDefaultSmsApp = SystemProperties.get("ro.config.default_sms_app", this.mContext.getResources().getString(17039971));
    ...
    /* JADX INFO: Multiple debug info for r2v61 java.lang.String: [D('useOpenWifiPackageName' java.lang.String), D('dialerAppPackageNames' java.lang.String[])] */
