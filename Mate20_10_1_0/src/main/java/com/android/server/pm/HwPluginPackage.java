...
public class HwPluginPackage implements IHwPluginPackage {
    ...
    public static String sDexFilterName = null;
    /* access modifiers changed from: private */
    public static String sLibFilterPrefix = null;
    @GuardedBy({"mLock"})
    ...
    private int collectMergePluginLocked(PackageParser.Package presetPkg, PackageParser.PackageLite installedLite, PackageSetting disabledPkgSetting) throws PackageManagerException {
        ...
        if (isPresetBetter) {
            ...
            addInheritedLib(baseCodePath, MemoryConstant.MEM_REPAIR_CONSTANT_BASE, presetInheritedLibs, this.mMergeNativeLibPaths);
        } else {
            String baseCodePath2 = installedLite.baseCodePath;
            this.mInstalledInheritedFiles.add(new File(baseCodePath2));
            addInheritedLib(baseCodePath2, MemoryConstant.MEM_REPAIR_CONSTANT_BASE, installedInheritedLibs, this.mMergeNativeLibPaths);
        }
