...
public final class HwPackageManagerServiceUtils {
    ...
    private static final String[] NOT_ALLOWED_UNINSTALL_WHITELIST = {"com.huawei.android.launcher", "com.huawei.systemmanager", "com.huawei.parentcontrol", UserBackupManagerService.SETTINGS_PACKAGE};
    ...
    public static IBootAnmation sIBootAnmation = null;
