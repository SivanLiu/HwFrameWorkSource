...
public class PackageInstallerSession extends IPackageInstallerSession.Stub {
        ...
        public void statusUpdate(Intent intent) {
            PackageInstallerSession.this.mHandler.post(new Runnable(intent) {
                ...
                public final void run() {
                    ChildStatusIntentReceiver.this.lambda$statusUpdate$0$PackageInstallerSession$ChildStatusIntentReceiver(this.f$1);
                }
            });
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:35:0x0090, code lost:
        r9.mCallback.onSessionSealedBlocking(r9);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:?, code lost:
        android.util.Slog.e(com.android.server.pm.PackageInstallerSession.TAG, "Package not valid", r0);
        destroyInternal();
        dispatchSessionFinished(r0.error, android.util.ExceptionUtils.getCompleteMessage(r0), null);
     */
    ...
    private static void copyFiles(List<File> fromFiles, File toDir, File fromDir) throws IOException {
