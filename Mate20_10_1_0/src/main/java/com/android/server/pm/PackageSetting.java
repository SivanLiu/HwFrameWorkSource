...
public final class PackageSetting extends PackageSettingBase {
    ...
    public String toString() {
        return "PackageSetting{" + Integer.toHexString(System.identityHashCode(this)) + HwLog.PREFIX + this.name + SliceClientPermissions.SliceAuthority.DELIMITER + this.appId + "}";
    }
    ...
    @Override // com.android.server.pm.SettingBase, com.android.server.pm.PackageSettingBase
