                                ...
                                try {
                                    if (!TAG_SHORTCUT.equals(tag)) {
                                        ...
                                        try {
                                            ...
                                            intents.clear();
                                            if (categories3 != null) {
                                                currentShortcut.setCategories(categories3);
                                                categories3 = null;
                                            }
                                            if (result2 == null) {
                                ...
                                if (TAG_SHARE_TARGET.equals(tag)) {
                                    if (currentShareTarget3 != null) {
                                        if (categories3 == null || categories3.isEmpty()) {
                                            ...
                                            outShareTargets.add(new ShareTargetInfo((ShareTargetInfo.TargetData[]) dataList.toArray(new ShareTargetInfo.TargetData[dataList.size()]), currentShareTarget3.mTargetClass, (String[]) categories3.toArray(new String[categories3.size()])));
                                            dataList.clear();
                                            categories = null;
                                            if (type == 2) {
                                                ...
                                                if (depth != 3 || !"intent".equals(tag)) {
                                                    ...
                                                    if (depth != 3 || !TAG_CATEGORIES.equals(tag)) {
                                                        ...
                                                        if (TextUtils.isEmpty(name2)) {
                                                            ...
                                                            if (categories == null) {
                                                                categories3 = new ArraySet<>();
                                                            } else {
                                                                categories3 = categories;
                                                            }
                                                            categories3.add(name2);
                                                            shortcutService2 = shortcutService;
                                                            activity4 = activity2;
                                                            currentShareTarget3 = currentShareTarget;
                                                            numShortcuts3 = numShortcuts;
