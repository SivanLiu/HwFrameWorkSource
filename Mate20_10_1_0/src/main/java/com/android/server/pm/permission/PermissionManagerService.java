...
public class PermissionManagerService {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:431:0x08a8, code lost:
        if (r10.equals(r9.packageName) != false) goto L_0x08aa;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:461:0x09e4, code lost:
        if (r11 != false) goto L_0x09e9;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:468:0x09f3, code lost:
        if (r12.isSystem() != false) goto L_0x0a07;
     */
    /* JADX WARNING: Removed duplicated region for block: B:123:0x02eb  */
    /* JADX WARNING: Removed duplicated region for block: B:124:0x02ef  */
    /* JADX WARNING: Removed duplicated region for block: B:186:0x0424  */
    /* JADX WARNING: Removed duplicated region for block: B:187:0x0426  */
    /* JADX WARNING: Removed duplicated region for block: B:190:0x0431  */
    /* JADX WARNING: Removed duplicated region for block: B:191:0x0433  */
    /* JADX WARNING: Removed duplicated region for block: B:193:0x0436  */
    /* JADX WARNING: Removed duplicated region for block: B:225:0x0494 A[Catch:{ all -> 0x04ea }] */
    /* JADX WARNING: Removed duplicated region for block: B:243:0x04c7 A[Catch:{ all -> 0x04ea }] */
    /* JADX WARNING: Removed duplicated region for block: B:246:0x04ce A[Catch:{ all -> 0x04ea }] */
    /* JADX WARNING: Removed duplicated region for block: B:275:0x0596 A[SYNTHETIC, Splitter:B:275:0x0596] */
    /* JADX WARNING: Removed duplicated region for block: B:279:0x05b3  */
    /* JADX WARNING: Removed duplicated region for block: B:282:0x05c5  */
    /* JADX WARNING: Removed duplicated region for block: B:283:0x05c7  */
    /* JADX WARNING: Removed duplicated region for block: B:288:0x05d4 A[Catch:{ all -> 0x06d7 }] */
    /* JADX WARNING: Removed duplicated region for block: B:289:0x05d6 A[Catch:{ all -> 0x06d7 }] */
    /* JADX WARNING: Removed duplicated region for block: B:291:0x05d9 A[Catch:{ all -> 0x06d7 }] */
    /* JADX WARNING: Removed duplicated region for block: B:331:0x0654 A[Catch:{ all -> 0x06bf }] */
    /* JADX WARNING: Removed duplicated region for block: B:357:0x06a3 A[Catch:{ all -> 0x06bf }] */
    /* JADX WARNING: Removed duplicated region for block: B:360:0x06a9 A[Catch:{ all -> 0x06bf }] */
    /* JADX WARNING: Removed duplicated region for block: B:491:0x0a4b  */
    /* JADX WARNING: Removed duplicated region for block: B:494:0x0a52 A[LOOP:5: B:493:0x0a50->B:494:0x0a52, LOOP_END] */
        ...
        if (ps2 != null) {
            ...
            synchronized (obj2) {
                try {
                    ...
                    while (i3 < N) {
                        try {
                            permName = (String) r8.requestedPermissions.get(i3);
                        } catch (Throwable th) {
                            th = th;
                            obj = obj2;
                            while (true) {
                                ...
                                try {
                                    if (bp.getSourcePackageSetting() == null) {
                                        ...
                                        if (origPermissions.hasRequestedPermission(permName)) {
                                            ...
                                            if (!r8.implicitPermissions.contains(permName)) {
                                                ...
                                                while (true) {
                                                    ...
                                                    if (!sp.getNewPermissions().contains(permName)) {
                                                        ...
                                                        newImplicitPermissions4.add(permName);
                                        ...
                                        if (r8.applicationInfo.isInstantApp() && !bp.isInstant()) {
                                            ...
                                            if (bp.isNormal()) {
                                                ...
                                                if (permissionManagerService.mPackageManager == null) {
                                                    permissionManagerService.mPackageManager = (PackageManagerService) ServiceManager.getService("package");
                                                }
                    ...
                    try {
                        ...
                        if (!ps2.isUpdatedSystem()) {
                            try {
                                obj = obj2;
                                try {
                                    int[] updatedUserIds7 = checkIfLegacyStorageOpsNeedToBeUpdated(r8, z, setInitialGrantForNewImplicitPermissionsLocked(origPermissions, permissionsState, pkg, newImplicitPermissions4, revokePermissionsNoLongerImplicitLocked(permissionsState, r8, updatedUserIds4)));
                                    if (callback != null) {
                    ...
                    try {
                        int[] updatedUserIds72 = checkIfLegacyStorageOpsNeedToBeUpdated(r8, z, setInitialGrantForNewImplicitPermissionsLocked(origPermissions, permissionsState, pkg, newImplicitPermissions4, revokePermissionsNoLongerImplicitLocked(permissionsState, r8, updatedUserIds4)));
                        if (callback != null) {
                        }
                        while (r2 < r0) {
                        }
