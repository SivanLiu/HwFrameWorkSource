...
public interface IHwPackageManagerServiceEx {
    ...
    void checkIllegalSysApk(PackageParser.Package v, int i) throws PackageManagerException;
    ...
    boolean forbidGMSUpgrade(PackageParser.Package v, PackageParser.Package v2, int i);
    ...
    boolean isDisallowedInstallApk(PackageParser.Package v);
