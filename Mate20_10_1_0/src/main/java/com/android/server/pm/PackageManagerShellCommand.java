...
class PackageManagerShellCommand extends ShellCommand {
    ...
    public int onCommand(String cmd) {
        ...
        try {
            ...
            switch (c) {
                ...
                case HdmiCecKeycode.CEC_KEYCODE_NUMBERS_1:
                ...
                case HdmiCecKeycode.CEC_KEYCODE_NUMBERS_5:
                    return runGrantRevokePermission(true);
                case HdmiCecKeycode.CEC_KEYCODE_NUMBERS_6:
                    return runGrantRevokePermission(false);
                case HdmiCecKeycode.CEC_KEYCODE_NUMBERS_7:
                ...
                case HdmiCecKeycode.CEC_KEYCODE_NEXT_FAVORITE:
                    return runCreateUser();
                case '0':
                    return runRemoveUser();
                case HdmiCecKeycode.CEC_KEYCODE_CHANNEL_DOWN:
                    return runSetUserRestriction();
                case HdmiCecKeycode.CEC_KEYCODE_PREVIOUS_CHANNEL:
                    return runGetMaxUsers();
                case HdmiCecKeycode.CEC_KEYCODE_SOUND_SELECT:
                ...
                case HdmiCecKeycode.CEC_KEYCODE_PAGE_UP:
    ...
    /* JADX INFO: Multiple debug info for r12v4 boolean: [D('isApex' boolean), D('userId' int)] */
