...
public class OemLockService extends SystemService {
    ...
    /* JADX WARN: Type inference failed for: r0v1, types: [com.android.server.oemlock.OemLockService$2, android.os.IBinder] */
    OemLockService(Context context, OemLock oemLock) {
        ...
        this.mUserRestrictionsListener = new UserManagerInternal.UserRestrictionsListener() {
            /* class com.android.server.oemlock.OemLockService.AnonymousClass1 */
        ...
        this.mService = new IOemLockService.Stub() {
            /* class com.android.server.oemlock.OemLockService.AnonymousClass2 */
