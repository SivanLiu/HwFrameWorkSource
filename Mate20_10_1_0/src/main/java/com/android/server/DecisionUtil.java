...
public final class DecisionUtil {
    ...
    /* access modifiers changed from: private */
    public static ConcurrentHashMap<String, DecisionCallback> sCallbackList = new ConcurrentHashMap<>();
    /* access modifiers changed from: private */
    public static IDecision sDecisionApi = null;
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            callbackThread.setUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
                ...
                public void uncaughtException(Thread t, Throwable e) {
                    String access$100 = DecisionUtil.TAG;
                    Log.e(access$100, t.getName() + " : " + e.getMessage());
                }
            });
    ...
    /* access modifiers changed from: private */
    public static ServiceConnectionCallback sServiceConnectionCallback = null;
