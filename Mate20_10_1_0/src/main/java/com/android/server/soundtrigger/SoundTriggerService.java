...
public class SoundTriggerService extends SystemService {
    ...
    class SoundTriggerServiceStub extends ISoundTriggerService.Stub {
        ...
        public int getModelState(ParcelUuid soundModelId) {
            ...
            SoundTriggerLogger access$200 = SoundTriggerService.sEventLogger;
            access$200.log(new SoundTriggerLogger.StringEvent("getModelState(): id = " + soundModelId));
            synchronized (SoundTriggerService.this.mLock) {
                SoundTrigger.SoundModel soundModel = (SoundTrigger.SoundModel) SoundTriggerService.this.mLoadedModels.get(soundModelId.getUuid());
                if (soundModel == null) {
                    Slog.e(SoundTriggerService.TAG, soundModelId + " is not loaded");
                    SoundTriggerLogger access$2002 = SoundTriggerService.sEventLogger;
                    access$2002.log(new SoundTriggerLogger.StringEvent("getModelState(): " + soundModelId + " is not loaded"));
                    return Integer.MIN_VALUE;
                }
                if (soundModel.type != 1) {
                    Slog.e(SoundTriggerService.TAG, "Unsupported model type, " + soundModel.type);
                    SoundTriggerLogger access$2003 = SoundTriggerService.sEventLogger;
                    access$2003.log(new SoundTriggerLogger.StringEvent("getModelState(): Unsupported model type, " + soundModel.type));
                } else {
    ...
    public class RemoteSoundTriggerDetectionService extends IRecognitionStatusCallback.Stub implements ServiceConnection {
                ...
                if (!this.mIsDestroyed) {
                    if (!this.mDestroyOnceRunningOpsDone) {
                        if (this.mService == null) {
                            ...
                            Settings.Global.getInt(SoundTriggerService.this.mContext.getContentResolver(), "max_sound_trigger_detection_service_ops_per_day", HwBootFail.STAGE_BOOT_SUCCESS);
        ...
        public void onGenericSoundTriggerDetected(SoundTrigger.GenericRecognitionEvent event) {
            ...
            runOrAddOperation(new Operation(new Runnable() {
                ...
                public final void run() {
                    RemoteSoundTriggerDetectionService.this.lambda$onGenericSoundTriggerDetected$0$SoundTriggerService$RemoteSoundTriggerDetectionService();
                }
                ...
                public final void run(int i, ISoundTriggerDetectionService iSoundTriggerDetectionService) {
                    RemoteSoundTriggerDetectionService.this.lambda$onGenericSoundTriggerDetected$1$SoundTriggerService$RemoteSoundTriggerDetectionService(this.f$1, i, iSoundTriggerDetectionService);
                }
            }, new Runnable(event) {
                ...
                public final void run() {
                    RemoteSoundTriggerDetectionService.this.lambda$onGenericSoundTriggerDetected$2$SoundTriggerService$RemoteSoundTriggerDetectionService(this.f$1);
                }
            }));
        }
        ...
        public void onError(int status) {
            ...
            runOrAddOperation(new Operation(new Runnable() {
                ...
                public final void run() {
                    RemoteSoundTriggerDetectionService.this.lambda$onError$3$SoundTriggerService$RemoteSoundTriggerDetectionService();
                }
                ...
                @Override // com.android.server.soundtrigger.SoundTriggerService.Operation.ExecuteOp
                public final void run(int i, ISoundTriggerDetectionService iSoundTriggerDetectionService) {
                    RemoteSoundTriggerDetectionService.this.lambda$onError$4$SoundTriggerService$RemoteSoundTriggerDetectionService(this.f$1, i, iSoundTriggerDetectionService);
                }
            }, null));
        }
