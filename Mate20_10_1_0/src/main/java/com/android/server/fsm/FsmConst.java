...
public class FsmConst {
    ...
    public static final int POLICY_TYPE_TEST = 2;
    public static final String TAG_FSM_DOUBLE_CLICK_WAKEUP_MANAGER = "Fsm_DoubleClickWakeupManager";
    public static final String TAG_FSM_FINGERPRINT_WAKEUP_MANAGER = "Fsm_FingerPrintWakeupManager";
    ...
    public static final String TAG_FSM_POWER_WAKEUP_MANAGER = "Fsm_PowerWakeupManager";
    ...
    public static final int WAKE_UP_TYPE_DOUBLIECLICK = 5;
    public static final int WAKE_UP_TYPE_FINGERPRINT = 3;
