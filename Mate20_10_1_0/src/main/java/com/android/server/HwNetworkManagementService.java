...
public class HwNetworkManagementService extends NetworkManagementService {
    ...
    private static final String INTENT_DS_DNS_STAT = "com.android.intent.action.dns_stat_report";
            ...
            if (event != null && macStr != null) {
                if (HwNetworkManagementService.STA_JOIN_EVENT.equals(event)) {
                    ...
                    if (!HwNetworkManagementService.this.mMacList.contains(macStr)) {
                        ...
                        Slog.e(access$200, macStr + " had been added, but still get event " + event);
                    }
                    ...
                    if (HwNetworkManagementService.this.mApLinkedStaHandler.hasMessages(msg.what)) {
                        ...
                        Slog.d(access$2002, "event=" + event + ", remove STA_JOIN message");
                        ...
                        String access$2003 = HwNetworkManagementService.TAG;
                        Slog.e(access$2003, macStr + " had been removed, but still get event " + event);
                    }
                }
                String access$2004 = HwNetworkManagementService.TAG;
                Slog.d(access$2004, "handle " + event + " event, mLinkedStaCount=" + HwNetworkManagementService.this.mLinkedStaCount);
                if (HwNetworkManagementService.this.mLinkedStaCount < 0 || HwNetworkManagementService.this.mLinkedStaCount > 8 || HwNetworkManagementService.this.mLinkedStaCount != HwNetworkManagementService.this.mMacList.size()) {
                    String access$2005 = HwNetworkManagementService.TAG;
                    Slog.e(access$2005, "mLinkedStaCount over flow, need synchronize. value = " + HwNetworkManagementService.this.mLinkedStaCount);
                    List unused = HwNetworkManagementService.this.mMacList = new ArrayList();
                    int unused2 = HwNetworkManagementService.this.mLinkedStaCount = 0;
                }
                ...
                String access$2006 = HwNetworkManagementService.TAG;
                Slog.e(access$2006, "send broadcast, event=" + event + ", extraInfo: " + staInfo);
    ...
    private TablePortDeathRecipient mDeathReceipient = new TablePortDeathRecipient("", -1);
    ...
    /* access modifiers changed from: private */
    public IOemNetd mOemNetdService = null;
    ...
    private void connectOemNetdService(SystemServices services) {
        if (services == null) {
    ...
    public HwNetworkManagementService(Context context, SystemServices services) {
    ...
    public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
        if (code == 201) {
            ...
            boolean needReset3 = false;
            boolean result2 = false;
            boolean needReset4 = false;
            ...
            if (code == CODE_SET_AD_STRATEGY_RULE) {
                ...
                if (pkgName != null) {
                    Slog.d(TAG, "CODE_SET_APK_DL_STRATEGY, pkgName=" + Arrays.asList(pkgName) + ", needReset=" + needReset2);
                }
                ArrayList<String> appUidList = convertPkgNameToUid(pkgName);
                Slog.d(TAG, "CODE_SET_APK_DL_STRATEGY, appUidList=" + appUidList);
                setApkDlFilterRules(appUidList, needReset2);
                reply.writeNoException();
                return true;
                ...
                if (pkgName2 != null) {
                    Slog.d(TAG, "CODE_CLEAR_AD_APKDL_STRATEGY, pkgName=" + Arrays.asList(pkgName2) + ", needReset=" + needReset3 + ", strategy=" + strategy);
                }
                ArrayList<String> appUidList2 = convertPkgNameToUid(pkgName2);
                Slog.d(TAG, "CODE_CLEAR_AD_APKDL_STRATEGY, appUidList=" + appUidList2);
                clearAdOrApkDlFilterRules(appUidList2, needReset3, strategy);
                reply.writeNoException();
                return true;
                ...
                Slog.d(TAG, "CODE_SET_APK_DL_URL_USER_RESULT, downloadId=" + downloadId + ", result=" + result2);
                setApkDlUrlUserResult(downloadId, result2);
                reply.writeNoException();
                return true;
                ...
                Slog.d(TAG, "CODE_SET_AD_STRATEGY_RULE, needReset=" + needReset4);
                setApkControlFilterRules(apkStrategyStr, needReset4);
                reply.writeNoException();
                return true;
                ...
                Slog.d(TAG, "CODE_SET_DNS_FORWARDING_CMD, enabled=" + enabled2 + ", dnsServer=" + dnsServer);
                setDnsForwarding(enabled2, dnsServer);
                reply.writeNoException();
                return true;
                ...
                Slog.d(TAG, "CODE_SET_INTERFACE_PROXY_ARP_CMD, enabled=" + enabled + ", ifaceName=" + ifaceName);
                setInterfaceProxyArp(enabled, ifaceName);
                reply.writeNoException();
                return true;
            }
        }
    ...
    private static String getSecurityType(WifiConfiguration wifiConfig) {
        ...
        if (authType != 4) {
            return BigMemoryConstant.NOTIFY_CAMERA_EVENT_OPEN_TYPE;
        }
        return "wpa2-psk";
    }
    ...
    public void sendWebStatMessage(String[] cooked, String raw) {
        ...
        try {
            ...
            if (mobileNetinfo == null || !mobileNetinfo.isConnected()) {
                ...
                try {
                    try {
                        chrIntent = new Intent("com.android.intent.action.web_stat_report");
            ...
            try {
                winCnt = Integer.parseInt(cooked[495]);
            } catch (Exception e4) {
                Slog.e(TAG, "Web Stat Report Send Broadcast Fail.");
            }
            try {
    ...
    public void sendApkDownloadUrlBroadcast(String[] cooked, String raw) {
        ...
        if (cooked.length >= 4) {
            ...
            if (!m.matches()) {
                str4 = "downloadId";
                str3 = AD_APKDL_STRATEGY_PERMISSION;
                str = "uid";
                str2 = "url";
                ...
                String subUrl22 = m.group(3);
                if (idx == 1) {
                    this.urlBuffer = new StringBuffer();
                    this.urlBuffer.append(subUrl22);
                } else {
                    this.urlBuffer.append(subUrl22);
                }
                if (max == idx) {
                    String url = hexStrToStr(this.urlBuffer.toString());
                    ...
                    intent.putExtra("startTime", this.startTimeMap.get(downloadId));
            ...
            String url2 = hexStrToStr(cooked[3]);
            Slog.d(TAG, "onEvent receive report_apkdl_event, startTime=" + startTime + ", downloadId=" + downloadId + ", uid=" + uid + ", url=" + url2);
            Intent intent2 = new Intent(INTENT_APKDL_URL_DETECTED);
            intent2.putExtra("startTime", startTime);
            intent2.putExtra(str4, downloadId);
            intent2.putExtra(str, uid);
            intent2.putExtra(str2, url2);
            this.mContext.sendBroadcast(intent2, str3);
            return;
        }
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (i == 1 || i == 0) {
                        ...
                        if (networkPolicyFlag == 1) {
                            SystemProperties.set(HwNetworkManagementService.KEY_NETWORK_POLICY_PROPERTIES, "true");
                        } else {
                            SystemProperties.set(HwNetworkManagementService.KEY_NETWORK_POLICY_PROPERTIES, "false");
                        }
                    } else if (i == 2 || i == 3) {
    ...
    /* access modifiers changed from: private */
    public void setNetworkAccessList(List<String> addrList, int whiteOrBlack) {
        if (addrList != null) {
            try {
                if (!addrList.isEmpty()) {
                    String str = TAG;
    ...
    private void setChrReportUid(int index, int uid) {
        ...
        try {
            iOemNetd.setChrAppUid(index, uid);
    ...
    /* access modifiers changed from: private */
    public void setNetBoosterDnsConfig(Bundle data) {
    ...
    private void ipTableConfig(boolean enable, String iface, int uid, IBinder binder) {
        ...
        if (iface != null && uid != -1 && binder != null) {
            ...
            try {
                ...
                if (this.mDeathReceipient != null && enable) {
    ...
    private class TablePortDeathRecipient implements IBinder.DeathRecipient {
        ...
        public void binderDied() {
            ...
            if (this.mInterface != null && this.mUID != -1) {
                if (HwNetworkManagementService.this.mOemNetdService == null) {
                    Slog.e(HwNetworkManagementService.TAG, "TablePort DeathRecipient mOemNetdService is null");
                    return;
                }
                try {
                    HwNetworkManagementService.this.mOemNetdService.ipTableConfig(0, this.mUID, this.mInterface);
                } catch (RemoteException | ServiceSpecificException e) {
                    Slog.e(HwNetworkManagementService.TAG, "binderDied error!");
                }
            }
        }
    }
