    ...
    private class Connection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            synchronized (RemotePrintServiceRecommendationService.this.mLock) {
                IRecommendationService unused = RemotePrintServiceRecommendationService.this.mService = IRecommendationService.Stub.asInterface(service);
                try {
        ...
        public void onServiceDisconnected(ComponentName name) {
            ...
            synchronized (RemotePrintServiceRecommendationService.this.mLock) {
                IRecommendationService unused = RemotePrintServiceRecommendationService.this.mService = null;
            }
        }
    }
}
