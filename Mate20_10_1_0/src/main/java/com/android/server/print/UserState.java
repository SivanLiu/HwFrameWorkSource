...
public final class UserState implements RemotePrintSpooler.PrintSpoolerCallbacks, RemotePrintService.PrintServiceCallbacks, RemotePrintServiceRecommendationService.RemotePrintServiceRecommendationServiceCallbacks {
    ...
    public void onPrintJobQueued(PrintJobInfo printJob) {
        ...
        if (service != null) {
            ...
            this.mSpooler.setPrintJobState(printJob.getId(), 6, this.mContext.getString(17041089));
        }
    }
            ...
            if (this.mPrinterDiscoverySession == null) {
                this.mPrinterDiscoverySession = new PrinterDiscoverySessionMediator() {
                    ...
                    public void onDestroyed() {
                        PrinterDiscoverySessionMediator unused = UserState.this.mPrinterDiscoverySession = null;
                    }
                };
        ...
        if (printJobs != null) {
            ...
            try {
                ...
                for (int i = 0; i < printJobCount; i++) {
                    this.mSpooler.setPrintJobState(printJobs.get(i).getId(), 6, this.mContext.getString(17041089));
                }
            } finally {
                Binder.restoreCallingIdentity(identity);
            }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0032, code lost:
        android.util.Log.e(com.android.server.print.UserState.LOG_TAG, "Error notifying for print job state change", r5);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:13:?, code lost:
        r1.get(r2).listener.onPrintServicesChanged();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x0026, code lost:
        r4 = move-exception;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0027, code lost:
        android.util.Log.e(com.android.server.print.UserState.LOG_TAG, "Error notifying for print services change", r4);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x0031, code lost:
        return;
     */
     ...
     */
    /* JADX WARNING: Code restructure failed: missing block: B:13:?, code lost:
        r1.get(r2).listener.onRecommendationsChanged();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x0028, code lost:
        r4 = move-exception;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0029, code lost:
        android.util.Log.e(com.android.server.print.UserState.LOG_TAG, "Error notifying for print service recommendations change", r4);
     */
