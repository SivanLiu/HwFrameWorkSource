...
public class InputMethodManagerService extends AbsInputMethodManagerService implements IHwInputMethodManagerInner, ServiceConnection, Handler.Callback {
    ...
    static {
        boolean z = false;
        if (SystemProperties.getBoolean("ro.config.remoteinput.debugtv", false) || "tv".equals(SystemProperties.get("ro.build.characteristics", BatteryService.HealthServiceWrapper.INSTANCE_VENDOR))) {
            z = true;
        }
        IS_TV = z;
    }
                        ...
                        if (curInputMethodId != null) {
                            for (int i = 0; i < N; i++) {
                                ...
                                if (change2 == 2 || change2 == 3) {
                                    ...
                                    boolean unused = InputMethodManagerService.this.setInputMethodEnabledLocked(imi.getId(), false);
                                }
                            }
                        }
    ...
    private class HardKeyboardListener implements WindowManagerInternal.OnHardKeyboardStatusChangeListener {
        ...
        public void handleHardKeyboardStatusChange(boolean available) {
            ...
            synchronized (InputMethodManagerService.this.mMethodMap) {
                if (!(InputMethodManagerService.this.mSwitchingDialog == null || InputMethodManagerService.this.mSwitchingDialogTitleView == null || !InputMethodManagerService.this.mSwitchingDialog.isShowing() || (switchSectionView = InputMethodManagerService.this.mSwitchingDialogTitleView.findViewById(16908999)) == null)) {
    ...
    public void systemRunning(StatusBarManagerService statusBar) {
        ...
        synchronized (this.mMethodMap) {
            if (!this.mSystemReady) {
                ...
                this.mShowOngoingImeSwitcherForPhones = this.mRes.getBoolean(17891617);
    ...
    public void updateSystemUiLocked(int vis, int backDisposition) {
        if (this.mCurToken != null) {
            ...
            if (imi != null && needsToShowImeSwitcher) {
                CharSequence title = this.mRes.getText(17041179);
    ...
    public void updateKeyboardFromSettingsLocked() {
        ...
        if (alertDialog != null && this.mSwitchingDialogTitleView != null && alertDialog.isShowing() && (hardKeySwitch = (Switch) this.mSwitchingDialogTitleView.findViewById(16909000)) != null) {
        ...
        if (i == 1) {
            ...
            switch (i) {
                case 1000:
                    ...
                    return true;
                case MSG_BIND_INPUT /*{ENCODED_INT: 1010}*/:
                    ...
                    args.recycle();
                    return true;
                case MSG_SHOW_SOFT_INPUT /*{ENCODED_INT: 1020}*/:
                    ...
                    args2.recycle();
                    return true;
                case MSG_HIDE_SOFT_INPUT /*{ENCODED_INT: 1030}*/:
                    ...
                    args3.recycle();
                    return true;
                case MSG_HIDE_CURRENT_INPUT_METHOD /*{ENCODED_INT: 1035}*/:
                    synchronized (this.mMethodMap) {
                        hideCurrentInputLocked(0, null);
                    }
                    return true;
                ...
                case 2000:
                    ...
                    args6.recycle();
                    return true;
                case MSG_UNBIND_CLIENT /*{ENCODED_INT: 3000}*/:
                    try {
                ...
                case MSG_SET_INTERACTIVE /*{ENCODED_INT: 3030}*/:
                    ...
                    return true;
                case MSG_REPORT_FULLSCREEN_MODE /*{ENCODED_INT: 3045}*/:
                    if (msg.arg1 != 0) {
                        setVisible = true;
                    }
                ...
                case 3070:
                    ...
                    return true;
                case MSG_HARD_KEYBOARD_SWITCH_CHANGED /*{ENCODED_INT: 4000}*/:
                    ...
                    return true;
                case MSG_SYSTEM_UNLOCK_USER /*{ENCODED_INT: 5000}*/:
                    ...
                    try {
                        ...
                        if (mSwitchSectionView == null) {
                            ...
                            try {
                                ...
                                final ImeSubtypeListAdapter adapter = new ImeSubtypeListAdapter(themeContext, 17367296, imList, checkedItem);
    ...
    private static class ImeSubtypeListAdapter extends ArrayAdapter<InputMethodSubtypeSwitchingController.ImeSubtypeListItem> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            RadioButton radioButton = (RadioButton) view.findViewById(16909299);
        ...
        public int onCommand(String cmd) {
            Arrays.asList("android.permission.DUMP", "android.permission.INTERACT_ACROSS_USERS_FULL", "android.permission.WRITE_SECURE_SETTINGS").forEach(new Consumer() {
                ...
                public final void accept(Object obj) {
                    ShellCommandImpl.this.lambda$onCommand$0$InputMethodManagerService$ShellCommandImpl((String) obj);
                }
            });
