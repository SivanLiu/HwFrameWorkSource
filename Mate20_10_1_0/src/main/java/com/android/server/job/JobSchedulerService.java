...
public class JobSchedulerService extends SystemService implements StateChangedListener, JobCompletedListener {
    ...
    public static class Constants {
        ...
        public void updateConstantsLocked(String value) {
            ...
            this.MAX_STANDARD_RESCHEDULE_COUNT = this.mParser.getInt(KEY_MAX_STANDARD_RESCHEDULE_COUNT, (int) HwBootFail.STAGE_BOOT_SUCCESS);
            this.MAX_WORK_RESCHEDULE_COUNT = this.mParser.getInt(KEY_MAX_WORK_RESCHEDULE_COUNT, (int) HwBootFail.STAGE_BOOT_SUCCESS);
    ...
    /* JADX INFO: Multiple debug info for r1v7 long: [D('backoff' long), D('delayMillis' long)] */
    /* access modifiers changed from: package-private */
    @VisibleForTesting
    ...
    /* JADX INFO: Multiple debug info for r8v9 long: [D('newLatestRuntimeElapsed' long), D('olrte' long)] */
    /* access modifiers changed from: package-private */
    @VisibleForTesting
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:10:0x001f, code lost:
        if (com.android.server.job.JobSchedulerService.DEBUG_STANDBY == false) goto L_0x0045;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x0021, code lost:
        android.util.Slog.i(com.android.server.job.JobSchedulerService.TAG, "Setting heartbeat alarm for " + r14 + " = " + android.util.TimeUtils.formatDuration(r14 - r5));
     */
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0045, code lost:
        ((android.app.AlarmManager) getContext().getSystemService("alarm")).setExact(3, r14, com.android.server.job.JobSchedulerService.HEARTBEAT_TAG, r20.mHeartbeatAlarm, r20.mHandler);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x0066, code lost:
        return;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x0012, code lost:
        r5 = com.android.server.job.JobSchedulerService.sElapsedRealtimeClock.millis();
        r14 = ((r5 + r3) / r3) * r3;
     */
    public void setNextHeartbeatAlarm() {
        synchronized (this.mLock) {
            if (this.mConstants.USE_HEARTBEATS) {
                long heartbeatLength = this.mConstants.STANDBY_HEARTBEAT_TIME;
            }
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:46:0x018f, code lost:
        if (r13 < (((long) r17.mConstants.STANDBY_BEATS[r4]) + r11)) goto L_0x01b9;
     */
        ...
        public List<JobInfo> getSystemScheduledPendingJobs() {
            ...
            synchronized (JobSchedulerService.this.mLock) {
                ...
                JobSchedulerService.this.mJobs.forEachJob(1000, new Consumer(pendingJobs) {
                    ...
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                        LocalService.this.lambda$getSystemScheduledPendingJobs$0$JobSchedulerService$LocalService(this.f$1, (JobStatus) obj);
                    }
                });
            }
            return pendingJobs;
            ...
            if (Binder.getCallingUid() == 1000) {
                synchronized (JobSchedulerService.this.mLock) {
                    ...
                    JobSchedulerService.this.mJobs.forEachJob(new Consumer(snapshots) {
                        ...
                        @Override // java.util.function.Consumer
                        public final void accept(Object obj) {
                            JobSchedulerStub.this.lambda$getAllJobSnapshots$0$JobSchedulerService$JobSchedulerStub(this.f$1, (JobStatus) obj);
                        }
                    });
    ...
    public int executeRunCommand(String pkgName, int userId, int jobId, boolean force) {
        if (DEBUG) {
            Slog.v(TAG, "executeRunCommand(): " + pkgName + SliceClientPermissions.SliceAuthority.DELIMITER + userId + HwLog.PREFIX + jobId + " f=" + force);
        }
        try {
    ...
    public int executeTimeoutCommand(PrintWriter pw, String pkgName, int userId, boolean hasJobId, int jobId) {
        if (DEBUG) {
            Slog.v(TAG, "executeTimeoutCommand(): " + pkgName + SliceClientPermissions.SliceAuthority.DELIMITER + userId + HwLog.PREFIX + jobId);
        }
        synchronized (this.mLock) {
    ...
    public int executeCancelCommand(PrintWriter pw, String pkgName, int userId, boolean hasJobId, int jobId) {
        if (DEBUG) {
            Slog.v(TAG, "executeCancelCommand(): " + pkgName + SliceClientPermissions.SliceAuthority.DELIMITER + userId + HwLog.PREFIX + jobId);
        }
        int pkgUid = -1;
        try {
