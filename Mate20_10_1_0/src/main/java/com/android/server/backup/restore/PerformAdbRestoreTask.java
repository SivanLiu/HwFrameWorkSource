...
public class PerformAdbRestoreTask implements Runnable {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:67:0x0135 A[SYNTHETIC] */
    /* JADX WARNING: Removed duplicated region for block: B:83:0x0178 A[SYNTHETIC] */
    public void run() {
    ...
    /* JADX INFO: Multiple debug info for r15v1 byte: [D('len' int), D('offset' int)] */
    /* JADX INFO: Multiple debug info for r13v4 byte: [D('len' int), D('offset' int)] */
    /* JADX INFO: Multiple debug info for r10v3 byte: [D('len' int), D('offset' int)] */
