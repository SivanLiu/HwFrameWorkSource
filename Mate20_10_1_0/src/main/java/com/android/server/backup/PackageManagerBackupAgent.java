        ...
        try {
            ...
            if (home != null) {
                try {
                    homeVersion2 = 0;
                    try {
                        homeInfo2 = this.mPackageManager.getPackageInfoAsUser(home.getPackageName(), 134217728, this.mUserId);
                            ...
                            while (it.hasNext()) {
                                ...
                                if (packName3.equals(str2)) {
                                    ...
                                    try {
                                        ...
                                        try {
                                            PackageInfo info = this.mPackageManager.getPackageInfoAsUser(packName3, 134217728, this.mUserId);
