...
public class TransportManager {
    ...
    TransportManager(int userId, Context context, Set<ComponentName> whitelist, String selectedTransport) {
        this.mUserId = userId;
    ...
    TransportManager(int userId, Context context, Set<ComponentName> whitelist, String selectedTransport, TransportClientManager transportClientManager) {
        ...
        if (this.mBackupIpcMonitor == null) {
            ...
            IHwIpcMonitor iHwIpcMonitor = this.mBackupIpcMonitor;
        }
    }
    ...
    public void onPackageChanged(String packageName, String... components) {
        ...
        synchronized (this.mTransportLock) {
            ...
            keySet.removeIf(new Predicate(transportComponents) {
                /* class com.android.server.backup.$$Lambda$xfpm33S8Jqv3KpU_llxhj8ZPI */
    ...
    public void updateTransportAttributes(ComponentName transportComponent, String name, Intent configurationIntent, String currentDestinationString, Intent dataManagementIntent, CharSequence dataManagementLabel) {
        synchronized (this.mTransportLock) {
            ...
            CharSequence unused5 = description.dataManagementLabel = dataManagementLabel;
    ...
    private boolean isTransportTrusted(ComponentName transport) {
        ...
        try {
            if ((this.mPackageManager.getPackageInfoAsUser(transport.getPackageName(), 0, this.mUserId).applicationInfo.privateFlags & 8) != 0) {
                return true;
            }
    ...
    private static Predicate<ComponentName> fromPackageFilter(String packageName) {
        return new Predicate(packageName) {
            /* class com.android.server.backup.$$Lambda$TransportManager$_dxJobf45tWiMkaNlKYz26kB2Q */
    ...
    private static class TransportDescription {
        ...
        private TransportDescription(String name2, String transportDirName2, Intent configurationIntent2, String currentDestinationString2, Intent dataManagementIntent2, CharSequence dataManagementLabel2) {
            this.name = name2;
