    ...
    class StreamFeederThread extends RestoreEngine implements Runnable, BackupRestoreTask {
        ...
        public void run() {
            ...
            try {
                    ...
                    if (result > 0) {
                        if (result > bufferSize) {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    boolean unused7 = performUnifiedRestoreTask.mDidLaunch = z;
                                    if (status2 != 0) {
                                    }
                                ...
                                boolean unused8 = performUnifiedRestoreTask2.mDidLaunch = z2;
                                if (status2 != 0) {
                                    try {
                                        PerformUnifiedRestoreTask.this.mTransportClient.connectOrThrow("PerformUnifiedRestoreTask$StreamFeederThread.run()").abortFullRestore();
                                    } catch (Exception e5) {
                                    ...
                                    IBackupAgent unused9 = PerformUnifiedRestoreTask.this.mAgent = this.mEngine.getAgent();
                                    byte[] unused10 = PerformUnifiedRestoreTask.this.mWidgetData = this.mEngine.getWidgetData();
                                }
                                PerformUnifiedRestoreTask.this.executeNextState(nextState);
                                setRunning(false);
                                throw iBackupTransport;
                        ...
                        while (toCopy > 0) {
                            try {
                                ...
                                this.mEngineThread.waitForResult();
                                IoUtils.closeQuietly(this.mEnginePipes[0]);
                                boolean unused11 = PerformUnifiedRestoreTask.this.mDidLaunch = this.mEngine.getAgent() != null;
                                if (-1003 != 0) {
                                }
                                nextState2 = UnifiedRestoreState.RESTORE_FINISHED;
                                IBackupAgent unused12 = PerformUnifiedRestoreTask.this.mAgent = this.mEngine.getAgent();
                                byte[] unused13 = PerformUnifiedRestoreTask.this.mWidgetData = this.mEngine.getWidgetData();
                                PerformUnifiedRestoreTask.this.executeNextState(nextState2);
                                setRunning(false);
                            } catch (Exception e7) {
                                e = e7;
                                ...
                                this.mEngineThread.waitForResult();
                                IoUtils.closeQuietly(this.mEnginePipes[0]);
                                boolean unused14 = PerformUnifiedRestoreTask.this.mDidLaunch = this.mEngine.getAgent() != null;
                                if (-1000 != 0) {
                                }
                                nextState2 = UnifiedRestoreState.RESTORE_FINISHED;
                                IBackupAgent unused15 = PerformUnifiedRestoreTask.this.mAgent = this.mEngine.getAgent();
                                byte[] unused16 = PerformUnifiedRestoreTask.this.mWidgetData = this.mEngine.getWidgetData();
                                PerformUnifiedRestoreTask.this.executeNextState(nextState2);
                                setRunning(false);
                            }
                        }
                ...
                this.mEngineThread.waitForResult();
                IoUtils.closeQuietly(this.mEnginePipes[0]);
                boolean unused17 = PerformUnifiedRestoreTask.this.mDidLaunch = this.mEngine.getAgent() != null;
                if (status2 == 0) {
                    nextState2 = UnifiedRestoreState.RESTORE_FINISHED;
                    IBackupAgent unused18 = PerformUnifiedRestoreTask.this.mAgent = this.mEngine.getAgent();
                    byte[] unused19 = PerformUnifiedRestoreTask.this.mWidgetData = this.mEngine.getWidgetData();
                } else {
                    try {
                        PerformUnifiedRestoreTask.this.mTransportClient.connectOrThrow("PerformUnifiedRestoreTask$StreamFeederThread.run()").abortFullRestore();
                    } catch (Exception e8) {
                ...
                this.mEngineThread.waitForResult();
                IoUtils.closeQuietly(this.mEnginePipes[0]);
                boolean unused20 = PerformUnifiedRestoreTask.this.mDidLaunch = this.mEngine.getAgent() != null;
                if (-1003 != 0) {
                }
                nextState2 = UnifiedRestoreState.RESTORE_FINISHED;
                IBackupAgent unused21 = PerformUnifiedRestoreTask.this.mAgent = this.mEngine.getAgent();
                byte[] unused22 = PerformUnifiedRestoreTask.this.mWidgetData = this.mEngine.getWidgetData();
                PerformUnifiedRestoreTask.this.executeNextState(nextState2);
                setRunning(false);
            } catch (Exception e10) {
                e = e10;
                ...
                this.mEngineThread.waitForResult();
                IoUtils.closeQuietly(this.mEnginePipes[0]);
                boolean unused23 = PerformUnifiedRestoreTask.this.mDidLaunch = this.mEngine.getAgent() != null;
                if (-1000 != 0) {
                }
                nextState2 = UnifiedRestoreState.RESTORE_FINISHED;
                IBackupAgent unused24 = PerformUnifiedRestoreTask.this.mAgent = this.mEngine.getAgent();
                byte[] unused25 = PerformUnifiedRestoreTask.this.mWidgetData = this.mEngine.getWidgetData();
                PerformUnifiedRestoreTask.this.executeNextState(nextState2);
                setRunning(false);
            } catch (Throwable th2) {
                ...
                boolean unused26 = performUnifiedRestoreTask22.mDidLaunch = z22;
                if (status2 != 0) {
                }
                PerformUnifiedRestoreTask.this.executeNextState(nextState);
                setRunning(false);
        ...
        public void handleCancel(boolean cancelAll) {
            ...
            PerformUnifiedRestoreTask performUnifiedRestoreTask = PerformUnifiedRestoreTask.this;
            IBackupManagerMonitor unused = performUnifiedRestoreTask.mMonitor = BackupManagerMonitorUtils.monitorEvent(performUnifiedRestoreTask.mMonitor, 45, PerformUnifiedRestoreTask.this.mCurrentPackage, 2, null);
