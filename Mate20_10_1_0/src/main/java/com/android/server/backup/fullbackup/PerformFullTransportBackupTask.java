...
public class PerformFullTransportBackupTask extends FullBackupTask implements BackupRestoreTask {
    ...
    public PerformFullTransportBackupTask(UserBackupManagerService backupManagerService2, TransportClient transportClient, IFullBackupRestoreObserver observer, String[] whichPackages, boolean updateSchedule, FullBackupJob runningJob, CountDownLatch latch, IBackupObserver backupObserver, IBackupManagerMonitor monitor, OnTaskFinishedListener listener, boolean userInitiated) {
        ...
        while (i < length) {
            String pkg = strArr[i];
            try {
                PackageInfo info = backupManagerService2.getPackageManager().getPackageInfoAsUser(pkg, 134217728, this.mUserId);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:115:0x028f, code lost:
        r8 = r29 + ((long) r8);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:116:0x0294, code lost:
        if (r35.mBackupObserver == null) goto L_0x02a9;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:119:0x029a, code lost:
        r32 = r3;
        r3 = r22;
        com.android.server.backup.utils.BackupObserverUtils.sendBackupOnUpdate(r35.mBackupObserver, r3, new android.app.backup.BackupProgress(r17, r8));
     */
                                        ...
                                        try {
                                            if (backupPackageStatus == 0) {
                                                try {
                                                    ...
                                                    FileInputStream in2 = new FileInputStream(enginePipes4[0].getFileDescriptor());
                                                    FileOutputStream out = new FileOutputStream(transportPipes2[c].getFileDescriptor());
                    ...
                    try {
                        RemoteCall.execute(new RemoteCallable(agent, totalSize) {
                            ...
                            public final void call(Object obj) {
                                SinglePackageBackupPreflight.this.lambda$preflightFullBackup$0$PerformFullTransportBackupTask$SinglePackageBackupPreflight(this.f$1, this.f$2, (IBackupCallback) obj);
                            }
    ...
    class SinglePackageBackupRunner implements Runnable, BackupRestoreTask {
        ...
        public void handleCancel(boolean cancelAll) {
            ...
            IBackupManagerMonitor unused = performFullTransportBackupTask.mMonitor = BackupManagerMonitorUtils.monitorEvent(performFullTransportBackupTask.mMonitor, 4, PerformFullTransportBackupTask.this.mCurrentPackage, 2, null);
