    ...
    private int runEnableDisable(boolean enable) throws RemoteException {
        ...
        while (true) {
            ...
            if (opt != null) {
                ...
                return 1 ^ this.mInterface.setEnabled(getNextArgRequired(), enable, userId);
            }
        }
    }
    ...
    private int runEnableExclusive() throws RemoteException {
        ...
        while (true) {
            ...
            if (opt != null) {
                ...
                if (inCategory) {
                    return 1 ^ this.mInterface.setEnabledExclusiveInCategory(overlay, userId);
                }
                return 1 ^ this.mInterface.setEnabledExclusive(overlay, true, userId);
            }
        }
    }
    ...
    private int runSetPriority() throws RemoteException {
        ...
        while (true) {
            ...
            if (opt != null) {
                ...
                return 1 ^ this.mInterface.setPriority(packageName, newParentPackageName, userId);
            }
        }
    }
}
