...
public class AlarmManagerService extends AbsAlarmManagerService {
        ...
        public boolean remove(Alarm alarm) {
            return remove(new Predicate() {
                ...
                public final boolean test(Object obj) {
                    return Batch.lambda$remove$0(Alarm.this, (Alarm) obj);
                }
            }, true);
        }
        ...
        public boolean remove(Predicate<Alarm> predicate, boolean reOrdering) {
            ...
            while (i < this.alarms.size()) {
                ...
                if (predicate.test(alarm)) {
                    ...
                    if (alarm.listener == AlarmManagerService.this.mTimeTickTrigger) {
                        AlarmManagerService alarmManagerService = AlarmManagerService.this;
                        long unused = alarmManagerService.mLastTickRemoved = alarmManagerService.mInjector.getCurrentTimeMillis();
                    }
                } else {
    ...
    AlarmManagerService(Context context, Injector injector) {
        ...
        this.mForceAppStandbyListener = new AppStateTracker.Listener() {
            ...
            public void unblockAllUnrestrictedAlarms() {
                synchronized (AlarmManagerService.this.mLock) {
                    Flog.i(500, "unblockAllUnrestrictedAlarms");
            ...
            public void unblockAlarmsForUid(int uid) {
                synchronized (AlarmManagerService.this.mLock) {
                    Flog.i(500, "unblockAlarmsForUid uid:" + uid);
            ...
            public void unblockAlarmsForUidPackage(int uid, String packageName) {
                synchronized (AlarmManagerService.this.mLock) {
                    Flog.i(500, "unblockAlarmsForUidPackage uid:" + uid + ", pkg:" + packageName);
    ...
    public void sendAllUnrestrictedPendingBackgroundAlarmsLocked() {
        ...
        findAllUnrestrictedPendingBackgroundAlarmsLockedInner(this.mPendingBackgroundAlarms, alarmsToDeliver, new Predicate() {
            ...
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return AlarmManagerService.this.isBackgroundRestricted((Alarm) obj);
            }
        });
    ...
    public void onStart() {
        ...
        synchronized (this.mLock) {
            ...
            Flog.i(500, "alarmmanagerservice onStart");
    ...
    /* JADX INFO: Multiple debug info for r9v5 'triggerElapsed'  long: [D('minInterval' long), D('triggerElapsed' long)] */
    /* JADX INFO: Multiple debug info for r9v6 'triggerElapsed'  long: [D('minInterval' long), D('triggerElapsed' long)] */
    /* access modifiers changed from: package-private */
        ...
        synchronized (this.mLock) {
            ...
            for (int i9 = 0; i9 < this.mUseAllowWhileIdleShortTime.size(); i9++) {
                if (this.mUseAllowWhileIdleShortTime.valueAt(i9)) {
                    ...
                    pw.print(com.android.server.devicepolicy.HwLog.PREFIX);
                }
            }
            pw.println("]");
            pw.println();
            ...
            pw.println(com.android.server.devicepolicy.HwLog.PREFIX);
    ...
    public void removeLocked(PendingIntent operation, IAlarmListener directReceiver) {
        if (operation != null || directReceiver != null) {
            ...
            Predicate<Alarm> whichAlarms = new Predicate(operation, directReceiver) {
                ...
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                    return AlarmManagerService.lambda$removeLocked$1(this.f$0, this.f$1, (Alarm) obj);
                }
            };
            ...
            for (int i2 = this.mPendingWhileIdleAlarms.size() - 1; i2 >= 0; i2--) {
                ...
                if (alarm.matches(operation, directReceiver)) {
                    ...
                    Flog.i(500, "remove pending idle:" + alarm + " by op:" + operation + ", rec:" + directReceiver);
                }
            }
            for (int i3 = this.mPendingBackgroundAlarms.size() - 1; i3 >= 0; i3--) {
                ...
                for (int j = alarmsForUid.size() - 1; j >= 0; j--) {
                    ...
                    if (alarm2.matches(operation, directReceiver)) {
                        ...
                        Flog.i(500, "remove pending background:" + alarm2 + " by op:" + operation + ", rec:" + directReceiver);
                    }
                }
                if (alarmsForUid.size() == 0) {
    ...
    public void removeLocked(int uid) {
        if (uid != 1000) {
            ...
            Predicate<Alarm> whichAlarms = new Predicate(uid) {
                ...
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                    return AlarmManagerService.lambda$removeLocked$2(this.f$0, (Alarm) obj);
                }
            };
            for (int i = this.mAlarmBatches.size() - 1; i >= 0; i--) {
                Batch b = this.mAlarmBatches.get(i);
            ...
            for (int i2 = this.mPendingWhileIdleAlarms.size() - 1; i2 >= 0; i2--) {
                ...
                if (a.uid == uid) {
                    ...
                    Flog.i(500, "remove pending idle:" + a + " by uid:" + uid);
                }
            }
            for (int i3 = this.mPendingBackgroundAlarms.size() - 1; i3 >= 0; i3--) {
                ArrayList<Alarm> alarmsForUid = this.mPendingBackgroundAlarms.valueAt(i3);
                for (int j = alarmsForUid.size() - 1; j >= 0; j--) {
                    if (alarmsForUid.get(j).uid == uid) {
                        Flog.i(500, "remove pending background:" + alarmsForUid.get(j) + " by uid:" + uid);
                        alarmsForUid.remove(j);
                        decrementAlarmCount(uid, 1);
                    }
                }
    ...
    public void removeLocked(String packageName) {
        if (packageName != null && !PackageManagerService.PLATFORM_PACKAGE_NAME.equals(packageName)) {
            ...
            Predicate<Alarm> whichAlarms = new Predicate(packageName, removedNextWakeFromIdle) {
                ...
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                    return AlarmManagerService.this.lambda$removeLocked$3$AlarmManagerService(this.f$1, this.f$2, (Alarm) obj);
                }
            };
            ...
            for (int i2 = this.mPendingWhileIdleAlarms.size() - 1; i2 >= 0; i2--) {
                ...
                if (a.matches(packageName)) {
                    ...
                    Flog.i(500, "remove pending idle:" + a + " by pkg:" + packageName);
                }
            }
            for (int i3 = this.mPendingBackgroundAlarms.size() - 1; i3 >= 0; i3--) {
                ArrayList<Alarm> alarmsForUid = this.mPendingBackgroundAlarms.valueAt(i3);
                for (int j = alarmsForUid.size() - 1; j >= 0; j--) {
                    ...
                    if (alarm.matches(packageName)) {
                        alarmsForUid.remove(j);
                        decrementAlarmCount(alarm.uid, 1);
                        Flog.i(500, "remove pending background:" + alarm + " by pkg:" + packageName);
                    }
                }
                if (alarmsForUid.size() == 0) {
                    this.mPendingBackgroundAlarms.removeAt(i3);
    ...
    public void removeLocked(int uid, String packageName) {
        if (uid == 1000) {
            ...
            Predicate<Alarm> whichAlarms = new Predicate(uid, packageName) {
                ...
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                    return AlarmManagerService.lambda$removeLocked$4(this.f$0, this.f$1, (Alarm) obj);
                }
            };
            for (int i = this.mAlarmBatches.size() - 1; i >= 0; i--) {
                Batch b = this.mAlarmBatches.get(i);
            ...
            for (int i2 = this.mPendingWhileIdleAlarms.size() - 1; i2 >= 0; i2--) {
                ...
                if (a.uid == uid && a.matches(packageName)) {
                    this.mPendingWhileIdleAlarms.remove(i2);
                    decrementAlarmCount(uid, 1);
                    Flog.i(500, "remove pending idle:" + a + " by uid:" + uid + ", pkg:" + packageName);
                }
            }
            for (int i3 = this.mPendingBackgroundAlarms.size() - 1; i3 >= 0; i3--) {
                ArrayList<Alarm> alarmsForUid = this.mPendingBackgroundAlarms.valueAt(i3);
                for (int j = alarmsForUid.size() - 1; j >= 0; j--) {
                    if (alarmsForUid.get(j).uid == uid && alarmsForUid.get(j).matches(packageName)) {
                        Flog.i(500, "remove pending background:" + alarmsForUid.get(j) + " by uid:" + uid + ", pkg:" + packageName);
                        alarmsForUid.remove(j);
                        decrementAlarmCount(uid, 1);
                    }
                }
    ...
    public void removeForStoppedLocked(int uid) {
        if (uid != 1000) {
            ...
            Predicate<Alarm> whichAlarms = new Predicate(uid) {
                ...
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                    return AlarmManagerService.lambda$removeForStoppedLocked$5(this.f$0, (Alarm) obj);
                }
            };
            for (int i = this.mAlarmBatches.size() - 1; i >= 0; i--) {
                Batch b = this.mAlarmBatches.get(i);
            ...
            for (int i2 = this.mPendingWhileIdleAlarms.size() - 1; i2 >= 0; i2--) {
                ...
                if (a.uid == uid) {
                    this.mPendingWhileIdleAlarms.remove(i2);
                    decrementAlarmCount(uid, 1);
                    Flog.i(500, "removeForStoppedLocked pending idle:" + a + " by uid:" + uid);
                }
            }
            for (int i3 = this.mPendingBackgroundAlarms.size() - 1; i3 >= 0; i3--) {
                if (this.mPendingBackgroundAlarms.keyAt(i3) == uid) {
                    ...
                    if (toRemove != null) {
                        ...
                        Flog.i(500, "removeForStoppedLocked pending background size" + toRemove.size() + ", by uid:" + uid);
                    }
                    this.mPendingBackgroundAlarms.removeAt(i3);
                }
            }
    ...
    public void removeUserLocked(int userHandle) {
        if (userHandle != 0) {
            ...
            Predicate<Alarm> whichAlarms = new Predicate(userHandle) {
                ...
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
                    return AlarmManagerService.lambda$removeUserLocked$6(this.f$0, (Alarm) obj);
                }
            };
            for (int i = this.mAlarmBatches.size() - 1; i >= 0; i--) {
                Batch b = this.mAlarmBatches.get(i);
            ...
            for (int i2 = this.mPendingWhileIdleAlarms.size() - 1; i2 >= 0; i2--) {
                if (UserHandle.getUserId(this.mPendingWhileIdleAlarms.get(i2).creatorUid) == userHandle) {
                    ...
                    Flog.i(500, "remove pending idle:" + removed + " by userHandle:" + userHandle);
                }
            }
            for (int i3 = this.mPendingBackgroundAlarms.size() - 1; i3 >= 0; i3--) {
                if (UserHandle.getUserId(this.mPendingBackgroundAlarms.keyAt(i3)) == userHandle) {
                    ...
                    if (toRemove != null) {
                        for (int j = 0; j < toRemove.size(); j++) {
                            ...
                            Flog.i(500, "remove pending background:" + toRemove.get(j) + " by userHandle:" + userHandle);
                        }
                    }
                    this.mPendingBackgroundAlarms.removeAt(i3);
                }
            ...
            while (i4 < N2) {
                ...
                if ((alarm2.flags & 4) != 0) {
                    ...
                    if (lastTime >= 0 && nowELAPSED < minTime) {
                        ...
                        alarmManagerService3.setImplLocked(alarm2, r10, z3);
                ...
                if (alarmManagerService3.isBackgroundRestricted(alarm2)) {
                    ...
                    if ((alarm2.flags & i3) != 0) {
                        EventLogTags.writeDeviceIdleWakeFromIdle(alarmManagerService3.mPendingIdleUntil != null ? r10 : z3, alarm2.statsTag);
                    }
                    ...
                    if (alarm2.repeatInterval > 0) {
                        ...
                        Flog.i(500, "set again repeat alarm: nextElapsed = " + nextElapsed + ",repeatInterval = " + alarm2.repeatInterval);
                        i2 = i4;
                        batch = batch2;
                        N = N2;
                        z = false;
    ...
    public static class Alarm {
        ...
        public String toString() {
            ...
            sb.append(" when ");
            sb.append(this.when);
            sb.append(com.android.server.devicepolicy.HwLog.PREFIX);
            PendingIntent pendingIntent = this.operation;
            if (pendingIntent != null) {
            ...
            while (true) {
                ...
                if ((result2 & 65536) != 0) {
                    ...
                    if (lastTimeChangeClockTime == 0 || nowRTC2 < expectedClockTime - 1000 || nowRTC2 > expectedClockTime + 1000) {
                        ...
                        if (result == 65536) {
                            synchronized (AlarmManagerService.this.mLock) {
                                long unused2 = AlarmManagerService.this.mLastTrigger = nowRTC;
    ...
    class DeliveryTracker extends IAlarmCompleteListener.Stub implements PendingIntent.OnFinished {
        ...
        private InFlight removeLocked(PendingIntent pi, Intent intent) {
            ...
            localLog.w("No in-flight alarm for " + pi + com.android.server.devicepolicy.HwLog.PREFIX + intent);
            return null;
        }
