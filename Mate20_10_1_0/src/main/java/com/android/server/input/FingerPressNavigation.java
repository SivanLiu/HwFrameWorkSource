...
public class FingerPressNavigation {
    ...
    protected FingerPressNavigation(Context context) {
        ...
        this.mStatusBarHeight = this.mContext.getResources().getDimensionPixelSize(17105443);
        ...
        if (policy instanceof HwPhoneWindowManager) {
            this.mPolicy = (HwPhoneWindowManager) policy;
        }
    }
    ...
    public void setCurFocusWindow(WindowState focus) {
        ...
        String str = null;
        WindowManager.LayoutParams focusAttrs = windowState != null ? windowState.getAttrs() : null;
        boolean z = false;
