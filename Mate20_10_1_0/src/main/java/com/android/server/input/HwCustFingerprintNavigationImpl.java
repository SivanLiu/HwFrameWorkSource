...
public class HwCustFingerprintNavigationImpl extends HwCustFingerprintNavigation {
    ...
    public HwCustFingerprintNavigationImpl(Context context) {
        ...
        this.mGallerySlide = Settings.Secure.getInt(this.mResolver, FINGERPRINT_GALLERY_SLIDE, 0) != 0 ? true : z;
    ...
    class SettingsObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            ...
            boolean z = false;
            boolean unused = hwCustFingerprintNavigationImpl.mLauncherSlide = Settings.Secure.getInt(hwCustFingerprintNavigationImpl.mResolver, HwCustFingerprintNavigationImpl.FINGERPRINT_LAUNCHER_SLIDE, 0) != 0;
            ...
            boolean unused2 = hwCustFingerprintNavigationImpl2.mGallerySlide = z;
        }
    }
    ...
    final class GalleryInspector extends FingerprintNavigationInspector {
        ...
        public boolean probe(InputEvent event) {
            ...
            if (!HwCustFingerprintNavigationImpl.this.mGallerySlide || !HwCustFingerprintNavigationImpl.this.isGallery() || HwCustFingerprintNavigationImpl.this.isScreenOff()) {
                return false;
            }
    ...
    final class LauncherNavigationInspector extends FingerprintNavigationInspector {
        ...
        @Override // com.android.server.input.HwCustFingerprintNavigationImpl.FingerprintNavigationInspector
        public boolean probe(InputEvent event) {
            if (!HwCustFingerprintNavigationImpl.this.mLauncherSlide || !HwCustFingerprintNavigationImpl.this.isLauncher() || HwCustFingerprintNavigationImpl.this.isScreenOff()) {
                return false;
            }
            if (!HwCustFingerprintNavigationImpl.this.isSpecialKey(event, 513) && !HwCustFingerprintNavigationImpl.this.isSpecialKey(event, 514)) {
                return false;
