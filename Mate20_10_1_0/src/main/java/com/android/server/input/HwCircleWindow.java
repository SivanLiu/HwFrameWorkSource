...
public class HwCircleWindow {
    ...
    /* access modifiers changed from: private */
    public float mInaccuracyToCenter = 0.5f;
    /* access modifiers changed from: private */
    public boolean mIsCanNaviDraw = true;
    /* access modifiers changed from: private */
    public boolean mIsDebug = false;
    /* access modifiers changed from: private */
    public boolean mIsImmersiveMode = false;
    /* access modifiers changed from: private */
    public boolean mIsNeedTip = false;
    ...
    public int mMode = 0;
    /* access modifiers changed from: private */
    public String mNeedTip = "pressure_needTip";
    /* access modifiers changed from: private */
    public float mPressLaunchLimit = PRESS_LAUNCH_LIMIT;
    /* access modifiers changed from: private */
    public float mPressStartLimit = PRESS_START_LIMIT;
        ...
        private void handleDispatchPromptTimeout() {
            if (HwCircleWindow.this.mHwCircle != null) {
                ...
                if (Settings.System.getIntForUser(HwCircleWindow.this.mContext.getContentResolver(), HwCircleWindow.this.mNeedTip, 0, ActivityManager.getCurrentUser()) == 1) {
                    ...
                    boolean unused = HwCircleWindow.this.mIsNeedTip = false;
                }
            }
        }
    }
    ...
    public class HwCircle extends View implements HwCircleAnimation.AnimationUpdateListener {
        ...
        public boolean onTouchEvent(MotionEvent event, int type) {
            ...
            float unused = hwCircleWindow.mPressLaunchLimit = hwCircleWindow.mLimit * HwCircleWindow.this.mInaccuracyToCenter;
            HwCircleWindow hwCircleWindow2 = HwCircleWindow.this;
            float unused2 = hwCircleWindow2.mPressStartLimit = hwCircleWindow2.mPressLaunchLimit * 0.6f;
