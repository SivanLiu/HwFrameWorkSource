...
public class ServiceWatcher implements ServiceConnection {
    ...
    public Runnable mRetryRunnable = new Runnable() {
        ...
        public void run() {
            if (ServiceWatcher.this.mBestService == null && ServiceWatcher.this.mRetryCount < 3) {
    ...
    public final void runOnBinder(BinderRunner runner) {
        runOnHandler(new Runnable(runner) {
            ...
            private final /* synthetic */ BinderRunner f$1;
    ...
    public final <T> T runOnBinderBlocking(BlockingBinderRunner<T> runner, T defaultValue) {
        try {
            return (T) runOnHandlerBlocking(new Callable(defaultValue, runner) {
                ...
                private final /* synthetic */ BlockingBinderRunner f$2;
