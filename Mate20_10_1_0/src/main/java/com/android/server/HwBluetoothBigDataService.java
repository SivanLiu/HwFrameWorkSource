...
public class HwBluetoothBigDataService {
    ...
    public String getAppName(Context mContext, int pid) {
        ...
        if (pid <= 0 || (activityManager = (ActivityManager) mContext.getSystemService(BigMemoryConstant.BIGMEMINFO_ITEM_TAG)) == null || (appProcesses = activityManager.getRunningAppProcesses()) == null || appProcesses.size() == 0) {
            return null;
        }
