...
public class KeepaliveTracker {
    ...
    public final int mAllowedUnprivilegedSlotsForUid;
    private final Handler mConnectivityServiceHandler;
    /* access modifiers changed from: private */
    public final Context mContext;
    /* access modifiers changed from: private */
    public final HashMap<NetworkAgentInfo, HashMap<Integer, KeepaliveInfo>> mKeepalives = new HashMap<>();
    /* access modifiers changed from: private */
    public final int mReservedPrivilegedSlots;
    /* access modifiers changed from: private */
    public final int[] mSupportedKeepalives;
    /* access modifiers changed from: private */
    public final TcpKeepaliveController mTcpController;
    ...
    public class KeepaliveInfo implements IBinder.DeathRecipient {
        ...
        public String toString() {
            return "KeepaliveInfo [ type=" + this.mType + " network=" + this.mNai.network + " startedState=" + startedStateString(this.mStartedState) + HwLog.PREFIX + IpUtils.addressAndPortToString(this.mPacket.srcAddress, this.mPacket.srcPort) + "->" + IpUtils.addressAndPortToString(this.mPacket.dstAddress, this.mPacket.dstPort) + " interval=" + this.mInterval + " uid=" + this.mUid + " pid=" + this.mPid + " privileged=" + this.mPrivileged + " packetData=" + HexDump.toHexString(this.mPacket.getPacket()) + " ]";
        }
        ...
        public void start(int slot) {
            ...
            if (error == 0) {
                ...
                int i = this.mType;
                if (i == 1) {
                    ((NetworkAgentInfo) this.mNai).asyncChannel.sendMessage(528400, slot, 0, this.mPacket);
    ...
    public void handleEventSocketKeepalive(NetworkAgentInfo nai, Message message) {
        ...
        if (ki == null) {
            ...
            int unused2 = ki.mStartedState = 1;
