...
public class OffloadController {
    ...
    public boolean start() {
        ...
        this.mControlInitialized = this.mHwInterface.initOffloadControl(new OffloadHardwareInterface.ControlCallback() {
            /* class com.android.server.connectivity.tethering.OffloadController.AnonymousClass1 */
    ...
    public class OffloadTetheringStatsProvider extends ITetheringStatsProvider.Stub {
        ...
        public NetworkStats getTetherStats(int how) {
            Runnable updateStats = new Runnable() {
                /* class com.android.server.connectivity.tethering.$$Lambda$OffloadController$OffloadTetheringStatsProvider$3TF0NI3fE8AxW0925oMv3YzAOk */

                public final void run() {
                    OffloadTetheringStatsProvider.this.lambda$getTetherStats$0$OffloadController$OffloadTetheringStatsProvider();
                }
            };
        ...
        public void setInterfaceQuota(String iface, long quotaBytes) {
            OffloadController.this.mHandler.post(new Runnable(quotaBytes, iface) {
                /* class com.android.server.connectivity.tethering.$$Lambda$OffloadController$OffloadTetheringStatsProvider$qF4r7cON_Hdae6JwwsXWcAUxEQ */
                ...
                public final void run() {
                    OffloadTetheringStatsProvider.this.lambda$setInterfaceQuota$1$OffloadController$OffloadTetheringStatsProvider(this.f$1, this.f$2);
                }
            });
        }
