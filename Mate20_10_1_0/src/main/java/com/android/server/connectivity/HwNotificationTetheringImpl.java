...
public class HwNotificationTetheringImpl implements HwNotificationTethering {
                ...
                if ("android.intent.action.BATTERY_CHANGED".equals(intent.getAction())) {
                    ...
                    if (HwNotificationTetheringImpl.this.mPluggedType != temp) {
                        ...
                        if (HwNotificationTetheringImpl.this.mPluggedType != 0) {
                            ...
                            HwNotificationTetheringImpl.this.mAlarmManager.setExact(2, SystemClock.elapsedRealtime() + 600000, HwNotificationTetheringImpl.IDLE_WIFI_TETHER_ALARM_TAG, HwNotificationTetheringImpl.this.mIdleApAlarmListener, null);
                        }
                    }
                }
            }
            ...
            if (this.mTetheredNotification != null) {
                ...
                if (this.mWifiTetherd) {
                    ...
                    if (this.mWifiConnectNum > 0) {
                        ...
                        this.mAlarmManager.setExact(2, SystemClock.elapsedRealtime() + 600000, IDLE_WIFI_TETHER_ALARM_TAG, this.mIdleApAlarmListener, null);
                    }
                }
                ...
                if (MOBILE_NETWORK_SHARING_INTEGRATION && this.mP2pTethered) {
                    ...
                    if (this.mP2pConnectNum > 0) {
                        ...
                        this.mSetIdleAlarm = true;
                        this.mAlarmManager.setExact(2, SystemClock.elapsedRealtime() + 600000, IDLE_P2P_TETHER_ALARM_TAG, this.mIdleP2PAlarmListener, null);
                    } else {
                ...
                if (isConfigR1()) {
                    ...
                    if (this.mWifiConnectNum <= 0) {
                        message = Resources.getSystem().getText(33686222);
                    } else {
    ...
    public synchronized void showStopWifiTetherNotification() {
        ...
        CharSequence message = resource.getText(33686219);
    ...
    /* access modifiers changed from: private */
    public synchronized void showStopP2PTetherNotification() {
    ...
    /* access modifiers changed from: private */
    public synchronized void clearStopP2PNotification() {
            ...
            public void onReceive(Context context, Intent intent) {
                if (intent != null && "android.intent.action.BATTERY_CHANGED".equals(intent.getAction())) {
                    ...
                    if (HwNotificationTetheringImpl.this.mPluggedType != pluggedValue) {
                        int unused = HwNotificationTetheringImpl.this.mPluggedType = pluggedValue;
                        if (HwNotificationTetheringImpl.this.mPluggedType != 0) {
                            boolean unused2 = HwNotificationTetheringImpl.this.mSetIdleAlarm = false;
                            HwNotificationTetheringImpl.this.mAlarmManager.cancel(HwNotificationTetheringImpl.this.mIdleApAlarmListener);
                            ...
                            boolean unused3 = HwNotificationTetheringImpl.this.mSetIdleAlarm = true;
                            HwNotificationTetheringImpl.this.mAlarmManager.setExact(2, SystemClock.elapsedRealtime() + 600000, HwNotificationTetheringImpl.IDLE_P2P_TETHER_ALARM_TAG, HwNotificationTetheringImpl.this.mIdleP2PAlarmListener, null);
                        }
                    }
                }
            }
