...
public class UpstreamNetworkMonitor {
    ...
    public Network mDefaultInternetNetwork;
    private ConnectivityManager.NetworkCallback mDefaultNetworkCallback;
    private boolean mDunRequired;
    /* access modifiers changed from: private */
    public EntitlementManager mEntitlementMgr;
    private final Handler mHandler;
    /* access modifiers changed from: private */
    public boolean mIsDefaultCellularUpstream;
    ...
    public NetworkState getCurrentPreferredUpstream() {
        ...
        if (!this.mDunRequired) {
            return dfltState;
        }
        return findFirstDunNetwork(this.mNetworkMap.values());
    }
    ...
    private class UpstreamNetworkCallback extends ConnectivityManager.NetworkCallback {
        ...
        public void onCapabilitiesChanged(Network network, NetworkCapabilities newNc) {
            if (this.mCallbackType == 2) {
                Network unused = UpstreamNetworkMonitor.this.mDefaultInternetNetwork = network;
                ...
                if (UpstreamNetworkMonitor.this.mIsDefaultCellularUpstream != newIsCellular) {
                    boolean unused2 = UpstreamNetworkMonitor.this.mIsDefaultCellularUpstream = newIsCellular;
        ...
        public void onLost(Network network) {
            if (this.mCallbackType == 2) {
                Network unused = UpstreamNetworkMonitor.this.mDefaultInternetNetwork = null;
                boolean unused2 = UpstreamNetworkMonitor.this.mIsDefaultCellularUpstream = false;
    ...
    public static boolean isCellular(NetworkCapabilities nc) {
        if (nc == null || !nc.hasTransport(0) || !nc.hasCapability(15)) {
            return false;
        }
        return true;
    }
