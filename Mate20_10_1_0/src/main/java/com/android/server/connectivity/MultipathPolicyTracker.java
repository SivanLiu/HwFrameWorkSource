...
public class MultipathPolicyTracker {
    ...
    public class MultipathTracker {
                        ...
                        this.mUsageCallback = new NetworkStatsManager.UsageCallback(MultipathPolicyTracker.this) {
                            ...
                            public void onThresholdReached(int networkType, String subscriberId) {
                                if (MultipathPolicyTracker.DBG) {
                                    String access$300 = MultipathPolicyTracker.TAG;
                                    Slog.d(access$300, "onThresholdReached for network " + network2);
                                }
        ...
        private long getDailyNonDefaultDataUsage() {
            ...
            if (MultipathPolicyTracker.DBG) {
                String access$300 = MultipathPolicyTracker.TAG;
                Slog.d(access$300, "Non-default data usage: " + bytes);
            }
            return bytes;
        }
        ...
        private long getNetworkTotalBytes(long start, long end) {
            try {
                ...
                String access$300 = MultipathPolicyTracker.TAG;
                Slog.w(access$300, "Failed to get data usage: " + e);
                return -1;
            }
        }
        ...
        public void updateMultipathBudget() {
            ...
            if (MultipathPolicyTracker.DBG) {
                String access$300 = MultipathPolicyTracker.TAG;
                Slog.d(access$300, "Opportunistic quota from data plan: " + quota + " bytes");
            }
            if (quota == -1) {
                quota = getUserPolicyOpportunisticQuotaBytes();
                if (MultipathPolicyTracker.DBG) {
                    String access$3002 = MultipathPolicyTracker.TAG;
                    Slog.d(access$3002, "Opportunistic quota from user policy: " + quota + " bytes");
                }
            }
            if (quota == -1) {
                quota = MultipathPolicyTracker.this.getDefaultDailyMultipathQuotaBytes();
                if (MultipathPolicyTracker.DBG) {
                    String access$3003 = MultipathPolicyTracker.TAG;
                    Slog.d(access$3003, "Setting quota: " + quota + " bytes");
                }
            }
            if (!haveMultipathBudget() || quota != this.mQuota) {
                ...
                if (budget > NetworkStatsManager.MIN_THRESHOLD_BYTES) {
                    if (MultipathPolicyTracker.DBG) {
                        String access$3004 = MultipathPolicyTracker.TAG;
                        Slog.d(access$3004, "Setting callback for " + budget + " bytes on network " + this.network);
                    }
                ...
                String access$3005 = MultipathPolicyTracker.TAG;
                Slog.d(access$3005, "Quota still " + quota + ", not updating.");
            }
        }
        ...
        private void registerUsageCallback(long budget) {
            maybeUnregisterUsageCallback();
            String access$300 = MultipathPolicyTracker.TAG;
            Slog.i(access$300, "registerUsageCallback, budget is " + budget);
        ...
        private void maybeUnregisterUsageCallback() {
            if (haveMultipathBudget()) {
                String access$300 = MultipathPolicyTracker.TAG;
                Slog.i(access$300, "Unregistering callback, budget was " + this.mMultipathBudget);
        ...
        this.mMobileNetworkCallback = new ConnectivityManager.NetworkCallback() {
            ...
            public void onCapabilitiesChanged(Network network, NetworkCapabilities nc) {
                ...
                if (existing != null) {
                    if (MultipathPolicyTracker.DBG) {
                        String access$300 = MultipathPolicyTracker.TAG;
                        Slog.d(access$300, "onCapabilitiesChanged tracking mobile network " + network);
                    }
                ...
                try {
                    ...
                    String access$3002 = MultipathPolicyTracker.TAG;
                    Slog.e(access$3002, "Can't track mobile network " + network + ": " + e.getMessage());
                }
                if (MultipathPolicyTracker.DBG) {
                    String access$3003 = MultipathPolicyTracker.TAG;
                    Slog.d(access$3003, "Tracking mobile network " + network);
                }
            }
            ...
            public void onLost(Network network) {
                ...
                if (MultipathPolicyTracker.DBG) {
                    String access$300 = MultipathPolicyTracker.TAG;
                    Slog.d(access$300, "No longer tracking mobile network " + network);
                }
            }
        };
    ...
    private final class SettingsObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            if (!Settings.Global.getUriFor("network_default_daily_multipath_quota_bytes").equals(uri)) {
                String access$300 = MultipathPolicyTracker.TAG;
                Slog.wtf(access$300, "Unexpected settings observation: " + uri);
            }
            if (MultipathPolicyTracker.DBG) {
