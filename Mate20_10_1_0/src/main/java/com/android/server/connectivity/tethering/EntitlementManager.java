...
public class EntitlementManager {
    ...
    private static final ComponentName TETHER_SERVICE = ComponentName.unflattenFromString(Resources.getSystem().getString(17039900));
    ...
    public TetheringConfigurationFetcher mFetcher;
    private final EntitlementHandler mHandler;
    /* access modifiers changed from: private */
    public OnUiEntitlementFailedListener mListener;
    /* access modifiers changed from: private */
    ...
    private class EntitlementHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (i == 0) {
                ...
                SharedLog access$000 = EntitlementManager.this.mLog;
                access$000.log("Unknown event: " + msg.what);
            } else {
    ...
    private static String typeString(int type) {
        ...
        return String.format("TETHERING UNKNOWN TYPE (%d)", Integer.valueOf(type));
    }
