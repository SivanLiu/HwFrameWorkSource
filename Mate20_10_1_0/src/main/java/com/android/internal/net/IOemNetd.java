            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 6:
                        ...
                        setNetBoosterKsiEnabled(_arg04);
                        reply.writeNoException();
                        return true;
                    case 7:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 13:
                        ...
                        setNetBoosterUidForeground(_arg05, _arg1);
                        reply.writeNoException();
                        return true;
                    case 14:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 27:
                        ...
                        SetInterfaceProxyArp(_arg03, data.readString());
                        reply.writeNoException();
                        return true;
                    case 28:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        SetDnsForwarding(_arg02, data.readString());
                        reply.writeNoException();
                        return true;
                    default:
