...
public final class HwPCManagerService extends DefaultHwPCManagerService {
    ...
    private static final int[] KEYBOARD_PRODUCT_ID = {4817, SCM_KEYBOARD_PID, MRX_KEYBOARD_PID};
    private static final int[] KEYBOARD_VENDOR_ID = {KIHITECH_KEYBOARD_VID, KIHITECH_KEYBOARD_VID, 4817};
    ...
    private static final int TWO_SEC_DELAY = 2500;
    ...
    private final InputManager.InputDeviceListener mInputDeviceListener = new InputManager.InputDeviceListener() {
        ...
        public void onInputDeviceAdded(int deviceId) {
            ...
            HwPCManagerService hwPCManagerService = HwPCManagerService.this;
            int unused = hwPCManagerService.mConnectedInputDevices = hwPCManagerService.mConnectedInputDevices | HwPCManagerService.whichInputDevice(device);
    ...
    /* access modifiers changed from: private */
    public boolean mIsAppOpenTwice = false;
    /* access modifiers changed from: private */
    ...
    private final UEventObserverExt mKeyboardObserver = new UEventObserverExt() {
        /* class com.huawei.server.pc.HwPCManagerService.AnonymousClass16 */

        public void onUEvent(UEventObserverExt.UEvent event) {
            if (event != null) {
                HwPCManagerService hwPCManagerService = HwPCManagerService.this;
                hwPCManagerService.exclusiveKeyboardTriggerPcMode(hwPCManagerService.isExclusiveKeyboardConnect(event));
            }
        }
    };
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public final ArrayList<Messenger> mMessengers = new ArrayList<>();
            ...
            if (HwPCManagerService.ACTION_NOTIFY_SWITCH_MODE.equals(action)) {
                ...
                if (!statusExt.isEmpty()) {
                    ...
                    if (wifiDisplayExt != null) {
                        String unused = HwPCManagerService.this.mWireLessDeviceName = String.format(context.getResources().getString(HwPartResourceUtils.getResourceId("notification_pc_connected")), wifiDisplayExt.getDeviceName());
                        return;
                    }
    ...
    /* access modifiers changed from: private */
    public int mPCBeforeBootAnimTime = 2000;
    /* access modifiers changed from: private */
    public DisplayInfoEx mPCDisplayInfo = null;
    ...
    private TaskStackListenerEx mTaskStackListener = new TaskStackListenerEx() {
        /* class com.huawei.server.pc.HwPCManagerService.AnonymousClass21 */
        ...
        public void onTaskMovedToFront(int taskId) throws RemoteException {
            ...
            HwPCManagerService.this.mHandler.sendMessageDelayed(msg2, 2500);
        ...
        public void onTaskProfileLocked(int taskId, int userId) throws RemoteException {
            ...
            HwPCManagerService.this.sendToMessengers(19, taskId, userId, null);
        }
    };
    ...
    /* access modifiers changed from: private */
    public String mWireLessDeviceName = BuildConfig.FLAVOR;
            ...
            if (isCalling()) {
                ...
                if (isEnterDesktopModeRemembered() && !isDesktopMode(this.mProjMode) && !isExclusiveKeyboard) {
                    ...
                    if (imageView != null && textView != null && checkBox != null) {
                        ...
                        this.mEnterDesktopAlertDialog = buider.setTitle(HwPartResourceUtils.getResourceId("desktop_mode_enter_title")).setPositiveButton(HwPartResourceUtils.getResourceId("desktop_mode_enter_start"), new DialogInterface.OnClickListener(checkBox, isExclusiveKeyboard) {
    ...
    private class LocalHandler extends HandlerEx {
        public LocalHandler(Looper looper) {
            super(looper, (Handler.Callback) null, true);
        }

        /* JADX DEBUG: Multi-variable search result rejected for r1v29, resolved type: android.app.AlarmManager */
        /* JADX WARN: Multi-variable type inference failed */
        /* JADX INFO: Multiple debug info for r0v129 int: [D('removeTaskId' int), D('taskId' int)] */
        /* JADX WARN: Type inference failed for: r7v0, types: [android.os.Handler, com.huawei.server.pc.HwPCManagerService$LocalHandler] */
                ...
                switch (i) {
                    case 4:
                        if (HwPCUtils.enabledInPad() && HwPCManagerService.this.isMonkeyRunning()) {
                            ...
                            if (!HwPCManagerService.isDesktopMode(HwPCManagerService.this.mProjMode)) {
                                ...
                                HwPCManagerService.this.restoreDreamSettingInPad();
                                HwPCManagerService hwPCManagerService = HwPCManagerService.this;
                                hwPCManagerService.sendNotificationForSwitch(hwPCManagerService.mProjMode);
                                ...
                                hwPCManagerService2.backToHomeInDefaultDisplay(hwPCManagerService2.get1stDisplay().mDisplayId);
                                if (HwPCUtils.enabledInPad()) {
                    ...
                    case 6:
                        if (HwPCManagerService.this.mKeyguardManager == null) {
                            ...
                            KeyguardManager unused3 = hwPCManagerService4.mKeyguardManager = (KeyguardManager) hwPCManagerService4.mContext.getSystemService("keyguard");
                        }
                        if (HwPCManagerService.this.mUserManagerInternal == null) {
                            HwPCManagerService hwPCManagerService5 = HwPCManagerService.this;
                            hwPCManagerService5.mUserManagerInternal = hwPCManagerService5.getUserManagerInternal();
                        }
                        if (!HwPCManagerService.this.mUserManagerInternal.isUserUnlockingOrUnlocked(UserHandleEx.myUserId())) {
                            ...
                            HwPCManagerService.this.mHandler.sendMessageDelayed(HwPCManagerService.this.mHandler.obtainMessage(6, msg.arg1, -1), HwPCManagerService.DISPLAY_ADD_DELAY);
                            return;
                        }
                    ...
                    case 19:
                        ...
                        hwPCManagerService6.showEnterDesktopAlertDialog(hwPCManagerService6.getCurrentContext(), true);
                        return;
                    case 20:
                        HwPCManagerService hwPCManagerService7 = HwPCManagerService.this;
                        hwPCManagerService7.showExitDesktopAlertDialog(hwPCManagerService7.getCurrentContext(), true);
                        return;
                    case HwPCManagerService.MSG_DP_STATE_CHANGED /*{ENCODED_INT: 21}*/:
                    ...
                    case 23:
                        ...
                        return;
                    case HwPCManagerService.MSG_CLEAR_LIGHTER_DRAWED /*{ENCODED_INT: 24}*/:
                        ...
                        return;
                    case HwPCManagerService.MSG_DP_LINK_STATE_CABLE_OUT /*{ENCODED_INT: 25}*/:
                        HwPCManagerService.this.dismissDpLinkErrorDialog();
                        return;
                    case HwPCManagerService.MSG_SHOW_HELP_TO_PC_MODEL /*{ENCODED_INT: 26}*/:
                        Intent intent = new Intent();
                    ...
                    case HwPCManagerService.MSG_CLEAR_DRAG_DROP_CACHE_DIR /*{ENCODED_INT: 27}*/:
                        HwPCManagerService.clearCacheFiles(HwPCManagerService.DRAG_DROP_CACHE_DIR);
                        return;
                    case HwPCManagerService.MSG_RECORD_TASKID /*{ENCODED_INT: 28}*/:
                        int taskId = msg.arg1;
                        if (HwPCManagerService.this.checkAppName(taskId)) {
                            HwPCUtils.log(HwPCManagerService.TAG, "MSG_RECORD_TASKID" + msg.arg1);
                            if (HwPCManagerService.this.mRelaunchTaskId == taskId) {
                                HwPCUtils.log(HwPCManagerService.TAG, "MSG_RECORD_TASKID wechat twice");
                                boolean unused4 = HwPCManagerService.this.mIsAppOpenTwice = true;
                            }
                            int unused5 = HwPCManagerService.this.mRelaunchTaskId = taskId;
                            return;
                        }
                        return;
                    case HwPCManagerService.MSG_RESTART_WECHAT /*{ENCODED_INT: 29}*/:
                        int removeTaskId = msg.arg1;
                        HwPCUtils.log(HwPCManagerService.TAG, "MSG_RESTART_WECHAT" + msg.arg1);
                        if (removeTaskId == HwPCManagerService.this.mRelaunchTaskId && HwPCManagerService.this.mIsAppOpenTwice) {
                            HwPCUtils.log(HwPCManagerService.TAG, "MSG_RESTART_WECHAT reopen wechat");
                            HwPCManagerService.this.reOpenWechat();
                            return;
                        }
                        return;
                    case HwPCManagerService.MSG_CLEAR_REOCRD_TASKID /*{ENCODED_INT: 30}*/:
                        HwPCUtils.log(HwPCManagerService.TAG, "MSG_CLEAR_REOCRD_TASKID");
                        int unused6 = HwPCManagerService.this.mRelaunchTaskId = -1;
                        boolean unused7 = HwPCManagerService.this.mIsAppOpenTwice = false;
                        return;
                    default:
                        return;
                }
    ...
    /* access modifiers changed from: private */
    public void disableShowTouchStatus() {
        if (HwPCUtils.enabledInPad()) {
    ...
    /* access modifiers changed from: private */
    public void setNotchStatus(boolean isEnterDesktop) {
        if (IS_NOTCH) {
            if (isEnterDesktop) {
    ...
    public HwPCManagerService(Context context, ActivityManagerServiceEx amsEx) {
        ...
        if (HwPCUtils.enabledInPad()) {
            if (SettingsEx.Secure.getInt(this.mContext.getContentResolver(), "selected-proj-mode", 0) == 1 ? true : projMode) {
    ...
    private boolean isWiredDisplay(int displayId) {
        ...
        if (display == null) {
            ...
            if (type == 5 && "com.huawei.works".equals(DisplayEx.getOwnerPackageName(display)) && ESHARE_DISPLAY_NAME.equals(display.getName())) {
                return true;
            }
    ...
    public void sendNotificationForSwitch(HwPCUtils.ProjectionMode projMode) {
        String mode;
        if (!HwPCUtils.enabledInPad() && this.mNm != null && !HwPCUtils.isHiCarCastMode() && systemUIExist() && explorerExist()) {
            ...
            RemoteViews contentView = createContentView(mode, switchModePendingIntent, showMKPendingIntent, disconnectPendingIntent, isConnectFromWelink, false);
            RemoteViews bigContentView = createContentView(mode, switchModePendingIntent, showMKPendingIntent, disconnectPendingIntent, isConnectFromWelink, true);
    ...
    public void onDisplayRemoved(int displayId) {
        if (HwPCUtils.enabledInPad()) {
            ...
            if (isInWindowsCastMode() && displayId == HwPCUtils.getWindowsCastDisplayId()) {
                ...
                HwPCUtils.setPhoneDisplayID(-1);
            } else if (HwVideoCallCastManager.getDefault().isDisplayForVideoCall(displayId)) {
                HwVideoCallCastManager.getDefault().onDisplayRemoved(this.mContext, displayId);
                HwPCUtils.setPhoneDisplayID(-1);
            } else if (displayId == get2ndDisplay().mDisplayId) {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v43, resolved type: com.huawei.server.hwmultidisplay.videocall.HwVideoCallCastManager */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r7v9, types: [android.os.Handler, com.huawei.server.pc.HwPCManagerService$LocalHandler] */
    /* JADX WARN: Type inference failed for: r2v30, types: [android.os.Handler, com.huawei.server.pc.HwPCManagerService$LocalHandler] */
    /* access modifiers changed from: private */
    ...
    private void sendShowHelpMsgToPCModel() {
        if (!HwPCUtils.enabledInPad()) {
            int helpMsgNumber = SettingsEx.Secure.getInt(this.mContext.getContentResolver(), HELP_MSG_PROMPT_NUMBER, 0);
            HwPCUtils.log(TAG, "showHelpMsgToPCModel helpMsgNumber : " + helpMsgNumber);
            if (helpMsgNumber < 3) {
                SettingsEx.Secure.putInt(this.mContext.getContentResolver(), HELP_MSG_PROMPT_NUMBER, helpMsgNumber + 1);
    ...
    private void autoLaunchMK() {
        if (!HwPCUtils.isHiCarCastMode()) {
            boolean guideStarted = false;
            if (SettingsEx.Secure.getInt(this.mContext.getContentResolver(), "guide-started", 0) == 1) {
                guideStarted = true;
            }
    ...
    public void setUsePCModeMouseIconContext(boolean pcmode) {
        HwInputManagerService.HwInputManagerLocalService inputManager = (HwInputManagerService.HwInputManagerLocalService) LocalServicesExt.getService(HwInputManagerService.HwInputManagerLocalService.class);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("android.intent.action.USER_PRESENT".equals(action) || "android.intent.action.USER_UNLOCKED".equals(action)) {
                ...
                if (HwPCManagerService.this.mRestartAppsWhenUnlocked) {
                    ...
                    boolean unused = hwPCManagerService.restartByUnlock2SetAnimTime = true;
                    HwPCManagerService hwPCManagerService2 = HwPCManagerService.this;
    ...
    /* access modifiers changed from: private */
    public void resizeTaskOnUnLock() {
        int taskId;
        if (HwPCUtils.isPcCastModeInServer() && HwPCUtils.enabledInPad()) {
            ...
            if (!tasks.isEmpty() && tasks.get(0) != null && tasks.get(0).topActivity != null && (taskId = tasks.get(0).id) != 1) {
                ...
                if (taskRecordEx.getOriginalWindowState() == 3 && taskRecordEx.getNextWindowState() == 3) {
    ...
    private boolean isExclusiveKeyboardConnected() {
        ...
        for (int i : InputDevice.getDeviceIds()) {
            ...
            if (device != null && isExclusiveKeyboard(device) && device.getVendorId() != 4817 && device.getProductId() != MRX_KEYBOARD_PID) {
                return true;
            }
        }
        return false;
    ...
    /* access modifiers changed from: private */
    public void exclusiveKeyboardTriggerPcMode(boolean isExclusiveKeyboardConnect) {
        if (isExclusiveKeyboardConnect) {
            HwPCUtils.log(TAG, "Exclusive Keyboard Connect");
            if (!isDesktopMode(this.mProjMode)) {
                this.mHandler.sendMessage(this.mHandler.obtainMessage(19));
            } else if (this.mExitDesktopAlertDialog != null) {
                HwPCUtils.log(TAG, "close exit desktop alert dialog");
                this.mExitDesktopAlertDialog.dismiss();
            } else {
                HwPCUtils.log(TAG, "isDesktopMode is true and mExitDesktopAlertDialog is null");
            }
        } else {
            HwPCUtils.log(TAG, "Exclusive Keyboard Disconnect");
            if (isDesktopMode(this.mProjMode)) {
    ...
    private boolean checkCallingPermission(int taskId) {
        ...
        if (!(callingPackages == null || targetTask == null || targetTask.topActivity == null)) {
            ...
            for (String callingPackageName : callingPackages) {
                if (targetPackageName.equals(callingPackageName) || "com.huawei.desktop.systemui".equals(callingPackageName) || "com.huawei.desktop.explorer".equals(callingPackageName)) {
                    return true;
                }
            }
        }
    ...
    class PointerEventListenerExt extends PointerEventListenerEx {
    ...
    private void bdReportConnectDisplay(int displayId) {
        ...
        if (display != null) {
            ...
            if (type == 0) {
                Context context = this.mContext;
                HwPCUtils.bdReport(context, 10009, "Display<" + name + "> type is UNKNOWN");
            } else if (type == 2) {
                Context context2 = this.mContext;
                HwPCUtils.bdReport(context2, 10009, "Display<" + name + "> type is HDMI");
            } else if (type == 3) {
                Context context3 = this.mContext;
                HwPCUtils.bdReport(context3, 10009, "Display<" + name + "> type is WIFI");
            } else if (type == 4) {
                Context context4 = this.mContext;
                HwPCUtils.bdReport(context4, 10009, "Display<" + name + "> type is OVERLAY");
            } else if (type == 5) {
                Context context5 = this.mContext;
                HwPCUtils.bdReport(context5, 10009, "Display<" + name + "> type is VIRTUAL");
            }
            Point size = new Point();
            display.getRealSize(size);
            Context context6 = this.mContext;
            HwPCUtils.bdReport(context6, 10010, "Display<" + name + "> width:" + size.x + " height:" + size.y);
            StringBuilder sb = new StringBuilder();
            sb.append(size.x);
            sb.append(BuildConfig.FLAVOR);
            BigInteger biWidth = new BigInteger(sb.toString());
            BigInteger value = biWidth.gcd(new BigInteger(size.y + BuildConfig.FLAVOR));
            Context context7 = this.mContext;
            HwPCUtils.bdReport(context7, 10011, "Display<" + name + "> ratio:" + (size.x / value.intValue()) + ":" + (size.y / value.intValue()));
        }
    }

    private void bdReportOnDisplayAdded(int displayId) {
        if (isWifiPCMode(displayId) || isConnectFromThirdApp(displayId) > 0) {
            HwPCUtils.bdReport(this.mContext, 10057, BuildConfig.FLAVOR);
        } else if (HwPCUtils.enabledInPad()) {
            if (!isPadPCDisplay(displayId)) {
                HwPCUtils.bdReport(this.mContext, 10008, BuildConfig.FLAVOR);
            }
                ...
                UiThreadEx.getHandler().post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (HwPCUtils.isValidExtDisplayId(displayId)) {
                            ...
                            Toast unused = hwPCManagerService.mCallingToast = Toast.makeText(context, context.getResources().getString(HwPartResourceUtils.getResourceId("desktop_mode_exit_incall")), 1);
                        } else {
                            HwPCManagerService hwPCManagerService2 = HwPCManagerService.this;
                            Context context2 = context;
                            Toast unused2 = hwPCManagerService2.mCallingToast = Toast.makeText(context2, context2.getResources().getString(HwPartResourceUtils.getResourceId("desktop_mode_enter_incall")), 1);
                        }
                        if (HwPCManagerService.this.mCallingToast != null) {
    ...
    /* access modifiers changed from: private */
    public DisplayInfoEx getPcDisplayInfo() {
    ...
    class PCSettingsObserver extends ContentObserver {
        ...
        private synchronized void updateScreenOffTimeoutSettings() {
            ContentResolver resolver = HwPCManagerService.this.mContext.getContentResolver();
            try {
                int unused = HwPCManagerService.this.mLockScreenTimeout = SettingsEx.Systemex.getIntForUser(resolver, "screen_off_timeout", 0, -2);
                if (HwPCUtils.enabledInPad()) {
        ...
        public synchronized void readScreenOffSettings() {
            try {
                if (HwPCUtils.enabledInPad()) {
                    ContentResolver resolver = HwPCManagerService.this.mContext.getContentResolver();
                    int unused = HwPCManagerService.this.mLockScreenTimeout = SettingsEx.Systemex.getIntForUser(resolver, "screen_off_timeout", 0, -2);
                    int unused2 = HwPCManagerService.this.mPadLockScreenTimeout = SettingsEx.Secure.getIntForUser(resolver, "pad_screen_off_timeout", HwPCManagerService.this.mLockScreenTimeout, -2);
                    SettingsEx.Secure.putInt(resolver, "pad_screen_off_timeout", HwPCManagerService.this.mPadLockScreenTimeout);
                    int unused3 = HwPCManagerService.this.mPadDesktopModeLockScreenTimeout = SettingsEx.Secure.getIntForUser(resolver, "pad_desktop_mode_screen_off_timeout", 600000, -2);
    ...
    /* access modifiers changed from: private */
    public boolean isExclusiveKeyboardConnect(UEventObserverExt.UEvent event) {
        String kbState;
        if (event == null || (kbState = event.get("KB_STATE")) == null || !kbState.equals("CONNECTED")) {
            return false;
        }
        return true;
    }
            ...
            if (channel != null) {
                this.mWifiP2pManager.requestGroupInfo(channel, new WifiP2pManager.GroupInfoListener() {
                    ...
                    public void onGroupInfoAvailable(WifiP2pGroup info) {
                        if (info != null) {
                            int unused = HwPCManagerService.this.mFreq = WifiP2pGroupExt.getFrequency(info);
    ...
    public void showDPLinkErrorDialog(Context context, String tip) {
        ...
        }).setMessage(String.format(tip, BuildConfig.FLAVOR)).create();
    ...
    private static boolean isDapKey(int keyCode) {
        return keyCode == 20 || keyCode == 269 || keyCode == 271 || keyCode == MSG_DP_STATE_CHANGED || keyCode == 22 || keyCode == 19 || keyCode == 268 || keyCode == 270 || keyCode == 23;
    }
    ...
    /* access modifiers changed from: private */
    public void sendToMessengers(int what, int arg1, int arg2, Object obj) {
        synchronized (this.mMessengers) {
    ...
    /* access modifiers changed from: private */
    public void disconnectWifiProjection() {
        if (!isDesktopMode(this.mProjMode) || this.mDisplayManager == null) {
    ...
    /* access modifiers changed from: private */
    public boolean checkAppName(int taskId) {
