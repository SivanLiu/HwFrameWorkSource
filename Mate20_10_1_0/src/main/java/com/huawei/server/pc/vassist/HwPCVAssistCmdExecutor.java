...
public final class HwPCVAssistCmdExecutor {
    ...
    private void minTask(VoiceCmd cmd) {
        ...
        if (taskId < 0) {
            ...
            HwActivityTaskManager.moveTaskBackwards(taskId);
    ...
    private String getResponseMsg(int errCode) {
        switch (errCode) {
            case RESULT_SUCCESS_PAGE_UP_DOWN_FULLSCN /*{ENCODED_INT: -6}*/:
                return BuildConfig.FLAVOR;
            case RESULT_SUCCESS_START_PLAY /*{ENCODED_INT: -5}*/:
                return getRandomResponseStr(this.mStartPlayResultStrs);
            case RESULT_SUCCESS_BACK_SHOWHOME /*{ENCODED_INT: -4}*/:
            case RESULT_SUCCESS_MIN_MAX_APP /*{ENCODED_INT: -3}*/:
                return this.mContext.getString(HwPartResourceUtils.getResourceId("pc_vassist_ok_done"));
            case RESULT_SUCCESS_CLOSE_APP /*{ENCODED_INT: -2}*/:
