...
public class HwMultiDisplayAudioManager {
    ...
    public AudioManager mAudioService = ((AudioManager) this.mContext.getSystemService("audio"));
    ...
    class PcDeviceSelectCallback extends DeviceSelectCallback {
    ...
    /* access modifiers changed from: private */
    public boolean isPackageRunningOnPCMode(int pid, int uid) {
