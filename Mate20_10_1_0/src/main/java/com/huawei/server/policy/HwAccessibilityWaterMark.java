...
public class HwAccessibilityWaterMark {
    ...
    public static final boolean ISDEBUG = (Log.HWINFO || (Log.HWModuleLog && Log.isLoggable(TAG, 4)));
    ...
    /* access modifiers changed from: private */
    public A11WaterMarkHandler mA11WatermarkHandle;
    ...
    /* access modifiers changed from: private */
    public void updateOnDisplayChange() {
        if (ISDEBUG) {
    ...
    /* access modifiers changed from: private */
    public void updateAccessWaterMarkStat() {
    ...
    /* access modifiers changed from: private */
    public void updateA11WaterMarkTextForced() {
        setWaterMarkModeText();
        setWaterMarkTextView(this.mIsShortCutSwitchOn);
    }

    /* access modifiers changed from: private */
    public void updateAccessibilityWaterMarkText() {
    ...
    /* access modifiers changed from: private */
    public void updateAccessibilityWaterMarkView() {
    ...
    private void setWaterMarkModeText() {
        ...
        if (view != null) {
            TextView modeText = (TextView) view.findViewById(34603525);
    ...
    private void setWaterMarkTextView(boolean isShortCutSwitchOn) {
        ...
        View view = this.mWaterMarkView;
        if (view != null) {
            TextView watermarkText = (TextView) view.findViewById(34603431);
    ...
    /* access modifiers changed from: private */
    public void prepareWaterMarkView() {
