...
public class FingerprintViewUtils {
    ...
    public static int getFingerprintDefaultLogoRadius(Context context) {
        ...
        int logoRadius = new BigDecimal((int) ((((float) context.getResources().getDimensionPixelSize(34472497)) * getDpiScale()) + 0.5f)).divide(new BigDecimal((double) (2.0f * getPxScale())), 2, RoundingMode.HALF_UP).intValue();
    ...
    public static int[] calculateFingerprintLayoutLeftMargin(int width, float scale, int currentRotation, Context context, int fingerprintCenterX) {
        ...
        if (currentRotation == 3) {
            leftmargin = (int) ((((float) context.getResources().getDimensionPixelSize(34472686)) * dpiScale) + 0.5f);
            ...
            rightmargin = ((int) ((((float) context.getResources().getDimensionPixelSize(34472686)) * dpiScale) + 0.5f)) + new BigDecimal(notchHeight).multiply(scaleDegreeBig).intValue();
        } else {
    ...
    public static void setFingerprintOnlyLayoutParams(Context context, WindowManager.LayoutParams fingerprintOnlyLayoutParams, int windowType, int[] fingerprintMargin) {
        if (context == null || fingerprintOnlyLayoutParams == null) {
            ...
            fingerprintOnlyLayoutParams.width = (int) ((((float) context.getResources().getDimensionPixelSize(34472495)) * getDpiScale()) + 0.5f);
        }
    }
