...
public final class WaterEffectRender implements GLSurfaceView.Renderer {
    ...
    /* access modifiers changed from: private */
    public boolean isShouldDrawNext;
    /* access modifiers changed from: private */
    public float mAlpha;
        ...
        this.mAnimator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                synchronized (WaterEffectRender.this) {
                    boolean unused = WaterEffectRender.this.isPaused = true;
                    float unused2 = WaterEffectRender.this.mAlpha = 0.0f;
                    boolean unused3 = WaterEffectRender.this.isShouldDrawNext = true;
                }
            }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        GLES30.glClear(AwarenessConstants.PHONE_STATE_CHANGED_ACTION);
        if (!isDrawPaused) {
