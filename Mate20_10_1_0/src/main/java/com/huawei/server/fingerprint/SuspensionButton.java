...
public class SuspensionButton extends RelativeLayout {
    ...
    private void initStatusBarHeight() {
        ...
        int resourceId = getContext().getResources().getIdentifier("status_bar_height", "dimen", AppStartupDataMgr.HWPUSH_PKGNAME);
        if (resourceId > 0) {
            statusBarHeight = getContext().getResources().getDimensionPixelSize(resourceId);
        }
        this.mHeight = statusBarHeight + getContext().getResources().getDimensionPixelSize(34472772);
    }
