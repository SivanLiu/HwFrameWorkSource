...
public class HwSpringPixelAnimation extends HWSpringAnimation {
    ...
    @Override // com.huawei.anim.dynamicanimation.animation.OscarDynamicAnimation, com.huawei.anim.dynamicanimation.animation.HWSpringAnimation
    public boolean updateValueAndVelocity(long deltaT) {
        MassState massState = getSpringModel().updateValues(deltaT);
