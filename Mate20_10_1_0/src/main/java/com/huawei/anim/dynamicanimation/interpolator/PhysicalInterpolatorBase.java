...
public abstract class PhysicalInterpolatorBase<T extends PhysicalInterpolatorBase<T>> implements Interpolator {
    ...
    /* JADX WARN: Type inference failed for: r1v3, types: [com.huawei.anim.dynamicanimation.PhysicalModelBase] */
    /* JADX WARN: Type inference failed for: r2v5, types: [com.huawei.anim.dynamicanimation.PhysicalModelBase] */
    /* JADX WARN: Type inference failed for: r3v2, types: [com.huawei.anim.dynamicanimation.PhysicalModelBase] */
    public float getInterpolation(float input) {
        float t = (this.mTimeScale * input) / 1000.0f;
        float x = ((T) getModel()).getX(t);
        if (this.mDataUpdateListener != null) {
            this.mDataUpdateListener.onDataUpdate(t, x, ((T) getModel()).getDX(t), ((T) getModel()).getDDX(t));
        }
        return x / getDeltaX();
    }
    ...
    /* JADX WARN: Type inference failed for: r0v4, types: [com.huawei.anim.dynamicanimation.PhysicalModelBase] */
    /* JADX WARN: Type inference failed for: r1v2, types: [com.huawei.anim.dynamicanimation.PhysicalModelBase] */
    /* access modifiers changed from: protected */
    public float getDeltaX() {
        return Math.abs(((T) getModel()).getEndPosition() - ((T) getModel()).getStartPosition());
    }
    ...
    /* JADX WARN: Type inference failed for: r6v3, types: [com.huawei.anim.dynamicanimation.PhysicalModelBase] */
    /* JADX WARN: Type inference failed for: r2v8, types: [com.huawei.anim.dynamicanimation.PhysicalModelBase] */
    /* JADX WARN: Type inference failed for: r3v2, types: [com.huawei.anim.dynamicanimation.PhysicalModelBase] */
    /* JADX WARN: Type inference failed for: r4v5, types: [com.huawei.anim.dynamicanimation.PhysicalModelBase] */
    public float getInterpolation2(float t) {
        ...
        float x = ((T) getModel()).getX(t2);
        this.mDataUpdateListener.onDataUpdate(t2, x, ((T) getModel()).getDX(t2), ((T) getModel()).getDDX(t2));
        return x / Math.abs(((T) getModel()).getEndPosition());
    }

    /* JADX WARN: Type inference failed for: r0v0, types: [com.huawei.anim.dynamicanimation.PhysicalModelBase] */
    /* JADX WARN: Type inference failed for: r0v2, types: [com.huawei.anim.dynamicanimation.PhysicalModelBase] */
    public float getDuration() {
        return ((T) getModel()).getEstimatedDuration();
    }

    /* JADX WARN: Type inference failed for: r0v0, types: [com.huawei.anim.dynamicanimation.PhysicalModelBase] */
    /* JADX WARN: Type inference failed for: r0v2, types: [com.huawei.anim.dynamicanimation.PhysicalModelBase] */
    public float getEndOffset() {
        return ((T) getModel()).getEndPosition();
    }
