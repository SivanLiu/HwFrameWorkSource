            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 53:
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_clearDailyWarnPreference /*{ENCODED_INT: 54}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 55:
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_clearMonthWarnPreference /*{ENCODED_INT: 56}*/:
                        data.enforceInterface(DESCRIPTOR);
                        clearMonthWarnPreference(data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_putSimProfileDes /*{ENCODED_INT: 57}*/:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getSimProfileDes /*{ENCODED_INT: 58}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        return true;
                    case TRANSACTION_getNetworkUsageDays /*{ENCODED_INT: 59}*/:
                        data.enforceInterface(DESCRIPTOR);
        ...
        private static class Proxy implements INetAssistantService {
            ...
            public void clearDailyWarnPreference(String imsi) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(imsi);
                    if (this.mRemote.transact(Stub.TRANSACTION_clearDailyWarnPreference, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public void clearMonthWarnPreference(String imsi) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(imsi);
                    if (this.mRemote.transact(Stub.TRANSACTION_clearMonthWarnPreference, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public void putSimProfileDes(SimProfileDes info) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(Stub.TRANSACTION_putSimProfileDes, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public Bundle getSimProfileDes() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (!this.mRemote.transact(Stub.TRANSACTION_getSimProfileDes, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
