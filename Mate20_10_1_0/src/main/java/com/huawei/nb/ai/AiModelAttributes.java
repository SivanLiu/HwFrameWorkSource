...
public final class AiModelAttributes {
    ...
    public static Map<String, Supplier<Object>> getAttributes(AiModel model) {
        Map<String, Supplier<Object>> attributes = new HashMap<>(32);
        model.getClass();
    ...
    public static Map<String, Supplier<Object>> getPrimaryKeyAttributes(AiModel model) {
        Map<String, Supplier<Object>> keyAttrs = new HashMap<>(1);
        model.getClass();
    ...
    public static Map<String, Supplier<Object>> getJsonAttributes(AiModel model) {
        Map<String, Supplier<Object>> jsonAttrs = new HashMap<>(32);
        model.getClass();
    ...
    public static Map<String, Consumer<String>> setAttributes(AiModel model) {
        Map<String, Consumer<String>> attributes = new HashMap<>(32);
        model.getClass();
    ...
    private static void setExtendedAttributes(AiModel newModel, AiModel model) {
    ...
    public static AiModel copyAiModel(AiModel model) {
        ...
        setExtendedAttributes(newModel, model);
        return newModel;
    }
}
