...
public interface ISubscribeCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISubscribeCallback {
        private static final String DESCRIPTOR = "com.huawei.nb.callback.ISubscribeCallback";
        ...
        public static ISubscribeCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof ISubscribeCallback)) {
                return new Proxy(obj);
            }
            return (ISubscribeCallback) iin;
        }
        ...
        private static class Proxy implements ISubscribeCallback {
