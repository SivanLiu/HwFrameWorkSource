...
public interface IUpdateCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IUpdateCallback {
        private static final String DESCRIPTOR = "com.huawei.nb.callback.IUpdateCallback";
        ...
        public static IUpdateCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof IUpdateCallback)) {
                return new Proxy(obj);
            }
            return (IUpdateCallback) iin;
        }
