...
public class CoordinatorSwitchChangeAudit extends Audit {
    ...
    public IMonitorEx.EventStreamEx createEventStream() {
        IMonitorEx.EventStreamEx eventStreamEx = IMonitorEx.openEventStream((int) EVENT_ID_SWITCHCHANGE_EVENT);
        if (eventStreamEx != null) {
            eventStreamEx.setParam(eventStreamEx, (short) SWITCHCHANGE_EVENT_STATE_VARCHAR, this.stateInfo);
            eventStreamEx.setParam(eventStreamEx, (short) SWITCHCHANGE_EVENT_URL_VARCHAR, this.urlInfo);
            eventStreamEx.setParam(eventStreamEx, (short) SWITCHCHANGE_EVENT_VERSION_VARCHAR, this.versionInfo);
            eventStreamEx.setParam(eventStreamEx, (short) SWITCHCHANGE_EVENT_TRIGGER_VARCHAR, this.triggerInfo);
        }
