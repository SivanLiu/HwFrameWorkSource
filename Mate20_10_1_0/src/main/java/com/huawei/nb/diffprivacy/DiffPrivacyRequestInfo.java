...
public class DiffPrivacyRequestInfo implements Parcelable {
    public static final Creator<DiffPrivacyRequestInfo> CREATOR = new Creator<DiffPrivacyRequestInfo>() {
        /* class com.huawei.nb.diffprivacy.DiffPrivacyRequestInfo.AnonymousClass1 */
