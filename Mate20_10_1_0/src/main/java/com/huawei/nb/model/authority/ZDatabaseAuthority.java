...
public class ZDatabaseAuthority extends AManagedObject {
    ...
    private ZDatabaseAuthority(Long id2, Long dbId2, String dbName2, Long packageUid2, String packageName2, Integer authority2, Boolean supportGroupAuthority2, String reserved2) {
        this.id = id2;
        this.dbId = dbId2;
        this.dbName = dbName2;
