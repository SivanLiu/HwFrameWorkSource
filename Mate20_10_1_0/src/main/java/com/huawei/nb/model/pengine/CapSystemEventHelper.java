...
public class CapSystemEventHelper extends AEntityHelper<CapSystemEvent> {
    ...
    public void bindValue(Statement statement, CapSystemEvent object) {
    ...
    public CapSystemEvent readObject(Cursor cursor, int offset) {
        return new CapSystemEvent(cursor);
    }

    public void setPrimaryKeyValue(CapSystemEvent object, long value) {
        object.setId(Integer.valueOf((int) value));
    }

    public Object getRelationshipObject(String field, CapSystemEvent object) {
        return null;
    }
