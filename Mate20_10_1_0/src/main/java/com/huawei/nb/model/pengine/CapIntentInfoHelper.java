...
public class CapIntentInfoHelper extends AEntityHelper<CapIntentInfo> {
    private static final CapIntentInfoHelper INSTANCE = new CapIntentInfoHelper();

    private CapIntentInfoHelper() {
    }

    public static CapIntentInfoHelper getInstance() {
        return INSTANCE;
    }

    public void bindValue(Statement statement, CapIntentInfo object) {
    ...
    public CapIntentInfo readObject(Cursor cursor, int offset) {
        return new CapIntentInfo(cursor);
    }

    public void setPrimaryKeyValue(CapIntentInfo object, long value) {
        object.setId(Integer.valueOf((int) value));
    }

    public Object getRelationshipObject(String field, CapIntentInfo object) {
        return null;
    }
