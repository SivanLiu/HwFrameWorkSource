...
public class CapLocationHelper extends AEntityHelper<CapLocation> {
    ...
    public void bindValue(Statement statement, CapLocation object) {
    ...
    public CapLocation readObject(Cursor cursor, int offset) {
        return new CapLocation(cursor);
    }

    public void setPrimaryKeyValue(CapLocation object, long value) {
        object.setId(Integer.valueOf((int) value));
    }

    public Object getRelationshipObject(String field, CapLocation object) {
        return null;
    }
