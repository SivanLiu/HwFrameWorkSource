...
public class CapSemanticAnalysisHelper extends AEntityHelper<CapSemanticAnalysis> {
    ...
    public void bindValue(Statement statement, CapSemanticAnalysis object) {
    ...
    public CapSemanticAnalysis readObject(Cursor cursor, int offset) {
        return new CapSemanticAnalysis(cursor);
    }

    public void setPrimaryKeyValue(CapSemanticAnalysis object, long value) {
        object.setId(Integer.valueOf((int) value));
    }

    public Object getRelationshipObject(String field, CapSemanticAnalysis object) {
        return null;
    }
