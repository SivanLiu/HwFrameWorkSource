...
public class WifiAggClusterCache extends AManagedObject {
    public static final Parcelable.Creator<WifiAggClusterCache> CREATOR = new Parcelable.Creator<WifiAggClusterCache>() {
        /* class com.huawei.nb.model.pengine.WifiAggClusterCache.AnonymousClass1 */
