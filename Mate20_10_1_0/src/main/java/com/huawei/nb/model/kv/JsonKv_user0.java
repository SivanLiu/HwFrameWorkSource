...
public class JsonKv_user0 extends AManagedObject {
    public static final Parcelable.Creator<JsonKv_user0> CREATOR = new Parcelable.Creator<JsonKv_user0>() {
        /* class com.huawei.nb.model.kv.JsonKv_user0.AnonymousClass1 */

        @Override // android.os.Parcelable.Creator
        public JsonKv_user0 createFromParcel(Parcel in) {
            return new JsonKv_user0(in);
        }

        @Override // android.os.Parcelable.Creator
        public JsonKv_user0[] newArray(int size) {
            return new JsonKv_user0[size];
        }
    };
    ...
    public JsonKv_user0(Cursor cursor) {
    ...
    private JsonKv_user0(Long id2, String primaryKey2, String value2, String version2, String owner2, String tag2, int clone2, String reserved12, String reserved22, String reserved32, int clearStatus2) {
        this.id = id2;
    ...
    @Override // com.huawei.odmf.core.AManagedObject
    public AEntityHelper<JsonKv_user0> getHelper() {
        return JsonKv_user0Helper.getInstance();
    }

    @Override // com.huawei.odmf.core.AManagedObject, com.huawei.odmf.core.ManagedObject
    public String getEntityName() {
        return "com.huawei.nb.model.kv.JsonKv_user0";
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("JsonKv_user0 { id: ").append(this.id);
