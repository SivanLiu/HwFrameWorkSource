...
public class PhoneStateLogsCacheHelper extends AEntityHelper<PhoneStateLogsCache> {
    private static final PhoneStateLogsCacheHelper INSTANCE = new PhoneStateLogsCacheHelper();

    private PhoneStateLogsCacheHelper() {
    }

    public static PhoneStateLogsCacheHelper getInstance() {
        return INSTANCE;
    }

    public void bindValue(Statement statement, PhoneStateLogsCache object) {
    ...
    public PhoneStateLogsCache readObject(Cursor cursor, int offset) {
        return new PhoneStateLogsCache(cursor);
    }

    public void setPrimaryKeyValue(PhoneStateLogsCache object, long value) {
        object.setId(Integer.valueOf((int) value));
    }

    public Object getRelationshipObject(String field, PhoneStateLogsCache object) {
        return null;
    }
