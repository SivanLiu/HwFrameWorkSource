...
public class CapAppUsageStatsHelper extends AEntityHelper<CapAppUsageStats> {
    ...
    public void bindValue(Statement statement, CapAppUsageStats object) {
    ...
    public CapAppUsageStats readObject(Cursor cursor, int offset) {
        return new CapAppUsageStats(cursor);
    }

    public void setPrimaryKeyValue(CapAppUsageStats object, long value) {
        object.setId(Integer.valueOf((int) value));
    }

    public Object getRelationshipObject(String field, CapAppUsageStats object) {
        return null;
    }
