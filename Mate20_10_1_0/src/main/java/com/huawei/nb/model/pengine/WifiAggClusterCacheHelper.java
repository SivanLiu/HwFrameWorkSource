...
public class WifiAggClusterCacheHelper extends AEntityHelper<WifiAggClusterCache> {
    private static final WifiAggClusterCacheHelper INSTANCE = new WifiAggClusterCacheHelper();

    private WifiAggClusterCacheHelper() {
    }

    public static WifiAggClusterCacheHelper getInstance() {
        return INSTANCE;
    }

    public void bindValue(Statement statement, WifiAggClusterCache object) {
    ...
    public WifiAggClusterCache readObject(Cursor cursor, int offset) {
        return new WifiAggClusterCache(cursor);
    }

    public void setPrimaryKeyValue(WifiAggClusterCache object, long value) {
        object.setId(Integer.valueOf((int) value));
    }

    public Object getRelationshipObject(String field, WifiAggClusterCache object) {
        return null;
    }
