...
public class CapSystemAppDataHelper extends AEntityHelper<CapSystemAppData> {
    ...
    public void bindValue(Statement statement, CapSystemAppData object) {
    ...
    public CapSystemAppData readObject(Cursor cursor, int offset) {
        return new CapSystemAppData(cursor);
    }

    public void setPrimaryKeyValue(CapSystemAppData object, long value) {
        object.setId(Integer.valueOf((int) value));
    }

    public Object getRelationshipObject(String field, CapSystemAppData object) {
        return null;
    }
