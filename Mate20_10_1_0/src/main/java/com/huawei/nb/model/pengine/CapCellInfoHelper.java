...
public class CapCellInfoHelper extends AEntityHelper<CapCellInfo> {
    ...
    public void bindValue(Statement statement, CapCellInfo object) {
    ...
    public CapCellInfo readObject(Cursor cursor, int offset) {
        return new CapCellInfo(cursor);
    }

    public void setPrimaryKeyValue(CapCellInfo object, long value) {
        object.setId(Integer.valueOf((int) value));
    }

    public Object getRelationshipObject(String field, CapCellInfo object) {
        return null;
    }
