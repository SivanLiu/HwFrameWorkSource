...
public class CapSemanticAnalysis extends AManagedObject {
    public static final Parcelable.Creator<CapSemanticAnalysis> CREATOR = new Parcelable.Creator<CapSemanticAnalysis>() {
        /* class com.huawei.nb.model.pengine.CapSemanticAnalysis.AnonymousClass1 */
