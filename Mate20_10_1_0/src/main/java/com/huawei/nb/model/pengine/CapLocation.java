...
public class CapLocation extends AManagedObject {
    public static final Parcelable.Creator<CapLocation> CREATOR = new Parcelable.Creator<CapLocation>() {
        /* class com.huawei.nb.model.pengine.CapLocation.AnonymousClass1 */
