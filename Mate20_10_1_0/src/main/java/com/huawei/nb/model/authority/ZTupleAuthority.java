...
public class ZTupleAuthority extends AManagedObject {
    public static final Parcelable.Creator<ZTupleAuthority> CREATOR = new Parcelable.Creator<ZTupleAuthority>() {
        /* class com.huawei.nb.model.authority.ZTupleAuthority.AnonymousClass1 */
    ...
    private ZTupleAuthority(Long id2, Long tableId2, String tableName2, Long tupleId2, String tupleName2, Long packageUid2, String packageName2, Integer authority2, Boolean supportGroupAuthority2, String reserved2) {
        this.id = id2;
