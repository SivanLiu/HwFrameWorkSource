...
public class RawDeviceInfoHelper extends AEntityHelper<RawDeviceInfo> {
    ...
    public void bindValue(Statement statement, RawDeviceInfo object) {
        ...
        String mPhoneNum = object.getMPhoneNum();
        if (mPhoneNum != null) {
    ...
    public RawDeviceInfo readObject(Cursor cursor, int offset) {
        return new RawDeviceInfo(cursor);
    }

    public void setPrimaryKeyValue(RawDeviceInfo object, long value) {
        object.setMId(Integer.valueOf((int) value));
    }

    public Object getRelationshipObject(String field, RawDeviceInfo object) {
        return null;
    }
