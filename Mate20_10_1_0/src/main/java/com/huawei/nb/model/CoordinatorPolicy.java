...
public class CoordinatorPolicy extends AManagedObject {
    ...
    public CoordinatorPolicy(Parcel in) {
        ...
        this.tilingTime = in.readByte() == 0 ? null : Integer.valueOf(in.readInt());
        this.dataTrafficSyncTime = in.readByte() == 0 ? null : Long.valueOf(in.readLong());
        this.syncPeriod = in.readByte() != 0 ? Integer.valueOf(in.readInt()) : num;
    }

    private CoordinatorPolicy(Integer policyNo2, String tableName2, String dbName2, Long syncMode2, Long syncTime2, Long syncPoint2, String remoteUrl2, Long dataType2, Long isAllowOverWrite2, Long networkMode2, String syncField2, String startTime2, Integer electricity2, Integer tilingTime2, Long dataTrafficSyncTime2, Integer syncPeriod2) {
        this.policyNo = policyNo2;
        ...
        this.dataTrafficSyncTime = dataTrafficSyncTime2;
        this.syncPeriod = syncPeriod2;
    }
    ...
    public void setPolicyNo(Integer policyNo2) {
        this.policyNo = policyNo2;
        setValue();
    }
    ...
    public void setDataTrafficSyncTime(Long dataTrafficSyncTime2) {
        this.dataTrafficSyncTime = dataTrafficSyncTime2;
        setValue();
    }
    ...
    public void setSyncPeriod(Integer syncPeriod2) {
        this.syncPeriod = syncPeriod2;
        setValue();
    }
