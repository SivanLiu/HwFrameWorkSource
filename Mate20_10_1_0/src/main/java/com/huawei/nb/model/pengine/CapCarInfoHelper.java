...
public class CapCarInfoHelper extends AEntityHelper<CapCarInfo> {
    private static final CapCarInfoHelper INSTANCE = new CapCarInfoHelper();

    private CapCarInfoHelper() {
    }

    public static CapCarInfoHelper getInstance() {
        return INSTANCE;
    }

    public void bindValue(Statement statement, CapCarInfo object) {
    ...
    public CapCarInfo readObject(Cursor cursor, int offset) {
        return new CapCarInfo(cursor);
    }

    public void setPrimaryKeyValue(CapCarInfo object, long value) {
        object.setId(Integer.valueOf((int) value));
    }

    public Object getRelationshipObject(String field, CapCarInfo object) {
        return null;
    }
