...
public class CapSystemAppData extends AManagedObject {
    public static final Parcelable.Creator<CapSystemAppData> CREATOR = new Parcelable.Creator<CapSystemAppData>() {
        /* class com.huawei.nb.model.pengine.CapSystemAppData.AnonymousClass1 */
