...
public class ZGroupGrant extends AManagedObject {
    public static final Parcelable.Creator<ZGroupGrant> CREATOR = new Parcelable.Creator<ZGroupGrant>() {
        ...
        public ZGroupGrant createFromParcel(Parcel in) {
            return new ZGroupGrant(in);
        }

        @Override // android.os.Parcelable.Creator
        public ZGroupGrant[] newArray(int size) {
            return new ZGroupGrant[size];
        }
    };
    ...
    private ZGroupGrant(Long id2, String groupName2, String tableName2, String owner2, boolean isGroupIdentifier2, String member2, Integer authority2, String reserved2) {
        this.id = id2;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ZGroupGrant { id: ").append(this.id);
