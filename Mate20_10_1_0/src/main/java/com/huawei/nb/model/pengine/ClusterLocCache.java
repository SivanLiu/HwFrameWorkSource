...
public class ClusterLocCache extends AManagedObject {
    public static final Parcelable.Creator<ClusterLocCache> CREATOR = new Parcelable.Creator<ClusterLocCache>() {
        /* class com.huawei.nb.model.pengine.ClusterLocCache.AnonymousClass1 */
