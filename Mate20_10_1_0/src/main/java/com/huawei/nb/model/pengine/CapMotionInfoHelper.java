...
public class CapMotionInfoHelper extends AEntityHelper<CapMotionInfo> {
    ...
    public void bindValue(Statement statement, CapMotionInfo object) {
    ...
    public CapMotionInfo readObject(Cursor cursor, int offset) {
        return new CapMotionInfo(cursor);
    }

    public void setPrimaryKeyValue(CapMotionInfo object, long value) {
        object.setId(Integer.valueOf((int) value));
    }

    public Object getRelationshipObject(String field, CapMotionInfo object) {
        return null;
    }
