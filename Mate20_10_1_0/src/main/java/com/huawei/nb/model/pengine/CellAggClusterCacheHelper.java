...
public class CellAggClusterCacheHelper extends AEntityHelper<CellAggClusterCache> {
    ...
    public void bindValue(Statement statement, CellAggClusterCache object) {
    ...
    public CellAggClusterCache readObject(Cursor cursor, int offset) {
        return new CellAggClusterCache(cursor);
    }

    public void setPrimaryKeyValue(CellAggClusterCache object, long value) {
        object.setId(Integer.valueOf((int) value));
    }

    public Object getRelationshipObject(String field, CellAggClusterCache object) {
        return null;
    }
