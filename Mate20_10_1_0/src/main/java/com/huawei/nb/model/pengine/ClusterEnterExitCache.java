...
public class ClusterEnterExitCache extends AManagedObject {
    public static final Parcelable.Creator<ClusterEnterExitCache> CREATOR = new Parcelable.Creator<ClusterEnterExitCache>() {
        /* class com.huawei.nb.model.pengine.ClusterEnterExitCache.AnonymousClass1 */
