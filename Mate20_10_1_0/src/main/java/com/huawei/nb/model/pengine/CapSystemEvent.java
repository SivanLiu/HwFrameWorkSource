...
public class CapSystemEvent extends AManagedObject {
    public static final Parcelable.Creator<CapSystemEvent> CREATOR = new Parcelable.Creator<CapSystemEvent>() {
        /* class com.huawei.nb.model.pengine.CapSystemEvent.AnonymousClass1 */
