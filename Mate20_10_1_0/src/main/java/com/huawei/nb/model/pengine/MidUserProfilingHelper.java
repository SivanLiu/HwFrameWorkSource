...
public class MidUserProfilingHelper extends AEntityHelper<MidUserProfiling> {
    ...
    public void bindValue(Statement statement, MidUserProfiling object) {
    ...
    public MidUserProfiling readObject(Cursor cursor, int offset) {
        return new MidUserProfiling(cursor);
    }

    public void setPrimaryKeyValue(MidUserProfiling object, long value) {
        object.setId(Integer.valueOf((int) value));
    }

    public Object getRelationshipObject(String field, MidUserProfiling object) {
        return null;
    }
