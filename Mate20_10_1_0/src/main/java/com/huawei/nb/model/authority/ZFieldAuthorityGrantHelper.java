...
public class ZFieldAuthorityGrantHelper extends AEntityHelper<ZFieldAuthorityGrant> {
    ...
    public void bindValue(Statement statement, ZFieldAuthorityGrant object) {
    ...
    public ZFieldAuthorityGrant readObject(Cursor cursor, int offset) {
        return new ZFieldAuthorityGrant(cursor);
    }

    public void setPrimaryKeyValue(ZFieldAuthorityGrant object, long value) {
        object.setId(Long.valueOf(value));
    }

    public Object getRelationshipObject(String field, ZFieldAuthorityGrant object) {
        return null;
    }
