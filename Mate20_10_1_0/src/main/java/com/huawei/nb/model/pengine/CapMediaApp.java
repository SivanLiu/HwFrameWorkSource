...
public class CapMediaApp extends AManagedObject {
    public static final Parcelable.Creator<CapMediaApp> CREATOR = new Parcelable.Creator<CapMediaApp>() {
        /* class com.huawei.nb.model.pengine.CapMediaApp.AnonymousClass1 */
