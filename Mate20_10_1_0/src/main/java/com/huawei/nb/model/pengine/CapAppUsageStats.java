...
public class CapAppUsageStats extends AManagedObject {
    public static final Parcelable.Creator<CapAppUsageStats> CREATOR = new Parcelable.Creator<CapAppUsageStats>() {
        /* class com.huawei.nb.model.pengine.CapAppUsageStats.AnonymousClass1 */
