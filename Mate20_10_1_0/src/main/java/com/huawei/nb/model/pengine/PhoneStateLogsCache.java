...
public class PhoneStateLogsCache extends AManagedObject {
    public static final Parcelable.Creator<PhoneStateLogsCache> CREATOR = new Parcelable.Creator<PhoneStateLogsCache>() {
        /* class com.huawei.nb.model.pengine.PhoneStateLogsCache.AnonymousClass1 */
