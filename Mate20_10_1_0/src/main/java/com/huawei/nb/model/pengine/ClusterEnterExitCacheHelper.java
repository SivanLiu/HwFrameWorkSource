...
public class ClusterEnterExitCacheHelper extends AEntityHelper<ClusterEnterExitCache> {
    private static final ClusterEnterExitCacheHelper INSTANCE = new ClusterEnterExitCacheHelper();

    private ClusterEnterExitCacheHelper() {
    }

    public static ClusterEnterExitCacheHelper getInstance() {
        return INSTANCE;
    }

    public void bindValue(Statement statement, ClusterEnterExitCache object) {
    ...
    public ClusterEnterExitCache readObject(Cursor cursor, int offset) {
        return new ClusterEnterExitCache(cursor);
    }

    public void setPrimaryKeyValue(ClusterEnterExitCache object, long value) {
        object.setId(Integer.valueOf((int) value));
    }

    public Object getRelationshipObject(String field, ClusterEnterExitCache object) {
        return null;
    }
