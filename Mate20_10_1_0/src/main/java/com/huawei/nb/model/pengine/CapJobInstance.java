...
public class CapJobInstance extends AManagedObject {
    ...
    private CapJobInstance(Integer id2, String type2, String status2, String tasks2, String result2, String resultDesc2, Long analyzeTime2, Long createTime2, Long lastModifyTime2) {
        this.id = id2;
        this.type = type2;
        this.status = status2;
        this.tasks = tasks2;
