...
public class CapCarInfo extends AManagedObject {
    public static final Parcelable.Creator<CapCarInfo> CREATOR = new Parcelable.Creator<CapCarInfo>() {
        /* class com.huawei.nb.model.pengine.CapCarInfo.AnonymousClass1 */
