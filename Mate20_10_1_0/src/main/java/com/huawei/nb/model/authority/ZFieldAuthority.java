...
public class ZFieldAuthority extends AManagedObject {
    ...
    private ZFieldAuthority(Long id2, Long tableId2, String tableName2, Long filedId2, String fieldName2, Long packageUid2, String packageName2, Integer authority2, String sysAuthorityName2, Boolean supportGroupAuthority2, String reserved2) {
        this.id = id2;
