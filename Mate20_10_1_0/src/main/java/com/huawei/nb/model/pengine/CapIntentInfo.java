...
public class CapIntentInfo extends AManagedObject {
    public static final Parcelable.Creator<CapIntentInfo> CREATOR = new Parcelable.Creator<CapIntentInfo>() {
        /* class com.huawei.nb.model.pengine.CapIntentInfo.AnonymousClass1 */

        @Override // android.os.Parcelable.Creator
        public CapIntentInfo createFromParcel(Parcel in) {
            return new CapIntentInfo(in);
        }

        @Override // android.os.Parcelable.Creator
        public CapIntentInfo[] newArray(int size) {
            return new CapIntentInfo[size];
        }
    };
    ...
    public CapIntentInfo(Cursor cursor) {
        Long l = null;
    ...
    public CapIntentInfo(Parcel in) {
        super(in);
        String str = null;
        if (in.readByte() == 0) {
            this.id = null;
        ...
        this.column16 = in.readByte() != 0 ? in.readString() : str;
    }

    private CapIntentInfo(Integer id2, Integer dataType2, Long timestamp2, String column02, String column17, String column22, String column32, String column42, String column52, String column62, String column72, String column82, String column92, String column102, String column112, String column122, String column132, String column142, String column152, String column162) {
        this.id = id2;
        this.dataType = dataType2;
        this.timestamp = timestamp2;
        this.column0 = column02;
        this.column1 = column17;
    ...
    public void setColumn1(String column17) {
        this.column1 = column17;
        setValue();
    }
    ...
    @Override // com.huawei.odmf.core.AManagedObject
    public AEntityHelper<CapIntentInfo> getHelper() {
        return CapIntentInfoHelper.getInstance();
    }

    @Override // com.huawei.odmf.core.AManagedObject, com.huawei.odmf.core.ManagedObject
    public String getEntityName() {
        return "com.huawei.nb.model.pengine.CapIntentInfo";
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("CapIntentInfo { id: ").append(this.id);
