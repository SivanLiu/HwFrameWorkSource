...
public class CapMediaAppHelper extends AEntityHelper<CapMediaApp> {
    private static final CapMediaAppHelper INSTANCE = new CapMediaAppHelper();

    private CapMediaAppHelper() {
    }

    public static CapMediaAppHelper getInstance() {
        return INSTANCE;
    }

    public void bindValue(Statement statement, CapMediaApp object) {
    ...
    public CapMediaApp readObject(Cursor cursor, int offset) {
        return new CapMediaApp(cursor);
    }

    public void setPrimaryKeyValue(CapMediaApp object, long value) {
        object.setId(Integer.valueOf((int) value));
    }

    public Object getRelationshipObject(String field, CapMediaApp object) {
        return null;
    }
