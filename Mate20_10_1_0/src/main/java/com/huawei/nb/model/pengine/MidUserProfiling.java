...
public class MidUserProfiling extends AManagedObject {
    public static final Parcelable.Creator<MidUserProfiling> CREATOR = new Parcelable.Creator<MidUserProfiling>() {
        /* class com.huawei.nb.model.pengine.MidUserProfiling.AnonymousClass1 */
