...
public class HwPostCamera {
    ...
    public final Object mAvSnapNumberCallbackLock = new Object();
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public final Object mHwPostProcCallbackLock = new Object();
    ...
    public final void setLcdWorkMode(int lcdWorkMode, int lcdWorkAction) {
        ...
        sendCommand(30, lcdWorkMode, lcdWorkAction);
    }
}
