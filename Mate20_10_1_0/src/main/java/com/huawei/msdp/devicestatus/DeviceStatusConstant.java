...
public class DeviceStatusConstant {
    ...
    public static final int[] MAP_MOTION_VALUE = {100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, TYPE_HW_STEP_COUNTER, TYPE_WAVE_LIGHT, TYPE_HEAD_DOWN, TYPE_TRIPLE_FINGER};
    ...
    public static int motionName2Value(String name) {
        int j = 0;
        while (true) {
            String[] strArr = MAP_MOTION_NAME;
            if (j >= strArr.length) {
                return -1;
            }
            if (strArr[j].equals(name)) {
