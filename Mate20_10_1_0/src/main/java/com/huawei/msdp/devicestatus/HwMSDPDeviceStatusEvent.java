...
public class HwMSDPDeviceStatusEvent implements Parcelable {
    ...
    public HuaweiMotionEvent getMotionExtras() {
        ...
        if (bundle == null || (parcelable = this.mwMSDPDeviceStatusEventExtras.getParcelable(bundle.getString(HwSecDiagnoseConstant.ANTIMAL_APK_TYPE))) == null || !(parcelable instanceof HuaweiMotionEvent)) {
            return null;
        }
