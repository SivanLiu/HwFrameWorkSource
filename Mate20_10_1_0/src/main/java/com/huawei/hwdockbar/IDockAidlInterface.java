...
public interface IDockAidlInterface extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IDockAidlInterface {
        ...
        public Stub() {
            attachInterface(this, "com.huawei.hwdockbar.IDockAidlInterface");
        }
        ...
        public static IDockAidlInterface asInterface(IBinder obj) {
            ...
            IInterface iin = obj.queryLocalInterface("com.huawei.hwdockbar.IDockAidlInterface");
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code == 1) {
                data.enforceInterface("com.huawei.hwdockbar.IDockAidlInterface");
                ...
                reply.writeString("com.huawei.hwdockbar.IDockAidlInterface");
                return true;
            }
        }

        private static class Proxy implements IDockAidlInterface {
            ...
            public String getInterfaceDescriptor() {
                return "com.huawei.hwdockbar.IDockAidlInterface";
            }
            ...
            public void connect(int navId) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken("com.huawei.hwdockbar.IDockAidlInterface");
