            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        HwLog.e(SocketListenerTransport.TAG, "serverSocket close fail: " + e);
                    }
                ...
                try {
                    HwLog.e(SocketListenerTransport.TAG, "createTCPNearbySocket Exception " + e);
                    if (serverSocket != null) {
                        try {
                            serverSocket.close();
                        } catch (IOException e4) {
                            HwLog.e(SocketListenerTransport.TAG, "serverSocket close fail: " + e4);
                        }
                    }
                    result = null;
                    internalNearbySocket = this.mInnerRequest.getInnerNearbySocket();
