...
public class NearbyConfig {
    public static final int ADV_NO_TIMEOUT = -1;
    public static final int AUTH_DOUBLE_CHANNEL = 2;
    public static final int AUTH_SINGLE_CHANNEL = 1;
    public static final int BROADCAST_TYPE_BLE = 1;
    public static final int BUSINESSID_COORDINATE = 17;
    public static final int BUSINESSID_DMSDP = 20;
    public static final int BUSINESSID_DMSDP_DISCOVER = 9;
    public static final int BUSINESSID_HICAR = 19;
    public static final int BUSINESSID_HWDDMP = 8;
    ...
    public static final int TYPECHANNEL_USB = 6;
