        ...
        synchronized (mCloneLock) {
            ...
            if (callback != null) {
                NearbyAdapter.createInstance(context, new NearbyAdapterCallback() {
                    ...
                    @Override // com.huawei.nearbysdk.NearbyAdapter.NAdapterGetCallback, com.huawei.nearbysdk.NearbyAdapterCallback
        ...
        synchronized (mCloneLock) {
            ...
            if (wifiSsid == null || wifiPwd == null || listener == null) {
                ...
                if (this.mNearbyAdapter != null) {
                    ...
                    if (nearbyService != null && (looper = this.mNearbyAdapter.getLooper()) != null) {
