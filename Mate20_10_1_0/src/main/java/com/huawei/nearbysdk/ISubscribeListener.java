...
public interface ISubscribeListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISubscribeListener {
        private static final String DESCRIPTOR = "com.huawei.nearbysdk.ISubscribeListener";
        ...
        public static ISubscribeListener asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof ISubscribeListener)) {
                return new Proxy(obj);
            }
            return (ISubscribeListener) iin;
        }
        ...
        private static class Proxy implements ISubscribeListener {
