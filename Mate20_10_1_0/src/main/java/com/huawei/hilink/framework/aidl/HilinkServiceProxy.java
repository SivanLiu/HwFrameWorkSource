...
public class HilinkServiceProxy implements Closeable {
    ...
    /* access modifiers changed from: private */
    public void signalServiceConnected() {
    ...
    private class HilinkServiceConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            IHilinkService unused = HilinkServiceProxy.this.hilinkServiceBinder = IHilinkService.Stub.asInterface(service);
            ...
            boolean unused2 = HilinkServiceProxy.this.isServiceConnected = true;
        ...
        public void close() {
            ...
            IHilinkService unused = HilinkServiceProxy.this.hilinkServiceBinder = null;
            HilinkServiceProxyState hilinkServiceProxyState = this.proxyState;
            if (hilinkServiceProxyState != null) {
