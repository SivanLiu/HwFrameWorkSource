...
public class ConnectRequest implements Parcelable {
    public static final Creator<ConnectRequest> CREATOR = new Creator<ConnectRequest>() {
    ...
    public boolean isLegal() {
        ...
        int i;
        String str2;
        if (this.requestID == 0 || (str = this.remoteIP) == null || str.length() == 0 || this.remoteIP.length() > 40 || (i = this.remotePort) < 0 || i > PORT_MAX) {
            return false;
        }
