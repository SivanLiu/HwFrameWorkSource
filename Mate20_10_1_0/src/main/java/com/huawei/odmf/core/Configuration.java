...
public class Configuration {
    ...
    private boolean checkConfig(int type2, int databaseType2, int storageMode2) {
        if (type2 != 200 && type2 != 201) {
            return false;
        }
        if (databaseType2 != 302 && databaseType2 != 301) {
            return false;
        }
        if (storageMode2 == 401 || storageMode2 == 402) {
            return true;
        }
        return false;
    }
    ...
    private static String modeToString(int mode) {
        switch (mode) {
            case CONFIGURATION_STORAGE_MODE_MEMORY /*{ENCODED_INT: 401}*/:
                return "CONFIGURATION_STORAGE_MODE_MEMORY";
            case CONFIGURATION_STORAGE_MODE_DISK /*{ENCODED_INT: 402}*/:
    ...
    private static String typeToString(int type2) {
        switch (type2) {
            ...
            case CONFIGURATION_TYPE_PROVIDER /*{ENCODED_INT: 201}*/:
    ...
    private static String databaseTypeToString(int databaseType2) {
        switch (databaseType2) {
            case CONFIGURATION_DATABASE_ODMF /*{ENCODED_INT: 301}*/:
                return "CONFIGURATION_DATABASE_ODMF";
            case CONFIGURATION_DATABASE_ANDROID /*{ENCODED_INT: 302}*/:
