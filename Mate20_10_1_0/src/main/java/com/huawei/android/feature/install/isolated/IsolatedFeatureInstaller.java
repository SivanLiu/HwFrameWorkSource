...
public class IsolatedFeatureInstaller implements IFeatureInstall {
    ...
    public int moveToVerifyIfNeed(Context context, DynamicModuleInfo dynamicModuleInfo) {
        ...
        if (dynamicModuleInfo.mSignatureVerifyType != 1 || (dynamicModuleInfo.mExpectSignInfo != null && HiPkgSignManager.doCheckArchiveApk(context, dynamicModuleInfo.mExpectSignInfo, dynamicModuleInfo.mTempPath, dynamicModuleInfo.mModuleName))) {
