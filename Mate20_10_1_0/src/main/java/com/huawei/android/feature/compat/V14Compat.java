...
public class V14Compat implements IDynamicFeatureInstaller {
    ...
    public static int dexInstall(ClassLoader classLoader, File file, File file2, String str) {
        try {
            ...
            ReflectUtils.insertNewElements(pathList, "dexElements", (Object[]) ReflectUtils.findMethodByClassLoader(classLoader, str, List.class, File.class, List.class).invoke(pathList, new ArrayList(Collections.singleton(file2)), file, arrayList2));
            return 0;
