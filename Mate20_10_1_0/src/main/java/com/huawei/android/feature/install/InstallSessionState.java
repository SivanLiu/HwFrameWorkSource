...
public class InstallSessionState {
    ...
    public final String toString() {
        return "SplitInstallSessionState{status=" + this.mStatus + ", errorCode=" + this.mErrorCode + ", bytesDownloaded=" + this.mBytesDownloaded + ",totalBytesToDownload=" + this.mTotalDownloaded + ",moduleNames=" + moduleNames() + "}";
    }
}
