...
public class V26Compat implements IDynamicFeatureInstaller {
    public static final String TAG = V26Compat.class.getSimpleName();
    ...
    public int dexInstall(ClassLoader classLoader, File file, File file2) {
        try {
            ...
            ReflectUtils.insertNewElements(pathList, "dexElements", (Object[]) ReflectUtils.findMethodByClassLoader(classLoader, "makePathElements", List.class, File.class, List.class).invoke(pathList, new ArrayList(Collections.singleton(file2)), file, arrayList2));
            return 0;
    ...
    public int nativeInstall(ClassLoader classLoader, Set<File> set) {
        ...
        try {
            ...
            Method findMethodByClassLoader = ReflectUtils.findMethodByClassLoader(classLoader, "makePathElements", List.class);
            Object[] objArr = {arrayList};
            ReflectUtils.findField(pathList, "nativeLibraryPathElements").set(pathList, (Object[]) findMethodByClassLoader.invoke(pathList, objArr));
            return 0;
        } catch (Exception e) {
