            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case TRANSACTION_batchLog /*{ENCODED_INT: 8}*/:
                        ...
                        return true;
                    case TRANSACTION_infer /*{ENCODED_INT: 9}*/:
                        data.enforceInterface(DESCRIPTOR);
                        int _result8 = infer(data.readString(), data.readString(), data.readHashMap(getClass().getClassLoader()));
                        reply.writeNoException();
        ...
        private static class Proxy implements IDecision {
            ...
            public int log(String sceneName, String feature, int label) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_log, _data, _reply, 0);
                    _reply.readException();
                    return _reply.readInt();
                } finally {
                    _reply.recycle();
            ...
            public int batchLog(String sceneName, List features, List labels) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_batchLog, _data, _reply, 0);
                    _reply.readException();
                    return _reply.readInt();
                } finally {
                    _reply.recycle();
            ...
            public int infer(String sceneName, String feature, Map result) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_infer, _data, _reply, 0);
                    _reply.readException();
                    return _reply.readInt();
                } finally {
                    _reply.recycle();
