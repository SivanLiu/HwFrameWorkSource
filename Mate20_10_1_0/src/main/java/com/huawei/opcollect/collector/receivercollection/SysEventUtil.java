...
public final class SysEventUtil {
    ...
    public static int querySysEventDailyCount(String eventName) {
        ...
        return (int) OdmfCollectScheduler.getInstance().getOdmfHelper().queryManageObjectCount(Query.select(RawSysEvent.class).greaterThanOrEqualTo("mTimeStamp", midnight).equalTo("mEventName", eventName).count("*"));
    }
