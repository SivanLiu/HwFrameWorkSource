...
public class DeviceStatusInfoAction extends Action {
    ...
    private static DeviceStatusInfoAction instance = null;
    ...
    public static DeviceStatusInfoAction getInstance(Context context) {
        ...
        synchronized (LOCK) {
            if (instance == null) {
                instance = new DeviceStatusInfoAction(context, OPCollectConstant.DEVICE_STATUS_INFO_ACTION_NAME);
            }
            deviceStatusInfoAction = instance;
        }
    ...
    public boolean destroy() {
        super.destroy();
        destroyDeviceStatusInfoActionInstance();
        return true;
    }

    private static void destroyDeviceStatusInfoActionInstance() {
        synchronized (LOCK) {
            instance = null;
        }
    }
