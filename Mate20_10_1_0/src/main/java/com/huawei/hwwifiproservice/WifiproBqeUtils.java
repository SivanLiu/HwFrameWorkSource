...
public class WifiproBqeUtils {
    ...
    /* access modifiers changed from: private */
    public long mBestSpeed;
    private List<Handler> mBqeHandlerList = new ArrayList();
    private List<Messenger> mBqeMessengerist = new ArrayList();
    /* access modifiers changed from: private */
    public Handler mBqeMsgHandler;
    /* access modifiers changed from: private */
    public long mBqeStartedTime;
    private ContentResolver mContentResolver;
    private Context mContext;
    /* access modifiers changed from: private */
    public boolean mIsBindWlanFailed = false;
    private boolean mIsOversea = false;
    private boolean mIsReceiverRegistered = false;
    /* access modifiers changed from: private */
    public boolean mIsSendRequest = false;
    /* access modifiers changed from: private */
    public boolean mIsServiceStarted = false;
    private boolean mIsSetExpire = false;
    /* access modifiers changed from: private */
    public boolean mIsStartRequestReceived = false;
    /* access modifiers changed from: private */
    public boolean mIsStopRequestReceived = false;
    /* access modifiers changed from: private */
    public boolean mIsSuspendRequest = false;
    /* access modifiers changed from: private */
    public long mLastSecondLoadRxByte;
    /* access modifiers changed from: private */
    public long mLastSecondLoadTime;
    ...
    /* access modifiers changed from: private */
    public int mSuspendRequestInterval = 0;
    ...
    public void startBqeService() {
        ...
        if (!this.mIsReceiverRegistered) {
            ...
            filter.addAction(WifiProCommonDefs.ACTION_RESP_WEBVIEW_CHECK_FROM_SERVICE);
    ...
    public void resetWlanRtt() {
        ...
        WifiManagerEx.ctrlHwWifiNetwork(HwWifiProService.SERVICE_NAME, 6, data);
    }
    ...
    public void queryWlanRtt() {
        ...
        Bundle data = new Bundle();
        data.putInt("WIFIPRO_WLAN_BQE_RTT", 1);
        Bundle resultRtt = WifiManagerEx.ctrlHwWifiNetwork(HwWifiProService.SERVICE_NAME, 7, data);
    ...
    private void recheckNetworkTypeByWebView(boolean oversea) {
        ...
        Intent intent = new Intent(WifiProCommonDefs.ACTION_REQUEST_WEBVIEW_CHECK_TO_SERVICE);
            ...
            public void handleMessage(Message msg) {
                ...
                if (i != 1) {
                    ...
                    if (speed > WifiproBqeUtils.this.mBestSpeed) {
                        long unused = WifiproBqeUtils.this.mBestSpeed = speed;
                    }
                    long unused2 = WifiproBqeUtils.this.mLastSecondLoadRxByte = currentRxByte;
                    long unused3 = WifiproBqeUtils.this.mLastSecondLoadTime = currentTime;
            ...
            if (WifiproBqeUtils.BQE_REQUEST_FINISHED.equals(action)) {
                ...
                if (bqeResult != 1) {
                    ...
                    if (serviceBestSpeed > WifiproBqeUtils.this.mBestSpeed) {
                        long unused2 = WifiproBqeUtils.this.mBestSpeed = serviceBestSpeed;
                ...
                boolean unused3 = WifiproBqeUtils.this.mIsStopRequestReceived = true;
                ...
                boolean unused4 = WifiproBqeUtils.this.mIsServiceStarted = true;
                if (WifiproBqeUtils.this.mIsSuspendRequest) {
                    boolean unused5 = WifiproBqeUtils.this.mIsSuspendRequest = false;
                    WifiproBqeUtils wifiproBqeUtils = WifiproBqeUtils.this;
                    wifiproBqeUtils.requestBqeOnce(wifiproBqeUtils.mSuspendRequestInterval);
                }
                WifiproBqeUtils.this.startWebView();
            } else if (WifiproBqeUtils.BQE_RECEIVE_REQUEST.equals(action)) {
                boolean unused6 = WifiproBqeUtils.this.mIsStartRequestReceived = true;
                ...
                boolean unused7 = WifiproBqeUtils.this.mIsBindWlanFailed = true;
            } else if (WifiProCommonDefs.ACTION_RESP_WEBVIEW_CHECK_FROM_SERVICE.equals(action)) {
                Log.d(WifiproBqeUtils.BQE_LOG_TAG, "ACTION_RESP_WEBVIEW_CHECK_FROM_SERVICE, need resp = " + WifiproBqeUtils.this.mNeedRecheckByWebView);
                WifiproBqeUtils.this.mNeedRecheckByWebView = false;
                WifiproBqeUtils.this.notifyWebviewResult(intent.getIntExtra(WifiProCommonDefs.EXTRA_FLAG_NETWORK_TYPE, 100));
            }
        }
    }

    /* access modifiers changed from: private */
    public void notifyBQEResult(int bqeLevel, int tcpRtt, int tcpRttPkts, long bestSpeed) {
        synchronized (this.mLock) {
            Bundle data = new Bundle();
    ...
    /* access modifiers changed from: private */
    public void notifyWebviewResult(int type) {
        synchronized (this.mLock) {
