...
public abstract class CaptivePortalProbeSpec {
    ...
    private static class RegexMatchProbeSpec extends CaptivePortalProbeSpec {
        ...
        public CaptivePortalProbeResult getResult(int status, String locationHeader) {
            return new CaptivePortalProbeResult((!CaptivePortalProbeSpec.isSafeMatch(String.valueOf(status), this.mStatusRegex) || !CaptivePortalProbeSpec.isSafeMatch(locationHeader, this.mLocationHeaderRegex)) ? 302 : 204, locationHeader, getUrl().toString(), this);
        }
    }
