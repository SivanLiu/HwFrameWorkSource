...
public class WiFiStateMonitor {
    ...
    private void registerBroadcastReceiver() {
        if (!this.isRegister) {
            ...
            this.intentFilter.addAction(WifiProCommonDefs.ACTION_NETWORK_CONDITIONS_MEASURED);
    ...
    /* access modifiers changed from: private */
    public void handleNetworkConditionsMeasured(Intent intent) {
    ...
    /* access modifiers changed from: private */
    public void handleConfiguredNetworkChange(Intent intent) {
    ...
    /* access modifiers changed from: private */
    public void handleSupplicantStateChange(Context context) {
