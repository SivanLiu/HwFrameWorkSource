...
public class HwDualBandWiFiMonitor {
    ...
    private void registerBroadcastReceiver() {
        if (!this.isRegister) {
            ...
            this.mIntentFilter.addAction(WifiProCommonDefs.ACTION_NETWORK_CONDITIONS_MEASURED);
    ...
    private class WifiBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            } else if (WifiProCommonDefs.ACTION_NETWORK_CONDITIONS_MEASURED.equals(action)) {
                Log.e(HwDualBandMessageUtil.TAG, "ACTION_NETWORK_CONDITIONS_MEASURED");
                int isInternetResult = intent.getIntExtra(WifiProCommonDefs.EXTRA_IS_INTERNET_READY, -1);
    ...
    /* access modifiers changed from: private */
    public void handleCfgNetChgAction(Intent intent) {
    ...
    /* access modifiers changed from: private */
    public void handleNetStateChangedAction(String action, NetworkInfo netInfo) {
        if (netInfo == null) {
            return;
        }
    ...
    /* access modifiers changed from: private */
    public void handleWifiStateChangeAction(Intent intent) {
