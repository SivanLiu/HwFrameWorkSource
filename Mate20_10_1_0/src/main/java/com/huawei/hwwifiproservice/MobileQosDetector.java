...
public class MobileQosDetector implements IGetMobileInfoCallBack {
    ...
    /* access modifiers changed from: private */
    public int mCurrDataSubID = 0;
    /* access modifiers changed from: private */
    public long mDataConnTimestamp = System.currentTimeMillis();
    /* access modifiers changed from: private */
    public boolean mDataSuspend = false;
    /* access modifiers changed from: private */
    public int mEvents = 321;
    /* access modifiers changed from: private */
    public Handler mHandler;
    /* access modifiers changed from: private */
    public int[] mHisSimStatus = null;
    ...
    /* access modifiers changed from: private */
    public int mIpqLevel = -1;
    /* access modifiers changed from: private */
    public boolean mIsMonitoring = false;
    /* access modifiers changed from: private */
    public int mIsRoveOutState = 0;
    ...
    /* access modifiers changed from: private */
    public boolean mMobileDataSwitch = false;
    /* access modifiers changed from: private */
    public final int mPhoneNum;
    /* access modifiers changed from: private */
    public int mQosLevel = -1;
    ...
    /* access modifiers changed from: private */
    public TcpIpqRtt mRtt = new TcpIpqRtt();
    /* access modifiers changed from: private */
    public int[] mSIMArray = null;
    /* access modifiers changed from: private */
    public int[] mSignalArray = null;
    /* access modifiers changed from: private */
    public int mSignalLevel = -1;
    /* access modifiers changed from: private */
    ...
    private Runnable mSpeedUpdate = new Runnable() {
        ...
        public void run() {
            ...
            int unused = mobileQosDetector.mSpeed = mobileQosDetector.mTraffic.getRxByteSpeed(1);
            MobileQosDetector mobileQosDetector2 = MobileQosDetector.this;
            int unused2 = mobileQosDetector2.mSpeedLevel = mobileQosDetector2.mTraffic.transform(MobileQosDetector.this.mSpeed);
    ...
    /* access modifiers changed from: private */
    public long mSubIdChangeTimsstamp = System.currentTimeMillis();
    ...
    /* access modifiers changed from: private */
    public long roStartRxBytes = 0;
    /* access modifiers changed from: private */
    public long roStartTxBytes = 0;
    ...
    /* access modifiers changed from: private */
    public void requestComputeQos(long delayMs) {
        this.mHandler.sendEmptyMessageDelayed(101, delayMs);
    }

    /* access modifiers changed from: private */
    public void reportQos(int reportType, int qosLevel) {
        ...
        if (reportType == 0) {
            ...
            iNetworkQosCallBack.onNetworkQosChange(0, qosLevel, true);
        } else {
            return;
        }
    ...
    private void initObserver() {
        ...
        ContentObserver dataSwitchObserver = new ContentObserver(this.mHandler) {
            ...
            public void onChange(boolean selfChange) {
                MobileQosDetector mobileQosDetector = MobileQosDetector.this;
                boolean unused = mobileQosDetector.mMobileDataSwitch = mobileQosDetector.getDataStatus();
                MobileQosDetector.this.requestComputeQos(0);
                MobileQosDetector mobileQosDetector2 = MobileQosDetector.this;
        ...
        ContentObserver subSelectObserver = new ContentObserver(this.mHandler) {
            ...
            public void onChange(boolean selfChange) {
                ...
                MobileQosDetector mobileQosDetector = MobileQosDetector.this;
                int unused = mobileQosDetector.mCurrDataSubID = Settings.Global.getInt(mobileQosDetector.mContentRsr, MobileQosDetector.SUB_SELECT_KEY, 0);
                MobileQosDetector mobileQosDetector2 = MobileQosDetector.this;
                ...
                if (oldId != MobileQosDetector.this.mCurrDataSubID) {
                    ...
                    MobileQosDetector mobileQosDetector3 = MobileQosDetector.this;
                    int unused2 = mobileQosDetector3.mSignalLevel = mobileQosDetector3.mSignalArray[subId];
                    int unused3 = MobileQosDetector.this.mSpeedLevel = -1;
                    int unused4 = MobileQosDetector.this.mIpqLevel = -1;
                    ...
                    int unused5 = mobileQosDetector4.mSimStatus = mobileQosDetector4.mTelephonyMgr.getSimState(MobileQosDetector.this.mCurrDataSubID);
    ...
    /* access modifiers changed from: private */
    public PhoneStateListener getPSListener(int subscription) {
        return new DualPhoneStateListener(subscription) {
            ...
            public void onSignalStrengthsChanged(SignalStrength signalStrength) {
                ...
                if (this.mSubId == MobileQosDetector.this.mCurrDataSubID && MobileQosDetector.this.mSignalLevel != MobileQosDetector.this.mSignalArray[subid]) {
                    MobileQosDetector mobileQosDetector2 = MobileQosDetector.this;
                    int unused2 = mobileQosDetector2.mSignalLevel = mobileQosDetector2.mSignalArray[subid];
                    MobileQosDetector.this.requestComputeQos(0);
                }
            }
            ...
            public void onDataConnectionStateChanged(int state, int networkType) {
                ...
                if (state == 2) {
                    ...
                    MobileQosDetector mobileQosDetector = MobileQosDetector.this;
                    int unused2 = mobileQosDetector.mSimStatus = mobileQosDetector.mTelephonyMgr.getSimState(MobileQosDetector.this.mCurrDataSubID);
            ...
            public void onServiceStateChanged(ServiceState serviceState) {
                ...
                if (voiceState == 0) {
                    ...
                    int[] access$2300 = MobileQosDetector.this.mSIMArray;
                    int i2 = this.mSubId;
                    access$2300[i2] = 0;
    ...
    /* access modifiers changed from: private */
    public void composeQOSLevel(int signalLevel, int reportType) {
        int ratLvl;
        int i;
        int i2;
            ...
            if (!this.mMobileDataSwitch) {
                ...
                if (!simReady) {
                    ...
                    if (simState == 5 && (i = this.mPhoneNum) >= 0 && i <= 3 && serviceState != null && serviceState.getState() == 0) {
                        ...
                        this.mSimStatus = 5;
                        simReady = true;
                        logi("SIM status change, simReady = " + true);
                    }
                }
                if (simReady) {
    ...
    class MobileQosDetectHandler extends Handler {
        ...
        private void handleRoStateChagneMsg(Message msg) {
            ...
            if (MobileQosDetector.this.mTraffic != null) {
                if (1 == roState) {
                    int unused = MobileQosDetector.this.mIsRoveOutState = 1;
                    MobileQosDetector mobileQosDetector = MobileQosDetector.this;
                    long unused2 = mobileQosDetector.roStartRxBytes = mobileQosDetector.mTraffic.getMobileRxBytes();
                    MobileQosDetector mobileQosDetector2 = MobileQosDetector.this;
                    long unused3 = mobileQosDetector2.roStartTxBytes = mobileQosDetector2.mTraffic.getMobileTxBytes();
                    long unused4 = MobileQosDetector.this.mTotalBytes = 0;
                    MobileQosDetector mobileQosDetector3 = MobileQosDetector.this;
                    ...
                    int unused5 = MobileQosDetector.this.mIsRoveOutState = 0;
        ...
        public void handleMessage(Message msg) {
            ...
            if (i != 101) {
                switch (i) {
                    case 105:
                        int unused = MobileQosDetector.this.mIpqLevel = -1;
