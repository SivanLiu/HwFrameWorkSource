...
public class HwIntelligenceStateMachine extends StateMachine {
    ...
    public ApInfoManager mApInfoManager = null;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public HwintelligenceWiFiCHR mHwIntelligenceWifiChr = null;
    /* access modifiers changed from: private */
    ...
    /* access modifiers changed from: private */
    public List<APInfoData> mTargetApInfoDatas = null;
    /* access modifiers changed from: private */
    public String mTargetCellId = null;
    /* access modifiers changed from: private */
    public String mTargetSsid = null;
    /* access modifiers changed from: private */
    public WifiInfo mTargetWifiInfo = null;
            ...
            if (i == 1) {
                ...
                if (i != 5) {
                    if (i == 24) {
                        ...
                        int unused = HwIntelligenceStateMachine.this.mConnectFailedReason = mData.getInt("reason");
                        String unused2 = HwIntelligenceStateMachine.this.mConnectFailedBssid = mData.getString("bssid", "");
                        String unused3 = HwIntelligenceStateMachine.this.mConnectFailedSsid = mData.getString("ssid", "");
                        ...
                        if (i == 100) {
                            ...
                            switch (i) {
                                ...
                                case 8:
                                    ...
                                    break;
                                case 14:
                                    boolean unused4 = HwIntelligenceStateMachine.this.mIsWifiP2PConnected = true;
                                    break;
                                case 15:
        ...
        private void updateConnectedInfo() {
            ...
            if (config != null) {
                ...
                if (HwIntelligenceStateMachine.this.getCurrentState() == HwIntelligenceStateMachine.this.mInternetReadyState) {
                    HwIntelligenceStateMachine hwIntelligenceStateMachine = HwIntelligenceStateMachine.this;
                    WifiInfo unused4 = hwIntelligenceStateMachine.mTargetWifiInfo = hwIntelligenceStateMachine.mWifiManager.getConnectionInfo();
                    if (HwIntelligenceStateMachine.this.mTargetWifiInfo != null) {
                        HwIntelligenceStateMachine hwIntelligenceStateMachine2 = HwIntelligenceStateMachine.this;
                        String unused5 = hwIntelligenceStateMachine2.mTargetCellId = hwIntelligenceStateMachine2.mCellStateMonitor.getCurrentCellid();
                        HwHiLog.d(MessageUtil.TAG, false, "mTargetSsid %{public}s mTargetBssid %{public}s", new Object[]{WifiProCommonUtils.safeDisplaySsid(HwIntelligenceStateMachine.this.mTargetSsid), WifiProCommonUtils.safeDisplayBssid(HwIntelligenceStateMachine.this.mTargetWifiInfo.getBSSID())});
                    }
                }
            }
        }
    ...
    class InternetReadyState extends State {
        ...
        public void enter() {
            ...
            if (info != null && info.getBSSID() != null && !bMobileAP) {
                ...
                long unused = HwIntelligenceStateMachine.this.mInternetReadyStateTime = SystemClock.elapsedRealtime();
        ...
        public boolean processMessage(Message message) {
            ...
            if (i == 2) {
                ...
                if (i == 32) {
                    ...
                    String unused8 = HwIntelligenceStateMachine.this.mTargetSsid = null;
                    WifiInfo unused9 = HwIntelligenceStateMachine.this.mTargetWifiInfo = null;
                    int unused10 = HwIntelligenceStateMachine.this.mAuthType = -1;
                    String unused11 = HwIntelligenceStateMachine.this.mTargetCellId = null;
                } else if (i == 14) {
                    HwHiLog.d(MessageUtil.TAG, false, "DisconnectedState MessageUtil.MSG_WIFI_P2P_CONNECTED", new Object[0]);
                    boolean unused12 = HwIntelligenceStateMachine.this.mIsWifiP2PConnected = true;
                    if (HwIntelligenceStateMachine.this.mIsWaittingAutoClose || HwIntelligenceStateMachine.this.mIsAutoCloseSearch) {
                        ...
                        boolean unused14 = HwIntelligenceStateMachine.this.mIsAutoCloseSearch = false;
                        HwIntelligenceStateMachine.this.releaseAutoTimer();
                    }
                } else if (i != 15) {
                    return false;
                    ...
                    boolean unused15 = HwIntelligenceStateMachine.this.mIsWifiP2PConnected = false;
                    autoOpenAllowScan();
                }
                ...
                boolean unused16 = HwIntelligenceStateMachine.this.mIsWaittingAutoClose = false;
                boolean unused17 = HwIntelligenceStateMachine.this.mIsAutoCloseSearch = false;
                HwIntelligenceStateMachine.this.releaseAutoTimer();
            }
            return true;
        }
            ...
            if (HwIntelligenceStateMachine.this.mIsInitialState) {
                ...
                if (HwIntelligenceStateMachine.this.mIsAutoClose) {
                    ...
                    if (hwIntelligenceStateMachine.isScreenOn(hwIntelligenceStateMachine.mContext)) {
                        ...
                        WifiInfo unused11 = HwIntelligenceStateMachine.this.mTargetWifiInfo = null;
                        String unused12 = HwIntelligenceStateMachine.this.mTargetCellId = null;
                        int unused13 = HwIntelligenceStateMachine.this.mAuthType = -1;
    ...
    /* access modifiers changed from: private */
    public void handleMsgWifiFindTarget() {
    ...
    /* access modifiers changed from: private */
    public void handleMsgWifiOpen() {
        this.mAutoOpenCnt++;
        if (this.mIsAutoOpenSearch) {
            this.mIsScreenOn = isScreenOn(this.mContext);
            HwHiLog.d(MessageUtil.TAG, false, "MSG_WIFI_HANDLE_OPEN mWifiManager.getWifiState() = %{public}d mIsScreenOn = %{public}s  mIsFullScreen  %{public}s", new Object[]{Integer.valueOf(this.mWifiManager.getWifiState()), String.valueOf(this.mIsScreenOn), String.valueOf(isFullScreen())});
            if (this.mWifiManager.getWifiState() == 1 && !this.mWifiManager.isWifiEnabled() && this.mIsScreenOn && !isFullScreen()) {
            ...
            } else if (this.mWifiManager.getWifiState() == 0 && this.mIsScreenOn && !isFullScreen()) {
                sendMessageDelayed(26, 3000);
            }
        }
    }
    ...
    public static HwIntelligenceStateMachine createIntelligenceStateMachine(Context context) {
        if (mHwIntelligenceStateMachine == null) {
            mHwIntelligenceStateMachine = new HwIntelligenceStateMachine(context);
        }
    ...
    public void uploadAutoOpenWifiFailed(boolean isMatchHomeScene) {
        ...
        if (SystemClock.elapsedRealtime() - this.mUploadAutoOpenWifiFailedTime >= this.mUploadIntervalTime) {
            ...
            DFTEventData.putInt("eventId", WifiProCommonUtils.ID_UPDATE_AUTO_OPEN_WIFI_FAILED_INFO);
