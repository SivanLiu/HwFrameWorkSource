...
public class WifiProDualBandApInfoRcd {
    ...
    public void dumpAll() {
        Log.d(TAG, "mApBSSID:" + this.mApBSSID + ", mApSSID:" + this.mApSSID + ", mInetCapability:" + this.mInetCapability + ", mServingBand:" + this.mServingBand + ", mApAuthType:" + this.mApAuthType + ", mChannelFrequency:" + this.mChannelFrequency + ", mDisappearCount:" + this.mDisappearCount + ", isInBlackList:" + this.mInBlackList + ", mUpdateTime:" + this.mUpdateTime);
    }
}
