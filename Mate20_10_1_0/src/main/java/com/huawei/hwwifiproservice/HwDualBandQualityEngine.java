...
public class HwDualBandQualityEngine {
    ...
    private static final RttScore[] RTT_SCORE_TABLE = {new RttScore(400, 15), new RttScore(HiCoexUtils.NETWORK_WIFI, 10), new RttScore(WifiproBqeUtils.BQE_GOOD_RTT, 5), new RttScore(2000, 0), new RttScore(HwQoEUtils.WIFI_CHECK_TIMEOUT, -5), new RttScore(16000, -10)};
