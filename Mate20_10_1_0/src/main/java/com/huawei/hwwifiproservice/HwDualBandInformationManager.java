...
public class HwDualBandInformationManager {
    ...
    public void updateAPInfo(WifiProDualBandApInfoRcd tempApInfo) {
        Log.e(HwDualBandMessageUtil.TAG, "updateAPInfo update AP info ssid = " + WifiProCommonUtils.safeDisplaySsid(tempApInfo.mApSSID));
    ...
    public boolean saveAPInfo() {
        ...
        Log.i(HwDualBandMessageUtil.TAG, "ConnectedState apInfo.mApBSSID = " + WifiProCommonUtils.safeDisplayBssid(apInfo.mApBSSID) + "  apInfo.mApSSID = " + WifiProCommonUtils.safeDisplaySsid(apInfo.mApSSID) + " apInfo.mChannelFrequency = " + apInfo.mChannelFrequency + " apInfo.mServingBand = " + apInfo.mServingBand);
    ...
    public void delectDualBandAPInfoBySsid(String ssid, int authType) {
        Log.e(HwDualBandMessageUtil.TAG, "delectDualBandAPInfoBySsid ssid= " + WifiProCommonUtils.safeDisplaySsid(ssid));
        ...
        if (rcdList != null && rcdList.size() != 0) {
            ...
            for (WifiProDualBandApInfoRcd rcd : rcdList) {
                if (rcd.mApAuthType.shortValue() == authType) {
                    Log.e(HwDualBandMessageUtil.TAG, "delectDualBandAPInfoBySsid  rcd.mApSSID = " + WifiProCommonUtils.safeDisplayBssid(rcd.mApBSSID) + " rcd.mServingBand = " + rcd.mServingBand);
