...
public class NetworkMonitor {
    ...
    private String getCaptivePortalServerHttpsUrl() {
        return getSettingFromResource(this.mContext, 33685604, 33685620, "captive_portal_https_url");
    }

    private String getCaptivePortalServerHttpsFallbackUrl() {
        return getSettingFromResource(this.mContext, 33685603, 33685619, KEYWORD_HTTPS_FALLBACK_URL);
    }

    public final String getCaptivePortalServerHttpUrl() {
        return getSettingFromResource(this.mContext, 33685602, 33685617, "captive_portal_http_url");
    }
    ...
    private URL[] makeCaptivePortalFallbackUrls() {
        ...
        try {
            ...
            return (URL[]) getArrayConfig(settingProviderUrls, 33816590, 33816593, new Function() {
                /* class com.huawei.hwwifiproservice.$$Lambda$NetworkMonitor$YEIaWAMgPWwAKzHG21jjYuYoJhc */
    ...
    private CaptivePortalProbeSpec[] makeCaptivePortalFallbackProbeSpecs() {
        try {
            ...
            return (CaptivePortalProbeSpec[]) getArrayConfig(TextUtils.isEmpty(settingsValue) ? emptySpecs : (CaptivePortalProbeSpec[]) CaptivePortalProbeSpec.parseCaptivePortalProbeSpecs(settingsValue).toArray(emptySpecs), 33816585, 33816592, $$Lambda$3BQoMf0hhFMxc9ZobyUHVdWpOE0.INSTANCE);
        } catch (Exception e) {
    ...
    /* access modifiers changed from: private */
    public CaptivePortalProbeSpec nextFallbackSpec() {
    ...
    private void sendDnsProbe(String host) {
        if (!TextUtils.isEmpty(host)) {
            ...
            try {
                InetAddress[] addresses = sendDnsProbeWithTimeout(host, 1000);
    ...
    public CaptivePortalProbeResult sendHttpProbe(URL url, int probeType, CaptivePortalProbeSpec probeSpec) {
        ...
        try {
                        ...
                        try {
                            ...
                            if (socketFactory != null) {
                                ...
                                try {
                                    if (socketFactory instanceof SSLSocketFactory) {
                                        ...
                                        urlConnection2.setConnectTimeout(HiCoexUtils.TIMEOUT_CONNECT);
                                        urlConnection2.setReadTimeout(HiCoexUtils.TIMEOUT_CONNECT);
                                        ...
                                        if (this.mCaptivePortalUserAgent != null) {
                                            try {
                                                ...
                                                e = e2;
                                                str6 = "sendHttpProbe, errorStream close happen error";
                                                str5 = "sendHttpProbe, inputStream close happen error";
                                            } catch (IllegalAccessException | KeyManagementException | KeyStoreException | NoSuchAlgorithmException | CertificateException e3) {
                                                str3 = "sendHttpProbe, errorStream close happen error";
                                                str4 = "sendHttpProbe, inputStream close happen error";
                                                try {
                                        ...
                                        try {
                                            ...
                                            try {
                                                ...
                                                th = th7;
                                                str7 = "sendHttpProbe, errorStream close happen error";
                                                str8 = "sendHttpProbe, inputStream close happen error";
                                                th = th;
                                                if (urlConnection2 != null) {
                                                }
                                                if (inputStream != null) {
                            ...
                            if (inputStream != null) {
                                try {
                                    ...
                                    HwHiLog.e("HwNetworkMonitor/" + this.mNetwork.toString(), false, str5, new Object[0]);
                                }
                            }
                            if (errorStream2 != null) {
                                try {
                            ...
                            if (inputStream != null) {
                                try {
                                    ...
                                    HwHiLog.e("HwNetworkMonitor/" + this.mNetwork.toString(), false, str4, new Object[0]);
                                }
                            }
                            if (errorStream2 != null) {
                                try {
            ...
            HwHiLog.e(sb.toString(), false, str3, new Object[0]);
            TrafficStats.setThreadStatsTag(oldTag);
            if (probeSpec != null) {
            }
