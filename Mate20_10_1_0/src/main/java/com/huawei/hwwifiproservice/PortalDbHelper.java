...
public class PortalDbHelper extends SQLiteOpenHelper {
    ...
    private static final String TAG = "Portal_DbHelper";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        HwHiLog.i(TAG, false, "wifipro_portal_page_info.db : onCreate() in APK", new Object[0]);
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        onCreate(db);
        HwHiLog.i(TAG, false, "wifipro_portal_page_info.db : onUpgrade() in APK", new Object[0]);
    }
    ...
    public void onDowngrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS DHCP_RESULTS_INTERNET_OK ");
        onCreate(db);
        HwHiLog.i(TAG, false, "wifipro_portal_page_info.db : onDowngrade() in APK", new Object[0]);
    }
}
