...
final class Utf8 {
    ...
    static final class SafeProcessor extends Processor {
        ...
        /* JADX INFO: Multiple debug info for r7v2 byte: [D('byte1' int), D('index' int)] */
        /* JADX INFO: Multiple debug info for r0v2 byte: [D('byte2' int), D('index' int)] */
        /* JADX INFO: Multiple debug info for r0v8 byte: [D('byte2' int), D('index' int)] */
    ...
    static final class UnsafeProcessor extends Processor {
        ...
        public int encodeUtf8(CharSequence in, byte[] out, int offset, int length) {
            ...
            String str2;
            char c2;
            long outIx2 = (long) (ARRAY_BASE_OFFSET + offset);
            long outLimit2 = ((long) length) + outIx2;
                    ...
                    if (outIx <= outLimit2 - 4) {
                        if (inIx + 1 != inLimit) {
                            ...
                            if (Character.isSurrogatePair(c4, low)) {
                                ...
                                UNSAFE.putByte(out, outIx5, (byte) (((codePoint >>> 12) & 63) | 128));
                                long outIx7 = outIx6 + 1;
                                c2 = 128;
                                UNSAFE.putByte(out, outIx6, (byte) (((codePoint >>> 6) & 63) | 128));
                                j2 = 1;
                                UNSAFE.putByte(out, outIx7, (byte) ((codePoint & 63) | 128));
                                outIx = outIx7 + 1;
                            }
                        }
            ...
            if (((long) inLimit) <= outLimit2 - outIx4) {
                ...
                while (inIx < inLimit) {
                    ...
                    if (c4 < c && outIx < outLimit2) {
                        ...
                        outIx3 = address;
                        if ((c4 < 55296 || 57343 < c4) && outIx <= outLimit2 - 3) {
                            long outIx5 = outIx + 1;
                            UNSAFE.putByte(outIx, (byte) ((c4 >>> '\f') | 480));
                            long outIx6 = outIx5 + 1;
                            UNSAFE.putByte(outIx5, (byte) (((c4 >>> 6) & 63) | 128));
                            UNSAFE.putByte(outIx6, (byte) ((c4 & '?') | 128));
                            outLimit = outLimit2;
                            outIx = outIx6 + 1;
                            c2 = 128;
                            outIx2 = 1;
                            ...
                            if (inIx + 1 != inLimit) {
                                ...
                                if (Character.isSurrogatePair(c4, low)) {
                                    ...
                                    UNSAFE.putByte(outIx7, (byte) (((codePoint >>> 12) & 63) | 128));
                                    long outIx9 = outIx8 + 1;
                                    c2 = 128;
                                    UNSAFE.putByte(outIx8, (byte) (((codePoint >>> 6) & 63) | 128));
                                    outIx2 = 1;
                                    outIx = outIx9 + 1;
                                    UNSAFE.putByte(outIx9, (byte) ((codePoint & 63) | 128));
                                }
                            }
                            throw new UnpairedSurrogateException(inIx - 1, inLimit);
                        } else if (55296 > c4 || c4 > 57343 || (inIx + 1 != inLimit && Character.isSurrogatePair(c4, in.charAt(inIx + 1)))) {
                        ...
                        outIx3 = address;
                        long outIx10 = outIx + 1;
                        UNSAFE.putByte(outIx, (byte) ((c4 >>> 6) | 960));
                        outIx = outIx10 + 1;
                        UNSAFE.putByte(outIx10, (byte) ((c4 & '?') | 128));
                        outLimit = outLimit2;
                        c2 = 128;
                        outIx2 = 1;
                    }
