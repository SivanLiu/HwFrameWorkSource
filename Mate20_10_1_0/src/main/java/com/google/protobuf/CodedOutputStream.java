...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    private static class ArrayEncoder extends CodedOutputStream {
        ...
        @Override // com.google.protobuf.ByteOutput, com.google.protobuf.CodedOutputStream
        ...
        public final void writeFixed32NoTag(int value) throws IOException {
            try {
                ...
                int i = this.position;
                this.position = i + 1;
                bArr[i] = (byte) (value & Constants.BYTE_MASK);
                byte[] bArr2 = this.buffer;
                int i2 = this.position;
                this.position = i2 + 1;
                bArr2[i2] = (byte) ((value >> 8) & Constants.BYTE_MASK);
                byte[] bArr3 = this.buffer;
                int i3 = this.position;
                this.position = i3 + 1;
                bArr3[i3] = (byte) ((value >> 16) & Constants.BYTE_MASK);
                byte[] bArr4 = this.buffer;
                int i4 = this.position;
                this.position = i4 + 1;
                bArr4[i4] = (byte) ((value >> 24) & Constants.BYTE_MASK);
            } catch (IndexOutOfBoundsException e) {
                throw new OutOfSpaceException(new IndexOutOfBoundsException(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.position), Integer.valueOf(this.limit), 1)));
            }
        }
        ...
        public final void writeFixed64NoTag(long value) throws IOException {
            try {
                ...
                int i = this.position;
                this.position = i + 1;
                bArr[i] = (byte) (((int) value) & Constants.BYTE_MASK);
                byte[] bArr2 = this.buffer;
                int i2 = this.position;
                this.position = i2 + 1;
                bArr2[i2] = (byte) (((int) (value >> 8)) & Constants.BYTE_MASK);
                byte[] bArr3 = this.buffer;
                int i3 = this.position;
                this.position = i3 + 1;
                bArr3[i3] = (byte) (((int) (value >> 16)) & Constants.BYTE_MASK);
                byte[] bArr4 = this.buffer;
                int i4 = this.position;
                this.position = i4 + 1;
                bArr4[i4] = (byte) (((int) (value >> 24)) & Constants.BYTE_MASK);
                byte[] bArr5 = this.buffer;
                int i5 = this.position;
                this.position = i5 + 1;
                bArr5[i5] = (byte) (((int) (value >> 32)) & Constants.BYTE_MASK);
                byte[] bArr6 = this.buffer;
                int i6 = this.position;
                this.position = i6 + 1;
                bArr6[i6] = (byte) (((int) (value >> 40)) & Constants.BYTE_MASK);
                byte[] bArr7 = this.buffer;
                int i7 = this.position;
                this.position = i7 + 1;
                bArr7[i7] = (byte) (((int) (value >> 48)) & Constants.BYTE_MASK);
                byte[] bArr8 = this.buffer;
                int i8 = this.position;
                this.position = i8 + 1;
                bArr8[i8] = (byte) (((int) (value >> 56)) & Constants.BYTE_MASK);
            } catch (IndexOutOfBoundsException e) {
                throw new OutOfSpaceException(new IndexOutOfBoundsException(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.position), Integer.valueOf(this.limit), 1)));
            }
        }
    ...
    private static abstract class AbstractBufferedEncoder extends CodedOutputStream {
        ...
        public final void bufferUInt64NoTag(long value) {
            boolean access$100 = CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS;
            if (access$100) {
                long originalPos = CodedOutputStream.ARRAY_BASE_OFFSET + ((long) this.position);
                long pos = originalPos;
                long value2 = value;
        ...
        public final void bufferFixed32NoTag(int value) {
            ...
            int i2 = this.position;
            this.position = i2 + 1;
            bArr[i2] = (byte) ((value >> 8) & Constants.BYTE_MASK);
            int i3 = this.position;
            this.position = i3 + 1;
            bArr[i3] = (byte) ((value >> 16) & Constants.BYTE_MASK);
            int i4 = this.position;
            this.position = i4 + 1;
            bArr[i4] = (byte) ((value >> 24) & Constants.BYTE_MASK);
        ...
        public final void bufferFixed64NoTag(long value) {
            ...
            int i5 = this.position;
            this.position = i5 + 1;
            bArr[i5] = (byte) (((int) (value >> 32)) & Constants.BYTE_MASK);
            int i6 = this.position;
            this.position = i6 + 1;
            bArr[i6] = (byte) (((int) (value >> 40)) & Constants.BYTE_MASK);
            int i7 = this.position;
            this.position = i7 + 1;
            bArr[i7] = (byte) (((int) (value >> 48)) & Constants.BYTE_MASK);
            int i8 = this.position;
            this.position = i8 + 1;
            bArr[i8] = (byte) (((int) (value >> 56)) & Constants.BYTE_MASK);
