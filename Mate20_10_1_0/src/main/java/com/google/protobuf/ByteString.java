...
public abstract class ByteString implements Iterable<Byte>, Serializable {
    ...
    public final ByteString concat(ByteString other) {
        if (ScoringParams.Values.MAX_EXPID - size() >= other.size()) {
    ...
    /* JADX INFO: Multiple debug info for r0v1 int: [D('result' com.google.protobuf.ByteString), D('halfLength' int)] */
    /* JADX INFO: Multiple debug info for r0v2 com.google.protobuf.ByteString: [D('result' com.google.protobuf.ByteString), D('halfLength' int)] */
