...
class SmallSortedMap<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: com.google.protobuf.SmallSortedMap<K extends java.lang.Comparable<K>, V> */
    /* JADX DEBUG: Multi-variable search result rejected for r0v1, resolved type: java.lang.Comparable */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    public V put(K key, V value) {
        ...
        if (size == i) {
            Entry lastEntryInArray = this.entryList.remove(i - 1);
