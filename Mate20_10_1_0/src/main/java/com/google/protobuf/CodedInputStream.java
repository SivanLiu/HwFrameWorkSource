...
public final class CodedInputStream {
    ...
    /* JADX INFO: Multiple debug info for r0v3 byte: [D('pos' int), D('x' int)] */
    /* JADX INFO: Multiple debug info for r1v6 'pos'  int: [D('pos' int), D('x' int)] */
    /* JADX INFO: Multiple debug info for r0v9 int: [D('pos' int), D('x' int)] */
    /* JADX INFO: Multiple debug info for r1v10 'x'  int: [D('pos' int), D('x' int)] */
    /* JADX INFO: Multiple debug info for r0v10 byte: [D('pos' int), D('y' int)] */
        ...
        if (i != pos2) {
            ...
            if (b >= 0) {
                ...
                if (x2 < 0) {
                    ...
                    pos = pos4 + 1;
                    int x3 = (buffer2[pos4] << 14) ^ x2;
                    if (x3 >= 0) {
                        x = x3 ^ 16256;
                    } else {
                        int x4 = pos + 1;
                        int x5 = (buffer2[pos] << 21) ^ x3;
                        if (x5 < 0) {
                            x = -2080896 ^ x5;
                            pos = x4;
                        } else {
    ...
    /* JADX INFO: Multiple debug info for r0v2 byte: [D('pos' int), D('y' int)] */
