...
public abstract class GeneratedMessageLite<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite<MessageType, BuilderType> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v1, resolved type: com.google.protobuf.GeneratedMessageLite */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v4, resolved type: com.google.protobuf.GeneratedMessageLite */
    /* JADX WARN: Multi-variable type inference failed */
    /* access modifiers changed from: package-private */
    ...
    public static abstract class ExtendableMessage<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends GeneratedMessageLite<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        ...
        public final void visit(Visitor visitor, MessageType other) {
            GeneratedMessageLite.super.visit(visitor, (GeneratedMessageLite) other);
        ...
        public final <Type> boolean hasExtension(ExtensionLite<MessageType, Type> extension) {
            GeneratedExtension<MessageType, ?> access$200 = GeneratedMessageLite.checkIsLite(extension);
        ...
        public final <Type> Type getExtension(ExtensionLite<MessageType, Type> extension) {
            GeneratedExtension<MessageType, ?> access$200 = GeneratedMessageLite.checkIsLite(extension);
            verifyExtensionContainingType(access$200);
            Object value = this.extensions.getField(access$200.descriptor);
            return value == null ? access$200.defaultValue : (Type) access$200.fromFieldSetType(value);
        }
    ...
    public static abstract class ExtendableBuilder<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends Builder<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        ...
        public final <Type> BuilderType setExtension(ExtensionLite<MessageType, Type> extension, Type value) {
            ...
            verifyExtensionContainingType(access$200);
            copyOnWrite();
            ((ExtendableMessage) this.instance).extensions.setField(access$200.descriptor, access$200.toFieldSetType(value));
            return this;
        }
