...
public class BEROctetString extends ASN1OctetString {
    ...
    public BEROctetString(ASN1OctetString[] aSN1OctetStringArr) {
        this(aSN1OctetStringArr, (int) DEFAULT_LENGTH);
    }
    ...
    @Override // org.bouncycastle.asn1.ASN1Primitive, org.bouncycastle.asn1.ASN1OctetString
    ...
    public Enumeration getObjects() {
        return this.octs == null ? generateOcts().elements() : new Enumeration() {
            /* class org.bouncycastle.asn1.BEROctetString.AnonymousClass1 */
            int counter = 0;
