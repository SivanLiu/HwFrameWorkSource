    ...
    public int generate(byte[] bArr, byte[] bArr2, boolean z) {
        ...
        if (Utils.isTooLarge(bArr2, 512)) {
            ...
            for (int i3 = 0; i3 < length2; i3++) {
                bigInteger2 = getScalarMultipleXCoord(this._P, bigInteger2);
                byte[] byteArray = getScalarMultipleXCoord(this._Q, bigInteger2).toByteArray();
            ...
            if (i2 < bArr.length) {
                bigInteger2 = getScalarMultipleXCoord(this._P, bigInteger2);
                byte[] byteArray2 = getScalarMultipleXCoord(this._Q, bigInteger2).toByteArray();
            ...
            this._s = BigIntegers.asUnsignedByteArray(this._sLength, getScalarMultipleXCoord(this._P, bigInteger2));
            return length;
        }
    }
