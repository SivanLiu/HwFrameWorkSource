...
public class HC128Engine implements StreamCipher {
    ...
    private static int mod512(int i) {
        return i & Parameter.BARRETT_MULTIPLICATION_III_SPEED;
    }
    ...
    private int step() {
        ...
        if (this.cnt < 512) {
            int[] iArr = this.p;
            iArr[mod512] = iArr[mod512] + g1(iArr[dim(mod512, 3)], this.p[dim(mod512, 10)], this.p[dim(mod512, Parameter.BARRETT_MULTIPLICATION_III_SPEED)]);
            i = h1(this.p[dim(mod512, 12)]);
            i2 = this.p[mod512];
        } else {
            int[] iArr2 = this.q;
            iArr2[mod512] = iArr2[mod512] + g2(iArr2[dim(mod512, 3)], this.q[dim(mod512, 10)], this.q[dim(mod512, Parameter.BARRETT_MULTIPLICATION_III_SPEED)]);
