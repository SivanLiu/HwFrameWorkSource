                            ...
                            if (build.getTargetConstraints() == null || build.getTargetConstraints().match((Certificate) ((X509Certificate) certificates.get(0)))) {
                                ...
                                while (size2 >= 0) {
                                    ...
                                    try {
                                        ...
                                        PKIXPolicyNode processCertE = RFC3280CertPathUtilities.processCertE(certPath, size2, RFC3280CertPathUtilities.processCertD(certPath, size2, hashSet4, pKIXPolicyNode2, arrayListArr2, i12, this.isForCRLCheck));
                                        ...
                                        if (i13 == size) {
                                            ...
                                            PKIXPolicyNode prepareCertB = RFC3280CertPathUtilities.prepareCertB(certPath, size2, arrayListArr, processCertE, i);
                                            ...
                                            int prepareNextCertH3 = RFC3280CertPathUtilities.prepareNextCertH3(certPath, size2, i12);
                                            ...
                                            int prepareNextCertM = RFC3280CertPathUtilities.prepareNextCertM(certPath, size2, RFC3280CertPathUtilities.prepareNextCertL(certPath, size2, i10));
                                ...
                                int i14 = size2 + 1;
                                int wrapupCertB = RFC3280CertPathUtilities.wrapupCertB(certPath, i14, RFC3280CertPathUtilities.wrapupCertA(i11, x509Certificate2));
                                if (x509Certificate2.getCriticalExtensionOIDs() != null) {
                                ...
                                PKIXPolicyNode wrapupCertG = RFC3280CertPathUtilities.wrapupCertG(certPath, build, initialPolicies, i14, arrayListArr2, pKIXPolicyNode2, hashSet4);
