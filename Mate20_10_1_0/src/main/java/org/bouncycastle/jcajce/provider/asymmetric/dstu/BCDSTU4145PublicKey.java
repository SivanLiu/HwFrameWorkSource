    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            if (instance.getObjectAt(0) instanceof ASN1Integer) {
                ...
                x9ECParameters = instance2;
                eCParameterSpec = new org.bouncycastle.jce.spec.ECParameterSpec(instance2.getCurve(), instance2.getG(), instance2.getN(), instance2.getH(), instance2.getSeed());
            } else {
                this.dstuParams = DSTU4145Params.getInstance(instance);
