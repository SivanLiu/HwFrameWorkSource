        ...
        if (str == null) {
            ...
            while (engineGetCertificate != null) {
                ...
                if (extensionValue != null) {
                    try {
                        AuthorityKeyIdentifier instance = AuthorityKeyIdentifier.getInstance(new ASN1InputStream(ASN1OctetString.getInstance(new ASN1InputStream(extensionValue).readObject()).getOctets()).readObject());
            ...
            if (bufferedInputStream.read() == 48) {
                ...
                try {
                    ...
                    if (authSafe.getContentType().equals((ASN1Primitive) data)) {
                        ...
                        while (i4 != contentInfo.length) {
                            if (contentInfo[i4].getContentType().equals((ASN1Primitive) data)) {
                                ASN1Sequence instance2 = ASN1Sequence.getInstance(new ASN1InputStream(ASN1OctetString.getInstance(contentInfo[i4].getContent()).getOctets()).readObject());
                                int i5 = i3;
                                ...
                                i = i4;
                                ASN1Sequence aSN1Sequence3 = (ASN1Sequence) ASN1Primitive.fromByteArray(cryptData(false, instance5.getEncryptionAlgorithm(), cArr, z, instance5.getContent().getOctets()));
                                int i6 = 0;
                                while (i6 != aSN1Sequence3.size()) {
                                    SafeBag instance6 = SafeBag.getInstance(aSN1Sequence3.getObjectAt(i6));
                                    if (instance6.getBagId().equals((ASN1Primitive) certBag)) {
                                        vector.addElement(instance6);
                                        aSN1Sequence = aSN1Sequence3;
                                    } else if (instance6.getBagId().equals((ASN1Primitive) pkcs8ShroudedKeyBag)) {
                                        EncryptedPrivateKeyInfo instance7 = EncryptedPrivateKeyInfo.getInstance(instance6.getBagValue());
                                        PrivateKey unwrapKey2 = unwrapKey(instance7.getEncryptionAlgorithm(), instance7.getEncryptedData(), cArr, z);
                                        ...
                                        String str5 = null;
                                        for (Enumeration objects2 = instance6.getBagAttributes().getObjects(); objects2.hasMoreElements(); objects2 = objects2) {
                                        ...
                                        aSN1Sequence = aSN1Sequence3;
                                        if (instance6.getBagId().equals((ASN1Primitive) keyBag)) {
                                            PrivateKey privateKey = BouncyCastleProvider.getPrivateKey(PrivateKeyInfo.getInstance(instance6.getBagValue()));
                                            ...
                                            String str7 = null;
                                            for (Enumeration objects3 = instance6.getBagAttributes().getObjects(); objects3.hasMoreElements(); objects3 = objects3) {
                                                ASN1Sequence instance8 = ASN1Sequence.getInstance(objects3.nextElement());
                                                ...
                                                if (instance10.size() > 0) {
                                                    ASN1Primitive aSN1Primitive3 = (ASN1Primitive) instance10.getObjectAt(0);
                                                    ASN1Encodable bagAttribute3 = pKCS12BagAttributeCarrier3.getBagAttribute(instance9);
                                                    if (bagAttribute3 == null) {
                                                        pKCS12BagAttributeCarrier3.setBagAttribute(instance9, aSN1Primitive3);
                                                    } else if (!bagAttribute3.toASN1Primitive().equals(aSN1Primitive3)) {
                                                        throw new IOException("attempt to add existing attribute with different value");
                                                    }
                                                    if (instance9.equals((ASN1Primitive) pkcs_9_at_friendlyName)) {
                                                        String string2 = ((DERBMPString) aSN1Primitive3).getString();
                                                        this.keys.put(string2, privateKey);
                                                        str7 = string2;
                                                    } else if (instance9.equals((ASN1Primitive) pkcs_9_at_localKeyId)) {
                    ...
                    while (i7 != vector.size()) {
                        ...
                        CertBag instance11 = CertBag.getInstance(safeBag.getBagValue());
                        if (instance11.getCertId().equals((ASN1Primitive) x509Certificate)) {
                            try {
                                Certificate generateCertificate = this.certFact.generateCertificate(new ByteArrayInputStream(((ASN1OctetString) instance11.getCertValue()).getOctets()));
                                if (safeBag.getBagAttributes() != null) {
                                    Enumeration objects4 = safeBag.getBagAttributes().getObjects();
                                    aSN1OctetString = null;
                                    str = null;
                                    while (objects4.hasMoreElements()) {
                                        ASN1Sequence instance12 = ASN1Sequence.getInstance(objects4.nextElement());
                                        ASN1ObjectIdentifier instance13 = ASN1ObjectIdentifier.getInstance(instance12.getObjectAt(0));
                                        ASN1Set instance14 = ASN1Set.getInstance(instance12.getObjectAt(1));
                                        if (instance14.size() > 0) {
                                            ASN1Primitive aSN1Primitive4 = (ASN1Primitive) instance14.getObjectAt(0);
                                            if (generateCertificate instanceof PKCS12BagAttributeCarrier) {
                                                ...
                                                ASN1Encodable bagAttribute4 = pKCS12BagAttributeCarrier4.getBagAttribute(instance13);
                                                if (bagAttribute4 == null) {
                                                    pKCS12BagAttributeCarrier4.setBagAttribute(instance13, aSN1Primitive4);
                                                } else if (!bagAttribute4.toASN1Primitive().equals(aSN1Primitive4)) {
                                                    throw new IOException("attempt to add existing attribute with different value");
                                                }
                                            }
                                            if (instance13.equals((ASN1Primitive) pkcs_9_at_friendlyName)) {
                                                str = ((DERBMPString) aSN1Primitive4).getString();
                                            } else if (instance13.equals((ASN1Primitive) pkcs_9_at_localKeyId)) {
                            ...
                            throw new RuntimeException("Unsupported certificate type: " + instance11.getCertId());
                        }
                    }
                } catch (Exception e4) {
