...
public class BaseBlockCipher extends BaseWrapCipher implements PBE {
    ...
    @Override // javax.crypto.CipherSpi, org.bouncycastle.jcajce.provider.symmetric.util.BaseWrapCipher
    ...
    public void engineInit(int i, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (!(key instanceof SecretKey)) {
            ...
            if (i2 == 2 || (key instanceof PKCS12Key)) {
                ...
                CipherParameters makePBEParameters = Util.makePBEParameters(pBKDF1Key.getEncoded(), 0, this.digest, this.keySizeInBits, this.ivLength * 8, this.pbeSpec, this.cipher.getAlgorithmName());
                ...
                if (key instanceof PBEKey) {
                    ...
                    CipherParameters makePBEParameters2 = Util.makePBEParameters(pBEKey2.getEncoded(), this.scheme, this.digest, this.keySizeInBits, this.ivLength * 8, this.pbeSpec, this.cipher.getAlgorithmName());
