    ...
    public void engineInit(byte[] bArr) throws IOException {
        try {
            ...
            if (aSN1Sequence.size() == 1) {
                ...
                this.currentSpec = instance.getTagNo() == 0 ? new IESParameterSpec(ASN1OctetString.getInstance(instance, false).getOctets(), null, ASN1Integer.getInstance(aSN1Sequence.getObjectAt(1)).intValueExact()) : new IESParameterSpec(null, ASN1OctetString.getInstance(instance, false).getOctets(), ASN1Integer.getInstance(aSN1Sequence.getObjectAt(1)).intValueExact());
