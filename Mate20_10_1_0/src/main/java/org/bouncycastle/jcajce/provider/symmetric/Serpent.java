...
public final class Serpent {
    ...
    public static class AlgParams extends IvAlgorithmParameters {
        ...
        @Override // org.bouncycastle.jcajce.provider.symmetric.util.IvAlgorithmParameters
    ...
    public static class ECB extends BaseBlockCipher {
        public ECB() {
            super(new BlockCipherProvider() {
                /* class org.bouncycastle.jcajce.provider.symmetric.Serpent.ECB.AnonymousClass1 */
    ...
    public static class TECB extends BaseBlockCipher {
        public TECB() {
            super(new BlockCipherProvider() {
                /* class org.bouncycastle.jcajce.provider.symmetric.Serpent.TECB.AnonymousClass1 */
