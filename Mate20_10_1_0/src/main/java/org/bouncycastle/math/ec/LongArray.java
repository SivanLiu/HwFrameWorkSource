...
class LongArray implements Cloneable {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v14, resolved type: byte */
    /* JADX DEBUG: Multi-variable search result rejected for r3v15, resolved type: byte */
    /* JADX DEBUG: Multi-variable search result rejected for r3v16, resolved type: byte */
    ...
    private static long interleave7(long j) {
        ...
        return (jArr[((int) (j >>> 54)) & Parameter.BARRETT_MULTIPLICATION_III_SPEED] << 6) | (Long.MIN_VALUE & j) | jArr[((int) j) & Parameter.BARRETT_MULTIPLICATION_III_SPEED] | (jArr[((int) (j >>> 9)) & Parameter.BARRETT_MULTIPLICATION_III_SPEED] << 1) | (jArr[((int) (j >>> 18)) & Parameter.BARRETT_MULTIPLICATION_III_SPEED] << 2) | (jArr[((int) (j >>> 27)) & Parameter.BARRETT_MULTIPLICATION_III_SPEED] << 3) | (jArr[((int) (j >>> 36)) & Parameter.BARRETT_MULTIPLICATION_III_SPEED] << 4) | (jArr[((int) (j >>> 45)) & Parameter.BARRETT_MULTIPLICATION_III_SPEED] << 5);
    }
    ...
    public LongArray modMultiply(LongArray longArray, int i, int[] iArr) {
        ...
        shiftUp(jArr3, 0, jArr4, 0, jArr3.length, 4);
        long[] jArr5 = longArray2.m_ints;
        long[] jArr6 = new long[(i4 << 3)];
        for (int i8 = 0; i8 < i2; i8++) {
            long j2 = jArr5[i8];
            int i9 = i8;
            while (true) {
                long j3 = j2 >>> 4;
                addBoth(jArr6, i9, jArr3, iArr2[((int) j2) & 15], jArr4, iArr2[((int) j3) & 15], i5);
                j2 = j3 >>> 4;
                if (j2 == 0) {
                    break;
                }
        ...
        while (true) {
            length -= i4;
            if (length == 0) {
                return reduceResult(jArr6, 0, i4, i, iArr);
            }
            addShiftedUp(jArr6, length - i4, jArr6, length, i4, 8);
        }
    }
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i, int[] iArr) {
        ...
        if (i2 == 1) {
            ...
            multiplyWord(j, longArray2.m_ints, i3, jArr, 0);
        ...
        int i11 = i7;
        interleave(longArray3.m_ints, 0, jArr2, 0, i2, 4);
        System.arraycopy(longArray2.m_ints, 0, jArr2, i2, i3);
        int i12 = i2;
        int i13 = 1;
        while (i13 < 8) {
            int i14 = i12 + i6;
    ...
    public LongArray modMultiplyLD(LongArray longArray, int i, int[] iArr) {
        ...
        while (true) {
            ...
            int i11 = i5;
            while (i11 < i2) {
                int i12 = (int) (jArr5[i11] >>> i9);
                addBoth(jArr6, i11 - 1, jArr3, iArr2[i12 & 15], jArr4, iArr2[(i12 >>> 4) & 15], i6);
                i11 += 2;
                i10 = i10;
            }
            shiftUp(jArr6, 0, i4, i10);
            i9 -= 8;
            i5 = 1;
        }
        for (int i13 = 56; i13 >= 0; i13 -= 8) {
            for (int i14 = 0; i14 < i2; i14 += 2) {
                int i15 = (int) (jArr5[i14] >>> i13);
                addBoth(jArr6, i14, jArr3, iArr2[i15 & 15], jArr4, iArr2[(i15 >>> 4) & 15], i6);
            }
            if (i13 > 0) {
                shiftUp(jArr6, 0, i4, 8);
            }
        }
        return reduceResult(jArr6, 0, i4, i, iArr);
    }
    ...
    public LongArray multiply(LongArray longArray, int i, int[] iArr) {
        ...
        while (true) {
            length -= i4;
            if (length == 0) {
                return new LongArray(jArr6, 0, i4);
            }
            addShiftedUp(jArr6, length - i4, jArr6, length, i4, 8);
        }
    }
