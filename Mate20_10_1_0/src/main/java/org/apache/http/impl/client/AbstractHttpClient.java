...
public abstract class AbstractHttpClient implements HttpClient {
    ...
    private Bundle getHwPermissionInfoReflect(Bundle params) {
        ...
        try {
            ...
            Object obj = hwPermManager.getDeclaredMethod("getInstance", new Class[0]).invoke(null, new Object[0]);
            return (Bundle) hwPermManager.getDeclaredMethod("getHwPermissionInfo", String.class, Integer.TYPE, Long.TYPE, Bundle.class).invoke(obj, null, 0, 0L, params);
