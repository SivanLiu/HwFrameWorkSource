...
public class DoubleMetaphone implements StringEncoder {
    ...
    public String doubleMetaphone(String value, boolean alternate) {
        ...
        while (!result.isComplete() && isSilentStart <= value2.length() - 1) {
            ...
            int index4 = isSilentStart == true ? 1 : 0;
            int index5 = isSilentStart == true ? 1 : 0;
            int index6 = isSilentStart == true ? 1 : 0;
            int index7 = isSilentStart == true ? 1 : 0;
            int index8 = isSilentStart == true ? 1 : 0;
            int index9 = isSilentStart == true ? 1 : 0;
            int index10 = isSilentStart == true ? 1 : 0;
            int index11 = isSilentStart == true ? 1 : 0;
            int index12 = isSilentStart == true ? 1 : 0;
            int index13 = isSilentStart == true ? 1 : 0;
            int index14 = isSilentStart == true ? 1 : 0;
            int index15 = isSilentStart == true ? 1 : 0;
            int index16 = isSilentStart == true ? 1 : 0;
            int index17 = isSilentStart == true ? 1 : 0;
            int index18 = isSilentStart == true ? 1 : 0;
            int index19 = isSilentStart == true ? 1 : 0;
            int index20 = isSilentStart == true ? 1 : 0;
            int index21 = isSilentStart == true ? 1 : 0;
            int index22 = isSilentStart == true ? 1 : 0;
            int index23 = isSilentStart == true ? 1 : 0;
            int index24 = isSilentStart == true ? 1 : 0;
            int index25 = isSilentStart == true ? 1 : 0;
            int index26 = isSilentStart == true ? 1 : 0;
