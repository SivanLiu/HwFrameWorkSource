...
public interface ITouchscreen extends IBase {
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default ITouchscreen asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default ITouchscreen castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default ITouchscreen getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default ITouchscreen getService(boolean retry) throws RemoteException {
        return getService(MemoryConstant.MEM_SCENE_DEFAULT, retry);
    }

    @Override // android.hidl.base.V1_0.IBase
    static default ITouchscreen getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default ITouchscreen getService() throws RemoteException {
    ...
    public static abstract class Stub extends HwBinder implements ITouchscreen {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-22, -48, 58, 41, 34, 66, -22, 118, 22, -13, -49, 122, 16, 97, -94, 105, 84, 86, 75, -26, 56, 24, 122, -3, 65, -124, 67, 36, -58, Byte.MIN_VALUE, -40, -82}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
