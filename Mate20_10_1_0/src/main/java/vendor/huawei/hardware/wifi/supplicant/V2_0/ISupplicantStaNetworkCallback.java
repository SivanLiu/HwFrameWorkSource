...
public interface ISupplicantStaNetworkCallback extends android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetworkCallback {
    ...
    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetworkCallback, android.hidl.base.V1_0.IBase
    static default ISupplicantStaNetworkCallback asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetworkCallback, android.hidl.base.V1_0.IBase
    static default ISupplicantStaNetworkCallback castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetworkCallback, android.hidl.base.V1_0.IBase
    static default ISupplicantStaNetworkCallback getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetworkCallback, android.hidl.base.V1_0.IBase
    static default ISupplicantStaNetworkCallback getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetworkCallback, android.hidl.base.V1_0.IBase
    static default ISupplicantStaNetworkCallback getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetworkCallback, android.hidl.base.V1_0.IBase
    static default ISupplicantStaNetworkCallback getService() throws RemoteException {
    ...
    public static final class Proxy implements ISupplicantStaNetworkCallback {
        ...
        @Override // vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicantStaNetworkCallback, android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetworkCallback, android.hidl.base.V1_0.IBase
        ...
        @Override // vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicantStaNetworkCallback
    ...
    public static abstract class Stub extends HwBinder implements ISupplicantStaNetworkCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{58, -113, 64, -126, -22, 43, 113, -123, 117, 2, -125, -38, -15, 107, 88, -17, Byte.MIN_VALUE, 16, 44, -73, 91, -3, 12, -10, -46, -56, 56, -14, -82, 63, -38, -117}, new byte[]{-40, -16, -121, 122, -31, -45, 33, -63, -40, -124, -57, 99, 29, -2, 54, -54, -80, -20, -118, 75, 40, 99, -44, -74, -121, -8, 93, 53, 73, -90, 59, -52}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
