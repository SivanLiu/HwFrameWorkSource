...
public interface ISupplicantP2pIfaceCallback extends android.hardware.wifi.supplicant.V1_0.ISupplicantP2pIfaceCallback {
    public static final String kInterfaceName = "vendor.huawei.hardware.wifi.supplicant@3.0::ISupplicantP2pIfaceCallback";
    ...
    void notifyP2pIfaceEvent(int i, String str) throws RemoteException;

    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantP2pIfaceCallback, android.hidl.base.V1_0.IBase
    void notifySyspropsChanged() throws RemoteException;

    void onHwDeviceFound(byte[] bArr, byte[] bArr2, byte[] bArr3, String str, short s, byte b, int i, byte[] bArr4) throws RemoteException;
    ...
    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantP2pIfaceCallback, android.hidl.base.V1_0.IBase
    static default ISupplicantP2pIfaceCallback asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantP2pIfaceCallback, android.hidl.base.V1_0.IBase
    static default ISupplicantP2pIfaceCallback castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantP2pIfaceCallback, android.hidl.base.V1_0.IBase
    static default ISupplicantP2pIfaceCallback getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantP2pIfaceCallback, android.hidl.base.V1_0.IBase
    static default ISupplicantP2pIfaceCallback getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantP2pIfaceCallback, android.hidl.base.V1_0.IBase
    static default ISupplicantP2pIfaceCallback getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantP2pIfaceCallback, android.hidl.base.V1_0.IBase
    static default ISupplicantP2pIfaceCallback getService() throws RemoteException {
    ...
    public static final class Proxy implements ISupplicantP2pIfaceCallback {
        ...
        @Override // vendor.huawei.hardware.wifi.supplicant.V3_0.ISupplicantP2pIfaceCallback, android.hardware.wifi.supplicant.V1_0.ISupplicantP2pIfaceCallback, android.hidl.base.V1_0.IBase
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.wifi.supplicant@3.0::ISupplicantP2pIfaceCallback]@Proxy";
            }
        }
        ...
        @Override // vendor.huawei.hardware.wifi.supplicant.V3_0.ISupplicantP2pIfaceCallback
        public void onHwDeviceFound(byte[] srcAddress, byte[] p2pDeviceAddress, byte[] primaryDeviceType, String deviceName, short configMethods, byte deviceCapabilities, int groupCapabilities, byte[] wfdDeviceInfo) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            ...
            _hidl_request.writeInt8(deviceCapabilities);
            _hidl_request.writeInt32(groupCapabilities);
            HwBlob _hidl_blob4 = new HwBlob(128);
            if (wfdDeviceInfo == null || wfdDeviceInfo.length != 128) {
                throw new IllegalArgumentException("Array element is not of the expected length");
            }
            _hidl_blob4.putInt8Array(0, wfdDeviceInfo);
            _hidl_request.writeBuffer(_hidl_blob4);
        ...
        @Override // vendor.huawei.hardware.wifi.supplicant.V3_0.ISupplicantP2pIfaceCallback
        public void notifyP2pIfaceEvent(int notifyType, String stringData) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(ISupplicantP2pIfaceCallback.kInterfaceName);
    ...
    public static abstract class Stub extends HwBinder implements ISupplicantP2pIfaceCallback {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(ISupplicantP2pIfaceCallback.kInterfaceName, android.hardware.wifi.supplicant.V1_0.ISupplicantP2pIfaceCallback.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-87, 8, -14, -110, -44, -48, -100, -106, 114, -21, Byte.MAX_VALUE, 69, 97, -7, 24, -78, -38, 28, -78, -5, -112, -20, -38, -120, 15, -122, 101, 18, Byte.MAX_VALUE, -17, 77, -64}, new byte[]{-117, 99, -11, -17, -94, -29, -66, 58, 124, -72, -92, 40, 118, 13, -126, 40, 90, 74, -73, -101, -53, -34, -90, -17, -112, -86, 84, 117, 85, -27, -126, -44}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        /* JADX INFO: Multiple debug info for r2v13 byte[]: [D('_hidl_blob' android.os.HwBlob), D('p2pDeviceAddress' byte[])] */
        /* JADX INFO: Multiple debug info for r2v15 byte[]: [D('_hidl_blob' android.os.HwBlob), D('p2pDeviceAddress' byte[])] */
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 18:
                    ...
                    byte[] srcAddress7 = new byte[6];
                    _hidl_request.readBuffer(6).copyToInt8Array(0, srcAddress7, 6);
                    byte[] p2pDeviceAddress6 = new byte[6];
                    _hidl_request.readBuffer(6).copyToInt8Array(0, p2pDeviceAddress6, 6);
                    byte[] primaryDeviceType2 = new byte[8];
                    _hidl_request.readBuffer(8).copyToInt8Array(0, primaryDeviceType2, 8);
                    String deviceName2 = _hidl_request.readString();
                    short configMethods2 = _hidl_request.readInt16();
                    byte deviceCapabilities2 = _hidl_request.readInt8();
                    int groupCapabilities2 = _hidl_request.readInt32();
                    byte[] wfdDeviceInfo2 = new byte[128];
                    _hidl_request.readBuffer(128).copyToInt8Array(0, wfdDeviceInfo2, 128);
                    onHwDeviceFound(srcAddress7, p2pDeviceAddress6, primaryDeviceType2, deviceName2, configMethods2, deviceCapabilities2, groupCapabilities2, wfdDeviceInfo2);
                    return;
                case 19:
                    if (_hidl_flags != false && true) {
                        _hidl_is_oneway = true;
                ...
                case 20:
                    ...
                    _hidl_request.enforceInterface(ISupplicantP2pIfaceCallback.kInterfaceName);
                    notifyP2pIfaceEvent(_hidl_request.readInt32(), _hidl_request.readString());
                    return;
                default:
                    switch (_hidl_code) {
                        case 256067662:
