...
public interface ISupplicant extends android.hardware.wifi.supplicant.V1_1.ISupplicant {
    public static final String kInterfaceName = "vendor.huawei.hardware.wifi.supplicant@2.0::ISupplicant";

    @Override // android.hardware.wifi.supplicant.V1_1.ISupplicant, android.hardware.wifi.supplicant.V1_0.ISupplicant, android.hidl.base.V1_0.IBase
    IHwBinder asBinder();
    ...
    @Override // android.hardware.wifi.supplicant.V1_1.ISupplicant, android.hardware.wifi.supplicant.V1_0.ISupplicant, android.hidl.base.V1_0.IBase
    static default ISupplicant asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hardware.wifi.supplicant.V1_1.ISupplicant, android.hardware.wifi.supplicant.V1_0.ISupplicant, android.hidl.base.V1_0.IBase
    static default ISupplicant castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hardware.wifi.supplicant.V1_1.ISupplicant, android.hardware.wifi.supplicant.V1_0.ISupplicant, android.hidl.base.V1_0.IBase
    static default ISupplicant getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // android.hardware.wifi.supplicant.V1_1.ISupplicant, android.hardware.wifi.supplicant.V1_0.ISupplicant, android.hidl.base.V1_0.IBase
    static default ISupplicant getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    @Override // android.hardware.wifi.supplicant.V1_1.ISupplicant, android.hardware.wifi.supplicant.V1_0.ISupplicant, android.hidl.base.V1_0.IBase
    static default ISupplicant getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hardware.wifi.supplicant.V1_1.ISupplicant, android.hardware.wifi.supplicant.V1_0.ISupplicant, android.hidl.base.V1_0.IBase
    static default ISupplicant getService() throws RemoteException {
    ...
    public static final class Proxy implements ISupplicant {
        ...
        @Override // vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicant, android.hardware.wifi.supplicant.V1_1.ISupplicant, android.hardware.wifi.supplicant.V1_0.ISupplicant, android.hidl.base.V1_0.IBase
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.wifi.supplicant@2.0::ISupplicant]@Proxy";
            }
        }
        ...
        public void addInterface(IfaceInfo ifaceInfo, addInterfaceCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
        ...
        @Override // android.hardware.wifi.supplicant.V1_1.ISupplicant
        public SupplicantStatus removeInterface(IfaceInfo ifaceInfo) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.wifi.supplicant.V1_1.ISupplicant.kInterfaceName);
            ifaceInfo.writeToParcel(_hidl_request);
            HwParcel _hidl_reply = new HwParcel();
    ...
    public static abstract class Stub extends HwBinder implements ISupplicant {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(ISupplicant.kInterfaceName, android.hardware.wifi.supplicant.V1_1.ISupplicant.kInterfaceName, android.hardware.wifi.supplicant.V1_0.ISupplicant.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-48, -60, -22, -10, 6, 98, 64, -13, 119, -7, 7, -34, -63, -121, -74, -102, -93, -89, 95, 21, -91, -16, 11, 111, 69, -37, 15, -25, -91, -121, 116, -97}, new byte[]{-29, 98, 32, 59, -108, 31, 24, -67, 76, -70, 41, -90, 42, -33, -96, 36, 83, -19, 0, -42, -66, 91, 114, -51, -74, -60, -41, -32, -65, 57, 74, 64}, new byte[]{-9, -27, 92, 8, 24, 125, -116, -123, 80, 104, -95, -18, 61, 12, -115, -82, -18, 117, 112, 41, 45, -106, 80, -100, 33, -88, 117, 109, 79, 92, -5, -101}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    getInterface(ifaceInfo, new getInterfaceCallback() {
                        /* class vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicant.Stub.AnonymousClass1 */
                ...
                case 2:
                    ...
                    listInterfaces(new listInterfacesCallback() {
                        /* class vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicant.Stub.AnonymousClass2 */
                ...
                case 9:
                    ...
                    IfaceInfo ifaceInfo2 = new IfaceInfo();
                    ifaceInfo2.readFromParcel(_hidl_request);
                    addInterface(ifaceInfo2, new addInterfaceCallback() {
                        /* class vendor.huawei.hardware.wifi.supplicant.V2_0.ISupplicant.Stub.AnonymousClass3 */
                ...
                case 10:
                    ...
                    _hidl_request.enforceInterface(android.hardware.wifi.supplicant.V1_1.ISupplicant.kInterfaceName);
                    IfaceInfo ifaceInfo3 = new IfaceInfo();
