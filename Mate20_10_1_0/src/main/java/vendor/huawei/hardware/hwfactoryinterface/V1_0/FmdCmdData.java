...
public final class FmdCmdData {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.commandId = _hidl_blob.getInt32(_hidl_offset + 4);
        this.operation = _hidl_blob.getInt32(_hidl_offset + 8);
        this.cycle = _hidl_blob.getInt32(_hidl_offset + 12);
        this.station = _hidl_blob.getString(_hidl_offset + 16);
        parcel.readEmbeddedBuffer((long) (this.station.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 16 + 0, false);
        this.bsn = _hidl_blob.getString(_hidl_offset + 32);
