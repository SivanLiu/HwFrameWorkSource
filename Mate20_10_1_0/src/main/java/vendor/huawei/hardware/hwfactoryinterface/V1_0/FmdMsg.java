...
public final class FmdMsg {
    ...
    public ArrayList<FmdEvent> events = new ArrayList<>();
    ...
    public final int hashCode() {
        return Objects.hash(Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.version))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.dataSource))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.numEvents))), Integer.valueOf(HidlSupport.deepHashCode(this.events)));
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        this.version = _hidl_blob.getInt32(_hidl_offset + 0);
        this.dataSource = _hidl_blob.getInt32(_hidl_offset + 4);
        this.numEvents = _hidl_blob.getInt32(_hidl_offset + 8);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            this.events.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 192));
        }
