...
public interface IHwFactoryInterface extends vendor.huawei.hardware.hwfactoryinterface.V1_0.IHwFactoryInterface {
    ...
    @Override // vendor.huawei.hardware.hwfactoryinterface.V1_0.IHwFactoryInterface, android.hidl.base.V1_0.IBase
    IHwBinder asBinder();
    ...
    @Override // vendor.huawei.hardware.hwfactoryinterface.V1_0.IHwFactoryInterface, android.hidl.base.V1_0.IBase
    static default IHwFactoryInterface asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // vendor.huawei.hardware.hwfactoryinterface.V1_0.IHwFactoryInterface, android.hidl.base.V1_0.IBase
    static default IHwFactoryInterface castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // vendor.huawei.hardware.hwfactoryinterface.V1_0.IHwFactoryInterface, android.hidl.base.V1_0.IBase
    static default IHwFactoryInterface getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // vendor.huawei.hardware.hwfactoryinterface.V1_0.IHwFactoryInterface, android.hidl.base.V1_0.IBase
    static default IHwFactoryInterface getService(boolean retry) throws RemoteException {
        return getService(MemoryConstant.MEM_SCENE_DEFAULT, retry);
    }

    @Override // vendor.huawei.hardware.hwfactoryinterface.V1_0.IHwFactoryInterface, android.hidl.base.V1_0.IBase
    static default IHwFactoryInterface getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // vendor.huawei.hardware.hwfactoryinterface.V1_0.IHwFactoryInterface, android.hidl.base.V1_0.IBase
    static default IHwFactoryInterface getService() throws RemoteException {
    ...
    public static final class Proxy implements IHwFactoryInterface {
        ...
        @Override // vendor.huawei.hardware.hwfactoryinterface.V1_0.IHwFactoryInterface, vendor.huawei.hardware.hwfactoryinterface.V1_1.IHwFactoryInterface, android.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IHwFactoryInterface {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-75, 50, -118, 19, 78, 94, 115, -20, -50, 77, 42, 71, -79, 76, -28, -47, 95, 76, 107, 103, 37, 89, -55, -80, 112, 122, -14, 0, -39, 46, 84, 66}, new byte[]{0, -64, -60, -54, -7, 16, -101, 116, -97, 11, -68, 114, -43, 7, 48, -104, 68, 88, -69, 22, -36, -110, -69, 49, 115, 90, -67, -114, -86, 118, 31, 28}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
