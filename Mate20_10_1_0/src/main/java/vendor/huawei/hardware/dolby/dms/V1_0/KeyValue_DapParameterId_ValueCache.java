...
public final class KeyValue_DapParameterId_ValueCache {
    public int key;
    public ValueCache value = new ValueCache();
    ...
    public final int hashCode() {
        return Objects.hash(Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.key))), Integer.valueOf(HidlSupport.deepHashCode(this.value)));
    }

    public final String toString() {
        return "{" + ".key = " + DapParameterId.toString(this.key) + ", .value = " + this.value + "}";
    }
