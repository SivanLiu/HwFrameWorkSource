...
public interface IDms extends IBase {
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IDms asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IDms castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IDms getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IDms getService(boolean retry) throws RemoteException {
        return getService(MemoryConstant.MEM_SCENE_DEFAULT, retry);
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IDms getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IDms getService() throws RemoteException {
    ...
    public static abstract class Stub extends HwBinder implements IDms {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{4, -48, -117, -1, 0, 78, 52, 116, -115, 56, 56, 16, -107, -8, -70, 53, -52, -121, 66, -89, -52, -114, 9, 74, 118, -109, -38, 44, -51, -45, 74, -27}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
