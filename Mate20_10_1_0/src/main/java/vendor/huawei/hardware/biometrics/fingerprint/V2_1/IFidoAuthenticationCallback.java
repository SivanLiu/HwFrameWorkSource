...
public interface IFidoAuthenticationCallback extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IFidoAuthenticationCallback {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IFidoAuthenticationCallback.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{76, -50, -80, -40, -87, 72, -64, -79, -57, 67, -66, -29, -21, -95, -8, -96, -50, -17, 81, -79, 61, -19, -4, -65, 7, -32, -99, -69, 106, -106, -86, -87}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    _hidl_request.enforceInterface(IFidoAuthenticationCallback.kInterfaceName);
