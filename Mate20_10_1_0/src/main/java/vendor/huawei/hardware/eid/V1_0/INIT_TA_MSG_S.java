...
public final class INIT_TA_MSG_S {
    public byte[] eid_aid = new byte[256];
    public int eid_aid_len;
    public byte[] eid_logo = new byte[24576];
    public byte[] hw_aid = new byte[256];
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        byte[] _hidl_array_item_0 = this.hw_aid;
        if (_hidl_array_item_0 == null || _hidl_array_item_0.length != 256) {
        ...
        long _hidl_array_offset_02 = 260 + _hidl_offset;
        byte[] _hidl_array_item_02 = this.eid_aid;
        if (_hidl_array_item_02 == null || _hidl_array_item_02.length != 256) {
            throw new IllegalArgumentException("Array element is not of the expected length");
        }
        _hidl_blob.putInt8Array(_hidl_array_offset_02, _hidl_array_item_02);
        _hidl_blob.putInt32(516 + _hidl_offset, this.eid_aid_len);
        long _hidl_array_offset_03 = 520 + _hidl_offset;
        byte[] _hidl_array_item_03 = this.eid_logo;
        if (_hidl_array_item_03 == null || _hidl_array_item_03.length != 24576) {
            throw new IllegalArgumentException("Array element is not of the expected length");
        }
