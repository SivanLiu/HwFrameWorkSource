...
public final class IMAGE_CONTAINER_S {
    public byte[] image = new byte[153600];
    public int len;
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<IMAGE_CONTAINER_S> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            _hidl_vec.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 153604));
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        if (_hidl_array_item_0 == null || _hidl_array_item_0.length != 153600) {
