...
public final class SEC_IMAGE_ZIP_S {
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<SEC_IMAGE_ZIP_S> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            _hidl_vec.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 133128));
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        if (_hidl_array_item_0 == null || _hidl_array_item_0.length != 131072) {
            throw new IllegalArgumentException("Array element is not of the expected length");
        }
        _hidl_blob.putInt8Array(_hidl_array_offset_0, _hidl_array_item_0);
        long _hidl_array_offset_02 = 131080 + _hidl_offset;
