...
public interface IEid extends vendor.huawei.hardware.eid.V1_0.IEid {
    ...
    @Override // vendor.huawei.hardware.eid.V1_0.IEid, android.hidl.base.V1_0.IBase
    static default IEid asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // vendor.huawei.hardware.eid.V1_0.IEid, android.hidl.base.V1_0.IBase
    static default IEid castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // vendor.huawei.hardware.eid.V1_0.IEid, android.hidl.base.V1_0.IBase
    static default IEid getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // vendor.huawei.hardware.eid.V1_0.IEid, android.hidl.base.V1_0.IBase
    static default IEid getService(boolean retry) throws RemoteException {
        return getService(MemoryConstant.MEM_SCENE_DEFAULT, retry);
    }

    @Override // vendor.huawei.hardware.eid.V1_0.IEid, android.hidl.base.V1_0.IBase
    static default IEid getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // vendor.huawei.hardware.eid.V1_0.IEid, android.hidl.base.V1_0.IBase
    static default IEid getService() throws RemoteException {
    ...
    public static final class Proxy implements IEid {
        ...
        @Override // vendor.huawei.hardware.eid.V1_1.IEid, vendor.huawei.hardware.eid.V1_0.IEid, android.hidl.base.V1_0.IBase
        ...
        @Override // vendor.huawei.hardware.eid.V1_1.IEid
    ...
    public static abstract class Stub extends HwBinder implements IEid {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IEid.kInterfaceName, vendor.huawei.hardware.eid.V1_0.IEid.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-33, 86, -60, 63, 76, 2, 44, -2, -3, -93, -85, -96, -35, -83, -82, -123, 106, -2, HwUibcReceiver.CurrentPacket.INPUT_MASK, 93, -55, 30, -29, -65, -116, 104, 89, 37, -75, -116, 39, -118}, new byte[]{-9, 116, 21, 40, -67, -90, 68, 123, 54, -54, -100, -25, 87, 47, -76, -32, 40, 116, -86, 99, 114, -86, 27, -123, 11, 63, -9, 27, -89, 34, 105, -105}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
            ...
            switch (_hidl_code) {
                ...
                case 3:
                    ...
                    HWEidGetImage(factor, new HWEidGetImageCallback() {
                        /* class vendor.huawei.hardware.eid.V1_1.IEid.Stub.AnonymousClass1 */
                ...
                case 4:
                    ...
                    HWEidGetUnsecImage(container, factor2, new HWEidGetUnsecImageCallback() {
                        /* class vendor.huawei.hardware.eid.V1_1.IEid.Stub.AnonymousClass2 */
                ...
                case 5:
                    ...
                    HWEidGetCertificateRequestMessage(input, new HWEidGetCertificateRequestMessageCallback() {
                        /* class vendor.huawei.hardware.eid.V1_1.IEid.Stub.AnonymousClass3 */
                ...
                case 6:
                    ...
                    HWEidGetInfoSign(input2, new HWEidGetInfoSignCallback() {
                        /* class vendor.huawei.hardware.eid.V1_1.IEid.Stub.AnonymousClass4 */
                ...
                case 7:
                    ...
                    HWEidGetIdentityInformation(input3, new HWEidGetIdentityInformationCallback() {
                        /* class vendor.huawei.hardware.eid.V1_1.IEid.Stub.AnonymousClass5 */
                ...
                case 8:
                    ...
                    HWEidGetFaceIsChanged(input4, new HWEidGetFaceIsChangedCallback() {
                        /* class vendor.huawei.hardware.eid.V1_1.IEid.Stub.AnonymousClass6 */
                ...
                case 9:
                    ...
                    int _hidl_out_ret3 = HWCtidGetImage();
                    _hidl_reply.writeStatus(0);
                ...
                case 10:
                    ...
                    _hidl_request.enforceInterface(IEid.kInterfaceName);
                    int _hidl_out_ret4 = HWCtidSetSecMode();
                    _hidl_reply.writeStatus(0);
                ...
                case 11:
                    ...
                    int _hidl_out_ret5 = HWCtidInitTa(init_msg2);
                    _hidl_reply.writeStatus(0);
                ...
                case 12:
                    ...
                    _hidl_request.enforceInterface(IEid.kInterfaceName);
                    IMAGE_ZIP_CONTAINER_S container2 = new IMAGE_ZIP_CONTAINER_S();
                    ...
                    HWEidGetSecImageZip(container2, coordinate, factor3, new HWEidGetSecImageZipCallback() {
                        /* class vendor.huawei.hardware.eid.V1_1.IEid.Stub.AnonymousClass7 */
                ...
                case 13:
                    ...
                    _hidl_request.enforceInterface(IEid.kInterfaceName);
                    IMAGE_ZIP_CONTAINER_S container3 = new IMAGE_ZIP_CONTAINER_S();
                    container3.readFromParcel(_hidl_request);
                    ENCRYPTION_FACTOR_S factor4 = new ENCRYPTION_FACTOR_S();
                    factor4.readFromParcel(_hidl_request);
                    HWEidGetUnsecImageZip(container3, factor4, new HWEidGetUnsecImageZipCallback() {
                        /* class vendor.huawei.hardware.eid.V1_1.IEid.Stub.AnonymousClass8 */
                ...
                case 14:
                    ...
                    HWEidGetVersion(new HWEidGetVersionCallback() {
                        /* class vendor.huawei.hardware.eid.V1_1.IEid.Stub.AnonymousClass9 */
