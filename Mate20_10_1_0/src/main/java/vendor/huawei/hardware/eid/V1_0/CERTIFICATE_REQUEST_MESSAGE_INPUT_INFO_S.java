...
public final class CERTIFICATE_REQUEST_MESSAGE_INPUT_INFO_S {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject != null && otherObject.getClass() == CERTIFICATE_REQUEST_MESSAGE_INPUT_INFO_S.class && this.rsv == ((CERTIFICATE_REQUEST_MESSAGE_INPUT_INFO_S) otherObject).rsv) {
            return true;
        }
        return false;
    }
