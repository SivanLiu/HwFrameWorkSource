...
public final class IDENTITY_INFORMATION_S {
    public byte[] info = new byte[5120];
    public int len;
    ...
    public final int hashCode() {
        return Objects.hash(Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.len))), Integer.valueOf(HidlSupport.deepHashCode(this.info)));
    }

    public final String toString() {
        return "{" + ".len = " + this.len + ", .info = " + Arrays.toString(this.info) + "}";
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<IDENTITY_INFORMATION_S> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            _hidl_vec.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 5124));
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        if (_hidl_array_item_0 == null || _hidl_array_item_0.length != 5120) {
