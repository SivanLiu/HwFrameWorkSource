...
public final class INIT_CTID_TA_MSG_S {
    public int[] cmd_list = new int[32];
    public int cmdlist_cnt;
    public byte[] ta_path = new byte[512];
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        byte[] _hidl_array_item_0 = this.uuid;
        ...
        byte[] _hidl_array_item_02 = this.ta_path;
        if (_hidl_array_item_02 == null || _hidl_array_item_02.length != 512) {
            throw new IllegalArgumentException("Array element is not of the expected length");
        }
        _hidl_blob.putInt8Array(_hidl_array_offset_02, _hidl_array_item_02);
        _hidl_blob.putInt32(532 + _hidl_offset, this.ta_path_len);
        long _hidl_array_offset_03 = 536 + _hidl_offset;
        int[] _hidl_array_item_03 = this.cmd_list;
        if (_hidl_array_item_03 == null || _hidl_array_item_03.length != 32) {
            throw new IllegalArgumentException("Array element is not of the expected length");
        }
        _hidl_blob.putInt32Array(_hidl_array_offset_03, _hidl_array_item_03);
