...
public final class DisplayEngineAreParam {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.mode == other.mode && this.level == other.level && this.threshold == other.threshold) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hash(Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.mode))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.level))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.threshold))));
    }

    public final String toString() {
        return "{" + ".mode = " + this.mode + ", .level = " + this.level + ", .threshold = " + this.threshold + "}";
    }
