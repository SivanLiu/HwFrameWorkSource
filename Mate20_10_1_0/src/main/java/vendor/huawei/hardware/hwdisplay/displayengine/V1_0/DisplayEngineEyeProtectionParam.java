...
public final class DisplayEngineEyeProtectionParam {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.enable == other.enable && this.rGamma == other.rGamma && this.gGamma == other.gGamma && this.bGamma == other.bGamma) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return Objects.hash(Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.enable))), Integer.valueOf(HidlSupport.deepHashCode(Float.valueOf(this.rGamma))), Integer.valueOf(HidlSupport.deepHashCode(Float.valueOf(this.gGamma))), Integer.valueOf(HidlSupport.deepHashCode(Float.valueOf(this.bGamma))));
    }

    public final String toString() {
        return "{" + ".enable = " + this.enable + ", .rGamma = " + this.rGamma + ", .gGamma = " + this.gGamma + ", .bGamma = " + this.bGamma + "}";
    }
