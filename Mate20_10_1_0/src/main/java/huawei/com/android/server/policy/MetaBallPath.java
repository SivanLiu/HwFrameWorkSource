...
public class MetaBallPath {
    ...
    public Handler mHandler = new BallHandler();
    Interpolator mInterpolatorMove = new PathInterpolator(CONTROL_X1, CONTROL_Y1, 0.1f, 0.85f);
    /* access modifiers changed from: private */
    public boolean mIsStopManual = false;
    float mMetaLimit;
    float mRadiusBall;
    float mRadiusCircle;
    ...
    /* access modifiers changed from: private */
    public void circle2Rect(float cx, float cy, float r, RectF rect) {
