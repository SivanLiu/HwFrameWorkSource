...
public class StylusGestureManager {
    ...
    public static final int MPEN_DFLT_VALUE = (SystemProperties.getBoolean("ro.mpen.default.support", true) ? 1 : 0);
    /* access modifiers changed from: private */
    ...
    private void initStylusStateObserver() {
        ...
        this.mStylusObserver = new ContentObserver(null) {
            ...
            public void onChange(boolean isSelfChange) {
                ...
                int unused = stylusGestureManager.mStylusState = Settings.System.getIntForUser(stylusGestureManager.mContext.getContentResolver(), StylusGestureManager.KEY_STYLUS_STATE_ENABLE, StylusGestureManager.MPEN_DFLT_VALUE, ActivityManager.getCurrentUser());
    ...
    private void initStylusIntroducedObserver() {
        ...
        this.mStylusIntroduceObserver = new ContentObserver(null) {
            ...
            public void onChange(boolean isSelfChange) {
                StylusGestureManager stylusGestureManager = StylusGestureManager.this;
                int unused = stylusGestureManager.mStylusIntroduced = Settings.System.getIntForUser(stylusGestureManager.mContext.getContentResolver(), StylusGestureManager.KEY_STYLUS_STATE_INTRODUCE, StylusGestureManager.STYLUS_INTRODUCED_NO, ActivityManager.getCurrentUser());
