...
public class ShutdownMenuAnimations {
    ...
    private static final int ID_REBOOT_SCREENBLACK = 34603432;
    ...
    /* access modifiers changed from: private */
    public AnimatorSet mAnimFocusEnterSet;
    private AnimatorSet mAnimFocusExitSet;
    private View mCircleView;
    /* access modifiers changed from: private */
    public AnimatorSet mConfirmSet;
    ...
    /* access modifiers changed from: private */
    public View mViewConfirmAction;
    /* access modifiers changed from: private */
    public View mViewFourAction;
    /* access modifiers changed from: private */
    public View mViewTwoAction;
    /* access modifiers changed from: private */
    ...
    public AnimatorSet setImageAnimation(boolean isEnter) {
        ...
        while (i < size2) {
            ...
            if (view != null) {
                switch (view.getId()) {
                    case ID_AIRPLANEMODE_RESOURCE /*{ENCODED_INT: 34603145}*/:
                        ...
                        break;
                    case ID_SILENTMODE_RESOURCE /*{ENCODED_INT: 34603146}*/:
                        ...
                        break;
                    case ID_REBOOT_RESOURCE /*{ENCODED_INT: 34603151}*/:
                        ...
                        break;
                    case ID_SHUTDOWN_RESOURCE /*{ENCODED_INT: 34603152}*/:
    ...
    private void startConfirmEnterOrExitAnim(final View view, final boolean isEnter, final boolean isReboot) {
        ...
        if (this.ROTATION == ROTATION_NINETY) {
            ...
            if (!(Settings.System.getInt(mContext.getContentResolver(), "navigationbar_is_min", 0) != 0)) {
                int navigationBarHeight = mContext.getResources().getDimensionPixelSize(17105305);
    ...
    public void newShutdownOrRebootEnterAnim(View view) {
        ...
        int[] iArr = this.imageLocationEnd;
        iArr[0] = iArr[0] + (view.getWidth() / 2);
        if (!(this.mViewConfirmAction == null || (view2 = this.warning_list_view) == null)) {
            view2.setAlpha(0.0f);
            this.mViewConfirmAction.setVisibility(0);
        }
        ...
        if (this.isAnimRunning || view == null) {
            ...
            if (animatorSet == null || !animatorSet.isRunning()) {
                ...
                this.mShutdownEnterSet.addListener(new Animator.AnimatorListener() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        ShutdownMenuAnimations.this.endNewConfirmEnterOrExitAnim(view, isEnter);
                    }
    ...
    public void endNewConfirmEnterOrExitAnim(View view, boolean isEnter) {
        ...
        View view4 = this.mViewConfirmAction;
        if (view4 != null) {
            view4.findViewById(34603108).performAccessibilityAction(64, null);
        }
    }
    ...
    /* access modifiers changed from: private */
    public ObjectAnimator newAlphaFadeIn(TextView confirmMessageView, View menuView, String confirmText, String menutext, boolean isEnter) {
        ...
        if (object instanceof AnimatorSet) {
            ...
            this.mAnimFocusEnterSet.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    AnimatorSet unused = ShutdownMenuAnimations.this.mAnimFocusEnterSet = null;
                }
            });
    ...
    /* access modifiers changed from: private */
    public void onFocusEnterAnimStart(Context context, View layoutView, int resBackgroundId, int resDrawableId) {
    ...
    private void onFocusExit(final Context context, View view, HwGlobalActionsView.InnerResCollection innerResCollection) {
        int layoutId = innerResCollection.getResLayoutId();
        Object objectFirst = AnimatorInflater.loadAnimator(mContext, 34144257);
        Object objectSecond = AnimatorInflater.loadAnimator(mContext, 34144258);
    ...
    /* access modifiers changed from: private */
    public void onFocusExitAnimEnd(Context context, View layoutView, int resBackgroundId, int resDrawableId) {
        onFocusChangeStart(context, layoutView, resBackgroundId, resDrawableId);
        TypedValue outValue = new TypedValue();
    ...
    private AnimatorSet setConfirmEnterAnim(View layoutView) {
        ...
        Object object = AnimatorInflater.loadAnimator(mContext, 34144259);
        if (object instanceof AnimatorSet) {
    ...
    public AnimatorSet getFocusConfirmEnterAnim(Context context, boolean isTelevisionMode, int layoutId) {
        if (isTelevisionMode) {
            ...
            if (view != null) {
                return setConfirmEnterAnim(view);
            }
