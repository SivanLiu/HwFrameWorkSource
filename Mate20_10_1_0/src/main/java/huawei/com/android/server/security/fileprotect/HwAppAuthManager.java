...
public class HwAppAuthManager {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0049, code lost:
        if (r5.hasNext() == false) goto L_0x005b;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x005f, code lost:
        if (r4.isEmpty() == false) goto L_0x0069;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x0061, code lost:
        android.util.Slog.d(huawei.com.android.server.security.fileprotect.HwAppAuthManager.TAG, "No App is protected");
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x0069, code lost:
        ...
        android.util.Slog.i(huawei.com.android.server.security.fileprotect.HwAppAuthManager.TAG, "PerformanceTag(notifyPMSReady:" + (java.lang.System.nanoTime() - r0) + ")");
     */
    ...
    private void loadHistoryPackages() {
        ...
        if (context != null && (contentResolver = context.getContentResolver()) != null && Settings.Secure.getInt(contentResolver, HISTORY_VERSION, 0) == 1) {
            ...
            if (!TextUtils.isEmpty(packageHistory) && (pkgs = packageHistory.split("#")) != null && pkgs.length >= 1) {
    ...
    private void saveHistoryPackages() {
        ...
        if (context != null && (contentResolver = context.getContentResolver()) != null) {
            ...
            if (!Settings.Secure.putInt(contentResolver, HISTORY_VERSION, 1)) {
                Slog.e(TAG, "save version failed for : 1");
    ...
    private static final class HwaaDisabledManager extends HwAppAuthManager {
        ...
        @Override // huawei.com.android.server.security.fileprotect.HwAppAuthManager
        public void checkFileProtect(PackageParser.Package pkg) {
        }
