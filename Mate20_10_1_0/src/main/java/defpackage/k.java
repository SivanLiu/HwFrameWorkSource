        ...
        try {
            ...
            if (dynamicFeatureState == 0 || 5 == dynamicFeatureState) {
                ...
                if (5 == dynamicFeatureState) {
                    ...
                    Log.d(FeatureLocalInstallManager.TAG, "rename : " + loadingFile.renameTo(new File(InstallStorageManager.getUnverifyApksDir(this.l.mContext), loadingFile.getName())));
