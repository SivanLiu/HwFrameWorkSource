            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 22:
                        ...
                        return true;
                    case TRANSACTION_destroyProfileSnapshot /*{ENCODED_INT: 23}*/:
                        data.enforceInterface(DESCRIPTOR);
                        destroyProfileSnapshot(data.readString(), data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_idmap /*{ENCODED_INT: 24}*/:
                        data.enforceInterface(DESCRIPTOR);
                        idmap(data.readString(), data.readString(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_removeIdmap /*{ENCODED_INT: 25}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 26:
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_markBootComplete /*{ENCODED_INT: 27}*/:
                        data.enforceInterface(DESCRIPTOR);
                        markBootComplete(data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_freeCache /*{ENCODED_INT: 28}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 45:
                        ...
                        return true;
                    case TRANSACTION_executeBackupTask /*{ENCODED_INT: 46}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 51:
                        ...
                        getDexFileStatus(_arg0, _arg1, _arg2, _arg3);
                        reply.writeNoException();
                    ...
                    case 52:
                        ...
                        getDexFileOutputPaths(_arg02, _arg12, _arg22, _arg32);
                        reply.writeNoException();
                    ...
                    case 54:
                        ...
                        getDexFileOptimizationStatus(_arg03, _arg13, _arg23, _arg33);
                        reply.writeNoException();
