...
public interface IVold extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IVold {
        ...
        static final int TRANSACTION_cryptsdAddKeyAuth = 101;
        static final int TRANSACTION_cryptsdBackupInfo = 103;
        static final int TRANSACTION_cryptsdDisable = 100;
        static final int TRANSACTION_cryptsdEnable = 99;
        static final int TRANSACTION_cryptsdUnlockKey = 102;
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 26:
                        ...
                        return true;
                    case TRANSACTION_destroyObb /*{ENCODED_INT: 27}*/:
                        data.enforceInterface(DESCRIPTOR);
                        destroyObb(data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_fstrim /*{ENCODED_INT: 28}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 45:
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_initUser0 /*{ENCODED_INT: 46}*/:
                        data.enforceInterface(DESCRIPTOR);
                        initUser0();
                        reply.writeNoException();
                        return true;
                    ...
                    case 50:
                        ...
                        createUserKey(_arg02, _arg12, _arg22);
                        reply.writeNoException();
                        return true;
                    case 51:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 74:
                        ...
                        createUserKeyIsec(_arg04, _arg13, _arg2);
                        reply.writeNoException();
                        return true;
                    case 75:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 87:
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_sdlockLock /*{ENCODED_INT: 88}*/:
                        data.enforceInterface(DESCRIPTOR);
                        sdlockLock(data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_sdlockUnlock /*{ENCODED_INT: 89}*/:
                        data.enforceInterface(DESCRIPTOR);
                        sdlockUnlock(data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_sdlockErase /*{ENCODED_INT: 90}*/:
                        data.enforceInterface(DESCRIPTOR);
                        sdlockErase();
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_sdlockPoll /*{ENCODED_INT: 91}*/:
                        data.enforceInterface(DESCRIPTOR);
                        String _result12 = sdlockPoll();
                        reply.writeNoException();
                        reply.writeString(_result12);
                        return true;
                    case TRANSACTION_sdlockGetCid /*{ENCODED_INT: 92}*/:
                        data.enforceInterface(DESCRIPTOR);
                        String _result13 = sdlockGetCid();
                        reply.writeNoException();
                        reply.writeString(_result13);
                        return true;
                    case TRANSACTION_sdlockReadPassword /*{ENCODED_INT: 93}*/:
                        data.enforceInterface(DESCRIPTOR);
                        String _result14 = sdlockReadPassword();
                        reply.writeNoException();
                        reply.writeString(_result14);
                        return true;
                    case TRANSACTION_sdlockWritePassword /*{ENCODED_INT: 94}*/:
                        data.enforceInterface(DESCRIPTOR);
                        sdlockWritePassword(data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_sdbackupGetDevStat /*{ENCODED_INT: 95}*/:
                        data.enforceInterface(DESCRIPTOR);
        ...
        private static class Proxy implements IVold {
            ...
            public void destroyUserStorage(String uuid, int userId, int storageFlags) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(userId);
                    _data.writeInt(storageFlags);
                    if (this.mRemote.transact(Stub.TRANSACTION_destroyUserStorage, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public void prepareSandboxForApp(String packageName, int appId, String sandboxId, int userId) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(userId);
                    if (this.mRemote.transact(Stub.TRANSACTION_prepareSandboxForApp, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public void destroySandboxForApp(String packageName, String sandboxId, int userId) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(sandboxId);
                    _data.writeInt(userId);
                    if (this.mRemote.transact(Stub.TRANSACTION_destroySandboxForApp, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public void sendBlockUserId(String volId, int blockUserId) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().sendBlockUserId(volId, blockUserId);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
