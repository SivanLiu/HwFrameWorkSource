...
public final class RttLciInformation {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.latitude == other.latitude && this.longitude == other.longitude && this.altitude == other.altitude && this.latitudeUnc == other.latitudeUnc && this.longitudeUnc == other.longitudeUnc && this.altitudeUnc == other.altitudeUnc && this.motionPattern == other.motionPattern && this.floor == other.floor && this.heightAboveFloor == other.heightAboveFloor && this.heightUnc == other.heightUnc) {
            return true;
        }
        return false;
    }
