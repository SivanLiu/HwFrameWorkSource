...
public final class NanDataPathSecurityConfig {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        this.securityType = _hidl_blob.getInt32(_hidl_offset + 0);
        this.cipherType = _hidl_blob.getInt32(_hidl_offset + 4);
        _hidl_blob.copyToInt8Array(_hidl_offset + 8, this.pmk, 32);
