...
public final class StaBackgroundScanParameters {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        this.basePeriodInMs = _hidl_blob.getInt32(_hidl_offset + 0);
        this.maxApPerScan = _hidl_blob.getInt32(_hidl_offset + 4);
        this.reportThresholdPercent = _hidl_blob.getInt32(_hidl_offset + 8);
        this.reportThresholdNumScans = _hidl_blob.getInt32(_hidl_offset + 12);
