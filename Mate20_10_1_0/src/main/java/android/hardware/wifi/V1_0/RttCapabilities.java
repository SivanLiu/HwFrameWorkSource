...
public final class RttCapabilities {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.rttOneSidedSupported == other.rttOneSidedSupported && this.rttFtmSupported == other.rttFtmSupported && this.lciSupported == other.lciSupported && this.lcrSupported == other.lcrSupported && this.responderSupported == other.responderSupported && HidlSupport.deepEquals(Integer.valueOf(this.preambleSupport), Integer.valueOf(other.preambleSupport)) && HidlSupport.deepEquals(Integer.valueOf(this.bwSupport), Integer.valueOf(other.bwSupport)) && this.mcVersion == other.mcVersion) {
            return true;
        }
        return false;
    }
