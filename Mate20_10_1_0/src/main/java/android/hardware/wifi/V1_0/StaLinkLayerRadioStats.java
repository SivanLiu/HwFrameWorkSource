...
public final class StaLinkLayerRadioStats {
    ...
    public ArrayList<Integer> txTimeInMsPerLevel = new ArrayList<>();
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        this.onTimeInMs = _hidl_blob.getInt32(_hidl_offset + 0);
        this.txTimeInMs = _hidl_blob.getInt32(_hidl_offset + 4);
        ...
        this.rxTimeInMs = _hidl_blob.getInt32(_hidl_offset + 24);
        this.onTimeInMsForScan = _hidl_blob.getInt32(_hidl_offset + 28);
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            childBlob.putInt32((long) (_hidl_index_0 * 4), this.txTimeInMsPerLevel.get(_hidl_index_0).intValue());
        }
