...
public interface IWifiRttController extends IBase {
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IWifiRttController asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IWifiRttController castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IWifiRttController getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IWifiRttController getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IWifiRttController getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IWifiRttController getService() throws RemoteException {
