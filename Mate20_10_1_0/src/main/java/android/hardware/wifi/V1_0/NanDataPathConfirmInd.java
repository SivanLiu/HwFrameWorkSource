...
public final class NanDataPathConfirmInd {
    ...
    public byte[] peerNdiMacAddr = new byte[6];
    public WifiNanStatus status = new WifiNanStatus();
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        this.ndpInstanceId = _hidl_blob.getInt32(_hidl_offset + 0);
        this.dataPathSetupSuccess = _hidl_blob.getBool(_hidl_offset + 4);
        _hidl_blob.copyToInt8Array(_hidl_offset + 5, this.peerNdiMacAddr, 6);
        ...
        this.status.readEmbeddedFromParcel(parcel, _hidl_blob, _hidl_offset + 32);
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        long _hidl_array_offset_0 = 5 + _hidl_offset;
        byte[] _hidl_array_item_0 = this.peerNdiMacAddr;
