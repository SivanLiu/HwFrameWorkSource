...
public interface IWifiNanIface extends IWifiIface {
    ...
    public static abstract class Stub extends HwBinder implements IWifiNanIface {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IWifiNanIface.kInterfaceName, IWifiIface.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-70, 90, -89, 79, 27, -89, 20, -16, 9, 56, 100, 34, 121, 35, 73, 40, 8, 121, 91, -38, 97, -103, -60, -22, 8, -111, 50, 45, 39, -8, -55, 49}, new byte[]{107, -102, -44, 58, 94, -5, -26, -54, 33, 79, 117, 30, 34, -50, 67, -49, 92, -44, -43, -43, -14, -53, -88, 15, 36, -52, -45, 117, 90, 114, 64, 28}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    getType(new getTypeCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiNanIface.Stub.AnonymousClass1 */
                ...
                case 2:
                    ...
                    getName(new getNameCallback() {
                        /* class android.hardware.wifi.V1_0.IWifiNanIface.Stub.AnonymousClass2 */
