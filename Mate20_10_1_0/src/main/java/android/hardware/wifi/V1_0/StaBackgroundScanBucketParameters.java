...
public final class StaBackgroundScanBucketParameters {
    ...
    public ArrayList<Integer> frequencies = new ArrayList<>();
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        this.bucketIdx = _hidl_blob.getInt32(_hidl_offset + 0);
        this.band = _hidl_blob.getInt32(_hidl_offset + 4);
        ...
        this.periodInMs = _hidl_blob.getInt32(_hidl_offset + 24);
        this.eventReportScheme = _hidl_blob.getInt32(_hidl_offset + 28);
        this.exponentialMaxPeriodInMs = _hidl_blob.getInt32(_hidl_offset + 32);
        this.exponentialBase = _hidl_blob.getInt32(_hidl_offset + 36);
        this.exponentialStepCount = _hidl_blob.getInt32(_hidl_offset + 40);
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            childBlob.putInt32((long) (_hidl_index_0 * 4), this.frequencies.get(_hidl_index_0).intValue());
        }
