...
public final class StaBackgroundScanCapabilities {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.maxCacheSize == other.maxCacheSize && this.maxBuckets == other.maxBuckets && this.maxApCachePerScan == other.maxApCachePerScan && this.maxReportingThreshold == other.maxReportingThreshold) {
            return true;
        }
        return false;
    }
