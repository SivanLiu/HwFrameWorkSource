...
public final class StaScanData {
    ...
    public int flags;
    public ArrayList<StaScanResult> results = new ArrayList<>();
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (HidlSupport.deepEquals(Integer.valueOf(this.flags), Integer.valueOf(other.flags)) && this.bucketsScanned == other.bucketsScanned && HidlSupport.deepEquals(this.results, other.results)) {
            return true;
        }
        return false;
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        this.flags = _hidl_blob.getInt32(_hidl_offset + 0);
        this.bucketsScanned = _hidl_blob.getInt32(_hidl_offset + 4);
        int _hidl_vec_size = _hidl_blob.getInt32(_hidl_offset + 8 + 8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 64), _hidl_blob.handle(), _hidl_offset + 8 + 0, true);
        this.results.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            this.results.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 64));
        }
