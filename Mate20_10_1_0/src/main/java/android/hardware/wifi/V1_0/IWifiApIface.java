...
public interface IWifiApIface extends IWifiIface {
    ...
    @Override // android.hardware.wifi.V1_0.IWifiIface, android.hidl.base.V1_0.IBase
    static default IWifiApIface asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hardware.wifi.V1_0.IWifiIface, android.hidl.base.V1_0.IBase
    static default IWifiApIface castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hardware.wifi.V1_0.IWifiIface, android.hidl.base.V1_0.IBase
    static default IWifiApIface getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // android.hardware.wifi.V1_0.IWifiIface, android.hidl.base.V1_0.IBase
    static default IWifiApIface getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    @Override // android.hardware.wifi.V1_0.IWifiIface, android.hidl.base.V1_0.IBase
    static default IWifiApIface getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hardware.wifi.V1_0.IWifiIface, android.hidl.base.V1_0.IBase
    static default IWifiApIface getService() throws RemoteException {
    ...
    public static final class Proxy implements IWifiApIface {
        ...
        @Override // android.hardware.wifi.V1_0.IWifiIface, android.hardware.wifi.V1_0.IWifiApIface, android.hidl.base.V1_0.IBase
        ...
        @Override // android.hardware.wifi.V1_0.IWifiApIface
    ...
    public static abstract class Stub extends HwBinder implements IWifiApIface {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IWifiApIface.kInterfaceName, IWifiIface.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-18, 2, 36, -18, 24, -127, 53, 6, -39, -42, -15, 61, -116, -114, 70, 121, -16, 83, -62, -112, -92, 67, -91, 42, 124, 82, -91, -45, -56, 82, 38, 43}, new byte[]{107, -102, -44, 58, 94, -5, -26, -54, 33, 79, 117, 30, 34, -50, 67, -49, 92, -44, -43, -43, -14, -53, -88, 15, 36, -52, -45, 117, 90, 114, 64, 28}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            if (_hidl_code == 1) {
                ...
                getType(new getTypeCallback() {
                    /* class android.hardware.wifi.V1_0.IWifiApIface.Stub.AnonymousClass1 */
                ...
                getName(new getNameCallback() {
                    /* class android.hardware.wifi.V1_0.IWifiApIface.Stub.AnonymousClass2 */
                ...
                getValidFrequenciesForBand(_hidl_request.readInt32(), new getValidFrequenciesForBandCallback() {
                    /* class android.hardware.wifi.V1_0.IWifiApIface.Stub.AnonymousClass3 */

                    @Override // android.hardware.wifi.V1_0.IWifiApIface.getValidFrequenciesForBandCallback
