...
public interface IWifiChipEventCallback extends android.hardware.wifi.V1_0.IWifiChipEventCallback {
    ...
    @Override // android.hardware.wifi.V1_0.IWifiChipEventCallback, android.hidl.base.V1_0.IBase
    IHwBinder asBinder();
    ...
    @Override // android.hardware.wifi.V1_0.IWifiChipEventCallback, android.hidl.base.V1_0.IBase
    static default IWifiChipEventCallback asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hardware.wifi.V1_0.IWifiChipEventCallback, android.hidl.base.V1_0.IBase
    static default IWifiChipEventCallback castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hardware.wifi.V1_0.IWifiChipEventCallback, android.hidl.base.V1_0.IBase
    static default IWifiChipEventCallback getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // android.hardware.wifi.V1_0.IWifiChipEventCallback, android.hidl.base.V1_0.IBase
    static default IWifiChipEventCallback getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    @Override // android.hardware.wifi.V1_0.IWifiChipEventCallback, android.hidl.base.V1_0.IBase
    static default IWifiChipEventCallback getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hardware.wifi.V1_0.IWifiChipEventCallback, android.hidl.base.V1_0.IBase
    static default IWifiChipEventCallback getService() throws RemoteException {
    ...
    public static final class RadioModeInfo {
        public int bandInfo;
        public ArrayList<IfaceInfo> ifaceInfos = new ArrayList<>();
        public int radioId;
        ...
        public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
            this.radioId = _hidl_blob.getInt32(_hidl_offset + 0);
            this.bandInfo = _hidl_blob.getInt32(_hidl_offset + 4);
        ...
        public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
            ...
            HwBlob childBlob = new HwBlob(_hidl_vec_size * 24);
            for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
                this.ifaceInfos.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 24));
            }
    ...
    public static final class Proxy implements IWifiChipEventCallback {
        ...
        @Override // android.hardware.wifi.V1_0.IWifiChipEventCallback, android.hardware.wifi.V1_2.IWifiChipEventCallback, android.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IWifiChipEventCallback {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IWifiChipEventCallback.kInterfaceName, android.hardware.wifi.V1_0.IWifiChipEventCallback.kInterfaceName, IBase.kInterfaceName));
        }
