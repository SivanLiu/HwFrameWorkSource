...
public interface IHostapd extends android.hardware.wifi.hostapd.V1_0.IHostapd {
    ...
    HostapdStatus addAccessPoint_1_1(IfaceParams ifaceParams, NetworkParams networkParams) throws RemoteException;
    ...
    @Override // android.hardware.wifi.hostapd.V1_0.IHostapd, android.hidl.base.V1_0.IBase
    static default IHostapd asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hardware.wifi.hostapd.V1_0.IHostapd, android.hidl.base.V1_0.IBase
    static default IHostapd castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hardware.wifi.hostapd.V1_0.IHostapd, android.hidl.base.V1_0.IBase
    static default IHostapd getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // android.hardware.wifi.hostapd.V1_0.IHostapd, android.hidl.base.V1_0.IBase
    static default IHostapd getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    @Override // android.hardware.wifi.hostapd.V1_0.IHostapd, android.hidl.base.V1_0.IBase
    static default IHostapd getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hardware.wifi.hostapd.V1_0.IHostapd, android.hidl.base.V1_0.IBase
    static default IHostapd getService() throws RemoteException {
    ...
    public static final class IfaceParams {
        public IfaceParams V1_0 = new IfaceParams();
    ...
    public static final class Proxy implements IHostapd {
        ...
        public HostapdStatus addAccessPoint_1_1(IfaceParams ifaceParams, NetworkParams nwParams) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
    ...
    public static abstract class Stub extends HwBinder implements IHostapd {
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            if (_hidl_code == 1) {
                ...
                NetworkParams nwParams2 = new NetworkParams();
