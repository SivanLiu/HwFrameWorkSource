...
public interface ISupplicantP2pNetwork extends ISupplicantNetwork {
    ...
    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantNetwork, android.hidl.base.V1_0.IBase
    static default ISupplicantP2pNetwork asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantNetwork, android.hidl.base.V1_0.IBase
    static default ISupplicantP2pNetwork castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantNetwork, android.hidl.base.V1_0.IBase
    static default ISupplicantP2pNetwork getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantNetwork, android.hidl.base.V1_0.IBase
    static default ISupplicantP2pNetwork getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantNetwork, android.hidl.base.V1_0.IBase
    static default ISupplicantP2pNetwork getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantNetwork, android.hidl.base.V1_0.IBase
    static default ISupplicantP2pNetwork getService() throws RemoteException {
    ...
    public static final class Proxy implements ISupplicantP2pNetwork {
        ...
        @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantNetwork, android.hardware.wifi.supplicant.V1_0.ISupplicantP2pNetwork, android.hidl.base.V1_0.IBase
