...
public interface ISupplicantStaIfaceCallback extends android.hardware.wifi.supplicant.V1_1.ISupplicantStaIfaceCallback {
    public static final String kInterfaceName = "android.hardware.wifi.supplicant@1.2::ISupplicantStaIfaceCallback";

    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantStaIfaceCallback, android.hardware.wifi.supplicant.V1_1.ISupplicantStaIfaceCallback, android.hidl.base.V1_0.IBase
    IHwBinder asBinder();
    ...
    void onDppFailure(int i) throws RemoteException;

    void onDppProgress(int i) throws RemoteException;

    void onDppSuccessConfigReceived(ArrayList<Byte> arrayList, String str, byte[] bArr, int i) throws RemoteException;
    ...
    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantStaIfaceCallback, android.hardware.wifi.supplicant.V1_1.ISupplicantStaIfaceCallback, android.hidl.base.V1_0.IBase
    static default ISupplicantStaIfaceCallback asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantStaIfaceCallback, android.hardware.wifi.supplicant.V1_1.ISupplicantStaIfaceCallback, android.hidl.base.V1_0.IBase
    static default ISupplicantStaIfaceCallback castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantStaIfaceCallback, android.hardware.wifi.supplicant.V1_1.ISupplicantStaIfaceCallback, android.hidl.base.V1_0.IBase
    static default ISupplicantStaIfaceCallback getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantStaIfaceCallback, android.hardware.wifi.supplicant.V1_1.ISupplicantStaIfaceCallback, android.hidl.base.V1_0.IBase
    static default ISupplicantStaIfaceCallback getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantStaIfaceCallback, android.hardware.wifi.supplicant.V1_1.ISupplicantStaIfaceCallback, android.hidl.base.V1_0.IBase
    static default ISupplicantStaIfaceCallback getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hardware.wifi.supplicant.V1_0.ISupplicantStaIfaceCallback, android.hardware.wifi.supplicant.V1_1.ISupplicantStaIfaceCallback, android.hidl.base.V1_0.IBase
    static default ISupplicantStaIfaceCallback getService() throws RemoteException {
    ...
    public static final class Proxy implements ISupplicantStaIfaceCallback {
        ...
        @Override // android.hardware.wifi.supplicant.V1_2.ISupplicantStaIfaceCallback, android.hardware.wifi.supplicant.V1_0.ISupplicantStaIfaceCallback, android.hardware.wifi.supplicant.V1_1.ISupplicantStaIfaceCallback, android.hidl.base.V1_0.IBase
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of android.hardware.wifi.supplicant@1.2::ISupplicantStaIfaceCallback]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements ISupplicantStaIfaceCallback {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(ISupplicantStaIfaceCallback.kInterfaceName, android.hardware.wifi.supplicant.V1_1.ISupplicantStaIfaceCallback.kInterfaceName, android.hardware.wifi.supplicant.V1_0.ISupplicantStaIfaceCallback.kInterfaceName, IBase.kInterfaceName));
        }
