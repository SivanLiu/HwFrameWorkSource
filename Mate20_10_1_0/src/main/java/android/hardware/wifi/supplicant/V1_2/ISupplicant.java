    ...
    public static final class Proxy implements ISupplicant {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of android.hardware.wifi.supplicant@1.2::ISupplicant]@Proxy";
            }
        }
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    getInterface(ifaceInfo, new getInterfaceCallback() {
                        /* class android.hardware.wifi.supplicant.V1_2.ISupplicant.Stub.AnonymousClass1 */
                ...
                case 2:
                    ...
                    listInterfaces(new listInterfacesCallback() {
                        /* class android.hardware.wifi.supplicant.V1_2.ISupplicant.Stub.AnonymousClass2 */
                ...
                case 9:
                    ...
                    addInterface(ifaceInfo2, new addInterfaceCallback() {
                        /* class android.hardware.wifi.supplicant.V1_2.ISupplicant.Stub.AnonymousClass3 */
