...
public interface IContexthubCallback extends IBase {
    ...
    void handleAppAbort(long j, int i) throws RemoteException;

    void handleAppsInfo(ArrayList<HubAppInfo> arrayList) throws RemoteException;

    void handleClientMsg(ContextHubMsg contextHubMsg) throws RemoteException;

    void handleHubEvent(int i) throws RemoteException;

    void handleTxnResult(int i, int i2) throws RemoteException;
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IContexthubCallback asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IContexthubCallback castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IContexthubCallback getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IContexthubCallback getService(boolean retry) throws RemoteException {
        return getService(BatteryService.HealthServiceWrapper.INSTANCE_VENDOR, retry);
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IContexthubCallback getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IContexthubCallback getService() throws RemoteException {
    ...
    public static final class Proxy implements IContexthubCallback {
        ...
        @Override // android.hardware.contexthub.V1_0.IContexthubCallback, android.hidl.base.V1_0.IBase
        ...
        public void handleClientMsg(ContextHubMsg msg) throws RemoteException {
        ...
        @Override // android.hardware.contexthub.V1_0.IContexthubCallback
        public void handleAppsInfo(ArrayList<HubAppInfo> appInfo) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IContexthubCallback.kInterfaceName);
    ...
    public static abstract class Stub extends HwBinder implements IContexthubCallback {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IContexthubCallback.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{UsbDescriptor.DESCRIPTORTYPE_SUPERSPEED_HUB, -77, 5, 76, 45, -109, 2, -40, 65, 126, -25, 73, 83, 83, -94, -120, Byte.MAX_VALUE, -29, 56, -7, 19, 39, 111, 46, -76, 30, Byte.MIN_VALUE, -15, 19, -107, -20, 46}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, -17, 5, UsbDescriptor.DESCRIPTORTYPE_AUDIO_INTERFACE, -13, -51, 105, 87, 19, -109, UsbDescriptor.DESCRIPTORTYPE_AUDIO_INTERFACE, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            if (_hidl_code == 1) {
                ...
                _hidl_request.enforceInterface(IContexthubCallback.kInterfaceName);
                handleTxnResult(_hidl_request.readInt32(), _hidl_request.readInt32());
                _hidl_reply.writeStatus(0);
                _hidl_reply.send();
                ...
                _hidl_request.enforceInterface(IContexthubCallback.kInterfaceName);
                handleHubEvent(_hidl_request.readInt32());
                _hidl_reply.writeStatus(0);
                _hidl_reply.send();
                ...
                _hidl_request.enforceInterface(IContexthubCallback.kInterfaceName);
                handleAppAbort(_hidl_request.readInt64(), _hidl_request.readInt32());
                _hidl_reply.writeStatus(0);
                _hidl_reply.send();
                ...
                _hidl_request.enforceInterface(IContexthubCallback.kInterfaceName);
                handleAppsInfo(HubAppInfo.readVectorFromParcel(_hidl_request));
                _hidl_reply.writeStatus(0);
                _hidl_reply.send();
            }
        }
