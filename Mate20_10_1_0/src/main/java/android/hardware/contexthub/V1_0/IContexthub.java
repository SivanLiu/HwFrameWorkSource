...
public interface IContexthub extends IBase {
    ...
    public static final class Proxy implements IContexthub {
        ...
        @Override // android.hardware.contexthub.V1_0.IContexthub, android.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IContexthub {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-91, -82, UsbDescriptor.DESCRIPTORTYPE_BOS, -24, 102, Byte.MAX_VALUE, 11, 26, -16, -101, 19, -25, 45, UsbDescriptor.DESCRIPTORTYPE_HUB, 96, UsbDescriptor.DESCRIPTORTYPE_BOS, 78, -77, -123, 59, UsbDescriptor.DESCRIPTORTYPE_AUDIO_ENDPOINT, 112, 121, -60, 90, -103, -74, -12, -93, 54, 6, 73}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, -17, 5, UsbDescriptor.DESCRIPTORTYPE_AUDIO_INTERFACE, -13, -51, 105, 87, 19, -109, UsbDescriptor.DESCRIPTORTYPE_AUDIO_INTERFACE, -72, 59, 24, -54, 76}));
        }
