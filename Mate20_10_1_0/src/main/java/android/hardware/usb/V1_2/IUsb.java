...
public interface IUsb extends android.hardware.usb.V1_1.IUsb {
    ...
    @Override // android.hardware.usb.V1_0.IUsb, android.hardware.usb.V1_1.IUsb, android.hidl.base.V1_0.IBase
    IHwBinder asBinder();
    ...
    @Override // android.hardware.usb.V1_0.IUsb, android.hardware.usb.V1_1.IUsb, android.hidl.base.V1_0.IBase
    static default IUsb asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hardware.usb.V1_0.IUsb, android.hardware.usb.V1_1.IUsb, android.hidl.base.V1_0.IBase
    static default IUsb castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hardware.usb.V1_0.IUsb, android.hardware.usb.V1_1.IUsb, android.hidl.base.V1_0.IBase
    static default IUsb getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // android.hardware.usb.V1_0.IUsb, android.hardware.usb.V1_1.IUsb, android.hidl.base.V1_0.IBase
    static default IUsb getService(boolean retry) throws RemoteException {
        return getService(BatteryService.HealthServiceWrapper.INSTANCE_VENDOR, retry);
    }

    @Override // android.hardware.usb.V1_0.IUsb, android.hardware.usb.V1_1.IUsb, android.hidl.base.V1_0.IBase
    static default IUsb getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hardware.usb.V1_0.IUsb, android.hardware.usb.V1_1.IUsb, android.hidl.base.V1_0.IBase
    static default IUsb getService() throws RemoteException {
    ...
    public static final class Proxy implements IUsb {
        ...
        @Override // android.hardware.usb.V1_2.IUsb, android.hardware.usb.V1_0.IUsb, android.hardware.usb.V1_1.IUsb, android.hidl.base.V1_0.IBase
