...
public interface IUsbGadgetCallback extends IBase {
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IUsbGadgetCallback asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IUsbGadgetCallback castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IUsbGadgetCallback getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IUsbGadgetCallback getService(boolean retry) throws RemoteException {
        return getService(BatteryService.HealthServiceWrapper.INSTANCE_VENDOR, retry);
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IUsbGadgetCallback getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IUsbGadgetCallback getService() throws RemoteException {
    ...
    public static final class Proxy implements IUsbGadgetCallback {
        ...
        @Override // android.hardware.usb.gadget.V1_0.IUsbGadgetCallback, android.hidl.base.V1_0.IBase
