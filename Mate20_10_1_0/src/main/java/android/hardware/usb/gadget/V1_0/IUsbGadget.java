...
public interface IUsbGadget extends IBase {
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IUsbGadget asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IUsbGadget castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IUsbGadget getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IUsbGadget getService(boolean retry) throws RemoteException {
        return getService(BatteryService.HealthServiceWrapper.INSTANCE_VENDOR, retry);
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IUsbGadget getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IUsbGadget getService() throws RemoteException {
    ...
    public static final class Proxy implements IUsbGadget {
        ...
        @Override // android.hardware.usb.gadget.V1_0.IUsbGadget, android.hidl.base.V1_0.IBase
    ...
    public static abstract class Stub extends HwBinder implements IUsbGadget {
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            if (_hidl_code == 1) {
                ...
                setCurrentUsbFunctions(_hidl_request.readInt64(), IUsbGadgetCallback.asInterface(_hidl_request.readStrongBinder()), _hidl_request.readInt64());
                ...
                _hidl_request.enforceInterface(IUsbGadget.kInterfaceName);
                getCurrentUsbFunctions(IUsbGadgetCallback.asInterface(_hidl_request.readStrongBinder()));
            }
        }
    }
}
