...
public interface IWeaver extends IBase {
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IWeaver asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IWeaver castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IWeaver getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IWeaver getService(boolean retry) throws RemoteException {
        return getService(BatteryService.HealthServiceWrapper.INSTANCE_VENDOR, retry);
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IWeaver getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IWeaver getService() throws RemoteException {
    ...
    public static abstract class Stub extends HwBinder implements IWeaver {
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            if (_hidl_code == 1) {
                ...
                getConfig(new getConfigCallback() {
                    /* class android.hardware.weaver.V1_0.IWeaver.Stub.AnonymousClass1 */
                ...
                _hidl_request.enforceInterface(IWeaver.kInterfaceName);
                read(_hidl_request.readInt32(), _hidl_request.readInt8Vector(), new readCallback() {
                    /* class android.hardware.weaver.V1_0.IWeaver.Stub.AnonymousClass2 */
