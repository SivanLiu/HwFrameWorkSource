...
public interface IAuthSecret extends IBase {
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IAuthSecret asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IAuthSecret castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IAuthSecret getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IAuthSecret getService(boolean retry) throws RemoteException {
        return getService(BatteryService.HealthServiceWrapper.INSTANCE_VENDOR, retry);
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IAuthSecret getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IAuthSecret getService() throws RemoteException {
    ...
    public static final class Proxy implements IAuthSecret {
        ...
        public void primaryUserCredential(ArrayList<Byte> secret) throws RemoteException {
            ...
            _hidl_request.writeInt8Vector(secret);
