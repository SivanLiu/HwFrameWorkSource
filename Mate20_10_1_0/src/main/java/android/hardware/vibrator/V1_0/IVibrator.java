...
public interface IVibrator extends IBase {
    ...
    int on(int i) throws RemoteException;
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IVibrator asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IVibrator castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IVibrator getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IVibrator getService(boolean retry) throws RemoteException {
        return getService(BatteryService.HealthServiceWrapper.INSTANCE_VENDOR, retry);
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IVibrator getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IVibrator getService() throws RemoteException {
    ...
    public static abstract class Stub extends HwBinder implements IVibrator {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{6, -22, 100, -52, 53, 101, 119, Byte.MAX_VALUE, 59, UsbDescriptor.DESCRIPTORTYPE_AUDIO_ENDPOINT, -98, 64, UsbDescriptor.DESCRIPTORTYPE_BOS, -6, 113, 0, -48, Byte.MAX_VALUE, 56, 39, -83, -109, 87, -80, -59, -45, -58, 81, 56, 78, 85, 83}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, -17, 5, UsbDescriptor.DESCRIPTORTYPE_AUDIO_INTERFACE, -13, -51, 105, 87, 19, -109, UsbDescriptor.DESCRIPTORTYPE_AUDIO_INTERFACE, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            if (_hidl_code == 1) {
                ...
                perform(_hidl_request.readInt32(), _hidl_request.readInt8(), new performCallback() {
                    /* class android.hardware.vibrator.V1_0.IVibrator.Stub.AnonymousClass1 */
