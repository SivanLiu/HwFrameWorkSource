...
public interface IHealth extends IBase {
    ...
    @FunctionalInterface
    public interface energyCounterCallback {
        void onValues(int i, long j);
    }

    @FunctionalInterface
    public interface updateCallback {
        void onValues(boolean z, HealthInfo healthInfo);
    }
    ...
    void energyCounter(energyCounterCallback energycountercallback) throws RemoteException;
    ...
    HealthConfig init(HealthConfig healthConfig) throws RemoteException;
    ...
    void update(HealthInfo healthInfo, updateCallback updatecallback) throws RemoteException;

    @Override // android.hidl.base.V1_0.IBase
    static default IHealth asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IHealth castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IHealth getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IHealth getService(boolean retry) throws RemoteException {
        return getService(BatteryService.HealthServiceWrapper.INSTANCE_VENDOR, retry);
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IHealth getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IHealth getService() throws RemoteException {
    ...
    public static final class Proxy implements IHealth {
        ...
        @Override // android.hardware.health.V1_0.IHealth, android.hidl.base.V1_0.IBase
        ...
        @Override // android.hardware.health.V1_0.IHealth
    ...
    public static abstract class Stub extends HwBinder implements IHealth {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-111, -30, -70, 56, 5, -55, UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, -16, 31, -63, UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, 30, -55, -1, UsbASFormat.EXT_FORMAT_TYPE_III, -119, 66, -82, -29, 52, 111, 45, 118, 20, -20, -64, -54, -22, -37, -27, 126, -44}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, -17, 5, UsbDescriptor.DESCRIPTORTYPE_AUDIO_INTERFACE, -13, -51, 105, 87, 19, -109, UsbDescriptor.DESCRIPTORTYPE_AUDIO_INTERFACE, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            if (_hidl_code == 1) {
                ...
                HealthConfig _hidl_out_configOut = init(config);
                ...
                update(info, new updateCallback() {
                    /* class android.hardware.health.V1_0.IHealth.Stub.AnonymousClass1 */

                    @Override // android.hardware.health.V1_0.IHealth.updateCallback
                ...
                _hidl_request.enforceInterface(IHealth.kInterfaceName);
                energyCounter(new energyCounterCallback() {
                    /* class android.hardware.health.V1_0.IHealth.Stub.AnonymousClass2 */

                    @Override // android.hardware.health.V1_0.IHealth.energyCounterCallback
