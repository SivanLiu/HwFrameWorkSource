...
public interface IOemLock extends IBase {
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IOemLock asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IOemLock castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IOemLock getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IOemLock getService(boolean retry) throws RemoteException {
        return getService(BatteryService.HealthServiceWrapper.INSTANCE_VENDOR, retry);
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IOemLock getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IOemLock getService() throws RemoteException {
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            if (_hidl_code == 1) {
                ...
                getName(new getNameCallback() {
                    /* class android.hardware.oemlock.V1_0.IOemLock.Stub.AnonymousClass1 */
                ...
                _hidl_request.enforceInterface(IOemLock.kInterfaceName);
                int _hidl_out_status = setOemUnlockAllowedByCarrier(_hidl_request.readBool(), _hidl_request.readInt8Vector());
                _hidl_reply.writeStatus(0);
                ...
                isOemUnlockAllowedByCarrier(new isOemUnlockAllowedByCarrierCallback() {
                    /* class android.hardware.oemlock.V1_0.IOemLock.Stub.AnonymousClass2 */
                ...
                _hidl_request.enforceInterface(IOemLock.kInterfaceName);
                int _hidl_out_status2 = setOemUnlockAllowedByDevice(_hidl_request.readBool());
                _hidl_reply.writeStatus(0);
                ...
                isOemUnlockAllowedByDevice(new isOemUnlockAllowedByDeviceCallback() {
                    /* class android.hardware.oemlock.V1_0.IOemLock.Stub.AnonymousClass3 */
