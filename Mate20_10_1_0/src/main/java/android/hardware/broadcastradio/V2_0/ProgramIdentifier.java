...
public final class ProgramIdentifier {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != ProgramIdentifier.class) {
            return false;
        }
        ProgramIdentifier other = (ProgramIdentifier) otherObject;
    ...
    public static final ArrayList<ProgramIdentifier> readVectorFromParcel(HwParcel parcel) {
        ArrayList<ProgramIdentifier> _hidl_vec = new ArrayList<>();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<ProgramIdentifier> _hidl_vec) {
        HwBlob _hidl_blob = new HwBlob(16);
