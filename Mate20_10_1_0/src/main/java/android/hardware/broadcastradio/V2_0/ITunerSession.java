...
public interface ITunerSession extends IBase {
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default ITunerSession asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        ...
        ITunerSession proxy = new Proxy(binder);
        try {
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default ITunerSession castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default ITunerSession getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default ITunerSession getService(boolean retry) throws RemoteException {
        return getService(BatteryService.HealthServiceWrapper.INSTANCE_VENDOR, retry);
    }

    @Override // android.hidl.base.V1_0.IBase
    static default ITunerSession getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default ITunerSession getService() throws RemoteException {
    ...
    public static final class Proxy implements ITunerSession {
        ...
        public int tune(ProgramSelector program) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(ITunerSession.kInterfaceName);
        ...
        @Override // android.hardware.broadcastradio.V2_0.ITunerSession
        public int scan(boolean directionUp, boolean skipSubChannel) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(ITunerSession.kInterfaceName);
        ...
        @Override // android.hardware.broadcastradio.V2_0.ITunerSession
        public int step(boolean directionUp) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(ITunerSession.kInterfaceName);
            _hidl_request.writeBool(directionUp);
            HwParcel _hidl_reply = new HwParcel();
        ...
        @Override // android.hardware.broadcastradio.V2_0.ITunerSession
        public int startProgramListUpdates(ProgramFilter filter) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(ITunerSession.kInterfaceName);
        ...
        @Override // android.hardware.broadcastradio.V2_0.ITunerSession
        public void isConfigFlagSet(int flag, isConfigFlagSetCallback _hidl_cb) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(ITunerSession.kInterfaceName);
        ...
        @Override // android.hardware.broadcastradio.V2_0.ITunerSession
        public int setConfigFlag(int flag, boolean value) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(ITunerSession.kInterfaceName);
            _hidl_request.writeInt32(flag);
        ...
        @Override // android.hardware.broadcastradio.V2_0.ITunerSession
        public ArrayList<VendorKeyValue> setParameters(ArrayList<VendorKeyValue> parameters) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(ITunerSession.kInterfaceName);
            ...
            try {
                ...
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
                return VendorKeyValue.readVectorFromParcel(_hidl_reply);
            } finally {
                _hidl_reply.release();
            }
        }
        ...
        @Override // android.hardware.broadcastradio.V2_0.ITunerSession
        public ArrayList<VendorKeyValue> getParameters(ArrayList<String> keys) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(ITunerSession.kInterfaceName);
    ...
    public static abstract class Stub extends HwBinder implements ITunerSession {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-41, 4, 100, -59, 23, -92, -95, -75, 22, 119, UsbDescriptor.DESCRIPTORTYPE_ENDPOINT_COMPANION, -124, 55, 117, -87, Byte.MAX_VALUE, 69, 81, 2, -111, -98, -108, 91, 4, -9, 23, -71, -38, 57, 12, UsbDescriptor.DESCRIPTORTYPE_BOS, 57}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, -17, 5, UsbDescriptor.DESCRIPTORTYPE_AUDIO_INTERFACE, -13, -51, 105, 87, 19, -109, UsbDescriptor.DESCRIPTORTYPE_AUDIO_INTERFACE, -72, 59, 24, -54, 76}));
        }
        ...
        public IHwInterface queryLocalInterface(String descriptor) {
            if (ITunerSession.kInterfaceName.equals(descriptor)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                case 1:
                    ...
                    _hidl_request.enforceInterface(ITunerSession.kInterfaceName);
                    ProgramSelector program = new ProgramSelector();
                ...
                case 2:
                    ...
                    _hidl_request.enforceInterface(ITunerSession.kInterfaceName);
                    int _hidl_out_result2 = scan(_hidl_request.readBool(), _hidl_request.readBool());
                    _hidl_reply.writeStatus(0);
                ...
                case 3:
                    ...
                    _hidl_request.enforceInterface(ITunerSession.kInterfaceName);
                    int _hidl_out_result3 = step(_hidl_request.readBool());
                    _hidl_reply.writeStatus(0);
                ...
                case 7:
                    ...
                    _hidl_request.enforceInterface(ITunerSession.kInterfaceName);
                    isConfigFlagSet(_hidl_request.readInt32(), new isConfigFlagSetCallback() {
                        /* class android.hardware.broadcastradio.V2_0.ITunerSession.Stub.AnonymousClass1 */
                ...
                case 8:
                    ...
                    _hidl_request.enforceInterface(ITunerSession.kInterfaceName);
                    int _hidl_out_result5 = setConfigFlag(_hidl_request.readInt32(), _hidl_request.readBool());
                    _hidl_reply.writeStatus(0);
                ...
                case 9:
                    ...
                    _hidl_request.enforceInterface(ITunerSession.kInterfaceName);
                    ArrayList<VendorKeyValue> _hidl_out_results = setParameters(VendorKeyValue.readVectorFromParcel(_hidl_request));
                    _hidl_reply.writeStatus(0);
                    VendorKeyValue.writeVectorToParcel(_hidl_reply, _hidl_out_results);
                    _hidl_reply.send();
                    return;
                case 10:
                    if ((_hidl_flags & 1) == 0) {
                    ...
                    _hidl_request.enforceInterface(ITunerSession.kInterfaceName);
                    ArrayList<VendorKeyValue> _hidl_out_parameters = getParameters(_hidl_request.readStringVector());
                    _hidl_reply.writeStatus(0);
                    VendorKeyValue.writeVectorToParcel(_hidl_reply, _hidl_out_parameters);
                    _hidl_reply.send();
                    return;
                case 11:
                    if ((_hidl_flags & 1) == 0) {
