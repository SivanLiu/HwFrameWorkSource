...
public final class DabTableEntry {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != DabTableEntry.class) {
            return false;
        }
        DabTableEntry other = (DabTableEntry) otherObject;
        if (HidlSupport.deepEquals(this.label, other.label) && this.frequency == other.frequency) {
            return true;
        }
        return false;
    }
    ...
    public static final ArrayList<DabTableEntry> readVectorFromParcel(HwParcel parcel) {
        ArrayList<DabTableEntry> _hidl_vec = new ArrayList<>();
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        this.label = _hidl_blob.getString(_hidl_offset + 0);
        parcel.readEmbeddedBuffer((long) (this.label.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 0 + 0, false);
        this.frequency = _hidl_blob.getInt32(16 + _hidl_offset);
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        _hidl_blob.putString(0 + _hidl_offset, this.label);
        _hidl_blob.putInt32(16 + _hidl_offset, this.frequency);
    }
}
