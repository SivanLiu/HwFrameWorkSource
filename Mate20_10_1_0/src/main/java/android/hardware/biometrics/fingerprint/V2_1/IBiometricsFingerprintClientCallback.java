...
public interface IBiometricsFingerprintClientCallback extends IBase {
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IBiometricsFingerprintClientCallback asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IBiometricsFingerprintClientCallback castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    @Override // android.hidl.base.V1_0.IBase
    static default IBiometricsFingerprintClientCallback getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IBiometricsFingerprintClientCallback getService(boolean retry) throws RemoteException {
        return getService(MemoryConstant.MEM_SCENE_DEFAULT, retry);
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IBiometricsFingerprintClientCallback getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    @Override // android.hidl.base.V1_0.IBase
    static default IBiometricsFingerprintClientCallback getService() throws RemoteException {
    ...
    public static abstract class Stub extends HwBinder implements IBiometricsFingerprintClientCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-86, -69, 92, 60, 88, 85, -110, -41, 30, -27, 123, 119, 41, -116, 20, -103, 61, 119, -111, 77, -34, -86, 100, -78, -59, 16, -102, 96, 43, 2, -22, 71}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
