...
public class IpServer extends StateMachine {
    ...
    /* access modifiers changed from: private */
    public IDhcpServer mDhcpServer;
    /* access modifiers changed from: private */
    public int mDhcpServerStartIndex = 0;
    /* access modifiers changed from: private */
        ...
        public void onStatusAvailable(int statusCode) {
            IpServer.this.getHandler().post(new Runnable(statusCode) {
                ...
                public final void run() {
                    OnHandlerStatusCallback.this.lambda$onStatusAvailable$0$IpServer$OnHandlerStatusCallback(this.f$1);
                }
            });
        }
    ...
    public class DhcpServerCallbacksImpl extends DhcpServerCallbacks {
        ...
        public void onDhcpServerCreated(int statusCode, IDhcpServer server) throws RemoteException {
            IpServer.this.getHandler().post(new Runnable(statusCode, server) {
                ...
                public final void run() {
                    DhcpServerCallbacksImpl.this.lambda$onDhcpServerCreated$0$IpServer$DhcpServerCallbacksImpl(this.f$1, this.f$2);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$onDhcpServerCreated$0$IpServer$DhcpServerCallbacksImpl(int statusCode, IDhcpServer server) {
            if (this.mStartIndex == IpServer.this.mDhcpServerStartIndex) {
                if (statusCode != 1) {
                    SharedLog access$300 = IpServer.this.mLog;
                    access$300.e("Error obtaining DHCP server: " + statusCode);
                    handleError();
                    return;
                }
                IDhcpServer unused = IpServer.this.mDhcpServer = server;
                try {
                    IpServer.this.mDhcpServer.start(new OnHandlerStatusCallback() {
                        ...
                        public void callback(int startStatusCode) {
                            if (startStatusCode != 1) {
                                SharedLog access$300 = IpServer.this.mLog;
                                access$300.e("Error starting DHCP server: " + startStatusCode);
        ...
        public void handleError() {
            int unused = IpServer.this.mLastError = 12;
            IpServer ipServer = IpServer.this;
            ...
            try {
                iDhcpServer.stop(new OnHandlerStatusCallback() {
                    ...
                    public void callback(int statusCode) {
                        if (statusCode != 1) {
                            SharedLog access$300 = IpServer.this.mLog;
                            access$300.e("Error stopping DHCP server: " + statusCode);
                            int unused = IpServer.this.mLastError = 12;
                        }
                    }
                });
    ...
    class InitialState extends State {
        ...
        public boolean processMessage(Message message) {
            ...
            int i = message.what;
            if (i == 327782) {
                int unused = IpServer.this.mLastError = 0;
                int i2 = message.arg1;
                if (i2 == 2) {
                    IpServer ipServer = IpServer.this;
    ...
    class BaseServingState extends State {
        ...
        public void enter() {
            if (!IpServer.this.startIPv4()) {
                int unused = IpServer.this.mLastError = 10;
                return;
            }
            try {
                ...
                access$300.e(sb.toString());
                int unused2 = IpServer.this.mLastError = 6;
            }
        }
        ...
        public void exit() {
            ...
            try {
                ...
                int unused = IpServer.this.mLastError = 7;
                SharedLog access$300 = IpServer.this.mLog;
                StringBuilder sb = new StringBuilder();
        ...
        public boolean processMessage(Message message) {
            IpServer.this.logMessage(this, message.what);
            switch (message.what) {
                case IpServer.CMD_TETHER_UNREQUESTED /*{ENCODED_INT: 327783}*/:
                    IpServer ipServer = IpServer.this;
                    ipServer.transitionTo(ipServer.mInitialState);
                    return true;
                case IpServer.CMD_INTERFACE_DOWN /*{ENCODED_INT: 327784}*/:
                    IpServer ipServer2 = IpServer.this;
                    ipServer2.transitionTo(ipServer2.mUnavailableState);
                    return true;
                case 327785:
                case 327786:
                case IpServer.CMD_TETHER_CONNECTION_CHANGED /*{ENCODED_INT: 327792}*/:
                default:
                    return false;
                case IpServer.CMD_IP_FORWARDING_ENABLE_ERROR /*{ENCODED_INT: 327787}*/:
                case IpServer.CMD_IP_FORWARDING_DISABLE_ERROR /*{ENCODED_INT: 327788}*/:
                case IpServer.CMD_START_TETHERING_ERROR /*{ENCODED_INT: 327789}*/:
                case IpServer.CMD_STOP_TETHERING_ERROR /*{ENCODED_INT: 327790}*/:
                case IpServer.CMD_SET_DNS_FORWARDERS_ERROR /*{ENCODED_INT: 327791}*/:
                    int unused = IpServer.this.mLastError = 5;
                    IpServer ipServer3 = IpServer.this;
                    ipServer3.transitionTo(ipServer3.mInitialState);
                    return true;
                case IpServer.CMD_IPV6_TETHER_UPDATE /*{ENCODED_INT: 327793}*/:
                    IpServer.this.updateUpstreamIPv6LinkProperties((LinkProperties) message.obj);
    ...
    class TetheredState extends BaseServingState {
        ...
        private void cleanupUpstream() {
            if (IpServer.this.mUpstreamIfaceSet != null) {
                ...
                InterfaceSet unused = IpServer.this.mUpstreamIfaceSet = null;
            }
        }
            ...
            if (i == 327782) {
                ...
                if (!noChangeInUpstreamIfaceSet(newUpstreamIfaceSet)) {
                    if (newUpstreamIfaceSet == null) {
                        ...
                        InterfaceSet unused = IpServer.this.mUpstreamIfaceSet = newUpstreamIfaceSet;
                        for (String ifname : added) {
                            try {
                                ...
                                access$300.e(sb.toString());
                                cleanupUpstream();
                                int unused2 = IpServer.this.mLastError = 8;
                                IpServer ipServer = IpServer.this;
                                ipServer.transitionTo(ipServer.mInitialState);
                                return true;
                            }
