        ...
        if (pos != -1) {
            ...
            if (name.length() != 0) {
                ...
                switch (name.hashCode()) {
                    case HASH_X_PERMITTED_CROSS_DOMAIN_POLICIES /*{ENCODED_INT: -1345594014}*/:
                        if (name.equals(X_PERMITTED_CROSS_DOMAIN_POLICIES)) {
                            this.mHeaders[IDX_X_PERMITTED_CROSS_DOMAIN_POLICIES] = val;
                            return;
                        }
                        return;
                    case HASH_EXPIRES /*{ENCODED_INT: -1309235404}*/:
                        if (name.equals("expires")) {
                            this.mHeaders[IDX_EXPIRES] = val;
                            return;
                        }
                        return;
                    case HASH_CONTENT_DISPOSITION /*{ENCODED_INT: -1267267485}*/:
                        if (name.equals(CONTENT_DISPOSITION)) {
                            this.mHeaders[9] = val;
                            return;
                        }
                        return;
                    case HASH_CONTENT_LEN /*{ENCODED_INT: -1132779846}*/:
                    ...
                    case HASH_PRAGMA /*{ENCODED_INT: -980228804}*/:
                        if (name.equals(PRAGMA)) {
                            this.mHeaders[16] = val;
                            return;
                        }
                        return;
                    case HASH_CONN_DIRECTIVE /*{ENCODED_INT: -775651618}*/:
                        ...
                        return;
                    case HASH_PROXY_AUTHENTICATE /*{ENCODED_INT: -301767724}*/:
                        if (name.equals(PROXY_AUTHENTICATE)) {
                            this.mHeaders[IDX_PROXY_AUTHENTICATE] = val;
                            return;
                        }
                        return;
                    case HASH_WWW_AUTHENTICATE /*{ENCODED_INT: -243037365}*/:
                        if (name.equals(WWW_AUTHENTICATE)) {
                            this.mHeaders[7] = val;
                            return;
                        }
                        return;
                    case HASH_CACHE_CONTROL /*{ENCODED_INT: -208775662}*/:
                        if (name.equals(CACHE_CONTROL)) {
                            String[] strArr = this.mHeaders;
                            if (strArr[IDX_CACHE_CONTROL] == null || strArr[IDX_CACHE_CONTROL].length() <= 0) {
                                this.mHeaders[IDX_CACHE_CONTROL] = val;
                                return;
                            }
                            StringBuilder sb = new StringBuilder();
                            String[] strArr2 = this.mHeaders;
                            sb.append(strArr2[IDX_CACHE_CONTROL]);
                            sb.append(',');
                            sb.append(val);
                            strArr2[IDX_CACHE_CONTROL] = sb.toString();
                            return;
                        }
                        return;
                    case HASH_ETAG /*{ENCODED_INT: 3123477}*/:
                        if (name.equals(ETAG)) {
                            this.mHeaders[IDX_ETAG] = val;
                            return;
                        }
                        return;
                    case HASH_LAST_MODIFIED /*{ENCODED_INT: 150043680}*/:
                        if (name.equals(LAST_MODIFIED)) {
                            this.mHeaders[13] = val;
                            return;
                        }
                        return;
                    case HASH_PROXY_CONNECTION /*{ENCODED_INT: 285929373}*/:
                        ...
                        return;
                    case HASH_CONTENT_TYPE /*{ENCODED_INT: 785670158}*/:
                        if (name.equals(CONTENT_TYPE)) {
                            this.mHeaders[2] = val;
                            return;
                        }
                        return;
                    case HASH_REFRESH /*{ENCODED_INT: 1085444827}*/:
                        if (name.equals(REFRESH)) {
                            this.mHeaders[17] = val;
                            return;
                        }
                        return;
                    case HASH_SET_COOKIE /*{ENCODED_INT: 1237214767}*/:
                        ...
                        return;
                    case HASH_TRANSFER_ENCODING /*{ENCODED_INT: 1274458357}*/:
                    ...
                    case HASH_ACCEPT_RANGES /*{ENCODED_INT: 1397189435}*/:
                        if (name.equals(ACCEPT_RANGES)) {
                            this.mHeaders[10] = val;
                            return;
                        }
                        return;
                    case HASH_LOCATION /*{ENCODED_INT: 1901043637}*/:
                        if (name.equals(LOCATION)) {
                            this.mHeaders[5] = val;
                            return;
                        }
                        return;
                    case HASH_CONTENT_ENCODING /*{ENCODED_INT: 2095084583}*/:
