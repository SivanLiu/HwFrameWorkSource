...
public abstract class Connection {
    ...
    private static String getEventHandlerErrorString(int errorId) {
        switch (errorId) {
            case EventHandler.TOO_MANY_REQUESTS_ERROR /*{ENCODED_INT: -15}*/:
                return "TOO_MANY_REQUESTS_ERROR";
            case EventHandler.FILE_NOT_FOUND_ERROR /*{ENCODED_INT: -14}*/:
                return "FILE_NOT_FOUND_ERROR";
            case EventHandler.FILE_ERROR /*{ENCODED_INT: -13}*/:
                return "FILE_ERROR";
            case EventHandler.ERROR_BAD_URL /*{ENCODED_INT: -12}*/:
                return "ERROR_BAD_URL";
            case EventHandler.ERROR_FAILED_SSL_HANDSHAKE /*{ENCODED_INT: -11}*/:
                return "ERROR_FAILED_SSL_HANDSHAKE";
            case EventHandler.ERROR_UNSUPPORTED_SCHEME /*{ENCODED_INT: -10}*/:
                return "ERROR_UNSUPPORTED_SCHEME";
            case EventHandler.ERROR_REDIRECT_LOOP /*{ENCODED_INT: -9}*/:
                return "ERROR_REDIRECT_LOOP";
            case EventHandler.ERROR_TIMEOUT /*{ENCODED_INT: -8}*/:
                return "ERROR_TIMEOUT";
            case EventHandler.ERROR_IO /*{ENCODED_INT: -7}*/:
                return "ERROR_IO";
            case EventHandler.ERROR_CONNECT /*{ENCODED_INT: -6}*/:
                return "ERROR_CONNECT";
            case EventHandler.ERROR_PROXYAUTH /*{ENCODED_INT: -5}*/:
                return "ERROR_PROXYAUTH";
            case EventHandler.ERROR_AUTH /*{ENCODED_INT: -4}*/:
                return "ERROR_AUTH";
            case EventHandler.ERROR_UNSUPPORTED_AUTH_SCHEME /*{ENCODED_INT: -3}*/:
