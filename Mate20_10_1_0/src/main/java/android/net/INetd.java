            ...
            if (code == TRANSACTION_getInterfaceVersion) {
                ...
                switch (code) {
                    ...
                    case 2:
                        ...
                        boolean firewallReplaceUidChain = firewallReplaceUidChain(_arg07, _arg1, data.createIntArray());
                        reply.writeNoException();
                    ...
                    case 3:
                        ...
                        boolean bandwidthEnableDataSaver = bandwidthEnableDataSaver(_arg06);
                        reply.writeNoException();
                    ...
                    case 5:
                        ...
                        networkCreateVpn(_arg08, _arg15);
                        reply.writeNoException();
                        return true;
                    case 6:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 11:
                        ...
                        networkRejectNonSecureVpn(_arg05, (UidRangeParcel[]) data.createTypedArray(UidRangeParcel.CREATOR));
                        reply.writeNoException();
                        return true;
                    case 12:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 22:
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_ipSecApplyTransportModeTransform /*{ENCODED_INT: 23}*/:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_ipSecRemoveTransportModeTransform /*{ENCODED_INT: 24}*/:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_ipSecAddSecurityPolicy /*{ENCODED_INT: 25}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 26:
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_ipSecDeleteSecurityPolicy /*{ENCODED_INT: 27}*/:
                        data.enforceInterface(DESCRIPTOR);
                        ipSecDeleteSecurityPolicy(data.readInt(), data.readInt(), data.readInt(), data.readInt(), data.readInt(), data.readInt());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_ipSecAddTunnelInterface /*{ENCODED_INT: 28}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 45:
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_bandwidthRemoveInterfaceQuota /*{ENCODED_INT: 46}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 56:
                        ...
                        return true;
                    case TRANSACTION_tetherInterfaceAdd /*{ENCODED_INT: 57}*/:
                        data.enforceInterface(DESCRIPTOR);
                        tetherInterfaceAdd(data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_tetherInterfaceRemove /*{ENCODED_INT: 58}*/:
                        data.enforceInterface(DESCRIPTOR);
                        tetherInterfaceRemove(data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_tetherInterfaceList /*{ENCODED_INT: 59}*/:
                        data.enforceInterface(DESCRIPTOR);
                        String[] _result6 = tetherInterfaceList();
                        reply.writeNoException();
                        reply.writeStringArray(_result6);
                        return true;
                    case TRANSACTION_tetherDnsSet /*{ENCODED_INT: 60}*/:
                        data.enforceInterface(DESCRIPTOR);
                        tetherDnsSet(data.readInt(), data.createStringArray());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_tetherDnsList /*{ENCODED_INT: 61}*/:
                        data.enforceInterface(DESCRIPTOR);
                        String[] _result7 = tetherDnsList();
                        reply.writeNoException();
                        reply.writeStringArray(_result7);
                        return true;
                    case TRANSACTION_networkAddRoute /*{ENCODED_INT: 62}*/:
                        data.enforceInterface(DESCRIPTOR);
                        networkAddRoute(data.readInt(), data.readString(), data.readString(), data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_networkRemoveRoute /*{ENCODED_INT: 63}*/:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 79:
                        ...
                        firewallEnableChildChain(_arg09, _arg14);
                        reply.writeNoException();
                        return true;
                    case 80:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 83:
                        ...
                        interfaceSetIPv6PrivacyExtensions(_arg010, _arg13);
                        reply.writeNoException();
                        return true;
                    case 84:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 85:
                        ...
                        interfaceSetEnableIPv6(_arg011, _arg12);
                        reply.writeNoException();
                        return true;
                    case 86:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 87:
                        ...
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_tetherRemoveForward /*{ENCODED_INT: 88}*/:
                        data.enforceInterface(DESCRIPTOR);
                        tetherRemoveForward(data.readString(), data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_setTcpRWmemorySize /*{ENCODED_INT: 89}*/:
                        data.enforceInterface(DESCRIPTOR);
                        setTcpRWmemorySize(data.readString(), data.readString());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_registerUnsolicitedEventListener /*{ENCODED_INT: 90}*/:
                        data.enforceInterface(DESCRIPTOR);
                        registerUnsolicitedEventListener(INetdUnsolicitedEventListener.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_firewallAddUidInterfaceRules /*{ENCODED_INT: 91}*/:
                        data.enforceInterface(DESCRIPTOR);
                        firewallAddUidInterfaceRules(data.readString(), data.createIntArray());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_firewallRemoveUidInterfaceRules /*{ENCODED_INT: 92}*/:
                        data.enforceInterface(DESCRIPTOR);
                        firewallRemoveUidInterfaceRules(data.createIntArray());
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_trafficSwapActiveStatsMap /*{ENCODED_INT: 93}*/:
                        data.enforceInterface(DESCRIPTOR);
                        trafficSwapActiveStatsMap();
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_getOemNetd /*{ENCODED_INT: 94}*/:
                        data.enforceInterface(DESCRIPTOR);
        ...
        private static class Proxy implements INetd {
            ...
            public void tetherInterfaceRemove(String ifName) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(ifName);
                    if (this.mRemote.transact(Stub.TRANSACTION_tetherInterfaceRemove, _data, _reply, 0) || Stub.getDefaultImpl() == null) {
                        _reply.readException();
                        _reply.recycle();
                        _data.recycle();
                        return;
            ...
            public String[] tetherInterfaceList() throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (!this.mRemote.transact(Stub.TRANSACTION_tetherInterfaceList, _data, _reply, 0) && Stub.getDefaultImpl() != null) {
