...
public abstract class LiveData<T> {
    ...
    public void dispatchingValue(@Nullable ObserverWrapper initiator) {
        ...
        do {
            ...
            if (initiator == null) {
                Iterator<Map.Entry<Observer<? super T>, ObserverWrapper>> iterator = this.mObservers.iteratorWithAdditions();
    ...
    public void removeObservers(@NonNull LifecycleOwner owner) {
        ...
        Iterator<Map.Entry<Observer<? super T>, ObserverWrapper>> it = this.mObservers.iterator();
        while (it.hasNext()) {
            Map.Entry<Observer<? super T>, ObserverWrapper> entry = it.next();
