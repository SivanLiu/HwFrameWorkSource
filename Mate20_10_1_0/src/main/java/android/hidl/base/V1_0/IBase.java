...
public interface IBase extends IHwInterface {
    ...
    static default IBase asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static default IBase castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static default IBase getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static default IBase getService(boolean retry) throws RemoteException {
        return getService(MemoryConstant.MEM_SCENE_DEFAULT, retry);
    }

    static default IBase getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static default IBase getService() throws RemoteException {
