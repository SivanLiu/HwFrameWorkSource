...
public class ViewDragHelper {
    ...
    /* JADX INFO: Multiple debug info for r3v8 int: [D('targetTop' int), D('actionIndex' int)] */
                            ...
                            if (i < pointerCount2) {
                                ...
                                if (!isValidPointerForActionMove(pointerId2)) {
                                    ...
                                    if (pastSlop) {
                                        ...
                                        action = action2;
                                        int newLeft = this.mCallback.clampViewPositionHorizontal(toCapture3, ((int) dx) + oldLeft, (int) dx);
                                        int oldTop = toCapture3.getTop();
                                        actionIndex = actionIndex2;
                                        pointerCount = pointerCount2;
                                        int newTop = this.mCallback.clampViewPositionVertical(toCapture3, ((int) dy) + oldTop, (int) dy);
