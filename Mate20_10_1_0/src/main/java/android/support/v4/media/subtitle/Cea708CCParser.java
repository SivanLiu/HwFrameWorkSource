...
class Cea708CCParser {
    ...
    private DisplayListener mListener = new DisplayListener() {
        /* class android.support.v4.media.subtitle.Cea708CCParser.AnonymousClass1 */
    ...
    private int parseC1(byte[] data, int pos) {
        ...
        switch (i) {
            case 128:
            case Const.CODE_C1_CW1 /*{ENCODED_INT: 129}*/:
            case Const.CODE_C1_CW2 /*{ENCODED_INT: 130}*/:
            case Const.CODE_C1_CW3 /*{ENCODED_INT: 131}*/:
            case Const.CODE_C1_CW4 /*{ENCODED_INT: 132}*/:
            case Const.CODE_C1_CW5 /*{ENCODED_INT: 133}*/:
            case Const.CODE_C1_CW6 /*{ENCODED_INT: 134}*/:
            case 135:
            ...
            case Const.CODE_C1_SPA /*{ENCODED_INT: 144}*/:
                ...
                return pos8;
            case Const.CODE_C1_SPC /*{ENCODED_INT: 145}*/:
                int pos9 = pos + 1;
                int pos10 = pos9 + 1;
                int pos11 = pos10 + 1;
            ...
            default:
                switch (i) {
                    case Const.CODE_C1_SWA /*{ENCODED_INT: 151}*/:
                        ...
                        return pos13;
                    case Const.CODE_C1_DF0 /*{ENCODED_INT: 152}*/:
                    case Const.CODE_C1_DF1 /*{ENCODED_INT: 153}*/:
                    case Const.CODE_C1_DF2 /*{ENCODED_INT: 154}*/:
                    case Const.CODE_C1_DF3 /*{ENCODED_INT: 155}*/:
                    case Const.CODE_C1_DF4 /*{ENCODED_INT: 156}*/:
                    case Const.CODE_C1_DF5 /*{ENCODED_INT: 157}*/:
                    case Const.CODE_C1_DF6 /*{ENCODED_INT: 158}*/:
                    case 159:
                        int pos14 = pos + 6;
                        emitCaptionEvent(new CaptionEvent(16, new CaptionWindow(this.mCommand - 152, (data[pos] & 32) != 0, (data[pos] & 16) != 0, (data[pos] & 8) != 0, data[pos] & 7, (data[pos + 1] & 128) != 0, data[pos + 1] & 127, data[pos + 2] & 255, (data[pos + 3] & 240) >> 4, 15 & data[pos + 3], data[pos + 4] & 63, 7 & data[pos + 5], (data[pos + 5] & 56) >> 3)));
                        return pos14;
                }
        }
        return pos;
    ...
    public static class CaptionColor {
        ...
        CaptionColor(int opacity2, int red2, int green2, int blue2) {
    ...
    public static class CaptionEvent {
        ...
        CaptionEvent(int type2, Object obj2) {
            this.type = type2;
            this.obj = obj2;
        }
    }
    ...
    public static class CaptionPenAttr {
        ...
        CaptionPenAttr(int penSize2, int penOffset2, int textTag2, int fontTag2, int edgeType2, boolean underline2, boolean italic2) {
    ...
    public static class CaptionPenColor {
        ...
        CaptionPenColor(CaptionColor foregroundColor2, CaptionColor backgroundColor2, CaptionColor edgeColor2) {
    ...
    public static class CaptionPenLocation {
        ...
        CaptionPenLocation(int row2, int column2) {
            this.row = row2;
            this.column = column2;
        }
    }
    ...
    public static class CaptionWindowAttr {
        ...
        CaptionWindowAttr(CaptionColor fillColor2, CaptionColor borderColor2, int borderType2, boolean wordWrap2, int printDirection2, int scrollDirection2, int justify2, int effectDirection2, int effectSpeed2, int displayEffect2) {
    ...
    public static class CaptionWindow {
        ...
        CaptionWindow(int id2, boolean visible2, boolean rowLock2, boolean columnLock2, int priority2, boolean relativePositioning2, int anchorVertical2, int anchorHorizontal2, int anchorId2, int rowCount2, int columnCount2, int penStyle2, int windowStyle2) {
            this.id = id2;
