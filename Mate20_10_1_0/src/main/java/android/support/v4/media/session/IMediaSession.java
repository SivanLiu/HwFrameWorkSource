            ...
            if (code == TRANSACTION_rateWithExtras) {
                ...
                switch (code) {
                    case 1:
                        ...
                        sendCommand(_arg011, _arg1, _arg2);
                        reply.writeNoException();
                        return true;
                    case 2:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 14:
                        ...
                        playFromMediaId(_arg012, _arg19);
                        reply.writeNoException();
                        return true;
                    case 15:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 34:
                        ...
                        prepareFromMediaId(_arg015, _arg15);
                        reply.writeNoException();
                        return true;
                    case 35:
                        data.enforceInterface(DESCRIPTOR);
                        ...
                        prepareFromSearch(_arg016, _arg14);
                        reply.writeNoException();
                        return true;
                    case 36:
                        data.enforceInterface(DESCRIPTOR);
