        ...
        if (!this.mSession.isClosed() && controller != null) {
            this.mSession.getCallbackExecutor().execute(new Runnable() {
                ...
                /* JADX WARNING: Code restructure failed: missing block: B:11:0x0026, code lost:
                    if (android.support.v4.media.MediaSession2Stub.access$200(r5.this$0, r1, r11) != false) goto L_0x0029;
                 */
                /* JADX WARNING: Code restructure failed: missing block: B:12:0x0028, code lost:
                    return;
                 */
                /* JADX WARNING: Code restructure failed: missing block: B:13:0x0029, code lost:
                    r0 = (android.support.v4.media.SessionCommand2) android.support.v4.media.MediaSession2Stub.access$300().get(r11.getCommandCode());
                 */
                /* JADX WARNING: Code restructure failed: missing block: B:15:0x0044, code lost:
                    if (android.support.v4.media.MediaSession2Stub.access$400(r5.this$0, r1, r12) != false) goto L_0x0047;
                 */
                /* JADX WARNING: Code restructure failed: missing block: B:16:0x0046, code lost:
                    return;
                 */
                /* JADX WARNING: Code restructure failed: missing block: B:17:0x0047, code lost:
                    r0 = (android.support.v4.media.SessionCommand2) android.support.v4.media.MediaSession2Stub.access$300().get(r12);
                 */
                /* JADX WARNING: Code restructure failed: missing block: B:18:0x0053, code lost:
                    if (r0 == null) goto L_0x009a;
                 */
                /* JADX WARNING: Code restructure failed: missing block: B:20:0x006b, code lost:
                    if (r5.this$0.mSession.getCallback().onCommandRequest(r5.this$0.mSession.getInstance(), r1, r0) != false) goto L_0x009a;
                 */
                /* JADX WARNING: Code restructure failed: missing block: B:21:0x006d, code lost:
                    android.util.Log.d(android.support.v4.media.MediaSession2Stub.TAG, "Command (" + r0 + ") from " + r1 + " was rejected by " + r5.this$0.mSession);
                 */
                ...
                /* JADX WARNING: Code restructure failed: missing block: B:26:0x00a3, code lost:
                    android.util.Log.w(android.support.v4.media.MediaSession2Stub.TAG, "Exception in " + r1.toString(), r1);
                 */
