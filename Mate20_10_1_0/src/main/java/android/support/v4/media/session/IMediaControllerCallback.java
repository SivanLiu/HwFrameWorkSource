    ...
    public static abstract class Stub extends Binder implements IMediaControllerCallback {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code != 1598968902) {
                ...
                Bundle _arg1 = null;
                ParcelableVolumeInfo _arg03 = null;
                Bundle _arg04 = null;
                CharSequence _arg05 = null;
                MediaMetadataCompat _arg06 = null;
                PlaybackStateCompat _arg07 = null;
                switch (code) {
                    case 1:
                    ...
                    case 3:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg07 = PlaybackStateCompat.CREATOR.createFromParcel(data);
                        }
                        onPlaybackStateChanged(_arg07);
                        return true;
                    case 4:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg06 = MediaMetadataCompat.CREATOR.createFromParcel(data);
                        }
                        onMetadataChanged(_arg06);
                        return true;
                    case 5:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 8:
                        data.enforceInterface(DESCRIPTOR);
                        if (data.readInt() != 0) {
                            _arg03 = ParcelableVolumeInfo.CREATOR.createFromParcel(data);
                        }
                        onVolumeInfoChanged(_arg03);
                        return true;
                    case 9:
                        data.enforceInterface(DESCRIPTOR);
                    ...
                    case 11:
                        ...
                        onCaptioningEnabledChanged(_arg02);
                        return true;
                    case 12:
                        data.enforceInterface(DESCRIPTOR);
