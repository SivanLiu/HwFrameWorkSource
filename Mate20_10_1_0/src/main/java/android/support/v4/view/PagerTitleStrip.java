...
public class PagerTitleStrip extends ViewGroup {
    ...
    /* JADX INFO: Multiple debug info for r1v2 int: [D('contentWidth' int), D('currRight' int)] */
    /* JADX INFO: Multiple debug info for r5v8 int: [D('alignedPrevHeight' int), D('vgrav' int)] */
