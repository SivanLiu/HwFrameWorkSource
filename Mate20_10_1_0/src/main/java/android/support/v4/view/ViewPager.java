...
public class ViewPager extends ViewGroup {
    ...
    /* JADX INFO: Multiple debug info for r5v7 int: [D('widthSpec' int), D('maxGutterSize' int)] */
    /* JADX INFO: Multiple debug info for r2v10 int: [D('widthSize' int), D('heightSpec' int)] */
    /* access modifiers changed from: protected */
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        this.mChildWidthMeasureSpec = MeasureSpec.makeMeasureSpec(childWidthSize2, 1073741824);
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            if (child2.getVisibility() != 8 && ((lp = (LayoutParams) child2.getLayoutParams()) == null || !lp.isDecor)) {
                child2.measure(MeasureSpec.makeMeasureSpec((int) (((float) childWidthSize2) * lp.widthFactor), 1073741824), this.mChildHeightMeasureSpec);
            }
        }
    }
            ...
            if (child2.getVisibility() != 8) {
                ...
                if (!lp2.isDecor && (ii = infoForChild(child2)) != null) {
                    ...
                    if (lp2.needsMeasure) {
                        ...
                        width = width2;
                        child2.measure(MeasureSpec.makeMeasureSpec((int) (((float) childWidth2) * lp2.widthFactor), 1073741824), MeasureSpec.makeMeasureSpec((height - paddingTop2) - paddingBottom2, 1073741824));
                    } else {
                        childWidth = childWidth2;
                        width = width2;
                    }
