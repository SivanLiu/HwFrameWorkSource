...
public class SmbFile extends URLConnection implements SmbConstants {
    ...
    public SmbFile(String url, NtlmPasswordAuthentication auth2) throws MalformedURLException {
        this(new URL((URL) null, url, Handler.SMB_HANDLER), auth2);
    }
    ...
    public SmbFile(String context, String name, NtlmPasswordAuthentication auth2) throws MalformedURLException {
        this(new URL(new URL((URL) null, context, Handler.SMB_HANDLER), name, Handler.SMB_HANDLER), auth2);
    }
    ...
    SmbFile(SmbFile context, String name, int type2, int attributes2, long createTime2, long lastModified2, long size2) throws MalformedURLException, UnknownHostException {
        ...
        if (context.isWorkgroup0()) {
            url = new URL((URL) null, "smb://" + name + "/", Handler.SMB_HANDLER);
        } else {
    ...
    /* JADX INFO: Multiple debug info for r0v0 jcifs.smb.SmbComQueryInformationResponse: [D('response' jcifs.smb.Trans2QueryPathInformationResponse), D('response' jcifs.smb.SmbComQueryInformationResponse)] */
    /* access modifiers changed from: package-private */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r19v0, resolved type: jcifs.smb.SmbException */
    /* JADX DEBUG: Multi-variable search result rejected for r19v1, resolved type: jcifs.smb.SmbException */
    /* JADX DEBUG: Multi-variable search result rejected for r19v3, resolved type: jcifs.smb.SmbException */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:79:0x0212, code lost:
        r18 = 0;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:81:0x021c, code lost:
        r18 = 1;
     */
    ...
    public void copyTo(SmbFile dest) throws SmbException {
        ...
        try {
            copyTo0(dest, (byte[][]) Array.newInstance(Byte.TYPE, 2, bsize), bsize, w, req, resp);
        } finally {
