...
class TransactNamedPipeOutputStream extends SmbFileOutputStream {
    ...
    @Override // java.io.OutputStream, java.io.Closeable, jcifs.smb.SmbFileOutputStream, java.lang.AutoCloseable
    public void close() throws IOException {
        this.pipe.close();
    }

    @Override // java.io.OutputStream, jcifs.smb.SmbFileOutputStream
