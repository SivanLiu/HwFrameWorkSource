...
public class SmbRandomAccessFile implements DataOutput, DataInput {
    ...
    public SmbRandomAccessFile(SmbFile file2, String mode) throws SmbException, MalformedURLException, UnknownHostException {
        this.access = 0;
        this.options = 0;
        this.tmp = new byte[8];
        ...
        file2.open(this.openFlags, this.access, 128, this.options);
        this.readSize = file2.tree.session.transport.rcv_buf_size - 70;
