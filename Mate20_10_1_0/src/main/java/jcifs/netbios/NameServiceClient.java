...
class NameServiceClient implements Runnable {
    ...
    NameServiceClient(int lport2, InetAddress laddr2) {
        ...
        this.out = new DatagramPacket(this.snd_buf, SND_BUF_SIZE, this.baddr, (int) NAME_SERVICE_UDP_PORT);
    ...
    /* access modifiers changed from: package-private */
    /* JADX WARNING: Code restructure failed: missing block: B:72:0x0073, code lost:
        continue;
     */
