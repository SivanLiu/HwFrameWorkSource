...
public class HwChangeButtonWindow extends LinearLayout {
    ...
    private void updateLayoutParams(Rect appBounds) {
        ...
        int i = IS_FRONT_NAV ? (System.getInt(this.mContext.getContentResolver(), "enable_navbar", 0) != 0) ^ 1 : 0;
    ...
    private void inflateView(Rect appBounds) {
        ...
        if (verticalscape) {
            ...
            this.mTextView.setText(33685964);
        ...
        if (this.mTextView != null) {
            ...
            this.mTextView.setText(getResourcesByLocale(this.mContext, 33685964));
            if (verticalscape) {
