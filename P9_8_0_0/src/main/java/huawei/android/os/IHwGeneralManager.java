        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 17:
                    ...
                    _result3 = startHaptic(_arg02, _arg1, uri);
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 18:
                ...
                case 24:
                    ...
                    _result = readProtectArea(_arg0, _arg1, strArr, iArr);
                    reply.writeNoException();
                    reply.writeInt(_result);
                ...
                case 25:
                    ...
                    _result = writeProtectArea(_arg0, _arg1, _arg2, iArr);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    reply.writeIntArray(iArr);
                    return true;
                ...
                case 31:
                    data.enforceInterface(DESCRIPTOR);
                    long _result6 = getPartitionInfo(data.readString(), data.readInt());
                    reply.writeNoException();
