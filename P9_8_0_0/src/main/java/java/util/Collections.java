...
import java.util.-$Lambda$i2v6-5RQNI3YGcqf1AP8d7D8zis.AnonymousClass5;
import java.util.-$Lambda$i2v6-5RQNI3YGcqf1AP8d7D8zis.AnonymousClass6;
...
public class Collections {
    ...
    static class CheckedList<E> extends CheckedCollection<E> implements List<E> {
        ...
        public void replaceAll(UnaryOperator<E> operator) {
            ...
            this.list.replaceAll(new AnonymousClass6(this, operator));
        }
    ...
    private static class CheckedMap<K, V> implements Map<K, V>, Serializable {
        ...
        private BiFunction<? super K, ? super V, ? extends V> typeCheck(BiFunction<? super K, ? super V, ? extends V> func) {
            ...
            return new AnonymousClass4(this, func);
        }
        ...
        public V computeIfAbsent(K key, Function<? super K, ? extends V> mappingFunction) {
            ...
            return this.m.computeIfAbsent(key, new AnonymousClass5(this, mappingFunction));
        }
        ...
        public V merge(K key, V value, BiFunction<? super V, ? super V, ? extends V> remappingFunction) {
            ...
            return this.m.merge(key, value, new java.util.-$Lambda$i2v6-5RQNI3YGcqf1AP8d7D8zis.AnonymousClass3(this, remappingFunction));
        }
    ...
    private static class CopiesList<E> extends AbstractList<E> implements RandomAccess, Serializable {
        ...
        public Stream<E> stream() {
            return IntStream.range(0, this.n).mapToObj(new java.util.-$Lambda$i2v6-5RQNI3YGcqf1AP8d7D8zis.AnonymousClass2(this));
        }
        ...
        public Stream<E> parallelStream() {
            return IntStream.range(0, this.n).parallel().mapToObj(new java.util.-$Lambda$i2v6-5RQNI3YGcqf1AP8d7D8zis.AnonymousClass1(this));
        }
