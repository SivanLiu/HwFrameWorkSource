...
public class ne {
    ...
    public static int bj(int -l_1_I) {
        ...
        -l_1_I2 = -l_1_I;
        f.f("ESharkCode", "appendNormalCode: " + -l_1_I + " -> " + -l_1_I2);
        return -l_1_I2;
    }
    ...
    public static boolean bk(int i) {
        ...
        int -l_1_I = bg(i);
        if (-l_1_I == -17 || -l_1_I == -18 || -l_1_I == -7 || -l_1_I == -19 || -l_1_I == -2) {
            return false;
        }
        int -l_2_I = bi(i);
        return (-l_2_I == -220000 || -l_2_I == -230000 || -l_2_I == -160000 || -l_2_I == -540000) ? false : true;
    }
