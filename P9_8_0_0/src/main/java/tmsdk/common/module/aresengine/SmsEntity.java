...
public class SmsEntity extends TelephonyEntity implements Parcelable {
    public static final Creator<SmsEntity> CREATOR = new Creator<SmsEntity>() {
        ...
        public SmsEntity f(Parcel parcel) {
    ...
    public static byte[] marshall(SmsEntity smsEntity) {
        ...
        smsEntity.writeToParcel(-l_1_R, 0);
        Object -l_2_R = -l_1_R.marshall();
        -l_1_R.recycle();
        return -l_2_R;
    }

    public static SmsEntity unmarshall(byte[] bArr) {
        Parcel -l_1_R = Parcel.obtain();
        -l_1_R.unmarshall(bArr, 0, bArr.length);
        -l_1_R.setDataPosition(0);
        Object -l_2_R = new SmsEntity(-l_1_R);
        -l_1_R.recycle();
        return -l_2_R;
    }
