...
public final class UpdateConfig {
    ...
    public static int getFileIdByFileName(String str) {
        ...
        try {
            return Integer.parseInt(str.substring(0, -l_1_I));
        } catch (Exception e) {
            return 0;
        }
    }
    ...
    public static int getFileIdByFlag(long j) {
        for (int -l_2_I = 0; -l_2_I < UPDATE_FLAGS.length; -l_2_I++) {
            if (j == UPDATE_FLAGS[-l_2_I]) {
                return FILE_IDS[-l_2_I];
            }
        }
        return 0;
    }
    ...
    public static String getFileNameByFileId(int i) {
        for (int -l_1_I = 0; -l_1_I < FILE_IDS.length; -l_1_I++) {
            if (i == FILE_IDS[-l_1_I]) {
                return FILE_NAMES[-l_1_I];
            }
        }
        return null;
    }
    ...
    public static String getFileNameIdByFlag(long j) {
        for (int -l_2_I = 0; -l_2_I < UPDATE_FLAGS.length; -l_2_I++) {
            if (j == UPDATE_FLAGS[-l_2_I]) {
                return Integer.toString(FILE_IDS[-l_2_I]) + C(j);
            }
        }
        return null;
    }
    ...
    public static long getFlagByFileName(String str) {
        for (int -l_1_I = 0; -l_1_I < FILE_NAMES.length; -l_1_I++) {
            if (str.equals(FILE_NAMES[-l_1_I])) {
                return UPDATE_FLAGS[-l_1_I];
            }
        }
        return -1;
