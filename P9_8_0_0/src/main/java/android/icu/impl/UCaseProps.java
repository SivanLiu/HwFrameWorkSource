...
public final class UCaseProps {
    ...
    private final int toUpperOrTitle(int r1, android.icu.impl.UCaseProps.ContextIterator r2, java.lang.Appendable r3, int r4, boolean r5) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.icu.impl.UCaseProps.toUpperOrTitle(int, android.icu.impl.UCaseProps$ContextIterator, java.lang.Appendable, int, boolean):int
...
*/
    ...
    public final int toFullFolding(int r1, java.lang.Appendable r2, int r3) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.icu.impl.UCaseProps.toFullFolding(int, java.lang.Appendable, int):int
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:116)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:249)
	at jadx.core.ProcessClass.process(ProcessClass.java:31)
	at jadx.core.ProcessClass.processDependencies(ProcessClass.java:56)
...
*/
        ...
        // Can't load method instructions.
        */
        throw new UnsupportedOperationException("Method not decompiled: android.icu.impl.UCaseProps.toFullFolding(int, java.lang.Appendable, int):int");
    }

    public final int toFullLower(int r1, android.icu.impl.UCaseProps.ContextIterator r2, java.lang.Appendable r3, int r4) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.icu.impl.UCaseProps.toFullLower(int, android.icu.impl.UCaseProps$ContextIterator, java.lang.Appendable, int):int
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:116)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:249)
	at jadx.core.ProcessClass.process(ProcessClass.java:31)
	at jadx.core.ProcessClass.processDependencies(ProcessClass.java:56)
