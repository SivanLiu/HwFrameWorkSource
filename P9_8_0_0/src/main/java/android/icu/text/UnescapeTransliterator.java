...
class UnescapeTransliterator extends Transliterator {
    ...
    static void register() {
        ...
        Transliterator.registerFactory("Hex-Any/Java", new Factory() {
            public Transliterator getInstance(String ID) {
                return new UnescapeTransliterator("Hex-Any/Java", new char[]{'\u0002', '\u0000', '\u0010', '\u0004', '\u0004', PatternTokenizer.BACK_SLASH, 'u', '￿'});
            }
        });
        Transliterator.registerFactory("Hex-Any/C", new Factory() {
            public Transliterator getInstance(String ID) {
                return new UnescapeTransliterator("Hex-Any/C", new char[]{'\u0002', '\u0000', '\u0010', '\u0004', '\u0004', PatternTokenizer.BACK_SLASH, 'u', '\u0002', '\u0000', '\u0010', '\b', '\b', PatternTokenizer.BACK_SLASH, 'U', '￿'});
            }
        });
        Transliterator.registerFactory("Hex-Any/XML", new Factory() {
            public Transliterator getInstance(String ID) {
                return new UnescapeTransliterator("Hex-Any/XML", new char[]{'\u0003', '\u0001', '\u0010', '\u0001', '\u0006', '&', '#', ULocale.PRIVATE_USE_EXTENSION, ';', '￿'});
            }
        });
        ...
        Transliterator.registerFactory("Hex-Any/Perl", new Factory() {
            public Transliterator getInstance(String ID) {
                return new UnescapeTransliterator("Hex-Any/Perl", new char[]{'\u0003', '\u0001', '\u0010', '\u0001', '\u0006', PatternTokenizer.BACK_SLASH, ULocale.PRIVATE_USE_EXTENSION, '{', '}', '￿'});
            }
        });
        Transliterator.registerFactory("Hex-Any", new Factory() {
            public Transliterator getInstance(String ID) {
                return new UnescapeTransliterator("Hex-Any", new char[]{'\u0002', '\u0000', '\u0010', '\u0004', '\u0006', 'U', '+', '\u0002', '\u0000', '\u0010', '\u0004', '\u0004', PatternTokenizer.BACK_SLASH, 'u', '\u0002', '\u0000', '\u0010', '\b', '\b', PatternTokenizer.BACK_SLASH, 'U', '\u0003', '\u0001', '\u0010', '\u0001', '\u0006', '&', '#', ULocale.PRIVATE_USE_EXTENSION, ';', '\u0002', '\u0001', '\n', '\u0001', '\u0007', '&', '#', ';', '\u0003', '\u0001', '\u0010', '\u0001', '\u0006', PatternTokenizer.BACK_SLASH, ULocale.PRIVATE_USE_EXTENSION, '{', '}', '￿'});
            }
        });
    }
