...
public final class DisplayManager {
    ...
    public Display[] getDisplays(String category) {
        ...
        synchronized (this.mLock) {
            ...
            Boolean isSpecialPackage = Boolean.valueOf(false);
            if (this.mContext != null) {
                String packageName = this.mContext.getPackageName();
                boolean equals = ("com.bankid.bus".equals(packageName) || "com.playstation.tornemobile".equals(packageName)) ? true : "com.fami_geki.video".equals(packageName);
                isSpecialPackage = Boolean.valueOf(equals);
            }
            if (HwPCUtils.enabledInPad() && isSpecialPackage.booleanValue()) {
