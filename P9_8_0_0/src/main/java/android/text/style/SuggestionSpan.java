...
public class SuggestionSpan extends CharacterStyle implements ParcelableSpan {
    ...
    public SuggestionSpan(Context context, Locale locale, String[] suggestions, int flags, Class<?> notificationTargetClass) {
        ...
        this.mLocaleStringForCompatibility = locale2 == null ? LogException.NO_VALUE : locale2.toString();
        this.mLanguageTag = locale2 == null ? LogException.NO_VALUE : locale2.toLanguageTag();
        if (context != null) {
        ...
        if (notificationTargetClass != null) {
            ...
            this.mNotificationTargetClassName = LogException.NO_VALUE;
        }
