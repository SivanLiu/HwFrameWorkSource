...
public final class PrintHelper {
    ...
    private static class PrintHelperImpl<RealHelper extends PrintHelperKitkat> implements PrintHelperVersionImpl {
        ...
        public void printBitmap(String jobName, Bitmap bitmap, final OnPrintFinishCallback callback) {
            android.support.v4.print.PrintHelperKitkat.OnPrintFinishCallback onPrintFinishCallback = null;
            if (callback != null) {
                onPrintFinishCallback = new android.support.v4.print.PrintHelperKitkat.OnPrintFinishCallback() {
                    public void onFinish() {
                        callback.onFinish();
                    }
                };
            }
            this.mPrintHelper.printBitmap(jobName, bitmap, onPrintFinishCallback);
        }
        ...
        public void printBitmap(String jobName, Uri imageFile, final OnPrintFinishCallback callback) throws FileNotFoundException {
            ...
            this.mPrintHelper.printBitmap(jobName, imageFile, onPrintFinishCallback);
        }
    }
