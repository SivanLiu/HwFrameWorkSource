...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent, NestedScrollingChild2, ScrollingView {
            ...
            case 2:
                ...
                if (activePointerIndex != -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        if (overScrollByCompat(0, deltaY, 0, getScrollY(), 0, range, 0, 0, true) && (hasNestedScrollingParent(0) ^ 1) != 0) {
                            this.mVelocityTracker.clear();
                        }
    ...
    boolean overScrollByCompat(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX, int scrollRangeY, int maxOverScrollX, int maxOverScrollY, boolean isTouchEvent) {
        ...
        if (clampedY && (hasNestedScrollingParent(1) ^ 1) != 0) {
        ...
        if (this.mScroller.computeScrollOffset()) {
            ...
            if (dy != 0) {
                ...
                if (!dispatchNestedScroll(0, scrolledDeltaY, 0, dy - scrolledDeltaY, null, 1)) {
                    ...
                    boolean canOverscroll = mode != 0 ? mode == 1 && range > 0 : true;
                    if (canOverscroll) {
                        ensureGlows();
                        if (y <= 0 && oldScrollY > 0) {
    ...
    private void flingWithNestedDispatch(int velocityY) {
        int scrollY = getScrollY();
        boolean canFling = (scrollY > 0 || velocityY > 0) ? scrollY < getScrollRange() || velocityY < 0 : false;
