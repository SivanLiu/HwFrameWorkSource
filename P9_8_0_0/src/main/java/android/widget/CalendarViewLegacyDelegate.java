...
jadx.core.utils.exceptions.CodegenException: Error generate insn: PHI: (r1_2 'i' int) = (r1_0 'i' int), (r1_1 'i' int) binds: {(r1_1 'i' int)=B:8:0x0061, (r1_0 'i' int)=B:7:0x005f} in method: android.widget.CalendarViewLegacyDelegate.WeekView.init(int, int, int):void
