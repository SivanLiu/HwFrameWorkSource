...
public class RemoteViews implements Parcelable, Filter {
    ...
    private static final String[] BASE_PACKAGES = new String[]{ZenModeConfig.SYSTEM_AUTHORITY, "com.huawei.systemmanager", "com.android.providers.applications", "com.android.providers.contacts", "com.android.providers.userdictionary", "com.android.providers.calendar", "com.android.providers.downloads", "com.android.providers.drm", IndexSearchConstants.MEDIA_PROVIDER_APK_NAME, "com.android.providers.downloads.ui", "com.android.calculator2", "com.android.htmlviewer", BrowserContract.AUTHORITY, "com.android.gallery3d", "com.android.exchange", "com.android.email", "com.huawei.android.hwlockscreen", "com.android.smspush", "com.google.android.gsf", "com.google.android.gsf.login", "com.google.android.gms", "com.android.vending"};
    ...
    private static class BitmapCache {
        ...
        private int addBitmapsForSafe(Bitmap b) {
            ...
            int index;
            if (this.mBitmapsCount < 50) {
                this.mBitmaps.add(b);
                index = this.mBitmapsCount;
            } else {
                index = this.mBitmapsCount % 50;
                this.mBitmaps.set(index, b);
                Log.w(RemoteViews.LOG_TAG, "RemoteViews try to cache " + this.mBitmapsCount + " bitmaps, only allows " + 50 + ", replace bitmap at index " + index);
            }
            this.mBitmapsCount++;
            return index;
        }
    ...
    private static class LayoutParamAction extends Action {
        ...
        public static final int LAYOUT_MARGIN_TOP_DIMEN = 4;
            ...
            if (target != null) {
                ...
                if (layoutParams != null) {
                    switch (this.property) {
                        ...
                        case 4:
                            if (layoutParams instanceof MarginLayoutParams) {
                                ((MarginLayoutParams) layoutParams).topMargin = resolveDimenPixelOffset(target, this.value);
                                target.setLayoutParams(layoutParams);
                                break;
                            }
                            break;
    ...
    private class ViewGroupAction extends Action {
        ...
        ViewGroupAction(Parcel parcel, BitmapCache bitmapCache, ApplicationInfo info, int depth) {
            ...
            if (parcel.readInt() == 0) {
                ...
                this.nestedViews = new RemoteViews(parcel, bitmapCache, info, depth);
            }
        }
        ...
        public boolean hasSameAppInfo(ApplicationInfo parentInfo) {
            if (this.nestedViews != null && this.nestedViews.mApplication.packageName.equals(parentInfo.packageName) && this.nestedViews.mApplication.uid == parentInfo.uid) {
                return true;
            }
            return false;
        }
        ...
        public void apply(View root, ViewGroup rootParent, OnClickHandler handler) {
            ...
            if (target != null) {
                if (this.nestedViews != null) {
                    this.nestedViews.setUseAppContext(RemoteViews.this.mUseAppContext);
        ...
        public Action initActionAsync(ViewTree root, ViewGroup rootParent, OnClickHandler handler) {
            ...
            final AsyncApplyTask task = this.nestedViews.getAsyncApplyTask(root.mRoot.getContext(), targetVg, null, handler);
        ...
        public boolean prefersAsyncApply() {
            return this.nestedViews != null ? this.nestedViews.prefersAsyncApply() : false;
        }
    }
                    ...
                    for (int i = 0; i < count; i++) {
                        ...
                        switch (tag) {
                            ...
                            case 3:
                                ...
                                break;
                            case 4:
                                this.mActions.add(new ViewGroupAction(parcel, this.mBitmapCache, this.mApplication, depth));
                                break;
                            case 5:
    ...
    public void setViewLayoutMarginTopDimen(int viewId, int topMarginDimen) {
        addAction(new LayoutParamAction(viewId, 4, topMarginDimen));
    }
    ...
    private View inflateView(Context context, final Context contextForResources, RemoteViews rv, ViewGroup parent, OnClickHandler handler) {
        ...
        if (!(handler == null || !handler.getClass().getName().contains("BaseStatusBar") || (this.mUseAppContext ^ 1) == 0)) {
            inflationContext = new ContextThemeWrapper(inflationContext, 33948039);
        }
        LayoutInflater inflater = ((LayoutInflater) context.getSystemService("layout_inflater")).cloneInContext(inflationContext);
        inflater.setFilter(this);
        if (((contextForResources.getApplicationInfo() == null ? 0 : contextForResources.getApplicationInfo().flags) & 1) != 0 && (mSystemuiHwWidget || isSystemSignature(context, context.getPackageName()))) {
