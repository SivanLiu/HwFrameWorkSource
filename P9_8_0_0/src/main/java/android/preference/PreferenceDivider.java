...
public class PreferenceDivider extends PreferenceCategory {
    ...
    public PreferenceDivider(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mDefHeight = a.getResources().getDimensionPixelSize(34472016);
    ...
    protected void onBindView(View view) {
        ...
        LinearLayout dividerContainer = (LinearLayout) view.findViewById(34603127);
        TextView titleView = (TextView) view.findViewById(16908310);
        TextView moreView = (TextView) view.findViewById(34603128);
        if (moreView != null) {
        ...
        if (!(titleView == null || (TextUtils.isEmpty(title) ^ 1) == 0 || this.mDividerHeight > titleView.getMeasuredHeight())) {
    ...
    public void setMore(CharSequence more) {
        if (more != null || this.mMore == null) {
            if (more == null || (more.equals(this.mMore) ^ 1) == 0) {
                return;
            }
        }
        this.mMore = more;
