...
public class WifiP2pServiceResponse implements Parcelable {
    public static final Creator<WifiP2pServiceResponse> CREATOR = new Creator<WifiP2pServiceResponse>() {
        public WifiP2pServiceResponse createFromParcel(Parcel in) {
            ...
            if (type == 1) {
                return WifiP2pDnsSdServiceResponse.newInstance(status, transId, dev, bArr);
            }
            if (type == 2) {
                return WifiP2pUpnpServiceResponse.newInstance(status, transId, dev, bArr);
            }
            return new WifiP2pServiceResponse(type, status, transId, dev, bArr);
        }
