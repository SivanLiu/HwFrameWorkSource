        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    ...
                    connect(_arg02, _arg12, _arg2, configRequest, data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 5:
                    ...
                    _arg0 = data.readInt();
                    if (data.readInt() != 0) {
                        publishConfig = (PublishConfig) PublishConfig.CREATOR.createFromParcel(data);
                    } else {
                        publishConfig = null;
                    }
                    publish(_arg0, publishConfig, android.net.wifi.aware.IWifiAwareDiscoverySessionCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 6:
                    ...
                    _arg0 = data.readInt();
                    if (data.readInt() != 0) {
                        subscribeConfig = (SubscribeConfig) SubscribeConfig.CREATOR.createFromParcel(data);
                    } else {
                        subscribeConfig = null;
                    }
                    subscribe(_arg0, subscribeConfig, android.net.wifi.aware.IWifiAwareDiscoverySessionCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 7:
                    ...
                    _arg1 = data.readInt();
                    if (data.readInt() != 0) {
                        publishConfig2 = (PublishConfig) PublishConfig.CREATOR.createFromParcel(data);
                    } else {
                        publishConfig2 = null;
                    }
                    updatePublish(_arg0, _arg1, publishConfig2);
                    reply.writeNoException();
                    return true;
                case 8:
                    ...
                    _arg1 = data.readInt();
                    if (data.readInt() != 0) {
                        subscribeConfig2 = (SubscribeConfig) SubscribeConfig.CREATOR.createFromParcel(data);
                    } else {
                        subscribeConfig2 = null;
                    }
                    updateSubscribe(_arg0, _arg1, subscribeConfig2);
                    reply.writeNoException();
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 10:
                    ...
                    return true;
                case 11:
                    ParcelableRttParams parcelableRttParams;
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt();
                    _arg1 = data.readInt();
                    if (data.readInt() != 0) {
                        parcelableRttParams = (ParcelableRttParams) ParcelableRttParams.CREATOR.createFromParcel(data);
                    } else {
                        parcelableRttParams = null;
                    }
                    int _result3 = startRanging(_arg0, _arg1, parcelableRttParams);
                    reply.writeNoException();
