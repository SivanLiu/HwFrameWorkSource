        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    IScannerCallback _arg02 = android.bluetooth.le.IScannerCallback.Stub.asInterface(data.readStrongBinder());
                    if (data.readInt() != 0) {
                        workSource = (WorkSource) WorkSource.CREATOR.createFromParcel(data);
                    } else {
                        workSource = null;
                    }
                    registerScanner(_arg02, workSource);
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 4:
                    ...
                    startScan(_arg0, scanSettings, data.createTypedArrayList(ScanFilter.CREATOR), data.readArrayList(getClass().getClassLoader()), data.readString());
                    reply.writeNoException();
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    startScanForIntent(pendingIntent, scanSettings, data.createTypedArrayList(ScanFilter.CREATOR), data.readString());
                    reply.writeNoException();
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    stopScanForIntent(pendingIntent, data.readString());
                    reply.writeNoException();
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 11:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        advertisingSetParameters = (AdvertisingSetParameters) AdvertisingSetParameters.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    if (data.readInt() != 0) {
                        periodicAdvertisingParameters = (PeriodicAdvertisingParameters) PeriodicAdvertisingParameters.CREATOR.createFromParcel(data);
                    } else {
                        periodicAdvertisingParameters = null;
                    }
                    if (data.readInt() != 0) {
                        advertiseData3 = (AdvertiseData) AdvertiseData.CREATOR.createFromParcel(data);
                    } else {
                        advertiseData3 = null;
                    }
                    startAdvertisingSet(advertisingSetParameters, advertiseData, advertiseData2, periodicAdvertisingParameters, advertiseData3, data.readInt(), data.readInt(), android.bluetooth.le.IAdvertisingSetCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 15:
                    ...
                    setAdvertisingData(_arg0, advertiseData);
                    reply.writeNoException();
                    return true;
                case 16:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setScanResponseData(_arg0, advertiseData);
                    reply.writeNoException();
                    return true;
                case 17:
                    AdvertisingSetParameters advertisingSetParameters2;
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt();
                    if (data.readInt() != 0) {
                        advertisingSetParameters2 = (AdvertisingSetParameters) AdvertisingSetParameters.CREATOR.createFromParcel(data);
                    } else {
                        advertisingSetParameters2 = null;
                    }
                    setAdvertisingParameters(_arg0, advertisingSetParameters2);
                    reply.writeNoException();
                    return true;
                case 18:
                    PeriodicAdvertisingParameters periodicAdvertisingParameters2;
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt();
                    if (data.readInt() != 0) {
                        periodicAdvertisingParameters2 = (PeriodicAdvertisingParameters) PeriodicAdvertisingParameters.CREATOR.createFromParcel(data);
                    } else {
                        periodicAdvertisingParameters2 = null;
                    }
                    setPeriodicAdvertisingParameters(_arg0, periodicAdvertisingParameters2);
                    reply.writeNoException();
                    return true;
                case 19:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setPeriodicAdvertisingData(_arg0, advertiseData);
                    reply.writeNoException();
                    return true;
                case 20:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 21:
                    ...
                    registerSync(scanResult, data.readInt(), data.readInt(), android.bluetooth.le.IPeriodicAdvertisingCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 22:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 35:
                    ...
                    discoverServiceByUuid(_arg0, _arg1, parcelUuid2);
                    reply.writeNoException();
                    return true;
                case 36:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 37:
                    ...
                    readUsingCharacteristicUuid(_arg0, _arg1, parcelUuid2, data.readInt(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    return true;
                case 38:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 53:
                    ...
                    _arg0 = data.readInt();
                    if (data.readInt() != 0) {
                        bluetoothGattService = (BluetoothGattService) BluetoothGattService.CREATOR.createFromParcel(data);
                    } else {
                        bluetoothGattService = null;
                    }
                    addService(_arg0, bluetoothGattService);
                    reply.writeNoException();
                    return true;
                case 54:
                    data.enforceInterface(DESCRIPTOR);
