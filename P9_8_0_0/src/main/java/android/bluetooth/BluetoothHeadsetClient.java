...
public final class BluetoothHeadsetClient implements BluetoothProfile {
    ...
    public boolean terminateCall(BluetoothDevice device, BluetoothHeadsetClientCall call) {
        ...
        if (this.mService != null && isEnabled() && isValidDevice(device)) {
            try {
                return this.mService.terminateCall(device, call);
            } catch (RemoteException e) {
                Log.e(TAG, Log.getStackTraceString(new Throwable()));
            }
        }
    ...
    public void setAudioRouteAllowed(BluetoothDevice device, boolean allowed) {
        ...
        try {
            this.mService.setAudioRouteAllowed(device, allowed);
        } catch (RemoteException e) {
            Log.e(TAG, e.toString());
        }
    }
    ...
    public boolean getAudioRouteAllowed(BluetoothDevice device) {
        if (this.mService == null || !isEnabled()) {
            ...
            try {
                return this.mService.getAudioRouteAllowed(device);
            } catch (RemoteException e) {
                Log.e(TAG, e.toString());
            }
        }
    ...
    public boolean disconnectAudio(BluetoothDevice device) {
        if (this.mService == null || !isEnabled()) {
            ...
            try {
                return this.mService.disconnectAudio(device);
            } catch (RemoteException e) {
                Log.e(TAG, e.toString());
            }
        }
