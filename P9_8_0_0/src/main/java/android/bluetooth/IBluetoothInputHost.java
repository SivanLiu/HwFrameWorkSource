        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    if (data.readInt() != 0) {
                        bluetoothHidDeviceAppConfiguration = (BluetoothHidDeviceAppConfiguration) BluetoothHidDeviceAppConfiguration.CREATOR.createFromParcel(data);
                    } else {
                        bluetoothHidDeviceAppConfiguration = null;
                    }
                    if (data.readInt() != 0) {
                        bluetoothHidDeviceAppSdpSettings = (BluetoothHidDeviceAppSdpSettings) BluetoothHidDeviceAppSdpSettings.CREATOR.createFromParcel(data);
                    } else {
                        bluetoothHidDeviceAppSdpSettings = null;
                    }
                    if (data.readInt() != 0) {
                        bluetoothHidDeviceAppQosSettings = (BluetoothHidDeviceAppQosSettings) BluetoothHidDeviceAppQosSettings.CREATOR.createFromParcel(data);
                    } else {
                        bluetoothHidDeviceAppQosSettings = null;
                    }
                    if (data.readInt() != 0) {
                        bluetoothHidDeviceAppQosSettings2 = (BluetoothHidDeviceAppQosSettings) BluetoothHidDeviceAppQosSettings.CREATOR.createFromParcel(data);
                    } else {
                        bluetoothHidDeviceAppQosSettings2 = null;
                    }
                    _result = registerApp(bluetoothHidDeviceAppConfiguration, bluetoothHidDeviceAppSdpSettings, bluetoothHidDeviceAppQosSettings, bluetoothHidDeviceAppQosSettings2, android.bluetooth.IBluetoothHidDeviceCallback.Stub.asInterface(data.readStrongBinder()));
                ...
                case 2:
                    ...
                    _result = unregisterApp(bluetoothHidDeviceAppConfiguration);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 3:
                    ...
                    _result = sendReport(bluetoothDevice, data.readInt(), data.createByteArray());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 4:
                    ...
                    _result = replyReport(bluetoothDevice, data.readByte(), data.readByte(), data.createByteArray());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 5:
                    ...
                    _result = reportError(bluetoothDevice, data.readByte());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 6:
                    ...
                    _result = unplug(bluetoothDevice);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 7:
