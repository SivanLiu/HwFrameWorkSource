        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    ...
                    scheduleResumeActivity(_arg0, _arg1, _arg22, bundle3);
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 6:
                    ...
                    scheduleLaunchActivity(intent, _arg14, _arg2, activityInfo, configuration3, configuration, compatibilityInfo3, _arg7, _arg8, _arg9, bundle4, persistableBundle, _arg122, _arg132, _arg142, _arg15, profilerInfo);
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 21:
                    ...
                    scheduleRegisteredReceiver(_arg04, intent2, _arg2, _arg32, bundle6, data.readInt() != 0, data.readInt() != 0, data.readInt(), data.readInt());
                    return true;
                case 22:
                    data.enforceInterface(DESCRIPTOR);
                    scheduleLowMemory();
                ...
                case 35:
                    ...
                    dumpHeap(_arg03, _arg12, parcelFileDescriptor2);
                    return true;
                case 36:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                ...
                case 38:
                    ...
                    setHttpProxy(_arg02, _arg12, _arg25, uri);
                    return true;
                case 39:
                    Bundle bundle7;
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 59:
                    ...
                    scheduleMultiWindowModeChanged(_arg0, _arg13, configuration2);
                    return true;
                case 60:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readStrongBinder();
                    ...
                    schedulePictureInPictureModeChanged(_arg0, _arg13, configuration2);
                    return true;
                case 61:
                    data.enforceInterface(DESCRIPTOR);
