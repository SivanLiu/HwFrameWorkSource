...
*/
        ...
        r8 = r13.mInstrumentation;	 Catch:{ Exception -> 0x00bf }
        r9 = 0;	 Catch:{ Exception -> 0x00bf }
        r0 = r6.makeApplication(r9, r8);	 Catch:{ Exception -> 0x00bf }
        r3 = r0.getBaseContext();	 Catch:{ Exception -> 0x00bf }
        r3 = (android.app.ContextImpl) r3;	 Catch:{ Exception -> 0x00bf }
        r8 = r14.info;	 Catch:{ Exception -> 0x00bf }
        r8 = r8.splitName;	 Catch:{ Exception -> 0x00bf }
        if (r8 == 0) goto L_0x0039;	 Catch:{ Exception -> 0x00bf }
    L_0x002f:
        r8 = r14.info;	 Catch:{ Exception -> 0x00bf }
        r8 = r8.splitName;	 Catch:{ Exception -> 0x00bf }
        r3 = r3.createContextForSplit(r8);	 Catch:{ Exception -> 0x00bf }
        r3 = (android.app.ContextImpl) r3;	 Catch:{ Exception -> 0x00bf }
    L_0x0039:
        r1 = r3.getClassLoader();	 Catch:{ Exception -> 0x00bf }
        r8 = r14.intent;	 Catch:{ Exception -> 0x00bf }
        r8.setExtrasClassLoader(r1);	 Catch:{ Exception -> 0x00bf }
        r8 = r14.intent;	 Catch:{ Exception -> 0x00bf }
        r8.prepareToEnterProcess();	 Catch:{ Exception -> 0x00bf }
        r14.setExtrasClassLoader(r1);	 Catch:{ Exception -> 0x00bf }
        r8 = r1.loadClass(r2);	 Catch:{ Exception -> 0x00bf }
        r7 = r8.newInstance();	 Catch:{ Exception -> 0x00bf }
        r7 = (android.content.BroadcastReceiver) r7;	 Catch:{ Exception -> 0x00bf }
        r8 = sCurrentBroadcastIntent;	 Catch:{ Exception -> 0x00ec }
        r9 = r14.intent;	 Catch:{ Exception -> 0x00ec }
        r8.set(r9);	 Catch:{ Exception -> 0x00ec }
        r7.setPendingResult(r14);	 Catch:{ Exception -> 0x00ec }
        r8 = android.util.Log.HWINFO;	 Catch:{ Exception -> 0x00ec }
        if (r8 == 0) goto L_0x009e;	 Catch:{ Exception -> 0x00ec }
    L_0x0062:
        r8 = new java.lang.StringBuilder;	 Catch:{ Exception -> 0x00ec }
        r8.<init>();	 Catch:{ Exception -> 0x00ec }
        r9 = "staticBroadcast[";	 Catch:{ Exception -> 0x00ec }
        r8 = r8.append(r9);	 Catch:{ Exception -> 0x00ec }
        r9 = r14.intent;	 Catch:{ Exception -> 0x00ec }
        r9 = r9.getAction();	 Catch:{ Exception -> 0x00ec }
        r8 = r8.append(r9);	 Catch:{ Exception -> 0x00ec }
        r9 = "](";	 Catch:{ Exception -> 0x00ec }
        r8 = r8.append(r9);	 Catch:{ Exception -> 0x00ec }
        r8 = r8.append(r15);	 Catch:{ Exception -> 0x00ec }
        r9 = "), call onReceive [";	 Catch:{ Exception -> 0x00ec }
        r8 = r8.append(r9);	 Catch:{ Exception -> 0x00ec }
        r8 = r8.append(r2);	 Catch:{ Exception -> 0x00ec }
        r9 = "]";	 Catch:{ Exception -> 0x00ec }
        r8 = r8.append(r9);	 Catch:{ Exception -> 0x00ec }
        r8 = r8.toString();	 Catch:{ Exception -> 0x00ec }
        r10 = 64;	 Catch:{ Exception -> 0x00ec }
        android.os.Trace.traceBegin(r10, r8);	 Catch:{ Exception -> 0x00ec }
    L_0x009e:
        r8 = r3.getReceiverRestrictedContext();	 Catch:{ Exception -> 0x00ec }
        r9 = r14.intent;	 Catch:{ Exception -> 0x00ec }
        r7.onReceive(r8, r9);	 Catch:{ Exception -> 0x00ec }
        r8 = android.util.Log.HWINFO;	 Catch:{ Exception -> 0x00ec }
        if (r8 == 0) goto L_0x00b0;	 Catch:{ Exception -> 0x00ec }
    L_0x00ab:
        r8 = 64;	 Catch:{ Exception -> 0x00ec }
        android.os.Trace.traceEnd(r8);	 Catch:{ Exception -> 0x00ec }
    L_0x00b0:
    ...
    L_0x00ec:
        r4 = move-exception;
        r14.sendFinished(r5);	 Catch:{ all -> 0x0121 }
        r8 = r13.mInstrumentation;	 Catch:{ all -> 0x0121 }
        r8 = r8.onException(r7, r4);	 Catch:{ all -> 0x0121 }
        if (r8 != 0) goto L_0x0128;	 Catch:{ all -> 0x0121 }
    L_0x00f8:
        r8 = new java.lang.RuntimeException;	 Catch:{ all -> 0x0121 }
        r9 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0121 }
        r9.<init>();	 Catch:{ all -> 0x0121 }
        r10 = "Unable to start receiver ";	 Catch:{ all -> 0x0121 }
        r9 = r9.append(r10);	 Catch:{ all -> 0x0121 }
        r9 = r9.append(r2);	 Catch:{ all -> 0x0121 }
        r10 = ": ";	 Catch:{ all -> 0x0121 }
        r9 = r9.append(r10);	 Catch:{ all -> 0x0121 }
        r10 = r4.toString();	 Catch:{ all -> 0x0121 }
        r9 = r9.append(r10);	 Catch:{ all -> 0x0121 }
        r9 = r9.toString();	 Catch:{ all -> 0x0121 }
        r8.<init>(r9, r4);	 Catch:{ all -> 0x0121 }
