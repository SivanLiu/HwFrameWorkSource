...
*/
        ...
        private RemoteViews applyStandardTemplateWithActions(int layoutId, StandardTemplateParams p) {
            ...
            big.setBoolean(16908692, "setEmphasizedMode", z);
            if (N > 0) {
                ...
                for (int i = 0; i < N; i++) {
                    ...
                    if (action != null) {
                        ...
                        big.addView(16908692, generateActionButton(action, z, i % 2 != 0, p.ambient));
                    }
                }
            } else {
                ...
                if (resultSpan2 instanceof TextAppearanceSpan) {
                    ...
                    if (textColor != null) {
                        ...
                        for (int i = 0; i < newColors.length; i++) {
                            newColors[i] = NotificationColorUtil.ensureLargeTextContrast(colors[i], background);
                        }
