...
public class RestoreSession {
    ...
    public int getAvailableRestoreSets(RestoreObserver observer, BackupManagerMonitor monitor) {
        ...
        if (monitor == null) {
            ...
            iBackupManagerMonitor = new BackupManagerMonitorWrapper(monitor);
        }
        try {
            err = this.mBinder.getAvailableRestoreSets(obsWrapper, iBackupManagerMonitor);
    ...
    public int restoreAll(long token, RestoreObserver observer, BackupManagerMonitor monitor) {
        ...
        try {
            err = this.mBinder.restoreAll(token, this.mObserver, iBackupManagerMonitor);
        } catch (RemoteException e) {
    ...
    public int restoreSome(long token, RestoreObserver observer, BackupManagerMonitor monitor, String[] packages) {
        ...
        try {
            err = this.mBinder.restoreSome(token, this.mObserver, iBackupManagerMonitor, packages);
        } catch (RemoteException e) {
    ...
    public int restorePackage(String packageName, RestoreObserver observer, BackupManagerMonitor monitor) {
        ...
        try {
            err = this.mBinder.restorePackage(packageName, this.mObserver, iBackupManagerMonitor);
        } catch (RemoteException e) {
