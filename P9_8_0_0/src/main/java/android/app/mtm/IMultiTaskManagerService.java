        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 10:
                    ...
                    RPolicyData _result2 = acquirePolicyData(_arg0, rSceneData);
                    reply.writeNoException();
                    if (_result2 != null) {
                        reply.writeInt(1);
                    ...
                    return true;
                case 11:
                    HwAppStartupSettingFilter hwAppStartupSettingFilter;
                    data.enforceInterface(DESCRIPTOR);
                    List<String> _arg02 = data.createStringArrayList();
                    if (data.readInt() != 0) {
                        hwAppStartupSettingFilter = (HwAppStartupSettingFilter) HwAppStartupSettingFilter.CREATOR.createFromParcel(data);
                    } else {
                        hwAppStartupSettingFilter = null;
                    }
                    List<HwAppStartupSetting> _result3 = retrieveAppStartupSettings(_arg02, hwAppStartupSettingFilter);
                    reply.writeNoException();
                ...
                case 16:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        appCleanParam = (AppCleanParam) AppCleanParam.CREATOR.createFromParcel(data);
                    } else {
                        appCleanParam = null;
                    }
                    requestAppCleanWithCallback(appCleanParam, android.app.mtm.iaware.appmng.IAppCleanCallback.Stub.asInterface(data.readStrongBinder()));
                    return true;
                case 1598968902:
