...
public class SearchDialog extends Dialog {
    ...
    static int resolveDialogTheme(Context context) {
        ...
        context.getTheme().resolveAttribute(17891501, outValue, true);
    ...
    private void createContentView() {
        ...
        this.mSearchView = (SearchView) findViewById(16909248);
        ...
        this.mBadgeLabel = (TextView) this.mSearchView.findViewById(16909239);
        this.mSearchAutoComplete = (AutoCompleteTextView) this.mSearchView.findViewById(16909247);
        this.mAppIcon = (ImageView) findViewById(16909238);
        this.mSearchPlate = this.mSearchView.findViewById(16909246);
        this.mWorkingSpinner = getContext().getDrawable(17303230);
        setWorking(false);
