    ...
    public static final class CodecCapabilities {
        ...
        public final boolean isFormatSupported(MediaFormat format) {
            ...
            for (Feature feat : getValidFeatures()) {
                ...
                if (yesNo != null && ((yesNo.intValue() == 1 && (isFeatureSupported(feat.mName) ^ 1) != 0) || (yesNo.intValue() == 0 && isFeatureRequired(feat.mName)))) {
                    return false;
                }
            }
        ...
        CodecCapabilities(android.media.MediaCodecInfo.CodecProfileLevel[] r14, int[] r15, boolean r16, int r17, android.media.MediaFormat r18, android.media.MediaFormat r19) {
...
*/
            ...
            r13.<init>();
            r4 = r19.getMap();
            r13.colorFormats = r15;
            r0 = r17;
            r13.mFlagsVerified = r0;
            r0 = r18;
            r13.mDefaultFormat = r0;
            r0 = r19;
            r13.mCapabilitiesInfo = r0;
            r8 = r13.mDefaultFormat;
            r9 = "mime";
            r8 = r8.getString(r9);
            r13.mMime = r8;
            r8 = r14.length;
        ...
        L_0x002e:
            ...
            r8 = 1;
            r6.profile = r8;
            r8 = android.media.MediaCodecInfo.VideoCapabilities.equivalentVP9Level(r19);
            r6.level = r8;
            r8 = 1;
            r14 = new android.media.MediaCodecInfo.CodecProfileLevel[r8];
            r8 = 0;
            r14[r8] = r6;
        L_0x0042:
            r13.profileLevels = r14;
            r8 = r13.mMime;
            r8 = r8.toLowerCase();
            r9 = "audio/";
            r8 = r8.startsWith(r9);
        ...
        L_0x0053:
            r0 = r19;
            r8 = android.media.MediaCodecInfo.AudioCapabilities.create(r0, r13);
            r13.mAudioCaps = r8;
            r8 = r13.mAudioCaps;
            r9 = r13.mDefaultFormat;
            r8.setDefaultFormat(r9);
        L_0x0062:
            if (r16 == 0) goto L_0x0073;
        L_0x0064:
            r0 = r19;
            r8 = android.media.MediaCodecInfo.EncoderCapabilities.create(r0, r13);
            r13.mEncoderCaps = r8;
            r8 = r13.mEncoderCaps;
            r9 = r13.mDefaultFormat;
            r8.setDefaultFormat(r9);
        L_0x0073:
            r2 = android.media.MediaCodecList.getGlobalSettings();
            r8 = "max-concurrent-instances";
            r8 = r2.get(r8);
            r9 = 32;
            r8 = android.media.Utils.parseIntSafely(r8, r9);
            r13.mMaxSupportedInstances = r8;
            r8 = "max-concurrent-instances";
            r8 = r4.get(r8);
            r9 = r13.mMaxSupportedInstances;
            r5 = android.media.Utils.parseIntSafely(r8, r9);
            r8 = 1;
            r8 = java.lang.Integer.valueOf(r8);
            r9 = 256; // 0x100 float:3.59E-43 double:1.265E-321;
            r9 = java.lang.Integer.valueOf(r9);
            r8 = android.util.Range.create(r8, r9);
            r9 = java.lang.Integer.valueOf(r5);
            r8 = r8.clamp(r9);
            r8 = (java.lang.Integer) r8;
            r8 = r8.intValue();
            r13.mMaxSupportedInstances = r8;
            r9 = r13.getValidFeatures();
            r8 = 0;
            r10 = r9.length;
        L_0x00b8:
        ...
        L_0x00ec:
            r0 = r19;
            r8 = android.media.MediaCodecInfo.VideoCapabilities.create(r0, r13);
            r13.mVideoCaps = r8;
            goto L_0x0062;
        L_0x00f6:
            r11 = r7.intValue();
        ...
        L_0x00fc:
            r11 = r13.mFlagsRequired;
            r12 = r1.mValue;
            r11 = r11 | r12;
            r13.mFlagsRequired = r11;
        L_0x0103:
            r11 = r13.mFlagsSupported;
            r12 = r1.mValue;
            r11 = r11 | r12;
            r13.mFlagsSupported = r11;
            r11 = r13.mDefaultFormat;
            r12 = 1;
            r11.setInteger(r3, r12);
            goto L_0x00da;
        L_0x0111:
            return;
            */
            throw new UnsupportedOperationException("Method not decompiled: android.media.MediaCodecInfo.CodecCapabilities.<init>(android.media.MediaCodecInfo$CodecProfileLevel[], int[], boolean, int, android.media.MediaFormat, android.media.MediaFormat):void");
        }
    }
    ...
    public static final class EncoderCapabilities {
        ...
        private void parseFromInfo(android.media.MediaFormat r9) {
            /* JADX: method processing error */
/*
Error: java.lang.IndexOutOfBoundsException: bitIndex < 0: -1
	at java.util.BitSet.get(BitSet.java:623)
...
*/
            ...
            r1 = r9.getMap();
            r3 = "complexity-range";
            r3 = r9.containsKey(r3);
            if (r3 == 0) goto L_0x001c;
        L_0x000d:
            r3 = "complexity-range";
            r3 = r9.getString(r3);
            r4 = r8.mComplexityRange;
            r3 = android.media.Utils.parseIntRange(r3, r4);
            r8.mComplexityRange = r3;
        L_0x001c:
            r3 = "quality-range";
            r3 = r9.containsKey(r3);
        ...
        L_0x004f:
            r2 = r4[r3];
            r6 = r8.mBitControl;
            r7 = parseBitrateMode(r2);
            r6 = r6 | r7;
            r8.mBitControl = r6;
            r3 = r3 + 1;
            goto L_0x004d;
        L_0x005d:
            r3 = "complexity-default";	 Catch:{ NumberFormatException -> 0x0091 }
            r3 = r1.get(r3);	 Catch:{ NumberFormatException -> 0x0091 }
            r3 = (java.lang.String) r3;	 Catch:{ NumberFormatException -> 0x0091 }
            r3 = java.lang.Integer.parseInt(r3);	 Catch:{ NumberFormatException -> 0x0091 }
            r3 = java.lang.Integer.valueOf(r3);	 Catch:{ NumberFormatException -> 0x0091 }
            r8.mDefaultComplexity = r3;	 Catch:{ NumberFormatException -> 0x0091 }
        L_0x0070:
            r3 = "quality-default";	 Catch:{ NumberFormatException -> 0x008f }
            r3 = r1.get(r3);	 Catch:{ NumberFormatException -> 0x008f }
            r3 = (java.lang.String) r3;	 Catch:{ NumberFormatException -> 0x008f }
            r3 = java.lang.Integer.parseInt(r3);	 Catch:{ NumberFormatException -> 0x008f }
            r3 = java.lang.Integer.valueOf(r3);	 Catch:{ NumberFormatException -> 0x008f }
            r8.mDefaultQuality = r3;	 Catch:{ NumberFormatException -> 0x008f }
        L_0x0083:
            r3 = "quality-scale";
            r3 = r1.get(r3);
