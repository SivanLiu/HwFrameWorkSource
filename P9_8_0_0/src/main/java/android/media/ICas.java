        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 4:
                    ...
                    return true;
                case 5:
                    ParcelableCasData parcelableCasData;
                    data.enforceInterface(DESCRIPTOR);
                    byte[] _arg0 = data.createByteArray();
                    if (data.readInt() != 0) {
                        parcelableCasData = (ParcelableCasData) ParcelableCasData.CREATOR.createFromParcel(data);
                    } else {
                        parcelableCasData = null;
                    }
                    processEcm(_arg0, parcelableCasData);
                    reply.writeNoException();
                    return true;
                case 6:
                    ParcelableCasData parcelableCasData2;
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        parcelableCasData2 = (ParcelableCasData) ParcelableCasData.CREATOR.createFromParcel(data);
                    } else {
                        parcelableCasData2 = null;
                    }
                    processEmm(parcelableCasData2);
                    reply.writeNoException();
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
