    ...
    public static abstract class Stub extends Binder implements IMediaRouterService {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    setDiscoveryRequest(android.media.IMediaRouterClient.Stub.asInterface(data.readStrongBinder()), data.readInt(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    setSelectedRoute(android.media.IMediaRouterClient.Stub.asInterface(data.readStrongBinder()), data.readString(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
