        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    ...
                    _result = findAccessibilityNodeInfoByAccessibilityId(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, bundle);
                    reply.writeNoException();
                ...
                case 7:
                    ...
                    _result2 = performAccessibilityAction(_arg0, _arg1, _arg2, bundle2, data.readInt(), android.view.accessibility.IAccessibilityInteractionConnectionCallback.Stub.asInterface(data.readStrongBinder()), data.readLong());
                    reply.writeNoException();
