...
public abstract class ColorSpace {
    ...
    static {
        ...
        sNamedColorSpaces[Named.LINEAR_SRGB.ordinal()] = new Rgb("sRGB IEC61966-2.1 (Linear)", SRGB_PRIMARIES, ILLUMINANT_D65, 1.0d, (float) TonemapCurve.LEVEL_BLACK, 1.0f, Named.LINEAR_SRGB.ordinal());
        ...
        sNamedColorSpaces[Named.DCI_P3.ordinal()] = new Rgb("SMPTE RP 431-2-2007 DCI (P3)", new float[]{0.68f, 0.32f, 0.265f, 0.69f, 0.15f, 0.06f}, new float[]{0.314f, 0.351f}, 2.6d, (float) TonemapCurve.LEVEL_BLACK, 1.0f, Named.DCI_P3.ordinal());
        colorSpaceArr = sNamedColorSpaces;
        ...
        sNamedColorSpaces[Named.ADOBE_RGB.ordinal()] = new Rgb("Adobe RGB (1998)", new float[]{0.64f, 0.33f, 0.21f, 0.71f, 0.15f, 0.06f}, ILLUMINANT_D65, 2.2d, (float) TonemapCurve.LEVEL_BLACK, 1.0f, Named.ADOBE_RGB.ordinal());
        colorSpaceArr = sNamedColorSpaces;
        ...
        sNamedColorSpaces[Named.ACES.ordinal()] = new Rgb("SMPTE ST 2065-1:2012 ACES", new float[]{0.7347f, 0.2653f, TonemapCurve.LEVEL_BLACK, 1.0f, 1.0E-4f, -0.077f}, ILLUMINANT_D60, 1.0d, -65504.0f, 65504.0f, Named.ACES.ordinal());
