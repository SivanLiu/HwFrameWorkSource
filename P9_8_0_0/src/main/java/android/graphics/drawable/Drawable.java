...
public abstract class Drawable {
    ...
    public void getOutline(Outline outline) {
        ...
        outline.setAlpha(TonemapCurve.LEVEL_BLACK);
    }
    ...
    public static Drawable createFromResourceStream(Resources res, TypedValue value, InputStream is, String srcName, Options opts) {
        ...
        if (ninePatchChunk == null || (NinePatch.isNinePatchChunk(ninePatchChunk) ^ 1) != 0) {
            ninePatchChunk = null;
            pad = null;
        }
        Rect opticalInsets = new Rect();
        bm.getOpticalInsets(opticalInsets);
        return drawableFromBitmap(res, bm, ninePatchChunk, pad, opticalInsets, srcName);
    }
