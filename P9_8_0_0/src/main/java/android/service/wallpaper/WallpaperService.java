...
public abstract class WallpaperService extends Service {
    ...
    public class Engine {
        ...
        boolean mIsCreating;
        final LayoutParams mLayout = new LayoutParams();
        ...
        void updateSurface(boolean forceRelayout, boolean forceReport, boolean redrawNeeded) {
            ...
            boolean z = (this.mWidth == myWidth && this.mHeight == myHeight) ? false : true;
            ...
            if (forceRelayout || creating || surfaceCreating || formatChanged || z || typeChanged || flagsChanged || redrawNeeded || (this.mIWallpaperEngine.mShownReported ^ 1) != 0) {
                try {
                    Rect rect;
                    this.mWidth = myWidth;
