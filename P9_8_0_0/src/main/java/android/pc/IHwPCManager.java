    ...
    public static abstract class Stub extends Binder implements IHwPCManager {
        ...
        private static class Proxy implements IHwPCManager {
            ...
            public HwRecentTaskInfo getHwRecentTaskInfo(int taskId) throws RemoteException {
                ...
                Parcel _reply = Parcel.obtain();
                try {
                    HwRecentTaskInfo hwRecentTaskInfo;
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(taskId);
                    this.mRemote.transact(11, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        hwRecentTaskInfo = (HwRecentTaskInfo) HwRecentTaskInfo.CREATOR.createFromParcel(_reply);
                    } else {
                        hwRecentTaskInfo = null;
                    }
                    _reply.recycle();
                    _data.recycle();
                    return hwRecentTaskInfo;
                } catch (Throwable th) {
                    _reply.recycle();
                    _data.recycle();
                }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 22:
                    ...
                    _result = injectInputEventExternal(inputEvent, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 23:
                ...
                case 32:
                    ...
                    dispatchKeyEventForExclusiveKeyboard(keyEvent);
                    reply.writeNoException();
                    return true;
                case 33:
                    data.enforceInterface(DESCRIPTOR);
