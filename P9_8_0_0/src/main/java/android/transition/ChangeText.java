    ...
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
        ...
        if (this.mChangeBehavior == 0) {
            ...
            if (this.mChangeBehavior == 3 || this.mChangeBehavior == 1) {
                animator = ValueAnimator.ofInt(new int[]{Color.alpha(startColor), 0});
            ...
            if (this.mChangeBehavior == 3 || this.mChangeBehavior == 2) {
                animator2 = ValueAnimator.ofInt(new int[]{0, Color.alpha(endColor)});
            ...
            if (animator != null && animator2 != null) {
                ...
                ((AnimatorSet) anim).playSequentially(new Animator[]{animator, animator2});
