        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 2:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        printDocumentInfo = (PrintDocumentInfo) PrintDocumentInfo.CREATOR.createFromParcel(data);
                    } else {
                        printDocumentInfo = null;
                    }
                    onLayoutFinished(printDocumentInfo, data.readInt() != 0, data.readInt());
                    return true;
                case 3:
                    ...
                    onLayoutFailed(charSequence, data.readInt());
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
