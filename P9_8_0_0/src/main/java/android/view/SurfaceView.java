...
public class SurfaceView extends View implements WindowStoppedCallback {
                        ...
                        try {
                            ...
                            if (visible && this.mSurface.isValid()) {
                                ...
                                if (redrawNeeded) {
                                    ...
                                    new SurfaceCallbackHelper(new android.view.-$Lambda$P6MTGFSudLpwrqb6oVD8FdorW1c.AnonymousClass1(this)).dispatchSurfaceRedrawNeededAsync(this.mSurfaceHolder, callbackArr);
                                }
                            }
                            this.mIsCreating = false;
    ...
    /* synthetic */ void lambda$-android_view_SurfaceView_36224() {
        performDrawFinished();
    }
