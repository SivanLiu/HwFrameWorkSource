    ...
    public static final class Builder {
        ...
        public CursorAnchorInfo build() {
            if (!this.mMatrixInitialized) {
                int isEmpty;
                if (this.mCharacterBoundsArrayBuilder != null) {
                    isEmpty = this.mCharacterBoundsArrayBuilder.isEmpty() ^ 1;
                } else {
                    isEmpty = 0;
                }
                if (!(isEmpty == 0 && (Float.isNaN(this.mInsertionMarkerHorizontal) ^ 1) == 0 && (Float.isNaN(this.mInsertionMarkerTop) ^ 1) == 0 && (Float.isNaN(this.mInsertionMarkerBaseline) ^ 1) == 0 && (Float.isNaN(this.mInsertionMarkerBottom) ^ 1) == 0)) {
