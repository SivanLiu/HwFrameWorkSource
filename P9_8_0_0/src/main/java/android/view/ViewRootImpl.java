...
*/
    ...
    private void performTraversals() {
        ...
        if (host != null && (this.mAdded ^ 1) == 0) {
            ...
            boolean z = !this.mFirst ? this.mViewVisibility == viewVisibility ? this.mNewSurfaceNeeded : true : false;
            if (this.mFirst) {
            ...
            boolean z2 = this.mLayoutRequested ? this.mStopped ? this.mReportNextDraw : true : false;
            if (z2) {
            ...
            boolean windowShouldResize = (!z2 || windowSizeMayChange == 0) ? false : (this.mWidth == host.getMeasuredWidth() && this.mHeight == host.getMeasuredHeight() && (lp.width != -2 || frame.width() >= desiredWindowWidth || frame.width() == this.mWidth)) ? (lp.height != -2 || frame.height() >= desiredWindowHeight) ? false : frame.height() != this.mHeight : true;
            ...
            if (this.mFirst || windowShouldResize || insetsChanged || z || params != null || this.mForceNextWindowRelayout) {
                ...
                if (isViewVisible) {
                    insetsPending = computesInternalInsets ? !this.mFirst ? z : true : false;
                }
                if (this.mSurfaceHolder != null) {
                ...
                z5 = this.mPendingContentInsets.equals(this.mAttachInfo.mContentInsets) ^ 1;
                ...
                if (!z5 && this.mLastSystemUiVisibility == this.mAttachInfo.mSystemUiVisibility) {
                    if (!this.mApplyInsetsRequested && this.mLastOverscanRequested == this.mAttachInfo.mOverscanRequested) {
                        ...
                        z4 = freeformResizing ? (relayoutResult & 8) == 0 : true;
                        if (this.mDragResizing != z4) {
                            if (z4) {
                                endDragResizing();
                            } else {
                                if (freeformResizing) {
            ...
            boolean z6 = z2 ? this.mStopped ? this.mReportNextDraw : true : false;
            if (z6) {
            ...
            boolean z7 = (z || this.mFirst) ? isViewVisible : false;
            boolean z8 = this.mAttachInfo.mHasWindowFocus ? isViewVisible : false;
            boolean z9 = z8 ? this.mLostWindowFocus : false;
            if (z9) {
                this.mLostWindowFocus = false;
            } else if (!z8 && this.mHadWindowFocus) {
            ...
            this.mHadWindowFocus = z8;
            if (z8 && (isInLocalFocusMode() ^ 1) != 0) {
                ...
                if (imTarget != this.mLastWasImTarget) {
                    ...
                    if (imm != null && imTarget) {
                        imm.onPreWindowFocus(this.mView, z8);
