        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    ...
                    sendAccessibilityEvent(accessibilityEvent, data.readInt());
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    int _result3 = addAccessibilityInteractionConnection(android.view.IWindow.Stub.asInterface(data.readStrongBinder()), android.view.accessibility.IAccessibilityInteractionConnection.Stub.asInterface(data.readStrongBinder()), data.readString(), data.readInt());
                    reply.writeNoException();
