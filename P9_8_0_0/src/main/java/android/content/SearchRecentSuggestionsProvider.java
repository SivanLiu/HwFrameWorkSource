    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        if (this.mUriMatcher.match(uri) == 1) {
            ...
            if (TextUtils.isEmpty(selectionArgs[0])) {
                ...
                strArr = this.mTwoLineDisplay ? new String[]{like, like} : new String[]{like};
                suggestSelection = this.mSuggestSuggestionClause;
            }
            Cursor c = db.query(sSuggestions, this.mSuggestionProjection, suggestSelection, strArr, null, null, ORDER_BY, null);
        ...
        if (length == 1 || length == 2) {
            ...
            if (base.equals(sSuggestions)) {
                ...
                if (projection != null && projection.length > 0) {
                    strArr2 = new String[(projection.length + 1)];
                    System.arraycopy(projection, 0, strArr2, 0, projection.length);
                    strArr2[projection.length] = "_id AS _id";
                }
                ...
                c = db.query(base, strArr2, stringBuilder.toString(), selectionArgs, null, null, sortOrder, null);
                c.setNotificationUri(getContext().getContentResolver(), uri);
                return c;
            }
            throw new IllegalArgumentException("Unknown Uri");
