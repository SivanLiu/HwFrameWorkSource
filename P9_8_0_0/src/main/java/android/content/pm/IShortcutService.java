        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 9:
                    ...
                    _arg0 = data.readString();
                    if (data.readInt() != 0) {
                        shortcutInfo = (ShortcutInfo) ShortcutInfo.CREATOR.createFromParcel(data);
                    } else {
                        shortcutInfo = null;
                    }
                    if (data.readInt() != 0) {
                    ...
                    _result = requestPinShortcut(_arg0, shortcutInfo, intentSender, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 10:
                    ...
                    Intent _result4 = createShortcutResultIntent(_arg0, shortcutInfo, data.readInt());
                    reply.writeNoException();
                    if (_result4 != null) {
                        reply.writeInt(1);
                ...
                case 11:
                    ...
                    disableShortcuts(_arg0, _arg1, charSequence, data.readInt(), data.readInt());
                    reply.writeNoException();
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
