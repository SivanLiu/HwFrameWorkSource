...
*/
    ...
    private static void collectCertificates(Package pkg, File apkFile, int parseFlags) throws PackageParserException {
        ...
        try {
            ...
            if ((parseFlags & 2048) != 0) {
                throw new PackageParserException(PackageManager.INSTALL_PARSE_FAILED_NO_CERTIFICATES, "No APK Signature Scheme v2 signature in ephemeral package " + apkPath, e3);
    ...
    public static ApkLite parseApkLite(File apkFile, int flags) throws PackageParserException {
        ...
        try {
            ...
            ApkLite parseApkLite = parseApkLite(apkPath, parser, parser, flags, signatures, certificateArr);
            IoUtils.closeQuietly(parser);
            IoUtils.closeQuietly(autoCloseable);
            return parseApkLite;
        } catch (Exception e) {
