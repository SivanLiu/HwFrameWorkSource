...
*/
    ...
    private void updateDpiConfiguration() {
        if (this.mLockDpi) {
            ...
            if (mPadDpi2 == 0 || mPadDpi2 == srcDpi || densityDpi == mPadDpi2 || densityDpi == ((int) (((((float) (mPadDpi2 * rogDpi)) * 1.0f) / ((float) dpi)) * 1.0f))) {
                if (mPadDpi2 != 0 || dpi == srcDpi || dpi == 0 || srcDpi == 0 || densityDpi == srcDpi || densityDpi == ((int) (((((float) (srcDpi * rogDpi)) * 1.0f) / ((float) dpi)) * 1.0f))) {
                    return;
                }
            }
            if (mPadDpi2 > 0) {
