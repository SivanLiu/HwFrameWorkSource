...
public class AlgorithmDecomposer {
    ...
    public Set<String> decompose(String algorithm) {
        ...
        if (elements.contains("SHA1") && (elements.contains("SHA-1") ^ 1) != 0) {
            elements.add("SHA-1");
        }
        if (elements.contains("SHA-1") && (elements.contains("SHA1") ^ 1) != 0) {
            elements.add("SHA1");
        }
        if (elements.contains("SHA224") && (elements.contains("SHA-224") ^ 1) != 0) {
            elements.add("SHA-224");
        }
        if (elements.contains("SHA-224") && (elements.contains("SHA224") ^ 1) != 0) {
            elements.add("SHA224");
        }
        if (elements.contains("SHA256") && (elements.contains("SHA-256") ^ 1) != 0) {
            elements.add("SHA-256");
        }
        if (elements.contains("SHA-256") && (elements.contains("SHA256") ^ 1) != 0) {
            elements.add("SHA256");
        }
        if (elements.contains("SHA384") && (elements.contains("SHA-384") ^ 1) != 0) {
            elements.add("SHA-384");
        }
        if (elements.contains("SHA-384") && (elements.contains("SHA384") ^ 1) != 0) {
            elements.add("SHA384");
        }
        if (elements.contains("SHA512") && (elements.contains("SHA-512") ^ 1) != 0) {
            elements.add("SHA-512");
        }
        if (elements.contains("SHA-512") && (elements.contains("SHA512") ^ 1) != 0) {
            elements.add("SHA512");
        }
        return elements;
    }
    ...
    public static String hashName(String algorithm) {
        return algorithm.replace(LanguageTag.SEP, (CharSequence) "");
    }
}
