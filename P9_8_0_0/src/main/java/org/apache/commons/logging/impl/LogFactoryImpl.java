...
public class LogFactoryImpl extends LogFactory {
    ...
    private Log discoverLogImplementation(String logCategory) throws LogConfigurationException {
        ...
        if (specifiedLogClassName != null) {
            ...
            log = createLogFromClass(specifiedLogClassName, logCategory, true);
            if (log != null) {
                return log;
            }
        ...
        for (int i = 0; i < classesToDiscover.length && log == null; i++) {
            log = createLogFromClass(classesToDiscover[i], logCategory, true);
        }
        if (log != null) {
            return log;
        }
    ...
    private Log createLogFromClass(String logAdapterClassName, String logCategory, boolean affectState) throws LogConfigurationException {
        ...
        if (logAdapter != null && affectState) {
            ...
            try {
                this.logMethod = cls.getMethod("setLogFactory", this.logMethodSignature);
            ...
            logDiagnostic("Log adapter '" + logAdapterClassName + "' from classloader " + LogFactory.objectId(cls.getClassLoader()) + " has been selected for use.");
        }
        return logAdapter;
    }
