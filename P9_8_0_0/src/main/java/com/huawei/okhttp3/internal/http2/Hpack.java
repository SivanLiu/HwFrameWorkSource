    ...
    static final class Reader {
        ...
        void readHeaders() throws IOException {
            while (!this.source.exhausted()) {
                ...
                if (b == AppOpsManagerEx.TYPE_MICROPHONE) {
                    throw new IOException("index == 0");
                } else if ((b & AppOpsManagerEx.TYPE_MICROPHONE) == AppOpsManagerEx.TYPE_MICROPHONE) {
        ...
        int readInt(int firstByte, int prefixMask) throws IOException {
            ...
            while (true) {
                int b = readByte();
                if ((b & AppOpsManagerEx.TYPE_MICROPHONE) == 0) {
        ...
        ByteString readByteString() throws IOException {
            ...
            boolean huffmanDecode = (firstByte & AppOpsManagerEx.TYPE_MICROPHONE) == AppOpsManagerEx.TYPE_MICROPHONE;
    ...
    static final class Writer {
        ...
        void writeHeaders(List<Header> headerBlock) throws IOException {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (headerIndex != -1) {
                    writeInt(headerIndex, 127, AppOpsManagerEx.TYPE_MICROPHONE);
                } else if (headerNameIndex == -1) {
                    this.out.writeByte(64);
                    writeByteString(name);
                    writeByteString(value);
                    insertIntoDynamicTable(header);
                } else if (!name.startsWith(Header.PSEUDO_PREFIX) || (Header.TARGET_AUTHORITY.equals(name) ^ 1) == 0) {
        ...
        void writeInt(int value, int prefixMask, int bits) {
            ...
            value -= prefixMask;
            while (value >= AppOpsManagerEx.TYPE_MICROPHONE) {
                this.out.writeByte((value & 127) | AppOpsManagerEx.TYPE_MICROPHONE);
                value >>>= 7;
            }
        ...
        void writeByteString(ByteString data) throws IOException {
            ...
            writeInt(huffmanBytes.size(), 127, AppOpsManagerEx.TYPE_MICROPHONE);
