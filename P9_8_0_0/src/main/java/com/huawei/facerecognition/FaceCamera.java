    ...
    public int createPreviewRequest(int requestType) {
        ...
        if (this.fpsRanges != null) {
            ...
            for (Range<Integer> fpsRange : this.fpsRanges) {
                if (fpsRange != null && (r8 == null || (((Integer) fpsRange.getUpper()).intValue() <= ((Integer) r8.getUpper()).intValue() && ((Integer) fpsRange.getLower()).intValue() <= ((Integer) r8.getLower()).intValue()))) {
                    range = fpsRange;
                }
            }
        }
