...
public interface IHwWindowManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IHwWindowManager {
        ...
        static final int TRANSACTION_isAppNotchSupport = 2;
        static final int TRANSACTION_releaseSnapshots = 1;
        ...
        private static class Proxy implements IHwWindowManager {
            ...
            public int releaseSnapshots(int memLevel) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(memLevel);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    int _result = releaseSnapshots(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result2 = isAppNotchSupport(data.readString());
                    reply.writeNoException();
    ...
    int releaseSnapshots(int i) throws RemoteException;
}
