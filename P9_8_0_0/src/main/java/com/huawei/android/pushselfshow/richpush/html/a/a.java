...
public class a implements SensorEventListener, g {
    ...
    private void a(JSONObject jSONObject) {
        ...
        if (this.l != 2 && this.l != 1) {
            a(1);
            this.b = true;
            Object -l_2_R = this.c.getSensorList(1);
            if (-l_2_R != null && -l_2_R.size() > 0) {
                this.d = (Sensor) -l_2_R.get(0);
        ...
        if ((System.currentTimeMillis() - this.s >= 2000 ? 1 : 0) != 0) {
            ...
            try {
                if ("TYPE_SHAKE".equals(this.o)) {
                    -l_2_R = b.c(this.e);
                    if (-l_2_R != null) {
                        Object -l_3_R = -l_2_R + File.separator + "pushresources/shake.mp3".substring(0, "pushresources/shake.mp3".indexOf("/"));
                        if (!new File(-l_3_R).exists() && new File(-l_3_R).mkdirs()) {
                            c.e("PushSelfShowLog", "resource mkdir true");
                        }
                        String -l_4_R = -l_2_R + File.separator + "pushresources/shake.mp3";
                        com.huawei.android.pushselfshow.utils.a.a(this.e, "pushresources/shake.mp3", -l_4_R);
                        if (new File(-l_4_R).exists()) {
                ...
                c.d("PushSelfShowLog", " error", -l_2_R2);
            }
        }
    }
    ...
    private JSONObject i() {
        ...
        try {
            -l_1_R.put("x", (double) this.h);
            -l_1_R.put("y", (double) this.i);
            -l_1_R.put("z", (double) this.j);
            -l_1_R.put("timestamp", this.k);
        } catch (Object -l_2_R) {
            c.d("PushSelfShowLog", -l_2_R.toString());
        }
        return -l_1_R;
    }
