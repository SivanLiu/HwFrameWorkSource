...
public abstract class a extends Thread {
    ...
    private Socket fx(String str, int i, boolean z) {
        ...
        try {
            ...
            try {
                ...
                if (socket != null) {
                    try {
                        ...
                        c.sf("PushLog2951", "call socket.close cause IOException:" + com.huawei.android.pushagent.utils.b.tj(e3));
                    }
                }
                throw new PushException("create socket failed", ErrorType.Err_Connect);
            } catch (SocketException e4) {
                e3 = e4;
                c.sf("PushLog2951", "call connectSync cause SocketException :" + com.huawei.android.pushagent.utils.b.tj(e3));
                com.huawei.android.pushagent.a.a.xv(50);
                if (socket != null) {
                    socket.close();
                }
                ...
                e3 = e5;
                c.sf("PushLog2951", "call connectSync cause IOException:" + com.huawei.android.pushagent.utils.b.tj(e3));
                com.huawei.android.pushagent.a.a.xv(50);
                if (socket != null) {
                    socket.close();
                }
                ...
                e3 = e6;
                c.sf("PushLog2951", "call connectSync cause Exception:" + com.huawei.android.pushagent.utils.b.tj(e3));
                com.huawei.android.pushagent.a.a.xv(50);
                if (socket != null) {
                    socket.close();
                }
            ...
            e3 = e7;
            socket = null;
            c.se("PushLog2951", "call getBytes cause:" + e3.toString(), e3);
            com.huawei.android.pushagent.a.a.xv(50);
            if (socket != null) {
                socket.close();
            }
