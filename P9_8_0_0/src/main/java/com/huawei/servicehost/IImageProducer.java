        ...
        private static class Proxy implements IImageProducer {
            ...
            public ImageDescriptor getImageDescriptor() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        imageDescriptor = (ImageDescriptor) ImageDescriptor.CREATOR.createFromParcel(_reply);
                    } else {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 10:
                    ...
                    _result2 = open1(imageDescriptor, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 1598968902:
