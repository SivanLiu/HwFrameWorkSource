            ...
            public HwMSDPDeviceStatusChangeEvent getCurrentDeviceStatus(String packageName) throws RemoteException {
                ...
                try {
                    ...
                    if (_reply.readInt() == 0) {
                        ...
                        hwMSDPDeviceStatusChangeEvent = (HwMSDPDeviceStatusChangeEvent) HwMSDPDeviceStatusChangeEvent.CREATOR.createFromParcel(_reply);
                    }
                    _reply.recycle();
                    _data.recycle();
                    return hwMSDPDeviceStatusChangeEvent;
                } catch (Throwable th) {
                    _reply.recycle();
                    _data.recycle();
                }
