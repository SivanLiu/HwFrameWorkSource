...
public class SocketListenerTransport extends Stub {
    ...
    class ChannelCreateRequestImpl implements ChannelCreateRequest {
        ...
        public int getBusinessId() {
            int result = -1;
            try {
                result = this.mInnerRequest.getBusinessId();
        ...
        public int getSecurityType() {
            int result = 0;
            try {
                result = this.mInnerRequest.getSecurityType();
            } catch (RemoteException e) {
                e.printStackTrace();
            }
            return result;
        ...
        public String getTag() {
            String result = "";
            try {
                result = this.mInnerRequest.getTag();
            } catch (RemoteException e) {
                e.printStackTrace();
            }
            return result;
        ...
        public BusinessTypeEnum getBusinessType() {
            ...
            try {
                result = NearbySDKUtils.getEnumFromInt(this.mInnerRequest.getBusinessType());
            } catch (RemoteException e) {
                e.printStackTrace();
            }
            return result;
        ...
        public int getChannelId() {
            int result = -1;
            try {
                result = this.mInnerRequest.getChannelId();
            } catch (RemoteException e) {
                e.printStackTrace();
            }
            return result;
        ...
        public String getServiceUuid() {
            String result = "";
            try {
                result = this.mInnerRequest.getServiceUuid();
            } catch (RemoteException e) {
                e.printStackTrace();
            }
            return result;
        ...
        public int getPort() {
            int result = -1;
            try {
                result = this.mInnerRequest.getPort();
            } catch (RemoteException e) {
                e.printStackTrace();
            }
            return result;
