        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 5:
                    ...
                    _result2 = sendFile(nearbyDevice, data.readInt(), (Uri[]) data.createTypedArray(Uri.CREATOR), com.huawei.nearbysdk.DTCP.ITransmitCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                ...
                case 6:
                    ...
                    _result2 = sendText(nearbyDevice, data.readInt(), data.readString(), com.huawei.nearbysdk.DTCP.ITransmitCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    reply.writeStrongBinder(_result2 != null ? _result2.asBinder() : null);
                    return true;
                case 7:
