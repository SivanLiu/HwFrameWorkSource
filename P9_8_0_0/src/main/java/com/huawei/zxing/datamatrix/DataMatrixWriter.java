...
public final class DataMatrixWriter implements Writer {
    ...
    public BitMatrix encode(String contents, BarcodeFormat format, int width, int height, Map<EncodeHintType, ?> hints) {
        if (contents.isEmpty()) {
            ...
            String encoded = HighLevelEncoder.encodeHighLevel(contents, shape, dimension, maxSize);
            SymbolInfo symbolInfo = SymbolInfo.lookup(encoded.length(), shape, dimension, maxSize, true);
