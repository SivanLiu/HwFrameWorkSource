...
final class PDF417ErrorCorrection {
    ...
    static int getRecommendedMinimumErrorCorrectionLevel(int n) throws WriterException {
        if (n <= 0) {
            ...
            if (n <= SmsConstantsEx.MAX_USER_DATA_SEPTETS) {
                return 3;
            }
            if (n <= 320) {
                return 4;
