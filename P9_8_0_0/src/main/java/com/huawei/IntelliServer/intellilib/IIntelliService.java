        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    ...
                    return true;
                case 4:
                    IntelliImgDescriptor intelliImgDescriptor;
                    data.enforceInterface(DESCRIPTOR);
                    int _arg0 = data.readInt();
                    if (data.readInt() == 0) {
                        intelliImgDescriptor = null;
                    } else {
                        intelliImgDescriptor = (IntelliImgDescriptor) IntelliImgDescriptor.CREATOR.createFromParcel(data);
                    }
                    registFaceId(_arg0, intelliImgDescriptor);
                    reply.writeNoException();
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
