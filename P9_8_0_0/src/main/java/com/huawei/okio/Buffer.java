...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
        ...
        if (string == null) {
            ...
            while (i < endIndex) {
                ...
                if (c < AppOpsManagerEx.TYPE_MICROPHONE) {
                    ...
                    writeByte((c & 63) | AppOpsManagerEx.TYPE_MICROPHONE);
                    i2 = i + 1;
                    ...
                    if (c > 56319 || low < 56320 || low > 57343) {
                        ...
                        writeByte((codePoint & 63) | AppOpsManagerEx.TYPE_MICROPHONE);
                        i2 = i + 2;
                    }
                }
                i = i2;
    ...
    public Buffer writeDecimalLong(long v) {
        ...
        int width = v < 100000000 ? v < 10000 ? v < 100 ? v < 10 ? 1 : 2 : v < 1000 ? 3 : 4 : v < 1000000 ? v < 100000 ? 5 : 6 : v < 10000000 ? 7 : 8 : v < 1000000000000L ? v < 10000000000L ? v < RealConnection.maxReserveDurationNs ? 9 : 10 : v < 100000000000L ? 11 : 12 : v < 1000000000000000L ? v < 10000000000000L ? 13 : v < 100000000000000L ? 14 : 15 : v < 100000000000000000L ? v < 10000000000000000L ? 16 : 17 : v < 1000000000000000000L ? 18 : 19;
        if (negative) {
            width++;
        }
