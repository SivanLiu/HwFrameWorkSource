...
public class HwCCModePlugin extends Stub implements IHwSecurityPlugin {
    ...
    private void waitForConfirm() {
        ...
        AlertDialog dialog = new Builder(this.mContext).setTitle(this.mContext.getString(33686057)).setMessage(this.mContext.getString(33686060)).setNeutralButton(this.mContext.getString(33685533), new OnClickListener() {
