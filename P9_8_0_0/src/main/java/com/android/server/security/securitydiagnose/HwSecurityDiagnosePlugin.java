...
public class HwSecurityDiagnosePlugin extends Stub implements IHwSecurityPlugin {
    ...
    private void setTriggerTime() {
        ...
        ((AlarmManager) this.mContext.getSystemService("alarm")).setRepeating(3, SystemClock.elapsedRealtime() + DELAY_TRIGGER_ROOT_SCAN, DELAY_TRIGGER_ROOT_SCAN, PendingIntent.getBroadcast(this.mContext, 0, new Intent(ROOT_ALARM_ACTION), 268435456));
    }
