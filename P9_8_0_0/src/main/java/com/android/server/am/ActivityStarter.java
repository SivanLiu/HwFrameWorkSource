...
public class ActivityStarter extends AbsActivityStarter {
                    ...
                    try {
                        ...
                        if (container != null || container.mParentActivity == null || container.mParentActivity.state == ActivityState.RESUMED) {
                            ...
                            if (HwDeviceManager.disallowOp(intent)) {
                                ...
                                res = startActivityLocked(caller, intent, intent2, resolvedType, aInfo2, rInfo2, voiceSession, voiceInteractor, resultTo, resultWho, requestCode, callingPid, callingUid, callingPackage, realCallingPid, realCallingUid, startFlags, options, ignoreTargetSecurity, componentSpecified, outRecord, container, inTask, reason);
    ...
    private boolean canLaunchIntoFocusedStack(ActivityRecord r, boolean newTask) {
        ...
        if (z && ((!newTask || focusedStack.mActivityContainer.isEligibleForNewTasks()) && this.mSourceDisplayId == focusedStack.mDisplayId)) {
            z2 = true;
        }
        return z2;
    }
