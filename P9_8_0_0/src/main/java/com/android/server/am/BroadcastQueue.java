                                            ...
                                            if (skip2 == 0) {
                                                ...
                                                if (allowed != 0) {
                                                    if (allowed != 3) {
                                                        ...
                                                        skip2 = 1;
                                                    } else if ((r.intent.getFlags() & 8388608) != 0 || (r.intent.getComponent() == null && r.intent.getPackage() == null && (r.intent.getFlags() & 16777216) == 0 && (isSignaturePerm(r.requiredPermissions) ^ 1) != 0)) {
