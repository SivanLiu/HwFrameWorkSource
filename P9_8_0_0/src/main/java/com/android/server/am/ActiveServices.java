        ...
        if (r.app != null && r.app.thread != null) {
            ...
            if (this.mAm.mUserController.hasStartedUserState(r.userId)) {
                ...
                if (app == null && (permissionsReviewRequired ^ 1) != 0) {
                    ...
                    String[] strArr = null;
                    if (HwPCUtils.isPcCastModeInServer() && this.mAm.mHwAMSEx != null) {
                        strArr = this.mAm.mHwAMSEx.initPCEntryArgsForService(r, this.mAm);
                        if (strArr.length == 0) {
                            strArr = null;
                        }
                    }
                    ...
                    app = this.mAm.startProcessLocked(procName, r.appInfo, true, intentFlags, hostingType, r.name, false, isolated, 0, false, null, null, strArr, null);
                    if (app == null) {
