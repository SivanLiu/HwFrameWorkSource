...
*/
    ...
    boolean shouldBeVisibleIgnoringKeyguard(boolean behindTranslucentActivity, boolean stackVisibleBehind, ActivityRecord visibleBehind, boolean behindFullscreenActivity) {
        ...
        boolean z = (!behindFullscreenActivity || this.mLaunchTaskBehind) ? true : activityVisibleBehind;
    ...
    static ActivityRecord restoreFromXml(XmlPullParser in, ActivityStackSupervisor stackSupervisor) throws IOException, XmlPullParserException {
        ...
        if (intent != null) {
            ...
            aInfo = stackSupervisor.resolveActivity(intent, resolvedType, 0, null, userId);
            if (aInfo != null) {
                ActivityRecord r2 = HwServiceFactory.createActivityRecord(service, null, 0, launchedFromUid, launchedFromPackage, intent, resolvedType, aInfo, service.getConfiguration(), null, null, 0, componentSpecified, false, stackSupervisor, null, null, null);
