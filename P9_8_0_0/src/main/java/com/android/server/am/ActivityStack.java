...
jadx.core.utils.exceptions.CodegenException: Error generate insn: PHI: (r11_1 'taskNdx' int) = (r11_0 'taskNdx' int), (r11_4 'taskNdx' int) binds: {(r11_4 'taskNdx' int)=B:26:0x0069, (r11_0 'taskNdx' int)=B:8:0x0010} in method: com.android.server.am.ActivityStack.findNextTranslucentActivity(com.android.server.am.ActivityRecord):com.android.server.am.ActivityRecord
...
*/
            ...
            boolean checkKeyguardVisibility(ActivityRecord r, boolean shouldBeVisible, boolean isTop) {
                ...
                boolean z2 = r.hasShowWhenLockedWindows() ? isInPinnedStack ^ 1 : false;
            ...
            protected boolean moveTaskToBackLocked(int taskId) {
                ...
                if (!prevIsHome && ((task != tr || !r4) && ((numTasks > 1 && !noValidateTask) || !isOnHomeDisplay()))) {
