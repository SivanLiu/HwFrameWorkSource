        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    notifManager.notifyAsUser(PreBootBroadcaster.TAG, 13, new Builder(PreBootBroadcaster.this.mService.mContext, SystemNotificationChannels.UPDATES).setSmallIcon(17303329).setWhen(0).setOngoing(true).setTicker(title).setColor(context.getColor(17170769)).setContentTitle(title).setContentIntent(activity).setVisibility(1).setProgress(max, index, false).build(), UserHandle.of(PreBootBroadcaster.this.mUserId));
                    return;
                case 2:
