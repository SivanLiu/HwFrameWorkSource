        ...
        class TetherMasterUtilState extends State {
            ...
            protected int findPreferredUpstreamType(boolean tryCell) {
                ...
                for (Integer netType2 : cfg.preferredUpstreamIfaceTypes) {
                    NetworkInfo info = cm.getNetworkInfo(netType2.intValue());
...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Exception block dominator not found, method:com.android.server.connectivity.Tethering.setUsbTethering(boolean):int. bs: [B:11:0x003f, B:26:0x006d]
