            ...
            while (true) {
                ...
                if (type == 1) {
                    ...
                    if (tag.equals(TAG_DEVICE_OWNER)) {
                        this.mDeviceOwner = new OwnerInfo(parser.getAttributeValue(null, ATTR_NAME), parser.getAttributeValue(null, "package"), false, null, null);
                        ...
                        if (tag.equals(TAG_DEVICE_INITIALIZER)) {
                            ...
                            if (tag.equals(TAG_PROFILE_OWNER)) {
                                ...
                                if (profileOwnerComponentStr != null) {
                                    ...
                                    if (admin != null) {
                                        obj = new OwnerInfo(profileOwnerName, admin, false, null, null);
                                    } else {
                                        Slog.e(TAG, "Error parsing device-owner file. Bad component name " + profileOwnerComponentStr);
                                    }
                                }
                                if (obj == null) {
                                    OwnerInfo ownerInfo = new OwnerInfo(profileOwnerName, profileOwnerPackageName, false, null, null);
                                }
