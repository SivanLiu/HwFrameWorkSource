...
public class PackageManagerService extends AbsPackageManagerService implements PackageSender, IHwPackageManagerInner {
    ...
    public static final int REASON_BG_SPEED_DEXOPT = 5;
    public static final int REASON_BOOT = 1;
    public static final int REASON_FIRST_BOOT = 0;
    public static final int REASON_INSTALL = 2;
    public static final int REASON_LAST = 5;
    ...
    static final int SCAN_UNPACKING_LIB = 524288;
    ...
    private boolean need_ux_opt = false;
    ...
    final class ActivityIntentResolver extends IntentResolver<ActivityIntentInfo, ResolveInfo> {
        ...
        protected ResolveInfo newResult(ActivityIntentInfo info, int match, int userId) {
            ...
            boolean matchInstantApp = (this.mFlags & 8388608) != 0;
    ...
    @IntDef(prefix = {"TYPE_"}, value = {0, 1, 2, 3, 4})
        ...
        protected void filterResults(List<AuxiliaryResolveInfo> results) {
            if (this.mOrderResult.size() != 0) {
                ...
                while (i < resultSize) {
                    ...
                    Pair<Integer, InstantAppResolveInfo> savedInfo = (Pair) this.mOrderResult.get(info.getPackageName());
                    if (savedInfo != null) {
...
*/
        ...
        public void handleStartCopy() throws RemoteException {
            ...
            if (ret == 1) {
                ...
                if (this.origin.existing || requiredUid == -1 || !PackageManagerService.this.isVerificationEnabled(verifierUser.getIdentifier(), this.installFlags, installerUid)) {
                    ...
                    intent.addFlags(1);
                    List<ResolveInfo> receivers = PackageManagerService.this.queryIntentReceiversInternal(intent, PackageManagerService.PACKAGE_MIME_TYPE, 0, verifierUser.getIdentifier());
                    ...
                    intent.putExtra("android.content.pm.extra.VERIFICATION_PACKAGE_NAME", pkgLite.packageName);
                    intent.putExtra("android.content.pm.extra.VERIFICATION_VERSION_CODE", pkgLite.versionCode);
                    ...
                    if (ret == 1 && PackageManagerService.this.mRequiredVerifierPackage != null) {
                        ...
                        intent.setComponent(requiredVerifierComponent);
                        ...
                        PackageManagerService.this.mContext.sendOrderedBroadcastAsUser(intent, verifierUser, "android.permission.PACKAGE_VERIFICATION_AGENT", new BroadcastReceiver() {
    ...
    private class IntentVerifierProxy implements IntentFilterVerifier<ActivityIntentInfo> {
        ...
        private void sendVerificationRequest(int userId, int verificationId, IntentFilterVerificationState ivs) {
            ...
            PackageManagerService.this.getDeviceIdleController().addPowerSaveTempWhitelistApp(Process.myUid(), this.mIntentFilterVerifierComponent.getPackageName(), PackageManagerService.this.getVerificationTimeout(), userId == -1 ? 0 : userId, false, "intent filter verifier");
    ...
    private class PackageManagerInternalImpl extends PackageManagerInternal {
        ...
        public List<ResolveInfo> queryIntentActivities(Intent intent, int flags, int filterCallingUid, int userId) {
            return PackageManagerService.this.queryIntentActivitiesInternal(intent, intent.resolveTypeIfNeeded(PackageManagerService.this.mContext.getContentResolver()), flags, filterCallingUid, userId, false);
        }
    ...
    private final class ProviderIntentResolver extends IntentResolver<ProviderIntentInfo, ResolveInfo> {
        ...
        protected ResolveInfo newResult(ProviderIntentInfo filter, int match, int userId) {
            ...
            PackageUserState userState = ps.readUserState(userId);
            boolean matchVisibleToInstantApp = (this.mFlags & 16777216) != 0;
            boolean isInstantApp = (this.mFlags & 8388608) != 0;
            if (matchVisibleToInstantApp) {
    ...
    private void handlePackagePostInstall(PackageInstalledInfo res, boolean grantPermissions, boolean killApp, String[] grantedPermissions, boolean launchedForRestore, String installerPackage, IPackageInstallObserver2 installObserver) {
        if (res.returnCode == 1) {
            ...
            String str = res.removedInfo != null ? res.removedInfo.installerPackageName : null;
            ...
            if (res.pkg.staticSharedLibName == null) {
                ...
                sendPackageAddedForNewUsers(packageName, res.pkg.applicationInfo.isSystemApp(), UserHandle.getAppId(res.uid), firstUsers);
    ...
    public PackageManagerService(Context context, Installer installer, boolean factoryTest, boolean onlyCore) {
        ...
        if (HWFLOW) {
            ...
            Slog.i(str, append.append(i2).append(" **** Config Init  ************ Time to elapsed: ").append(SystemClock.uptimeMillis() - this.startTimer).append(" ms").toString());
        }
        synchronized (this.mInstallLock) {
            synchronized (this.mPackages) {
                ...
                for (i = 0; i < builtInLibCount; i++) {
                    addSharedLibraryLPw((String) libConfig.valueAt(i), null, (String) libConfig.keyAt(i), -1, 0, PLATFORM_PACKAGE_NAME, 0);
                }
                ...
                String customResolverActivity = Resources.getSystem().getString(17039761);
        ...
        if (HWFLOW) {
            ...
            i2 = this.mTimerCounter + 1;
            this.mTimerCounter = i2;
            Slog.i(str, append.append(i2).append(" **** loadSysWhitelist  ************ Time to elapsed: ").append(SystemClock.uptimeMillis() - this.startTimer).append(" ms").toString());
        }
        synchronized (this.mPackages) {
        ...
        if (HWFLOW) {
            ...
            i2 = this.mTimerCounter + 1;
            this.mTimerCounter = i2;
            Slog.i(str, append.append(i2).append(" **** getUninstallApk  ************ Time to elapsed: ").append(SystemClock.uptimeMillis() - this.startTimer).append(" ms").toString());
        }
        ...
        if (HWFLOW) {
            ...
            i2 = this.mTimerCounter + 1;
            this.mTimerCounter = i2;
            Slog.i(str, append.append(i2).append(" **** scanNonSystemPartitionDir  ************ Time to elapsed: ").append(SystemClock.uptimeMillis() - this.startTimer).append(" ms").toString());
        }
        if (HWFLOW) {
            this.startTimer = SystemClock.uptimeMillis();
        }
        ...
        if (HWFLOW) {
            ...
            i2 = this.mTimerCounter + 1;
            this.mTimerCounter = i2;
            Slog.i(str, append.append(i2).append(" **** scanRemovableAppDir  ************ Time to elapsed: ").append(SystemClock.uptimeMillis() - this.startTimer).append(" ms").toString());
        }
        ...
        synchronized (this.mInstallLock) {
            synchronized (this.mPackages) {
                ...
                for (i = 0; i < deletePkgsList.size(); i++) {
                    String packageName = ((PackageSetting) deletePkgsList.get(i)).name;
        ...
        synchronized (this.mInstallLock) {
            synchronized (this.mPackages) {
                ...
                this.mPrepareAppDataFuture = SystemServerInitThreadPool.get().submit(new com.android.server.pm.-$Lambda$kozCdtU4hxwnpbopzC6ZLMsBV5E.AnonymousClass2(storageFlags, this, reconcileAppsDataLI(StorageManager.UUID_PRIVATE_INTERNAL, 0, storageFlags, true, true)), "prepareAppData");
                if (this.mIsUpgrade && (onlyCore ^ 1) != 0) {
        ...
        this.need_ux_opt = isUxOptimizeCustProduct();
        Trace.traceEnd(262144);
    }

    /* synthetic */ void lambda$-com_android_server_pm_PackageManagerService_158110(List deferPackages, int storageFlags) {
        BootTimingsTraceLog traceLog = new BootTimingsTraceLog("SystemServerTimingAsync", 262144);
    ...
    private static File preparePackageParserCache(boolean isUpgrade) {
        ...
        if ("userdebug".equals(Build.TYPE) && VERSION.INCREMENTAL.startsWith("eng.")) {
    ...
    private Pair<ComponentName, String> getInstantAppResolverLPr() {
        String[] packageArray = this.mContext.getResources().getStringArray(17236009);
    ...
    private void applyFactoryDefaultBrowserLPw(int userId) {
        String browserPkg = this.mContext.getResources().getString(17039877);
    ...
    public void checkPackageStartable(String packageName, int userId) {
        ...
        synchronized (this.mPackages) {
            ...
            if (ps == null || filterAppAccessLPr(ps, callingUid, userId)) {
                ...
                if (!userKeyUnlocked) {
                    int i;
                    if (ps.pkg.applicationInfo.isDirectBootAware()) {
                        i = 1;
                    } else {
                        i = ps.pkg.applicationInfo.isPartiallyDirectBootAware();
                    }
                    if ((i ^ 1) != 0) {
    ...
    public PermissionInfo getPermissionInfo(String name, String packageName, int flags) {
        ...
        synchronized (this.mPackages) {
            ...
            if (permissionInfo != null) {
                permissionInfo.protectionLevel = adjustPermissionProtectionFlagsLPr(permissionInfo.protectionLevel, packageName, callingUid);
            }
        }
    }
    ...
    public void freeStorageAndNotify(String volumeUuid, long freeStorageSize, int storageFlags, IPackageDataObserver observer) {
        ...
        this.mHandler.post(new com.android.server.pm.-$Lambda$kozCdtU4hxwnpbopzC6ZLMsBV5E.AnonymousClass4(storageFlags, freeStorageSize, this, volumeUuid, observer));
    }

    /* synthetic */ void lambda$-com_android_server_pm_PackageManagerService_220441(String volumeUuid, long freeStorageSize, int storageFlags, IPackageDataObserver observer) {
    ...
    public void freeStorage(String volumeUuid, long freeStorageSize, int storageFlags, IntentSender pi) {
        ...
        this.mHandler.post(new com.android.server.pm.-$Lambda$kozCdtU4hxwnpbopzC6ZLMsBV5E.AnonymousClass3(storageFlags, freeStorageSize, this, volumeUuid, pi));
    }

    /* synthetic */ void lambda$-com_android_server_pm_PackageManagerService_221240(String volumeUuid, long freeStorageSize, int storageFlags, IntentSender pi) {
        boolean success = false;
        try {
            freeStorage(volumeUuid, freeStorageSize, storageFlags);
            success = true;
    ...
    public void freeStorage(String volumeUuid, long bytes, int storageFlags) throws IOException {
        ...
        if (file.getUsableSpace() < bytes) {
            if (ENABLE_FREE_CACHE_V2) {
                ...
                if (aggressive || defyReserved) {
                    reservedBytes = 0;
                } else {
                    reservedBytes = storage.getStorageCacheBytes(file);
                }
    ...
    int updateFlagsForResolve(int flags, int userId, Intent intent, int callingUid, boolean wantInstantApps, boolean onlyExposedExplicitly) {
        ...
        if (getInstantAppPackageName(callingUid) != null) {
            ...
            flags = (flags | 16777216) | 8388608;
        } else {
            boolean canViewInstantApps = (wantInstantApps && "android.intent.action.VIEW".equals(intent.getAction()) && hasWebURI(intent)) ? true : (flags & 8388608) != 0 ? canViewInstantApps(callingUid, userId) : false;
            flags &= -50331649;
    ...
    private ResolveInfo resolveIntentInternal(Intent intent, String resolvedType, int flags, int userId, boolean resolveForStart) {
        try {
            ...
            List<ResolveInfo> query = queryIntentActivitiesInternal(intent, resolvedType, flags, callingUid, userId, resolveForStart);
            Trace.traceEnd(262144);
    ...
    private void requestInstantAppResolutionPhaseTwo(AuxiliaryResolveInfo responseObj, Intent origIntent, String resolvedType, String callingPackage, Bundle verificationBundle, int userId) {
        this.mHandler.sendMessage(this.mHandler.obtainMessage(20, new InstantAppRequest(responseObj, origIntent, resolvedType, callingPackage, userId, verificationBundle)));
    }
    ...
    ResolveInfo findPreferredActivity(Intent intent, String resolvedType, int flags, List<ResolveInfo> query, int priority, boolean always, boolean removeMatches, boolean debug, int userId) {
        ...
        synchronized (this.mPackages) {
            ...
            if (queryIntent != null && queryIntent.size() > 0) {
                ...
                int M = queryIntent.size();
                for (int i = 0; i < M; i++) {
                    PreferredActivity pa = (PreferredActivity) queryIntent.get(i);
                    if (debug) {
    ...
    protected List<ResolveInfo> queryIntentActivitiesInternal(Intent intent, String resolvedType, int flags, int userId) {
        return queryIntentActivitiesInternal(intent, resolvedType, flags, Binder.getCallingUid(), userId, false);
    }
    ...
    protected List<ResolveInfo> queryIntentActivitiesInternal(Intent intent, String resolvedType, int flags, int filterCallingUid, int userId, boolean resolveForStart) {
        ...
        if (comp != null) {
            ...
            if (ai != null) {
                ...
                boolean matchInstantApp = (8388608 & flags) != 0;
            ...
            return applyPostResolutionFilter(arrayList, instantAppPkgName);
        }
        ...
        synchronized (this.mPackages) {
            ...
            if (pkgName == null) {
                ...
                if (xpResolveInfo != null) {
                    ...
                    applyPostResolutionFilter = applyPostResolutionFilter(filterIfNotSystemUser(arrayList, userId), instantAppPkgName);
                ...
                if (hasWebURI(intent)) {
                    ...
                    if (crossProfileDomainInfo != null) {
                        ...
                        if (result.size() == 0 && (r22 ^ 1) != 0) {
                            result.add(crossProfileDomainInfo.resolveInfo);
                            applyPostResolutionFilter = applyPostResolutionFilter(result, instantAppPkgName);
                            return applyPostResolutionFilter;
                        }
                    } else if (result.size() <= 1 && (r22 ^ 1) != 0) {
                        applyPostResolutionFilter = applyPostResolutionFilter(result, instantAppPkgName);
                        return applyPostResolutionFilter;
                    }
    ...
    private List<ResolveInfo> maybeAddInstantAppInstaller(List<ResolveInfo> result, Intent intent, String resolvedType, int flags, int userId) {
        ...
        if (!((8388608 & flags) != 0)) {
            List<ResolveInfo> instantApps = this.mActivities.queryIntent(intent, resolvedType, ((flags | 64) | 8388608) | 16777216, userId);
        ...
        if (!blockResolution) {
            if (localInstantApp == null) {
                ...
                auxiliaryResponse = InstantAppResolver.doInstantAppResolutionPhaseOne(this.mContext, this.mInstantAppResolverConnection, new InstantAppRequest(null, intent, resolvedType, null, userId, null));
                Trace.traceEnd(262144);
            } else {
    ...
    private List<ResolveInfo> applyPostResolutionFilter(List<ResolveInfo> resolveInfos, String ephemeralPkgName) {
        for (int i = resolveInfos.size() - 1; i >= 0; i--) {
            ...
            if (isEphemeralApp && info.activityInfo.splitName != null && (ArrayUtils.contains(info.activityInfo.applicationInfo.splitNames, info.activityInfo.splitName) ^ 1) != 0) {
                if (DEBUG_EPHEMERAL) {
                    Slog.v(TAG, "Adding ephemeral installer to the ResolveInfo list");
                }
            ...
            } else if (!(ephemeralPkgName == null || ephemeralPkgName.equals(info.activityInfo.packageName) || (!isEphemeralApp && (info.activityInfo.flags & DumpState.DUMP_DEXOPT) != 0))) {
                resolveInfos.remove(i);
            }
        }
        return resolveInfos;
    ...
    private List<ResolveInfo> queryIntentReceiversInternal(Intent intent, String resolvedType, int flags, int userId) {
        ...
        synchronized (this.mPackages) {
            String pkgName = intent.getPackage();
            if (pkgName == null) {
                List<ResolveInfo> applyPostResolutionFilter = applyPostResolutionFilter(this.mReceivers.queryIntent(intent, resolvedType, flags, userId), instantAppPkgName);
                return applyPostResolutionFilter;
            }
            Package pkg = (Package) this.mPackages.get(pkgName);
            if (pkg != null) {
                applyPostResolutionFilter = applyPostResolutionFilter(this.mReceivers.queryIntentForPackage(intent, resolvedType, flags, pkg.receivers, userId), instantAppPkgName);
                return applyPostResolutionFilter;
            }
    ...
    public Bitmap getInstantAppIcon(String packageName, int userId) {
        if (packageName == null) {
            Slog.w(TAG, "Failed to get instant app icon, for packageName is null!");
            return null;
        } else if (isEphemeralDisabled()) {
            return null;
        } else {
        ...
        synchronized (this.mPackages) {
            if ((1073741824 & hwFlags) == 0) {
                ...
                if (!needInstallRemovablePreApk(pkg, hwFlags)) {
                    ...
                    if (psTemp.codePath != null && (psTemp.codePath.equals(scanFile) ^ 1) != 0 && psTemp.codePathString != null && psTemp.codePathString.startsWith("/data/app/") && (policyFlags & 1) == 0 && pkg.mVersionCode <= psTemp.versionCode) {
                        Slog.d(TAG, "scan return here for ota nosys package:" + pkg.packageName);
                        recordUninstalledDelapp(pkg.packageName, scanFile.getAbsolutePath());
                        return null;
                    }
                }
            }
            ...
            if (sm != null) {
                ...
                if (doTrim) {
                    ...
                    if (!isFirstBoot() && dexOptDialogShown) {
                        try {
                            ActivityManager.getService().showBootMessage(this.mContext.getResources().getString(17039576), true);
                            return;
                        } catch (RemoteException e) {
                            return;
                        }
    ...
    public void updatePackagesIfNeeded() {
        ...
        if (causeUpgrade || (i ^ 1) == 0 || (causePrunedCache ^ 1) == 0) {
            ...
            if (SystemProperties.getBoolean("ro.config.show_dex2oatDialog", false) || this.need_ux_opt) {
            ...
            int[] stats = performDexOptUpgrade(pkgs, showDialog, PackageManagerServiceCompilerMapping.getCompilerFilterForReason(i2));
    ...
    private int[] performDexOptUpgrade(List<Package> pkgs, boolean showDialog, String compilerFilter) {
        ...
        boolean isChina = "CN".equalsIgnoreCase(SystemProperties.get("ro.product.locale.region", ""));
        if (showDialog && this.need_ux_opt) {
            connectBootAnimation();
        }
        for (Package pkg : pkgs) {
            numberOfPackagesVisited++;
            if (PackageDexOptimizer.canOptimizePackage(pkg)) {
                if (showDialog && (this.need_ux_opt ^ 1) != 0) {
                    try {
                        ActivityManager.getService().showBootMessage(this.mContext.getResources().getString(17039574, new Object[]{Integer.valueOf(numberOfPackagesVisited), Integer.valueOf(numberOfPackagesToDexopt)}), true);
                    } catch (RemoteException e) {
                    }
                    synchronized (this.mPackages) {
                        this.mDexOptDialogShown = true;
                    }
                } else if (showDialog && this.need_ux_opt && this.mIBootAnmation != null) {
                    int inputData = 0;
                    ...
                    try {
                        ...
                        Slog.w(TAG, "show boot dexoat process error," + e2.getMessage());
                    }
                }
                if (isSystemApp(pkg) && DexFile.isProfileGuidedCompilerFilter(compilerFilter) && (Environment.getReferenceProfile(pkg.packageName).exists() ^ 1) != 0) {
    ...
    public boolean performDexOpt(String packageName, boolean checkProfiles, int compileReason, boolean force) {
        ...
        if (performDexOptWithStatus(packageName, checkProfiles, compileReason, force) != -1) {
            z = true;
        }
        return z;
    }
    ...
    int performDexOptWithStatus(String packageName, boolean checkProfiles, int compileReason, boolean force) {
        return performDexOptTraced(packageName, checkProfiles, PackageManagerServiceCompilerMapping.getCompilerFilterForReason(compileReason), force);
    }
    ...
    public boolean performDexOptMode(String packageName, boolean checkProfiles, String targetCompilerFilter, boolean force) {
        ...
        if (performDexOptTraced(packageName, checkProfiles, targetCompilerFilter, force) != -1) {
            z = true;
        }
        return z;
    }
    ...
    private int performDexOptInternalWithDependenciesLI(Package p, boolean checkProfiles, String targetCompilerFilter, boolean force) {
        ...
        if (!deps.isEmpty()) {
            for (Package depPackage : deps) {
                pdo.performDexOpt(depPackage, null, instructionSets, false, targetCompilerFilter, getOrCreateCompilerPackageStats(depPackage), true);
            }
        }
        return pdo.performDexOpt(p, p.usesLibraryFiles, instructionSets, checkProfiles, targetCompilerFilter, getOrCreateCompilerPackageStats(p), this.mDexManager.isUsedByOtherApps(p.packageName));
    }
    ...
    public void forceDexOpt(String packageName) {
        ...
        synchronized (this.mInstallLock) {
            Trace.traceBegin(262144, "dexopt");
            int res = performDexOptInternalWithDependenciesLI(pkg, false, PackageManagerServiceCompilerMapping.getDefaultCompilerFilter(), true);
            Trace.traceEnd(262144);
            if (res != 1) {
    ...
    private void updateSharedLibrariesLPr(Package pkg, Package changingLib) throws PackageManagerException {
        if (pkg != null) {
            ...
            if (pkg.usesLibraries != null) {
                arraySet = addSharedLibrariesLPw(pkg.usesLibraries, null, null, pkg.packageName, changingLib, true, null);
            }
            if (pkg.usesStaticLibraries != null) {
                arraySet = addSharedLibrariesLPw(pkg.usesStaticLibraries, pkg.usesStaticLibrariesVersions, pkg.usesStaticLibrariesCertDigests, pkg.packageName, changingLib, true, arraySet);
            }
            if (pkg.usesOptionalLibraries != null) {
                arraySet = addSharedLibrariesLPw(pkg.usesOptionalLibraries, null, null, pkg.packageName, changingLib, false, arraySet);
            }
    ...
    private ArraySet<String> addSharedLibrariesLPw(List<String> requestedLibraries, int[] requiredVersions, String[] requiredCertDigests, String packageName, Package changingLib, boolean required, ArraySet<String> outUsedLibraries) throws PackageManagerException {
        ...
        for (int i = 0; i < libCount; i++) {
            ...
            if (libEntry != null) {
                if (!(requiredVersions == null || requiredCertDigests == null)) {
                    ...
                    if (!PackageUtils.computeCertSha256Digest(libPkg.mSignatures[0]).equalsIgnoreCase(requiredCertDigests[i])) {
                ...
                UiThread.getHandler().post(new Runnable() {
                    public void run() {
                        if (PackageManagerService.this.mContext != null) {
                            Toast.makeText(PackageManagerService.this.mContext, PackageManagerService.this.mContext.getString(33685975), 0).show();
                        }
                    }
                });
        ...
        synchronized (this.mPackages) {
            ...
            try {
                ...
                try {
                    ...
                    if (pkgSetting2 == null) {
                        pkgSetting = Settings.createNewSetting(pkg.packageName, packageSetting, disabledPkgSetting, realName, suid, destCodeFile, destResourceFile, pkg.applicationInfo.nativeLibraryRootDir, pkg.applicationInfo.primaryCpuAbi, pkg.applicationInfo.secondaryCpuAbi, pkg.mVersionCode, pkg.applicationInfo.flags, pkg.applicationInfo.privateFlags, user, true, (131072 & scanFlags) != 0, pkg.parentPackage != null ? pkg.parentPackage.packageName : null, pkg.getChildPackageNames(), UserManagerService.getInstance(), strArr, pkg.usesStaticLibrariesVersions);
                        if (packageSetting != null) {
    ...
    private boolean grantSignaturePermission(String perm, Package pkg, BasePermission bp, PermissionsState origPermissions) {
        ...
        if (!privappPermissionsDisable && privilegedPermission && pkg.isPrivilegedApp() && (platformPackage ^ 1) != 0 && platformPermission) {
            ...
            if (!(wlPermissions != null ? wlPermissions.contains(perm) : false)) {
    ...
    private void sendPackageAddedForUser(String packageName, PackageSetting pkgSetting, int userId) {
        sendPackageAddedForNewUsers(packageName, !isSystemApp(pkgSetting) ? isUpdatedSystemApp(pkgSetting) : true, pkgSetting.appId, userId);
    ...
    public void sendPackageAddedForNewUsers(String packageName, boolean isSystem, int appId, int... userIds) {
        if (!ArrayUtils.isEmpty(userIds)) {
            ...
            if (isSystem) {
                this.mHandler.post(new -$Lambda$kozCdtU4hxwnpbopzC6ZLMsBV5E(this, userIds, packageName));
            }
        }
    }

    /* synthetic */ void lambda$-com_android_server_pm_PackageManagerService_740839(int[] userIds, String packageName) {
        for (int userId : userIds) {
    ...
    private void sendBootCompletedBroadcastToSystemApp(String packageName, int userId) {
        if (this.mUserManagerInternal.isUserRunning(userId)) {
            ...
            try {
                ...
                am.broadcastIntent(null, new Intent("android.intent.action.LOCKED_BOOT_COMPLETED").setPackage(packageName), null, null, 0, null, null, requiredPermissions, -1, null, false, false, userId);
                if (this.mUserManagerInternal.isUserUnlockingOrUnlocked(userId)) {
                    am.broadcastIntent(null, new Intent("android.intent.action.BOOT_COMPLETED").setPackage(packageName), null, null, 0, null, null, requiredPermissions, -1, null, false, false, userId);
                }
            } catch (RemoteException e) {
    ...
    private void installPackageLI(InstallArgs args, PackageInstalledInfo res) {
        ...
        throw th4;
        Throwable th5;
        if (!(instantApp && Global.getInt(this.mContext.getContentResolver(), "instant_app_dexopt_enabled", 0) == 0)) {
            Trace.traceBegin(262144, "dexopt");
            this.mPackageDexOptimizer.performDexOpt(pkg, pkg.usesLibraryFiles, null, false, PackageManagerServiceCompilerMapping.getCompilerFilterForReason(2), getOrCreateCompilerPackageStats(pkg), this.mDexManager.isUsedByOtherApps(pkg.packageName));
            Trace.traceEnd(262144);
        }
        ...
        if (args.doRename(res.returnCode, pkg, str)) {
            ...
            try {
                ...
                if (replace) {
                    ...
                    replacePackageLIF(pkg, parseFlags, (scanFlags | 512) | 524288, args.user, installerPackageName, res, args.installReason);
                } else {
    ...
    private boolean deleteSystemPackageLIF(Package deletedPkg, PackageSetting deletedPs, int[] allUserHandles, int flags, PackageRemovedInfo outInfo, boolean writeSettings) {
        ...
        synchronized (this.mPackages) {
            if (isDelapp(disabledPs) || isDelappInData(disabledPs) || isDelappInCust(disabledPs) || isPreRemovableApp(disabledPs.codePath.toString())) {
        ...
        if (disabledPs.versionCode < deletedPs.versionCode) {
            flags &= -2;
        } else if ((isDelapp(disabledPs) || isDelappInData(disabledPs) || isDelappInCust(disabledPs) || isPreRemovableApp(disabledPs.codePath.toString())) && disabledPs.versionCode == deletedPs.versionCode) {
            flags &= -2;
        } else {
            flags |= 1;
        }
        ...
        try {
            if (isDelapp(disabledPs) || isDelappInData(disabledPs) || isDelappInCust(disabledPs) || isPreRemovableApp(disabledPs.codePath.toString())) {
                recordUninstalledDelapp(deletedPkg.packageName, disabledPs.codePathString);
                ...
                newPkg = scanPackageTracedLI(disabledPs.codePath, parseFlags, 65536, 0, null);
            }
            if (newPkg != null) {
                try {
            ...
            Slog.w(TAG, "Failed to delete system package:" + deletedPkg.packageName + ": " + e3.getMessage());
            return false;
        }
    }
    ...
    private void markPackageUninstalledForUserLPw(PackageSetting ps, UserHandle user) {
        ...
        for (int nextUserId : userIds) {
            ps.setUserState(nextUserId, 0, 0, false, true, true, false, false, false, null, null, null, ps.readUserState(nextUserId).domainVerificationStatus, 0, 0);
        }
        this.mSettings.writeKernelMappingLPr(ps);
    }
        ...
        this.mHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Flog.d(DisplayTransformManager.LEVEL_COLOR_MATRIX_GRAYSCALE, "clearApplicationUserData, finish freeze package:" + packageName);
                    if (packageFreezer != null) {
                        try {
                            packageFreezer.close();
                        } catch (Throwable th2) {
            ...
            public void run() {
                ...
                if (doClearData) {
                    synchronized (PackageManagerService.this.mInstallLock) {
                        ...
                        PackageManagerService.this.clearAppDataLIF(pkg, i2, 515);
                    }
    ...
    static /* synthetic */ void lambda$-com_android_server_pm_PackageManagerService_1044161(int userId) {
        IActivityManager am = ActivityManager.getService();
        if (am != null) {
    ...
    private void setEnabledSetting(String packageName, String className, int newState, int flags, int userId, String callingPackage) {
        if (newState == 0 || newState == 1 || newState == 2 || newState == 3 || newState == 4) {
            ...
            synchronized (this.mPackages) {
                if (callingUid == 2000 && (pkgSetting.pkgFlags & 256) == 0) {
    ...
    private void movePackageInternal(String packageName, String volumeUuid, int moveId, int callingUid, UserHandle user) throws PackageManagerException {
        ...
        installFlags |= 2;
        Message msg = this.mHandler.obtainMessage(5);
        InstallParams params = new InstallParams(OriginInfo.fromExistingFile(file), moveInfo, anonymousClass32, installFlags, installerPackageName, volumeUuid, null, user, packageAbiOverride, null, null, 0);
