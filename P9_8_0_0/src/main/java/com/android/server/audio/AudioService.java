...
*/
    ...
    public AudioService(Context context) {
        ...
        this.mBecomingNoisyIntentDevices = 537034636;
        this.mMcc = 0;
        this.mSafeMediaVolumeDevices = 536887308;
        ...
        this.mPlaybackMonitor = new PlaybackActivityMonitor();
    ...
    private void createStreamStates() {
        ...
        for (int i = 0; i < numStreamTypes; i++) {
            streams[i] = new VolumeStreamState(System.VOLUME_SETTINGS_INT[this.mStreamVolumeAlias[i]], i);
        }
