...
final class AutofillManagerServiceImpl {
    ...
    /* synthetic */ void lambda$-com_android_server_autofill_AutofillManagerServiceImpl_4079(Message msg) {
        switch (msg.what) {
            case 1:
    ...
    private Session createSessionByTokenLocked(IBinder activityToken, int uid, IBinder appCallbackToken, boolean hasCallback, ComponentName componentName) {
        ...
        while (true) {
            ...
            if (sessionId != Integer.MIN_VALUE && this.mSessions.indexOfKey(sessionId) < 0) {
                ...
                Session newSession = new Session(this, this.mUi, this.mContext, this.mHandlerCaller, this.mUserId, this.mLock, sessionId, uid, activityToken, appCallbackToken, hasCallback, this.mInfo.getServiceInfo().getComponentName(), componentName);
