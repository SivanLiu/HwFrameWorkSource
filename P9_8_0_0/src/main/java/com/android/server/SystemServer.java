    ...
    private void startBootstrapServices() {
        ...
        this.mSensorServiceStart = SystemServerInitThreadPool.get().submit(new Runnable() {
            private final /* synthetic */ void $m$0() {
                SystemServer.lambda$-com_android_server_SystemServer_38251();
            }
    ...
    private void startOtherServices() {
        ...
        try {
            ...
            this.mZygotePreload = SystemServerInitThreadPool.get().submit(new Runnable() {
                private final /* synthetic */ void $m$0() {
                    SystemServer.lambda$-com_android_server_SystemServer_45948();
                }
            ...
            if (!disableConsumerIr) {
                ...
                ConsumerIrService consumerIrService2 = new ConsumerIrService(context);
                try {
                    ServiceManager.addService("consumer_ir", consumerIrService2);
                    traceEnd();
                    ...
                    if (this.mFactoryTestMode != 1) {
                        ...
                        if (!disableNetwork) {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    if (!disableLocation) {
                                        ...
                                        try {
                                                ...
                                                if (!disableNonCoreServices) {
                                                    ...
                                                    if (!disableSerial) {
                                                        ...
                                                        try {
                                                                ...
                                                                try {
                                                                    ...
                                                                    if (!disableNonCoreServices) {
                                                                        ...
                                                                        try {
                                                                            ...
                                                                            reportWtf("starting StartBackgroundDexOptService", e322222222222222222);
                                                                        }
                                                                        traceEnd();
                                                                        traceBeginAndSlog("StartPruneInstantAppsJobService");
                                                                        try {
                                                                            ...
                                                                            reportWtf("StartPruneInstantAppsJobService", e3222222222222222222);
                                                                        }
                                                                        traceEnd();
                                                                    }
                                                                    traceBeginAndSlog("StartShortcutServiceLifecycle");
                                                            ...
                                                            e3222222222222222222 = th7;
                                                            Slog.e(TAG, "Failure starting SerialService", e3222222222222222222);
                                                            traceEnd();
                                                            traceBeginAndSlog("StartHardwarePropertiesManagerService");
                                                            hardwarePropertiesManagerService = new HardwarePropertiesManagerService(context);
                                                            ServiceManager.addService("hardware_properties", hardwarePropertiesManagerService);
                                                    ...
                                                    try {
                                                        ...
                                                        e3222222222222222222 = th8;
                                                        Slog.e(TAG, "Failure starting HardwarePropertiesManagerService", e3222222222222222222);
                                                        traceEnd();
                                                        traceBeginAndSlog("StartTwilightService");
                                                        this.mSystemServiceManager.startService(TwilightService.class);
                                                        traceEnd();
                                            ...
                                            e3222222222222222222 = th9;
                                            reportWtf("starting Country Detector", e3222222222222222222);
                                            traceEnd();
                                            traceBeginAndSlog("StartSearchManagerService");
                                            this.mSystemServiceManager.startService(SEARCH_MANAGER_SERVICE_CLASS);
                                            traceEnd();
                                    ...
                                    try {
                                        ...
                                        e3222222222222222222 = th10;
                                        networkTimeUpdateService2 = networkTimeUpdateService;
                                        reportWtf("starting NetworkTimeUpdate service", e3222222222222222222);
                                        traceEnd();
                                        traceBeginAndSlog("StartCommonTimeManagementService");
                                        commonTimeManagementService = new CommonTimeManagementService(context);
                                        ServiceManager.addService("commontime_management", commonTimeManagementService);
                                    ...
                                    try {
                                        ...
                                        e3222222222222222222 = th11;
                                        commonTimeManagementService2 = commonTimeManagementService;
                                        reportWtf("starting CommonTimeManagementService service", e3222222222222222222);
                                        traceEnd();
                                        if (disableNetwork) {
                                            traceBeginAndSlog("CertBlacklister");
                                            certBlacklister = new CertBlacklister(context);
                                ...
                                e3222222222222222222 = th12;
                                reportWtf("starting Network Score Service", e3222222222222222222);
                                traceEnd();
                                traceBeginAndSlog("StartNetworkStatsService");
                                networkStats = NetworkStatsService.create(context, networkManagement);
                                ServiceManager.addService("netstats", networkStats);
                            ...
                            try {
                                ...
                                reportWtf("starting NetworkStats Service", e32222222222222222222);
                            }
                            traceEnd();
                            traceBeginAndSlog("StartNetworkPolicyManagerService");
                            try {
                                ...
                                reportWtf("starting NetworkPolicy Service", e322222222222222222222);
                            }
                            traceEnd();
                            traceBeginAndSlog("StartWifi");
                            this.mSystemServiceManager.startService(WIFI_SERVICE_CLASS);
                            ...
                            try {
                                ...
                                reportWtf("starting Connectivity Service", e3222222222222222222222);
                            }
                            traceEnd();
                            traceBeginAndSlog("StartNsdService");
                            try {
                                ...
                                reportWtf("starting Service Discovery Service", e32222222222222222222222);
                            }
                            traceEnd();
                        }
                        if (disableNonCoreServices) {
                        ...
                        try {
                            ...
                            reportWtf("starting Search Service", e322222222222222222222222);
                        }
                        traceEnd();
                        traceBeginAndSlog("StartWallpaperManagerService");
                        this.mSystemServiceManager.startService(HwServiceFactory.getWallpaperManagerServiceClassName());
                        ...
                        try {
                            ...
                            reportWtf("starting WiredAccessoryManager", e3222222222222222222222222);
                        }
                        traceEnd();
                        if (disableNonCoreServices) {
                            if (this.mPackageManager.hasSystemFeature("android.software.midi")) {
                        ...
                        try {
                            ...
                            reportWtf("starting DiskStats Service", e32222222222222222222222222);
                        }
                        traceEnd();
                        if (disableSamplingProfiler) {
                            traceBeginAndSlog("StartSamplingProfilerService");
                        ...
                        try {
                            ...
                            reportWtf("attestation Service", e322222222222222222222222222);
                        }
                        traceBeginAndSlog("StartNetworkTimeUpdateService");
                        try {
                            networkTimeUpdateService = new NetworkTimeUpdateService(context);
                            ...
                            reportWtf("starting NetworkTimeUpdate service", e322222222222222222222222222);
                            traceEnd();
                            traceBeginAndSlog("StartCommonTimeManagementService");
                            commonTimeManagementService = new CommonTimeManagementService(context);
                            ServiceManager.addService("commontime_management", commonTimeManagementService);
                        ...
                        try {
                            ...
                            reportWtf("starting CommonTimeManagementService service", e322222222222222222222222222);
                            traceEnd();
                            if (disableNetwork) {
                                traceBeginAndSlog("CertBlacklister");
                                certBlacklister = new CertBlacklister(context);
            ...
            try {
                ...
                if (enableRms || enableIaware) {
                    try {
                        ...
                        Slog.e(TAG, e3222222222222222222222222222.toString());
                    }
                }
                traceEnd();
                ...
                SystemServerInitThreadPool.get().submit(new Runnable() {
                    private final /* synthetic */ void $m$0() {
                        SystemServer.lambda$-com_android_server_SystemServer_54841();
                    }
        ...
        try {
            ...
            reportWtf("making display ready", e32222222222222222222222222222);
        }
        traceEnd();
        ...
        try {
            ...
            reportWtf("performing fstrim", e322222222222222222222222222222);
        }
        traceEnd();
        HwBootCheck.bootSceneStart(102, JobStatus.DEFAULT_TRIGGER_MAX_DELAY);
        HwBootFail.setBootStage(HwBootFail.STAGE_APP_DEXOPT_END);
        ...
        try {
            ...
            reportWtf("making Vibrator Service ready", e3222222222222222222222222222222);
        }
        traceEnd();
        traceBeginAndSlog("MakeLockSettingsServiceReady");
        if (iLockSettings != null) {
