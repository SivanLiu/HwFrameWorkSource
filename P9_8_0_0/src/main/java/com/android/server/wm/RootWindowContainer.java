...
class RootWindowContainer extends WindowContainer<DisplayContent> {
    ...
    static /* synthetic */ void lambda$-com_android_server_wm_RootWindowContainer_17193(String name, ArrayList output, int objectId, WindowState w) {
        if (name != null) {
    ...
    static /* synthetic */ void lambda$-com_android_server_wm_RootWindowContainer_22062(int userId, boolean disabled, WindowState w) {
    ...
    /* synthetic */ void lambda$-com_android_server_wm_RootWindowContainer_22327(WindowState w) {
        if (w.mAppOp != -1) {
            this.mService.setAppOpVisibilityLwHook(w, this.mService.mAppOps.checkOpNoThrow(w.mAppOp, w.getOwningUid(), w.getOwningPackage()));
        }
    }

    static /* synthetic */ boolean lambda$-com_android_server_wm_RootWindowContainer_22968(int pid, WindowState w) {
    ...
    /* synthetic */ void lambda$-com_android_server_wm_RootWindowContainer_25631(SparseIntArray pidCandidates, WindowState w) {
    ...
    static /* synthetic */ void lambda$-com_android_server_wm_RootWindowContainer_53172(ArrayList windows, PrintWriter pw, int[] index, boolean dumpAll, WindowState w) {
        boolean z = true;
