        ...
        synchronized (service.mWindowMap) {
            try {
                ...
                if (mainWindow == null) {
                    ...
                    int sysUiVis = mainWindow.getSystemUiVisibility();
                    int windowFlags = mainWindow.getAttrs().flags;
                    int windowPrivateFlags = mainWindow.getAttrs().privateFlags;
                    layoutParams.type = 3;
                    ...
                    int currentOrientation = mainWindow.getConfiguration().orientation;
                }
            } finally {
                WindowManagerService.resetPriorityAfterLockedSection();
            }
