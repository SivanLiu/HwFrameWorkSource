...
public class DockedStackDividerController implements DimLayerUser {
            ...
            if (homeStack != null) {
                ...
                if (homeTask != null && (isWithinDisplay(homeTask) ^ 1) == 0) {
                    if (!this.mMinimizedDock || !this.mService.mPolicy.isKeyguardShowingAndNotOccluded()) {
                        ...
                        if (IS_DOCOMO && homeVisible && recentStack != null && recentStack.isVisible()) {
                            homeVisible = false;
                        }
    ...
    /* synthetic */ void lambda$-com_android_server_wm_DockedStackDividerController_34683(boolean adjustedForIme, boolean adjustedForDivider) {
