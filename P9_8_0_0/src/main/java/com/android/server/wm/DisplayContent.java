...
public class DisplayContent extends AbsDisplayContent {
    ...
    protected final class NonAppWindowContainers extends DisplayChildWindowContainer<WindowToken> {
        private final Predicate<WindowState> mGetOrientingWindow = new Predicate() {
            private final /* synthetic */ boolean $m$0(Object arg0) {
                return NonAppWindowContainers.lambda$-com_android_server_wm_DisplayContent$NonAppWindowContainers_175443((WindowState) arg0);
            }
    ...
    static /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_134746(int r1, int r2, com.android.server.wm.WindowState r3) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.server.wm.DisplayContent.lambda$-com_android_server_wm_DisplayContent_134746(int, int, com.android.server.wm.WindowState):void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.wm.DisplayContent.lambda$-com_android_server_wm_DisplayContent_134746(int, int, com.android.server.wm.WindowState):void");
    }
    ...
    /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent_33773(WindowState w) {
    ...
    protected boolean updateRotationUnchecked(boolean inTransaction) {
        ...
        if (rotateSeamlessly && getWindow(new Predicate() {
            private final /* synthetic */ boolean $m$0(Object arg0) {
    ...
    int getLayerForAnimationBackground(WindowStateAnimator winAnimator) {
        WindowState visibleWallpaper = this.mBelowAppWindowsContainers.getWindow(new Predicate() {
            private final /* synthetic */ boolean $m$0(Object arg0) {
                return DisplayContent.lambda$-com_android_server_wm_DisplayContent_107222((WindowState) arg0);
            }
    ...
    boolean hasSecureWindowOnScreen() {
        return getWindow(new Predicate() {
            private final /* synthetic */ boolean $m$0(Object arg0) {
                return DisplayContent.lambda$-com_android_server_wm_DisplayContent_134560((WindowState) arg0);
            }
