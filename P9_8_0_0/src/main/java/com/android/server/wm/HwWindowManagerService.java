    ...
    protected void checkKeyguardDismissDoneLocked() {
        if (this.mKeyguardDismissDoneCallback != null) {
            if (this.mKeyguardWin != null) {
                int delay = 0;
                int i = this.mKeyguardAttachWallpaper ^ 1;
                if (i == 0 && this.mTopWallpaperWin != null) {
                    i = this.mTopWallpaperWin.mWinAnimator.mSurfaceController.mSurfaceShown ? this.mTopWallpaperAnimLayer != this.mTopWallpaperWin.mWinAnimator.mSurfaceController.mSurfaceLayer ? 1 : 0 : 1;
                    delay = !this.mTopWallpaperWin.mWinAnimator.mSurfaceController.mSurfaceShown ? 60 : 0;
                }
                if (!(this.mKeyguardWin.mHasSurface || r1 == 0)) {
