...
public class VoiceInteractionManagerService extends SystemService {
    ...
    class VoiceInteractionManagerServiceStub extends Stub {
            ...
            if (curRecognizer != null) {
                ...
                try {
                    ...
                    if (unflattenFromString != null) {
                        interactorInfo = pm.getServiceInfo(unflattenFromString, 786432, userHandle);
                    }
        ...
        private String getForceVoiceInteractionServicePackage(Resources res) {
            String interactorPackage = res.getString(17039785);
        ...
        void switchImplementationIfNeededLocked(boolean force) {
            if (!this.mSafeMode) {
                ...
                if (!(curService == null || (curService.isEmpty() ^ 1) == 0)) {
                    try {
                        componentName = ComponentName.unflattenFromString(curService);
                ...
                if (!(force || this.mImpl == null || this.mImpl.mUser != this.mCurUser)) {
                    if ((this.mImpl.mComponent.equals(componentName) ^ 1) == 0) {
                        return;
                    }
                }
