                ...
                if (view != null) {
                    ...
                    if (imageView != null && textView != null && checkBox != null) {
                        ...
                        if (isExclusiveKeyboard) {
                            ...
                            content = this.mContext.getResources().getString(33685690);
                        } else {
                            imageView.setImageResource(33751791);
                            content = this.mContext.getResources().getString(33685535);
                        }
                        textView.setText(getSpanString(content, this.mContext.getResources().getString(33685778), ""));
                        textView.setMovementMethod(LinkMovementMethod.getInstance());
                        checkBox.setOnCheckedChangeListener(new -$Lambda$IuXpI61eoAu7q3AMTqaXOaSXORQ());
                        this.mEnterDesktopAlertDialog = buider.setTitle(33685915).setPositiveButton(33685914, new com.android.server.pc.-$Lambda$IuXpI61eoAu7q3AMTqaXOaSXORQ.AnonymousClass6(isExclusiveKeyboard, this, checkBox)).setNegativeButton(33685534, new com.android.server.pc.-$Lambda$IuXpI61eoAu7q3AMTqaXOaSXORQ.AnonymousClass2(this)).setView(view).setOnDismissListener(new com.android.server.pc.-$Lambda$IuXpI61eoAu7q3AMTqaXOaSXORQ.AnonymousClass4(this)).create();
    ...
    private void showExitDesktopAlertDialog(Context context, boolean isExclusiveKeyboard) {
        ...
        if (isMMIRunning() || isKeyguardLocked()) {
            ...
            if (isExitDesktopModeRemembered() && isDesktopMode(this.mProjMode) && (isExclusiveKeyboard ^ 1) != 0) {
                ...
                View view = LayoutInflater.from(buider.getContext()).inflate(34013290, null);
                if (view != null) {
                    String enter_toast = context.getString(33685916);
                    String exit_toast = context.getString(33685947);
                    String enter_exclusive_keyboard = context.getString(33685607);
                    HwPCUtils.log(TAG, "these string will be used in future:" + enter_toast + exit_toast + enter_exclusive_keyboard + context.getString(33685919));
                    ImageView imageView = (ImageView) view.findViewById(34603068);
                    TextView textView = (TextView) view.findViewById(34603067);
                    CheckBox checkBox = (CheckBox) view.findViewById(34603069);
                    if (imageView != null && textView != null && checkBox != null) {
                        imageView.setPadding(0, 0, 0, 0);
                        if (isExclusiveKeyboard) {
                            textView.setText(33685920);
                        } else {
                            textView.setText(33685918);
                        }
                        checkBox.setOnCheckedChangeListener(new OnCheckedChangeListener() {
                            private final /* synthetic */ void $m$0(CompoundButton arg0, boolean arg1) {
                                HwPCManagerService.lambda$-com_android_server_pc_HwPCManagerService_29699(arg0, arg1);
                            }
                        ...
                        this.mExitDesktopAlertDialog = buider.setTitle(33685943).setPositiveButton(33685922, new com.android.server.pc.-$Lambda$IuXpI61eoAu7q3AMTqaXOaSXORQ.AnonymousClass7(isExclusiveKeyboard, this, checkBox)).setNegativeButton(33685917, new com.android.server.pc.-$Lambda$IuXpI61eoAu7q3AMTqaXOaSXORQ.AnonymousClass3(this)).setView(view).setOnDismissListener(new com.android.server.pc.-$Lambda$IuXpI61eoAu7q3AMTqaXOaSXORQ.AnonymousClass5(this)).create();
            ...
            if (context != null) {
                UiThread.getHandler().post(new Runnable() {
                    public void run() {
                        ...
                        if (HwPCUtils.isValidExtDisplayId(displayId)) {
                            HwPCManagerService.this.mCallingToast = Toast.makeText(context, context.getResources().getString(33685921), 1);
                        } else {
                            HwPCManagerService.this.mCallingToast = Toast.makeText(context, context.getResources().getString(33685760), 1);
                        }
                        if (HwPCManagerService.this.mCallingToast != null) {
