...
jadx.core.utils.exceptions.CodegenException: Error generate insn: PHI: (r15_6 'j' int) = (r15_0 'j' int), (r15_9 'j' int) binds: {(r15_9 'j' int)=B:108:0x057c, (r15_0 'j' int)=B:198:0x057f} in method: com.android.server.HwNetworkManagementService.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean
