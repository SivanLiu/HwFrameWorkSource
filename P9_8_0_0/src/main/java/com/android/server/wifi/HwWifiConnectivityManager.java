            ...
            public void onReceive(Context context, Intent intent) {
                if (intent != null) {
                    ...
                    if (stationary != HwWifiConnectivityManager.this.mIsStationary) {
                        ...
                        if (HwWifiConnectivityManager.this.mWifiStateMachine == null || (HwWifiConnectivityManager.wifiStateMachineUtils.getScreenOn(HwWifiConnectivityManager.this.mWifiStateMachine) ^ 1) == 0) {
