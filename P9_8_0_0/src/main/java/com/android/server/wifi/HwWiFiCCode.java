...
public class HwWiFiCCode {
    ...
    public String getActiveCountryCode() {
        ...
        if (countryCode == null || (countryCode.isEmpty() ^ 1) == 0) {
    ...
    private int getNetworkMCC() {
        ...
        if (!("".equals(regPlmnMcc) || regPlmnMcc.length() != 3 || (regPlmnMcc.equals(residentPlmnMcc) ^ 1) == 0)) {
    ...
    private static boolean loadCustMccTableV2() {
        ...
        Throwable th;
        File mccTableFileCustV2 = HwCfgFilePolicy.getCfgFile("global/mccTable_V2.xml", 0);
