...
public class WifiStateMachine extends AbsWifiStateMachine implements WifiRssiEventHandler, FilterController {
    ...
    class SoftApState extends State {
        ...
        public void enter() {
            ...
            this.mSoftApManager = WifiStateMachine.this.mWifiInjector.makeSoftApManager(WifiStateMachine.this.mNwService, new SoftApListener(), apInterface, config.getWifiConfiguration());
