                    ...
                    if (colon >= 0) {
                        ...
                        if (key.equals(CONFIG_KEY)) {
                            ...
                            if (!key.equals("SSID")) {
                                    ...
                                    if (key.equals("FQDN")) {
                                        ...
                                        if (key.equals(FRIENDLY_NNAME_KEY)) {
                                            ...
                                            if (key.equals(CLOUD_SECURITY_CHECK_KEY)) {
                                                ...
                                                wifiConfiguration.cloudSecurityCheck = i;
                                            } else {
                                                                                                                                                                                ...
                                                                                                                                                                                if (key.equals(USER_APPROVED_KEY)) {
                                                                                                                                                                                    ...
                                                                                                                                                                                    if (key.equals(SHARED_KEY)) {
                                                                                                                                                                                        ...
                                                                                                                                                                                        if (key.equals(HAS_EVER_CONNECTED_KEY)) {
                                                                                                                                                                                            ...
                                                                                                                                                                                            if (key.equals(EAP_SUB_ID_KEY) && wifiConfiguration.enterpriseConfig != null) {
                                                                                                                                                                                                int eapMethod = wifiConfiguration.enterpriseConfig.getEapMethod();
                                                                                                                                                                                                if (!(eapMethod == 4 || eapMethod == 5)) {
                                                                                                                                                                                                    if (eapMethod == 6) {
                                                                                                                                                                                                    }
                                                                                                                                                                                                }
                                                                                                                                                                                                wifiConfiguration.enterpriseConfig.setEapSubId(Integer.parseInt(value));
                                                                                                                                                                                            }
                                                                                                                                                                                        }
                                                                                                                                                                                    }
                                                                                                                                                                                }
                                ...
                                ssid = value;
                                if (wifiConfiguration.SSID == null || (wifiConfiguration.SSID.equals(value) ^ 1) == 0) {
