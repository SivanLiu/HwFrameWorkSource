...
public class StatusBarManagerService extends Stub {
    ...
    /* synthetic */ void lambda$-com_android_server_statusbar_StatusBarManagerService_24255() {
    ...
    public void shutdown() {
        ...
        long identity = Binder.clearCallingIdentity();
        try {
            this.mHandler.post(new -$Lambda$-TUoAzP8agiJJX9P4eGDtNXdVZ4());
        } finally {
            Binder.restoreCallingIdentity(identity);
        }
    }
    ...
    static /* synthetic */ void lambda$-com_android_server_statusbar_StatusBarManagerService_26372(boolean safeMode) {
        if (safeMode) {
