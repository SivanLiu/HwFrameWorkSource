...
final class WifiDisplayAdapter extends DisplayAdapter {
    ...
    private final class WifiDisplayDevice extends DisplayDevice {
        ...
        public void setNameLocked(String name) {
            this.mName = name;
            this.mInfo = null;
            Slog.w(WifiDisplayAdapter.TAG, "@@@@@@ WifiDisplayAdapter--setNameLocked--change the mInfo to null");
        }
        ...
        public DisplayDeviceInfo getDisplayDeviceInfoLocked() {
            Slog.w(WifiDisplayAdapter.TAG, "@@@@@@ WifiDisplayAdapter--getDisplayDeviceInfoLocked--mInfo = " + this.mInfo);
            if (this.mInfo == null) {
    ...
    public WifiDisplayAdapter(SyncRoot syncRoot, Context context, Handler handler, DisplayAdapter.Listener listener, PersistentDataStore persistentDataStore) {
        ...
        this.mSupportsProtectedBuffers = context.getResources().getBoolean(17957048);
    }
