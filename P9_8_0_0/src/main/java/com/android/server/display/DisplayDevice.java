...
abstract class DisplayDevice {
    ...
    public final void setProjectionInTransactionLocked(int orientation, Rect layerStackRect, Rect displayRect) {
        if (this.mCurrentOrientation == orientation && this.mCurrentLayerStackRect != null && (this.mCurrentLayerStackRect.equals(layerStackRect) ^ 1) == 0 && this.mCurrentDisplayRect != null) {
            if ((this.mCurrentDisplayRect.equals(displayRect) ^ 1) == 0) {
                return;
            }
        }
