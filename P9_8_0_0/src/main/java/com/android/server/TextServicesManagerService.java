...
public class TextServicesManagerService extends Stub {
    ...
    private final class SpellCheckerBindGroup {
        ...
        /* synthetic */ void -com_android_server_TextServicesManagerService$SpellCheckerBindGroup-mthref-0(SessionRequest sessionRequest) {
            getISpellCheckerSessionLocked(sessionRequest);
        }
    ...
    public SpellCheckerSubtype getCurrentSpellCheckerSubtype(String locale, boolean allowImplicitlySelectedSubtype) {
        ...
        for (int i = 0; i < sci.getSubtypeCount(); i++) {
            ...
            if (subtypeHashCode == 0) {
                ...
                if (candidate == null && str.length() >= 2 && scsLocale.length() >= 2 && str.startsWith(scsLocale)) {
                    candidate = scs;
                }
