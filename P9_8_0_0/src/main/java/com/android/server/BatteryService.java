...
public class BatteryService extends AbsBatteryService {
    ...
    private void processValuesLocked(boolean force) {
        ...
        if (this.mBatteryProps.batteryStatus == this.mLastBatteryStatus && this.mBatteryProps.batteryHealth == this.mLastBatteryHealth && this.mBatteryProps.batteryPresent == this.mLastBatteryPresent) {
            ...
            if (this.mBatteryProps.batteryLevel != this.mLastBatteryLevel) {
                if (BatteryManager.HW_BATTERY_LEV_JOB_ALLOWED > 0) {
                    if (this.mBatteryProps.batteryLevel < BatteryManager.HW_BATTERY_LEV_JOB_ALLOWED && this.mLastBatteryLevel < BatteryManager.HW_BATTERY_LEV_JOB_ALLOWED) {
                    ...
                    } else if (this.mBatteryProps.batteryLevel < BatteryManager.HW_BATTERY_LEV_JOB_ALLOWED && this.mLastBatteryLevel >= BatteryManager.HW_BATTERY_LEV_JOB_ALLOWED) {
        ...
        if (this.mBatteryProps.batteryLevel != this.mLastBatteryLevel) {
            if (BatteryManager.HW_BATTERY_LEV_JOB_ALLOWED > 0) {
                if (this.mBatteryProps.batteryLevel < BatteryManager.HW_BATTERY_LEV_JOB_ALLOWED) {
                }
                statusIntent = new Intent("com.huawei.intent.action.BATTERY_LEV_JOB_NOT_ALLOWED");
