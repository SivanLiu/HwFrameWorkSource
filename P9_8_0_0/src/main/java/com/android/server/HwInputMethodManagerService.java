...
public class HwInputMethodManagerService extends InputMethodManagerService {
    ...
    private boolean isTrikeyExist() {
        ...
        try {
            ...
            ret = ((Boolean) clazz.getDeclaredMethod("isSupportTrikey", null).invoke(clazz.getDeclaredMethod(WifiProCHRManager.LOG_GET_INSTANCE_API_NAME, null).invoke(clazz, (Object[]) null), (Object[]) null)).booleanValue();
        } catch (Exception e) {
