        ...
        if (object != null) {
            ...
            if (object instanceof MessageNano) {
                ...
                for (Field field : clazz.getFields()) {
                    ...
                    if (!("cachedSize".equals(fieldName) || (modifiers & 1) != 1 || (modifiers & 8) == 8 || (fieldName.startsWith(Session.SESSION_SEPARATION_CHAR_CHILD) ^ 1) == 0 || (fieldName.endsWith(Session.SESSION_SEPARATION_CHAR_CHILD) ^ 1) == 0)) {
