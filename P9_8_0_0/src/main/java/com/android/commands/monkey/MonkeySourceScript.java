    ...
    private void handleEvent(String s, String[] args) {
        ...
        if (s.indexOf(EVENT_KEYWORD_KEY) >= 0 && args.length == 8) {
            try {
                ...
                MonkeyEvent e = new MonkeyKeyEvent(downTime, eventTime, action, code, Integer.parseInt(args[4]), Integer.parseInt(args[5]), Integer.parseInt(args[6]), Integer.parseInt(args[7]));
            ...
            try {
                ...
                if (s.indexOf("Pointer") > 0) {
                    r0 = new MonkeyTouchEvent(action);
                } else {
                    r0 = new MonkeyTrackballEvent(action);
                }
            ...
            try {
                ...
                if (!(rotationDegree == 0 || rotationDegree == 1 || rotationDegree == 2)) {
                    if (rotationDegree == 3) {
                    }
                }
            ...
            if (s.indexOf(EVENT_KEYWORD_ACTIVITY) >= 0 && args.length >= 2) {
                ...
                if (args.length > 2) {
                    try {
                        ...
                        Logger.err.println("// " + e62.toString());
                        return;
                    }
                }
                if (args.length == 2) {
            ...
            try {
                ...
                r0 = new MonkeyWaitEvent(pressDuration);
                ...
                this.mQ.addLast(r0);
                this.mQ.addLast(r0);
            } catch (NumberFormatException e622) {
                Logger.err.println("// " + e622.toString());
            }
        }
    }
