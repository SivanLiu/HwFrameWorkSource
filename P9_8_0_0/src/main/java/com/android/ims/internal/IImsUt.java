...
public interface IImsUt extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IImsUt {
        ...
        static final int TRANSACTION_isSupportCFT = 19;
        ...
        static final int TRANSACTION_updateCallBarringOption = 20;
        static final int TRANSACTION_updateCallForward = 11;
        static final int TRANSACTION_updateCallForwardUncondTimer = 21;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 22:
                    data.enforceInterface(DESCRIPTOR);
                    String _result3 = getUtIMPUFromNetwork();
                    reply.writeNoException();
