        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 23:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        inputContentInfo = (InputContentInfo) InputContentInfo.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    commitContent(inputContentInfo, _arg1, bundle2, data.readInt(), com.android.internal.view.IInputContextCallback.Stub.asInterface(data.readStrongBinder()));
                    return true;
                case 1598968902:
