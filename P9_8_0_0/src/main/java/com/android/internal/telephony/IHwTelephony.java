...
public interface IHwTelephony extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IHwTelephony {
        ...
        static final int TRANSACTION_getCdmaGsmImsiForSubId = 98;
        ...
        static final int TRANSACTION_informModemTetherStatusToChangeGRO = 96;
        static final int TRANSACTION_is4RMimoEnabled = 99;
        ...
        static final int TRANSACTION_writeSimLockNwData = 97;
