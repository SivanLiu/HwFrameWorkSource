...
public class HwAllInOneController extends Handler {
    ...
    private static final boolean IS_SUB0_ALWAYS_DEFAULTSUB = SystemProperties.getBoolean("ro.config.sub0_defaultsub", false);
    ...
    private void setDefault4GSlot(int slotId) {
        if (!IS_SUB0_ALWAYS_DEFAULTSUB || slotId == 0) {
            int LteSlot;
            int gsmOnlySlot;
        ...
        logd("setDefault4GSlot: SUB_0 should be default subscription");
    }
