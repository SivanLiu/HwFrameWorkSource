...
public class HwCustApnReminderImpl extends HwCustApnReminder {
    ...
    private void mentionApnFailed() {
        ...
        builder.setTitle(33685990).setCancelable(HWDBG).setMessage(33685989).setPositiveButton(33685987, new goSetApnListener()).setNegativeButton(33685988, new OnClickListener() {
