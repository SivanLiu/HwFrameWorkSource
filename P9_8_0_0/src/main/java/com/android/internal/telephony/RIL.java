...
public class RIL extends AbstractRIL implements CommandsInterface {
    ...
    private IRadio getRadioProxy(Message result) {
        ...
        if (!this.mIsMobileNetworkSupported) {
            ...
            try {
                iRadio = vendor.huawei.hardware.radio.V1_1.IRadio.getService(HIDL_SERVICE_NAME[this.mPhoneId == null ? 0 : this.mPhoneId.intValue()]);
            ...
            try {
                ...
                if (this.mRadioProxy != null) {
                    ...
                    iRadio.setResponseFunctionsHuawei(this.mRadioResponse, this.mRadioIndication);
                    iRadio.setResponseFunctions(this.mRadioResponse, this.mRadioIndication);
                } else {
                    riljLoge("getRadioProxy: huawei radioProxy == null");
                }
            } catch (Exception e22) {
                this.mRadioProxy = null;
                riljLoge("RadioProxy getService/setResponseFunctions: " + e22);
            }
            if (this.mRadioProxy == null) {
                if (result != null) {
                    AsyncResult.forMessage(result, null, CommandException.fromRilErrno(1));
    ...
    public void setupDataCall(int radioTechnology, DataProfile dataProfile, boolean isRoaming, boolean allowRoaming, Message result) {
        ...
        if (radioProxy != null) {
            ...
            try {
                ...
                handleRadioProxyExceptionForRR(rr, "setupDataCall", e2);
            }
        }
    }
    ...
    void processRequestAck(int serial) {
        synchronized (this.mRequestList) {
            RILRequest rr = (RILRequest) this.mRequestList.get(serial);
        }
        if (rr == null) {
