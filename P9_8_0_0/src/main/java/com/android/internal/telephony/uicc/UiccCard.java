...
public class UiccCard extends AbstractUiccCard {
    ...
    private void onIccSwap(boolean isAdded) {
        if (this.mContext.getResources().getBoolean(17956973)) {
    ...
    private void promptForRestart(boolean isAdded) {
        ...
        synchronized (this.mLock) {
            String dialogComponent = this.mContext.getResources().getString(17039794);
    ...
    private void promptInstallCarrierApp(String pkgName) {
        ...
        String message = r.getString(17039716);
        AlertDialog dialog = new Builder(this.mContext).setMessage(message).setNegativeButton(r.getString(17039717), listener).setPositiveButton(r.getString(17039715), listener).create();
