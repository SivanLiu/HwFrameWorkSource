...
public class InCallDataStateMachine extends StateMachine {
    ...
    private void showDialog() {
        String toastString = String.format(this.mContext.getResources().getString(33686059), new Object[]{Integer.valueOf(this.mInCallPhoneId + 1)});
        Builder builder = new Builder(this.mContext, 33947691);
        builder.setTitle(33686058);
