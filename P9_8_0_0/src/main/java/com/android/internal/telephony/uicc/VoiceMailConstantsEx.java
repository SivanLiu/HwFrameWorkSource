...
public class VoiceMailConstantsEx extends VoiceMailConstants {
    ...
    public void getVoiceMailConfig(String carrier) {
        ...
        if (!TextUtils.isEmpty(this.mVMNumberOnSim) && this.voicemailPriorityMode != 3) {
            ...
            Object simSerialNumber = ((TelephonyManager) this.mContext.getSystemService("phone")) != null ? TelephonyManager.getDefault().getSimSerialNumber() : null;
            String number = !TextUtils.isEmpty(simSerialNumber) ? sp.getString(simSerialNumber + this.mSlotId, null) : sp.getString("vm_number_key" + this.mSlotId, null);
            if (number != null) {
