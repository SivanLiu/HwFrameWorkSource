                                ...
                                if (this.mSysMemUsage.readFromParcel(in)) {
                                    ...
                                    while (NPROC > 0) {
                                        ...
                                        while (NUID > 0) {
                                            ...
                                            vers = in.readInt();
                                            obj = hadData ? (ProcessState) this.mProcesses.get(procName, uid) : null;
                                            if (obj == null) {
                                                obj = new ProcessState(this, pkgName, uid, vers, procName);
                                                if (!obj.readFromParcel(in, true)) {
                                                    return;
                                                }
                                            } else if (!obj.readFromParcel(in, false)) {
                                                return;
                                            }
                                            this.mProcesses.put(procName, uid, obj);
                                        }
                                    }
                                    int NPKG = in.readInt();
                                    if (NPKG < 0) {
                                            ...
                                            while (NVERS > 0) {
                                                ...
                                                while (NPROCS > 0) {
                                                    ...
                                                    if (commonProc == null) {
                                                        ...
                                                        obj = hadData ? (ProcessState) packageState.mProcesses.get(procName) : null;
                                                        if (obj == null) {
                                                            obj = new ProcessState(commonProc, pkgName, uid, vers, procName, 0);
                                                            if (!obj.readFromParcel(in, true)) {
                                                                return;
                                                            }
                                                        } else if (!obj.readFromParcel(in, false)) {
                                                        ...
                                                        packageState.mProcesses.put(procName, obj);
                                                    } else {
                                                ...
                                                while (NSRVS > 0) {
                                                    ...
                                                    String readCommonString = version > 9 ? readCommonString(in, version) : null;
                                                    ServiceState serviceState = hadData ? (ServiceState) packageState.mServices.get(serviceName) : null;
                                                    if (serviceState == null) {
                                                        serviceState = new ServiceState(this, pkgName, serviceName, readCommonString, null);
                                                    }
                                                    if (serviceState.readFromParcel(in)) {
                                                        packageState.mServices.put(serviceName, serviceState);
                                                    } else {
                                                        return;
                                                    }
                                                }
