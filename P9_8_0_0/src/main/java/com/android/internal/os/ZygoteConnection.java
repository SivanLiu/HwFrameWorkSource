            ...
            if (args == null) {
                ...
                try {
                    ...
                    try {
                        ...
                        if (arguments2.preloadDefault) {
                            return handlePreload();
                        }
                        if (arguments2.preloadPackage != null) {
                            return handlePreloadPackage(arguments2.preloadPackage, arguments2.preloadPackageLibs, arguments2.preloadPackageCacheKey);
                        } else if (arguments2.permittedCapabilities == 0 && arguments2.effectiveCapabilities == 0) {
                            ...
                            pid = Zygote.forkAndSpecialize(arguments2.uid, arguments2.gid, arguments2.gids, arguments2.debugFlags, iArr, arguments2.mountExternal, arguments2.seInfo, arguments2.niceName, fdsToClose, iArr2, arguments2.instructionSet, arguments2.appDataDir);
