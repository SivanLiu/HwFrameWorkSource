        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    _result = startListening(com.android.internal.appwidget.IAppWidgetHost.Stub.asInterface(data.readStrongBinder()), data.readString(), data.readInt(), data.createIntArray());
                ...
                case 16:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getInstalledProvidersForProfile(data.readInt(), data.readInt(), data.readString());
                    reply.writeNoException();
                    if (_result != null) {
                        reply.writeInt(1);
                        _result.writeToParcel(reply, 1);
                ...
                case 25:
                    ...
                    _result3 = requestPinAppWidget(_arg0, componentName3, bundle, intentSender);
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 26:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = isRequestPinAppWidgetSupported();
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 1598968902:
