        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 13:
                    ...
                    if (data.readInt() != 0) {
                        serverAddr = (ServerAddr) ServerAddr.CREATOR.createFromParcel(data);
                    } else {
                        serverAddr = null;
                    }
                    _result = setupTunnelOverWifi(_arg0, _arg1, _arg2, serverAddr);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 14:
                    ...
                    _result = teardownTunnelOverWifi(_arg0, _arg1, _arg2, serverAddr);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 15:
