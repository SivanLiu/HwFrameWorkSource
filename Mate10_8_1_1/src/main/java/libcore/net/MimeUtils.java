...
public final class MimeUtils {
    ...
    static {
        ...
        add("application/x-jmol", DateFormat.HOUR_MINUTE_TZ);
        ...
        add("text/xml", XMLConstants.XML_NS_PREFIX);
        ...
        add("text/x-csh", "csh");
        add("text/x-csrc", "c");
        add("text/x-dsrc", DateFormat.DAY);
    ...
    public static String guessMimeTypeFromExtension(String extension) {
        ...
        return (String) extensionToMimeTypeMap.get(extension.toLowerCase(Locale.US));
    }
    ...
    public static String guessExtensionFromMimeType(String mimeType) {
        ...
        return (String) mimeTypeToExtensionMap.get(mimeType.toLowerCase(Locale.US));
    }
}
