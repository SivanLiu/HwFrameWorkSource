...
public final class DeviceAdminInfo implements Parcelable {
    ...
    static {
        sPoliciesDisplayOrder.add(new PolicyInfo(4, "wipe-data", 17040836, 17040825, 17040837, 17040826));
        sPoliciesDisplayOrder.add(new PolicyInfo(2, "reset-password", 17040833, 17040821));
        sPoliciesDisplayOrder.add(new PolicyInfo(0, "limit-password", 17040832, 17040820));
        sPoliciesDisplayOrder.add(new PolicyInfo(1, "watch-login", 17040835, 17040823, 17040835, 17040824));
        sPoliciesDisplayOrder.add(new PolicyInfo(3, "force-lock", 17040831, 17040819));
        sPoliciesDisplayOrder.add(new PolicyInfo(5, "set-global-proxy", 17040834, 17040822));
        sPoliciesDisplayOrder.add(new PolicyInfo(6, "expire-password", 17040830, 17040818));
        sPoliciesDisplayOrder.add(new PolicyInfo(7, "encrypted-storage", 17040829, 17040817));
        sPoliciesDisplayOrder.add(new PolicyInfo(8, "disable-camera", 17040827, 17040815));
        sPoliciesDisplayOrder.add(new PolicyInfo(9, "disable-keyguard-features", 17040828, 17040816));
