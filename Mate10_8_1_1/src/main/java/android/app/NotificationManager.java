...
*/
    ...
    public void notifyAsUser(String tag, int id, Notification notification, UserHandle user) {
        ...
        if (this.mContext.getApplicationInfo().targetSdkVersion <= 22 || notification.getSmallIcon() != null) {
            ...
            try {
                service.enqueueNotificationWithTag(pkg, this.mContext.getOpPackageName(), tag, id, Builder.maybeCloneStrippedForDelivery(notification, ((ActivityManager) this.mContext.getSystemService(Context.ACTIVITY_SERVICE)).isLowRamDevice()), user.getIdentifier());
                return;
