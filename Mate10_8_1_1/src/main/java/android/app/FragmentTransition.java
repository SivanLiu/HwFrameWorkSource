...
class FragmentTransition {
    ...
    private static void replaceHide(Transition exitTransition, Fragment exitingFragment, final ArrayList<View> exitingViews) {
        if (exitingFragment != null && exitTransition != null && exitingFragment.mAdded && exitingFragment.mHidden && exitingFragment.mHiddenChanged) {
            ...
            OneShotPreDrawListener.add(exitingFragment.mContainer, new -$Lambda$aS31cHIhRx41653CMnd4gZqshIQ((byte) 3, exitingViews));
    ...
    private static void scheduleTargetChange(ViewGroup sceneRoot, Fragment inFragment, View nonExistentView, ArrayList<View> sharedElementsIn, Transition enterTransition, ArrayList<View> enteringViews, Transition exitTransition, ArrayList<View> exitingViews) {
        OneShotPreDrawListener.add(sceneRoot, new -$Lambda$3eJ3p8XnIxdVOnT82Ns3R0V5ZQE(enterTransition, nonExistentView, inFragment, sharedElementsIn, enteringViews, exitingViews, exitTransition));
    }
    ...
    private static TransitionSet configureSharedElementsReordered(ViewGroup sceneRoot, View nonExistentView, ArrayMap<String, String> nameOverrides, FragmentContainerTransition fragments, ArrayList<View> sharedElementsOut, ArrayList<View> sharedElementsIn, Transition enterTransition, Transition exitTransition) {
        ...
        if (nameOverrides.isEmpty()) {
            ...
            transitionSet = getSharedElementTransition(inFragment, outFragment, inIsPop);
        }
        ArrayMap<String, View> outSharedElements = captureOutSharedElements(nameOverrides, transitionSet, fragments);
        ArrayMap<String, View> inSharedElements = captureInSharedElements(nameOverrides, transitionSet, fragments);
        if (nameOverrides.isEmpty()) {
            transitionSet = null;
        ...
        if (enterTransition == null && exitTransition == null && transitionSet == null) {
            return null;
        }
        ...
        if (transitionSet != null) {
            ...
            setSharedElementTargets(transitionSet, nonExistentView, sharedElementsOut);
            setOutEpicenter(transitionSet, exitTransition, outSharedElements, fragments.firstOutIsPop, fragments.firstOutTransaction);
            epicenter = new Rect();
        ...
        OneShotPreDrawListener.add(sceneRoot, new android.app.-$Lambda$3eJ3p8XnIxdVOnT82Ns3R0V5ZQE.AnonymousClass1(inIsPop, inFragment, outFragment, inSharedElements, epicenterView, epicenter));
        return transitionSet;
    }
    ...
    private static TransitionSet configureSharedElementsOrdered(ViewGroup sceneRoot, View nonExistentView, ArrayMap<String, String> nameOverrides, FragmentContainerTransition fragments, ArrayList<View> sharedElementsOut, ArrayList<View> sharedElementsIn, Transition enterTransition, Transition exitTransition) {
        ...
        View view = sceneRoot;
        OneShotPreDrawListener.add(view, new android.app.-$Lambda$3eJ3p8XnIxdVOnT82Ns3R0V5ZQE.AnonymousClass2(inIsPop, nameOverrides, transitionSet, fragments, sharedElementsIn, nonExistentView, inFragment, outFragment, sharedElementsOut, enterTransition, inEpicenter));
        return transitionSet;
    }
        ...
        if (fragment != null) {
            ...
            if (containerId != 0) {
                ...
                switch (isPop ? INVERSE_OPS[op.cmd] : op.cmd) {
                    ...
                    case 3:
                    case 6:
                        setFirstOut = isReorderedTransaction ? (fragment.mAdded || fragment.mView == null || fragment.mView.getVisibility() != 0) ? false : fragment.mView.getTransitionAlpha() > 0.0f : fragment.mAdded ? fragment.mHidden ^ 1 : false;
                        wasRemoved = true;
                        break;
                    case 4:
