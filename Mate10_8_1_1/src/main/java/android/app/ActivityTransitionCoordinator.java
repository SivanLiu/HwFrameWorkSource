...
abstract class ActivityTransitionCoordinator extends ResultReceiver {
    ...
    protected void scheduleSetSharedElementEnd(ArrayList<View> snapshots) {
        ...
        if (decorView != null) {
            OneShotPreDrawListener.add(decorView, new -$Lambda$Pcw-0289sroTvc5U7X-pS90OouM((byte) 0, this, snapshots));
        }
    }

    /* synthetic */ void lambda$-android_app_ActivityTransitionCoordinator_27512(ArrayList snapshots) {
    ...
    protected void scheduleGhostVisibilityChange(int visibility) {
        View decorView = getDecor();
        if (decorView != null) {
            OneShotPreDrawListener.add(decorView, new -$Lambda$w9bG0NLfK6B6UpQKzQS6S1ayAh0(visibility, this));
        }
    }

    /* synthetic */ void lambda$-android_app_ActivityTransitionCoordinator_39166(int visibility) {
