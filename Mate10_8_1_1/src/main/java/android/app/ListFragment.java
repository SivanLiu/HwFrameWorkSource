    ...
    private void ensureList() {
        if (this.mList == null) {
            ...
            if (root instanceof ListView) {
                ...
                this.mStandardEmptyView = (TextView) root.findViewById(16908991);
                if (this.mStandardEmptyView == null) {
                    this.mEmptyView = root.findViewById(R.id.empty);
                } else {
                    this.mStandardEmptyView.setVisibility(8);
                }
                this.mProgressContainer = root.findViewById(16909189);
                this.mListContainer = root.findViewById(16909024);
