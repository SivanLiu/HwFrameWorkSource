...
public class SearchDialog extends Dialog {
    ...
    static int resolveDialogTheme(Context context) {
        ...
        context.getTheme().resolveAttribute(17891502, outValue, true);
    ...
    private void createContentView() {
        setContentView(17367259);
        this.mSearchView = (SearchView) findViewById(16909251);
        ...
        this.mBadgeLabel = (TextView) this.mSearchView.findViewById(16909242);
        this.mSearchAutoComplete = (AutoCompleteTextView) this.mSearchView.findViewById(16909250);
        this.mAppIcon = (ImageView) findViewById(16909241);
        this.mSearchPlate = this.mSearchView.findViewById(16909249);
        this.mWorkingSpinner = getContext().getDrawable(17303358);
        setWorking(false);
