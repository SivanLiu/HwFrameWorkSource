...
public class Fragment implements ComponentCallbacks2, OnCreateContextMenuListener {
    ...
    public void setTargetFragment(Fragment fragment, int requestCode) {
        ...
        if (mine == null || fragmentManager == null || mine == fragmentManager) {
    ...
    public void startPostponedEnterTransition() {
        if (this.mFragmentManager == null || this.mFragmentManager.mHost == null) {
            ...
            this.mFragmentManager.mHost.getHandler().postAtFrontOfQueue(new -$Lambda$aS31cHIhRx41653CMnd4gZqshIQ((byte) 2, this));
        } else {
            callStartTransitionListener();
        }
    }

    /* synthetic */ void -android_app_Fragment-mthref-0() {
        callStartTransitionListener();
    }
