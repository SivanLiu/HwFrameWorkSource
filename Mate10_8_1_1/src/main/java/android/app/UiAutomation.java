...
public final class UiAutomation {
    ...
    public ParcelFileDescriptor executeShellCommand(String command) {
        ...
        try {
            ...
            this.mUiAutomationConnection.executeShellCommand(command, autoCloseable, null);
    ...
    public ParcelFileDescriptor[] executeShellCommandRw(String command) {
        ...
        try {
            ...
            parcelFileDescriptor = pipe_read[0];
            autoCloseable = pipe_read[1];
            ParcelFileDescriptor[] pipe_write = ParcelFileDescriptor.createPipe();
            autoCloseable2 = pipe_write[0];
            parcelFileDescriptor2 = pipe_write[1];
            this.mUiAutomationConnection.executeShellCommand(command, autoCloseable, autoCloseable2);
        } catch (IOException ioe) {
            Log.e(LOG_TAG, "Error executing shell command!", ioe);
        } catch (RemoteException re) {
            Log.e(LOG_TAG, "Error executing shell command!", re);
        ...
        return new ParcelFileDescriptor[]{parcelFileDescriptor, parcelFileDescriptor2};
    }
