...
public interface IActivityManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IActivityManager {
        ...
        static final int TRANSACTION_activityRelaunched = 251;
        ...
        static final int TRANSACTION_backgroundWhitelistUid = 291;
        ...
        static final int TRANSACTION_createStackOnDisplay = 211;
        static final int TRANSACTION_dismissKeyguard = 281;
        static final int TRANSACTION_dumpHeap = 114;
        static final int TRANSACTION_dumpHeapFinished = 218;
        static final int TRANSACTION_enterPictureInPictureMode = 248;
        static final int TRANSACTION_enterSafeMode = 59;
        static final int TRANSACTION_exitFreeformMode = 237;
        ...
        static final int TRANSACTION_getActivityStackId = 236;
        static final int TRANSACTION_getAllStackInfos = 164;
        static final int TRANSACTION_getAppTaskThumbnailSize = 201;
        ...
        static final int TRANSACTION_getFocusedStackId = 212;
        static final int TRANSACTION_getFrontActivityScreenCompatMode = 118;
        static final int TRANSACTION_getGrantedUriPermissions = 255;
        static final int TRANSACTION_getHwInnerService = 294;
        static final int TRANSACTION_getIntentForIntentSender = 155;
        static final int TRANSACTION_getIntentSender = 54;
        static final int TRANSACTION_getLastResumedActivityUserId = 290;
        static final int TRANSACTION_getLaunchedFromPackage = 158;
        static final int TRANSACTION_getLaunchedFromUid = 143;
        static final int TRANSACTION_getLockTaskModeState = 216;
        static final int TRANSACTION_getMaxNumPictureInPictureActions = 250;
        static final int TRANSACTION_getMemoryInfo = 69;
        static final int TRANSACTION_getMemoryTrimLevel = 265;
        ...
        static final int TRANSACTION_getPackageProcessState = 223;
        ...
        static final int TRANSACTION_getTaskDescriptionIcon = 205;
        static final int TRANSACTION_getTaskForActivity = 20;
        static final int TRANSACTION_getTaskSnapshot = 285;
        ...
        static final int TRANSACTION_getUidProcessState = 227;
        static final int TRANSACTION_getUriPermissionOwnerForActivity = 252;
        ...
        static final int TRANSACTION_isAppForeground = 257;
        static final int TRANSACTION_isAppStartModeDisabled = 243;
        static final int TRANSACTION_isAssistDataAllowedOnCurrentActivity = 230;
        static final int TRANSACTION_isImmersive = 105;
        static final int TRANSACTION_isInLockTaskMode = 185;
        static final int TRANSACTION_isInMultiWindowMode = 245;
        static final int TRANSACTION_isInPictureInPictureMode = 246;
        ...
        static final int TRANSACTION_isRootVoiceInteraction = 232;
        ...
        static final int TRANSACTION_isVrModePackageEnabled = 267;
        static final int TRANSACTION_keyguardGoingAway = 226;
        ...
        static final int TRANSACTION_killPackageDependents = 247;
        ...
        static final int TRANSACTION_launchAssistIntent = 206;
        static final int TRANSACTION_makePackageIdle = 264;
        static final int TRANSACTION_moveActivityTaskToBack = 68;
        static final int TRANSACTION_moveStackToDisplay = 279;
        static final int TRANSACTION_moveTaskBackwards = 19;
        static final int TRANSACTION_moveTaskToDockedStack = 239;
        static final int TRANSACTION_moveTaskToFront = 18;
        static final int TRANSACTION_moveTaskToStack = 162;
        static final int TRANSACTION_moveTasksToFullscreenStack = 241;
        static final int TRANSACTION_moveTopActivityToPinnedStack = 242;
        static final int TRANSACTION_navigateUpTo = 140;
        static final int TRANSACTION_newUriPermissionOwner = 110;
        static final int TRANSACTION_noteAlarmFinish = 222;
        static final int TRANSACTION_noteAlarmStart = 221;
        static final int TRANSACTION_noteWakeupAlarm = 61;
        static final int TRANSACTION_notifyActivityDrawn = 169;
        static final int TRANSACTION_notifyCleartextNetwork = 210;
        ...
        static final int TRANSACTION_notifyLockedProfile = 269;
        static final int TRANSACTION_notifyPinnedStackAnimationEnded = 262;
        static final int TRANSACTION_notifyPinnedStackAnimationStarted = 261;
        ...
        static final int TRANSACTION_positionTaskInStack = 235;
        ...
        static final int TRANSACTION_registerTaskStackListener = 209;
        static final int TRANSACTION_registerUidObserver = 228;
        static final int TRANSACTION_registerUserSwitchObserver = 148;
        static final int TRANSACTION_releaseActivityInstance = 202;
        static final int TRANSACTION_releasePersistableUriPermission = 174;
        static final int TRANSACTION_releaseSomeActivities = 203;
        static final int TRANSACTION_removeContentProvider = 62;
        static final int TRANSACTION_removeContentProviderExternal = 135;
        static final int TRANSACTION_removeStack = 263;
        ...
        static final int TRANSACTION_reportSizeConfigurations = 238;
        static final int TRANSACTION_requestActivityRelaunch = 276;
        static final int TRANSACTION_requestAssistContextExtras = 214;
        static final int TRANSACTION_requestAutofillData = 280;
        static final int TRANSACTION_requestBugReport = 151;
        static final int TRANSACTION_requestTelephonyBugReport = 152;
        static final int TRANSACTION_resizeDockedStack = 253;
        static final int TRANSACTION_resizePinnedStack = 266;
        static final int TRANSACTION_resizeStack = 163;
        static final int TRANSACTION_resizeTask = 215;
        static final int TRANSACTION_restart = 171;
        static final int TRANSACTION_restartUserInBackground = 282;
        ...
        static final int TRANSACTION_scheduleApplicationInfoChanged = 286;
        static final int TRANSACTION_sendIdleJobTrigger = 271;
        static final int TRANSACTION_sendIntentSender = 272;
        ...
        static final int TRANSACTION_setDisablePreviewScreenshots = 289;
        static final int TRANSACTION_setDumpHeapDebugLimit = 217;
        static final int TRANSACTION_setExitInfo = 200;
        ...
        static final int TRANSACTION_setHasTopUi = 275;
        ...
        static final int TRANSACTION_setPersistentVrThread = 287;
        static final int TRANSACTION_setPictureInPictureParams = 249;
        ...
        static final int TRANSACTION_setRenderThread = 274;
        static final int TRANSACTION_setRequestedOrientation = 63;
        static final int TRANSACTION_setServiceForeground = 67;
        static final int TRANSACTION_setShowWhenLocked = 292;
        static final int TRANSACTION_setTaskDescription = 186;
        static final int TRANSACTION_setTaskResizeable = 213;
        static final int TRANSACTION_setTurnScreenOn = 293;
        static final int TRANSACTION_setUserIsMonkey = 160;
        static final int TRANSACTION_setVoiceKeepAwake = 219;
        static final int TRANSACTION_setVrMode = 254;
        static final int TRANSACTION_setVrThread = 273;
        static final int TRANSACTION_shouldUpRecreateTask = 139;
        static final int TRANSACTION_showAssistFromActivity = 231;
        static final int TRANSACTION_showBootMessage = 132;
        static final int TRANSACTION_showLockTaskEscapeMessage = 224;
        ...
        static final int TRANSACTION_startBinderTracking = 233;
        static final int TRANSACTION_startConfirmDeviceCredentialIntent = 270;
        static final int TRANSACTION_startInPlaceAnimationOnFrontMostApplication = 207;
        static final int TRANSACTION_startInstrumentation = 34;
        static final int TRANSACTION_startLocalVoiceInteraction = 258;
        ...
        static final int TRANSACTION_stopBinderTrackingAndDump = 234;
        static final int TRANSACTION_stopLocalVoiceInteraction = 259;
        ...
        static final int TRANSACTION_supportsLocalVoiceInteraction = 260;
        static final int TRANSACTION_suppressResizeConfigChanges = 240;
        static final int TRANSACTION_swapDockedAndFullscreenStack = 268;
        ...
        static final int TRANSACTION_unlockUser = 244;
        ...
        static final int TRANSACTION_unregisterTaskStackListener = 278;
        static final int TRANSACTION_unregisterUidObserver = 229;
        ...
        static final int TRANSACTION_updateDeviceOwner = 225;
        static final int TRANSACTION_updateDisplayOverrideConfiguration = 277;
        static final int TRANSACTION_updateLockTaskPackages = 220;
        static final int TRANSACTION_updatePersistentConfiguration = 130;
        static final int TRANSACTION_waitForNetworkStateUpdate = 288;
        ...
        private static class Proxy implements IActivityManager {
            ...
            public TaskThumbnail getTaskThumbnail(int taskId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        taskThumbnail = (TaskThumbnail) TaskThumbnail.CREATOR.createFromParcel(_reply);
                    } else {
                        taskThumbnail = null;
                    }
                    _reply.recycle();
            ...
            public WaitResult startActivityAndWait(IApplicationThread caller, String callingPackage, Intent intent, String resolvedType, IBinder resultTo, String resultWho, int requestCode, int flags, ProfilerInfo profilerInfo, Bundle options, int userId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        waitResult = (WaitResult) WaitResult.CREATOR.createFromParcel(_reply);
                    } else {
                        waitResult = null;
                    }
                    _reply.recycle();
            ...
            public void setExitInfo(Bundle bundle, Bitmap iconBitmap) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public boolean updateDisplayOverrideConfiguration(Configuration values, int displayId) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(displayId);
                    this.mRemote.transact(Stub.TRANSACTION_updateDisplayOverrideConfiguration, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public void setShowWhenLocked(IBinder token, boolean showWhenLocked) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_setShowWhenLocked, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void setTurnScreenOn(IBinder token, boolean turnScreenOn) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_setTurnScreenOn, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    ParcelFileDescriptor _result10 = openContentUri(data.readString());
                ...
                case 2:
                    ...
                    if (data.readInt() != 0) {
                        parcelableCrashInfo = (ParcelableCrashInfo) ParcelableCrashInfo.CREATOR.createFromParcel(data);
                    } else {
                        parcelableCrashInfo = null;
                    }
                    handleApplicationCrash(_arg0, parcelableCrashInfo);
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    _result = startActivity(_arg02, _arg1, intent, _arg3, _arg4, _arg5, _arg6, _arg7, profilerInfo, bundle);
                    reply.writeNoException();
                ...
                case 5:
                    ...
                    _result2 = finishActivity(_arg0, _arg12, intent, data.readInt());
                    reply.writeNoException();
                ...
                case 6:
                    ...
                    _arg02 = android.app.IApplicationThread.Stub.asInterface(data.readStrongBinder());
                    _arg1 = data.readString();
                    IIntentReceiver _arg25 = android.content.IIntentReceiver.Stub.asInterface(data.readStrongBinder());
                    if (data.readInt() != 0) {
                        intentFilter = (IntentFilter) IntentFilter.CREATOR.createFromParcel(data);
                    } else {
                        intentFilter = null;
                    }
                    _result3 = registerReceiver(_arg02, _arg1, _arg25, intentFilter, data.readString(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (_result3 != null) {
                        reply.writeInt(1);
                ...
                case 8:
                    ...
                    IIntentReceiver _arg33 = android.content.IIntentReceiver.Stub.asInterface(data.readStrongBinder());
                    _arg42 = data.readInt();
                    _arg5 = data.readString();
                    if (data.readInt() != 0) {
                    ...
                    _result = broadcastIntent(_arg02, intent2, _arg2, _arg33, _arg42, _arg5, bundle7, _arg72, _arg8, bundle, data.readInt() != 0, data.readInt() != 0, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 9:
                    ...
                    unbroadcastIntent(_arg02, intent2, data.readInt());
                    reply.writeNoException();
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    finishReceiver(_arg0, _arg12, _arg2, bundle2, data.readInt() != 0, data.readInt());
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 12:
                    ...
                    activityIdle(_arg0, configuration2, data.readInt() != 0);
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 14:
                    ...
                    activityStopped(_arg0, bundle3, persistableBundle, charSequence);
                    return true;
                case 15:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 17:
                    data.enforceInterface(DESCRIPTOR);
                    List<RunningTaskInfo> _result11 = getTasks(data.readInt(), data.readInt());
                    reply.writeNoException();
                ...
                case 18:
                    ...
                    moveTaskToFront(_arg03, _arg12, bundle4);
                    reply.writeNoException();
                    return true;
                case 19:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 25:
                    ...
                    PendingIntent _result12 = getRunningServiceControlPanel(componentName);
                    reply.writeNoException();
                    if (_result12 != null) {
                        reply.writeInt(1);
                ...
                case 26:
                    ...
                    _result5 = startService(_arg02, intent2, data.readString(), data.readInt() != 0, data.readString(), data.readInt());
                    reply.writeNoException();
                    if (_result5 != null) {
                        reply.writeInt(1);
                        _result5.writeToParcel(reply, 1);
                ...
                case 27:
                    ...
                    _result = stopService(_arg02, intent2, data.readString(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 28:
                    data.enforceInterface(DESCRIPTOR);
                    _arg02 = android.app.IApplicationThread.Stub.asInterface(data.readStrongBinder());
                    _arg13 = data.readStrongBinder();
                    if (data.readInt() != 0) {
                        intent = (Intent) Intent.CREATOR.createFromParcel(data);
                    } else {
                        intent = null;
                    }
                    _result = bindService(_arg02, _arg13, intent, data.readString(), android.app.IServiceConnection.Stub.asInterface(data.readStrongBinder()), data.readInt(), data.readString(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 29:
                ...
                case 30:
                    ...
                    publishService(_arg0, intent2, data.readStrongBinder());
                    reply.writeNoException();
                    return true;
                case 31:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 34:
                    ...
                    _result2 = startInstrumentation(componentName, _arg1, _arg22, bundle2, android.app.IInstrumentationWatcher.Stub.asInterface(data.readStrongBinder()), android.app.IUiAutomationConnection.Stub.asInterface(data.readStrongBinder()), data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 35:
                    ...
                    addInstrumentationResults(_arg02, bundle3);
                    reply.writeNoException();
                    return true;
                case 36:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    finishInstrumentation(_arg02, _arg12, bundle4);
                    reply.writeNoException();
                    return true;
                case 37:
                    data.enforceInterface(DESCRIPTOR);
                    Configuration _result13 = getConfiguration();
                    reply.writeNoException();
                    if (_result13 != null) {
                        reply.writeInt(1);
                ...
                case 38:
                    ...
                    _result2 = updateConfiguration(configuration);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 39:
                    ...
                    _result2 = stopServiceToken(componentName, data.readStrongBinder(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 40:
                ...
                case 45:
                    ...
                    _result = checkUriPermission(uri, data.readInt(), data.readInt(), data.readInt(), data.readInt(), data.readStrongBinder());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 46:
                    ...
                    grantUriPermission(_arg02, _arg1, uri2, data.readInt(), data.readInt());
                    reply.writeNoException();
                    return true;
                case 47:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    revokeUriPermission(_arg02, _arg1, uri2, data.readInt(), data.readInt());
                    reply.writeNoException();
                    return true;
                case 48:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 54:
                    ...
                    _arg03 = data.readInt();
                    _arg1 = data.readString();
                    _arg23 = data.readStrongBinder();
                    _arg3 = data.readString();
                    _arg42 = data.readInt();
                    Intent[] _arg52 = (Intent[]) data.createTypedArray(Intent.CREATOR);
                    ...
                    IIntentSender _result14 = getIntentSender(_arg03, _arg1, _arg23, _arg3, _arg42, _arg52, _arg63, _arg7, bundle8, data.readInt());
                    reply.writeNoException();
                ...
                case 60:
                    ...
                    _result2 = startNextMatchingActivity(_arg0, intent2, bundle4);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 61:
                ...
                case 65:
                    ...
                    unbindFinished(_arg0, intent2, data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 66:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 67:
                    ...
                    setServiceForeground(componentName, _arg13, _arg22, notification, data.readInt());
                    reply.writeNoException();
                    return true;
                case 68:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 69:
                    data.enforceInterface(DESCRIPTOR);
                    MemoryInfo _arg05 = new MemoryInfo();
                    getMemoryInfo(_arg05);
                    reply.writeNoException();
                    if (_arg05 != null) {
                        reply.writeInt(1);
                ...
                case 70:
                    data.enforceInterface(DESCRIPTOR);
                    List<ProcessErrorStateInfo> _result15 = getProcessesInErrorState();
                    reply.writeNoException();
                ...
                case 74:
                    data.enforceInterface(DESCRIPTOR);
                    List<RunningServiceInfo> _result16 = getServices(data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeTypedList(_result16);
                    return true;
                case 75:
                    data.enforceInterface(DESCRIPTOR);
                    TaskThumbnail _result17 = getTaskThumbnail(data.readInt());
                    reply.writeNoException();
                    if (_result17 != null) {
                        reply.writeInt(1);
                ...
                case 76:
                    data.enforceInterface(DESCRIPTOR);
                    TaskDescription _result18 = getTaskDescription(data.readInt());
                    reply.writeNoException();
                    if (_result18 != null) {
                        reply.writeInt(1);
                ...
                case 77:
                    data.enforceInterface(DESCRIPTOR);
                    List<RunningAppProcessInfo> _result19 = getRunningAppProcesses();
                    reply.writeNoException();
                    reply.writeTypedList(_result19);
                    return true;
                case 78:
                    data.enforceInterface(DESCRIPTOR);
                    ConfigurationInfo _result20 = getDeviceConfigurationInfo();
                    reply.writeNoException();
                    if (_result20 != null) {
                        reply.writeInt(1);
                ...
                case 79:
                    ...
                    _result8 = peekService(intent3, data.readString(), data.readString());
                    reply.writeNoException();
                ...
                case 80:
                    ...
                    _arg12 = data.readInt();
                    _arg24 = data.readInt() != 0;
                    if (data.readInt() != 0) {
                        profilerInfo2 = (ProfilerInfo) ProfilerInfo.CREATOR.createFromParcel(data);
                    } else {
                        profilerInfo2 = null;
                    }
                    _result2 = profileControl(_arg04, _arg12, _arg24, profilerInfo2, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 81:
                ...
                case 92:
                    data.enforceInterface(DESCRIPTOR);
                    Debug.MemoryInfo[] _result21 = getProcessMemoryInfo(data.createIntArray());
                    reply.writeNoException();
                ...
                case 94:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    _arg02 = android.app.IApplicationThread.Stub.asInterface(data.readStrongBinder());
                    IIntentSender _arg14 = android.content.IIntentSender.Stub.asInterface(data.readStrongBinder());
                    _arg23 = data.readStrongBinder();
                    if (data.readInt() != 0) {
                    ...
                    _result = startActivityIntentSender(_arg02, _arg14, _arg23, intent4, _arg43, _arg53, _arg62, _arg7, _arg8, _arg9, bundle9);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 95:
                    ...
                    return true;
                case 96:
                    ParcelableCrashInfo parcelableCrashInfo2;
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readStrongBinder();
                    _arg1 = data.readString();
                    _arg24 = data.readInt() != 0;
                    if (data.readInt() != 0) {
                        parcelableCrashInfo2 = (ParcelableCrashInfo) ParcelableCrashInfo.CREATOR.createFromParcel(data);
                    } else {
                        parcelableCrashInfo2 = null;
                    }
                    _result2 = handleApplicationWtf(_arg0, _arg1, _arg24, parcelableCrashInfo2);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 97:
                ...
                case 99:
                    ...
                    WaitResult _result22 = startActivityAndWait(_arg02, _arg1, intent, _arg3, _arg4, _arg5, _arg6, _arg7, profilerInfo, bundle, data.readInt());
                    reply.writeNoException();
                    if (_result22 != null) {
                        reply.writeInt(1);
                ...
                case 101:
                    ...
                    _result = startActivityWithConfig(_arg02, _arg1, intent, _arg3, _arg4, _arg5, _arg6, _arg7, configuration3, bundle, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 102:
                    data.enforceInterface(DESCRIPTOR);
                    List<ApplicationInfo> _result23 = getRunningExternalApplications();
                    reply.writeNoException();
                ...
                case 104:
                    ...
                    _arg12 = data.readInt();
                    if (data.readInt() != 0) {
                        violationInfo = (ViolationInfo) ViolationInfo.CREATOR.createFromParcel(data);
                    } else {
                        violationInfo = null;
                    }
                    handleApplicationStrictModeViolation(_arg0, _arg12, violationInfo);
                    reply.writeNoException();
                    return true;
                case 105:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 109:
                    ...
                    _result4 = getProviderMimeType(uri, data.readInt());
                    reply.writeNoException();
                    reply.writeString(_result4);
                    return true;
                case 110:
                ...
                case 111:
                    ...
                    grantUriPermissionFromOwner(_arg0, _arg12, _arg2, uri3, data.readInt(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    return true;
                case 112:
                    Uri uri4;
                    ...
                    revokeUriPermissionFromOwner(_arg0, uri4, data.readInt(), data.readInt());
                    reply.writeNoException();
                    return true;
                case 113:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    _result = checkGrantUriPermission(_arg03, _arg1, uri2, data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 114:
                    ...
                    _result2 = dumpHeap(_arg04, _arg12, _arg24, _arg32, _arg44, _arg5, parcelFileDescriptor);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 115:
                    ...
                    _arg02 = android.app.IApplicationThread.Stub.asInterface(data.readStrongBinder());
                    _arg1 = data.readString();
                    Intent[] _arg26 = (Intent[]) data.createTypedArray(Intent.CREATOR);
                    ...
                    _result = startActivities(_arg02, _arg1, _arg26, _arg34, _arg4, bundle5, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 116:
                ...
                case 131:
                    data.enforceInterface(DESCRIPTOR);
                    long[] _result24 = getProcessPss(data.createIntArray());
                    reply.writeNoException();
                    reply.writeLongArray(_result24);
                    return true;
                case 132:
                    ...
                    showBootMessage(charSequence2, data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 133:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 136:
                    data.enforceInterface(DESCRIPTOR);
                    RunningAppProcessInfo _arg06 = new RunningAppProcessInfo();
                    getMyMemoryState(_arg06);
                    reply.writeNoException();
                    if (_arg06 != null) {
                        reply.writeInt(1);
                ...
                case 138:
                    data.enforceInterface(DESCRIPTOR);
                    UserInfo _result25 = getCurrentUser();
                    reply.writeNoException();
                    if (_result25 != null) {
                        reply.writeInt(1);
                ...
                case 140:
                    ...
                    _result2 = navigateUpTo(_arg0, intent2, _arg22, intent4);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 141:
                    data.enforceInterface(DESCRIPTOR);
                    setLockScreenShown(data.readInt() != 0, data.readInt());
                    reply.writeNoException();
                    return true;
                case 142:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 146:
                    ...
                    _result = startActivityAsUser(_arg02, _arg1, intent, _arg3, _arg4, _arg5, _arg6, _arg7, profilerInfo, bundle, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 147:
                ...
                case 150:
                    data.enforceInterface(DESCRIPTOR);
                    int[] _result26 = getRunningUserIds();
                    reply.writeNoException();
                ...
                case 153:
                    data.enforceInterface(DESCRIPTOR);
                    long _result27 = inputDispatchingTimedOut(data.readInt(), data.readInt() != 0, data.readString());
                    reply.writeNoException();
                ...
                case 157:
                    ...
                    reportAssistContextExtras(_arg0, bundle3, assistStructure, assistContent, uri5);
                    reply.writeNoException();
                    return true;
                case 158:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 163:
                    ...
                    resizeStack(_arg03, rect, data.readInt() != 0, data.readInt() != 0, data.readInt() != 0, data.readInt());
                    reply.writeNoException();
                    return true;
                case 164:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 166:
                    data.enforceInterface(DESCRIPTOR);
                    StackInfo _result29 = getStackInfo(data.readInt());
                    reply.writeNoException();
                    if (_result29 != null) {
                        reply.writeInt(1);
                ...
                case 168:
                    ...
                    _result2 = convertToTranslucent(_arg0, bundle3);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 169:
                ...
                case 170:
                    data.enforceInterface(DESCRIPTOR);
                    reportActivityFullyDrawn(data.readStrongBinder(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 171:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 173:
                    ...
                    takePersistableUriPermission(uri, data.readInt(), data.readInt());
                    reply.writeNoException();
                    return true;
                case 174:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    releasePersistableUriPermission(uri, data.readInt(), data.readInt());
                    reply.writeNoException();
                    return true;
                case 175:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 177:
                    data.enforceInterface(DESCRIPTOR);
                    Rect _result30 = getTaskBounds(data.readInt());
                    reply.writeNoException();
                    if (_result30 != null) {
                        reply.writeInt(1);
                ...
                case 186:
                    ...
                    _arg0 = data.readStrongBinder();
                    if (data.readInt() != 0) {
                        taskDescription = (TaskDescription) TaskDescription.CREATOR.createFromParcel(data);
                    } else {
                        taskDescription = null;
                    }
                    setTaskDescription(_arg0, taskDescription);
                    reply.writeNoException();
                    return true;
                case 187:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    _arg43 = data.readString();
                    IVoiceInteractionSession _arg54 = android.service.voice.IVoiceInteractionSession.Stub.asInterface(data.readStrongBinder());
                    IVoiceInteractor _arg64 = com.android.internal.app.IVoiceInteractor.Stub.asInterface(data.readStrongBinder());
                    _arg7 = data.readInt();
                    if (data.readInt() != 0) {
                        profilerInfo = (ProfilerInfo) ProfilerInfo.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    _result = startVoiceActivity(_arg04, _arg12, _arg22, intent4, _arg43, _arg54, _arg64, _arg7, profilerInfo, bundle, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 188:
                    ...
                    _result = startAssistantActivity(_arg04, _arg12, _arg22, intent4, _arg43, bundle5, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 189:
                ...
                case 190:
                    data.enforceInterface(DESCRIPTOR);
                    List<IBinder> _result31 = getAppTasks(data.readString());
                    reply.writeNoException();
                    reply.writeBinderList(_result31);
                    return true;
                case 191:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 196:
                    ...
                    _result = startActivityFromRecents(_arg03, bundle3);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 197:
                ...
                case 198:
                    ...
                    _result = startActivityAsCaller(_arg02, _arg1, intent, _arg3, _arg4, _arg5, _arg6, _arg7, profilerInfo, bundle, data.readInt() != 0, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 199:
                    ...
                    if (data.readInt() != 0) {
                        taskDescription2 = (TaskDescription) TaskDescription.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    _result = addAppTask(_arg0, intent2, taskDescription2, bitmap);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 200:
                    ...
                    if (data.readInt() != 0) {
                        bitmap2 = (Bitmap) Bitmap.CREATOR.createFromParcel(data);
                    } else {
                        bitmap2 = null;
                    }
                    setExitInfo(bundle6, bitmap2);
                    reply.writeNoException();
                    return true;
                case 201:
                    data.enforceInterface(DESCRIPTOR);
                    Point _result32 = getAppTaskThumbnailSize();
                    reply.writeNoException();
                    if (_result32 != null) {
                        reply.writeInt(1);
                ...
                case 205:
                    data.enforceInterface(DESCRIPTOR);
                    Bitmap _result33 = getTaskDescriptionIcon(data.readString(), data.readInt());
                    reply.writeNoException();
                    if (_result33 != null) {
                        reply.writeInt(1);
                ...
                case 206:
                    ...
                    _result2 = launchAssistIntent(intent3, _arg12, _arg2, _arg35, bundle10);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 207:
                    ...
                    startInPlaceAnimationOnFrontMostApplication(bundle6);
                    reply.writeNoException();
                    return true;
                case 208:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 211:
                    data.enforceInterface(DESCRIPTOR);
                    _result = createStackOnDisplay(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 212:
                ...
                case 214:
                    data.enforceInterface(DESCRIPTOR);
                    _arg03 = data.readInt();
                    IResultReceiver _arg15 = com.android.internal.os.IResultReceiver.Stub.asInterface(data.readStrongBinder());
                    if (data.readInt() != 0) {
                        bundle4 = (Bundle) Bundle.CREATOR.createFromParcel(data);
                    } else {
                        bundle4 = null;
                    }
                    _result2 = requestAssistContextExtras(_arg03, _arg15, bundle4, data.readStrongBinder(), data.readInt() != 0, data.readInt() != 0);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 215:
                    ...
                    resizeTask(_arg03, rect, data.readInt());
                    reply.writeNoException();
                    return true;
                case 216:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 231:
                    ...
                    _result2 = showAssistFromActivity(_arg0, bundle3);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 232:
                ...
                case 234:
                    ...
                    _result2 = stopBinderTrackingAndDump(parcelFileDescriptor2);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 235:
                ...
                case 239:
                    ...
                    _result2 = moveTaskToDockedStack(_arg03, _arg12, _arg24, _arg32, rect2);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 240:
                ...
                case 242:
                    ...
                    _result2 = moveTopActivityToPinnedStack(_arg03, rect);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 243:
                ...
                case 248:
                    ...
                    _arg0 = data.readStrongBinder();
                    if (data.readInt() != 0) {
                        pictureInPictureParams = (PictureInPictureParams) PictureInPictureParams.CREATOR.createFromParcel(data);
                    } else {
                        pictureInPictureParams = null;
                    }
                    _result2 = enterPictureInPictureMode(_arg0, pictureInPictureParams);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 249:
                    ...
                    setPictureInPictureParams(_arg0, pictureInPictureParams);
                    reply.writeNoException();
                    return true;
                case 250:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 253:
                    ...
                    resizeDockedStack(rect3, rect, rect4, rect5, rect2);
                    reply.writeNoException();
                    return true;
                case 254:
                    ...
                    _result = setVrMode(_arg0, _arg16, componentName2);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 255:
                ...
                case 258:
                    ...
                    startLocalVoiceInteraction(_arg0, bundle3);
                    reply.writeNoException();
                    return true;
                case 259:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 267:
                    ...
                    _result2 = isVrModePackageEnabled(componentName);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 268:
                ...
                case 270:
                    ...
                    startConfirmDeviceCredentialIntent(intent3, bundle3);
                    reply.writeNoException();
                    return true;
                case 271:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 272:
                    Bundle bundle11;
                    data.enforceInterface(DESCRIPTOR);
                    IIntentSender _arg07 = android.content.IIntentSender.Stub.asInterface(data.readStrongBinder());
                    _arg13 = data.readStrongBinder();
                    _arg22 = data.readInt();
                    if (data.readInt() != 0) {
                        intent4 = (Intent) Intent.CREATOR.createFromParcel(data);
                    ...
                    _arg43 = data.readString();
                    IIntentReceiver _arg55 = android.content.IIntentReceiver.Stub.asInterface(data.readStrongBinder());
                    _arg62 = data.readString();
                    if (data.readInt() != 0) {
                    ...
                    _result = sendIntentSender(_arg07, _arg13, _arg22, intent4, _arg43, _arg55, _arg62, bundle11);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 273:
                ...
                case 276:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_updateDisplayOverrideConfiguration /*277*/:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        configuration = (Configuration) Configuration.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    _result2 = updateDisplayOverrideConfiguration(configuration, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case TRANSACTION_unregisterTaskStackListener /*278*/:
                    data.enforceInterface(DESCRIPTOR);
                    unregisterTaskStackListener(android.app.ITaskStackListener.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case TRANSACTION_moveStackToDisplay /*279*/:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 280:
                    data.enforceInterface(DESCRIPTOR);
                    IResultReceiver _arg08 = com.android.internal.os.IResultReceiver.Stub.asInterface(data.readStrongBinder());
                    if (data.readInt() != 0) {
                        bundle3 = (Bundle) Bundle.CREATOR.createFromParcel(data);
                    } else {
                        bundle3 = null;
                    }
                    _result2 = requestAutofillData(_arg08, bundle3, data.readStrongBinder(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case TRANSACTION_dismissKeyguard /*281*/:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_restartUserInBackground /*282*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = restartUserInBackground(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_cancelTaskWindowTransition /*283*/:
                    data.enforceInterface(DESCRIPTOR);
                    cancelTaskWindowTransition(data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_cancelTaskThumbnailTransition /*284*/:
                    data.enforceInterface(DESCRIPTOR);
                    cancelTaskThumbnailTransition(data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getTaskSnapshot /*285*/:
                    data.enforceInterface(DESCRIPTOR);
                    TaskSnapshot _result34 = getTaskSnapshot(data.readInt(), data.readInt() != 0);
                    reply.writeNoException();
                    if (_result34 != null) {
                        reply.writeInt(1);
                    ...
                    return true;
                case TRANSACTION_scheduleApplicationInfoChanged /*286*/:
                    data.enforceInterface(DESCRIPTOR);
                    scheduleApplicationInfoChanged(data.createStringArrayList(), data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setPersistentVrThread /*287*/:
                    data.enforceInterface(DESCRIPTOR);
                    setPersistentVrThread(data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_waitForNetworkStateUpdate /*288*/:
                    data.enforceInterface(DESCRIPTOR);
                    waitForNetworkStateUpdate(data.readLong());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setDisablePreviewScreenshots /*289*/:
                    data.enforceInterface(DESCRIPTOR);
                    setDisablePreviewScreenshots(data.readStrongBinder(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getLastResumedActivityUserId /*290*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getLastResumedActivityUserId();
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case TRANSACTION_backgroundWhitelistUid /*291*/:
                    data.enforceInterface(DESCRIPTOR);
                    backgroundWhitelistUid(data.readInt());
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setShowWhenLocked /*292*/:
                    data.enforceInterface(DESCRIPTOR);
                    setShowWhenLocked(data.readStrongBinder(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setTurnScreenOn /*293*/:
                    data.enforceInterface(DESCRIPTOR);
                    setTurnScreenOn(data.readStrongBinder(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_getHwInnerService /*294*/:
                    data.enforceInterface(DESCRIPTOR);
    ...
    void setExitInfo(Bundle bundle, Bitmap bitmap) throws RemoteException;
    ...
    void setLockScreenShown(boolean z, int i) throws RemoteException;
