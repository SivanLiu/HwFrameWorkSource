...
public class Paint {
    ...
    private static native float nGetStrikeThruPosition(long j, long j2);

    private static native float nGetStrikeThruThickness(long j, long j2);
    ...
    private static native float nGetUnderlinePosition(long j, long j2);

    private static native float nGetUnderlineThickness(long j, long j2);
    ...
    public float getUnderlinePosition() {
        return nGetUnderlinePosition(this.mNativePaint, this.mNativeTypeface);
    }

    public float getUnderlineThickness() {
        return nGetUnderlineThickness(this.mNativePaint, this.mNativeTypeface);
    }
    ...
    public float getStrikeThruPosition() {
        return nGetStrikeThruPosition(this.mNativePaint, this.mNativeTypeface);
    }

    public float getStrikeThruThickness() {
        return nGetStrikeThruThickness(this.mNativePaint, this.mNativeTypeface);
    }
