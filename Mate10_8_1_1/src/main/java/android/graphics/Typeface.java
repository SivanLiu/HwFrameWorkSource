...
public class Typeface {
    ...
    public static final class Builder {
        ...
        private Typeface resolveFallbackTypeface() {
            ...
            SparseArray<Typeface> innerCache;
            Typeface typeface;
            if (this.mItalic != -1) {
                if (this.mItalic == 1) {
                }
                ...
                key = i2 | i;
                synchronized (sLock) {
                    innerCache = (SparseArray) sTypefaceCache.get(base.native_instance);
                    if (innerCache != null) {
        ...
        public Typeface build() {
            ...
            if (this.mFd != null) {
                ...
                try {
                    FileInputStream fileInputStream2 = new FileInputStream(this.mFd);
                    try {
    ...
    public static Typeface createFromResources(FamilyResourceEntry entry, AssetManager mgr, String path) {
        ...
        FontFamily fontFamily = new FontFamily();
        for (FontFileResourceEntry fontFile : filesEntry.getEntries()) {
    ...
    private static FontFamily makeFamilyFromParsed(Family family, Map<String, ByteBuffer> bufferForPath) {
        ...
        for (Font font : family.getFonts()) {
            ...
            if (fontBuffer == null) {
                ...
                FileInputStream fileInputStream = null;
                try {
                    FileInputStream fileInputStream2 = new FileInputStream(fullPathName);
                    try {
