...
public class BitmapFactory {
    ...
    public static Bitmap decodeResource(Resources res, int id) {
        Bitmap bm = decodeResource(res, id, null);
        String pkgname = ActivityThread.currentPackageName();
        Application app = ActivityThread.currentApplication();
        if (!"com.nttdocomo.android.doumt".equals(pkgname) || app == null || bm == null || res == null || (res.getCompatibilityInfo().supportsScreen() ^ 1) == 0) {
            return bm;
        }
        String className = getTopActivityName(app);
        if (className == null || !className.contains("com.nttdocomo.android.doumt.usecase.continuousanimation.OpenGLAnimationActivity") || bm.getWidth() != 72 || bm.getHeight() != 72) {
            return bm;
        }
        float density = res.getDisplayMetrics().density;
        return Bitmap.createScaledBitmap(bm, (int) ((((float) bm.getWidth()) * density) / 3.0f), (int) ((((float) bm.getHeight()) * density) / 3.0f), true);
    }
    ...
    private static String getTopActivityName(Context context) {
        ...
        RunningTaskInfo info = (RunningTaskInfo) manager.getRunningTasks(1).get(0);
    ...
    public static Bitmap decodeStream(InputStream is) {
        Bitmap bm = decodeStream(is, null, null);
        String pkgname = ActivityThread.currentPackageName();
        Application app = ActivityThread.currentApplication();
        if (!"com.nttdocomo.android.doumt".equals(pkgname) || bm == null || app == null || app.mLoadedApk == null || (app.mLoadedApk.getResources().getCompatibilityInfo().supportsScreen() ^ 1) == 0) {
            return bm;
        }
        String className = getTopActivityName(app);
        if (className == null || !className.contains("com.nttdocomo.android.doumt.usecase.swipeimage.SwipeImageActivity") || bm.getWidth() != 1063 || bm.getHeight() != AdvertisingSetParameters.INTERVAL_HIGH) {
            return bm;
        }
        float density = app.mLoadedApk.getResources().getDisplayMetrics().density;
        return Bitmap.createScaledBitmap(bm, (int) ((((float) bm.getWidth()) * density) / 3.0f), (int) ((((float) bm.getHeight()) * density) / 3.0f), true);
    }
