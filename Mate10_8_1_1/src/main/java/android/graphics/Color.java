...
public class Color {
    ...
    public static long pack(float red, float green, float blue, float alpha, ColorSpace colorSpace) {
        ...
        if (id == -1) {
            ...
            return (((((((long) Half.toHalf(red)) & 65535) << 48) | ((((long) Half.toHalf(green)) & 65535) << 32)) | ((((long) Half.toHalf(blue)) & 65535) << 16)) | ((((long) ((int) ((Math.max(0.0f, Math.min(alpha, 1.0f)) * 1023.0f) + 0.5f))) & 1023) << 6)) | (((long) id) & 63);
        }
    }
