...
public class KeyboardView extends View implements OnClickListener {
    ...
    public KeyboardView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mDisambiguateSwipe = getResources().getBoolean(17957040);
            ...
            for (Key key : keys) {
                if (!drawSingleKey || invalidKey == key) {
                    ...
                    if (str != null) {
                        ...
                        canvas.drawText(str, (float) ((((key.width - padding.left) - padding.right) / 2) + padding.left), (((float) (((key.height - padding.top) - padding.bottom) / 2)) + ((paint.getTextSize() - paint.descent()) / 2.0f)) + ((float) padding.top), paint);
    ...
    private void sendAccessibilityEventForUnicodeCharacter(int eventType, int code) {
        if (this.mAccessibilityManager.isEnabled()) {
            ...
            switch (code) {
                case -6:
                    text = this.mContext.getString(17040177);
                    break;
                case -5:
                    text = this.mContext.getString(17040179);
                    break;
                case -4:
                    text = this.mContext.getString(17040180);
                    break;
                case -3:
                    text = this.mContext.getString(17040178);
                    break;
                case -2:
                    text = this.mContext.getString(17040182);
                    break;
                case -1:
                    text = this.mContext.getString(17040183);
                    break;
                case 10:
                    text = this.mContext.getString(17040181);
                    break;
                default:
