...
public class InputMethodService extends AbstractInputMethodService {
    ...
    public void updateFullscreenMode() {
        ...
        if (!(this.mIsFullscreen == onEvaluateFullscreenMode && (this.mFullscreenApplied ^ 1) == 0)) {
            changed = true;
        ...
        if (changed) {
            onConfigureWindow(this.mWindow.getWindow(), onEvaluateFullscreenMode, this.mShowInputRequested ^ 1);
    ...
    public CharSequence getTextForImeAction(int imeOptions) {
        switch (imeOptions & 255) {
            case 1:
                return null;
            case 2:
                return getText(17040148);
            case 3:
                return getText(17040151);
            case 4:
                return getText(17040152);
            case 5:
                return getText(17040149);
            case 6:
                return getText(17040147);
            case 7:
                return getText(17040150);
            default:
                return getText(17040146);
        }
    }
    ...
    public boolean isLandScapeMultiWindowMode() {
        ...
        if (config.orientation != 2 || dockSide == -1) {
            return false;
        }
        return true;
    }
