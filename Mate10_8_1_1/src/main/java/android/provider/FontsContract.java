...
public class FontsContract {
    ...
    private static final Comparator<byte[]> sByteArrayComparator = -$Lambda$a7Jyr6j_Mb70hHJ2ssL1AAhKh4c.$INST$0;
    ...
    public static Typeface getFontSync(FontRequest request) {
        ...
        synchronized (sLock) {
            ...
            sHandler.post(new AnonymousClass3(request, id, holder, lock, timeout, waiting, cond));
    ...
    public static void requestFonts(Context context, FontRequest request, Handler handler, CancellationSignal cancellationSignal, FontRequestCallback callback) {
        ...
        if (cachedTypeface != null) {
            callerThreadHandler.post(new android.provider.-$Lambda$a7Jyr6j_Mb70hHJ2ssL1AAhKh4c.AnonymousClass1((byte) 2, callback, cachedTypeface));
        } else {
            handler.post(new AnonymousClass2(context, cancellationSignal, request, callerThreadHandler, callback));
        }
    }

    static /* synthetic */ void lambda$-android_provider_FontsContract_20998(Context context, CancellationSignal cancellationSignal, FontRequest request, Handler callerThreadHandler, FontRequestCallback callback) {
        int i = 0;
        try {
            ...
            if (anotherCachedTypeface != null) {
                callerThreadHandler.post(new android.provider.-$Lambda$a7Jyr6j_Mb70hHJ2ssL1AAhKh4c.AnonymousClass1((byte) 0, callback, anotherCachedTypeface));
            } else if (result.getStatusCode() != 0) {
                switch (result.getStatusCode()) {
                    case 1:
                        callerThreadHandler.post(new -$Lambda$asz6VwQ86PPY-v8JLMb7rx-pSqg((byte) 1, callback));
                        return;
                    case 2:
                        callerThreadHandler.post(new -$Lambda$asz6VwQ86PPY-v8JLMb7rx-pSqg((byte) 2, callback));
                        return;
                    default:
                        callerThreadHandler.post(new -$Lambda$asz6VwQ86PPY-v8JLMb7rx-pSqg((byte) 3, callback));
                        return;
                }
            } else {
                FontInfo[] fonts = result.getFonts();
                if (fonts == null || fonts.length == 0) {
                    callerThreadHandler.post(new -$Lambda$asz6VwQ86PPY-v8JLMb7rx-pSqg((byte) 4, callback));
                    return;
                }
                ...
                while (i < length) {
                    ...
                    if (font.getResultCode() != 0) {
                        ...
                        if (resultCode < 0) {
                            callerThreadHandler.post(new -$Lambda$asz6VwQ86PPY-v8JLMb7rx-pSqg((byte) 5, callback));
                        } else {
                            callerThreadHandler.post(new AnonymousClass4(resultCode, callback));
                        }
                        return;
                    }
                    i++;
                ...
                if (typeface == null) {
                    callerThreadHandler.post(new -$Lambda$asz6VwQ86PPY-v8JLMb7rx-pSqg((byte) 6, callback));
                    return;
                }
                sTypefaceCache.put(request.getIdentifier(), typeface);
                callerThreadHandler.post(new android.provider.-$Lambda$a7Jyr6j_Mb70hHJ2ssL1AAhKh4c.AnonymousClass1((byte) 1, callback, typeface));
            }
        } catch (NameNotFoundException e) {
            callerThreadHandler.post(new -$Lambda$asz6VwQ86PPY-v8JLMb7rx-pSqg((byte) 0, callback));
        }
    }
        ...
        for (FontInfo font : fonts) {
            if (font.getResultCode() == 0) {
                ...
                if (out.containsKey(uri)) {
                    ...
                    try {
                        parcelFileDescriptor = resolver.openFileDescriptor(uri, "r", cancellationSignal);
    ...
    static /* synthetic */ int lambda$-android_provider_FontsContract_31286(byte[] l, byte[] r) {
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                try {
                    ...
                    while (cursor.moveToNext()) {
                        ...
                        String string = vsColumnIndex != -1 ? cursor.getString(vsColumnIndex) : null;
                        ...
                        result2.add(new FontInfo(fileUri, ttcIndex, FontVariationAxis.fromFontVariationSettings(string), weight, italic, resultCode));
                    }
                    result = result2;
                } catch (Throwable th4) {
                    th = th4;
