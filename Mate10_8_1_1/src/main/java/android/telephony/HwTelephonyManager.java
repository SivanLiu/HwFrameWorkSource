...
public class HwTelephonyManager {
    ...
    public boolean setNetworkSelectionModeManual(int subId, OperatorInfo operator, boolean persistSelection) {
        return TelephonyManager.getDefault().setNetworkSelectionModeManual(subId, operator, persistSelection);
    }
    ...
    public boolean is4RMimoEnabled(int subId) {
        return HwTelephonyManagerInner.getDefault().is4RMimoEnabled(subId);
    }
