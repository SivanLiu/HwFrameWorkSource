...
public class SubscriptionInfo implements Parcelable {
    public static final Creator<SubscriptionInfo> CREATOR = new Creator<SubscriptionInfo>() {
        public SubscriptionInfo createFromParcel(Parcel source) {
            ...
            return new SubscriptionInfo(id, iccId, simSlotIndex, displayName, carrierName, nameSource, iconTint, number, dataRoaming, (Bitmap) Bitmap.CREATOR.createFromParcel(source), mcc, mnc, source.readString(), source.readBoolean(), (UiccAccessRule[]) source.createTypedArray(UiccAccessRule.CREATOR), status, nwMode);
        }
    ...
    public SubscriptionInfo(int id, String iccId, int simSlotIndex, CharSequence displayName, CharSequence carrierName, int nameSource, int iconTint, String number, int roaming, Bitmap icon, int mcc, int mnc, String countryIso, boolean isEmbedded, UiccAccessRule[] accessRules, int status, int nwMode) {
        this.mId = id;
        this.mIccId = iccId;
        this.mSimSlotIndex = simSlotIndex;
        this.mDisplayName = displayName;
