...
public interface IIpConnectivityMetrics extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IIpConnectivityMetrics {
        ...
        private static class Proxy implements IIpConnectivityMetrics {
            ...
            public boolean registerNetdEventCallback(INetdEventCallback callback) throws RemoteException {
            ...
            public boolean unregisterNetdEventCallback() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    int _result2 = logEvent(connectivityMetricsEvent);
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    _result = registerNetdEventCallback(android.net.INetdEventCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    if (_result) {
                        i = 1;
                    }
                ...
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    _result = unregisterNetdEventCallback();
                    reply.writeNoException();
                    if (_result) {
                        i = 1;
                    }
    ...
    boolean registerNetdEventCallback(INetdEventCallback iNetdEventCallback) throws RemoteException;

    boolean unregisterNetdEventCallback() throws RemoteException;
}
