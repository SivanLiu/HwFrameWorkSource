...
public final class OsuProvider implements Parcelable {
    public static final Creator<OsuProvider> CREATOR = new Creator<OsuProvider>() {
        public OsuProvider createFromParcel(Parcel in) {
            ...
            return new OsuProvider(osuSsid, friendlyName, serviceDescription, serverUri, nai, methodList, (Icon) in.readParcelable(null));
        }
    ...
    public boolean equals(Object thatObject) {
        ...
        if (this.mOsuSsid != null ? this.mOsuSsid.equals(that.mOsuSsid) : that.mOsuSsid == null) {
            if (TextUtils.equals(this.mFriendlyName, that.mFriendlyName) && TextUtils.equals(this.mServiceDescription, that.mServiceDescription)) {
                ...
                if (TextUtils.equals(this.mNetworkAccessIdentifier, that.mNetworkAccessIdentifier)) {
                    ...
                    if (this.mIcon != null) {
                        z = this.mIcon.sameAs(that.mIcon);
                    } else if (that.mIcon != null) {
                        z = false;
                    }
                    return z;
                }
