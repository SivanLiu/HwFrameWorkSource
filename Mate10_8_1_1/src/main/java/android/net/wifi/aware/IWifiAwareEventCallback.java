        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 3:
                    ...
                    return true;
                case 4:
                    ParcelableRttResults parcelableRttResults;
                    data.enforceInterface(DESCRIPTOR);
                    int _arg0 = data.readInt();
                    if (data.readInt() != 0) {
                        parcelableRttResults = (ParcelableRttResults) ParcelableRttResults.CREATOR.createFromParcel(data);
                    } else {
                        parcelableRttResults = null;
                    }
                    onRangingSuccess(_arg0, parcelableRttResults);
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
