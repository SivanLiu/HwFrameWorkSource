...
public class WifiConfiguration implements Parcelable {
    ...
    public static class NetworkSelectionStatus {
        ...
        public static final int DISABLED_BY_SYSTEM = 12;
    ...
    public boolean isOpenNetwork() {
        ...
        boolean z = cardinality != 0 ? cardinality == 1 ? this.allowedKeyManagement.get(0) : false : true;
