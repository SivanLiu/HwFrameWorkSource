...
public interface IConnectivityManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IConnectivityManager {
        ...
        static final int TRANSACTION_addVpnAddress = 70;
        ...
        static final int TRANSACTION_factoryReset = 73;
        ...
        static final int TRANSACTION_getAllVpnInfo = 46;
        static final int TRANSACTION_getAlwaysOnVpnPackage = 50;
        static final int TRANSACTION_getCaptivePortalServerUrl = 76;
        static final int TRANSACTION_getDefaultNetworkCapabilitiesForUser = 10;
        static final int TRANSACTION_getGlobalProxy = 37;
        static final int TRANSACTION_getLastTetherError = 23;
        static final int TRANSACTION_getLegacyVpnInfo = 45;
        ...
        static final int TRANSACTION_getMultipathPreference = 68;
        ...
        static final int TRANSACTION_getProxyForNetwork = 39;
        static final int TRANSACTION_getRestoreDefaultNetworkDelay = 69;
        static final int TRANSACTION_getTetherableBluetoothRegexs = 33;
        static final int TRANSACTION_getTetherableIfaces = 27;
        static final int TRANSACTION_getTetherableUsbRegexs = 31;
        static final int TRANSACTION_getTetherableWifiRegexs = 32;
        static final int TRANSACTION_getTetheredDhcpRanges = 30;
        static final int TRANSACTION_getTetheredIfaces = 28;
        static final int TRANSACTION_getTetheringErroredIfaces = 29;
        static final int TRANSACTION_getVpnConfig = 43;
        static final int TRANSACTION_isActiveNetworkMetered = 18;
        static final int TRANSACTION_isActiveNetworkMeteredForUid = 19;
        static final int TRANSACTION_isAlwaysOnVpnPackageSupported = 48;
        static final int TRANSACTION_isNetworkSupported = 11;
        static final int TRANSACTION_isTetheringSupported = 24;
        ...
        static final int TRANSACTION_prepareVpn = 40;
        ...
        static final int TRANSACTION_removeVpnAddress = 71;
        static final int TRANSACTION_reportInetCondition = 35;
        static final int TRANSACTION_reportNetworkConnectivity = 36;
        ...
        static final int TRANSACTION_setAlwaysOnVpnPackage = 49;
        ...
        static final int TRANSACTION_setUnderlyingNetworksForVpn = 72;
        static final int TRANSACTION_setUsbTethering = 34;
        static final int TRANSACTION_setVpnPackageAuthorization = 41;
        static final int TRANSACTION_startCaptivePortalApp = 67;
        static final int TRANSACTION_startLegacyVpn = 44;
        static final int TRANSACTION_startNattKeepalive = 74;
        static final int TRANSACTION_startTethering = 25;
        static final int TRANSACTION_stopKeepalive = 75;
        static final int TRANSACTION_stopTethering = 26;
        static final int TRANSACTION_tether = 21;
        static final int TRANSACTION_turnOffVpn = 81;
        static final int TRANSACTION_unregisterNetworkFactory = 57;
        static final int TRANSACTION_untether = 22;
        ...
        private static class Proxy implements IConnectivityManager {
            ...
            public boolean isActiveNetworkMeteredForUid(int uid) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 19:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = isActiveNetworkMeteredForUid(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 20:
                ...
                case 21:
                    data.enforceInterface(DESCRIPTOR);
                    _result5 = tether(data.readString(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result5);
                    return true;
                case 22:
                    data.enforceInterface(DESCRIPTOR);
                    _result5 = untether(data.readString(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result5);
                    return true;
                case 23:
                ...
                case 25:
                    ...
                    startTethering(_arg0, resultReceiver, data.readInt() != 0, data.readString());
                    reply.writeNoException();
                    return true;
                case 26:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 34:
                    data.enforceInterface(DESCRIPTOR);
                    _result5 = setUsbTethering(data.readInt() != 0, data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result5);
                    return true;
                case 35:
                ...
                case 48:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = isAlwaysOnVpnPackageSupported(data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 49:
                ...
                case 68:
                    ...
                    _result5 = getMultipathPreference(network);
                    reply.writeNoException();
                    reply.writeInt(_result5);
                    return true;
                case 69:
    ...
    boolean isActiveNetworkMeteredForUid(int i) throws RemoteException;
