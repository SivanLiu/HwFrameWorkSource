...
public interface INetd extends IInterface {
    ...
    public static abstract class Stub extends Binder implements INetd {
        ...
        static final int TRANSACTION_getNetdPid = 21;
        ...
        static final int TRANSACTION_setIPv6AddrGenMode = 24;
        ...
        static final int TRANSACTION_wakeupAddInterface = 22;
        static final int TRANSACTION_wakeupDelInterface = 23;
        ...
        private static class Proxy implements INetd {
            ...
            public void addPrivateDnsServer(String server, int port, String fingerprintAlgorithm, String[] fingerprints) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            public void removePrivateDnsServer(String server) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    addPrivateDnsServer(data.readString(), data.readInt(), data.readString(), data.createStringArray());
                    reply.writeNoException();
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    removePrivateDnsServer(data.readString());
                    reply.writeNoException();
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 17:
                    data.enforceInterface(DESCRIPTOR);
                    ipSecAddSecurityAssociation(data.readInt(), data.readInt(), data.readInt(), data.readString(), data.readString(), data.readLong(), data.readInt(), data.readString(), data.createByteArray(), data.readInt(), data.readString(), data.createByteArray(), data.readInt(), data.readInt(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    return true;
                case 18:
                    data.enforceInterface(DESCRIPTOR);
    ...
    void addPrivateDnsServer(String str, int i, String str2, String[] strArr) throws RemoteException;
    ...
    void ipSecAddSecurityAssociation(int i, int i2, int i3, String str, String str2, long j, int i4, String str3, byte[] bArr, int i5, String str4, byte[] bArr2, int i6, int i7, int i8, int i9) throws RemoteException;
    ...
    void removePrivateDnsServer(String str) throws RemoteException;
