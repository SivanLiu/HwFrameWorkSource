        ...
        private static class Proxy implements ILowpanManager {
            ...
            public ILowpanInterface getInterface(String name) throws RemoteException {
                ...
                try {
                    ...
                    ILowpanInterface _result = android.net.lowpan.ILowpanInterface.Stub.asInterface(_reply.readStrongBinder());
                    return _result;
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public void addInterface(ILowpanInterface lowpan_interface) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (lowpan_interface != null) {
                        iBinder = lowpan_interface.asBinder();
                    }
                    _data.writeStrongBinder(iBinder);
