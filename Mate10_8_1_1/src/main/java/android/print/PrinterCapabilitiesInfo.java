...
public final class PrinterCapabilitiesInfo implements Parcelable {
    ...
    public static final class Builder {
        ...
        public Builder setColorModes(int colorModes, int defaultColorMode) {
            PrinterCapabilitiesInfo.enforceValidMask(colorModes, -$Lambda$nZCUMFnU8HXNMZ1DQrWBqUtcQbo.$INST$0);
        ...
        public Builder setDuplexModes(int duplexModes, int defaultDuplexMode) {
            PrinterCapabilitiesInfo.enforceValidMask(duplexModes, -$Lambda$nZCUMFnU8HXNMZ1DQrWBqUtcQbo.$INST$1);
...
*/
    ...
    private PrinterCapabilitiesInfo(Parcel parcel) {
        ...
        enforceValidMask(this.mColorModes, -$Lambda$nZCUMFnU8HXNMZ1DQrWBqUtcQbo.$INST$2);
        this.mDuplexModes = parcel.readInt();
        enforceValidMask(this.mDuplexModes, -$Lambda$nZCUMFnU8HXNMZ1DQrWBqUtcQbo.$INST$3);
        readDefaults(parcel);
