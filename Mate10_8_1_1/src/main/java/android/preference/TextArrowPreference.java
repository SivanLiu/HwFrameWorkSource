...
public class TextArrowPreference extends Preference {
    ...
    protected void onBindView(View view) {
        ...
        if (title_frame != null) {
            ...
            if (TextUtils.isEmpty(getTitle()) && TextUtils.isEmpty(getSummary())) {
                isEmpty = TextUtils.isEmpty(getNetherSummary());
            } else {
                isEmpty = false;
            }
            if (isEmpty) {
    ...
    public void setDetail(CharSequence detail) {
        if (detail != null || this.mDetail == null) {
            if (detail == null || (detail.equals(this.mDetail) ^ 1) == 0) {
                return;
            }
        }
        this.mDetail = detail;
    ...
    public void setNetherSummary(CharSequence netherSummary) {
        if (netherSummary != null || this.mNetherSummary == null) {
            if (netherSummary == null || (netherSummary.equals(this.mNetherSummary) ^ 1) == 0) {
                return;
            }
        }
