...
public class StaticLayout extends Layout {
    ...
    public static final class Builder {
        ...
        private long[] getHyphenators(LocaleList locales) {
            ...
            for (int i = 0; i < length; i++) {
                result[i] = Hyphenator.get(locales.get(i)).getNativePtr();
            }
            return result;
        }
        ...
        private void setLocales(LocaleList locales) {
            if (!locales.equals(this.mLocales)) {
                StaticLayout.nSetLocales(this.mNativePtr, locales.toLanguageTags(), getHyphenators(locales));
    ...
    private static native void nSetLocales(long j, String str, long[] jArr);
        ...
        while (paraStart <= bufEnd) {
            ...
            if (spanned != null) {
                ...
                if (lineHeightSpanArr.length == 0) {
                    ...
                    for (i = 0; i < lineHeightSpanArr.length; i++) {
            ...
            nSetupParagraph(b.mNativePtr, chs, paraEnd - paraStart, (float) firstWidth, firstWidthLineCount, (float) restWidth, iArr, 20, b.mBreakStrategy, b.mHyphenationFrequency, b.mJustificationMode != 0);
