...
public class ChangeTransform extends Transition {
    ...
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
        ...
        boolean parentsMatch = this.mReparent ? parentsMatch((ViewGroup) startValues.values.get(PROPNAME_PARENT), (ViewGroup) endValues.values.get(PROPNAME_PARENT)) ^ 1 : false;
        ...
        ObjectAnimator transformAnimator = createTransformAnimator(startValues, endValues, parentsMatch);
        if (parentsMatch && transformAnimator != null && this.mUseOverlay) {
