...
*/
    ...
    public final void handleConnectionEvent(String event, Bundle extras) {
        Log.d((Object) this, "handleConnectionEvent: event=" + event, new Object[0]);
        for (Listener l : this.mListeners) {
    ...
    public final boolean addConnection(Connection connection) {
        ...
        if (connection == null || (this.mChildConnections.contains(connection) ^ 1) == 0 || !connection.setConference(this)) {
            return false;
        }
    ...
    public final void setConnectionElapsedTime(long connectionElapsedTime) {
        this.mConnectElapsedTimeMillis = connectionElapsedTime;
    }
