        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 42:
                    ...
                    _result4 = getPackagesAndVisibilityForAccount(account);
                    reply.writeNoException();
                ...
                case 43:
                    ...
                    _result3 = addAccountExplicitlyWithVisibility(account, _arg1, bundle, data.readHashMap(getClass().getClassLoader()));
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 44:
                    ...
                    _result3 = setAccountVisibility(account, data.readString(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 45:
                    ...
                    int _result6 = getAccountVisibility(account, data.readString());
                    reply.writeNoException();
                ...
                case 49:
                    ...
                    _result3 = hasAccountAccess(account, _arg1, userHandle);
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 50:
                    ...
                    IntentSender _result7 = createRequestAccountAccessIntentSenderAsUser(account, _arg1, userHandle);
                    reply.writeNoException();
                    if (_result7 != null) {
                        reply.writeInt(1);
