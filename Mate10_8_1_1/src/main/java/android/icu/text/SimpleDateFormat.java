...
*/
    ...
    @java.lang.Deprecated
    private int subParse(java.lang.String r1, int r2, char r3, int r4, boolean r5, boolean r6, boolean[] r7, android.icu.util.Calendar r8, android.icu.text.MessageFormat r9, android.icu.util.Output<android.icu.text.TimeZoneFormat.TimeType> r10, android.icu.util.Output<android.icu.impl.DayPeriodRules.DayPeriod> r11) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.icu.text.SimpleDateFormat.subParse(java.lang.String, int, char, int, boolean, boolean, boolean[], android.icu.util.Calendar, android.icu.text.MessageFormat, android.icu.util.Output, android.icu.util.Output):int
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:116)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:249)
	at jadx.core.ProcessClass.process(ProcessClass.java:31)
	at jadx.core.ProcessClass.processDependencies(ProcessClass.java:56)
                ...
                if (pch != ich) {
                    if (ich != '.' || pos != originalPos || itemIndex <= 0 || !getBooleanAttribute(BooleanAttribute.PARSE_ALLOW_WHITESPACE)) {
                        if ((pch != ' ' && pch != '.') || !getBooleanAttribute(BooleanAttribute.PARSE_ALLOW_WHITESPACE)) {
                            if (pos == originalPos || !getBooleanAttribute(BooleanAttribute.PARSE_PARTIAL_LITERAL_MATCH)) {
                                break;
                            }
                            idx++;
                        } else {
