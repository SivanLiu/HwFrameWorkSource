...
*/
    ...
    private byte firstL_R_AL() {
        ...
        while (i < this.prologue.length()) {
            ...
            if (result == (byte) 10) {
                if (!(dirProp == (byte) 0 || dirProp == (byte) 1)) {
                    if (dirProp == (byte) 13) {
                    }
                }
                result = dirProp;
    ...
    private void getDirProps() {
        ...
        while (i < this.originalLength) {
            ...
            } else if (dirProp == (byte) 7 && !(i < this.originalLength && uchar == 13 && this.text[i] == '\n')) {
                this.paras_limit[this.paraCount - 1] = i;
                if (isDefaultLevelInverse && r12 == (byte) 1) {
                    this.paras_level[this.paraCount - 1] = (byte) 1;
                }
                if ((this.reorderingOptions & 4) != 0) {
                    this.length = i;
            ...
            while (idx >= pLastIsoRun.start) {
                if (bd.openings[idx].match != c) {
                    ...
                    if (newProp == (byte) 10) {
                        ...
                        if (bidiPairedBracket != c && UCharacter.getIntPropertyValue(c, UProperty.BIDI_PAIRED_BRACKET_TYPE) == 1) {
