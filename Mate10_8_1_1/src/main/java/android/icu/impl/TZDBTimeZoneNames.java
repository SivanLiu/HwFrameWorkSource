                ...
                if (TZDB_NAMES_TRIE == null) {
                    ...
                    for (String mzID : TimeZoneNamesImpl._getAvailableMetaZoneIDs()) {
                        ...
                        if (std != null || dst != null) {
                            ...
                            if (std != null) {
                                trie.put(std, new TZDBNameInfo(mzID2, NameType.SHORT_STANDARD, equals, parseRegions));
                            }
                            if (dst != null) {
                                trie.put(dst, new TZDBNameInfo(mzID2, NameType.SHORT_DAYLIGHT, equals, parseRegions));
                            }
                        }
                    }
