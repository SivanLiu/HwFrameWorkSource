...
public class LocaleDisplayNamesImpl extends LocaleDisplayNames {
    ...
    private String localeDisplayNameInternal(ULocale locale) {
        ...
        if (str == null) {
            ...
            str = result.replace(this.formatOpenParen, this.formatReplaceOpenParen).replace(this.formatCloseParen, this.formatReplaceCloseParen);
        }
        ...
        if (resultRemainder != null) {
            str = SimpleFormatterImpl.formatCompiledPattern(this.format, str, resultRemainder);
        }
