                ...
                try {
                    ...
                    if (command.equals("android.support.v4.media.session.command.GET_EXTRA_BINDER")) {
                        ...
                        if (impl != null && impl.mQueue != null) {
                            ...
                            QueueItem queueItem = (index < 0 || index >= impl.mQueue.size()) ? null : (QueueItem) impl.mQueue.get(index);
                            if (queueItem != null) {
                    ...
                    switch (msg.what) {
                        ...
                        case 28:
                            if (MediaSessionImplBase.this.mQueue != null) {
                                QueueItem queueItem = (msg.arg1 < 0 || msg.arg1 >= MediaSessionImplBase.this.mQueue.size()) ? null : (QueueItem) MediaSessionImplBase.this.mQueue.get(msg.arg1);
                                if (queueItem != null) {
                                    cb.onRemoveQueueItem(queueItem.getDescription());
                                    break;
                                }
                            }
                            break;
