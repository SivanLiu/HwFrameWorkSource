        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    if (data.readInt() != 0) {
                        associationRequest = (AssociationRequest) AssociationRequest.CREATOR.createFromParcel(data);
                    } else {
                        associationRequest = null;
                    }
                    associate(associationRequest, android.companion.IFindDeviceCallback.Stub.asInterface(data.readStrongBinder()), data.readString());
                ...
                case 2:
                    ...
                    stopScan(associationRequest, android.companion.IFindDeviceCallback.Stub.asInterface(data.readStrongBinder()), data.readString());
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 5:
                    ...
                    boolean _result2 = hasNotificationAccess(componentName);
                    reply.writeNoException();
                ...
                case 6:
                    ...
                    PendingIntent _result3 = requestNotificationAccess(componentName);
                    reply.writeNoException();
                    if (_result3 != null) {
                        reply.writeInt(1);
