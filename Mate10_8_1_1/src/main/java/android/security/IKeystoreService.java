    ...
    public static abstract class Stub extends Binder implements IKeystoreService {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 17:
                    data.enforceInterface(DESCRIPTOR);
                    String _result5 = grant(data.readString(), data.readInt());
                    reply.writeNoException();
                ...
                case 19:
                    data.enforceInterface(DESCRIPTOR);
                    long _result6 = getmtime(data.readString(), data.readInt());
                    reply.writeNoException();
                ...
                case 27:
                    ...
                    ExportResult _result7 = exportKey(_arg0, _arg1, keymasterBlob, keymasterBlob3, data.readInt());
                    reply.writeNoException();
                    if (_result7 != null) {
                        reply.writeInt(1);
                ...
                case 32:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result8 = isOperationAuthorized(data.readStrongBinder());
                    reply.writeNoException();
                ...
                case 37:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        keymasterArguments3 = (KeymasterArguments) KeymasterArguments.CREATOR.createFromParcel(data);
                    } else {
                        keymasterArguments3 = null;
                    }
                    KeymasterCertificateChain _arg13 = new KeymasterCertificateChain();
                    _result = attestDeviceIds(keymasterArguments3, _arg13);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    if (_arg13 != null) {
                        reply.writeInt(1);
