...
public class SoterUtil {
    ...
    public static SoterRSAKeyGenParameterSpec convertKeyNameToParameterSpec(String name) {
        ...
        return new SoterRSAKeyGenParameterSpec(true, isAutoSignedWithCommonkWhenGetPublicKey, mAutoSignedKeyNameWhenGetPublicKey, isSecmsgFidCounterSignedWhenSign, isAutoAddCounterWhenGetPublicKey, isNeedNextAttk);
    }
