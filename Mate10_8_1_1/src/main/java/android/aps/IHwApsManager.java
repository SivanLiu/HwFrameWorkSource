...
public interface IHwApsManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IHwApsManager {
        ...
        static final int TRANSACTION_getDynamicFps = 34;
        static final int TRANSACTION_getDynamicResolutionRatio = 32;
        static final int TRANSACTION_getFbSkip = 27;
        static final int TRANSACTION_getFps = 10;
        static final int TRANSACTION_getHighpToLowp = 28;
        static final int TRANSACTION_getMipMap = 30;
        ...
        static final int TRANSACTION_getShadowMap = 29;
        ...
        static final int TRANSACTION_setDynamicFps = 33;
        static final int TRANSACTION_setDynamicResolutionRatio = 31;
        static final int TRANSACTION_setFbSkip = 23;
        static final int TRANSACTION_setFps = 4;
        static final int TRANSACTION_setHighpToLowp = 24;
        static final int TRANSACTION_setLowResolutionMode = 2;
        static final int TRANSACTION_setMipMap = 26;
        static final int TRANSACTION_setPackageApsInfo = 7;
        static final int TRANSACTION_setResolution = 1;
        static final int TRANSACTION_setShadowMap = 25;
        ...
        private static class Proxy implements IHwApsManager {
            ...
            public ApsAppInfo getPackageApsInfo(String pkgName) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        apsAppInfo = (ApsAppInfo) ApsAppInfo.CREATOR.createFromParcel(_reply);
                    } else {
                        apsAppInfo = null;
                    }
                    _reply.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 7:
                    ...
                    if (data.readInt() != 0) {
                        apsAppInfo = (ApsAppInfo) ApsAppInfo.CREATOR.createFromParcel(data);
                    } else {
                        apsAppInfo = null;
                    }
                    _result = setPackageApsInfo(_arg0, apsAppInfo);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 8:
                ...
                case 20:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = registerCallback(data.readString(), android.aps.IApsManagerServiceCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 21:
                ...
                case 23:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setFbSkip(data.readString(), data.readInt() != 0);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 24:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setHighpToLowp(data.readString(), data.readInt() != 0);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 25:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setShadowMap(data.readString(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 26:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setMipMap(data.readString(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 27:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getFbSkip(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 28:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getHighpToLowp(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 29:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getShadowMap(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 30:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getMipMap(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 31:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setDynamicResolutionRatio(data.readString(), data.readFloat());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 32:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getDynamicResolutionRatio(data.readString());
                    reply.writeNoException();
                    reply.writeFloat(_result2);
                    return true;
                case 33:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setDynamicFps(data.readString(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 34:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getDynamicFps(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
