...
public class MediaScanner implements AutoCloseable {
    ...
    public class MyMediaScannerClient implements MediaScannerClient {
        ...
        public void scanFile(String path, long lastModified, long fileSize, boolean isDirectory, boolean noMedia) {
            ...
            mediaScanner.mScanDirectoryFilesNum = mediaScanner.mScanDirectoryFilesNum + 1;
...
*/
    ...
    public void updateExifFile() throws android.os.RemoteException {
        /* JADX: method processing error */
/*
Error: java.util.NoSuchElementException
	at java.util.HashMap$HashIterator.nextNode(HashMap.java:1439)
...
*/
        /*
        r22 = this;
        r5 = "_id>? and cam_exif_flag is null";
        r2 = 1;
        ...
        r4 = "limit";
        r7 = "1000";
        r2 = r2.appendQueryParameter(r4, r7);
        r3 = r2.build();
        r10 = 0;
    L_0x0028:
        r2 = 100;
    ...
    L_0x002c:
        r10 = r10 + 1;
        r2 = new java.lang.StringBuilder;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r2.<init>();	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r4 = "";	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r2 = r2.append(r4);	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r0 = r16;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r2 = r2.append(r0);	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r2 = r2.toString();	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r4 = 0;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r6[r4] = r2;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        if (r9 == 0) goto L_0x004d;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
    L_0x0049:
        r9.close();	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r9 = 0;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
    L_0x004d:
        r0 = r22;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r2 = r0.mMediaProvider;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r4 = FILES_PRESCAN_PROJECTION_MEDIA;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r7 = "_id";	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r8 = 0;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r9 = r2.query(r3, r4, r5, r6, r7, r8);	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        if (r9 != 0) goto L_0x0070;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
    L_0x005d:
        r2 = 100;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        if (r10 != r2) goto L_0x006a;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
    L_0x0061:
        r2 = "MediaScanner";	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r4 = "SQL query exceed the limit 10 !";	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        android.util.Log.d(r2, r4);	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
    L_0x006a:
    ...
    L_0x006f:
        return;
    L_0x0070:
        r15 = r9.getCount();	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        if (r15 == 0) goto L_0x005d;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
    L_0x0076:
        r2 = r9.moveToNext();	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        if (r2 == 0) goto L_0x0028;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
    L_0x007c:
        r2 = 0;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r18 = r9.getLong(r2);	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r16 = r18;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r21 = new android.content.ContentValues;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r21.<init>();	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r2 = "cam_exif_flag";	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r4 = "1";	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r0 = r21;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r0.put(r2, r4);	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r0 = r22;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r2 = r0.mImagesUri;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r0 = r18;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r20 = android.content.ContentUris.withAppendedId(r2, r0);	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r13 = 0;
        r14 = new android.media.ExifInterface;	 Catch:{ IOException -> 0x00d0 }
        r2 = 1;	 Catch:{ IOException -> 0x00d0 }
        r2 = r9.getString(r2);	 Catch:{ IOException -> 0x00d0 }
        r14.<init>(r2);	 Catch:{ IOException -> 0x00d0 }
        r13 = r14;
    L_0x00a9:
        r2 = android.common.HwFrameworkFactory.getHwMediaScannerManager();	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r0 = r21;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r2.scanHwMakerNote(r0, r13);	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r0 = r22;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r2 = r0.mMediaProvider;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r4 = 0;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r7 = 0;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r0 = r20;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r1 = r21;	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r2.update(r0, r1, r4, r7);	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        goto L_0x0076;
    L_0x00c0:
        r11 = move-exception;
        r2 = "MediaScanner";	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r4 = "updateExifFile SQLException ! ";	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        android.util.Log.e(r2, r4);	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        if (r9 == 0) goto L_0x006f;
    L_0x00cc:
        r9.close();
        goto L_0x006f;
    L_0x00d0:
        r12 = move-exception;
        r2 = "MediaScanner";	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        r4 = "new ExifInterface Exception !";	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        android.util.Log.e(r2, r4);	 Catch:{ SQLException -> 0x00c0, all -> 0x00db }
        goto L_0x00a9;
    L_0x00db:
        r2 = move-exception;
    ...
    L_0x00e1:
        throw r2;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.media.MediaScanner.updateExifFile():void");
    }
            ...
            while (true) {
                ...
                while (c.moveToNext()) {
                    ...
                    if (path != null && path.startsWith("/")) {
                        ...
                        if (!isOnlyMedia && count < MAX_ENTRY_SIZE) {
                            String key = path;
    ...
    public void scanDirectories(String[] directories) {
        ...
        try {
            ...
            Log.d(TAG, "scanDirectories total files number is " + this.mScanDirectoryFilesNum);
