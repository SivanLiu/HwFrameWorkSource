...
class WebVttParser {
    ...
    private final Phase mParseCueTime = new Phase() {
        ...
        public void parse(String line) {
            ...
            String rest = line.substring(arrowAt + 3).replaceFirst("^\\s+", "").replaceFirst("\\s+", WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER);
            ...
            if (WebVttParser.this.mCue.mLinePosition == null && WebVttParser.this.mCue.mSize == 100) {
                if (WebVttParser.this.mCue.mWritingDirection != 100) {
                }
                WebVttParser.this.mPhase = WebVttParser.this.mParseCueText;
            }
