...
class Cea608CCWidget extends ClosedCaptionWidget implements DisplayListener {
    ...
    private static class CCLineBox extends TextView {
        ...
        CCLineBox(Context context) {
            ...
            this.mOutlineWidth = (float) res.getDimensionPixelSize(17105268);
            this.mShadowRadius = (float) res.getDimensionPixelSize(17105270);
            this.mShadowOffset = (float) res.getDimensionPixelSize(17105269);
        }
