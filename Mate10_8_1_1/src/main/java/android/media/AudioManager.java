...
*/
    ...
    public AudioManager(Context context) {
        ...
        this.mPreviousPorts = new ArrayList();
        setContext(context);
        this.mUseVolumeKeySounds = getContext().getResources().getBoolean(17957055);
        this.mUseFixedVolume = getContext().getResources().getBoolean(17957052);
    }
    ...
    public boolean isFMActive() {
        if (1 == AudioSystem.getDeviceConnectionState(1048576, "")) {
            return true;
        }
        return false;
    }
    ...
    public String getProperty(String key) {
        ...
        if (PROPERTY_OUTPUT_SAMPLE_RATE.equals(key)) {
            ...
            if (PROPERTY_SUPPORT_SPEAKER_NEAR_ULTRASOUND.equals(key)) {
                return String.valueOf(getContext().getResources().getBoolean(17957033));
            }
