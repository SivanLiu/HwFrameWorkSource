...
public class MediaRouter {
    ...
    static class Static implements DisplayListener {
        ...
        Static(Context appContext) {
            ...
            this.mSystemCategory = new RouteCategory(17039881, 3, false);
        ...
        void startMonitoringRoutes(Context appContext) {
            ...
            this.mDefaultAudioVideo.mNameResId = 17039882;
        ...
        void updateAudioRoutes(AudioRoutesInfo newRoutes) {
            ...
            if (!TextUtils.equals(newRoutes.bluetoothName, this.mCurAudioRoutesInfo.bluetoothName)) {
                ...
                if (this.mCurAudioRoutesInfo.bluetoothName != null) {
                    if (this.mBluetoothA2dpRoute == null) {
                        ...
                        info.mDescription = this.mResources.getText(17039688);
            ...
            if (audioRoutesChanged) {
                ...
                if (!(this.mSelectedRoute == null || this.mSelectedRoute == this.mDefaultAudioVideo)) {
                    if (this.mSelectedRoute != this.mBluetoothA2dpRoute) {
                        return;
                    }
                }
    ...
    static void selectRouteStatic(int types, RouteInfo route, boolean explicit) {
        ...
        if (-assertionsDisabled || route != null) {
            ...
            boolean wasDefaultOrBluetoothRoute = oldRoute != sStatic.mDefaultAudioVideo ? oldRoute == sStatic.mBluetoothA2dpRoute : true;
                ...
                if (sStatic.isPlaybackActive() && btRoute != null && (types & 1) != 0 && (route == btRoute || route == sStatic.mDefaultAudioVideo)) {
                    try {
                        ...
                        if (route != btRoute) {
                            ...
                            Log.w(TAG, "Default route is selected while a BT route is available: pkgName=" + sStatic.mPackageName + ", callers=" + sb.toString());
                        }
                    } catch (RemoteException e) {
    ...
    static RouteInfo makeWifiDisplayRoute(WifiDisplay display, WifiDisplayStatus wfdStatus) {
        ...
        newRoute.mDescription = sStatic.mResources.getText(17041291);
