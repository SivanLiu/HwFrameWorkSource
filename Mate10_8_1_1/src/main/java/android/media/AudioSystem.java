...
public class AudioSystem {
    ...
    public static final int FORCE_DESKTOP_HDMI = 15;
    public static final int FORCE_DESKTOP_NO_HDMI = 16;
    ...
    public static final int FOR_DESKTOP_MODE = 7;
...
*/
    ...
    public static int getPlatformType(Context context) {
        if (context.getResources().getBoolean(17957060)) {
            return 1;
        }
    ...
    public static boolean isSingleVolume(Context context) {
        return getPlatformType(context) != 2 ? context.getResources().getBoolean(17957017) : true;
    }
}
