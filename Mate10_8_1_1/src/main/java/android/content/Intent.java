...
public class Intent implements Parcelable, Cloneable {
    ...
    public void removeFlags(int r1) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.content.Intent.removeFlags(int):void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.content.Intent.removeFlags(int):void");
    }
    ...
    private Intent(Intent o, int copyMode) {
        ...
        if (copyMode != 1) {
            ...
            } else if (o.mExtras != null && (o.mExtras.maybeIsEmpty() ^ 1) != 0) {
                                ...
                                if (end + 1 < data.length()) {
                                    ...
                                    if (indexOf >= 0) {
                                        ...
                                        if (indexOf < data.length()) {
                                            ...
                                            if (newEnd >= 0) {
                                                str = data.substring(indexOf + 1, newEnd);
                                                end = newEnd;
                                            }
                                        }
                                    } else {
    ...
    public void prepareToLeaveProcess(Context context) {
        boolean equals;
        if (this.mComponent != null) {
            equals = Objects.equals(this.mComponent.getPackageName(), context.getPackageName()) ^ 1;
        } else {
            equals = true;
        }
        prepareToLeaveProcess(equals);
    }
    ...
    public void prepareToLeaveProcess(boolean leavingPackage) {
        ...
        if (this.mAction != null && this.mData != null && StrictMode.vmContentUriWithoutPermissionEnabled() && leavingPackage) {
            str = this.mAction;
            if (!str.equals(ACTION_PROVIDER_CHANGED) && !str.equals("android.provider.action.QUICK_CONTACT")) {
