...
public interface IPackageManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPackageManager {
        ...
        static final int TRANSACTION_getHwInnerService = 184;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    ...
                    _result2 = getPackageInfoVersioned(versionedPackage, data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (_result2 != null) {
                        reply.writeInt(1);
                        _result2.writeToParcel(reply, 1);
                ...
                case 14:
                    ...
                    _result6 = getActivityInfo(componentName, data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (_result6 != null) {
                        reply.writeInt(1);
                ...
                case 16:
                    ...
                    _result6 = getReceiverInfo(componentName, data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (_result6 != null) {
                        reply.writeInt(1);
                        _result6.writeToParcel(reply, 1);
                ...
                case 17:
                    ...
                    ServiceInfo _result18 = getServiceInfo(componentName, data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (_result18 != null) {
                        reply.writeInt(1);
                ...
                case 18:
                    ...
                    _result7 = getProviderInfo(componentName, data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (_result7 != null) {
                        reply.writeInt(1);
                ...
                case 42:
                    ...
                    _result10 = resolveIntent(intent, data.readString(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (_result10 != null) {
                        reply.writeInt(1);
                ...
                case 43:
                    ...
                    _result10 = findPersistentPreferredActivity(intent, data.readInt());
                    reply.writeNoException();
                    if (_result10 != null) {
                        reply.writeInt(1);
                        _result10.writeToParcel(reply, 1);
                ...
                case 45:
                    ...
                    _result5 = queryIntentActivities(intent, data.readString(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (_result5 != null) {
                        reply.writeInt(1);
                        _result5.writeToParcel(reply, 1);
                ...
                case 46:
                    ...
                    _result5 = queryIntentActivityOptions(componentName, _arg12, _arg23, intent3, data.readString(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (_result5 != null) {
                        reply.writeInt(1);
                        _result5.writeToParcel(reply, 1);
                ...
                case 47:
                    ...
                    _result5 = queryIntentReceivers(intent, data.readString(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (_result5 != null) {
                        reply.writeInt(1);
                        _result5.writeToParcel(reply, 1);
                ...
                case 48:
                    ...
                    _result10 = resolveService(intent, data.readString(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (_result10 != null) {
                        reply.writeInt(1);
                        _result10.writeToParcel(reply, 1);
                ...
                case 49:
                    ...
                    _result5 = queryIntentServices(intent, data.readString(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (_result5 != null) {
                        reply.writeInt(1);
                        _result5.writeToParcel(reply, 1);
                ...
                case 50:
                    ...
                    _result5 = queryIntentContentProviders(intent, data.readString(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (_result5 != null) {
                        reply.writeInt(1);
                        _result5.writeToParcel(reply, 1);
                ...
                case 58:
                    ...
                    InstrumentationInfo _result19 = getInstrumentationInfo(componentName, data.readInt());
                    reply.writeNoException();
                    if (_result19 != null) {
                        reply.writeInt(1);
                ...
                case 65:
                    ...
                    deletePackageVersioned(versionedPackage, android.content.pm.IPackageDeleteObserver2.Stub.asInterface(data.readStrongBinder()), data.readInt(), data.readInt());
                    reply.writeNoException();
                    return true;
                case 66:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 68:
                    ...
                    _result10 = getLastChosenActivity(intent, data.readString(), data.readInt());
                    reply.writeNoException();
                    if (_result10 != null) {
                        reply.writeInt(1);
                        _result10.writeToParcel(reply, 1);
                ...
                case 69:
                    ...
                    setLastChosenActivity(intent, _arg14, _arg2, intentFilter2, _arg4, componentName3);
                    reply.writeNoException();
                    return true;
                case 70:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    addPreferredActivity(intentFilter, _arg1, _arg22, componentName2, data.readInt());
                    reply.writeNoException();
                    return true;
                case 71:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    replacePreferredActivity(intentFilter, _arg1, _arg22, componentName2, data.readInt());
                    reply.writeNoException();
                    return true;
                case 72:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 73:
                    ...
                    _result3 = getPreferredActivities(_arg03, _arg15, data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result3);
                ...
                case 88:
                    ...
                    _result12 = getHomeActivities(_arg04);
                    reply.writeNoException();
                    if (_result12 != null) {
                        reply.writeInt(1);
                ...
                case 91:
                    ...
                    _result3 = getComponentEnabledSetting(componentName, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result3);
                    return true;
                case 92:
                ...
                case 98:
                    ...
                    freeStorage(_arg0, _arg16, _arg2, intentSender);
                    reply.writeNoException();
                    return true;
                case 99:
                    data.enforceInterface(DESCRIPTOR);
