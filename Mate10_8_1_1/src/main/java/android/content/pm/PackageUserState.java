...
public class PackageUserState {
    ...
    public boolean isMatch(ComponentInfo componentInfo, int flags) {
        ...
        boolean z;
        if ((262144 & flags) != 0) {
            i = componentInfo.directBootAware ^ 1;
        } else {
            i = 0;
        }
        if ((524288 & flags) != 0) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.ceDataInode != oldState.ceDataInode || this.installed != oldState.installed || this.stopped != oldState.stopped || this.notLaunched != oldState.notLaunched || this.hidden != oldState.hidden || this.suspended != oldState.suspended || this.instantApp != oldState.instantApp || this.virtualPreload != oldState.virtualPreload || this.enabled != oldState.enabled) {
            return false;
        }
