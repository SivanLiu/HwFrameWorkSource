...
public class SyncActivityTooManyDeletes extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CharSequence[] options = new CharSequence[]{getResources().getText(17041110), getResources().getText(17041113), getResources().getText(17041109)};
        TextView textView = new TextView(this);
        CharSequence tooManyDeletesDescFormat = getResources().getText(17041112);
