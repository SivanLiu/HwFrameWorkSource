...
*/
    ...
    public static final class VmPolicy {
        ...
        public static final class Builder {
            ...
            android.os.StrictMode.VmPolicy.Builder disable(int r1) {
                /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.os.StrictMode.VmPolicy.Builder.disable(int):android.os.StrictMode$VmPolicy$Builder
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:116)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:249)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
...
*/
                ...
                // Can't load method instructions.
                */
                throw new UnsupportedOperationException("Method not decompiled: android.os.StrictMode.VmPolicy.Builder.disable(int):android.os.StrictMode$VmPolicy$Builder");
            }
    ...
    public static boolean conditionallyEnableDebugLogging() {
        int amTheSystemServerProcess;
        if (SystemProperties.getBoolean(VISUAL_PROPERTY, false)) {
            amTheSystemServerProcess = amTheSystemServerProcess() ^ 1;
        } else {
            amTheSystemServerProcess = 0;
        }
        boolean suppress = SystemProperties.getBoolean(DISABLE_PROPERTY, false);
        if (amTheSystemServerProcess == 0 && (Build.IS_USER || suppress)) {
    ...
    public static void onVmPolicyViolation(String message, Throwable originStack, boolean forceDeath) {
        ...
        int i = (sVmPolicyMask & 262144) == 0 ? forceDeath : 1;
