...
public final class PowerManager {
    ...
    public final class WakeLock {
        ...
        /* synthetic */ void lambda$-android_os_PowerManager$WakeLock_64233(Runnable r) {
            try {
                r.run();
            } finally {
                release();
    ...
    public int getDisplayPanelType() {
        int type = -1;
        try {
            type = this.mService.getDisplayPanelType();
        } catch (RemoteException e) {
            e.rethrowFromSystemServer();
        }
        return type;
    ...
    public boolean isSustainedPerformanceModeSupported() {
        return this.mContext.getResources().getBoolean(17957039);
    }
    ...
    public int getAodState(String file) {
        int ret = -1;
        try {
            ret = this.mService.getAodState(file);
        } catch (RemoteException e) {
