...
public interface IHwSysResManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IHwSysResManager {
        ...
        static final int TRANSACTION_custConfigUpdate = 40;
        ...
        static final int TRANSACTION_getHabitTopN = 42;
        ...
        static final int TRANSACTION_getNetLocationStrategy = 41;
        ...
        static final int TRANSACTION_getTypeTopN = 43;
        ...
        static final int TRANSACTION_isVisibleWindow = 38;
        ...
        static final int TRANSACTION_reportSysWakeUp = 39;
        ...
        private static class Proxy implements IHwSysResManager {
            ...
            public boolean isVisibleWindow(int userid, String pkg, int type) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeString(pkg);
                    _data.writeInt(type);
                    this.mRemote.transact(Stub.TRANSACTION_isVisibleWindow, _data, _reply, 0);
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    _reply.recycle();
                    _data.recycle();
            ...
            public void reportSysWakeUp(String reason) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(reason);
                    this.mRemote.transact(Stub.TRANSACTION_reportSysWakeUp, _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public NetLocationStrategy getNetLocationStrategy(String pkgName, int uid, int type) throws RemoteException {
                ...
                Parcel _reply = Parcel.obtain();
                try {
                    NetLocationStrategy netLocationStrategy;
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(pkgName);
                    _data.writeInt(uid);
                    _data.writeInt(type);
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        netLocationStrategy = (NetLocationStrategy) NetLocationStrategy.CREATOR.createFromParcel(_reply);
                    } else {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    ...
                    recordResourceOverloadStatus(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, bundle2);
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 4:
                    ...
                    _result = acquireSysRes(_arg0, uri, _arg22, bundle);
                    reply.writeNoException();
                ...
                case 5:
                    ...
                    notifyResourceStatus(_arg0, _arg1, _arg2, bundle);
                    reply.writeNoException();
                    return true;
                case 6:
                ...
                case 35:
                    ...
                    reportHabitData(parceledListSlice);
                    reply.writeNoException();
                    return true;
                case 36:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case TRANSACTION_getFrequentIM /*37*/:
                    ...
                    reply.writeStringList(_result5);
                    return true;
                case TRANSACTION_isVisibleWindow /*38*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = isVisibleWindow(data.readInt(), data.readString(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case TRANSACTION_reportSysWakeUp /*39*/:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 42:
                    data.enforceInterface(DESCRIPTOR);
                    _result5 = getHabitTopN(data.readInt());
                    reply.writeNoException();
                    reply.writeStringList(_result5);
                    return true;
                case 43:
                    data.enforceInterface(DESCRIPTOR);
                    Bundle _result9 = getTypeTopN(data.createIntArray());
                    reply.writeNoException();
                    if (_result9 != null) {
                        reply.writeInt(1);
