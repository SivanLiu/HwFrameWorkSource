...
public class SurfaceView extends View implements WindowStoppedCallback {
    ...
    public SurfaceView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mSurfaceHolder = new SurfaceHolder() {
            ...
            /* synthetic */ void lambda$-android_view_SurfaceView$3_48209(boolean screenOn) {
    ...
    public void setVisibility(int visibility) {
        ...
        this.mViewVisibility = z;
        boolean z2 = (this.mWindowVisibility && this.mViewVisibility) ? this.mWindowStopped ^ 1 : false;
    ...
    protected void updateSurface() {
        if (this.mHaveFrame) {
            ...
            if (viewRoot == null || viewRoot.mSurface == null || (viewRoot.mSurface.isValid() ^ 1) != 0) {
                if (!(viewRoot == null || viewRoot.mSurface == null || (viewRoot.mSurface.isValid() ^ 1) == 0 || this.mSurfaceControl == null || !this.mFromStopped || !this.mDelayDestory)) {
            ...
            ViewRootImpl impl;
            if (z || formatChanged || sizeChanged || visibleChanged || windowVisibleChanged) {
                getLocationInWindow(this.mLocation);
                try {
                    ...
                    try {
                        ...
                        if (sizeChanged || z || (this.mRtHandlingPositionUpdates ^ 1) != 0) {
                        ...
                        if (visible && this.mSurface.isValid()) {
                            ...
                            if (z || formatChanged || sizeChanged || visibleChanged || realSizeChanged) {
                                if (callbackArr == null) {
                                    callbackArr = getSurfaceCallbacks();
                                }
                                for (Callback c22 : r12) {
                            ...
                            if (redrawNeeded) {
                                ...
                                new SurfaceCallbackHelper(new -$Lambda$XmA8Y30pNAdQP9ujRlGx1qfDHH8((byte) 1, this)).dispatchSurfaceRedrawNeededAsync(this.mSurfaceHolder, callbackArr);
                            }
                        }
                        this.mIsCreating = false;
    ...
    /* synthetic */ void -android_view_SurfaceView-mthref-0() {
        onDrawFinished();
    }
    ...
    /* synthetic */ void lambda$-android_view_SurfaceView_37955() {
        performDrawFinished();
    }
