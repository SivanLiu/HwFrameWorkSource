...
public class FocusFinder {
    ...
    static final class FocusSorter {
        ...
        private Comparator<View> mSidesComparator = new android.view.-$Lambda$6k_RnLLpNi5zg27ubDxN4lDdBbk.AnonymousClass1((byte) 1, this);
        private Comparator<View> mTopsComparator = new android.view.-$Lambda$6k_RnLLpNi5zg27ubDxN4lDdBbk.AnonymousClass1((byte) 0, this);

        FocusSorter() {
        }

        /* synthetic */ int lambda$-android_view_FocusFinder$FocusSorter_31960(View first, View second) {
            if (first == second) {
                return 0;
            }
        ...
        /* synthetic */ int lambda$-android_view_FocusFinder$FocusSorter_32420(View first, View second) {
            if (first == second) {
                return 0;
            }
            Rect firstRect = (Rect) this.mRectByView.get(first);
    ...
    private FocusFinder() {
        ...
        this.mUserSpecifiedFocusComparator = new UserSpecifiedFocusComparator(-$Lambda$6k_RnLLpNi5zg27ubDxN4lDdBbk.$INST$0);
        this.mUserSpecifiedClusterComparator = new UserSpecifiedFocusComparator(-$Lambda$6k_RnLLpNi5zg27ubDxN4lDdBbk.$INST$1);
    ...
    public View findNextKeyboardNavigationCluster(View root, View currentCluster, int direction) {
        ...
        if (currentCluster != null) {
            view = findNextUserSpecifiedKeyboardNavigationCluster(root, currentCluster, direction);
            if (view != null) {
                return view;
            }
        }
        ...
        try {
            ...
            if (!clusters.isEmpty()) {
                view = findNextKeyboardNavigationCluster(root, currentCluster, clusters, direction);
            }
            clusters.clear();
            return view;
        } catch (Throwable th) {
