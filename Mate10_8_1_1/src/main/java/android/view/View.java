...
*/
    ...
    public View(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (isRtlCompatibilityMode()) {
            ...
            int i3 = !startPaddingDefined ? endPaddingDefined : 1;
            if (this.mLeftPaddingDefined && (i3 ^ 1) != 0) {
                this.mUserPaddingLeftInitial = leftPadding;
            }
            if (this.mRightPaddingDefined && (i3 ^ 1) != 0) {
                this.mUserPaddingRightInitial = rightPadding;
            }
        }
        ...
        int i4 = this.mUserPaddingRightInitial;
        if (bottomPadding < 0) {
            bottomPadding = this.mPaddingBottom;
        }
        internalSetPadding(i2, topPadding, i4, bottomPadding);
        if (viewFlagMasks != 0) {
    ...
    private boolean performLongClickInternal(float x, float y) {
        ...
        if ((this.mViewFlags & 1073741824) == 1073741824 && !r0) {
    ...
    void handleFocusGainInternal(int direction, Rect previouslyFocusedRect) {
        if ((this.mPrivateFlags & 2) == 0) {
            ...
            if (this.mParent != null) {
                ...
                updateFocusedInCluster(findFocus, direction);
            }
            if (this.mAttachInfo != null) {
    ...
    public final boolean isImportantForAutofill() {
        ...
        if (!(id == -1 || (isViewIdGenerated(id) ^ 1) == 0)) {
            ...
            String pkg = null;
            try {
                str = res.getResourceEntryName(id);
                pkg = res.getResourcePackageName(id);
            } catch (NotFoundException e) {
            }
            return (str == null || pkg == null || !pkg.equals(this.mContext.getPackageName())) ? false : true;
        }
    }
    ...
    View findUserSetNextKeyboardNavigationCluster(View root, int direction) {
        switch (direction) {
            case 1:
                ...
                return root.findViewByPredicateInsideOut(this, new -$Lambda$iU_USrtPm1XIm5H9QYQvXfBGDE4(this.mID));
            case 2:
    ...
    static /* synthetic */ boolean lambda$-android_view_View_422620(int id, View t) {
    ...
    public void setImportantForAccessibility(int mode) {
        ...
        if (mode != oldMode) {
            ...
            boolean includeForAccessibility = maySkipNotify ? includeForAccessibility() : false;
    ...
    public void onVisibilityAggregated(boolean isVisible) {
        ...
        Drawable -get1 = this.mForegroundInfo != null ? this.mForegroundInfo.mDrawable : null;
        if (!(-get1 == null || isVisible == -get1.isVisible())) {
            -get1.setVisible(isVisible, false);
        }
        if (isAutofillable()) {
            AutofillManager afm = getAutofillManager();
    ...
    private boolean skipInvalidate() {
        ...
        if (this.mParent instanceof ViewGroup) {
            return ((ViewGroup) this.mParent).isViewTransitioning(this) ^ 1;
        }
        return true;
    }
    ...
    void invalidateInternal(int l, int t, int r, int b, boolean invalidateCache, boolean fullInvalidate) {
        if (this.mGhostView != null) {
            ...
            if ((this.mPrivateFlags & 48) != 48 && (!(invalidateCache && (this.mPrivateFlags & 32768) == 32768) && (this.mPrivateFlags & Integer.MIN_VALUE) == Integer.MIN_VALUE)) {
    ...
    private void getHorizontalScrollBarBounds(Rect drawBounds, Rect touchBounds) {
        ...
        if (bounds != null) {
            int isVerticalScrollBarHidden;
            int inside = (this.mViewFlags & 33554432) == 0 ? -1 : 0;
            if (isVerticalScrollBarEnabled()) {
                isVerticalScrollBarHidden = isVerticalScrollBarHidden() ^ 1;
            } else {
                isVerticalScrollBarHidden = 0;
            }
            int size = getHorizontalScrollbarHeight();
            int verticalScrollBarGap = isVerticalScrollBarHidden != 0 ? getVerticalScrollbarWidth() : 0;
            int width = this.mRight - this.mLeft;
            int height = this.mBottom - this.mTop;
    ...
    protected final void onDrawScrollBars(Canvas canvas) {
        ...
        if (cache != null) {
            ...
            if (state != 0) {
                ...
                Rect bounds;
                if (this.mRoundScrollbarRenderer != null) {
                    if (isVerticalScrollBarHidden != 0) {
                ...
                } else if (isVerticalScrollBarHidden != 0 || drawHorizontalScrollBar) {
                    ScrollBarDrawable scrollBar = cache.scrollBar;
    ...
    void dispatchAttachedToWindow(AttachInfo info, int visibility) {
        ...
        onAttachedToWindow();
        ListenerInfo li = this.mListenerInfo;
        Iterable<OnAttachStateChangeListener> -get0 = li != null ? li.mOnAttachStateChangeListeners : null;
        if (-get0 != null && -get0.size() > 0) {
            for (OnAttachStateChangeListener listener : -get0) {
    ...
    private void buildDrawingCacheImpl(boolean autoScale) {
        ...
        int height = this.mBottom - this.mTop;
        AttachInfo attachInfo = this.mAttachInfo;
        boolean z = attachInfo != null ? attachInfo.mScalingRequired : false;
        if (autoScale && z) {
        ...
        int i = attachInfo != null ? attachInfo.mUse32BitDrawingCache : 0;
        int i2 = width * height;
        int i3 = (!isOpaque || (i ^ 1) == 0) ? 4 : 2;
        long projectedBitmapSize = (long) (i3 * i2);
        ...
        if (!(bitmap != null && bitmap.getWidth() == width && bitmap.getHeight() == height)) {
            Config quality;
            if (isOpaque) {
                quality = i != 0 ? Config.ARGB_8888 : Config.RGB_565;
            } else {
                i3 = this.mViewFlags;
    ...
    boolean draw(Canvas canvas, ViewGroup parent, long drawingTime) {
        ...
        boolean z2 = this.mAttachInfo != null ? this.mAttachInfo.mScalingRequired : false;
        ...
        int i = cache != null ? drawingWithRenderNode ^ 1 : 0;
        int i2 = cache == null ? drawingWithRenderNode ^ 1 : 0;
        int restoreTo = -1;
        ...
        if (z && hardwareAcceleratedCanvas && a.hasAlpha() && (this.mPrivateFlags & 262144) == 262144) {
            invalidate(true);
        }
        this.mRecreateDisplayList = false;
        return z;
    ...
    public void draw(Canvas canvas) {
        ...
        int i = (PFLAG_DIRTY_MASK & privateFlags) == 4194304 ? this.mAttachInfo != null ? this.mAttachInfo.mIgnoreDirtyState ^ 1 : 1 : 0;
    ...
    protected void drawableStateChanged() {
        ...
        Drawable -get1 = this.mForegroundInfo != null ? this.mForegroundInfo.mDrawable : null;
        if (-get1 != null && -get1.isStateful()) {
            changed |= -get1.setState(state);
        }
        if (this.mScrollCache != null) {
    ...
    public boolean isDefaultFocusHighlightNeeded(Drawable background, Drawable foreground) {
        ...
        if (!isInTouchMode() && getDefaultFocusHighlightEnabled() && r0 && isAttachedToWindow()) {
    ...
    public void onDrawForeground(Canvas canvas) {
        ...
        if (-get1 != null) {
            if (this.mForegroundInfo.mBoundsChanged) {
                ...
                Gravity.apply(this.mForegroundInfo.mGravity, -get1.getIntrinsicWidth(), -get1.getIntrinsicHeight(), selfBounds, overlayBounds, getLayoutDirection());
                -get1.setBounds(overlayBounds);
            }
            -get1.draw(canvas);
        }
    }
    ...
    public final <T extends View> T findViewByPredicateInsideOut(View start, Predicate<View> predicate) {
        View view = null;
        while (true) {
            T view2 = start.findViewByPredicateTraversal(predicate, view);
    ...
    protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX, int scrollRangeY, int maxOverScrollX, int maxOverScrollY, boolean isTouchEvent) {
        ...
        boolean z = overScrollMode != 0 ? overScrollMode == 1 ? canScrollHorizontal : false : true;
        boolean z2 = overScrollMode != 0 ? overScrollMode == 1 ? canScrollVertical : false : true;
    ...
    public void setTooltipText(CharSequence tooltipText) {
        ...
        if (this.mTooltipInfo == null) {
            ...
            this.mTooltipInfo.mShowTooltipRunnable = new -$Lambda$XmA8Y30pNAdQP9ujRlGx1qfDHH8((byte) 2, this);
            this.mTooltipInfo.mHideTooltipRunnable = new -$Lambda$XmA8Y30pNAdQP9ujRlGx1qfDHH8((byte) 3, this);
        }
        this.mTooltipInfo.mTooltipText = tooltipText;
    }

    /* synthetic */ void -android_view_View-mthref-0() {
        showHoverTooltip();
    }

    /* synthetic */ void -android_view_View-mthref-1() {
        hideTooltip();
    }
