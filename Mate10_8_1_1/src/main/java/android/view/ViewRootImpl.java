    ...
    final class ViewPostImeInputStage extends InputStage {
        ...
        private int processKeyEvent(QueuedInputEvent q) {
            ...
            if (event.getAction() == 0 && event.getKeyCode() == 61) {
                ...
                } else if (KeyEvent.metaStateHasModifiers(event.getMetaState(), StorageVolume.STORAGE_ID_PRIMARY)) {
                ...
                case 5:
                    ...
                    if (ViewRootImpl.this.mAdded) {
                        ...
                        if (ViewRootImpl.this.mWinFrame.equals(args.arg1) && (ViewRootImpl.this.mPendingOverscanInsets.equals(args.arg5) ^ 1) == 0 && (ViewRootImpl.this.mPendingContentInsets.equals(args.arg2) ^ 1) == 0 && (ViewRootImpl.this.mPendingStableInsets.equals(args.arg6) ^ 1) == 0 && (ViewRootImpl.this.mPendingVisibleInsets.equals(args.arg3) ^ 1) == 0) {
                            equals = ViewRootImpl.this.mPendingOutsets.equals(args.arg7) ^ 1;
                        } else {
                            equals = 1;
                        }
                        ...
                        if (!(ViewRootImpl.this.mView == null || r25 == 0)) {
            ...
            if (Log.HWINFO) {
                if (event instanceof MotionEvent) {
                    ...
                    if (((double) myEvent.getX()) > 0.0d || ((double) myEvent.getY()) > 0.0d) {
                        Log.v("InputEvent", "L3:" + myEvent.mSeq + NativeLibraryHelper.CLEAR_ABI_OVERRIDE + ((int) Math.rint((double) myEvent.getX())) + NativeLibraryHelper.CLEAR_ABI_OVERRIDE + ((int) Math.rint((double) myEvent.getY())) + NativeLibraryHelper.CLEAR_ABI_OVERRIDE + myEvent.getAction());
                    }
...
*/
        ...
        if (this.mTranslator == null) {
            if (((attrs.flags & 16777216) != 0) && ThreadedRenderer.isAvailable()) {
                ...
                if (fakeHwAccelerated) {
                    ...
                    boolean z = attrs.format == -1 ? hasSurfaceInsets : true;
                    boolean wideGamut = this.mContext.getResources().getConfiguration().isScreenWideColorGamut() ? attrs.getColorMode() == 1 : false;
                    this.mAttachInfo.mThreadedRenderer = ThreadedRenderer.create(this.mContext, z, attrs.getTitle().toString());
    ...
    private void performTraversals() {
        ...
        if (host != null && (this.mAdded ^ 1) == 0) {
            ...
            if (this.mFirst) {
                ...
                viewVisibilityChanged = this.mAppVisibilityChanged;
            }
            ...
            boolean z = this.mLayoutRequested ? this.mStopped ? this.mReportNextDraw : true : false;
            if (z) {
            ...
            boolean windowShouldResize = (!z || windowSizeMayChange == 0) ? false : (this.mWidth == host.getMeasuredWidth() && this.mHeight == host.getMeasuredHeight() && (lp.width != -2 || frame.width() >= desiredWindowWidth || frame.width() == this.mWidth)) ? (lp.height != -2 || frame.height() >= desiredWindowHeight) ? false : frame.height() != this.mHeight : true;
            ...
            if (this.mFirst || windowShouldResize || insetsChanged || viewVisibilityChanged || params != null || this.mForceNextWindowRelayout) {
                ...
                z4 = this.mPendingContentInsets.equals(this.mAttachInfo.mContentInsets) ^ 1;
                ...
                if (!z4 && this.mLastSystemUiVisibility == this.mAttachInfo.mSystemUiVisibility) {
                    if (!this.mApplyInsetsRequested && this.mLastOverscanRequested == this.mAttachInfo.mOverscanRequested) {
                        ...
                        freeformResizing = (relayoutResult & 16) == 0;
                        z3 = freeformResizing ? (relayoutResult & 8) == 0 : true;
                        ...
                        if (threadedRenderer != null && threadedRenderer.isEnabled()) {
                            if (!hwInitialized && this.mWidth == threadedRenderer.getWidth() && this.mHeight == threadedRenderer.getHeight()) {
                                if (this.mNeedsRendererSetup) {
                                }
                            }
                        ...
                        if (!this.mStopped || this.mReportNextDraw) {
                            if (!ensureTouchModeLocally((relayoutResult & 1) == 0) && this.mWidth == host.getMeasuredWidth() && this.mHeight == host.getMeasuredHeight() && !r33) {
                                if (z2) {
                                }
                            }
            ...
            boolean z5 = z ? this.mStopped ? this.mReportNextDraw : true : false;
            if (z5) {
            ...
            boolean z6 = (viewVisibilityChanged || this.mFirst) ? isViewVisible : false;
            boolean z7 = this.mAttachInfo.mHasWindowFocus ? isViewVisible : false;
            boolean z8 = z7 ? this.mLostWindowFocus : false;
            if (z8) {
                this.mLostWindowFocus = false;
            } else if (!z7 && this.mHadWindowFocus) {
            ...
            this.mHadWindowFocus = z7;
            if (z7 && (isInLocalFocusMode() ^ 1) != 0) {
                ...
                if (imTarget != this.mLastWasImTarget) {
                    ...
                    if (imm != null && imTarget) {
                        imm.onPreWindowFocus(this.mView, z7);
    ...
    private void performDraw() {
                ...
                try {
                    ...
                    if (this.mReportNextDraw) {
                        ...
                        if (this.mSurfaceHolder == null && this.mSurface.isValid()) {
                            new SurfaceCallbackHelper(new -$Lambda$XmA8Y30pNAdQP9ujRlGx1qfDHH8((byte) 4, this)).dispatchSurfaceRedrawNeededAsync(this.mSurfaceHolder, this.mSurfaceHolder.getCallbacks());
                        } else {
                            pendingDrawFinished();
                        }
                    }
        ...
        } else if (this.mAttachInfo.mDisplayState != 1) {
            if (this.mAttachInfo.mDisplayState != 4) {
            }
        }
        if ((this.mReportNextDraw ^ 1) != 0) {
            if (mSupportAod) {
                if (!(this.mAttachInfo.mDisplayState == 1 || this.mAttachInfo.mDisplayState == 4)) {
                    if (this.mStopped) {
                    }
                }
                if (this.mTag != null && this.mTag.contains("[AOD]")) {
    ...
    /* synthetic */ void -android_view_ViewRootImpl-mthref-0() {
        postDrawFinished();
    }
    ...
    private void draw(boolean fullRedrawNeeded) {
        ...
        if (surface.isValid()) {
            ...
            boolean computeScrollOffset = this.mScroller != null ? this.mScroller.computeScrollOffset() : false;
            ...
            Rect rect = params != null ? params.surfaceInsets : null;
            if (rect != null) {
                xOffset -= rect.left;
                yOffset -= rect.top;
                dirty.offset(rect.left, rect.right);
            }
            ...
            if (!dirty.isEmpty() || this.mIsAnimating || accessibilityFocusDirty) {
                ...
                if (this.mAttachInfo.mThreadedRenderer != null && this.mAttachInfo.mThreadedRenderer.isEnabled()) {
                    boolean z = !accessibilityFocusDirty ? this.mInvalidateRootRequested : true;
    ...
    boolean scrollToRectOrFocus(Rect rectangle, boolean immediate) {
        ...
        if (vi.left > ci.left || vi.top > ci.top || vi.right > ci.right || vi.bottom > ci.bottom) {
            ...
            View view = this.mLastScrolledFocus != null ? (View) this.mLastScrolledFocus.get() : null;
            if (focus != view) {
                rectangle = null;
            }
            if (!(focus == view && (this.mScrollMayChange ^ 1) != 0 && rectangle == null)) {
    ...
    public void updateConfiguration(int newDisplayId) {
        if (this.mView != null) {
            ...
            if (this.mForceNextConfigUpdate || this.mLastConfigurationFromResources.diff(config) != 0) {
                ...
                } else if (this.mDisplay == null && this.mView.getContext() != null && HwPCUtils.isValidExtDisplayId(this.mView.getContext())) {
    ...
    private void handleWindowContentChangedEvent(AccessibilityEvent event) {
        ...
        if (focusedHost != null && this.mAccessibilityFocusedVirtualView != null) {
            ...
            if ((changes & 1) != 0 || changes == 0) {
                ...
                while (view != null && (hostInSubtree ^ 1) != 0) {
