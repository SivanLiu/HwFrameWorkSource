...
public final class TextClassification {
    ...
    private TextClassification(String text, Drawable icon, String label, Intent intent, OnClickListener onClickListener, EntityConfidence<String> entityConfidence, int logType, String versionInfo) {
        this.mText = text;
        this.mIcon = icon;
        this.mLabel = label;
        this.mIntent = intent;
