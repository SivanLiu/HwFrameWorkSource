...
public class LegacyResultMapper {
    ...
    private static void mapAeAndFlashMode(CameraMetadataNative m, CameraCharacteristics characteristics, Parameters p) {
        int flashMode = 0;
        Object valueOf = ((Boolean) characteristics.get(CameraCharacteristics.FLASH_INFO_AVAILABLE)).booleanValue() ? null : Integer.valueOf(0);
        int aeMode = 1;
        ...
        m.set(CaptureResult.FLASH_STATE, valueOf);
