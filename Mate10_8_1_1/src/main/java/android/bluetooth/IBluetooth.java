...
public interface IBluetooth extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBluetooth {
        ...
        static final int TRANSACTION_connectSocket = 53;
        static final int TRANSACTION_createBond = 24;
        static final int TRANSACTION_createBondOutOfBand = 25;
        static final int TRANSACTION_createSocketChannel = 54;
        ...
        static final int TRANSACTION_isActivityAndEnergyReportingSupported = 59;
        ...
        static final int TRANSACTION_isLe2MPhySupported = 60;
        static final int TRANSACTION_isLeCodedPhySupported = 61;
        static final int TRANSACTION_isLeExtendedAdvertisingSupported = 62;
        static final int TRANSACTION_isLePeriodicAdvertisingSupported = 63;
        static final int TRANSACTION_isMultiAdvertisementSupported = 56;
        static final int TRANSACTION_isOffloadedFilteringSupported = 57;
        static final int TRANSACTION_isOffloadedScanBatchingSupported = 58;
        static final int TRANSACTION_isRadioEnabled = 6;
        static final int TRANSACTION_onBrEdrDown = 68;
        static final int TRANSACTION_onLeServiceUp = 67;
        ...
        static final int TRANSACTION_requestActivityInfo = 66;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 29:
                    ...
                    _result = isBondingInitiatedLocally(bluetoothDevice);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 30:
                ...
                case 40:
                    ...
                    _result2 = getBatteryLevel(bluetoothDevice);
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 41:
                ...
                case 53:
                    ...
                    _result6 = connectSocket(bluetoothDevice, _arg1, parcelUuid, data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (_result6 != null) {
                        reply.writeInt(1);
                ...
                case 54:
                    ...
                    _result6 = createSocketChannel(_arg0, _arg12, parcelUuid, data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (_result6 != null) {
                        reply.writeInt(1);
                        _result6.writeToParcel(reply, 1);
