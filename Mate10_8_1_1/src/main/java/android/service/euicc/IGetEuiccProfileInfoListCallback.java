...
public interface IGetEuiccProfileInfoListCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGetEuiccProfileInfoListCallback {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    GetEuiccProfileInfoListResult getEuiccProfileInfoListResult;
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        getEuiccProfileInfoListResult = (GetEuiccProfileInfoListResult) GetEuiccProfileInfoListResult.CREATOR.createFromParcel(data);
                    } else {
                        getEuiccProfileInfoListResult = null;
                    }
