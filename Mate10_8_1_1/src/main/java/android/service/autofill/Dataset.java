    ...
    public static final Creator<Dataset> CREATOR = new Creator<Dataset>() {
        public Dataset createFromParcel(Parcel parcel) {
            ...
            while (i < idCount) {
                ...
                AutofillValue autofillValue = valueCount > i ? (AutofillValue) values.get(i) : null;
                if (presentations.isEmpty()) {
                    remoteViews = null;
                } else {
                    remoteViews = (RemoteViews) presentations.get(i);
                }
                builder.setValueAndPresentation(id, autofillValue, remoteViews);
                i++;
            }
