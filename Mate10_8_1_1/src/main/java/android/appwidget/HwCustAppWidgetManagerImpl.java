...
public class HwCustAppWidgetManagerImpl extends HwCustAppWidgetManager {
    ...
    private static final String PKGNAME_HUAWEI_LUANCHER = "com.huawei.android.launcher";
    ...
    public void hideTotemweatherWidgets(String pkgName, ParceledListSlice providers) {
        if (IS_DOCOMO && pkgName != null && providers != null && providers.getList() != null && !pkgName.equals(PKGNAME_SIMPLELUANCHER) && (pkgName.equals(PKGNAME_HUAWEI_LUANCHER) ^ 1) != 0) {
