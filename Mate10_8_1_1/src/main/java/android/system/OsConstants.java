...
public final class OsConstants {
    ...
    public static final int MSG_HRT = placeholder();
    public static final int MSG_LPW = placeholder();
    ...
    public static final int TCP_RECONN = placeholder();
    ...
    public static int CAP_TO_INDEX(int x) {
        return x >>> 5;
    }

    public static int CAP_TO_MASK(int x) {
        return 1 << (x & 31);
    }
