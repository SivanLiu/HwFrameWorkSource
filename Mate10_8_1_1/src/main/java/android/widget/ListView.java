...
public class ListView extends HwAbsListView {
    ...
    private View fillDown(int pos, int nextTop) {
        ...
        while (nextTop < end && pos < this.mItemCount - this.mAnimOffset) {
                        ...
                        if (this.mItemCount == 0) {
                            ...
                            switch (this.mLayoutMode) {
                                ...
                                case 4:
                                    ...
                                    if (sel == null && this.mFocusSelector != null) {
                                        focusRunnable = this.mFocusSelector.setupFocusIfValid(selectedPosition);
                                ...
                                case 5:
                                    ...
                                    break;
                                case 6:
                                    sel = moveSelection(view4, newSel, delta, childrenTop, childrenBottom);
                                    break;
                                default:
                                    if (childCount != 0) {
                            ...
                            if (sel == null) {
                                if (this.mItemsCanFocus || !hasFocus() || (sel.hasFocus() ^ 1) == 0) {
                                    ...
                                    if (sel == view2 && view3 != null && view3.requestFocus()) {
                                        focusWasTaken = true;
                                    } else {
                                ...
                                inTouchMode = this.mTouchMode == 1 ? this.mTouchMode != 2 : true;
                                if (inTouchMode) {
    ...
    private boolean arrowScrollImpl(int direction) {
        ...
        ArrowScrollFocusResult arrowScrollFocused = this.mItemsCanFocus ? arrowScrollFocused(direction) : null;
        if (arrowScrollFocused != null) {
            nextSelectedPosition = arrowScrollFocused.getSelectedPosition();
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (drawDividers || drawOverscrollHeader || drawOverscrollFooter) {
            ...
            ListAdapter adapter = this.mAdapter;
            int isOpaque = isOpaque() ? super.isOpaque() ^ 1 : 0;
            if (isOpaque != 0 && this.mDividerPaint == null && this.mIsCacheColorOpaque) {
                this.mDividerPaint = new Paint();
