...
class YearPickerView extends ListView {
    ...
    private static class YearAdapter extends BaseAdapter {
        private static final int ITEM_LAYOUT = 17367322;
        private static final int ITEM_TEXT_ACTIVATED_APPEARANCE = 16974725;
        private static final int ITEM_TEXT_APPEARANCE = 16974724;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (hasNewView) {
                v = (TextView) this.mInflater.inflate(17367322, parent, false);
            } else {
            ...
            if (hasNewView || v.isActivated() != activated) {
                ...
                if (activated) {
                    textAppearanceResId = 16974725;
                } else {
                    textAppearanceResId = 16974724;
                }
