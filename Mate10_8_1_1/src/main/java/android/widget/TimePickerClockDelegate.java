        ...
        public void onValueSelected(int pickerType, int newValue, boolean autoAdvance) {
            ...
            switch (pickerType) {
                case 0:
                    ...
                    int i = TimePickerClockDelegate.this.mAllowAutoAdvance ? autoAdvance : 0;
                    TimePickerClockDelegate.this.setHourInternal(newValue, 1, i ^ 1, true);
                    if (i != 0) {
