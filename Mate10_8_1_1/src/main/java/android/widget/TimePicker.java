...
public class TimePicker extends FrameLayout {
    ...
    static abstract class AbstractTimePickerDelegate implements TimePickerDelegate {
        ...
        public final void autofill(AutofillValue value) {
            if (value == null || (value.isDate() ^ 1) != 0) {
                Log.w(TimePicker.LOG_TAG, value + " could not be autofilled into " + this);
                return;
            }
    ...
    /* synthetic */ void lambda$-android_widget_TimePicker_4967(Context context, TimePicker v, int h, int m) {
