...
public abstract class ForwardingListener implements OnTouchListener, OnAttachStateChangeListener {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (wasForwarding) {
            onForwardingStopped = !onTouchForwarded(event) ? onForwardingStopped() ^ 1 : true;
        } else {
            onForwardingStopped = onTouchObserved(event) ? onForwardingStarted() : false;
        ...
        this.mForwarding = onForwardingStopped;
        return !onForwardingStopped ? wasForwarding : true;
    }
