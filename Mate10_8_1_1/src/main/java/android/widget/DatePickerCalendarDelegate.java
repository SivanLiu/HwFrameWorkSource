...
class DatePickerCalendarDelegate extends AbstractDatePickerDelegate {
    ...
    private final OnClickListener mOnHeaderClickListener = new -$Lambda$47CjpztMF6VTC4ohP7T_r8sdL0g(this);
    ...
    public DatePickerCalendarDelegate(DatePicker delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (monthHeaderTextAppearance != 0) {
            ...
            colorStateList = applyLegacyColorFixes(textAppearance.getColorStateList(0));
    ...
    /* synthetic */ void lambda$-android_widget_DatePickerCalendarDelegate_11048(View v) {
        tryVibrate();
        switch (v.getId()) {
            case R.id.date_picker_header_date /*16908825*/:
                setCurrentView(0);
                return;
            case R.id.date_picker_header_year /*16908826*/:
                setCurrentView(1);
                return;
            default:
                return;
    ...
    private void setCurrentView(int viewIndex) {
        switch (viewIndex) {
            ...
            case 1:
                this.mYearPickerView.setYear(this.mCurrentDate.get(1));
                this.mYearPickerView.post(new -$Lambda$2f4l12BcqlVIiuw8w0ONZMWiEpk((byte) 0, this));
                if (this.mCurrentView != viewIndex) {
    ...
    /* synthetic */ void lambda$-android_widget_DatePickerCalendarDelegate_13424() {
