...
public final class DateTimeFormatter {
    ...
    private static final TemporalQuery<Period> PARSED_EXCESS_DAYS = -$Lambda$j8BjRHFvnsAjgkxE0mjQfJ-QL-Y.$INST$0;
    private static final TemporalQuery<Boolean> PARSED_LEAP_SECOND = -$Lambda$j8BjRHFvnsAjgkxE0mjQfJ-QL-Y.$INST$1;
    ...
    private java.time.format.DateTimeParseContext parseUnresolved0(java.lang.CharSequence r1, java.text.ParsePosition r2) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.time.format.DateTimeFormatter.parseUnresolved0(java.lang.CharSequence, java.text.ParsePosition):java.time.format.DateTimeParseContext
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: java.time.format.DateTimeFormatter.parseUnresolved0(java.lang.CharSequence, java.text.ParsePosition):java.time.format.DateTimeParseContext");
    }
