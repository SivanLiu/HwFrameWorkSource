...
public final class LocalTime implements Temporal, TemporalAdjuster, Comparable<LocalTime>, Serializable {
    ...
    static java.time.LocalTime readExternal(java.io.DataInput r1) throws java.io.IOException {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.time.LocalTime.readExternal(java.io.DataInput):java.time.LocalTime
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: java.time.LocalTime.readExternal(java.io.DataInput):java.time.LocalTime");
    }

    void writeExternal(java.io.DataOutput r1) throws java.io.IOException {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.time.LocalTime.writeExternal(java.io.DataOutput):void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:116)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:249)
	at jadx.core.ProcessClass.process(ProcessClass.java:31)
	at jadx.core.ProcessClass.processDependencies(ProcessClass.java:56)
...
*/
        ...
        // Can't load method instructions.
        */
        throw new UnsupportedOperationException("Method not decompiled: java.time.LocalTime.writeExternal(java.io.DataOutput):void");
    }
    ...
    public static LocalTime parse(CharSequence text, DateTimeFormatter formatter) {
        ...
        return (LocalTime) formatter.parse(text, -$Lambda$O4_RxJbNUbAPd8V96UPf6lwKRd8.$INST$3);
    }
