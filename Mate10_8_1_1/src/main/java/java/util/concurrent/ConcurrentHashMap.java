...
public class ConcurrentHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
        ...
        public boolean equals(Object o) {
            if (o instanceof Entry) {
                ...
                if (k != null) {
                    Object v = e.getValue();
                    if (v != null && (k == this.key || k.equals(this.key))) {
                        return v != this.val ? v.equals(this.val) : true;
                    }
                }
            }
            return false;
            ...
            if (transformer != null) {
                ...
                if (reducer != null) {
                    ...
                    while (true) {
                        ...
                        U u = transformer.apply(p);
                        if (u != null) {
                            obj = obj == null ? u : reducer.apply(obj, u);
                        }
                    }
                    this.result = obj;
        ...
        public final void compute() {
            ...
            if (reducer != null) {
                ...
                while (true) {
                    ...
                    entry = entry == null ? p : (Entry) reducer.apply(entry, p);
                }
                this.result = entry;
                for (CountedCompleter<?> c = firstComplete(); c != null; c = c.nextComplete()) {
        ...
        public final void compute() {
            ...
            if (reducer != null) {
                ...
                while (true) {
                    ...
                    V v = p.val;
                    obj = obj == null ? v : reducer.apply(obj, v);
                }
                this.result = obj;
                for (CountedCompleter<?> c = firstComplete(); c != null; c = c.nextComplete()) {
    ...
    public boolean equals(Object o) {
        if (o != this) {
            ...
            while (true) {
                ...
                V val = p.val;
                V v = m.get(p.key);
                if (v == null || !(v == val || (v.equals(val) ^ 1) == 0)) {
                    return false;
                }
            }
            return false;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        while (true) {
            ...
            if (k != null && v != null) {
                size++;
                node = new Node(spread(k.hashCode()), k, v, node);
            }
        }
        if (size == 0) {
            this.sizeCtl = 0;
                            ...
                            synchronized (f) {
                                if (tabAt(tab, i) == f) {
                                    if (fh >= 0) {
                                        ...
                                        TreeNode<K, V> r2 = t.root;
                                        if (r2 != null) {
                                            findTreeNode = r2.findTreeNode(h, key, null);
                                        } else {
                                            findTreeNode = null;
                                        }
                                        val = remappingFunction.apply(key, findTreeNode == null ? null : findTreeNode.val);
                                        if (val != null) {
                                            ...
                                            delta = -1;
                                            if (t.removeTreeNode(findTreeNode)) {
                                                setTabAt(tab, i, untreeify(t.first));
                                            }
                                        }
                                    } else if (f instanceof ReservationNode) {
                                ...
                                if (tabAt(tab, i) == f) {
                                    if (fh >= 0) {
                                        ...
                                        if (r == null) {
                                            ...
                                            treeNode = r.findTreeNode(h, key, null);
                                        }
                                        if (treeNode == null) {
                                            val = value;
                                        } else {
                                            val = remappingFunction.apply(treeNode.val, value);
                                        }
                                        if (val != null) {
                                            if (treeNode != null) {
                                                treeNode.val = val;
        ...
        if (as != null) {
            ...
            if (m >= 0) {
                ...
                if (a != null) {
                    ...
                    long j3 = CELLVALUE;
                    long v = a.value;
                    uncontended = unsafe2.compareAndSwapLong(a, j3, v, v + x);
                    if ((uncontended ^ 1) == 0) {
                        if (check > 1) {
                            j2 = sumCount();
                            if (check >= 0) {
                            ...
                            if (tabAt(tab, i) == f) {
                                ...
                                if (fh >= 0) {
                                    ...
                                    while (p != lastRun) {
                                        ...
                                        V pv = p.val;
                                        if ((ph & n) == 0) {
                                            node2 = new Node(ph, pk, pv, ln2);
                                            node = hn;
                                        } else {
                                            node2 = new Node(ph, pk, pv, hn);
                                            ln = ln2;
                                        }
                                        p = p.next;
                                        hn = node;
                                    ...
                                    if (hc <= 6) {
                                        ...
                                        node2 = new TreeBin(hi);
                                    } else {
                                        node = t;
                                    }
                                    setTabAt(nextTab, i, ln);
                                    setTabAt(nextTab, i + n, node);
                                    setTabAt(tab, i, forwardingNode);
                                    advance = true;
                                }
                            }
