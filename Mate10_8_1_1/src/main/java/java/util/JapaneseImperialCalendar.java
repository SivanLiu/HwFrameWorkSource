...
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.util.JapaneseImperialCalendar.computeFields():void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: java.util.JapaneseImperialCalendar.computeFields():void");
    }
                ...
                case 2:
                    ...
                    if (isTransitionYear(this.jdate.getNormalizedYear())) {
                        ...
                        if (min != max) {
                            ...
                            } else if (n == max && calendarDate.getMonth() - 1 == n) {
                                dom = calendarDate.getDayOfMonth();
                    ...
                    if (year == getMaximum(1)) {
                        ...
                        if (year == getMinimum(1)) {
                            ...
                            n = getRolledValue(internalGet(field), amount, min, max);
                            if (n == min) {
                                jd.addYear(HttpURLConnection.HTTP_BAD_REQUEST);
                                jd.setMonth(n + 1);
                                if (jd.getDayOfMonth() < d.getDayOfMonth()) {
                                    jd.setDayOfMonth(d.getDayOfMonth());
                                    jcal.normalize(jd);
