...
import java.util.-$Lambda$AdCi8d-cQd1TrFsbt1AeYkjxVJo.AnonymousClass1;
import java.util.-$Lambda$AdCi8d-cQd1TrFsbt1AeYkjxVJo.AnonymousClass2;
...
public interface Spliterator<T> {
    ...
    public interface OfInt extends OfPrimitive<Integer, IntConsumer, OfInt> {
        ...
        boolean tryAdvance(Consumer<? super Integer> action) {
            ...
            action.getClass();
            return tryAdvance(new AnonymousClass1((byte) 2, action));
        }
        ...
        void forEachRemaining(Consumer<? super Integer> action) {
            ...
            action.getClass();
            forEachRemaining(new AnonymousClass1((byte) 1, action));
        }
    }
    ...
    public interface OfDouble extends OfPrimitive<Double, DoubleConsumer, OfDouble> {
        ...
        boolean tryAdvance(Consumer<? super Double> action) {
            ...
            action.getClass();
            return tryAdvance(new -$Lambda$AdCi8d-cQd1TrFsbt1AeYkjxVJo((byte) 2, action));
        }
        ...
        void forEachRemaining(Consumer<? super Double> action) {
            ...
            action.getClass();
            forEachRemaining(new -$Lambda$AdCi8d-cQd1TrFsbt1AeYkjxVJo((byte) 1, action));
        }
    }
    ...
    public interface OfLong extends OfPrimitive<Long, LongConsumer, OfLong> {
        ...
        boolean tryAdvance(Consumer<? super Long> action) {
            ...
            action.getClass();
            return tryAdvance(new AnonymousClass2((byte) 2, action));
        }
        ...
        void forEachRemaining(Consumer<? super Long> action) {
            ...
            action.getClass();
            forEachRemaining(new AnonymousClass2((byte) 1, action));
        }
    }
