...
public class Properties extends Hashtable<Object, Object> {
        ...
        while (true) {
            ...
            if (limit >= 0) {
                ...
                while (keyLen < limit) {
                    c = lr.lineBuf[keyLen];
                    if ((c != '=' && c != ':') || (i ^ 1) == 0) {
                        if (Character.isWhitespace(c) && (i ^ 1) != 0) {
                            valueStart = keyLen + 1;
                            break;
                        }
                        if (c == '\\') {
    ...
    public String getProperty(String key) {
        ...
        String str = oval instanceof String ? (String) oval : null;
        return (str != null || this.defaults == null) ? str : this.defaults.getProperty(key);
    }
