...
public class Logger {
    ...
    public void setResourceBundle(ResourceBundle bundle) {
        ...
        synchronized (this) {
            ...
            LoggerBundle lb = this.loggerBundle;
            if (lb.resourceBundleName != null) {
                equals = lb.resourceBundleName.equals(baseName);
            } else {
                equals = true;
            }
            if (equals) {
    ...
    private LoggerBundle getEffectiveLoggerBundle() {
        ...
        while (target != null) {
            ...
            String resourceBundleName = this.isSystemLogger ? target.isSystemLogger ? trb.resourceBundleName : null : target.getResourceBundleName();
