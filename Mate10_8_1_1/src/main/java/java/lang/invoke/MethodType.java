    ...
    private static class ConcurrentWeakInternSet<T> {
        ...
        private static class WeakEntry<T> extends WeakReference<T> {
            ...
            public boolean equals(Object obj) {
                ...
                Object mine = get();
                boolean equals = (that == null || mine == null) ? this == obj ? true : MethodType.-assertionsDisabled : mine.equals(that);
                return equals;
            }
    ...
    public MethodType dropParameterTypes(int start, int end) {
        ...
        if (start < 0 || start > end || end > len) {
            ...
            if (start == 0) {
                ...
                int tail = len - end;
                Object nptypes3 = (Class[]) Arrays.copyOfRange(this.ptypes, 0, start + tail);
                System.arraycopy(this.ptypes, end, nptypes3, start, tail);
            }
            return makeImpl(this.rtype, nptypes, true);
        }
    }
