...
public interface CharSequence {
    ...
    IntStream chars() {
        return StreamSupport.intStream(new -$Lambda$S9HjrJh0nDg7IyU6wZdPArnZWRQ((byte) 0, this), 16464, false);
    }
    ...
    IntStream codePoints() {
        return StreamSupport.intStream(new -$Lambda$S9HjrJh0nDg7IyU6wZdPArnZWRQ((byte) 1, this), 16, false);
    }
