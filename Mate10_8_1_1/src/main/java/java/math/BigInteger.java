...
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.math.BigInteger.twosComplement():byte[]
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: java.math.BigInteger.twosComplement():byte[]");
    }

    public boolean testBit(int r1) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: java.math.BigInteger.testBit(int):boolean
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:116)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:249)
	at jadx.core.ProcessClass.process(ProcessClass.java:31)
	at jadx.core.ProcessClass.processDependencies(ProcessClass.java:56)
...
*/
        ...
        // Can't load method instructions.
        */
        throw new UnsupportedOperationException("Method not decompiled: java.math.BigInteger.testBit(int):boolean");
    }
    ...
    private static void parseFromString(BigInteger bi, String value, int radix) {
        ...
        while (substrStart < endChar) {
            ...
            digits[digitIndex] = multiplyByInt(digits, digits, digitIndex, bigRadix) + inplaceAdd(digits, digitIndex, Integer.parseInt(value.substring(substrStart, substrEnd), radix));
