...
jadx.core.utils.exceptions.CodegenException: Error generate insn: PHI: (r17_2 'i' int) = (r17_0 'i' int), (r17_1 'i' int) binds: {(r17_0 'i' int)=B:1:0x000a, (r17_1 'i' int)=B:2:0x000c} in method: java.text.SimpleDateFormat.matchString(java.lang.String, int, int, java.lang.String[], java.text.CalendarBuilder):int
