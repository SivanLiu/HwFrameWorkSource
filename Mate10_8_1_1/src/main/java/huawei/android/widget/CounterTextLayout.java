...
public class CounterTextLayout extends LinearLayout {
    ...
    private class TextInputAccessibilityDelegate extends AccessibilityDelegate {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfo info) {
            ...
            if (CounterTextLayout.this.mCounterView != null) {
                text = CounterTextLayout.this.mCounterView.getText();
            } else {
                text = null;
            }
    ...
    private void measureBubble(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        boolean measureMatchParentChildren = MeasureSpec.getMode(widthMeasureSpec) == SQLiteDatabase.ENABLE_DATABASE_ENCRYPTION ? MeasureSpec.getMode(heightMeasureSpec) != SQLiteDatabase.ENABLE_DATABASE_ENCRYPTION : true;
        ...
        if (count > 1) {
            for (i = 0; i < count; i++) {
                ...
                if (lp2.width == -1) {
                    ...
                    childWidthMeasureSpec = MeasureSpec.makeMeasureSpec(widthNoMargin > 0 ? widthNoMargin : 0, SQLiteDatabase.ENABLE_DATABASE_ENCRYPTION);
                } else {
                ...
                if (lp2.height == -1) {
                    ...
                    childHeightMeasureSpec = MeasureSpec.makeMeasureSpec(heightNoMargin > 0 ? heightNoMargin : 0, SQLiteDatabase.ENABLE_DATABASE_ENCRYPTION);
                } else {
