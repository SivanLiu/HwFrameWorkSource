...
import android.widget.ActionMenuPresenter.OverflowPopup;
...
public class HwOverflowMenuButton extends Button implements ActionMenuChildView {
    ...
    public HwOverflowMenuButton(Context context, ActionMenuPresenter actionMenuPresenter) {
        ...
        setOnTouchListener(new ForwardingListener(this) {
            public ListPopupWindow getPopup() {
                if (HwOverflowMenuButton.this.getOverflowPopup() == null) {
                    return null;
                }
                MenuPopup mp = HwOverflowMenuButton.this.getOverflowPopup().getPopup();
                if (mp != null) {
            ...
            public boolean onForwardingStarted() {
                ...
                return HwOverflowMenuButton.DEBUG;
            }
    ...
    private OverflowPopup getOverflowPopup() {
        return (OverflowPopup) ReflectUtil.getObject(this.mActionMenuPresenter, "mOverflowPopup", ActionMenuPresenter.class);
    }
