...
public class ActionBarEx {
    ...
    public static void setStartIcon(ActionBar actionBar, HwToolbar toolbar, boolean icon1Visible, Drawable icon1, OnClickListener listener1) {
        toolbar.setStartIcon(icon1Visible, icon1, listener1);
        setIconLayout(actionBar, toolbar);
    }

    public static void setEndIcon(ActionBar actionBar, HwToolbar toolbar, boolean icon2Visible, Drawable icon2, OnClickListener listener2) {
    ...
    private static void setIconLayout(ActionBar actionBar, HwToolbar toolbar) {
        ...
        if (toolbar.getIconLayout() != null) {
            actionBar.setCustomView(toolbar.getIconLayout(), new LayoutParams(-1, -2));
        }
    }
    ...
    public static void setSplitViewAnimationEnable(HwToolbar toolbar, boolean enableAnim) {
        toolbar.setSplitViewAnimationEnable(enableAnim);
    }
