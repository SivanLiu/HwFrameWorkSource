    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (this.mProgressStyle == 1) {
            ...
            if (HwWidgetUtils.isHwTheme(getContext())) {
                view = inflater.inflate(50790401, null);
                this.mMessageView = (TextView) view.findViewById(50659340);
                this.mProgress = (ProgressBar) view.findViewById(50659341);
                this.mProgressPercent = (TextView) view.findViewById(50659342);
                this.mCancel = view.findViewById(50659330);
                this.mSpace = view.findViewById(50659336);
                view.setTag(this);
            } else {
                view = inflater.inflate(a.getResourceId(HwWidgetUtils.getResourceDeclareStyleableIndex("com.android.internal", "AlertDialog_horizontalProgressLayout"), resources.getIdentifier("alert_dialog_progress", "layout", "android")), null);
                this.mProgress = (ProgressBar) view.findViewById(resources.getIdentifier("progress", "id", "android"));
                this.mProgressNumber = (TextView) view.findViewById(resources.getIdentifier("progress_number", "id", "android"));
                this.mProgressPercent = (TextView) view.findViewById(resources.getIdentifier("progress_percent", "id", "android"));
            }
            setView(view);
        } else {
            view = inflater.inflate(a.getResourceId(HwWidgetUtils.getResourceDeclareStyleableIndex("com.android.internal", "AlertDialog_progressLayout"), resources.getIdentifier("progress_dialog", "layout", "android")), null);
            this.mProgress = (ProgressBar) view.findViewById(resources.getIdentifier("progress", "id", "android"));
            this.mMessageView = (TextView) view.findViewById(resources.getIdentifier("message", "id", "android"));
            setView(view);
        }
        a.recycle();
        if (this.mMax > 0) {
