...
public class HwGlobalActions implements OnDismissListener, OnClickListener, ActionPressedCallback {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 6:
                    ...
                    Bitmap bitmap = HwGlobalActions.this.mBlurDrawable == null ? null : HwGlobalActions.this.mBlurDrawable.getBitmap();
                    if (!(bitmap == null || bitmap == blurBitmap)) {
                        bitmap.recycle();
                    }
                    if (blurBitmap != null) {
    ...
    private boolean isSDCardMounted() {
        ...
        if (storageManager != null) {
            for (StorageVolume storageVolume : storageManager.getVolumeList()) {
                if (storageVolume.isRemovable() && (storageVolume.getPath().contains("usb") ^ 1) != 0) {
    ...
    public void onGoToSetActionPressed() {
        ...
        StatisticalUtils.reportc(this.mContext, 26);
    }
    ...
    public void onDoNotNeedActionPressed() {
        ...
        this.mIsShowRecommend = false;
        sendBroadcast(1);
        StatisticalUtils.reportc(this.mContext, 27);
    }
    ...
    public void hideGlobalActionsView() {
        if (this.mGlobalActionsView != null) {
            ...
            Bitmap bitmap = this.mBlurDrawable == null ? null : this.mBlurDrawable.getBitmap();
            if (bitmap != null) {
                bitmap.recycle();
            }
        }
