...
public class ShutdownMenuAnimations {
    ...
    public static final Interpolator CubicBezier_33_33 = new CubicBezierInterpolator(0.2f, 0.5f, CONFIRM_SCALE, 0.5f);
    private static final int DEGREES_ROTATE = 360;
    private static final int DURATION_130MS = 130;
    private static final int DURATION_200MS = 200;
    ...
    private static final int ID_REBOOT_SCREENBLACK = 34603071;
    ...
    private void startConfirmEnterOrExitAnim(final View view, final boolean isEnter, final boolean isReboot) {
        ...
        if (this.ROTATION == ROTATION_NINETY) {
            ...
            if (System.getInt(mContext.getContentResolver(), "navigationbar_is_min", 0) != 0) {
                ...
                int navigationBarHeight = mContext.getResources().getDimensionPixelSize(17105147);
                this.imageLocationStart[0] = wm.getDefaultDisplay().getWidth() / 2;
    ...
    private AnimatorSet startConfirmTranslationAnimation(View view, int fromX, int fromY, boolean isEnter) {
        ...
        if (isEnter) {
            translateX = ObjectAnimator.ofFloat(view, "translationX", new float[]{(float) fromX, GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO});
            translateY = ObjectAnimator.ofFloat(view, "translationY", new float[]{(float) fromY, GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO});
            scaleX = ObjectAnimator.ofFloat(view, "scaleX", new float[]{CONFIRM_SCALE, 1.0f});
            scaleY = ObjectAnimator.ofFloat(view, "scaleY", new float[]{CONFIRM_SCALE, 1.0f});
        } else {
            translateX = ObjectAnimator.ofFloat(view, "translationX", new float[]{GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO, (float) fromX});
            translateY = ObjectAnimator.ofFloat(view, "translationY", new float[]{GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO, (float) fromY});
            scaleX = ObjectAnimator.ofFloat(view, "scaleX", new float[]{1.0f, CONFIRM_SCALE});
            scaleY = ObjectAnimator.ofFloat(view, "scaleY", new float[]{1.0f, CONFIRM_SCALE});
        }
        anims.add(translateX);
        anims.add(translateY);
        anims.add(scaleX);
    ...
    private AnimatorSet startViewStubAnimation(int toX, boolean isEnter, boolean isReboot) {
        ...
        if (isEnter) {
            if (isReboot) {
                translateX = ObjectAnimator.ofFloat(this.shutdown_view, "translationX", new float[]{GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO, (float) toX});
                alpha_view = ObjectAnimator.ofFloat(this.shutdown_view, "alpha", new float[]{1.0f, GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO});
                anims.add(ObjectAnimator.ofFloat(this.poweroff_hint_view, "alpha", new float[]{1.0f, GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO}));
            } else {
                translateX = ObjectAnimator.ofFloat(this.reboot_view, "translationX", new float[]{GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO, (float) toX});
                alpha_view = ObjectAnimator.ofFloat(this.reboot_view, "alpha", new float[]{1.0f, GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO});
            }
        } else if (isReboot) {
            translateX = ObjectAnimator.ofFloat(this.shutdown_view, "translationX", new float[]{(float) toX, GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO});
            alpha_view = ObjectAnimator.ofFloat(this.shutdown_view, "alpha", new float[]{GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO, 1.0f});
            anims.add(ObjectAnimator.ofFloat(this.poweroff_hint_view, "alpha", new float[]{GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO, 1.0f}));
        } else {
            translateX = ObjectAnimator.ofFloat(this.reboot_view, "translationX", new float[]{(float) toX, GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO});
            alpha_view = ObjectAnimator.ofFloat(this.reboot_view, "alpha", new float[]{GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO, 1.0f});
        }
        anims.add(translateX);
