...
public class HwAlertController extends AlertController {
    ...
    protected void setupView() {
        ...
        View buttonPanel = getWindow().findViewById(16908769);
        ...
        View customPanel = getWindow().findViewById(16908818);
        ProgressBar progress = (ProgressBar) getWindow().findViewById(16908301);
        if (buttonPanel != null && messageView != null && progress == null) {
            View topPanel = getWindow().findViewById(16909404);
            View contentPanel = getWindow().findViewById(16908811);
            ...
            if (customPanel == null || customPanel.getVisibility() == 8) {
                messageView.getViewTreeObserver().addOnPreDrawListener(new CustOnPreDrawListener(messageView));
            }
        }
    }
