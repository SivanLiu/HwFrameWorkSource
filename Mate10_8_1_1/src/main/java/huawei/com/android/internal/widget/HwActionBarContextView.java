...
public class HwActionBarContextView extends ActionBarContextView implements OnClickListener, ActionModeView {
    ...
    public HwActionBarContextView(Context context, AttributeSet attrs) {
        ...
        this.mOKMenuItem = new ActionMenuItem(context, 0, 16909120, 0, 0, context.getString(17039370));
        this.mCancelMenuItem = new ActionMenuItem(context, 0, 16908780, 0, 0, context.getString(17039360));
    }
    ...
    protected void initTitle() {
        ...
        if (titleLayout == null) {
            ...
            if (titleLayout != null) {
                this.mOK = (ImageView) titleLayout.findViewById(16909120);
                this.mCancel = (ImageView) titleLayout.findViewById(16908780);
                ...
                titleView = (TextView) titleLayout.findViewById(16908685);
                subTitleView = (TextView) titleLayout.findViewById(16908684);
                if (this.mOK != null) {
    ...
    public void onClick(View view) {
        ...
        if (callback != null && actionMode != null) {
            if (view.getId() == 16909120) {
                if (!callback.onMenuItemSelected((MenuBuilder) actionMode.getMenu(), this.mOKMenuItem)) {
                    actionMode.finish();
                }
            } else if (view.getId() == 16908780 && !callback.onMenuItemSelected((MenuBuilder) actionMode.getMenu(), this.mCancelMenuItem)) {
                actionMode.finish();
            }
        }
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (changed && getParent() != null) {
            ...
            if (vp != null && vp.getId() != 16909317 && vp.getId() != 16908682) {
