    ...
    public boolean getOffHostServices(String packageName, Callbacks callbacks) {
        ...
        try {
            ...
            for (int i = 0; i < apduServices.size(); i++) {
                ...
                Log.d(TAG, "getOffHostServices: seName = " + str);
                ...
                callbacks.onGetOffHostService(isLast, ((ApduServiceInfo) apduServices.get(i)).getDescription(), str, ((ApduServiceInfo) apduServices.get(i)).getBannerId(), groupDescription, ((ApduServiceInfo) apduServices.get(i)).getAidGroups());
            }
            return true;
        } catch (RemoteException e) {
            Log.e(TAG, "getOffHostServices failed", e);
