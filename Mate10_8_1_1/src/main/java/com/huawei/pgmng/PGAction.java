...
public class PGAction {
    ...
    protected static boolean isValid(int id) {
        if (id >= 10000 && id <= 10017) {
            return true;
        }
        if (id >= 20000 && id <= 20003) {
            return true;
        }
        if (id >= 30000 && id <= 30004) {
            return true;
        }
        if (id < 40000 || id > 40000) {
            return false;
        }
        return true;
    }
    ...
    public static int checkActionFlag(int actionId) {
        ...
        if (!(actionId == 10017 || actionId == 10016 || actionId == 10006)) {
            if (actionId != 10016) {
                return 3;
            }
        }
    ...
    public static int checkActionType(int actionId) {
        ...
        if (actionId >= 30000 && actionId < 40000) {
            return 3;
        }
        if (actionId >= 40000) {
            return 4;
