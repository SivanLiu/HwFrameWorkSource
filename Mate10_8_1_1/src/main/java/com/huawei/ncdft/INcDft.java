        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    ...
                    _result = reportNlpLocation(_arg0, _arg1, _arg2, providerRequest);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 5:
                    ...
                    _result = reportGnssApkName(_arg0, _arg1, locationRequest, data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 6:
                    ...
                    _result = reportNetworkInfo(_arg0, _arg1, networkInfo);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 7:
                    ...
                    _result = reportGnssLocation(_arg0, _arg1, location, data.readLong(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 8:
