...
public final class OPCollectConstant {
    ...
    public static final String APP_PROBE_ACTION_NAME = "RawAppProbe";
    public static final String APP_PROBE_COUNT_ACTION_NAME = "RawAppProbeCount";
    ...
    public static final String USER_INFO_ACTION_NAME = "RawUserInfoStatistic";
    ...
    public static String getActionNameFromSwitchName(String switchName) {
        if (switchName == null || EventIdConstant.PURPOSE_STR_BLANK.equalsIgnoreCase(switchName)) {
            return null;
        }
        if (APP_PROBE_COUNT_ACTION_NAME.equalsIgnoreCase(switchName)) {
            return APP_PROBE_COUNT_ACTION_NAME;
        }
        ...
        if (APP_PROBE_ACTION_NAME.equalsIgnoreCase(switchName)) {
            return APP_PROBE_ACTION_NAME;
        }
        if (USER_INFO_ACTION_NAME.equalsIgnoreCase(switchName)) {
            return USER_INFO_ACTION_NAME;
        }
