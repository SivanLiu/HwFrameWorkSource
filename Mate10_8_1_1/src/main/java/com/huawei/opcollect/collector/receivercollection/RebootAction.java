...
public class RebootAction extends Action {
    ...
    public void enable() {
        ...
        if (this.mReceiver == null) {
            ...
            this.mContext.registerReceiver(this.mReceiver, new IntentFilter("android.intent.action.REBOOT"), OPCollectUtils.OPCOLLECT_PERMISSION, OdmfCollectScheduler.getInstance().getCtrlHandler());
        }
    }
