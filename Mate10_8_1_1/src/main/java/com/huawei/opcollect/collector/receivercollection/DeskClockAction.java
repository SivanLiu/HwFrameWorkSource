...
public class DeskClockAction extends Action {
    private static final String CLOCK_ACTION_STRING = "com.android.deskclock.ALARM_ALERT";
    ...
    public void enable() {
        ...
        if (this.mReceiver == null && this.mContext != null) {
            ...
            this.mContext.registerReceiver(this.mReceiver, new IntentFilter(CLOCK_ACTION_STRING), null, OdmfCollectScheduler.getInstance().getCtrlHandler());
