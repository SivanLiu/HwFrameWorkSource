...
import com.huawei.android.totemweather.aidl.IRequestCallBack.Stub;
...
public class WeatherInfoAction extends Action implements ILocationListener {
    ...
    private HwWeatherData mHwWeatherData = null;
    private long mLastRequestTime = 0;
    private final Object mLock = new Object();
    private IRequestCityWeather mRequestWeather = null;
    private ServiceConnection mWeatherConnection = null;
    private IRequestCallBack mWeatherRequestCallBack = null;
    ...
    private static class MyWeatherRequestCallBack extends Stub {
        private final WeakReference<WeatherInfoAction> mService;
    ...
    private static class WeatherInfoHandler extends Handler {
        ...
        WeatherInfoHandler(WeatherInfoAction service) {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1) {
                action.mHwWeatherData = (HwWeatherData) msg.obj;
                action.perform();
            } else if (msg.what == 2) {
                ...
                try {
                    action.mRequestWeather = IRequestCityWeather.Stub.asInterface(msg.obj);
