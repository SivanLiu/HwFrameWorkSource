...
public class PowerConnectedAction extends Action {
    ...
    public static synchronized PowerConnectedAction getInstance(Context context) {
        PowerConnectedAction powerConnectedAction;
        synchronized (PowerConnectedAction.class) {
            if (sInstance == null) {
    ...
    public void enable() {
        ...
        if (this.mReceiver == null && this.mContext != null) {
            ...
            this.mContext.registerReceiver(this.mReceiver, new IntentFilter("android.intent.action.ACTION_POWER_CONNECTED"), OPCollectUtils.OPCOLLECT_PERMISSION, OdmfCollectScheduler.getInstance().getCtrlHandler());
    ...
    protected boolean execute() {
        ...
        String chargeType = EventIdConstant.PURPOSE_STR_BLANK;
        if (2 == chargePlug) {
            chargeType = "USB";
