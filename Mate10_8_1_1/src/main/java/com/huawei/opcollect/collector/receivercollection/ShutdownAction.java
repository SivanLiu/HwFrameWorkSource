...
public class ShutdownAction extends Action {
    ...
    public void enable() {
        ...
        if (this.mReceiver == null && this.mContext != null) {
            ...
            this.mContext.registerReceiver(this.mReceiver, new IntentFilter("android.intent.action.ACTION_SHUTDOWN"), OPCollectUtils.OPCOLLECT_PERMISSION, OdmfCollectScheduler.getInstance().getCtrlHandler());
            OPCollectLog.r("ShutdownAction", "enabled");
        }
    }

    protected boolean execute() {
        SysEventUtil.collectSysEventData(SysEventUtil.EVENT_SHUTDOWN_PHONE, SystemProperties.get(SHUTDOWN_ACTION_PROPERTY, EventIdConstant.PURPOSE_STR_BLANK));
        return true;
    }
