...
import com.huawei.opcollect.collector.probecollection.AppProbeAction;
...
import com.huawei.opcollect.collector.pullcollection.UserInfoAction;
...
public class ActionFactory {
    public static Action getSysInfoAction(Context context, String name) {
        ...
        if (ActionTableName.RAW_USER_INFO_STATISTIC.getValue().equals(name)) {
            return UserInfoAction.getInstance(context);
        }
        if (ActionTableName.RAW_APP_PROBE.getValue().equals(name)) {
            return AppProbeAction.getInstance(context);
        }
