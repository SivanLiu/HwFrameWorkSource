...
*/
        ...
        L_0x001a:
            ...
            com.huawei.hwsqlite.SQLiteDatabaseUtils.bindObjectToProgram(r5, r3, r8);	 Catch:{ SQLException -> 0x0032, all -> 0x0071 }
            goto L_0x0014;
        L_0x0032:
            r0 = move-exception;
            r8 = "SQLiteDatabaseUtils";	 Catch:{ SQLException -> 0x0032, all -> 0x0071 }
        ...
        L_0x0071:
            ...
            throw r8;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.huawei.hwsqlite.SQLiteDatabaseUtils.InsertHelper.insertInternal(android.content.ContentValues, boolean):long");
        }
...
*/
        ...
        L_0x0017:
            r0 = move-exception;
            r1 = "SQLiteDatabaseUtils";	 Catch:{ SQLException -> 0x0017, all -> 0x0039 }
        ...
        L_0x0039:
            ...
            throw r1;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.huawei.hwsqlite.SQLiteDatabaseUtils.InsertHelper.execute():long");
        }
        ...
        private void buildSQL() throws SQLException {
            StringBuilder sb = new StringBuilder(AppOpsManagerEx.TYPE_MICROPHONE);
            sb.append("INSERT INTO ");
            sb.append(this.mTableName);
            sb.append(" (");
            StringBuilder sbv = new StringBuilder(AppOpsManagerEx.TYPE_MICROPHONE);
            sbv.append("VALUES (");
            int i = 1;
            Cursor cursor = null;
            try {
    ...
    public static long queryNumEntries(SQLiteDatabase db, String table, String selection, String[] selectionArgs) {
        return longForQuery(db, "select count(*) from " + table + (!TextUtils.isEmpty(selection) ? " where " + selection : ""), selectionArgs);
    }
