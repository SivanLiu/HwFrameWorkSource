...
public class SmartLowpowerBrowser implements ISmartLowpowerBrowser {
    ...
    private boolean detectAnimation(long drawingTime, boolean viewScrollChanged, boolean handlingPointerEvent) {
        ...
        int DETECT_DEPTH = 7;
        if (stackTraceElements[7].getClassName().equals("org.chromium.android_webview.AwContents")) {
            equals = stackTraceElements[7].getMethodName().equals("postInvalidateOnAnimation");
        } else {
            equals = LOG;
        }
        if (!equals) {
            ...
            if (stackTraceElements[8].getClassName().equals("org.chromium.android_webview.AwContents")) {
                equals = stackTraceElements[8].getMethodName().equals("postInvalidateOnAnimation");
            } else {
                equals = LOG;
            }
            if (!equals) {
