...
public class HwDialogStubImpl implements HwDialogStub {
    ...
    private OnGlobalLayoutListener mOnGlobalLayoutListener = new OnGlobalLayoutListener() {
        ...
        private int getScreenHeight() {
            ...
            this.screenHeight = res.getDisplayMetrics().heightPixels - res.getDimensionPixelSize(17105265);
            return this.screenHeight;
        }
    };
    ...
    private void setState(View view, int direction) {
        if (this.mContext != null) {
            ...
            int offset = (((res.getDisplayMetrics().heightPixels - res.getDimensionPixelSize(17105265)) - (view != null ? view.getHeight() : 0)) / 2) - ((int) ((res.getDisplayMetrics().density * 36.0f) + 0.5f));
            if (offset < 0) {
                offset = 0;
            }
            this.mOffset = offset;
