...
import com.huawei.android.pushagent.utils.b.e;
...
public class TrsReq {
    ...
    public TrsReq(Context context, String str, String str2) {
        this.mccmnc = f.ga(context);
        this.pushDeviceId = f.gk(context);
        this.deviceIdType = f.gt(context);
        this.chanMode = b.kp(context).km();
        this.connId = str2;
        this.belongid = str;
        this.version = f.gs(context);
        ...
        if (1 == this.chanMode) {
            this.sn = new e().getDeviceId();
        }
    }

    private long getAgentV(Context context) {
        long l = com.huawei.android.pushagent.utils.tools.b.l(context, "com.huawei.android.pushagent");
        if (l < 0) {
            return -1;
        }
        return l;
