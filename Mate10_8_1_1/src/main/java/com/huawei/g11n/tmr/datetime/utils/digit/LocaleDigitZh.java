        ...
        while (matcher.find()) {
            ...
            switch (hanzi.length()) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    res = (((((Integer) numMap.get(Character.valueOf(hanzi.charAt(0)))).intValue() * FaceCamera.RET_OPEN_CAMERA_OK) + (((Integer) numMap.get(Character.valueOf(hanzi.charAt(1)))).intValue() * 100)) + (((Integer) numMap.get(Character.valueOf(hanzi.charAt(2)))).intValue() * 10)) + ((Integer) numMap.get(Character.valueOf(hanzi.charAt(3)))).intValue();
                    break;
                default:
                    break;
            }
