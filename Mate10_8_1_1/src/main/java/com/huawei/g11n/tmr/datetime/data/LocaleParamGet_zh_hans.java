    ...
    public HashMap<String, String> date = new HashMap<String, String>() {
        {
            ...
            put("param_digitYear", "\\u0604|二[零一二三四五六七八九]{3}|(?<![零一二三四五六七八九])[零一二三四][零一二三四五六七八九]");
            ...
            put("param_pastForward", "昨[日天]?\\(?|前[日天]\\(?|去年|前年|上月|上个月|上个?|1[0-9]{3}年|一[一二三四五六七八九零]{3}年|[五六七八九][一二三四五六七八九零]年");
