        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    _result = confirm(data.readString(), com.huawei.nearbysdk.DTCP.ITransmitCallback.Stub.asInterface(data.readStrongBinder()));
                ...
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    NearbyDevice _result2 = getSenderDevice();
                    reply.writeNoException();
                    if (_result2 != null) {
                        reply.writeInt(1);
