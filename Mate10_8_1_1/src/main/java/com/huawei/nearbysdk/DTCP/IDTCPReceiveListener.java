        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 2:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        baseShareInfo = (BaseShareInfo) BaseShareInfo.CREATOR.createFromParcel(data);
                    } else {
                        baseShareInfo = null;
                    }
                    onPreviewReceive(baseShareInfo, com.huawei.nearbysdk.DTCP.IDTCPReceiver.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
