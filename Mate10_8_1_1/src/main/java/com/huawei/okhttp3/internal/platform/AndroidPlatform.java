    ...
    static final class CloseGuard {
        ...
        static CloseGuard get() {
            ...
            try {
                ...
                method = closeGuardClass.getMethod("warnIfOpen", new Class[0]);
            } catch (Exception e) {
                getMethod = null;
                openMethod = null;
                method = null;
            }
            return new CloseGuard(getMethod, openMethod, method);
        }
    }
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        optionalMethod = getAlpnSelectedProtocol;
                    } catch (ClassNotFoundException e) {
                        optionalMethod = getAlpnSelectedProtocol;
                    }
                } catch (ClassNotFoundException e2) {
                }
                return new AndroidPlatform(sslParametersClass, setUseSessionTickets, setHostname, optionalMethod, setAlpnProtocols);
