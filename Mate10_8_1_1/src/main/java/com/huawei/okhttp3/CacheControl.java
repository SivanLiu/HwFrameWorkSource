        ...
        for (int i = 0; i < size; i++) {
            ...
            while (pos < value.length()) {
                ...
                if ("no-cache".equalsIgnoreCase(directive)) {
                    ...
                    maxAgeSeconds = HttpHeaders.parseSeconds(str, -1);
                } else if ("s-maxage".equalsIgnoreCase(directive)) {
                    sMaxAgeSeconds = HttpHeaders.parseSeconds(str, -1);
                    ...
                    maxStaleSeconds = HttpHeaders.parseSeconds(str, Integer.MAX_VALUE);
                } else if ("min-fresh".equalsIgnoreCase(directive)) {
                    minFreshSeconds = HttpHeaders.parseSeconds(str, -1);
