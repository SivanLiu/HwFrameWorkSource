        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TRANSACTION_setCamera1VideoSurface /*25*/:
                    ...
                    setCamera1VideoSurface(surface);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setCamera2VideoSurface /*26*/:
                    ...
                    setCamera2VideoSurface(surface);
                    reply.writeNoException();
                    return true;
                ...
                case 33:
                    ...
                    setVideoFormat(imageDescriptor);
                    reply.writeNoException();
                    return true;
                case 34:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setPreviewFormatLine2(imageDescriptor);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setCaptureFormatLine2 /*35*/:
                    ...
                    setCaptureFormatLine2(imageDescriptor);
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setVideoFormatLine2 /*36*/:
                    ...
                    setVideoFormatLine2(imageDescriptor);
                    reply.writeNoException();
                    return true;
                case 1598968902:
