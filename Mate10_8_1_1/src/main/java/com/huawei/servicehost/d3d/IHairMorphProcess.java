    ...
    public static abstract class Stub extends Binder implements IHairMorphProcess {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ImageWrap imageWrap;
                    ImageWrap imageWrap2;
                    ImageWrap imageWrap3;
                    ImageWrap imageWrap4;
                    ImageWrap imageWrap5;
                    int i;
                    ...
                    if (data.readInt() != 0) {
                        imageWrap2 = (ImageWrap) ImageWrap.CREATOR.createFromParcel(data);
                    } else {
                        imageWrap2 = null;
                    }
                    if (data.readInt() != 0) {
                        imageWrap3 = (ImageWrap) ImageWrap.CREATOR.createFromParcel(data);
                    } else {
                        imageWrap3 = null;
                    }
                    if (data.readInt() != 0) {
                        imageWrap4 = (ImageWrap) ImageWrap.CREATOR.createFromParcel(data);
                    } else {
                        imageWrap4 = null;
                    }
                    if (data.readInt() != 0) {
                        imageWrap5 = (ImageWrap) ImageWrap.CREATOR.createFromParcel(data);
                    } else {
                        imageWrap5 = null;
                    }
                    boolean _result = process(imageWrap, imageWrap2, imageWrap3, imageWrap4, imageWrap5);
