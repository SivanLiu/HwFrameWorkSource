...
public interface IImsUt extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IImsUt {
        ...
        static final int TRANSACTION_getUtIMPUFromNetwork = 19;
        static final int TRANSACTION_isSupportCFT = 20;
        static final int TRANSACTION_processECT = 18;
        ...
        static final int TRANSACTION_updateCallBarringOption = 21;
        static final int TRANSACTION_updateCallForward = 11;
        static final int TRANSACTION_updateCallForwardUncondTimer = 22;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 19:
                    data.enforceInterface(DESCRIPTOR);
                    String _result2 = getUtIMPUFromNetwork();
                    reply.writeNoException();
                    reply.writeString(_result2);
                    return true;
                case 20:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result3 = isSupportCFT();
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 21:
                    data.enforceInterface(DESCRIPTOR);
                    _result = updateCallBarringOption(data.readString(), data.readInt(), data.readInt() != 0, data.createStringArray());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 22:
                    data.enforceInterface(DESCRIPTOR);
                    _result = updateCallForwardUncondTimer(data.readInt(), data.readInt(), data.readInt(), data.readInt(), data.readInt(), data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 1598968902:
    ...
    int updateCallBarringOption(String str, int i, boolean z, String[] strArr) throws RemoteException;
