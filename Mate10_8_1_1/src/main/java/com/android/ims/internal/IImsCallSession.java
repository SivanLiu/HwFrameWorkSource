...
public interface IImsCallSession extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IImsCallSession {
        ...
        static final int TRANSACTION_sendRttMessage = 33;
        static final int TRANSACTION_sendRttModifyRequest = 31;
        static final int TRANSACTION_sendRttModifyResponse = 32;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 31:
                    ...
                    sendRttModifyRequest(imsCallProfile2);
                    reply.writeNoException();
                    return true;
                case 32:
                    data.enforceInterface(DESCRIPTOR);
                    sendRttModifyResponse(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 33:
                    data.enforceInterface(DESCRIPTOR);
