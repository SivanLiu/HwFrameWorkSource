    ...
    public class ImsCallSessionListenerProxy extends com.android.ims.internal.ImsCallSession.Listener {
        ...
        public void callSessionTerminated(ImsCallSession session, ImsReasonInfo reasonInfo) {
            ...
            if (reasonInfo.getExtraMessage() != null && reasonInfo.getExtraMessage().trim().equals(ImsCall.WIFI_LTE_ERROR_MESSAGE)) {
                ...
                reasonInfo = new ImsReasonInfo(1514, reasonInfo.getExtraCode(), reasonInfo.getExtraMessage());
    ...
    public List<ConferenceParticipant> getConferenceParticipants() {
        synchronized (this.mLockObj) {
            ...
            if (this.mConferenceParticipants == null) {
                ...
                r0 = new ArrayList(this.mConferenceParticipants);
                return r0;
            }
        }
    }
    ...
    private void merge(int callType) throws ImsException {
        ...
        synchronized (this.mLockObj) {
            ...
            if (this.mMergePeer != null && this.mMergePeer.mUpdateRequest != 0) {
                ...
                if (this.mHold || this.mContext.getResources().getBoolean(17957095)) {
            ...
            if (isMergeHost() || (isMergePeer() ^ 1) == 0) {
                if (isMergeHost()) {
                    ...
                    if (isCallSessionMergePending()) {
                        ...
                        z = this.mMergePeer.isCallSessionMergePending() ^ 1;
                    }
                    if (!isMultiparty()) {
                    ...
                    if (isCallSessionMergePending()) {
                        ...
                        z = this.mMergeHost.isCallSessionMergePending() ^ 1;
                    }
                    if (this.mMergeHost.isMultiparty()) {
                        z = isCallSessionMergePending() ^ 1;
                    } else {
                        z &= isSessionAlive(this.mMergeHost.mTransientConferenceSession);
                    }
                } else {
