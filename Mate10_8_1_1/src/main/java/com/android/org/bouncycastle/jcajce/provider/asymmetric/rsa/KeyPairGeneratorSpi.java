...
public class KeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    public void initialize(int strength, SecureRandom random) {
        ...
        this.param = new RSAKeyGenerationParameters(bigInteger, random, strength, PrimeCertaintyCalculator.getDefaultCertainty(strength));
        this.engine.init(this.param);
    }
    ...
    public void initialize(AlgorithmParameterSpec params, SecureRandom random) throws InvalidAlgorithmParameterException {
        if (params instanceof RSAKeyGenParameterSpec) {
            ...
            this.param = new RSAKeyGenerationParameters(publicExponent, random, rsaParams.getKeysize(), PrimeCertaintyCalculator.getDefaultCertainty(2048));
            this.engine.init(this.param);
            return;
        }
