    ...
    private static class Parser {
        ...
        private InsertCommand parseInsertCommand() {
            ...
            while (true) {
                ...
                if (argument == null) {
                    break;
                } else if (ARGUMENT_URI.equals(argument)) {
        ...
        private DeleteCommand parseDeleteCommand() {
            ...
            while (true) {
                ...
                if (argument == null) {
                    ...
                    str = argumentValueRequired(argument);
                } else {
                    throw new IllegalArgumentException("Unsupported argument: " + argument);
                }
            }
            if (uri != null) {
                return new DeleteCommand(uri, userId, str);
            }
            throw new IllegalArgumentException("Content provider URI not specified. Did you specify --uri argument?");
        }
        ...
        public QueryCommand parseQueryCommand() {
            ...
            if (uri != null) {
                return new QueryCommand(uri, userId, projection, str, sort);
            }
            throw new IllegalArgumentException("Content provider URI not specified. Did you specify --uri argument?");
        }
