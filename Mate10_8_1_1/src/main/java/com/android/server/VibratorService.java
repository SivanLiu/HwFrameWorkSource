...
public class VibratorService extends Stub implements InputDeviceListener {
    ...
    VibratorService(Context context) {
        ...
        VibrationEffect clickEffect = createEffect(getLongIntArray(context.getResources(), 17236044));
        VibrationEffect doubleClickEffect = VibrationEffect.createWaveform(new long[]{0, 30, 100, 30}, -1);
        VibrationEffect tickEffect = createEffect(getLongIntArray(context.getResources(), 17235996));
