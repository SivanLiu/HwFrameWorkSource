...
public class LockdownVpnTracker {
    ...
    private void handleStateChangedLocked() {
        ...
        int equals2;
        if (egressProp != null) {
            equals2 = TextUtils.equals(this.mAcceptedEgressIface, egressProp.getInterfaceName()) ^ 1;
        } else {
            equals2 = 1;
        }
        ...
        if (this.mErrorCount > 4) {
            showNotification(17041216, 17303713);
            ...
            if (vpnInfo.isConnected() && vpnConfig != null) {
                ...
                if (!TextUtils.equals(iface, this.mAcceptedIface) || !sourceAddrs.equals(this.mAcceptedSourceAddr)) {
                    ...
                    showNotification(17041213, 17303712);
            ...
            showNotification(17041214, 17303713);
