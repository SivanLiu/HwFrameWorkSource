...
public class ResetPassWord {
    ...
    public static String decodeCurrentPwd(String mainSpacePin, String pwdQuestionAnswer) {
        if (TextUtils.isEmpty(mainSpacePin) || TextUtils.isEmpty(pwdQuestionAnswer) || (FileUtils.verifyFile().booleanValue() ^ 1) != 0) {
        ...
        String origCredential = "";
        try {
            origCredential = new String(origPwd, "UTF-8");
