...
public class ESEInfoManager {
    ...
    public String getCplc() {
        ...
        try {
            ...
            if (channel != null) {
                ...
                if (resultStr != null && resultStr.startsWith("9F7F") && resultStr.endsWith("9000")) {
                    str = resultStr.substring(6, (HexByteHelper.hexStringToDecimalInteger(resultStr.substring(4, 6)) * 2) + 6);
                } else {
            ...
            HwLog.e("getCplc Exception : Session or Channel operation failed");
            HwLog.d("getCplc, channel close begin.");
            channel.close();
            HwLog.d("getCplc, channel close end.");
        ...
        HwLog.d("getCplc : " + (str == null ? "failed" : GestureNavConst.REPORT_SUCCESS));
        return str;
    }
