...
public class HwSecurityService extends SystemService {
    ...
    private static final boolean SUPPORT_HW_IUDF = StorageUtils.SDCARD_ROMOUNTED_STATE.equalsIgnoreCase(SystemProperties.get("ro.config.support_iudf", StorageUtils.SDCARD_RWMOUNTED_STATE));
    ...
    private static final boolean SUPPORT_PRIVSPACE = StorageUtils.SDCARD_ROMOUNTED_STATE.equalsIgnoreCase(SystemProperties.get("ro.config.support_privacyspace", StorageUtils.SDCARD_RWMOUNTED_STATE));
    ...
    public void onStart() {
        ...
        if (IS_CHINA_AREA) {
            registerPlugin(12, 1, 1000, HwAntiMalPlugin.CREATOR, null, false);
        }
