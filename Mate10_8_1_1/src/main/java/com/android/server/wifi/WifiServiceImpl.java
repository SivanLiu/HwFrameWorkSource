...
public class WifiServiceImpl extends Stub {
    ...
    public WifiServiceImpl(Context context, WifiInjector wifiInjector, AsyncChannel asyncChannel) {
        ...
        if (Build.PERMISSIONS_REVIEW_REQUIRED) {
            ...
            z = context.getResources().getBoolean(17956996);
        }
    ...
    public void startScan(ScanSettings settings, WorkSource workSource, String packageName) {
        ...
        if (this.mPowerManager.isScreenOn() || ("com.huawei.ca".equals(packageName) ^ 1) == 0 || ("com.huawei.parentcontrol".equals(packageName) ^ 1) == 0 || Binder.getCallingUid() == 1000 || ("com.huawei.hidisk".equals(packageName) ^ 1) == 0) {
            ...
            if (isRequestFromBackground(packageName)) {
                ...
                if ((2 != this.mWifiStatStore.getWifiPerformanceState() || ("android".equals(packageName) ^ 1) == 0) && (lastScanMs == 0 || elapsedRealtime - lastScanMs >= this.mBackgroundThrottleInterval)) {
                    synchronized (this.mLastScanTimestamps) {
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiServiceImpl_83566(String ifaceName, int mode) {
    ...
    public WifiActivityEnergyInfo reportActivityInfo() {
        ...
        if (this.mWifiStateMachineChannel != null) {
            ...
            if (stats != null) {
                long[] txTimePerLevel;
                long rxIdleCurrent = (long) this.mContext.getResources().getInteger(17694911);
                long rxCurrent = (long) this.mContext.getResources().getInteger(17694869);
                long txCurrent = (long) this.mContext.getResources().getInteger(17694919);
                double voltage = ((double) this.mContext.getResources().getInteger(17694916)) / 1000.0d;
    ...
    public int addOrUpdateNetwork(WifiConfiguration config) {
        ...
        if (config.isPasspoint()) {
            ...
            this.mHwWifiCHRService = HwWifiServiceFactory.getHwWifiCHRService();
            if (this.mHwWifiCHRService != null) {
                this.mHwWifiCHRService.updateApkChangewWifiStatus(10, getAppName(Binder.getCallingPid()));
            }
            if (this.mWifiStateMachineChannel != null) {
    ...
    public boolean removeNetwork(int netId) {
        ...
        this.mHwWifiCHRService = HwWifiServiceFactory.getHwWifiCHRService();
        if (this.mHwWifiCHRService != null) {
            this.mHwWifiCHRService.updateApkChangewWifiStatus(12, getAppName(Binder.getCallingPid()));
        }
        if (this.mWifiStateMachineChannel != null) {
    ...
    private void registerForBroadcasts() {
        ...
        if (this.mContext.getResources().getBoolean(17957065)) {
