    ...
    public List<APInfoData> getAllApInfos() {
        synchronized (this.mLock) {
            ...
            if (this.mDatabase == null || (this.mDatabase.isOpen() ^ 1) != 0) {
                ...
                r0 = null;
                try {
                    r0 = this.mDatabase.rawQuery("SELECT * FROM BSSIDTable", null);
                    while (r0.moveToNext()) {
                        infos.add(new APInfoData(r0.getString(r0.getColumnIndex("bssid")), r0.getString(r0.getColumnIndex("ssid")), r0.getInt(r0.getColumnIndex("inbacklist")), r0.getInt(r0.getColumnIndex(HwDualBandMessageUtil.MSG_KEY_AUTHTYPE)), r0.getLong(r0.getColumnIndex(WifiScanGenieDataBaseImpl.CHANNEL_TABLE_TIME))));
                    }
                    if (r0 != null) {
                        r0.close();
                    }
