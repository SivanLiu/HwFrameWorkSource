...
public class BackgroundScanScheduler {
    ...
    private static final int[] PREDEFINED_BUCKET_PERIODS = new int[]{30000, 120000, 480000, 10000, 60000, 1920000, WifiConnectivityManager.MAX_CONNECTION_ATTEMPTS_TIME_INTERVAL_MS, 960000, 3840000, -1};
