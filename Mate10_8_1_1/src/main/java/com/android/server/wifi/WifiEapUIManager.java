...
public class WifiEapUIManager {
    ...
    public void showDialog(String title, String message) {
        ...
        this.mDialog.getWindow().setType(HwWifiLogMsgID.EVENT_UPDATE_WIFI_STATE);
    ...
    public void showDialog(int errorcode) {
        showDialog(Resources.getSystem().getString(33686093), getMessage(errorcode));
    }

    private String getMessage(int errorcode) {
        String message = "";
        String[] errorMessages = Resources.getSystem().getStringArray(33816592);
