...
public class HwMSSArbitrager {
    ...
    private BroadcastReceiver mBcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("android.intent.action.BATTERY_CHANGED".equals(action)) {
                ...
                if (SystemProperties.getInt("runtime.hwmss.debug", 0) == 0 && HwMSSArbitrager.this.isChargePluggedin() && (HwMSSArbitrager.this.isP2PConnected() ^ 1) != 0 && (HwMSSArbitrager.this.mWiFiApMode ^ 1) != 0) {
    ...
    public boolean setMSSCurrentState(MSSState state) {
        ...
        if (this.wcsm != null) {
            this.wcsm.updateMSSState(this.mMSSCurrentState.toString());
        }
    ...
    public boolean isMSSAllowed(int direction, int freq) {
        ...
        if (direction == 2 && this.sisoFixFlag) {
            ...
            if (!this.mWiFiApMode) {
                if (!isWiFiConnected()) {
                    ...
                    return false;
                } else if (SystemProperties.getInt("runtime.hwmss.blktest", 0) == 0 && isInMSSBlacklist()) {
