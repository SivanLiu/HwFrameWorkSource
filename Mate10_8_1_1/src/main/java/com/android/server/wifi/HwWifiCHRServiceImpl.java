...
public class HwWifiCHRServiceImpl extends Handler implements HwWifiCHRService {
    ...
    private void updateSettingsIfNeed() {
        long now = SystemClock.elapsedRealtime();
        if (now - this.mGetSettingTimestamp > 60000) {
        ...
        if (apkName != null) {
            ...
            switch (apkAction) {
                ...
                case 8:
                    ...
                    break;
                case 10:
                    HwWifiStatStoreImpl.getDefault().updateApkChangewWifiStatus(10, apkName, 1);
                    break;
                case 11:
                    HwWifiStatStoreImpl.getDefault().updateApkChangewWifiStatus(11, apkName, 1);
                    break;
                case 12:
                    HwWifiStatStoreImpl.getDefault().updateApkChangewWifiStatus(12, apkName, 1);
                    break;
            }
        }
    }
