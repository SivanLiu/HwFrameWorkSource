            ...
            if (currRssi != HuaweiWifiWatchdogStateMachine.INVALID_RSSI) {
                if (HuaweiWifiWatchdogStateMachine.this.mPoorNetRssiTH < -75) {
                    if (currRssi <= HuaweiWifiWatchdogStateMachine.this.mPoorNetRssiTH) {
                        ...
                        HuaweiWifiWatchdogStateMachine huaweiWifiWatchdogStateMachine = HuaweiWifiWatchdogStateMachine.this;
                        huaweiWifiWatchdogStateMachine.mRssiTHValidTime = huaweiWifiWatchdogStateMachine.mRssiTHValidTime + 30000;
                            ...
                            if (this.mPktChkCnt >= 1) {
                                ...
                                if (pTot > 0) {
                                    ...
                                    if (!this.isFirstEnterMontoringState) {
                                        ...
                                        boolean z = HuaweiWifiWatchdogStateMachine.this.mCurrRssi < HuaweiWifiWatchdogStateMachine.this.mPoorNetRssiRealTH ? !isRttBadForLowRssi ? lossRateVeryBad : true : false;
                                        ...
                                        boolean z2 = (isWlanLossRateBad && isRttBadForCongestion) ? true : isWlanLossRateBad ? isTcpRetranBad : false;
