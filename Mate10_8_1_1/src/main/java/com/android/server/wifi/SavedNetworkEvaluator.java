...
public class SavedNetworkEvaluator extends AbsSavedNetworkEvaluator implements NetworkEvaluator {
    ...
    public SavedNetworkEvaluator(Context context, WifiConfigManager configManager, Clock clock, LocalLog localLog, WifiConnectivityHelper connectivityHelper) {
        ...
        this.mRssiScoreSlope = context.getResources().getInteger(17694878);
        this.mRssiScoreOffset = context.getResources().getInteger(17694877);
        this.mSameBssidAward = context.getResources().getInteger(17694879);
        this.mSameNetworkAward = context.getResources().getInteger(17694889);
        this.mLastSelectionAward = context.getResources().getInteger(17694875);
        this.mSecurityAward = context.getResources().getInteger(17694880);
        this.mBand5GHzAward = context.getResources().getInteger(17694872);
    ...
    public WifiConfiguration evaluateNetworks(List<ScanDetail> scanDetails, WifiConfiguration currentNetwork, String currentBssid, boolean connected, boolean untrustedNetworkAllowed, List<Pair<ScanDetail, WifiConfiguration>> connectableNetworks) {
        ...
        for (ScanDetail scanDetail : scanDetails) {
            ...
            if (this.mWifiConfigManager.getConfiguredNetworkForScanDetailAndCache(scanDetail) != null) {
                ...
                List<WifiConfiguration> associatedConfigurations = new ArrayList(Arrays.asList(new WifiConfiguration[]{this.mWifiConfigManager.getConfiguredNetworkForScanDetailAndCache(scanDetail)}));
                ...
                } else if (highestScoreOfScanResult > highestScore || (highestScoreOfScanResult == highestScore && r20 != null && scanResult.level > r20.level)) {
