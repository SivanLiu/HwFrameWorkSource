...
public class WifiInjector {
    ...
    public WifiInjector(Context context) {
        if (context == null) {
            ...
            this.mCountryCode = HwWifiServiceFactory.getHwWifiServiceManager().createHwWifiCountryCode(this.mContext, this.mWifiNative, SystemProperties.get(BOOT_DEFAULT_WIFI_COUNTRY_CODE), this.mContext.getResources().getBoolean(17957074));
            ...
            this.mIpConfigStore = new IpConfigStore(new DelayedDiskWrite());
            this.mWifiConfigManager = HwWifiServiceFactory.getHwWifiServiceManager().createHwWifiConfigManager(this.mContext, this.mClock, UserManager.get(this.mContext), TelephonyManager.from(this.mContext), this.mWifiKeyStore, this.mWifiConfigStore, this.mWifiPermissionsUtil, this.mWifiPermissionsWrapper, new NetworkListStoreData(this.mContext), new DeletedEphemeralSsidsStoreData());
    ...
    public WifiConnectivityManager makeWifiConnectivityManager(WifiInfo wifiInfo, boolean hasConnectionRequests) {
        return HwWifiServiceFactory.getHwWifiServiceManager().createHwWifiConnectivityManager(this.mContext, this.mWifiStateMachine, getWifiScanner(), this.mWifiConfigManager, wifiInfo, this.mWifiNetworkSelector, this.mWifiConnectivityHelper, this.mWifiLastResortWatchdog, this.mOpenNetworkNotifier, this.mWifiMetrics, this.mWifiStateMachineHandlerThread.getLooper(), this.mClock, this.mConnectivityLocalLog, hasConnectionRequests, this.mFrameworkFacade, this.mSavedNetworkEvaluator, this.mScoredNetworkEvaluator, this.mPasspointNetworkEvaluator);
    }
