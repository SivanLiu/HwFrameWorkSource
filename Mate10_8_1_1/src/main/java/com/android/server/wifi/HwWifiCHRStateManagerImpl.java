...
import com.android.server.wifi.ABS.HwABSCHRBlackListEvent;
import com.android.server.wifi.ABS.HwABSCHRExEvent;
import com.android.server.wifi.ABS.HwABSCHRManager;
import com.android.server.wifi.ABS.HwABSCHRStatistics;
import com.android.server.wifi.HwQoE.HiDataCHRHandoverInfo;
import com.android.server.wifi.HwQoE.HiDataCHRMachineInfo;
import com.android.server.wifi.HwQoE.HiDataCHRManager;
import com.android.server.wifi.HwQoE.HiDataCHRStallInfo;
import com.android.server.wifi.HwQoE.HiDataCHRStatisticsInfo;
...
public class HwWifiCHRStateManagerImpl extends Handler implements HwWifiCHRStateManager {
    ...
    private static final int LINKSPEED_GEAR = 6;
    ...
    private static final String STREAMING_SLOWLY_BAD_QOE = "STREAMING_SLOWLY_BAD_QOE";
    ...
    private static final int UPLOAD_HIDATA_CNT = 20;
    ...
    private long mFirstHiDataChrTimeStamp = 0;
    ...
    private short usLastAP_channel = (short) 0;
...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find block by offset: 0x0022 in list [B:6:0x001d]
...
*/
        ...
        r6 = this;
        r0 = 0;
        r2 = r6.mLock;	 Catch:{ InterruptedException -> 0x0023, all -> 0x004a }
        r4 = 1;	 Catch:{ InterruptedException -> 0x0023, all -> 0x004a }
        r3 = java.util.concurrent.TimeUnit.SECONDS;	 Catch:{ InterruptedException -> 0x0023, all -> 0x004a }
        r0 = r2.tryLock(r4, r3);	 Catch:{ InterruptedException -> 0x0023, all -> 0x004a }
        if (r0 == 0) goto L_0x001b;	 Catch:{ InterruptedException -> 0x0023, all -> 0x004a }
    L_0x000d:
        r2 = "HwWifiCHRStateManager";	 Catch:{ InterruptedException -> 0x0023, all -> 0x004a }
        r3 = "clearHwCHRAccessNetworkEventInfoList";	 Catch:{ InterruptedException -> 0x0023, all -> 0x004a }
        android.util.Log.d(r2, r3);	 Catch:{ InterruptedException -> 0x0023, all -> 0x004a }
        r2 = r6.mHwCHRAccessNetworkEventInfoList;	 Catch:{ InterruptedException -> 0x0023, all -> 0x004a }
        r2.clear();	 Catch:{ InterruptedException -> 0x0023, all -> 0x004a }
    L_0x001b:
    ...
    L_0x0023:
        r1 = move-exception;
        r2 = HWFLOW;	 Catch:{ InterruptedException -> 0x0023, all -> 0x004a }
        if (r2 == 0) goto L_0x0042;	 Catch:{ InterruptedException -> 0x0023, all -> 0x004a }
    L_0x0028:
        r2 = "HwWifiCHRStateManager";	 Catch:{ InterruptedException -> 0x0023, all -> 0x004a }
        r3 = new java.lang.StringBuilder;	 Catch:{ InterruptedException -> 0x0023, all -> 0x004a }
        r3.<init>();	 Catch:{ InterruptedException -> 0x0023, all -> 0x004a }
        r4 = "clearHwCHRAccessNetworkEventInfoList";	 Catch:{ InterruptedException -> 0x0023, all -> 0x004a }
        r3 = r3.append(r4);	 Catch:{ InterruptedException -> 0x0023, all -> 0x004a }
        r3 = r3.append(r1);	 Catch:{ InterruptedException -> 0x0023, all -> 0x004a }
        r3 = r3.toString();	 Catch:{ InterruptedException -> 0x0023, all -> 0x004a }
        android.util.Log.d(r2, r3);	 Catch:{ InterruptedException -> 0x0023, all -> 0x004a }
    L_0x0042:
        if (r0 == 0) goto L_0x0022;
    L_0x0044:
    ...
    L_0x0052:
        throw r2;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.wifi.HwWifiCHRStateManagerImpl.clearHwCHRAccessNetworkEventInfoList():void");
    }

    public void syncAddHwCHRAccessNetworkEventInfoList(com.android.server.wifi.HwCHRAccessNetworkEventInfo r7) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find block by offset: 0x0049 in list [B:12:0x0044]
	at jadx.core.utils.BlockUtils.getBlockByOffset(BlockUtils.java:43)
	at jadx.core.dex.instructions.IfNode.initBlocks(IfNode.java:60)
	at jadx.core.dex.visitors.blocksmaker.BlockFinish.initBlocksInIfNodes(BlockFinish.java:48)
	at jadx.core.dex.visitors.blocksmaker.BlockFinish.visit(BlockFinish.java:33)
...
*/
    ...
    L_0x0004:
        r2 = "HwWifiCHRStateManager";
        r3 = new java.lang.StringBuilder;
        r3.<init>();
        r4 = "====syncAddHwCHRAccessNetworkEventInfoList getEventId =";
        r3 = r3.append(r4);
        r4 = r7.getEventId();
        r3 = r3.append(r4);
        r3 = r3.toString();
    ...
    L_0x0022:
        r0 = 0;
        r2 = r6.mLock;	 Catch:{ InterruptedException -> 0x004a, all -> 0x0071 }
        r4 = 1;	 Catch:{ InterruptedException -> 0x004a, all -> 0x0071 }
        r3 = java.util.concurrent.TimeUnit.SECONDS;	 Catch:{ InterruptedException -> 0x004a, all -> 0x0071 }
        r0 = r2.tryLock(r4, r3);	 Catch:{ InterruptedException -> 0x004a, all -> 0x0071 }
        if (r0 == 0) goto L_0x0042;	 Catch:{ InterruptedException -> 0x004a, all -> 0x0071 }
    L_0x002f:
        r2 = r6.mHwCHRAccessNetworkEventInfoList;	 Catch:{ InterruptedException -> 0x004a, all -> 0x0071 }
        r2 = r2.size();	 Catch:{ InterruptedException -> 0x004a, all -> 0x0071 }
        r3 = 20;	 Catch:{ InterruptedException -> 0x004a, all -> 0x0071 }
        if (r2 < r3) goto L_0x003d;	 Catch:{ InterruptedException -> 0x004a, all -> 0x0071 }
    L_0x0039:
        r2 = 5;	 Catch:{ InterruptedException -> 0x004a, all -> 0x0071 }
        r6.reportHwCHRAccessNetworkEventInfoList(r2);	 Catch:{ InterruptedException -> 0x004a, all -> 0x0071 }
    L_0x003d:
        r2 = r6.mHwCHRAccessNetworkEventInfoList;	 Catch:{ InterruptedException -> 0x004a, all -> 0x0071 }
        r2.add(r7);	 Catch:{ InterruptedException -> 0x004a, all -> 0x0071 }
    L_0x0042:
    ...
    L_0x004a:
        r1 = move-exception;
        r2 = HWFLOW;	 Catch:{ InterruptedException -> 0x004a, all -> 0x0071 }
        if (r2 == 0) goto L_0x0069;	 Catch:{ InterruptedException -> 0x004a, all -> 0x0071 }
    L_0x004f:
        r2 = "HwWifiCHRStateManager";	 Catch:{ InterruptedException -> 0x004a, all -> 0x0071 }
        r3 = new java.lang.StringBuilder;	 Catch:{ InterruptedException -> 0x004a, all -> 0x0071 }
        r3.<init>();	 Catch:{ InterruptedException -> 0x004a, all -> 0x0071 }
        r4 = "syncAddHwCHRAccessNetworkEventInfoList";	 Catch:{ InterruptedException -> 0x004a, all -> 0x0071 }
        r3 = r3.append(r4);	 Catch:{ InterruptedException -> 0x004a, all -> 0x0071 }
        r3 = r3.append(r1);	 Catch:{ InterruptedException -> 0x004a, all -> 0x0071 }
        r3 = r3.toString();	 Catch:{ InterruptedException -> 0x004a, all -> 0x0071 }
        android.util.Log.d(r2, r3);	 Catch:{ InterruptedException -> 0x004a, all -> 0x0071 }
    L_0x0069:
        if (r0 == 0) goto L_0x0049;
    L_0x006b:
        r2 = r6.mLock;
    ...
    L_0x0079:
        throw r2;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.wifi.HwWifiCHRStateManagerImpl.syncAddHwCHRAccessNetworkEventInfoList(com.android.server.wifi.HwCHRAccessNetworkEventInfo):void");
    }
    ...
    private HwWifiCHRStateManagerImpl(Looper looper) {
        ...
        this.mssArbi = HwMSSArbitrager.getInstance(mContextRef);
            ...
            if (!(cellInfo instanceof CellInfoLte) || !cellInfo.isRegistered()) {
                if (!(cellInfo instanceof CellInfoWcdma) || !cellInfo.isRegistered()) {
                    if ((cellInfo instanceof CellInfoGsm) && cellInfo.isRegistered()) {
                        this.mCellArfcn = ((CellInfoGsm) cellInfo).getCellIdentity().getArfcn();
                        this.mCellRssi = ((CellInfoGsm) cellInfo).getCellSignalStrength().getDbm();
                        break;
                    } else if ((cellInfo instanceof CellInfoCdma) && cellInfo.isRegistered()) {
                        this.mCellRssi = ((CellInfoCdma) cellInfo).getCellSignalStrength().getDbm();
                    }
                } else {
                    this.mCellArfcn = ((CellInfoWcdma) cellInfo).getCellIdentity().getUarfcn();
                    this.mCellRssi = ((CellInfoWcdma) cellInfo).getCellSignalStrength().getDbm();
                    break;
                }
            }
            this.mCellArfcn = ((CellInfoLte) cellInfo).getCellIdentity().getEarfcn();
            this.mCellRssi = ((CellInfoLte) cellInfo).getCellSignalStrength().getDbm();
            break;
        }
        Log.d(TAG, "mCellArfcn = " + this.mCellArfcn + ", mCellRssi = " + this.mCellRssi);
    }
    ...
    public void handleUpdateChannel(int channel) {
        ...
        this.usLastAP_channel = this.usAP_channel;
    ...
    public void updateLinkSpeed(int linkSpeed) {
        ...
        HwWifiStatStoreImpl.getDefault().updateLinkSpeed(linkSpeed);
    }

    public void updateMSSState(String state) {
        Log.d(TAG, "update updateMSSState:" + state);
        HwWifiStatStoreImpl.getDefault().updateMSSAntstate(state);
    }
    ...
    public void updateWifiException(int ucErrorCode, String ucSubErrorCode) {
        ...
        if (909002039 == ucErrorCode) {
            if (isNeedTriggerDFTEvent(ucErrorCode)) {
                uploadDFTEvent(ucErrorCode, ucSubErrorCode);
            }
        } else if (!isWifiConnectTypeEvent(ucErrorCode) || (isWifiProEvaluate() ^ 1) == 0 || (this.mConnectType.equals("REASSOC") ^ 1) == 0 || (this.mConnectType.equals("ROAM_CONNECT") ^ 1) == 0) {
    ...
    public void handleUploadDisconnectException(int reasoncode) {
        ...
        this.mABSReassFaileReason = reasoncode;
    ...
    private boolean isNeedTriggerDFTEvent(int type) {
        ...
        switch (type) {
            ...
            case 909002041:
            case 909002042:
                if (this.mHiDataChrCnt == 0) {
                    this.mFirstHiDataChrTimeStamp = now;
                    this.mHiDataChrCnt++;
                    return true;
                } else if (this.commercialUser) {
                    if (this.mHiDataChrCnt < 20 && now - this.mFirstHiDataChrTimeStamp < COMM_UPLOAD_MIN_SPAN) {
                        this.mHiDataChrCnt++;
                        return true;
                    } else if (now - this.mFirstHiDataChrTimeStamp <= COMM_UPLOAD_MIN_SPAN) {
                        return false;
                    } else {
                        this.mHiDataChrCnt = 1;
                        this.mFirstAccessWebSlowlyTimeStamp = now;
                        return true;
                    }
                } else if (this.mHiDataChrCnt < 50 && now - this.mFirstHiDataChrTimeStamp < COMM_UPLOAD_MIN_SPAN) {
                    this.mHiDataChrCnt++;
                    return true;
                } else if (now - this.mFirstHiDataChrTimeStamp <= COMM_UPLOAD_MIN_SPAN) {
                    return false;
    ...
    private EventStream getClassEventStream(int eventid) {
        ...
        switch (eventid) {
            ...
            case 909009030:
                try {
                    EventStream channelBusyInfo = IMonitor.openEventStream(eventid);
                    if (channelBusyInfo == null) {
                        Log.e(TAG, "class EventStream channelBusyInfo is null");
                        return null;
                    }
                    if (this.mWifiNative == null) {
                        this.mWifiNative = WifiInjector.getInstance().getWifiNative();
                    ...
                    if (pollResult == null) {
                        Log.e(TAG, "pollResult is null");
                        return null;
                    }
                    channelBusyInfo.setParam((short) 0, pollResult.currentNoise).setParam((short) 1, pollResult.currentSnr).setParam((short) 2, pollResult.currentChload);
                    return channelBusyInfo;
                } catch (Exception e17) {
                    Log.e(TAG, "set Class EventStream channelBusyInfo error.");
                    return null;
                }
            case 909009035:
                HiDataCHRStallInfo hidataStallinfo = HiDataCHRManager.getInstance(mContextRef).getWeChatStallInfo();
                if (hidataStallinfo == null) {
                    Log.e(TAG, "hidataStallinfo is null.");
                    return null;
                }
                try {
                    EventStream hidataStallClassinfo = IMonitor.openEventStream(eventid);
                    if (hidataStallClassinfo == null) {
                        Log.e(TAG, "hidataStallClassinfo is null.");
                        return null;
                    }
                    hidataStallClassinfo.setParam((short) 0, hidataStallinfo.mAPKName).setParam((short) 1, hidataStallinfo.mScenario).setParam((short) 2, hidataStallinfo.mRAT).setParam((short) 3, hidataStallinfo.mUlTup).setParam((short) 4, hidataStallinfo.mDlTup).setParam((short) 5, hidataStallinfo.mApRtt).setParam((short) 6, hidataStallinfo.mNetRtt).setParam((short) 7, hidataStallinfo.mCellSig).setParam((short) 8, hidataStallinfo.mCellRsrq).setParam((short) 9, hidataStallinfo.mCellSinr).setParam((short) 10, hidataStallinfo.mNeiborApRssi);
                    return hidataStallClassinfo;
                } catch (Exception e18) {
                    Log.e(TAG, "set Class EventStream hidataStallinfo error.");
                    return null;
                }
            default:
    ...
    public void handleNotifyNcSTATDftEvent() {
        ...
        for (j = 0; j < 7; j++) {
            statlist.add(String.valueOf(hwWifiDFT2StabilityStat.mfgAppSpd[j]));
        }
        ...
        for (i = (short) 0; i < ssidStatSize; i++) {
            ...
            list.add(String.valueOf(hwWifiDFT2StabilitySsidStat.mMIMODura));
            for (j = 0; j < 6; j++) {
                list.add(String.valueOf(hwWifiDFT2StabilitySsidStat.mRxPktInCurLnkSpd[j]));
                list.add(String.valueOf(hwWifiDFT2StabilitySsidStat.mRxByteInCurLnkSpd[j]));
                list.add(String.valueOf(hwWifiDFT2StabilitySsidStat.mTxPktInCurLnkSpd[j]));
                list.add(String.valueOf(hwWifiDFT2StabilitySsidStat.mTxByteInCurLnkSpd[j]));
            }
        ...
        for (i = (short) 0; i < apkActionSize; i++) {
            ...
            list.add(String.valueOf(apkAction.mscanGap));
            for (j = 0; j < 4; j++) {
                list.add(String.valueOf(apkAction.mDscpCNT[j]));
            }
            HwWifiDFTConnManager.getInstance().reportWifiDFTEvent(909002030, list);
        }
        HwWifiStatStoreImpl.getDefault().clearStatInfo();
        this.mWifiRepeaterOpenedCount = 0;
        this.mWifiRepeaterWorkingTime = 0;
        this.mDiffFreqStationRepeaterDuration = 0;
        this.mRepeterConnFailedCount = 0;
    }
        ...
        switch (type) {
                    ...
                    for (CSubRSSIGROUP_EVENT rssigroup : this.mRssiGroup.getRSSIGroupCHR()) {
                        if (rssiGroupLen < 4) {
                            ...
                            if (stream == null) {
                                ...
                                abnormalDisconnect.setParam((short) 18, channelLoadInfo);
                                ...
                                IMonitor.closeEventStream(channelLoadInfo);
                                resetWhenDisconnect();
            ...
            case 909002023:
                try {
                    ...
                    connectedFailed.setParam((short) 0, connectType).setParam((short) 9, apInfo).setParam((short) 10, apConnectInfo).setParam((short) 12, BTStatusInfo).setParam((short) 13, this.mPublicEssCnt).setParam((short) 15, this.mAPVendorInfo).setParam((short) 16, wifiSettingsInfo).setParam((short) 17, 0).setParam((short) 18, CellIDInfo).setParam((short) 19, String.valueOf(this.mTriggerReportType)).setParam((short) 20, handsetStateInfo).setParam((short) 22, this.mCellRssi).setParam((short) 23, this.mCellArfcn).setParam((short) 21, this.mssArbi.getMSSCurrentState().toString());
                    ...
                    for (CSubRSSIGROUP_EVENT rssigroup2 : this.mRssiGroup.getRSSIGroupCHR()) {
                        if (rssiGroupLen < 4) {
                            ...
                            if (stream == null) {
                                Log.e(TAG, "openEventStream error,type is : 909009010");
                                connectedFailed.setParam((short) 25, channelLoadInfo);
                    ...
                    try {
                        ...
                        for (int i = 0; i < 6; i++) {
                            ...
                            if (stream == null) {
                                ...
                                accessInternetFailed.setParam((short) 34, channelLoadInfo);
            ...
            case 909002025:
                try {
                    ...
                    accessWebSlowly.setParam((short) 0, ucSubErrorCode).setParam((short) 1, this.mConnectType).setParam((short) 3, apInfo).setParam((short) 4, apConnectInfo).setParam((short) 6, this.mPublicEssCnt).setParam((short) 7, this.mAPVendorInfo).setParam((short) 8, wifiSettingsInfo).setParam((short) 9, BTStatusInfo).setParam((short) 10, CellIDInfo).setParam((short) 11, wifiNetConfigInfo).setParam((short) 12, tcpPacketInfo).setParam((short) 13, CpuMemInfo).setParam((short) 16, bcmChipInfo).setParam((short) 17, this.mMultiGWCount).setParam((short) 18, wifiSDIOInfo).setParam((short) 19, this.mAWS.getRTTArp()).setParam((short) 20, this.mAWS.getRTTBaidu()).setParam((short) 21, 0).setParam((short) 22, this.mPortalStatus).setParam((short) 23, apRoamInfo).setParam((short) 24, repeaterValue).setParam((short) 25, getRepeaterFreq()).setParam((short) 26, netQualityInfo).setParam((short) 27, handsetStateInfo).setParam((short) 30, this.mCellRssi).setParam((short) 31, this.mCellArfcn).setParam((short) 28, this.mssArbi.getMSSCurrentState().toString()).setParam((short) 32, gameLagInfo).setParam((short) 33, channelLoadInfo);
                    if (STREAMING_SLOWLY_BAD_QOE.equals(ucSubErrorCode)) {
                        hidatainfo = getClassEventStream(909009035);
                        accessWebSlowly.setParam((short) 36, hidatainfo);
                    }
                    ...
                    IMonitor.closeEventStream(channelLoadInfo);
                    if (STREAMING_SLOWLY_BAD_QOE.equals(ucSubErrorCode)) {
                        IMonitor.closeEventStream(hidatainfo);
                    }
            ...
            case 909002029:
                try {
                    ...
                    apModelCollect.setParam((short) 2, this.mRouterBrand).setParam((short) 0, MacSsidInfo).setParam((short) 4, this.mApStreamInfo).setParam((short) 5, this.mAPVendorInfo).setParam((short) 1, this.misAPRecognized).setParam((short) 3, this.mRouterModel).setParam((short) 6, String.valueOf(this.mCurrentApBssid.hashCode()));
            ...
            case 909002032:
                ...
                wifiProStatistic.setParam((short) 2, this.mWifiOobInitState).setParam((short) 9, this.mWifiToWifiSuccCount).setParam((short) 10, this.mNoInetHandoverCount).setParam((short) 11, this.mTotalBQE_BadROC).setParam((short) 12, this.mManualBackROC).setParam((short) 13, this.mUserCancelROC).setParam((short) 31, this.mCellAutoOpenCount).setParam((short) 32, this.mCellAutoCloseCount).setParam((short) 33, this.mPingPongCount).setParam((short) 45, this.mBMD_TenMNotifyCount).setParam((short) 46, this.mBMD_TenM_RI_Count).setParam((short) 47, this.mBMD_FiftyMNotifyCount).setParam((short) 48, this.mBMD_FiftyM_RI_Count).setParam((short) 50, this.mRO_TotMobileData).setParam((short) 51, this.mAF_PhoneNumSuccCnt).setParam((short) 53, this.mAF_PasswordSuccCnt).setParam((short) 55, this.mAF_AutoLoginSuccCnt).setParam((short) 66, this.mBG_FreeInetOkApCnt).setParam((short) 67, this.mBG_FishingApCnt).setParam((short) 68, this.mBG_FreeNotInetApCnt).setParam((short) 69, this.mBG_PortalApCnt).setParam((short) 83, this.mBG_NCByConnectFail).setParam((short) 84, this.mBG_NCByCheckFail).setParam((short) 115, this.mManualConnBlockPortalCount).setParam((short) 117, this.mWifiproOpenCount).setParam((short) 65, this.mBG_SettingRunCnt).setParam((short) 80, this.mBG_DHCPFailCnt).setParam((short) 81, this.mBG_AUTH_FailCnt).setParam((short) 82, this.mBG_AssocRejectCnt).setParam((short) 79, this.mBG_DNSFailCnt).setParam((short) 106, this.mHomeAPAddRoPeriodCnt).setParam((short) 107, this.mHomeAPQoeBadCnt).setParam((short) 85, this.mBG_NCByStateErr).setParam((short) 86, this.mBG_NCByUnknown).setParam((short) 87, this.mBQE_CNUrl1FailCount).setParam((short) 88, this.mBQE_CNUrl2FailCount).setParam((short) 89, this.mBQE_CNUrl3FailCount).setParam((short) 90, this.mBQE_NCNUrl1FailCount).setParam((short) 91, this.mBQE_NCNUrl2FailCount).setParam((short) 92, this.mBQE_NCNUrl3FailCount).setParam((short) 93, this.mBQE_ScoreUnknownCount).setParam((short) 94, this.mBQE_BindWlanFailCount).setParam((short) 75, this.mBG_InetNotOkActiveOk).setParam((short) 76, this.mBG_InetOkActiveNotOk).setParam((short) 77, this.mBG_UserSelApFishingCnt).setParam((short) 78, this.mBG_ConntTimeoutCnt).setParam((short) 58, this.mBSG_RsGoodCnt).setParam((short) 59, this.mBSG_RsMidCnt).setParam((short) 60, this.mBSG_RsBadCnt).setParam((short) 61, this.mBSG_EndIn4sCnt).setParam((short) 62, this.mBSG_EndIn4s7sCnt).setParam((short) 63, this.mBSG_NotEndIn7sCnt).setParam((short) 118, this.mWifiproCloseCount);
                IMonitor.sendEvent(wifiProStatistic);
                IMonitor.closeEventStream(wifiProStatistic);
                Log.d(TAG, "IMonitor send wifipro CHR event");
                return;
            case 909002034:
                EventStream absAssocFailEvent = IMonitor.openEventStream(909002034);
                if (absAssocFailEvent == null) {
                    Log.e(TAG, "absAssocFailEvent is null.");
                    return;
                }
                HwABSCHRExEvent mABSException = HwABSCHRManager.getInstance(mContextRef).getExceptionInfo();
                if (mABSException == null) {
                    Log.e(TAG, "mABSException is null.");
                    return;
                }
                EventStream apInfor = getClassEventStream(909009001);
                absAssocFailEvent.setParam((short) 0, String.valueOf(this.mABSReassFaileReason)).setParam((short) 2, apInfor).setParam((short) 3, mABSException.mSwitchType);
                IMonitor.sendEvent(absAssocFailEvent);
                IMonitor.closeEventStream(apInfor);
                IMonitor.closeEventStream(absAssocFailEvent);
                return;
            case 909002035:
                EventStream absStatEvent = IMonitor.openEventStream(909002035);
                if (absStatEvent == null) {
                    Log.e(TAG, "absStatEvent is null.");
                    return;
                }
                HwABSCHRStatistics mABSStatistics = HwABSCHRManager.getInstance(mContextRef).getStatisticsInfo();
                if (mABSStatistics == null) {
                    Log.e(TAG, "mABSStatistics is null.");
                    return;
                }
                absStatEvent.setParam((short) 0, mABSStatistics.long_connect_event).setParam((short) 1, mABSStatistics.short_connect_event).setParam((short) 2, mABSStatistics.search_event).setParam((short) 3, mABSStatistics.antenna_preempted_screen_on_event).setParam((short) 4, mABSStatistics.antenna_preempted_screen_off_event).setParam((short) 5, mABSStatistics.mo_mt_call_event).setParam((short) 6, mABSStatistics.siso_to_mimo_event).setParam((short) 7, mABSStatistics.ping_pong_times).setParam((short) 8, mABSStatistics.max_ping_pong_times).setParam((short) 9, mABSStatistics.mimo_time).setParam((short) 10, mABSStatistics.siso_time).setParam((short) 11, mABSStatistics.mimo_screen_on_time).setParam((short) 12, mABSStatistics.siso_screen_on_time).setParam((short) 13, mABSStatistics.mRssiL0).setParam((short) 14, mABSStatistics.mRssiL1).setParam((short) 15, mABSStatistics.mRssiL2).setParam((short) 16, mABSStatistics.mRssiL3).setParam((short) 17, mABSStatistics.mRssiL4);
                IMonitor.sendEvent(absStatEvent);
                IMonitor.closeEventStream(absStatEvent);
                return;
            case 909002038:
                ...
                return;
            case 909002039:
                EventStream userSwitchManuallyEvent = IMonitor.openEventStream(909002039);
                if (userSwitchManuallyEvent == null) {
                    Log.e(TAG, "userSwitchManuallyEvent is null.");
                    return;
                }
                boolean isWeChating = HwQoEService.getInstance().isWeChating();
                HiDataCHRHandoverInfo hiDataHandoverInfo = null;
                if (isWeChating) {
                    hiDataHandoverInfo = HiDataCHRManager.getInstance(mContextRef).getWeChatHandoverInfo();
                    if (hiDataHandoverInfo == null) {
                        Log.e(TAG, "hiDataHandoverInfo is null.");
                        return;
                    }
                    userSwitchManuallyEvent.setParam((short) 0, hiDataHandoverInfo.mAPKname).setParam((short) 1, hiDataHandoverInfo.mScenario).setParam((short) 2, hiDataHandoverInfo.mEventType).setParam((short) 3, hiDataHandoverInfo.mWifiSsidBef).setParam((short) 4, hiDataHandoverInfo.mWifiRssiBef).setParam((short) 5, hiDataHandoverInfo.mWifiChBef).setParam((short) 6, hiDataHandoverInfo.mWifiSsidAft).setParam((short) 7, hiDataHandoverInfo.mWifiRssiAft).setParam((short) 5, hiDataHandoverInfo.mWifiChAft);
                } else {
                    String str = null;
                    int acttype = -1;
                    int oldrssi = -255;
                    if (ucSubErrorCode != null && ucSubErrorCode.length() > 10) {
                        String[] bundledata = ucSubErrorCode.substring(8, ucSubErrorCode.length() - 2).split(",");
                        str = getParamFromString(bundledata, "apkname");
                        try {
                            oldrssi = Integer.parseInt(getParamFromString(bundledata, "oldrssi"));
                            acttype = Integer.parseInt(getParamFromString(bundledata, "type"));
                        } catch (NumberFormatException e3) {
                            Log.e(TAG, "NumberFormatException .");
                        }
                    }
                    if ((acttype == 2 || acttype == 1 || acttype == 11 || acttype == 9) && this.connectedType != 1) {
                        Log.e(TAG, "open /connect command should report when WLAN connected .");
                        return;
                    }
                    userSwitchManuallyEvent.setParam((short) 0, str).setParam((short) 1, 0).setParam((short) 2, acttype).setParam((short) 3, this.mPreviousConnectEventSSID).setParam((short) 4, oldrssi).setParam((short) 5, this.usLastAP_channel).setParam((short) 6, this.strAp_Ssid).setParam((short) 7, this.mRssi).setParam((short) 5, this.usAP_channel);
                }
                int networktype = this.mTelephonyManager.getNetworkType();
                int networkcalss = TelephonyManager.getNetworkClass(networktype);
                updateCellInfo();
                userSwitchManuallyEvent.setParam((short) 9, networkcalss).setParam((short) 10, this.mCellRssi).setParam((short) 11, this.mCellArfcn);
                Log.e(TAG, "networktype:" + networktype + " mCellRssi:" + this.mCellRssi + " mCellArfcn:" + this.mCellArfcn);
                if (isWeChating && hiDataHandoverInfo != null) {
                    userSwitchManuallyEvent.setParam((short) 12, hiDataHandoverInfo.mWifiRxTup1Bef).setParam((short) 13, hiDataHandoverInfo.mWifiRxTup2Bef).setParam((short) 14, hiDataHandoverInfo.mWifiChLoad).setParam((short) 15, hiDataHandoverInfo.mWifiTxFail1Bef).setParam((short) 16, hiDataHandoverInfo.mWifiTxFail2Bef).setParam((short) 17, hiDataHandoverInfo.mWifiRxTupAft).setParam((short) 18, hiDataHandoverInfo.mCellRxTup).setParam((short) 19, hiDataHandoverInfo.mSwitchCauseBef);
                }
                IMonitor.sendEvent(userSwitchManuallyEvent);
                IMonitor.closeEventStream(userSwitchManuallyEvent);
                return;
            case 909002040:
                EventStream wechatVideoCallStatics = IMonitor.openEventStream(909002040);
                if (wechatVideoCallStatics == null) {
                    Log.e(TAG, "wechatVideoCallStatics is null.");
                    return;
                }
                HiDataCHRStatisticsInfo mHiDataVideoinfo = HiDataCHRManager.getInstance(mContextRef).getWeChatVideoStatistics();
                if (mHiDataVideoinfo == null) {
                    Log.e(TAG, "mHiDataVideoinfo is null.");
                    return;
                }
                wechatVideoCallStatics.setParam((short) 0, mHiDataVideoinfo.mCallTotalCnt).setParam((short) 1, mHiDataVideoinfo.mStartInCellularCnt).setParam((short) 2, mHiDataVideoinfo.mStartInWiFiCnt).setParam((short) 3, mHiDataVideoinfo.mCallInCellularDur).setParam((short) 4, mHiDataVideoinfo.mCallInWiFiDur).setParam((short) 5, mHiDataVideoinfo.mCellLv1Cnt).setParam((short) 6, mHiDataVideoinfo.mCellLv2Cnt).setParam((short) 7, mHiDataVideoinfo.mCellLv3Cnt).setParam((short) 8, mHiDataVideoinfo.mWiFiLv1Cnt).setParam((short) 9, mHiDataVideoinfo.mWiFiLv2Cnt).setParam((short) 10, mHiDataVideoinfo.mWiFiLv3Cnt).setParam((short) 11, mHiDataVideoinfo.mTrfficCell).setParam((short) 12, mHiDataVideoinfo.mVipSwitchCnt).setParam((short) 13, mHiDataVideoinfo.mStallSwitchCnt).setParam((short) 14, mHiDataVideoinfo.mStallSwitch0Cnt).setParam((short) 15, mHiDataVideoinfo.mStallSwitch1Cnt).setParam((short) 16, mHiDataVideoinfo.mStallSwitchAbove1Cnt).setParam((short) 17, mHiDataVideoinfo.mSwitch2CellCnt).setParam((short) 18, mHiDataVideoinfo.mSwitch2WifiCnt);
                IMonitor.sendEvent(wechatVideoCallStatics);
                IMonitor.closeEventStream(wechatVideoCallStatics);
                return;
            case 909002041:
                EventStream wechatAudioCallStatics = IMonitor.openEventStream(909002041);
                if (wechatAudioCallStatics == null) {
                    Log.e(TAG, "wechatAudioCallStatics is null.");
                    return;
                }
                HiDataCHRStatisticsInfo mHiDataAudioinfo = HiDataCHRManager.getInstance(mContextRef).getWeChatAudioStatistics();
                if (mHiDataAudioinfo == null) {
                    Log.e(TAG, "mHiDataAudioinfo is null.");
                    return;
                }
                wechatAudioCallStatics.setParam((short) 0, mHiDataAudioinfo.mCallTotalCnt).setParam((short) 1, mHiDataAudioinfo.mStartInCellularCnt).setParam((short) 2, mHiDataAudioinfo.mStartInWiFiCnt).setParam((short) 3, mHiDataAudioinfo.mCallInCellularDur).setParam((short) 4, mHiDataAudioinfo.mCallInWiFiDur).setParam((short) 5, mHiDataAudioinfo.mCellLv1Cnt).setParam((short) 6, mHiDataAudioinfo.mCellLv2Cnt).setParam((short) 7, mHiDataAudioinfo.mCellLv3Cnt).setParam((short) 8, mHiDataAudioinfo.mWiFiLv1Cnt).setParam((short) 9, mHiDataAudioinfo.mWiFiLv2Cnt).setParam((short) 10, mHiDataAudioinfo.mWiFiLv3Cnt).setParam((short) 11, mHiDataAudioinfo.mTrfficCell).setParam((short) 12, mHiDataAudioinfo.mVipSwitchCnt).setParam((short) 13, mHiDataAudioinfo.mStallSwitchCnt).setParam((short) 14, mHiDataAudioinfo.mStallSwitch0Cnt).setParam((short) 15, mHiDataAudioinfo.mStallSwitch1Cnt).setParam((short) 16, mHiDataAudioinfo.mStallSwitchAbove1Cnt).setParam((short) 17, mHiDataAudioinfo.mSwitch2CellCnt).setParam((short) 18, mHiDataAudioinfo.mSwitch2WifiCnt);
                IMonitor.sendEvent(wechatAudioCallStatics);
                IMonitor.closeEventStream(wechatAudioCallStatics);
                return;
            case 909002042:
                EventStream machineLearningParaInfo = IMonitor.openEventStream(909002042);
                if (machineLearningParaInfo == null) {
                    Log.e(TAG, "machineLearningParaInfo is null.");
                    return;
                }
                HiDataCHRMachineInfo mHiDataMachineInfo = HiDataCHRManager.getInstance(mContextRef).getWeChatMachineInfo();
                if (mHiDataMachineInfo == null) {
                    Log.e(TAG, "mHiDataMachineInfo is null.");
                    return;
                }
                machineLearningParaInfo.setParam((short) 0, mHiDataMachineInfo.mRxTup1Bef).setParam((short) 1, mHiDataMachineInfo.mRxTup2Bef).setParam((short) 2, mHiDataMachineInfo.mChLoad).setParam((short) 3, mHiDataMachineInfo.mTxFail1Bef).setParam((short) 4, mHiDataMachineInfo.mTxFail2Bef);
                IMonitor.sendEvent(machineLearningParaInfo);
                IMonitor.closeEventStream(machineLearningParaInfo);
                return;
            case 909002043:
                EventStream ABSBlackistEvent = IMonitor.openEventStream(909002043);
                HwABSCHRBlackListEvent ABSBlackListException = HwABSCHRManager.getInstance(mContextRef).getABSBlackListException();
                if (ABSBlackistEvent == null || ABSBlackListException == null) {
                    Log.e(TAG, "ABSBlackistEvent is null.");
                    return;
                }
                String maskMacAddress;
                if (this.commercialUser) {
                    maskMacAddress = maskMacAddress(ABSBlackListException.mABSApBssid);
                } else {
                    maskMacAddress = ABSBlackListException.mABSApBssid;
                }
                ABSBlackistEvent.setParam((short) 0, maskMacAddress).setParam((short) 1, ABSBlackListException.mABSApSsid).setParam((short) 2, ABSBlackListException.mABSAddReason).setParam((short) 3, ABSBlackListException.mABSSuportVoWifi).setParam((short) 4, ABSBlackListException.mABSSwitchTimes).setParam((short) 5, ABSBlackListException.mABSFailedTimes).setParam((short) 6, ABSBlackListException.mABSTotalNum).setParam((short) 7, ABSBlackListException.mABSBlackListNum);
                IMonitor.sendEvent(ABSBlackistEvent);
                IMonitor.closeEventStream(ABSBlackistEvent);
                return;
            default:
    ...
    private String getParamFromString(String[] list, String find) {
        int index = -1;
        for (int i = 0; i < list.length; i++) {
            String temstring = list[i];
    ...
    private String maskMacAddress(String macAddress) {
        if (macAddress != null) {
            if (macAddress.split(":").length >= 4) {
                return String.format("%s:%s:%s:%s:**:**", new Object[]{macAddress.split(":")[0], macAddress.split(":")[1], macAddress.split(":")[2], macAddress.split(":")[3]});
            }
        }
        return macAddress;
    }
    ...
    private String maskIpAddress(String ipAddress) {
        if (ipAddress != null) {
            if (ipAddress.split("\\.").length >= 3) {
                return String.format("%s.%s.%s.***", new Object[]{ipAddress.split("\\.")[0], ipAddress.split("\\.")[1], ipAddress.split("\\.")[2]});
            }
        }
        return ipAddress;
    }
    ...
    private void handleUpdateAP(String iface, int networkId, SupplicantState newSupplicantState, String BSSID) {
        if ("wlan0".equals(iface)) {
            ...
            if (this.mHwWifiStatStore != null) {
                ...
                getApVendorInfo();
                this.mHwWifiStatStore.setApRoamingParam((byte) this.mEssCount);
            }
            this.hwWifiCHRService = HwWifiCHRServiceImpl.getDefault();
            if (this.hwWifiCHRService != null) {
