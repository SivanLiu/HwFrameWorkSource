...
public class WifiNative {
    ...
    public Pair<Integer, IApInterface> setupForSoftApMode() {
        if (startHalIfNecessary(false)) {
            IApInterface iApInterface = this.mWificondControl.setupDriverForSoftApMode();
    ...
    public boolean stopRxFilter() {
        return this.mSupplicantStaIfaceHal.stopRxFilter();
    }
    ...
    public int setWifiAnt(String iface, int mode, int operation) {
        Log.d(this.mTAG, "setWifiAnt iface: " + iface + " mode: " + mode + " operation: " + operation);
        return setWifiAntNative(iface, mode, operation);
    }

    public int getWifiAnt(String iface, int mode) {
        Log.d(this.mTAG, "getWifiAnt iface: " + iface + " mode: " + mode);
        return getWifiAntNative(iface, mode);
    }

    public int setCmdToWifiChip(String iface, int mode, int type, int action, int param) {
        Log.d(this.mTAG, "setCmdToWifiChip iface: " + iface + " mode: " + mode + " type: " + type + " action: " + action + " param: " + param);
