...
public class IconInfo {
    ...
    public boolean equals(Object thatObject) {
        ...
        if (this.mWidth == that.mWidth && this.mHeight == that.mHeight && TextUtils.equals(this.mLanguage, that.mLanguage) && TextUtils.equals(this.mIconType, that.mIconType)) {
            z = TextUtils.equals(this.mFileName, that.mFileName);
        }
        return z;
    }

    public int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(this.mWidth), Integer.valueOf(this.mHeight), this.mLanguage, this.mIconType, this.mFileName});
    }
