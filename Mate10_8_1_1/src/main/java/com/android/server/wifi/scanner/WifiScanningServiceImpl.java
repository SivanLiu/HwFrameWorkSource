...
public class WifiScanningServiceImpl extends Stub {
    ...
    class WifiPnoScanStateMachine extends StateMachine implements PnoEventHandler {
        private final RequestList<Pair<PnoSettings, WifiScanner.ScanSettings>> mActivePnoScans = new RequestList();
        private final DefaultState mDefaultState = new DefaultState();
        ...
        if (this.mSingleScanStateMachine != null) {
            ...
            if (!(scanResults == null || scanResults.size() == 0)) {
                ...
                for (ScanResult r : scanResults) {
                    ...
                    r22 = new Object[6];
                    r22[4] = String.format("%1.32s", new Object[]{ssid});
                    r22[5] = r.capabilities;
