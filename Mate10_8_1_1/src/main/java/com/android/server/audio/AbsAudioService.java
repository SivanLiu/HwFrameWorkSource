...
public abstract class AbsAudioService extends Stub {
    ...
    static {
        ...
        if (!(DTS_SOUND_EFFECTS_SUPPORT || SWS_SOUND_EFFECTS_SUPPORT)) {
            z = DOLBY_SOUND_EFFECTS_SUPPORT;
        }
        SOUND_EFFECTS_SUPPORT = z;
        if (DUAL_SMARTPA_SUPPORT) {
            z2 = "false".equals(AudioSystem.getParameters("audio_capability#spk_rcv_stereo_support")) ^ 1;
        }
