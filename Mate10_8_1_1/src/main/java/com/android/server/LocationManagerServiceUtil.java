    ...
    private void bindSpecificService(String packageName, int version, boolean bind) {
        ...
        if (bind) {
            if (networkProvider != null) {
                ...
                networkProvider = LocationProviderProxy.createAndBind(this.mContext, "network", NETWORK_LOCATION_SERVICE_ACTION, 17956962, 17039809, 17236013, getLocationHandler());
                if (networkProvider != null) {
            ...
            if (geocoderProxy != null) {
                ...
                needUpdateProvider = true;
                setGeocodeProvider(GeocoderProxy.createAndBind(this.mContext, 17956954, 17039789, 17236013, getLocationHandler()));
            }
