...
public class HwServiceFactory {
    ...
    public interface Factory {
        ...
        ActivityStack createActivityStack(ActivityDisplay activityDisplay, int i, ActivityStackSupervisor activityStackSupervisor, RecentTasks recentTasks, boolean z);
    ...
    public static ActivityStack createActivityStack(ActivityDisplay display, int stackId, ActivityStackSupervisor supervisor, RecentTasks recentTasks, boolean onTop) {
        Factory obj = getImplObject();
        if (obj != null) {
            return obj.createActivityStack(display, stackId, supervisor, recentTasks, onTop);
        }
        return new ActivityStack(display, stackId, supervisor, recentTasks, onTop);
    }
