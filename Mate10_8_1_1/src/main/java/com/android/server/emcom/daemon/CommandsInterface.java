...
public interface CommandsInterface {
    ...
    public static final int EMCOM_SD_XENGINE_ADD_PROXY_CONFIG = 265;
    public static final int EMCOM_SD_XENGINE_CONFIG_MPIP = 262;
    public static final int EMCOM_SD_XENGINE_REMOVE_PROXY_CONFIG = 266;
    ...
    void exeAddConfigProxy(String str, String str2, int i, int i2, int i3, int i4, boolean z, boolean z2, float f, Message message);

    void exeAppForeground(int i, int i2, Message message);

    void exeBootComplete(Message message);

    void exeConfigMpip(ArrayList<HicomMpipInfo> arrayList, Message message);

    void exeConfigUpdate(Message message);

    void exePackageChanged(int i, String str, Message message);

    void exeRemoveConfigProxy(String str, String str2, int i, int i2, int i3, int i4, boolean z, boolean z2, float f, Message message);
