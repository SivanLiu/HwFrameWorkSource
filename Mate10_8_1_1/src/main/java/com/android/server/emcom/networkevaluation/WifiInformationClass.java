...
class WifiInformationClass {
    ...
    static {
        r0 = new int[3][][];
        r0[0] = new int[][]{new int[]{90, 100}, new int[]{130, 120}, new int[]{500, 860}};
        r0[1] = new int[][]{new int[]{60, 60}, new int[]{110, 110}, new int[]{500, 550}};
        r0[2] = new int[][]{new int[]{60, 60}, new int[]{110, 110}, new int[]{500, 550}};
