...
public class SlideOutContainer extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        this.mScrim = findViewById(34603212);
        this.mOrb = (HwGestureSideLayout) findViewById(34603209);
        this.mOrbLegacy = (SlideOutCircleView) findViewById(34603210);
    ...
    public void show(boolean show, boolean animate) {
        if (show) {
            ...
            startExitAnimation(new Runnable() {
                public void run() {
                    SlideOutContainer.this.mAnimatingOut = false;
    ...
    public void setSlidingSide(boolean onLeft) {
        if (this.mOrbLegacy != null) {
            this.mOrbLegacy.setSlidingSide(onLeft);
        }
        if (this.mOrb != null) {
            this.mOrb.setSlidingSide(onLeft);
        }
    }

    public boolean isShowing() {
        return getVisibility() == 0 ? this.mAnimatingOut ^ 1 : false;
    }
