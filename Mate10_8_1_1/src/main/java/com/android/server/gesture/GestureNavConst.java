...
public class GestureNavConst {
    ...
    public static final float BOTTOM_WINDOW_SINGLE_HAND_RATIO = (SystemProperties.getInt("ro.config.curved_screen", 0) == 1 ? 1.8f : 1.4f);
    ...
    public static final boolean CONFIG_PROP_GESTURE_NAV = SystemProperties.getBoolean("ro.config.gesture_nav_support", false);
    public static final boolean DEBUG = Log.HWINFO;
    public static final boolean DEBUG_ALL = (DEBUG ? Log.HWLog : false);
    ...
    public static final float FAST_VELOCITY_THRESHOLD_1 = 1500.0f;
    ...
    public static String reportResultStr(boolean success, int side) {
        return "result:" + (success ? REPORT_SUCCESS : REPORT_FAILURE) + ",side:" + side;
    }
    ...
    public static int getBackWindowWidth(Context context) {
        return context.getResources().getDimensionPixelSize(34472228);
    }

    public static int getBottomWindowHeight(Context context) {
        return context.getResources().getDimensionPixelSize(34472229);
    }

    public static int getBackMaxDistance1(Context context) {
        return context.getResources().getDimensionPixelSize(34472226);
    }

    public static int getBackMaxDistance2(Context context) {
        return context.getResources().getDimensionPixelSize(34472227);
    }

    public static int getStatusBarHeight(Context context) {
        return context.getResources().getDimensionPixelSize(17105265);
    }
