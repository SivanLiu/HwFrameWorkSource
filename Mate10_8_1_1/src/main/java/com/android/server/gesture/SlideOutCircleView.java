...
public class SlideOutCircleView extends FrameLayout {
    ...
    public SlideOutCircleView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mCircleSideMargin = context.getResources().getDimensionPixelSize(34472250);
        this.mCircleMinSize = context.getResources().getDimensionPixelSize(34472249);
        this.mCircleMaxSize = context.getResources().getDimensionPixelSize(34472248);
        this.mCircleCenterStartPos = context.getResources().getDimensionPixelSize(34472247);
        this.mBaseMargin = context.getResources().getDimensionPixelSize(34472246);
        this.mStaticOffset = context.getResources().getDimensionPixelSize(34472252);
    ...
    protected void onFinishInflate() {
        ...
        this.mLeftLogo = (ImageView) findViewById(34603057);
        this.mRightLogo = (ImageView) findViewById(34603144);
    }
    ...
    private void updateElevation() {
        ...
        if (1.0f - t <= GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO) {
            t = GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        }
        setElevation(t * ((float) this.mMaxElevation));
    }
    ...
    private void updateLogo() {
        ...
        if (exitAnimationRunning) {
            ...
            mLogo.setAlpha(alphaTmp > GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO ? alphaTmp : GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO);
        }
    ...
    private void performExitFadeOutAnimation(int startDelay, int duration, final Runnable endRunnable) {
        ...
        this.mFadeOutAnimator.addUpdateListener(new AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                SlideOutCircleView.this.mOutlineAlpha = backgroundValue;
