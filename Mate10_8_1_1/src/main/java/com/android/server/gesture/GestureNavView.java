...
public class GestureNavView extends SurfaceView {
    ...
    public interface IGestureNavBottomAnim {
        void onGestureEnd(int i);

        void onGestureFailed();

        void onGestureReallyStarted();

        void onGestureSlowProcess(float f, float f2, float f3);

        void onGestureSlowProcessStarted();

        void onGestureStarted();

        void onGestureSuccessFinished(float f, long j, float f2, boolean z, Runnable runnable);
    }
