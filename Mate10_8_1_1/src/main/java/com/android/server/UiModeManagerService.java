...
final class UiModeManagerService extends SystemService {
    ...
    public void onStart() {
        ...
        if (res.getInteger(17694756) == 1) {
            z = true;
        } else {
            z = false;
        }
        this.mCarModeKeepsScreenOn = z;
        if (res.getInteger(17694775) == 1) {
            z2 = true;
        }
        this.mDeskModeKeepsScreenOn = z2;
        this.mEnableCarDockLaunch = res.getBoolean(17956947);
        this.mUiModeLocked = res.getBoolean(17956987);
        this.mNightModeLocked = res.getBoolean(17956986);
        ...
        this.mNightMode = Secure.getInt(context.getContentResolver(), "ui_night_mode", res.getInteger(17694769));
        SystemServerInitThreadPool.get().submit(new -$Lambda$VaVGUZuNs2jqHMhhxPzwNl4zK-M((byte) 4, this), TAG + ".onStart");
