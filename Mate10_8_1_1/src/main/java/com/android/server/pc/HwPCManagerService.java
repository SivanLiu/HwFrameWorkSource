...
public final class HwPCManagerService extends Stub {
    ...
    static /* synthetic */ void lambda$-com_android_server_pc_HwPCManagerService_21994(CompoundButton buttonView, boolean isChecked) {
    }

    static /* synthetic */ void lambda$-com_android_server_pc_HwPCManagerService_28795(CompoundButton buttonView, boolean isChecked) {
    }
    ...
    private void showEnterDesktopAlertDialog(Context context, boolean isExclusiveKeyboard, boolean notDisplayAdd) {
        if (isMMIRunning() || isKeyguardLocked()) {
            ...
            if (isEnterDesktopModeRemembered() && (isDesktopMode(this.mProjMode) ^ 1) != 0 && (isExclusiveKeyboard ^ 1) != 0) {
                ...
                View view = LayoutInflater.from(buider.getContext()).inflate(34013294, null);
                if (view != null) {
                    ImageView imageView = (ImageView) view.findViewById(34603218);
                    TextView textView = (TextView) view.findViewById(34603217);
                    CheckBox checkBox = (CheckBox) view.findViewById(34603219);
                    if (imageView != null && textView != null && checkBox != null) {
                        ...
                        if (isExclusiveKeyboard) {
                            ...
                            imageView.setImageResource(33751807);
                        ...
                        checkBox.setOnCheckedChangeListener(-$Lambda$IuXpI61eoAu7q3AMTqaXOaSXORQ.$INST$0);
                        this.mEnterDesktopAlertDialog = buider.setTitle(33685778).setPositiveButton(33685760, new com.android.server.pc.-$Lambda$IuXpI61eoAu7q3AMTqaXOaSXORQ.AnonymousClass3((byte) 0, isExclusiveKeyboard, this, checkBox)).setNegativeButton(33685532, new com.android.server.pc.-$Lambda$IuXpI61eoAu7q3AMTqaXOaSXORQ.AnonymousClass1((byte) 0, this)).setView(view).setOnDismissListener(new com.android.server.pc.-$Lambda$IuXpI61eoAu7q3AMTqaXOaSXORQ.AnonymousClass2((byte) 0, this)).create();
                        ...
                        if (!(w == null || contentResolver == null)) {
                            View titleView = w.findViewById(16908709);
    ...
    /* synthetic */ void lambda$-com_android_server_pc_HwPCManagerService_22270(CheckBox checkBox, boolean isExclusiveKeyboard, DialogInterface dialog, int which) {
    ...
    /* synthetic */ void lambda$-com_android_server_pc_HwPCManagerService_23628(DialogInterface dialog, int which) {
        Log.d(TAG, "onClick:cancel which=" + which);
        this.isNeedEnterDesktop = false;
        dialog.cancel();
    }

    /* synthetic */ void lambda$-com_android_server_pc_HwPCManagerService_23919(DialogInterface dialog) {
        ...
        if (isMMIRunning() || isKeyguardLocked()) {
            ...
            if (isExitDesktopModeRemembered() && isDesktopMode(this.mProjMode) && (isExclusiveKeyboard ^ 1) != 0) {
                ...
                if (view != null) {
                    ...
                    HwPCUtils.log(TAG, "these string will be used in future:" + enter_toast + exit_toast + context.getString(33685534) + context.getString(33685917));
                    ImageView imageView = (ImageView) view.findViewById(34603218);
                    TextView textView = (TextView) view.findViewById(34603217);
                    CheckBox checkBox = (CheckBox) view.findViewById(34603219);
                    if (imageView != null && textView != null && checkBox != null) {
                        ...
                        checkBox.setOnCheckedChangeListener(-$Lambda$IuXpI61eoAu7q3AMTqaXOaSXORQ.$INST$1);
                        this.mExitDesktopAlertDialog = buider.setTitle(33685921).setPositiveButton(33685920, new com.android.server.pc.-$Lambda$IuXpI61eoAu7q3AMTqaXOaSXORQ.AnonymousClass3((byte) 1, isExclusiveKeyboard, this, checkBox)).setNegativeButton(33685915, new com.android.server.pc.-$Lambda$IuXpI61eoAu7q3AMTqaXOaSXORQ.AnonymousClass1((byte) 1, this)).setView(view).setOnDismissListener(new com.android.server.pc.-$Lambda$IuXpI61eoAu7q3AMTqaXOaSXORQ.AnonymousClass2((byte) 1, this)).create();
    ...
    /* synthetic */ void lambda$-com_android_server_pc_HwPCManagerService_29068(CheckBox checkBox, boolean isExclusiveKeyboard, DialogInterface dialog, int which) {
        Log.d(TAG, "onClick:start which=" + which);
    ...
    /* synthetic */ void lambda$-com_android_server_pc_HwPCManagerService_30353(DialogInterface dialog, int which) {
        this.isNeedEixtDesktop = false;
        Log.d(TAG, "onClick:cancel which=" + which);
        dialog.cancel();
    }

    /* synthetic */ void lambda$-com_android_server_pc_HwPCManagerService_30643(DialogInterface dialog) {
    ...
    public HwPCManagerService(android.content.Context r19, com.android.server.am.ActivityManagerService r20) {
...
*/
        ...
        r0 = r18;
        r0.mUserId = r14;
        r14 = 2000; // 0x7d0 float:2.803E-42 double:9.88E-321;
        r0 = r18;
        r0.mPCBeforeBootAnimTime = r14;
        r14 = 0;
        r0 = r18;
        r0.mIsDisplayLargerThan1080p = r14;
        r14 = 0;
        r0 = r18;
        r0.mPhoneState = r14;
        r14 = android.util.HwPCUtils.ProjectionMode.DESKTOP_MODE;
        r0 = r18;
        r0.mProjMode = r14;
        r14 = 0;
        r0 = r18;
        r0.mIsExclusiveKeyboardOnline = r14;
        r14 = 1;
        r0 = r18;
        r0.mIMEWithHardKeyboardState = r14;
        r14 = 0;
        r0 = r18;
        r0.mPadPCDisplayIsRemoved = r14;
        r14 = new android.content.ComponentName;
        r15 = "com.huawei.desktop.systemui";
        r16 = "com.huawei.systemui.mk.activity.ImitateActivity";
        r14.<init>(r15, r16);
        r0 = r18;
        r0.mTouchPadComponent = r14;
        r14 = new android.content.ComponentName;
        r15 = "com.huawei.desktop.systemui";
        r16 = "com.huawei.systemui.SystemUIService";
        r14.<init>(r15, r16);
        r0 = r18;
        r0.mSystemUIComponent = r14;
        r14 = new com.android.server.pc.HwPCManagerService$1;
        r0 = r18;
        r14.<init>();
        r0 = r18;
        r0.mConnSysUI = r14;
        r14 = new android.content.ComponentName;
        r15 = "com.huawei.desktop.explorer";
        r16 = "com.huawei.filemanager.services.ExplorerService";
        r14.<init>(r15, r16);
        r0 = r18;
        r0.mExplorerComponent = r14;
        r14 = new com.android.server.pc.HwPCManagerService$2;
        r0 = r18;
        r14.<init>();
        r0 = r18;
        r0.mConnExplorer = r14;
        r14 = 0;
        r0 = r18;
        r0.mHasSwitchNtf = r14;
        r14 = 0;
        r0 = r18;
        r0.mHasKMNotf = r14;
        r14 = "hw_pc_support_overlay";
        r15 = 0;
        r14 = android.os.SystemProperties.getBoolean(r14, r15);
        r0 = r18;
        r0.mSupportOverlay = r14;
        r14 = "hw_pc_support_touchpad";
        r15 = 1;
        r14 = android.os.SystemProperties.getBoolean(r14, r15);
        r0 = r18;
        r0.mSupportTouchPad = r14;
        r14 = 0;
        r0 = r18;
        r0.mEnterDesktopAlertDialog = r14;
        r14 = 0;
        r0 = r18;
        r0.mExitDesktopAlertDialog = r14;
        r14 = new com.android.server.pc.HwPCManagerService$3;
        r0 = r18;
        r14.<init>();
        r0 = r18;
        r0.mNotifyReceiver = r14;
        r14 = 0;
        r0 = r18;
        r0.isNeedEnterDesktop = r14;
        r14 = 0;
        r0 = r18;
        r0.isNeedEixtDesktop = r14;
        r14 = 0;
        r0 = r18;
        r0.mRestartAppsWhenUnlocked = r14;
        r14 = 0;
        r0 = r18;
        r0.mIsDisplayAddedAfterSwitch = r14;
        r14 = 1;
        r0 = r18;
        r0.mRotationSwitch = r14;
        r14 = 0;
        r0 = r18;
        r0.mRotationValue = r14;
        r14 = new com.android.server.pc.HwPCManagerService$4;
        r0 = r18;
        r14.<init>();
        r0 = r18;
        r0.mShutdownReceiver = r14;
        r14 = -1;
        r0 = r18;
        r0.mDreamsEnabledSetting = r14;
        r14 = new android.os.Handler;
        r15 = com.android.server.UiThread.get();
        r15 = r15.getLooper();
        r14.<init>(r15);
        r0 = r18;
        r0.mUIHandler = r14;
        ...
        r0 = r18;
        r0.mProvisioned = r14;
        r14 = "content://settings/system/screen_off_timeout";
        r0 = r18;
        r0.SCREEN_OF_TIMEOUT_URI = r14;
        r14 = "content://settings/global/device_provisioned";
        r0 = r18;
        r0.DEVICE_PROVISIONED_URI = r14;
        r14 = 0;
        r0 = r18;
        r0.mLockScreenTimeout = r14;
        r14 = 0;
        r0 = r18;
        r0.mPadDesktopModeLockScreenTimeout = r14;
        r14 = 0;
        r0 = r18;
        r0.mPadLockScreenTimeout = r14;
        r14 = 0;
        r0 = r18;
        r0.mConnectedInputDevices = r14;
        r14 = new java.util.concurrent.ConcurrentHashMap;
        r14.<init>();
        r0 = r18;
        r0.mKeyboardInfo = r14;
        r14 = new com.android.server.pc.HwPCManagerService$5;
        r0 = r18;
        r14.<init>();
        r0 = r18;
        r0.mInputDeviceListener = r14;
        r14 = 0;
        r0 = r18;
        r0.mAxisX = r14;
        r14 = 0;
        r0 = r18;
        r0.mAxisY = r14;
        r14 = new com.android.server.pc.HwPCManagerService$6;
        r0 = r18;
        r14.<init>();
        r0 = r18;
        r0.mPointerListener = r14;
        r14 = new java.util.ArrayList;
        r14.<init>();
        r0 = r18;
        r0.mIntentList = r14;
        r14 = new com.android.server.pc.HwPCManagerService$7;
        r0 = r18;
        r14.<init>();
        r0 = r18;
        r0.mAlarmListener = r14;
        r14 = 1;
        r0 = r18;
        r0.mScreenPowerOn = r14;
        r14 = new java.lang.Object;
        r14.<init>();
        r0 = r18;
        r0.mScreenAccessLock = r14;
        r14 = new com.android.server.pc.HwPCManagerService$8;
        r0 = r18;
        r14.<init>();
        r0 = r18;
        r0.mAlarmClockReceiver = r14;
        r0 = r19;
        r1 = r18;
        r1.mContext = r0;
        r14 = r20;
        r14 = (com.android.server.am.HwActivityManagerService) r14;
        r0 = r18;
        r0.mAMS = r14;
        r14 = new com.android.server.ServiceThread;
        r15 = "HwPCManagerService";
        r16 = -2;
        r17 = 0;
        ...
        r0 = r18;
        r14 = r0.mHandlerThread;
        r14.start();
        r14 = new com.android.server.pc.HwPCManagerService$LocalHandler;
        r0 = r18;
        r15 = r0.mHandlerThread;
        r15 = r15.getLooper();
        r0 = r18;
        r14.<init>(r15);
        r0 = r18;
    ...
    L_0x01aa:
        ...
        r0.mUserId = r14;
    L_0x01b0:
        r14 = android.app.ActivityManager.getService();	 Catch:{ RemoteException -> 0x0202 }
        r15 = new com.android.server.pc.HwPCManagerService$12;	 Catch:{ RemoteException -> 0x0202 }
        r0 = r18;	 Catch:{ RemoteException -> 0x0202 }
        r15.<init>();	 Catch:{ RemoteException -> 0x0202 }
        r16 = "HwPCManagerService";	 Catch:{ RemoteException -> 0x0202 }
        r14.registerUserSwitchObserver(r15, r16);	 Catch:{ RemoteException -> 0x0202 }
    L_0x01c1:
        r14 = com.android.server.pc.DisplayDriverCommunicator.getInstance();
        r0 = r18;
        r0.mDDC = r14;
        r4 = -1;
        r0 = r18;
        r14 = r0.mContext;
        r15 = "display";
        r14 = r14.getSystemService(r15);
        r14 = (android.hardware.display.DisplayManager) r14;
        r0 = r18;
        r0.mDisplayManager = r14;
        r0 = r18;
        r14 = r0.mDisplayManager;
    ...
    L_0x0202:
        r6 = move-exception;
        r14 = "HwPCManagerService";
        r15 = "registerUserSwitchObserver RemoteException";
        android.util.HwPCUtils.log(r14, r15);
        goto L_0x01c1;
    L_0x020d:
        r14 = r5[r9];
        r14 = r14.getDisplayId();
        r0 = r18;
        r14 = r0.isWiredDisplay(r14);
        if (r14 == 0) goto L_0x01ff;
    L_0x021b:
        r14 = r5[r9];
        r4 = r14.getDisplayId();
    L_0x0221:
        r14 = -1;
        if (r4 == r14) goto L_0x0235;
    L_0x0224:
        r8 = r4;
        r0 = r18;
        r14 = r0.mUIHandler;
        r15 = new com.android.server.pc.HwPCManagerService$13;
        r0 = r18;
        r15.<init>(r8);
    ...
    L_0x0235:
        ...
        r14 = r0.mContext;
        r15 = "input";
        r10 = r14.getSystemService(r15);
        r10 = (android.hardware.input.InputManager) r10;
        if (r10 != 0) goto L_0x034b;
    L_0x0244:
        r14 = new com.android.server.pc.HwPCManagerService$PCSettingsObserver;
        r0 = r18;
        r15 = r0.mHandler;
        r0 = r18;
        r14.<init>(r15);
        r0 = r18;
        r0.mPCSettingsObserver = r14;
        r0 = r18;
        r14 = r0.mPCSettingsObserver;
        r14.readScreenOffSettings();
        r0 = r18;
        r14 = r0.mPCSettingsObserver;
        r14.restoreScreenOffSettings();
        r14 = r18.deviceIsProvisioned();
        r0 = r18;
        r0.mProvisioned = r14;
        r0 = r18;
        r14 = r0.mPCSettingsObserver;
        ...
        r0 = r18;
        r0.mProjMode = r14;
        r14 = android.util.HwPCUtils.enabledInPad();
        if (r14 == 0) goto L_0x0299;
    L_0x027c:
        r0 = r18;
        r14 = r0.mContext;
        r14 = r14.getContentResolver();
        r15 = "selected-proj-mode";
        r16 = 0;
        r14 = android.provider.Settings.Secure.getInt(r14, r15, r16);
        r15 = 1;
    ...
    L_0x0299:
        ...
        r15 = "notification";
        r14 = r14.getSystemService(r15);
        r14 = (android.app.NotificationManager) r14;
        r0 = r18;
        r0.mNm = r14;
        r0 = r18;
        r14 = r0.mNm;
    ...
    L_0x02b0:
        r18.initNotifications();
    L_0x02b3:
        r7 = new android.content.IntentFilter;
        r7.<init>();
        r14 = "com.android.server.pc.action.SWITCH_MODE";
        r7.addAction(r14);
        r14 = "android.intent.action.LOCALE_CHANGED";
        r7.addAction(r14);
        r14 = "com.android.server.pc.action.UNINSTALL_APP";
        r7.addAction(r14);
        r14 = "com.android.server.pc.action.SHOW_MK";
        r7.addAction(r14);
        r0 = r18;
        r14 = r0.mContext;
        r0 = r18;
        r15 = r0.mNotifyReceiver;
        r16 = "com.huawei.permission.SWITCH_MODE";
        r17 = 0;
        r0 = r16;
        r1 = r17;
        r14.registerReceiver(r15, r7, r0, r1);
        r14 = new com.android.server.pc.HwPCManagerService$UnlockScreenReceiver;
        r15 = 0;
        r0 = r18;
        r14.<init>();
        r0 = r18;
        r0.mUnlockScreenReceiver = r14;
        r12 = new android.content.IntentFilter;
        r12.<init>();
        r14 = "android.intent.action.USER_PRESENT";
        r12.addAction(r14);
        r0 = r18;
        r14 = r0.mContext;
        r0 = r18;
        r15 = r0.mUnlockScreenReceiver;
        r14.registerReceiver(r15, r12);
        r14 = new com.android.server.am.HwPCMultiWindowThumbnailPersister;
        r0 = r20;
        r14.<init>(r0);
        r0 = r18;
        r0.mThumbnailPersister = r14;
        r18.registerExternalPointerEventListener();
        r14 = "audio";
        r14 = android.os.ServiceManager.getService(r14);
        r0 = r18;
        r0.mIBinderAudioService = r14;
        r14 = -1;
        r0 = r18;
        r0.setDesktopModeToAudioService(r14);
        r14 = "alarm";
        r0 = r19;
        r14 = r0.getSystemService(r14);
        r14 = (android.app.AlarmManager) r14;
        r0 = r18;
        r0.mAlarmManager = r14;
        r0 = r18;
        r14 = r0.mContext;
        r15 = "phone";
        r14 = r14.getSystemService(r15);
        r14 = (android.telephony.TelephonyManager) r14;
        r0 = r18;
        r0.mTelephonyPhone = r14;
        r14 = android.util.HwPCUtils.ProjectionMode.PHONE_MODE;
        android.util.HwPCUtils.setPcCastModeInServerEarly(r14);
        return;
    L_0x034b:
        r3 = android.view.InputDevice.getDeviceIds();
        r9 = 0;
    L_0x0350:
        r14 = r3.length;
        if (r9 >= r14) goto L_0x0369;
    L_0x0353:
        r14 = r3[r9];
        r2 = android.view.InputDevice.getDevice(r14);
        r0 = r18;
        r14 = r0.mConnectedInputDevices;
        r15 = whichInputDevice(r2);
        r14 = r14 | r15;
        r0 = r18;
        r0.mConnectedInputDevices = r14;
        r9 = r9 + 1;
    ...
    L_0x0369:
        r0 = r18;
        r14 = r0.mInputDeviceListener;
        r15 = 0;
        r10.registerInputDeviceListener(r14, r15);
        goto L_0x0244;
    L_0x0373:
        r11 = 0;
        goto L_0x0291;
    L_0x0376:
        ...
        goto L_0x0299;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.pc.HwPCManagerService.<init>(android.content.Context, com.android.server.am.ActivityManagerService):void");
    }
    ...
    private void sendNotificationForSwitch(ProjectionMode projMode) {
        if (!HwPCUtils.enabledInPad() && this.mNm != null) {
            ...
            String contentText = String.format(this.mContext.getString(33685959), new Object[]{otherMode});
            this.mBuilderForSwitch.setContentText(contentText).setStyle(new BigTextStyle().bigText(contentText));
    ...
    private void sendNotificationForInputDev() {
        if (!HwPCUtils.enabledInPad() && this.mNm != null) {
            ...
            String contentText = this.mContext.getString(33685961);
            this.mBuilderForInput.setContentText(contentText).setStyle(new BigTextStyle().bigText(contentText));
    ...
    public void onDisplayRemoved(int displayId) {
        if (HwPCUtils.enabledInPad()) {
            ...
            boolean isDesktopMode = HwPCUtils.getPhoneDisplayID() == displayId ? isDesktopMode(this.mProjMode) ^ 1 : false;
            HwPCUtils.log(TAG, "onDisplayRemoved, displayId:" + displayId + ", isInPhoneMode:" + isDesktopMode);
            if (HwPCUtils.getPCDisplayID() != displayId && (isDesktopMode ^ 1) != 0) {
        ...
        if (HwPCUtils.enabled()) {
            ...
            if (!this.mProvisioned) {
                ...
                if (isWiredDisplay(displayId)) {
                    ...
                    this.mDisplayId = displayId;
                    boolean explorerExist = systemUIExist() ? explorerExist() : false;
                    boolean enterDesktopMode = explorerExist && isDesktopMode(this.mProjMode) && this.mUserId == 0;
                    HwPCUtils.log(TAG, "onDisplayAdded mProjMode " + this.mProjMode + ", mConnectedInputDevices = " + this.mConnectedInputDevices + ", exist =" + explorerExist + ", mUserId = " + this.mUserId + ", enterDesktopMode =" + enterDesktopMode);
                    if (this.mDisplayManager != null) {
    ...
    private void setScreenPowerInner(boolean powerOn, boolean checking) {
        ...
        synchronized (this.mScreenAccessLock) {
            ...
            try {
                FileOutputStream fileDevice = new FileOutputStream(new File(SCREEN_POWER_DEVICE));
                try {
                    fileDevice.write(val.getBytes("utf-8"));
