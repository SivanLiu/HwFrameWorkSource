...
final class AccessibilityController {
    ...
    private static final class DisplayMagnifier {
        ...
        private final class MagnifiedViewport {
            ...
            private void populateWindowsOnScreenLocked(SparseArray<WindowState> outWindows) {
                ...
                dc.forAllWindows((Consumer) new -$Lambda$YIZfR4m-B8z_tYbP2x4OJ3o7OYE((byte) 0, outWindows), false);
            }

            static /* synthetic */ void lambda$-com_android_server_wm_AccessibilityController$DisplayMagnifier$MagnifiedViewport_30521(SparseArray outWindows, WindowState w) {
        ...
        public MagnificationSpec getMagnificationSpecForWindowLocked(WindowState windowState) {
            ...
            if (spec == null || (spec.isNop() ^ 1) == 0 || this.mWindowManagerService.mPolicy.canMagnifyWindow(windowState.mAttrs.type)) {
                return spec;
            }
            return null;
        }
    ...
    private static final class WindowsForAccessibilityObserver {
        ...
        private void populateVisibleWindowsOnScreenLocked(SparseArray<WindowState> outWindows) {
            ...
            dc.forAllWindows((Consumer) new -$Lambda$YIZfR4m-B8z_tYbP2x4OJ3o7OYE((byte) 1, outWindows), false);
        }

        static /* synthetic */ void lambda$-com_android_server_wm_AccessibilityController$WindowsForAccessibilityObserver_62363(SparseArray outWindows, WindowState w) {
            if (w.isVisibleLw()) {
                outWindows.put(w.mLayer, w);
            }
        }
