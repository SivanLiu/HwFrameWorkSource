...
class AppWindowToken extends WindowToken implements AppFreezeListener {
    ...
    private boolean isInFilterList() {
        String windowTitle = toString();
        for (String mgObj : this.mFilterNameList) {
            if (windowTitle.contains(mgObj)) {
                return true;
            }
        }
        return false;
    ...
    AppWindowToken(WindowManagerService service, IApplicationToken token, boolean voiceInteraction, DisplayContent dc, long inputDispatchingTimeoutNanos, boolean fullscreen, boolean showForAllUsers, int targetSdk, int orientation, int rotationAnimationHint, int configChanges, boolean launchTaskBehind, boolean alwaysFocusable, AppWindowContainerController controller, Configuration overrideConfig, Rect bounds, boolean naviBarHide, boolean hwNotchSupport, int hwGestureNavOptions) {
        ...
        this.mHwGestureNavOptions = hwGestureNavOptions;
    }
    ...
    AppWindowToken(WindowManagerService service, IApplicationToken token, boolean voiceInteraction, DisplayContent dc, boolean fillsParent, Configuration overrideConfig, Rect bounds) {
        ...
        this.mFilterNameList = new String[]{"com.android.mediacenter/.ui.player.land.PlaybackLandActivity", "com.android.gallery3d", "com.huawei.hiassistant", "com.google.android.videos/.mobile.usecase.watch.WatchActivity$InitiallyLandscape", "com.huawei.himovie/com.huawei.hwvplayer.service.player.FullscreenActivity", "com.huawei.android.launcher/.WallpaperSetting", "com.huawei.health/com.huawei.healthcloud.plugintrack.ui.activity.TrackLineChartActivity", "com.huawei.systemmanager/.power.ui.HwPowerManagerActivity", "com.android.settings/.applications.InstalledAppDetails", "com.huawei.himovie.overseas/com.huawei.hwvplayer.service.player.FullscreenActivity"};
        this.appToken = token;
    ...
    void updateReportedVisibilityLocked() {
        if (this.appToken != null) {
            ...
            boolean z2 = (numInteresting <= 0 || numVisible < numInteresting) ? false : this.hidden ^ 1;
            if (!nowGone) {
                if (!z) {
    ...
    int getOrientation(int candidate) {
        ...
        if ((!this.sendingToBottom ? this.mService.mClosingApps.contains(this) : true) || (!isVisible() && !this.mService.mOpeningApps.contains(this) && (!isOnTop() || (isInFilterList() ^ 1) == 0))) {
            return -2;
        }
        return this.mOrientation;
    }
    ...
    static /* synthetic */ boolean lambda$-com_android_server_wm_AppWindowToken_72070(WindowState w) {
    ...
    void dump(PrintWriter pw, String prefix) {
        ...
        if (this.mNumInterestingWindows == 0 && this.mNumDrawnWindows == 0 && !this.allDrawn) {
            ...
            if (this.startingWindow == null && this.startingSurface == null && !this.startingDisplayed && !this.startingMoved) {
                if (this.mHiddenSetFromTransferredStartingWindow) {
                }
                if (!this.mFrozenBounds.isEmpty()) {
                    pw.print(prefix);
