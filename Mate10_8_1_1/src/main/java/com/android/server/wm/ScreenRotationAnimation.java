...
class ScreenRotationAnimation {
    ...
    private boolean startAnimation(SurfaceSession session, long maxAnimationDuration, float animationScale, int finalWidth, int finalHeight, boolean dismissing, int exitAnim, int enterAnim) {
        ...
        if (this.TWO_PHASE_ANIMATION && this.mFinishExitAnimation == null && !(dismissing && delta == 0)) {
            firstStart = true;
            this.mStartExitAnimation = AnimationUtils.loadAnimation(this.mContext, 17432706);
            this.mStartEnterAnimation = AnimationUtils.loadAnimation(this.mContext, 17432705);
            this.mFinishExitAnimation = AnimationUtils.loadAnimation(this.mContext, 17432697);
            this.mFinishEnterAnimation = AnimationUtils.loadAnimation(this.mContext, 17432696);
        }
        if (exitAnim == 0 || enterAnim == 0) {
            boolean customAnim = false;
            ...
            if (this.mRotateExitAnimation == null || this.mRotateEnterAnimation == null) {
                switch (delta) {
                    case 0:
                        ...
                        break;
                    case 1:
                        this.mRotateExitAnimation = AnimationUtils.loadAnimation(this.mContext, 17432703);
                        this.mRotateEnterAnimation = AnimationUtils.loadAnimation(this.mContext, 17432702);
                        break;
                    case 2:
                        this.mRotateExitAnimation = AnimationUtils.loadAnimation(this.mContext, 17432694);
                        this.mRotateEnterAnimation = AnimationUtils.loadAnimation(this.mContext, 17432693);
                        break;
                    case 3:
