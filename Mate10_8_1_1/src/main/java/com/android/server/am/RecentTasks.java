                ...
                if (userId == -1 || task.userId == userId) {
                    if (task.autoRemoveRecents && task.getTopActivity() == null) {
                        ...
                        if (ai == this.mTmpActivityInfo) {
                            ...
                            if (app == this.mTmpAppInfo || (app.flags & DumpState.DUMP_VOLUMES) == 0) {
                                remove(i);
                                task.removedFromRecents();
                        ...
                        } else if (ai.enabled && (ai.applicationInfo.enabled ^ 1) == 0 && (ai.applicationInfo.flags & DumpState.DUMP_VOLUMES) != 0) {
        ...
        while (i < recentsCount) {
            ...
            if (task != tr) {
                if ((stack == null || trStack == null || stack == trStack) && task.userId == tr.userId) {
                    ...
                    int filterEquals = intent != null ? intent.filterEquals(trIntent) : 0;
                    ...
                    int i2 = isDocument ? isDocument2 : 0;
                    boolean taskHasExcludeFlag = (task.intent.getFlags() & DumpState.DUMP_VOLUMES) != 0;
                    if ((equals && !taskHasExcludeFlag) || (filterEquals ^ 1) == 0 || (i2 ^ 1) == 0) {
                        if (i2 != 0) {
