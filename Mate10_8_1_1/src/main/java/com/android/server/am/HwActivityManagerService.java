...
public final class HwActivityManagerService extends ActivityManagerService {
    ...
    public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
        ...
        switch (code) {
            ...
            case 3211:
                ...
                _result = requestContentNode(componentName, bundle, data.readInt());
                reply.writeNoException();
            ...
            case 3212:
                ...
                _result = requestContentOther(componentName, bundle, data.readInt());
                reply.writeNoException();
                reply.writeInt(_result ? 1 : 0);
                return true;
            case 3301:
    ...
    protected final void startProcessLocked(ProcessRecord app, String hostingType, String hostingNameStr, String abiOverride, String entryPoint, String[] entryPointArgs) {
        if (!shouldPreventStartProcess(app)) {
            ...
            if (HwPCUtils.isPcCastModeInServer()) {
                ...
                if (HwPCUtils.enabledInPad() && r22 == null) {
            ...
            if (HwVRUtils.isVRMode()) {
                Slog.e(TAG, "hwAMS startProcessLocked is VR Display is " + HwVRUtils.getVRDisplayID());
                entryPointArgs = new String[]{String.valueOf(HwVRUtils.getVRDisplayID()), String.valueOf(2880), String.valueOf(1600)};
            }
            ...
            } else if (app.maxAdj > 260 && AwareAppMngSort.checkAppMngEnable() && isAppMngOomAdjCustomized(app.info.packageName)) {
                app.maxAdj = 260;
            }
    ...
    protected void setFocusedActivityLockedForNavi(ActivityRecord r) {
        if (this.mFocusedActivityForNavi != r) {
            if (ActivityManagerDebugConfig.DEBUG_FOCUS) {
                Slog.d(TAG, "setFocusedActivityLockedForNavi: r=" + r);
            }
    ...
    private boolean shouldPreventStartComponent(int type, String calleePackage, int callerUid, int callerPid, String callerPackage, int userId) {
        ...
        if (this.mSystemReady) {
            ...
            try {
                if (this.mTrustSpaceManagerInternal != null) {
                    z = this.mTrustSpaceManagerInternal.checkIntent(type, calleePackage, callerUid, callerPid, callerPackage, userId);
                }
                if (!(z || this.mSecurityProfileInternal == null)) {
                    z |= this.mSecurityProfileInternal.shouldPreventInteraction(type, calleePackage, callerUid, callerPid, callerPackage, userId);
                }
    ...
    public void registerActivityObserver(IActivityObserver observer) {
        ...
        Slog.i(TAG, "registerActivityObserver:" + observer + ", callingPid=" + Binder.getCallingPid() + ", num=" + this.mActivityObservers.getRegisteredCallbackCount());
    }
    ...
    public void unregisterActivityObserver(IActivityObserver observer) {
        ...
        Slog.i(TAG, "unregisterActivityObserver:" + observer + ", callingPid=" + Binder.getCallingPid() + ", num=" + this.mActivityObservers.getRegisteredCallbackCount());
    }
    ...
    final int broadcastIntentLocked(ProcessRecord callerApp, String callerPackage, Intent intent, String resolvedType, IIntentReceiver resultTo, int resultCode, String resultData, Bundle resultExtras, String[] requiredPermissions, int appOp, Bundle bOptions, boolean ordered, boolean sticky, int callingPid, int callingUid, int userId) {
        ...
        if (this.mHwGameAssistantController != null) {
            this.mHwGameAssistantController.handleInterestedBroadcast(intent);
        }
                        ...
                        if (bounds != null) {
                            if (bounds.top < 0) {
                                ...
                                if (task == null) {
                                    ...
                                    str = "HwPCMultiWindowManager";
                                    append = new StringBuilder().append("hwResizeTask: ");
                                    if (bounds != null) {
                                        str2 = "null";
                                    } else {
                                        str2 = bounds.toShortString() + " (" + bounds.width() + ", " + bounds.height() + ")";
                                    }
                                    HwPCUtils.log(str, append.append(str2).toString());
    ...
    public void removePackageAlarm(String pkg, List<String> tags, int targetUid) {
        synchronized (this) {
            if (this.mAlms != null) {
                this.mAlms.removePackageAlarm(pkg, tags, targetUid);
            } else {
