...
final class PendingIntentRecord extends Stub {
    ...
    int sendInner(int r1, android.content.Intent r2, java.lang.String r3, android.os.IBinder r4, android.content.IIntentReceiver r5, java.lang.String r6, android.os.IBinder r7, java.lang.String r8, int r9, int r10, int r11, android.os.Bundle r12) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.server.am.PendingIntentRecord.sendInner(int, android.content.Intent, java.lang.String, android.os.IBinder, android.content.IIntentReceiver, java.lang.String, android.os.IBinder, java.lang.String, int, int, int, android.os.Bundle):int
