        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    CharSequence title = context.getText(17039581);
                    ...
                    notifManager.notifyAsUser(PreBootBroadcaster.TAG, 13, new Builder(PreBootBroadcaster.this.mService.mContext, SystemNotificationChannels.UPDATES).setSmallIcon(17303457).setWhen(0).setOngoing(true).setTicker(title).setColor(context.getColor(17170772)).setContentTitle(title).setContentIntent(activity).setVisibility(1).setProgress(max, index, false).build(), UserHandle.of(PreBootBroadcaster.this.mUserId));
                    return;
                case 2:
    ...
    public void sendNext() {
        if (this.mIndex >= this.mTargets.size()) {
            ...
            if (this.mProgress != null) {
                ...
                this.mProgress.setProgress(this.mIndex, this.mTargets.size(), this.mService.mContext.getString(17039574, new Object[]{label}));
            }
