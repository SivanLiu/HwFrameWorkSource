...
public class HwFingersSnapshooter {
    ...
    private void handleFingerSnapShooterInit() {
        ...
        this.mTrigerStartThreshold = (float) ((Context) checkNull("context", this.mContext)).getResources().getDimensionPixelSize(17105265);
    ...
    private boolean isTalkBackServicesOn() {
        ...
        boolean contains = enabledSerices != null ? enabledSerices.contains(TALKBACK_COMPONENT_NAME) : false;
        Log.i(TAG, "accessibilityEnabled:" + accessibilityEnabled + ",isContainsTalkBackService:" + contains);
