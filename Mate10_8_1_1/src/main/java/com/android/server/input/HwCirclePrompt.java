...
public class HwCirclePrompt {
    ...
    private void drawText(Canvas canvas, TextPaint paint) {
        ...
        if (str != null) {
            StaticLayout staticlayout = new StaticLayout(str, paint, this.mWidth - this.fontRightPadding, Alignment.ALIGN_NORMAL, 1.0f, GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO, false);
    ...
    private void drawTextH(Canvas canvas, TextPaint paint) {
        ...
        paint.setTextAlign(Align.CENTER);
        String str = this.mContext.getString(33685838);
        StaticLayout staticlayout = new StaticLayout(str, paint, this.mHeight - this.fontRightPadding, Alignment.ALIGN_NORMAL, 1.0f, GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO, false);
        ...
        canvas.rotate(-90.0f, GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO, GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO);
        staticlayout.draw(canvas);
        canvas.rotate(90.0f, GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO, GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO);
        canvas.restore();
    }
