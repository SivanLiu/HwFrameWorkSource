...
public class HwCircleAnimation {
    ...
    public synchronized void resetAnimaion() {
        ...
        if (this.mRingAlpha == GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO && this.mSmallAlpha == GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO) {
            if (this.mBgAlpha == GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO && this.mInnerAlpha == GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO) {
                if (this.showing) {
                }
