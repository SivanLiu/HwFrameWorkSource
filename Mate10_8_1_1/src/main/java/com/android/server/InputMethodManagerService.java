...
public class InputMethodManagerService extends AbsInputMethodManagerService implements IHwInputMethodManagerInner, ServiceConnection, Callback {
    ...
    static final int MSG_SYSTEM_SWITCH_USER = 6000;
    ...
    private static class ImeSubtypeListAdapter extends ArrayAdapter<ImeSubtypeListItem> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            RadioButton radioButton = (RadioButton) view.findViewById(16909199);
    ...
    public static final class Lifecycle extends SystemService {
        ...
        public void onSwitchUser(int userHandle) {
            this.mService.mHandler.sendMessage(this.mService.mHandler.obtainMessage(InputMethodManagerService.MSG_SYSTEM_SWITCH_USER, userHandle, 0));
        }
    ...
    public InputMethodManagerService(Context context) {
        ...
        this.mSlotIme = this.mContext.getString(17041073);
    ...
    public void systemRunning(StatusBarManagerService statusBar) {
        synchronized (this.mMethodMap) {
            if (!this.mSystemReady) {
                ...
                this.mShowOngoingImeSwitcherForPhones = this.mRes.getBoolean(17957094);
    ...
    InputBindResult startInputInnerLocked() {
        ...
        if (this.mSystemReady) {
            ...
            this.mCurIntent.putExtra("android.intent.extra.client_label", 17040163);
    ...
    private void updateSystemUiLocked(IBinder token, int vis, int backDisposition) {
        if (calledWithValidToken(token)) {
            ...
            if (imi != null && needsToShowImeSwitcher) {
                this.mImeSwitcherNotification.setContentTitle(this.mRes.getText(17040955)).setContentText(InputMethodUtils.getImeAndSubtypeDisplayName(this.mContext, imi, this.mCurrentSubtype)).setContentIntent(this.mImeSwitchPendingIntent);
                try {
                ...
                if (!calledFromValidUser) {
                    ...
                    switch (softInputMode & 15) {
                        case 0:
                            ...
                            } else if (!(!isTextEditor || r11 == 0 || (softInputMode & 256) == 0)) {
                                if (DEBUG_FLOW) {
                                    Slog.v(TAG, "Unspecified window will show input");
                                }
                                if (attribute != null) {
                                    inputBindResult = startInputUncheckedLocked(cs, inputContext, missingMethods, attribute, controlFlags, startInputReason);
                                    didStart = true;
                                }
    ...
    public boolean handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case MSG_SYSTEM_UNLOCK_USER /*5000*/:
                ...
                return true;
            case MSG_SYSTEM_SWITCH_USER /*6000*/:
                onSwitchUser(msg.arg1);
                return true;
            default:
                return false;
        }
    ...
    private void showInputMethodMenu(boolean showAuxSubtypes) {
        ...
        synchronized (this.mMethodMap) {
            ...
            if (immis == null || immis.size() == 0) {
                ...
                final ImeSubtypeListAdapter adapter = new ImeSubtypeListAdapter(contextThemeWrapper, 17367275, imList, checkedItem);
    ...
    private void setDefaultImeEnable(String pkgImeName) {
        try {
            ...
            Slog.wtf(TAG, "Unexpected exception");
        }
    }
