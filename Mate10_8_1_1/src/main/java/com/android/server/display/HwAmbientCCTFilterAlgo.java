...
public class HwAmbientCCTFilterAlgo {
    ...
    private float mLastCloseScreenCCT = GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
    ...
    private float calculateAscendThresholdDelta(float amCCT) {
        float ascendThreshold = GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        PointF temp1 = null;
    ...
    private float calculateDescendThresholdDelta(float amCCT) {
        float descendThreshold = GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        PointF temp1 = null;
    ...
    private float prefilterWeightedMeanFilter(long now) {
        ...
        if (N == 0) {
            ...
            int i;
            float maxCCT = GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
            float sum = GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
            ...
            for (i = N - 1; i >= N - this.mData.preWeightedMeanFilterNum; i--) {
                float weight;
                if (this.mAmbientCCTRingBuffer.getLux(i) != GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO || maxCCT > this.mData.preWeightedMeanFilterCCTTh) {
                    weight = 1.0f;
                } else {
