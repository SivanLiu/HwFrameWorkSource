...
public final class HwBrightnessXmlLoader {
    ...
    public static class Data implements Cloneable {
        ...
        protected Object clone() throws CloneNotSupportedException {
            ...
            newData.brightnessMappingPoints = cloneList(this.brightnessMappingPoints);
    ...
    private static class Element_AutoModeInOutDoorLimitEnble extends HwXmlElement {
        private Element_AutoModeInOutDoorLimitEnble() {
        }

        public String getName() {
            return "AutoModeInOutDoorLimitEnble";
        }
    ...
    private static class Element_BrightenGradualTime extends HwXmlElement {
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.brightenGradualTime > GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        }
    }
    ...
    private static class Element_BrightnessMappingPoints_Point extends HwXmlElement {
        ...
        protected boolean parseValue(XmlPullParser parser) throws XmlPullParserException, IOException {
            if (!this.mIsParsed) {
                ...
                Slog.i(this.TAG, "clear default brightnessMappingPoints,load XML points");
            }
    ...
    private static class Element_CameraAnimationTime extends HwXmlElement {
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.cameraAnimationTime > GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        }
    }
    ...
    private static class Element_DarkLightLevelRatio extends HwXmlElement {
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.darkLightLevelRatio > GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        }
    }
    ...
    private static class Element_DarkLightLuxMaxThreshold extends HwXmlElement {
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.darkLightLuxMaxThreshold > GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        }
    }
    ...
    private static class Element_DarkLightLuxMinThreshold extends HwXmlElement {
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.darkLightLuxMinThreshold > GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        }
    }
    ...
    private static class Element_DarkenGradualTime extends HwXmlElement {
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.darkenGradualTime > GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        }
    }
    ...
    private static class Element_DarkenGradualTimeMax extends HwXmlElement {
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.darkenGradualTimeMax > GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        }
    }
    ...
    private static class Element_DarkenGradualTimeMin extends HwXmlElement {
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.darkenGradualTimeMin >= GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        }
    }
    ...
    private static class Element_InitDoubleSensorInterfere extends HwXmlElement {
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.initDoubleSensorInterfere > GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        }
    }
    ...
    private static class Element_InitSigmoidFuncSlope extends HwXmlElement {
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.initSigmoidFuncSlope > GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        }
    }
    ...
    private static class Element_ManualAnimationBrightenTime extends HwXmlElement {
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.manualAnimationBrightenTime > GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        }
    }
    ...
    private static class Element_ManualAnimationDarkenTime extends HwXmlElement {
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.manualAnimationDarkenTime > GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        }
    }
    ...
    private static class Element_ManualPowerSavingAnimationBrightenTime extends HwXmlElement {
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.manualPowerSavingAnimationBrightenTime > GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        }
    }
    ...
    private static class Element_ManualPowerSavingAnimationDarkenTime extends HwXmlElement {
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.manualPowerSavingAnimationDarkenTime > GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        }
    }
    ...
    private static class Element_ManualThermalModeAnimationBrightenTime extends HwXmlElement {
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.manualThermalModeAnimationBrightenTime > GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        }
    }
    ...
    private static class Element_ManualThermalModeAnimationDarkenTime extends HwXmlElement {
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.manualThermalModeAnimationDarkenTime > GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        }
    }

    private static class Element_MonitorEnable extends HwXmlElement {
        private Element_MonitorEnable() {
        }
    ...
    private static class Element_OffsetBrightenDebounceTime extends HwXmlElement {
        private Element_OffsetBrightenDebounceTime() {
        }

        public String getName() {
            return "OffsetBrightenDebounceTime";
        }
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.offsetBrightenDebounceTime >= 0;
        }
    }

    private static class Element_OffsetDarkenDebounceTime extends HwXmlElement {
        private Element_OffsetDarkenDebounceTime() {
        }

        public String getName() {
            return "OffsetDarkenDebounceTime";
        }
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.offsetDarkenDebounceTime >= 0;
        }
    }
    ...
    private static class Element_OffsetResetShortLuxDelta extends HwXmlElement {
        private Element_OffsetResetShortLuxDelta() {
        }

        public String getName() {
            return "OffsetResetShortLuxDelta";
        }
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.offsetResetShortLuxDelta >= 0;
        }
    }

    private static class Element_OffsetResetShortSwitchTime extends HwXmlElement {
        private Element_OffsetResetShortSwitchTime() {
        }

        public String getName() {
            return "OffsetResetShortSwitchTime";
        }
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.offsetResetShortSwitchTime >= 0;
        }
    }
    ...
    private static class Element_OffsetValidAmbientLuxEnable extends HwXmlElement {
        private Element_OffsetValidAmbientLuxEnable() {
        }

        public String getName() {
            return "OffsetValidAmbientLuxEnable";
        }
    ...
    private static class Element_PgModeBrightnessMappingEnable extends HwXmlElement {
        private Element_PgModeBrightnessMappingEnable() {
        }

        public String getName() {
            return "PgModeBrightnessMappingEnable";
        }
    ...
    private static class Element_RatioForBrightnenSmallThr extends HwXmlElement {
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.ratioForBrightnenSmallThr > GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        }
    }
    ...
    private static class Element_RatioForDarkenSmallThr extends HwXmlElement {
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.ratioForDarkenSmallThr > GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        }
    }
    ...
    private static class Element_RebootFirstBrightnessAutoTime extends HwXmlElement {
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.rebootFirstBrightnessAutoTime > GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        }
    }
    ...
    private static class Element_RebootFirstBrightnessManualTime extends HwXmlElement {
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.rebootFirstBrightnessManualTime > GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        }
    }
    ...
    private static class Element_ScreenBrightnessMinNit extends HwXmlElement {
        ...
        protected boolean checkValue() {
            return HwBrightnessXmlLoader.mData.screenBrightnessMinNit > GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO;
        }
    }
    ...
    private static class Element_ThermalModeBrightnessMappingEnable extends HwXmlElement {
        private Element_ThermalModeBrightnessMappingEnable() {
        }

        public String getName() {
            return "ThermalModeBrightnessMappingEnable";
        }
    ...
    private void registerElement(HwXmlParser parser) {
        HwBrightnessXmlLoader hwBrightnessXmlLoader = this;
        ...
        rootElement.registerChildElement(new Element_ThermalModeBrightnessMappingEnable());
        rootElement.registerChildElement(new Element_PgModeBrightnessMappingEnable());
        ...
        rootElement.registerChildElement(new Element_OffsetResetShortSwitchTime());
        rootElement.registerChildElement(new Element_OffsetResetShortLuxDelta());
        rootElement.registerChildElement(new Element_OffsetBrightenDebounceTime());
        rootElement.registerChildElement(new Element_OffsetDarkenDebounceTime());
        rootElement.registerChildElement(new Element_OffsetValidAmbientLuxEnable());
        rootElement.registerChildElement(new Element_AutoModeInOutDoorLimitEnble());
        ...
        rootElement.registerChildElement(new Element_MonitorEnable());
