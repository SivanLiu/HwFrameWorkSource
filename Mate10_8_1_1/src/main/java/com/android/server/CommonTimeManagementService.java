...
class CommonTimeManagementService extends Binder {
    ...
    /* synthetic */ void lambda$-com_android_server_CommonTimeManagementService_4830() {
        scheduleTimeConfigReconnect();
    }

    /* synthetic */ void lambda$-com_android_server_CommonTimeManagementService_4910() {
        connectToTimeConfig();
    }

    /* synthetic */ void lambda$-com_android_server_CommonTimeManagementService_4984() {
    ...
    private void reevaluateServiceState() {
        ...
        synchronized (this.mLock) {
            ...
            if (str != null) {
                if (!(this.mCurIface == null || (str.equals(this.mCurIface) ^ 1) == 0)) {
                    Log.e(TAG, String.format("Switching common time service binding from %s to %s.", new Object[]{this.mCurIface, str}));
                    this.mCurIface = str;
                }
            }
            doRebind = false;
