            ...
            if (file != null) {
                ...
                try {
                    ...
                    try {
                        ...
                        this.mXtraSwitch = StorageUtils.SDCARD_ROMOUNTED_STATE.equals(xtraProperties.getProperty("XTRA_DOWNLOAD_INTERVAL_CONFIG", StorageUtils.SDCARD_ROMOUNTED_STATE));
