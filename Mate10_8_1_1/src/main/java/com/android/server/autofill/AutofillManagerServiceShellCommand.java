...
public final class AutofillManagerServiceShellCommand extends ShellCommand {
    ...
    private int requestDestroy(PrintWriter pw) {
        ...
        return requestSessionCommon(pw, latch, new -$Lambda$mpPqaCtNJERkwd7tRkFrIaSM3WQ((byte) 0, userId, this, new Stub() {
    ...
    private int requestList(final PrintWriter pw) {
        ...
        int userId = getUserIdFromArgsOrAllUsers();
        final CountDownLatch latch = new CountDownLatch(1);
        return requestSessionCommon(pw, latch, new -$Lambda$mpPqaCtNJERkwd7tRkFrIaSM3WQ((byte) 1, userId, this, new Stub() {
            public void send(int resultCode, Bundle resultData) {
