    ...
    public static void sendBackupOnUpdate(IBackupObserver observer, String packageName, BackupProgress progress) {
        if (observer != null) {
            try {
                ...
                Slog.w(RefactoredBackupManagerService.TAG, "Backup observer went away: onUpdate");
            }
        }
    }
    ...
    public static void sendBackupOnPackageResult(IBackupObserver observer, String packageName, int status) {
        if (observer != null) {
            try {
                ...
                Slog.w(RefactoredBackupManagerService.TAG, "Backup observer went away: onResult");
            }
        }
    }
    ...
    public static void sendBackupFinished(IBackupObserver observer, int status) {
        if (observer != null) {
            try {
                ...
                Slog.w(RefactoredBackupManagerService.TAG, "Backup observer went away: backupFinished");
            }
        }
    }
}
