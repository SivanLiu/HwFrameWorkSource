...
public class SystemImpl implements SystemInterface {
    ...
    private SystemImpl() {
        ...
        xmlResourceParser = AppGlobals.getInitialApplication().getResources().getXml(18284549);
    ...
    public boolean isMultiProcessDefaultEnabled() {
        return Build.SUPPORTED_64_BIT_ABIS.length <= 0 ? ActivityManager.isLowRamDeviceStatic() ^ 1 : true;
    }
}
