...
final class OverlayManagerSettings {
    ...
    private static final class SettingsItem {
        ...
        SettingsItem(String packageName, int userId, String targetPackageName, String baseCodePath, int state, boolean isEnabled, boolean isStatic, int priority) {
            ...
            if (OverlayManagerSettings.FWK_NOVA_TAG.equals(packageName) && HwThemeManager.isNovaProduct() && (HwThemeManager.isDeepDarkTheme(userId) ^ 1) != 0) {
                enable = true;
            }
    ...
    static /* synthetic */ boolean lambda$-com_android_server_om_OverlayManagerSettings_21170(int userId, SettingsItem item) {
