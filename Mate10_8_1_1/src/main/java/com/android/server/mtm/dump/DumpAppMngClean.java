...
public final class DumpAppMngClean {
    ...
    private static /* synthetic */ int[] -getandroid-app-mtm-iaware-appmng-AppMngConstant$AppMngFeatureSwitchesValues() {
        ...
        try {
            iArr[AppMngFeature.APP_ALARM.ordinal()] = 3;
        ...
        if (pw != null) {
            ...
            synchronized (DumpAppMngClean.class) {
                if (consumers.isEmpty()) {
                    consumers.put("clean", -$Lambda$Bs1UnMTRw7HKW5nOccPxJy5itpc.$INST$0);
                    consumers.put("dumpPackage", -$Lambda$Bs1UnMTRw7HKW5nOccPxJy5itpc.$INST$1);
                    consumers.put("dumpPackageList", -$Lambda$Bs1UnMTRw7HKW5nOccPxJy5itpc.$INST$6);
                    consumers.put("dumpTask", -$Lambda$Bs1UnMTRw7HKW5nOccPxJy5itpc.$INST$7);
                    consumers.put("SMClean", -$Lambda$Bs1UnMTRw7HKW5nOccPxJy5itpc.$INST$8);
                    consumers.put("SMQuery", -$Lambda$Bs1UnMTRw7HKW5nOccPxJy5itpc.$INST$9);
                    consumers.put("PGClean", -$Lambda$Bs1UnMTRw7HKW5nOccPxJy5itpc.$INST$10);
                    consumers.put("CrashClean", -$Lambda$Bs1UnMTRw7HKW5nOccPxJy5itpc.$INST$11);
                    consumers.put("CheckStatus", -$Lambda$Bs1UnMTRw7HKW5nOccPxJy5itpc.$INST$12);
                    consumers.put("dumpDecide", -$Lambda$Bs1UnMTRw7HKW5nOccPxJy5itpc.$INST$13);
                    consumers.put("dumpHistory", -$Lambda$Bs1UnMTRw7HKW5nOccPxJy5itpc.$INST$2);
                    consumers.put("help", -$Lambda$Bs1UnMTRw7HKW5nOccPxJy5itpc.$INST$3);
                    consumers.put("dumpBigData", -$Lambda$Bs1UnMTRw7HKW5nOccPxJy5itpc.$INST$4);
                    consumers.put("dumpAppType", -$Lambda$Bs1UnMTRw7HKW5nOccPxJy5itpc.$INST$5);
                }
