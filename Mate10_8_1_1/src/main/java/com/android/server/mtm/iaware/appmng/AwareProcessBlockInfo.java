...
public class AwareProcessBlockInfo implements Comparable<AwareProcessBlockInfo> {
    ...
    public String toString() {
        ...
        sb.append(",uid=").append(this.mUid).append(",pkg=").append(this.mPackageName).append(", cleanType=").append(this.mCleanType.description()).append(", reason=").append(this.mReason);
        return sb.toString();
    }
