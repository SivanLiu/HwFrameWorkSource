...
public class ServicesStatusController extends AwareStateController {
    ...
    private void resetServicesState() {
        ServiceState serviceState = this.mTelephonyManager != null ? this.mTelephonyManager.getServiceState() : null;
        if (serviceState != null) {
            this.mIsRoaming = serviceState.getRoaming();
            this.mServicesState = serviceState.getState();
            if (this.DEBUG) {
