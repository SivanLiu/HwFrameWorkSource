...
public class SearchPanelView extends FrameLayout {
    ...
    public SearchPanelView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mNavigationBarHeight = context.getResources().getDimensionPixelSize(17105147);
    ...
    private void notifyTrikeyEvent(int keyCode) {
        ...
        Log.d(TAG, "isShowNaviGuide:" + isShowNaviGuide + ", aiEnable:" + aiEnable + ", aiNavEnable:" + aiNavEnable);
        Intent intent;
        if (aiNavEnable && (aiEnable ^ 1) != 0 && (FrontFingerPrintSettings.isChinaArea() ^ 1) != 0) {
        ...
        } else if (isShowNaviGuide == 0 && (FrontFingerPrintSettings.isNaviBarEnabled(resolver) ^ 1) != 0) {
