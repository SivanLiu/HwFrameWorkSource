...
public class KeyguardServiceDelegate {
    ...
    private final ServiceConnection mKeyguardConnection = new ServiceConnection() {
        ...
        static /* synthetic */ void lambda$-com_android_server_policy_keyguard_KeyguardServiceDelegate$1_10265() {
            try {
    ...
    public void bindService(Context context) {
        ...
        ComponentName keyguardComponent = ComponentName.unflattenFromString(context.getApplicationContext().getResources().getString(17039804));
        intent.addFlags(256);
