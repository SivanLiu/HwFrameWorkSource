...
class LegacyGlobalActions implements OnDismissListener, OnClickListener {
    ...
    private static abstract class SinglePressAction implements Action {
        ...
        public View create(Context context, View convertView, ViewGroup parent, LayoutInflater inflater) {
            ...
            TextView statusView = (TextView) v.findViewById(16909331);
    ...
    private class BugReportAction extends SinglePressAction implements LongPressAction {
        ...
        public String getStatus() {
            return LegacyGlobalActions.this.mContext.getString(17039695, new Object[]{VERSION.RELEASE, Build.ID});
        }
    }
    ...
    private class SilentModeToggleAction extends ToggleAction {
        public SilentModeToggleAction() {
            super(17302281, 17302279, 17040081, 17040080, 17040079);
        }
    ...
    private static class SilentModeTriStateAction implements Action, View.OnClickListener {
        private final int[] ITEM_IDS = new int[]{16909129, 16909130, 16909131};
        private final AudioManager mAudioManager;
        private final Context mContext;
    ...
    public LegacyGlobalActions(Context context, WindowManagerFuncs windowManagerFuncs, Runnable onDismiss) {
        ...
        this.mShowSilentToggle = this.mContext.getResources().getBoolean(17957052) ^ 1;
    ...
    private GlobalActionsDialog createDialog() {
        ...
        this.mAirplaneModeOn = new ToggleAction(17302408, 17302410, 17040086, 17040085, 17040084) {
            void onToggle(boolean on) {
        ...
        String[] defaultActions = this.mContext.getResources().getStringArray(17236009);
    ...
    private Action getSettingsAction() {
        return new SinglePressAction(17302734, 17040078) {
            public void onPress() {
    ...
    private Action getEmergencyAction() {
        return new SinglePressAction(17302178, 17040073) {
            public void onPress() {
    ...
    private Action getAssistAction() {
        return new SinglePressAction(17302257, 17040071) {
            public void onPress() {
    ...
    private Action getVoiceAssistAction() {
        return new SinglePressAction(17302764, 17040082) {
            public void onPress() {
    ...
    private Action getLockdownAction() {
        return new SinglePressAction(17301551, 17040075) {
            public void onPress() {
            ...
            for (final UserInfo user : users) {
                if (user.supportsSwitchToByUser()) {
                    ...
                    if (currentUser != null) {
                        ...
                        items.add(new SinglePressAction(17302625, createFromPath, (user.name == null ? user.name : "Primary") + (isCurrentUser ? " ✔" : "")) {
                            public void onPress() {
                                try {
