...
public class AccessibilityShortcutController {
    ...
    public static String getTargetServiceComponentNameString(Context context, int userId) {
        ...
        return context.getString(17039766);
    }
    ...
    public void performAccessibilityShortcut() {
        ...
        if (vibrator != null && vibrator.hasVibrator()) {
            vibrator.vibrate(PhoneWindowManager.getLongIntArray(this.mContext.getResources(), 17236014), -1, VIBRATION_ATTRIBUTES);
        }
    ...
    private AlertDialog createShortcutWarningDialog(int userId) {
        ...
        return new AlertDialog.Builder(ActivityThread.currentActivityThread().getSystemUiContext(), this.mContext.getResources().getIdentifier("androidhwext:style/Theme.Emui.Dialog.Alert", null, null)).setTitle(17039533).setMessage(String.format(this.mContext.getString(17039532), new Object[]{Integer.valueOf(3), serviceInfo.getResolveInfo().loadLabel(this.mContext.getPackageManager()).toString()})).setCancelable(false).setPositiveButton(17040260, null).setNegativeButton(17039903, new com.android.server.policy.-$Lambda$k6uOVlk6EqgDgfUMuhedgW8Qb2I.AnonymousClass1(userId, this)).setOnCancelListener(new -$Lambda$k6uOVlk6EqgDgfUMuhedgW8Qb2I(userId, this)).create();
    }

    /* synthetic */ void lambda$-com_android_server_policy_AccessibilityShortcutController_10091(int userId, DialogInterface d, int which) {
        Secure.putStringForUser(this.mContext.getContentResolver(), "accessibility_shortcut_target_service", "", userId);
    }

    /* synthetic */ void lambda$-com_android_server_policy_AccessibilityShortcutController_10423(int userId, DialogInterface d) {
