...
public class HwServiceFactoryImpl implements Factory {
    ...
    public ActivityStack createActivityStack(ActivityDisplay display, int stackId, ActivityStackSupervisor supervisor, RecentTasks recentTasks, boolean onTop) {
        return new HwActivityStack(display, stackId, supervisor, recentTasks, onTop);
    }
