...
public class DataDispatch {
    ...
    private static /* synthetic */ int[] -getandroid-rms-iaware-AwareConstant$ResourceTypeSwitchesValues() {
        ...
        try {
            iArr[ResourceType.RESOURCE_MEDIA_BTN.ordinal()] = 12;
        } catch (NoSuchFieldError e7) {
        }
        try {
            iArr[ResourceType.RESOURCE_NET_MANAGE.ordinal()] = 13;
        } catch (NoSuchFieldError e8) {
        }
        try {
            iArr[ResourceType.RESOURCE_SCENE_REC.ordinal()] = 14;
        ...
        try {
            iArr[ResourceType.RESOURCE_STATUS_BAR.ordinal()] = 15;
        ...
        try {
            iArr[ResourceType.RESOURCE_USER_PRESENT.ordinal()] = 16;
