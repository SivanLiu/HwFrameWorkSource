...
public class MemoryReader {
    ...
    private static final int[] PROC_SWAPS_FORMAT = new int[]{CommandsInterface.EMCOM_SD_XENGINE_REMOVE_PROXY_CONFIG, CommandsInterface.EMCOM_SD_XENGINE_ADD_PROXY_CONFIG, 8201, 8201};
