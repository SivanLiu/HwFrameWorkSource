...
public class KillAction extends Action {
    ...
    private AwareAppMngSortPolicy getAwareAppMngSortPolicy() {
        if (getInvaildKillCount() <= 3) {
            return MemoryUtils.getAppMngSortPolicy(2, 3);
        }
        AwareLog.i(TAG, "request MEM_LEVEL1 grouplist");
        return MemoryUtils.getAppMngSortPolicy(2, 3, 1);
    }
            ...
            if (procGroup == null) {
                ...
                if (procs == null || procs.size() < 1) {
                    ...
                    if (pids != null) {
                        ...
                        EventTracker.getInstance().trackEvent(1002, 0, 0, "uid:" + procGroup.mUid + ", proc:" + str);
                    ...
                    EventTracker.getInstance().trackEvent(1002, 0, 0, "uid:" + procGroup.mUid + ", proc:" + str + " fail ");
                    position--;
                }
            }
        }
