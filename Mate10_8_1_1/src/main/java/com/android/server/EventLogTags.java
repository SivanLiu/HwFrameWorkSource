...
public class EventLogTags {
    ...
    public static void writeNotificationCanceled(String key, int reason, int lifespan, int freshness, int exposure, String listener) {
        EventLog.writeEvent(NOTIFICATION_CANCELED, new Object[]{key, Integer.valueOf(reason), Integer.valueOf(lifespan), Integer.valueOf(freshness), Integer.valueOf(exposure), listener});
    }
