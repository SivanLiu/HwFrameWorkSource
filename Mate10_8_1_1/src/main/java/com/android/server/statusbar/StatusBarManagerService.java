...
public class StatusBarManagerService extends Stub {
    ...
    private final StatusBarManagerInternal mInternalService = new StatusBarManagerInternal() {
        ...
        public boolean showShutdownUi(boolean isReboot, String reason) {
            if (StatusBarManagerService.this.mContext.getResources().getBoolean(17957016) && StatusBarManagerService.this.mBar != null) {
                try {
    ...
    private void updateUiVisibilityLocked(int vis, int fullscreenStackVis, int dockedStackVis, int mask, Rect fullscreenBounds, Rect dockedBounds) {
        if (this.mSystemUiVisibility == vis && this.mFullscreenStackSysUiVisibility == fullscreenStackVis && this.mDockedStackSysUiVisibility == dockedStackVis && (this.mFullscreenStackBounds.equals(fullscreenBounds) ^ 1) == 0) {
            if ((this.mDockedStackBounds.equals(dockedBounds) ^ 1) == 0) {
                return;
            }
        }
    ...
    /* synthetic */ void lambda$-com_android_server_statusbar_StatusBarManagerService_25210() {
    ...
    static /* synthetic */ void lambda$-com_android_server_statusbar_StatusBarManagerService_27327(boolean safeMode) {
        if (safeMode) {
    ...
    public String[] getStatusBarIcons() {
        return this.mContext.getResources().getStringArray(17236031);
    }
