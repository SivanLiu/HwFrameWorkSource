...
public class HwUsbDeviceManager extends UsbDeviceManager {
    ...
    private static final String CLASS_NAME_USBLIQUID = "com.huawei.hwdetectrepair.smartnotify.USBLiquidReceiver";
    ...
    protected void sendUSBLiquidBroadcast(String msg) {
