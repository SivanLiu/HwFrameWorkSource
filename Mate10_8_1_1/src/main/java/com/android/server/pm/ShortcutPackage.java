...
class ShortcutPackage extends ShortcutPackageItem {
            ...
            if (!isNewApp) {
                ...
                for (int i = this.mShortcuts.size() - 1; i >= 0; i--) {
                    try {
                        ...
                        Log.w(TAG, "rescanPackageIfNeeded error for packagname:" + getPackageName() + ",classLoader:" + ((ShortcutInfo) this.mShortcuts.valueAt(i)).getClass().getClassLoader());
                    }
                }
            }
    ...
    static /* synthetic */ int lambda$-com_android_server_pm_ShortcutPackage_34997(ShortcutInfo a, ShortcutInfo b) {
    ...
    static /* synthetic */ int lambda$-com_android_server_pm_ShortcutPackage_42045(ShortcutInfo a, ShortcutInfo b) {
