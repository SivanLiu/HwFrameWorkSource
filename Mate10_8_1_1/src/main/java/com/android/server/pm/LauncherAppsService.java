...
public class LauncherAppsService extends SystemService {
    ...
    static class LauncherAppsImpl extends Stub {
        ...
        private class MyPackageMonitor extends PackageMonitor implements ShortcutChangeListener {
            ...
            /* synthetic */ void lambda$-com_android_server_pm_LauncherAppsService$LauncherAppsImpl$MyPackageMonitor_39373(String packageName, int userId) {
                onShortcutChangedInner(packageName, userId);
            }

            public void onShortcutChanged(String packageName, int userId) {
                LauncherAppsImpl.this.postToPackageMonitorHandler(new -$Lambda$i1ZZeLvwPPAZVBl_nnQ0C2t5oMs((byte) 0, userId, this, packageName));
            }
