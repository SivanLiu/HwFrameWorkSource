...
class ShortcutUser {
    ...
    static /* synthetic */ void lambda$-com_android_server_pm_ShortcutUser_8319(int packageUserId, String packageName, Consumer callback, ShortcutPackageItem spi) {
    ...
    static /* synthetic */ void lambda$-com_android_server_pm_ShortcutUser_10335(ShortcutPackage pkg) {
    ...
    /* synthetic */ void lambda$-com_android_server_pm_ShortcutUser_18284(ShortcutService s, int[] restoredLaunchers, ShortcutLauncher sl) {
    ...
    /* synthetic */ void lambda$-com_android_server_pm_ShortcutUser_18707(ShortcutService s, int[] restoredPackages, int[] restoredShortcuts, ShortcutPackage sp) {
