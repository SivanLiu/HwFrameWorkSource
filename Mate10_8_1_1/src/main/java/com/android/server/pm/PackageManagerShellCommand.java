...
class PackageManagerShellCommand extends ShellCommand {
    ...
    private int runCompile() throws RemoteException {
        ...
        if (compilerFilter != null && compilationReason != null) {
            ...
            return 1;
        } else if (allPackages && str != null) {
            pw.println("-a cannot be specified together with --split");
            return 1;
        } else if (!secondaryDex || str == null) {
            ...
            for (String packageName2 : packageNames) {
                ...
                if (secondaryDex) {
                    ...
                    result = this.mInterface.performDexOptMode(packageName2, checkProfiles, targetCompilerFilter, forceCompilation, true, str);
                }
                if (!result) {
    ...
    private int runSetHomeActivity() {
        ...
        try {
            this.mInterface.setHomeActivity(unflattenFromString, userId);
            pw.println("Success");
            return 0;
        } catch (Exception e) {
            pw.println(e.toString());
    ...
    private int runGetPrivappDenyPermissions() {
        ...
        ArraySet<String> privAppDenyPermissions = SystemConfig.getInstance().getPrivAppDenyPermissions(pkg);
