...
public abstract class IccRecords extends AbstractIccRecords implements IccConstants {
    ...
    public String toString() {
        ...
        if (this.mCarrierTestOverride.isInTestMode()) {
            StringBuilder append2 = new StringBuilder().append(" mFakeImsi=");
        ...
        append = append.append(str).append(" mncLength=").append(this.mMncLength).append(" mailboxIndex=").append(this.mMailboxIndex).append(" spn=").append(this.mSpn);
        if (this.mCarrierTestOverride.isInTestMode()) {
            append2 = new StringBuilder().append(" mFakeSpn=");
