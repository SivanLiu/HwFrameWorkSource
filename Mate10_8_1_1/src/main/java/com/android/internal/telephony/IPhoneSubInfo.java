...
public interface IPhoneSubInfo extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPhoneSubInfo {
        ...
        static final int TRANSACTION_getIccSimChallengeResponse = 34;
        static final int TRANSACTION_getImeiForSubscriber = 5;
        static final int TRANSACTION_getIsimChallengeResponse = 33;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 24:
                    data.enforceInterface(DESCRIPTOR);
                    ImsiEncryptionInfo _result3 = getCarrierInfoForImsiEncryption(data.readInt(), data.readInt(), data.readString());
                    reply.writeNoException();
                    if (_result3 != null) {
                        reply.writeInt(1);
                ...
                case 25:
                    ...
                    if (data.readInt() != 0) {
                        imsiEncryptionInfo = (ImsiEncryptionInfo) ImsiEncryptionInfo.CREATOR.createFromParcel(data);
                    } else {
                        imsiEncryptionInfo = null;
                    }
                    setCarrierInfoForImsiEncryption(_arg0, _arg1, imsiEncryptionInfo);
                    reply.writeNoException();
                    return true;
                case 26:
                    data.enforceInterface(DESCRIPTOR);
