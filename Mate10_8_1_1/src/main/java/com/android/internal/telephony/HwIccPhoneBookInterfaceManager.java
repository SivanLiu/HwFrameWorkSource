    ...
    public boolean updateAdnRecordsWithContentValuesInEfBySearchHW(int efid, ContentValues values, String pin2) {
        synchronized (this.mLock2) {
            if (this.mPhone.getContext().checkCallingOrSelfPermission("android.permission.WRITE_CONTACTS") != 0) {
                ...
                String[] strArr = TextUtils.isEmpty(oldEmail) ? null : new String[]{oldEmail};
                String[] strArr2 = TextUtils.isEmpty(newEmail) ? null : new String[]{newEmail};
                String[] strArr3 = TextUtils.isEmpty(oldAnr) ? null : new String[]{oldAnr};
                String[] strArr4 = TextUtils.isEmpty(newAnr) ? null : new String[]{newAnr};
                ...
                synchronized (this.mLock) {
                    ...
                    AdnRecord oldAdn = new AdnRecord(oldTag, oldPhoneNumber, strArr, strArr3);
                    AdnRecord newAdn = new AdnRecord(newTag, newPhoneNumber, strArr2, strArr4);
