    ...
    public void globalEccCustom(String operatorNumeric) {
        ...
        if (isValid != 0) {
            ...
            if (HwTelephonyFactory.getHwPhoneManager().isSupportEccFormVirtualNet()) {
                obj = HwTelephonyFactory.getHwPhoneManager().getVirtualNetEccWihCard(this.mPhoneId);
                obj2 = HwTelephonyFactory.getHwPhoneManager().getVirtualNetEccNoCard(this.mPhoneId);
                logd("try to get Ecc form virtualNet ecclist_withcard=" + obj + " ecclist_nocard=" + obj2);
            }
            ...
            logd("[SLOT" + this.mPhoneId + "]GECC-globalEccCustom: ecc_withcard = " + obj + ", ecc_nocard = " + obj2);
            if ((TextUtils.isEmpty(obj) ? TextUtils.isEmpty(obj2) ^ 1 : 1) != 0) {
                this.mPhone.mCi.requestSetEmergencyNumbers(obj, obj2);
            } else {
                this.mPhone.mCi.requestSetEmergencyNumbers("", "");
            }
        }
