...
public interface IHwTelephony extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IHwTelephony {
        ...
        static final int TRANSACTION_getCallForwardingOption = 98;
        static final int TRANSACTION_getCdmaGsmImsi = 39;
        static final int TRANSACTION_getCdmaGsmImsiForSubId = 106;
        ...
        static final int TRANSACTION_getImsImpu = 100;
        ...
        static final int TRANSACTION_getLine1NumberFromImpu = 101;
        ...
        static final int TRANSACTION_informModemTetherStatusToChangeGRO = 104;
        static final int TRANSACTION_invokeOemRilRequestRaw = 95;
        static final int TRANSACTION_is4RMimoEnabled = 103;
        static final int TRANSACTION_isCTCdmaCardInGsmMode = 7;
        static final int TRANSACTION_isCardUimLocked = 30;
        static final int TRANSACTION_isCspPlmnEnabled = 96;
        ...
        static final int TRANSACTION_isSecondaryCardGsmOnly = 102;
        ...
        static final int TRANSACTION_setCallForwardingOption = 97;
        ...
        static final int TRANSACTION_setDeepNoDisturbState = 105;
        ...
        static final int TRANSACTION_setSubscription = 99;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 83:
                    ...
                    _arg1 = data.readInt();
                    if (data.readInt() != 0) {
                        message2 = (Message) Message.CREATOR.createFromParcel(data);
                    } else {
                        message2 = null;
                    }
                    notifyCellularCommParaReady(_arg0, _arg1, message2);
                    reply.writeNoException();
                    return true;
                case 84:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 87:
                    ...
                    _arg22 = data.readInt();
                    if (data.readInt() != 0) {
                        message3 = (Message) Message.CREATOR.createFromParcel(data);
                    } else {
                        message3 = null;
                    }
                    _result3 = setDmRcsConfig(_arg0, _arg1, _arg22, message3);
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case TRANSACTION_setRcsSwitch /*88*/:
                    ...
                    _result3 = setRcsSwitch(_arg0, _arg1, message2);
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case TRANSACTION_getRcsSwitchState /*89*/:
                    ...
                    _result3 = getRcsSwitchState(_arg0, message);
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 90:
                    ...
                    _result3 = setDmPcscf(_arg0, _arg12, message2);
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 91:
                    ...
                    _result3 = sendLaaCmd(_arg0, _arg12, message2);
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 92:
                    ...
                    _result3 = getLaaDetailedState(_arg02, message);
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 93:
                ...
                case 95:
                    ...
                    _arg2 = data.createByteArray();
                    _result2 = invokeOemRilRequestRaw(_arg0, _arg13, _arg2);
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    reply.writeByteArray(_arg2);
                    return true;
                case 96:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = isCspPlmnEnabled(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 97:
                    ...
                    if (data.readInt() != 0) {
                        message4 = (Message) Message.CREATOR.createFromParcel(data);
                    } else {
                        message4 = null;
                    }
                    setCallForwardingOption(_arg0, _arg1, _arg22, _arg3, _arg4, message4);
                    reply.writeNoException();
                    return true;
                case 98:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    getCallForwardingOption(_arg0, _arg1, message2);
                    reply.writeNoException();
                    return true;
                case 99:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    _result3 = setSubscription(_arg0, _arg14, message2);
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 100:
                ...
                case 101:
                    data.enforceInterface(DESCRIPTOR);
                    _result = getLine1NumberFromImpu(data.readInt());
                    reply.writeNoException();
                    reply.writeString(_result);
                    return true;
                case 102:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = isSecondaryCardGsmOnly();
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 103:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = is4RMimoEnabled(data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 104:
                    ...
                    reply.writeNoException();
                    return true;
                case TRANSACTION_setDeepNoDisturbState /*105*/:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = setDeepNoDisturbState(data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result3 ? 1 : 0);
                    return true;
                case 106:
