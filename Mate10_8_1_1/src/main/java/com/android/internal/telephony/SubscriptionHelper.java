...
class SubscriptionHelper extends Handler {
    ...
    public void updateSubActivation(int[] simStatus, boolean isStackReadyEvent) {
        ...
        if (isAllSubsAvailable() && (setUiccSent ^ 1) != 0) {
            ...
            boolean isVSimCauseCardReload = ((HwVSimUtils.isVSimDsdsVersionOne() && HwVSimUtils.isVSimEnabled()) || HwVSimUtils.isVSimInProcess()) ? true : HwVSimUtils.isVSimCauseCardReload();
