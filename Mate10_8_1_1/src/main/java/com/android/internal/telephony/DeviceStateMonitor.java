...
public class DeviceStateMonitor extends Handler {
    ...
    public void handleMessage(Message msg) {
        boolean z = false;
        Rlog.d(TAG, "handleMessage msg=" + msg);
        switch (msg.what) {
            case 0:
                onRilConnected();
                return;
    ...
    private void updateDeviceState(int eventType, boolean state) {
        ...
        Rlog.d(TAG, "mIsScreenOn: " + this.mIsScreenOn + " mIsCharging: " + this.mIsCharging + " mIsTetheringOn: " + this.mIsTetheringOn + " mIsPowerSaveOn:" + this.mIsPowerSaveOn);
        int newFilter = 0;
    ...
    protected void getCaller() {
        for (StackTraceElement ste : Thread.currentThread().getStackTrace()) {
            Rlog.d(TAG, "    at " + ste.getClassName() + "." + ste.getMethodName() + "(" + ste.getFileName() + ":" + ste.getLineNumber() + ")");
        }
    }
}
