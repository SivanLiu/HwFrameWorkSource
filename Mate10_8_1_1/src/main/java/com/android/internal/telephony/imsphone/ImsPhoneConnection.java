...
public class ImsPhoneConnection extends Connection implements ImsVideoProviderWrapperCallback {
    ...
    public void onReceiveSessionModifyResponse(int r1, android.telecom.VideoProfile r2, android.telecom.VideoProfile r3) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.internal.telephony.imsphone.ImsPhoneConnection.onReceiveSessionModifyResponse(int, android.telecom.VideoProfile, android.telecom.VideoProfile):void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.telephony.imsphone.ImsPhoneConnection.onReceiveSessionModifyResponse(int, android.telecom.VideoProfile, android.telecom.VideoProfile):void");
    }
    ...
    public ImsPhoneConnection(Phone phone, ImsCall imsCall, ImsPhoneCallTracker ct, ImsPhoneCall parent, boolean isUnknown) {
        ...
        if (phone.getContext().getResources().getBoolean(17957058)) {
    ...
    /* synthetic */ void lambda$-com_android_internal_telephony_imsphone_ImsPhoneConnection_40494(String message) {
    ...
    boolean updateExtras(ImsCall imsCall) {
        ...
        boolean changed = areBundlesEqual(bundle, this.mExtras) ^ 1;
        if (changed) {
