...
public class HwGsmMmiCode {
    ...
    public static CharSequence processBadPinString(Context context, String sc) {
        ...
        CharSequence result = context.getText(17039680);
        if (mPromptUserBadPin2 && (SC_PIN2.equals(sc) || SC_PUK2.equals(sc))) {
            return context.getText(33685780);
        }
        return context.getText(17039680);
    }
    ...
    private static CharSequence getErrorMessage(GsmMmiCode gsmMmiCode, AsyncResult ar) {
        return gsmMmiCode.mContext.getText(17040455);
    }
        ...
        if (ar.exception != null) {
            ...
            if (ar.result instanceof Bundle) {
                ...
                if (ssInfo != null) {
                    ...
                    if (ssInfo.mStatus == 0) {
                        if (mToastSwitch) {
                            sb.append(gsmMmiCode.mContext.getText(17040858));
                        } else {
                            sb.append(gsmMmiCode.mContext.getText(17040971));
                        }
                        gsmMmiCode.mState = State.COMPLETE;
                    } else if (ssInfo.mStatus == 1) {
                        if (mToastSwitch) {
                            sb.append(gsmMmiCode.mContext.getText(17040859));
                        } else {
                            sb.append(gsmMmiCode.mContext.getText(17040972));
                        }
                        gsmMmiCode.mState = State.COMPLETE;
                    } else {
                        sb.append(gsmMmiCode.mContext.getText(17040455));
                    }
                } else {
                    sb.append(gsmMmiCode.mContext.getText(17040455));
                }
    ...
    private static void onHwImsSetComplete(GsmMmiCode gsmMmiCode, Message msg, AsyncResult ar) {
        ...
        if (ar.exception != null) {
            ...
            if (!(ar.exception instanceof CommandException)) {
                ...
                sb.append(gsmMmiCode.mContext.getText(17040546));
            } else {
                sb.append(gsmMmiCode.mContext.getText(17040455));
            }
            ...
            if (gsmMmiCode.getHwCallFwdReg()) {
                sb.append(gsmMmiCode.mContext.getText(17040976));
            } else if (mToastSwitch) {
                sb.append(gsmMmiCode.mContext.getText(17041050));
            } else {
                sb.append(gsmMmiCode.mContext.getText(17040972));
            }
            ...
            gsmMmiCode.mState = State.COMPLETE;
            if (mToastSwitch) {
                sb.append(gsmMmiCode.mContext.getText(17041049));
            } else {
                sb.append(gsmMmiCode.mContext.getText(17040971));
            }
            if (SC_CLIR.equals(gsmMmiCode.mSc)) {
            ...
            gsmMmiCode.mState = State.COMPLETE;
            sb.append(gsmMmiCode.mContext.getText(17040974));
        } else {
            gsmMmiCode.mState = State.FAILED;
            sb.append(gsmMmiCode.mContext.getText(17040455));
        }
    ...
    private static void onHwImsQueryClirComplete(GsmMmiCode gsmMmiCode, AsyncResult ar) {
        ...
        if (ar.exception == null) {
            ...
            switch (clirInfo[1]) {
                case 0:
                    sb.append(gsmMmiCode.mContext.getText(17040975));
                    gsmMmiCode.mState = State.COMPLETE;
                    break;
                case 1:
