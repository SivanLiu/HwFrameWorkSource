...
public class SubscriptionController extends AbstractSubscriptionController {
    ...
    static /* synthetic */ int lambda$-com_android_internal_telephony_SubscriptionController_6639(SubscriptionInfo arg0, SubscriptionInfo arg1) {
    ...
    private SubscriptionInfo getSubInfoRecord(Cursor cursor) {
        ...
        Bitmap iconBitmap = BitmapFactory.decodeResource(this.mContext.getResources(), 17302746);
        ...
        if (isEmbedded) {
            decodeRules = UiccAccessRule.decodeRules(cursor.getBlob(cursor.getColumnIndexOrThrow("access_rules")));
        } else {
            decodeRules = null;
        }
        ...
        return new SubscriptionInfo(simSlotIndex, iccId, simSlotIndex, displayName, carrierName, nameSource, iconTint, number, dataRoaming, iconBitmap, mcc, mnc, countryIso, isEmbedded, decodeRules, status, nwMode);
    }
    ...
    private int getUnusedColor(String callingPackage) {
        ...
        this.colorArr = this.mContext.getResources().getIntArray(17236066);
        int colorIdx = 0;
    ...
    /* synthetic */ boolean lambda$-com_android_internal_telephony_SubscriptionController_35814(String callingPackage, SubscriptionInfo subscriptionInfo) {
...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Exception block dominator not found, method:com.android.internal.telephony.SubscriptionController.addSubInfoRecord(java.lang.String, int):int. bs: [B:2:0x0038, B:10:0x0076, B:20:0x00bb]
...
*/
        ...
        r3 = r3.append(r4);
        r4 = android.telephony.SubscriptionInfo.givePrintableIccid(r23);
        r3 = r3.append(r4);
        r4 = " slotIndex:";
        r3 = r3.append(r4);
        r0 = r24;
    ...
    L_0x0038:
        r3 = "[addSubInfoRecord]- null iccId";	 Catch:{ all -> 0x0273 }
        r0 = r22;	 Catch:{ all -> 0x0273 }
        r0.logdl(r3);	 Catch:{ all -> 0x0273 }
        r3 = -1;
        android.os.Binder.restoreCallingIdentity(r12);
        return r3;
    L_0x0045:
        r0 = r22;	 Catch:{ all -> 0x0273 }
        r3 = r0.mContext;	 Catch:{ all -> 0x0273 }
        r2 = r3.getContentResolver();	 Catch:{ all -> 0x0273 }
        r3 = android.telephony.SubscriptionManager.CONTENT_URI;	 Catch:{ all -> 0x0273 }
        r4 = 3;	 Catch:{ all -> 0x0273 }
        r4 = new java.lang.String[r4];	 Catch:{ all -> 0x0273 }
        r5 = "_id";	 Catch:{ all -> 0x0273 }
        r6 = 0;	 Catch:{ all -> 0x0273 }
        r4[r6] = r5;	 Catch:{ all -> 0x0273 }
        r5 = "sim_id";	 Catch:{ all -> 0x0273 }
        r6 = 1;	 Catch:{ all -> 0x0273 }
        r4[r6] = r5;	 Catch:{ all -> 0x0273 }
        r5 = "name_source";	 Catch:{ all -> 0x0273 }
        r6 = 2;	 Catch:{ all -> 0x0273 }
        r4[r6] = r5;	 Catch:{ all -> 0x0273 }
        r5 = "icc_id=?";	 Catch:{ all -> 0x0273 }
        r6 = 1;	 Catch:{ all -> 0x0273 }
        r6 = new java.lang.String[r6];	 Catch:{ all -> 0x0273 }
        r7 = 0;	 Catch:{ all -> 0x0273 }
        r6[r7] = r23;	 Catch:{ all -> 0x0273 }
        r7 = 0;	 Catch:{ all -> 0x0273 }
        r9 = r2.query(r3, r4, r5, r6, r7);	 Catch:{ all -> 0x0273 }
        r16 = 0;
        if (r9 == 0) goto L_0x007e;
    L_0x0076:
        r3 = r9.moveToFirst();	 Catch:{ all -> 0x026c }
        r3 = r3 ^ 1;	 Catch:{ all -> 0x026c }
        if (r3 == 0) goto L_0x0200;	 Catch:{ all -> 0x026c }
    L_0x007e:
        r16 = 1;	 Catch:{ all -> 0x026c }
        r20 = r22.insertEmptySubInfoRecord(r23, r24);	 Catch:{ all -> 0x026c }
        r3 = new java.lang.StringBuilder;	 Catch:{ all -> 0x026c }
        r3.<init>();	 Catch:{ all -> 0x026c }
        r4 = "[addSubInfoRecord] New record created: ";	 Catch:{ all -> 0x026c }
        r3 = r3.append(r4);	 Catch:{ all -> 0x026c }
        r0 = r20;	 Catch:{ all -> 0x026c }
        r3 = r3.append(r0);	 Catch:{ all -> 0x026c }
        r3 = r3.toString();	 Catch:{ all -> 0x026c }
        r0 = r22;	 Catch:{ all -> 0x026c }
        r0.logdl(r3);	 Catch:{ all -> 0x026c }
    L_0x009f:
        if (r9 == 0) goto L_0x00a4;
    L_0x00a1:
        r9.close();	 Catch:{ all -> 0x0273 }
    L_0x00a4:
        r3 = android.telephony.SubscriptionManager.CONTENT_URI;	 Catch:{ all -> 0x0273 }
        r5 = "sim_id=?";	 Catch:{ all -> 0x0273 }
        r4 = 1;	 Catch:{ all -> 0x0273 }
        r6 = new java.lang.String[r4];	 Catch:{ all -> 0x0273 }
        r4 = java.lang.String.valueOf(r24);	 Catch:{ all -> 0x0273 }
        r7 = 0;	 Catch:{ all -> 0x0273 }
        r6[r7] = r4;	 Catch:{ all -> 0x0273 }
        r4 = 0;	 Catch:{ all -> 0x0273 }
        r7 = 0;	 Catch:{ all -> 0x0273 }
        r9 = r2.query(r3, r4, r5, r6, r7);	 Catch:{ all -> 0x0273 }
        if (r9 == 0) goto L_0x01cd;
    L_0x00bb:
        r3 = r9.moveToFirst();	 Catch:{ all -> 0x028e }
        if (r3 == 0) goto L_0x01cd;	 Catch:{ all -> 0x028e }
    L_0x00c1:
        r3 = "_id";	 Catch:{ all -> 0x028e }
        r3 = r9.getColumnIndexOrThrow(r3);	 Catch:{ all -> 0x028e }
        r18 = r9.getInt(r3);	 Catch:{ all -> 0x028e }
        r18 = r24;	 Catch:{ all -> 0x028e }
        r3 = sSlotIndexToSubId;	 Catch:{ all -> 0x028e }
        r4 = java.lang.Integer.valueOf(r24);	 Catch:{ all -> 0x028e }
        r8 = r3.get(r4);	 Catch:{ all -> 0x028e }
        r8 = (java.lang.Integer) r8;	 Catch:{ all -> 0x028e }
        if (r8 == 0) goto L_0x00e4;	 Catch:{ all -> 0x028e }
    L_0x00dc:
        r3 = r8.intValue();	 Catch:{ all -> 0x028e }
        r0 = r24;	 Catch:{ all -> 0x028e }
        if (r3 == r0) goto L_0x0278;	 Catch:{ all -> 0x028e }
    L_0x00e4:
        r3 = sSlotIndexToSubId;	 Catch:{ all -> 0x028e }
        r4 = java.lang.Integer.valueOf(r24);	 Catch:{ all -> 0x028e }
        r5 = java.lang.Integer.valueOf(r24);	 Catch:{ all -> 0x028e }
        r3.put(r4, r5);	 Catch:{ all -> 0x028e }
        r19 = r22.getActiveSubInfoCountMax();	 Catch:{ all -> 0x028e }
        r10 = r22.getDefaultSubId();	 Catch:{ all -> 0x028e }
        r3 = new java.lang.StringBuilder;	 Catch:{ all -> 0x028e }
        r3.<init>();	 Catch:{ all -> 0x028e }
        r4 = "[addSubInfoRecord] sSlotIndexToSubId.size=";	 Catch:{ all -> 0x028e }
        r3 = r3.append(r4);	 Catch:{ all -> 0x028e }
        r4 = sSlotIndexToSubId;	 Catch:{ all -> 0x028e }
        r4 = r4.size();	 Catch:{ all -> 0x028e }
        r3 = r3.append(r4);	 Catch:{ all -> 0x028e }
        r4 = " slotIndex=";	 Catch:{ all -> 0x028e }
        r3 = r3.append(r4);	 Catch:{ all -> 0x028e }
        r0 = r24;	 Catch:{ all -> 0x028e }
        r3 = r3.append(r0);	 Catch:{ all -> 0x028e }
        r4 = " subId=";	 Catch:{ all -> 0x028e }
        r3 = r3.append(r4);	 Catch:{ all -> 0x028e }
        r0 = r24;	 Catch:{ all -> 0x028e }
        r3 = r3.append(r0);	 Catch:{ all -> 0x028e }
        r4 = " defaultSubId=";	 Catch:{ all -> 0x028e }
        r3 = r3.append(r4);	 Catch:{ all -> 0x028e }
        r3 = r3.append(r10);	 Catch:{ all -> 0x028e }
        r4 = " simCount=";	 Catch:{ all -> 0x028e }
        r3 = r3.append(r4);	 Catch:{ all -> 0x028e }
        r0 = r19;	 Catch:{ all -> 0x028e }
        r3 = r3.append(r0);	 Catch:{ all -> 0x028e }
        r3 = r3.toString();	 Catch:{ all -> 0x028e }
        r0 = r22;	 Catch:{ all -> 0x028e }
        r0.logdl(r3);	 Catch:{ all -> 0x028e }
        r3 = android.telephony.SubscriptionManager.isValidSubscriptionId(r10);	 Catch:{ all -> 0x028e }
        if (r3 == 0) goto L_0x0155;	 Catch:{ all -> 0x028e }
    L_0x0150:
        r3 = 1;	 Catch:{ all -> 0x028e }
        r0 = r19;	 Catch:{ all -> 0x028e }
        if (r0 != r3) goto L_0x015c;	 Catch:{ all -> 0x028e }
    L_0x0155:
        r0 = r22;	 Catch:{ all -> 0x028e }
        r1 = r24;	 Catch:{ all -> 0x028e }
        r0.setDefaultFallbackSubId(r1);	 Catch:{ all -> 0x028e }
    L_0x015c:
        r3 = 1;	 Catch:{ all -> 0x028e }
        r0 = r19;	 Catch:{ all -> 0x028e }
        if (r0 != r3) goto L_0x0198;	 Catch:{ all -> 0x028e }
    L_0x0161:
        r3 = new java.lang.StringBuilder;	 Catch:{ all -> 0x028e }
        r3.<init>();	 Catch:{ all -> 0x028e }
        r4 = "[addSubInfoRecord] one sim set defaults to subId=";	 Catch:{ all -> 0x028e }
        r3 = r3.append(r4);	 Catch:{ all -> 0x028e }
        r0 = r24;	 Catch:{ all -> 0x028e }
        r3 = r3.append(r0);	 Catch:{ all -> 0x028e }
        r3 = r3.toString();	 Catch:{ all -> 0x028e }
        ...
        r0 = r22;	 Catch:{ all -> 0x028e }
        r1 = r24;	 Catch:{ all -> 0x028e }
        r0.setDefaultDataSubId(r1);	 Catch:{ all -> 0x028e }
        r0 = r22;	 Catch:{ all -> 0x028e }
        r1 = r24;	 Catch:{ all -> 0x028e }
        r0.setDataSubId(r1);	 Catch:{ all -> 0x028e }
        r0 = r22;	 Catch:{ all -> 0x028e }
        r1 = r24;	 Catch:{ all -> 0x028e }
        r0.setDefaultSmsSubId(r1);	 Catch:{ all -> 0x028e }
        r0 = r22;	 Catch:{ all -> 0x028e }
        r1 = r24;	 Catch:{ all -> 0x028e }
        r0.setDefaultVoiceSubId(r1);	 Catch:{ all -> 0x028e }
    L_0x0198:
        r3 = new java.lang.StringBuilder;	 Catch:{ all -> 0x028e }
        r3.<init>();	 Catch:{ all -> 0x028e }
        r4 = "[addSubInfoRecord] hashmap(";	 Catch:{ all -> 0x028e }
        r3 = r3.append(r4);	 Catch:{ all -> 0x028e }
        r0 = r24;	 Catch:{ all -> 0x028e }
        r3 = r3.append(r0);	 Catch:{ all -> 0x028e }
        r4 = ",";	 Catch:{ all -> 0x028e }
        ...
        r0 = r22;	 Catch:{ all -> 0x028e }
        r0.logdl(r3);	 Catch:{ all -> 0x028e }
        r3 = r9.moveToNext();	 Catch:{ all -> 0x028e }
    ...
    L_0x01d2:
        r0 = r22;	 Catch:{ all -> 0x0273 }
        r1 = r24;	 Catch:{ all -> 0x0273 }
        r18 = r0.getSubIdUsingPhoneId(r1);	 Catch:{ all -> 0x0273 }
        r3 = android.telephony.SubscriptionManager.isValidSubscriptionId(r18);	 Catch:{ all -> 0x0273 }
        if (r3 != 0) goto L_0x0295;	 Catch:{ all -> 0x0273 }
    L_0x01e0:
        r3 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0273 }
        r3.<init>();	 Catch:{ all -> 0x0273 }
        r4 = "[addSubInfoRecord]- getSubId failed invalid subId = ";	 Catch:{ all -> 0x0273 }
        r3 = r3.append(r4);	 Catch:{ all -> 0x0273 }
        r0 = r18;	 Catch:{ all -> 0x0273 }
        r3 = r3.append(r0);	 Catch:{ all -> 0x0273 }
        r3 = r3.toString();	 Catch:{ all -> 0x0273 }
        r0 = r22;	 Catch:{ all -> 0x0273 }
        r0.logdl(r3);	 Catch:{ all -> 0x0273 }
        r3 = -1;
        android.os.Binder.restoreCallingIdentity(r12);
    ...
    L_0x0200:
        r3 = 0;
        r18 = r9.getInt(r3);	 Catch:{ all -> 0x026c }
        r3 = 1;	 Catch:{ all -> 0x026c }
        r15 = r9.getInt(r3);	 Catch:{ all -> 0x026c }
        r3 = 2;	 Catch:{ all -> 0x026c }
        r11 = r9.getInt(r3);	 Catch:{ all -> 0x026c }
        r21 = new android.content.ContentValues;	 Catch:{ all -> 0x026c }
        r21.<init>();	 Catch:{ all -> 0x026c }
        r0 = r24;	 Catch:{ all -> 0x026c }
        if (r0 == r15) goto L_0x0231;	 Catch:{ all -> 0x026c }
    L_0x0218:
        r3 = "sim_id";	 Catch:{ all -> 0x026c }
        r4 = java.lang.Integer.valueOf(r24);	 Catch:{ all -> 0x026c }
        r0 = r21;	 Catch:{ all -> 0x026c }
        r0.put(r3, r4);	 Catch:{ all -> 0x026c }
        r3 = "network_mode";	 Catch:{ all -> 0x026c }
        r4 = -1;	 Catch:{ all -> 0x026c }
        r4 = java.lang.Integer.valueOf(r4);	 Catch:{ all -> 0x026c }
        r0 = r21;	 Catch:{ all -> 0x026c }
        r0.put(r3, r4);	 Catch:{ all -> 0x026c }
    L_0x0231:
        r3 = 2;	 Catch:{ all -> 0x026c }
        if (r11 == r3) goto L_0x0236;	 Catch:{ all -> 0x026c }
    L_0x0234:
        r16 = 1;	 Catch:{ all -> 0x026c }
    L_0x0236:
        r3 = r21.size();	 Catch:{ all -> 0x026c }
        if (r3 <= 0) goto L_0x0262;	 Catch:{ all -> 0x026c }
    L_0x023c:
        r3 = android.telephony.SubscriptionManager.CONTENT_URI;	 Catch:{ all -> 0x026c }
        r4 = new java.lang.StringBuilder;	 Catch:{ all -> 0x026c }
        r4.<init>();	 Catch:{ all -> 0x026c }
        r5 = "_id=";	 Catch:{ all -> 0x026c }
        r4 = r4.append(r5);	 Catch:{ all -> 0x026c }
        r0 = r18;	 Catch:{ all -> 0x026c }
        r6 = (long) r0;	 Catch:{ all -> 0x026c }
        r5 = java.lang.Long.toString(r6);	 Catch:{ all -> 0x026c }
        r4 = r4.append(r5);	 Catch:{ all -> 0x026c }
        r4 = r4.toString();	 Catch:{ all -> 0x026c }
        r5 = 0;	 Catch:{ all -> 0x026c }
        r0 = r21;	 Catch:{ all -> 0x026c }
        r2.update(r3, r0, r4, r5);	 Catch:{ all -> 0x026c }
        r22.refreshCachedActiveSubscriptionInfoList();	 Catch:{ all -> 0x026c }
    L_0x0262:
        r3 = "[addSubInfoRecord] Record already exists";	 Catch:{ all -> 0x026c }
        r0 = r22;	 Catch:{ all -> 0x026c }
        r0.logdl(r3);	 Catch:{ all -> 0x026c }
        goto L_0x009f;
    L_0x026c:
    ...
    L_0x0278:
        ...
        r3 = r3 ^ 1;	 Catch:{ all -> 0x028e }
        if (r3 != 0) goto L_0x00e4;	 Catch:{ all -> 0x028e }
    L_0x0284:
        r3 = "[addSubInfoRecord] currentSubId != null && currentSubId is valid, IGNORE";	 Catch:{ all -> 0x028e }
        r0 = r22;	 Catch:{ all -> 0x028e }
        r0.logdl(r3);	 Catch:{ all -> 0x028e }
        goto L_0x0198;
    L_0x028e:
    ...
    L_0x0294:
        throw r3;	 Catch:{ all -> 0x0273 }
    L_0x0295:
        if (r16 == 0) goto L_0x034b;	 Catch:{ all -> 0x0273 }
    L_0x0297:
        r0 = r22;	 Catch:{ all -> 0x0273 }
        r3 = r0.mTelephonyManager;	 Catch:{ all -> 0x0273 }
        r0 = r18;	 Catch:{ all -> 0x0273 }
        r17 = r3.getSimOperatorName(r0);	 Catch:{ all -> 0x0273 }
        r3 = android.text.TextUtils.isEmpty(r17);	 Catch:{ all -> 0x0273 }
        if (r3 != 0) goto L_0x0320;	 Catch:{ all -> 0x0273 }
    L_0x02a7:
        r14 = r17;	 Catch:{ all -> 0x0273 }
    L_0x02a9:
        r21 = new android.content.ContentValues;	 Catch:{ all -> 0x0273 }
        r21.<init>();	 Catch:{ all -> 0x0273 }
        r3 = "display_name";	 Catch:{ all -> 0x0273 }
        r0 = r21;	 Catch:{ all -> 0x0273 }
        r0.put(r3, r14);	 Catch:{ all -> 0x0273 }
        r3 = android.telephony.SubscriptionManager.CONTENT_URI;	 Catch:{ all -> 0x0273 }
        r4 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0273 }
        r4.<init>();	 Catch:{ all -> 0x0273 }
        r5 = "sim_id=";	 Catch:{ all -> 0x0273 }
        r4 = r4.append(r5);	 Catch:{ all -> 0x0273 }
        r0 = r18;	 Catch:{ all -> 0x0273 }
        r6 = (long) r0;	 Catch:{ all -> 0x0273 }
        r5 = java.lang.Long.toString(r6);	 Catch:{ all -> 0x0273 }
        r4 = r4.append(r5);	 Catch:{ all -> 0x0273 }
        r4 = r4.toString();	 Catch:{ all -> 0x0273 }
        r5 = 0;	 Catch:{ all -> 0x0273 }
        r0 = r21;	 Catch:{ all -> 0x0273 }
        r2.update(r3, r0, r4, r5);	 Catch:{ all -> 0x0273 }
        r22.refreshCachedActiveSubscriptionInfoList();	 Catch:{ all -> 0x0273 }
        r3 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0273 }
        r3.<init>();	 Catch:{ all -> 0x0273 }
        r4 = "[addSubInfoRecord] sim name = ";	 Catch:{ all -> 0x0273 }
        r3 = r3.append(r4);	 Catch:{ all -> 0x0273 }
        r3 = r3.append(r14);	 Catch:{ all -> 0x0273 }
        r3 = r3.toString();	 Catch:{ all -> 0x0273 }
        r0 = r22;	 Catch:{ all -> 0x0273 }
        r0.logdl(r3);	 Catch:{ all -> 0x0273 }
    L_0x02f5:
        r3 = sPhones;	 Catch:{ all -> 0x0273 }
        r3 = r3[r24];	 Catch:{ all -> 0x0273 }
        r3.updateDataConnectionTracker();	 Catch:{ all -> 0x0273 }
        r3 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0273 }
        r3.<init>();	 Catch:{ all -> 0x0273 }
        r4 = "[addSubInfoRecord]- info size=";	 Catch:{ all -> 0x0273 }
        r3 = r3.append(r4);	 Catch:{ all -> 0x0273 }
        r4 = sSlotIndexToSubId;	 Catch:{ all -> 0x0273 }
        r4 = r4.size();	 Catch:{ all -> 0x0273 }
        r3 = r3.append(r4);	 Catch:{ all -> 0x0273 }
        r3 = r3.toString();	 Catch:{ all -> 0x0273 }
        r0 = r22;	 Catch:{ all -> 0x0273 }
        r0.logdl(r3);	 Catch:{ all -> 0x0273 }
    ...
    L_0x0320:
        r0 = r22;	 Catch:{ all -> 0x0273 }
        r3 = r0.mTelephonyManager;	 Catch:{ all -> 0x0273 }
        r3 = r3.isMultiSimEnabled();	 Catch:{ all -> 0x0273 }
        if (r3 == 0) goto L_0x0346;	 Catch:{ all -> 0x0273 }
    L_0x032a:
        r3 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0273 }
        r3.<init>();	 Catch:{ all -> 0x0273 }
        r4 = "CARD ";	 Catch:{ all -> 0x0273 }
        r3 = r3.append(r4);	 Catch:{ all -> 0x0273 }
        r4 = r24 + 1;	 Catch:{ all -> 0x0273 }
        r4 = java.lang.Integer.toString(r4);	 Catch:{ all -> 0x0273 }
        r3 = r3.append(r4);	 Catch:{ all -> 0x0273 }
        r14 = r3.toString();	 Catch:{ all -> 0x0273 }
        goto L_0x02a9;	 Catch:{ all -> 0x0273 }
    L_0x0346:
        r14 = "CARD";	 Catch:{ all -> 0x0273 }
        goto L_0x02a9;	 Catch:{ all -> 0x0273 }
    L_0x034b:
        r0 = r22;	 Catch:{ all -> 0x0273 }
        r3 = r0.mCacheActiveSubInfoList;	 Catch:{ all -> 0x0273 }
        r3 = r3.get();	 Catch:{ all -> 0x0273 }
        if (r3 != 0) goto L_0x02f5;	 Catch:{ all -> 0x0273 }
    L_0x0355:
        r3 = "[addSubInfoRecord] need to refresh empty cache if setDisplayName is false";	 Catch:{ all -> 0x0273 }
        r0 = r22;	 Catch:{ all -> 0x0273 }
        r0.logdl(r3);	 Catch:{ all -> 0x0273 }
        r22.refreshCachedActiveSubscriptionInfoList();	 Catch:{ all -> 0x0273 }
        goto L_0x02f5;
        ...
        synchronized (this.mLock) {
            ...
            if (showPlmn) {
                ...
                if (showSpn && !Objects.equals(spn, plmn)) {
                    carrierText = plmn + this.mContext.getString(17040240).toString() + spn;
                }
            } else if (showSpn) {
                carrierText = spn;
            }
    ...
    public int getDefaultSubId() {
        int subId;
        if (this.mContext.getResources().getBoolean(17957060)) {
    ...
    public List<SubscriptionInfo> getSubInfoUsingSlotIndexWithCheck(int slotIndex, boolean needCheck, String callingPackage) {
        ...
        if (SubscriptionManager.isValidSlotIndex(slotIndex)) {
            ...
            cursor = this.mContext.getContentResolver().query(SubscriptionManager.CONTENT_URI, null, "sim_id=?", new String[]{String.valueOf(slotIndex)}, null);
