...
*/
    ...
    private void initActionBarTransition() {
        ObjectAnimator fadeOutAnim = ObjectAnimator.ofFloat(this.mContainerViewCopy, AppAssociate.ASSOC_WINDOW_ALPHA, new float[]{1.0f, 0.0f});
        ...
        ObjectAnimator fadeInAnim = ObjectAnimator.ofFloat(this.mContainerView, AppAssociate.ASSOC_WINDOW_ALPHA, new float[]{FADE_IN_START_ALPHA, 1.0f});
    ...
    public void selectTab(Tab tab) {
        ...
        if (!(fragmentTransaction == null || (fragmentTransaction.isEmpty() ^ 1) == 0)) {
    ...
    private void initContainerViewCopy() {
        if (this.mDecorView != null) {
            ...
            if (this.mDecorView instanceof ViewGroup) {
                this.mContainerViewCopy.setLayoutParams(new LayoutParams(-2, -2));
