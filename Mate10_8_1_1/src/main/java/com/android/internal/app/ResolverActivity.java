...
public class ResolverActivity extends Activity {
    ...
    class ItemClickListener implements OnItemClickListener, OnItemLongClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            if (position >= 0 && ResolverActivity.this.mAdapter.resolveInfoForPosition(position, true) != null) {
                ...
                if (!ResolverActivity.this.mSupportsAlwaysUseOption || (ResolverActivity.this.mAdapter.hasFilteredItem() ^ 1) == 0 || ((hasValidSelection && ResolverActivity.this.mLastSelected == checkedPos) || ResolverActivity.this.mAlwaysButton == null)) {
    ...
    protected void onCreate(Bundle savedInstanceState, Intent intent, CharSequence title, int defaultTitleRes, Intent[] initialIntents, List<ResolveInfo> rList, boolean supportsAlwaysUseOption) {
        ...
        if (!configureContentView(this.mIntents, initialIntents, rList)) {
            ...
            MetricsLogger.action((Context) this, i, intent.getAction() + SettingsStringUtil.DELIMITER + intent.getType() + SettingsStringUtil.DELIMITER + (categories != null ? Arrays.toString(categories.toArray()) : ""));
    ...
    protected boolean onTargetSelected(TargetInfo target, boolean alwaysCheck) {
        ...
        Intent resolvedIntent = target != null ? target.getResolvedIntent() : null;
        if (resolvedIntent != null && ((this.mSupportsAlwaysUseOption || this.mAdapter.hasFilteredItem()) && this.mAdapter.mUnfilteredResolveList != null)) {
            ...
            if (resolvedIntent.getSelector() != null) {
                filterIntent = resolvedIntent.getSelector();
            } else {
                filterIntent = resolvedIntent;
            }
            ...
            if (filter != null) {
                ...
                if (alwaysCheck) {
                    ...
                    pm.addPreferredActivity(filter, bestMatch, set, resolvedIntent.getComponent());
                    if (!ri.handleAllWebDataURI) {
                        ...
                        if (scheme == null) {
                            ...
                            isHttpOrHttps = scheme.equals("https");
                        }
                        boolean equals = action != null ? action.equals("android.intent.action.VIEW") : false;
                        boolean contains;
                        if (categories != null) {
                    ...
                    try {
                        this.mAdapter.mResolverListController.setLastChosen(resolvedIntent, filter, bestMatch);
                    } catch (RemoteException re) {
    ...
    public void onPrepareAdapterView(AbsListView adapterView, ResolveListAdapter adapter) {
        ...
        if (this.mSupportsAlwaysUseOption && viewGroup != null) {
            viewGroup.setChoiceMode(1);
        }
        if (useHeader && viewGroup != null && viewGroup.getHeaderViewsCount() == 0) {
            viewGroup.addHeaderView(LayoutInflater.from(this).inflate((int) R.layout.resolver_different_item_header, viewGroup, false));
        }
    }
