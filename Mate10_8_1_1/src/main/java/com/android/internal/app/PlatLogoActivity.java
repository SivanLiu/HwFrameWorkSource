...
public class PlatLogoActivity extends Activity {
    ...
    public void onAttachedToWindow() {
        ...
        im.setScaleY(0.5f);
        im.setAlpha(0.0f);
        im.setBackground(new RippleDrawable(ColorStateList.valueOf(-8952201), getDrawable(R.drawable.platlogo), null));
        im.setOutlineProvider(new ViewOutlineProvider() {
            public void getOutline(View view, Outline outline) {
                int w = view.getWidth();
                int h = view.getHeight();
                outline.setOval((int) (((double) w) * 0.125d), (int) (((double) h) * 0.125d), (int) (((double) w) * 0.96d), (int) (((double) h) * 0.96d));
            }
        });
        im.setElevation(12.0f * dp);
