...
public class ChooserActivity extends ResolverActivity {
                ...
                for (Intent ii : initialIntents) {
                    if (ii != null) {
                        ...
                        if (ii.getComponent() != null) {
                            try {
                                activityInfo = pm.getActivityInfo(ii.getComponent(), 0);
                        ...
                        if (activityInfo == null) {
                            resolveInfo = pm.resolveActivity(ii, 65536);
                        ...
                        if (activityInfo == null) {
                            ...
                            this.mCallerTargets.add(new DisplayResolveInfo(ii, resolveInfo, resolveInfo.loadLabel(pm), null, ii));
                        }
                    }
                }
            }
    ...
    final class ChooserTargetInfo implements TargetInfo {
        ...
        public boolean startAsCaller(Activity activity, Bundle options, int userId) {
            ...
            if (this.mSourceInfo != null) {
                equals = this.mSourceInfo.getResolvedComponentName().getPackageName().equals(this.mChooserTarget.getComponentName().getPackageName());
            } else {
                equals = false;
            }
            activity.startActivityAsCaller(intent, options, equals, userId);
            return true;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (targetParcelable instanceof Intent) {
            ...
            super.onCreate(savedInstanceState, target, title, defaultTitleRes, intentArr, null, false);
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (adapter.getScore(dri) != 0.0f) {
                ...
                if (convertServiceName != null) {
                    ComponentName serviceComponent = new ComponentName(ai.packageName, convertServiceName);
