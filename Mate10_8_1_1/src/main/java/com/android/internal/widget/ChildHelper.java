...
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.internal.widget.ChildHelper.Bucket.clear(int):void
...
*/
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.internal.widget.ChildHelper.Bucket.clear(int):void");
        }

        void insert(int r1, boolean r2) {
            /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.internal.widget.ChildHelper.Bucket.insert(int, boolean):void
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:116)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:249)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.ProcessClass.process(ProcessClass.java:31)
...
*/
            ...
            // Can't load method instructions.
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.internal.widget.ChildHelper.Bucket.insert(int, boolean):void");
        }

        boolean remove(int r1) {
            /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.internal.widget.ChildHelper.Bucket.remove(int):boolean
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:116)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:249)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.ProcessClass.process(ProcessClass.java:31)
...
*/
            ...
            // Can't load method instructions.
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.internal.widget.ChildHelper.Bucket.remove(int):boolean");
        }
    ...
    View findHiddenNonRemovedView(int position) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (holder.getLayoutPosition() == position && (holder.isInvalid() ^ 1) != 0 && (holder.isRemoved() ^ 1) != 0) {
                return view;
            }
        }
        return null;
