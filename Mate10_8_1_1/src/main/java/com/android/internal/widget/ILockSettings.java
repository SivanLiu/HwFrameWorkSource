...
public interface ILockSettings extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ILockSettings {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 26:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setLockCredentialWithToken(data.readString(), data.readInt(), data.readLong(), data.createByteArray(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 27:
    ...
    boolean setLockCredentialWithToken(String str, int i, long j, byte[] bArr, int i2, int i3) throws RemoteException;
