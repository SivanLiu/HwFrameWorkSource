...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemClickListener {
    ...
    public void animateToVisibility(int visibility) {
        ...
        if (visibility == 0) {
            ...
            ObjectAnimator anim = ObjectAnimator.ofFloat(this, AppAssociate.ASSOC_WINDOW_ALPHA, new float[]{1.0f});
        ...
        anim = ObjectAnimator.ofFloat(this, AppAssociate.ASSOC_WINDOW_ALPHA, new float[]{0.0f});
        anim.setDuration(200);
        anim.setInterpolator(sAlphaInterpolator);
        anim.addListener(this.mVisAnimListener.withFinalVisibility(visibility));
        anim.start();
