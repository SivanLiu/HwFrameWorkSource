...
public final class ENCRYPTION_FACTOR_S {
    public final byte[] certificate = new byte[8192];
    ...
    public final boolean equals(Object otherObject) {
        ...
        return this.encryptionMethod == other.encryptionMethod && this.certificateLen == other.certificateLen && this.splitTimes == other.splitTimes && HidlSupport.deepEquals(this.certificate, other.certificate);
    }
    ...
    public final String toString() {
        ...
        builder.append(this.encryptionMethod);
        builder.append(", .certificateLen = ");
        builder.append(this.certificateLen);
        builder.append(", .splitTimes = ");
        builder.append(this.splitTimes);
        builder.append(", .certificate = ");
        builder.append(Arrays.toString(this.certificate));
        builder.append("}");
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_0_0 = 0; _hidl_index_0_0 < 8192; _hidl_index_0_0++) {
            this.certificate[_hidl_index_0_0] = _hidl_blob.getInt8(_hidl_array_offset_0);
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<ENCRYPTION_FACTOR_S> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((ENCRYPTION_FACTOR_S) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 8204));
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        long _hidl_array_offset_0 = _hidl_offset + 12;
        for (int _hidl_index_0_0 = 0; _hidl_index_0_0 < 8192; _hidl_index_0_0++) {
            _hidl_blob.putInt8(_hidl_array_offset_0, this.certificate[_hidl_index_0_0]);
            _hidl_array_offset_0++;
        }
    }
}
