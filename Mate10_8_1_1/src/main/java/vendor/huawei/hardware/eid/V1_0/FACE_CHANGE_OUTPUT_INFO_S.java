...
public final class FACE_CHANGE_OUTPUT_INFO_S {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != FACE_CHANGE_OUTPUT_INFO_S.class) {
            return false;
        }
        return this.rsv == ((FACE_CHANGE_OUTPUT_INFO_S) otherObject).rsv;
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<FACE_CHANGE_OUTPUT_INFO_S> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((FACE_CHANGE_OUTPUT_INFO_S) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 4));
        }
