...
public interface IRadio extends android.hardware.radio.V1_0.IRadio {
    public static final String kInterfaceName = "vendor.huawei.hardware.radio@1.0::IRadio";
    ...
    public static final class Proxy implements IRadio {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.radio@1.0::IRadio]@Proxy";
            }
        }
