...
public class GoogleHttpClient implements HttpClient {
    ...
    public GoogleHttpClient(ContentResolver resolver, String appAndVersion, boolean gzipCapable) {
        String userAgent = new StringBuilder();
        userAgent.append(appAndVersion);
        userAgent.append(" (");
        userAgent.append(Build.DEVICE);
        userAgent.append(" ");
        userAgent.append(Build.ID);
        userAgent.append(")");
    ...
    public HttpResponse execute(HttpUriRequest request, HttpContext context) throws IOException {
        ...
        try {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Bad URL from: ");
