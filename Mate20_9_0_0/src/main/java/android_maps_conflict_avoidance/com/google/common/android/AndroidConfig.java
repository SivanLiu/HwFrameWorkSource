...
public class AndroidConfig extends Config {
    ...
    protected String getDistributionChannelInternal() {
        ...
        if (TextUtil.isEmpty(cupcakeValue)) {
            str = "Web";
        } else {
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("gmm-");
            stringBuilder.append(cupcakeValue);
    ...
    private String getSetting(String key) {
        try {
            ...
            Cursor cursor = contentResolver.query(parse, strArr, stringBuilder.toString(), null, null);
