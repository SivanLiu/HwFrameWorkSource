...
public class Tile {
    ...
    public static Tile getTile(byte flags, int xIndex, int yIndex, Zoom zoom) {
        ...
        int objectCacheIndex2 = objectCacheIndex;
        Tile tile = tileObjectCache[objectCacheIndex2];
        if (tile != null && tile.flags == flags && tile.xIndex == xIndex && tile.yIndex == yIndex && tile.zoom == zoom) {
            return tile;
        }
        Tile tile2 = new Tile(flags, xIndex, yIndex, zoom, hashCode);
        tileObjectCache[objectCacheIndex2] = tile2;
        return tile2;
    }
    ...
    public String toString() {
        ...
        stringBuilder.append(this.xIndex);
        stringBuilder.append(", ");
        stringBuilder.append(this.yIndex);
        stringBuilder.append(", ");
