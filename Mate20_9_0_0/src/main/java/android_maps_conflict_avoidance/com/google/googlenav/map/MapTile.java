...
public class MapTile {
    ...
    public void setPaint(long mapPaintTime, long lastMapPaintTime) {
        if (this.completePaintCount == 0 && this.lastPaintTime != lastMapPaintTime && mapPaintTime - this.lastPaintTime > 2000) {
    ...
    private static void verifyTileDimensions(GoogleImage image) {
        ...
        if (image.getHeight() != 256 || image.getWidth() != 256) {
            ...
            stringBuilder.append("wrong image size: ");
    ...
    public GoogleImage getImage(long accessTime) {
        ...
        synchronized (this) {
            ...
            if (this.mapImage == null) {
                returnValue2 = getTempImage();
            } else {
                returnValue2 = this.mapImage;
            }
    ...
    public String toString() {
        ...
        stringBuilder2.append(this.location.toString());
        if (this.data != null) {
    ...
    private static GoogleImage getImageFromUnicolor(byte[] unicolorData) {
        ...
        int color = (((unicolorData[0] & 255) << 16) | ((unicolorData[1] & 255) << 8)) | (unicolorData[2] & 255);
