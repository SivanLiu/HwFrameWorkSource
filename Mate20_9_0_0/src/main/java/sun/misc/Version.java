...
public class Version {
    ...
    public static void print(PrintStream ps) {
        ...
        stringBuilder.append(java_vm_name);
        stringBuilder.append(" (build ");
        stringBuilder.append(java_vm_version);
        stringBuilder.append(", ");
        stringBuilder.append(java_vm_info);
        stringBuilder.append(")");
            ...
            if (!jvmVersionInfoAvailable) {
                ...
                if (cs.length() >= 5 && Character.isDigit(cs.charAt(0)) && cs.charAt(1) == '.' && Character.isDigit(cs.charAt(2)) && cs.charAt(3) == '.' && Character.isDigit(cs.charAt(4))) {
                    ...
                    if (cs.charAt(0) == '_' && cs.length() >= 3) {
                        int nextChar = 0;
                        if (Character.isDigit(cs.charAt(1)) && Character.isDigit(cs.charAt(2)) && Character.isDigit(cs.charAt(3))) {
                            nextChar = 4;
                        } else if (Character.isDigit(cs.charAt(1)) && Character.isDigit(cs.charAt(2))) {
                            nextChar = 3;
                        }
                        try {
                            jvm_update_version = Integer.valueOf(cs.subSequence(1, nextChar).toString()).intValue();
