...
final class EPollPort extends Port {
    ...
    private class EventHandlerTask implements Runnable {
        ...
        /* JADX WARNING: Missing block: B:32:0x00d6, code skipped:
            r9.this$0.fdToChannelLock.readLock().unlock();
     */
            ...
            while (true) {
                try {
                    ...
                    while (true) {
                        ...
                        n = EPoll.getDescriptor(eventAddress);
                        if (n == EPollPort.this.sp[0]) {
                        ...
                        PollableChannel channel = (PollableChannel) EPollPort.this.fdToChannel.get(Integer.valueOf(n));
                        if (channel != null) {
