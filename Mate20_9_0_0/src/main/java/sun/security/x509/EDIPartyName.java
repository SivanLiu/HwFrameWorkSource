...
public class EDIPartyName implements GeneralNameInterface {
    ...
    public EDIPartyName(DerValue derValue) throws IOException {
        ...
        for (DerValue opt : new DerInputStream(derValue.toByteArray()).getSequence(2)) {
            DerValue opt2;
            if (opt2.isContextSpecific((byte) 0) && !opt2.isConstructed()) {
            ...
            if (opt2.isContextSpecific((byte) 1) && !opt2.isConstructed()) {
                if (this.party == null) {
    ...
    public String toString() {
        ...
        if (this.assigner == null) {
            ...
            stringBuilder2.append("  nameAssigner = ");
            stringBuilder2.append(this.assigner);
