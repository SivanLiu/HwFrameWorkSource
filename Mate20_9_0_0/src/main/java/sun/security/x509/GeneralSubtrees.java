...
public class GeneralSubtrees implements Cloneable {
    ...
    public String toString() {
        ...
        s.append("   GeneralSubtrees:\n");
        s.append(this.trees.toString());
        s.append("\n");
        return s.toString();
    }
        ...
        try {
            ...
            switch (name.getType()) {
                ...
                default:
                    ...
                    stringBuilder.append("Unsupported GeneralNameInterface type: ");
            ...
            stringBuilder2.append("Unexpected error: ");
    ...
    /* JADX WARNING: Missing block: B:17:0x0052, code skipped:
            r8 = r8 + 1;
     */
    /* JADX WARNING: Missing block: B:57:0x00e2, code skipped:
            r7 = r7 + 1;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public GeneralSubtrees intersect(GeneralSubtrees other) {
        ...
        if (generalSubtrees != null) {
            ...
            GeneralNameInterface thisEntry;
            ...
            int i = 0;
            while (i < size()) {
                thisEntry = getGeneralNameInterface(i);
                ...
                if (sameType) {
                    ...
                    if (!intersection) {
                        ...
                        widestSubtree = createWidestSubtree(thisEntry);
            ...
            for (i = 0; i < other.size(); i++) {
                widestSubtree = generalSubtrees.get(i);
                thisEntry = getGeneralNameInterface(widestSubtree);
                boolean diffType = false;
                int j3 = 0;
                while (j3 < size()) {
                    switch (getGeneralNameInterface(j3).constrains(thisEntry)) {
                        case -1:
                            diffType = true;
                            break;
                        case 0:
