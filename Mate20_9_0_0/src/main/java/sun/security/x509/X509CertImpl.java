...
public class X509CertImpl extends X509Certificate implements DerEncoder {
    ...
    public Object get(String name) throws CertificateParsingException {
        ...
        if (id.equalsIgnoreCase(NAME)) {
            ...
            if (id.equalsIgnoreCase("info")) {
                ...
                if (id.equalsIgnoreCase(SIGNATURE)) {
                    ...
                    stringBuilder.append("Attribute name not recognized or get() not allowed for the same: ");
        ...
        stringBuilder = new StringBuilder();
        stringBuilder.append("Invalid root of attribute name, expected [x509], received [");
        stringBuilder.append(id);
    ...
    public void set(String name, Object obj) throws CertificateException, IOException {
        ...
        if (id.equalsIgnoreCase(NAME)) {
            ...
            if (!id.equalsIgnoreCase("info")) {
                stringBuilder = new StringBuilder();
                stringBuilder.append("Attribute name not recognized or set() not allowed for the same: ");
                stringBuilder.append(id);
                throw new CertificateException(stringBuilder.toString());
            } else if (attr.getSuffix() != null) {
    ...
    public void delete(String name) throws CertificateException, IOException {
        ...
        if (id.equalsIgnoreCase(NAME)) {
            ...
            if (id.equalsIgnoreCase("info")) {
                ...
                stringBuilder = new StringBuilder();
                stringBuilder.append("Attribute name not recognized or delete() not allowed for the same: ");
                stringBuilder.append(id);
                throw new CertificateException(stringBuilder.toString());
            }
        }
    ...
    public String toString() {
        ...
        stringBuilder2.append(encoder.encodeBuffer(this.signature));
    ...
    public boolean[] getKeyUsage() {
        try {
            ...
            if (ret.length < 9) {
                Object usageBits = new boolean[9];
                System.arraycopy((Object) ret, 0, usageBits, 0, ret.length);
                ret = usageBits;
            }
            return ret;
        } catch (Exception e) {
    ...
    private void parse(DerValue val, byte[] originalEncodedForm) throws CertificateException, IOException {
        ...
        } else if (val.data == null || val.tag != (byte) 48) {
