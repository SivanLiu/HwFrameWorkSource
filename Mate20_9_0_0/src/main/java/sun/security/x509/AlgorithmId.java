...
public class AlgorithmId implements Serializable, DerEncoder {
    ...
    public String getName() {
        ...
        if (this.params != null && this.algid.equals(specifiedWithECDSA_oid)) {
            try {
                algName = makeSigAlg(parse(new DerValue(getEncodedParams())).getName(), "EC");
            } catch (IOException e) {
            }
        }
    ...
    public boolean equals(AlgorithmId other) {
        ...
        if (this.algid.equals(other.algid) && paramsEqual) {
            return true;
        }
        return false;
    }
    ...
    public static AlgorithmId get(String algname) throws NoSuchAlgorithmException {
        ...
        try {
            ...
            stringBuilder.append("unrecognized algorithm name: ");
                    ...
                    if (upperCaseAlias.startsWith("ALG.ALIAS")) {
                        ...
                        if (indexOf != -1) {
                            ...
                            if (oid != null) {
                                ...
                                if (stdAlgName2 != null) {
                                    stdAlgName2 = stdAlgName2.toUpperCase(Locale.ENGLISH);
    ...
    public static String makeSigAlg(String digAlg, String encAlg) {
        digAlg = digAlg.replace(LanguageTag.SEP, (CharSequence) "");
