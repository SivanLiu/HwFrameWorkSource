...
public class CRLNumberExtension extends Extension implements CertAttrSet<String> {
    ...
    public void set(String name, Object obj) throws IOException {
        if (!name.equalsIgnoreCase("value")) {
            ...
            stringBuilder.append("Attribute name not recognized by CertAttrSet:");
    ...
    public String toString() {
        ...
        s.append(this.extensionLabel);
        s.append(": ");
        s.append(this.crlNumber == null ? "" : Debug.toHexString(this.crlNumber));
        s.append("\n");
        return s.toString();
    }
