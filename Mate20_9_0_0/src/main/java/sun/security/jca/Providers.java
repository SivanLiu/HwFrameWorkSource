...
public class Providers {
    ...
    public static synchronized ProviderList beginThreadProviderList(ProviderList list) {
        ...
        synchronized (Providers.class) {
            if (ProviderList.debug != null) {
                ...
                stringBuilder.append("ThreadLocal providers: ");
    ...
    private static void checkBouncyCastleDeprecation(String service, String algorithm) throws NoSuchAlgorithmException {
        ...
        if (VMRuntime.getRuntime().getTargetSdkVersion() <= maximumAllowableApiLevelForBcDeprecation) {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append(" * The implementation of the ");
            stringBuilder.append(key);
            stringBuilder.append(" algorithm from");
        ...
        stringBuilder2.append("The BC provider no longer provides an implementation for ");
        stringBuilder2.append(key);
        stringBuilder2.append(".  Please see https://android-developers.googleblog.com/2018/03/cryptography-changes-in-android-p.html for more details.");
