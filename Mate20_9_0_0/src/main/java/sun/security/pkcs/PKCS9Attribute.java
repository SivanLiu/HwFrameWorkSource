...
public class PKCS9Attribute implements DerEncoder {
    ...
    public PKCS9Attribute(String name, Object value) throws IllegalArgumentException {
        ...
        stringBuilder.append("Unrecognized attribute name ");
        stringBuilder.append(name);
        stringBuilder.append(" constructing PKCS9Attribute.");
    ...
    private void init(ObjectIdentifier oid, Object value) throws IllegalArgumentException {
        ...
        stringBuilder.append(value.getClass().toString());
        ...
        if (derIn.available() != 0) {
            ...
            if (this.index == -1) {
                if (debug != null) {
                    Debug debug = debug;
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("Unsupported signer attribute: ");
    ...
    public void derEncode(OutputStream out) throws IOException {
        ...
        if (i != -1) {
            ...
            switch (i) {
                ...
                case 8:
                    ...
                    while (i2 < values.length) {
                        temps[i2] = new DerOutputStream();
                        temps[i2].putPrintableString(values[i2]);
                        i2++;
                    }
                    temp.putOrderedSetOf((byte) 49, temps);
                    break;
        ...
        temp2 = new DerOutputStream();
        temp2.write((byte) 48, temp.toByteArray());
        out.write(temp2.toByteArray());
    }
