...
public class X509CertPath extends CertPath {
    ...
    public X509CertPath(List<? extends Certificate> certs) throws CertificateException {
        ...
        for (Object obj : certs) {
            if (!(obj instanceof X509Certificate)) {
                ...
                stringBuilder.append("List is not all X509Certificates: ");
    ...
    private static List<X509Certificate> parsePKIPATH(InputStream is) throws CertificateException {
        if (is != null) {
            try {
                ...
                ArrayList certList = new ArrayList(seq.length);
                ...
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("IOException parsing PkiPath data: ");
                stringBuilder.append(ioe);
                throw new CertificateException(stringBuilder.toString(), ioe);
            }
        }
    ...
    private byte[] encodePKIPATH() throws CertificateEncodingException {
        ...
        try {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("IOException encoding PkiPath data: ");
            stringBuilder.append(ioe);
            throw new CertificateEncodingException(stringBuilder.toString(), ioe);
        }
    }
