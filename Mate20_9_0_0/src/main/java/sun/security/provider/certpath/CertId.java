...
public class CertId {
    ...
    public int hashCode() {
        if (this.myhash == -1) {
            ...
            int i = 0;
            for (int i2 = 0; i2 < this.issuerNameHash.length; i2++) {
                this.myhash += this.issuerNameHash[i2] * i2;
            }
            while (i < this.issuerKeyHash.length) {
    ...
    public String toString() {
        ...
        stringBuilder.append(this.hashAlgId.toString());
        ...
        stringBuilder2.append(this.certSerialNumber.toString());
