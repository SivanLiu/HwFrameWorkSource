...
class ForwardState implements State {
    ...
    public String toString() {
        ...
        sb.append(this.issuerDN);
        sb.append("\n  traversedCACerts: ");
        sb.append(this.traversedCACerts);
        sb.append("\n  init: ");
        sb.append(String.valueOf(this.init));
        sb.append("\n  keyParamsNeeded: ");
        sb.append(String.valueOf(this.keyParamsNeededFlag));
        sb.append("\n  subjectNamesTraversed: \n");
        sb.append(this.subjectNamesTraversed);
        sb.append("]\n");
        return sb.toString();
    }
