    ...
    protected T startActivity(Intent intent, Bundle savedInstanceState, Object lastNonConfigurationInstance) {
        ...
        if (!this.mAttached) {
            ...
            try {
                ...
                newActivity = getInstrumentation().newActivity(this.mActivityClass, this.mActivityContext, null, this.mApplication, intent2, info, title, this.mMockParent, null, lastNonConfigurationInstance);
            } catch (Exception e) {
