...
public class TouchUtils {
    ...
    private static class ViewStateSnapshot {
        ...
        public int hashCode() {
            int i = 0;
            int result = 31 * (this.mFirst != null ? this.mFirst.hashCode() : 0);
            if (this.mLast != null) {
                i = this.mLast.hashCode();
            }
            return (31 * ((31 * ((31 * (result + i)) + this.mFirstTop)) + this.mLastBottom)) + this.mChildCount;
        }
    }
    ...
    public static void tapView(InstrumentationTestCase test, View v) {
        ...
        inst.sendPointerSync(MotionEvent.obtain(j, eventTime, 2, f, f2, null));
        inst.waitForIdleSync();
    ...
    public static void touchAndCancelView(InstrumentationTestCase test, View v) {
        ...
        float f2 = y + (((float) touchSlop) / 2.0f);
        MotionEvent motionEvent = event;
        inst.sendPointerSync(MotionEvent.obtain(downTime, eventTime, 3, f, f2, null));
        inst.waitForIdleSync();
    }
    ...
    public static void clickView(InstrumentationTestCase test, View v) {
        ...
        inst2.sendPointerSync(MotionEvent.obtain(downTime, SystemClock.uptimeMillis(), 0, f, f2, null));
    ...
    public static void longClickView(InstrumentationTestCase test, View v) {
        ...
        inst.sendPointerSync(MotionEvent.obtain(downTime, SystemClock.uptimeMillis(), 1, x, y, null));
        inst.waitForIdleSync();
    }
    ...
    public static void drag(InstrumentationTestCase test, float fromX, float toX, float fromY, float toY, int stepCount) {
        ...
        while (true) {
            ...
            if (i3 < i) {
                ...
                x2 += xStep;
                int i4 = i3;
                event = MotionEvent.obtain(downTime, SystemClock.uptimeMillis(), 2, x2, y2, 0);
                inst.sendPointerSync(event);
                i2 = i4 + 1;
                MotionEvent motionEvent = event;
            } else {
