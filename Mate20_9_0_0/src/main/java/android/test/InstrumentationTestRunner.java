...
public class InstrumentationTestRunner extends Instrumentation implements TestSuiteProvider {
    ...
    private class SuiteAssignmentPrinter implements TestListener {
        ...
        public void endTest(Test test) {
            ...
            stringBuilder.append(test.getClass().getName());
            stringBuilder.append("#");
            stringBuilder.append(((TestCase) test).getName());
            stringBuilder.append("\nin ");
            stringBuilder.append(assignmentSuite);
            stringBuilder.append(" suite\nrunTime: ");
            stringBuilder.append(String.valueOf(runTime));
            stringBuilder.append("\n");
            this.mTestResult.putString("stream", stringBuilder.toString());
    ...
    private String getCoverageFilePath() {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(getTargetContext().getFilesDir().getAbsolutePath());
        stringBuilder.append(File.separator);
        stringBuilder.append(DEFAULT_COVERAGE_FILE_NAME);
    ...
    private void reportEmmaError(String hint, Exception e) {
        ...
        msg.append("Failed to generate emma coverage. ");
        msg.append(hint);
        msg = msg.toString();
        ...
        this.mResults.putString("stream", stringBuilder.toString());
    }
}
