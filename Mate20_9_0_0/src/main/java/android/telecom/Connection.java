...
public abstract class Connection extends Conferenceable {
    ...
    public static final class RttTextStream {
        ...
        public RttTextStream(ParcelFileDescriptor toInCall, ParcelFileDescriptor fromInCall) {
            ...
            this.mPipeFromInCall = new InputStreamReader(new FileInputStream(fromInCall.getFileDescriptor()));
    ...
    public static abstract class VideoProvider {
        ...
        private final class VideoProviderHandler extends Handler {
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    case 1:
                        binder = msg.obj;
                        callback = Stub.asInterface((IBinder) msg.obj);
                        if (callback == null) {
        ...
        private final class VideoProviderBinder extends IVideoProvider.Stub {
            ...
            /* synthetic */ VideoProviderBinder(VideoProvider x0, AnonymousClass1 x1) {
                this();
            }
    ...
    public final void setSsNotificationData(int type, int code) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setSsNotificationData = ");
    ...
    public final void sendRttInitiationSuccess() {
        this.mListeners.forEach(new -$$Lambda$Connection$8xeoCKtoHEwnDqv6gbuSfOMODH0(this));
    }

    public final void sendRttInitiationFailure(int reason) {
        this.mListeners.forEach(new -$$Lambda$Connection$noXZvls4rxmO_SOjgkFMZLLrfSg(this, reason));
    }

    public final void sendRttSessionRemotelyTerminated() {
        this.mListeners.forEach(new -$$Lambda$Connection$SYsjtKchY2AYvOeGveCrqxSfKTU(this));
    }

    public final void sendRemoteRttRequest() {
        this.mListeners.forEach(new -$$Lambda$Connection$lnfFNF0t9fPLEf01JE291g4chSk(this));
    }
