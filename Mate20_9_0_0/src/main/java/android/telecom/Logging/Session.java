...
public class Session {
    ...
    public int hashCode() {
        int i = 0;
        int result = 31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * (this.mSessionId != null ? this.mSessionId.hashCode() : 0)) + (this.mShortMethodName != null ? this.mShortMethodName.hashCode() : 0))) + ((int) (this.mExecutionStartTimeMs ^ (this.mExecutionStartTimeMs >>> 32))))) + ((int) (this.mExecutionEndTimeMs ^ (this.mExecutionEndTimeMs >>> 32))))) + (this.mParentSession != null ? this.mParentSession.hashCode() : 0))) + (this.mChildSessions != null ? this.mChildSessions.hashCode() : 0))) + this.mIsCompleted)) + this.mChildCounter)) + this.mIsStartedFromActiveSession);
