...
final class ConnectionServiceAdapterServant {
        ...
        private void internalHandleMessage(Message msg) throws RemoteException {
            ...
            switch (i) {
                ...
                case 16:
                    ...
                    access$000.setIsVoipAudioMode(str, z, null);
                    return;
                case 17:
                    args = (SomeArgs) msg.obj;
                    try {
                ...
                case 29:
                    args = (SomeArgs) msg.obj;
                    try {
                        ConnectionServiceAdapterServant.this.mDelegate.setAudioRoute((String) args.arg1, args.argi1, (String) args.arg2, (Info) args.arg3);
                        return;
                    } finally {
                        args.recycle();
                    }
    ...
    private final IConnectionServiceAdapter mStub = new Stub() {
        ...
        public final void setAudioRoute(String connectionId, int audioRoute, String bluetoothAddress, Info sessionInfo) {
            SomeArgs args = SomeArgs.obtain();
            args.arg1 = connectionId;
