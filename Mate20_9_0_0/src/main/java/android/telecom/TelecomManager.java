...
public class TelecomManager {
    ...
    public List<PhoneAccountHandle> getCallCapablePhoneAccounts(boolean includeDisabledAccounts) {
        try {
            ...
            stringBuilder.append(includeDisabledAccounts);
        ...
        if (service != null) {
            ...
            if (extras == null) {
                try {
                    ...
                    Log.e(TAG, "Error calling ITelecomService#placeCall", e2);
                    return;
                }
            }
            e2 = extras;
            service.placeCall(address, e2, this.mContext.getOpPackageName());
        }
    }
