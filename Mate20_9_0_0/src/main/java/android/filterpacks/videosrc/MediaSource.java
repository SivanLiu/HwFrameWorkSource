            ...
            if (useUrl) {
                try {
                    if (this.mLogVerbose) {
                        ...
                        stringBuilder.append("Setting MediaPlayer source to URI ");
                        stringBuilder.append(this.mSourceUrl);
                        Log.v(str, stringBuilder.toString());
                    }
                    ...
                    this.mMediaPlayer = null;
                    if (useUrl) {
                        throw new RuntimeException(String.format("Unable to set MediaPlayer to URL %s!", new Object[]{this.mSourceUrl}), e22);
                    }
                    throw new RuntimeException(String.format("Unable to set MediaPlayer to asset %s!", new Object[]{this.mSourceAsset}), e22);
                }
            }
            if (this.mLogVerbose != null) {
                e22 = TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append("Setting MediaPlayer source to asset ");
                stringBuilder.append(this.mSourceAsset);
                Log.v(e22, stringBuilder.toString());
            }
