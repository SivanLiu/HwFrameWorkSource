...
public class RedEyeFilter extends Filter {
    ...
    public void process(FilterContext context) {
        FrameFormat inputFormat = pullInput(SliceItem.FORMAT_IMAGE).getFormat();
    ...
    private void createRedEyeFrame(FilterContext context) {
        ...
        this.mRadius = Math.max(MIN_RADIUS, RADIUS_RATIO * ((float) Math.min(bitmapWidth, bitmapHeight)));
