            ...
            if (params != null && (params.get(FreezeScreenScene.CHECK_TYPE_PARAM) instanceof Integer)) {
                ...
                switch (checkType) {
                    ...
                    case FreezeScreenScene.FOCUS_WINDOW_NULL_SCENE /*907400013*/:
                        eStream.setParam((short) 0, MonitorHelper.getPackageName()).setParam((short) 1, MonitorHelper.getVersionName()).setParam((short) 2, (String) params.get("focusedActivityName"));
                        break;
                }
            ...
            if (FOCUS_WINDOW_ERROR_SCENE_STRING.equals(type)) {
                ...
                if (this.mHungConfigFocusWindow != null) {
                    ...
                    if (value != null) {
                        try {
                            if (value.length >= 2) {
                                e = Integer.parseInt(value[1]);
                                mCheckFreezeScreenDelayTime = e;
                ...
                if (this.mHungConfigTransWindow != null) {
                    ...
                    if (value != null) {
                        try {
                            if (value.length >= 2) {
                                e3 = Integer.parseInt(value[1]);
                                mCheckFreezeScreenDelayTime = e3;
                                if (status == 0 && value != null && "1".equals(value[0])) {
