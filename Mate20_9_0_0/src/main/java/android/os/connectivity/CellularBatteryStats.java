...
public final class CellularBatteryStats implements Parcelable {
    public static final Creator<CellularBatteryStats> CREATOR = new Creator<CellularBatteryStats>() {
        public CellularBatteryStats createFromParcel(Parcel in) {
            return new CellularBatteryStats(in, null);
        }
    ...
    /* synthetic */ CellularBatteryStats(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
