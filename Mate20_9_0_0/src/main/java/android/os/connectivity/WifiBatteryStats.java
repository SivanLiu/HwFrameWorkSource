...
public final class WifiBatteryStats implements Parcelable {
    public static final Creator<WifiBatteryStats> CREATOR = new Creator<WifiBatteryStats>() {
        public WifiBatteryStats createFromParcel(Parcel in) {
            return new WifiBatteryStats(in, null);
        }
    ...
    /* synthetic */ WifiBatteryStats(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
