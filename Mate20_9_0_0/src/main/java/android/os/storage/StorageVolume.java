...
public final class StorageVolume implements Parcelable {
    ...
    public static final class ScopedAccessProviderContract {
        ...
        public static final String[] TABLE_PERMISSIONS_COLUMNS = new String[]{COL_PACKAGE, COL_VOLUME_UUID, "directory", COL_GRANTED};
    ...
    /* synthetic */ StorageVolume(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        parcel.writeInt(this.mRemovable);
        parcel.writeInt(this.mEmulated);
        parcel.writeInt(this.mAllowMassStorage);
