...
public final class StatsDimensionsValue implements Parcelable {
    ...
    public static final Creator<StatsDimensionsValue> CREATOR = new Creator<StatsDimensionsValue>() {
    ...
    public List<StatsDimensionsValue> getTupleValueList() {
        ...
        try {
            StatsDimensionsValue[] orig = this.mValue;
    ...
    public String toString() {
        try {
            ...
            if (this.mValueType == 7) {
                sb.append("{");
                StatsDimensionsValue[] sbvs = this.mValue;
        ...
        switch (valueType) {
            ...
            default:
                try {
                    ...
                    stringBuilder.append("readValue of an impossible type ");
