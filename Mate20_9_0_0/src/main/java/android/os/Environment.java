...
public class Environment {
    ...
    public static class UserEnvironment {
        ...
        public File[] buildExternalStorageAndroidObbDirs() {
            return Environment.buildPaths(getExternalDirs(), "Android", Environment.DIR_OBB);
        }
        ...
        public File[] buildExternalStorageAppObbDirs(String packageName) {
            return Environment.buildPaths(getExternalDirs(), "Android", Environment.DIR_OBB, packageName);
        }
    ...
    public static File getLegacyExternalStorageObbDirectory() {
        return buildPath(getLegacyExternalStorageDirectory(), "Android", DIR_OBB);
    }
    ...
    private static boolean hasInterestingFiles(File dir) {
        ...
        while (true) {
            ...
            File[] listFilesOrEmpty = FileUtils.listFilesOrEmpty((File) explore.pop());
    ...
    public static File getFingerprintFileDirectory(int userId) {
        if (VERSION.FIRST_SDK_INT <= 27) {
            return getUserSystemDirectory(userId);
        }
        return getDataVendorDeDirectory(userId);
    }
}
