...
public final class Debug {
    ...
    public static final int MEMINFO_MEM_AVAILABLE = 15;
    ...
    public static class MemoryInfo implements Parcelable {
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeInt(this.hasSwappedOutPss);
    ...
    private static String fixTracePath(String tracePath) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(tracePath);
        stringBuilder.append(DEFAULT_TRACE_EXTENSION);
            ...
            switch (stringInfo) {
                ...
                case 0:
                    try {
                        ...
                        stringBuilder2.append("Cannot set field for ");
                        stringBuilder2.append(propertyName);
                        throw new IllegalArgumentException(stringBuilder2.toString(), ex);
                    }
                case 1:
                    break;
                default:
                    stringBuilder = new StringBuilder();
                    stringBuilder.append("Unexpected getStringInfo(");
                    stringBuilder.append(propertyName);
                    stringBuilder.append(") return value ");
                    stringBuilder.append(stringInfo);
        ...
        if (value != null) {
            if (fieldTypeMatches(field, value.getClass())) {
                try {
                    ...
                    stringBuilder2.append("Cannot set field for ");
                    stringBuilder2.append(propertyName);
                    throw new IllegalArgumentException(stringBuilder2.toString(), ex2);
                }
            }
            stringBuilder = new StringBuilder();
            stringBuilder.append("Type of ");
    ...
    public static void setFieldsOn(Class<?> cl, boolean partial) {
        ...
        stringBuilder.append(cl == null ? "null" : cl.getName());
    ...
    public static boolean dumpService(String name, FileDescriptor fd, String[] args) {
        ...
        try {
            ...
            stringBuilder2.append("Can't dump service: ");
    ...
    public static void attachJvmtiAgent(String library, String options, ClassLoader classLoader) throws IOException {
        ...
        Preconditions.checkArgument(library.contains("=") ^ 1);
        if (options == null) {
        ...
        VMDebug.attachAgent(stringBuilder.toString(), classLoader);
    }
}
