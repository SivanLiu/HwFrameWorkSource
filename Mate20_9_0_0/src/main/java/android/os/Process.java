...
public class Process {
    ...
    public static final int FIRST_HBS_APPLICATION_UID = 19959;
    public static final int FIRST_ISOLATED_UID = 99000;
    public static final int FIRST_SHARED_APPLICATION_GID = 50000;
    private static final String HBS_PACKAGE_DATA_PATH = "/data/data/com.huawei.hbs.framework";
    private static final String HBS_PACKAGE_NAME = "com.huawei.hbs.framework";
    ...
    public static final int THREAD_GROUP_PERCEPTIBLE = 11;
    ...
    public static final ProcessStartResult start(String processClass, String niceName, int uid, int gid, int[] gids, int runtimeFlags, int mountExternal, int targetSdkVersion, String seInfo, String abi, String instructionSet, String appDataDir, String invokeWith, String[] zygoteArgs) {
    ...
    public static final ProcessStartResult startWebView(String processClass, String niceName, int uid, int gid, int[] gids, int runtimeFlags, int mountExternal, int targetSdkVersion, String seInfo, String abi, String instructionSet, String appDataDir, String invokeWith, String[] zygoteArgs) {
    ...
    public static final int myUid() {
        int uid = Os.getuid();
        if (FIRST_HBS_APPLICATION_UID > uid || uid > 19999) {
            return uid;
        }
        try {
            StructStat hbsStat = Os.stat(HBS_PACKAGE_DATA_PATH);
            if (hbsStat != null) {
                return hbsStat.st_uid;
            }
            return uid;
        } catch (ErrnoException e) {
            Slog.w(LOG_TAG, "get myUid, HBS uid not found");
            return uid;
        }
    }
    ...
    public static final int getUidForPid(int pid) {
        ...
        readProcLines(stringBuilder.toString(), procStatusLabels, procStatusValues);
    ...
    public static final String getCmdlineForPid(int pid) {
        ...
        readProcFile(stringBuilder.toString(), new int[]{4128}, outStrings, null, null);
        return outStrings[0];
    }
    ...
    public static final boolean isThreadInProcess(int tid, int pid) {
        ...
        try {
            ...
            stringBuilder.append(pid);
            if (Os.access(stringBuilder.toString(), OsConstants.F_OK)) {
                z = true;
                return z;
            }
