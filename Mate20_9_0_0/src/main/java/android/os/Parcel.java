...
public final class Parcel {
    ...
    public void putClassCookies(Map<Class, Object> cookies) {
        if (cookies != null) {
            ...
            this.mClassCookies.putAll((Map) cookies);
        }
    }
    ...
    public final <T extends Parcelable> void writeTypedArray(T[] val, int parcelableFlags) {
        if (val != null) {
            writeInt(N);
            for (Parcelable writeTypedObject : val) {
    ...
    public final void writeValue(Object v) {
        if (v == null) {
            ...
            writeInt(9);
            writeInt(((Boolean) v).booleanValue());
    ...
    public final void readException(int code, String msg) {
        ...
        if (remoteStackTrace != null) {
            ...
            stringBuilder.append(remoteStackTrace);
            RemoteException cause = new RemoteException(stringBuilder.toString(), null, false, false);
            try {
                ...
                stringBuilder2.append("Cannot set cause ");
    ...
    public final ArrayList<IBinder> createBinderArrayList() {
        ...
        if (N < 0 || N > 50000000) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("createBinderArrayList() error，invalid N：");
            ...
            if (creator == null) {
                ...
                if (loader == null) {
                    try {
                        ...
                        str = TAG;
                        stringBuilder = new StringBuilder();
                        stringBuilder.append("Illegal access when unmarshalling: ");
                        stringBuilder.append(name);
                        Log.e(str, stringBuilder.toString(), e);
                        stringBuilder = new StringBuilder();
                        stringBuilder.append("IllegalAccessException when unmarshalling: ");
                        stringBuilder.append(name);
                        throw new BadParcelableException(stringBuilder.toString());
                    } catch (ClassNotFoundException e2) {
                        str = TAG;
                        stringBuilder = new StringBuilder();
                        stringBuilder.append("Class not found when unmarshalling: ");
                        stringBuilder.append(name);
                        Log.e(str, stringBuilder.toString(), e2);
                        stringBuilder = new StringBuilder();
                        stringBuilder.append("ClassNotFoundException when unmarshalling: ");
                        stringBuilder.append(name);
                        throw new BadParcelableException(stringBuilder.toString());
                    } catch (NoSuchFieldException e3) {
                        stringBuilder = new StringBuilder();
                        stringBuilder.append("Parcelable protocol requires a Parcelable.Creator object called CREATOR on class ");
                        stringBuilder.append(name);
                        throw new BadParcelableException(stringBuilder.toString());
                    }
                }
                parcelableClassLoader = loader;
                Class<?> parcelableClass = Class.forName(name, null, parcelableClassLoader);
                    ...
                    if ((f.getModifiers() & 8) != 0) {
                        if (Creator.class.isAssignableFrom(f.getType())) {
                            ...
                            if (creator != null) {
                                ...
                                StringBuilder stringBuilder2 = new StringBuilder();
                                stringBuilder2.append("Parcelable protocol requires a non-null Parcelable.Creator object called CREATOR on class ");
                                stringBuilder2.append(name);
                                throw new BadParcelableException(stringBuilder2.toString());
                            }
                        }
                        StringBuilder stringBuilder3 = new StringBuilder();
                        stringBuilder3.append("Parcelable protocol requires a Parcelable.Creator object called CREATOR on class ");
                        stringBuilder3.append(name);
                        throw new BadParcelableException(stringBuilder3.toString());
                    }
                    StringBuilder stringBuilder4 = new StringBuilder();
                    stringBuilder4.append("Parcelable protocol requires the CREATOR object to be static on class ");
                    stringBuilder4.append(name);
                    throw new BadParcelableException(stringBuilder4.toString());
                }
                StringBuilder stringBuilder5 = new StringBuilder();
                stringBuilder5.append("Parcelable protocol requires subclassing from Parcelable on class ");
                stringBuilder5.append(name);
                throw new BadParcelableException(stringBuilder5.toString());
            }
        }
        return creator;
    }
