...
public class HealthStatsWriter {
    ...
    public void addStats(int key, String name, HealthStatsWriter value) {
        ...
        if (map == null) {
            ArrayMap[] arrayMapArr = this.mStatsValues;
    ...
    public void addTimers(int key, String name, TimerStat value) {
        ...
        if (map == null) {
            ArrayMap[] arrayMapArr = this.mTimersValues;
    ...
    public void addMeasurements(int key, String name, long value) {
        ...
        if (map == null) {
            ArrayMap[] arrayMapArr = this.mMeasurementsValues;
    ...
    public void flattenToParcel(Parcel out) {
        ...
        while (i2 < keys.length) {
            if (this.mMeasurementsValues[i2] != null) {
                out.writeInt(keys[i2]);
                writeLongsMap(out, this.mMeasurementsValues[i2]);
            }
            i2++;
        }
    }
