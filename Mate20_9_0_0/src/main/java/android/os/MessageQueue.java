...
public final class MessageQueue {
    ...
    public void enableReduceDelay(boolean enabled) {
        boolean z = mIawareEnabled && enabled;
        this.mIsReduceDelay = z;
    }
    ...
    /* JADX WARNING: Missing block: B:72:0x00df, code skipped:
            r0 = r4;
     */
    /* JADX WARNING: Missing block: B:78:0x00fd, code skipped:
            r0 = 0;
     */
    /* JADX WARNING: Missing block: B:79:0x00fe, code skipped:
            r5 = r0;
     */
    /* JADX WARNING: Missing block: B:80:0x00ff, code skipped:
            if (r5 >= r6) goto L_0x012b;
     */
    /* JADX WARNING: Missing block: B:81:0x0101, code skipped:
            r7 = r1.mPendingIdleHandlers[r5];
            r1.mPendingIdleHandlers[r5] = null;
            r10 = false;
     */
    /* JADX WARNING: Missing block: B:84:0x0110, code skipped:
            r10 = r7.queueIdle();
     */
    /* JADX WARNING: Missing block: B:85:0x0112, code skipped:
            r0 = move-exception;
     */
    /* JADX WARNING: Missing block: B:86:0x0113, code skipped:
            r11 = r0;
    ...
    Message next() {
        ...
        while (true) {
            int nextPollTimeoutMillis2 = nextPollTimeoutMillis;
            ...
            synchronized (this) {
                try {
                    ...
                    int nextPollTimeoutMillis3;
                    if (msg == null) {
                        nextPollTimeoutMillis3 = -1;
                    } else if (now < msg.when) {
                        nextPollTimeoutMillis3 = (int) Math.min(msg.when - now, 2147483647L);
                    } else {
                        this.mBlocked = false;
                        if (prevMsg != null) {
        ...
        if (msg.target == null) {
            ...
            synchronized (this) {
                ...
                if (this.mQuitting) {
                    ...
                    stringBuilder2.append(" sending message to a Handler on a dead thread");
                    IllegalStateException e = new IllegalStateException(stringBuilder2.toString());
