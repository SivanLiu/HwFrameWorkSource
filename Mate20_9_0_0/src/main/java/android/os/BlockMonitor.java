...
public class BlockMonitor {
    ...
    private static class BlockRadar {
        ...
        public static void upload(int bugType, int sceneDef, String msg) {
            ...
            if (Log.HWINFO) {
                ...
                stringBuilder.append("BlockMonitor:");
    ...
    public static void checkBinderTime(long startTime) {
        ...
        if (processTime >= 4000) {
            ...
            for (StackTraceElement element : new Throwable().getStackTrace()) {
                ...
                stringBuilder.append(";");
                briefSb.append(stringBuilder.toString());
                sb.append(element);
                sb.append("\n");
            }
    ...
    private static String dumpTopMessage(MessageQueue messageQueue) {
        ...
        while (i < msgList.size() && i < 3) {
            MessageInfo info2 = (MessageInfo) msgList.get(i);
    ...
    private static void countDelayedMsg(long msgDelayed, long processTime, Message msg) {
        ...
        List list2 = mDelayedMsgList;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(dumpMessage(msg));
        stringBuilder.append(", delayed: ");
        stringBuilder.append(msgDelayed);
        stringBuilder.append("ms, finish: ");
        stringBuilder.append(processTime);
