...
public class JankEventData implements Parcelable {
    ...
    /* synthetic */ JankEventData(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
    ...
    public ContentValues getContentValues(String[] fieldnames) {
        ...
        index = index2 + 1;
        values.put(fieldnames[index2], this.arg1);
        index2 = index + 1;
        values.put(fieldnames[index], Integer.valueOf(this.arg2));
        index = index2 + 1;
        values.put(fieldnames[index2], Integer.valueOf(this.cpu_load));
        index2 = index + 1;
        values.put(fieldnames[index], Integer.valueOf(this.freemem));
        index = index2 + 1;
        values.put(fieldnames[index2], Integer.valueOf(this.freestorage));
        index2 = index + 1;
        values.put(fieldnames[index], Integer.valueOf(this.limit_freq));
        index = index2 + 1;
        values.put(fieldnames[index2], this.CpuLoadTop_proc1);
        index2 = index + 1;
        values.put(fieldnames[index], this.CpuLoadTop_proc2);
        index = index2 + 1;
        values.put(fieldnames[index2], this.CpuLoadTop_proc3);
        index2 = index + 1;
        values.put(fieldnames[index], Integer.valueOf(this.CpuLoad_proc1));
        index = index2 + 1;
        values.put(fieldnames[index2], Integer.valueOf(this.CpuLoad_proc2));
        index2 = index + 1;
        values.put(fieldnames[index], Integer.valueOf(this.CpuLoad_proc3));
        index = index2 + 1;
        values.put(fieldnames[index2], Integer.valueOf(this.mIoWaitLoad));
        return values;
    }
}
