            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    case 1:
                        ...
                        onListenerRegistered(android.view.IPinnedStackController.Stub.asInterface(parcel.readStrongBinder()));
                        return true;
                    case 2:
                        Rect _arg02;
                        Rect _arg1;
                        ...
                        onMovementBoundsChanged(_arg02, _arg1, _arg2, _arg3, _arg4, parcel.readInt());
                        return true;
                    case 3:
                        parcel.enforceInterface(descriptor);
                        if (parcel.readInt() != 0) {
