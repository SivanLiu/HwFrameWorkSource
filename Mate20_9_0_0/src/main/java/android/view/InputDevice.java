...
public final class InputDevice implements Parcelable {
    ...
    public static final class MotionRange {
        ...
        /* synthetic */ MotionRange(int x0, int x1, float x2, float x3, float x4, float x5, float x6, AnonymousClass1 x7) {
    ...
    /* synthetic */ InputDevice(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        out.writeInt(this.mIsExternal);
        out.writeInt(this.mSources);
        out.writeInt(this.mKeyboardType);
        this.mKeyCharacterMap.writeToParcel(out, flags);
        out.writeInt(this.mHasVibrator);
        out.writeInt(this.mHasMicrophone);
        out.writeInt(this.mHasButtonUnderPad);
        int numRanges = this.mMotionRanges.size();
