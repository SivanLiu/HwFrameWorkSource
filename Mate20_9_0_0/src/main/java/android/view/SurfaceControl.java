...
public class SurfaceControl implements Parcelable {
    ...
    public static class Builder {
        ...
        public SurfaceControl build() {
            if (this.mWidth > 0 && this.mHeight > 0) {
                return new SurfaceControl(this.mSession, this.mName, this.mWidth, this.mHeight, this.mFormat, this.mFlags, this.mParent, this.mWindowType, this.mOwnerUid, null);
            }
    ...
    private static native void nativeSetBlurAlpha(long j, long j2, float f);

    private static native void nativeSetBlurBlank(long j, long j2, int i, int i2, int i3, int i4);

    private static native void nativeSetBlurRadius(long j, long j2, int i);

    private static native void nativeSetBlurRegion(long j, long j2, Region region);

    private static native void nativeSetBlurRound(long j, long j2, int i, int i2);
    ...
    private static native void nativeSetSurfaceLowResolutionInfo(long j, long j2, float f, int i);

    private static native void nativeSetTransparentRegionHint(long j, long j2, Region region);

    private static native void nativeSetWindowClipFlag(long j, long j2, int i);

    private static native void nativeSetWindowClipIcon(long j, long j2, int i, int i2, byte[] bArr, int i3, int i4, int i5);

    private static native void nativeSetWindowClipRound(long j, long j2, float f, float f2);
    ...
    /* synthetic */ SurfaceControl(SurfaceSession x0, String x1, int x2, int x3, int x4, int x5, SurfaceControl x6, int x7, int x8, AnonymousClass1 x9) throws OutOfResourcesException, IllegalArgumentException {
        this(x0, x1, x2, x3, x4, x5, x6, x7, x8);
    }

    private SurfaceControl(SurfaceSession session, String name, int w, int h, int format, int flags, SurfaceControl parent, int windowType, int ownerUid) throws OutOfResourcesException, IllegalArgumentException {
        String str = name;
        ...
        if (session == null) {
            ...
            if ((flags & 4) == 0) {
                ...
                Log.w(str2, stringBuilder.toString(), new Throwable());
            }
            this.mName = str;
            i = w;
            this.mWidth = i;
            ...
            this.mNativeObject = nativeCreate(session, str, i, i2, format, flags, j, windowType, ownerUid);
    ...
    private SurfaceControl(Parcel in) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Couldn't read SurfaceControl from parcel=");
    ...
    public boolean hwIsNativeClientValid() {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("SurfaceControl#hwIsNativeClientValid   mNativeObject = ");
        stringBuilder.append(this.mNativeObject);
    ...
    public static Bitmap screenshot_ext_hw(Rect sourceCrop, int width, int height, int rotation) {
        nativeSetSecureScreenRecShotFlag(null, 4, 4);
        return screenshot(sourceCrop, width, height, rotation);
    }
    ...
    public static Bitmap screenshot(Rect sourceCrop, int width, int height, int minLayer, int maxLayer, boolean useIdentityTransform, int rotation) {
        ...
        return nativeScreenshot(getBuiltInDisplay(null), sourceCrop, width, height, minLayer, maxLayer, false, useIdentityTransform, rotation);
    }
    ...
    public static GraphicBuffer screenshotToBuffer(Rect sourceCrop, int width, int height, int minLayer, int maxLayer, boolean useIdentityTransform, int rotation) {
        return nativeScreenshotToBuffer(getBuiltInDisplay(null), sourceCrop, width, height, minLayer, maxLayer, false, useIdentityTransform, rotation);
    }
    ...
    public static Bitmap screenshot(Rect sourceCrop, int width, int height, int rotation) {
        ...
        IBinder displayToken = getBuiltInDisplay(null);
        int i = 3;
    ...
    public static void log() {
        ...
        if (processAndAppName[0] != null && processAndAppName[1] == null) {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append(" <");
            stringBuilder.append(processAndAppName[0]);
            stringBuilder.append(">[");
            stringBuilder.append(processAndAppName[0]);
            stringBuilder.append("][");
            stringBuilder.append(processAndAppName[0]);
            stringBuilder.append("]:[SurfaceControl.screenshot] ");
            stringBuilder.append(processAndAppName[2]);
            Log.i(str, stringBuilder.toString());
        } else if (processAndAppName[1] != null) {
            str = TAG_CTAIFS;
            StringBuilder stringBuilder2 = new StringBuilder();
            stringBuilder2.append(" <");
            stringBuilder2.append(processAndAppName[1]);
            stringBuilder2.append(">[");
            stringBuilder2.append(processAndAppName[1]);
            stringBuilder2.append("][");
            stringBuilder2.append(processAndAppName[0]);
            stringBuilder2.append("]:[SurfaceControl.screenshot] ");
            stringBuilder2.append(processAndAppName[2]);
