...
public final class InputEventConsistencyVerifier {
    ...
    private static final class KeyState {
        ...
        public static KeyState obtain(int deviceId, int source, int keyCode) {
            ...
            KeyState state2 = state;
            state2.deviceId = deviceId;
            state2.source = source;
            state2.keyCode = keyCode;
            state2.unhandled = false;
            return state2;
        }
            ...
            try {
                ...
                switch (action) {
                    ...
                    default:
                        ...
                        stringBuilder.append(KeyEvent.actionToString(action));
        ...
        if (startEvent(event, nestingLevel, EVENT_TYPE_TOUCH)) {
            ...
            try {
                ...
                if (!(newStream || this.mTouchEventStreamDeviceId == -1 || (this.mTouchEventStreamDeviceId == deviceId && this.mTouchEventStreamSource == source))) {
                    ...
                    stringBuilder.append(Integer.toHexString(source));
                    problem(stringBuilder.toString());
                }
                ...
                if ((source & 2) != 0) {
                    ...
                    switch (action) {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            expectedPointerCount = Integer.bitCount(this.mTouchEventStreamPointers);
                            if (pointerCount != expectedPointerCount) {
                                StringBuilder stringBuilder2 = new StringBuilder();
                                stringBuilder2.append("ACTION_MOVE contained ");
                                stringBuilder2.append(pointerCount);
                                stringBuilder2.append(" pointers but there are currently ");
                                stringBuilder2.append(expectedPointerCount);
                                stringBuilder2.append(" pointers down.");
                                problem(stringBuilder2.toString());
                        ...
                        case 4:
                            ...
                            break;
                        default:
                            expectedPointerCount = event.getActionMasked();
                            int actionIndex = event.getActionIndex();
                            int id;
                            int idBit;
                            StringBuilder stringBuilder3;
                            StringBuilder stringBuilder4;
                            if (expectedPointerCount != 5) {
                                if (expectedPointerCount != 6) {
                                    StringBuilder stringBuilder5 = new StringBuilder();
                                    stringBuilder5.append("Invalid action ");
                                    stringBuilder5.append(MotionEvent.actionToString(action));
                                    stringBuilder5.append(" for touch event.");
                                    problem(stringBuilder5.toString());
                                    break;
                                }
                                if (actionIndex >= 0) {
                                    if (actionIndex < pointerCount) {
                                        ...
                                        if ((this.mTouchEventStreamPointers & idBit) == 0) {
                                            ...
                                            stringBuilder3.append("ACTION_POINTER_UP specified pointer id ");
                                            stringBuilder3.append(id);
                                            stringBuilder3.append(" which is not currently down.");
                                            problem(stringBuilder3.toString());
                                            this.mTouchEventStreamIsTainted = true;
                                        } else {
                                ...
                                stringBuilder4.append("ACTION_POINTER_UP index is ");
                                stringBuilder4.append(actionIndex);
                                stringBuilder4.append(" but the pointer count is ");
                                stringBuilder4.append(pointerCount);
                                stringBuilder4.append(".");
                                problem(stringBuilder4.toString());
                                this.mTouchEventStreamIsTainted = true;
                                ensureHistorySizeIsZeroForThisAction(event);
                            } else {
                                if (this.mTouchEventStreamPointers == 0) {
                                ...
                                if (actionIndex >= 0) {
                                    if (actionIndex < pointerCount) {
                                        ...
                                        if ((this.mTouchEventStreamPointers & idBit) != 0) {
                                            stringBuilder3 = new StringBuilder();
                                            stringBuilder3.append("ACTION_POINTER_DOWN specified pointer id ");
                                            stringBuilder3.append(id);
                                            stringBuilder3.append(" which is already down.");
                                            problem(stringBuilder3.toString());
                                            this.mTouchEventStreamIsTainted = true;
                                        } else {
                                            this.mTouchEventStreamPointers |= idBit;
                                ...
                                stringBuilder4 = new StringBuilder();
                                stringBuilder4.append("ACTION_POINTER_DOWN index is ");
                                stringBuilder4.append(actionIndex);
                                stringBuilder4.append(" but the pointer count is ");
                                stringBuilder4.append(pointerCount);
                                stringBuilder4.append(".");
                    ...
                    switch (action) {
                        ...
                        case 11:
                            ...
                            if ((this.mButtonsPressed & actionButton) != 0) {
                                ...
                                stringBuilder.append(actionButton);
    ...
    public void onUnhandledEvent(InputEvent event, int nestingLevel) {
        if (nestingLevel == this.mLastNestingLevel) {
            ...
            if (event instanceof KeyEvent) {
                ...
                KeyState state = findKeyState(keyEvent.getDeviceId(), keyEvent.getSource(), keyEvent.getKeyCode(), null);
                if (state != null) {
    ...
    private void ensurePointerCountIsOneForThisAction(MotionEvent event) {
        ...
        if (pointerCount != 1) {
            ...
            stringBuilder.append(pointerCount);
            stringBuilder.append(" but it should always be 1 for ");
            stringBuilder.append(MotionEvent.actionToString(event.getAction()));
            problem(stringBuilder.toString());
        }
    }
    ...
    private void ensureHistorySizeIsZeroForThisAction(MotionEvent event) {
        ...
        if (historySize != 0) {
            ...
            stringBuilder.append(historySize);
    ...
    private void finishEvent() {
        ...
        i = (this.mMostRecentEventIndex + 1) % 5;
