...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    private static final int LAST_KEYCODE = 705;
    @Deprecated
    ...
    public static class DispatcherState {
        ...
        public void handleUpEvent(KeyEvent event) {
            ...
            if (index >= 0) {
                KeyEvent.access$076(event, JlogConstants.JLID_CAMERA3_HAL_TAF_END);
    ...
    public static final boolean isSystemKey(int keyCode) {
        if (!(keyCode == 82 || keyCode == 130 || keyCode == 164)) {
            switch (keyCode) {
                case 2:
                case 3:
                case 4:
    ...
    private static int metaStateFilterDirectionalModifiers(int metaState, int modifiers, int basic, int left, int right) {
        ...
        if (wantBasic) {
            ...
            stringBuilder.append(metaStateToString(basic));
            stringBuilder.append(" combined with ");
            stringBuilder.append(metaStateToString(left));
            stringBuilder.append(" or ");
            stringBuilder.append(metaStateToString(right));
    ...
    public String toString() {
        ...
        msg.append(", hwFlags=0x");
        msg.append(Integer.toHexString(this.mHwFlags));
    ...
    public static String metaStateToString(int metaState) {
        ...
        while (metaState2 != 0) {
            ...
            metaState2 >>>= 1;
            if (isSet) {
                String name = META_SYMBOLIC_NAMES[metaState];
                if (result != null) {
                    result.append('|');
                    result.append(name);
