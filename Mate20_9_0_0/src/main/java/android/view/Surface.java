...
public class Surface implements Parcelable {
    ...
    private static native void nativeSetActivity(long j, String str);
    ...
    public void setActivityName(String actName) {
        synchronized (this.mLock) {
            checkNotReleasedLocked();
            nativeSetActivity(this.mNativeObject, actName);
        }
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        if (dest != null) {
            synchronized (this.mLock) {
                ...
                dest.writeInt(this.mIsSingleBuffered);
    ...
    public String toString() {
        ...
        synchronized (this.mLock) {
            ...
            stringBuilder2.append(") ( mSurfaceControllerIsValid =");
            stringBuilder2.append(this.mSurfaceControllerIsValid);
            stringBuilder2.append(") (mNativeObject  =");
            stringBuilder2.append(Long.toHexString(this.mNativeObject));
