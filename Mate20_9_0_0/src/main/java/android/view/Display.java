...
public final class Display {
    ...
    public static final class ColorTransform implements Parcelable {
        ...
        public String toString() {
            ...
            stringBuilder.append(this.mColorTransform);
    ...
    private Display(DisplayManagerGlobal global, int displayId, DisplayInfo displayInfo, DisplayAdjustments daj, Resources res) {
        ...
        this.mResources = res;
        DisplayAdjustments displayAdjustments = this.mResources != null ? new DisplayAdjustments(this.mResources.getConfiguration()) : daj != null ? new DisplayAdjustments(daj) : null;
    ...
    public String toString() {
        ...
        synchronized (this) {
            ...
            stringBuilder2.append(this.mDisplayInfo);
            stringBuilder2.append(", ");
            stringBuilder2.append(this.mTempMetrics);
            stringBuilder2.append(", isValid=");
            stringBuilder2.append(this.mIsValid);
