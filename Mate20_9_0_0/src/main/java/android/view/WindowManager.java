...
public interface WindowManager extends ViewManager {
    ...
    public static class LayoutParams extends android.view.ViewGroup.LayoutParams implements Parcelable {
        ...
        @ExportedProperty(flagMapping = {@FlagToString(equals = 1, mask = 1, name = "FAKE_HARDWARE_ACCELERATED"), @FlagToString(equals = 2, mask = 2, name = "FORCE_HARDWARE_ACCELERATED"), @FlagToString(equals = 4, mask = 4, name = "WANTS_OFFSET_NOTIFICATIONS"), @FlagToString(equals = 16, mask = 16, name = "SHOW_FOR_ALL_USERS"), @FlagToString(equals = 64, mask = 64, name = "NO_MOVE_ANIMATION"), @FlagToString(equals = 128, mask = 128, name = "COMPATIBLE_WINDOW"), @FlagToString(equals = 256, mask = 256, name = "SYSTEM_ERROR"), @FlagToString(equals = 512, mask = 512, name = "INHERIT_TRANSLUCENT_DECOR"), @FlagToString(equals = 1024, mask = 1024, name = "KEYGUARD"), @FlagToString(equals = 2048, mask = 2048, name = "DISABLE_WALLPAPER_TOUCH_EVENTS"), @FlagToString(equals = 4096, mask = 4096, name = "FORCE_STATUS_BAR_VISIBLE_TRANSPARENT"), @FlagToString(equals = 8192, mask = 8192, name = "PRESERVE_GEOMETRY"), @FlagToString(equals = 16384, mask = 16384, name = "FORCE_DECOR_VIEW_VISIBILITY"), @FlagToString(equals = 32768, mask = 32768, name = "WILL_NOT_REPLACE_ON_RELAUNCH"), @FlagToString(equals = 65536, mask = 65536, name = "LAYOUT_CHILD_WINDOW_IN_PARENT_FRAME"), @FlagToString(equals = 131072, mask = 131072, name = "FORCE_DRAW_STATUS_BAR_BACKGROUND"), @FlagToString(equals = 262144, mask = 262144, name = "SUSTAINED_PERFORMANCE_MODE"), @FlagToString(equals = 524288, mask = 524288, name = "HIDE_NON_SYSTEM_OVERLAY_WINDOWS"), @FlagToString(equals = 1048576, mask = 1048576, name = "IS_ROUNDED_CORNERS_OVERLAY"), @FlagToString(equals = 2097152, mask = 2097152, name = "ACQUIRES_SLEEP_TOKEN"), @FlagToString(equals = 4194304, mask = 4194304, name = "IS_SCREEN_DECOR")})
        ...
        public void writeToParcel(Parcel out, int parcelableFlags) {
            ...
            out.writeInt(this.hasSystemUiListeners);
            ...
            out.writeInt(this.hasManualSurfaceInsets);
            out.writeInt(this.preservePreviousSurfaceInsets);
        ...
        public String debug(String output) {
            ...
            stringBuilder2.append("WindowManager.LayoutParams={title=");
            stringBuilder2.append(this.mTitle);
            stringBuilder2.append("}");
            Log.d("Debug", stringBuilder2.toString());
            return "";
        }
        ...
        private static String softInputModeToString(int softInputMode) {
            ...
            if (state != 0) {
                ...
                switch (state) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        result.append(CalendarColumns.VISIBLE);
                        break;
                    case 5:
            ...
            if (adjust != 0) {
                ...
                if (adjust == 16) {
                    ...
                    result.append(Engine.KEY_PARAM_PAN);
                } else if (adjust != 48) {
                    result.append(adjust);
                } else {
