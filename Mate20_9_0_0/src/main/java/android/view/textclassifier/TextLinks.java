...
public final class TextLinks implements Parcelable {
    ...
    public static final class Builder {
        ...
        public TextLinks build() {
            return new TextLinks(this.mFullText, this.mLinks, null);
        }
    }
    ...
    public static final class Options {
        ...
        public static Options fromLinkMask(int mask) {
            ...
            return new Options().setEntityConfig(EntityConfig.createWithEntityList(entitiesToFind));
        }
        ...
        public Options setEntityConfig(EntityConfig entityConfig) {
    ...
    public static final class Request implements Parcelable {
        ...
        public static final class Builder {
            ...
            public Request build() {
                return new Request(this.mText, this.mDefaultLocales, this.mEntityConfig, this.mLegacyFallback, this.mCallingPackageName, null);
            }
        }
        ...
        /* synthetic */ Request(CharSequence x0, LocaleList x1, EntityConfig x2, boolean x3, String x4, AnonymousClass1 x5) {
            this(x0, x1, x2, x3, x4);
        }

        private Request(CharSequence text, LocaleList defaultLocales, EntityConfig entityConfig, boolean legacyFallback, String callingPackageName) {
            this.mText = text;
            this.mDefaultLocales = defaultLocales;
            this.mEntityConfig = entityConfig;
            this.mLegacyFallback = legacyFallback;
        ...
        private Request(Parcel in) {
            ...
            if (in.readInt() != 0) {
                entityConfig = (EntityConfig) EntityConfig.CREATOR.createFromParcel(in);
            }
            this.mEntityConfig = entityConfig;
    ...
    public static final class TextLink implements Parcelable {
        ...
        /* synthetic */ TextLink(Parcel x0, AnonymousClass1 x1) {
            this(x0);
        }
        ...
        TextLink(int start, int end, Map<String, Float> entityScores, URLSpan urlSpan) {
            ...
            boolean z = true;
            Preconditions.checkArgument(entityScores.isEmpty() ^ 1);
            if (start > end) {
                z = false;
            }
            ...
            this.mStart = start;
            this.mEnd = end;
            this.mEntityScores = new EntityConfidence((Map) entityScores);
        ...
        private TextLink(Parcel in) {
            this.mEntityScores = (EntityConfidence) EntityConfidence.CREATOR.createFromParcel(in);
    ...
    /* synthetic */ TextLinks(String x0, ArrayList x1, AnonymousClass1 x2) {
        this(x0, x1);
    }
