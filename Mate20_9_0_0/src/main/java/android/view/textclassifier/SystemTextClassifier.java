...
public final class SystemTextClassifier implements TextClassifier {
    ...
    private final ITextClassifierService mManagerService = Stub.asInterface(ServiceManager.getServiceOrThrow("textclassification"));
    ...
    public TextSelection suggestSelection(Request request) {
        ...
        try {
            ...
            TextSelection selection = (TextSelection) callback.mReceiver.get();
            if (selection != null) {
                return selection;
            }
    ...
    public TextClassification classifyText(TextClassification.Request request) {
        ...
        try {
            ...
            TextClassification classification = (TextClassification) callback.mReceiver.get();
    ...
    public TextLinks generateLinks(TextLinks.Request request) {
        ...
        try {
            ...
            TextLinks links = (TextLinks) callback.mReceiver.get();
            if (links != null) {
                return links;
            }
        } catch (RemoteException | InterruptedException e) {
