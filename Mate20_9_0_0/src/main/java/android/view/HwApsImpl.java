...
import com.huawei.android.hwaps.IColorPlusController;
...
public class HwApsImpl implements IHwApsImpl {
    ...
    public void setLowResolutionMode(Context context, boolean enableLowResolutionMode) {
        ...
        stringBuilder.append("APS: SDR: HwApsImpl.setLowResolutionMod, enableLowResolutionMode = ");
        stringBuilder.append(enableLowResolutionMode);
        Log.i("sdr", stringBuilder.toString());
        try {
            ...
            stringBuilder2.append("APS: SDR: HwApsImpl.setLowResolutionMode, exception = ");
            stringBuilder2.append(e);
            Log.i("sdr", stringBuilder2.toString());
        }
    }
    ...
    public boolean isSupportApsColorPlus(String pkgName) {
        IColorPlusController colorPluscontroller = HwapsWrapper.getColorPlusController();
        if (colorPluscontroller != null) {
            return colorPluscontroller.isSupportApsColorPlus(pkgName);
        }
        return false;
    }
