...
public final class Configuration implements Parcelable, Comparable<Configuration> {
    ...
    public static int reduceScreenLayout(int curLayout, int longSizeDp, int shortSizeDp) {
        ...
        boolean screenLayoutLong = false;
        if (longSizeDp < 470) {
            ...
            if (shortSizeDp > R.styleable.Theme_searchDialogTheme || longSizeDp > 570) {
    ...
    private void fixUpLocaleList() {
        if ((this.locale == null && !this.mLocaleList.isEmpty()) || (this.locale != null && !this.locale.equals(this.mLocaleList.get(0)))) {
            ...
            if (this.locale == null) {
                ...
                emptyLocaleList = new LocaleList(new Locale[]{this.locale});
            }
    ...
    public void setLocale(Locale loc) {
        ...
        if (loc == null) {
            ...
            emptyLocaleList = new LocaleList(new Locale[]{loc});
        }
    ...
    public static String resourceQualifierString(Configuration config, DisplayMetrics metrics) {
        ...
        if (config.mcc != 0) {
            ...
            stringBuilder2.append(XML_ATTR_MCC);
            stringBuilder2.append(config.mcc);
            parts.add(stringBuilder2.toString());
            if (config.mnc != 0) {
                stringBuilder2 = new StringBuilder();
                stringBuilder2.append(XML_ATTR_MNC);
                stringBuilder2.append(config.mnc);
                parts.add(stringBuilder2.toString());
            }
        }
        ...
        i = SystemProperties.getInt("ro.sf.real_lcd_density", SystemProperties.getInt("ro.sf.lcd_density", 0));
        int realDpi = SystemProperties.getInt("persist.sys.dpi", i);
        if (realDpi == i) {
            ...
            smallestScreenWidthDp = (config.smallestScreenWidthDp * realDpi) / i;
            screenWidthDp = (config.screenWidthDp * realDpi) / i;
            int screenHeightDp = (config.screenHeightDp * realDpi) / i;
            if (config.smallestScreenWidthDp != 0) {
                stringBuilder3 = new StringBuilder();
                stringBuilder3.append(XML_ATTR_SMALLEST_WIDTH);
                stringBuilder3.append(smallestScreenWidthDp);
                stringBuilder3.append("dp");
                parts.add(stringBuilder3.toString());
            }
            if (screenWidthDp != 0) {
                stringBuilder3 = new StringBuilder();
                stringBuilder3.append("w");
                stringBuilder3.append(screenWidthDp);
                stringBuilder3.append("dp");
                parts.add(stringBuilder3.toString());
            }
            if (screenHeightDp != 0) {
                ...
                stringBuilder3.append(screenHeightDp);
                stringBuilder3.append("dp");
                parts.add(stringBuilder3.toString());
            }
        }
        ...
        smallestScreenWidthDp = config.screenLayout & 48;
        if (smallestScreenWidthDp == 16) {
            parts.add("notlong");
        } else if (smallestScreenWidthDp == 32) {
            parts.add("long");
        }
        smallestScreenWidthDp = config.screenLayout & 768;
        if (smallestScreenWidthDp == 256) {
            parts.add("notround");
        } else if (smallestScreenWidthDp == 512) {
            parts.add("round");
        }
        smallestScreenWidthDp = config.colorMode & 12;
        if (smallestScreenWidthDp == 4) {
            parts.add("lowdr");
        } else if (smallestScreenWidthDp == 8) {
            parts.add("highdr");
        }
        ...
        smallestScreenWidthDp = config.uiMode & 48;
        if (smallestScreenWidthDp == 16) {
            parts.add("notnight");
        } else if (smallestScreenWidthDp == 32) {
            parts.add(Parameters.SCENE_MODE_NIGHT);
        }
        smallestScreenWidthDp = config.densityDpi;
        if (smallestScreenWidthDp != 0) {
            if (smallestScreenWidthDp == 120) {
                parts.add("ldpi");
            } else if (smallestScreenWidthDp == 160) {
                parts.add("mdpi");
            } else if (smallestScreenWidthDp == 213) {
                parts.add("tvdpi");
            } else if (smallestScreenWidthDp == 240) {
                parts.add("hdpi");
            } else if (smallestScreenWidthDp == 320) {
                parts.add("xhdpi");
            } else if (smallestScreenWidthDp == 480) {
                parts.add("xxhdpi");
            } else if (smallestScreenWidthDp != 640) {
                switch (smallestScreenWidthDp) {
        ...
        smallestScreenWidthDp = config.touchscreen;
        if (smallestScreenWidthDp == 1) {
            parts.add("notouch");
        } else if (smallestScreenWidthDp == 3) {
            parts.add("finger");
        }
        ...
        if (metrics != null) {
            if (metrics.widthPixels >= metrics.heightPixels) {
                smallestScreenWidthDp = metrics.widthPixels;
                screenWidthDp = metrics.heightPixels;
            } else {
                smallestScreenWidthDp = metrics.heightPixels;
                screenWidthDp = metrics.widthPixels;
            }
            StringBuilder stringBuilder4 = new StringBuilder();
            stringBuilder4.append(smallestScreenWidthDp);
            stringBuilder4.append("x");
            stringBuilder4.append(screenWidthDp);
            parts.add(stringBuilder4.toString());
        }
        stringBuilder = new StringBuilder();
