...
public final class ConfigurationEx implements Comparable<Object>, IHwConfiguration {
    ...
    public int updateFrom(IHwConfiguration obj) {
        ...
        if (!(delta.hwtheme == 0 || this.hwtheme == delta.hwtheme)) {
            changed = 0 | StubController.PERMISSION_CALLLOG_WRITE;
    ...
    public void setDensityDPI(int dpi) {
        ...
        SystemProperties.set("persist.sys.dpi", stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append((dpi * oldRealDpi) / oldDisplayDpi);
        stringBuilder.append("");
        SystemProperties.set("persist.sys.realdpi", stringBuilder.toString());
    }
    ...
    public int hashCode() {
        return (31 * ((31 * ((31 * ((31 * 17) + this.simpleuiMode)) + this.hwtheme)) + this.userId)) + this.isClearCache;
    }
}
