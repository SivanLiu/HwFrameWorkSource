    ...
    public CharSequence get(int idx) {
        synchronized (this) {
            ...
            if (style != null) {
                ...
                res2 = applyStyles(str, style, this.mStyleIDs);
            }
            if (this.mStrings != null) {
                this.mStrings[idx] = res2;
            } else {
                this.mSparseStrings.put(idx, res2);
            }
        }
    }
        ...
        while (i < iArr.length) {
            ...
            if (type == ids.boldId) {
                ...
                if (tag.startsWith("font;")) {
                    ...
                    if (sub != null) {
                        buffer.setSpan(getColor(sub, z), iArr[i + 1], iArr[i + 2] + 1, 33);
                    }
                    sub = subtag(tag, ";face=");
                    if (sub != null) {
