        ...
        if (restrictionType == -1) {
            ...
            switch (restrictionType) {
                ...
                case 8:
                    ...
                    while (XmlUtils.nextElementWithin(xmlPullParser, outerDepth)) {
                        RestrictionEntry childEntry = loadRestrictionElement(context, xmlPullParser);
                        if (childEntry == null) {
                            String str2 = TAG;
                            StringBuilder stringBuilder = new StringBuilder();
                            stringBuilder.append("Child entry cannot be loaded for bundle restriction ");
                            ...
                            if (restrictionType == 8 && childEntry.getType() != 7) {
                                ...
                                stringBuilder2.append("bundle_array ");
                                stringBuilder2.append(key);
                                stringBuilder2.append(" can only contain entries of type bundle");
                                Log.w(str, stringBuilder2.toString());
                            }
                        }
                        Object xmlPullParser2 = xml;
                    }
                ...
                default:
                    ...
                    stringBuilder3.append("Unknown restriction type ");
                    stringBuilder3.append(restrictionType);
