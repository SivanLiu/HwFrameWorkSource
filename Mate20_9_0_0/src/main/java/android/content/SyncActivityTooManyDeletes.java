...
public class SyncActivityTooManyDeletes extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        float f = 16.0f;
        View ll2 = ll;
        addBtnToRootView(ll, dip2px(this, 16.0f), dip2px(this, 16.0f), dip2px(this, 16.0f), 0, options[0], null);
        View view = ll2;
        addBtnToRootView(view, dip2px(this, f), dip2px(this, f), dip2px(this, f), 0, options[1], 1);
        addBtnToRootView(view, dip2px(this, f), dip2px(this, f), dip2px(this, f), dip2px(this, f), options[2], 2);
        getWindow().setBackgroundDrawableResource(17170445);
        AlertDialog dialog = new Builder(this, 33947691).setTitle(getTitle().toString()).setView(ll2).create();
