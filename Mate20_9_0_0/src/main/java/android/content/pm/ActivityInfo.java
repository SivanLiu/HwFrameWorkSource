...
public class ActivityInfo extends ComponentInfo implements Parcelable {
    ...
    public void dump(Printer pw, String prefix, int dumpFlags) {
        ...
        if (this.originMaxAspectRatio != 0.0f) {
            stringBuilder = new StringBuilder();
            stringBuilder.append(prefix);
            stringBuilder.append("originMaxAspectRatio=");
            stringBuilder.append(this.originMaxAspectRatio);
            pw.println(stringBuilder.toString());
        }
        if (this.hwNotchSupport) {
            ...
            stringBuilder.append(this.hwNotchSupport);
            pw.println(stringBuilder.toString());
        }
        if (this.hwGestureNavOptions != 0) {
            stringBuilder = new StringBuilder();
            stringBuilder.append(prefix);
            stringBuilder.append("hwGestureNavOptions=");
            stringBuilder.append(this.hwGestureNavOptions);
            pw.println(stringBuilder.toString());
        }
    ...
    public void writeToParcel(Parcel dest, int parcelableFlags) {
        ...
        dest.writeInt(this.navigationHide);
        ...
        dest.writeInt(this.hwNotchSupport);
