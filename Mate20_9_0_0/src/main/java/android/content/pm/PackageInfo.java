...
public class PackageInfo implements Parcelable {
    ...
    /* synthetic */ PackageInfo(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
    ...
    public void writeToParcel(Parcel dest, int parcelableFlags) {
        ...
        dest.writeInt(this.isStub);
        dest.writeInt(this.coreApp);
        dest.writeInt(this.requiredForAllUsers);
    ...
    private PackageInfo(Parcel source) {
        ...
        if (source.readInt() != 0) {
            this.signingInfo = (SigningInfo) SigningInfo.CREATOR.createFromParcel(source);
        }
        if (this.applicationInfo != null) {
