...
public abstract class PackageManagerInternal {
    ...
    public abstract boolean filterAppAccess(Package packageR, int i, int i2);
    ...
    public abstract Package getDisabledPackage(String str);

    public abstract ComponentName getHomeActivitiesAsUser(List<ResolveInfo> list, int i);

    public abstract boolean getHwCertPermission(boolean z, Package packageR, String str);
    ...
    public abstract boolean hasSignatureCapability(int i, int i2, @CertCapabilities int i3);
    ...
    public abstract boolean isLegacySystemApp(Package packageR);
