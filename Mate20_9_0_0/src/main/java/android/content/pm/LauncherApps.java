...
public class LauncherApps {
    ...
    private static class CallbackMessageHandler extends Handler {
        ...
        private static class CallbackInfo {
            ...
            /* synthetic */ CallbackInfo(AnonymousClass1 x0) {
                this();
            }
        }
    ...
    public LauncherActivityInfo resolveActivity(Intent intent, UserHandle user) {
        ...
        try {
            if (intent.getComponent() == null) {
                ...
                stringBuilder.append(" resolveActivity intent.getComponent() is null! packageName is ");
    ...
    public ApplicationInfo getApplicationInfo(String packageName, int flags, UserHandle user) throws NameNotFoundException {
        ...
        Preconditions.checkNotNull(user, Context.USER_SERVICE);
        logErrorForInvalidProfileAccess(user);
        try {
            ...
            try {
                ...
                if (bmp != null) {
                    ...
                    if (shortcut.hasAdaptiveBitmap()) {
                        adaptiveIconDrawable = new AdaptiveIconDrawable(null, dr);
                ...
                try {
                    ...
                    adaptiveIconDrawable = "getShortcutIconDrawable()";
                    Log.e(TAG, adaptiveIconDrawable);
                }
            }
    ...
    private Drawable loadDrawableResourceFromPackage(String packageName, int resId, UserHandle user, int density) {
        ...
        try {
            return this.mContext.getPackageManager().getResourcesForApplication(getApplicationInfo(packageName, null, user)).getDrawableForDensity(resId, density);
