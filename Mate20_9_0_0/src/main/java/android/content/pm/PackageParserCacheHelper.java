...
public class PackageParserCacheHelper {
    ...
    public static class ReadHelper extends ReadWriteHelper {
        ...
        public String readString(Parcel p) {
            return (String) this.mStrings.get(p.readInt());
        }
    }

    public static class WriteHelper extends ReadWriteHelper {
        ...
        public void writeString(Parcel p, String s) {
            Integer cur = (Integer) this.mIndexes.get(s);
            if (cur != null) {
