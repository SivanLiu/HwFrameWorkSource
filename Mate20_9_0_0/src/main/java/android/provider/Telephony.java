...
public final class Telephony {
    ...
    public static final class Sms implements BaseColumns, TextBasedSmsColumns {
        ...
        public static final class Intents {
            ...
            public static SmsMessage[] getMessagesFromIntent(Intent intent) {
                try {
                    ...
                    String str2 = Telephony.TAG;
                    StringBuilder stringBuilder2 = new StringBuilder();
                    stringBuilder2.append("getMessagesFromIntent: ");
        ...
        public static String getDefaultSmsPackage(Context context) {
            ComponentName component = SmsApplication.getDefaultSmsApplication(context, null);
            if (component != null) {
    ...
    public static final class Threads implements ThreadsColumns {
        ...
        public static long getOrCreateThreadId(Context context, Set<String> recipients) {
            ...
            stringBuilder.append(recipients.size());
            stringBuilder.append(" recipients");
            Rlog.e(Telephony.TAG, stringBuilder.toString());
