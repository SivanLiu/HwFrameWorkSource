...
import android.provider.SettingsValidators.ComponentNameListValidator;
import android.provider.SettingsValidators.DiscreteValueValidator;
import android.provider.SettingsValidators.InclusiveFloatRangeValidator;
import android.provider.SettingsValidators.InclusiveIntegerRangeValidator;
import android.provider.SettingsValidators.PackageNameListValidator;
...
public final class Settings {
    ...
    private static class NameValueCache {
        ...
        private String[] allowAdjustBrightnessApps = new String[]{"com.android.systemui", "com.android.settings", "com.huawei.desktop.systemui", PKG_MMITEST, PKG_RETAILDEMO};
        ...
        public boolean putStringForUser(ContentResolver cr, String name, String value, String tag, boolean makeDefault, int userHandle) {
            ...
            e2 = getStringForUser(contentResolver, System.SCREEN_BRIGHTNESS_MODE, i);
            if (System.SCREEN_BRIGHTNESS_MODE.equals(str2)) {
                String packageName = cr.getPackageName();
                if (allowBrightnessAdjust(packageName)) {
                    str = Settings.TAG;
                    stringBuilder = new StringBuilder();
                    stringBuilder.append("nosystemapp to change adjust brightness mode,packageName:");
                    ...
                    if (!(e2 == null || e2.equals(str3))) {
                        if (e2.equals(WifiEnterpriseConfig.ENGINE_DISABLE)) {
                            putStringForUser(contentResolver, System.HW_SCREEN_BRIGHTNESS_MODE_VALUE, "1", null, false, i);
                        } else if (e2.equals("1")) {
                            putStringForUser(contentResolver, System.HW_SCREEN_BRIGHTNESS_MODE_VALUE, WifiEnterpriseConfig.ENGINE_DISABLE, null, false, i);
                        }
                    }
                }
            }
            if (System.SCREEN_BRIGHTNESS.equals(str2) && allowBrightnessAdjust(cr.getPackageName()) && e2 != null && e2.equals(WifiEnterpriseConfig.ENGINE_DISABLE)) {
                putStringForUser(contentResolver, System.HW_SCREEN_TEMP_BRIGHTNESS, str3, null, false, i);
            }
            Bundle arg = new Bundle();
            arg.putString("value", str3);
            arg.putInt(Settings.CALL_METHOD_USER_KEY, i);
            if (str4 != null) {
                arg.putString(Settings.CALL_METHOD_TAG_KEY, str4);
            }
            if (makeDefault) {
                arg.putBoolean(Settings.CALL_METHOD_MAKE_DEFAULT_KEY, true);
            }
            this.mProviderHolder.getProvider(contentResolver).call(cr.getPackageName(), this.mCallSetCommand, str2, arg);
            if (System.SCREEN_BRIGHTNESS_MODE.equals(str2)) {
                str5 = Settings.TAG;
                stringBuilder2 = new StringBuilder();
                stringBuilder2.append("package: ");
                stringBuilder2.append(cr.getPackageName());
                stringBuilder2.append(" modify ");
                stringBuilder2.append(System.SCREEN_BRIGHTNESS_MODE);
                stringBuilder2.append(" to ");
                stringBuilder2.append(str3);
                Log.i(str5, stringBuilder2.toString());
            }
            if (System.SCREEN_OFF_TIMEOUT.equals(str2) || "location_providers_allowed".equals(str2) || System.NOTIFICATION_SOUND.equals(str2) || System.RINGTONE.equals(str2)) {
                str5 = Settings.TAG;
                stringBuilder2 = new StringBuilder();
                stringBuilder2.append("package: ");
                stringBuilder2.append(cr.getPackageName());
        ...
        /* JADX WARNING: Removed duplicated region for block: B:157:0x01ff  */
        /* JADX WARNING: Removed duplicated region for block: B:142:0x01da A:{SYNTHETIC, Splitter:B:142:0x01da} */
        /* JADX WARNING: Removed duplicated region for block: B:139:0x01d4  */
        /* JADX WARNING: Removed duplicated region for block: B:180:0x024c  */
        /* JADX WARNING: Removed duplicated region for block: B:184:0x0253  */
        /* JADX WARNING: Removed duplicated region for block: B:180:0x024c  */
        /* JADX WARNING: Removed duplicated region for block: B:184:0x0253  */
        /* JADX WARNING: Removed duplicated region for block: B:180:0x024c  */
        /* JADX WARNING: Removed duplicated region for block: B:184:0x0253  */
        ...
        public String getStringForUser(ContentResolver cr, String name, int userHandle) {
            ...
            String str3 = name;
            int i = userHandle;
            boolean isSelf = i == UserHandle.myUserId();
                ...
                synchronized (this) {
                    if (this.mGenerationTracker != null) {
                        if (this.mGenerationTracker.isGenerationChanged()) {
                            this.mValues.clear();
                        } else if (this.mValues.containsKey(str3)) {
                            str = (String) this.mValues.get(str3);
                            return str;
                        }
                        if (this.mGenerationTracker != null) {
            ...
            if (this.mCallGetCommand != null) {
                ...
                if (!isSelf) {
                    try {
                        args = new Bundle();
                        args.putInt(Settings.CALL_METHOD_USER_KEY, i);
                    } catch (RemoteException e2) {
                    } catch (Throwable th2) {
                        while (true) {
                        }
                ...
                synchronized (this) {
                    ...
                    if (!Settings.isInSystemServer() || Binder.getCallingUid() == Process.myUid()) {
                        args = cp.call(cr.getPackageName(), this.mCallGetCommand, str3, args2);
                    } else {
                            ...
                            synchronized (this) {
                                if (needsGenerationTracker) {
                                    ...
                                    if (array != null && index >= 0) {
                                        ...
                                        this.mGenerationTracker = new GenerationTracker(array, index, generation, new -$$Lambda$Settings$NameValueCache$qSyMM6rUAHCa-5rsP-atfAqR3sA(this));
                                    }
                                }
                                if (!needsGenerationTracker) {
                                    if (this.mGenerationTracker == null || currentGeneration != this.mGenerationTracker.getCurrentGeneration()) {
                                        ...
                                        stringBuilder2.append("mValues not put! needsGenerationTracker: ");
                                        stringBuilder2.append(needsGenerationTracker);
                                        stringBuilder2.append(" currentGeneration: ");
                                        stringBuilder2.append(currentGeneration);
            ...
            Cursor c3 = null;
            try {
                Bundle queryArgs = ContentResolver.createSqlQueryBundle(NAME_EQ_PLACEHOLDER, new String[]{str3}, null);
                    ...
                    try {
                        if (Binder.getCallingUid() != Process.myUid()) {
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        try {
                                            value = Settings.TAG;
                                            stringBuilder = new StringBuilder();
                                            stringBuilder.append("Can't get key ");
                                            stringBuilder.append(str3);
                                            stringBuilder.append(" from ");
                                            stringBuilder.append(this.mUri);
                                            Log.w(value, stringBuilder.toString(), e);
                                            if (c != null) {
                                            }
                                            return str2;
                                        } catch (Throwable th4) {
                            ...
                            try {
                                ...
                                try {
                                    value = c.moveToNext() ? c.getString(0) : str2;
                                    synchronized (this) {
                                        if (this.mGenerationTracker != null && currentGeneration == this.mGenerationTracker.getCurrentGeneration()) {
                                            this.mValues.put(str3, value);
                                        }
                                    }
                                    if (c != null) {
                                    }
    ...
    public static final class Bookmarks implements BaseColumns {
        ...
        public static Intent getIntentForShortcut(ContentResolver cr, char shortcut) {
            Intent intent = null;
            ContentResolver c = cr;
            Cursor c2 = c.query(CONTENT_URI, sIntentProjection, sShortcutSelection, new String[]{String.valueOf(shortcut)}, ORDERING);
            while (intent == null) {
                try {
                    if (!c2.moveToNext()) {
                        break;
                    }
                    intent = Intent.parseUri(c2.getString(c2.getColumnIndexOrThrow("intent")), 0);
    ...
    public static final class Global extends NameValueTable {
        ...
        private static final Validator APP_AUTO_RESTRICTION_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator AUTO_TIME_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String AUTO_TIME_ZONE = "auto_time_zone";
        private static final Validator AUTO_TIME_ZONE_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator BLUETOOTH_ON_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator BUGREPORT_IN_POWER_MENU_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String CALL_AUTO_RETRY = "call_auto_retry";
        private static final Validator CALL_AUTO_RETRY_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        @Deprecated
        ...
        private static final Validator CHARGING_SOUNDS_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator CHARGING_VIBRATION_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator DOCK_AUDIO_MEDIA_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String DOCK_SOUNDS_ENABLED = "dock_sounds_enabled";
        private static final Validator DOCK_SOUNDS_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator EMERGENCY_TONE_VALIDATOR = new DiscreteValueValidator(new String[]{WifiEnterpriseConfig.ENGINE_DISABLE, "1", WifiScanLog.EVENT_KEY2});
        ...
        private static final Validator ENCODED_SURROUND_OUTPUT_ENABLED_FORMATS_VALIDATOR = new Validator() {
            public boolean validate(String value) {
                try {
                    for (String format : TextUtils.split(value, ",")) {
        ...
        private static final Validator ENCODED_SURROUND_OUTPUT_VALIDATOR = new DiscreteValueValidator(new String[]{WifiEnterpriseConfig.ENGINE_DISABLE, "1", WifiScanLog.EVENT_KEY2, WifiScanLog.EVENT_KEY3});
        @Deprecated
        ...
        private static final Validator LOW_POWER_MODE_TRIGGER_LEVEL_VALIDATOR = new InclusiveIntegerRangeValidator(0, 100);
        ...
        private static final Validator NETWORK_RECOMMENDATIONS_ENABLED_VALIDATOR = new DiscreteValueValidator(new String[]{"-1", WifiEnterpriseConfig.ENGINE_DISABLE, "1"});
        ...
        private static final Validator POWER_SOUNDS_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String PREFERRED_NETWORK_MODE = "preferred_network_mode";
        public static final String PRIVATE_DNS_DEFAULT_MODE = "private_dns_default_mode";
        public static final String PRIVATE_DNS_MODE = "private_dns_mode";
        private static final Validator PRIVATE_DNS_MODE_VALIDATOR = SettingsValidators.ANY_STRING_VALIDATOR;
        public static final String PRIVATE_DNS_SPECIFIER = "private_dns_specifier";
        private static final Validator PRIVATE_DNS_SPECIFIER_VALIDATOR = SettingsValidators.ANY_STRING_VALIDATOR;
        ...
        private static final Validator SOFT_AP_TIMEOUT_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator USB_MASS_STORAGE_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator WIFI_CARRIER_NETWORKS_AVAILABLE_NOTIFICATION_ON_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator WIFI_NETWORKS_AVAILABLE_NOTIFICATION_ON_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String WIFI_NETWORKS_AVAILABLE_REPEAT_DELAY = "wifi_networks_available_repeat_delay";
        private static final Validator WIFI_NETWORKS_AVAILABLE_REPEAT_DELAY_VALIDATOR = SettingsValidators.NON_NEGATIVE_INTEGER_VALIDATOR;
        public static final String WIFI_NETWORK_SHOW_RSSI = "wifi_network_show_rssi";
        public static final String WIFI_NUM_OPEN_NETWORKS_KEPT = "wifi_num_open_networks_kept";
        private static final Validator WIFI_NUM_OPEN_NETWORKS_KEPT_VALIDATOR = SettingsValidators.NON_NEGATIVE_INTEGER_VALIDATOR;
        ...
        private static final Validator WIFI_WAKEUP_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String WIFI_WATCHDOG_ON = "wifi_watchdog_on";
        public static final String WIFI_WATCHDOG_POOR_NETWORK_TEST_ENABLED = "wifi_watchdog_poor_network_test_enabled";
        private static final Validator WIFI_WATCHDOG_POOR_NETWORK_TEST_ENABLED_VALIDATOR = SettingsValidators.ANY_STRING_VALIDATOR;
        ...
        private static final Validator ZEN_DURATION_VALIDATOR = SettingsValidators.ANY_INTEGER_VALIDATOR;
        ...
        public static final String getBluetoothHeadsetPriorityKey(String address) {
            ...
            stringBuilder.append(address.toUpperCase(Locale.ROOT));
    ...
    public static final class Secure extends NameValueTable {
        ...
        private static final Validator ACCESSIBILITY_AUTOCLICK_DELAY_VALIDATOR = SettingsValidators.NON_NEGATIVE_INTEGER_VALIDATOR;
        public static final String ACCESSIBILITY_AUTOCLICK_ENABLED = "accessibility_autoclick_enabled";
        private static final Validator ACCESSIBILITY_AUTOCLICK_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String ACCESSIBILITY_BUTTON_TARGET_COMPONENT = "accessibility_button_target_component";
        private static final Validator ACCESSIBILITY_BUTTON_TARGET_COMPONENT_VALIDATOR = new Validator() {
            public boolean validate(String value) {
                return value != null;
            }
        };
        public static final String ACCESSIBILITY_CAPTIONING_BACKGROUND_COLOR = "accessibility_captioning_background_color";
        private static final Validator ACCESSIBILITY_CAPTIONING_BACKGROUND_COLOR_VALIDATOR = SettingsValidators.ANY_INTEGER_VALIDATOR;
        public static final String ACCESSIBILITY_CAPTIONING_EDGE_COLOR = "accessibility_captioning_edge_color";
        private static final Validator ACCESSIBILITY_CAPTIONING_EDGE_COLOR_VALIDATOR = SettingsValidators.ANY_INTEGER_VALIDATOR;
        public static final String ACCESSIBILITY_CAPTIONING_EDGE_TYPE = "accessibility_captioning_edge_type";
        private static final Validator ACCESSIBILITY_CAPTIONING_EDGE_TYPE_VALIDATOR = new DiscreteValueValidator(new String[]{WifiEnterpriseConfig.ENGINE_DISABLE, "1", WifiScanLog.EVENT_KEY2});
        public static final String ACCESSIBILITY_CAPTIONING_ENABLED = "accessibility_captioning_enabled";
        private static final Validator ACCESSIBILITY_CAPTIONING_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String ACCESSIBILITY_CAPTIONING_FONT_SCALE = "accessibility_captioning_font_scale";
        private static final Validator ACCESSIBILITY_CAPTIONING_FONT_SCALE_VALIDATOR = new InclusiveFloatRangeValidator(0.5f, 2.0f);
        public static final String ACCESSIBILITY_CAPTIONING_FOREGROUND_COLOR = "accessibility_captioning_foreground_color";
        private static final Validator ACCESSIBILITY_CAPTIONING_FOREGROUND_COLOR_VALIDATOR = SettingsValidators.ANY_INTEGER_VALIDATOR;
        public static final String ACCESSIBILITY_CAPTIONING_LOCALE = "accessibility_captioning_locale";
        private static final Validator ACCESSIBILITY_CAPTIONING_LOCALE_VALIDATOR = SettingsValidators.LOCALE_VALIDATOR;
        public static final String ACCESSIBILITY_CAPTIONING_PRESET = "accessibility_captioning_preset";
        private static final Validator ACCESSIBILITY_CAPTIONING_PRESET_VALIDATOR = new DiscreteValueValidator(new String[]{"-1", WifiEnterpriseConfig.ENGINE_DISABLE, "1", WifiScanLog.EVENT_KEY2, WifiScanLog.EVENT_KEY3, WifiScanLog.EVENT_KEY4});
        public static final String ACCESSIBILITY_CAPTIONING_TYPEFACE = "accessibility_captioning_typeface";
        private static final Validator ACCESSIBILITY_CAPTIONING_TYPEFACE_VALIDATOR = new DiscreteValueValidator(new String[]{"DEFAULT", "MONOSPACE", "SANS_SERIF", "SERIF"});
        public static final String ACCESSIBILITY_CAPTIONING_WINDOW_COLOR = "accessibility_captioning_window_color";
        private static final Validator ACCESSIBILITY_CAPTIONING_WINDOW_COLOR_VALIDATOR = SettingsValidators.ANY_INTEGER_VALIDATOR;
        ...
        private static final Validator ACCESSIBILITY_DISPLAY_DALTONIZER_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        private static final Validator ACCESSIBILITY_DISPLAY_DALTONIZER_VALIDATOR = new DiscreteValueValidator(new String[]{"-1", WifiEnterpriseConfig.ENGINE_DISABLE, WifiScanLog.EVENT_KEY11, WifiScanLog.EVENT_KEY12, WifiScanLog.EVENT_KEY13});
        public static final String ACCESSIBILITY_DISPLAY_INVERSION_ENABLED = "accessibility_display_inversion_enabled";
        private static final Validator ACCESSIBILITY_DISPLAY_INVERSION_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        @Deprecated
        ...
        private static final Validator ACCESSIBILITY_DISPLAY_MAGNIFICATION_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator ACCESSIBILITY_DISPLAY_MAGNIFICATION_NAVBAR_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String ACCESSIBILITY_DISPLAY_MAGNIFICATION_SCALE = "accessibility_display_magnification_scale";
        private static final Validator ACCESSIBILITY_DISPLAY_MAGNIFICATION_SCALE_VALIDATOR = new InclusiveFloatRangeValidator(1.0f, Float.MAX_VALUE);
        public static final String ACCESSIBILITY_ENABLED = "accessibility_enabled";
        private static final Validator ACCESSIBILITY_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String ACCESSIBILITY_HIGH_TEXT_CONTRAST_ENABLED = "high_text_contrast_enabled";
        private static final Validator ACCESSIBILITY_HIGH_TEXT_CONTRAST_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String ACCESSIBILITY_LARGE_POINTER_ICON = "accessibility_large_pointer_icon";
        private static final Validator ACCESSIBILITY_LARGE_POINTER_ICON_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String ACCESSIBILITY_SHORTCUT_DIALOG_SHOWN = "accessibility_shortcut_dialog_shown";
        private static final Validator ACCESSIBILITY_SHORTCUT_DIALOG_SHOWN_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String ACCESSIBILITY_SHORTCUT_ENABLED = "accessibility_shortcut_enabled";
        private static final Validator ACCESSIBILITY_SHORTCUT_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String ACCESSIBILITY_SHORTCUT_ON_LOCK_SCREEN = "accessibility_shortcut_on_lock_screen";
        private static final Validator ACCESSIBILITY_SHORTCUT_ON_LOCK_SCREEN_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String ACCESSIBILITY_SHORTCUT_TARGET_SERVICE = "accessibility_shortcut_target_service";
        private static final Validator ACCESSIBILITY_SHORTCUT_TARGET_SERVICE_VALIDATOR = SettingsValidators.NULLABLE_COMPONENT_NAME_VALIDATOR;
        public static final String ACCESSIBILITY_SOFT_KEYBOARD_MODE = "accessibility_soft_keyboard_mode";
        @Deprecated
        public static final String ACCESSIBILITY_SPEAK_PASSWORD = "speak_password";
        private static final Validator ACCESSIBILITY_SPEAK_PASSWORD_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        @Deprecated
        public static final String ADB_ENABLED = "adb_enabled";
        public static final String ALLOWED_GEOLOCATION_ORIGINS = "allowed_geolocation_origins";
        @Deprecated
        public static final String ALLOW_MOCK_LOCATION = "mock_location";
        private static final Validator ALLOW_MOCK_LOCATION_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator ASSIST_GESTURE_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String ASSIST_GESTURE_SENSITIVITY = "assist_gesture_sensitivity";
        private static final Validator ASSIST_GESTURE_SENSITIVITY_VALIDATOR = new InclusiveFloatRangeValidator(0.0f, 1.0f);
        public static final String ASSIST_GESTURE_SETUP_COMPLETE = "assist_gesture_setup_complete";
        private static final Validator ASSIST_GESTURE_SETUP_COMPLETE_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String ASSIST_GESTURE_SILENCE_ALERTS_ENABLED = "assist_gesture_silence_alerts_enabled";
        private static final Validator ASSIST_GESTURE_SILENCE_ALERTS_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String ASSIST_GESTURE_WAKE_ENABLED = "assist_gesture_wake_enabled";
        private static final Validator ASSIST_GESTURE_WAKE_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator AUTOFILL_SERVICE_VALIDATOR = SettingsValidators.NULLABLE_COMPONENT_NAME_VALIDATOR;
        @SystemApi
        ...
        private static final Validator AUTOMATIC_STORAGE_MANAGER_DAYS_TO_RETAIN_VALIDATOR = SettingsValidators.NON_NEGATIVE_INTEGER_VALIDATOR;
        ...
        private static final Validator CAMERA_DOUBLE_TAP_POWER_GESTURE_DISABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String CAMERA_DOUBLE_TWIST_TO_FLIP_ENABLED = "camera_double_twist_to_flip_enabled";
        private static final Validator CAMERA_DOUBLE_TWIST_TO_FLIP_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String CAMERA_GESTURE_DISABLED = "camera_gesture_disabled";
        private static final Validator CAMERA_GESTURE_DISABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator DOUBLE_TAP_TO_WAKE_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String DOZE_ALWAYS_ON = "doze_always_on";
        public static final String DOZE_ENABLED = "doze_enabled";
        private static final Validator DOZE_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String DOZE_PULSE_ON_DOUBLE_TAP = "doze_pulse_on_double_tap";
        private static final Validator DOZE_PULSE_ON_DOUBLE_TAP_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator DOZE_PULSE_ON_PICK_UP_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator ENABLED_ACCESSIBILITY_SERVICES_VALIDATOR = new ComponentNameListValidator(SettingsStringUtil.DELIMITER);
        public static final String ENABLED_INPUT_METHODS = "enabled_input_methods";
        @Deprecated
        public static final String ENABLED_NOTIFICATION_ASSISTANT = "enabled_notification_assistant";
        private static final Validator ENABLED_NOTIFICATION_ASSISTANT_VALIDATOR = new ComponentNameListValidator(SettingsStringUtil.DELIMITER);
        @Deprecated
        public static final String ENABLED_NOTIFICATION_LISTENERS = "enabled_notification_listeners";
        private static final Validator ENABLED_NOTIFICATION_LISTENERS_VALIDATOR = new ComponentNameListValidator(SettingsStringUtil.DELIMITER);
        @Deprecated
        public static final String ENABLED_NOTIFICATION_POLICY_ACCESS_PACKAGES = "enabled_notification_policy_access_packages";
        private static final Validator ENABLED_NOTIFICATION_POLICY_ACCESS_PACKAGES_VALIDATOR = new PackageNameListValidator(SettingsStringUtil.DELIMITER);
        public static final String ENABLED_PRINT_SERVICES = "enabled_print_services";
        public static final String ENABLED_VR_LISTENERS = "enabled_vr_listeners";
        private static final Validator ENABLED_VR_LISTENERS_VALIDATOR = new ComponentNameListValidator(SettingsStringUtil.DELIMITER);
        public static final String ENHANCED_VOICE_PRIVACY_ENABLED = "enhanced_voice_privacy_enabled";
        private static final Validator ENHANCED_VOICE_PRIVACY_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        @Deprecated
        public static final String HTTP_PROXY = "http_proxy";
        public static final String HUSH_GESTURE_USED = "hush_gesture_used";
        private static final Validator HUSH_GESTURE_USED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator INCALL_POWER_BUTTON_BEHAVIOR_VALIDATOR = new DiscreteValueValidator(new String[]{"1", WifiScanLog.EVENT_KEY2});
        ...
        public static final String[] LEGACY_RESTORE_SETTINGS = new String[]{ENABLED_NOTIFICATION_LISTENERS, ENABLED_NOTIFICATION_ASSISTANT, ENABLED_NOTIFICATION_POLICY_ACCESS_PACKAGES};
        ...
        private static final Validator LOCKDOWN_IN_POWER_MENU_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        @Deprecated
        ...
        private static final Validator LONG_PRESS_TIMEOUT_VALIDATOR = SettingsValidators.NON_NEGATIVE_INTEGER_VALIDATOR;
        ...
        private static final Validator MANUAL_RINGER_TOGGLE_COUNT_VALIDATOR = SettingsValidators.NON_NEGATIVE_INTEGER_VALIDATOR;
        public static final String MOUNT_PLAY_NOTIFICATION_SND = "mount_play_not_snd";
        private static final Validator MOUNT_PLAY_NOTIFICATION_SND_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String MOUNT_UMS_AUTOSTART = "mount_ums_autostart";
        private static final Validator MOUNT_UMS_AUTOSTART_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String MOUNT_UMS_NOTIFY_ENABLED = "mount_ums_notify_enabled";
        private static final Validator MOUNT_UMS_NOTIFY_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String MOUNT_UMS_PROMPT = "mount_ums_prompt";
        private static final Validator MOUNT_UMS_PROMPT_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator NFC_PAYMENT_DEFAULT_COMPONENT_VALIDATOR = SettingsValidators.COMPONENT_NAME_VALIDATOR;
        ...
        private static final Validator NIGHT_DISPLAY_AUTO_MODE_VALIDATOR = new InclusiveIntegerRangeValidator(0, 2);
        public static final String NIGHT_DISPLAY_COLOR_TEMPERATURE = "night_display_color_temperature";
        private static final Validator NIGHT_DISPLAY_COLOR_TEMPERATURE_VALIDATOR = SettingsValidators.NON_NEGATIVE_INTEGER_VALIDATOR;
        public static final String NIGHT_DISPLAY_CUSTOM_END_TIME = "night_display_custom_end_time";
        private static final Validator NIGHT_DISPLAY_CUSTOM_END_TIME_VALIDATOR = SettingsValidators.NON_NEGATIVE_INTEGER_VALIDATOR;
        public static final String NIGHT_DISPLAY_CUSTOM_START_TIME = "night_display_custom_start_time";
        private static final Validator NIGHT_DISPLAY_CUSTOM_START_TIME_VALIDATOR = SettingsValidators.NON_NEGATIVE_INTEGER_VALIDATOR;
        public static final String NIGHT_DISPLAY_LAST_ACTIVATED_TIME = "night_display_last_activated_time";
        public static final String NOTIFICATION_BADGING = "notification_badging";
        private static final Validator NOTIFICATION_BADGING_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator PREFERRED_TTY_MODE_VALIDATOR = new DiscreteValueValidator(new String[]{WifiEnterpriseConfig.ENGINE_DISABLE, "1", WifiScanLog.EVENT_KEY2, WifiScanLog.EVENT_KEY3});
        ...
        private static final Validator QS_AUTO_ADDED_TILES_VALIDATOR = new Validator() {
            public boolean validate(String value) {
                ...
                boolean valid = true;
                for (String tile : value.split(",")) {
                    int i = (tile.length() <= 0 || !SettingsValidators.ANY_STRING_VALIDATOR.validate(tile)) ? 0 : 1;
                    valid |= i;
                }
                return valid;
            }
        ...
        private static final Validator RTT_CALLING_MODE_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String SCREENSAVER_ACTIVATE_ON_DOCK = "screensaver_activate_on_dock";
        private static final Validator SCREENSAVER_ACTIVATE_ON_DOCK_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String SCREENSAVER_ACTIVATE_ON_SLEEP = "screensaver_activate_on_sleep";
        private static final Validator SCREENSAVER_ACTIVATE_ON_SLEEP_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String SCREENSAVER_COMPONENTS = "screensaver_components";
        private static final Validator SCREENSAVER_COMPONENTS_VALIDATOR = new ComponentNameListValidator(",");
        public static final String SCREENSAVER_DEFAULT_COMPONENT = "screensaver_default_component";
        public static final String SCREENSAVER_ENABLED = "screensaver_enabled";
        private static final Validator SCREENSAVER_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator SELECTED_SPELL_CHECKER_SUBTYPE_VALIDATOR = SettingsValidators.COMPONENT_NAME_VALIDATOR;
        private static final Validator SELECTED_SPELL_CHECKER_VALIDATOR = SettingsValidators.COMPONENT_NAME_VALIDATOR;
        ...
        private static final Validator SHOW_FIRST_CRASH_DIALOG_DEV_OPTION_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String SHOW_IME_WITH_HARD_KEYBOARD = "show_ime_with_hard_keyboard";
        private static final Validator SHOW_IME_WITH_HARD_KEYBOARD_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator SLEEP_TIMEOUT_VALIDATOR = new InclusiveIntegerRangeValidator(-1, Integer.MAX_VALUE);
        public static final String SMS_DEFAULT_APPLICATION = "sms_default_application";
        public static final String SPELL_CHECKER_ENABLED = "spell_checker_enabled";
        private static final Validator SPELL_CHECKER_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator SWIPE_UP_TO_SWITCH_APPS_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String SYNC_PARENT_SOUNDS = "sync_parent_sounds";
        private static final Validator SYNC_PARENT_SOUNDS_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String SYSTEM_NAVIGATION_KEYS_ENABLED = "system_navigation_keys_enabled";
        private static final Validator SYSTEM_NAVIGATION_KEYS_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator TOUCH_EXPLORATION_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator TOUCH_EXPLORATION_GRANTED_ACCESSIBILITY_SERVICES_VALIDATOR = new ComponentNameListValidator(SettingsStringUtil.DELIMITER);
        ...
        private static final Validator TTS_DEFAULT_LOCALE_VALIDATOR = new Validator() {
            public boolean validate(String value) {
                ...
                boolean valid = true;
                for (String ttsLocale : value.split(",")) {
        ...
        private static final Validator TTS_DEFAULT_PITCH_VALIDATOR = SettingsValidators.NON_NEGATIVE_INTEGER_VALIDATOR;
        public static final String TTS_DEFAULT_RATE = "tts_default_rate";
        private static final Validator TTS_DEFAULT_RATE_VALIDATOR = SettingsValidators.NON_NEGATIVE_INTEGER_VALIDATOR;
        public static final String TTS_DEFAULT_SYNTH = "tts_default_synth";
        private static final Validator TTS_DEFAULT_SYNTH_VALIDATOR = SettingsValidators.PACKAGE_NAME_VALIDATOR;
        @Deprecated
        public static final String TTS_DEFAULT_VARIANT = "tts_default_variant";
        public static final String TTS_ENABLED_PLUGINS = "tts_enabled_plugins";
        private static final Validator TTS_ENABLED_PLUGINS_VALIDATOR = new PackageNameListValidator(WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER);
        @Deprecated
        public static final String TTS_USE_DEFAULTS = "tts_use_defaults";
        public static final String TTY_MODE_ENABLED = "tty_mode_enabled";
        private static final Validator TTY_MODE_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        public static final String USE_GOOGLE_MAIL = "use_google_mail";
        public static final Map<String, Validator> VALIDATORS = new ArrayMap();
        public static final String VIDEO_CALL_SHOW_SWITCH = "video_call_show_switch";
        public static final String VOICE_INTERACTION_SERVICE = "voice_interaction_service";
        public static final String VOICE_RECOGNITION_SERVICE = "voice_recognition_service";
        public static final String VOLUME_HUSH_GESTURE = "volume_hush_gesture";
        private static final Validator VOLUME_HUSH_GESTURE_VALIDATOR = SettingsValidators.NON_NEGATIVE_INTEGER_VALIDATOR;
        ...
        private static final Validator VR_DISPLAY_MODE_VALIDATOR = new DiscreteValueValidator(new String[]{WifiEnterpriseConfig.ENGINE_DISABLE, "1"});
        public static final String WAKE_GESTURE_ENABLED = "wake_gesture_enabled";
        private static final Validator WAKE_GESTURE_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String WIFICALLING_SHOW_STATUS = "wificalling_show_status";
            ...
            if (MOVED_TO_LOCK_SETTINGS.contains(name)) {
                ...
                if (!(sLockSettings == null || sIsSystemProcess)) {
                    ...
                    if (z) {
                        ...
                        StringBuilder stringBuilder2 = new StringBuilder();
                        stringBuilder2.append("Settings.Secure.");
                        stringBuilder2.append(name);
                        stringBuilder2.append(" is deprecated and no longer accessible. See API documentation for potential replacements.");
        ...
        public static boolean putStringForUser(ContentResolver resolver, String name, String value, String tag, boolean makeDefault, int userHandle) {
            ...
            if (LOCATION_MODE.equals(name) || "location_providers_allowed".equals(name)) {
                int resultMode = HwFrameworkFactory.getHwInnerLocationManager().checkLocationSettings(resolver, name, value, userHandle);
                if (resultMode >= 0) {
                    return setLocationModeForUser(resolver, resultMode, userHandle);
                }
            }
            String str;
            StringBuilder stringBuilder;
            if ("mdm_policy_invalid_value".equals(fixedValue)) {
                ...
                stringBuilder.append("Setting '");
                stringBuilder.append(name);
                stringBuilder.append("' set operation was prevented by current MDM policy.");
                Log.w(str, stringBuilder.toString());
                return false;
            }
            value = fixedValue;
        ...
        @Deprecated
        private static boolean setLocationModeForUser(ContentResolver cr, int mode, int userId) {
            boolean z;
            synchronized (Settings.mLocationSettingsLock) {
                boolean gps = false;
                ...
                String str = Settings.TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("setLocationModeForUser: mode = ");
                stringBuilder.append(mode);
                Log.i(str, stringBuilder.toString());
                switch (mode) {
                    case 0:
                    ...
                    default:
                        stringBuilder = new StringBuilder();
                        stringBuilder.append("Invalid location mode: ");
                        stringBuilder.append(mode);
                ...
                StringBuilder stringBuilder2 = new StringBuilder();
                stringBuilder2.append("setLocationModeForUser: gps = ");
                stringBuilder2.append(gps);
                stringBuilder2.append(", network = ");
                stringBuilder2.append(network);
                stringBuilder2.append(", nlpSuccess = ");
                stringBuilder2.append(nlpSuccess);
                stringBuilder2.append(", gpsSuccess = ");
                stringBuilder2.append(gpsSuccess);
    ...
    public static final class System extends NameValueTable {
        ...
        public static final Validator ACCELEROMETER_ROTATION_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        @Deprecated
        public static final String ADB_ENABLED = "adb_enabled";
        public static final String ADVANCED_SETTINGS = "advanced_settings";
        public static final int ADVANCED_SETTINGS_DEFAULT = 0;
        private static final Validator ADVANCED_SETTINGS_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        @Deprecated
        public static final String AIRPLANE_MODE_ON = "airplane_mode_on";
        @Deprecated
        public static final String AIRPLANE_MODE_RADIOS = "airplane_mode_radios";
        ...
        private static final Validator ALARM_ALERT_VALIDATOR = SettingsValidators.URI_VALIDATOR;
        ...
        private static final Validator BLUETOOTH_DISCOVERABILITY_TIMEOUT_VALIDATOR = SettingsValidators.NON_NEGATIVE_INTEGER_VALIDATOR;
        ...
        private static final Validator DIM_SCREEN_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String DISPLAY_COLOR_MODE = "display_color_mode";
        private static final Validator DISPLAY_COLOR_MODE_VALIDATOR = new InclusiveIntegerRangeValidator(0, 3);
        @Deprecated
        public static final String DOCK_SOUNDS_ENABLED = "dock_sounds_enabled";
        private static final Validator DOCK_SOUNDS_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String DTMF_TONE_TYPE_WHEN_DIALING = "dtmf_tone_type";
        public static final Validator DTMF_TONE_TYPE_WHEN_DIALING_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String DTMF_TONE_WHEN_DIALING = "dtmf_tone";
        public static final Validator DTMF_TONE_WHEN_DIALING_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        public static final Validator HAPTIC_FEEDBACK_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String HAPTIC_FEEDBACK_INTENSITY = "haptic_feedback_intensity";
        public static final String HEARING_AID = "hearing_aid";
        public static final Validator HEARING_AID_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String HIDE_ROTATION_LOCK_TOGGLE_FOR_ACCESSIBILITY = "hide_rotation_lock_toggle_for_accessibility";
        public static final Validator HIDE_ROTATION_LOCK_TOGGLE_FOR_ACCESSIBILITY_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        @Deprecated
        public static final String HTTP_PROXY = "http_proxy";
        ...
        public static final Validator LOCKSCREEN_DISABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String LOCKSCREEN_SOUNDS_ENABLED = "lockscreen_sounds_enabled";
        public static final Validator LOCKSCREEN_SOUNDS_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        @Deprecated
        public static final String LOCK_PATTERN_ENABLED = "lock_pattern_autolock";
        @Deprecated
        public static final String LOCK_PATTERN_TACTILE_FEEDBACK_ENABLED = "lock_pattern_tactile_feedback_enabled";
        ...
        public static final Validator LOCK_TO_APP_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        @Deprecated
        public static final String LOGGING_ID = "logging_id";
        @Deprecated
        public static final String LOW_BATTERY_SOUND = "low_battery_sound";
        public static final String MASTER_MONO = "master_mono";
        private static final Validator MASTER_MONO_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String MEDIA_BUTTON_RECEIVER = "media_button_receiver";
        private static final Validator MEDIA_BUTTON_RECEIVER_VALIDATOR = SettingsValidators.COMPONENT_NAME_VALIDATOR;
        public static final String MICROPHONE_MUTE = "microphone_mute";
        @Deprecated
        public static final String MODE_RINGER = "mode_ringer";
        public static final String MODE_RINGER_STREAMS_AFFECTED = "mode_ringer_streams_affected";
        private static final Validator MODE_RINGER_STREAMS_AFFECTED_VALIDATOR = SettingsValidators.NON_NEGATIVE_INTEGER_VALIDATOR;
        private static final HashSet<String> MOVED_TO_GLOBAL = new HashSet();
        ...
        private static final Validator MUTE_STREAMS_AFFECTED_VALIDATOR = SettingsValidators.NON_NEGATIVE_INTEGER_VALIDATOR;
        @Deprecated
        public static final String NETWORK_PREFERENCE = "network_preference";
        @Deprecated
        ...
        private static final Validator NOTIFICATIONS_USE_RING_VOLUME_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String NOTIFICATION_LIGHT_PULSE = "notification_light_pulse";
        public static final Validator NOTIFICATION_LIGHT_PULSE_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator NOTIFICATION_SOUND_VALIDATOR = SettingsValidators.URI_VALIDATOR;
        ...
        public static final Validator POINTER_LOCATION_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator RINGTONE_VALIDATOR = SettingsValidators.URI_VALIDATOR;
        ...
        private static final Validator SCREEN_BRIGHTNESS_MODE_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String SCREEN_OFF_TIMEOUT = "screen_off_timeout";
        private static final Validator SCREEN_OFF_TIMEOUT_VALIDATOR = SettingsValidators.NON_NEGATIVE_INTEGER_VALIDATOR;
        @Deprecated
        public static final String SETTINGS_CLASSNAME = "settings_classname";
        ...
        public static final Validator SETUP_WIZARD_HAS_RUN_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String SHOW_BATTERY_PERCENT = "status_bar_show_battery_percent";
        private static final Validator SHOW_BATTERY_PERCENT_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String SHOW_GTALK_SERVICE_STATUS = "SHOW_GTALK_SERVICE_STATUS";
        private static final Validator SHOW_GTALK_SERVICE_STATUS_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        @Deprecated
        public static final String SHOW_PROCESSES = "show_processes";
        public static final String SHOW_TOUCHES = "show_touches";
        public static final Validator SHOW_TOUCHES_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        @Deprecated
        public static final String SHOW_WEB_SUGGESTIONS = "show_web_suggestions";
        public static final Validator SHOW_WEB_SUGGESTIONS_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String SIMPLEUI_MODE = "simpleui_mode";
        public static final String SIP_ADDRESS_ONLY = "SIP_ADDRESS_ONLY";
        public static final Validator SIP_ADDRESS_ONLY_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String SIP_ALWAYS = "SIP_ALWAYS";
        public static final Validator SIP_ALWAYS_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        @Deprecated
        public static final String SIP_ASK_ME_EACH_TIME = "SIP_ASK_ME_EACH_TIME";
        public static final Validator SIP_ASK_ME_EACH_TIME_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        public static final Validator SIP_RECEIVE_CALLS_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String SMART_BACKLIGHT = "smart_backlight_enable";
        public static final String SOUND_EFFECTS_ENABLED = "sound_effects_enabled";
        public static final Validator SOUND_EFFECTS_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator TEXT_AUTO_CAPS_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String TEXT_AUTO_PUNCTUATE = "auto_punctuate";
        private static final Validator TEXT_AUTO_PUNCTUATE_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String TEXT_AUTO_REPLACE = "auto_replace";
        private static final Validator TEXT_AUTO_REPLACE_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String TEXT_SHOW_PASSWORD = "show_password";
        private static final Validator TEXT_SHOW_PASSWORD_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String TIME_12_24 = "time_12_24";
        public static final Validator TIME_12_24_VALIDATOR = new DiscreteValueValidator(new String[]{WifiScanLog.EVENT_KEY12, WifiScanLog.EVENT_KEY24, null});
        @Deprecated
        public static final String TRANSITION_ANIMATION_SCALE = "transition_animation_scale";
        ...
        private static final Validator VIBRATE_INPUT_DEVICES_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String VIBRATE_IN_SILENT = "vibrate_in_silent";
        private static final Validator VIBRATE_IN_SILENT_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String VIBRATE_ON = "vibrate_on";
        private static final Validator VIBRATE_ON_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String VIBRATE_WHEN_RINGING = "vibrate_when_ringing";
        public static final Validator VIBRATE_WHEN_RINGING_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        private static final Validator VIBRATION_INTENSITY_VALIDATOR = new InclusiveIntegerRangeValidator(0, 3);
        ...
        public static final String[] VOLUME_SETTINGS_INT = new String[]{VOLUME_VOICE, VOLUME_SYSTEM, VOLUME_RING, VOLUME_MUSIC, VOLUME_ALARM, VOLUME_NOTIFICATION, VOLUME_BLUETOOTH_SCO, "", "", "", VOLUME_ACCESSIBILITY};
        ...
        private static final Validator WALLPAPER_ACTIVITY_VALIDATOR = new Validator() {
            ...
            public boolean validate(String value) {
                boolean z = false;
                if (value == null || (value != null && value.length() > 1000)) {
                    return false;
                }
        ...
        private static final Validator WIFI_STATIC_DNS1_VALIDATOR = SettingsValidators.LENIENT_IP_ADDRESS_VALIDATOR;
        @Deprecated
        public static final String WIFI_STATIC_DNS2 = "wifi_static_dns2";
        private static final Validator WIFI_STATIC_DNS2_VALIDATOR = SettingsValidators.LENIENT_IP_ADDRESS_VALIDATOR;
        @Deprecated
        public static final String WIFI_STATIC_GATEWAY = "wifi_static_gateway";
        private static final Validator WIFI_STATIC_GATEWAY_VALIDATOR = SettingsValidators.LENIENT_IP_ADDRESS_VALIDATOR;
        @Deprecated
        public static final String WIFI_STATIC_IP = "wifi_static_ip";
        private static final Validator WIFI_STATIC_IP_VALIDATOR = SettingsValidators.LENIENT_IP_ADDRESS_VALIDATOR;
        @Deprecated
        public static final String WIFI_STATIC_NETMASK = "wifi_static_netmask";
        private static final Validator WIFI_STATIC_NETMASK_VALIDATOR = SettingsValidators.LENIENT_IP_ADDRESS_VALIDATOR;
        @Deprecated
        public static final String WIFI_USE_STATIC_IP = "wifi_use_static_ip";
        private static final Validator WIFI_USE_STATIC_IP_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        @Deprecated
        public static final String WIFI_WATCHDOG_ACCEPTABLE_PACKET_LOSS_PERCENTAGE = "wifi_watchdog_acceptable_packet_loss_percentage";
        @Deprecated
        public static final String WIFI_WATCHDOG_AP_COUNT = "wifi_watchdog_ap_count";
        ...
        public static final Validator WINDOW_ORIENTATION_LISTENER_LOG_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
    ...
    public static String getGTalkDeviceId(long androidId) {
        ...
        stringBuilder.append(Long.toHexString(androidId));
        return stringBuilder.toString();
    }
    ...
    public static boolean isCallingPackageAllowedToPerformAppOpsProtectedOperation(Context context, int uid, String callingPackage, boolean throwException, int appOpsOpCode, String[] permissions, boolean makeNote) {
        ...
        if ((mode == 2 && ("com.huawei.runningtestii".equals(callingPackage) || "com.huawei.hidp".equals(callingPackage) || uid == 1000 || UserHandle.getAppId(uid) == 1000)) || mode == 0) {
            return true;
        }
        if (mode == 3) {
