...
public class Matrix4f {
    ...
    public void loadRotate(float rot, float x, float y, float z) {
        ...
        this.mMat[4] = (recipLen * nc) - zs;
        this.mMat[8] = (zx * nc) + ys;
        this.mMat[1] = (recipLen * nc) + zs;
    ...
    public boolean inverse() {
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            for (int j = 0; j < 4; j++) {
                result.mMat[(4 * i2) + j] = computeCofactor(i2, j);
            }
        }
        ...
        float det2 = 1.0f / det;
        while (i < 16) {
            this.mMat[i] = result.mMat[i] * det2;
            i++;
        }
        return true;
    }
    ...
    public boolean inverseTranspose() {
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            for (int j = 0; j < 4; j++) {
                result.mMat[(4 * j) + i2] = computeCofactor(i2, j);
            }
        }
