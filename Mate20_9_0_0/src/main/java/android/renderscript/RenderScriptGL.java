...
public class RenderScriptGL extends RenderScript {
    ...
    public RenderScriptGL(Context ctx, SurfaceConfig sc) {
        ...
        int i9 = this.mSurfaceConfig.mSamplesMin;
        int i10 = this.mSurfaceConfig.mSamplesPref;
        int i11 = i10;
        int i12 = i9;
        int i13 = i8;
        this.mContext = nContextCreateGL(device, 0, sdkVersion, i, i2, i3, i4, i5, i6, i7, i13, i12, i11, this.mSurfaceConfig.mSamplesQ, dpi);
        if (this.mContext != 0) {
