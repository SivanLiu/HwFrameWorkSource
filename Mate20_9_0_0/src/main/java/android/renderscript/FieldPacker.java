...
public class FieldPacker {
    ...
    public void addI64(long v) {
        ...
        int i2 = this.mPos;
        this.mPos = i2 + 1;
        bArr2[i2] = (byte) ((int) ((v >> 16) & 255));
        bArr2 = this.mData;
        i2 = this.mPos;
        this.mPos = i2 + 1;
        bArr2[i2] = (byte) ((int) ((v >> 24) & 255));
        bArr2 = this.mData;
        i2 = this.mPos;
        this.mPos = i2 + 1;
        bArr2[i2] = (byte) ((int) ((v >> 32) & 255));
        bArr2 = this.mData;
        i2 = this.mPos;
        this.mPos = i2 + 1;
        bArr2[i2] = (byte) ((int) ((v >> 40) & 255));
        bArr2 = this.mData;
        i2 = this.mPos;
        this.mPos = i2 + 1;
        bArr2[i2] = (byte) ((int) ((v >> 48) & 255));
        bArr2 = this.mData;
        i2 = this.mPos;
        this.mPos = i2 + 1;
        bArr2[i2] = (byte) ((int) ((v >> 56) & 255));
    }
    ...
    public long subI64() {
        ...
        i = this.mPos - 1;
        this.mPos = i;
        long v2 = v | ((((long) bArr[i]) & 255) << 8);
        byte x = this.mData;
        int i2 = this.mPos - 1;
        this.mPos = i2;
        return v2 | (((long) x[i2]) & 255);
    }
