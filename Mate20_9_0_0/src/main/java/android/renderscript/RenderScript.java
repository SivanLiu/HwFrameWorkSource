            ...
            while (this.mRun) {
                ...
                if (msg == 4) {
                    ...
                    if (subID >= 4096 || (subID >= 2048 && (this.mRS.mContextType != ContextType.DEBUG || this.mRS.mErrorCallback == null))) {
                        ...
                        String str = RenderScript.LOG_TAG;
                        stringBuilder = new StringBuilder();
    ...
    static {
        ...
        if (!SystemProperties.getBoolean("config.disable_renderscript", false)) {
            try {
                ...
                Log.e(LOG_TAG, stringBuilder.toString());
                stringBuilder2 = new StringBuilder();
                stringBuilder2.append("Error loading GC methods: ");
    ...
    static synchronized String getCachePath() {
        ...
        synchronized (RenderScript.class) {
            if (mCachePath == null) {
                ...
                file = new File(RenderScriptCacheDir.mCacheDir, "com.android.renderscript.cache");
