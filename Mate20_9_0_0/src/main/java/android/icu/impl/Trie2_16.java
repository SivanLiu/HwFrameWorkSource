    ...
    public final int get(int codePoint) {
        if (codePoint >= 0) {
            if (codePoint < 55296 || (codePoint > UTF16.LEAD_SURROGATE_MAX_VALUE && codePoint <= DateTimePatternGenerator.MATCH_ALL_FIELDS_LENGTH)) {
                ...
                return this.index[(this.index[2048 + ((codePoint - 55296) >> 5)] << 2) + (codePoint & 31)];
            } else if (codePoint < this.highStart) {
                return this.index[(this.index[this.index[2080 + (codePoint >> 11)] + ((codePoint >> 5) & 63)] << 2) + (codePoint & 31)];
