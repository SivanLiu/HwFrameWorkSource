...
public class Grego {
    private static final int[] DAYS_BEFORE = new int[]{0, 31, 59, 90, 120, 151, 181, 212, 243, UnicodeBlock.TANGUT_COMPONENTS_ID, 304, 334, 0, 31, 60, 91, 121, 152, 182, 213, 244, UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS_EXTENSION_F_ID, 305, 335};
    ...
    public static int[] dayToFields(long day, int[] fields) {
        ...
        int dayOfYear3 = dayOfYear2 + 1;
        fields2[0] = year;
        fields2[1] = month;
        fields2[2] = dayOfMonth;
        fields2[3] = dayOfWeek;
        fields2[4] = dayOfYear3;
        return fields2;
    }
