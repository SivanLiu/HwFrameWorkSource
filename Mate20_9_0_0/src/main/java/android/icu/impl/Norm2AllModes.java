...
public final class Norm2AllModes {
    ...
    private static CacheBase<String, Norm2AllModes, ByteBuffer> cache = new SoftCache<String, Norm2AllModes, ByteBuffer>() {
        protected Norm2AllModes createInstance(String key, ByteBuffer bytes) {
            ...
            if (bytes == null) {
                impl = new Normalizer2Impl();
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append(key);
                stringBuilder.append(".nrm");
                impl = impl.load(stringBuilder.toString());
            } else {
    ...
    private static final class Norm2AllModesSingleton {
        ...
        /* synthetic */ Norm2AllModesSingleton(String x0, AnonymousClass1 x1) {
            this(x0);
        }
        ...
        private Norm2AllModesSingleton(String name) {
            try {
                ...
                stringBuilder.append(".nrm");
                this.allModes = new Norm2AllModes(impl.load(stringBuilder.toString()), null);
    ...
    public static final class DecomposeNormalizer2 extends Normalizer2WithImpl {
        ...
        public int getQuickCheck(int c) {
            return this.impl.isDecompYes(this.impl.getNorm16(c));
        }
    ...
    /* synthetic */ Norm2AllModes(Normalizer2Impl x0, AnonymousClass1 x1) {
        this(x0);
    }
