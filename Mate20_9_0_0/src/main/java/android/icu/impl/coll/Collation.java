...
public final class Collation {
    ...
    static long ceFromSimpleCE32(int ce32) {
        return ((((long) (SECONDARY_MASK & ce32)) << 32) | (((long) (65280 & ce32)) << 16)) | ((long) ((ce32 & 255) << 8));
    }

    static long ceFromCE32(int ce32) {
        int tertiary = ce32 & 255;
        if (tertiary < 192) {
            return ((((long) (SECONDARY_MASK & ce32)) << 32) | (((long) (65280 & ce32)) << 16)) | ((long) (tertiary << 8));
        }
        ce32 -= tertiary;
        if ((tertiary & 15) == 1) {
    ...
    static long unassignedPrimaryFromCodePoint(int c) {
        c++;
        long primary = (long) (((c % 18) * 14) + 2);
        c /= 18;
        return 4261412864L | ((((long) ((2 + (c % 254)) << 8)) | primary) | ((long) ((4 + ((c / 254) % 251)) << 16)));
    }
