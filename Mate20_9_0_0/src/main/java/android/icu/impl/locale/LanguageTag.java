...
public class LanguageTag {
    ...
    public static LanguageTag parse(String languageTag, ParseStatus sts) {
        ...
        if (isGrandfathered) {
            ...
            if (s.length() == 0) {
                ...
                sts._errorMsg = stringBuilder.toString();
            }
        }
        return tag;
    }
    ...
    public static LanguageTag parseLocale(BaseLocale baseLocale, LocaleExtensions localeExtensions) {
        ...
        if (privuseVar != null) {
            ...
            if (privateuse == null) {
                ...
                stringBuilder2.append("lvariant-");
                stringBuilder2.append(privuseVar);
                privateuse = stringBuilder2.toString();
            } else {
                stringBuilder2 = new StringBuilder();
                stringBuilder2.append(privateuse);
                stringBuilder2.append(SEP);
                stringBuilder2.append(PRIVUSE_VARIANT_PREFIX);
                stringBuilder2.append(SEP);
                stringBuilder2.append(privuseVar.replace(BaseLocale.SEP, SEP));
                privateuse = stringBuilder2.toString();
            }
        }
        if (privateuse != null) {
    ...
    public String toString() {
        ...
        if (this._language.length() > 0) {
            ...
            for (String extlang2 : this._variants) {
                sb.append(SEP);
                sb.append(extlang2);
            }
            for (String extlang22 : this._extensions) {
                sb.append(SEP);
                sb.append(extlang22);
            }
        }
