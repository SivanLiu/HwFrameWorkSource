...
class BasicDurationFormatter implements DurationFormatter {
    ...
    public DurationFormatter withLocale(String locName) {
        ...
        if (this.fallback == null) {
            ...
            dateFormatter = this.fallback.withLocale(locName);
        }
        return new BasicDurationFormatter(newFormatter, newBuilder, dateFormatter, this.fallbackLimit, locName, this.timeZone);
    }
    ...
    public DurationFormatter withTimeZone(TimeZone tz) {
        ...
        if (this.fallback == null) {
            ...
            dateFormatter = this.fallback.withTimeZone(tz);
        }
        return new BasicDurationFormatter(this.formatter, newBuilder, dateFormatter, this.fallbackLimit, this.localeName, tz);
    }
