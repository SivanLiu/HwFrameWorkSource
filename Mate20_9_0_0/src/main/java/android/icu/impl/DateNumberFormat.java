    ...
    private void initialize(ULocale loc, String digitString, String nsName) {
        ...
        if (elems == null) {
            ...
            try {
                ...
                stringBuilder.append("/symbols/minusSign");
                minusString = rb.getStringWithFallback(stringBuilder.toString());
                ...
                if (nsName.equals("latn")) {
                    ...
                    String ex1;
                    try {
                        ex1 = rb.getStringWithFallback("NumberElements/latn/symbols/minusSign");
