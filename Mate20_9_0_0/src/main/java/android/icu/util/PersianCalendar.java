...
public class PersianCalendar extends Calendar {
    ...
    private static final int[][] MONTH_COUNT = new int[][]{new int[]{31, 31, 0}, new int[]{31, 31, 31}, new int[]{31, 31, 62}, new int[]{31, 31, 93}, new int[]{31, 31, 124}, new int[]{31, 31, 155}, new int[]{30, 30, 186}, new int[]{30, 30, 216}, new int[]{30, 30, 246}, new int[]{30, 30, UnicodeBlock.MASARAM_GONDI_ID}, new int[]{30, 30, 306}, new int[]{29, 30, 336}};
    ...
    protected void handleComputeFields(int julianDay) {
        ...
        int dayOfYear = (int) (daysSinceEpoch - ((365 * (((long) year) - 1)) + Calendar.floorDivide((8 * ((long) year)) + 21, 33)));
        if (dayOfYear < 216) {
            month = dayOfYear / 31;
        } else {
