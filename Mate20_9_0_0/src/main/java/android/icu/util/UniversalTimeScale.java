...
public final class UniversalTimeScale {
    ...
    private static final class TimeScaleData {
        ...
        long minRound = (Long.MIN_VALUE + this.unitsRound);
        long toMax;
        long toMin;
        long units;
        long unitsRound;
        ...
        TimeScaleData(long theUnits, long theEpochOffset, long theToMin, long theToMax, long theFromMin, long theFromMax) {
            ...
            this.units = j;
            this.unitsRound = j / 2;
            this.epochOffset = theEpochOffset / j;
            if (j == UniversalTimeScale.ticks) {
                long j2 = this.epochOffset;
                this.epochOffsetM1 = j2;
                this.epochOffsetP1 = j2;
            } else {
    ...
    private static TimeScaleData toRangeCheck(long universalTime, int scale) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("universalTime out of range:");
        stringBuilder.append(universalTime);
        throw new IllegalArgumentException(stringBuilder.toString());
    }
    ...
    private static TimeScaleData fromRangeCheck(long otherTime, int scale) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("otherTime out of range:");
        stringBuilder.append(otherTime);
        throw new IllegalArgumentException(stringBuilder.toString());
    }
