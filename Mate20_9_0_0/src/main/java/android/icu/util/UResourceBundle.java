...
public abstract class UResourceBundle extends ResourceBundle {
    ...
    public UResourceBundle get(int index) {
        UResourceBundle obj = handleGet(index, (HashMap) null, this);
        if (obj == null) {
            obj = getParent();
            if (obj != null) {
                obj = obj.get(index);
            ...
            if (obj == null) {
                ...
                throw new MissingResourceException(stringBuilder.toString(), getClass().getName(), getKey());
            }
        }
        return obj;
    }
    ...
    private Object resolveObject(String aKey, UResourceBundle requested) {
        ...
        UResourceBundle obj = handleGet(aKey, (HashMap) null, requested);
        if (obj != null) {
            if (obj.getType() == 0) {
