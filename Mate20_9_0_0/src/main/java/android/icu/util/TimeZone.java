...
public abstract class TimeZone implements Serializable, Cloneable, Freezable<TimeZone> {
    ...
    private String _getDisplayName(int style, boolean daylight, ULocale locale) {
        if (locale != null) {
            ...
            if (style == 7 || style == 3 || style == 2) {
                ...
                return style == 2 ? tzfmt.formatOffsetShortLocalizedGMT(offset) : tzfmt.formatOffsetLocalizedGMT(offset);
                ...
                switch (style) {
                    case 4:
                        return tzfmt2.formatOffsetISO8601Basic(offset, false, false, false);
                    case 5:
                        return tzfmt2.formatOffsetLocalizedGMT(offset);
                    default:
                        return null;
                }
            } else {
                ...
                return style == 1 ? tzfmt3.formatOffsetLocalizedGMT(offset2) : tzfmt3.formatOffsetShortLocalizedGMT(offset2);
            }
        }
    ...
    private static TimeZone getTimeZone(String id, int type, boolean frozen) {
        ...
        if (result == null) {
            ...
            stringBuilder.append("\" is a bogus id so timezone is falling back to Etc/Unknown(GMT).");
    ...
    public static String getRegion(String id) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Unknown system zone id: ");
        stringBuilder.append(id);
        throw new IllegalArgumentException(stringBuilder.toString());
    }
