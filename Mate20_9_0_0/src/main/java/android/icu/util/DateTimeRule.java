    ...
    public String toString() {
        ...
        switch (this.dateRuleType) {
            ...
            case 1:
                ...
                stringBuilder.append(Integer.toString(this.weekInMonth));
                stringBuilder.append(DOWSTR[this.dayOfWeek]);
                sDate = stringBuilder.toString();
                break;
            case 2:
                stringBuilder = new StringBuilder();
                stringBuilder.append(DOWSTR[this.dayOfWeek]);
                stringBuilder.append(">=");
                stringBuilder.append(Integer.toString(this.dayOfMonth));
                sDate = stringBuilder.toString();
                break;
            case 3:
                stringBuilder = new StringBuilder();
