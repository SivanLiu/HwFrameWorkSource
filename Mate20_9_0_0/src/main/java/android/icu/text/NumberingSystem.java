...
public class NumberingSystem {
    ...
    public static NumberingSystem getInstance(ULocale locale) {
        ...
        key.append(baseName);
        key.append("@numbers=");
        key.append(numbersKeyword);
        return (NumberingSystem) cachedLocaleData.getInstance(key.toString(), new LocaleLookupData(locale, numbersKeyword));
    }
    ...
    static NumberingSystem lookupInstanceByLocale(LocaleLookupData localeLookupData) {
        try {
            ...
            if (resolvedNumberingSystem != null) {
                ex = getInstanceByName(resolvedNumberingSystem);
            }
            if (ex == null) {
                ex = new NumberingSystem();
            }
            return ex;
    ...
    private static NumberingSystem lookupInstanceByName(String name) {
        try {
            ...
            return getInstance(name, radix, z, description);
        } catch (MissingResourceException e) {
            return null;
        }
    }
