...
class ModulusSubstitution extends NFSubstitution {
    ...
    ModulusSubstitution(int pos, NFRule rule, NFRule rulePredecessor, NFRuleSet ruleSet, String description) {
        ...
        if (this.divisor == 0) {
            ...
            stringBuilder.append("Substitution with bad divisor (");
            stringBuilder.append(this.divisor);
            stringBuilder.append(") ");
            stringBuilder.append(description.substring(0, pos));
            stringBuilder.append(" | ");
            stringBuilder.append(description.substring(pos));
