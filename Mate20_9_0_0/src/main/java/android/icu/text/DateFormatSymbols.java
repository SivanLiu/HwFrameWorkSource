...
public class DateFormatSymbols implements Serializable, Cloneable {
    ...
    private static final class CalendarDataSink extends Sink {
        ...
        static {
            Class cls = DateFormatSymbols.class;
        }
            ...
            for (int i = 0; table.getKeyAndValue(i, key, value); i++) {
                if (!key.endsWith("%variant")) {
                    ...
                    if (value.getType() == 0) {
                        ...
                        String currentPath = new StringBuilder();
                        currentPath.append(path);
                        currentPath.append("/");
                        currentPath.append(keyString);
        ...
        private AliasType processAliasFromValue(String currentRelativePath, Value value) {
            ...
            stringBuilder.append("Malformed 'calendar' alias. Path: ");
            stringBuilder.append(aliasPath);
            throw new ICUException(stringBuilder.toString());
        }
    }

    /* synthetic */ DateFormatSymbols(ULocale x0, ICUResourceBundle x1, String x2, AnonymousClass1 x3) {
        this(x0, x1, x2);
    }
    ...
    public String[][] getZoneStrings() {
        ...
        while (true) {
            ...
            if (i2 < tzIDs.length) {
                ...
                String canonicalID2 = canonicalID;
                array[i2][0] = tzIDs[i2];
                tznames.getDisplayNames(canonicalID2, types, now, array[i2], 1);
                i = i2 + 1;
            } else {
    ...
    protected void initializeData(ULocale desiredLocale, String type) {
        ...
        key.append(desiredLocale.getBaseName());
        key.append('+');
        key.append(type);
        key = key.toString();
    ...
    protected void initializeData(ULocale desiredLocale, ICUResourceBundle b, String calendarType) {
        ...
        if (b == null) {
            ...
            b2 = (ICUResourceBundle) UResourceBundle.getBundleInstance(ICUData.ICU_BASE_NAME, uLocale);
        } else {
            b2 = b;
            calendarType2 = calendarType;
        }
        while (calendarType2 != null) {
            ...
            ICUResourceBundle dataForType = b2.findWithFallback(stringBuilder.toString());
            if (dataForType != null) {
                ...
                stringBuilder2.append("The 'gregorian' calendar type wasn't found for the locale: ");
                stringBuilder2.append(desiredLocale.getBaseName());
                throw new MissingResourceException(stringBuilder2.toString(), getClass().getName(), "gregorian");
            } else {
                calendarType2 = "gregorian";
                calendarSink.visitAllResources();
            }
        }
        Map<String, String[]> arrays2 = calendarSink.arrays;
        Map<String, Map<String, String>> maps = calendarSink.maps;
        this.eras = (String[]) arrays2.get("eras/abbreviated");
        this.eraNames = (String[]) arrays2.get("eras/wide");
        this.narrowEras = (String[]) arrays2.get("eras/narrow");
        this.months = (String[]) arrays2.get("monthNames/format/wide");
        this.shortMonths = (String[]) arrays2.get("monthNames/format/abbreviated");
        this.narrowMonths = (String[]) arrays2.get("monthNames/format/narrow");
        this.standaloneMonths = (String[]) arrays2.get("monthNames/stand-alone/wide");
        this.standaloneShortMonths = (String[]) arrays2.get("monthNames/stand-alone/abbreviated");
        this.standaloneNarrowMonths = (String[]) arrays2.get("monthNames/stand-alone/narrow");
        String[] lWeekdays = (String[]) arrays2.get("dayNames/format/wide");
        this.weekdays = new String[8];
        this.weekdays[0] = "";
        System.arraycopy(lWeekdays, 0, this.weekdays, 1, lWeekdays.length);
        String[] aWeekdays = (String[]) arrays2.get("dayNames/format/abbreviated");
        this.shortWeekdays = new String[8];
        this.shortWeekdays[0] = "";
        System.arraycopy(aWeekdays, 0, this.shortWeekdays, 1, aWeekdays.length);
        String[] sWeekdays = (String[]) arrays2.get("dayNames/format/short");
        ...
        String[] nWeekdays = (String[]) arrays2.get("dayNames/format/narrow");
        if (nWeekdays == null) {
            nWeekdays = (String[]) arrays2.get("dayNames/stand-alone/narrow");
            if (nWeekdays == null) {
                nWeekdays = (String[]) arrays2.get("dayNames/format/abbreviated");
                if (nWeekdays == null) {
        ...
        String[] swWeekdays = (String[]) arrays2.get("dayNames/stand-alone/wide");
        ...
        String[] saWeekdays = (String[]) arrays2.get("dayNames/stand-alone/abbreviated");
        ...
        String[] ssWeekdays = (String[]) arrays2.get("dayNames/stand-alone/short");
        ...
        String[] snWeekdays = (String[]) arrays2.get("dayNames/stand-alone/narrow");
        ...
        this.ampms = (String[]) arrays2.get("AmPmMarkers");
        this.ampmsNarrow = (String[]) arrays2.get("AmPmMarkersNarrow");
        this.quarters = (String[]) arrays2.get("quarters/format/wide");
        this.shortQuarters = (String[]) arrays2.get("quarters/format/abbreviated");
        this.standaloneQuarters = (String[]) arrays2.get("quarters/stand-alone/wide");
        this.standaloneShortQuarters = (String[]) arrays2.get("quarters/stand-alone/abbreviated");
        ...
        this.shortYearNames = (String[]) arrays2.get("cyclicNameSets/years/format/abbreviated");
        this.shortZodiacNames = (String[]) arrays2.get("cyclicNameSets/zodiacs/format/abbreviated");
        ...
        while (uloc2 < i) {
            ...
            this.capitalization.put(allUsages[uloc2], noTransforms);
            uloc2++;
            i = i2;
            b2 = b3;
        }
        ...
        try {
            e = rb.getWithFallback("contextTransforms");
        } catch (MissingResourceException e2) {
            e = null;
        }
        contextTransformsBundle = e;
        if (contextTransformsBundle != null) {
            ...
            while (ctIterator.hasNext()) {
                ...
                if (intVector.length >= 2) {
                    calendarType2 = contextTransformUsage.getKey();
                    CapitalizationContextUsage usage = (CapitalizationContextUsage) contextUsageTypeMap.get(calendarType2);
                    if (usage != null) {
        ...
        stringBuilder.append("/symbols/timeSeparator");
        try {
            setTimeSeparatorString(rb.getStringWithFallback(stringBuilder.toString()));
