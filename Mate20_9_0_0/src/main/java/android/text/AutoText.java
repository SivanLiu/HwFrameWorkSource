...
public class AutoText {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:18:0x0050 A:{LOOP_END, LOOP:0: B:1:0x0007->B:18:0x0050} */
    /* JADX WARNING: Removed duplicated region for block: B:22:0x004f A:{SYNTHETIC} */
    ...
    private void add(String src, char off) {
        ...
        for (int i = 0; i < slen; i++) {
            ...
            int herep2 = herep;
            boolean found = false;
            while (this.mTrie[herep2] != TRIE_NULL) {
                if (c != this.mTrie[this.mTrie[herep2] + 0]) {
