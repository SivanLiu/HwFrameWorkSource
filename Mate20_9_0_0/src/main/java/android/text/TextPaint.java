...
public class TextPaint extends Paint {
    ...
    public boolean hasEqualAttributes(TextPaint other) {
        return this.bgColor == other.bgColor && this.baselineShift == other.baselineShift && this.linkColor == other.linkColor && this.drawableState == other.drawableState && this.density == other.density && this.underlineColor == other.underlineColor && this.underlineThickness == other.underlineThickness && super.hasEqualAttributes(other);
    }
