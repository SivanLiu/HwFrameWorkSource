...
public class SuggestionSpan extends CharacterStyle implements ParcelableSpan {
    ...
    private void initStyle(Context context) {
        ...
        typedArray = context.obtainStyledAttributes(null, R.styleable.SuggestionSpan, 17891537, 0);
        ...
        typedArray = context.obtainStyledAttributes(null, R.styleable.SuggestionSpan, 17891536, 0);
    ...
    public void notifySelection(Context context, String original, int index) {
        ...
        if (context != null && this.mNotificationTargetClassName != null) {
            if (this.mSuggestions == null || index < 0 || index >= this.mSuggestions.length) {
                ...
                stringBuilder.append("Unable to notify the suggestion as the index is out of range index=");
                stringBuilder.append(index);
                stringBuilder.append(" length=");
                stringBuilder.append(this.mSuggestions.length);
