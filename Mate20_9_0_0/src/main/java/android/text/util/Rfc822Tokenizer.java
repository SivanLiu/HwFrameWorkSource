...
public class Rfc822Tokenizer implements Tokenizer {
    public static void tokenize(CharSequence text, Collection<Rfc822Token> out) {
        ...
        Collection<Rfc822Token> collection = out;
        ...
        while (i < cursor) {
            ...
            if (c == ',' || c == ';') {
                ...
                crunch(name);
                if (address.length() > 0) {
                    collection.add(new Rfc822Token(name.toString(), address.toString(), comment.toString()));
                } else if (name.length() > 0) {
                    collection.add(new Rfc822Token(null, name.toString(), comment.toString()));
                }
                name.setLength(0);
                address.setLength(0);
                comment.setLength(0);
                ...
                while (i < cursor) {
                    ...
                    if (c == '\"') {
                        ...
                        if (i + 1 < cursor) {
                            name.append(charSequence.charAt(i + 1));
                        }
                        i += 2;
                    } else {
                        name.append(c);
                ...
                while (i < cursor && level > 0) {
                    ...
                    if (c == ')') {
                        ...
                        if (i + 1 < cursor) {
                            comment.append(charSequence.charAt(i + 1));
                        }
                        i += 2;
                    } else {
                        comment.append(c);
