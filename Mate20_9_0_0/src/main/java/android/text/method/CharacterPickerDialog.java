...
public class CharacterPickerDialog extends Dialog implements OnItemClickListener, OnClickListener {
    ...
    private class OptionsAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            Button b = (Button) CharacterPickerDialog.this.mInflater.inflate(17367110, null);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridView grid = (GridView) findViewById(16908802);
        grid.setAdapter(new OptionsAdapter(getContext()));
        grid.setOnItemClickListener(this);
        this.mCancelButton = (Button) findViewById(16908793);
