...
public class HwNotificationResource {
    ...
    private static synchronized IHwNotificationResource getImplObject() {
        synchronized (HwNotificationResource.class) {
            IHwNotificationResource iHwNotificationResource;
            if (sInstance != null) {
                iHwNotificationResource = sInstance;
                return iHwNotificationResource;
            }
            iHwNotificationResource = HwFrameworkFactory.getHwNotificationResource();
            if (iHwNotificationResource == null) {
                iHwNotificationResource = new HwNotificationResourceDummy();
            }
            sInstance = iHwNotificationResource;
            IHwNotificationResource iHwNotificationResource2 = sInstance;
            return iHwNotificationResource2;
        }
    }
