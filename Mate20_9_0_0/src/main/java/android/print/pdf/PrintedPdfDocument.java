...
public class PrintedPdfDocument extends PdfDocument {
    ...
    public PrintedPdfDocument(Context context, PrintAttributes attributes) {
        ...
        this.mContentRect = new Rect((int) ((((float) minMargins.getLeftMils()) / 1000.0f) * 1116733440), (int) ((((float) minMargins.getTopMils()) / 1000.0f) * 1116733440), this.mPageWidth - ((int) ((((float) minMargins.getRightMils()) / 1000.0f) * 1116733440)), this.mPageHeight - ((int) ((((float) minMargins.getBottomMils()) / 1000.0f) * 72.0f)));
    }
