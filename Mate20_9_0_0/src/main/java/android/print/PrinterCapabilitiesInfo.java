...
public final class PrinterCapabilitiesInfo implements Parcelable {
    ...
    public int hashCode() {
        int i = 0;
        int hashCode = 31 * ((31 * ((31 * 1) + (this.mMinMargins == null ? 0 : this.mMinMargins.hashCode()))) + (this.mMediaSizes == null ? 0 : this.mMediaSizes.hashCode()));
        if (this.mResolutions != null) {
            i = this.mResolutions.hashCode();
        }
        return (31 * ((31 * ((31 * (hashCode + i)) + this.mColorModes)) + this.mDuplexModes)) + Arrays.hashCode(this.mDefaults);
    }
