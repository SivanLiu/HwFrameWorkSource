...
public final class Log {
    ...
    public static void i(ArrayList<String> applicationInfo, String callingMethod, String description) {
        if (HWINFO) {
            ...
            stringBuilder.append((String) applicationInfo.get(0));
            stringBuilder.append(">[");
            stringBuilder.append((String) applicationInfo.get(1));
            stringBuilder.append("][");
            stringBuilder.append((String) applicationInfo.get(2));
            stringBuilder.append("]");
            String stringBuilder2 = stringBuilder.toString();
            StringBuilder stringBuilder3 = new StringBuilder();
            stringBuilder3.append("[");
            stringBuilder3.append(callingMethod);
            stringBuilder3.append("] ");
            stringBuilder3.append(description);
            i(stringBuilder2, stringBuilder3.toString());
        }
    }
