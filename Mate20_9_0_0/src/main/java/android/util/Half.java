...
public final class Half extends Number implements Comparable<Half> {
    ...
    public static int compare(short x, short y) {
        ...
        int i2 = x & FP16_COMBINED;
        short yBits = NaN;
        short xBits = i2 > FP16_EXPONENT_MAX ? NaN : x;
    ...
    public static short min(short x, short y) {
        ...
        if ((x & FP16_COMBINED) == 0 && (y & FP16_COMBINED) == 0) {
            return (x & 32768) != 0 ? x : y;
        }
        return ((x & 32768) != 0 ? 32768 - (x & 65535) : x & 65535) < ((y & 32768) != 0 ? 32768 - (65535 & y) : y & 65535) ? x : y;
    }
    ...
    public static boolean less(short x, short y) {
        ...
        if (((x & 32768) != 0 ? 32768 - (x & 65535) : x & 65535) < ((y & 32768) != 0 ? 32768 - (65535 & y) : y & 65535)) {
            z = true;
        }
        return z;
    }
