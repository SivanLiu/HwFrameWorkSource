...
final class IMonitorEventStreamImpl extends EventStream {
    ...
    public EventStream setParam(short paramID, Boolean value) {
        setParam(paramID, value.booleanValue());
        return this;
    }
    ...
    public EventStream fillArrayParam(short paramID, Boolean value) {
        fillArrayParam(paramID, value.booleanValue());
        return this;
    }
    ...
    public EventStream setParam(String param, Boolean value) {
        setParam(param, value.booleanValue());
        return this;
    }

    public EventStream setParam(String param, byte value) {
        setParam(param, (long) value);
        return this;
    }

    public EventStream setParam(String param, short value) {
        setParam(param, (long) value);
        return this;
    }

    public EventStream setParam(String param, int value) {
        setParam(param, (long) value);
        return this;
    }

    public EventStream setParam(String param, long value) {
        if (isHandleValid()) {
    ...
    public EventStream setParam(String param, float value) {
        if (isHandleValid()) {
    ...
    public EventStream setParam(String param, String value) {
        if (value != null && isHandleValid()) {
    ...
    public EventStream setParam(String param, Date value) {
        if (value == null) {
            return this;
        }
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.US);
    ...
    public EventStream setParam(String param, EventStream value) {
        if (value != null && isHandleValid()) {
    ...
    public EventStream fillArrayParam(String param, Boolean value) {
        fillArrayParam(param, value.booleanValue());
        return this;
    }

    public EventStream fillArrayParam(String param, byte value) {
        fillArrayParam(param, (long) value);
        return this;
    }

    public EventStream fillArrayParam(String param, short value) {
        fillArrayParam(param, (long) value);
        return this;
    }

    public EventStream fillArrayParam(String param, int value) {
        fillArrayParam(param, (long) value);
        return this;
    }

    public EventStream fillArrayParam(String param, long value) {
        if (isHandleValid()) {
    ...
    public EventStream fillArrayParam(String param, float value) {
        if (isHandleValid()) {
    ...
    public EventStream fillArrayParam(String param, String value) {
        if (value != null && isHandleValid()) {
    ...
    public EventStream fillArrayParam(String param, Date value) {
        if (value == null) {
            return this;
        }
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.US);
    ...
    public EventStream fillArrayParam(String param, EventStream value) {
        if (value != null && isHandleValid()) {
    ...
    public EventStream unsetParam(String param) {
        if (isHandleValid()) {
