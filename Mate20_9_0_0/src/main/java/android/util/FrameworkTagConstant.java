...
public class FrameworkTagConstant {
    ...
    public static final String[] AM_MODULE_TAG = new String[]{AM_TAG, "ActivityManager_activity", "ActivityManager_service", "ActivityManager_contentProvider", "ActivityManager_broadcast", "ActivityManager_task", "ActivityManager_visibility", "ActivityManager_keyguard", "ActivityManager_fragment"};
    ...
    public static final String[] INPUT_MODULE_TAG = new String[]{INPUT_TAG, "InputManager_combKeyExt", "InputManager_inputMethod", "InputManager_fingersense", "InputManager_fingerpress", "InputManager_fingernavi", "InputManager_input", "InputEvent"};
    ...
    public static final String[] PM_MODULE_TAG = new String[]{PM_TAG, "PackageManager_pemission", "PackageManager_lib", "PackageManager_abi", "PackageManager_dex", "PackageManager_cust", "PackageManager_scan", "PackageManager_install", "PackageManager_update", "PackageManager_uninstall", "PackageManager_clean"};
    ...
    public static final String[] VIEW_MODULE_TAG = new String[]{VIEW_TAG, "View_measure", "View_layout", "View_draw"};
    private static final String VIEW_TAG = "View";
    public static final String[] WM_MODULE_TAG = new String[]{WM_TAG, "WindowManager_startWindow", "WindowManager_statusBar", "WindowManager_navigationBar", "WindowManager_windowChange", "WindowManager_keyguard", "WindowManager_cover", "WindowManager_visibility", "WindowManager_orientation", "WindowManager_focus", "WindowManager_transition"};
