...
public final class Slog {
    ...
    public static int v(String tag, String msg, Throwable tr) {
        ...
        return Log.println_native(3, 2, tag, stringBuilder.toString());
    }
    ...
    public static int d(String tag, String msg, Throwable tr) {
        ...
        stringBuilder.append(10);
        stringBuilder.append(Log.getStackTraceString(tr));
        return Log.println_native(3, 3, tag, stringBuilder.toString());
    }
    ...
    public static int i(String tag, String msg, Throwable tr) {
        ...
        stringBuilder.append(10);
        stringBuilder.append(Log.getStackTraceString(tr));
        return Log.println_native(3, 4, tag, stringBuilder.toString());
    }
    ...
    public static int w(String tag, String msg, Throwable tr) {
        ...
        stringBuilder.append(10);
        stringBuilder.append(Log.getStackTraceString(tr));
        return Log.println_native(3, 5, tag, stringBuilder.toString());
    }
    ...
    public static int e(String tag, String msg, Throwable tr) {
        ...
        stringBuilder.append(10);
        stringBuilder.append(Log.getStackTraceString(tr));
        return Log.println_native(3, 6, tag, stringBuilder.toString());
    }
