...
public class SparseLongArray implements Cloneable {
    ...
    public void removeAtRange(int index, int size) {
        size = Math.min(size, this.mSize - index);
        System.arraycopy(this.mKeys, index + size, this.mKeys, index, this.mSize - (index + size));
        System.arraycopy(this.mValues, index + size, this.mValues, index, this.mSize - (index + size));
        this.mSize -= size;
    }
