            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 7:
                        ...
                        return true;
                    case 8:
                        MediaMetadata _arg05;
                        data.enforceInterface(descriptor);
                        if (data.readInt() != 0) {
                            _arg05 = (MediaMetadata) MediaMetadata.CREATOR.createFromParcel(data);
                        }
                        setMetadata(_arg05);
                        reply.writeNoException();
                        return true;
                    case 9:
                        PlaybackState _arg06;
                        data.enforceInterface(descriptor);
                        if (data.readInt() != 0) {
                            _arg06 = (PlaybackState) PlaybackState.CREATOR.createFromParcel(data);
                        }
                        setPlaybackState(_arg06);
                        reply.writeNoException();
                        return true;
                    case 10:
                        ParceledListSlice _arg07;
                        data.enforceInterface(descriptor);
                        if (data.readInt() != 0) {
                            _arg07 = (ParceledListSlice) ParceledListSlice.CREATOR.createFromParcel(data);
                        }
                        setQueue(_arg07);
                        reply.writeNoException();
                        return true;
                    case 11:
                        ...
                        data.enforceInterface(descriptor);
                        if (data.readInt() != 0) {
                            _arg08 = (CharSequence) TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(data);
                        }
                        setQueueTitle(_arg08);
                        reply.writeNoException();
                        return true;
                    case 12:
                        data.enforceInterface(descriptor);
