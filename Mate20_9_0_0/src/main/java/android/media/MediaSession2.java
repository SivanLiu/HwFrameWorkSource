...
public class MediaSession2 implements AutoCloseable {
    ...
    static abstract class BuilderBase<T extends MediaSession2, U extends BuilderBase<T, U, C>, C extends SessionCallback> {
        ...
        BuilderBase(ProviderCreator<BuilderBase<T, U, C>, BuilderBaseProvider<T, C>> creator) {
            this.mProvider = (BuilderBaseProvider) creator.createProvider(this);
        }

        U setPlayer(MediaPlayerBase player) {
            this.mProvider.setPlayer_impl(player);
            return this;
        }

        U setPlaylistAgent(MediaPlaylistAgent playlistAgent) {
    ...
    public static final class CommandButton {
        ...
        public static final class Builder {
            private final BuilderProvider mProvider = ApiLoader.getProvider().createMediaSession2CommandButtonBuilder(this);
    ...
    public static final class Builder extends BuilderBase<MediaSession2, Builder, SessionCallback> {
        public Builder(Context context) {
            super(new -$$Lambda$MediaSession2$Builder$oNoIFxcC0aQZ6LWPAiWUEmVRf6c(context));
        }
