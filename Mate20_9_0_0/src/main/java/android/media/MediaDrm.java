            ...
            switch (msg.what) {
                case 200:
                    if (!(MediaDrm.this.mOnEventListener == null || msg.obj == null || !(msg.obj instanceof Parcel))) {
                        ...
                        MediaDrm.this.mOnEventListener.onEvent(this.mMediaDrm, sessionId, msg.arg1, msg.arg2, data2);
                    }
                    return;
                case 201:
                    if (!(MediaDrm.this.mOnExpirationUpdateListener == null || msg.obj == null || !(msg.obj instanceof Parcel))) {
                        ...
                        if (sessionId.length > 0) {
                            ...
                            String str2 = MediaDrm.TAG;
                            StringBuilder stringBuilder2 = new StringBuilder();
                            stringBuilder2.append("Drm key expiration update: ");
                            stringBuilder2.append(expirationTime);
                ...
                case 202:
                    ...
                    return;
                default:
                    String str3 = MediaDrm.TAG;
                    StringBuilder stringBuilder3 = new StringBuilder();
                    stringBuilder3.append("Unknown message type ");
