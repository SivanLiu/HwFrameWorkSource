...
public final class PlaybackParams implements Parcelable {
    ...
    public static final Creator<PlaybackParams> CREATOR = new Creator<PlaybackParams>() {
        public PlaybackParams createFromParcel(Parcel in) {
            return new PlaybackParams(in, null);
        }
    ...
    /* synthetic */ PlaybackParams(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
