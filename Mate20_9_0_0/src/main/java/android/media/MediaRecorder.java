...
public class MediaRecorder implements AudioRouting {
    ...
    public void setUse64bitOffset(int bUse64BitOffset) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setUse64bitOffset param-use-64bit-offset=");
        stringBuilder.append(bUse64BitOffset);
        Log.i(str, stringBuilder.toString());
        StringBuilder stringBuilder2 = new StringBuilder();
        stringBuilder2.append("param-use-64bit-offset=");
        stringBuilder2.append(bUse64BitOffset);
