...
public final class DynamicsProcessing extends AudioEffect {
    ...
    public Config getConfig() {
        ...
        int ch = 0;
        params[0] = Integer.valueOf(48);
        Number[] values = new Number[]{Integer.valueOf(0), Float.valueOf(0.0f), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0)};
    ...
    private EqBand queryEngineEqBandByChannelIndex(int param, int channelIndex, int bandIndex) {
        ...
        Number[] values = new Number[]{Integer.valueOf(0), Float.valueOf(0.0f), Float.valueOf(0.0f)};
        byte[] paramBytes = numberArrayToByteArray(params);
        byte[] valueBytes = numberArrayToByteArray(values);
        getParameter(paramBytes, valueBytes);
        byteArrayToNumberArray(valueBytes, values);
    ...
    private void updateEngineEqByChannelIndex(int param, int channelIndex, Eq eq) {
        ...
        params[0] = Integer.valueOf(param);
        params[1] = Integer.valueOf(channelIndex);
        setNumberArray(params, new Number[]{Integer.valueOf(eq.isInUse()), Integer.valueOf(eq.isEnabled()), Integer.valueOf(bandCount)});
        while (true) {
            int b2 = b;
            if (b2 < bandCount) {
    ...
    private MbcBand queryEngineMbcBandByChannelIndex(int channelIndex, int bandIndex) {
        Number[] values = new Number[]{Integer.valueOf(0), Float.valueOf(0.0f), Float.valueOf(0.0f), Float.valueOf(0.0f), Float.valueOf(0.0f), Float.valueOf(0.0f), Float.valueOf(0.0f), Float.valueOf(0.0f), Float.valueOf(0.0f), Float.valueOf(0.0f), Float.valueOf(0.0f)};
        byte[] paramBytes = numberArrayToByteArray(new Number[]{Integer.valueOf(85), Integer.valueOf(channelIndex), Integer.valueOf(bandIndex)});
        byte[] valueBytes = numberArrayToByteArray(values);
        getParameter(paramBytes, valueBytes);
        byteArrayToNumberArray(valueBytes, values);
    ...
    private void updateEngineMbcByChannelIndex(int channelIndex, Mbc mbc) {
        ...
        params[0] = Integer.valueOf(80);
        params[1] = Integer.valueOf(channelIndex);
        setNumberArray(params, new Number[]{Integer.valueOf(mbc.isInUse()), Integer.valueOf(mbc.isEnabled()), Integer.valueOf(bandCount)});
        while (true) {
            int b2 = b;
            if (b2 < bandCount) {
    ...
    private Limiter queryEngineLimiterByChannelIndex(int channelIndex) {
        Number[] values = new Number[]{Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Float.valueOf(0.0f), Float.valueOf(0.0f), Float.valueOf(0.0f), Float.valueOf(0.0f), Float.valueOf(0.0f)};
        byte[] paramBytes = numberArrayToByteArray(new Number[]{Integer.valueOf(112), Integer.valueOf(channelIndex)});
        byte[] valueBytes = numberArrayToByteArray(values);
        getParameter(paramBytes, valueBytes);
        byteArrayToNumberArray(valueBytes, values);
    ...
    private byte[] numberArrayToByteArray(Number[] values) {
        ...
        while (i2 < values.length) {
            if ((values[i2] instanceof Integer) || (values[i2] instanceof Float)) {
                expectedBytes += 4;
                i2++;
            } else {
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("unknown value type ");
                stringBuilder.append(values[i2].getClass());
                throw new IllegalArgumentException(stringBuilder.toString());
            }
        }
