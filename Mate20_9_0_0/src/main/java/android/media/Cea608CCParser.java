...
class Cea608CCParser {
    ...
    private static class CCData {
        ...
        private boolean isSpecialChar() {
            return (this.mData1 == (byte) 17 || this.mData1 == (byte) 25) && this.mData2 >= (byte) 48 && this.mData2 <= (byte) 63;
        }

        private boolean isExtendedChar() {
            return (this.mData1 == (byte) 18 || this.mData1 == (byte) 26 || this.mData1 == (byte) 19 || this.mData1 == (byte) 27) && this.mData2 >= (byte) 32 && this.mData2 <= (byte) 63;
        }
