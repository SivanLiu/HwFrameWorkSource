...
public final class AudioFormat implements Parcelable {
    ...
    public static final int[] SURROUND_SOUND_ENCODING = new int[]{5, 6, 7, 8, 10, 14, 18};
    ...
    public static class Builder {
        ...
        public Builder setChannelMask(int channelMask) {
            if (channelMask == 0) {
                ...
                stringBuilder.append(Integer.toHexString(channelMask).toUpperCase());
                throw new IllegalArgumentException(stringBuilder.toString());
            }
        }
        ...
        public Builder setChannelIndexMask(int channelIndexMask) {
            if (channelIndexMask == 0) {
                ...
                stringBuilder.append(Integer.toHexString(channelIndexMask).toUpperCase());
                throw new IllegalArgumentException(stringBuilder.toString());
            }
        }

        public Builder setSampleRate(int sampleRate) throws IllegalArgumentException {
            if ((sampleRate < 4000 || sampleRate > AudioFormat.SAMPLE_RATE_HZ_MAX) && sampleRate != 0) {
                StringBuilder stringBuilder = new StringBuilder();
