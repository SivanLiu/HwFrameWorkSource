...
public class AudioSystem {
    ...
    public static final int DEVICE_IN_ALL_USB = -1979705344;
    ...
    public static final int NUM_FORCE_CONFIG = 18;
    ...
    static {
        ...
        if (MAX_VOLUME > 0) {
            iArr = new int[11];
            iArr[0] = ((VOICE_CALL_MAX_VOLUME > 0 ? VOICE_CALL_MAX_VOLUME : MAX_VOLUME) * 4) / 5;
            iArr[1] = (MAX_VOLUME * 7) / 7;
            iArr[2] = (MAX_VOLUME * 5) / 7;
            iArr[3] = (MAX_VOLUME * 11) / 15;
            iArr[4] = (MAX_VOLUME * 6) / 7;
            iArr[5] = (MAX_VOLUME * 5) / 7;
            iArr[6] = (MAX_VOLUME * 7) / 15;
            iArr[7] = (MAX_VOLUME * 7) / 7;
            iArr[8] = (MAX_VOLUME * 11) / 15;
            iArr[9] = (MAX_VOLUME * 11) / 15;
            iArr[10] = (MAX_VOLUME * 11) / 15;
        } else {
    ...
    private static void dynamicPolicyCallbackFromNative(int event, String regId, int val) {
        ...
        if (event != 0) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("dynamicPolicyCallbackFromNative: unknown event ");
    ...
    static boolean isOffloadSupported(AudioFormat format) {
