...
public interface ISessionTokensListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISessionTokensListener {
        ...
        private static class Proxy implements ISessionTokensListener {
            ...
            public void onSessionTokensChanged(List<Bundle> tokens) throws RemoteException {
        ...
        public static ISessionTokensListener asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code == 1) {
                ...
                onSessionTokensChanged(data.createTypedArrayList(Bundle.CREATOR));
                return true;
    ...
    void onSessionTokensChanged(List<Bundle> list) throws RemoteException;
}
