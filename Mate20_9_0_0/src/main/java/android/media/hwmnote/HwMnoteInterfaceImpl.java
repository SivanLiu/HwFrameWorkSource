...
public class HwMnoteInterfaceImpl implements IHwMnoteInterface {
    ...
    public void readHwMnote(byte[] mnote) throws IOException {
        ...
        try {
            ...
            stringBuilder.append("Invalid HwMnote format : ");
    ...
    private void initTagInfo() {
        ...
        this.mHwMnoteTagInfo.put(HwMnoteInterfaceUtils.HW_MNOTE_TAG_FACE_COUNT, 1 | (StubController.PERMISSION_CALLLOG_DELETE | faceFlags));
        ...
        this.mHwMnoteTagInfo.put(HwMnoteInterfaceUtils.HW_MNOTE_TAG_FACE_MOUTH_CENTER, 458752 | faceFlags);
    }
