...
public interface MediaPlaylistAgentProvider {
    ...
    void registerPlaylistEventCallback_impl(Executor executor, PlaylistEventCallback playlistEventCallback);
    ...
    void unregisterPlaylistEventCallback_impl(PlaylistEventCallback playlistEventCallback);
