...
public interface MediaSession2Provider extends TransportControlProvider {
    ...
    public interface BuilderBaseProvider<T extends MediaSession2, C extends SessionCallback> {
        T build_impl();
    ...
    public interface CommandButtonProvider {
        ...
        public interface BuilderProvider {
            ...
            Builder setCommand_impl(SessionCommand2 sessionCommand2);

            Builder setDisplayName_impl(String str);

            Builder setEnabled_impl(boolean z);

            Builder setExtras_impl(Bundle bundle);

            Builder setIconResId_impl(int i);
        }
    ...
    void sendCustomCommand_impl(ControllerInfo controllerInfo, SessionCommand2 sessionCommand2, Bundle bundle, ResultReceiver resultReceiver);

    void sendCustomCommand_impl(SessionCommand2 sessionCommand2, Bundle bundle);

    void setAllowedCommands_impl(ControllerInfo controllerInfo, SessionCommandGroup2 sessionCommandGroup2);

    void setAudioFocusRequest_impl(AudioFocusRequest audioFocusRequest);

    void setCustomLayout_impl(ControllerInfo controllerInfo, List<CommandButton> list);

    void setOnDataSourceMissingHelper_impl(OnDataSourceMissingHelper onDataSourceMissingHelper);
