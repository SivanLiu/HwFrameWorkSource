    ...
    public SubtitleTrack getDefaultTrack() {
        ...
        synchronized (this.mTracks) {
            ...
            while (it.hasNext()) {
                ...
                boolean forced = format.getInteger(MediaFormat.KEY_IS_FORCED_SUBTITLE, 0) != 0 ? languageMatches : false;
                boolean autoselect = format.getInteger(MediaFormat.KEY_IS_AUTOSELECT, languageMatches) != 0 ? languageMatches : false;
                boolean is_default = format.getInteger(MediaFormat.KEY_IS_DEFAULT, 0) != 0 ? languageMatches : false;
