...
public class TunerSyncInfo implements Parcelable {
    public static final Creator<TunerSyncInfo> CREATOR = new Creator<TunerSyncInfo>() {
        public TunerSyncInfo createFromParcel(Parcel source) {
            return new TunerSyncInfo(source, null);
        }
    ...
    /* synthetic */ TunerSyncInfo(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
