...
public class TunerDataTsif implements Parcelable {
    ...
    /* synthetic */ TunerDataTsif(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
    ...
    public String toString() {
        ...
        stringBuilder.append("[mAesMode : ");
        stringBuilder.append(this.mAesMode);
        sBuilder.append(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append(",mDwind0 : ");
        stringBuilder.append(this.mDwind0);
        sBuilder.append(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append(",mDwind1 : ");
        stringBuilder.append(this.mDwind1);
        sBuilder.append(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append(",mDwind2 : ");
        stringBuilder.append(this.mDwind2);
        sBuilder.append(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append(",mSpiCalibrationFlag : ");
        stringBuilder.append(this.mSpiCalibrationFlag);
        sBuilder.append(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append(",mSpiTsBitPerWord : ");
        stringBuilder.append(this.mSpiTsBitPerWord);
        sBuilder.append(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append(",mThl0 : ");
        stringBuilder.append(this.mThl0);
        sBuilder.append(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append(",mThl1 : ");
        stringBuilder.append(this.mThl1);
        sBuilder.append(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append(",mThl2 : ");
        stringBuilder.append(this.mThl2);
        sBuilder.append(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append(",mTsPktType : ");
        stringBuilder.append(this.mTsPktType);
