...
public class TunerTuneState implements Parcelable {
    ...
    /* synthetic */ TunerTuneState(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
    ...
    private TunerTuneState(Parcel in) {
        ...
        this.mCs_Mgerr = in.readByte() == (byte) 1;
        this.mCs_Dmderr = in.readByte() == (byte) 1;
        this.mCs_Ofdmerr = in.readByte() == (byte) 1;
        this.mCs_Frmlck = in.readByte() == (byte) 1;
        this.mCs_Tuned = in.readByte() == (byte) 1;
        this.mCs_Timeout = in.readByte() == (byte) 1;
        this.mCs_Fatal = in.readByte() == (byte) 1;
        this.mTs_Sync = in.readByte() == (byte) 1;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        dest.writeByte((byte) this.mCs_Dmderr);
        dest.writeByte((byte) this.mCs_Mgerr);
        dest.writeByte((byte) this.mCs_Fatal);
        dest.writeByte((byte) this.mCs_Frmlck);
        dest.writeByte((byte) this.mCs_Ofdmerr);
        dest.writeByte((byte) this.mCs_Sseqerr);
        dest.writeByte((byte) this.mCs_Timeout);
        dest.writeByte((byte) this.mCs_Tuned);
        dest.writeByte((byte) this.mTs_Sync);
        dest.writeByte((byte) this.mTs_Tuned);
