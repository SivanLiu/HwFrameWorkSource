...
public final class SoundTriggerManager {
    ...
    public int startRecognition(UUID soundModelId, Bundle params, ComponentName detectionService, RecognitionConfig config) {
    ...
    public int getDetectionServiceOperationsTimeout() {
        try {
            return Global.getInt(this.mContext.getContentResolver(), "sound_trigger_detection_service_op_timeout");
