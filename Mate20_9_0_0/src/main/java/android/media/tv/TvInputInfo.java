...
public final class TvInputInfo implements Parcelable {
    ...
    public static final class Builder {
        ...
        public TvInputInfo build() {
            ...
            return new TvInputInfo(resolveInfo, id, type, isHardwareInput, charSequence, i2, icon, icon2, icon3, str, booleanValue, i, this.mHdmiDeviceInfo, isConnectedToHdmiSwitch, this.mParentId, this.mExtras, null);
        }
        ...
        /* JADX WARNING: Removed duplicated region for block: B:45:0x00cd A:{ExcHandler: IOException | XmlPullParserException (r2_3 'e' java.lang.Exception), Splitter:B:1:0x000a} */
     ...
     */
        /* JADX WARNING: Missing block: B:45:0x00cd, code skipped:
            r2 = move-exception;
     */
        /* JADX WARNING: Missing block: B:46:0x00ce, code skipped:
            r4 = new java.lang.StringBuilder();
            r4.append("Failed reading meta-data for ");
            r4.append(r0.packageName);
     */
        ...
        private void parseServiceMetadata(int inputType) {
            ...
            try {
                ...
                if (parser != null) {
                    ...
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("Meta-data does not start with tv-input tag for ");
                    stringBuilder.append(si.name);
                    throw new IllegalStateException(stringBuilder.toString());
                }
                StringBuilder stringBuilder2 = new StringBuilder();
                stringBuilder2.append("No android.media.tv.input meta-data found for ");
                stringBuilder2.append(si.name);
                throw new IllegalStateException(stringBuilder2.toString());
            } catch (IOException | XmlPullParserException e) {
            } catch (NameNotFoundException e2) {
                StringBuilder stringBuilder3 = new StringBuilder();
                stringBuilder3.append("No resources found for ");
                stringBuilder3.append(si.packageName);
                throw new IllegalStateException(stringBuilder3.toString(), e2);
            } catch (Throwable th) {
                if (parser != null) {
                    if (r3 != null) {
                        parser.close();
    ...
    /* synthetic */ TvInputInfo(ResolveInfo x0, String x1, int x2, boolean x3, CharSequence x4, int x5, Icon x6, Icon x7, Icon x8, String x9, boolean x10, int x11, HdmiDeviceInfo x12, boolean x13, String x14, Bundle x15, AnonymousClass1 x16) {
