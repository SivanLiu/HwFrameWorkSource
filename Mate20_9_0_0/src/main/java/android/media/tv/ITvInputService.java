            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 3:
                        ...
                        createSession(_arg0, android.media.tv.ITvInputSessionCallback.Stub.asInterface(data.readStrongBinder()), data.readString());
                        return true;
                    case 4:
                        data.enforceInterface(descriptor);
                    ...
                    case 5:
                        data.enforceInterface(descriptor);
                        if (data.readInt() != 0) {
                            _arg02 = (TvInputHardwareInfo) TvInputHardwareInfo.CREATOR.createFromParcel(data);
                        }
                    ...
                    case 6:
                        ...
                        notifyHardwareRemoved(_arg02);
                        return true;
                    case 7:
                        data.enforceInterface(descriptor);
                        if (data.readInt() != 0) {
                            _arg03 = (HdmiDeviceInfo) HdmiDeviceInfo.CREATOR.createFromParcel(data);
                        }
                        notifyHdmiDeviceAdded(_arg03);
                        return true;
                    case 8:
                        data.enforceInterface(descriptor);
                        if (data.readInt() != 0) {
                        ...
                        notifyHdmiDeviceRemoved(_arg03);
                        return true;
                    default:
