        ...
        public final void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    String inputId2 = args.arg3;
                    args.recycle();
                    Session sessionImpl = TvInputService.this.onCreateSession(inputId2);
                    if (sessionImpl == null) {
                        try {
                ...
                case 3:
                    ...
                    String inputId3 = args.arg2;
                    args.recycle();
                    RecordingSession recordingSessionImpl = TvInputService.this.onCreateRecordingSession(inputId3);
                ...
                case 4:
                    ...
                    return;
                case 5:
                    inputId = TvInputService.this.onHardwareRemoved(msg.obj);
                    if (inputId != null) {
                ...
                case 6:
                    ...
                    return;
                case 7:
                    inputId = TvInputService.this.onHdmiDeviceRemoved(msg.obj);
                    if (inputId != null) {
                        broadcastRemoveHardwareInput(inputId);
                    }
                    return;
    ...
    public static abstract class Session implements Callback {
        ...
        int dispatchInputEvent(InputEvent event, InputEventReceiver receiver) {
            ...
            if (event instanceof KeyEvent) {
                ...
                boolean z = KeyEvent.isMediaKey(keyEvent.getKeyCode()) || keyEvent.getKeyCode() == 222;
