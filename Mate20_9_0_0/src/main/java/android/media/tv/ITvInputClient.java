            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    case 1:
                        ...
                        if (data.readInt() != 0) {
                            _arg1 = (InputChannel) InputChannel.CREATOR.createFromParcel(parcel);
                        }
                        onSessionCreated(_arg0, _arg12, _arg1, data.readInt());
                        return true;
                    case 2:
                        parcel.enforceInterface(descriptor);
                    ...
                    case 3:
                        ...
                        onSessionEvent(_arg0, _arg13, data.readInt());
                        return true;
                    case 4:
                        parcel.enforceInterface(descriptor);
                        if (data.readInt() != 0) {
