            ...
            synchronized (this.mMetadataLock) {
                ...
                if (type == 0) {
                    if (trackId != null) {
                        try {
                            if (!containsTrack(this.mAudioTracks, trackId)) {
                                str = TvInputManager.TAG;
                                stringBuilder = new StringBuilder();
                                stringBuilder.append("Invalid audio trackId: ");
                    ...
                    if (!(trackId == null || containsTrack(this.mVideoTracks, trackId))) {
                        str = TvInputManager.TAG;
                        stringBuilder = new StringBuilder();
                        stringBuilder.append("Invalid video trackId: ");
                        stringBuilder.append(trackId);
                        Log.w(str, stringBuilder.toString());
                    }
                } else if (type != 2) {
                    ...
                    str = TvInputManager.TAG;
                    stringBuilder = new StringBuilder();
                    stringBuilder.append("Invalid subtitle trackId: ");
                    stringBuilder.append(trackId);
                    Log.w(str, stringBuilder.toString());
                }
            }
            ...
            public void onSessionCreated(String inputId, IBinder token, InputChannel channel, int seq) {
                ...
                synchronized (TvInputManager.this.mSessionCallbackRecordMap) {
                    ...
                    try {
                        ...
                        if (iBinder != null) {
                            session = new Session(iBinder, channel, TvInputManager.this.mService, TvInputManager.this.mUserId, i, TvInputManager.this.mSessionCallbackRecordMap, null);
                        }
