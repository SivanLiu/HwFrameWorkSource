...
public final class TvTrackInfo implements Parcelable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(TextUtils.equals(this.mId, obj.mId) && this.mType == obj.mType && TextUtils.equals(this.mLanguage, obj.mLanguage) && TextUtils.equals(this.mDescription, obj.mDescription) && Objects.equals(this.mExtra, obj.mExtra) && (!this.mType != 0 ? this.mAudioChannelCount == obj.mAudioChannelCount && this.mAudioSampleRate == obj.mAudioSampleRate : this.mType != 1 || (this.mVideoWidth == obj.mVideoWidth && this.mVideoHeight == obj.mVideoHeight && this.mVideoFrameRate == obj.mVideoFrameRate && this.mVideoPixelAspectRatio == obj.mVideoPixelAspectRatio)))) {
            z = false;
        }
        return z;
    }
