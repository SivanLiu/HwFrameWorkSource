...
public final class RecommendationInfo implements Parcelable {
    ...
    /* synthetic */ RecommendationInfo(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
    ...
    private RecommendationInfo(Parcel parcel) {
        this(parcel.readCharSequence(), parcel.readCharSequence(), readDiscoveredPrinters(parcel), parcel.readByte() != (byte) 0);
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte((byte) this.mRecommendsMultiVendorService);
    }
}
