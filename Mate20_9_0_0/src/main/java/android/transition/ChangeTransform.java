...
public class ChangeTransform extends Transition {
    ...
    private static class GhostListener extends TransitionListenerAdapter {
        ...
        public void onTransitionEnd(Transition transition) {
            ...
            this.mView.setTagInternal(16909460, null);
            this.mView.setTagInternal(16909179, null);
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        if (view.getVisibility() != 8) {
            ...
            if (this.mReparent) {
                ...
                transitionValues.values.put(PROPNAME_INTERMEDIATE_MATRIX, view.getTag(16909460));
                transitionValues.values.put(PROPNAME_INTERMEDIATE_PARENT_MATRIX, view.getTag(16909179));
            }
        }
    }
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues startValues, TransitionValues endValues, boolean handleParentChange) {
        ...
        final PathAnimatorMatrix path2 = pathAnimatorMatrix;
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (!this.mIsCanceled) {
                    if (z && ChangeTransform.this.mUseOverlay) {
                        ...
                        view2.setTagInternal(16909460, null);
                        view2.setTagInternal(16909179, null);
                    }
                }
            ...
            public void onAnimationPause(Animator animation) {
                setCurrentMatrix(path2.getMatrix());
            }
            ...
            private void setCurrentMatrix(Matrix currentMatrix) {
                ...
                view2.setTagInternal(16909460, this.mTempMatrix);
                transforms2.restore(view2);
            }
        };
    ...
    private void setMatricesForParent(TransitionValues startValues, TransitionValues endValues) {
        ...
        endValues.view.setTagInternal(16909179, endParentMatrix);
