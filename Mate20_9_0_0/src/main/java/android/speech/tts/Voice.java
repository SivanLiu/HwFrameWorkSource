...
public class Voice implements Parcelable {
    ...
    public int hashCode() {
        int i = 0;
        int hashCode = 31 * ((31 * ((31 * ((31 * 1) + (this.mFeatures == null ? 0 : this.mFeatures.hashCode()))) + this.mLatency)) + (this.mLocale == null ? 0 : this.mLocale.hashCode()));
        if (this.mName != null) {
            i = this.mName.hashCode();
        }
        return (31 * ((31 * (hashCode + i)) + this.mQuality)) + (this.mRequiresNetworkConnection ? 1231 : 1237);
    }
