...
public abstract class Uri implements Parcelable, Comparable<Uri> {
    ...
    public static final class Builder {
        ...
        public Builder appendQueryParameter(String key, String value) {
            this.opaquePart = null;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append(Uri.encode(key, null));
            stringBuilder.append("=");
            stringBuilder.append(Uri.encode(value, null));
            String encodedParameter = stringBuilder.toString();
            if (this.query == null) {
            ...
            if (oldQuery == null || oldQuery.length() == 0) {
                ...
                stringBuilder2.append(oldQuery);
                stringBuilder2.append("&");
                stringBuilder2.append(encodedParameter);
                this.query = Part.fromEncoded(stringBuilder2.toString());
            }
            return this;
        }
    ...
    static class Part extends AbstractPart {
        ...
        /* synthetic */ Part(String x0, String x1, AnonymousClass1 x2) {
            this(x0, x1);
        }
    ...
    static class PathPart extends AbstractPart {
        ...
        PathSegments getPathSegments() {
            ...
            int previous = 0;
            while (true) {
                int indexOf = path.indexOf(47, previous);
                int current = indexOf;
                if (indexOf <= -1) {
                    break;
                }
        ...
        static PathPart appendEncodedSegment(PathPart oldPart, String newSegment) {
            if (oldPart == null) {
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("/");
                stringBuilder.append(newSegment);
            ...
            if (oldPathLength == 0) {
                ...
                stringBuilder2.append(newSegment);
                newPath = stringBuilder2.toString();
            } else {
                stringBuilder2 = new StringBuilder();
                stringBuilder2.append(oldPath);
                stringBuilder2.append("/");
        ...
        static PathPart readFrom(Parcel parcel) {
            ...
            switch (representation) {
                ...
                default:
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("Bad representation: ");
                    stringBuilder.append(representation);
                    throw new IllegalArgumentException(stringBuilder.toString());
            }
        }
        ...
        static PathPart makeAbsolute(PathPart oldPart) {
            ...
            if (encodedCached) {
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("/");
                stringBuilder.append(oldPart.encoded);
                newEncoded = stringBuilder.toString();
            } else {
            ...
            if (decodedCached) {
                StringBuilder stringBuilder2 = new StringBuilder();
                stringBuilder2.append("/");
                stringBuilder2.append(oldPart.decoded);
                newDecoded = stringBuilder2.toString();
            } else {
    ...
    private static abstract class AbstractHierarchicalUri extends Uri {
        ...
        /* synthetic */ AbstractHierarchicalUri(AnonymousClass1 x0) {
            this();
        }
    ...
    private static class OpaqueUri extends Uri {
        ...
        /* synthetic */ OpaqueUri(String x0, Part x1, Part x2, AnonymousClass1 x3) {
            this(x0, x1, x2);
        }
    ...
    private static class HierarchicalUri extends AbstractHierarchicalUri {
        ...
        /* synthetic */ HierarchicalUri(String x0, Part x1, PathPart x2, Part x3, Part x4, AnonymousClass1 x5) {
            this(x0, x1, x2, x3, x4);
        }
    ...
    private static class StringUri extends AbstractHierarchicalUri {
        ...
        /* synthetic */ StringUri(String x0, AnonymousClass1 x1) {
            this(x0);
        }
        ...
        static String parsePath(String uriString, int ssi) {
            ...
            if (length > ssi + 2 && uriString.charAt(ssi + 1) == '/' && uriString.charAt(ssi + 2) == '/') {
                ...
                while (pathStart < length) {
                    charAt = uriString.charAt(pathStart);
                    if (charAt != '#') {
                        if (charAt == '/') {
                            break;
                        } else if (charAt != '?') {
            ...
            while (pathEnd < length) {
                charAt = uriString.charAt(pathEnd);
                if (charAt == '#' || charAt == '?') {
                    break;
                }
                pathEnd++;
    ...
    /* synthetic */ Uri(AnonymousClass1 x0) {
        this();
    }
    ...
    public String toSafeString() {
        ...
        if (scheme != null) {
            ...
            if (scheme.equalsIgnoreCase("tel") || scheme.equalsIgnoreCase(Context.SIP_SERVICE) || scheme.equalsIgnoreCase("sms") || scheme.equalsIgnoreCase("smsto") || scheme.equalsIgnoreCase("mailto") || scheme.equalsIgnoreCase(Context.NFC_SERVICE) || scheme.equalsIgnoreCase("geo")) {
                ...
                builder.append("//");
                builder.append(getHost() != null ? getHost() : "");
                if (getPort() != -1) {
                    StringBuilder stringBuilder2 = new StringBuilder();
                    stringBuilder2.append(":");
    ...
    public boolean getBooleanQueryParameter(String key, boolean defaultValue) {
        ...
        boolean z = ("false".equals(flag) || "0".equals(flag)) ? false : true;
        return z;
    }
