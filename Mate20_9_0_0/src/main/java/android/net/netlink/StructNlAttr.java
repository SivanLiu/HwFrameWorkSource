...
public class StructNlAttr {
    ...
    public String toString() {
        ...
        stringBuilder.append("StructNlAttr{ nla_len{");
        stringBuilder.append(this.nla_len);
        stringBuilder.append("}, nla_type{");
        stringBuilder.append(this.nla_type);
        stringBuilder.append("}, nla_value{");
        stringBuilder.append(NetlinkConstants.hexify(this.nla_value));
