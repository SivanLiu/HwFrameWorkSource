...
public class StructNlMsgErr {
    ...
    public String toString() {
        ...
        stringBuilder.append("StructNlMsgErr{ error{");
        stringBuilder.append(this.error);
        stringBuilder.append("}, msg{");
        stringBuilder.append(this.msg == null ? BackupManagerConstants.DEFAULT_BACKUP_FINISHED_NOTIFICATION_RECEIVERS : this.msg.toString());
