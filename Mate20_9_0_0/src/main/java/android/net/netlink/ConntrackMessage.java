...
public class ConntrackMessage extends NetlinkMessage {
    ...
    public static byte[] newIPv4TimeoutUpdateRequest(int proto, Inet4Address src, int sport, Inet4Address dst, int dport, int timeoutSec) {
        r2 = new StructNlAttr[2];
        r2[0] = new StructNlAttr((short) 1, new StructNlAttr((short) 1, (InetAddress) src), new StructNlAttr((short) 2, (InetAddress) dst));
        r2[1] = new StructNlAttr((short) 2, new StructNlAttr((short) 1, (byte) proto), new StructNlAttr((short) 2, (short) sport, ByteOrder.BIG_ENDIAN), new StructNlAttr((short) 3, (short) dport, ByteOrder.BIG_ENDIAN));
        StructNlAttr ctaTupleOrig = new StructNlAttr((short) 1, r2);
        StructNlAttr ctaTimeout = new StructNlAttr((short) 7, timeoutSec, ByteOrder.BIG_ENDIAN);
        byte[] bytes = new byte[(20 + (ctaTupleOrig.getAlignedLength() + ctaTimeout.getAlignedLength()))];
