...
public class WifiEnterpriseConfig implements Parcelable {
    ...
    public boolean saveToSupplicant(SupplicantSaver saver) {
        ...
        if (this.mEapMethod != 1 && this.mPhase2Method != 0) {
            ...
            return saver.saveValue(PHASE2_KEY, convertToQuotedString(stringBuilder.toString()));
        ...
        if (isSubIdValid(subId)) {
            switch (this.mEapMethod) {
                ...
                case 6:
                    ...
                    String str = TAG;
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("setEapSubId: Eap Method is ");
                    stringBuilder.append(this.mEapMethod);
                    stringBuilder.append(", subId is ");
