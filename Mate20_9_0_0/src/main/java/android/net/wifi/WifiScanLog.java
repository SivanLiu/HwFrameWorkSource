...
public class WifiScanLog {
    ...
    /* synthetic */ WifiScanLog(AnonymousClass1 x0) {
        this();
    }
    ...
    /* JADX WARNING: Missing block: B:27:0x00e2, code skipped:
            return;
     */
    ...
    private synchronized void addEvent(String scanKey, String eventKey, Object... params) {
        if (HWFLOW) {
            ...
            if (DBG.booleanValue()) {
                ...
                stringBuilder.append(scanKey);
                stringBuilder.append(eventLog.toString());
                Log.i("WifiScanLogDBG", stringBuilder.toString());
            }
        }
    }
