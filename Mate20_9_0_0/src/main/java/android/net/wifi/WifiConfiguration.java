...
public class WifiConfiguration implements Parcelable {
    ...
    public static class KeyMgmt {
        ...
        public static final String[] strings = new String[]{KeyProperties.DIGEST_NONE, "WPA_PSK", "WPA_EAP", "IEEE8021X", "WPA2_PSK", "OSEN", "FT_PSK", "FT_EAP", "WAPI_PSK", "WAPI_CERT", "QUALCOMM_WAPI_PSK", "QUALCOMM_WAPI_CERT"};
    ...
    public static class PairwiseCipher {
        ...
        public static final String[] strings = new String[]{KeyProperties.DIGEST_NONE, "TKIP", "CCMP", "SMS4"};
    ...
    public static boolean isValidMacAddressForRandomization(MacAddress mac) {
        return (mac == null || mac.isMulticastAddress() || !mac.isLocallyAssigned() || MacAddress.fromString(WifiInfo.DEFAULT_MAC_ADDRESS).equals(mac)) ? false : true;
    }
    ...
    public void defendSsid() {
        if (!isSsidValid()) {
            ...
            stringBuilder.append("\"");
            this.SSID = stringBuilder.toString();
        }
    }
    ...
    public String toString() {
        ...
        stringBuilder2.append(this.mNetworkSelectionStatus.getNetworkStatusString());
        ...
        if (this.mNetworkSelectionStatus.getNetworkSelectionDisableReason() > 0) {
            ...
            stringBuilder2.append(this.mNetworkSelectionStatus.getNetworkDisableReasonString());
            stringBuilder2.append("\n");
            sbuf.append(stringBuilder2.toString());
            if (this.mNetworkSelectionStatus.getNetworkSelectionDisableName() != null) {
                stringBuilder2 = new StringBuilder();
                stringBuilder2.append(" networkSelectionDisableName ");
                stringBuilder2.append(this.mNetworkSelectionStatus.getNetworkSelectionDisableName());
                stringBuilder2.append("\n");
                sbuf.append(stringBuilder2.toString());
            }
            ...
            while (true) {
                ...
                if (this.mNetworkSelectionStatus.getDisableReasonCounter(index) != 0) {
                    ...
                    stringBuilder.append(NetworkSelectionStatus.getNetworkDisableReasonString(index));
                    stringBuilder.append(" counter:");
                    stringBuilder.append(this.mNetworkSelectionStatus.getDisableReasonCounter(index));
                    stringBuilder.append("\n");
        ...
        sbuf.append(" KeyMgmt:");
        for (index = 0; index < this.allowedKeyManagement.size(); index++) {
        ...
        while (true) {
            index = gc;
            if (index >= this.allowedGroupCiphers.size()) {
                break;
            }
        ...
        if (this.mNetworkSelectionStatus.getNetworkSelectionBSSID() != null) {
            stringBuilder2 = new StringBuilder();
            stringBuilder2.append(" networkSelectionBSSID=");
            stringBuilder2.append(this.mNetworkSelectionStatus.getNetworkSelectionBSSID());
            sbuf.append(stringBuilder2.toString());
        }
    ...
    public String getKeyIdForCredentials(WifiConfiguration current) {
        ...
        try {
            ...
            stringBuilder.append(trimStringForKeyId(wifiEnterpriseConfig2.getKeyId(wifiEnterpriseConfig)));
    ...
    public String configKey(boolean allowCached) {
        ...
        if (this.providerFriendlyName != null) {
            ...
            stringBuilder2.append("-");
            stringBuilder2.append(Integer.toString(UserHandle.getUserId(this.creatorUid)));
            return stringBuilder2.toString();
        }
        if (this.allowedKeyManagement.get(1)) {
            stringBuilder = new StringBuilder();
            stringBuilder.append(this.SSID);
            stringBuilder.append(KeyMgmt.strings[1]);
            key = stringBuilder.toString();
            ...
            stringBuilder = new StringBuilder();
            stringBuilder.append(this.SSID);
            stringBuilder.append(KeyMgmt.strings[11]);
            key = stringBuilder.toString();
        } else if (this.allowedKeyManagement.get(6)) {
            stringBuilder = new StringBuilder();
            stringBuilder.append(this.SSID);
            stringBuilder.append(KeyMgmt.strings[6]);
            key = stringBuilder.toString();
        } else if (this.allowedKeyManagement.get(7)) {
            stringBuilder = new StringBuilder();
            stringBuilder.append(this.SSID);
            stringBuilder.append(KeyMgmt.strings[7]);
            key = stringBuilder.toString();
        } else {
            stringBuilder = new StringBuilder();
            stringBuilder.append(this.SSID);
    ...
    public IpAssignment getIpAssignment() {
        ...
        if (DBG) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Get IpAssignment (nid: ");
            stringBuilder.append(this.networkId);
            stringBuilder.append(", SSID: ");
            stringBuilder.append(this.SSID);
            stringBuilder.append(") IpAssignment: ");
            stringBuilder.append(this.mIpConfiguration.ipAssignment.toString());
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.wifiProNoHandoverNetwork);
        dest.writeInt(this.wifiProNoInternetAccess);
        ...
        dest.writeInt(this.isTempCreated);
        dest.writeInt(this.isPortalConnect);
