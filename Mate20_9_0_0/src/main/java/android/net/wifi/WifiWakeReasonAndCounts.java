...
public class WifiWakeReasonAndCounts implements Parcelable {
    ...
    public String toString() {
        ...
        int i = 0;
        for (int i2 = 0; i2 < this.cmdEventWakeCntArray.length; i2++) {
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append(" cmdEventWakeCntArray[");
            stringBuilder.append(i2);
            stringBuilder.append("] ");
            stringBuilder.append(this.cmdEventWakeCntArray[i2]);
            sb.append(stringBuilder.toString());
        }
        while (i < this.driverFWLocalWakeCntArray.length) {
            StringBuilder stringBuilder2 = new StringBuilder();
            stringBuilder2.append(" driverFWLocalWakeCntArray[");
            stringBuilder2.append(i);
            stringBuilder2.append("] ");
            stringBuilder2.append(this.driverFWLocalWakeCntArray[i]);
