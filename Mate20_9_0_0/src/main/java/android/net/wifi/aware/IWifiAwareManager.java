            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    ...
                    case 3:
                        ...
                        IWifiAwareEventCallback _arg24 = android.net.wifi.aware.IWifiAwareEventCallback.Stub.asInterface(data.readStrongBinder());
                        if (data.readInt() != 0) {
                            _arg2 = (ConfigRequest) ConfigRequest.CREATOR.createFromParcel(parcel);
                        }
                        connect(_arg03, _arg12, _arg24, _arg2, data.readInt() != 0);
                        reply.writeNoException();
                        return true;
                    case 4:
                        parcel.enforceInterface(descriptor);
                    ...
                    case 5:
                        ...
                        _arg1 = data.readInt();
                        if (data.readInt() != 0) {
                            _arg22 = (PublishConfig) PublishConfig.CREATOR.createFromParcel(parcel);
                        }
                        publish(_arg0, _arg1, _arg22, android.net.wifi.aware.IWifiAwareDiscoverySessionCallback.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case 6:
                        parcel.enforceInterface(descriptor);
                        ...
                        _arg1 = data.readInt();
                        if (data.readInt() != 0) {
                            _arg23 = (SubscribeConfig) SubscribeConfig.CREATOR.createFromParcel(parcel);
                        }
                        subscribe(_arg0, _arg1, _arg23, android.net.wifi.aware.IWifiAwareDiscoverySessionCallback.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case 7:
                        parcel.enforceInterface(descriptor);
                        ...
                        updatePublish(_arg02, _arg1, _arg22);
                        reply.writeNoException();
                        return true;
                    case 8:
                        parcel.enforceInterface(descriptor);
                        ...
                        updateSubscribe(_arg02, _arg1, _arg23);
                        reply.writeNoException();
                        return true;
                    case 9:
                        parcel.enforceInterface(descriptor);
