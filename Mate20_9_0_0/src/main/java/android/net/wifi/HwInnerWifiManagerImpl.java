...
public class HwInnerWifiManagerImpl implements HwInnerWifiManager {
    ...
    public int calculateSignalLevelHW(int freq, int rssi) {
        ...
        if (TextUtils.isEmpty(this.wifi_level_threshold)) {
            ...
            strArr = this.wifi_level_threshold.split(",");
            if (strArr.length == 4) {
                try {
                    rssi_Level_4 = Integer.parseInt(strArr[0]);
                    rssi_Level_3 = Integer.parseInt(strArr[1]);
                    rssi_Level_2 = Integer.parseInt(strArr[2]);
                    rssi_Level_1 = Integer.parseInt(strArr[3]);
                } catch (Exception e) {
                    String str = TAG;
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("Exception occured,use the default level threshold! wifi_level_threshold = ");
                    stringBuilder.append(this.wifi_level_threshold);
                ...
                String str2 = TAG;
                StringBuilder stringBuilder2 = new StringBuilder();
                stringBuilder2.append("Customization of wifi level is illeagel! wifi_level_threshold =");
                stringBuilder2.append(this.wifi_level_threshold);
    ...
    public boolean getHwMeteredHint(Context context) {
        ...
        str = TAG;
        StringBuilder stringBuilder2 = new StringBuilder();
        stringBuilder2.append("isPhoneAP = ");
        stringBuilder2.append(isPhoneAP);
        Log.d(str, stringBuilder2.toString());
        return isPhoneAP;
    }
    ...
    public List<String> getApLinkedStaList() {
        ...
        if (b != null) {
            try {
                ...
                _reply.readException();
                ArrayList createStringArrayList = _reply.createStringArrayList();
                _reply.recycle();
                _data.recycle();
    ...
    public void setSoftapMacFilter(String macFilter) {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setSoftapMacFilter macFilter = ");
    ...
    public void setSoftapDisassociateSta(String mac) {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setSoftapDisassociateSta mac = ");
    ...
    public boolean setVoWifiDetectMode(WifiDetectConfInfo info) {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setVoWifiDetectMode info :");
    ...
    public boolean setVoWifiDetectPeriod(int period) {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setVoWifiDetectPeriod period :");
    ...
    public boolean requestWifiEnable(boolean flag, String reason) {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("requestWifiEnable flag : ");
    ...
    public boolean setWifiTxPower(int power) {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setWifiTxPower power :");
    ...
    public boolean startHwQoEMonitor(int monitorType, int period, IHwQoECallback callback) {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("startHwQoEMonitor period :");
        stringBuilder.append(period);
        Log.d(str, stringBuilder.toString());
        int _result = 0;
        try {
    ...
    public void extendWifiScanPeriodForP2p(Context context, boolean bExtend, int iTimes) {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("extendWifiScanPeriodForP2p flag : ");
