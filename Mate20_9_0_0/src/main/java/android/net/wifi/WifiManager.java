...
public class WifiManager {
                ...
                public void handleMessage(Message msg) {
                    ...
                    switch (msg.what) {
                        ...
                        case 2:
                            ...
                            String str2 = WifiManager.TAG;
                            StringBuilder stringBuilder2 = new StringBuilder();
                            stringBuilder2.append("LocalOnlyHotspotCallbackProxy: failed to start.  reason: ");
                            stringBuilder2.append(reasonCode);
                            Log.w(str2, stringBuilder2.toString());
                            callback.onFailed(reasonCode);
                            Log.w(WifiManager.TAG, "done with the callback...");
                            break;
                        default:
                            String str3 = WifiManager.TAG;
                    ...
                    if (i != 3) {
                        switch (i) {
                            ...
                            default:
                                String str2 = WifiManager.TAG;
                                StringBuilder stringBuilder2 = new StringBuilder();
                                stringBuilder2.append("LocalOnlyHotspotObserverProxy unhandled message.  type: ");
     ...
     */
        ...
        /* JADX WARNING: Removed duplicated region for block: B:30:0x0036 A:{SKIP} */
        /* JADX WARNING: Missing block: B:9:0x0012, code skipped:
            ...
            synchronized (this.mBinder) {
                if (this.mRefCounted) {
                    ...
                    if (this.mRefCount < 0) {
                        ...
                        StringBuilder stringBuilder = new StringBuilder();
                        stringBuilder.append("WifiLock under-locked ");
                        stringBuilder.append(this.mTag);
                        throw new RuntimeException(stringBuilder.toString());
                    }
                }
    ...
    private static class ProvisioningCallbackProxy extends Stub {
        ...
        public void onProvisioningStatus(int status) {
            this.mHandler.post(new -$$Lambda$WifiManager$ProvisioningCallbackProxy$0_NXiwyrbrT_579x-6QMO0y3rzc(this, status));
        }

        public void onProvisioningFailure(int status) {
            this.mHandler.post(new -$$Lambda$WifiManager$ProvisioningCallbackProxy$rgPeSRj_1qriYZtaCu57EZHtc_Q(this, status));
        }
    }
    ...
    public void connect(WifiConfiguration config, ActionListener listener) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("connect, pid:");
    ...
    public void forget(int netId, ActionListener listener) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("forget, pid:");
        stringBuilder.append(Process.myPid());
        stringBuilder.append(", tid:");
        stringBuilder.append(Process.myTid());
        stringBuilder.append(", uid:");
    ...
    public void disable(int netId, ActionListener listener) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("disable, pid:");
        stringBuilder.append(Process.myPid());
        stringBuilder.append(", tid:");
        stringBuilder.append(Process.myTid());
        stringBuilder.append(", uid:");
    ...
    public void startWps(WpsInfo config, WpsCallback listener) {
        if (HWFLOW) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("startWps, pid:");
            stringBuilder.append(Process.myPid());
            stringBuilder.append(", tid:");
            stringBuilder.append(Process.myTid());
            stringBuilder.append(", uid:");
    ...
    public void cancelWps(WpsCallback listener) {
        if (HWFLOW) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("cancelWps, pid:");
            stringBuilder.append(Process.myPid());
            stringBuilder.append(", tid:");
            stringBuilder.append(Process.myTid());
            stringBuilder.append(", uid:");
