...
public final class Credential implements Parcelable {
    ...
    public boolean equals(Object thatObject) {
        ...
        if (!(TextUtils.equals(this.mRealm, that.mRealm) && this.mCreationTimeInMillis == that.mCreationTimeInMillis && this.mExpirationTimeInMillis == that.mExpirationTimeInMillis && this.mCheckAaaServerCertStatus == that.mCheckAaaServerCertStatus && (!this.mUserCredential != null ? that.mUserCredential != null : !this.mUserCredential.equals(that.mUserCredential)) && (!this.mCertCredential != null ? that.mCertCredential != null : !this.mCertCredential.equals(that.mCertCredential)) && (!this.mSimCredential != null ? that.mSimCredential != null : !this.mSimCredential.equals(that.mSimCredential)) && isX509CertificateEquals(this.mCaCertificate, that.mCaCertificate) && isX509CertificatesEquals(this.mClientCertificateChain, that.mClientCertificateChain) && isPrivateKeyEquals(this.mClientPrivateKey, that.mClientPrivateKey))) {
            z = false;
        }
        return z;
    }
    ...
    private static boolean isX509CertificateEquals(X509Certificate cert1, X509Certificate cert2) {
        ...
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Failed to equals result ");
            stringBuilder.append(e.getMessage());
            Log.d(str, stringBuilder.toString());
        }
        return result;
