...
public final class HomeSp implements Parcelable {
    ...
    public boolean equals(Object thatObject) {
        ...
        if (!(TextUtils.equals(this.mFqdn, that.mFqdn) && TextUtils.equals(this.mFriendlyName, that.mFriendlyName) && TextUtils.equals(this.mIconUrl, that.mIconUrl) && (!this.mHomeNetworkIds != null ? that.mHomeNetworkIds != null : !this.mHomeNetworkIds.equals(that.mHomeNetworkIds)) && Arrays.equals(this.mMatchAllOis, that.mMatchAllOis) && Arrays.equals(this.mMatchAnyOis, that.mMatchAnyOis) && Arrays.equals(this.mOtherHomePartners, that.mOtherHomePartners) && Arrays.equals(this.mRoamingConsortiumOis, that.mRoamingConsortiumOis))) {
            z = false;
        }
        return z;
    }
