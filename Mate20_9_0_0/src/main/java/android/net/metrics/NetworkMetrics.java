...
public class NetworkMetrics {
    ...
    public static class Summary {
        ...
        public String toString() {
            ...
            j.add(String.format("tcp avg_loss=%.1f%% total_sent=%d total_lost=%d", new Object[]{Double.valueOf(100.0d * this.tcpLossRate.average()), Integer.valueOf(this.tcpLossRate.count), Integer.valueOf((int) this.tcpLossRate.sum)}));
