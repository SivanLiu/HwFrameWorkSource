...
public final class NetworkCapabilities implements Parcelable {
    ...
    public Set<UidRange> getUids() {
        return this.mUids == null ? null : new ArraySet(this.mUids);
    }
    ...
    public boolean appliesToUid(int uid) {
        ...
        Iterator it = this.mUids.iterator();
        while (it.hasNext()) {
    ...
    public String toString() {
        ...
        if (this.mUids != null) {
            if (1 == this.mUids.size() && ((UidRange) this.mUids.valueAt(0)).count() == 1) {
                sb.append(" Uid: ");
    ...
    public void writeToProto(ProtoOutputStream proto, long fieldId) {
        ...
        while (i < length) {
            proto.write(NetworkCapabilitiesProto.CAPABILITIES, capabilities[i]);
            i++;
        }
