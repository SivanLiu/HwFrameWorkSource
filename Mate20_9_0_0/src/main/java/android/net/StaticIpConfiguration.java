...
public class StaticIpConfiguration implements Parcelable {
    ...
    public String toString() {
        ...
        if (this.ipAddress != null) {
            str.append(encryption_ipAddress);
            str.append(" ");
        }
        str.append("Gateway ");
        if (this.gateway != null) {
    ...
    public int hashCode() {
        int i = 0;
        int hashCode = 47 * ((47 * ((47 * 13) + (this.ipAddress == null ? 0 : this.ipAddress.hashCode()))) + (this.gateway == null ? 0 : this.gateway.hashCode()));
        if (this.domains != null) {
            i = this.domains.hashCode();
        }
        return (47 * (hashCode + i)) + this.dnsServers.hashCode();
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        Iterator it = this.dnsServers.iterator();
        while (it.hasNext()) {
            NetworkUtils.parcelInetAddress(dest, (InetAddress) it.next(), flags);
        }
