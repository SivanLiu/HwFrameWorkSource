...
public class HwNetworkPolicyManager extends NetworkPolicyManager {
    ...
    public void setHwUidPolicy(int uid, int policy) {
        ...
        try {
            ...
            stringBuilder.append("setHwUidPolicy uid = ");
            stringBuilder.append(uid);
            stringBuilder.append(" policy = ");
            stringBuilder.append(policy);
            stringBuilder.append(" opPackageName =  ");
            stringBuilder.append(this.mHwContext.getOpPackageName());
    ...
    public void addHwUidPolicy(int uid, int policy) {
        ...
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("addHwUidPolicy uid = ");
            stringBuilder.append(uid);
            stringBuilder.append(" policy = ");
            stringBuilder.append(policy);
            stringBuilder.append(" opPackageName = ");
    ...
    public void removeHwUidPolicy(int uid, int policy) {
        ...
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("removeHwUidPolicy uid = ");
            stringBuilder.append(uid);
            stringBuilder.append(" policy = ");
            stringBuilder.append(policy);
            stringBuilder.append(" opPackageName = ");
    ...
    public int getHwUidPolicy(int uid) {
        ...
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("getHwUidPolicy uid = ");
            stringBuilder.append(uid);
            stringBuilder.append(" policy = ");
            stringBuilder.append(policy);
            Slog.i(str, stringBuilder.toString());
    ...
    public int[] getHwUidsWithPolicy(int policy) {
        ...
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("getHwUidPolicy uids = ");
            stringBuilder.append(uids.toString());
            stringBuilder.append(" policy = ");
            stringBuilder.append(policy);
            Slog.i(str, stringBuilder.toString());
            if (data != null) {
    ...
    public void forceUpdatePolicy(boolean isRoaming) {
        Parcel data = Parcel.obtain();
        try {
            data.writeInt(isRoaming);
            this.mNetworkPolicyManagerService.transact(205, data, null, 0);
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("forceUpdatePolicy isRoaming = ");
