...
public abstract class CaptivePortalProbeSpec {
    ...
    private static class RegexMatchProbeSpec extends CaptivePortalProbeSpec {
        ...
        public CaptivePortalProbeResult getResult(int status, String locationHeader) {
            int returnCode = (CaptivePortalProbeSpec.safeMatch(String.valueOf(status), this.mStatusRegex) && CaptivePortalProbeSpec.safeMatch(locationHeader, this.mLocationHeaderRegex)) ? 204 : 302;
    ...
    public static CaptivePortalProbeSpec parseSpecOrNull(String spec) {
        if (spec != null) {
            try {
                ...
                stringBuilder.append("Invalid probe spec: ");
    ...
    private static boolean safeMatch(String value, Pattern pattern) {
