...
public final class Headers {
                    ...
                    case HASH_CACHE_CONTROL /*-208775662*/:
                        if (name.equals(CACHE_CONTROL)) {
                            if (this.mHeaders[IDX_CACHE_CONTROL] != null && this.mHeaders[IDX_CACHE_CONTROL].length() > 0) {
                                ...
                                stringBuilder.append(strArr[IDX_CACHE_CONTROL]);
                                stringBuilder.append(',');
                                stringBuilder.append(val);
                                strArr[IDX_CACHE_CONTROL] = stringBuilder.toString();
                                break;
                            }
    ...
    public void getHeaders(HeaderCallback hcb) {
        ...
        i = this.mExtraHeaderNames.size();
        while (i2 < i) {
            hcb.header((String) this.mExtraHeaderNames.get(i2), (String) this.mExtraHeaderValues.get(i2));
            i2++;
        }
    }
