...
public class RequestQueue implements RequestFeeder {
    ...
    class ActivePool implements ConnectionManager {
        ...
        public void stopTiming() {
            ...
            stringBuilder.append("Http thread used ");
            stringBuilder.append(totalTime);
            stringBuilder.append(" ms  for ");
            stringBuilder.append(this.mTotalRequest);
            stringBuilder.append(" requests and ");
            stringBuilder.append(this.mTotalConnection);
            stringBuilder.append(" new connections");
        ...
        void logState() {
            ...
            for (int i = 0; i < this.mConnectionCount; i++) {
                ...
                dump.append(stringBuilder.toString());
            }
    ...
    synchronized void dump() {
        ...
        if (!this.mPending.isEmpty()) {
            ...
            while (iter.hasNext()) {
                ...
                stringBuilder.append(" ");
                StringBuilder line = new StringBuilder(stringBuilder.toString());
                ListIterator reqIter = ((LinkedList) entry.getValue()).listIterator(null);
                while (iter.hasNext()) {
                    Request request = (Request) iter.next();
                    StringBuilder stringBuilder2 = new StringBuilder();
                    stringBuilder2.append(request);
                    stringBuilder2.append(" ");
                    line.append(stringBuilder2.toString());
                }
                dump.append(line);
                dump.append("\n");
                count = count2;
