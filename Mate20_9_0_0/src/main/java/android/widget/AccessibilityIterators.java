    ...
    static class LineTextSegmentIterator extends AbstractTextSegmentIterator {
        ...
        public int[] following(int offset) {
            ...
            if (offset < 0) {
                ...
                nextLine = this.mLayout.getLineForOffset(offset);
                if (getLineEdgeIndex(nextLine, -1) == offset) {
                } else {
                    nextLine++;
                }
            }
        ...
        public int[] preceding(int offset) {
            ...
            if (offset > this.mText.length()) {
                ...
                previousLine = this.mLayout.getLineForOffset(offset);
                if (getLineEdgeIndex(previousLine, 1) + 1 == offset) {
                } else {
                    previousLine--;
                }
            }
