...
class DatePickerCalendarDelegate extends AbstractDatePickerDelegate {
    ...
    private final OnClickListener mOnHeaderClickListener = new -$$Lambda$DatePickerCalendarDelegate$GuCiuXPsIV2EU6oKGRXrsGY-DHM(this);
    ...
    public DatePickerCalendarDelegate(DatePicker delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mContainer = (ViewGroup) ((LayoutInflater) this.mContext.getSystemService("layout_inflater")).inflate(a.getResourceId(19, 17367123), this.mDelegator, false);
        this.mContainer.setSaveFromParentEnabled(false);
        this.mDelegator.addView(this.mContainer);
        ViewGroup header = (ViewGroup) this.mContainer.findViewById(16908840);
        this.mHeaderYear = (TextView) header.findViewById(16908842);
        this.mHeaderYear.setOnClickListener(this.mOnHeaderClickListener);
        this.mHeaderMonthDay = (TextView) header.findViewById(16908841);
        ...
        a.recycle();
        this.mAnimator = (ViewAnimator) this.mContainer.findViewById(16908732);
        this.mDayPickerView = (DayPickerView) this.mAnimator.findViewById(16908839);
        ...
        this.mYearPickerView = (YearPickerView) this.mAnimator.findViewById(16908843);
        ...
        this.mSelectDay = res.getString(17041058);
        this.mSelectYear = res.getString(17041064);
    ...
    private void setCurrentView(int viewIndex) {
        switch (viewIndex) {
            ...
            case 1:
                this.mYearPickerView.setYear(this.mCurrentDate.get(1));
                this.mYearPickerView.post(new -$$Lambda$DatePickerCalendarDelegate$-6rynvAYPe1gU9xVgvSm4VMsr2M(this));
                if (this.mCurrentView != viewIndex) {
    ...
    public void init(int year, int month, int dayOfMonth, OnDateChangedListener callBack) {
