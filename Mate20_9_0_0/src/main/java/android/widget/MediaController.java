...
public class MediaController extends FrameLayout {
    ...
    private void initControllerView(View v) {
        ...
        this.mPauseButton = (ImageButton) v.findViewById(16909182);
        if (this.mPauseButton != null) {
            this.mPauseButton.requestFocus();
            this.mPauseButton.setOnClickListener(this.mPauseListener);
        }
        this.mFfwdButton = (ImageButton) v.findViewById(16908890);
        int i = 0;
        ...
        this.mRewButton = (ImageButton) v.findViewById(16909254);
        ...
        this.mNextButton = (ImageButton) v.findViewById(16909116);
        if (!(this.mNextButton == null || this.mFromXml || this.mListenersSet)) {
            this.mNextButton.setVisibility(8);
        }
        this.mPrevButton = (ImageButton) v.findViewById(16909217);
        if (!(this.mPrevButton == null || this.mFromXml || this.mListenersSet)) {
            this.mPrevButton.setVisibility(8);
        }
        this.mProgress = (ProgressBar) v.findViewById(16909075);
        ...
        this.mEndTime = (TextView) v.findViewById(16909428);
        this.mCurrentTime = (TextView) v.findViewById(16909431);
