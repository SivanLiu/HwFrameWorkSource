    ...
    private View createViewFromResource(LayoutInflater inflater, int position, View convertView, ViewGroup parent, int resource) {
        ...
        try {
            ...
            if (item == null) {
                ...
                stringBuilder2.append("item is null,the position is ");
                stringBuilder2.append(position);
                stringBuilder2.append(" and itemcount is ");
                stringBuilder2.append(getCount());
                Log.w("ArrayAdapter", stringBuilder2.toString());
            }
