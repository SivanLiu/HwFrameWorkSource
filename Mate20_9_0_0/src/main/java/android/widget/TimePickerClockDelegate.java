...
class TimePickerClockDelegate extends AbstractTimePickerDelegate {
    ...
    public TimePickerClockDelegate(TimePicker delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mSelectHours = res.getString(17041059);
        this.mSelectMinutes = res.getString(17041063);
        View mainView = inflater.inflate(a.getResourceId(12, 17367319), (ViewGroup) delegator);
        mainView.setSaveFromParentEnabled(false);
        this.mRadialTimePickerHeader = mainView.findViewById(16909433);
        this.mRadialTimePickerHeader.setOnTouchListener(new NearestTouchDelegate());
        this.mHourView = (NumericTextView) mainView.findViewById(16908969);
        ...
        this.mHourView.setAccessibilityDelegate(new ClickActionDelegate(context2, 17041059));
        this.mSeparatorView = (TextView) mainView.findViewById(16909302);
        this.mMinuteView = (NumericTextView) mainView.findViewById(16909088);
        ...
        this.mMinuteView.setAccessibilityDelegate(new ClickActionDelegate(context2, 17041063));
        this.mMinuteView.setRange(0, 59);
        this.mAmPmLayout = mainView.findViewById(16908730);
        this.mAmPmLayout.setOnTouchListener(new NearestTouchDelegate());
        String[] amPmStrings = TimePicker.getAmPmStrings(context);
        this.mAmLabel = (RadioButton) this.mAmPmLayout.findViewById(16908728);
        ...
        this.mPmLabel = (RadioButton) this.mAmPmLayout.findViewById(16909206);
        ...
        if (timeHeaderTextAppearance != 0) {
            amPmStrings = this.mContext.obtainStyledAttributes(null, ATTRS_TEXT_COLOR, 0, timeHeaderTextAppearance);
            headerTextColor = applyLegacyColorFixes(amPmStrings.getColorStateList(0));
            amPmStrings.recycle();
        } else {
        ...
        this.mTextInputPickerHeader = mainView.findViewById(16908998);
        if (headerTextColor != null) {
        ...
        a.recycle();
        this.mRadialTimePickerView = (RadialTimePickerView) mainView.findViewById(16909231);
        ...
        this.mTextInputPickerView = (TextInputTimePickerView) mainView.findViewById(16909001);
        this.mTextInputPickerView.setListener(this.mOnValueTypedListener);
        this.mRadialTimePickerModeButton = (ImageButton) mainView.findViewById(16909450);
        ...
        this.mRadialTimePickerModeEnabledDescription = context.getResources().getString(17041257);
        this.mTextInputPickerModeEnabledDescription = context.getResources().getString(17041258);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:32:0x0075 A:{LOOP_END, LOOP:1: B:30:0x0071->B:32:0x0075} */
    ...
    private void updateHourFormat() {
        ...
        while (i2 < lengthPattern) {
            ...
            if (c == 'H' || c == DateFormat.HOUR || c == 'K' || c == DateFormat.HOUR_OF_DAY) {
                ...
                i2 = 1 ^ this.mHourFormatStartsAtZero;
                this.mHourView.setRange(i2, (this.mIs24Hour ? 23 : 11) + i2);
    ...
    private static String getHourMinSeparatorFromPattern(String dateTimePattern) {
        String defaultSeparator = SettingsStringUtil.DELIMITER;
