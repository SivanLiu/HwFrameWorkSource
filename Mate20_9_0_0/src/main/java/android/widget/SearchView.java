...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    public static class SearchAutoComplete extends AutoCompleteTextView {
        ...
        final Runnable mRunShowSoftInputIfNecessary = new -$$Lambda$SearchView$SearchAutoComplete$qdPU54FiW6QTzCbsg7P4cSs3cJ8(this);
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            if (width >= 600 || (width >= DisplayMetrics.DENSITY_XXXHIGH && height >= DisplayMetrics.DENSITY_XXHIGH)) {
                return 192;
            }
            return 160;
        }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(a.getResourceId(0, 17367271), (ViewGroup) this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(16909288);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(16909284);
        this.mSearchPlate = findViewById(16909287);
        this.mSubmitArea = findViewById(16909381);
        this.mSearchButton = (ImageView) findViewById(16909282);
        this.mGoButton = (ImageView) findViewById(16909285);
        this.mCloseButton = (ImageView) findViewById(16909283);
        this.mVoiceButton = (ImageView) findViewById(16909290);
        this.mCollapsedIcon = (ImageView) findViewById(16909286);
        ...
        this.mSuggestionRowLayout = a.getResourceId(11, 17367270);
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(17105304);
    }
    ...
    private int getPreferredHeight() {
        ...
        return getContext().getResources().getDimensionPixelSize(17105303);
    }
    ...
    private void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            if (this.mIconifiedByDefault) {
                iconOffset = res.getDimensionPixelSize(17105037) + res.getDimensionPixelSize(17105038);
            } else {
                iconOffset = 0;
            }
