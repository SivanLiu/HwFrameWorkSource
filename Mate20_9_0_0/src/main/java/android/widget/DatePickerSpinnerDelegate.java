...
class DatePickerSpinnerDelegate extends AbstractDatePickerDelegate {
    ...
    DatePickerSpinnerDelegate(DatePicker delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        boolean spinnersShown = attributesArray.getBoolean(true, true);
        boolean calendarViewShown = attributesArray.getBoolean(true, true);
        ...
        ((LayoutInflater) context2.getSystemService("layout_inflater")).inflate(layoutResourceId, this.mDelegator, true).setSaveFromParentEnabled(false);
        ...
        this.mSpinners = (LinearLayout) this.mDelegator.findViewById(16909197);
        this.mCalendarView = (CalendarView) this.mDelegator.findViewById(16908791);
        ...
        this.mDaySpinner = (NumberPicker) this.mDelegator.findViewById(16908845);
        ...
        this.mDaySpinnerInput = (EditText) this.mDaySpinner.findViewById(16909148);
        this.mMonthSpinner = (NumberPicker) this.mDelegator.findViewById(16909099);
        ...
        this.mMonthSpinnerInput = (EditText) this.mMonthSpinner.findViewById(16909148);
        this.mYearSpinner = (NumberPicker) this.mDelegator.findViewById(16909540);
        this.mYearSpinner.setOnLongPressUpdateInterval(100);
        this.mYearSpinner.setOnValueChangedListener(onChangeListener);
        this.mYearSpinnerInput = (EditText) this.mYearSpinner.findViewById(16909148);
    ...
    private void reorderSpinners() {
        ...
        for (int i = 0; i < spinnerCount; i++) {
            ...
            } else if (c == android.text.format.DateFormat.YEAR) {
    ...
    private void setImeOptions(NumberPicker spinner, int spinnerCount, int spinnerIndex) {
        ...
        ((TextView) spinner.findViewById(16909148)).setImeOptions(imeOptions);
    }

    private void setContentDescriptions() {
        trySetContentDescription(this.mDaySpinner, 16908990, 17039897);
        trySetContentDescription(this.mDaySpinner, 16908850, 17039893);
        trySetContentDescription(this.mMonthSpinner, 16908990, 17039898);
        trySetContentDescription(this.mMonthSpinner, 16908850, 17039894);
        trySetContentDescription(this.mYearSpinner, 16908990, 17039899);
        trySetContentDescription(this.mYearSpinner, 16908850, 17039895);
    }
