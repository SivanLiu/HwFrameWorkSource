...
public class SRUtils {
    private static final String[] BLACK_LIST = new String[]{"com.tencent.mm.ui.chatting.ChattingImageBGView"};
    ...
    private static final String[] WHITE_LIST = new String[]{"com.tencent.mm", "com.ss.android.article.news", "jp.naver.line.android", "com.instagram.android"};
    ...
    public static boolean checkIsFullScreen(Context context, int w, int h) {
        ...
        if ((((int) (((float) screenWidth) * 1064514355)) <= w && maxWidth >= w) || (minHeight <= h && maxHeight >= h)) {
            z = true;
        }
        return z;
    }
    ...
    public static Bitmap drawableToBitmap(Drawable drawable) {
        ...
        return bitmap2.createAshmemBitmap(Config.ARGB_8888);
    }
}
