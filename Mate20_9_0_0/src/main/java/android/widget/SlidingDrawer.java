        ...
        if (this.mTracking || this.mAnimating) {
            ...
            if (cache == null) {
                ...
                if (isVertical) {
                    ...
                    f2 = (float) (handle.getLeft() - this.mTopOffset);
                }
                if (isVertical) {
        ...
        if (!this.mAnimating) {
            ...
            if (content.isLayoutRequested()) {
                ...
                if (this.mVertical) {
                    ...
                    content.layout(this.mTopOffset + childHeight, 0, (this.mTopOffset + childHeight) + content.getMeasuredWidth(), content.getMeasuredHeight());
                }
            }
