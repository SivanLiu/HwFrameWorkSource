...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    private class Callbacks implements OnItemClickListener, OnClickListener, OnLongClickListener, OnDismissListener {
        ...
        /* synthetic */ Callbacks(ActivityChooserView x0, AnonymousClass1 x1) {
            this();
        }
        ...
        private void startActivity(Intent intent, ResolveInfo resolveInfo) {
            try {
                ...
                CharSequence message = ActivityChooserView.this.mContext.getString(17039548, new Object[]{appLabel});
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        /* synthetic */ ActivityChooserViewAdapter(ActivityChooserView x0, AnonymousClass1 x1) {
            this();
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            switch (getItemViewType(position)) {
                case 0:
                    if (convertView == null || convertView.getId() != 16909048) {
                        convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(17367076, parent, false);
                    }
                ...
                case 1:
                    if (convertView == null || convertView.getId() != 1) {
                        convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(17367076, parent, false);
                        convertView.setId(1);
                        ((TextView) convertView.findViewById(16908310)).setText(ActivityChooserView.this.mContext.getString(17039542));
                    }
                    return convertView;
                default:
                    throw new IllegalArgumentException();
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        Drawable expandActivityOverflowButtonDrawable = attributesArray.getDrawable(null);
        attributesArray.recycle();
        LayoutInflater.from(this.mContext).inflate(17367075, (ViewGroup) this, true);
        this.mCallbacks = new Callbacks(this, null);
        this.mActivityChooserContent = (LinearLayout) findViewById(16908701);
        this.mActivityChooserContentBackground = this.mActivityChooserContent.getBackground();
        this.mDefaultActivityButton = (FrameLayout) findViewById(16908853);
        this.mDefaultActivityButton.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(16908977);
        FrameLayout expandButton = (FrameLayout) findViewById(16908875);
        ...
        this.mExpandActivityOverflowButtonImage = (ImageView) expandButton.findViewById(16908977);
        ...
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(17104972));
    }
    ...
    private void showPopupUnchecked(int maxActivityCount) {
        if (this.mAdapter.getDataModel() != null) {
            ...
            if (!popupWindow.isShowing()) {
                ...
                popupWindow.getListView().setContentDescription(this.mContext.getString(17039547));
