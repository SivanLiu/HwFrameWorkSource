...
class TimePickerSpinnerDelegate extends AbstractTimePickerDelegate {
    ...
    public TimePickerSpinnerDelegate(TimePicker delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mHourSpinner = (NumberPicker) timePicker.findViewById(16908968);
        ...
        this.mHourSpinnerInput = (EditText) this.mHourSpinner.findViewById(16909148);
        this.mHourSpinnerInput.setImeOptions(5);
        this.mDivider = (TextView) this.mDelegator.findViewById(16908863);
        if (this.mDivider != null) {
            setDividerText();
        }
        this.mMinuteSpinner = (NumberPicker) this.mDelegator.findViewById(16909087);
        ...
        this.mMinuteSpinnerInput = (EditText) this.mMinuteSpinner.findViewById(16909148);
        this.mMinuteSpinnerInput.setImeOptions(5);
        this.mAmPmStrings = getAmPmStrings(context);
        View amPmView = this.mDelegator.findViewById(16908727);
        if (amPmView instanceof Button) {
            ...
            this.mAmPmSpinnerInput = (EditText) this.mAmPmSpinner.findViewById(16909148);
            this.mAmPmSpinnerInput.setImeOptions(6);
        }
        if (isAmPmAtStart()) {
            ViewGroup amPmParent = (ViewGroup) timePicker.findViewById(16909430);
    ...
    private void setContentDescriptions() {
        trySetContentDescription(this.mMinuteSpinner, 16908990, 17041251);
        trySetContentDescription(this.mMinuteSpinner, 16908850, 17041245);
        trySetContentDescription(this.mHourSpinner, 16908990, 17041250);
        trySetContentDescription(this.mHourSpinner, 16908850, 17041244);
        if (this.mAmPmSpinner != null) {
            trySetContentDescription(this.mAmPmSpinner, 16908990, 17041252);
            trySetContentDescription(this.mAmPmSpinner, 16908850, 17041246);
        }
    }
