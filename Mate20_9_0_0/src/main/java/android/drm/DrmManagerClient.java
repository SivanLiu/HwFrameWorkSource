...
public class DrmManagerClient implements AutoCloseable {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 1002:
                    ...
                    break;
                default:
                    String str = DrmManagerClient.TAG;
    ...
    public void installDrmEngine(String engineFilePath) {
        if (engineFilePath == null || engineFilePath.equals("")) {
            ...
            stringBuilder.append(engineFilePath);
    ...
    public int processDrmInfo(DrmInfo drmInfo) {
        if (drmInfo == null || !drmInfo.isValid()) {
            ...
            return this.mEventHandler.sendMessage(this.mEventHandler.obtainMessage(1002, drmInfo)) ? 0 : ERROR_UNKNOWN;
        }
    }
    ...
    public int removeAllRights() {
        ...
        return this.mEventHandler.sendMessage(this.mEventHandler.obtainMessage(1001)) ? 0 : ERROR_UNKNOWN;
    }
