...
public class SQLiteAuditLog {
    ...
    private void execSQLiteAuditLog(String mainFile, long connectionPtr, Application ap) {
        if (ap == null) {
            if ((mDebugFlags & HW_AUDIT_DBG_WARNING) != 0) {
                ...
                stringBuilder.append(":currentApplication is null");
        ...
        if (ctx == null) {
            if ((mDebugFlags & HW_AUDIT_DBG_WARNING) != 0) {
                ...
                stringBuilder2.append(":getApplicationContext is null");
            ...
            if (this.mPkgName.equals(mPkgNameSQLAuditProvider) || this.resolver == null) {
                if (this.resolver == null && (mDebugFlags & HW_AUDIT_DBG_WARNING) != 0) {
                    ...
                    stringBuilder2.append(":getContentResolver is null");
                    Log.w(str2, stringBuilder2.toString());
                }
                return;
            }
    ...
    private boolean isAuditProviderSystem(Context ctx) {
        ...
        if (pm == null) {
            if ((mDebugFlags & HW_AUDIT_DBG_WARNING) != 0) {
                ...
                stringBuilder.append(Process.myPid());
                stringBuilder.append(":getPackageManager return null");
                Log.w(str, stringBuilder.toString());
            }
            return false;
        }
        ...
        try {
            ...
            if (pkgInfo == null || pkgInfo.sharedUserId == null) {
                if ((mDebugFlags & HW_AUDIT_DBG_WARNING) != 0) {
                    ...
                    stringBuilder = new StringBuilder();
                    stringBuilder.append(Process.myPid());
                    stringBuilder.append(":audit provider pkgInfo or sharedUserId == null");
                    Log.w(str, stringBuilder.toString());
                }
                return false;
                ...
                if (providerInfo == null || providerInfo.length != 1) {
                    if ((mDebugFlags & HW_AUDIT_DBG_WARNING) != 0) {
                        ...
                        stringBuilder2 = new StringBuilder();
                        stringBuilder2.append(Process.myPid());
                        stringBuilder2.append(":audit providerInfo is null or length != 1");
                        Log.w(str2, stringBuilder2.toString());
                    }
                    return false;
                    ...
                    if ((mDebugFlags & HW_AUDIT_DBG_WARNING) != 0) {
                        ...
                        stringBuilder2 = new StringBuilder();
                        stringBuilder2.append(Process.myPid());
                        stringBuilder2.append(":audit provider authority != mPkgNameSQLAuditProvider");
                        Log.w(str2, stringBuilder2.toString());
                    }
                    return false;
                }
                ...
                if ((mDebugFlags & HW_AUDIT_DBG_WARNING) != 0) {
                    ...
                    stringBuilder = new StringBuilder();
                    stringBuilder.append(Process.myPid());
                    stringBuilder.append(":audit provider sharedUserId != android.uid.system");
                    Log.w(str, stringBuilder.toString());
                }
                return false;
            }
            ...
            if ((mDebugFlags & HW_AUDIT_DBG_WARNING) != 0) {
                ...
                stringBuilder2 = new StringBuilder();
                stringBuilder2.append(Process.myPid());
                stringBuilder2.append(":getPackageInfo catch name not found exception");
                Log.w(str2, stringBuilder2.toString());
            }
            return false;
        }
    ...
    private int getAuditFlags() {
        ...
        if ((mDebugFlags & HW_AUDIT_DBG_FLAGS) != 0) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append(this.mCallingProcess);
            stringBuilder.append("(");
            stringBuilder.append(this.mCallingPid);
            stringBuilder.append("):");
            stringBuilder.append(this.mMainDbFile);
            stringBuilder.append(" mAuditFlags:");
            stringBuilder.append(this.mAuditFlags);
    ...
    private void getRecordsFromProvider(String dataBaseName) {
        ...
        Bundle bundle = null;
        args.putString(Record.DATABASE_NAME_ID, str2);
        try {
            ...
            if ((mDebugFlags & HW_AUDIT_DBG_WARNING) != 0) {
                ...
                stringBuilder.append(" getRecordsFromProvider failed");
                Log.w(str, stringBuilder.toString());
            }
        }
        if (bundle == null) {
        ...
        boolean[] transLockAudit_array = bundle.getBooleanArray(Record.transLockAudit_ID);
        ...
        boolean[] transLockAudit_recordSQL_array = bundle.getBooleanArray(Record.TRANS_LOCK_AUDIT_RECORD_SQL_ID);
        boolean[] convLinkAudit_array = bundle.getBooleanArray(Record.convLinkAudit_ID);
        boolean[] memManageAudit_array = bundle.getBooleanArray(Record.memManageAudit_ID);
        boolean[] zArr;
        int[] iArr;
        Bundle bundle2;
        boolean[] zArr2;
        ...
        boolean[] zArr3;
        boolean[] zArr4;
        if (AppName_array == null || dataBaseName_array == null || timeAudit_array == null || timeAudit_timeThresholdSQL_array == null || timeAudit_recordSQL_array == null || timeAudit_recordExecPlan_array == null || timeAudit_turnOnDetailedStatistics_array == null || statInfoAudit_array == null || groupOrderAudit_array == null || groupOrderAudit_timeThresholdSQL_array == null || groupOrderAudit_recordSQL_array == null || transLockAudit_array == null || transLockAudit_timeThresholdTransactionLock_array == null || transLockAudit_recordSQL_array == null || convLinkAudit_array == null) {
            zArr = transLockAudit_recordSQL_array;
            iArr = transLockAudit_timeThresholdTransactionLock_array;
            bundle2 = bundle;
            zArr2 = transLockAudit_array;
            strArr = dataBaseName_array;
            zArr3 = convLinkAudit_array;
            dataBaseName_array = dataBaseName;
        } else if (memManageAudit_array == null) {
            zArr4 = memManageAudit_array;
            zArr = transLockAudit_recordSQL_array;
            iArr = transLockAudit_timeThresholdTransactionLock_array;
            bundle2 = bundle;
            zArr2 = transLockAudit_array;
            ...
            boolean[] memManageAudit_array2 = memManageAudit_array;
            if (AppName_array.length == dataBaseName_array.length && AppName_array.length == timeAudit_array.length && AppName_array.length == timeAudit_timeThresholdSQL_array.length && AppName_array.length == timeAudit_recordSQL_array.length && AppName_array.length == timeAudit_recordExecPlan_array.length && AppName_array.length == timeAudit_turnOnDetailedStatistics_array.length && AppName_array.length == statInfoAudit_array.length && AppName_array.length == groupOrderAudit_array.length && AppName_array.length == groupOrderAudit_timeThresholdSQL_array.length && AppName_array.length == groupOrderAudit_recordSQL_array.length && AppName_array.length == transLockAudit_array.length && AppName_array.length == transLockAudit_timeThresholdTransactionLock_array.length && AppName_array.length == transLockAudit_recordSQL_array.length) {
                strArr = dataBaseName_array;
                bundle = convLinkAudit_array;
                if (AppName_array.length == bundle.length) {
                    zArr3 = bundle;
                    boolean[] memManageAudit_array3 = memManageAudit_array2;
                    if (AppName_array.length != memManageAudit_array3.length) {
                        zArr = transLockAudit_recordSQL_array;
                        iArr = transLockAudit_timeThresholdTransactionLock_array;
                        zArr2 = transLockAudit_array;
                        zArr4 = memManageAudit_array3;
                        memManageAudit_array3 = dataBaseName;
                    } else {
                        StringBuilder stringBuilder2;
                        this.hashMap.clear();
                        if ((mDebugFlags & HW_AUDIT_DBG_AUDITOBSERVER) != null) {
                            bundle = TAG;
                            zArr4 = memManageAudit_array3;
                            stringBuilder2 = new StringBuilder();
                            zArr = transLockAudit_recordSQL_array;
                            stringBuilder2.append(this.mCurProcess);
                            stringBuilder2.append("(");
                            stringBuilder2.append(this.mPid);
                            stringBuilder2.append(")getting conf,record number: ");
                            stringBuilder2.append(AppName_array.length);
                            Log.d(bundle, stringBuilder2.toString());
                        } else {
                            zArr = transLockAudit_recordSQL_array;
                            zArr4 = memManageAudit_array3;
                        }
                        transLockAudit_recordSQL_array = null;
                        while (transLockAudit_recordSQL_array < AppName_array.length) {
                            bundle = new Record();
                            bundle.timeAudit = timeAudit_array[transLockAudit_recordSQL_array];
                            bundle.timeAudit_timeThresholdSQL = timeAudit_timeThresholdSQL_array[transLockAudit_recordSQL_array];
                            bundle.timeAudit_recordSQL = timeAudit_recordSQL_array[transLockAudit_recordSQL_array];
                            bundle.timeAudit_recordExecPlan = timeAudit_recordExecPlan_array[transLockAudit_recordSQL_array];
                            bundle.timeAudit_turnOnDetailedStatistics = timeAudit_turnOnDetailedStatistics_array[transLockAudit_recordSQL_array];
                            bundle.statInfoAudit = statInfoAudit_array[transLockAudit_recordSQL_array];
                            bundle.groupOrderAudit = groupOrderAudit_array[transLockAudit_recordSQL_array];
                            bundle.groupOrderAudit_timeThresholdSQL = groupOrderAudit_timeThresholdSQL_array[transLockAudit_recordSQL_array];
                            bundle.groupOrderAudit_recordSQL = groupOrderAudit_recordSQL_array[transLockAudit_recordSQL_array];
                            bundle.transLockAudit = transLockAudit_array[transLockAudit_recordSQL_array];
                            bundle.transLockAudit_timeThresholdTransactionLock = transLockAudit_timeThresholdTransactionLock_array[transLockAudit_recordSQL_array];
                            bundle.transLockAudit_recordSQL = zArr[transLockAudit_recordSQL_array];
                            bundle.convLinkAudit = zArr3[transLockAudit_recordSQL_array];
                            bundle.memManageAudit = zArr4[transLockAudit_recordSQL_array];
                            iArr = transLockAudit_timeThresholdTransactionLock_array;
                            HashMap hashMap;
                            if ("ALL".equals(strArr[transLockAudit_recordSQL_array])) {
                                hashMap = this.hashMap;
                                stringBuilder2 = new StringBuilder();
                                zArr2 = transLockAudit_array;
                                stringBuilder2.append(AppName_array[transLockAudit_recordSQL_array]);
                                stringBuilder2.append(strArr[transLockAudit_recordSQL_array]);
                                hashMap.put(stringBuilder2.toString(), bundle);
                                str = dataBaseName;
                            } else {
                                zArr2 = transLockAudit_array;
                                hashMap = this.hashMap;
                                StringBuilder stringBuilder3 = new StringBuilder();
                                stringBuilder3.append(AppName_array[transLockAudit_recordSQL_array]);
                                stringBuilder3.append(dataBaseName);
                                hashMap.put(stringBuilder3.toString(), bundle);
                            }
                            transLockAudit_recordSQL_array++;
                            transLockAudit_timeThresholdTransactionLock_array = iArr;
                            transLockAudit_array = zArr2;
                        }
                        zArr2 = transLockAudit_array;
                        str = dataBaseName;
                        return;
    ...
    private Record getRecord(String AppName) {
        ...
        synchronized (this.hashMap) {
            ...
            stringBuilder.append(this.mMainDbFile);
            record = (Record) hashMap.get(stringBuilder.toString());
            if (record == null) {
                hashMap = this.hashMap;
                stringBuilder = new StringBuilder();
            ...
            if (record == null) {
                record = (Record) this.hashMap.get("ALLALL");
            }
        }
        return record;
    }
    ...
    private void persistTimeAudit() {
        if (this.mCurrRec != null && this.mCurrRec.timeAudit && this.mVdbeExecTime >= this.mCurrRec.timeAudit_timeThresholdSQL) {
            ...
            values.put(AuditLog.FEATUREID, Integer.valueOf(1));
    ...
    private void persistStatInfo() {
        if (this.mCurrRec.statInfoAudit && this.mStat1.size() != 0) {
            ContentValues values = new ContentValues();
            values.put(AuditLog.PID, Integer.valueOf(this.mPid));
            values.put(AuditLog.FEATUREID, Integer.valueOf(2));
            values.put(AuditLog.PKGNAME, this.mPkgName);
            values.put(AuditLog.APPNAME, this.mCurProcess);
            values.put(AuditLog.MAINDBFILE, this.mMainDbFile);
    ...
    private void persistGroupOrderAudit() {
        if (this.mCurrRec.groupOrderAudit && this.mVdbeExecTime >= this.mCurrRec.groupOrderAudit_timeThresholdSQL && this.mGrpOrderbyEqp.size() != 0) {
            ContentValues values = new ContentValues();
            values.put(AuditLog.PID, Integer.valueOf(this.mPid));
            values.put(AuditLog.FEATUREID, Integer.valueOf(3));
            values.put(AuditLog.PKGNAME, this.mPkgName);
            values.put(AuditLog.MAINDBFILE, this.mMainDbFile);
    ...
    private void persistTransLockAudit() {
        if (this.mCurrRec.transLockAudit && this.mTransLockTime >= this.mCurrRec.transLockAudit_timeThresholdTransactionLock) {
            ContentValues values = new ContentValues();
            values.put(AuditLog.PID, Integer.valueOf(this.mPid));
            values.put(AuditLog.FEATUREID, Integer.valueOf(4));
            values.put(AuditLog.PKGNAME, this.mPkgName);
            values.put(AuditLog.MAINDBFILE, this.mMainDbFile);
    ...
    private void printTimeAudit() {
        ...
        if (record != null) {
            ...
            if (record.timeAudit) {
                ...
                str = TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append("VdbeExec Time:");
                stringBuilder.append(this.mVdbeExecTime);
                stringBuilder.append(" VdbeTran Time:");
                stringBuilder.append(this.mVdbeTranTime);
                stringBuilder.append(" CPU Freq Info:");
                stringBuilder.append(getCpuFreqInfoForPid(this.mCpuNum));
                stringBuilder.append(" Cpu Core ID:");
                stringBuilder.append(this.mCpuNum);
                stringBuilder.append(" FileRead Count:");
                stringBuilder.append(this.mFileReadCount);
                stringBuilder.append(" ReadPage Count:");
                stringBuilder.append(this.mReadPageCount);
                stringBuilder.append(" TravelRow Num:");
                stringBuilder.append(this.mTravelRowNum);
                stringBuilder.append(" ResultRow Num:");
                stringBuilder.append(this.mResultRowNum);
                stringBuilder.append(" SortRow Num:");
                stringBuilder.append(this.mSortRowNum);
                stringBuilder.append(" Vdbe Step:");
                stringBuilder.append(this.mVbdeStep);
                Log.d(str, stringBuilder.toString());
                if (record.timeAudit_recordExecPlan && this.mEqp.size() > 0) {
                    str = TAG;
                    stringBuilder = new StringBuilder();
                    stringBuilder.append("record exec plan:");
                    stringBuilder.append(this.mEqp.toString());
                    Log.d(str, stringBuilder.toString());
                }
                if (record.timeAudit_turnOnDetailedStatistics) {
                    ...
                    str = TAG;
                    stringBuilder = new StringBuilder();
                    stringBuilder.append("FileRead Time:");
                    stringBuilder.append(this.mFileReadTime);
                    stringBuilder.append(" ReadPage Time:");
                    stringBuilder.append(this.mReadPageTime);
                    stringBuilder.append(" Sort Time:");
                    stringBuilder.append(this.mSortTime);
                    Log.d(str, stringBuilder.toString());
                }
            }
            if (record.timeAudit_recordSQL || record.groupOrderAudit_recordSQL || record.transLockAudit_recordSQL) {
                str = TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append("record SQL statements:");
                stringBuilder.append(this.mSql.toString());
                Log.d(str, stringBuilder.toString());
            }
        }
    }
    ...
    private void printAuditLog4Conf() {
        ...
        if (record != null && (mDebugFlags & HW_AUDIT_DBG_PRINT) != 0) {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append(this.mVdbeBeginDateTime);
            stringBuilder.append(":");
            stringBuilder.append(this.mPkgName);
            stringBuilder.append("-");
            stringBuilder.append(this.mCurProcess);
            stringBuilder.append("(");
            ...
            if (this.mCallingPid != this.mPid) {
                str = TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append("Calling Process:");
                stringBuilder.append(this.mCallingProcess);
                stringBuilder.append("(");
                stringBuilder.append(this.mCallingPid);
                stringBuilder.append(")");
            ...
            if (record.statInfoAudit) {
                ...
                if (this.mStat1.size() > 0) {
                    ...
                    stringBuilder.append(this.mStat1.toString());
                    Log.d(str, stringBuilder.toString());
                } else {
                    Log.d(TAG, "stat:none");
                }
            ...
            if (record.groupOrderAudit) {
                ...
                while (idx < count) {
                    int idx2 = idx + 1;
                    Log.d(TAG, (String) this.mGrpOrderbyEqp.get(idx));
                    idx = idx2;
                }
                String str2 = TAG;
                StringBuilder stringBuilder2 = new StringBuilder();
                stringBuilder2.append("VdbeExec return:");
                stringBuilder2.append(this.mVdbeExecRet);
                Log.d(str2, stringBuilder2.toString());
                if (this.mErrMsg != null) {
                    str2 = TAG;
                    stringBuilder2 = new StringBuilder();
                    stringBuilder2.append("Error Msg:");
            ...
            if (record.transLockAudit) {
                ...
                str = TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append("TransLock Time:");
                stringBuilder.append(this.mTransLockTime);
                Log.d(str, stringBuilder.toString());
                str = TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append(this.mPkgName);
            ...
            if (record.convLinkAudit) {
                ...
                str = TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append("Con Num:");
                stringBuilder.append(this.mConnctionCount);
                stringBuilder.append(" AttachFile Count:");
                stringBuilder.append(this.mAttachFileCount);
                Log.d(str, stringBuilder.toString());
            }
            if (record.memManageAudit) {
                ...
                str = TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append("Begin MemUsed:");
                stringBuilder.append(this.mBeginMemUsed);
                stringBuilder.append(" End MemUsed:");
                stringBuilder.append(this.mEndMemUsed);
                stringBuilder.append(" Max MemUsed:");
                stringBuilder.append(this.mMaxMemUsed);
                stringBuilder.append(" Pager MemUsed:");
                stringBuilder.append(this.mPagerMemUsed);
                Log.d(str, stringBuilder.toString());
            }
            Log.d(TAG, "---------------------------------------------------------------------");
        }
    ...
    private static final String getCpuFreqInfoForPid(int cpu) {
        ...
        stringBuilder.append("/cpufreq/scaling_cur_freq");
    ...
    private static String getProcessName(int pid) {
        ...
        try {
            ...
            if ((mDebugFlags & HW_AUDIT_DBG_WARNING) != 0) {
                String str = TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("getProcessName for ");
