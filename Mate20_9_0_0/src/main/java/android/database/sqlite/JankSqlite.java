...
public final class JankSqlite {
    ...
    private static long mJankSamplingNum = 20;
        ...
        public synchronized boolean addOpr(long tl, String table, String dbname) {
            ...
            if (this.mbCircle) {
                ...
                if (averagetl > this.mLimit) {
                    boolean bUIThread = Looper.myLooper() == Looper.getMainLooper();
                    if (bUIThread) {
                        int i = this.mLogID;
                        int i2 = (int) averagetl;
                        ...
                        stringBuilder.append("),(");
                        stringBuilder.append(bUIThread);
                        stringBuilder.append(")");
                        Jlog.d(i, dbname, i2, stringBuilder.toString());
                    }
                    this.mbCircle = false;
                    this.mNextIndex = 0;
                    this.mTotaltime = 0;
