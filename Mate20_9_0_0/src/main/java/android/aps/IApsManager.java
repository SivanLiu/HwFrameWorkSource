...
public interface IApsManager {
    ...
    boolean getFbSkip(String str);

    int getFps(String str);

    boolean getHighpToLowp(String str);

    int getMaxFps(String str);

    int getMipMap(String str);
    ...
    int setColorPlusPkgList(List<String> list);
