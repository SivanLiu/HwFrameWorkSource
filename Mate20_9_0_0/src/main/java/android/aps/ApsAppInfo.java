...
public class ApsAppInfo implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flag) {
        ...
        dest.writeByte((byte) this.mSwitchable);
    }
    ...
    private void readFromParcel(Parcel in) {
        ...
        this.mSwitchable = in.readByte() != (byte) 0;
    }

    public String toString() {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("ApsAppInfo [mBasePackageName=");
        stringBuilder.append(this.mBasePackageName);
        stringBuilder.append(", mResolutionRatio=");
        stringBuilder.append(this.mResolutionRatio);
        stringBuilder.append(", mMinFrameRate=");
        stringBuilder.append(this.mMinFrameRate);
        stringBuilder.append(", mMaxFrameRate=");
        stringBuilder.append(this.mMaxFrameRate);
        stringBuilder.append(", mTexturePercent=");
        stringBuilder.append(this.mTexturePercent);
        stringBuilder.append(", mBrightnessPercent=");
        stringBuilder.append(this.mBrightnessPercent);
        stringBuilder.append(", mSwitchable=");
        stringBuilder.append(this.mSwitchable);
        stringBuilder.append(", mFBSkipSwitch=");
        stringBuilder.append(this.mFBSkipSwitch);
        stringBuilder.append(", mHighpToLowpSwitch=");
        stringBuilder.append(this.mHighpToLowpSwitch);
        stringBuilder.append(", mShadowMapSwitch=");
        stringBuilder.append(this.mShadowMapSwitch);
        stringBuilder.append(", mMipMapSwitch=");
        stringBuilder.append(this.mMipMapSwitch);
    ...
    public int hashCode() {
        int i = 1237;
        int hashCode = 31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * 1) + (this.mBasePackageName == null ? 0 : this.mBasePackageName.hashCode()))) + this.mBrightnessPercent)) + (this.mFBSkipSwitch ? 1231 : 1237))) + this.mMinFrameRate)) + this.mMaxFrameRate)) + (this.mHighpToLowpSwitch ? 1231 : 1237))) + this.mMipMapSwitch)) + Float.floatToIntBits(this.mResolutionRatio))) + this.mShadowMapSwitch);
        if (this.mSwitchable) {
            i = 1231;
        }
        return (31 * (hashCode + i)) + this.mTexturePercent;
    }
