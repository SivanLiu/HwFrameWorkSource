...
public final class R {
    ...
    public static final class styleable {
        public static final int[] CoordinatorLayout = new int[]{0, 0};
        public static final int[] CoordinatorLayout_Layout = new int[]{0, 0, 0, 0, 0, 0, 16842931};
        ...
        public static final int[] FontFamily = new int[]{0, 0, 0, 0, 0, 0};
        public static final int[] FontFamilyFont = new int[]{0, 0, 0, 0, 0, 16844082, 16844083, 16844095, 16844143, 16844144};
