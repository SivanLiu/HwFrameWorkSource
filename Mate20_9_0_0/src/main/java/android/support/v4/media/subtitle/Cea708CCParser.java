    ...
    private int parseC1(byte[] data, int pos) {
        ...
        switch (i) {
            ...
            case Const.CODE_C1_SPA /*144*/:
                pos2 = pos + 2;
                emitCaptionEvent(new CaptionEvent(12, new CaptionPenAttr(data[pos] & 3, (data[pos] & 12) >> 2, (data[pos] & 240) >> 4, 7 & data[pos + 1], (data[pos + 1] & 56) >> 3, (data[pos + 1] & 64) != 0 ? true : DEBUG, (data[pos + 1] & 128) != 0 ? true : DEBUG)));
                return pos2;
            ...
            default:
                switch (i) {
                    case Const.CODE_C1_SWA /*151*/:
                        int pos3 = pos + 4;
                        emitCaptionEvent(new CaptionEvent(15, new CaptionWindowAttr(new CaptionColor((data[pos] & 192) >> 6, (data[pos] & 48) >> 4, (data[pos] & 12) >> 2, data[pos] & 3), new CaptionColor(0, (data[pos + 1] & 48) >> 4, (data[pos + 1] & 12) >> 2, data[pos + 1] & 3), ((data[pos + 2] & 128) >> 5) | ((data[pos + 1] & 192) >> 6), (data[pos + 2] & 64) != 0 ? true : DEBUG, (data[pos + 2] & 48) >> 4, (data[pos + 2] & 12) >> 2, data[pos + 2] & 3, (12 & data[pos + 3]) >> 2, (data[pos + 3] & 240) >> 4, 3 & data[pos + 3])));
                        return pos3;
                    ...
                    case 159:
                        ...
                        int pos4 = pos + 6;
                        pos2 = 16;
                        CaptionWindow captionWindow2 = new CaptionWindow(this.mCommand - 152, (data[pos] & 32) != 0 ? true : DEBUG, (data[pos] & 16) != 0 ? true : DEBUG, (data[pos] & 8) != 0 ? true : DEBUG, data[pos] & 7, (data[pos + 1] & 128) != 0 ? true : DEBUG, data[pos + 1] & 127, data[pos + 2] & 255, (data[pos + 3] & 240) >> 4, 15 & data[pos + 3], data[pos + 4] & 63, 7 & data[pos + 5], (data[pos + 5] & 56) >> 3);
