...
class Cea608CCParser {
    ...
    private static class CCData {
        ...
        boolean isDisplayableChar() {
            return (isBasicChar() || isSpecialChar() || isExtendedChar()) ? true : Cea608CCParser.DEBUG;
        }
        ...
        private boolean isBasicChar() {
            return (this.mData1 < (byte) 32 || this.mData1 > Byte.MAX_VALUE) ? Cea608CCParser.DEBUG : true;
        }

        private boolean isSpecialChar() {
            return ((this.mData1 == (byte) 17 || this.mData1 == (byte) 25) && this.mData2 >= (byte) 48 && this.mData2 <= (byte) 63) ? true : Cea608CCParser.DEBUG;
        }

        private boolean isExtendedChar() {
            return ((this.mData1 == (byte) 18 || this.mData1 == (byte) 26 || this.mData1 == (byte) 19 || this.mData1 == (byte) 27) && this.mData2 >= (byte) 32 && this.mData2 <= (byte) 63) ? true : Cea608CCParser.DEBUG;
        }
    ...
    private static class StyleCode {
        ...
        boolean isItalics() {
            return (this.mStyle & 1) != 0 ? true : Cea608CCParser.DEBUG;
        }

        boolean isUnderline() {
            return (this.mStyle & 2) != 0 ? true : Cea608CCParser.DEBUG;
        }
