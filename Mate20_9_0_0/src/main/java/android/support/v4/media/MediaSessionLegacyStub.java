...
class MediaSessionLegacyStub extends Callback {
    ...
    final class ControllerLegacyCb extends ControllerCb {
        ...
        void onGetChildrenDone(String parentId, int page, int pageSize, List<MediaItem2> list, Bundle extras) throws RemoteException {
        }
        ...
        void onGetSearchResultDone(String query, int page, int pageSize, List<MediaItem2> list, Bundle extras) throws RemoteException {
        }
    ...
    private boolean isAllowedCommand(ControllerInfo controller, SessionCommand2 command) {
        ...
        return (allowedCommands == null || !allowedCommands.hasCommand(command)) ? DEBUG : true;
    }
    ...
    private boolean isAllowedCommand(ControllerInfo controller, int commandCode) {
        ...
        return (allowedCommands == null || !allowedCommands.hasCommand(commandCode)) ? DEBUG : true;
    }
        ...
        this.mSession.getCallbackExecutor().execute(new Runnable() {
            public void run() {
                if (!MediaSessionLegacyStub.this.mSession.isClosed()) {
                    ...
                    boolean accept = (allowedCommands != null || controllerInfo.isTrusted()) ? true : MediaSessionLegacyStub.DEBUG;
