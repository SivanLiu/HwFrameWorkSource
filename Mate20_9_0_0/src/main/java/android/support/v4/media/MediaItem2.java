...
public class MediaItem2 {
    ...
    public static final class Builder {
        ...
        public MediaItem2 build() {
            ...
            return new MediaItem2(id, this.mDataSourceDesc, this.mMetadata, this.mFlags, null);
        }
    }
    ...
    static MediaItem2 fromBundle(@NonNull Bundle bundle, @Nullable UUID uuid) {
        ...
        if (metadataBundle != null) {
            mediaItem2 = MediaMetadata2.fromBundle(metadataBundle);
        }
        return new MediaItem2(id, null, (MediaMetadata2) mediaItem2, bundle.getInt(KEY_FLAGS), uuid);
    }
