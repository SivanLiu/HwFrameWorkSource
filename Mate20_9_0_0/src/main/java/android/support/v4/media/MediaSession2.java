...
public class MediaSession2 implements SessionPlayer, AutoCloseable {
    ...
    static abstract class ControllerCb {
        ...
        abstract void onBufferingStateChanged(@NonNull MediaItem2 mediaItem2, int i, long j) throws RemoteException;
        ...
        abstract void onGetChildrenDone(@NonNull String str, int i, int i2, @Nullable List<MediaItem2> list, @Nullable Bundle bundle) throws RemoteException;

        abstract void onGetItemDone(@NonNull String str, @Nullable MediaItem2 mediaItem2) throws RemoteException;

        abstract void onGetLibraryRootDone(@Nullable Bundle bundle, @Nullable String str, @Nullable Bundle bundle2) throws RemoteException;

        abstract void onGetSearchResultDone(@NonNull String str, int i, int i2, @Nullable List<MediaItem2> list, @Nullable Bundle bundle) throws RemoteException;

        abstract void onPlaybackInfoChanged(@NonNull PlaybackInfo playbackInfo) throws RemoteException;

        abstract void onPlaybackSpeedChanged(long j, long j2, float f) throws RemoteException;

        abstract void onPlayerStateChanged(long j, long j2, int i) throws RemoteException;
        ...
        abstract void onSeekCompleted(long j, long j2, long j3) throws RemoteException;
