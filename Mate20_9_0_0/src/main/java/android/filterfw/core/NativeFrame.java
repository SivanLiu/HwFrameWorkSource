...
public class NativeFrame extends Frame {
    ...
    public Object getObjectValue() {
        ...
        if (structClass == null) {
            ...
            try {
                ...
                stringBuilder.append(structClass);
    ...
    public void setFloats(float[] floats) {
        ...
        if (floats.length * nativeFloatSize() > getFormat().getSize()) {
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("NativeFrame cannot hold ");
            stringBuilder.append(floats.length);
    ...
    public void setData(ByteBuffer buffer, int offset, int length) {
        ...
        if (length + offset > buffer.limit()) {
            ...
            stringBuilder.append("Offset and length exceed buffer size in native setData: ");
            stringBuilder.append(length + offset);
            stringBuilder.append(" bytes given, but only ");
            stringBuilder.append(buffer.limit());
            stringBuilder.append(" bytes available!");
            throw new RuntimeException(stringBuilder.toString());
        } else if (getFormat().getSize() != length) {
            stringBuilder = new StringBuilder();
            stringBuilder.append("Data size in setData does not match native frame size: Frame size is ");
            stringBuilder.append(getFormat().getSize());
            stringBuilder.append(" bytes, but ");
            stringBuilder.append(length);
            stringBuilder.append(" bytes given!");
            throw new RuntimeException(stringBuilder.toString());
