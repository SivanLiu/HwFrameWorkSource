...
public final class BluetoothAdapter {
    ...
    public boolean enable() {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("BT enbale calling pid = ");
    ...
    public BluetoothServerSocket listenUsingInsecureL2capOn(int port) throws IOException {
        ...
        if (port == -2) {
            ...
            String str2 = TAG;
            StringBuilder stringBuilder2 = new StringBuilder();
            stringBuilder2.append("listenUsingInsecureL2capOn: set assigned channel to ");
            stringBuilder2.append(assignedChannel);
    ...
    public BluetoothServerSocket listenUsingL2capCoc(int transport) throws IOException {
        if (transport == 2) {
            ...
            if (errno == 0) {
                ...
                if (assignedPsm != 0) {
                    String str = TAG;
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("listenUsingL2capCoc: set assigned PSM to ");
        ...
        StringBuilder stringBuilder3 = new StringBuilder();
        stringBuilder3.append("Unsupported transport: ");
        ...
        if (transport == 2) {
            ...
            if (errno == 0) {
                ...
                if (assignedPsm != 0) {
                    String str = TAG;
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("listenUsingInsecureL2capOn: set assigned PSM to ");
                    stringBuilder.append(assignedPsm);
                    Log.d(str, stringBuilder.toString());
                    bluetoothServerSocket.setChannel(assignedPsm);
                    return bluetoothServerSocket;
