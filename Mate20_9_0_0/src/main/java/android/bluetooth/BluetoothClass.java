...
public final class BluetoothClass implements Parcelable {
    ...
    public int getMajorDeviceClass() {
        return this.mClass & Major.UNCATEGORIZED;
    }
    ...
    public boolean doesClassMatch(int profile) {
        ...
        stringBuilder.append("enableNoAutoConnect: ");
        ...
        if (profile == 1) {
            ...
            int deviceClass = getDeviceClass();
            return deviceClass == Device.AUDIO_VIDEO_LOUDSPEAKER || deviceClass == Device.AUDIO_VIDEO_HEADPHONES || deviceClass == Device.AUDIO_VIDEO_CAR_AUDIO || deviceClass == Device.AUDIO_VIDEO_HIFI_AUDIO;
        } else if (profile == 6) {
            if (hasService(524288)) {
                return true;
            }
            int deviceClass2 = getDeviceClass();
            return deviceClass2 == Device.AUDIO_VIDEO_SET_TOP_BOX || deviceClass2 == Device.AUDIO_VIDEO_HIFI_AUDIO || deviceClass2 == Device.AUDIO_VIDEO_VCR;
        } else if (profile == 0) {
            if (hasService(262144)) {
                return true;
            }
            int deviceClass3 = getDeviceClass();
            return deviceClass3 == Device.AUDIO_VIDEO_WEARABLE_HEADSET || deviceClass3 == Device.AUDIO_VIDEO_HANDSFREE || deviceClass3 == Device.AUDIO_VIDEO_CAR_AUDIO;
        } else if (profile == 2) {
