...
public class SdpOppOpsRecord implements Parcelable {
    ...
    public String toString() {
        ...
        sb.append("  RFCOMM Chan Number: ");
        sb.append(this.mRfcommChannel);
        sb.append("\n  L2CAP PSM: ");
        sb.append(this.mL2capPsm);
        sb.append("\n  Profile version: ");
        sb.append(this.mProfileVersion);
        sb.append("\n  Service Name: ");
        sb.append(this.mServiceName);
        sb.append("\n  Formats List: ");
        sb.append(Arrays.toString(this.mFormatsList));
        return sb.toString();
    }
}
