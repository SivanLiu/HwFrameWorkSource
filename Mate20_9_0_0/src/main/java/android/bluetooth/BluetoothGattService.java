...
public class BluetoothGattService implements Parcelable {
    ...
    private BluetoothGattService(Parcel in) {
        ...
        if (chrcs != null) {
            Iterator it = chrcs.iterator();
            while (it.hasNext()) {
                BluetoothGattCharacteristic chrc = (BluetoothGattCharacteristic) it.next();
        ...
        if (chrcs != null) {
            Iterator it2 = inclSvcs.iterator();
            while (it2.hasNext()) {
                BluetoothGattIncludedService isvc = (BluetoothGattIncludedService) it2.next();
