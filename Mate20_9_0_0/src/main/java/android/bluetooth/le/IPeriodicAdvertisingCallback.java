            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    case 1:
                        ...
                        return true;
                    case 2:
                        PeriodicAdvertisingReport _arg03;
                        parcel.enforceInterface(descriptor);
                        if (data.readInt() != 0) {
                            _arg03 = (PeriodicAdvertisingReport) PeriodicAdvertisingReport.CREATOR.createFromParcel(parcel);
                        }
                        onPeriodicAdvertisingReport(_arg03);
                        return true;
                    case 3:
                        parcel.enforceInterface(descriptor);
