        ...
        private static class Proxy implements IBluetoothHeadsetClient {
            ...
            public BluetoothHeadsetClientCall dial(BluetoothDevice device, String number) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = (BluetoothHeadsetClientCall) BluetoothHeadsetClientCall.CREATOR.createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    _reply.recycle();
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 15:
                        ...
                        _result3 = terminateCall(_arg02, _arg12);
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case 16:
                    ...
                    case 18:
                        ...
                        BluetoothHeadsetClientCall _result8 = dial(_arg0, data.readString());
                        reply.writeNoException();
                        if (_result8 != null) {
                            reply.writeInt(1);
                    ...
                    case 24:
                        ...
                        setAudioRouteAllowed(_arg0, _arg1);
                        reply.writeNoException();
                        return true;
                    case 25:
                        data.enforceInterface(descriptor);
