...
public class BluetoothGattCharacteristic implements Parcelable {
    ...
    /* JADX WARNING: Missing block: B:12:0x0056, code skipped:
            ...
            r4.mValue[r2] = (byte) ((r5 >> 8) & 255);
     */
    /* JADX WARNING: Missing block: B:13:0x0069, code skipped:
            r4.mValue[r7] = (byte) (r5 & 255);
            r2 = r7;
     */
    ...
    public boolean setValue(int mantissa, int exponent, int formatType, int offset) {
        ...
        if (formatType == 50) {
            ...
            this.mValue[offset] = (byte) (mantissa & 255);
            int offset3 = i + 1;
            this.mValue[i] = (byte) ((mantissa >> 8) & 255);
            i = offset3 + 1;
            this.mValue[offset3] = (byte) ((mantissa >> 16) & 255);
            bArr = this.mValue;
            bArr[i] = (byte) (bArr[i] + ((byte) (exponent & 255)));
        }
        return true;
    }
