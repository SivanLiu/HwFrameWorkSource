            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    case 1:
                        ...
                        if (data.readInt() != 0) {
                            _arg0 = (BluetoothHealthAppConfiguration) BluetoothHealthAppConfiguration.CREATOR.createFromParcel(parcel);
                        }
                    ...
                    case 2:
                        ...
                        parcel.enforceInterface(descriptor);
                        if (data.readInt() != 0) {
                            _arg02 = (BluetoothHealthAppConfiguration) BluetoothHealthAppConfiguration.CREATOR.createFromParcel(parcel);
                        } else {
                            _arg02 = null;
                        }
                        if (data.readInt() != 0) {
                        ...
                        onHealthChannelStateChange(_arg02, _arg1, _arg2, _arg3, _arg0, data.readInt());
                        reply.writeNoException();
                        return true;
                    default:
