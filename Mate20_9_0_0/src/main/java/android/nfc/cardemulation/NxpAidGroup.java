...
public final class NxpAidGroup extends AidGroup implements Parcelable {
    public static final Creator<NxpAidGroup> CREATOR = new Creator<NxpAidGroup>() {
    ...
    public static class ApduPatternGroup implements Parcelable {
        public static final Creator<ApduPatternGroup> CREATOR = new Creator<ApduPatternGroup>() {
        ...
        public String toString() {
            ...
            for (ApduPattern apdu : this.apduList) {
                ...
                stringBuilder.append("apdu_data");
                stringBuilder.append(apdu.getreferenceData());
                out.append(stringBuilder.toString());
                stringBuilder = new StringBuilder();
                stringBuilder.append("apdu mask");
                stringBuilder.append(apdu.getMask());
                out.append(stringBuilder.toString());
            }
            return out.toString();
        }
    ...
    public ArrayList<ApduPattern> getApduPatternList() {
        ...
        try {
            Iterator it = this.mStaticApduPatternGroups.iterator();
            while (it.hasNext()) {
                ApduPatternGroup group = (ApduPatternGroup) it.next();
                if (group != null) {
