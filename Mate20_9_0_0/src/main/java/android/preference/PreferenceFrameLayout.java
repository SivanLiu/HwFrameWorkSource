...
public class PreferenceFrameLayout extends FrameLayout {
    ...
    public PreferenceFrameLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        int defaultBottomPadding = (int) ((density * 0.0f) + 1056964608);
        int defaultLeftPadding = (int) ((density * 0.0f) + 1056964608);
        int defaultRightPadding = (int) ((0.0f * density) + 1056964608);
        this.mBorderTop = a.getDimensionPixelSize(3, (int) ((density * 0.0f) + 1056964608));
