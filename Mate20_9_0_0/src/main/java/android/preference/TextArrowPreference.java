...
public class TextArrowPreference extends Preference {
    ...
    protected void onBindView(View view) {
        ...
        if (title_frame != null) {
            boolean title_frame_empty = TextUtils.isEmpty(getTitle()) && TextUtils.isEmpty(getSummary()) && TextUtils.isEmpty(getNetherSummary());
            title_frame.setVisibility(title_frame_empty ? 8 : 0);
        }
