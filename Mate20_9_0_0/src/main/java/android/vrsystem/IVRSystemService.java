            ...
            if (code != IBinder.INTERFACE_TRANSACTION) {
                ...
                switch (code) {
                    case 1:
                        ...
                        boolean _result2 = isVRmode();
                        reply.writeNoException();
                        reply.writeInt(_result2);
                        return true;
                    case 2:
                        data.enforceInterface(descriptor);
                        String _result3 = getContactName(data.readString());
                        reply.writeNoException();
                    ...
                    case 4:
                        data.enforceInterface(descriptor);
                        registerExpandListener(android.vrsystem.IVRListener.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case 5:
                        data.enforceInterface(descriptor);
                    ...
                    case 8:
                        data.enforceInterface(descriptor);
                        _result = getHelmetBattery();
                        reply.writeNoException();
                        reply.writeInt(_result);
                        return true;
                    case 9:
                        data.enforceInterface(descriptor);
                        _result = getHelmetBrightness();
                        reply.writeNoException();
                        reply.writeInt(_result);
                        return true;
                    case 10:
