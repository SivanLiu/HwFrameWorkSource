...
public interface INetworkServiceCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements INetworkServiceCallback {
        ...
        private static class Proxy implements INetworkServiceCallback {
            ...
            public void onGetNetworkRegistrationStateComplete(int result, NetworkRegistrationState state) throws RemoteException {
            ...
            if (code != IBinder.INTERFACE_TRANSACTION) {
                switch (code) {
                    case 1:
                        ...
                        if (data.readInt() != 0) {
                            _arg1 = (NetworkRegistrationState) NetworkRegistrationState.CREATOR.createFromParcel(data);
                        } else {
                            _arg1 = null;
                        }
