...
public class TelephonyManager {
    ...
    static {
        boolean z = false;
        if (SystemProperties.get("ro.config.hw_opta", WifiEnterpriseConfig.ENGINE_DISABLE).equals("92") && SystemProperties.get("ro.config.hw_optb", WifiEnterpriseConfig.ENGINE_DISABLE).equals("156")) {
            z = true;
        }
        IS_CHINA_TELECOM = z;
    }
    ...
    public CellLocation getCellLocation() {
        ...
        try {
            ...
            stringBuilder.append("getCellLocation calling app is ");
            ...
            str = TAG;
            stringBuilder = new StringBuilder();
            stringBuilder.append("getCellLocation returning null due to NullPointerException ");
    ...
    public List<NeighboringCellInfo> getNeighboringCellInfo() {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("getNeighboringCellInfo calling app is ");
        stringBuilder.append(callingAppName);
        Log.d(str, stringBuilder.toString());
        try {
            ITelephony telephony = getITelephony();
            if (telephony == null) {
    ...
    private int getSimStateIncludingLoaded() {
        ...
        String str2 = TAG;
        StringBuilder stringBuilder2 = new StringBuilder();
        stringBuilder2.append("getSimState: default sim:");
    ...
    public String getSimSerialNumber(int subId) {
        try {
            ...
            String substring = (!SUPPORT_19BIT_ICCID || iccid == null || iccid.length() < 19) ? iccid : iccid.substring(0, 19);
            return substring;
        } catch (RemoteException e) {
            return null;
        } catch (NullPointerException e2) {
    ...
    public String getLine1Number(int subId) {
        ...
        try {
            ...
            number = info.getLine1NumberForSubscriber(subId, this.mContext.getOpPackageName());
            if (this.mCust != null && this.mCust.isVZW() && getPhoneType() == 1) {
                return this.mCust.getVZWLine1Number(subId, number, getSimOperator());
            }
            return number;
    ...
    public List<CellInfo> getAllCellInfo() {
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("getAllCellInfo calling app is ");
            stringBuilder.append(getOpPackageName());
            Log.d(str, stringBuilder.toString());
    ...
    public static void setTelephonyProperty(int phoneId, String property, String value) {
        ...
        if (SubscriptionManager.isValidPhoneId(phoneId)) {
            ...
            if (propVal.length() > 91) {
                str = TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append("setTelephonyProperty: property too long phoneId=");
        ...
        str = TAG;
        stringBuilder = new StringBuilder();
        stringBuilder.append("setTelephonyProperty: invalid phoneId=");
        stringBuilder.append(phoneId);
        stringBuilder.append(" property=");
        stringBuilder.append(property);
        stringBuilder.append(" value: ");
    ...
    private static String updatePreferNetworkModeValArray(String v, String name) {
        ...
        StringBuilder stringBuilder;
        try {
            if (Global.PREFERRED_NETWORK_MODE.equals(name)) {
                if (getDefault().isMultiSimEnabled()) {
                    String str2 = TAG;
                    StringBuilder stringBuilder2 = new StringBuilder();
                    stringBuilder2.append("updatePreferNetworkModeValArray: v = ");
                    ...
                    if (v != null) {
                        ...
                        if (1 == valArray.length) {
                            ...
                            if (subId == 0) {
                                stringBuilder = new StringBuilder();
                                stringBuilder.append(valArray[0]);
                                stringBuilder.append(",1");
                                vNew = stringBuilder.toString();
                            } else if (1 == subId) {
                                stringBuilder = new StringBuilder();
                                stringBuilder.append("1,");
                                stringBuilder.append(valArray[0]);
                            ...
                            String str3 = TAG;
                            StringBuilder stringBuilder3 = new StringBuilder();
                            stringBuilder3.append("updatePreferNetworkModeValArray: vNew = ");
                            stringBuilder3.append(vNew);
            ...
            str = TAG;
            stringBuilder = new StringBuilder();
            stringBuilder.append("updatePreferNetworkModeValArray NPE: ");
            stringBuilder.append(ex);
            Rlog.d(str, stringBuilder.toString());
        } catch (Exception ex2) {
            str = TAG;
            stringBuilder = new StringBuilder();
            stringBuilder.append("updatePreferNetworkModeValArray Exception: ");
            stringBuilder.append(ex2);
            Rlog.d(str, stringBuilder.toString());
        }
        return vNew;
        ...
        if (index == Integer.MAX_VALUE) {
            ...
            if (valArray != null) {
                for (i = index + 1; i < valArray.length; i++) {
                    ...
                    stringBuilder.append(",");
                    stringBuilder.append(valArray[i]);
    ...
    public boolean isResolvingImsBinding() {
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("isResolvingImsBinding, RemoteException: ");
            stringBuilder.append(e.getMessage());
            Rlog.e(str, stringBuilder.toString());
        }
        return false;
    ...
    public void sendUssdRequest(String ussdRequest, final UssdResponseCallback callback, Handler handler) {
        ...
        ResultReceiver wrappedCallback = new ResultReceiver(handler) {
            protected void onReceiveResult(int resultCode, Bundle ussdResponse) {
                String str = TelephonyManager.TAG;
                StringBuilder stringBuilder = new StringBuilder();
    ...
    public void setDataEnabledProperties(String appName, boolean enable) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setDataEnabledProperties: appName=");
    ...
    private String getBasebandVersionLegacy(int phoneId) {
        ...
        prop.append("gsm.version.baseband");
