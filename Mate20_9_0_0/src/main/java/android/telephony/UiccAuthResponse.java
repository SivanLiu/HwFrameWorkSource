...
public class UiccAuthResponse implements Parcelable {
    ...
    public static final Creator<UiccAuthResponse> CREATOR = new Creator<UiccAuthResponse>() {
        public UiccAuthResponse createFromParcel(Parcel in) {
            return new UiccAuthResponse(in, null);
        }
    ...
    /* synthetic */ UiccAuthResponse(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
