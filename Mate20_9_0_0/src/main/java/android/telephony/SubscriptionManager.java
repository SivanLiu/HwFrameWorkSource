...
public class SubscriptionManager {
    ...
    public SubscriptionInfo getActiveSubscriptionInfo(int subId) {
        ...
        stringBuilder.append("[getActiveSubscriptionInfo]+ subId=");
    ...
    public SubscriptionInfo getActiveSubscriptionInfoForIccIndex(String iccId) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("[getActiveSubscriptionInfoForIccIndex]+ iccId=");
    ...
    public SubscriptionInfo getActiveSubscriptionInfoForSimSlotIndex(int slotIndex) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("[getActiveSubscriptionInfoForSimSlotIndex]+ slotIndex=");
    ...
    public Uri addSubscriptionInfoRecord(String iccId, int slotIndex) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("[addSubscriptionInfoRecord]+ iccId:");
        stringBuilder.append(SubscriptionInfo.givePrintableIccid(iccId));
        stringBuilder.append(" slotIndex:");
        stringBuilder.append(slotIndex);
        logd(stringBuilder.toString());
    ...
    public int setDisplayName(String displayName, int subId, long nameSource) {
        ...
        stringBuilder.append(this.mContext != null ? this.mContext.getOpPackageName() : "");
    ...
    public static int getDefaultVoiceSubscriptionId() {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("getDefaultVoiceSubscriptionId, sub id = ");
        stringBuilder.append(subId);
        logd(stringBuilder.toString());
        return subId;
    }
    ...
    public void setDefaultVoiceSubId(int subId) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setDefaultVoiceSubId sub id = ");
        stringBuilder.append(subId);
        logd(stringBuilder.toString());
        try {
            ISub iSub = ISub.Stub.asInterface(ServiceManager.getService("isub"));
    ...
    public static int getDefaultSmsSubscriptionId() {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("getDefaultSmsSubscriptionId, sub id = ");
        stringBuilder.append(subId);
        logd(stringBuilder.toString());
        return subId;
    }
    ...
    public void setDefaultSmsSubId(int subId) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setDefaultSmsSubId sub id = ");
        stringBuilder.append(subId);
        logd(stringBuilder.toString());
        try {
            ISub iSub = ISub.Stub.asInterface(ServiceManager.getService("isub"));
    ...
    public void setDefaultDataSubId(int subId) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setDataSubscription sub id = ");
        stringBuilder.append(subId);
        logd(stringBuilder.toString());
        try {
            ISub iSub = ISub.Stub.asInterface(ServiceManager.getService("isub"));
    ...
    public static void putPhoneIdAndSubIdExtra(Intent intent, int phoneId, int subId) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("putPhoneIdAndSubIdExtra: phoneId=");
    ...
    public void setSubscriptionOverrideUnmetered(int subId, boolean overrideUnmetered, long timeoutMillis) {
        boolean overrideValue = overrideUnmetered;
        try {
