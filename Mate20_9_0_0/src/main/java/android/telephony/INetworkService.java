        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != IBinder.INTERFACE_TRANSACTION) {
                switch (code) {
                    ...
                    case 3:
                        data.enforceInterface(descriptor);
                        getNetworkRegistrationState(data.readInt(), data.readInt(), android.telephony.INetworkServiceCallback.Stub.asInterface(data.readStrongBinder()));
                        return true;
                    case 4:
                        data.enforceInterface(descriptor);
                        registerForNetworkRegistrationStateChanged(data.readInt(), android.telephony.INetworkServiceCallback.Stub.asInterface(data.readStrongBinder()));
                        return true;
                    case 5:
                        data.enforceInterface(descriptor);
                        unregisterForNetworkRegistrationStateChanged(data.readInt(), android.telephony.INetworkServiceCallback.Stub.asInterface(data.readStrongBinder()));
                        return true;
                    default:
