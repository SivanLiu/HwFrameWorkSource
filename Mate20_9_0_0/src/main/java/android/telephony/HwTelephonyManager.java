...
public class HwTelephonyManager {
    ...
    /* renamed from: android.telephony.HwTelephonyManager$1 */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                $SwitchMap$android$telephony$TelephonyManager$MultiSimVariants[MultiSimVariants.UNKNOWN.ordinal()] = 4;
    ...
    private static class HwPhoneCallback extends PhoneCallback {
        ...
        public void onCallback1(int param) {
            if (this.mHwPhoneCallBackInterface != null) {
                this.mHwPhoneCallBackInterface.onCallback1(param);
            }
        }

        public void onCallback2(int param1, int param2) {
            if (this.mHwPhoneCallBackInterface != null) {
                this.mHwPhoneCallBackInterface.onCallback2(param1, param2);
            }
        }

        public void onCallback3(int param1, int param2, Bundle param3) {
            if (this.mHwPhoneCallBackInterface != null) {
                this.mHwPhoneCallBackInterface.onCallback3(param1, param2, param3);
            }
        }
    ...
    public MultiSimVariantsEx getMultiSimConfiguration() {
        switch (AnonymousClass1.$SwitchMap$android$telephony$TelephonyManager$MultiSimVariants[TelephonyManager.getDefault().getMultiSimConfiguration().ordinal()]) {
            case 1:
    ...
    public boolean setNetworkSelectionModeManual(int subId, OperatorInfo operator, boolean persistSelection) {
        return TelephonyManager.getDefault().setNetworkSelectionModeManual(subId, operator.getOperatorNumeric(), persistSelection);
    }
    ...
    public static int answerRingingCallForSubscriber(int subId) {
        try {
            ITelephony iTelephony = Stub.asInterface(ServiceManager.getService("phone"));
            if (iTelephony == null) {
                return -1;
            }
            iTelephony.answerRingingCallForSubscriber(subId);
            return 1;
    ...
    public boolean registerForAntiFakeBaseStation(HwPhoneCallBackInterface callback) {
        if (this.mHwPhoneCallback == null) {
            this.mHwPhoneCallback = new HwPhoneCallback();
        }
    ...
    public boolean unregisterForAntiFakeBaseStation() {
        if (this.mHwPhoneCallback != null) {
            this.mHwPhoneCallback.setHwPhoneCallBack(null);
        }
