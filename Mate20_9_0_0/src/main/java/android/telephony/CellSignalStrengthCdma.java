...
public final class CellSignalStrengthCdma extends CellSignalStrength implements Parcelable {
    ...
    /* synthetic */ CellSignalStrengthCdma(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
    ...
    public CellSignalStrengthCdma(int cdmaDbm, int cdmaEcio, int evdoDbm, int evdoEcio, int evdoSnr) {
        ...
        int i2 = (cdmaDbm <= 0 || cdmaDbm >= 120) ? Integer.MAX_VALUE : -cdmaDbm;
        this.mCdmaDbm = i2;
        int i3 = (cdmaEcio <= 0 || cdmaEcio >= 160) ? Integer.MAX_VALUE : -cdmaEcio;
        this.mCdmaEcio = i3;
        int i4 = (evdoDbm <= 0 || evdoDbm >= 120) ? Integer.MAX_VALUE : -evdoDbm;
        this.mEvdoDbm = i4;
        i4 = (evdoEcio <= 0 || evdoEcio >= 160) ? Integer.MAX_VALUE : -evdoEcio;
        this.mEvdoEcio = i4;
