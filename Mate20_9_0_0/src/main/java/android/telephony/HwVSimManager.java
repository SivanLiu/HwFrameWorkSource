...
public class HwVSimManager {
    ...
    public int enableVSim(int operation, String imsi, int cardtype, int apntype, String acqorder, String challenge) {
        ...
        stringBuilder2.append("enableVSim finish, result is ");
    ...
    public boolean disableVSim() {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("disableVSim finish, result is ");
    ...
    public boolean dsFlowCfg(int repFlag, int threshold, int totalThreshold, int oper) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("dsFlowCfg, repFlag = ");
        stringBuilder.append(repFlag);
        stringBuilder.append(", threshold = ");
        stringBuilder.append(threshold);
        stringBuilder.append(", totalThreshold = ");
        stringBuilder.append(totalThreshold);
    ...
    public int enableVSim(int operation, String imsi, int cardtype, int apntype, String acqorder, String tapath, int vsimloc, String challenge) {
        ...
        int result = 3;
        try {
            result = getIHwVSim().enableVSimV2(i, imsi, i2, i3, str2, tapath, i4, challenge);
        } catch (RemoteException ex) {
            printExLogIfSupportVSim(ex);
        }
        str = TAG;
    ...
    public int dialupForVSim() {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("dialupForVSim finish, result is ");
        stringBuilder.append(result);
        Rlog.d(str, stringBuilder.toString());
        return result;
    }
