...
public class SubscriptionInfo implements Parcelable {
    public static final Creator<SubscriptionInfo> CREATOR = new Creator<SubscriptionInfo>() {
        public SubscriptionInfo createFromParcel(Parcel source) {
            ...
            return new SubscriptionInfo(id, iccId, simSlotIndex, displayName, carrierName, nameSource, iconTint, number, dataRoaming, (Bitmap) Bitmap.CREATOR.createFromParcel(parcel), mcc, mnc, source.readString(), source.readBoolean(), (UiccAccessRule[]) parcel.createTypedArray(UiccAccessRule.CREATOR), source.readString(), status, nwMode);
        }
    ...
    public String toString() {
        ...
        stringBuilder.append(cardIdToPrint);
        stringBuilder.append(" mSubStatus=");
        stringBuilder.append(this.mStatus);
        stringBuilder.append(" mNwMode=");
        stringBuilder.append(this.mNwMode);
