...
public final class DataProfile implements Parcelable {
    ...
    public String toString() {
        ...
        stringBuilder.append("/");
        stringBuilder.append(this.mSupportedApnTypesBitmap);
        stringBuilder.append("/");
        stringBuilder.append(this.mRoamingProtocol);
        stringBuilder.append("/");
        stringBuilder.append(this.mBearerBitmap);
        stringBuilder.append("/");
        stringBuilder.append(this.mMtu);
        stringBuilder.append("/");
        stringBuilder.append(this.mMvnoType);
        stringBuilder.append("/");
        stringBuilder.append(this.mMvnoMatchData);
        stringBuilder.append("/");
        stringBuilder.append(this.mModemCognitive);
