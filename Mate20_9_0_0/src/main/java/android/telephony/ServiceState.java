...
public class ServiceState implements Parcelable {
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        out.writeInt(this.mIsDataRoamingFromRegistration);
        out.writeInt(this.mIsUsingCarrierAggregation);
    ...
    public int hashCode() {
        int i = 0;
        int hashCode = (((((((((((this.mVoiceRegState * 31) + (this.mDataRegState * 37)) + this.mVoiceRoamingType) + this.mDataRoamingType) + this.mChannelNumber) + Arrays.hashCode(this.mCellBandwidths)) + this.mIsManualNetworkSelection) + (this.mVoiceOperatorAlphaLong == null ? 0 : this.mVoiceOperatorAlphaLong.hashCode())) + (this.mVoiceOperatorAlphaShort == null ? 0 : this.mVoiceOperatorAlphaShort.hashCode())) + (this.mVoiceOperatorNumeric == null ? 0 : this.mVoiceOperatorNumeric.hashCode())) + (this.mDataOperatorAlphaLong == null ? 0 : this.mDataOperatorAlphaLong.hashCode())) + (this.mDataOperatorAlphaShort == null ? 0 : this.mDataOperatorAlphaShort.hashCode());
        if (this.mDataOperatorNumeric != null) {
            i = this.mDataOperatorNumeric.hashCode();
        }
        return ((((hashCode + i) + this.mCdmaRoamingIndicator) + this.mCdmaDefaultRoamingIndicator) + this.mIsEmergencyOnly) + this.mIsDataRoamingFromRegistration;
    }
    ...
    public String toString() {
        ...
        stringBuilder2.append(rilServiceStateToString(this.mVoiceRegState));
        stringBuilder2.append(")");
        ...
        stringBuilder2.append("(");
        stringBuilder2.append(rilServiceStateToString(this.mDataRegState));
        stringBuilder2.append(")");
        stringBuilder.append(stringBuilder2.toString());
        stringBuilder.append(", mChannelNumber=");
        stringBuilder.append(this.mChannelNumber);
        stringBuilder.append(", duplexMode()=");
        stringBuilder.append(getDuplexMode());
        stringBuilder.append(", mCellBandwidths=");
        stringBuilder.append(Arrays.toString(this.mCellBandwidths));
        stringBuilder.append(", mVoiceRoamingType=");
        stringBuilder.append(getRoamingLogString(this.mVoiceRoamingType));
        stringBuilder.append(", mDataRoamingType=");
        stringBuilder.append(getRoamingLogString(this.mDataRoamingType));
        ...
        stringBuilder.append(this.mIsManualNetworkSelection ? "(manual)" : "(automatic)");
        stringBuilder.append(", mRilVoiceRadioTechnology=");
        stringBuilder.append(this.mRilVoiceRadioTechnology);
        stringBuilder2 = new StringBuilder();
        stringBuilder2.append("(");
        stringBuilder2.append(rilRadioTechnologyToString(this.mRilVoiceRadioTechnology));
        stringBuilder2.append(")");
        stringBuilder.append(stringBuilder2.toString());
        stringBuilder.append(", mRilDataRadioTechnology=");
        stringBuilder.append(this.mRilDataRadioTechnology);
        stringBuilder2 = new StringBuilder();
        stringBuilder2.append("(");
        stringBuilder2.append(rilRadioTechnologyToString(this.mRilDataRadioTechnology));
        stringBuilder2.append(")");
        stringBuilder.append(stringBuilder2.toString());
        stringBuilder.append(", mCssIndicator=");
        stringBuilder.append(this.mCssIndicator ? "supported" : "unsupported");
        ...
        stringBuilder.append(", mIsDataRoamingFromRegistration=");
        stringBuilder.append(this.mIsDataRoamingFromRegistration);
        stringBuilder.append(", mIsUsingCarrierAggregation=");
        stringBuilder.append(this.mIsUsingCarrierAggregation);
        stringBuilder.append(", mLteEarfcnRsrpBoost=");
        stringBuilder.append(this.mLteEarfcnRsrpBoost);
        stringBuilder.append(", mNetworkRegistrationStates=");
        stringBuilder.append(this.mNetworkRegistrationStates);
    ...
    public static boolean isGsm(int radioTechnology) {
        return radioTechnology == 1 || radioTechnology == 2 || radioTechnology == 3 || radioTechnology == 9 || radioTechnology == 10 || radioTechnology == 11 || radioTechnology == 14 || radioTechnology == 15 || radioTechnology == 16 || radioTechnology == 17 || radioTechnology == 18 || radioTechnology == 19 || radioTechnology == 30 || radioTechnology == 18;
    }
    ...
    public static int getBitmaskFromString(String bearerList) {
        ...
        while (bearerBitmask2 < length) {
            int bearerInt = 0;
            try {
                bearerInt = Integer.parseInt(bearers[bearerBitmask2].trim());
                if (bearerInt == 0) {
                    return 0;
                }
        ...
        if (regState != null) {
            synchronized (this.mNetworkRegistrationStates) {
                for (int i = 0; i < this.mNetworkRegistrationStates.size(); i++) {
                    NetworkRegistrationState curRegState = (NetworkRegistrationState) this.mNetworkRegistrationStates.get(i);
