...
public final class TelephonyHistogram implements Parcelable {
    ...
    public String toString() {
        ...
        int i = 0;
        for (int append : this.mBucketEndPoints) {
        ...
        while (i < this.mBucketCounters.length) {
            StringBuilder stringBuilder2 = new StringBuilder();
            stringBuilder2.append(WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER);
            stringBuilder2.append(this.mBucketCounters[i]);
            intervals.append(stringBuilder2.toString());
            i++;
        }
        StringBuilder stringBuilder3 = new StringBuilder();
        stringBuilder3.append(basic);
        stringBuilder3.append(intervals);
