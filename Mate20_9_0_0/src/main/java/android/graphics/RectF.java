...
public class RectF implements Parcelable {
    ...
    public int hashCode() {
        int i = 0;
        int result = 31 * ((31 * ((31 * (this.left != 0.0f ? Float.floatToIntBits(this.left) : 0)) + (this.top != 0.0f ? Float.floatToIntBits(this.top) : 0))) + (this.right != 0.0f ? Float.floatToIntBits(this.right) : 0));
        if (this.bottom != 0.0f) {
