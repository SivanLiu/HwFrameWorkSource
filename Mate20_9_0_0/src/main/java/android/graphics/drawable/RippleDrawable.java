...
public class RippleDrawable extends LayerDrawable {
    ...
    private void tryRippleEnter() {
        if (this.mExitingRipplesCount < 10) {
            if (this.mRipple == null) {
                ...
                this.mRipple = new RippleForeground(this, this.mHotspotBounds, x, f, this.mForceSoftware);
            }
    ...
    Paint getRipplePaint() {
        ...
        if (Color.alpha(color) > 128) {
            color = (AdvertisingSetParameters.INTERVAL_MAX & color) | Integer.MIN_VALUE;
        }
