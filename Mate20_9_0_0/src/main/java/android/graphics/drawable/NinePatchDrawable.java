...
public class NinePatchDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        if (needsDensityScaling) {
            restoreToCount = -1 >= null ? -1 : canvas.save();
        ...
        if (srcResId != 0) {
            ...
            if (bitmap == null || bitmap.getNinePatchChunk() == null) {
                try {
                    ...
                    bitmap = ImageDecoder.decodeBitmap(ImageDecoder.createSource(r, is, density), new -$$Lambda$NinePatchDrawable$yQvfm7FAkslD5wdGFysjgwt8cLE(padding));
                    is.close();
                } catch (IOException e) {
                }
            }
    ...
    static /* synthetic */ void lambda$updateStateFromTypedArray$0(Rect padding, ImageDecoder decoder, ImageInfo info, Source src) {
