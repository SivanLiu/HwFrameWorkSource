...
public class BitmapDrawable extends Drawable {
    ...
    public BitmapDrawable(Resources res, String filepath) {
        ...
        try {
            ...
            bitmap = ImageDecoder.decodeBitmap(ImageDecoder.createSource(res, stream), -$$Lambda$BitmapDrawable$23eAuhdkgEf5MIRJC-rMNbn4Pyg.INSTANCE);
        ...
        if (bitmap != null) {
            ...
            if (state.mRebuildShader) {
                ...
                if (tmx == null && tmy == null) {
                    ...
                    paint.setShader(new BitmapShader(bitmap, tileMode, tmy == null ? TileMode.CLAMP : tmy));
                }
