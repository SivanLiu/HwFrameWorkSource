    ...
    public static abstract class Stub extends Binder implements IHwSysResManager {
        ...
        private static class Proxy implements IHwSysResManager {
            ...
            public Bundle getTypeTopN(int[] appTypes) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(Stub.TRANSACTION_getTypeTopN, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (i != 1598968902) {
                ...
                IDeviceSettingCallback _arg12;
                switch (i) {
                    case 1:
                        parcel.enforceInterface(descriptor);
                        ResourceConfig[] _result5 = getResourceConfig(data.readInt());
                    ...
                    case 2:
                        ...
                        recordResourceOverloadStatus(_arg03, _arg13, _arg22, _arg33, _arg4, _arg5, _arg6);
                        reply.writeNoException();
                        return true;
                    case 3:
                        parcel.enforceInterface(descriptor);
                    ...
                    case 4:
                        ...
                        IContentObserver _arg23 = android.database.IContentObserver.Stub.asInterface(data.readStrongBinder());
                        if (data.readInt() != 0) {
                            _arg32 = (Bundle) Bundle.CREATOR.createFromParcel(parcel);
                        }
                        int _result6 = acquireSysRes(_arg0, _arg14, _arg23, _arg32);
                        reply.writeNoException();
                    ...
                    case 5:
                        ...
                        notifyResourceStatus(_arg0, _arg1, _arg24, _arg32);
                        reply.writeNoException();
                        return true;
                    case 6:
                        MultiTaskPolicy _arg15;
                        parcel.enforceInterface(descriptor);
                        _arg0 = data.readInt();
                        if (data.readInt() != 0) {
                            _arg15 = (MultiTaskPolicy) MultiTaskPolicy.CREATOR.createFromParcel(parcel);
                        }
                        dispatch(_arg0, _arg15);
                        reply.writeNoException();
                        return true;
                    case 7:
                        parcel.enforceInterface(descriptor);
                        if (data.readInt() != 0) {
                            _arg02 = (CollectData) CollectData.CREATOR.createFromParcel(parcel);
                        }
                        reportData(_arg02);
                        reply.writeNoException();
                        return true;
                    ...
                    case 13:
                        parcel.enforceInterface(descriptor);
                        _result = isResourceNeeded(data.readInt());
                        reply.writeNoException();
                    ...
                    case 14:
                        ...
                        parcel.enforceInterface(descriptor);
                        if (data.readInt() != 0) {
                            _arg04 = (RPolicyData) RPolicyData.CREATOR.createFromParcel(parcel);
                        }
                    ...
                    case 15:
                        parcel.enforceInterface(descriptor);
                        _arg0 = data.readInt();
                        List<DumpData> _arg16 = new ArrayList();
                        _result2 = getDumpData(_arg0, _arg16);
                        reply.writeNoException();
                    ...
                    case 16:
                        ...
                        _result3 = getStatisticsData(_arg05);
                        reply.writeNoException();
                        parcel2.writeInt(_result3);
                        parcel2.writeTypedList(_arg05);
                        return true;
                    case 17:
                        parcel.enforceInterface(descriptor);
                        ...
                        _arg1 = saveBigData(_result3, _arg3);
                        reply.writeNoException();
                    ...
                    case 18:
                        ...
                        String _result7 = fetchBigDataByVersion(_result3, _result2, _arg2, _arg3);
                        reply.writeNoException();
                        parcel2.writeString(_result7);
                        return true;
                    case 19:
                        parcel.enforceInterface(descriptor);
                        String _result8 = fetchDFTDataByVersion(data.readInt(), data.readInt(), data.readInt() != 0, data.readInt() != 0, data.readInt() != 0);
                        reply.writeNoException();
                    ...
                    case 21:
                        parcel.enforceInterface(descriptor);
                        _result = isFakeForegroundProcess(data.readString());
                        reply.writeNoException();
                        parcel2.writeInt(_result);
                        return true;
                    case 22:
                        parcel.enforceInterface(descriptor);
                        _arg3 = isEnableFakeForegroundControl();
                        reply.writeNoException();
                        parcel2.writeInt(_arg3);
                        return true;
                    case 23:
                        parcel.enforceInterface(descriptor);
                        _arg1 = getWhiteList(data.readInt(), data.readInt());
                        reply.writeNoException();
                        parcel2.writeString(_arg1);
                        return true;
                    case 24:
                        parcel.enforceInterface(descriptor);
                        _result = registerResourceUpdateCallback(android.rms.IUpdateWhiteListCallback.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        parcel2.writeInt(_result);
                        return true;
                    case 25:
                        parcel.enforceInterface(descriptor);
                        _result3 = getPid(data.readString());
                        reply.writeNoException();
                        parcel2.writeInt(_result3);
                        return true;
                    case 26:
                    ...
                    case 28:
                        parcel.enforceInterface(descriptor);
                        _result4 = getIAwareProtectList(data.readInt());
                        reply.writeNoException();
                        parcel2.writeStringList(_result4);
                        return true;
                    case 29:
                        parcel.enforceInterface(descriptor);
                        List<String> _result10 = getLongTimeRunningApps();
                        reply.writeNoException();
                        parcel2.writeStringList(_result10);
                        return true;
                    case 30:
                        parcel.enforceInterface(descriptor);
                        List<String> _result11 = getMostFrequentUsedApps(data.readInt(), data.readInt());
                        reply.writeNoException();
                        parcel2.writeStringList(_result11);
                        return true;
                    case 31:
                        parcel.enforceInterface(descriptor);
                        _result = registerProcessStateChangeObserver(android.rms.IProcessStateChangeObserver.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        parcel2.writeInt(_result);
                        return true;
                    case 32:
                        parcel.enforceInterface(descriptor);
                        _result = unRegisterProcessStateChangeObserver(android.rms.IProcessStateChangeObserver.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        parcel2.writeInt(_result);
                        return true;
                    case 33:
                    ...
                    case 34:
                        parcel.enforceInterface(descriptor);
                        long _result12 = getMemAvaliable();
                        reply.writeNoException();
                    ...
                    case 35:
                        ...
                        reportAppType(_arg06, _result2, _arg3, data.readInt());
                        reply.writeNoException();
                        return true;
                    case 36:
                        parcel.enforceInterface(descriptor);
                        ...
                        reportHabitData(_arg32);
                        reply.writeNoException();
                        return true;
                    case 37:
                        parcel.enforceInterface(descriptor);
                        List<MemRepairPkgInfo> _result13 = getMemRepairProcGroup(data.readInt());
                        reply.writeNoException();
                        parcel2.writeTypedList(_result13);
                        return true;
                    case 38:
                        parcel.enforceInterface(descriptor);
                        _result4 = getFrequentIM(data.readInt());
                        reply.writeNoException();
                        parcel2.writeStringList(_result4);
                        return true;
                    case 39:
                        parcel.enforceInterface(descriptor);
                        _arg2 = isVisibleWindow(data.readInt(), data.readString(), data.readInt());
                        reply.writeNoException();
                    ...
                    case 43:
                        parcel.enforceInterface(descriptor);
                        NetLocationStrategy _result14 = getNetLocationStrategy(data.readString(), data.readInt(), data.readInt());
                        reply.writeNoException();
                        if (_result14 != null) {
                            parcel2.writeInt(1);
                    ...
                    case TRANSACTION_registerSceneCallback /*44*/:
                        parcel.enforceInterface(descriptor);
                        boolean _result15 = registerSceneCallback(data.readStrongBinder(), data.readInt());
                        reply.writeNoException();
                        parcel2.writeInt(_result15);
                        return true;
                    case TRANSACTION_isScene /*45*/:
                        parcel.enforceInterface(descriptor);
                        _result = isScene(data.readInt());
                        reply.writeNoException();
                        parcel2.writeInt(_result);
                        return true;
                    case TRANSACTION_getHabitTopN /*46*/:
                        parcel.enforceInterface(descriptor);
                        _result4 = getHabitTopN(data.readInt());
                        reply.writeNoException();
                        parcel2.writeStringList(_result4);
                        return true;
                    case TRANSACTION_getTypeTopN /*47*/:
                        parcel.enforceInterface(descriptor);
                        Bundle _result16 = getTypeTopN(data.createIntArray());
                        reply.writeNoException();
                        if (_result16 != null) {
                            parcel2.writeInt(1);
                    ...
                    case 48:
                        parcel.enforceInterface(descriptor);
                        _arg0 = data.readInt();
                        _arg12 = android.rms.iaware.IDeviceSettingCallback.Stub.asInterface(data.readStrongBinder());
                        if (data.readInt() != 0) {
                            _arg32 = (Bundle) Bundle.CREATOR.createFromParcel(parcel);
                        }
                        registerDevModeMethod(_arg0, _arg12, _arg32);
                        reply.writeNoException();
                        return true;
                    case TRANSACTION_unregisterDevModeMethod /*49*/:
                        ...
                        unregisterDevModeMethod(_arg0, _arg12, _arg32);
                        reply.writeNoException();
                        return true;
                    default:
