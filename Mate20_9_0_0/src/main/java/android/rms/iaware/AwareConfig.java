...
public class AwareConfig implements Parcelable {
    ...
    public static class Item implements Parcelable {
        ...
        public String toString() {
            ...
            stringBuilder.append(this.mItemProperties);
            stringBuilder.append(", subItemList=");
            stringBuilder.append(this.mSubItemList);
    ...
    public static class SubItem implements Parcelable {
        ...
        public String toString() {
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("SubItem [name=");
    ...
    public String toString() {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("AwareConfigList [mItems=");
        stringBuilder.append(this.mItems);
        stringBuilder.append("]");
        return stringBuilder.toString();
    }
