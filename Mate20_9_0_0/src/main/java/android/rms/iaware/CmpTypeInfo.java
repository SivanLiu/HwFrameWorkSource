...
public class CmpTypeInfo implements Parcelable {
    ...
    public String toString() {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("CmpTypeInfo [type=");
        ...
        stringBuilder.append(", perception_count=");
        stringBuilder.append(this.perception_count);
        stringBuilder.append(", unperception_count=");
        stringBuilder.append(this.unperception_count);
        stringBuilder.append("]");
        return stringBuilder.toString();
    }
