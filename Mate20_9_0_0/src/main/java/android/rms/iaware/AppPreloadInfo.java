...
public class AppPreloadInfo implements Parcelable {
    ...
    public String toString() {
        ...
        stringBuilder.append("AppPreloadInfo [packageName=");
        stringBuilder.append(this.packageName);
        stringBuilder.append(", powerDissipation=");
        stringBuilder.append(this.powerDissipation);
        stringBuilder.append(", preloadMem=");
        stringBuilder.append(this.preloadMem);
        stringBuilder.append(", coldstartTime=");
        stringBuilder.append(this.coldstartTime);
        stringBuilder.append(", warmstartTime=");
        stringBuilder.append(this.warmstartTime);
