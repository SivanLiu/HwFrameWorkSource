...
public class Dialog implements DialogInterface, Callback, KeyEvent.Callback, OnCreateContextMenuListener, OnWindowDismissedCallback {
    ...
    private void layoutWhenGravityChanged() {
        ...
        try {
            ...
            stringBuilder.append("Dialog: RemoteException = ");
            stringBuilder.append(e);
            Log.e(str, stringBuilder.toString());
        } catch (Exception e2) {
            str = TAG;
            stringBuilder = new StringBuilder();
            stringBuilder.append("Dialog: layoutWhenGravityChanged cause Exception = ");
        ...
        while (true) {
            ...
            if (activity != null || context == null) {
                ...
                if (context instanceof ContextWrapper) {
                    componentName = ((ContextWrapper) context).getBaseContext();
                }
