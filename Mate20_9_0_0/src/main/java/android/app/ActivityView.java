...
public class ActivityView extends ViewGroup {
    ...
    public static abstract class StateCallback {
        ...
        public void onTaskMovedToFront(StackInfo stackInfo) {
        }
    }
    ...
    private class TaskStackListenerImpl extends TaskStackListener {
        ...
        private StackInfo getTopMostStackInfo() throws RemoteException {
            ...
            List<StackInfo> stackInfoList = ActivityView.this.mActivityManager.getAllStackInfos();
    ...
    private void initVirtualDisplay() {
        if (this.mVirtualDisplay == null) {
            ...
            this.mVirtualDisplay = displayManager.createVirtualDisplay(stringBuilder.toString(), width, height, getBaseDisplayDensity(), this.mSurface, 9);
            if (this.mVirtualDisplay == null) {
