...
class ExitTransitionCoordinator extends ActivityTransitionCoordinator {
    ...
    protected void notifyComplete() {
        ...
        stringBuilder.append("notifyComplete isReadyToNotify= ");
        stringBuilder.append(isReadyToNotify());
        stringBuilder.append(" mSharedElementNotified= ");
        stringBuilder.append(this.mSharedElementNotified);
