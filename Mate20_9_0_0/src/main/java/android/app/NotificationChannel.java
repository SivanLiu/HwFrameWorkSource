...
public final class NotificationChannel implements Parcelable {
    ...
    protected NotificationChannel(Parcel in) {
        ...
        this.mBypassDnd = in.readByte() != (byte) 0;
        ...
        this.mLights = in.readByte() != (byte) 0;
        this.mVibration = in.createLongArray();
        this.mUserLockedFields = in.readInt();
        this.mFgServiceShown = in.readByte() != (byte) 0;
        this.mVibrationEnabled = in.readByte() != (byte) 0;
        this.mShowBadge = in.readByte() != (byte) 0;
        if (in.readByte() != (byte) 0) {
            z = true;
        }
        this.mDeleted = z;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte(this.mBypassDnd);
        ...
        dest.writeByte(this.mLights);
        dest.writeLongArray(this.mVibration);
        dest.writeInt(this.mUserLockedFields);
        dest.writeByte(this.mFgServiceShown);
        dest.writeByte(this.mVibrationEnabled);
        dest.writeByte(this.mShowBadge);
        dest.writeByte(this.mDeleted);
        if (this.mGroup != null) {
            dest.writeByte((byte) 1);
    ...
    public void setVibrationPattern(long[] vibrationPattern) {
        boolean z = vibrationPattern != null && vibrationPattern.length > 0;
    ...
    private void populateFromXml(XmlPullParser parser, boolean forRestore, Context context) {
        boolean z = true;
        boolean z2 = (forRestore && context == null) ? false : true;
        Preconditions.checkArgument(z2, "forRestore is true but got null context");
    ...
    private void writeXml(XmlSerializer out, boolean forBackup, Context context) throws IOException {
        boolean z = (forBackup && context == null) ? false : true;
        Preconditions.checkArgument(z, "forBackup is true but got null context");
    ...
    public int hashCode() {
        int i = 0;
        int hashCode = 31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * (getId() != null ? getId().hashCode() : 0)) + (getName() != null ? getName().hashCode() : 0))) + (getDescription() != null ? getDescription().hashCode() : 0))) + getImportance())) + this.mBypassDnd)) + getLockscreenVisibility())) + (getSound() != null ? getSound().hashCode() : 0))) + this.mLights)) + getLightColor())) + Arrays.hashCode(this.mVibration))) + getUserLockedFields())) + this.mVibrationEnabled)) + this.mShowBadge)) + isDeleted())) + (getGroup() != null ? getGroup().hashCode() : 0));
        if (getAudioAttributes() != null) {
            i = getAudioAttributes().hashCode();
        }
        return (31 * (hashCode + i)) + isBlockableSystem();
    }
    ...
    public String toString() {
        ...
        stringBuilder.append(!TextUtils.isEmpty(this.mDesc) ? "hasDescription " : "");
