...
public class ActivityManager {
    ...
    public static class RecentTaskInfo implements Parcelable {
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeInt(this.supportsSplitScreenMultiWindow);
        ...
        public void readFromParcel(Parcel source) {
            ...
            this.taskDescription = source.readInt() > 0 ? (TaskDescription) TaskDescription.CREATOR.createFromParcel(source) : null;
            ...
            if (source.readInt() > 0) {
                rect = (Rect) Rect.CREATOR.createFromParcel(source);
            }
            this.bounds = rect;
            boolean z = true;
            if (source.readInt() != 1) {
    ...
    public static class RunningAppProcessInfo implements Parcelable {
        ...
        public static int procStateToImportanceForTargetSdk(int procState, int targetSdkVersion) {
            ...
            if (targetSdkVersion < 26) {
                ...
                if (importance == IMPORTANCE_CANT_SAVE_STATE) {
                    return 170;
                }
            }
            return importance;
    ...
    public static class TaskSnapshot implements Parcelable {
        ...
        public String toString() {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("TaskSnapshot{mSnapshot=");
    ...
    public static void noteAlarmFinish(PendingIntent ps, WorkSource workSource, int sourceUid, String tag) {
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("noteAlarmFinish fail for ");
