...
public class ActivityRelaunchItem extends ClientTransactionItem {
    public static final Creator<ActivityRelaunchItem> CREATOR = new Creator<ActivityRelaunchItem>() {
        public ActivityRelaunchItem createFromParcel(Parcel in) {
            return new ActivityRelaunchItem(in, null);
        }
    ...
    /* synthetic */ ActivityRelaunchItem(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
    ...
    public int hashCode() {
        return (31 * ((31 * ((31 * ((31 * ((31 * 17) + Objects.hashCode(this.mPendingResults))) + Objects.hashCode(this.mPendingNewIntents))) + this.mConfigChanges)) + Objects.hashCode(this.mConfig))) + this.mPreserveWindow;
    }
