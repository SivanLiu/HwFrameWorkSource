...
public class Activity extends ContextThemeWrapper implements Factory2, Callback, KeyEvent.Callback, OnCreateContextMenuListener, ComponentCallbacks2, OnWindowDismissedCallback, WindowControllerCallback, AutofillClient {
    ...
    public void setExitInfo(float pivotX, float pivotY, int iconWidth, int iconHeight, Bitmap iconBitmap, int flag) {
        try {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("pivotX = ");
            stringBuilder.append(pivotX);
            stringBuilder.append(", pivotY = ");
            stringBuilder.append(pivotY);
            stringBuilder.append(", iconWidth = ");
            stringBuilder.append(iconBitmap != null ? iconBitmap.getWidth() : iconWidth);
            stringBuilder.append(", iconHeight = ");
            stringBuilder.append(iconBitmap != null ? iconBitmap.getHeight() : iconHeight);
            stringBuilder.append(", iconWidth = ");
            stringBuilder.append(iconBitmap != null ? iconBitmap.getWidth() : iconWidth);
            ...
            stringBuilder2.append("setExitInfo failed: ");
            ...
            if (this.mDefaultKeyMode == 2) {
                ...
                if (event.getRepeatCount() != 0 || event.isSystem()) {
                    ...
                    if (handled && this.mDefaultKeySsb.length() > 0) {
                        ...
                        String str2 = Intent.ACTION_DIAL;
                        StringBuilder stringBuilder = new StringBuilder();
                        stringBuilder.append("tel:");
                        stringBuilder.append(str);
                        Intent intent = new Intent(str2, Uri.parse(stringBuilder.toString()));
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        if (Log.HWINFO && keyCode == 4 && event.getAction() == 1) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("dispatchKeyEvent keycode=");
            stringBuilder.append(keyCode);
            stringBuilder.append(" ,tracking=");
            stringBuilder.append(event.isTracking());
            stringBuilder.append(" ,canceled=");
            stringBuilder.append(event.isCanceled());
    ...
    public boolean onCreatePanelMenu(int featureId, Menu menu) {
        ...
        if ("com.android.gallery3d".equals(getPackageName())) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("onCreatePanelMenu for activity: ");
    ...
    public boolean onMenuItemSelected(int featureId, MenuItem item) {
        ...
        if (featureId == 0) {
            if (titleCondensed != null) {
                EventLog.writeEvent(SQLiteDatabase.SQLITE_MAX_LIKE_PATTERN_LENGTH, new Object[]{Integer.valueOf(0), titleCondensed.toString()});
            }
            ...
            if (titleCondensed != null) {
                EventLog.writeEvent(SQLiteDatabase.SQLITE_MAX_LIKE_PATTERN_LENGTH, new Object[]{Integer.valueOf(1), titleCondensed.toString()});
            }
        ...
        if (this.mCustActivity == null || !this.mCustActivity.isRequestSplit(this) || !this.mCustActivity.handleStartSplitActivity(intent)) {
            if (this.mParent == null) {
                ...
                if (HwSystemManager.canStartActivity(getApplicationContext(), intent)) {
                    ...
                    String str = TAG;
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("this app not allowed to StartActivity:");
    ...
    private void startIntentSenderForResultInner(IntentSender intent, String who, int requestCode, Intent fillInIntent, int flagsMask, int flagsValues, Bundle options) throws SendIntentException {
        ...
        Object obj = null;
        result = result.startActivityIntentSender(applicationThread, target, intent != null ? intent.getWhitelistToken() : null, intent2, str, this.mToken, who, requestCode, flagsMask, flagsValues, options);
        if (result != -96) {
    ...
    public PendingIntent createPendingResult(int requestCode, Intent data, int flags) {
        ...
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("createPendingResult catch RemoteException: ");
    ...
    public boolean navigateUpTo(Intent upIntent) {
        ...
        int resultCode;
        Intent resultData;
        Intent upIntent2 = upIntent.getComponent();
        if (upIntent2 == null) {
            upIntent2 = upIntent.resolveActivity(getPackageManager());
            if (upIntent2 == null) {
                return false;
            }
            upIntent = new Intent(upIntent);
            upIntent.setComponent(upIntent2);
        }
        Intent destInfo = upIntent2;
        upIntent2 = upIntent;
        synchronized (this) {
            resultCode = this.mResultCode;
            resultData = this.mResultData;
    ...
    final void performStart(String reason) {
        ...
        if (this.mCalled) {
            ...
            if (isAppDebuggable || isDlwarningEnabled) {
                ...
                if (dlwarning != null) {
                    ...
                    String warning2 = new StringBuilder();
                    warning2.append("Detected problems with app native libraries\n(please consult log for detail):\n");
                    warning2.append(dlwarning);
                    warning = warning2.toString();
                    if (isAppDebuggable) {
            ...
            if ((isAppDebuggable || isApiWarningEnabled) && !this.mMainThread.mHiddenApiWarningShown && VMRuntime.getRuntime().hasUsedHiddenApi()) {
                ...
                appName = getApplicationInfo().loadLabel(getPackageManager()).toString();
                warning = "Detected problems with API compatibility\n(visit g.co/dev/appcompat for more info)";
                if (isAppDebuggable) {
                    new AlertDialog.Builder(this).setTitle(appName).setMessage(warning).setPositiveButton(17039370, null).setCancelable(false).show();
                } else {
                    StringBuilder stringBuilder2 = new StringBuilder();
        ...
        stringBuilder3.append(this.mComponent.toShortString());
        stringBuilder3.append(" did not call through to super.onStart()");
    ...
    final void performRestart(boolean start, String reason) {
        ...
        if (this.mStopped) {
            ...
            if (!this.mCalled) {
                ...
                stringBuilder2.append(" did not call through to super.onRestart()");
