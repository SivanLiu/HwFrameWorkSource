...
public abstract class ClientTransactionHandler {
    ...
    public abstract void handleNewIntent(IBinder iBinder, List<ReferrerIntent> list, boolean z);
    ...
    public abstract ActivityClientRecord prepareRelaunchActivity(IBinder iBinder, List<ResultInfo> list, List<ReferrerIntent> list2, int i, MergedConfiguration mergedConfiguration, boolean z);
