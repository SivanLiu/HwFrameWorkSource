...
public class HwActivitySplitterImpl implements IHwActivitySplitterImpl {
    ...
    public void setControllerShowing(boolean showing) {
        if (Log.HWLog) {
            ...
            stringBuilder.append("set controller showing : ");
    ...
    private void adjustContentIndexView() {
        if (this.mContentIndexView != null && this.mContentIndexViewWeight > 0.0f && reachSplitSize()) {
            ...
            if (Log.HWLog) {
                String str = TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("Adjust content index view, set width to ");
                stringBuilder.append(lp.width);
                Log.i(str, stringBuilder.toString());
            }
    ...
    public boolean needSplitActivity(Intent intent) {
        boolean split = false;
        if (intent != null) {
            boolean z = ((intent.getHwFlags() & 4) == 0 || (needCancelSplit(intent) && (intent.getIntExtra(EXTRA_SPLIT_MODE, 0) & 8) == 0)) ? false : true;
            split = z;
    ...
    private void checkSecondStage(Intent intent) {
        if (intent != null) {
            ...
            if (Log.HWLog) {
                String str = TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("Is second stage ? ");
                stringBuilder.append(this.mIsSecondStageActivity);
                Log.i(str, stringBuilder.toString());
            }
        }
    }
    ...
    private void setActionBarButton(boolean enable) {
        if (isBaseActivityNeedExit()) {
            View abLayout = getActionBarView();
            if (abLayout != null) {
                View up = abLayout.findViewById(16909498);
                if (up != null) {
    ...
    private String getCompName(Intent intent) {
        ...
        if (compName == null) {
            ...
            str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("get fragment name ");
            ...
            this.mSplitHandler = new Handler() {
                public void handleMessage(Message msg) {
                    if (msg.what == 1) {
                        ...
                        if (Log.HWLog) {
                            String str = HwActivitySplitterImpl.TAG;
                            StringBuilder stringBuilder = new StringBuilder();
                            stringBuilder.append("Is top ? ");
                            stringBuilder.append(isTop);
                            stringBuilder.append(", activity is ");
                            stringBuilder.append(HwActivitySplitterImpl.this.mActivity);
                            Log.i(str, stringBuilder.toString());
                        }
                        if (!isTop) {
                            return;
        ...
        if (this.mIsSplitBaseActivity) {
            ...
            if (currentSubIntent != null && (this.mResumed || this.mActivity.isInMultiWindowMode())) {
                ...
                if (Log.HWLog) {
                    ...
                    stringBuilder.append("fromConfigChange ? ");
                    stringBuilder.append(fromConfigChange);
                    stringBuilder.append(", FirstTime start ? ");
                    stringBuilder.append(mFirstTimeStart);
                    stringBuilder.append(", mRestart ?");
                    stringBuilder.append(this.mRestart);
                    Log.i(str, stringBuilder.toString());
                }
                this.mRestart = false;
                ...
                if (start) {
                    ...
                    if (reachSplitSize()) {
                        ...
                        try {
                            ...
                            str = TAG;
                            stringBuilder = new StringBuilder();
                            stringBuilder.append("startActivity Fail, ");
        ...
        if (reachSplitSize()) {
            ...
            if (r != null) {
                ...
                if (Log.HWLog) {
                    ...
                    stringBuilder.append(r.left);
                    stringBuilder.append(", right ");
                    stringBuilder.append(r.right);
                    stringBuilder.append(", top ");
                    stringBuilder.append(r.top);
                    stringBuilder.append(", bottom ");
                    stringBuilder.append(r.bottom);
                ...
                int contentWidth = (int) ((this.mContentWindowWeight * ((float) winWidth)) + 1056964608);
                if (isRtlLocale()) {
                    lp.x = 0;
                } else {
    ...
    public void adjustWindow(int width) {
        ...
        if (Log.HWLog) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Adjust content view, set width to ");
            stringBuilder.append(lp.width);
            Log.i(str, stringBuilder.toString());
        }
        this.mActivity.getWindow().setAttributes(lp);
    ...
    private int getCurrentWindowWidth() {
        ...
        if (Log.HWLog) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Get current window width is ");
            stringBuilder.append(this.mWinSize.x);
            Log.i(str, stringBuilder.toString());
        }
    ...
    private boolean isInUnsplittableList(Intent intent) {
        ...
        if (Log.HWLog) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Unsplittable intent ");
    ...
    public void setSplittableIfNeeded(Intent intent) {
        ...
        if (intent == null) {
            str = TAG;
            stringBuilder = new StringBuilder();
            stringBuilder.append("Intent null when set splittable.");
            stringBuilder.append(this.mActivity);
            Log.e(str, stringBuilder.toString());
            return;
        }
        ...
        if (this.mIsSplitBaseActivity) {
            if (Log.HWLog) {
                str = TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append("Need split for intent ");
                stringBuilder.append(intent);
                Log.i(str, stringBuilder.toString());
            }
            setSecondStageIntent(intent);
            ...
            if (Log.HWLog) {
                str = TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append("Set splittable for intent : ");
                stringBuilder.append(intent);
                Log.i(str, stringBuilder.toString());
            }
            deliverExtraInfo(intent);
    ...
    public void setResumed(boolean resumed) {
        if (this.mIsSplitBaseActivity || this.mIsSecondStageActivity) {
            ...
            if (Log.HWLog) {
                str = TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append("Set resumed to ");
            ...
            if (this.mIsSplitBaseActivity) {
                if (Log.HWLog) {
                    str = TAG;
                    stringBuilder = new StringBuilder();
                    stringBuilder.append("setResumed, Base window splitted? ");
                    stringBuilder.append(this.mAllSubFinished);
                    Log.i(str, stringBuilder.toString());
                }
    ...
    private void finishAssociatedActivities() {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Activity is already finishing : ");
        stringBuilder.append(this.mActivity);
    ...
    public boolean isRtlLocale() {
        ...
        if (Log.HWLog) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("CurrentLang is ");
            stringBuilder.append(currentLang);
            Log.i(str, stringBuilder.toString());
        }
        return currentLang.contains("ar") || currentLang.contains("fa") || currentLang.contains("iw") || currentLang.contains("ur");
    }
