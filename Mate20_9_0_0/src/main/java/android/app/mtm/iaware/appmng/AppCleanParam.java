...
public class AppCleanParam implements Parcelable {
    public static final Creator<AppCleanParam> CREATOR = new Creator<AppCleanParam>() {
        public AppCleanParam createFromParcel(Parcel in) {
            return new AppCleanParam(in, null);
        }
    ...
    public static class AppCleanInfo implements Parcelable {
        public static final Creator<AppCleanInfo> CREATOR = new Creator<AppCleanInfo>() {
        ...
        Integer mCleanType;
        String mPkgName;
        Integer mTaskId = Integer.valueOf(-1);
        Integer mUserid;
    ...
    public static class Builder {
        ...
        public AppCleanParam build() {
            return new AppCleanParam(this, null);
        }
    }
    ...
    public String toString() {
        ...
        stringBuilder.append(this.mKilledCount);
