...
public class HwAppStartupSettingFilter implements Parcelable, Cloneable {
    ...
    /* synthetic */ HwAppStartupSettingFilter(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
    ...
    public String toString() {
        ...
        sb.append(" policy:");
        sb.append(Arrays.toString(this.mPolicy));
        sb.append(" modifier:");
        sb.append(Arrays.toString(this.mModifier));
        sb.append(" show:");
        sb.append(Arrays.toString(this.mShow));
        return sb.toString();
    }
