            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    case 1:
                        ...
                        Intent _arg02 = _arg0;
                        getInstantAppResolveInfoList(_arg02, data.createIntArray(), data.readString(), data.readInt(), android.os.IRemoteCallback.Stub.asInterface(data.readStrongBinder()));
                        return true;
                    case 2:
                        parcel.enforceInterface(descriptor);
                        if (data.readInt() != 0) {
                        ...
                        getInstantAppIntentFilterList(_arg0, data.createIntArray(), data.readString(), android.os.IRemoteCallback.Stub.asInterface(data.readStrongBinder()));
                        return true;
                    default:
