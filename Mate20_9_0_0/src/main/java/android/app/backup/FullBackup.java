...
public class FullBackup {
    ...
    public static class BackupScheme {
        ...
        public void parseBackupSchemeFromXmlLocked(XmlPullParser parser, Set<PathWithRequiredFlags> excludes, Map<String, Set<PathWithRequiredFlags>> includes) throws IOException, XmlPullParserException {
                    ...
                    if (next == 1) {
                        ...
                        if (domainDirectory != null) {
                            ...
                            if (canonicalFile != null) {
                                ...
                                if (Log.isLoggable(FullBackup.TAG_XML_PARSER, 2)) {
                                    str2 = FullBackup.TAG_XML_PARSER;
                                    StringBuilder stringBuilder2 = new StringBuilder();
                                    stringBuilder2.append("...parsed ");
                                    stringBuilder2.append(canonicalFile.getCanonicalPath());
                                    stringBuilder2.append(" for domain \"");
                                    stringBuilder2.append(domainFromXml);
                                ...
                                if ("database".equals(domainFromXml) && !canonicalFile.isDirectory()) {
                                    ...
                                    str2.append(canonicalFile.getCanonicalPath());
                                    str2.append("-journal");
                                    str2 = str2.toString();
                                    activeSet.add(new PathWithRequiredFlags(str2, requiredFlags));
                                    if (Log.isLoggable(FullBackup.TAG_XML_PARSER, 2)) {
                                        str3 = FullBackup.TAG_XML_PARSER;
                                        stringBuilder = new StringBuilder();
                                        stringBuilder.append("...automatically generated ");
                                        stringBuilder.append(str2);
                                        stringBuilder.append(". Ignore if nonexistent.");
                                        Log.v(str3, stringBuilder.toString());
                                    }
                                    str3 = new StringBuilder();
                                    str3.append(canonicalFile.getCanonicalPath());
                                    str3.append("-wal");
                                    str3 = str3.toString();
                                    activeSet.add(new PathWithRequiredFlags(str3, requiredFlags));
                                    if (Log.isLoggable(FullBackup.TAG_XML_PARSER, 2)) {
                                        String str4 = FullBackup.TAG_XML_PARSER;
                            ...
                            str = FullBackup.TAG_XML_PARSER;
                            StringBuilder stringBuilder4 = new StringBuilder();
                            stringBuilder4.append("...parsing \"");
                            stringBuilder4.append(parser.getName());
                            stringBuilder4.append("\": domain=\"");
                            stringBuilder4.append(domainFromXml);
                            stringBuilder4.append("\" invalid; skipping");
                ...
                if (Log.isLoggable(FullBackup.TAG_XML_PARSER, 2)) {
                    ...
                    if (includes.isEmpty()) {
                        ...
                        for (Entry<String, Set<PathWithRequiredFlags>> entry : includes.entrySet()) {
                            ...
                            for (PathWithRequiredFlags includeData : (Set) entry.getValue()) {
                                String str5 = FullBackup.TAG_XML_PARSER;
                                StringBuilder stringBuilder6 = new StringBuilder();
                                stringBuilder6.append(" path: ");
                                stringBuilder6.append(includeData.getPath());
                                stringBuilder6.append(" requiredFlags: ");
                                stringBuilder6.append(includeData.getRequiredFlags());
                    ...
                    if (excludes.isEmpty()) {
                        ...
                        for (PathWithRequiredFlags excludeData : excludes) {
                            ...
                            stringBuilder5.append(excludeData.getPath());
                            stringBuilder5.append(" requiredFlags: ");
                            stringBuilder5.append(excludeData.getRequiredFlags());
                            Log.v(str, stringBuilder5.toString());
                        }
                    }
                    Log.v(FullBackup.TAG_XML_PARSER, "  ");
            ...
            stringBuilder7.append("Xml file didn't start with correct tag (<full-backup-content>). Found \"");
            stringBuilder7.append(parser.getName());
            stringBuilder7.append("\"");
            throw new XmlPullParserException(stringBuilder7.toString());
        }
    ...
    public static void restoreFile(ParcelFileDescriptor data, long size, int type, long mode, long mtime, File outFile) throws IOException {
        ...
        if (type == 2) {
            ...
            while (true) {
                ...
                int got = in2.read(buffer, 0, j2 > ((long) buffer.length) ? buffer.length : (int) j2);
                if (got <= 0) {
                    String str2 = TAG;
                    StringBuilder stringBuilder2 = new StringBuilder();
                ...
                if (out != null) {
                    try {
                        ...
                        Log.e(str3, stringBuilder3.toString(), e2);
                        out.close();
                        outFile.delete();
                        out = null;
                    }
