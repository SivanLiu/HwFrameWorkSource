...
public class RestoreSession {
    ...
    public int restoreSome(long token, RestoreObserver observer, BackupManagerMonitor monitor, String[] packages) {
        ...
        if (monitor == null) {
            ...
            backupManagerMonitorWrapper = new BackupManagerMonitorWrapper(monitor);
        }
        try {
            err = this.mBinder.restoreSome(token, this.mObserver, backupManagerMonitorWrapper, packages);
        } catch (RemoteException e) {
