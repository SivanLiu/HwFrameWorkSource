...
public final class UsageStatsManager {
    ...
    public void setAppStandbyBuckets(Map<String, Integer> appBuckets) {
        if (appBuckets != null) {
            ...
            for (Entry<String, Integer> bucketEntry : appBuckets.entrySet()) {
                bucketInfoList.add(new AppStandbyInfo((String) bucketEntry.getKey(), ((Integer) bucketEntry.getValue()).intValue()));
            }
            try {
