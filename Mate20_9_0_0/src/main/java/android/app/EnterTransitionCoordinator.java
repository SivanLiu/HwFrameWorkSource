...
class EnterTransitionCoordinator extends ActivityTransitionCoordinator {
    ...
    private void onTakeSharedElements() {
        ...
        stringBuilder.append("onTakeSharedElements mIsReadyForTransition= ");
        stringBuilder.append(this.mIsReadyForTransition);
        stringBuilder.append(" mSharedElementsBundle= ");
        stringBuilder.append(this.mSharedElementsBundle);
