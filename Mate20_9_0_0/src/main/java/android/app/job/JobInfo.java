...
public class JobInfo implements Parcelable {
    ...
    public static final class Builder {
        ...
        public Builder setRequiresCharging(boolean requiresCharging) {
            this.mConstraintFlags = (this.mConstraintFlags & -2) | requiresCharging;
            return this;
        }
        ...
        public Builder setPeriodic(long intervalMillis, long flexMillis) {
            ...
            if (intervalMillis < minPeriod) {
                ...
                stringBuilder.append(TimeUtils.formatDuration(intervalMillis));
                stringBuilder.append(" for job ");
                stringBuilder.append(this.mJobId);
                stringBuilder.append(" is too small; raising to ");
                stringBuilder.append(TimeUtils.formatDuration(minPeriod));
                Log.w(access$2700, stringBuilder.toString());
            ...
            if (flexMillis < minFlex) {
                ...
                stringBuilder2.append("Requested flex ");
                stringBuilder2.append(TimeUtils.formatDuration(flexMillis));
                stringBuilder2.append(" for job ");
                stringBuilder2.append(this.mJobId);
                stringBuilder2.append(" is too small; raising to ");
                stringBuilder2.append(TimeUtils.formatDuration(minFlex));
                Log.w(access$27002, stringBuilder2.toString());
                flexMillis = minFlex;
            }
        ...
        public Builder setBackoffCriteria(long initialBackoffMillis, int backoffPolicy) {
            ...
            if (initialBackoffMillis < minBackoff) {
                ...
                stringBuilder.append(TimeUtils.formatDuration(initialBackoffMillis));
                stringBuilder.append(" for job ");
                stringBuilder.append(this.mJobId);
                stringBuilder.append(" is too small; raising to ");
                stringBuilder.append(TimeUtils.formatDuration(minBackoff));
                Log.w(access$2700, stringBuilder.toString());
    ...
    public int hashCode() {
        ...
        hashCode = (31 * hashCode2) + this.constraintFlags;
        if (this.triggerContentUris != null) {
            hashCode = (31 * hashCode) + Arrays.hashCode(this.triggerContentUris);
        }
        hashCode = (31 * ((31 * ((31 * ((31 * hashCode) + Long.hashCode(this.triggerContentUpdateDelay))) + Long.hashCode(this.triggerContentMaxDelay))) + Boolean.hashCode(this.hasEarlyConstraint))) + Boolean.hashCode(this.hasLateConstraint);
        if (this.networkRequest != null) {
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        out.writeInt(this.isPeriodic);
        out.writeInt(this.isPersisted);
        ...
        out.writeInt(this.hasEarlyConstraint);
        out.writeInt(this.hasLateConstraint);
