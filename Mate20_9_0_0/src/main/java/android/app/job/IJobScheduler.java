            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 2:
                        ...
                        if (data.readInt() != 0) {
                            _arg12 = (JobWorkItem) JobWorkItem.CREATOR.createFromParcel(data);
                        }
                        int _result2 = enqueue(_arg0, _arg12);
                        reply.writeNoException();
                    ...
                    case 3:
                        ...
                        int _result3 = scheduleAsPackage(_arg1, data.readString(), data.readInt(), data.readString());
                        reply.writeNoException();
                    ...
                    case 7:
                        data.enforceInterface(descriptor);
                        _arg0 = getPendingJob(data.readInt());
                        reply.writeNoException();
                        if (_arg0 != null) {
                            reply.writeInt(1);
