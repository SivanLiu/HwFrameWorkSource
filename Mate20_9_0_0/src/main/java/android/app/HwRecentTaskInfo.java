...
public class HwRecentTaskInfo extends RecentTaskInfo {
    public static final Creator<HwRecentTaskInfo> CREATOR = new Creator<HwRecentTaskInfo>() {
        public HwRecentTaskInfo createFromParcel(Parcel source) {
            return new HwRecentTaskInfo(source, null);
        }
    ...
    /* synthetic */ HwRecentTaskInfo(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
    ...
    public void translateRecentTaskinfo(RecentTaskInfo rti) {
        this.id = rti.id;
