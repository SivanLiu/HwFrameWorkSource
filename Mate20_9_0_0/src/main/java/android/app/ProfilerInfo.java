...
public class ProfilerInfo implements Parcelable {
    ...
    public int hashCode() {
        return (31 * ((31 * ((31 * ((31 * ((31 * 17) + Objects.hashCode(this.profileFile))) + this.samplingInterval)) + this.autoStopProfiler)) + this.streamingOutput)) + Objects.hashCode(this.agent);
    }
}
