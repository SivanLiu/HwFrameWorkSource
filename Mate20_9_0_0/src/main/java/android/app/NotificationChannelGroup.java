...
public final class NotificationChannelGroup implements Parcelable {
    ...
    public int hashCode() {
        int i = 0;
        int result = 31 * ((31 * ((31 * ((31 * (getId() != null ? getId().hashCode() : 0)) + (getName() != null ? getName().hashCode() : 0))) + (getDescription() != null ? getDescription().hashCode() : 0))) + isBlocked());
        if (getChannels() != null) {
    ...
    public String toString() {
        ...
        stringBuilder.append(!TextUtils.isEmpty(this.mDescription) ? "hasDescription " : "");
