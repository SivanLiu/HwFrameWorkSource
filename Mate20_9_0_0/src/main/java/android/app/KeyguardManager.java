        ...
        if (!LockPatternUtils.frpCredentialEnabled(this.mContext)) {
            ...
            try {
                ...
                if (pdb == null) {
                    ...
                    pdb = new Intent(ACTION_CONFIRM_FRP_CREDENTIAL);
                    pdb.putExtra(EXTRA_TITLE, title);
                    pdb.putExtra(EXTRA_DESCRIPTION, description);
                    pdb.putExtra(EXTRA_ALTERNATE_BUTTON_LABEL, alternateButtonLabel);
                    pdb.setPackage(getSettingsPackageForIntent(pdb));
                    return pdb;
                } else {
            ...
            this.mAm.dismissKeyguard(activity.getActivityToken(), new IKeyguardDismissCallback.Stub() {
                public void onDismissError() throws RemoteException {
                    if (callback != null && !activity.isDestroyed()) {
                        ...
                        handler.post(new -$$Lambda$rztNj2LGZZegxvT34NFbOqZrZHM(keyguardDismissCallback));
                    }
                }
                ...
                public void onDismissSucceeded() throws RemoteException {
                    if (callback != null && !activity.isDestroyed()) {
                        ...
                        KeyguardDismissCallback keyguardDismissCallback = callback;
                        Objects.requireNonNull(keyguardDismissCallback);
                        handler.post(new -$$Lambda$YTMEV7TmbMrzjIag59qAffcsEUw(keyguardDismissCallback));
                    }
                }
                ...
                public void onDismissCancelled() throws RemoteException {
                    if (callback != null && !activity.isDestroyed()) {
                        ...
                        KeyguardDismissCallback keyguardDismissCallback = callback;
                        Objects.requireNonNull(keyguardDismissCallback);
                        handler.post(new -$$Lambda$KlsE01yvVI54Xvdo0TIjyhUKWHQ(keyguardDismissCallback));
                    }
                }
            }, message);
        } catch (RemoteException e) {
