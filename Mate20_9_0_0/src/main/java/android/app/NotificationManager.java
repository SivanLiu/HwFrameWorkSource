...
public class NotificationManager {
    ...
    public static class Policy implements Parcelable {
        ...
        private static final int[] ALL_SUPPRESSED_EFFECTS = new int[]{1, 2, 4, 8, 16, 64, 128};
        ...
        private static final int[] SCREEN_OFF_SUPPRESSED_EFFECTS = new int[]{1, 4, 8, 128};
        private static final int[] SCREEN_ON_SUPPRESSED_EFFECTS = new int[]{2, 16, 64};
        ...
        private static String priorityCategoryToString(int priorityCategory) {
            ...
            switch (priorityCategory) {
                ...
                default:
                    ...
                    stringBuilder.append(priorityCategory);
                    return stringBuilder.toString();
            }
        }
        ...
        public static String prioritySendersToString(int prioritySenders) {
            switch (prioritySenders) {
                ...
                default:
                    ...
                    stringBuilder.append(prioritySenders);
                    return stringBuilder.toString();
            }
        }
    }
    ...
    public void notifyAsUser(String tag, int id, Notification notification, UserHandle user) {
        ...
        if (this.mContext.getApplicationInfo().targetSdkVersion <= 22 || notification.getSmallIcon() != null) {
            ...
            try {
                service.enqueueNotificationWithTag(pkg, this.mContext.getOpPackageName(), tag, id, Builder.maybeCloneStrippedForDelivery(notification, ((ActivityManager) this.mContext.getSystemService(Context.ACTIVITY_SERVICE)).isLowRamDevice(), this.mContext), user.getIdentifier());
                return;
