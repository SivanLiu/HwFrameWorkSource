...
public final class Slice implements Parcelable {
    ...
    public static class Builder {
        ...
        public Builder addText(CharSequence text, String subType, List<String> hints) {
            this.mItems.add(new SliceItem((Object) text, SliceItem.FORMAT_TEXT, subType, (List) hints));
            return this;
        }

        public Builder addIcon(Icon icon, String subType, List<String> hints) {
            Preconditions.checkNotNull(icon);
            this.mItems.add(new SliceItem((Object) icon, SliceItem.FORMAT_IMAGE, subType, (List) hints));
            return this;
        }
        ...
        public Builder addRemoteInput(RemoteInput remoteInput, String subType, List<String> hints) {
            ...
            this.mItems.add(new SliceItem((Object) remoteInput, "input", subType, (List) hints));
            return this;
        }

        public Builder addInt(int value, String subType, List<String> hints) {
            this.mItems.add(new SliceItem(Integer.valueOf(value), SliceItem.FORMAT_INT, subType, (List) hints));
            return this;
        }
        ...
        public Builder addBundle(Bundle bundle, String subType, List<String> hints) {
            ...
            this.mItems.add(new SliceItem((Object) bundle, SliceItem.FORMAT_BUNDLE, subType, (List) hints));
            return this;
        }
    ...
    protected Slice(Parcel in) {
        ...
        for (int i = 0; i < n; i++) {
            this.mItems[i] = (SliceItem) SliceItem.CREATOR.createFromParcel(in);
        }
    ...
    private String toString(String indent) {
        ...
        for (int i = 0; i < this.mItems.length; i++) {
            ...
            if (Objects.equals(this.mItems[i].getFormat(), "slice")) {
                ...
                sb.append(slice.toString(stringBuilder.toString()));
            } else if (Objects.equals(this.mItems[i].getFormat(), SliceItem.FORMAT_TEXT)) {
                sb.append("text: ");
