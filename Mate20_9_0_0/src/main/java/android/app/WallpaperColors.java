...
public final class WallpaperColors implements Parcelable {
    ...
    public static WallpaperColors fromBitmap(Bitmap bitmap) {
        if (bitmap != null) {
            ...
            swatches.removeIf(new -$$Lambda$WallpaperColors$8R5kfKKLfHjpw_QXmD1mWOKwJxc(((float) (bitmap.getWidth() * bitmap.getHeight())) * 0.05f));
            ...
            while (i < swatchesSize) {
                ...
                return new WallpaperColors(primary, secondary, tertiary, 4 | i);
            }
            i = calculateDarkHints(bitmap);
            if (shouldRecycle) {
            }
    ...
    static /* synthetic */ boolean lambda$fromBitmap$0(float minColorArea, Swatch s) {
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.mMainColors.size(); i++) {
            colors.append(Integer.toHexString(((Color) this.mMainColors.get(i)).toArgb()));
            colors.append(" ");
        }
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("[WallpaperColors: ");
        stringBuilder.append(colors.toString());
        stringBuilder.append("h: ");
        stringBuilder.append(this.mColorHints);
