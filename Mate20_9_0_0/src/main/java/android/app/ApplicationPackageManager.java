...
public class ApplicationPackageManager extends PackageManager {
    ...
    public Intent getLaunchIntentForPackage(String packageName) {
        ...
        if (ris.get(0) == null || ((ResolveInfo) ris.get(0)).activityInfo == null) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("getLaunchIntentForPackage ");
            stringBuilder.append(packageName);
            stringBuilder.append(" activityInfo is null, return!");
    ...
    public boolean hasSystemFeature(String name, int version) {
        try {
            ...
            String feature = new StringBuilder();
            feature.append(name);
            feature.append(version);
            feature = feature.toString();
            synchronized (this.mFeaturesCache) {
                Boolean result = (Boolean) this.mFeaturesCache.get(feature);
                boolean booleanValue;
                if (result != null) {
                    booleanValue = result.booleanValue();
                    return booleanValue;
                }
                result = Boolean.valueOf(this.mPM.hasSystemFeature(name, version));
                this.mFeaturesCache.put(feature, result);
                booleanValue = result.booleanValue();
                return booleanValue;
            }
        } catch (RemoteException e) {
    ...
    public List<PackageInfo> getInstalledPackagesAsUser(int flags, int userId) {
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("getInstalledPackages blocked, userId ");
    ...
    public List<ResolveInfo> queryIntentActivitiesAsUser(Intent intent, int flags, int userId) {
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("queryIntentActivitiesAsUser blocked, ");
    ...
    public List<ResolveInfo> queryIntentActivityOptions(ComponentName caller, Intent[] specifics, Intent intent, int flags) {
        ...
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("queryIntentActivityOptions blocked, ");
    ...
    public List<ResolveInfo> queryBroadcastReceiversAsUser(Intent intent, int flags, int userId) {
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("queryBroadcastReceivers blocked, ");
            stringBuilder.append(intent);
            Log.d(str, stringBuilder.toString());
            return HwSystemManager.getFakeResolveInfoList(list);
        } catch (RemoteException e) {
    ...
    public Drawable getDrawable(String packageName, int resId, ApplicationInfo appInfo) {
        ...
        if (resId != 0) {
            try {
                ...
                stringBuilder.append(packageName);
                Log.w("PackageManager", stringBuilder.toString(), e4);
            }
        }
        return null;
    }
    ...
    public boolean isSafeMode() {
        try {
            if (this.mCachedSafeMode < 0) {
                this.mCachedSafeMode = this.mPM.isSafeMode();
            }
    ...
    public XmlResourceParser getXml(String packageName, int resid, ApplicationInfo appInfo) {
        ...
        try {
            ...
            stringBuilder.append(" in package ");
            stringBuilder.append(packageName);
            Log.w("PackageManager", stringBuilder.toString(), e2);
            return null;
    ...
    public Drawable loadItemIcon(PackageItemInfo itemInfo, ApplicationInfo appInfo) {
        ...
        if (itemInfo.showUserIcon != UserInfo.NO_PROFILE_GROUP_ID) {
            return dr;
        }
