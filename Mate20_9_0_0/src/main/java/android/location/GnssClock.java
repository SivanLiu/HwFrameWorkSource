...
public final class GnssClock implements Parcelable {
    ...
    public String toString() {
        ...
        objArr2[0] = "FullBiasNanos";
        objArr2[1] = hasFullBiasNanos() ? Long.valueOf(this.mFullBiasNanos) : null;
        builder.append(String.format(str, objArr2));
        str = "   %-15s = %-25s   %-26s = %s\n";
        ...
        objArr[1] = hasDriftNanosPerSecond() ? Double.valueOf(this.mDriftNanosPerSecond) : null;
