...
public final class GnssStatus {
    ...
    public static boolean checkGnssData(int svCount, int[] svidWithFlags, float[] cn0s, float[] elevations, float[] azimuths) {
        ...
        stringBuilder.append("checkGnssData() svCount=");
        stringBuilder.append(svCount);
        stringBuilder.append(" cn0s:");
        stringBuilder.append(Integer.toHexString(System.identityHashCode(cn0s)));
        stringBuilder.append(" elevations:");
        stringBuilder.append(Integer.toHexString(System.identityHashCode(elevations)));
        stringBuilder.append(" azimuths:");
        stringBuilder.append(Integer.toHexString(System.identityHashCode(azimuths)));
        Log.i("GnssStatus", stringBuilder.toString());
        return false;
    }
}
