...
public class GpsClock implements Parcelable {
    ...
    public String toString() {
        ...
        objArr2[0] = "BiasInNs";
        objArr2[1] = hasBiasInNs() ? Double.valueOf(this.mBiasInNs) : null;
        objArr2[2] = "BiasUncertaintyInNs";
        objArr2[3] = hasBiasUncertaintyInNs() ? Double.valueOf(this.mBiasUncertaintyInNs) : null;
        builder.append(String.format(str, objArr2));
        str = "   %-15s = %-25s   %-26s = %s\n";
        objArr = new Object[4];
