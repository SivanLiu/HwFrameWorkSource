...
public final class GnssMeasurement implements Parcelable {
    ...
    public String toString() {
        ...
        objArr2[0] = "CarrierPhase";
        objArr2[1] = hasCarrierPhase() ? Double.valueOf(this.mCarrierPhase) : null;
        objArr2[2] = "CarrierPhaseUncertainty";
        ...
        objArr2[0] = "SnrInDb";
        objArr2[1] = hasSnrInDb() ? Double.valueOf(this.mSnrInDb) : null;
        builder.append(String.format(str, objArr2));
        str = "   %-29s = %s\n";
        Object[] objArr3 = new Object[2];
        objArr3[0] = "AgcLevelDb";
        if (hasAutomaticGainControlLevelDb()) {
            d = Double.valueOf(this.mAutomaticGainControlLevelInDb);
        }
        objArr3[1] = d;
        builder.append(String.format(str, objArr3));
        return builder.toString();
    }
