...
public class GpsMeasurement implements Parcelable {
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        parcel.writeInt(this.mUsedInFix);
    }
    ...
    public String toString() {
        ...
        objArr[1] = hasCodePhaseInChips() ? Double.valueOf(this.mCodePhaseInChips) : null;
        objArr[2] = "CodePhaseUncertaintyInChips";
        objArr[3] = hasCodePhaseUncertaintyInChips() ? Double.valueOf(this.mCodePhaseUncertaintyInChips) : null;
        builder.append(String.format(str, objArr));
        str = "   %-29s = %s\n";
        objArr = new Object[2];
        objArr[0] = "CarrierFrequencyInHz";
        objArr[1] = hasCarrierFrequencyInHz() ? Float.valueOf(this.mCarrierFrequencyInHz) : null;
        builder.append(String.format(str, objArr));
        str = "   %-29s = %s\n";
        objArr = new Object[2];
        objArr[0] = "CarrierCycles";
        objArr[1] = hasCarrierCycles() ? Long.valueOf(this.mCarrierCycles) : null;
        builder.append(String.format(str, objArr));
        str = "   %-29s = %-25s   %-40s = %s\n";
        objArr = new Object[4];
        ...
        objArr = new Object[2];
        objArr[0] = "BitNumber";
        objArr[1] = hasBitNumber() ? Integer.valueOf(this.mBitNumber) : null;
        builder.append(String.format(str, objArr));
        str = "   %-29s = %s\n";
        objArr = new Object[2];
        objArr[0] = "TimeFromLastBitInMs";
        objArr[1] = hasTimeFromLastBitInMs() ? Short.valueOf(this.mTimeFromLastBitInMs) : null;
        builder.append(String.format(str, objArr));
        str = "   %-29s = %-25s   %-40s = %s\n";
        objArr = new Object[4];
        objArr[0] = "DopplerShiftInHz";
        objArr[1] = hasDopplerShiftInHz() ? Double.valueOf(this.mDopplerShiftInHz) : null;
        objArr[2] = "DopplerShiftUncertaintyInHz";
        objArr[3] = hasDopplerShiftUncertaintyInHz() ? Double.valueOf(this.mDopplerShiftUncertaintyInHz) : null;
        builder.append(String.format(str, objArr));
        builder.append(String.format("   %-29s = %s\n", new Object[]{"MultipathIndicator", getMultipathIndicatorString()}));
        str = "   %-29s = %s\n";
        objArr = new Object[2];
        objArr[0] = "SnrInDb";
        objArr[1] = hasSnrInDb() ? Double.valueOf(this.mSnrInDb) : null;
        builder.append(String.format(str, objArr));
        str = "   %-29s = %-25s   %-40s = %s\n";
        objArr = new Object[4];
        objArr[0] = "ElevationInDeg";
        objArr[1] = hasElevationInDeg() ? Double.valueOf(this.mElevationInDeg) : null;
        objArr[2] = "ElevationUncertaintyInDeg";
        objArr[3] = hasElevationUncertaintyInDeg() ? Double.valueOf(this.mElevationUncertaintyInDeg) : null;
        builder.append(String.format(str, objArr));
        str = "   %-29s = %-25s   %-40s = %s\n";
        Object[] objArr2 = new Object[4];
        objArr2[0] = "AzimuthInDeg";
        objArr2[1] = hasAzimuthInDeg() ? Double.valueOf(this.mAzimuthInDeg) : null;
        objArr2[2] = "AzimuthUncertaintyInDeg";
