...
public final class SnoozeCriterion implements Parcelable {
    ...
    public boolean equals(Object o) {
        ...
        if (!this.mExplanation == null ? this.mExplanation.equals(that.mExplanation) : that.mExplanation == null) {
            return false;
        }
        if (this.mConfirmation != null) {
    ...
    public int hashCode() {
        int i = 0;
        int result = 31 * ((31 * (this.mId != null ? this.mId.hashCode() : 0)) + (this.mExplanation != null ? this.mExplanation.hashCode() : 0));
        if (this.mConfirmation != null) {
