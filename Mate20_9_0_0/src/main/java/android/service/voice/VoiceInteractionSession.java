...
public class VoiceInteractionSession implements Callback, ComponentCallbacks2 {
            ...
            public void handleAssist(Bundle data, AssistStructure structure, AssistContent content, int index, int count) {
                ...
                new Thread("AssistStructure retriever") {
                    public void run() {
                        ...
                        VoiceInteractionSession.this.mHandlerCaller.sendMessage(VoiceInteractionSession.this.mHandlerCaller.obtainMessageOOOOII(104, bundle, failure == null ? assistStructure : null, failure, assistContent, i, i2));
                    }
                }.start();
            }
    ...
    void ensureWindowCreated() {
        if (!this.mInitialized) {
            if (this.mUiEnabled) {
                ...
                this.mRootView = this.mInflater.inflate(17367328, null);
    ...
    public void setContentView(View view) {
        ...
        this.mContentFrame.addView(view, (LayoutParams) new FrameLayout.LayoutParams(-1, -1));
