    ...
    private Chunk invokeViewMethod(View rootView, View targetView, ByteBuffer in) {
                        ...
                        default:
                            switch (c) {
                                ...
                                default:
                                    ...
                                    stringBuilder3.append("Unsupported parameter type (");
                                    stringBuilder3.append(c);
                                    stringBuilder3.append(") to invoke view method.");
                                    return createFailChunk(-2, stringBuilder3.toString());
                            }
                    }
                } else {
        ...
        try {
            try {
                ...
                String str2 = TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append("Exception while invoking method: ");
                ...
                return createFailChunk(-3, method);
            }
        } catch (NoSuchMethodException e2) {
            String str3 = TAG;
            StringBuilder stringBuilder4 = new StringBuilder();
            stringBuilder4.append("No such method: ");
