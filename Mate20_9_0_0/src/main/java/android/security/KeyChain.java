    ...
    public static KeyPair getKeyPair(Context context, String alias) throws KeyChainException, InterruptedException {
        if (alias == null) {
            ...
            try {
                ...
                String keyChainConnection2 = keyId;
                if (keyChainConnection2 == null) {
                    return null;
                }
                try {
                    return AndroidKeyStoreProvider.loadAndroidKeyStoreKeyPairFromKeystore(KeyStore.getInstance(), keyChainConnection2, -1);
                ...
                if (keyChainConnection != null) {
                    $closeResource(e, keyChainConnection);
                }
            }
        } else {
