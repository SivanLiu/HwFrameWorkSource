...
public class KeyStore {
    ...
    public boolean contains(String key, int uid) {
        ...
        try {
            if (this.mBinder == null) {
                ...
                stringBuilder.append("KeyStore binder is null, key = ");
    ...
    public boolean verify(String key, byte[] data, byte[] signature) {
        ...
        if (this.mBinder.verify(key, data, bArr) == 1) {
            z = true;
        }
        return z;
    }
    ...
    public boolean isHardwareBacked(String keyType) {
        ...
        try {
            if (this.mBinder == null) {
                String str = TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("KeyStore binder is null, keyType = ");
    ...
    public int generateKey(String alias, KeymasterArguments args, byte[] entropy, int uid, int flags, KeyCharacteristics outCharacteristics) {
        ...
        try {
            return this.mBinder.generateKey(alias, keymasterArguments, entropy2, uid, flags, outCharacteristics);
    ...
    public OperationResult begin(String alias, int purpose, boolean pruneable, KeymasterArguments args, byte[] entropy, int uid) {
        ...
        try {
            return this.mBinder.begin(getToken(), alias, purpose, pruneable, args2, bArr, uid);
        } catch (RemoteException e4) {
            e = e4;
            Log.w(TAG, "Cannot connect to keystore", e);
            return null;
    ...
    public OperationResult update(IBinder token, KeymasterArguments arguments, byte[] input) {
        ...
        return this.mBinder.update(token, keymasterArguments, input != null ? input : new byte[0]);
    }
    ...
    public OperationResult finish(IBinder token, KeymasterArguments arguments, byte[] signature, byte[] entropy) {
        ...
        return this.mBinder.finish(token, keymasterArguments, signature != null ? signature : new byte[0], entropy != null ? entropy : new byte[0]);
    }
