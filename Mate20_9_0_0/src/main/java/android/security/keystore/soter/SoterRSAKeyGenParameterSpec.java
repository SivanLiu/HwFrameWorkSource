...
public class SoterRSAKeyGenParameterSpec extends RSAKeyGenParameterSpec {
    ...
    public String toString() {
        ...
        stringBuilder.append("SoterRSAKeyGenParameterSpec{isForSoter=");
        stringBuilder.append(this.isForSoter);
        stringBuilder.append(", isAutoSignedWithCommonkWhenGetPublicKey=");
        stringBuilder.append(this.isAutoSignedWithCommonkWhenGetPublicKey);
        stringBuilder.append(", mAutoSignedKeyNameWhenGetPublicKey='");
        stringBuilder.append(this.mAutoSignedKeyNameWhenGetPublicKey);
        stringBuilder.append('\'');
        stringBuilder.append(", isSecmsgFidCounterSignedWhenSign=");
        stringBuilder.append(this.isSecmsgFidCounterSignedWhenSign);
        stringBuilder.append(", isAutoAddCounterWhenGetPublicKey=");
        stringBuilder.append(this.isAutoAddCounterWhenGetPublicKey);
        stringBuilder.append(", isNeedUseNextAttk=");
        stringBuilder.append(this.isNeedUseNextAttk);
        stringBuilder.append('}');
