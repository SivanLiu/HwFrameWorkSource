...
public class SoterUtil {
    ...
    public static SoterRSAKeyGenParameterSpec convertKeyNameToParameterSpec(String name) {
        ...
        if (!contains(PARAM_NEED_AUTO_ADD_COUNTER_WHEN_GET_PUBLIC_KEY, splits)) {
            ...
            isNeedNextAttk = true;
            return new SoterRSAKeyGenParameterSpec(true, isAutoSignedWithCommonkWhenGetPublicKey, mAutoSignedKeyNameWhenGetPublicKey, isSecmsgFidCounterSignedWhenSign2, isAutoAddCounterWhenGetPublicKey, isNeedNextAttk);
        } else {
            isAutoAddCounterWhenGetPublicKey = true;
        }
