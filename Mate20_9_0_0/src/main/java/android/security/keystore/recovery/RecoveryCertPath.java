...
public final class RecoveryCertPath implements Parcelable {
    ...
    public static final Creator<RecoveryCertPath> CREATOR = new Creator<RecoveryCertPath>() {
        public RecoveryCertPath createFromParcel(Parcel in) {
            return new RecoveryCertPath(in, null);
        }
    ...
    /* synthetic */ RecoveryCertPath(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
