...
public class RecoveryController {
    ...
    public static RecoveryController getInstance(Context context) {
        return new RecoveryController(Stub.asInterface(ServiceManager.getService("lock_settings")), KeyStore.getInstance());
    }
    ...
    @Deprecated
    public void setRecoveryStatus(String packageName, String alias, int status) throws NameNotFoundException, InternalRecoveryServiceException {
        throw new UnsupportedOperationException();
    }
    ...
    public int getRecoveryStatus(String alias) throws InternalRecoveryServiceException {
        try {
            Integer status = (Integer) this.mBinder.getRecoveryStatus().get(alias);
            if (status == null) {
                return 3;
            }
    ...
    InternalRecoveryServiceException wrapUnexpectedServiceSpecificException(ServiceSpecificException e) {
        ...
        return new InternalRecoveryServiceException(stringBuilder.toString(), e);
    }
}
