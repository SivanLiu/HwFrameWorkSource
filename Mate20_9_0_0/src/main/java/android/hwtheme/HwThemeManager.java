...
public class HwThemeManager {
    ...
    public static final String HWT_PATH_SKIN;
    ...
    public static final String HWT_PATH_SKIN_INSTALL_FLAG;
    ...
    public static final int SUPPORT_DARK = 1;
    public static final int SUPPORT_HONOR = 16;
    public static final int SUPPORT_NOVA = 256;
    ...
    private static String mOverLayThemePath;
    private static String mOverLayThemeType = "";
    ...
    static {
        ...
        HWT_PATH_SKIN = stringBuilder.toString();
        stringBuilder = new StringBuilder();
        stringBuilder.append(Environment.getDataDirectory());
        stringBuilder.append("/themes");
        HWT_PATH_THEME = stringBuilder.toString();
        stringBuilder = new StringBuilder();
        stringBuilder.append(Environment.getDataDirectory());
        stringBuilder.append("/skin_if");
        HWT_PATH_SKIN_INSTALL_FLAG = stringBuilder.toString();
        stringBuilder = new StringBuilder();
        stringBuilder.append(OVERLAY_THEME);
        stringBuilder.append(UserHandle.myUserId());
        mOverLayThemePath = stringBuilder.toString();
    }
    ...
    public static void linkDataSkinDirAsUser(int userId) {
        ...
        String str = HWT_USER_SYSTEM;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(HWT_PATH_THEME);
        stringBuilder.append("/");
        stringBuilder.append(userId);
        CommandLineUtil.link(str, stringBuilder.toString(), HWT_PATH_SKIN);
    }
    ...
    public static boolean isDeepDarkTheme(int userId) {
        ...
        stringBuilder.append(OVERLAY_THEME);
        stringBuilder.append(userId);
        setOverLayThemePath(stringBuilder.toString());
