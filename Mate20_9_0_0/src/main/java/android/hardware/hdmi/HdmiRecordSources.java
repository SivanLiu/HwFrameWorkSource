...
public final class HdmiRecordSources {
            ...
            if (atscType != 1) {
                switch (atscType) {
                    ...
                    default:
                        ...
                        Log.w(TAG, stringBuilder.toString());
                        StringBuilder stringBuilder2 = new StringBuilder();
                        stringBuilder2.append("Invalid ATSC type:");
            ...
            if (dvbType != 2) {
                switch (dvbType) {
                    ...
                    default:
                        ...
                        Log.w(TAG, stringBuilder.toString());
                        StringBuilder stringBuilder2 = new StringBuilder();
                        stringBuilder2.append("Invalid DVB type:");
    ...
    public static AnalogueServiceSource ofAnalogue(int broadcastType, int frequency, int broadcastSystem) {
        ...
        if (broadcastType < 0 || broadcastType > 2) {
            ...
            stringBuilder2.append("Invalid Broadcast type:");
            stringBuilder2.append(broadcastType);
            throw new IllegalArgumentException(stringBuilder2.toString());
            ...
            Log.w(TAG, stringBuilder.toString());
            stringBuilder2 = new StringBuilder();
            stringBuilder2.append("Invalid frequency value[0x0000-0xFFFF]:");
    ...
    public static ExternalPlugData ofExternalPlug(int plugNumber) {
        ...
        Log.w(TAG, stringBuilder.toString());
        StringBuilder stringBuilder2 = new StringBuilder();
        stringBuilder2.append("Invalid plug number[1-255]");
    ...
    public static ExternalPhysicalAddress ofExternalPhysicalAddress(int physicalAddress) {
        ...
        Log.w(TAG, stringBuilder.toString());
        StringBuilder stringBuilder2 = new StringBuilder();
        stringBuilder2.append("Invalid physical address:");
