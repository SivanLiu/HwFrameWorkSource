        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 12:
                        data.enforceInterface(descriptor);
                        _arg0 = canChangeSystemAudioMode();
                        reply.writeNoException();
                        reply.writeInt(_arg0);
                        return true;
                    case 13:
                        data.enforceInterface(descriptor);
                        _arg0 = getSystemAudioMode();
                        reply.writeNoException();
                        reply.writeInt(_arg0);
                        return true;
                    case 14:
                        ...
                        setSystemAudioMode(_arg0, android.hardware.hdmi.IHdmiControlCallback.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case 15:
                        data.enforceInterface(descriptor);
                    ...
                    case 24:
                        ...
                        sendVendorCommand(_arg02, _arg1, _arg2, _arg0);
                        reply.writeNoException();
                        return true;
                    case 25:
                        data.enforceInterface(descriptor);
