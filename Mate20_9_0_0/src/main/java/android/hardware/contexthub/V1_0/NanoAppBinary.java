...
public final class NanoAppBinary {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.appId = hwBlob.getInt64(_hidl_offset + 0);
        this.appVersion = hwBlob.getInt32(_hidl_offset + 8);
        this.flags = hwBlob.getInt32(_hidl_offset + 12);
        this.targetChreApiMajorVersion = hwBlob.getInt8(_hidl_offset + 16);
        this.targetChreApiMinorVersion = hwBlob.getInt8(_hidl_offset + 17);
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<NanoAppBinary> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((NanoAppBinary) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 40));
            _hidl_index_0++;
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            if (_hidl_index_02 < _hidl_vec_size) {
                childBlob.putInt8((long) (_hidl_index_02 * 1), ((Byte) this.customBinary.get(_hidl_index_02)).byteValue());
