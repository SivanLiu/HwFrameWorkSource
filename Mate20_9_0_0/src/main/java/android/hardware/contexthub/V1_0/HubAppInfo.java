...
public final class HubAppInfo {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.version = hwBlob.getInt32(_hidl_offset + 8);
        ...
        this.enabled = hwBlob.getBool(_hidl_offset + 32);
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<HubAppInfo> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((HubAppInfo) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 40));
            _hidl_index_0++;
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            if (_hidl_index_02 < _hidl_vec_size) {
                ((MemRange) this.memUsage.get(_hidl_index_02)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_02 * 16));
