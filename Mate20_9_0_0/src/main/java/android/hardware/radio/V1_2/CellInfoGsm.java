...
public final class CellInfoGsm {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.signalStrengthGsm.readEmbeddedFromParcel(parcel, _hidl_blob, 80 + _hidl_offset);
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<CellInfoGsm> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((CellInfoGsm) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 96));
            _hidl_index_0++;
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.signalStrengthGsm.writeEmbeddedToBlob(_hidl_blob, 80 + _hidl_offset);
    }
}
