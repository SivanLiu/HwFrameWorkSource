...
public final class NetworkScanRequest {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.interval = hwBlob.getInt32(_hidl_offset + 4);
        ...
        this.maxSearchTime = hwBlob.getInt32(_hidl_offset + 24);
        this.incrementalResults = hwBlob.getBool(_hidl_offset + 28);
        this.incrementalResultsPeriodicity = hwBlob.getInt32(_hidl_offset + 32);
        int _hidl_vec_size2 = hwBlob.getInt32((_hidl_offset + 40) + 8);
        HwBlob childBlob2 = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size2 * 16), _hidl_blob.handle(), (_hidl_offset + 40) + 0, true);
        this.mccMncs.clear();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<NetworkScanRequest> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((NetworkScanRequest) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 56));
            _hidl_index_0++;
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        hwBlob.putInt32(_hidl_offset + 4, this.interval);
        ...
        for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size; _hidl_index_02++) {
            ((RadioAccessSpecifier) this.specifiers.get(_hidl_index_02)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_02 * 72));
        }
        hwBlob.putBlob((_hidl_offset + 8) + 0, childBlob);
        hwBlob.putInt32(_hidl_offset + 24, this.maxSearchTime);
        hwBlob.putBool(_hidl_offset + 28, this.incrementalResults);
        hwBlob.putInt32(_hidl_offset + 32, this.incrementalResultsPeriodicity);
        _hidl_vec_size = this.mccMncs.size();
        ...
        while (true) {
            ...
            if (_hidl_index_03 < _hidl_vec_size) {
                childBlob2.putString((long) (_hidl_index_03 * 16), (String) this.mccMncs.get(_hidl_index_03));
