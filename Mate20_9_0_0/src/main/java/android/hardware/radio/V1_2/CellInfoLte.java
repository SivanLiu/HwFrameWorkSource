...
public final class CellInfoLte {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.signalStrengthLte.readEmbeddedFromParcel(parcel, _hidl_blob, 88 + _hidl_offset);
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<CellInfoLte> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((CellInfoLte) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 112));
            _hidl_index_0++;
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.signalStrengthLte.writeEmbeddedToBlob(_hidl_blob, 88 + _hidl_offset);
    }
}
