...
public final class CellInfoCdma {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.signalStrengthCdma.readEmbeddedFromParcel(parcel, _hidl_blob, 56 + _hidl_offset);
        this.signalStrengthEvdo.readEmbeddedFromParcel(parcel, _hidl_blob, 64 + _hidl_offset);
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<CellInfoCdma> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((CellInfoCdma) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 80));
            _hidl_index_0++;
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.signalStrengthCdma.writeEmbeddedToBlob(_hidl_blob, 56 + _hidl_offset);
        this.signalStrengthEvdo.writeEmbeddedToBlob(_hidl_blob, 64 + _hidl_offset);
    }
}
