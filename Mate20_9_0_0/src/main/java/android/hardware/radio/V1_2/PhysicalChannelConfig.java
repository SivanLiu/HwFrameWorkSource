...
public final class PhysicalChannelConfig {
    ...
    public final String toString() {
        ...
        builder.append(CellConnectionStatus.toString(this.status));
        builder.append(", .cellBandwidthDownlink = ");
        builder.append(this.cellBandwidthDownlink);
        builder.append("}");
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<PhysicalChannelConfig> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((PhysicalChannelConfig) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 8));
            _hidl_index_0++;
        }
