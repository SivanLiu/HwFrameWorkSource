...
public final class CardStatus {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.physicalSlotId = hwBlob.getInt32(_hidl_offset + 40);
        this.atr = hwBlob.getString(_hidl_offset + 48);
        hwParcel.readEmbeddedBuffer((long) (this.atr.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 48) + 0, false);
        this.iccid = hwBlob.getString(_hidl_offset + 64);
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<CardStatus> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((CardStatus) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 80));
            _hidl_index_0++;
        }
