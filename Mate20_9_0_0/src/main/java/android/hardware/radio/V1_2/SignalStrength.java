...
public final class SignalStrength {
    ...
    public final void readFromParcel(HwParcel parcel) {
        readEmbeddedFromParcel(parcel, parcel.readBuffer(76), 0);
    }
    ...
    public static final ArrayList<SignalStrength> readVectorFromParcel(HwParcel parcel) {
        ...
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 76), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            SignalStrength _hidl_vec_element = new SignalStrength();
            _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, (long) (_hidl_index_0 * 76));
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<SignalStrength> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((SignalStrength) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 76));
            _hidl_index_0++;
        }
