...
public final class CellIdentityGsm {
    public final android.hardware.radio.V1_0.CellIdentityGsm base = new android.hardware.radio.V1_0.CellIdentityGsm();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<CellIdentityGsm> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((CellIdentityGsm) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 80));
            _hidl_index_0++;
        }
