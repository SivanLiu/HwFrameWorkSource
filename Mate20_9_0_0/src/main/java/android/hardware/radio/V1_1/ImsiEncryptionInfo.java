...
public final class ImsiEncryptionInfo {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.keyIdentifier = hwBlob.getString(_hidl_offset + 48);
        parcel.readEmbeddedBuffer((long) (this.keyIdentifier.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 48) + 0, false);
        this.expirationTime = hwBlob.getInt64(_hidl_offset + 64);
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            if (_hidl_index_02 < _hidl_vec_size) {
                childBlob.putInt8((long) (_hidl_index_02 * 1), ((Byte) this.carrierKey.get(_hidl_index_02)).byteValue());
