...
public final class RadioMetadata implements Parcelable {
    ...
    static {
        METADATA_KEYS_TYPE.put(METADATA_KEY_RDS_PI, Integer.valueOf(0));
        ...
        METADATA_KEYS_TYPE.put(METADATA_KEY_PROGRAM_NAME, Integer.valueOf(1));
        METADATA_KEYS_TYPE.put(METADATA_KEY_DAB_ENSEMBLE_NAME, Integer.valueOf(1));
        METADATA_KEYS_TYPE.put(METADATA_KEY_DAB_ENSEMBLE_NAME_SHORT, Integer.valueOf(1));
        METADATA_KEYS_TYPE.put(METADATA_KEY_DAB_SERVICE_NAME, Integer.valueOf(1));
        METADATA_KEYS_TYPE.put(METADATA_KEY_DAB_SERVICE_NAME_SHORT, Integer.valueOf(1));
        METADATA_KEYS_TYPE.put(METADATA_KEY_DAB_COMPONENT_NAME, Integer.valueOf(1));
        METADATA_KEYS_TYPE.put(METADATA_KEY_DAB_COMPONENT_NAME_SHORT, Integer.valueOf(1));
