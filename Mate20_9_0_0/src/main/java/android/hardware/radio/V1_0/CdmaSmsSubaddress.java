...
public final class CdmaSmsSubaddress {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.subaddressType = hwBlob.getInt32(_hidl_offset + 0);
        this.odd = hwBlob.getBool(_hidl_offset + 4);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            if (_hidl_index_02 < _hidl_vec_size) {
                childBlob.putInt8((long) (_hidl_index_02 * 1), ((Byte) this.digits.get(_hidl_index_02)).byteValue());
