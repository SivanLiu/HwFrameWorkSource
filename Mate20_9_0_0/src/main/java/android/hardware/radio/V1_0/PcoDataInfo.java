...
public final class PcoDataInfo {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.bearerProto = hwBlob.getString(_hidl_offset + 8);
        parcel.readEmbeddedBuffer((long) (this.bearerProto.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 8) + 0, false);
        this.pcoId = hwBlob.getInt32(_hidl_offset + 24);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            if (_hidl_index_02 < _hidl_vec_size) {
                childBlob.putInt8((long) (_hidl_index_02 * 1), ((Byte) this.contents.get(_hidl_index_02)).byteValue());
