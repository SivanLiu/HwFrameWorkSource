...
public final class CellIdentity {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size * 48), _hidl_blob.handle(), (_hidl_offset + 8) + 0, 1);
        ...
        for (_hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size2; _hidl_index_0++) {
            ...
            _hidl_vec_element.readEmbeddedFromParcel(hwParcel, childBlob, (long) (_hidl_index_0 * 48));
            this.cellIdentityGsm.add(_hidl_vec_element);
        }
        _hidl_vec_size2 = hwBlob.getInt32((_hidl_offset + 24) + 8);
        childBlob = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size2 * 48), _hidl_blob.handle(), (_hidl_offset + 24) + 0, true);
        ...
        childBlob = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size2 * 20), _hidl_blob.handle(), (_hidl_offset + 40) + 0, true);
        this.cellIdentityCdma.clear();
        for (_hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size2; _hidl_index_0++) {
            CellIdentityCdma _hidl_vec_element3 = new CellIdentityCdma();
            _hidl_vec_element3.readEmbeddedFromParcel(hwParcel, childBlob, (long) (_hidl_index_0 * 20));
            this.cellIdentityCdma.add(_hidl_vec_element3);
        }
        _hidl_vec_size2 = hwBlob.getInt32((_hidl_offset + 56) + 8);
        childBlob = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size2 * 48), _hidl_blob.handle(), (_hidl_offset + 56) + 0, true);
        this.cellIdentityLte.clear();
        for (_hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size2; _hidl_index_0++) {
            CellIdentityLte _hidl_vec_element4 = new CellIdentityLte();
            _hidl_vec_element4.readEmbeddedFromParcel(hwParcel, childBlob, (long) (_hidl_index_0 * 48));
            this.cellIdentityLte.add(_hidl_vec_element4);
        }
        _hidl_vec_size2 = hwBlob.getInt32((_hidl_offset + 72) + 8);
        childBlob = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size2 * 48), _hidl_blob.handle(), 0 + (_hidl_offset + 72), true);
        ...
        while (true) {
            ...
            if (_hidl_index_0 < _hidl_vec_size2) {
                ...
                _hidl_vec_element5.readEmbeddedFromParcel(hwParcel, childBlob, (long) (_hidl_index_0 * 48));
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob2 = new HwBlob(_hidl_vec_size * 48);
        for (int _hidl_index_03 = 0; _hidl_index_03 < _hidl_vec_size; _hidl_index_03++) {
            ((CellIdentityWcdma) this.cellIdentityWcdma.get(_hidl_index_03)).writeEmbeddedToBlob(childBlob2, (long) (_hidl_index_03 * 48));
        }
