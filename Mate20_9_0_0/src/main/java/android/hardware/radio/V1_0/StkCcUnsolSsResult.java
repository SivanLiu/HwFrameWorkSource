...
public final class StkCcUnsolSsResult {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size * 16), _hidl_blob.handle(), (_hidl_offset + 24) + 0, 1);
        this.ssInfo.clear();
        ...
        childBlob = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size2 * 16), _hidl_blob.handle(), 0 + (_hidl_offset + 40), true);
        this.cfData.clear();
        while (true) {
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            if (_hidl_index_03 < _hidl_vec_size2) {
                ((CfData) this.cfData.get(_hidl_index_03)).writeEmbeddedToBlob(childBlob2, (long) (_hidl_index_03 * 16));
