...
public final class Call {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.isMpty = hwBlob.getBool(_hidl_offset + 12);
        this.isMT = hwBlob.getBool(_hidl_offset + 13);
        this.als = hwBlob.getInt8(_hidl_offset + 14);
        this.isVoice = hwBlob.getBool(_hidl_offset + 15);
        this.isVoicePrivacy = hwBlob.getBool(_hidl_offset + 16);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            if (_hidl_index_02 < _hidl_vec_size) {
                ((UusInfo) this.uusInfo.get(_hidl_index_02)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_02 * 24));
