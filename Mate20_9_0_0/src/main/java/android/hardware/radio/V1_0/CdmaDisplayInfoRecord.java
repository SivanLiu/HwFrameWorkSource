...
public final class CdmaDisplayInfoRecord {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (HidlSupport.deepEquals(this.alphaBuf, ((CdmaDisplayInfoRecord) otherObject).alphaBuf)) {
            return true;
        }
        return false;
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        parcel.readEmbeddedBuffer((long) (this.alphaBuf.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 0) + 0, false);
    }
