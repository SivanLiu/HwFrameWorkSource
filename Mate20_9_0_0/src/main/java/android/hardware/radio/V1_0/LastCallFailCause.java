...
public final class LastCallFailCause {
    ...
    public static final String dumpBitfield(int o) {
        ...
        if ((OEM_CAUSE_1 & o) == OEM_CAUSE_1) {
            list.add("OEM_CAUSE_1");
            flipped |= OEM_CAUSE_1;
        }
        if ((OEM_CAUSE_2 & o) == OEM_CAUSE_2) {
            list.add("OEM_CAUSE_2");
            flipped |= OEM_CAUSE_2;
        }
        if ((OEM_CAUSE_3 & o) == OEM_CAUSE_3) {
            list.add("OEM_CAUSE_3");
            flipped |= OEM_CAUSE_3;
        }
        if ((OEM_CAUSE_4 & o) == OEM_CAUSE_4) {
            list.add("OEM_CAUSE_4");
            flipped |= OEM_CAUSE_4;
        }
        if ((OEM_CAUSE_5 & o) == OEM_CAUSE_5) {
            list.add("OEM_CAUSE_5");
            flipped |= OEM_CAUSE_5;
        }
        if ((OEM_CAUSE_6 & o) == OEM_CAUSE_6) {
            list.add("OEM_CAUSE_6");
            flipped |= OEM_CAUSE_6;
        }
        if ((OEM_CAUSE_7 & o) == OEM_CAUSE_7) {
            list.add("OEM_CAUSE_7");
            flipped |= OEM_CAUSE_7;
        }
        if ((OEM_CAUSE_8 & o) == OEM_CAUSE_8) {
            list.add("OEM_CAUSE_8");
            flipped |= OEM_CAUSE_8;
        }
        if ((OEM_CAUSE_9 & o) == OEM_CAUSE_9) {
            list.add("OEM_CAUSE_9");
            flipped |= OEM_CAUSE_9;
        }
        if ((OEM_CAUSE_10 & o) == OEM_CAUSE_10) {
            list.add("OEM_CAUSE_10");
            flipped |= OEM_CAUSE_10;
        }
        if ((OEM_CAUSE_11 & o) == OEM_CAUSE_11) {
            list.add("OEM_CAUSE_11");
            flipped |= OEM_CAUSE_11;
        }
        if ((OEM_CAUSE_12 & o) == OEM_CAUSE_12) {
            list.add("OEM_CAUSE_12");
            flipped |= OEM_CAUSE_12;
        }
        if ((OEM_CAUSE_13 & o) == OEM_CAUSE_13) {
            list.add("OEM_CAUSE_13");
            flipped |= OEM_CAUSE_13;
        }
        if ((OEM_CAUSE_14 & o) == OEM_CAUSE_14) {
            list.add("OEM_CAUSE_14");
            flipped |= OEM_CAUSE_14;
        }
        if ((OEM_CAUSE_15 & o) == OEM_CAUSE_15) {
