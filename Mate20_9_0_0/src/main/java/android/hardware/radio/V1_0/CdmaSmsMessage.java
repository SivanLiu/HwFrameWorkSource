...
public final class CdmaSmsMessage {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.teleserviceId = hwBlob.getInt32(_hidl_offset + 0);
        this.isServicePresent = hwBlob.getBool(_hidl_offset + 4);
        this.serviceCategory = hwBlob.getInt32(_hidl_offset + 8);
        this.address.readEmbeddedFromParcel(hwParcel, hwBlob, _hidl_offset + 16);
        this.subAddress.readEmbeddedFromParcel(hwParcel, hwBlob, _hidl_offset + 48);
        int _hidl_vec_size = hwBlob.getInt32((_hidl_offset + 72) + 8);
        HwBlob childBlob = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size * 1), _hidl_blob.handle(), (_hidl_offset + 72) + 0, true);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            if (_hidl_index_02 < _hidl_vec_size) {
                childBlob.putInt8((long) (_hidl_index_02 * 1), ((Byte) this.bearerData.get(_hidl_index_02)).byteValue());
