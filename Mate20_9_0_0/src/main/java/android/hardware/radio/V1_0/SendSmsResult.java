...
public final class SendSmsResult {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.messageRef = hwBlob.getInt32(_hidl_offset + 0);
        this.ackPDU = hwBlob.getString(_hidl_offset + 8);
        parcel.readEmbeddedBuffer((long) (this.ackPDU.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 8) + 0, false);
        this.errorCode = hwBlob.getInt32(_hidl_offset + 24);
    }
