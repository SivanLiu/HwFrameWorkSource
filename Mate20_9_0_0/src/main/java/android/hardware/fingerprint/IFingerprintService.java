            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    case 1:
                        ...
                        IFingerprintServiceReceiver _arg3 = android.hardware.fingerprint.IFingerprintServiceReceiver.Stub.asInterface(data.readStrongBinder());
                        ...
                        Bundle _arg6 = bundle;
                        authenticate(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, android.hardware.biometrics.IBiometricPromptReceiver.Stub.asInterface(data.readStrongBinder()));
                    ...
                    case 20:
                        parcel.enforceInterface(descriptor);
                        int _result7 = getRemainingNum();
                        reply.writeNoException();
                        parcel2.writeInt(_result7);
                        return true;
                    case 21:
                        parcel.enforceInterface(descriptor);
                        long _result8 = getRemainingTime();
                        reply.writeNoException();
