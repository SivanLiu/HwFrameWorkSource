...
public final class GeofenceHardwareImpl {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 2:
                    ...
                    callbackList2 = GeofenceHardwareImpl.this.mCallbacks[monitoringType];
                ...
                case 4:
                    ...
                    if (GeofenceHardwareImpl.DEBUG) {
                        String str2 = GeofenceHardwareImpl.TAG;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    if (callback2 != null) {
                        try {
                            callback2.onGeofenceTransition(geofenceTransition.mGeofenceId, geofenceTransition.mTransition, geofenceTransition.mLocation, geofenceTransition.mTimestamp, geofenceTransition.mMonitoringType);
                        } catch (RemoteException e) {
                        }
                    }
                    GeofenceHardwareImpl.this.releaseWakeLock();
                ...
                case 3:
                    ...
                    if (callback3 != null) {
                        try {
                            callback3.onGeofenceRemove(geofenceId, msg.arg2);
                ...
                case 4:
                    ...
                    if (callback2 != null) {
                        try {
                            callback2.onGeofencePause(geofenceId, msg.arg2);
                ...
                case 6:
                    ...
                    if (GeofenceHardwareImpl.DEBUG) {
                        String str2 = GeofenceHardwareImpl.TAG;
                        StringBuilder stringBuilder2 = new StringBuilder();
                        stringBuilder2.append("Geofence callback reaped:");
                        stringBuilder2.append(callback4);
                        Log.d(str2, stringBuilder2.toString());
                    }
                    int monitoringType = msg.arg1;
                    synchronized (GeofenceHardwareImpl.this.mGeofences) {
    ...
    class Reaper implements DeathRecipient {
        ...
        public int hashCode() {
            int i = 0;
            int hashCode = 31 * ((31 * 17) + (this.mCallback != null ? this.mCallback.asBinder().hashCode() : 0));
            if (this.mMonitorCallback != null) {
                i = this.mMonitorCallback.asBinder().hashCode();
            }
            return (31 * (hashCode + i)) + this.mMonitoringType;
        }
        ...
        try {
            ...
            if (this.mVersion >= 2) {
                if ((this.mCapabilities & 1) == 0) {
                    ...
                    z = this.mFusedService == null && this.mFusedService.isSupported() && hasGnnsCapabilities;
    ...
    public boolean pauseGeofence(int geofenceId, int monitoringType) {
        ...
        if (DEBUG) {
            String str = TAG;
            StringBuilder stringBuilder2 = new StringBuilder();
            stringBuilder2.append("Pause Geofence: GeofenceId: ");
            stringBuilder2.append(geofenceId);
    ...
    public boolean resumeGeofence(int geofenceId, int monitoringType, int monitorTransition) {
        ...
        if (DEBUG) {
            String str = TAG;
            StringBuilder stringBuilder2 = new StringBuilder();
            stringBuilder2.append("Resume Geofence: GeofenceId: ");
            stringBuilder2.append(geofenceId);
            Log.d(str, stringBuilder2.toString());
        }
        synchronized (this.mGeofences) {
    ...
    public void reportGeofenceTransition(int geofenceId, Location location, int transition, long transitionTimestamp, int monitoringType, int sourcesUsed) {
        ...
        GeofenceTransition geofenceTransition = new GeofenceTransition(geofenceId, i, j, location2, i2, i3);
        acquireWakeLock();
