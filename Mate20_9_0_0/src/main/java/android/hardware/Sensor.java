...
public final class Sensor {
    ...
    public static final int TYPE_COLOR_SENSOR = 65554;
    public static final int TYPE_DEVICE_ORIENTATION = 27;
    public static final int TYPE_DEVICE_PRIVATE_BASE = 65536;
    public static final int TYPE_DROP_SENSOR = 65556;
    @SystemApi
    public static final int TYPE_DYNAMIC_SENSOR_META = 32;
    public static final int TYPE_EXT_HALL = 65557;
    ...
    public static final int TYPE_TOF_SENSOR = 65555;
