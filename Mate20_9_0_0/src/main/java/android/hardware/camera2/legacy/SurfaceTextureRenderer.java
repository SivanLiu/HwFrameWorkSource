...
public class SurfaceTextureRenderer {
    ...
    private void drawFrame(SurfaceTexture st, int width, int height, int flipType) throws BufferQueueAbandonedException {
        ...
        try {
            ...
            BufferQueueAbandonedException bufferQueueAbandonedException = e;
    ...
    private void configureEGLContext() {
        ...
        if (this.mEGLDisplay != EGL14.EGL_NO_DISPLAY) {
            ...
            if (EGL14.eglInitialize(this.mEGLDisplay, version, 0, version, 1)) {
                ...
                EGL14.eglChooseConfig(this.mEGLDisplay, new int[]{12324, 8, 12323, 8, 12322, 8, 12352, 4, EGL_RECORDABLE_ANDROID, 1, 12339, 5, 12344}, 0, eGLConfigArr, 0, configs.length, new int[1], 0);
    ...
    private boolean swapBuffers(EGLSurface surface) throws BufferQueueAbandonedException {
        ...
        if (error == MtpConstants.FORMAT_UNDEFINED) {
            return result;
        }
        if (error == MtpConstants.FORMAT_MPEG || error == 12301) {
    ...
    private void checkEglError(String msg) {
        ...
        if (eglGetError != MtpConstants.FORMAT_UNDEFINED) {
            StringBuilder stringBuilder = new StringBuilder();
