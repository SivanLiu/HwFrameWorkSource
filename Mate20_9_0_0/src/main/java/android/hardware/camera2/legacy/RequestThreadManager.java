...
import android.hardware.camera2.legacy.RequestQueue.RequestQueueEntry;
        ...
        public boolean handleMessage(Message msg) {
            ...
            if (i != -1) {
                switch (i) {
                    case 1:
                        startTime = 0;
                        ConfigureHolder config = message.obj;
                        startTime2 = config.surfaces != null ? config.surfaces.size() : 0;
                        String access$100 = RequestThreadManager.this.TAG;
                        StringBuilder stringBuilder = new StringBuilder();
                        stringBuilder.append("Configure outputs: ");
                        stringBuilder.append(startTime2);
                        stringBuilder.append(" surfaces configured.");
                    ...
                    case 2:
                        ...
                        RequestQueueEntry nextBurst = RequestThreadManager.this.mRequestQueue.getNext();
                        if (nextBurst == null) {
                            try {
                                if (!RequestThreadManager.this.mCaptureCollector.waitForEmpty(4000, TimeUnit.MILLISECONDS)) {
                                ...
                                Log.e(RequestThreadManager.this.TAG, "Interrupted while waiting for requests to complete: ", e5);
                                RequestThreadManager.this.mDeviceState.setError(1);
                                break;
                            }
                        }
                        ...
                        for (RequestHolder holder : burstHolder.produceRequestHolders(nextBurst.getFrameNumber().longValue())) {
                            ...
                            if (RequestThreadManager.this.mLastRequest == null || RequestThreadManager.this.mLastRequest.captureRequest != request) {
                                paramsChanged = ParameterUtils.convertSize(RequestThreadManager.this.mParams.getPreviewSize());
                                LegacyRequest legacyRequest = new LegacyRequest(RequestThreadManager.this.mCharacteristics, request, paramsChanged, RequestThreadManager.this.mParams);
                                ...
                                if (RequestThreadManager.this.mParams.same(legacyRequest.parameters)) {
                                    previewSize = paramsChanged;
                                    startTime = startTime2;
                                } else {
                                    try {
                                        RequestThreadManager.this.mCamera.setParameters(legacyRequest.parameters);
                                        boolean paramsChanged3 = true;
                                        RequestThreadManager.this.mParams = legacyRequest.parameters;
                                        Object obj = paramsChanged;
                                        startTime = startTime2;
                                        paramsChanged2 = paramsChanged3;
                                    } catch (RuntimeException e22) {
                                        previewSize = paramsChanged;
                                        Log.e(RequestThreadManager.this.TAG, "Exception while setting camera parameters: ", e22);
                                        holder.failRequest();
                                        startTime = startTime2;
                            ...
                            try {
                                ...
                                startTime2 = request;
                                holder2 = holder;
                                Log.e(RequestThreadManager.this.TAG, "Received device exception during capture call: ", e3);
                                RequestThreadManager.this.mDeviceState.setError(1);
                                ...
                                startTime2 = request;
                                holder2 = holder;
                                Log.e(RequestThreadManager.this.TAG, "Received device exception during capture call: ", e22);
                                RequestThreadManager.this.mDeviceState.setError(1);
                                RequestThreadManager.this.mDeviceState.setRepeatingRequestError(RequestThreadManager.this.cancelRepeating(burstHolder.getRequestId()), burstHolder.getRequestId());
                                z = true;
                                return z;
                            ...
                            try {
                                if (RequestThreadManager.this.mCaptureCollector.queueRequest(holder, RequestThreadManager.this.mLastRequest, 4000, TimeUnit.MILLISECONDS)) {
                                    ...
                                    RequestThreadManager.this.mFaceDetectMapper.processFaceDetectMode(startTime2, RequestThreadManager.this.mParams);
                                    RequestThreadManager.this.mFocusStateMapper.processRequestTriggers(startTime2, RequestThreadManager.this.mParams);
                                    if (holder2.hasJpegTargets()) {
                                    ...
                                    if (paramsChanged) {
                                        try {
                                            ...
                                            Log.e(RequestThreadManager.this.TAG, "Received device exception: ", e222);
                                            RequestThreadManager.this.mDeviceState.setError(1);
                                        }
                                    }
                                    ...
                                    try {
                                        ...
                                        Log.e(RequestThreadManager.this.TAG, "Interrupted waiting for request completion: ", e52);
                                        RequestThreadManager.this.mDeviceState.setError(1);
                                    }
                                } else {
                                ...
                                e52 = e10;
                                Log.e(RequestThreadManager.this.TAG, "Interrupted during capture: ", e52);
                                RequestThreadManager.this.mDeviceState.setError(1);
                                RequestThreadManager.this.mDeviceState.setRepeatingRequestError(RequestThreadManager.this.cancelRepeating(burstHolder.getRequestId()), burstHolder.getRequestId());
                                z = true;
                                return z;
                                ...
                                e222 = e11;
                                Log.e(RequestThreadManager.this.TAG, "Received device exception during capture call: ", e222);
                                RequestThreadManager.this.mDeviceState.setError(1);
                                RequestThreadManager.this.mDeviceState.setRepeatingRequestError(RequestThreadManager.this.cancelRepeating(burstHolder.getRequestId()), burstHolder.getRequestId());
                                z = true;
                                return z;
                    ...
                    case 3:
                        ...
                        try {
                            ...
                            Log.e(RequestThreadManager.this.TAG, "Interrupted while waiting for requests to complete: ", e522);
                            RequestThreadManager.this.mDeviceState.setError(1);
                        }
                    ...
                    default:
                        ...
                        stringBuilder2.append(" on RequestThread.");
        ...
        try {
            ...
            for (Surface s : this.mCallbackOutputs) {
                try {
                    ...
                    BufferQueueAbandonedException bufferQueueAbandonedException = e3;
            ...
            ArrayList callbackOutputSizes = new ArrayList();
            ...
            try {
                ...
                if (previewOutputSizes.size() > 0) {
                    ...
                    outSize = smallestSupportedJpegSize != null ? smallestSupportedJpegSize : largestJpegDimen;
                    ...
                    while (it.hasNext()) {
                        ...
                        largestOutput = (Size) it.next();
                        Iterator it2 = it;
                        supportedFpsRanges2 = supportedFpsRanges;
                        long currArea = (long) (largestOutput.getWidth() * largestOutput.getHeight());
                        previewOutputSizes2 = previewOutputSizes;
                        long bestArea = (long) (bestPreviewDimen.getWidth() * bestPreviewDimen.getHeight());
                        if (checkAspectRatiosMatch(outSize, largestOutput) && currArea < bestArea && currArea >= largestOutputArea) {
                ...
                previewOutputSizes = previewOutputSizes2.iterator();
                for (Surface p : this.mPreviewOutputs) {
                    previews.add(new Pair(p, (Size) previewOutputSizes.next()));
                }
                ...
                for (Surface p2 : this.mPreviewOutputs) {
                    ...
                    } catch (BufferQueueAbandonedException e322) {
                        BufferQueueAbandonedException bufferQueueAbandonedException2 = e322;
                        Log.e(this.TAG, "Surface abandoned, skipping setSurfaceOrientation()", e322);
                    }
                }
