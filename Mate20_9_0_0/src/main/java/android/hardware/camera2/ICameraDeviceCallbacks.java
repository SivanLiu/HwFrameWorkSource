...
public interface ICameraDeviceCallbacks extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICameraDeviceCallbacks {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                CaptureResultExtras _arg0 = null;
                switch (code) {
                    case 1:
                        data.enforceInterface(descriptor);
                        int _arg02 = data.readInt();
                        if (data.readInt() != 0) {
                            _arg0 = (CaptureResultExtras) CaptureResultExtras.CREATOR.createFromParcel(data);
                        }
                        onDeviceError(_arg02, _arg0);
                        return true;
                    case 2:
                        data.enforceInterface(descriptor);
                        onDeviceIdle();
                    ...
                    case 4:
                        ...
                        onResultReceived(_arg03, _arg0, (PhysicalCaptureResultInfo[]) data.createTypedArray(PhysicalCaptureResultInfo.CREATOR));
                        return true;
                    case 5:
                        data.enforceInterface(descriptor);
