...
public final class OutputConfiguration implements Parcelable {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.mRotation != other.mRotation || !this.mConfiguredSize.equals(other.mConfiguredSize) || this.mConfiguredFormat != other.mConfiguredFormat || this.mSurfaceGroupId != other.mSurfaceGroupId || this.mSurfaceType != other.mSurfaceType || this.mIsDeferredConfig != other.mIsDeferredConfig || this.mIsShared != other.mIsShared || this.mConfiguredFormat != other.mConfiguredFormat || this.mConfiguredDataspace != other.mConfiguredDataspace || this.mConfiguredGenerationId != other.mConfiguredGenerationId || ((this.mPhysicalCameraId == null && other.mPhysicalCameraId != null) || (this.mPhysicalCameraId != null && !this.mPhysicalCameraId.equals(other.mPhysicalCameraId)))) {
            return false;
        }
