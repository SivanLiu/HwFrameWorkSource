...
public final class OptionalInt32 {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != OptionalInt32.class) {
            return false;
        }
        OptionalInt32 other = (OptionalInt32) otherObject;
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.specified))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.value)))});
    }
    ...
    public static final ArrayList<OptionalInt32> readVectorFromParcel(HwParcel parcel) {
        ArrayList<OptionalInt32> _hidl_vec = new ArrayList();
        HwBlob _hidl_blob = parcel.readBuffer(16);
        int _hidl_vec_size = _hidl_blob.getInt32(8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 8), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            OptionalInt32 _hidl_vec_element = new OptionalInt32();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<OptionalInt32> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((OptionalInt32) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 8));
            _hidl_index_0++;
        }
