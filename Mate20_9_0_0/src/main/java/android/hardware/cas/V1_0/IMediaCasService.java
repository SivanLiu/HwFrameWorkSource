        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 2:
                    ...
                    _hidl_request.enforceInterface(IMediaCasService.kInterfaceName);
                    _hidl_is_oneway = isSystemIdSupported(_hidl_request.readInt32());
                    _hidl_reply.writeStatus(0);
                    _hidl_reply.writeBool(_hidl_is_oneway);
                    _hidl_reply.send();
                    return;
                case 3:
                    if ((_hidl_flags & 1) == 0) {
                ...
                case 4:
                    ...
                    _hidl_request.enforceInterface(IMediaCasService.kInterfaceName);
                    _hidl_is_oneway = isDescramblerSupported(_hidl_request.readInt32());
                    _hidl_reply.writeStatus(0);
                    _hidl_reply.writeBool(_hidl_is_oneway);
                    _hidl_reply.send();
                    return;
