            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 10:
                        ...
                        setTouchCalibrationForInputDevice(_arg04, _arg13, _arg23);
                        reply.writeNoException();
                        return true;
                    case 11:
                        data.enforceInterface(descriptor);
                    ...
                    case 12:
                        data.enforceInterface(descriptor);
                        if (data.readInt() != 0) {
                            _arg02 = (InputDeviceIdentifier) InputDeviceIdentifier.CREATOR.createFromParcel(data);
                        }
                        KeyboardLayout[] _result8 = getKeyboardLayoutsForInputDevice(_arg02);
                        reply.writeNoException();
                    ...
                    case 14:
                        ...
                        String _result10 = getCurrentKeyboardLayoutForInputDevice(_arg02);
                        reply.writeNoException();
                    ...
                    case 15:
                        ...
                        setCurrentKeyboardLayoutForInputDevice(_arg02, data.readString());
                        reply.writeNoException();
                        return true;
                    case 16:
                        data.enforceInterface(descriptor);
                        ...
                        String[] _result11 = getEnabledKeyboardLayoutsForInputDevice(_arg02);
                        reply.writeNoException();
                    ...
                    case 17:
                        ...
                        addKeyboardLayoutForInputDevice(_arg02, data.readString());
                        reply.writeNoException();
                        return true;
                    case 18:
                        data.enforceInterface(descriptor);
                        ...
                        removeKeyboardLayoutForInputDevice(_arg02, data.readString());
                        reply.writeNoException();
                        return true;
                    case 19:
                        data.enforceInterface(descriptor);
                    ...
                    case 27:
                        data.enforceInterface(descriptor);
                        IInputForwarder _result12 = createInputForwarder(data.readInt());
                        reply.writeNoException();
                        if (_result12 != null) {
                            _arg03 = _result12.asBinder();
                        }
                        reply.writeStrongBinder(_arg03);
                        return true;
                    case 28:
                        data.enforceInterface(descriptor);
                        IBinder _result13 = getHwInnerService();
                        reply.writeNoException();
