...
public interface ISupplicantStaNetworkCallback extends IBase {
    ...
    public static final class NetworkRequestEapSimGsmAuthParams {
        ...
        public final boolean equals(Object otherObject) {
            ...
            if (HidlSupport.deepEquals(this.rands, ((NetworkRequestEapSimGsmAuthParams) otherObject).rands)) {
                return true;
            }
            return false;
        }
        ...
        public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
            ...
            while (true) {
                ...
                if (_hidl_index_02 < _hidl_vec_size) {
                    childBlob.putInt8Array((long) (_hidl_index_02 * 16), (byte[]) this.rands.get(_hidl_index_02));
