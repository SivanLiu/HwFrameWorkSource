...
public final class NanDataPathScheduleUpdateInd {
    ...
    public final String toString() {
        ...
        builder.append(Arrays.toString(this.peerDiscoveryAddress));
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob2 = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size2 * 4), _hidl_blob.handle(), (_hidl_offset + 24) + 0, true);
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<NanDataPathScheduleUpdateInd> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((NanDataPathScheduleUpdateInd) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 40));
            _hidl_index_0++;
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_vec_size = this.ndpInstanceIds.size();
        ...
        while (true) {
            ...
            if (_hidl_index_03 < _hidl_vec_size) {
                childBlob2.putInt32((long) (_hidl_index_03 * 4), ((Integer) this.ndpInstanceIds.get(_hidl_index_03)).intValue());
                _hidl_index_0 = _hidl_index_03 + 1;
            } else {
