...
public final class NanDataPathConfirmInd {
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(this.V1_0)), Integer.valueOf(HidlSupport.deepHashCode(this.channelInfo))});
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.V1_0.readEmbeddedFromParcel(hwParcel, hwBlob, _hidl_offset + 0);
        int _hidl_vec_size = hwBlob.getInt32((_hidl_offset + 56) + 8);
        HwBlob childBlob = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size * 12), _hidl_blob.handle(), (_hidl_offset + 56) + 0, true);
        this.channelInfo.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            NanDataPathChannelInfo _hidl_vec_element = new NanDataPathChannelInfo();
            _hidl_vec_element.readEmbeddedFromParcel(hwParcel, childBlob, (long) (_hidl_index_0 * 12));
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<NanDataPathConfirmInd> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((NanDataPathConfirmInd) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 72));
            _hidl_index_0++;
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            if (_hidl_index_02 < _hidl_vec_size) {
                ((NanDataPathChannelInfo) this.channelInfo.get(_hidl_index_02)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_02 * 12));
