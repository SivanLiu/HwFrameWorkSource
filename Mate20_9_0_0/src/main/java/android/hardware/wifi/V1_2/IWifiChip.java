...
public interface IWifiChip extends android.hardware.wifi.V1_1.IWifiChip {
    ...
    public static abstract class Stub extends HwBinder implements IWifiChip {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList(Arrays.asList(new String[]{IWifiChip.kInterfaceName, android.hardware.wifi.V1_1.IWifiChip.kInterfaceName, android.hardware.wifi.V1_0.IWifiChip.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 8:
                    ...
                    requestDriverDebugDump(new requestDriverDebugDumpCallback() {
                        public void onValues(WifiStatus status, ArrayList<Byte> blob) {
                            _hidl_reply.writeStatus(0);
                            status.writeToParcel(_hidl_reply);
                            _hidl_reply.writeInt8Vector((ArrayList) blob);
                            _hidl_reply.send();
                        }
                    });
                    return;
                ...
                case 11:
                    ...
                    getApIfaceNames(new getApIfaceNamesCallback() {
                        public void onValues(WifiStatus status, ArrayList<String> ifnames) {
                            _hidl_reply.writeStatus(0);
                            status.writeToParcel(_hidl_reply);
                            _hidl_reply.writeStringVector((ArrayList) ifnames);
                            _hidl_reply.send();
                        }
                    });
                    return;
                ...
                case 28:
                    ...
                    _hidl_request.enforceInterface(android.hardware.wifi.V1_0.IWifiChip.kInterfaceName);
                    WifiStatus _hidl_out_status3 = startLoggingToDebugRingBuffer(_hidl_request.readString(), _hidl_request.readInt32(), _hidl_request.readInt32(), _hidl_request.readInt32());
                    _hidl_reply.writeStatus(0);
                ...
                case 30:
                    ...
                    _hidl_request.enforceInterface(android.hardware.wifi.V1_0.IWifiChip.kInterfaceName);
                    _hidl_out_status2 = stopLoggingToDebugRingBuffer();
                    _hidl_reply.writeStatus(0);
                ...
                case 34:
                    ...
                    _hidl_request.enforceInterface(android.hardware.wifi.V1_1.IWifiChip.kInterfaceName);
                    _hidl_out_status2 = resetTxPowerScenario();
                    _hidl_reply.writeStatus(0);
                    _hidl_out_status2.writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    return;
                case 35:
                    ...
                    _hidl_out_status = selectTxPowerScenario_1_2(_hidl_request.readInt32());
                    _hidl_reply.writeStatus(0);
                    _hidl_out_status.writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    return;
                case ReasonCode.STA_LEAVING /*36*/:
                    ...
                    _hidl_request.enforceInterface(IWifiChip.kInterfaceName);
                    _hidl_out_status = registerEventCallback_1_2(IWifiChipEventCallback.asInterface(_hidl_request.readStrongBinder()));
                    _hidl_reply.writeStatus(0);
                    _hidl_out_status.writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    return;
