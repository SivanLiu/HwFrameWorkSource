...
public final class NanDataPathChannelInfo {
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.channelFreq))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.channelBandwidth))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.numSpatialStreams)))});
    }
    ...
    public final String toString() {
        ...
        builder.append(WifiChannelWidthInMhz.toString(this.channelBandwidth));
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<NanDataPathChannelInfo> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((NanDataPathChannelInfo) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 12));
            _hidl_index_0++;
        }
