...
public final class NanRespondToDataPathIndicationRequest {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.acceptRequest = hwBlob.getBool(_hidl_offset + 0);
        this.ndpInstanceId = hwBlob.getInt32(_hidl_offset + 4);
        this.ifaceName = hwBlob.getString(_hidl_offset + 8);
        ...
        this.securityConfig.readEmbeddedFromParcel(hwParcel, hwBlob, _hidl_offset + 24);
        int _hidl_vec_size = hwBlob.getInt32((_hidl_offset + 80) + 8);
        HwBlob childBlob = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size * 1), _hidl_blob.handle(), (_hidl_offset + 80) + 0, true);
        this.appInfo.clear();
        int _hidl_index_0 = 0;
        ...
        int _hidl_vec_size2 = hwBlob.getInt32((_hidl_offset + 96) + 8);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        HwBlob hwBlob = _hidl_blob;
        hwBlob.putBool(_hidl_offset + 0, this.acceptRequest);
        hwBlob.putInt32(_hidl_offset + 4, this.ndpInstanceId);
        hwBlob.putString(_hidl_offset + 8, this.ifaceName);
        this.securityConfig.writeEmbeddedToBlob(hwBlob, _hidl_offset + 24);
        ...
        while (true) {
            ...
            if (_hidl_index_03 < _hidl_vec_size) {
                childBlob2.putInt8((long) (_hidl_index_03 * 1), ((Byte) this.serviceNameOutOfBand.get(_hidl_index_03)).byteValue());
