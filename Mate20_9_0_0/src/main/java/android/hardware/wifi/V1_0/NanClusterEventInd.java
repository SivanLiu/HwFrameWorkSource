...
public final class NanClusterEventInd {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.eventType == other.eventType && HidlSupport.deepEquals(this.addr, other.addr)) {
            return true;
        }
        return false;
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.copyToInt8Array(4 + _hidl_offset, this.addr, 6);
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putInt8Array(4 + _hidl_offset, this.addr);
    }
}
