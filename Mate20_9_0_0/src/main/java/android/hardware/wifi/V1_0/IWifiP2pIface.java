...
public interface IWifiP2pIface extends IWifiIface {
    ...
    public static abstract class Stub extends HwBinder implements IWifiP2pIface {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList(Arrays.asList(new String[]{IWifiP2pIface.kInterfaceName, IWifiIface.kInterfaceName, IBase.kInterfaceName}));
        }
    ...
    static IWifiP2pIface asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static IWifiP2pIface castFrom(IHwInterface iface) {
        return iface == null ? null : asInterface(iface.asBinder());
    }

    static IWifiP2pIface getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static IWifiP2pIface getService(boolean retry) throws RemoteException {
        return getService(HalDeviceManager.HAL_INSTANCE_NAME, retry);
    }

    static IWifiP2pIface getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static IWifiP2pIface getService() throws RemoteException {
