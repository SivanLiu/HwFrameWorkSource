...
public final class StaRoamingConfig {
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            childBlob.putInt8Array((long) (_hidl_index_0 * 6), (byte[]) this.bssidBlacklist.get(_hidl_index_0));
        }
        ...
        while (true) {
            ...
            if (_hidl_index_03 < _hidl_vec_size) {
                childBlob2.putInt8Array((long) (_hidl_index_03 * 32), (byte[]) this.ssidWhitelist.get(_hidl_index_03));
