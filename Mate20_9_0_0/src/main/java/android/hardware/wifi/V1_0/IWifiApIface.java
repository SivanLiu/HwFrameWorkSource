...
public interface IWifiApIface extends IWifiIface {
                ...
                case 4:
                    ...
                    getValidFrequenciesForBand(_hidl_request.readInt32(), new getValidFrequenciesForBandCallback() {
                        public void onValues(WifiStatus status, ArrayList<Integer> frequencies) {
                            _hidl_reply.writeStatus(0);
                            status.writeToParcel(_hidl_reply);
                            _hidl_reply.writeInt32Vector((ArrayList) frequencies);
                            _hidl_reply.send();
                        }
                    });
                    return;
    ...
    static IWifiApIface getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static IWifiApIface getService(boolean retry) throws RemoteException {
