...
public final class StaLinkLayerStats {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size * 32), _hidl_blob.handle(), (_hidl_offset + 136) + 0, true);
        this.radios.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            if (_hidl_index_02 < _hidl_vec_size) {
                ((StaLinkLayerRadioStats) this.radios.get(_hidl_index_02)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_02 * 32));
