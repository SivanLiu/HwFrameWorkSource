...
public interface IWifiIface extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IWifiIface {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList(Arrays.asList(new String[]{IWifiIface.kInterfaceName, IBase.kInterfaceName}));
        }
    ...
    static IWifiIface asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
    ...
    static IWifiIface castFrom(IHwInterface iface) {
        return iface == null ? null : asInterface(iface.asBinder());
    }

    static IWifiIface getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static IWifiIface getService(boolean retry) throws RemoteException {
        return getService(HalDeviceManager.HAL_INSTANCE_NAME, retry);
    }

    static IWifiIface getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static IWifiIface getService() throws RemoteException {
