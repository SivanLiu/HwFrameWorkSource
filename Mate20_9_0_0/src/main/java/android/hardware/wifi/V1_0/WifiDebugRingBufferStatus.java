...
public final class WifiDebugRingBufferStatus {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (HidlSupport.deepEquals(this.ringName, other.ringName) && this.flags == other.flags && this.ringId == other.ringId && this.sizeInBytes == other.sizeInBytes && this.freeSizeInBytes == other.freeSizeInBytes && this.verboseLevel == other.verboseLevel) {
            return true;
        }
        return false;
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        parcel.readEmbeddedBuffer((long) (this.ringName.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 0) + 0, false);
