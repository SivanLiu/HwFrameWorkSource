...
public final class WifiDebugPacketFateFrameInfo {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.frameType = hwBlob.getInt32(_hidl_offset + 0);
        this.frameLen = hwBlob.getInt64(_hidl_offset + 8);
        this.driverTimestampUsec = hwBlob.getInt64(_hidl_offset + 16);
        this.firmwareTimestampUsec = hwBlob.getInt64(_hidl_offset + 24);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            if (_hidl_index_02 < _hidl_vec_size) {
                childBlob.putInt8((long) (_hidl_index_02 * 1), ((Byte) this.frameContent.get(_hidl_index_02)).byteValue());
