...
public final class NanDebugConfig {
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putInt8Array(7 + _hidl_offset, this.intfAddrVal);
        ...
        _hidl_blob.putInt32Array(28 + _hidl_offset, this.discoveryChannelMhzVal);
        _hidl_blob.putBool(36 + _hidl_offset, this.validUseBeaconsInBandVal);
        _hidl_blob.putBoolArray(37 + _hidl_offset, this.useBeaconsInBandVal);
        _hidl_blob.putBool(39 + _hidl_offset, this.validUseSdfInBandVal);
        _hidl_blob.putBoolArray(40 + _hidl_offset, this.useSdfInBandVal);
    }
}
