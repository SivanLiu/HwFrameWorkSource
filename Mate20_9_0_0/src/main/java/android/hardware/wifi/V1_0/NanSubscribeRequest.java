...
public final class NanSubscribeRequest {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.baseConfigs.readEmbeddedFromParcel(hwParcel, hwBlob, _hidl_offset + 0);
        this.subscribeType = hwBlob.getInt32(_hidl_offset + 176);
        this.srfType = hwBlob.getInt32(_hidl_offset + 180);
        this.srfRespondIfInAddressSet = hwBlob.getBool(_hidl_offset + 184);
        this.shouldUseSrf = hwBlob.getBool(_hidl_offset + 185);
        this.isSsiRequiredForMatch = hwBlob.getBool(_hidl_offset + 186);
        int _hidl_vec_size = hwBlob.getInt32((_hidl_offset + 192) + 8);
        HwBlob childBlob = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size * 6), _hidl_blob.handle(), 0 + (_hidl_offset + 192), true);
        this.intfAddr.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<NanSubscribeRequest> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((NanSubscribeRequest) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 208));
            _hidl_index_0++;
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            if (_hidl_index_02 < _hidl_vec_size) {
                childBlob.putInt8Array((long) (_hidl_index_02 * 6), (byte[]) this.intfAddr.get(_hidl_index_02));
