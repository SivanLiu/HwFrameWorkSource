...
public final class StaScanData {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.flags = hwBlob.getInt32(_hidl_offset + 0);
        this.bucketsScanned = hwBlob.getInt32(_hidl_offset + 4);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            if (_hidl_index_02 < _hidl_vec_size) {
                ((StaScanResult) this.results.get(_hidl_index_02)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_02 * 64));
