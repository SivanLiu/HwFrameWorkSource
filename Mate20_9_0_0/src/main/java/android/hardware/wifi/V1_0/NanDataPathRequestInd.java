...
public final class NanDataPathRequestInd {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        hwBlob.copyToInt8Array(_hidl_offset + 1, this.peerDiscMacAddr, 6);
        this.ndpInstanceId = hwBlob.getInt32(_hidl_offset + 8);
        this.securityRequired = hwBlob.getBool(_hidl_offset + 12);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putInt8Array(1 + _hidl_offset, this.peerDiscMacAddr);
        ...
        while (true) {
            ...
            if (_hidl_index_02 < _hidl_vec_size) {
                childBlob.putInt8((long) (_hidl_index_02 * 1), ((Byte) this.appInfo.get(_hidl_index_02)).byteValue());
