...
public final class WeaverReadResponse {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.timeout == other.timeout && HidlSupport.deepEquals(this.value, other.value)) {
            return true;
        }
        return false;
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.timeout = hwBlob.getInt32(_hidl_offset + 0);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            if (_hidl_index_02 < _hidl_vec_size) {
                childBlob.putInt8((long) (_hidl_index_02 * 1), ((Byte) this.value.get(_hidl_index_02)).byteValue());
