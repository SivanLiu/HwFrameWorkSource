...
public class Camera {
    ...
    public class Parameters {
        ...
        public void dump() {
            ...
            for (String k : this.mMap.keySet()) {
                String str2 = Camera.TAG;
                StringBuilder stringBuilder2 = new StringBuilder();
                stringBuilder2.append("dump: ");
                stringBuilder2.append(k);
                stringBuilder2.append("=");
                stringBuilder2.append((String) this.mMap.get(k));
        ...
        public void unflatten(String flattened) {
            ...
            for (String kv : splitter) {
                ...
                if (pos != -1) {
                    this.mMap.put(kv.substring(null, pos), kv.substring(pos + 1));
                }
            }
        }
        ...
        public void set(String key, String value) {
            ...
            if (key.indexOf(61) != -1 || key.indexOf(59) != -1 || key.indexOf(0) != -1) {
                ...
                stringBuilder.append(key);
                stringBuilder.append("\" contains invalid character (= or ; or \\0)");
                Log.e(str, stringBuilder.toString());
        ...
        public void setPreviewSize(int width, int height) {
            ...
            v.append(Integer.toString(width));
            v.append("x");
            v.append(Integer.toString(height));
            set(KEY_PREVIEW_SIZE, v.toString());
        }
        ...
        public void setPreviewFpsRange(int min, int max) {
            String str = KEY_PREVIEW_FPS_RANGE;
            StringBuilder stringBuilder = new StringBuilder();
        ...
        public void setPreviewFormat(int pixel_format) {
            ...
            stringBuilder.append(pixel_format);
        ...
        public List<Integer> getSupportedPreviewFormats() {
            ...
            while (it.hasNext()) {
                int f = pixelFormatForCameraFormat((String) it.next());
                if (f != 0) {
        ...
        public void setPictureSize(int width, int height) {
            ...
            v.append("x");
            v.append(Integer.toString(height));
            set(KEY_PICTURE_SIZE, v.toString());
        }
        ...
        private String cameraFormatForPixelFormat(int pixel_format) {
            ...
            if (pixel_format == ImageFormat.YV12) {
        ...
        private Size strToSize(String str) {
            ...
            if (pos != -1) {
                return new Size(Integer.parseInt(str.substring(null, pos)), Integer.parseInt(str.substring(pos + 1)));
            }
            String str2 = Camera.TAG;
            StringBuilder stringBuilder = new StringBuilder();
        ...
        public void handleMessage(Message msg) {
            ...
            if (i == 4) {
                ...
                if (Camera.this.mZoomListener != null) {
                    ...
                    access$1000.onZoomChange(i2, z, this.mCamera);
                }
            } else if (i == 16) {
                ...
                if (Camera.this.mAutoFocusMoveCallback != null) {
                    ...
                    access$1400.onAutoFocusMoving(z, this.mCamera);
                }
            }
        }
    }
    ...
    public static Camera openLegacy(int cameraId, int halVersion) {
        ...
        stringBuilder.append(halVersion);
        throw new IllegalArgumentException(stringBuilder.toString());
    }
    ...
    private int cameraInitVersion(int cameraId, int halVersion) {
        ...
        boolean blocked = HwSystemManager.allowOp(1024) ^ true;
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
    ...
    public final void setPreviewDisplay(SurfaceHolder holder) throws IOException {
        if (!HwSystemManager.allowOp(true) || holder == null) {
    ...
    public final void setPreviewCallbackAllocation(Allocation previewAllocation) throws IOException {
        ...
        if (previewAllocation != null) {
            ...
            if (previewSize.width != previewAllocation.getType().getX() || previewSize.height != previewAllocation.getType().getY()) {
                ...
                stringBuilder.append(previewAllocation.getType().getX());
                stringBuilder.append(", ");
                stringBuilder.append(previewAllocation.getType().getY());
                stringBuilder.append(". Preview is ");
                stringBuilder.append(previewSize.width);
                stringBuilder.append(", ");
                stringBuilder.append(previewSize.height);
                throw new IllegalArgumentException(stringBuilder.toString());
