...
public class UsbManager {
    ...
    static {
        ...
        FUNCTION_NAME_TO_CODE.put(USB_FUNCTION_ADB, Long.valueOf(1));
        FUNCTION_NAME_TO_CODE.put(USB_FUNCTION_NCM, Long.valueOf(1048576));
        FUNCTION_NAME_TO_CODE.put(USB_FUNCTION_HISUITE, Long.valueOf(2048));
        FUNCTION_NAME_TO_CODE.put(USB_FUNCTION_HDB, Long.valueOf(4096));
        FUNCTION_NAME_TO_CODE.put(USB_FUNCTION_MASS_STORAGE, Long.valueOf(8192));
        FUNCTION_NAME_TO_CODE.put(USB_FUNCTION_MANUFACTURE, Long.valueOf(16384));
        FUNCTION_NAME_TO_CODE.put(USB_FUNCTION_HISI_DEBUG, Long.valueOf(32768));
        FUNCTION_NAME_TO_CODE.put("serial", Long.valueOf(65536));
    }
    ...
    public void setCurrentFunction(String functions, boolean usbDataUnlocked) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setCurrentFunction: ");
