...
public class InputMethodService extends AbstractInputMethodService {
    ...
    private static final class SettingsObserver extends ContentObserver {
        ...
        public static SettingsObserver createAndRegister(InputMethodService service) {
            ...
            service.getContentResolver().registerContentObserver(Global.getUriFor(InputMethodService.NAVIGATIONBAR_IS_MIN), true, observer);
            return observer;
        }
        ...
        private boolean shouldShowImeWithHardKeyboard() {
            ...
            switch (this.mShowImeWithHardKeyboard) {
                ...
                case 2:
                    return true;
                default:
                    String str = InputMethodService.TAG;
        ...
        public void onChange(boolean selfChange, Uri uri) {
            Uri showImeWithHardKeyboardUri = Secure.getUriFor("show_ime_with_hard_keyboard");
            Uri navigationBarIsMinUri = Global.getUriFor(InputMethodService.NAVIGATIONBAR_IS_MIN);
    ...
    public static /* synthetic */ void lambda$new$0(InputMethodService inputMethodService, InternalInsetsInfo info) {
    ...
    public void onStartInputView(EditorInfo info, boolean restarting) {
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("onStartInputView runHwTHPCommand error occured:");
    ...
    public void onFinishInputView(boolean finishingInput) {
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("onFinishInputView runHwTHPCommand error occured:");
            stringBuilder.append(e);
            Log.w(str, stringBuilder.toString());
        }
        if (!finishingInput) {
    ...
    private boolean isSupportWriteIme() {
        boolean z = false;
        if (Secure.getInt(getContentResolver(), WRITE_IME_ENABLE, 0) != 0) {
            z = true;
        }
        return z;
    }
    ...
    public void showWindow(boolean showInput) {
        if (DEBUG_FLOW) {
            ...
            stringBuilder.append(showInput);
            stringBuilder.append(" mShowInputRequested=");
            stringBuilder.append(this.mShowInputRequested);
            stringBuilder.append(" mWindowAdded=");
            stringBuilder.append(this.mWindowAdded);
            stringBuilder.append(" mWindowCreated=");
            stringBuilder.append(this.mWindowCreated);
    ...
    private void setInputEditorInfo() {
        ...
        if (System.getInt(getContentResolver(), KEY_STYLUS_STATE_ENABLE, 0) == 0) {
            this.mChangeModeFlag = "0";
        } else {
            this.mChangeModeFlag = Secure.getString(getContentResolver(), "input_source");
        }
        bundle.putString(this.CHANGE_INPUT_MODE_FOR_BAIDU, this.mChangeModeFlag);
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("default input mode = ");
        stringBuilder.append(this.mChangeModeFlag);
    ...
    protected void dump(FileDescriptor fd, PrintWriter fout, String[] args) {
        ...
        stringBuilder.append("  mWindowVisible=");
        stringBuilder.append(this.mWindowVisible);
        stringBuilder.append(" mWindowWasVisible=");
        stringBuilder.append(this.mWindowWasVisible);
        ...
        p.println(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append("  mStartInputToken=");
        stringBuilder.append(this.mStartInputToken);
        p.println(stringBuilder.toString());
        ...
        p.println(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append(" mShouldClearInsetOfPreviousIme=");
        stringBuilder.append(this.mShouldClearInsetOfPreviousIme);
        p.println(stringBuilder.toString());
        stringBuilder = new StringBuilder();
