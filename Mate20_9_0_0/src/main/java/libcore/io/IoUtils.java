...
public final class IoUtils {
    ...
    public static File createTemporaryDirectory(String prefix) {
        while (true) {
            String candidateName = new StringBuilder();
            candidateName.append(prefix);
            candidateName.append(Math.randomIntInternal());
            File result = new File(System.getProperty("java.io.tmpdir"), candidateName.toString());
            if (result.mkdir()) {
                return result;
            }
        }
