        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 2:
                        data.enforceInterface(descriptor);
                        byte[] _result4 = getSecureElementUid(data.readString());
                        reply.writeNoException();
                        reply.writeByteArray(_result4);
                        return true;
                    case 3:
                        data.enforceInterface(descriptor);
                        _result2 = reset(data.readString());
                        reply.writeNoException();
                        reply.writeInt(_result2);
                        return true;
                    case 4:
                        data.enforceInterface(descriptor);
                        Bundle _result5 = getAtr(data.readString());
                        reply.writeNoException();
                        if (_result5 != null) {
                            reply.writeInt(1);
                    ...
                    case TRANSACTION_openuicc /*10*/:
                        data.enforceInterface(descriptor);
                        _result3 = openuicc(data.readString(), data.readStrongBinder());
                        reply.writeNoException();
                        if (_result3 != null) {
                            reply.writeInt(1);
                    ...
                    case TRANSACTION_closeuicc /*11*/:
                        data.enforceInterface(descriptor);
                        _result3 = closeuicc(data.readString(), data.readStrongBinder());
                        reply.writeNoException();
                        if (_result3 != null) {
                            reply.writeInt(1);
                            _result3.writeToParcel(reply, 1);
                    ...
                    case TRANSACTION_transceiveuicc /*12*/:
                        data.enforceInterface(descriptor);
                        _result3 = transceiveuicc(data.readString(), data.createByteArray());
                        reply.writeNoException();
                        if (_result3 != null) {
                            reply.writeInt(1);
                            _result3.writeToParcel(reply, 1);
                    ...
                    case TRANSACTION_eSEChipReset /*13*/:
                        data.enforceInterface(descriptor);
                        _result2 = eSEChipReset(data.readString());
                        reply.writeNoException();
                        reply.writeInt(_result2);
                        return true;
                    default:
