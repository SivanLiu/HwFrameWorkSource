        ...
        private static class Proxy implements INxpNfcController {
            ...
            public NxpApduServiceInfo getDefaultOffHostService(int userId, String packageName) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = (NxpApduServiceInfo) NxpApduServiceInfo.CREATOR.createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    _reply.recycle();
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    case 1:
                        ...
                        if (data.readInt() != 0) {
                            _arg3 = (NxpApduServiceInfo) NxpApduServiceInfo.CREATOR.createFromParcel(data);
                        }
                    ...
                    case 4:
                        ...
                        boolean _result4 = commitOffHostService(_arg0, _arg1, _arg2, _arg3);
                        reply.writeNoException();
