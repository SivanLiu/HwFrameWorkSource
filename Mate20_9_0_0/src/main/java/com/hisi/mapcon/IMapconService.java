        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 3:
                        data.enforceInterface(descriptor);
                        _result2 = setDomain(data.readInt(), data.readInt());
                        reply.writeNoException();
                    ...
                    case 6:
                        data.enforceInterface(descriptor);
                        _result2 = notifyImsOff(data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result2);
                        return true;
                    case 7:
                    ...
                    case 8:
                        data.enforceInterface(descriptor);
                        _result2 = setVoWifiServiceOn(data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result2);
                        return true;
                    case 9:
                        data.enforceInterface(descriptor);
                        _result2 = setVoWifiServiceOff(data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result2);
                        return true;
                    case 10:
                        data.enforceInterface(descriptor);
                        _result2 = getVoWifiServiceState(data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result2);
                        return true;
                    case 11:
                        data.enforceInterface(descriptor);
                        int _result4 = setVoWifiServiceDomain(data.readInt(), data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result4);
                        return true;
                    case 12:
                        data.enforceInterface(descriptor);
                        _result2 = getVoWifiServiceDomain(data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result2);
                        return true;
                    case 13:
                        ...
                        _result3 = setupTunnelOverWifi(_result, _result2, _arg2, _arg3);
                        reply.writeNoException();
                    ...
                    case 14:
                        ...
                        _result3 = teardownTunnelOverWifi(_result, _result2, _arg2, _arg3);
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case 15:
                        data.enforceInterface(descriptor);
                        String _result5 = getUtOverWifiApn();
                        reply.writeNoException();
