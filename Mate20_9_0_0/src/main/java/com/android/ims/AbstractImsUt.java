...
public abstract class AbstractImsUt implements AbstractImsUtInterface {
    ...
    public interface ImsUtReference {
        ...
        void updateCallBarringOption(String str, int i, boolean z, int i2, Message message, String[] strArr);
    ...
    public void updateCallBarringOption(String password, int cbType, boolean enable, int serviceClass, Message result, String[] barrList) {
        this.mReference.updateCallBarringOption(password, cbType, enable, serviceClass, result, barrList);
    }
