...
public class CapInfo implements Parcelable {
    ...
    /* synthetic */ CapInfo(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        dest.writeInt(this.mImSupported);
        dest.writeInt(this.mFtSupported);
        dest.writeInt(this.mFtThumbSupported);
        dest.writeInt(this.mFtSnFSupported);
        dest.writeInt(this.mFtHttpSupported);
        dest.writeInt(this.mIsSupported);
        dest.writeInt(this.mVsDuringCSSupported);
        dest.writeInt(this.mVsSupported);
        dest.writeInt(this.mSpSupported);
        dest.writeInt(this.mCdViaPresenceSupported);
        dest.writeInt(this.mIpVoiceSupported);
        dest.writeInt(this.mIpVideoSupported);
        dest.writeInt(this.mGeoPullFtSupported);
        dest.writeInt(this.mGeoPullSupported);
        dest.writeInt(this.mGeoPushSupported);
        dest.writeInt(this.mSmSupported);
        dest.writeInt(this.mFullSnFGroupChatSupported);
        dest.writeInt(this.mRcsIpVoiceCallSupported);
        dest.writeInt(this.mRcsIpVideoCallSupported);
        dest.writeInt(this.mRcsIpVideoOnlyCallSupported);
