            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    ...
                    case 2:
                        parcel.enforceInterface(descriptor);
                        _arg0 = data.readInt();
                        IOptionsListener _arg12 = com.android.ims.internal.uce.options.IOptionsListener.Stub.asInterface(data.readStrongBinder());
                        if (data.readInt() != 0) {
                            _arg1 = (UceLong) UceLong.CREATOR.createFromParcel(parcel);
                        }
                    ...
                    case 8:
                        ...
                        if (data.readInt() != 0) {
                            _arg1 = (OptionsCapInfo) OptionsCapInfo.CREATOR.createFromParcel(parcel);
                        }
                        StatusCode _result4 = responseIncomingOptions(_arg02, _arg14, _arg2, _arg3, _arg1, data.readInt() != 0);
                        reply.writeNoException();
                        if (_result4 != null) {
                            parcel2.writeInt(1);
