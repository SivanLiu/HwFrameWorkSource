            ...
            if (code != IBinder.INTERFACE_TRANSACTION) {
                ...
                switch (code) {
                    case 1:
                        ...
                        receiveSessionModifyRequest(_arg2);
                        return true;
                    case 2:
                        VideoProfile _arg1;
                        data.enforceInterface(descriptor);
                        ...
                        receiveSessionModifyResponse(_arg0, _arg1, _arg2);
                        return true;
                    case 3:
                        data.enforceInterface(descriptor);
                    ...
                    case 5:
                        ...
                        return true;
                    case 6:
                        CameraCapabilities _arg02;
                        data.enforceInterface(descriptor);
                        if (data.readInt() != 0) {
                            _arg02 = (CameraCapabilities) CameraCapabilities.CREATOR.createFromParcel(data);
                        }
