            ...
            if (code != IBinder.INTERFACE_TRANSACTION) {
                ...
                switch (code) {
                    case 1:
                        ...
                        boolean _result3 = startService(com.android.ims.internal.uce.uceservice.IUceListener.Stub.asInterface(data.readStrongBinder()));
                    ...
                    case 9:
                        data.enforceInterface(descriptor);
                        IPresenceService _result4 = getPresenceService();
                        reply.writeNoException();
                        if (_result4 != null) {
                            _arg12 = _result4.asBinder();
                        }
                        reply.writeStrongBinder(_arg12);
                        return true;
                    case 10:
                        data.enforceInterface(descriptor);
                        IOptionsService _result5 = getOptionsService();
                        reply.writeNoException();
                        if (_result5 != null) {
                            _arg12 = _result5.asBinder();
                        }
                        reply.writeStrongBinder(_arg12);
                        return true;
                    default:
