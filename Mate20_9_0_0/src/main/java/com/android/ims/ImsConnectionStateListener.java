...
public class ImsConnectionStateListener extends Callback {
    ...
    public void onFeatureCapabilityChangedAdapter(int imsRadioTech, Capabilities c) {
        ...
        while (i < enabledCapabilities.length) {
