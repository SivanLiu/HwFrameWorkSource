...
public class GnssMetrics {
    ...
    public String dumpGnssMetricsAsProtoString() {
        ...
        String s = Base64.encodeToString(GnssLog.toByteArray(msg), 0);
        reset();
        return s;
    }
    ...
    public String dumpGnssMetricsAsText() {
        ...
        if (stats != null) {
            ...
            stringBuilder.append(((double) stats.getLoggingDurationMs()) / 60000.0d);
            ...
            if (t != null && t.length == 2) {
                ...
                stringBuilder2.append(Double.toString(20.0d));
