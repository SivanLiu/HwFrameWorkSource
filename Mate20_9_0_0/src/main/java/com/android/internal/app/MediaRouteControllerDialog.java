...
public class MediaRouteControllerDialog extends AlertDialog {
    ...
    private final class MediaRouterCallback extends SimpleCallback {
        ...
        /* synthetic */ MediaRouterCallback(MediaRouteControllerDialog x0, AnonymousClass1 x1) {
            this();
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setButton(-2, getContext().getResources().getString(17040416), new OnClickListener() {
        ...
        View customPanelView = getWindow().findViewById(16908834);
        if (customPanelView != null) {
            customPanelView.setMinimumHeight(0);
        }
        this.mVolumeLayout = (LinearLayout) customView.findViewById(16909073);
        this.mVolumeSlider = (SeekBar) customView.findViewById(16909074);
        ...
        if (update()) {
            ...
            FrameLayout controlFrame = (FrameLayout) customView.findViewById(16909069);
