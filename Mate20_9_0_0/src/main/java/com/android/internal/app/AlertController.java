...
public class AlertController {
    ...
    protected void setupView() {
        View buttonPanel;
        boolean buttonPanel2;
        View spacer;
        View parentPanel = this.mWindow.findViewById(16909180);
        View defaultTopPanel = parentPanel.findViewById(16909452);
        View defaultContentPanel = parentPanel.findViewById(16908827);
        View defaultButtonPanel = parentPanel.findViewById(16908781);
        View customPanel = (ViewGroup) parentPanel.findViewById(16908834);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel != null ? customPanel.findViewById(16909452) : null;
        View customContentPanel = customPanel != null ? customPanel.findViewById(16908827) : null;
        View customButtonPanel = customPanel != null ? customPanel.findViewById(16908781) : null;
        ...
        View buttonPanel3 = resolvePanel(customButtonPanel, defaultButtonPanel);
        if (contentPanel != null) {
            setupContent(contentPanel);
        }
        if (buttonPanel3 != null) {
            setupButtons(buttonPanel3);
        }
        if (topPanel != null) {
            setupTitle(topPanel);
        }
        ...
        boolean z = (buttonPanel3 == null || buttonPanel3.getVisibility() == 8) ? false : true;
        boolean hasButtonPanel = z;
        if (hasButtonPanel) {
            buttonPanel = buttonPanel3;
            buttonPanel2 = true;
        } else {
            if (contentPanel != null) {
                spacer = contentPanel.findViewById(16909417);
                if (spacer != null) {
                    buttonPanel = buttonPanel3;
                    spacer.setVisibility(null);
                    buttonPanel2 = true;
        ...
        if (hasTopPanel) {
            if (this.mScrollView != null) {
                this.mScrollView.setClipToPadding(buttonPanel2);
            }
            spacer = null;
            if (this.mMessage == null && this.mListView == null && !hasCustomPanel) {
                spacer = topPanel.findViewById(16909437);
            } else {
                if (!hasCustomPanel) {
                    spacer = topPanel.findViewById(16909436);
                }
                if (spacer == null) {
                    spacer = topPanel.findViewById(16909435);
                }
            }
            if (spacer != null) {
            ...
            spacer = contentPanel.findViewById(16909418);
            if (spacer != null) {
                spacer.setVisibility(0);
            }
        }
        ...
        boolean hasTopPanel2 = hasTopPanel;
        boolean hasButtonPanel2 = hasButtonPanel;
        boolean hasCustomPanel2 = hasCustomPanel;
        TypedArray a = this.mContext.obtainStyledAttributes(false, R.styleable.AlertDialog, 16842845, false);
        boolean hasTopPanel3 = hasTopPanel2;
        boolean hasButtonPanel3 = hasButtonPanel2;
        boolean hasCustomPanel3 = hasCustomPanel2;
        TypedArray a2 = a;
        setBackground(a, topPanel, contentPanel, customPanel, buttonPanel, hasTopPanel3, hasCustomPanel3, hasButtonPanel3);
        a2.recycle();
    }
    ...
    protected void setupTitle(ViewGroup topPanel) {
        if (this.mCustomTitleView == null || !this.mShowTitle) {
            ...
            if ((TextUtils.isEmpty(this.mTitle) ^ 1) && this.mShowTitle) {
                this.mTitleView = (TextView) this.mWindow.findViewById(16908716);
            ...
            this.mWindow.findViewById(16909441).setVisibility(8);
            this.mIconView.setVisibility(8);
    ...
    protected void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (ScrollView) contentPanel.findViewById(16909276);
    ...
    private void centerButton(Button button) {
        ...
        View leftSpacer = this.mWindow.findViewById(16909039);
        if (leftSpacer != null) {
            leftSpacer.setVisibility(0);
        }
        View rightSpacer = this.mWindow.findViewById(16909256);
        if (rightSpacer != null) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:65:0x00d2 A:{SYNTHETIC, EDGE_INSN: B:65:0x00d2->B:43:0x00d2 ?: BREAK  , EDGE_INSN: B:65:0x00d2->B:43:0x00d2 ?: BREAK  } */
    ...
    protected void setBackground(TypedArray a, View topPanel, View contentPanel, View customPanel, View buttonPanel, boolean hasTitle, boolean hasCustomView, boolean hasButtons) {
        ...
        if (typedArray.getBoolean(true, true)) {
            fullDark = 17303218;
            topDark = 17303232;
            centerDark2 = 17303215;
            bottomDark = 17303212;
            fullBright = 17303217;
            topBright2 = 17303231;
            centerBright2 = 17303214;
            bottomBright = 17303211;
            bottomMedium = 17303213;
        }
        topBright2 = typedArray.getResourceId(5, topBright2);
        topDark = typedArray.getResourceId(1, topDark);
        centerBright2 = typedArray.getResourceId(6, centerBright2);
        centerDark2 = typedArray.getResourceId(2, centerDark2);
        ...
        if (contentPanel != null) {
            ...
            if (contentPanel.getVisibility() != 8) {
                ...
                topDark = 0;
                while (true) {
                    topBright = topBright2;
                    if (topDark < views.length) {
                        break;
                    }
                    View v = views[topDark];
                    if (v == null) {
                        centerBright = centerBright2;
                    } else {
                        if (lastView != null) {
                            if (setView) {
                                centerBright = centerBright2;
                        ...
                        lastView = v;
                        lastLight = light[topDark];
                    }
                    topDark++;
                    topBright2 = topBright;
                    centerBright2 = centerBright;
                }
                if (lastView != null) {
                    if (setView) {
                        topBright2 = lastLight ? hasButtons ? typedArray.getResourceId(8, bottomMedium) : typedArray.getResourceId(7, bottomBright) : typedArray.getResourceId(3, bottomDark);
                        lastView.setBackgroundResource(topBright2);
                    } else {
                ...
                if (listView != null && this.mAdapter != null) {
                    ...
                    centerBright2 = this.mCheckedItem;
                    if (centerBright2 > -1) {
                        listView.setItemChecked(centerBright2, true);
                        listView.setSelectionFromTop(centerBright2, typedArray.getDimensionPixelSize(19, 0));
                        return;
                    }
                    return;
                }
    ...
    protected void setHuaweiScrollIndicators(boolean hasCustomPanel, boolean hasTopPanel, boolean hasButtonPanel) {
        if (!hasCustomPanel) {
            ...
            if (content != null) {
                content.setScrollIndicators((hasButtonPanel ? 2 : 0) | hasTopPanel, 3);
            }
        }
    }
