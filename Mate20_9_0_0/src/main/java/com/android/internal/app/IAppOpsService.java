        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    ...
                    case 9:
                        parcel.enforceInterface(descriptor);
                        _result2 = noteProxyOperation(data.readInt(), data.readString(), data.readInt(), data.readString());
                        reply.writeNoException();
                    ...
                    case 17:
                        parcel.enforceInterface(descriptor);
                        _result2 = checkAudioOperation(data.readInt(), data.readInt(), data.readInt(), data.readString());
                        reply.writeNoException();
                        parcel2.writeInt(_result2);
                        return true;
                    case 18:
