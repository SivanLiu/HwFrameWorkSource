    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (directLaunch != null) {
            ...
            try {
                ...
                stringBuilder.append("Unable to direct launch to ");
                stringBuilder.append(directLaunch);
                stringBuilder.append(": ");
                stringBuilder.append(e.getMessage());
                Slog.i("DumpHeapActivity", stringBuilder.toString());
            }
        }
        Builder b = new Builder(this, 16974394);
        b.setTitle(17039962);
