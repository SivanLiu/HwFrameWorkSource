...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    private void init(View decor) {
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(16908687));
        ...
        this.mSplitView = (ActionBarContainer) decor.findViewById(16909357);
    ...
    protected void initContainerView(View decor) {
        View view = decor.findViewById(16908688);
    ...
    protected void initContextView(View decor) {
        View view = decor.findViewById(16908692);
    ...
    protected void initActionBarOverlayLayout(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(16908849);
    }
