...
public class AssistUtils {
    ...
    public ComponentName getAssistComponentForUser(int userId) {
        ...
        ResolveInfo info = this.mContext.getPackageManager().resolveActivityAsUser(searchManager.getAssistIntent(null), Protocol.BASE_SYSTEM_RESERVED, userId);
        if (info != null) {
    ...
    private static boolean isDisclosureEnabled(Context context) {
        return Secure.getInt(context.getContentResolver(), "assist_disclosure_enabled", 0) != 0;
    }
