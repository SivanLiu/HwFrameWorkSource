...
public class MicroAlertController extends AlertController {
    ...
    protected void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (ScrollView) this.mWindow.findViewById(16909276);
        ...
        if (this.mMessageView != null) {
            if (this.mMessage != null) {
                ...
                if (this.mListView != null) {
                    View topPanel = this.mScrollView.findViewById(16909452);
                    ...
                    View buttonPanel = this.mScrollView.findViewById(16908781);
