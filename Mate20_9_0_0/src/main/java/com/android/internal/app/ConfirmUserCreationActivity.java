    ...
    private String checkUserCreationRequirements() {
        ...
        if (callingPackage != null) {
            try {
                ...
                boolean cantCreateAnyMoreUsers = this.mUserManager.canAddMoreUsers() ^ true;
                boolean accountExists = (this.mAccountName == null || this.mAccountType == null || (AccountManager.get(this).someUserHasAccount(new Account(this.mAccountName, this.mAccountType)) | this.mUserManager.someUserHasSeedAccount(this.mAccountName, this.mAccountType)) == 0) ? false : true;
                ...
                if (cantCreateUser) {
                    ...
                    String message;
                    if (accountExists) {
                        message = getString(17041305, new Object[]{appName, this.mAccountName});
                    } else {
                        message = getString(17041306, new Object[]{appName, this.mAccountName});
                    }
                    return message;
                }
