...
public class WrapperInit {
    ...
    public static void main(String[] args) {
        ...
        ZygoteInit.preload(new TimingsTraceLog("WrapperInitTiming", 16384));
        String[] runtimeArgs = new String[(args.length - 2)];
        System.arraycopy(args, 2, runtimeArgs, 0, runtimeArgs.length);
        wrapperInit(targetSdkVersion, runtimeArgs).run();
    }
            ...
            while (i < 64) {
                ...
                if ((data[dataIndex].inheritable & OsConstants.CAP_TO_MASK(i)) != 0) {
                    try {
                        ...
                        stringBuilder.append("RuntimeInit: Failed to raise ambient capability ");
