...
public class CallbackRegistry<C, T, A> implements Cloneable {
    ...
    private void notifyRemainderLocked(T sender, int arg, A arg2, int remainderIndex) {
        ...
        i = arg;
        A a = arg2;
        notifyRemainderLocked(t, i, a, remainderIndex - 1);
        notifyCallbacksLocked(t, i, a, startIndex, endIndex, bits);
    }
    ...
    private void setRemovalBitLocked(int index) {
        ...
        if (this.mRemainderRemoved == null) {
            ...
            newRemainders = new long[(this.mCallbacks.size() / 64)];
        ...
        newRemainders = this.mRemainderRemoved;
        newRemainders[remainderIndex] = newRemainders[remainderIndex] | bitMask;
    }
