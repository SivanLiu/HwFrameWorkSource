...
public class FastPrintWriter extends PrintWriter {
    ...
    public FastPrintWriter(OutputStream out) {
        this(out, false, (int) SmsCbConstants.SERIAL_NUMBER_ETWS_EMERGENCY_USER_ALERT);
    }

    public FastPrintWriter(OutputStream out, boolean autoFlush) {
        this(out, autoFlush, (int) SmsCbConstants.SERIAL_NUMBER_ETWS_EMERGENCY_USER_ALERT);
    }
    ...
    public FastPrintWriter(Writer wr) {
        this(wr, false, (int) SmsCbConstants.SERIAL_NUMBER_ETWS_EMERGENCY_USER_ALERT);
    }

    public FastPrintWriter(Writer wr, boolean autoFlush) {
        this(wr, autoFlush, (int) SmsCbConstants.SERIAL_NUMBER_ETWS_EMERGENCY_USER_ALERT);
    }
