...
public final class BitUtils {
    ...
    public static boolean maskedEquals(UUID a, UUID b, UUID mask) {
        ...
        boolean z = maskedEquals(a.getLeastSignificantBits(), b.getLeastSignificantBits(), mask.getLeastSignificantBits()) && maskedEquals(a.getMostSignificantBits(), b.getMostSignificantBits(), mask.getMostSignificantBits());
        return z;
    }
