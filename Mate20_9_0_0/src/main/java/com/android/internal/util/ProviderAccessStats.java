...
public class ProviderAccessStats {
    ...
    private final ThreadLocal<PerThreadData> mThreadLocal = ThreadLocal.withInitial(-$$Lambda$ProviderAccessStats$9AhC6lKURctNKuYjVd-wu7jn6_c.INSTANCE);
    ...
    private void incrementStats(int callingUid, SparseLongArray stats) {
        ...
        PerThreadData data = (PerThreadData) this.mThreadLocal.get();
        data.nestCount++;
        if (data.nestCount == 1) {
