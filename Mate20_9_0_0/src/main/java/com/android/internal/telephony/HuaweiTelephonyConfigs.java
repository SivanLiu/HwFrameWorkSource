...
public class HuaweiTelephonyConfigs {
    ...
    public static boolean isHisiPlatform() {
        return definedChipPlatformValue.startsWith("hi363") || definedChipPlatformValue.startsWith("hi6210") || definedChipPlatformValue.startsWith("hi365") || definedChipPlatformValue.startsWith("hi6250") || definedChipPlatformValue.startsWith("hi366") || definedChipPlatformValue.startsWith("kirin9") || !HwModemCapability.isCapabilitySupport(9);
    }

    public static boolean isQcomPlatform() {
        if (definedChipPlatformValue.startsWith("msm") || true == HwModemCapability.isCapabilitySupport(9)) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isModemBipEnable() {
        return !isHisiPlatform() && HwModemCapability.isCapabilitySupport(1);
    }
    ...
    public static boolean isPsRestrictedByFdn() {
        ...
        stringBuilder.append("fddn EVENT_GET_AD_DONE FDN_PS_CHECK:");
        stringBuilder.append(FDN_PS_CHECK);
        stringBuilder.append(" ,FDN_PRELOAD_CACHE:");
        stringBuilder.append(FDN_PRELOAD_CACHE);
        Log.d(str, stringBuilder.toString());
        if (FDN_PS_CHECK && FDN_PRELOAD_CACHE) {
            return true;
        }
        return false;
    }
