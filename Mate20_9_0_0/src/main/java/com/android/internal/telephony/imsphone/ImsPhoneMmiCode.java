...
public final class ImsPhoneMmiCode extends Handler implements MmiCode {
    ...
    boolean isSupportedOverImsPhone() {
        ...
        if (isServiceCodeCallForwarding(this.mSc) || isServiceCodeCallBarring(this.mSc) || ((this.mSc != null && this.mSc.equals(SC_WAIT)) || ((this.mSc != null && this.mSc.equals(SC_CLIR)) || ((this.mSc != null && this.mSc.equals(SC_CLIP)) || ((this.mSc != null && this.mSc.equals(SC_COLR)) || ((this.mSc != null && this.mSc.equals(SC_COLP)) || ((this.mSc != null && this.mSc.equals(SC_BS_MT)) || (this.mSc != null && this.mSc.equals(SC_BAICa))))))))) {
            try {
                ...
                String str = LOG_TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("Invalid service class ");
    ...
    /* JADX WARNING: Removed duplicated region for block: B:32:0x0077 A:{Catch:{ RuntimeException -> 0x03e2 }} */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void processCode() throws CallStateException {
        try {
            ...
            if (isShortCode()) {
                ...
                str = LOG_TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append("processCode: Sending short code '");
                stringBuilder.append(this.mDialingNumber);
                stringBuilder.append("' over CS pipe.");
                Rlog.d(str, stringBuilder.toString());
            ...
            if (isServiceCodeCallForwarding(this.mSc)) {
                ...
                if (isInterrogate()) {
                    ...
                    int cfAction;
                    boolean z;
                    boolean isSettingUnconditional;
                    if (isActivate()) {
                    ...
                    if (reason != 0) {
                        if (reason != 4) {
                            ...
                            this.mPhone.setCallForwardingOption(cfAction2, reason, str, serviceClass, time, obtainMessage(4, isSettingUnconditional, isEnableDesired, this));
                        }
                    }
                    z = true;
                    isSettingUnconditional = z;
                ...
                str = scToBarringFacility(this.mSc);
                isEnableDesired = siToServiceClass(this.mSib);
                if (isInterrogate()) {
                    this.mPhone.getCallBarring(str, obtainMessage(7, this), isEnableDesired);
                } else {
                    if (!isActivate()) {
                        if (!isDeactivate()) {
                    ...
                    this.mPhone.setCallBarring(str, isActivate(), password, obtainMessage(0, this), isEnableDesired);
                }
                ...
                if (this.mSc != null && this.mSc.equals(SC_CLIP)) {
                    ...
                    callAction = siToServiceClass(this.mSib);
                    if (!isActivate()) {
                        if (!isDeactivate()) {
                            if (isInterrogate()) {
                    ...
                    this.mPhone.setCallWaiting(isActivate(), callAction, obtainMessage(0, this));
                } else if (this.mPoundString != null) {
                    str = LOG_TAG;
                    stringBuilder = new StringBuilder();
                    stringBuilder.append("processCode: Sending pound string '");
                    stringBuilder.append(this.mDialingNumber);
                    stringBuilder.append("' over CS pipe.");
                    Rlog.d(str, stringBuilder.toString());
                    throw new CallStateException(Phone.CS_FALLBACK);
            ...
            stringBuilder2.append("processCode: RuntimeException = ");
    ...
    void onUssdFinished(String ussdMessage, boolean isUssdRequest) {
        if (this.mState == State.PENDING) {
            ...
            if (TextUtils.isEmpty(ussdMessage)) {
                ...
                str = LOG_TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append("onUssdFinished: no message; using: ");
        ...
        if (i != 10) {
            ...
            switch (i) {
                ...
                case 6:
                    ...
                    return;
                case 7:
                    onSuppSvcQueryComplete(msg.obj);
                    return;
                default:
                    return;
            }
    ...
    private CharSequence getMmiErrorMessage(AsyncResult ar) {
        if (ar.exception instanceof ImsException) {
            int code = ((ImsException) ar.exception).getCode();
            if (code == 241) {
    ...
    private void onSetComplete(Message msg, AsyncResult ar) {
        ...
        String str = LOG_TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("onSetComplete: mmi=");
        stringBuilder.append(this);
        Rlog.d(str, stringBuilder.toString());
        this.mPhone.onMMIDone(this);
    }
    ...
    private void onSuppSvcQueryComplete(AsyncResult ar) {
        ...
        if (ar.exception != null) {
            ...
            if (ssInfo != null) {
                String str = LOG_TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("onSuppSvcQueryComplete: ImsSsInfo mStatus = ");
                stringBuilder.append(ssInfo.getStatus());
                Rlog.d(str, stringBuilder.toString());
        ...
        String str2 = LOG_TAG;
        StringBuilder stringBuilder2 = new StringBuilder();
        stringBuilder2.append("onSuppSvcQueryComplete mmi=");
    ...
    private void onIcbQueryComplete(AsyncResult ar) {
        String str = LOG_TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("onIcbQueryComplete mmi=");
        stringBuilder.append(this);
        Rlog.d(str, stringBuilder.toString());
        StringBuilder sb = new StringBuilder(getScString());
        sb.append("\n");
            ...
            if (infos.length == 0) {
                ...
                for (int i = 0; i < s; i++) {
                    if (infos[i].getIcbNum() != null) {
                        ...
                        stringBuilder2.append(infos[i].getIcbNum());
                        stringBuilder2.append(" status: ");
                        stringBuilder2.append(infos[i].getStatus());
    ...
    private void onQueryClirComplete(AsyncResult ar) {
        ...
        if (ar.exception == null) {
            ...
            String str = LOG_TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("onQueryClirComplete: CLIR param n=");
        ...
        String str2 = LOG_TAG;
        StringBuilder stringBuilder2 = new StringBuilder();
        stringBuilder2.append("onQueryClirComplete mmi=");
        stringBuilder2.append(this);
        Rlog.d(str2, stringBuilder2.toString());
        this.mPhone.onMMIDone(this);
    }
        ...
        switch (ssData.requestType) {
            ...
            case 4:
                if (ssData.result == 0 && ssData.isTypeUnConditional()) {
                    ...
                    String str2 = LOG_TAG;
                    StringBuilder stringBuilder2 = new StringBuilder();
                    stringBuilder2.append("setCallForwardingFlag cffEnabled: ");
            ...
            default:
                ...
                stringBuilder3.append("Invaid requestType in SSData : ");
                stringBuilder3.append(ssData.requestType);
    ...
    public String toString() {
        ...
        if (this.mSia != null) {
            ...
            stringBuilder.append(this.mSia);
            sb.append(stringBuilder.toString());
        }
        if (this.mSib != null) {
            stringBuilder = new StringBuilder();
            stringBuilder.append(" sib=");
            stringBuilder.append(this.mSib);
            sb.append(stringBuilder.toString());
        }
        if (this.mSic != null) {
            stringBuilder = new StringBuilder();
            stringBuilder.append(" sic=");
            stringBuilder.append(this.mSic);
            sb.append(stringBuilder.toString());
        }
        if (this.mPoundString != null) {
            stringBuilder = new StringBuilder();
            stringBuilder.append(" poundString=");
            stringBuilder.append(Rlog.pii(LOG_TAG, this.mPoundString));
            sb.append(stringBuilder.toString());
        }
        if (this.mDialingNumber != null) {
            stringBuilder = new StringBuilder();
            stringBuilder.append(" dialingNumber=");
            stringBuilder.append(Rlog.pii(LOG_TAG, this.mDialingNumber));
            sb.append(stringBuilder.toString());
        }
        if (this.mPwd != null) {
            stringBuilder = new StringBuilder();
            stringBuilder.append(" pwd=");
            stringBuilder.append(Rlog.pii(LOG_TAG, this.mPwd));
            sb.append(stringBuilder.toString());
        }
