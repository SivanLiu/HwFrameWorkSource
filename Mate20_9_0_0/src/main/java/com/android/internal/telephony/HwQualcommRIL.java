...
public class HwQualcommRIL extends RIL {
    ...
    public static boolean checkExistinSys(String path) {
        ...
        if (new File(stringBuilder.toString(), path).exists()) {
            return true;
        }
        return false;
    }
    ...
    public boolean openSwitchOfUploadAntOrMaxTxPower(int mask) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("openSwitchOfUploadAntOrMaxTxPower, mask = ");
        ...
        stringBuilder.append("openSwitchOfUploadAntOrMaxTxPower, result = ");
    ...
    public boolean closeSwitchOfUploadAntOrMaxTxPower(int mask) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("closeSwitchOfUploadAntOrMaxTxPower, mask = ");
        stringBuilder.append(mask);
        riljLog(stringBuilder.toString());
        boolean result = false;
        try {
        ...
        stringBuilder = new StringBuilder();
        stringBuilder.append("closeSwitchOfUploadAntOrMaxTxPower, result = ");
        stringBuilder.append(result);
        riljLog(stringBuilder.toString());
        return result;
    }
    ...
    public void queryCardType(Message result) {
        ...
        stringBuilder.append(requestToString(rr.getRequest()));
    ...
    public void sendCloudMessageToModem(int event_id) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("sendCloudMessageToModem() entry: event_id = ");
        ...
        stringBuilder2.append("sendCloudMessageToModem() exit : result = ");
    ...
    public void updateStackBinding(int stack, int enable, Message response) {
        ...
        String str = RILJ_LOG_TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("UpdateStackBinding: on Stack: ");
        stringBuilder.append(stack);
        stringBuilder.append(", enable/disable: ");
    ...
    public void switchVoiceCallBackgroundState(int state, Message result) {
        ...
        String str = RILJ_LOG_TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("switchVoiceCallBackgroundState: state is ");
    ...
    public String getHwPrlVersion() {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("getHwPrlVersion() exit : prl = ");
    ...
    public String getHwCDMAMsplVersion() {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("getHwCDMAMsplVersion() exit : MsplVersion = ");
        stringBuilder.append(MsplVersion);
        riljLog(stringBuilder.toString());
        return MsplVersion;
    }
    ...
    public String getHwCDMAMlplVersion() {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("getHwCDMAMsplVersion() exit : MlplVersion = ");
        stringBuilder.append(MlplVersion);
        riljLog(stringBuilder.toString());
        return MlplVersion;
    }
    ...
    public void closeRrc(String interfaceName) {
        if (1 == this.mPhoneType) {
            ...
            String str = RILJ_LOG_TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("request interface ");
            stringBuilder.append(interfaceName);
            stringBuilder.append(" go dormant for GSMphone");
            Rlog.d(str, stringBuilder.toString());
            try {
            ...
            StringBuilder stringBuilder2 = new StringBuilder();
            stringBuilder2.append("closeRrc, result = ");
            stringBuilder2.append(result);
            riljLog(stringBuilder2.toString());
        } else {
    ...
    public boolean setEhrpdByQMI(boolean enable) {
        boolean result = false;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setEhrpdByQMI() entry:enable =");
        stringBuilder.append(enable);
        riljLog(stringBuilder.toString());
        if (qcRilHook != null) {
        ...
        stringBuilder = new StringBuilder();
        stringBuilder.append("setEhrpdByQMI() exit : result = ");
        stringBuilder.append(result);
        riljLog(stringBuilder.toString());
        return result;
    }
    ...
    public void setImsSwitch(boolean on) {
        ...
        try {
            ...
            System.putInt(this.mContext.getContentResolver(), "hw_volte_user_switch", on);
    ...
    public void setLTEReleaseVersion(int state, Message response) {
        ...
        if (qcRilHook != null) {
            ...
            if (obj != null) {
                ret = Integer.valueOf(((Boolean) obj).booleanValue());
            } else {
    ...
    public void setPowerGrade(int powerGrade, Message response) {
        ...
        String str = RILJ_LOG_TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setPowerGrade: state is ");
    ...
    public void setWifiTxPowerGrade(int powerGrade, Message response) {
        ...
        String str = RILJ_LOG_TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setWifiTXPowerGrade: state is ");
        stringBuilder.append(powerGrade);
        Rlog.d(str, stringBuilder.toString());
    ...
    public boolean cmdForECInfo(int event, int action, byte[] buf) {
        String str = RILJ_LOG_TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("cmd for get/set nv, event is : ");
    ...
    public byte getNVInterface(int nvItem, byte[] buf) {
        byte result = ERROR;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("getNVInterface() entry:nvItem =");
        stringBuilder.append(nvItem);
        riljLog(stringBuilder.toString());
        if (qcRilHook != null) {
        ...
        stringBuilder = new StringBuilder();
        stringBuilder.append("getNVInterface() exit : result = ");
        stringBuilder.append(result);
        riljLog(stringBuilder.toString());
        return result;
    }
    ...
    public boolean setEcTestControl(boolean Control_flag) {
        boolean result = false;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setEcTestControl() entry:Control_flag =");
        stringBuilder.append(Control_flag);
        riljLog(stringBuilder.toString());
        if (qcRilHook != null) {
        ...
        stringBuilder = new StringBuilder();
        stringBuilder.append("setEcTestControl() exit : result = ");
        stringBuilder.append(result);
        riljLog(stringBuilder.toString());
        return result;
    }
    ...
    public boolean setKmcPubKey(byte[] buf) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setKmcPubKey() exit : result = ");
        stringBuilder.append(result);
        riljLog(stringBuilder.toString());
        return result;
    }
    ...
    public boolean getKmcPubKey(byte[] buf) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("getKmcPubKey() exit : result = ");
        stringBuilder.append(result);
        riljLog(stringBuilder.toString());
        return result;
    }
    ...
    public boolean getRandomInterface(byte[] buf) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("getRandomInterface() exit : result = ");
        stringBuilder.append(result);
        riljLog(stringBuilder.toString());
        return result;
    }
    ...
    public boolean getEcCdmaCallVersion() {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("getEcCdmaCallVersion() exit : result = ");
        stringBuilder.append(result);
        riljLog(stringBuilder.toString());
        return result;
    }
    ...
    public boolean setEcCdmaCallVersion(boolean version) {
        boolean result = false;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setEcCdmaCallVersion() entry:version =");
        ...
        stringBuilder = new StringBuilder();
        stringBuilder.append("setEcCdmaCallVersion() exit : result = ");
        stringBuilder.append(result);
        riljLog(stringBuilder.toString());
        return result;
    }
    ...
    public int getEcCdmaCallInfo() {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("getEcCdmaCallInfo() exit : result = ");
        stringBuilder.append(result);
        riljLog(stringBuilder.toString());
        return 0;
    }
    ...
    public boolean setEcCdmaCallInfo(int info) {
        boolean result = false;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setEcCdmaCallInfo() entry:version =");
        ...
        stringBuilder = new StringBuilder();
        stringBuilder.append("setEcCdmaCallInfo() exit : result = ");
        stringBuilder.append(result);
        riljLog(stringBuilder.toString());
        return result;
    }
    ...
    public boolean getMipActiveProfile(byte[] buf) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("getMipActiveProfile() exit : result = ");
        stringBuilder.append(result);
        riljLog(stringBuilder.toString());
        return result;
    }
    ...
    public boolean getMipGenUserProf(byte[] buf) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("getMipGenUserProf() exit : result = ");
        stringBuilder.append(result);
        riljLog(stringBuilder.toString());
        return result;
    }
    ...
    public void setDeepNoDisturbState(int state, Message response) {
        ...
        Throwable tr = null;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setDeepNoDisturbState() entry:state =");
        stringBuilder.append(state);
        riljLog(stringBuilder.toString());
        if (qcRilHook != null) {
        ...
        riljLog("setDeepNoDisturbState() exit");
    }
}
