        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 14:
                        data.enforceInterface(descriptor);
                        _result5 = setDisplayName(data.readString(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result5);
                        return true;
                    case 15:
                        data.enforceInterface(descriptor);
                        int _result6 = setDisplayNameUsingSrc(data.readString(), data.readInt(), data.readLong());
                        reply.writeNoException();
                    ...
                    case 19:
                        data.enforceInterface(descriptor);
                        int[] _result7 = getSubId(data.readInt());
                        reply.writeNoException();
                    ...
                    case 30:
                        data.enforceInterface(descriptor);
                        int[] _result8 = getActiveSubIdList();
                        reply.writeNoException();
                    ...
                    case 32:
                        data.enforceInterface(descriptor);
                        String _result9 = getSubscriptionProperty(data.readInt(), data.readString(), data.readString());
                        reply.writeNoException();
                    ...
                    case 34:
                        data.enforceInterface(descriptor);
                        boolean _result10 = isActiveSubId(data.readInt());
                        reply.writeNoException();
