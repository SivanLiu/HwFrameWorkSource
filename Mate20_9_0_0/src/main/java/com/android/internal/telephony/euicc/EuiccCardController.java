...
public class EuiccCardController extends Stub {
    ...
    private class SimSlotStatusChangedBroadcastReceiver extends BroadcastReceiver {
        ...
        /* synthetic */ SimSlotStatusChangedBroadcastReceiver(EuiccCardController x0, AnonymousClass1 x1) {
            this();
        }
    ...
    public EuiccCardController(Context context, Handler handler, EuiccController euiccController, UiccController uiccController) {
        ...
        if (isBootUp(this.mContext)) {
            this.mSimSlotStatusChangeReceiver = new SimSlotStatusChangedBroadcastReceiver(this, null);
    ...
    public static boolean isBootUp(Context context) {
        int bootCount = Global.getInt(context.getContentResolver(), "boot_count", -1);
    ...
    private EuiccCard getEuiccCard(String cardId) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("EuiccCard is null. CardId : ");
    ...
    public void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
        ...
        stringBuilder.append("mBestComponent=");
        stringBuilder.append(this.mBestComponent);
        pw.println(stringBuilder.toString());
