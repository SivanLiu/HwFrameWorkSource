...
public class HwCarrierConfigCardRecord {
    ...
    public boolean isCDMAValid() {
        if (this.mIsSingleModeCdmaCard) {
            ...
            stringBuilder.append("SingleModeCdmaCard mccmnc = ");
            stringBuilder.append(this.mCMccmnc);
    ...
    private boolean isCdmaPlmnHighPri() {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("GCF_CARD_CDMA_PLMNS = ");
        stringBuilder.append(GCF_CARD_CDMA_PLMNS);
        logd(stringBuilder.toString());
        if (TextUtils.isEmpty(GCF_CARD_CDMA_PLMNS)) {
            return false;
        ...
        while (i < length) {
            ...
            if (TextUtils.isEmpty(plmn) || !plmn.equals(this.mCMccmnc)) {
                ...
                stringBuilder2.append("isCdmaMccMncInProp: gcf card mccmnc = ");
                stringBuilder2.append(this.mCMccmnc);
                stringBuilder2.append(" need cdma PLMN match card.");
