...
public class HwVSimDefaultProcessor extends HwVSimProcessor {
    ...
    private void onCmdSwitchWorkMode(Message msg) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("onCmdSwitchWorkMode : isEnabled = ");
        stringBuilder.append(isEnabled);
        stringBuilder.append(", old mode = ");
        stringBuilder.append(param.oldMode);
        stringBuilder.append(", new mode = ");
        stringBuilder.append(param.workMode);
        stringBuilder.append(", isHotplug = ");
        stringBuilder.append(param.isHotplug);
        logd(stringBuilder.toString());
    ...
    private void onGetReservedPlmnDone(Message msg) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("onGetReservedPlmnDone, result = ");
    ...
    private void onCmdSetApnReady(Message msg) {
        ...
        notifyResult(msg.obj, Integer.valueOf(0));
    }
