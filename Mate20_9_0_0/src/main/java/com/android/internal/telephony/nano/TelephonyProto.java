...
public interface TelephonyProto {
    ...
    public static final class ModemPowerStats extends ExtendableMessageNano<ModemPowerStats> {
        ...
        public void writeTo(CodedOutputByteBufferNano output) throws IOException {
            ...
            if (this.txTimeMs != null && this.txTimeMs.length > 0) {
                for (long writeInt64 : this.txTimeMs) {
                    output.writeInt64(9, writeInt64);
                }
            }
            super.writeTo(output);
        }
        ...
        protected int computeSerializedSize() {
            ...
            int dataSize = 0;
            for (long element : this.txTimeMs) {
                dataSize += CodedOutputByteBufferNano.computeInt64SizeNoTag(element);
            }
            return (size + dataSize) + (1 * this.txTimeMs.length);
        }
            ...
            while (true) {
                ...
                switch (tag) {
                    ...
                    case 72:
                        ...
                        i = this.txTimeMs == null ? 0 : this.txTimeMs.length;
                    ...
                    case 74:
                        ...
                        int i2 = this.txTimeMs == null ? 0 : this.txTimeMs.length;
        ...
        public static final class Event extends ExtendableMessageNano<Event> {
            ...
            public static final class CBMessage extends ExtendableMessageNano<CBMessage> {
                ...
                protected int computeSerializedSize() {
                    ...
                    if (this.serviceCategory != 0) {
                        return size + CodedOutputByteBufferNano.computeInt32Size(4, this.serviceCategory);
                    }
                    return size;
                }
            ...
            protected int computeSerializedSize() {
                ...
                if (this.cellBroadcastMessage != null) {
                    return size + CodedOutputByteBufferNano.computeMessageSize(13, this.cellBroadcastMessage);
                }
                return size;
            }
                ...
                while (true) {
                    ...
                    switch (tag) {
                        ...
                        case 50:
                            ...
                            break;
                        case 58:
                            initialPos = WireFormatNano.getRepeatedFieldArrayLength(input, 58);
                            value = this.dataCalls == null ? 0 : this.dataCalls.length;
                            RilDataCall[] newArray = new RilDataCall[(value + initialPos)];
                            if (value != 0) {
                                System.arraycopy(this.dataCalls, 0, newArray, 0, value);
                            }
                            while (value < newArray.length - 1) {
                                newArray[value] = new RilDataCall();
                                input.readMessage(newArray[value]);
                                input.readTag();
                                value++;
                            }
                            newArray[value] = new RilDataCall();
    ...
    public static final class TelephonyCallSession extends ExtendableMessageNano<TelephonyCallSession> {
        ...
        public static final class Event extends ExtendableMessageNano<Event> {
            ...
            protected int computeSerializedSize() {
                ...
                if (this.type != 0) {
                    size2 += CodedOutputByteBufferNano.computeInt32Size(1, this.type);
                }
                if (this.delay != 0) {
                    size2 += CodedOutputByteBufferNano.computeInt32Size(2, this.delay);
                }
                if (this.settings != null) {
                    size2 += CodedOutputByteBufferNano.computeMessageSize(3, this.settings);
                }
                if (this.serviceState != null) {
                    size2 += CodedOutputByteBufferNano.computeMessageSize(4, this.serviceState);
                }
                if (this.imsConnectionState != null) {
                    size2 += CodedOutputByteBufferNano.computeMessageSize(5, this.imsConnectionState);
                }
                if (this.imsCapabilities != null) {
                    size2 += CodedOutputByteBufferNano.computeMessageSize(6, this.imsCapabilities);
                }
                int i = 0;
                if (this.dataCalls != null && this.dataCalls.length > 0) {
                    size = size2;
                ...
                if (this.phoneState != 0) {
                    size2 += CodedOutputByteBufferNano.computeInt32Size(8, this.phoneState);
                }
                if (this.callState != 0) {
                    size2 += CodedOutputByteBufferNano.computeInt32Size(9, this.callState);
                }
                if (this.callIndex != 0) {
                    size2 += CodedOutputByteBufferNano.computeInt32Size(10, this.callIndex);
                }
                if (this.mergedCallIndex != 0) {
                    size2 += CodedOutputByteBufferNano.computeInt32Size(11, this.mergedCallIndex);
                }
                if (this.calls != null && this.calls.length > 0) {
                    while (true) {
                        size = i;
                        if (size >= this.calls.length) {
                            break;
                        }
                        RilCall element2 = this.calls[size];
                        if (element2 != null) {
                            size2 += CodedOutputByteBufferNano.computeMessageSize(12, element2);
                        }
                        i = size + 1;
                    }
                }
                if (this.error != 0) {
                    size2 += CodedOutputByteBufferNano.computeInt32Size(13, this.error);
                }
                if (this.rilRequest != 0) {
                    size2 += CodedOutputByteBufferNano.computeInt32Size(14, this.rilRequest);
                }
                if (this.rilRequestId != 0) {
                    size2 += CodedOutputByteBufferNano.computeInt32Size(15, this.rilRequestId);
                }
                if (this.srvccState != 0) {
                    size2 += CodedOutputByteBufferNano.computeInt32Size(16, this.srvccState);
                }
                if (this.imsCommand != 0) {
                    size2 += CodedOutputByteBufferNano.computeInt32Size(17, this.imsCommand);
                }
                if (this.reasonInfo != null) {
                    size2 += CodedOutputByteBufferNano.computeMessageSize(18, this.reasonInfo);
                }
                if (this.srcAccessTech != -1) {
                    size2 += CodedOutputByteBufferNano.computeInt32Size(19, this.srcAccessTech);
                }
                if (this.targetAccessTech != -1) {
                    size2 += CodedOutputByteBufferNano.computeInt32Size(20, this.targetAccessTech);
                }
                if (this.nitzTimestampMillis != 0) {
                    return size2 + CodedOutputByteBufferNano.computeInt64Size(21, this.nitzTimestampMillis);
                }
                return size2;
            }
                ...
                while (true) {
                    ...
                    switch (tag) {
                        ...
                        case 58:
                            ...
                            RilDataCall[] newArray = new RilDataCall[(i + value)];
                            if (i != 0) {
                        ...
                        case 88:
                            ...
                            break;
                        case 98:
                            value = WireFormatNano.getRepeatedFieldArrayLength(input, 98);
                            i = this.calls == null ? 0 : this.calls.length;
                            RilCall[] newArray2 = new RilCall[(i + value)];
                            if (i != 0) {
    ...
    public static final class TelephonyEvent extends ExtendableMessageNano<TelephonyEvent> {
        ...
        public static final class CarrierIdMatching extends ExtendableMessageNano<CarrierIdMatching> {
            ...
            protected int computeSerializedSize() {
                ...
                if (this.result != null) {
                    return size + CodedOutputByteBufferNano.computeMessageSize(2, this.result);
                }
                return size;
            }
        ...
        public static final class CarrierIdMatchingResult extends ExtendableMessageNano<CarrierIdMatchingResult> {
            ...
            public void writeTo(CodedOutputByteBufferNano output) throws IOException {
                ...
                if (!this.gid1.equals("")) {
                    output.writeString(2, this.gid1);
                }
                if (!this.mccmnc.equals("")) {
                    output.writeString(3, this.mccmnc);
                }
                super.writeTo(output);
            }
            ...
            protected int computeSerializedSize() {
                ...
                if (!this.gid1.equals("")) {
                    size += CodedOutputByteBufferNano.computeStringSize(2, this.gid1);
                }
                if (this.mccmnc.equals("")) {
                    return size;
                }
                return size + CodedOutputByteBufferNano.computeStringSize(3, this.mccmnc);
            }
        ...
        public static final class CarrierKeyChange extends ExtendableMessageNano<CarrierKeyChange> {
            ...
            protected int computeSerializedSize() {
                ...
                if (this.isDownloadSuccessful) {
                    return size + CodedOutputByteBufferNano.computeBoolSize(2, this.isDownloadSuccessful);
                }
                return size;
            }
            ...
            public RilSetupDataCallResponse mergeFrom(CodedInputByteBufferNano input) throws IOException {
                while (true) {
                    ...
                    if (tag == 8) {
                        int initialPos = input.getPosition();
                        int value = input.readInt32();
                        if (!(value == 8 || value == 14 || value == 81 || value == 65535)) {
                            switch (value) {
                                case -6:
                                case -5:
                                case -4:
        ...
        protected int computeSerializedSize() {
            ...
            if (this.carrierKeyChange != null) {
                return size + CodedOutputByteBufferNano.computeMessageSize(17, this.carrierKeyChange);
            }
            return size;
        }
            ...
            while (true) {
                ...
                switch (tag) {
                    ...
                    case 58:
                        ...
                        break;
                    case 66:
                        initialPos = WireFormatNano.getRepeatedFieldArrayLength(input, 66);
                        value = this.dataCalls == null ? 0 : this.dataCalls.length;
                        RilDataCall[] newArray = new RilDataCall[(value + initialPos)];
                        if (value != 0) {
                            System.arraycopy(this.dataCalls, 0, newArray, 0, value);
    ...
    public static final class TelephonyHistogram extends ExtendableMessageNano<TelephonyHistogram> {
        ...
        protected int computeSerializedSize() {
            ...
            i = 0;
            while (i2 < this.bucketCounters.length) {
                i += CodedOutputByteBufferNano.computeInt32SizeNoTag(this.bucketCounters[i2]);
                i2++;
            }
            return (size + i) + (1 * this.bucketCounters.length);
        }
            ...
            while (true) {
                ...
                switch (tag) {
                    ...
                    case 66:
                        ...
                        input.rewindToPosition(startPos);
                        i2 = this.bucketEndPoints == null ? 0 : this.bucketEndPoints.length;
                    ...
                    case 74:
                        ...
                        input.rewindToPosition(startPos);
                        i2 = this.bucketCounters == null ? 0 : this.bucketCounters.length;
                        newArray2 = new int[(i2 + arrayLength2)];
                        if (i2 != 0) {
                            System.arraycopy(this.bucketCounters, 0, newArray2, 0, i2);
                        }
                        while (i2 < newArray2.length) {
                            newArray2[i2] = input.readInt32();
                            i2++;
                        }
                        this.bucketCounters = newArray2;
                        input.popLimit(i);
                        break;
                    default:
                        if (storeUnknownField(input, tag)) {
    ...
    public static final class TelephonyLog extends ExtendableMessageNano<TelephonyLog> {
        ...
        public void writeTo(CodedOutputByteBufferNano output) throws IOException {
            ...
            if (this.histograms != null && this.histograms.length > 0) {
                while (true) {
                    ...
                    TelephonyHistogram element4 = this.histograms[i];
                    if (element4 != null) {
        ...
        protected int computeSerializedSize() {
            ...
            if (this.histograms != null && this.histograms.length > 0) {
                while (true) {
                    size = i;
                    if (size >= this.histograms.length) {
                        break;
                    }
                    TelephonyHistogram element4 = this.histograms[size];
                    if (element4 != null) {
                        size2 += CodedOutputByteBufferNano.computeMessageSize(4, element4);
                    }
                    i = size + 1;
                }
            }
            if (this.eventsDropped) {
                size2 += CodedOutputByteBufferNano.computeBoolSize(5, this.eventsDropped);
            }
            if (this.startTime != null) {
                size2 += CodedOutputByteBufferNano.computeMessageSize(6, this.startTime);
            }
            if (this.endTime != null) {
                size2 += CodedOutputByteBufferNano.computeMessageSize(7, this.endTime);
            }
            if (this.modemPowerStats != null) {
                return size2 + CodedOutputByteBufferNano.computeMessageSize(8, this.modemPowerStats);
            }
            return size2;
        }
