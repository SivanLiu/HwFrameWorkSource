...
public abstract class HwSmsMessage {
    ...
    public static SubmitPdu getDeliverPdu(String scAddress, String scTimeStamp, String origAddress, String message, byte[] UDH) {
        ...
        try {
            ...
            if ((255 & userData[0]) > PduHeaders.PREVIOUSLY_SENT_BY) {
            ...
            try {
                ...
                stringBuilder.append("encode SC timestamp failed.");
            ...
            try {
                timeStampArray = SmsMessage.encodeUCS2(message, UDH);
                if (timeStampArray.length > 141) {
                    return null;
                }
                bo.write(8);
                try {
