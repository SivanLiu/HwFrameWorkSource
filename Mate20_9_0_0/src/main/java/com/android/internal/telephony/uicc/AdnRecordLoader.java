            ...
            switch (msg.what) {
                case 1:
                    ...
                    if (ar.exception == null) {
                        adn = new AdnRecord(this.mEf, this.mRecordNumber, data2);
                        this.mResult = adn;
                ...
                case 2:
                    ar = (AsyncResult) msg.obj;
                    data = (byte[]) ar.result;
                    AdnRecord adn2 = ar.userObj;
                    if (ar.exception == null) {
                        String str = LOG_TAG;
                        StringBuilder stringBuilder = new StringBuilder();
                        stringBuilder.append("ADN extension EF: 0x");
                        stringBuilder.append(Integer.toHexString(this.mExtensionEF));
                        stringBuilder.append(":");
                        stringBuilder.append(adn2.mExtRecord);
                        stringBuilder.append("\n");
                        stringBuilder.append(IccUtils.bytesToHexString(data));
                        Rlog.d(str, stringBuilder.toString());
                        adn2.appendExtRecord(data);
                    } else {
                ...
                case 3:
                    ...
                    if (ar.exception == null) {
                        ...
                        int s = datas.size();
                        for (int i = 0; i < s; i++) {
                            AdnRecord adn3 = new AdnRecord(this.mEf, 1 + i, (byte[]) datas.get(i));
                            this.mAdns.add(adn3);
