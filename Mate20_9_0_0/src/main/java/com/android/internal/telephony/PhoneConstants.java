...
public class PhoneConstants extends AbstractPhoneConstants {
    ...
    public static final String[] APN_TYPES = new String[]{APN_TYPE_DEFAULT, APN_TYPE_MMS, APN_TYPE_SUPL, APN_TYPE_DUN, APN_TYPE_HIPRI, APN_TYPE_FOTA, APN_TYPE_IMS, APN_TYPE_CBS, APN_TYPE_IA, APN_TYPE_EMERGENCY, APN_TYPE_INTERNALDEFAULT};
    ...
    public static final int PIN_NOT_SUPPORT = 3;
