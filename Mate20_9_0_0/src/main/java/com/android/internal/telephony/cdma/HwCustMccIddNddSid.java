...
public class HwCustMccIddNddSid {
    ...
    public String toString() {
        ...
        stringBuilder.append(", SidMin = ");
        stringBuilder.append(this.SidMin);
        stringBuilder.append(", SidMax = ");
        stringBuilder.append(this.SidMax);
        stringBuilder.append(", Idd = ");
        stringBuilder.append(this.Idd);
        stringBuilder.append(", Ndd = ");
        stringBuilder.append(this.Ndd);
