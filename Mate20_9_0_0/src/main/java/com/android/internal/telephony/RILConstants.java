...
public interface RILConstants extends AbstractRILConstants {
    ...
    public static final int PREFERRED_NETWORK_MODE = Integer.parseInt(TelephonyManager.getTelephonyProperty(0, "ro.telephony.default_network", Integer.toString(0)));
    ...
    public static final int RIL_REQUEST_GET_SLOT_STATUS = 144;
    ...
    public static final int RIL_REQUEST_SET_LINK_CAPACITY_REPORTING_CRITERIA = 149;
    public static final int RIL_REQUEST_SET_LOCATION_UPDATES = 76;
    public static final int RIL_REQUEST_SET_LOGICAL_TO_PHYSICAL_SLOT_MAPPING = 145;
    ...
    public static final int RIL_REQUEST_SET_SIGNAL_STRENGTH_REPORTING_CRITERIA = 148;
    ...
    public static final int RIL_REQUEST_START_KEEPALIVE = 146;
    ...
    public static final int RIL_REQUEST_STOP_KEEPALIVE = 147;
    ...
    public static final int RIL_UNSOL_ICC_SLOT_STATUS = 1050;
    public static final int RIL_UNSOL_KEEPALIVE_STATUS = 1051;
    ...
    public static final int RIL_UNSOL_PHYSICAL_CHANNEL_CONFIG = 1052;
