...
public class SimulatedCommands extends BaseCommands implements CommandsInterface, SimulatedRadioControl {
    ...
    public void getIccSlotsStatus(Message result) {
        ...
        if (this.mIccSlotStatus != null) {
            ...
            resultFail(result, null, new CommandException(Error.REQUEST_NOT_SUPPORTED));
        }
    }
    ...
    public void supplyIccPin(String pin, Message result) {
        ...
        if (this.mSimLockedState != SimLockState.REQUIRE_PIN) {
            ...
            stringBuilder.append("[SimCmd] supplyIccPin: wrong state, state=");
            stringBuilder.append(this.mSimLockedState);
            ...
            if (result != null) {
                ...
                str = LOG_TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append("[SimCmd] supplyIccPin: failed! attempt=");
                stringBuilder.append(this.mPinUnlockAttempts);
                Rlog.i(str, stringBuilder.toString());
    ...
    public void supplyIccPuk(String puk, String newPin, Message result) {
        ...
        if (this.mSimLockedState != SimLockState.REQUIRE_PUK) {
            str = LOG_TAG;
            stringBuilder = new StringBuilder();
            stringBuilder.append("[SimCmd] supplyIccPuk: wrong state, state=");
            stringBuilder.append(this.mSimLockedState);
            Rlog.i(str, stringBuilder.toString());
            resultFail(result, null, new CommandException(Error.PASSWORD_INCORRECT));
            ...
            if (result != null) {
                ...
                str = LOG_TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append("[SimCmd] supplyIccPuk: failed! attempt=");
                stringBuilder.append(this.mPukUnlockAttempts);
                Rlog.i(str, stringBuilder.toString());
    ...
    public void supplyIccPin2(String pin2, Message result) {
        ...
        if (this.mSimFdnEnabledState != SimFdnState.REQUIRE_PIN2) {
            str = LOG_TAG;
            stringBuilder = new StringBuilder();
            stringBuilder.append("[SimCmd] supplyIccPin2: wrong state, state=");
            stringBuilder.append(this.mSimFdnEnabledState);
            Rlog.i(str, stringBuilder.toString());
            resultFail(result, null, new CommandException(Error.PASSWORD_INCORRECT));
            ...
            if (result != null) {
                ...
                str = LOG_TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append("[SimCmd] supplyIccPin2: failed! attempt=");
                stringBuilder.append(this.mPin2UnlockAttempts);
                Rlog.i(str, stringBuilder.toString());
    ...
    public void supplyIccPuk2(String puk2, String newPin2, Message result) {
        ...
        if (this.mSimFdnEnabledState != SimFdnState.REQUIRE_PUK2) {
            str = LOG_TAG;
            stringBuilder = new StringBuilder();
            stringBuilder.append("[SimCmd] supplyIccPuk2: wrong state, state=");
            stringBuilder.append(this.mSimLockedState);
            Rlog.i(str, stringBuilder.toString());
            resultFail(result, null, new CommandException(Error.PASSWORD_INCORRECT));
            ...
            if (result != null) {
                ...
                str = LOG_TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append("[SimCmd] supplyIccPuk2: failed! attempt=");
                stringBuilder.append(this.mPuk2UnlockAttempts);
                Rlog.i(str, stringBuilder.toString());
    ...
    public void queryFacilityLockForApp(String facility, String pin, int serviceClass, String appId, Message result) {
        ...
        if (facility != null && facility.equals(CommandsInterface.CB_FACILITY_BA_SIM)) {
            if (result != null) {
                r = new int[]{this.mSimLockEnabled};
                str = LOG_TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append("[SimCmd] queryFacilityLock: SIM is ");
                stringBuilder.append(r[0] == 0 ? "unlocked" : "locked");
                Rlog.i(str, stringBuilder.toString());
            ...
            if (result != null) {
                r = new int[]{this.mSimFdnEnabled};
                str = LOG_TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append("[SimCmd] queryFacilityLock: FDN is ");
                stringBuilder.append(r[0] == 0 ? "disabled" : "enabled");
                Rlog.i(str, stringBuilder.toString());
                resultSuccess(result, r);
            }
        }
    ...
    public void getSignalStrength(Message result) {
        if (this.mSignalStrength == null) {
            ...
            this.mSignalStrength = new SignalStrength(20, 0, -1, -1, -1, -1, -1, 99, KeepaliveStatus.INVALID_HANDLE, KeepaliveStatus.INVALID_HANDLE, KeepaliveStatus.INVALID_HANDLE, KeepaliveStatus.INVALID_HANDLE, KeepaliveStatus.INVALID_HANDLE, 0, 0, -1);
        }
    ...
    public void writeSmsToSim(int status, String smsc, String pdu, Message response) {
        String str = LOG_TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Write SMS to SIM with status ");
    ...
    public void writeSmsToRuim(int status, String pdu, Message response) {
        String str = LOG_TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Write SMS to RUIM with status ");
        stringBuilder.append(status);
        Rlog.d(str, stringBuilder.toString());
        unimplemented(response);
    }
