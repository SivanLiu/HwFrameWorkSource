        ...
        switch (msg.what) {
            ...
            case 2:
                if (msg.obj.exception != null) {
                    ...
                    stringBuilder.append("Memory status report to modem pending : mStorageAvailable = ");
                    stringBuilder.append(this.mStorageAvailable);
            ...
            case 3:
                if (this.mReportMemoryStatusPending) {
                    ...
                    stringBuilder2.append("Sending pending memory status report : mStorageAvailable = ");
                    stringBuilder2.append(this.mStorageAvailable);
