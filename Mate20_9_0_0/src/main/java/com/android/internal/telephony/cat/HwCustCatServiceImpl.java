...
public class HwCustCatServiceImpl extends HwCustCatService {
    ...
    public void onOtaCommand(int otaType) {
        ...
        stringBuilder.append("hwcustCatService impl ota type = ");
        ...
        if (CUST_ENABLE_OTA_BIP) {
            ...
            stringBuilder2.append("hwcustCatService impl ota type2 = ");
            stringBuilder2.append(otaType);
    ...
    public void handleOtaCommand(OtaCmdMessage resMsg, CommandsInterface ci) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("otatype is ");
        stringBuilder.append(resMsg.otaType);
        CatLog.d(this, stringBuilder.toString());
    ...
    public boolean handleRefreshNotification(UiccController uiccController, CommandParams cmdParams, int slotId) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("handleRefreshNotification slotId = ");
    ...
    public void broadcastFileChangeNotification(int slotId) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("broadcast File Change Notification slotId = ");
        stringBuilder.append(slotId);
        CatLog.d(this, stringBuilder.toString());
    ...
    public void broadcastUimLockNotification(int slotId) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("broadcast Uim Lock Notification slotId = ");
        stringBuilder.append(slotId);
        CatLog.d(this, stringBuilder.toString());
