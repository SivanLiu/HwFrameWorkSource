...
public class Input implements Parcelable {
    ...
    /* synthetic */ Input(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.ucs2);
        dest.writeInt(this.packed);
        dest.writeInt(this.digitOnly);
        dest.writeInt(this.echo);
        dest.writeInt(this.yesNo);
