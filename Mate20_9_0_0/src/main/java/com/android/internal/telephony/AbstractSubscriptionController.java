...
public abstract class AbstractSubscriptionController extends Stub {
    ...
    public interface SubscriptionControllerReference {
        ...
        void checkNeedSetMainSlotByPid(int i, int i2);
        ...
        String getSubscriptionPropertyFromSettingsGlobal(int i, String str);
        ...
        void setSubscriptionPropertyIntoSettingsGlobal(int i, String str, String str2);
    ...
    public void setSubscriptionPropertyIntoSettingsGlobal(int subId, String propKey, String propValue) {
        this.mReference.setSubscriptionPropertyIntoSettingsGlobal(subId, propKey, propValue);
    }

    public String getSubscriptionPropertyFromSettingsGlobal(int subId, String propKey) {
        return this.mReference.getSubscriptionPropertyFromSettingsGlobal(subId, propKey);
    }

    public void checkNeedSetMainSlotByPid(int subId, int pid) {
        this.mReference.checkNeedSetMainSlotByPid(subId, pid);
    }
}
