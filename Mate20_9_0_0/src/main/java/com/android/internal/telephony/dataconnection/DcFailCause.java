...
public enum DcFailCause {
    ...
    private boolean isMatchedDsFail() {
        ...
        try {
            ...
            stringBuilder.append("isMatchedDsFail cntelfailcau: ");
            stringBuilder.append(cntelfailcau);
            Rlog.d("DcFailCause", stringBuilder.toString());
            String[] failcau = cntelfailcau.split(",");
            int length = failcau.length;
            while (i < length) {
                if (Integer.toString(this.mErrorCode).equals(failcau[i])) {
                    StringBuilder stringBuilder2 = new StringBuilder();
                    stringBuilder2.append("ErrorCode has been matched: ");
                    stringBuilder2.append(this.mErrorCode);
                    Rlog.d("DcFailCause", stringBuilder2.toString());
                    isMatched = true;
                }
                i++;
            }
    ...
    private boolean isMatchedDsPermanentFail() {
        ...
        try {
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("isMatchedDsPermanentFail mCustPsPermanentFailure: ");
            stringBuilder.append(mCustPsPermanentFailure);
            Rlog.d("DcFailCause", stringBuilder.toString());
            String[] fcaues = mCustPsPermanentFailure.split(",");
            int length = fcaues.length;
            while (i < length) {
                if (Integer.toString(this.mErrorCode).equals(fcaues[i])) {
                    StringBuilder stringBuilder2 = new StringBuilder();
                    stringBuilder2.append("isMatchedDsPermanentFail, ErrorCode has been matched: ");
                    stringBuilder2.append(this.mErrorCode);
                    Rlog.d("DcFailCause", stringBuilder2.toString());
                    isMatched = true;
                }
