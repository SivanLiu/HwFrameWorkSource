...
public class CdmaSubscriptionSourceManager extends Handler {
    ...
    private CdmaSubscriptionSourceManager(Context context, CommandsInterface ci) {
        ...
        stringBuilder.append("cdmaSSM constructor: ");
        stringBuilder.append(subscriptionSource);
        ...
        switch (msg.what) {
            ...
            case 4:
                ...
                if (ar.exception == null) {
                    ...
                    stringBuilder2.append("actStatus = ");
                    stringBuilder2.append(actStatus);
                ...
                stringBuilder3.append("EVENT_SUBSCRIPTION_STATUS_CHANGED, Exception:");
                stringBuilder3.append(ar.exception);
                logw(stringBuilder3.toString());
                return;
            default:
    ...
    public static int getDefault(Context context) {
        ...
        String str = LOG_TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("subscriptionSource from settings: ");
        stringBuilder.append(subscriptionSource);
    ...
    private void handleGetCdmaSubscriptionSource(AsyncResult ar) {
        if (ar.exception == null && ar.result != null && (ar.result instanceof int[])) {
            ...
            if (newSubscriptionSource != this.mCdmaSubscriptionSource.get()) {
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("Subscription Source Changed : ");
        ...
        StringBuilder stringBuilder2 = new StringBuilder();
        stringBuilder2.append("Unable to get CDMA Subscription Source, Exception: ");
