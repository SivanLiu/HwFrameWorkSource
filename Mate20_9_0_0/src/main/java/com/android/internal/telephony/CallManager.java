...
public class CallManager extends AbstractCallManager {
            ...
            if (i != 122) {
                switch (i) {
                    ...
                    case 118:
                        ...
                        return;
                    case 119:
                        for (i = 0; i < CallManager.this.mPostDialCharacterRegistrants.size(); i++) {
    ...
    public int getServiceState() {
        ...
        Iterator it = this.mPhones.iterator();
        while (it.hasNext()) {
            int serviceState = ((Phone) it.next()).getServiceState().getState();
            if (serviceState == 0) {
                return serviceState;
            }
            if (serviceState == 1) {
    ...
    public void unregisterPhone(Phone phone) {
        if (phone != null && this.mPhones.contains(phone)) {
            String str = LOG_TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("unregisterPhone(");
            stringBuilder.append(phone.getPhoneName());
            stringBuilder.append(" ");
            stringBuilder.append(phone);
            stringBuilder.append(")");
    ...
    public void acceptCall(Call ringingCall) throws CallStateException {
        ...
        if (hasActiveFgCall()) {
            ...
            boolean hasBgCall = activePhone.getBackgroundCall().isIdle() ^ true;
    ...
    public Connection dial(Phone phone, String dialString, int videoState) throws CallStateException {
        ...
        if (canDial(phone)) {
            if (hasActiveFgCall(subId)) {
                ...
                String str = LOG_TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("hasBgCall: ");
                stringBuilder.append(hasBgCall);
                stringBuilder.append(" sameChannel:");
            ...
            return phone.dial(dialString, new Builder().setVideoState(videoState).build());
    ...
    public Connection dial(Phone phone, String dialString, UUSInfo uusInfo, int videoState) throws CallStateException {
        return phone.dial(dialString, new Builder().setUusInfo(uusInfo).setVideoState(videoState).build());
    }
    ...
    private boolean canDial(Phone phone) {
        ...
        if (!result) {
            ...
            stringBuilder.append(" hasRingingCall=");
            stringBuilder.append(hasRingingCall);
            stringBuilder.append(" fgCallState=");
            stringBuilder.append(fgCallState);
            Rlog.d(str, stringBuilder.toString());
        }
        return result;
    ...
    public Call getActiveFgCall() {
        ...
        if (this.mDefaultPhone == null) {
            ...
            call2 = this.mDefaultPhone.getForegroundCall();
        }
        return call2;
    }
    ...
    public Call getFirstActiveBgCall() {
        ...
        if (this.mDefaultPhone == null) {
            ...
            call2 = this.mDefaultPhone.getBackgroundCall();
        }
        return call2;
    }
    ...
    public Call getFirstActiveRingingCall() {
        ...
        if (this.mDefaultPhone == null) {
            ...
            call2 = this.mDefaultPhone.getRingingCall();
        }
        return call2;
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < TelephonyManager.getDefault().getPhoneCount(); i++) {
            ...
            stringBuilder2.append(getState(i));
            b.append(stringBuilder2.toString());
            Call call = getActiveFgCall(i);
            if (call != null) {
                stringBuilder = new StringBuilder();
                stringBuilder.append("\n- Foreground: ");
                stringBuilder.append(getActiveFgCallState(i));
                b.append(stringBuilder.toString());
                stringBuilder = new StringBuilder();
                stringBuilder.append(" from ");
                stringBuilder.append(call.getPhone());
                b.append(stringBuilder.toString());
                b.append("\n  Conn: ");
                b.append(getFgCallConnections(i));
            }
            call = getFirstActiveBgCall(i);
            if (call != null) {
                stringBuilder = new StringBuilder();
                stringBuilder.append("\n- Background: ");
                stringBuilder.append(call.getState());
                b.append(stringBuilder.toString());
                stringBuilder = new StringBuilder();
                stringBuilder.append(" from ");
                stringBuilder.append(call.getPhone());
                b.append(stringBuilder.toString());
                b.append("\n  Conn: ");
                b.append(getBgCallConnections(i));
            }
