...
public abstract class Connection {
    ...
    public void setConnectionExtras(Bundle extras) {
        if (extras != null) {
            ...
            if (filteredCount != previousCount) {
                ...
                stringBuilder.append("setConnectionExtras: filtering ");
                stringBuilder.append(previousCount - filteredCount);
                stringBuilder.append(" invalid extras.");
    ...
    protected void notifyDisconnect(int reason) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("notifyDisconnect: callId=");
    ...
    public String toString() {
        ...
        stringBuilder.append((this.mConnectionCapabilities & 16) == 16 ? "Y" : "N");
        str.append(stringBuilder.toString());
        if (Rlog.isLoggable(LOG_TAG, 3)) {
            str.append("addr: XXXX");
            stringBuilder = new StringBuilder();
            stringBuilder.append(" pres.: ");
            stringBuilder.append(getNumberPresentation());
            str.append(stringBuilder.toString());
            str.append(" dial: XXXX");
            stringBuilder = new StringBuilder();
            stringBuilder.append(" postdial: ");
            stringBuilder.append(getRemainingPostDialString());
            str.append(stringBuilder.toString());
            stringBuilder = new StringBuilder();
            stringBuilder.append(" cnap name: ");
            stringBuilder.append(getCnapName());
            str.append(stringBuilder.toString());
            stringBuilder = new StringBuilder();
            stringBuilder.append("(");
            stringBuilder.append(getCnapNamePresentation());
            stringBuilder.append(")");
            str.append(stringBuilder.toString());
        }
        stringBuilder = new StringBuilder();
        stringBuilder.append(" incoming: ");
        stringBuilder.append(isIncoming());
        str.append(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        ...
        str.append(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append(" post dial state: ");
        stringBuilder.append(getPostDialState());
        str.append(stringBuilder.toString());
        return str.toString();
    }
}
