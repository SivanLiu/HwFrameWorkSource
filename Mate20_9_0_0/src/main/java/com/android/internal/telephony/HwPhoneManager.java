...
public interface HwPhoneManager {
    ...
    String decryptInfo(Context context, String str);

    void encryptInfo(Context context, String str, String str2);
    ...
    boolean needUnEscapeHtmlforUssdMsg(Phone phone);
    ...
    boolean processSendUssdInImsCall(GsmMmiCode gsmMmiCode, Phone phone);
