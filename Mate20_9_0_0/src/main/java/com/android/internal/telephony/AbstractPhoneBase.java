...
public abstract class AbstractPhoneBase extends Handler implements PhoneInternalInterface {
    ...
    static {
        boolean z = SystemProperties.get("ro.config.hw_opta", ProxyController.MODEM_0).equals("92") && SystemProperties.get("ro.config.hw_optb", ProxyController.MODEM_0).equals("156");
        IS_CHINA_TELECOM = z;
    }
    ...
    public void retryGetDeviceId(int curRetryCount, int deviceIdMask) {
        ...
        if (count <= 5) {
            ...
            stringBuilder.append("retryGetDeviceId:");
            stringBuilder.append(count);
            stringBuilder.append(" try after ");
            stringBuilder.append(DEVICE_ID_RETRY_INTERVAL);
    ...
    public void registerForHWBuffer(Handler h, int what, Object obj) {
        String str = LOG_TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("PhoneBase.registerForHWBuffer() >>h: ");
    ...
    public void unregisterForHWBuffer(Handler h) {
        String str = LOG_TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("PhoneBase.unregisterForHWBuffer() >>h: ");
        stringBuilder.append(h);
        Rlog.v(str, stringBuilder.toString());
