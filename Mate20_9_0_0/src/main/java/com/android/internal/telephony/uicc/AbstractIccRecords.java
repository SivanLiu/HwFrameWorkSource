...
public abstract class AbstractIccRecords extends Handler {
    ...
    public void sendIccidDoneBroadcast(String mIccId) {
        ...
        stringBuilder.append(" SimRecords sendIccidDoneBroadcast EXTRA_SIM_ICCID=");
        stringBuilder.append(SubscriptionInfo.givePrintableIccid(mIccId));
