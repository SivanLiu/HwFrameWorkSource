...
class CallInfo {
    ...
    String toCLCCLine(int index) {
        ...
        stringBuilder.append(this.mIsMT ? ProxyController.MODEM_1 : ProxyController.MODEM_0);
        stringBuilder.append(",");
        stringBuilder.append(this.mState.value());
        stringBuilder.append(",0,");
        stringBuilder.append(this.mIsMpty ? ProxyController.MODEM_1 : ProxyController.MODEM_0);
        stringBuilder.append(",\"");
