...
public class HwDataConnectionManagerImpl implements HwDataConnectionManager {
    ...
    public boolean needSetUserDataEnabled(boolean enabled) {
        ...
        try {
            ...
            stringBuilder.append("needSetUserDataEnabled result = ");
            stringBuilder.append(result);
            Rlog.d("HwDataConnectionManager", stringBuilder.toString());
            if (result != 1) {
                z = false;
            }
            reply.recycle();
    ...
    public boolean isSoftBankCard(Phone mPhone) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("sbnam:isSoftBankCard sbnam hw_softbank_plmn:");
        stringBuilder.append(softbankPlmns);
        stringBuilder.append(" operator:");
        stringBuilder.append(operator);
        Rlog.e("HwDataConnectionManager", stringBuilder.toString());
        if (softbankPlmns != null) {
            ...
            while (i < length) {
                ...
                if (plmn == null || !plmn.equals(operator)) {
                    ...
                    stringBuilder2.append("sbnam:isSoftBankCard sbnam find softbank card ");
                    stringBuilder2.append(operator);
                    Rlog.e("HwDataConnectionManager", stringBuilder2.toString());
                    return true;
                }
            }
        }
