...
public class HwHisiCsgNetworkInfo {
    ...
    public String toString() {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("HwHisiCsgNetworkInfo{mOper='");
        stringBuilder.append(this.mOper);
        stringBuilder.append('\'');
        stringBuilder.append(", mCSGId='");
        stringBuilder.append(this.mCSGId);
        stringBuilder.append('\'');
        ...
        stringBuilder.append(", mLongName=");
        stringBuilder.append(this.mLongName);
        stringBuilder.append(", mShortName=");
        stringBuilder.append(this.mShortName);
        stringBuilder.append(", mCsgIdType=");
        stringBuilder.append(this.mCsgIdType);
        stringBuilder.append(", mCsgIdName=");
        stringBuilder.append(this.mCsgIdName);
        stringBuilder.append(", mRsrp=");
        stringBuilder.append(this.mRsrp);
        stringBuilder.append(", mRsrq=");
