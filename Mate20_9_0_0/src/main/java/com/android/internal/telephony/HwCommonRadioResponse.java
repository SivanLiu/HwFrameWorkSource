...
import vendor.huawei.hardware.radio.V2_0.IRadioResponse.Stub;
...
public class HwCommonRadioResponse extends Stub {
    ...
    HwCommonRadioResponse(RIL ril) {
        ...
        stringBuilder.append("HwCommonRadioResponse[");
        stringBuilder.append(this.mRil.mPhoneId);
    ...
    public void RspMsg(RadioResponseInfo responseInfo, int msgId, RspMsgPayload payload) {
        ...
        switch (msgId) {
            ...
            case 663:
                ...
                break;
            case 690:
                ret = HwHisiRadioIndication.convertHwHalSignalStrength((int[]) processInts(payload));
                break;
            default:
                validMsgId = false;
                break;
