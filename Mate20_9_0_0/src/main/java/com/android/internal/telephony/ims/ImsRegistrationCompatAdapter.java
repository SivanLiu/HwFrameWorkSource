...
public class ImsRegistrationCompatAdapter extends ImsRegistrationImplBase {
    ...
    private final IImsRegistrationListener mListener = new Stub() {
        ...
        public void registrationConnectedWithRadioTech(int imsRadioTech) throws RemoteException {
            ImsRegistrationCompatAdapter.this.onRegistered(((Integer) ImsRegistrationCompatAdapter.RADIO_TECH_MAPPER.getOrDefault(Integer.valueOf(imsRadioTech), Integer.valueOf(-1))).intValue());
        }

        public void registrationProgressingWithRadioTech(int imsRadioTech) throws RemoteException {
            ImsRegistrationCompatAdapter.this.onRegistering(((Integer) ImsRegistrationCompatAdapter.RADIO_TECH_MAPPER.getOrDefault(Integer.valueOf(imsRadioTech), Integer.valueOf(-1))).intValue());
        }
        ...
        public void registrationChangeFailed(int targetAccessTech, ImsReasonInfo imsReasonInfo) throws RemoteException {
            ImsRegistrationCompatAdapter.this.onTechnologyChangeFailed(((Integer) ImsRegistrationCompatAdapter.RADIO_TECH_MAPPER.getOrDefault(Integer.valueOf(targetAccessTech), Integer.valueOf(-1))).intValue(), imsReasonInfo);
        }
    };
