...
import vendor.huawei.hardware.radio.V2_0.IRadioIndication.Stub;
import vendor.huawei.hardware.radio.V2_0.RILUnsolMsgPayload;

public class HwCommonRadioIndication extends Stub {
    private RIL mRil;
    private String mTag;
    ...
    HwCommonRadioIndication(RIL ril) {
        ...
        stringBuilder.append("HwCommonRadioIndication[");
    ...
    private void handleECCXlema(int indicationType, String eccNum) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("handleECCXlema: eccNum = ");
        stringBuilder.append(eccNum);
