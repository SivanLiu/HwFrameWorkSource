...
public class SmsMessage extends SmsMessageBase {
    ...
    private void parsePdu(byte[] pdu) {
        ...
        try {
            ...
            if (length <= pdu.length) {
                ...
                stringBuilder2.append("createFromPdu: Invalid pdu, bearerDataLength ");
                stringBuilder2.append(bearerDataLength);
                stringBuilder2.append(" > pdu len ");
                stringBuilder2.append(pdu.length);
                throw new RuntimeException(stringBuilder2.toString());
            }
            stringBuilder = new StringBuilder();
            stringBuilder.append("createFromPdu: Invalid pdu, addr.numberOfDigits ");
    ...
    public void parseSms() {
        ...
        if (!(this.mOriginatingAddress == null || this.mOriginatingAddress.origBytes == null)) {
            ...
            if (this.mOriginatingAddress.ton == 1 && this.mOriginatingAddress.address.charAt(0) != '+') {
                ...
                StringBuilder stringBuilder2 = new StringBuilder();
                stringBuilder2.append(HwCustPlusAndIddNddConvertUtils.PLUS_PREFIX);
                stringBuilder2.append(this.mOriginatingAddress.address);
                smsAddress.address = stringBuilder2.toString();
            }
        }
        ...
        if (this.mBearerData.messageType == 4) {
            if (this.mBearerData.messageStatusSet) {
                ...
                stringBuilder3.append("DELIVERY_ACK message without msgStatus (");
                stringBuilder3.append(this.mUserData == null ? "also missing" : "does have");
                stringBuilder3.append(" userData).");
                Rlog.d(str, stringBuilder3.toString());
                this.status = 0;
            }
        } else if (!(this.mBearerData.messageType == 1 || this.mBearerData.messageType == 2)) {
            StringBuilder stringBuilder4 = new StringBuilder();
            stringBuilder4.append("Unsupported message type: ");
            stringBuilder4.append(this.mBearerData.messageType);
    ...
    private static SubmitPdu privateGetSubmitPdu(String destAddrStr, boolean statusReportRequested, UserData userData, int priority) {
        ...
        try {
            ...
            stringBuilder3.append(pdu.encodedMessage.length);
            ...
            stringBuilder.append(ex);
            Rlog.e(str4, stringBuilder.toString());
            return null;
        }
    }
