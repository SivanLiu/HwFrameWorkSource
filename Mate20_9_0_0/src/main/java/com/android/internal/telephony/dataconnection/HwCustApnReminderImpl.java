...
public class HwCustApnReminderImpl extends HwCustApnReminder {
    ...
    private class ApnRemindHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            stringBuilder.append("[apn_all_fail] handleMessage msg = ");
            stringBuilder.append(msg);
            hwCustApnReminderImpl.log(stringBuilder.toString());
            if (msg.what == 1) {
    ...
    private class goSetApnListener implements OnClickListener {
        ...
        /* synthetic */ goSetApnListener(HwCustApnReminderImpl x0, AnonymousClass1 x1) {
            this();
        }
        ...
        public void onClick(DialogInterface dialog, int whichButton) {
            ...
            HwCustApnReminderImpl hwCustApnReminderImpl = HwCustApnReminderImpl.this;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("[apn_all_fail][apnTracker] jump to ApnSettings, subId is ");
    ...
    public void dataRoamingSwitchForCust(String displayName, Context mContext, int mSlotId, boolean isMultiSimEnabled) {
        ...
        if (isMultiSimEnabled) {
            ...
            stringBuilder.append("EE Data roaming is on for double card");
            stringBuilder.append(mSlotId);
        ...
        stringBuilder = new StringBuilder();
        stringBuilder.append("EE Data roaming is on for single card");
        stringBuilder.append(mSlotId);
        log(stringBuilder.toString());
        custRoamingSwitchForCust(mContext, displayName);
    }
    ...
    public void notifyDisableAp(Context context, String oldImsi) {
        if (context != null) {
            IS_DISABLE_AP = "true".equals(Global.getString(context.getContentResolver(), "dualimsi.disableap"));
    ...
    public void deletePreferApn(Context context, String imsi, int slotId) {
        ...
        try {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Exception: read delete_preferapn_switch error ");
