...
public class ModelInterpreter implements Runnable, SimulatedRadioControl {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:37:0x007c A:{SYNTHETIC} */
    /* JADX WARNING: Removed duplicated region for block: B:44:0x0079 A:{SYNTHETIC} */
