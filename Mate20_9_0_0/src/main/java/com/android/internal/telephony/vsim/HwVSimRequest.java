...
public final class HwVSimRequest implements Cloneable {
    ...
    private static class RequestCore {
        ...
        public void setGotCardType(int index, boolean result) {
            if (this.mGotCardType != null && index >= 0 && index < this.mGotCardType.length) {
                ...
                stringBuilder.append("mGotCardType[");
                stringBuilder.append(index);
                stringBuilder.append("] = ");
                stringBuilder.append(this.mGotCardType[index]);
        ...
        public void logCardTypes() {
            if (this.mCardTypes != null) {
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("mCardTypes = ");
                stringBuilder.append(Arrays.toString(this.mCardTypes));
                logd(stringBuilder.toString());
            }
        }
        ...
        public boolean isGotAllCardTypes() {
            ...
            while (i < this.mGotCardType.length) {
        ...
        public void setPowerOnOffMark(int index, boolean result) {
            ...
            if (index >= 0 && index < this.mPowerOnOffMark.length) {
                ...
                if (this.mSubs != null && index < this.mSubs.length) {
                    ...
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("mPowerOnOffMark[");
                    stringBuilder.append(index);
                    stringBuilder.append("(");
                    stringBuilder.append(subId);
                    stringBuilder.append(")] = ");
                    stringBuilder.append(this.mPowerOnOffMark[index]);
                    logd(stringBuilder.toString());
                }
            }
        }
        ...
        public void setSimStateMark(int index, boolean result) {
            ...
            if (index >= 0 && index < this.mGetSimStateMark.length) {
                ...
                if (this.mSubs != null && index < this.mSubs.length) {
                    int subId = this.mSubs[index];
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("mGetSimStateMark[");
                    stringBuilder.append(index);
                    stringBuilder.append("(");
                    stringBuilder.append(subId);
                    stringBuilder.append(")] = ");
                    stringBuilder.append(this.mGetSimStateMark[index]);
                    logd(stringBuilder.toString());
                }
            }
        }
        ...
        public void setCardOnOffMark(int index, boolean result) {
            ...
            if (index >= 0 && index < this.mCardOnOffMark.length) {
                ...
                if (this.mSubs != null && index < this.mSubs.length) {
                    int subId = this.mSubs[index];
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("mCardOnOffMark[");
                    stringBuilder.append(index);
                    stringBuilder.append("(");
                    stringBuilder.append(subId);
                    stringBuilder.append(")] = ");
                    stringBuilder.append(this.mCardOnOffMark[index]);
                    logd(stringBuilder.toString());
                }
            }
        }
        ...
        public void setGetIccCardStatusMark(int index, boolean result) {
            ...
            if (this.mGetIccCardStatusMark != null && index >= 0 && index < this.mGetIccCardStatusMark.length) {
                ...
                if (this.mSubs != null && index < this.mSubs.length) {
                    int subId = this.mSubs[index];
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("mGetIccCardStatusMark[");
                    stringBuilder.append(index);
                    stringBuilder.append("(");
                    stringBuilder.append(subId);
                    stringBuilder.append(")] = ");
                    stringBuilder.append(this.mGetIccCardStatusMark[index]);
                    logd(stringBuilder.toString());
                }
            }
        }
        ...
        public boolean isAllMarkClear() {
            ...
            while (true) {
                i = i2;
                if (i >= this.mGetIccCardStatusMark.length) {
                    return allDone;
                }
                if (this.mGetIccCardStatusMark[i]) {
                    return false;
                }
                i2 = i + 1;
            }
        ...
        public void setGotSimSlotMark(boolean result) {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("mGotSimSlotMark = ");
            stringBuilder.append(this.mGotSimSlotMark);
            logd(stringBuilder.toString());
        }
        ...
        public void setIsNeedSwitchCommrilMode(boolean result) {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("mIsNeedSwitchCommrilMode = ");
        ...
        public void setExpectCommrilMode(CommrilMode mode) {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("mExpectCommrilMode = ");
    ...
    public int getSource() {
        return this.mCore != null ? this.mCore.getSource() : 0;
    }
    ...
    public int getCardCount() {
        return this.mCore != null ? this.mCore.getCardCount() : 0;
    }
}
