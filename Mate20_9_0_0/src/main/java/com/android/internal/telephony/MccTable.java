...
public final class MccTable {
    ...
    public static void updateMccMncConfiguration(Context context, String mccmnc, boolean fromServiceState) {
        String str = LOG_TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("updateMccMncConfiguration mccmnc='");
        stringBuilder.append(mccmnc);
        stringBuilder.append("' fromServiceState=");
        stringBuilder.append(fromServiceState);
        Slog.d(str, stringBuilder.toString());
        if (Build.IS_DEBUGGABLE) {
            str = SystemProperties.get("persist.sys.override_mcc");
            if (!TextUtils.isEmpty(str)) {
                mccmnc = str;
                String str2 = LOG_TAG;
                StringBuilder stringBuilder2 = new StringBuilder();
                stringBuilder2.append("updateMccMncConfiguration overriding mccmnc='");
        ...
        if (!TextUtils.isEmpty(mccmnc)) {
            str = TelephonyManager.getDefault().getSimOperatorNumeric();
            String str3 = LOG_TAG;
            StringBuilder stringBuilder3 = new StringBuilder();
            stringBuilder3.append("updateMccMncConfiguration defaultMccMnc=");
            ...
            if (!HwTelephonyFactory.getHwPhoneManager().shouldSkipUpdateMccMnc(mccmnc) || fromServiceState) {
                ...
                if (VSimUtilsInner.isVSimOn()) {
                    str3 = SystemProperties.get("gsm.operator.numeric.vsim");
                    str4 = LOG_TAG;
                    stringBuilder4 = new StringBuilder();
                    stringBuilder4.append("updateMccMncConfiguration mccmnc = ");
                    stringBuilder4.append(mccmnc);
                    stringBuilder4.append(" getVSimNetworkOperator = ");
                    stringBuilder4.append(str3);
                    Slog.d(str4, stringBuilder4.toString());
                    if (mccmnc.equals(str3)) {
                ...
                try {
                    ...
                    str4 = LOG_TAG;
                    stringBuilder4 = new StringBuilder();
                    stringBuilder4.append("updateMccMncConfiguration: mcc=");
                    stringBuilder4.append(mcc);
                    stringBuilder4.append(", mnc=");
                    stringBuilder4.append(mnc);
                    Slog.d(str4, stringBuilder4.toString());
                    Locale locale = null;
                    if (mcc != 0) {
                    ...
                    if (fromServiceState) {
                        ...
                        try {
                            ...
                            if (updateConfig) {
                                ...
                                stringBuilder5.append("updateMccMncConfiguration updateConfig config=");
                                stringBuilder5.append(config);
                                stringBuilder5.append("config.userSetLocale= ");
                                stringBuilder5.append(config.userSetLocale);
                    ...
                    stringBuilder3.append("Error parsing IMSI: ");
    ...
    private static Locale getLocaleForLanguageCountry(Context context, String language, String country, int mcc) {
        ...
        if (SystemProperties.get("persist.sys.locale", "").isEmpty()) {
            ...
            try {
                ...
                ArrayList<String> locales = new ArrayList(Arrays.asList(localeArray));
                try {
                    String str2;
                    String custScript = HwTelephonyFactory.getHwPhoneManager().custScriptForMcc(mcc);
                    String str3 = LOG_TAG;
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("getLocaleForLanguageCountry: custScript= ");
                    stringBuilder.append(custScript);
                                ...
                                if (l.getLanguage().equals(target.getLanguage())) {
                                    if (l.getCountry().equals(target.getCountry())) {
                                        if (custScript != null && custScript.equalsIgnoreCase(l.getScript())) {
                                            str2 = LOG_TAG;
                                            StringBuilder stringBuilder2 = new StringBuilder();
                                            stringBuilder2.append("getLocaleForLanguageCountry: got perfect match: ");
                                            stringBuilder2.append(l.toLanguageTag());
                                            Slog.d(str2, stringBuilder2.toString());
                                            firstMatch = l;
                                            break;
                                        }
                                        String str4 = LOG_TAG;
                                        StringBuilder stringBuilder3 = new StringBuilder();
                                        stringBuilder3.append("getLocaleForLanguageCountry: got language and country match: ");
                                        stringBuilder3.append(l.toLanguageTag());
                    ...
                    if (firstMatch2 != null) {
                        firstMatch = HwTelephonyFactory.getHwPhoneManager().getBetterMatchLocale(context, language2, custScript, country2, firstMatch2);
                        if (firstMatch != null) {
                    ...
                    if (firstMatch2 != null) {
                        ...
                        stringBuilder.append("getLocaleForLanguageCountry: got a final match: ");
                        stringBuilder.append(firstMatch2.toLanguageTag());
                        Slog.d(str3, stringBuilder.toString());
                        return firstMatch2;
                    }
                    if (!TextUtils.isEmpty(target.getCountry())) {
                        ...
                        if (LocaleStore.getLocaleInfo(target).isTranslated()) {
                            ...
                            stringBuilder4.append("getLocaleForLanguageCountry: target locale is translated: ");
    ...
    private static void setTimezoneFromMccIfNeeded(Context context, int mcc) {
        if (!TimeServiceHelper.isTimeZoneSettingInitializedStatic() || HwTelephonyFactory.getHwPhoneManager().isDefaultTimezone()) {
            ...
            if (zoneId != null && zoneId.length() > 0) {
                ...
                String str = LOG_TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("timezone set to ");
    ...
    private static void setWifiCountryCodeFromMcc(Context context, int mcc) {
        ...
        String str = LOG_TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("WIFI_COUNTRY_CODE set to ");
        stringBuilder.append(country);
        Slog.d(str, stringBuilder.toString());
