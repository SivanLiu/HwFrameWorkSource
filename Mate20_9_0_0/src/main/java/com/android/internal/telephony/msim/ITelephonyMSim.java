        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 14:
                        data.enforceInterface(DESCRIPTOR);
                        _result2 = supplyPin(data.readString(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result2);
                        return true;
                    case 15:
                        data.enforceInterface(DESCRIPTOR);
                        _arg0 = supplyPuk(data.readString(), data.readString(), 0);
                        reply.writeNoException();
                        reply.writeInt(_arg0);
                        return true;
                    case 16:
                        data.enforceInterface(DESCRIPTOR);
                        _result2 = handlePinMmi(data.readString(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result2);
                        return true;
                    case 17:
                    ...
                    case 18:
                        ...
                        _result2 = setRadio(_arg0, data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result2);
                        return true;
                    case 19:
                    ...
                    case 20:
                        data.enforceInterface(DESCRIPTOR);
                        _result3 = enableApnType(data.readString());
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case 21:
                        data.enforceInterface(DESCRIPTOR);
                        _result3 = disableApnType(data.readString());
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case 22:
                        data.enforceInterface(DESCRIPTOR);
                        _arg0 = enableDataConnectivity();
                        reply.writeNoException();
                        reply.writeInt(_arg0);
                        return true;
                    case 23:
                        data.enforceInterface(DESCRIPTOR);
                        _arg0 = disableDataConnectivity();
                        reply.writeNoException();
                        reply.writeInt(_arg0);
                        return true;
                    case 24:
                        data.enforceInterface(DESCRIPTOR);
                        _arg0 = isDataConnectivityPossible();
                        reply.writeNoException();
                        reply.writeInt(_arg0);
                        return true;
                    case 25:
                        data.enforceInterface(DESCRIPTOR);
                        _result3 = getCallState(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    ...
                    case 28:
                        data.enforceInterface(DESCRIPTOR);
                        _result3 = getActivePhoneType(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case 29:
                        data.enforceInterface(DESCRIPTOR);
                        _result3 = getCdmaEriIconIndex(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case 30:
                        data.enforceInterface(DESCRIPTOR);
                        _result3 = getCdmaEriIconMode(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case 31:
                        data.enforceInterface(DESCRIPTOR);
                        String _result5 = getCdmaEriText(data.readInt());
                        reply.writeNoException();
                        reply.writeString(_result5);
                        return true;
                    case 32:
                        data.enforceInterface(DESCRIPTOR);
                        _arg0 = needsOtaServiceProvisioning();
                        reply.writeNoException();
                        reply.writeInt(_arg0);
                        return true;
                    case 33:
                        data.enforceInterface(DESCRIPTOR);
                        _result3 = getVoiceMessageCount(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case 34:
                        data.enforceInterface(DESCRIPTOR);
                        _result3 = getNetworkType(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case 35:
                    ...
                    case 36:
                        data.enforceInterface(DESCRIPTOR);
                        _result3 = getLteOnCdmaMode(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case 37:
                        data.enforceInterface(DESCRIPTOR);
                        List<CellInfo> _result6 = getAllCellInfo();
                        reply.writeNoException();
                        reply.writeTypedList(_result6);
                        return true;
                    case 38:
                        data.enforceInterface(DESCRIPTOR);
                        _result4 = getDefaultSubscription();
                        reply.writeNoException();
                        reply.writeInt(_result4);
                        return true;
                    case TRANSACTION_getPreferredVoiceSubscription /*39*/:
                        data.enforceInterface(DESCRIPTOR);
                        _result4 = getPreferredVoiceSubscription();
                        reply.writeNoException();
                        reply.writeInt(_result4);
                        return true;
                    case 40:
                        data.enforceInterface(DESCRIPTOR);
                        _result4 = getPreferredDataSubscription();
                        reply.writeNoException();
                        reply.writeInt(_result4);
                        return true;
                    case 41:
                    ...
                    case 42:
                        data.enforceInterface(DESCRIPTOR);
                        _result3 = getDataNetworkType(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    default:
