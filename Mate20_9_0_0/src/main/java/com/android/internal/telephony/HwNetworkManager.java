...
public interface HwNetworkManager {
    ...
    void countPackageUseCellInfo(ServiceStateTracker serviceStateTracker, Phone phone, String str);
    ...
    boolean isNeedLocationTimeZoneUpdate(Phone phone, String str);
    ...
    String retToStringEx(int i, Object obj);
