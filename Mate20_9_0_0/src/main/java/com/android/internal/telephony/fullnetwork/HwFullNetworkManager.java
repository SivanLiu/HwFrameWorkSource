...
public class HwFullNetworkManager {
    ...
    public void setDefault4GSlotForOpetator() {
        this.mStateHandler.sendMessage(this.mStateHandler.obtainMessage(HwFullNetworkConstants.EVENT_CHECK_MAIN_SLOT_FOR_OPEATOR, Integer.valueOf(0)));
    }
