...
public class TimeServiceHelper {
    ...
    public void setListener(final Listener listener) {
        if (listener == null) {
            ...
            this.mCr.registerContentObserver(Global.getUriFor("auto_time"), true, new ContentObserver(new Handler()) {
                public void onChange(boolean selfChange) {
                    listener.onTimeDetectionChange(TimeServiceHelper.this.isTimeDetectionEnabled());
                }
            });
            this.mCr.registerContentObserver(Global.getUriFor("auto_time_zone"), true, new ContentObserver(new Handler()) {
                public void onChange(boolean selfChange) {
