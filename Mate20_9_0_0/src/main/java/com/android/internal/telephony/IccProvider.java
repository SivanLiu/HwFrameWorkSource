...
public class IccProvider extends ContentProvider {
        ...
        while (true) {
            ...
            if (n2 >= 0) {
                ...
                if (pair.length != 2) {
                    ...
                    stringBuilder2.append("resolve: bad whereClause parameter: ");
                    stringBuilder2.append(param);
                    Rlog.e(str2, stringBuilder2.toString());
                } else {
                    str2 = pair[0].trim();
                    String val = pair[1].trim();
                    if (STR_TAG.equals(str2)) {
                        tag = normalizeValue(val);
                    } else if (STR_NUMBER.equals(str2)) {
                        number = normalizeValue(val);
                    } else if (STR_EMAILS.equals(str2)) {
                        emails = null;
                    } else if (STR_PIN2.equals(str2)) {
    ...
    private MatrixCursor loadFromEf(int efType, int subId) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("loadFromEf: efType=0x");
        stringBuilder.append(Integer.toHexString(efType).toUpperCase());
        ...
        if (adnRecords != null) {
            ...
            StringBuilder stringBuilder2 = new StringBuilder();
            stringBuilder2.append("adnRecords.size=");
    ...
    private boolean addIccRecordToEf(int efType, String name, String number, String[] emails, String pin2, int subId) {
        ...
        stringBuilder = new StringBuilder();
        stringBuilder.append("addIccRecordToEf: ");
    ...
    private boolean updateIccRecordInEf(int efType, String oldName, String oldNumber, String newName, String newNumber, String pin2, int subId) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("updateIccRecordInEf: efType=0x");
        stringBuilder.append(Integer.toHexString(efType).toUpperCase());
        stringBuilder.append(", subscription=");
        int i = subId;
        stringBuilder.append(i);
        ...
        stringBuilder = new StringBuilder();
        stringBuilder.append("updateIccRecordInEf: ");
        stringBuilder.append(success);
        log(stringBuilder.toString());
        return success;
    }
    ...
    private boolean deleteIccRecordFromEf(int efType, String name, String number, String[] emails, String pin2, int subId) {
        ...
        stringBuilder = new StringBuilder();
        stringBuilder.append("deleteIccRecordFromEf: ");
        stringBuilder.append(success);
        log(stringBuilder.toString());
        return success;
    }
        ...
        if (!record.isEmpty()) {
            ...
            if (emails != null) {
                ...
                while (i < length) {
                    ...
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("Adding email:");
                    stringBuilder.append(Rlog.pii(TAG, email));
                    log(stringBuilder.toString());
