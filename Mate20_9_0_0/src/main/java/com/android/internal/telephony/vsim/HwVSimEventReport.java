...
public class HwVSimEventReport {
    ...
    public static class VSimEventInfo {
        ...
        public String toString() {
            ...
            stringBuilder.append(this.mCauseType);
            stringBuilder.append(", result=");
            stringBuilder.append(this.mResultType);
            stringBuilder.append(", process=");
            stringBuilder.append(this.mProcessType);
            stringBuilder.append(", card=");
            stringBuilder.append(this.mCardType);
            stringBuilder.append(", ps reg time=");
            stringBuilder.append(this.mPsRegTime);
            stringBuilder.append(", sim operator=");
            stringBuilder.append(this.mSimOperator);
            stringBuilder.append(", saved commril mode=");
            stringBuilder.append(this.mSavedCommrilMode);
            stringBuilder.append(", saved main slot=");
            stringBuilder.append(this.mSavedMainSlot);
            stringBuilder.append(", simmode=");
            stringBuilder.append(this.mSimMode);
            stringBuilder.append(", slots table=");
            stringBuilder.append(this.mSlotsTable);
            stringBuilder.append(", saved network mode=");
            stringBuilder.append(this.mSavedNetworkMode);
            stringBuilder.append(", cardpresent info=");
            stringBuilder.append(this.mCardPresent);
            stringBuilder.append(", work mode=");
            stringBuilder.append(this.mWorkMode);
    ...
    public void reportEvent(VSimEventInfo eventInfo) {
        if (HWFLOW) {
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("reportEvent, event info: ");
            stringBuilder.append(eventInfo);
