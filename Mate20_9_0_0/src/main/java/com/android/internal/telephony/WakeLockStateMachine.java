    ...
    class DefaultState extends State {
        ...
        public boolean processMessage(Message msg) {
            if (msg.what != 4) {
                ...
                stringBuilder.append("updatePhoneObject: phone=");
                stringBuilder.append(WakeLockStateMachine.this.mPhone.getClass().getSimpleName());
                wakeLockStateMachine.log(stringBuilder.toString());
            }
            return true;
        }
    }
