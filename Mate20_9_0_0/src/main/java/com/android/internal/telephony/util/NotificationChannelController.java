...
public class NotificationChannelController {
    ...
    private static void createAll(Context context) {
        NotificationChannel alertChannel = new NotificationChannel(CHANNEL_ID_ALERT, context.getText(17040583), 3);
        alertChannel.setSound(System.DEFAULT_NOTIFICATION_URI, new Builder().setUsage(5).build());
        alertChannel.setBlockableSystem(true);
        new NotificationChannel(CHANNEL_ID_MOBILE_DATA_STATUS, context.getText(17040582), 2).setBlockableSystem(true);
        new NotificationChannel(CHANNEL_ID_SIM, context.getText(17040590), 2).setSound(null, null);
        ((NotificationManager) context.getSystemService(NotificationManager.class)).createNotificationChannels(Arrays.asList(new NotificationChannel[]{new NotificationChannel(CHANNEL_ID_CALL_FORWARD, context.getText(17040573), 2), new NotificationChannel(CHANNEL_ID_SMS, context.getText(17040591), 4), new NotificationChannel(CHANNEL_ID_WFC, context.getText(17040598), 2), alertChannel, mobileDataStatusChannel, simChannel}));
    ...
    private static void migrateVoicemailNotificationSettings(Context context) {
        NotificationChannel voiceMailChannel = new NotificationChannel(CHANNEL_ID_VOICE_MAIL, context.getText(17040596), 3);
        ...
        voiceMailChannel.setSound(sound == null ? System.DEFAULT_NOTIFICATION_URI : sound, new Builder().setUsage(5).build());
