...
public interface ISmsInterception extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISmsInterception {
        ...
        private static class Proxy implements ISmsInterception {
            ...
            if (code != 1598968902) {
                switch (code) {
                    case 1:
                        ...
                        registerListener(com.android.internal.telephony.ISmsInterceptionListener.Stub.asInterface(data.readStrongBinder()), data.readInt());
