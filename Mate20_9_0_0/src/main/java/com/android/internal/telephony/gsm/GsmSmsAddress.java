...
public class GsmSmsAddress extends SmsAddress {
    ...
    public GsmSmsAddress(byte[] data, int offset, int length) throws ParseException {
        ...
        if ((toa & 128) != 128) {
            ...
            stringBuilder.append("Invalid TOA - high bit must be set. toa = ");
            stringBuilder.append(toa);
            throw new ParseException(stringBuilder.toString(), offset + 1);
            ...
            if ((addressLength & 1) == 1) {
                ...
                int i = length - 1;
                bArr[i] = (byte) (bArr[i] | MetricsEvent.FINGERPRINT_ENROLLING);
            }
