...
public class HwVolteChrManagerImpl implements HwVolteChrManager {
    ...
    public void updateCallLog(ImsPhoneConnection conn, ImsPhone phone) {
        ...
        stringBuilder2.append("updateCallLog causecode=");
        stringBuilder2.append(causeCode);
        stringBuilder2.append(",mRemoteCauseCode=");
        stringBuilder2.append(this.mRemoteCauseCode);
        stringBuilder2.append(", reason=");
        stringBuilder2.append(reason);
        chrLog(stringBuilder2.toString());
        ...
        if (!conn.isIncoming()) {
            ...
            stringBuilder.append(CallCountEvent.Mo.toString());
            stringBuilder.append(subfix);
            mList.add(stringBuilder.toString());
        } else if (!this.mIsMissedCallTipsOn) {
            stringBuilder = new StringBuilder();
            stringBuilder.append(CallCountEvent.Mt.toString());
            stringBuilder.append(subfix);
            mList.add(stringBuilder.toString());
        }
        if (conn.getDurationMillis() > 0) {
            stringBuilder = new StringBuilder();
            stringBuilder.append(CallCountEvent.Connected.toString());
            stringBuilder.append(subfix);
            mList.add(stringBuilder.toString());
            if (CallEndReason.CALL_FAIL_UE == reason) {
                stringBuilder = new StringBuilder();
                stringBuilder.append(CallCountEvent.DropCallUE.toString());
                stringBuilder.append(subfix);
                mList.add(stringBuilder.toString());
            } else if (CallEndReason.CALL_FAIL_NW == reason) {
                stringBuilder = new StringBuilder();
                stringBuilder.append(CallCountEvent.DropCallNW.toString());
                stringBuilder.append(subfix);
                mList.add(stringBuilder.toString());
            }
            ...
            if (CallEndReason.CALL_FAIL_UE == reason) {
                stringBuilder = new StringBuilder();
                stringBuilder.append(CallCountEvent.MoFailUE.toString());
                stringBuilder.append(subfix);
                mList.add(stringBuilder.toString());
            } else if (CallEndReason.CALL_FAIL_NW == reason) {
                stringBuilder = new StringBuilder();
                stringBuilder.append(CallCountEvent.MoFailNW.toString());
                stringBuilder.append(subfix);
                mList.add(stringBuilder.toString());
            }
            callLostEvent(conn, causeCode, phone);
            ...
            stringBuilder = new StringBuilder();
            stringBuilder.append(CallCountEvent.MtFailUE.toString());
            stringBuilder.append(subfix);
            mList.add(stringBuilder.toString());
        } else if (CallEndReason.CALL_FAIL_NW == reason) {
            stringBuilder = new StringBuilder();
            stringBuilder.append(CallCountEvent.MtFailNW.toString());
            stringBuilder.append(subfix);
            mList.add(stringBuilder.toString());
        }
    ...
    public void updateMtCallLog(int event) {
        ...
        if (2 == event || 9 == event) {
            StringBuilder stringBuilder;
            CallCountEvent callCountEvent;
            ArrayList<String> mList = new ArrayList();
            Bundle mB = new Bundle();
            if (2 == event) {
                stringBuilder = new StringBuilder();
                callCountEvent = CallCountEvent.Mt;
            } else {
                stringBuilder = new StringBuilder();
                callCountEvent = CallCountEvent.MtFailNW;
            }
            stringBuilder.append(callCountEvent.toString());
            stringBuilder.append(CALL_TYPE_AUDIO);
            mList.add(stringBuilder.toString());
            mB.putStringArrayList(CALL_COUNT_LIST, mList);
            sendVolteChrBroadcast(mB, VOLTE_STATISTIC_EVENT);
        }
    ...
    public void triggerCallLostEvent(ImsPhoneConnection conn, ImsPhone phone, int callType) {
        ...
        stringBuilder.append("triggerCallLostEvent callType=");
        stringBuilder.append(callType);
        chrLog(stringBuilder.toString());
    ...
    public void triggerAnswerFailedEvent(int callState) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("triggerAnswerFailedEvent callState=");
    ...
    public void triggerMtCallFailEvent(long ringTime, long inviteTime, int failType, int failCause) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("triggerMtCallFailEvent: ring/hang time: ");
        stringBuilder.append(ringTime);
        stringBuilder.append(", invite time: ");
        stringBuilder.append(inviteTime);
        chrLog(stringBuilder.toString());
    ...
    private void sendVolteChrBroadcast(Bundle data, int faultID) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("sendVolteChrBroadcast faultID=");
        stringBuilder.append(faultID);
        chrLog(stringBuilder.toString());
    ...
    private CallEndReason getCallEndReason(int causeCode, int remoteCauseCode) {
        int SIP_CODE_MIN = HwFullNetworkConstants.EVENT_CHECK_STATE_BASE + 18432;
        int SIP_CODE_MAX = 606 + 18432;
        if (causeCode == 3 || causeCode == 2) {
            return CallEndReason.CALL_END_NORMAL;
        }
        if (remoteCauseCode == 0 || 16 == remoteCauseCode) {
            return CallEndReason.CALL_END_NORMAL;
        }
        if (remoteCauseCode < SIP_CODE_MIN || remoteCauseCode > SIP_CODE_MAX) {
    ...
    public void setSrvccFlag(boolean flag) {
        if (this.mSrvccFlag != flag) {
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("setSrvccFlag: ");
    ...
    private void triggerSrvccAbnormalEvent(int state) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("triggerSrvccFailEvent state=");
        stringBuilder.append(state);
        chrLog(stringBuilder.toString());
        ...
        switch (state) {
            ...
            default:
                StringBuilder stringBuilder2 = new StringBuilder();
                stringBuilder2.append("triggerSrvccAbnormalEvent unknown state=");
                stringBuilder2.append(state);
                chrLogE(stringBuilder2.toString());
                return;
        }
    }
