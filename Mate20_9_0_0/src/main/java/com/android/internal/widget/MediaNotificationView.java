...
public class MediaNotificationView extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        this.mRightIcon = (ImageView) findViewById(16909258);
        this.mActions = findViewById(16909068);
        this.mHeader = findViewById(16909134);
        this.mMainColumn = findViewById(16909135);
    }
}
