            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    case 1:
                        ...
                        setBoolean(_arg02, z, data.readInt());
                    ...
                    case 4:
                        ...
                        _result = getBoolean(_arg02, z, data.readInt());
                        reply.writeNoException();
                        parcel2.writeInt(_result);
                        return true;
                    case 5:
                        parcel.enforceInterface(descriptor);
                        long _result5 = getLong(data.readString(), data.readLong(), data.readInt());
                        reply.writeNoException();
                        parcel2.writeLong(_result5);
                        return true;
                    case 6:
                        parcel.enforceInterface(descriptor);
                        String _result6 = getString(data.readString(), data.readString(), data.readInt());
                        reply.writeNoException();
                    ...
                    case 9:
                        parcel.enforceInterface(descriptor);
                        VerifyCredentialResponse _result7 = checkCredential(data.readString(), data.readInt(), data.readInt(), com.android.internal.widget.ICheckCredentialProgressCallback.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        if (_result7 != null) {
                            parcel2.writeInt(1);
                    ...
                    case 10:
                        parcel.enforceInterface(descriptor);
                        _result2 = verifyCredential(data.readString(), data.readInt(), data.readLong(), data.readInt());
                        reply.writeNoException();
                        if (_result2 != null) {
                            parcel2.writeInt(1);
                    ...
                    case 11:
                        parcel.enforceInterface(descriptor);
                        _result2 = verifyTiedProfileChallenge(data.readString(), data.readInt(), data.readLong(), data.readInt());
                        reply.writeNoException();
                        if (_result2 != null) {
                            parcel2.writeInt(1);
                            _result2.writeToParcel(parcel2, 1);
                    ...
                    case 12:
                        parcel.enforceInterface(descriptor);
                        _result3 = checkVoldPassword(data.readInt());
                        reply.writeNoException();
                        parcel2.writeInt(_result3);
                        return true;
                    case 13:
                        parcel.enforceInterface(descriptor);
                        _result3 = havePattern(data.readInt());
                        reply.writeNoException();
                        parcel2.writeInt(_result3);
                        return true;
                    case 14:
                        parcel.enforceInterface(descriptor);
                        _result3 = havePassword(data.readInt());
                        reply.writeNoException();
                        parcel2.writeInt(_result3);
                        return true;
                    case 15:
                        parcel.enforceInterface(descriptor);
                        byte[] _result8 = getHashFactor(data.readString(), data.readInt());
                        reply.writeNoException();
                    ...
                    case 16:
                        ...
                        setSeparateProfileChallengeEnabled(_arg03, z, data.readString());
                        reply.writeNoException();
                        return true;
                    case 17:
                        parcel.enforceInterface(descriptor);
                        _result3 = getSeparateProfileChallengeEnabled(data.readInt());
                        reply.writeNoException();
                        parcel2.writeInt(_result3);
                        return true;
                    case 18:
                    ...
                    case 26:
                        parcel.enforceInterface(descriptor);
                        _result4 = generateKey(data.readString());
                        reply.writeNoException();
                    ...
                    case 28:
                        parcel.enforceInterface(descriptor);
                        _result4 = getKey(data.readString());
                        reply.writeNoException();
                        parcel2.writeString(_result4);
                        return true;
                    case 29:
                    ...
                    case 36:
                        ...
                        RecoveryCertPath _arg2 = _arg0;
                        byte[] _result14 = startRecoverySessionWithCertPath(_arg04, _arg1, _arg2, data.createByteArray(), data.createByteArray(), parcel.createTypedArrayList(KeyChainProtectionParams.CREATOR));
                        reply.writeNoException();
                    ...
                    case 40:
                        parcel.enforceInterface(descriptor);
                        boolean _result16 = clearExtendLockScreenPassword(data.readString(), data.readInt());
                        reply.writeNoException();
