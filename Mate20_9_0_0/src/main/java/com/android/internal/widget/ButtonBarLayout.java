...
public class ButtonBarLayout extends LinearLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mAllowStacking && !isStacked() && (Tonal.MAIN_COLOR_DARK & getMeasuredWidthAndState()) == AsyncService.CMD_ASYNC_SERVICE_DESTROY) {
            setStacked(true);
            needsRemeasure = true;
        }
        if (needsRemeasure) {
    ...
    private void setStacked(boolean stacked) {
        ...
        View spacer = findViewById(16909350);
        if (spacer != null) {
