...
public class MessagingPropertyAnimator implements OnLayoutChangeListener {
    ...
    private static final int TAG_ALPHA_ANIMATOR = 16909391;
    private static final int TAG_FIRST_LAYOUT = 16909392;
    private static final int TAG_LAYOUT_TOP = 16909393;
    private static final int TAG_TOP = 16909395;
    private static final int TAG_TOP_ANIMATOR = 16909394;
    ...
    private static void setFirstLayout(View view, boolean first) {
        view.setTagInternal(TAG_FIRST_LAYOUT, Boolean.valueOf(first));
    }

    private static void setLayoutTop(View view, int top) {
        view.setTagInternal(TAG_LAYOUT_TOP, Integer.valueOf(top));
    }
    ...
    private static void setTop(View v, int value) {
        v.setTagInternal(TAG_TOP, Integer.valueOf(value));
    ...
    private static void startTopAnimation(final View v, int start, int end, Interpolator interpolator) {
        ...
        ObjectAnimator animator = ObjectAnimator.ofInt(v, TOP, new int[]{start, end});
        setTop(v, start);
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                v.setTagInternal(MessagingPropertyAnimator.TAG_TOP_ANIMATOR, null);
    ...
    public static void fadeIn(final View v) {
        ...
        ObjectAnimator animator = ObjectAnimator.ofFloat(v, View.ALPHA, new float[]{0.0f, 1.0f});
        v.setAlpha(0.0f);
        animator.setInterpolator(ALPHA_IN);
        animator.setDuration(APPEAR_ANIMATION_LENGTH);
        animator.addListener(new AnimatorListenerAdapter() {
            public void onAnimationEnd(Animator animation) {
                v.setTagInternal(MessagingPropertyAnimator.TAG_ALPHA_ANIMATOR, null);
    ...
    public static void fadeOut(final View view, final Runnable endAction) {
        ...
        ObjectAnimator animator = ObjectAnimator.ofFloat(view, View.ALPHA, new float[]{view.getAlpha(), 0.0f});
        animator.setInterpolator(ALPHA_OUT);
        animator.setDuration(APPEAR_ANIMATION_LENGTH);
        animator.addListener(new AnimatorListenerAdapter() {
            public void onAnimationEnd(Animator animation) {
                view.setTagInternal(MessagingPropertyAnimator.TAG_ALPHA_ANIMATOR, null);
