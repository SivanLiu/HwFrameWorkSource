        ...
        private void ensureTextColorsGenerated() {
            if (!this.mGeneratedTextColors) {
                ...
                if (lightBodyAlpha == -1 || lightTitleAlpha == -1) {
                    int darkBodyAlpha = ColorUtils.calculateMinimumAlpha(Tonal.MAIN_COLOR_DARK, this.mRgb, Palette.MIN_CONTRAST_BODY_TEXT);
                    int darkTitleAlpha = ColorUtils.calculateMinimumAlpha(Tonal.MAIN_COLOR_DARK, this.mRgb, Palette.MIN_CONTRAST_TITLE_TEXT);
                    if (darkBodyAlpha == -1 || darkTitleAlpha == -1) {
                        ...
                        if (lightBodyAlpha != -1) {
                            ...
                            alphaComponent = ColorUtils.setAlphaComponent(Tonal.MAIN_COLOR_DARK, darkBodyAlpha);
                        }
                        this.mBodyTextColor = alphaComponent;
                        if (lightTitleAlpha != -1) {
                            alphaComponent2 = ColorUtils.setAlphaComponent(-1, lightTitleAlpha);
                        } else {
                            alphaComponent2 = ColorUtils.setAlphaComponent(Tonal.MAIN_COLOR_DARK, darkTitleAlpha);
                        }
                        this.mTitleTextColor = alphaComponent2;
                        this.mGeneratedTextColors = true;
                    } else {
                        this.mBodyTextColor = ColorUtils.setAlphaComponent(Tonal.MAIN_COLOR_DARK, darkBodyAlpha);
                        this.mTitleTextColor = ColorUtils.setAlphaComponent(Tonal.MAIN_COLOR_DARK, darkTitleAlpha);
                        this.mGeneratedTextColors = true;
                        return;
                    }
                }
