    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if ("android.intent.action.PACKAGE_ADDED".equals(action)) {
            ...
            if (pkg != null) {
                ...
                if (intent.getBooleanExtra("android.intent.extra.REPLACING", false) != 0) {
            ...
            if (pkg != null) {
                ...
                if (intent.getBooleanExtra("android.intent.extra.REPLACING", false)) {
                    ...
                    if (intent.getBooleanExtra("android.intent.extra.REMOVED_FOR_ALL_USERS", false) != 0) {
            ...
            if (pkg != null) {
                ...
                this.mTempArray[0] = pkg;
                this.mChangeType = 3;
                if (onPackageChanged(pkg, uid, this.mModifiedComponents) != 0) {
                    this.mSomePackagesChanged = true;
                }
                onPackageModified(pkg);
            }
            ...
            if ("android.intent.action.QUERY_PACKAGE_RESTART".equals(action)) {
                ...
                this.mChangeType = 2;
                if (onHandleForceStop(intent, this.mDisappearingPackages, intent.getIntExtra("android.intent.extra.UID", 0), false) != 0) {
                    setResultCode(-1);
                }
