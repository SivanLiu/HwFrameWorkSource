...
public class ActionMenuItemView extends TextView implements ItemView, OnClickListener, ActionMenuChildView {
    ...
    private boolean shouldAllowTextWithIcon() {
        ...
        return width >= MetricsEvent.ACTION_SUPPORT_SIGN_IN || ((width >= MetricsEvent.ACTION_PERMISSION_DENIED_WRITE_CALENDAR && configuration.screenHeightDp >= MetricsEvent.ACTION_SUPPORT_SIGN_IN) || configuration.orientation == 2);
    }
