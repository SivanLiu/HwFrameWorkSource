        ...
        public void setTextBeforeCursor(CharSequence textBeforeCursor, int seq) {
            synchronized (this) {
                if (seq == this.mSeq) {
                    ...
                    stringBuilder.append(") in setTextBeforeCursor, ignoring.");
        ...
        public void setTextAfterCursor(CharSequence textAfterCursor, int seq) {
            synchronized (this) {
                if (seq == this.mSeq) {
                    ...
                    stringBuilder.append(" (expected ");
                    stringBuilder.append(this.mSeq);
                    stringBuilder.append(") in setTextAfterCursor, ignoring.");
                    Log.i(str, stringBuilder.toString());
                }
            }
        }
        ...
        public void setSelectedText(CharSequence selectedText, int seq) {
            synchronized (this) {
                if (seq == this.mSeq) {
                    ...
                    stringBuilder.append(" (expected ");
                    stringBuilder.append(this.mSeq);
                    stringBuilder.append(") in setSelectedText, ignoring.");
                    Log.i(str, stringBuilder.toString());
                }
            }
        }
        ...
        public void setExtractedText(ExtractedText extractedText, int seq) {
            synchronized (this) {
                if (seq == this.mSeq) {
                    ...
                    stringBuilder.append(" (expected ");
                    stringBuilder.append(this.mSeq);
                    stringBuilder.append(") in setExtractedText, ignoring.");
                    Log.i(str, stringBuilder.toString());
                }
            }
        }
