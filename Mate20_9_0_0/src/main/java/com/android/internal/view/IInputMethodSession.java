            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    ...
                    case 2:
                        ...
                        if (data.readInt() != 0) {
                            _arg0 = (ExtractedText) ExtractedText.CREATOR.createFromParcel(parcel);
                        }
                        updateExtractedText(_arg02, _arg0);
                        return true;
                    case 3:
                        parcel.enforceInterface(descriptor);
                    ...
                    case 9:
                        ...
                        return true;
                    case 10:
                        CursorAnchorInfo _arg05;
                        parcel.enforceInterface(descriptor);
                        if (data.readInt() != 0) {
                            _arg05 = (CursorAnchorInfo) CursorAnchorInfo.CREATOR.createFromParcel(parcel);
                        }
                        updateCursorAnchorInfo(_arg05);
                        return true;
                    default:
