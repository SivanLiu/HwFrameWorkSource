...
public class IconMenuPresenter extends BaseMenuPresenter {
    ...
    public IconMenuPresenter(Context context) {
        super(new ContextThemeWrapper(context, 16974827), 17367155, 17367154);
    }
    ...
    public boolean shouldIncludeItem(int childIndex, MenuItemImpl item) {
        boolean fits = (this.mMenu.getNonActionItems().size() == this.mMaxItems && childIndex < this.mMaxItems) || childIndex < this.mMaxItems - 1;
