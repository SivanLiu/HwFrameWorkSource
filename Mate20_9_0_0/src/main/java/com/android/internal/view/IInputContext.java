...
public interface IInputContext extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IInputContext {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                ExtractedTextRequest _arg0 = null;
                CharSequence _arg02;
                switch (code) {
                    case 1:
                    ...
                    case 4:
                        data.enforceInterface(descriptor);
                        if (data.readInt() != 0) {
                            _arg0 = (ExtractedTextRequest) ExtractedTextRequest.CREATOR.createFromParcel(data);
                        }
                        getExtractedText(_arg0, data.readInt(), data.readInt(), com.android.internal.view.IInputContextCallback.Stub.asInterface(data.readStrongBinder()));
                        return true;
                    case 5:
                        data.enforceInterface(descriptor);
                    ...
                    case 9:
                        ...
                        commitText(_arg02, data.readInt());
                        return true;
                    case 10:
                    ...
                    case 23:
                        ...
                        ExtractedTextRequest _arg2 = _arg0;
