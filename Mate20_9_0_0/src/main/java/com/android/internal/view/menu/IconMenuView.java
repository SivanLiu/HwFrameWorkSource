...
public final class IconMenuView extends ViewGroup implements ItemInvoker, MenuView, Runnable {
    ...
    private void positionChildren(int menuWidth, int menuHeight) {
        ...
        while (row < numRows) {
            int numRows2;
            float itemWidth = ((float) (i - (this.mVerticalDividerWidth * (numItemsForRow2[row] - 1)))) / ((float) numItemsForRow2[row]);
            float itemLeft = 0.0f;
            LayoutParams childLayoutParams2 = childLayoutParams;
            int itemPosOnRow = 0;
            while (itemPosOnRow < numItemsForRow2[row]) {
                int itemPos2;
                LayoutParams childLayoutParams3;
                ...
                childLayoutParams2 = (LayoutParams) child.getLayoutParams();
                childLayoutParams2.left = (int) itemLeft;
                childLayoutParams2.right = (int) (itemLeft + itemWidth);
                childLayoutParams2.top = (int) itemTop;
                childLayoutParams2.bottom = (int) (itemTop + itemHeight);
                itemLeft += itemWidth;
                itemPos++;
                if (this.mVerticalDivider != null) {
                    itemPos2 = itemPos;
                    childLayoutParams3 = childLayoutParams2;
