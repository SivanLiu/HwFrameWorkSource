...
public final class CodedOutputByteBufferNano {
    ...
    private static int encodedLength(CharSequence sequence) {
        ...
        stringBuilder.append(((long) utf8Length) + ProtoOutputStream.FIELD_TYPE_DOUBLE);
    ...
    private static void encodeDirect(CharSequence sequence, ByteBuffer byteBuffer) {
        ...
        while (i < utf16Length) {
            ...
            if (c < 128) {
                ...
                byteBuffer.put((byte) (DisplayMetrics.DENSITY_XXHIGH | (c >>> 12)));
    ...
    private static int encode(CharSequence sequence, byte[] bytes, int offset, int length) {
        ...
        while (i < utf16Length) {
            ...
            if (charAt < 128 && j < limit) {
                ...
                j2 = j + 1;
                bytes[j] = (byte) (DisplayMetrics.DENSITY_XXHIGH | (charAt >>> 12));
                j = j2 + 1;
    ...
    public void writeRawVarint32(int value) throws IOException {
        while ((value & WifiNetworkScoreCache.INVALID_NETWORK_SCORE) != 0) {
    ...
    public static int computeRawVarint32Size(int value) {
        if ((value & WifiNetworkScoreCache.INVALID_NETWORK_SCORE) == 0) {
            return 1;
        }
        if ((value & -16384) == 0) {
            return 2;
