...
public class PrefixTimeZonesMap implements Externalizable {
    ...
    public List<String> lookupTimeZonesForNumber(PhoneNumber number) {
        ...
        stringBuilder.append(PhoneNumberUtil.getInstance().getNationalSignificantNumber(number));
        return lookupTimeZonesForNumber(Long.parseLong(stringBuilder.toString()));
    }
