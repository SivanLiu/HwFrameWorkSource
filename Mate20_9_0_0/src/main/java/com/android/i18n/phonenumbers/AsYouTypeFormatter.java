...
public class AsYouTypeFormatter {
    ...
    private boolean maybeCreateNewTemplate() {
        Iterator<NumberFormat> it = this.possibleFormats.iterator();
        while (it.hasNext()) {
    ...
    private String inputDigitWithOptionToRememberPosition(char nextChar, boolean rememberPosition) {
        ...
        if (this.ableToFormat) {
            ...
            if (this.isExpectingCountryCallingCode) {
                ...
                stringBuilder.append(this.prefixBeforeNationalNumber);
    ...
    private String appendNationalNumber(String nationalNumber) {
        ...
        stringBuilder.append(SEPARATOR_BEFORE_NATIONAL_NUMBER);
        stringBuilder.append(nationalNumber);
        return stringBuilder.toString();
    }
    ...
    private boolean attemptToExtractIdd() {
        Pattern internationalPrefix = this.regexCache;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("\\+|");
        stringBuilder.append(this.currentMetadata.getInternationalPrefix());
        Matcher iddMatcher = internationalPrefix.getPatternForRegex(stringBuilder.toString()).matcher(this.accruedInputWithoutFormatting);
    ...
    private boolean attemptToExtractCountryCallingCode() {
        ...
        StringBuilder stringBuilder = this.prefixBeforeNationalNumber;
        stringBuilder.append(countryCodeString);
        stringBuilder.append(SEPARATOR_BEFORE_NATIONAL_NUMBER);
        this.extractedNationalPrefix = "";
        return true;
    }
