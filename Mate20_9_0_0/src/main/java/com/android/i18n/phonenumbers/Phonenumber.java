...
public final class Phonenumber {
    ...
    public static class PhoneNumber implements Serializable {
        ...
        public int hashCode() {
            int i = 1237;
            int hash = 53 * ((53 * ((53 * ((53 * ((53 * ((53 * ((53 * ((53 * ((53 * 41) + getCountryCode())) + Long.valueOf(getNationalNumber()).hashCode())) + getExtension().hashCode())) + (isItalianLeadingZero() ? 1231 : 1237))) + getNumberOfLeadingZeros())) + getRawInput().hashCode())) + getCountryCodeSource().hashCode())) + getPreferredDomesticCarrierCode().hashCode());
