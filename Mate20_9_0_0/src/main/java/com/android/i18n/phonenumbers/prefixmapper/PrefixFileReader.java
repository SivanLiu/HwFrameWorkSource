...
public class PrefixFileReader {
    ...
    private void loadMappingFileProvider() {
        ...
        stringBuilder.append(this.phonePrefixDataDirectory);
        stringBuilder.append("config");
        InputStream source = PrefixFileReader.class.getResourceAsStream(stringBuilder.toString());
    ...
    public String getDescriptionForNumber(PhoneNumber number, String language, String script, String region) {
