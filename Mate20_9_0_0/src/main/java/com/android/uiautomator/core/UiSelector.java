...
public class UiSelector {
    ...
    private UiSelector getLastSubSelector() {
        UiSelector child;
        if (this.mSelectorAttributes.indexOfKey(SELECTOR_CHILD) >= 0) {
            child = (UiSelector) this.mSelectorAttributes.get(SELECTOR_CHILD);
            ...
            child = (UiSelector) this.mSelectorAttributes.get(SELECTOR_PARENT);
            if (child.getLastSubSelector() == null) {
                return child;
            }
            return child.getLastSubSelector();
    ...
    String dumpToString(boolean all) {
        ...
        stringBuilder.append(UiSelector.class.getSimpleName());
        ...
        for (int i = SELECTOR_NIL; i < criterionCount; i++) {
            ...
            switch (criterion) {
                ...
                default:
                    ...
                    stringBuilder2.append(criterion);
