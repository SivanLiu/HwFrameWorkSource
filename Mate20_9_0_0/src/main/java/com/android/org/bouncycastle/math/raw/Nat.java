...
public abstract class Nat {
    ...
    public static int addBothTo(int len, int[] x, int[] y, int[] z) {
        long c = 0;
        for (int i = 0; i < len; i++) {
            c += ((((long) x[i]) & M) + (((long) y[i]) & M)) + (M & ((long) z[i]));
            z[i] = (int) c;
            c >>>= 32;
        }
        return (int) c;
    ...
    public static int addBothTo(int len, int[] x, int xOff, int[] y, int yOff, int[] z, int zOff) {
        long c = 0;
        for (int i = 0; i < len; i++) {
            c += ((((long) x[xOff + i]) & M) + (((long) y[yOff + i]) & M)) + (M & ((long) z[zOff + i]));
            z[zOff + i] = (int) c;
            c >>>= 32;
        }
        return (int) c;
    ...
    public static int addDWordAt(int len, long x, int[] z, int zOff, int zPos) {
        ...
        z[zOff + zPos] = (int) c;
        c = (c >>> 32) + ((M & ((long) z[(zOff + zPos) + 1])) + (x >>> 32));
        z[(zOff + zPos) + 1] = (int) c;
        return (c >>> 32) == 0 ? 0 : incAt(len, z, zOff, zPos + 2);
    }
    ...
    public static int addTo(int len, int[] x, int xOff, int[] z, int zOff) {
        long c = 0;
        for (int i = 0; i < len; i++) {
            c += (((long) x[xOff + i]) & M) + (M & ((long) z[zOff + i]));
            z[zOff + i] = (int) c;
            c >>>= 32;
        }
        return (int) c;
    ...
    public static int mulWordDwordAddAt(int len, int x, long y, int[] z, int zPos) {
        ...
        iArr[zPos + 0] = (int) c;
        c = (c >>> 32) + (((y >>> 32) * xVal) + (((long) iArr[zPos + 1]) & M));
        iArr[zPos + 1] = (int) c;
        c = (c >>> 32) + (M & ((long) iArr[zPos + 2]));
        iArr[zPos + 2] = (int) c;
        if ((c >>> 32) == 0) {
            int i = len;
            return 0;
    ...
    public static int sub(int len, int[] x, int xOff, int[] y, int yOff, int[] z, int zOff) {
        long c = 0;
        for (int i = 0; i < len; i++) {
            c += (((long) x[xOff + i]) & M) - (M & ((long) y[yOff + i]));
            z[zOff + i] = (int) c;
            c >>= 32;
        }
        return (int) c;
    ...
    public static int subBothFrom(int len, int[] x, int[] y, int[] z) {
        long c = 0;
        for (int i = 0; i < len; i++) {
            c += ((((long) z[i]) & M) - (((long) x[i]) & M)) - (M & ((long) y[i]));
            z[i] = (int) c;
            c >>= 32;
        }
        return (int) c;
    ...
    public static int subBothFrom(int len, int[] x, int xOff, int[] y, int yOff, int[] z, int zOff) {
        long c = 0;
        for (int i = 0; i < len; i++) {
            c += ((((long) z[zOff + i]) & M) - (((long) x[xOff + i]) & M)) - (M & ((long) y[yOff + i]));
            z[zOff + i] = (int) c;
            c >>= 32;
        }
        return (int) c;
    ...
    public static int subFrom(int len, int[] x, int xOff, int[] z, int zOff) {
        long c = 0;
        for (int i = 0; i < len; i++) {
            c += (((long) z[zOff + i]) & M) - (M & ((long) x[xOff + i]));
            z[zOff + i] = (int) c;
            c >>= 32;
        }
        return (int) c;
