...
public class CipherSpi extends BaseCipherSpi {
    ...
    private void initFromSpec(OAEPParameterSpec pSpec) throws NoSuchPaddingException {
        ...
        stringBuilder.append(mgfParams.getDigestAlgorithm());
        ...
        if (params == null || (params instanceof OAEPParameterSpec)) {
            ...
            if (params != null) {
                ...
                if (!spec.getMGFAlgorithm().equalsIgnoreCase("MGF1") && !spec.getMGFAlgorithm().equals(PKCSObjectIdentifiers.id_mgf1.getId())) {
                    ...
                    stringBuilder2.append("no match on digest algorithm: ");
                    stringBuilder2.append(spec.getDigestAlgorithm());
            ...
            switch (opmode) {
                ...
                default:
                    ...
                    stringBuilder3.append(opmode);
                    stringBuilder3.append(" passed to RSA");
                    throw new InvalidParameterException(stringBuilder3.toString());
            }
        }
        StringBuilder stringBuilder4 = new StringBuilder();
        stringBuilder4.append("unknown parameter type: ");
        stringBuilder4.append(params.getClass().getName());
