...
public class PBESecretKeyFactory extends BaseSecretKeyFactory implements PBE {
    ...
    protected SecretKey engineGenerateSecret(KeySpec keySpec) throws InvalidKeySpecException {
        if (keySpec instanceof PBEKeySpec) {
            ...
            if (this.forCipher) {
                makePBEParameters = Util.makePBEParameters(pbeSpec, this.scheme, this.digest, this.keySize, this.ivSize);
            } else {
                makePBEParameters = Util.makePBEMacParameters(pbeSpec, this.scheme, this.digest, this.keySize);
            }
            return new BCPBEKey(this.algName, this.algOid, this.scheme, this.digest, this.keySize, this.ivSize, pbeSpec, makePBEParameters);
        }
