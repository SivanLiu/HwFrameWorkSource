...
public class PKIXPolicyNode implements PolicyNode {
    ...
    public String toString(String _indent) {
        ...
        for (int i = 0; i < this.children.size(); i++) {
            ...
            _buf.append(pKIXPolicyNode.toString(stringBuilder.toString()));
        }
        _buf.append(_indent);
        _buf.append("}\n");
    ...
    public PKIXPolicyNode copy() {
        ...
        for (PKIXPolicyNode _child : this.children) {
            PKIXPolicyNode _child2 = _child2.copy();
            _child2.setParent(_node);
