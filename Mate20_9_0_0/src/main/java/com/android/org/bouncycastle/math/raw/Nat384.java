...
public abstract class Nat384 {
    public static void mul(int[] x, int[] y, int[] zz) {
        ...
        c18 += Nat192.addTo(iArr, 18, iArr, 12, Nat192.addTo(iArr, 0, iArr, 6, 0) + c18);
        ...
        Nat192.mul(dx, dy, tt);
        Nat.addWordAt(24, c18 + (neg ? Nat.addTo(12, tt, 0, iArr, 6) : Nat.subFrom(12, tt, 0, iArr, 6)), iArr, 18);
    }
    ...
    public static void square(int[] x, int[] zz) {
        ...
        c18 += Nat192.addTo(zz, 18, zz, 12, Nat192.addTo(zz, 0, zz, 6, 0) + c18);
        int[] dx = Nat192.create();
