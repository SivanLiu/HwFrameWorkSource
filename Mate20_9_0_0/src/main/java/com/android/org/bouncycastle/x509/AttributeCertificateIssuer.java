    ...
    public boolean match(Certificate cert) {
        ...
        if (this.form instanceof V2Form) {
            ...
            if (issuer.getBaseCertificateID() != null) {
                if (issuer.getBaseCertificateID().getSerial().getValue().equals(x509Cert.getSerialNumber()) && matchesDN(x509Cert.getIssuerX500Principal(), issuer.getBaseCertificateID().getIssuer())) {
                    z = true;
                }
                return z;
            }
        ...
        if (matchesDN(x509Cert.getSubjectX500Principal(), this.form)) {
            return true;
        }
        return false;
    }
