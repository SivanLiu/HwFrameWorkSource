...
public class CustomNamedCurves {
    ...
    static X9ECParametersHolder secp192k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(curve, new X9ECPoint(curve, Hex.decode("04DB4FF10EC057E9AE26B07D0280B7F4341DA5D1B1EAE06C7D9B2F2F6D9C5628A7844163D015BE86344082AA88D95E2F9D")), curve.getOrder(), curve.getCofactor(), null);
        }
    };
    ...
    static X9ECParametersHolder secp224k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(curve, new X9ECPoint(curve, Hex.decode("04A1455B334DF099DF30FC28A169A467E9E47075A90F7E650EB6B7A45C7E089FED7FBA344282CAFBD6F7E319F7C0B0BD59E2CA4BDB556D61A5")), curve.getOrder(), curve.getCofactor(), null);
        }
    };
    ...
    static X9ECParametersHolder secp256k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(curve, new X9ECPoint(curve, Hex.decode("0479BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798483ADA7726A3C4655DA4FBFC0E1108A8FD17B448A68554199C47D08FFB10D4B8")), curve.getOrder(), curve.getCofactor(), null);
        }
    };
