...
public class X9Curve extends ASN1Object implements X9ObjectIdentifiers {
    ...
    public X9Curve(X9FieldID fieldID, ASN1Sequence seq) {
        ...
        if (this.fieldIdentifier.equals(prime_field)) {
            ...
            this.curve = new Fp(p, new X9FieldElement(p, (ASN1OctetString) aSN1Sequence.getObjectAt(0)).getValue().toBigInteger(), new X9FieldElement(p, (ASN1OctetString) aSN1Sequence.getObjectAt(1)).getValue().toBigInteger());
            ...
            int i2 = k32;
            ECCurve eCCurve = r7;
            ECCurve f2m = new F2m(k2, k3, i, i2, new X9FieldElement(k2, k3, i, i2, (ASN1OctetString) aSN1Sequence.getObjectAt(0)).getValue().toBigInteger(), new X9FieldElement(k2, k3, i, i2, (ASN1OctetString) aSN1Sequence.getObjectAt(1)).getValue().toBigInteger());
            this.curve = eCCurve;
        } else {
