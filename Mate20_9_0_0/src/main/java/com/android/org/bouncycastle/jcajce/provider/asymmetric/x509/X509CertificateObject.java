...
class X509CertificateObject extends X509Certificate implements PKCS12BagAttributeCarrier {
    ...
    public void checkValidity(Date date) throws CertificateExpiredException, CertificateNotYetValidException {
        ...
        if (date.getTime() > getNotAfter().getTime()) {
            ...
            stringBuilder.append(this.c.getEndDate().getTime());
            ...
            stringBuilder.append(this.c.getStartDate().getTime());
    ...
    public boolean hasUnsupportedCriticalExtension() {
        if (getVersion() == 3) {
            ...
            if (extensions != null) {
                ...
                while (e.hasMoreElements()) {
                    ASN1ObjectIdentifier oid = (ASN1ObjectIdentifier) e.nextElement();
                    if (!(oid.equals(Extension.keyUsage) || oid.equals(Extension.certificatePolicies) || oid.equals(Extension.policyMappings) || oid.equals(Extension.inhibitAnyPolicy) || oid.equals(Extension.cRLDistributionPoints) || oid.equals(Extension.issuingDistributionPoint) || oid.equals(Extension.deltaCRLIndicator) || oid.equals(Extension.policyConstraints) || oid.equals(Extension.basicConstraints) || oid.equals(Extension.subjectAlternativeName))) {
            ...
            while (it.hasMoreElements()) {
                ...
                switch (genName.getTagNo()) {
                    ...
                    default:
                        ...
                        stringBuilder.append(genName.getTagNo());
