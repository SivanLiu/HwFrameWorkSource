...
public class X509Name extends ASN1Object {
                ...
                if (s.size() == 2) {
                    ...
                    if (!(value instanceof ASN1String) || (value instanceof DERUniversalString)) {
                        try {
                            ...
                            stringBuilder.append(bytesToString(Hex.encode(value.toASN1Primitive().getEncoded(ASN1Encoding.DER))));
                    ...
                    if (v.length() <= 0 || v.charAt(0) != '#') {
                        ...
                        vector2.addElement(stringBuilder2.toString());
                    }
    ...
    public X509Name(Vector ordering, Hashtable attributes, X509NameEntryConverter converter) {
        ...
        if (ordering != null) {
            for (int i2 = 0; i2 != ordering.size(); i2++) {
                this.ordering.addElement(ordering.elementAt(i2));
    ...
    public boolean equals(Object obj) {
        ...
        boolean z = false;
        if (!(x509Name instanceof X509Name) && !(x509Name instanceof ASN1Sequence)) {
            return false;
        }
        if (toASN1Primitive().equals(x509Name.toASN1Primitive())) {
            return true;
        }
        try {
            X509Name other = getInstance(obj);
            ...
            for (int i = start; i != end; i += delta) {
                ...
                while (j < orderingSize) {
                    if (!indexes[j] && oid.equals((ASN1ObjectIdentifier) other.ordering.elementAt(j)) && equivalentStrings(value, (String) other.values.elementAt(j))) {
                        indexes[j] = true;
                        found = true;
                        break;
                    }
    ...
    public String toString(boolean reverse, Hashtable oidSymbols) {
        ...
        for (int i2 = 0; i2 < this.ordering.size(); i2++) {
            if (((Boolean) this.added.elementAt(i2)).booleanValue()) {
                ava.append('+');
                appendValue(ava, oidSymbols, (ASN1ObjectIdentifier) this.ordering.elementAt(i2), (String) this.values.elementAt(i2));
            } else {
