...
class X509Util {
    ...
    static Implementation getImplementation(String baseName, String algorithm, Provider prov) throws NoSuchAlgorithmException {
        ...
        while (true) {
            ...
            property = prov.getProperty(stringBuilder.toString());
        ...
        if (property != null) {
            try {
                ...
                if (clsLoader != null) {
                    cls = clsLoader.loadClass(property);
                } else {
                ...
                stringBuilder2.append(prov.getName());
        ...
        stringBuilder3.append("cannot find implementation ");
        stringBuilder3.append(algorithm);
        stringBuilder3.append(" for provider ");
        stringBuilder3.append(prov.getName());
        throw new NoSuchAlgorithmException(stringBuilder3.toString());
    }
