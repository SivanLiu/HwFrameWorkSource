...
public class SECNamedCurves {
    ...
    static X9ECParametersHolder secp112r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            ECCurve curve = SECNamedCurves.configureCurve(new Fp(p, a, b, n, h));
    ...
    static X9ECParametersHolder secp192k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(1);
            ECCurve curve = SECNamedCurves.configureCurveGLV(new Fp(p, a, b, n, h), new GLVTypeBParameters(new BigInteger("bb85691939b869c1d087f601554b96b80cb4f55b35f433c2", 16), new BigInteger("3d84f26c12238d7b4f3d516613c1759033b1a5800175d0b1", 16), new BigInteger[]{new BigInteger("71169be7330b3038edb025f1", 16), new BigInteger("-b3fb3400dec5c4adceb8655c", 16)}, new BigInteger[]{new BigInteger("12511cfe811d0f4e6bc688b4d", 16), new BigInteger("71169be7330b3038edb025f1", 16)}, new BigInteger("71169be7330b3038edb025f1d0f9", 16), new BigInteger("b3fb3400dec5c4adceb8655d4c94", 16), 208));
            return new X9ECParameters(curve, new X9ECPoint(curve, Hex.decode("04DB4FF10EC057E9AE26B07D0280B7F4341DA5D1B1EAE06C7D9B2F2F6D9C5628A7844163D015BE86344082AA88D95E2F9D")), n, h, null);
        }
    };
    ...
    static X9ECParametersHolder secp224k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(1);
            ECCurve curve = SECNamedCurves.configureCurveGLV(new Fp(p, a, b, n, h), new GLVTypeBParameters(new BigInteger("fe0e87005b4e83761908c5131d552a850b3f58b749c37cf5b84d6768", 16), new BigInteger("60dcd2104c4cbc0be6eeefc2bdd610739ec34e317f9b33046c9e4788", 16), new BigInteger[]{new BigInteger("6b8cf07d4ca75c88957d9d670591", 16), new BigInteger("-b8adf1378a6eb73409fa6c9c637d", 16)}, new BigInteger[]{new BigInteger("1243ae1b4d71613bc9f780a03690e", 16), new BigInteger("6b8cf07d4ca75c88957d9d670591", 16)}, new BigInteger("6b8cf07d4ca75c88957d9d67059037a4", 16), new BigInteger("b8adf1378a6eb73409fa6c9c637ba7f5", 16), 240));
            return new X9ECParameters(curve, new X9ECPoint(curve, Hex.decode("04A1455B334DF099DF30FC28A169A467E9E47075A90F7E650EB6B7A45C7E089FED7FBA344282CAFBD6F7E319F7C0B0BD59E2CA4BDB556D61A5")), n, h, null);
        }
    };
    ...
    static X9ECParametersHolder sect131r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            int m = 131;
            ECCurve eCCurve = r0;
            ECCurve f2m = new F2m(131, 2, 3, 8, a, b, n, h);
            f2m = SECNamedCurves.configureCurve(eCCurve);
            return new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("040081BAF91FDF9833C40F9C181343638399078C6E7EA38C001F73C8134B1B4EF9E150")), n, h, S);
        }
    };
    static X9ECParametersHolder sect131r2 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            ECCurve f2m = new F2m(131, 2, 3, 8, a, b, n, h);
            f2m = SECNamedCurves.configureCurve(eCCurve);
            return new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("040356DCD8F2F95031AD652D23951BB366A80648F06D867940A5366D9E265DE9EB240F")), n, h, S);
        }
    };
    static X9ECParametersHolder sect163k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            int m = 163;
            ECCurve eCCurve = r0;
            ECCurve f2m = new F2m(163, 3, 6, 7, a, b, n, h);
            ECCurve curve = SECNamedCurves.configureCurve(eCCurve);
            return new X9ECParameters(curve, new X9ECPoint(curve, Hex.decode("0402FE13C0537BBC11ACAA07D793DE4E6D5E5C94EEE80289070FB05D38FF58321F2E800536D538CCDAA3D9")), n, h, null);
        }
    };
    static X9ECParametersHolder sect163r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            ECCurve f2m = new F2m(163, 3, 6, 7, a, b, n, h);
            f2m = SECNamedCurves.configureCurve(eCCurve);
            return new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("040369979697AB43897789566789567F787A7876A65400435EDB42EFAFB2989D51FEFCE3C80988F41FF883")), n, h, S);
        }
    };
    static X9ECParametersHolder sect163r2 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            ECCurve f2m = new F2m(163, 3, 6, 7, a, b, n, h);
            f2m = SECNamedCurves.configureCurve(eCCurve);
            return new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("0403F0EBA16286A2D57EA0991168D4994637E8343E3600D51FBC6C71A0094FA2CDD545B11C5C0C797324F1")), n, h, S);
        }
    };
    static X9ECParametersHolder sect193r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger h = BigInteger.valueOf(2);
            ECCurve curve = SECNamedCurves.configureCurve(new F2m(193, 15, a, b, n, h));
    ...
    static X9ECParametersHolder sect233k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(curve, new X9ECPoint(curve, Hex.decode("04017232BA853A7E731AF129F22FF4149563A419C26BF50A4C9D6EEFAD612601DB537DECE819B7F70F555A67C427A8CD9BF18AEB9B56E0C11056FAE6A3")), n, h, null);
        }
    };
    ...
    static X9ECParametersHolder sect239k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(curve, new X9ECPoint(curve, Hex.decode("0429A0B6A887A983E9730988A68727A8B2D126C44CC2CC7B2A6555193035DC76310804F12E549BDB011C103089E73510ACB275FC312A5DC6B76553F0CA")), n, h, null);
        }
    };
    static X9ECParametersHolder sect283k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            int m = 283;
            ECCurve eCCurve = r0;
            ECCurve f2m = new F2m(283, 5, 7, 12, a, b, n, h);
            ECCurve curve = SECNamedCurves.configureCurve(eCCurve);
            return new X9ECParameters(curve, new X9ECPoint(curve, Hex.decode("040503213F78CA44883F1A3B8162F188E553CD265F23C1567A16876913B0C2AC245849283601CCDA380F1C9E318D90F95D07E5426FE87E45C0E8184698E45962364E34116177DD2259")), n, h, null);
        }
    };
    static X9ECParametersHolder sect283r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            ECCurve f2m = new F2m(283, 5, 7, 12, a, b, n, h);
            f2m = SECNamedCurves.configureCurve(eCCurve);
            return new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("0405F939258DB7DD90E1934F8C70B0DFEC2EED25B8557EAC9C80E2E198F8CDBECD86B1205303676854FE24141CB98FE6D4B20D02B4516FF702350EDDB0826779C813F0DF45BE8112F4")), n, h, S);
        }
    };
    static X9ECParametersHolder sect409k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(curve, new X9ECPoint(curve, Hex.decode("040060F05F658F49C1AD3AB1890F7184210EFD0987E307C84C27ACCFB8F9F67CC2C460189EB5AAAA62EE222EB1B35540CFE902374601E369050B7C4E42ACBA1DACBF04299C3460782F918EA427E6325165E9EA10E3DA5F6C42E9C55215AA9CA27A5863EC48D8E0286B")), n, h, null);
        }
    };
    ...
    static X9ECParametersHolder sect571k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            int m = 571;
            ECCurve eCCurve = r0;
            ECCurve f2m = new F2m(571, 2, 5, 10, a, b, n, h);
            ECCurve curve = SECNamedCurves.configureCurve(eCCurve);
    ...
    static X9ECParametersHolder sect571r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            ECCurve f2m = new F2m(571, 2, 5, 10, a, b, n, h);
            f2m = SECNamedCurves.configureCurve(eCCurve);
            return new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("")), n, h, S);
        }
    };
