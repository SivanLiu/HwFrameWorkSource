...
public class SecP224R1Field {
    ...
    public static void reduce(int[] xx, int[] z) {
        ...
        long xx122 = xx12;
        xx12 = (((long) xx[9]) & M) + xx13;
        long xx132 = xx13;
        long cc = 0 + ((((long) xx[0]) & M) - t0);
        long z0 = cc & M;
        xx13 = (cc >> 32) + ((((long) xx[1]) & M) - t1);
        iArr[1] = (int) xx13;
        long cc2 = (xx13 >> 32) + ((((long) xx[2]) & M) - xx12);
        iArr[2] = (int) cc2;
        cc2 = (cc2 >> 32) + (((((long) xx[3]) & M) + t0) - xx10);
        xx13 = cc2 & M;
        cc2 = (cc2 >> 32) + (((((long) xx[4]) & M) + t1) - xx11);
        iArr[4] = (int) cc2;
        cc2 = (cc2 >> 32) + (((((long) xx[5]) & M) + xx12) - xx122);
        iArr[5] = (int) cc2;
        cc2 = (cc2 >> 32) + (((((long) xx[6]) & M) + xx10) - xx132);
        iArr[6] = (int) cc2;
        cc2 = (cc2 >> 32) + 1;
        xx13 += cc2;
        t0 = z0 - cc2;
        ...
        if (cc2 != 0) {
            cc2 += ((long) iArr[1]) & M;
            iArr[1] = (int) cc2;
            cc2 = (((long) iArr[2]) & M) + (cc2 >> 32);
            iArr[2] = (int) cc2;
            xx13 += cc2 >> 32;
        }
        iArr[3] = (int) xx13;
        if (((xx13 >> 32) != 0 && Nat.incAt(7, iArr, 4) != 0) || (iArr[6] == -1 && Nat224.gte(iArr, P))) {
            addPInvTo(z);
        }
    }
