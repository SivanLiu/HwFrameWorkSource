...
public class SecP256R1Field {
    ...
    public static void reduce(int[] xx, int[] z) {
        ...
        xx09 = 0 + (((((long) xx[0]) & M) - t3) - t7);
        int[] iArr2 = z;
        iArr2[0] = (int) xx09;
        xx09 = (xx09 >> 32) + ((((((long) xx[1]) & M) + t1) - t4) - t6);
        iArr2[1] = (int) xx09;
        xx09 = (xx09 >> 32) + (((((long) xx[2]) & M) + t2) - t5);
        iArr2[2] = (int) xx09;
        xx09 = (xx09 >> 32) + ((((((long) xx[3]) & M) + (t3 << 1)) + t7) - t6);
        iArr2[3] = (int) xx09;
        xx09 = (xx09 >> 32) + ((((((long) xx[4]) & M) + (t4 << 1)) + xx14) - t1);
        iArr2[4] = (int) xx09;
        xx09 = (xx09 >> 32) + (((((long) xx[5]) & M) + (t5 << 1)) - t2);
        iArr2[5] = (int) xx09;
        xx09 = (xx09 >> 32) + (((((long) xx[6]) & M) + (t6 << 1)) + t7);
        iArr2[6] = (int) xx09;
        xx09 = (xx09 >> 32) + (((((((long) xx[7]) & M) + (xx15 << 1)) + xx08) - t2) - t4);
        iArr2[7] = (int) xx09;
        reduce32((int) ((xx09 >> 32) + 6), iArr2);
    }
