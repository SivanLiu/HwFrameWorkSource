...
public final class DESede {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider provider) {
            ...
            provider.addAlgorithm("Cipher.DESEDE", stringBuilder.toString());
            stringBuilder = new StringBuilder();
            stringBuilder.append(PREFIX);
            stringBuilder.append("$Wrap");
            provider.addAlgorithm("Cipher.DESEDEWRAP", stringBuilder.toString());
            StringBuilder stringBuilder2 = new StringBuilder();
            stringBuilder2.append("Alg.Alias.Cipher.");
            stringBuilder2.append(PKCSObjectIdentifiers.id_alg_CMS3DESwrap);
            provider.addAlgorithm(stringBuilder2.toString(), "DESEDEWRAP");
            ...
            if (provider.hasAlgorithm("MessageDigest", "SHA-1")) {
                ...
                provider.addAlgorithm("Cipher.PBEWITHSHAAND3-KEYTRIPLEDES-CBC", stringBuilder.toString());
                stringBuilder = new StringBuilder();
                stringBuilder.append(PREFIX);
                stringBuilder.append("$PBEWithSHAAndDES2Key");
                provider.addAlgorithm("Cipher.PBEWITHSHAAND2-KEYTRIPLEDES-CBC", stringBuilder.toString());
            ...
            provider.addAlgorithm("KeyGenerator.DESEDE", stringBuilder.toString());
            stringBuilder = new StringBuilder();
            stringBuilder.append(PREFIX);
            stringBuilder.append("$KeyFactory");
            provider.addAlgorithm("SecretKeyFactory.DESEDE", stringBuilder.toString());
            ...
            stringBuilder2.append(PKCSObjectIdentifiers.des_EDE3_CBC);
            provider.addAlgorithm(stringBuilder2.toString(), "DESEDE");
            stringBuilder = new StringBuilder();
            stringBuilder.append(PREFIX);
            stringBuilder.append("$PBEWithSHAAndDES3KeyFactory");
            provider.addAlgorithm("SecretKeyFactory.PBEWITHSHAAND3-KEYTRIPLEDES-CBC", stringBuilder.toString());
            stringBuilder = new StringBuilder();
            stringBuilder.append(PREFIX);
            stringBuilder.append("$PBEWithSHAAndDES2KeyFactory");
            provider.addAlgorithm("SecretKeyFactory.PBEWITHSHAAND2-KEYTRIPLEDES-CBC", stringBuilder.toString());
