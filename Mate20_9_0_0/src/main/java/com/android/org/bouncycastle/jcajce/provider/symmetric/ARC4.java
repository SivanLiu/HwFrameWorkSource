...
public final class ARC4 {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider provider) {
            ...
            provider.addAlgorithm("Cipher.ARC4", stringBuilder.toString());
            ...
            provider.addAlgorithm("KeyGenerator.ARC4", stringBuilder.toString());
            ...
            provider.addAlgorithm("SecretKeyFactory.PBEWITHSHAAND128BITRC4", stringBuilder.toString());
            stringBuilder = new StringBuilder();
            stringBuilder.append(PREFIX);
            stringBuilder.append("$PBEWithSHAAnd40BitKeyFactory");
            provider.addAlgorithm("SecretKeyFactory.PBEWITHSHAAND40BITRC4", stringBuilder.toString());
            StringBuilder stringBuilder2 = new StringBuilder();
            stringBuilder2.append("Alg.Alias.AlgorithmParameters.");
            stringBuilder2.append(PKCSObjectIdentifiers.pbeWithSHAAnd128BitRC4);
            provider.addAlgorithm(stringBuilder2.toString(), "PKCS12PBE");
            stringBuilder2 = new StringBuilder();
            stringBuilder2.append("Alg.Alias.AlgorithmParameters.");
            stringBuilder2.append(PKCSObjectIdentifiers.pbeWithSHAAnd40BitRC4);
            provider.addAlgorithm(stringBuilder2.toString(), "PKCS12PBE");
            ...
            provider.addAlgorithm("Cipher.PBEWITHSHAAND128BITRC4", stringBuilder.toString());
            stringBuilder = new StringBuilder();
            stringBuilder.append(PREFIX);
            stringBuilder.append("$PBEWithSHAAnd40Bit");
            provider.addAlgorithm("Cipher.PBEWITHSHAAND40BITRC4", stringBuilder.toString());
