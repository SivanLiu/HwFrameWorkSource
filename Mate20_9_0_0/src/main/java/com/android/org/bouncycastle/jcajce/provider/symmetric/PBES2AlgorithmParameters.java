        ...
        public void configure(ConfigurableProvider provider) {
            ...
            for (int keySize : new int[]{128, 256}) {
                for (int shaVariant : shaVariants) {
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("AlgorithmParameters.PBEWithHmacSHA");
                    stringBuilder.append(shaVariant);
                    stringBuilder.append("AndAES_");
                    stringBuilder.append(keySize);
                    String stringBuilder2 = stringBuilder.toString();
                    StringBuilder stringBuilder3 = new StringBuilder();
                    stringBuilder3.append(PREFIX);
                    stringBuilder3.append("$PBEWithHmacSHA");
                    stringBuilder3.append(shaVariant);
                    stringBuilder3.append("AES");
                    stringBuilder3.append(keySize);
                    stringBuilder3.append("AlgorithmParameters");
