...
public abstract class Nat224 {
    ...
    public static int addTo(int[] x, int xOff, int[] z, int zOff, int cIn) {
        ...
        z[zOff + 5] = (int) c;
        c = (c >>> 32) + ((((long) x[xOff + 6]) & M) + (M & ((long) z[zOff + 6])));
        z[zOff + 6] = (int) c;
        return (int) (c >>> 32);
    }
    ...
    public static void mul(int[] x, int[] y, int[] zz) {
        ...
        while (true) {
            ...
            if (i3 < i2) {
                ...
                zz[i3 + 4] = (int) c3;
                c3 = (c3 >>> 32) + ((c * y_5) + (((long) zz[i3 + 5]) & M));
                zz[i3 + 5] = (int) c3;
                c3 = (c3 >>> 32) + ((c * y_62) + (((long) zz[i3 + 6]) & M));
                zz[i3 + 6] = (int) c3;
                zz[i3 + 7] = (int) (c3 >>> 32);
                i = i3 + 1;
                y_6 = y_62;
    ...
    public static int mulAddTo(int[] x, int[] y, int[] zz) {
        ...
        while (true) {
            ...
            if (i2 < 7) {
                ...
                y_6 = ((long) x[i2]) & M;
                y_42 = y_4;
                y_4 = 0 + ((y_6 * y_0) + (((long) zz[i2 + 0]) & M));
                zz[i2 + 0] = (int) y_4;
                y_12 = y_1;
                y_4 = (y_4 >>> 32) + ((y_6 * y_1) + (((long) zz[i2 + 1]) & M));
                zz[i2 + 1] = (int) y_4;
                y_22 = y_2;
                y_1 = (y_4 >>> 32) + ((y_6 * y_2) + (((long) zz[i2 + 2]) & M));
                zz[i2 + 2] = (int) y_1;
                y_1 = (y_1 >>> 32) + ((y_6 * y_3) + (((long) zz[i2 + 3]) & M));
                zz[i2 + 3] = (int) y_1;
                y_1 = (y_1 >>> 32) + ((y_6 * y_42) + (((long) zz[i2 + 4]) & M));
                zz[i2 + 4] = (int) y_1;
                y_1 = (y_1 >>> 32) + ((y_6 * y_5) + (((long) zz[i2 + 5]) & M));
                zz[i2 + 5] = (int) y_1;
                y_1 = (y_1 >>> 32) + ((y_6 * y_62) + (((long) zz[i2 + 6]) & M));
                zz[i2 + 6] = (int) y_1;
                y_1 = (y_1 >>> 32) + (zc + (((long) zz[i2 + 7]) & M));
                zz[i2 + 7] = (int) y_1;
                zc = y_1 >>> 32;
                i = i2 + 1;
                y_6 = y_62;
    ...
    public static int mulAddTo(int[] x, int xOff, int[] y, int yOff, int[] zz, int zzOff) {
        ...
        while (i < 7) {
            ...
            y_6 = ((long) x[xOff + i]) & M;
            y_0 = y_02;
            long c = 0 + ((y_6 * y_02) + (((long) zz[zzOff2 + 0]) & M));
            zz[zzOff2 + 0] = (int) c;
            long c2 = (c >>> 32) + ((y_6 * y_12) + (((long) zz[zzOff2 + 1]) & M));
            zz[zzOff2 + 1] = (int) c2;
            y_1 = y_12;
            c2 = (c2 >>> 32) + ((y_6 * y_22) + (((long) zz[zzOff2 + 2]) & M));
            zz[zzOff2 + 2] = (int) c2;
            y_2 = y_22;
            c2 = (c2 >>> 32) + ((y_6 * y_3) + (((long) zz[zzOff2 + 3]) & M));
            zz[zzOff2 + 3] = (int) c2;
            c2 = (c2 >>> 32) + ((y_6 * y_4) + (((long) zz[zzOff2 + 4]) & M));
            zz[zzOff2 + 4] = (int) c2;
            c2 = (c2 >>> 32) + ((y_6 * y_5) + (((long) zz[zzOff2 + 5]) & M));
            zz[zzOff2 + 5] = (int) c2;
            c2 = (c2 >>> 32) + ((y_6 * y_62) + (((long) zz[zzOff2 + 6]) & M));
            zz[zzOff2 + 6] = (int) c2;
            c2 = (c2 >>> 32) + (zc + (((long) zz[zzOff2 + 7]) & M));
            zz[zzOff2 + 7] = (int) c2;
            zc = c2 >>> 32;
            zzOff2++;
            i = i2 + 1;
    ...
    public static int mulByWordAddTo(int x, int[] y, int[] z) {
        ...
        z[5] = (int) c;
        c = (c >>> 32) + (((((long) z[6]) & M) * xVal) + (M & ((long) y[6])));
        z[6] = (int) c;
        return (int) (c >>> 32);
    }
    ...
    public static int mulWordAddTo(int x, int[] y, int yOff, int[] z, int zOff) {
        ...
        z[zOff + 5] = (int) c;
        c = (c >>> 32) + (((((long) y[yOff + 6]) & M) * xVal) + (M & ((long) z[zOff + 6])));
        z[zOff + 6] = (int) c;
        return (int) (c >>> 32);
    }
    ...
    public static int mul33DWordAdd(int x, long y, int[] z, int zOff) {
        ...
        iArr[i + 3] = (int) c;
        return (c >>> 32) == 0 ? 0 : Nat.incAt(7, iArr, i, 4);
    }
    ...
    public static void square(int[] x, int[] zz) {
        ...
        while (true) {
            ...
            if (i2 <= 0) {
                ...
                c2 = (int) x_1;
                zz[12] = (c2 << 1) | c3;
                zz[13] = ((zz[13] + ((int) (x_1 >>> 32))) << 1) | (c2 >>> 31);
                return;
            }
            i = i2;
            j = M;
    ...
    public static void square(int[] x, int xOff, int[] zz, int zzOff) {
        ...
        while (true) {
            ...
            if (i2 <= 0) {
                ...
                long zz_10 = j & M;
                p &= M;
                long zz_12 = (((long) zz[zzOff + 12]) & M) + (p >>> 32);
                j = (zz_63 & M) + (zz_5 * x_02);
                w = (int) j;
                zz[zzOff + 6] = (w << 1) | c3;
                c3 = w >>> 31;
                xVal += (j >>> 32) + (zz_5 * c);
                j = zz_82 + ((xVal >>> 32) + (zz_5 * x_2));
                j2 += (j >>> 32) + (zz_5 * x_3);
                long x_1 = c;
                c = zz_10 + ((j2 >>> 32) + (zz_5 * x_4));
                p += (c >>> 32) + (zz_5 * x_5);
                zz_5 = zz_12 + (p >>> 32);
                w = (int) xVal;
                zz[zzOff + 7] = (w << 1) | c3;
                ...
                w = (int) zz_5;
                zz[zzOff + 12] = (w << 1) | c3;
                zz[zzOff + 13] = ((zz[zzOff + 13] + ((int) (zz_5 >>> 32))) << 1) | (w >>> 31);
                return;
            }
            i = i2;
            j = M;
