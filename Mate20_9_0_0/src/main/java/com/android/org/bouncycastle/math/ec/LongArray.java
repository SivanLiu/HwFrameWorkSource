...
class LongArray implements Cloneable {
    ...
    private static int bitLength(long w) {
        ...
        if (t == 0) {
            ...
            k = t >>> 8;
            k = k == 0 ? 16 + bitLengths[t] : 24 + bitLengths[k];
        }
        return b + k;
    }
    ...
    public BigInteger toBigInteger() {
        ...
        for (barrI = 0; barrI < barrI2; barrI++) {
            barr[barrI] = temp[barrI];
        }
        barrI = usedLen - 2;
        while (barrI >= 0) {
            long mi = this.m_ints[barrI];
            int barrI3 = barrI2;
            barrI2 = 7;
            while (barrI2 >= 0) {
                int barrI4 = barrI3 + 1;
                byte[] temp2 = temp;
                barr[barrI3] = (byte) ((int) (mi >>> (i * barrI2)));
                barrI2--;
                barrI3 = barrI4;
                temp = temp2;
                i = 8;
    ...
    public LongArray modMultiplyLD(LongArray other, int m, int[] ks) {
        ...
        if (tmp == 1) {
            ...
            return reduceResult(c0, 0, aDeg, i, iArr);
        }
        long[] T0;
        int[] ti;
        int k;
        ...
        ti = ti2;
        long[] T03 = T02;
        long[] T12 = new long[T03.length];
        shiftUp(T03, 0, T12, 0, T03.length, 4);
        long[] a = A.m_ints;
        T02 = new long[aDeg];
        int k2 = 56;
        tOff = 56;
        while (true) {
            ...
            while (true) {
                ...
                T0 = a;
                T1 = T12;
                addBoth(c, j2 - 1, T03, ti[aVal & 15], T1, ti[v], bMax);
                j = j2 + 2;
                T02 = bDeg;
                a = T0;
                T12 = T1;
        ...
        while (true) {
            j2 = k2;
            if (j2 < 0) {
                return reduceResult(c2, 0, aDeg, i, iArr);
            }
            tOff = 0;
            while (true) {
                cLen = tOff;
                ...
                int aVal2 = (int) (T0[cLen] >>> j2);
                k = (aVal2 >>> 4) & 15;
                j = ti[aVal2 & 15];
                v = cLen;
                addBoth(c2, cLen, T03, j, T1, ti[k], bMax);
                tOff = v + 2;
            }
            if (j2 > 0) {
                shiftUp(c2, 0, aDeg, 8);
    ...
    public LongArray modMultiply(LongArray other, int m, int[] ks) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                c = T02;
                T0 = a;
                addBoth(T02, cOff, T03, ti[u], T1, ti[v], bMax);
                aVal >>>= 4;
                if (aVal == 0) {
                    break;
                }
        ...
        while (true) {
            ...
            if (bDeg != 0) {
                long[] T12 = T1;
                addShiftedUp(c, cOff2 - aDeg, c, cOff2, aDeg, 8);
                T1 = T12;
            } else {
                return reduceResult(c, 0, aDeg, i, iArr);
            }
        }
    }
    ...
    public LongArray modMultiplyAlt(LongArray other, int m, int[] ks) {
        ...
        aDeg = cLen;
        cLen = 64;
        int bMax2 = ((bDeg + (64 < 64 ? 16 : 16 - 1)) + 63) >>> 6;
        int bTotal = bMax2 * 8;
        int stride = 4 * 8;
        int[] ci2 = new int[(1 << 4)];
        int cTotal = tmp;
        ...
        int cTotal2 = (cTotal + aDeg) + 1;
        long[] c = new long[cTotal2];
        int bLen3 = bLen;
        bDeg = bTotal;
        int bMax3 = bMax2;
        int[] ci3 = ci2;
        int banks = 8;
        interleave(A.m_ints, 0, c, 0, tmp, 4);
        bLen = tmp;
        int bLen4 = bLen3;
        cTotal2 = 0;
        System.arraycopy(B.m_ints, 0, c, bLen, bLen4);
        bTotal = bLen;
        bLen = 1;
        while (true) {
            bank = bLen;
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if (bLen != 0) {
                        ...
                        B2 = B;
                        bLen = bMax;
                        add(c, bMax2 + ci[bLen], c, bank, bLen);
                    } else {
                        A2 = A;
                        B2 = B;
                        int i5 = bLen;
        ...
        while (true) {
            ...
            if (i2 > 1) {
                if ((((long) i2) & 1) == 0) {
                    i3 = cLen;
                    addShiftedUp(c, ci[i2 >>> 1], c, ci[i2], aDeg, 16);
                } else {
                    i3 = cLen;
                    distribute(c, ci[i2], ci[i2 - 1], ci[1], aDeg);
                }
                cLen = i3;
            } else {
                i3 = cLen;
                return reduceResult(c, ci[1], aDeg, i, iArr);
            }
        }
    }
    ...
    public LongArray multiply(LongArray other, int m, int[] ks) {
        ...
        if (tmp == 1) {
            ...
            c0 = new long[cLen];
            long[] c02 = c0;
            multiplyWord(a0, B.m_ints, bLen, c0, null);
        ...
        int tOff = bMax;
        ti[1] = tOff;
        System.arraycopy(B.m_ints, 0, c0, tOff, bLen);
        int tOff2 = tOff;
        for (int i = 2; i < 16; i++) {
            tOff = tOff2 + bMax;
            tOff2 = tOff;
            ti[i] = tOff;
            if ((i & 1) == 0) {
                shiftUp(c0, tOff2 >>> 1, c0, tOff2, bMax, 1);
            } else {
                add(c0, bMax, c0, tOff2 - bMax, c0, tOff2, bMax);
            }
        }
        long[] T1 = new long[c0.length];
        shiftUp(c0, 0, T1, 0, c0.length, 4);
        long[] a = A.m_ints;
        ...
        while (aPos < tmp) {
            ...
            while (true) {
                ...
                long[] jArr2 = T0;
                long[] jArr3 = T1;
                addBoth(jArr, i2, jArr2, ti[((int) aVal) & 15], jArr3, ti[((int) aVal) & 15], bMax);
                aVal >>>= 4;
                if (aVal == 0) {
                    break;
                }
        ...
        while (true) {
            ...
            if (i3 != 0) {
                ...
                long[] a3 = null;
                ti2 = ti;
                addShiftedUp(jArr4, tOff, c0, i4, cLen, 8);
                c = c2;
                ti = ti2;
                aDeg = cOff2;
                a = a2;
    ...
    private static int reduceInPlace(long[] buf, int off, int len, int m, int[] ks) {
        ...
        int excessBits;
        int vectorWiseWords;
        int numBits = Math.min(i2 << 6, (i3 << 1) - 1);
        int excessBits2 = (i2 << 6) - numBits;
        int len2 = i2;
        while (true) {
        ...
        int wordWiseLimit = Math.max(i3, iArr[kLen - 1] + 64);
        int vectorableWords = (Math.min(numBits - wordWiseLimit, i3 - kNext) + excessBits) >> 6;
        if (vectorableWords > 1) {
            int i4 = len2 - vectorableWords;
            vectorWiseWords = i4;
            numBits = wordWiseLimit;
            reduceVectorWise(jArr, i, len2, i4, i3, iArr);
            while (true) {
                i2 = vectorWiseWords;
                if (len2 <= i2) {
                    break;
        ...
        if (len2 > numBits) {
            reduceWordWise(jArr, i, vectorWiseWords, numBits, i3, iArr);
            len2 = numBits;
        }
        if (len2 > i3) {
            reduceBitWise(jArr, i, len2, i3, iArr);
        }
        return mLen;
    }
    ...
    private static void reduceWordWise(long[] buf, int off, int len, int toBit, int m, int[] ks) {
        ...
        if (word2 != 0) {
            toPos2 = off + toPos;
            buf[toPos2] = buf[toPos2] ^ (word2 << partial);
    ...
    public LongArray modInverse(int m, int[] ks) {
        ...
        if (uzDegree == 0) {
            ...
            int t = (i + 63) >>> 6;
            reduceBit(new LongArray(t).m_ints, 0, i, i, ks);
            new LongArray(t).m_ints[0] = 1;
            LongArray g2z = new LongArray(t);
            int[] uvDeg = new int[]{uzDegree, i + 1};
