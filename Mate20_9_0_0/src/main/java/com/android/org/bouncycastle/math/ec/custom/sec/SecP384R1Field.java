...
public class SecP384R1Field {
    ...
    public static void reduce(int[] xx, int[] z) {
        ...
        xx20 = (((long) xx[15]) & M) + xx23;
        long t4 = xx17 + xx21;
        long t5 = xx21 - xx23;
        long t6 = xx22 - xx23;
        long t7 = t0 + t5;
        xx22 = 0 + ((((long) xx[0]) & M) + t7);
        iArr[0] = (int) xx22;
        long xx172 = xx17;
        xx22 = (xx22 >> 32) + ((((((long) xx[1]) & M) + xx23) - t0) + t1);
        iArr[1] = (int) xx22;
        long cc = (xx22 >> 32) + ((((((long) xx[2]) & M) - xx21) - t1) + t2);
        iArr[2] = (int) cc;
        cc = (cc >> 32) + ((((((long) xx[3]) & M) - t2) + xx20) + t7);
        iArr[3] = (int) cc;
        cc = (cc >> 32) + ((((((((long) xx[4]) & M) + xx16) + xx21) + t1) - xx20) + t7);
        iArr[4] = (int) cc;
        cc = (cc >> 32) + (((((((long) xx[5]) & M) - xx16) + t1) + t2) + t4);
        iArr[5] = (int) cc;
        cc = (cc >> 32) + (((((((long) xx[6]) & M) + xx18) - xx172) + t2) + xx20);
        iArr[6] = (int) cc;
        cc = (cc >> 32) + (((((((long) xx[7]) & M) + xx16) + xx19) - xx18) + xx20);
        iArr[7] = (int) cc;
        cc = (cc >> 32) + (((((((long) xx[8]) & M) + xx16) + xx172) + xx202) - xx19);
        iArr[8] = (int) cc;
        cc = (cc >> 32) + ((((((long) xx[9]) & M) + xx18) - xx202) + t4);
        iArr[9] = (int) cc;
        cc = (cc >> 32) + (((((((long) xx[10]) & M) + xx18) + xx19) - t5) + t6);
        iArr[10] = (int) cc;
        cc = (cc >> 32) + ((((((long) xx[11]) & M) + xx19) + xx202) - t6);
        iArr[11] = (int) cc;
        reduce32((int) ((cc >> 32) + 1), iArr);
    }
