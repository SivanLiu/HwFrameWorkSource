...
public class OpenSSLX509CertificateFactory extends CertificateFactorySpi {
    ...
    private static abstract class Parser<T> {
        ...
        /* synthetic */ Parser(AnonymousClass1 x0) {
            this();
        }
                ...
                try {
                    ...
                    if (len >= 0) {
                        ...
                        if (buffer[0] == (byte) 45) {
                            ...
                            items = fromPkcs7PemInputStream(pbis);
                            if (items.size() == 0) {
                                return null;
                            }
                            items.get(0);
                        ...
                        items = fromPkcs7DerInputStream(pbis);
                        if (items.size() == 0) {
                            return null;
                        }
                        return items.get(0);
    ...
    public CertPath engineGenerateCertPath(List<? extends Certificate> certificates) throws CertificateException {
        ...
        while (i < certificates.size()) {
            ...
            if (c instanceof X509Certificate) {
                ...
                stringBuilder.append("Certificate not X.509 type at index ");
