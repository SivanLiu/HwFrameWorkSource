...
public final class NativeCrypto {
    ...
    static native void ASN1_TIME_to_Calendar(long j, Calendar calendar) throws ParsingException;

    static native byte[] ASN1_seq_pack_X509(long[] jArr);

    static native long[] ASN1_seq_unpack_X509_bio(long j) throws ParsingException;
    ...
    static native int ECDH_compute_key(byte[] bArr, int i, EVP_PKEY evp_pkey, EVP_PKEY evp_pkey2) throws InvalidKeyException, IndexOutOfBoundsException;
    ...
    static native byte[] EC_KEY_marshal_curve_name(EC_GROUP ec_group) throws IOException;
    ...
    static native int EVP_CipherUpdate(EVP_CIPHER_CTX evp_cipher_ctx, byte[] bArr, int i, byte[] bArr2, int i2, int i3) throws IndexOutOfBoundsException;
    ...
    static native boolean EVP_DigestVerifyFinal(EVP_MD_CTX evp_md_ctx, byte[] bArr, int i, int i2) throws IndexOutOfBoundsException;
    ...
    static native int EVP_PKEY_decrypt(EVP_PKEY_CTX evp_pkey_ctx, byte[] bArr, int i, byte[] bArr2, int i2, int i3) throws IndexOutOfBoundsException, BadPaddingException;

    static native long EVP_PKEY_decrypt_init(EVP_PKEY evp_pkey) throws InvalidKeyException;

    static native int EVP_PKEY_encrypt(EVP_PKEY_CTX evp_pkey_ctx, byte[] bArr, int i, byte[] bArr2, int i2, int i3) throws IndexOutOfBoundsException, BadPaddingException;

    static native long EVP_PKEY_encrypt_init(EVP_PKEY evp_pkey) throws InvalidKeyException;
    ...
    static native long EVP_parse_private_key(byte[] bArr) throws ParsingException;

    static native long EVP_parse_public_key(byte[] bArr) throws ParsingException;
    ...
    static native void SSL_set1_tls_channel_id(long j, NativeSsl nativeSsl, EVP_PKEY evp_pkey);
    ...
    static native void X509_CRL_verify(long j, OpenSSLX509CRL openSSLX509CRL, EVP_PKEY evp_pkey);
    ...
    static native void X509_verify(long j, OpenSSLX509Certificate openSSLX509Certificate, EVP_PKEY evp_pkey) throws BadPaddingException;
    ...
    static native long[] d2i_PKCS7_bio(long j, int i) throws ParsingException;
    ...
    static native void setLocalCertsAndPrivateKey(long j, NativeSsl nativeSsl, byte[][] bArr, EVP_PKEY evp_pkey) throws SSLException;
        ...
        if (cipherSuites != null) {
            ...
            while (i < cipherSuites.length) {
                ...
                if (cipherSuites[i] == null) {
                    ...
                    stringBuilder.append(cipherSuites[i]);
                    stringBuilder.append(" is not supported.");
                    throw new IllegalArgumentException(stringBuilder.toString());
                }
            }
