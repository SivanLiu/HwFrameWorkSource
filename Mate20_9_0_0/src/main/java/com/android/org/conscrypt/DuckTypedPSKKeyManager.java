        ...
        for (Method targetMethod : PSKKeyManager.class.getMethods()) {
            if (!targetMethod.isSynthetic()) {
                ...
                if (!targetReturnType.isAssignableFrom(sourceReturnType)) {
                    ...
                    stringBuilder.append(sourceMethod);
                    stringBuilder.append(" return value (");
                    stringBuilder.append(sourceReturnType);
                    stringBuilder.append(") incompatible with target return value (");
                    stringBuilder.append(targetReturnType);
