...
class ConscryptEngineSocket extends OpenSSLSocketImpl {
    ...
    /* renamed from: com.android.org.conscrypt.ConscryptEngineSocket$2 */
    static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            try {
                $SwitchMap$javax$net$ssl$SSLEngineResult$Status[Status.BUFFER_UNDERFLOW.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$javax$net$ssl$SSLEngineResult$Status[Status.OK.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$javax$net$ssl$SSLEngineResult$Status[Status.CLOSED.ordinal()] = 3;
            ...
            try {
                $SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus[HandshakeStatus.NOT_HANDSHAKING.ordinal()] = 4;
            } catch (NoSuchFieldError e7) {
            }
            try {
                $SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus[HandshakeStatus.FINISHED.ordinal()] = 5;
        ...
        private int readInternal(byte[] b, int off, int len) throws IOException {
            ...
            while (this.fromEngine.remaining() <= 0) {
                ...
                switch (AnonymousClass2.$SwitchMap$javax$net$ssl$SSLEngineResult$Status[engineResult.getStatus().ordinal()]) {
                    ...
                    default:
                        StringBuilder stringBuilder = new StringBuilder();
                        stringBuilder.append("Unexpected engine result ");
                        stringBuilder.append(engineResult.getStatus());
                        throw new SSLException(stringBuilder.toString());
                }
        ...
        private void writeInternal(ByteBuffer buffer) throws IOException {
            ...
            do {
                ...
                if (engineResult.getStatus() != Status.OK) {
                    ...
                    stringBuilder = new StringBuilder();
                    stringBuilder.append("Engine bytesProduced ");
                    stringBuilder.append(engineResult.bytesProduced());
                    stringBuilder.append(" does not match bytes written ");
                    stringBuilder.append(this.target.position());
                    throw new SSLException(stringBuilder.toString());
                }
            } while (len > 0);
        }
            ...
            try {
                switch (AnonymousClass2.$SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus[this.engine.getHandshakeStatus().ordinal()]) {
                    ...
                    default:
                        ...
                        stringBuilder.append(this.engine.getHandshakeStatus());
