...
public final class LockSettingsCmd extends BaseCommand {
    ...
    public void onRun() throws Exception {
        Stub.asInterface(ServiceManager.getService("lock_settings")).asBinder().shellCommand(FileDescriptor.in, FileDescriptor.out, FileDescriptor.err, getRawArgs(), new ShellCallback(), new ResultReceiver(null) {
        });
    }
}
