...
public class MonkeySourceNetwork implements MonkeyEventSource {
        ...
        public MonkeyCommandReturn waitForEvent() {
            if (this.event == 1) {
                try {
                    ...
                    String str = MonkeySourceNetwork.TAG;
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("Deferral interrupted: ");
    ...
    private static class KeyCommand implements MonkeyCommand {
        ...
        public MonkeyCommandReturn translateCommand(List<String> command, CommandQueue queue) {
            ...
            if (keyCode < 0) {
                String str = MonkeySourceNetwork.TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("Can't find keyname: ");
                stringBuilder.append((String) command.get(2));
                Log.e(str, stringBuilder.toString());
                return MonkeySourceNetwork.EARG;
            }
            String str2 = MonkeySourceNetwork.TAG;
    ...
    private static class PressCommand implements MonkeyCommand {
        ...
        public MonkeyCommandReturn translateCommand(List<String> command, CommandQueue queue) {
            ...
            if (keyCode < 0) {
                ...
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("Can't find keyname: ");
                stringBuilder.append((String) command.get(1));
                Log.e(str, stringBuilder.toString());
                return MonkeySourceNetwork.EARG;
            }
    ...
    private static class TapCommand implements MonkeyCommand {
        ...
        public MonkeyCommandReturn translateCommand(List<String> command, CommandQueue queue) {
            ...
            try {
                ...
                y = Integer.parseInt((String) command.get(2));
    ...
    private static class TouchCommand implements MonkeyCommand {
        ...
        public MonkeyCommandReturn translateCommand(List<String> command, CommandQueue queue) {
            ...
            try {
                ...
                y = Integer.parseInt((String) command.get(3));
                int action = -1;
                ...
                if (action == -1) {
                    String str = MonkeySourceNetwork.TAG;
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("Got a bad action: ");
    ...
    private static class TrackballCommand implements MonkeyCommand {
        ...
        public MonkeyCommandReturn translateCommand(List<String> command, CommandQueue queue) {
            ...
            int dy = 0;
            try {
                int dx = Integer.parseInt((String) command.get(1));
                queue.enqueueEvent(new MonkeyTrackballEvent(2).addPointer(0, (float) dx, (float) Integer.parseInt((String) command.get(2))));
                return MonkeySourceNetwork.OK;
            } catch (NumberFormatException e) {
                Log.e(MonkeySourceNetwork.TAG, "Got something that wasn't a number", e);
                return MonkeySourceNetwork.EARG;
    ...
    private static int getKeyCode(String keyName) {
        ...
        try {
            ...
            if (keyCode == 0) {
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("KEYCODE_");
                stringBuilder.append(keyName.toUpperCase());
                keyCode = MonkeySourceRandom.getKeyCode(stringBuilder.toString());
                if (keyCode == 0) {
                    return -1;
                }
            }
    ...
    private void translateCommand(String commandLine) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("translateCommand: ");
