...
public abstract class MonkeyMotionEvent extends MonkeyEvent {
    ...
    private MotionEvent getEvent() {
        ...
        int i7 = i6;
        return MotionEvent.obtain(ev, uptimeMillis, i2, pointerCount, pointerIds, pointerCoordsArr, i3, f, f2, i4, i7, this.mSource, this.mFlags);
    }
