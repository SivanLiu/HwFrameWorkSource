...
public class MonkeyNetworkMonitor extends Stub {
    ...
    public void dump() {
        ...
        stringBuilder.append("## Network stats: elapsed time=");
        stringBuilder.append(this.mElapsedTime);
        stringBuilder.append("ms (");
        stringBuilder.append(this.mMobileElapsedTime);
        stringBuilder.append("ms mobile, ");
        stringBuilder.append(this.mWifiElapsedTime);
        stringBuilder.append("ms wifi, ");
        stringBuilder.append((this.mElapsedTime - this.mMobileElapsedTime) - this.mWifiElapsedTime);
        stringBuilder.append("ms not connected)");
