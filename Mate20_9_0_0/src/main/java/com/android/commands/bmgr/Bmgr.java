...
public final class Bmgr {
    ...
    abstract class Observer extends Stub {
        @GuardedBy("trigger")
    ...
    class RestoreObserver extends IRestoreObserver.Stub {
        ...
        public void restoreStarting(int numPackages) {
            ...
            stringBuilder.append("restoreStarting: ");
            stringBuilder.append(numPackages);
        ...
        public void onUpdate(int nowBeingRestored, String currentPackage) {
            ...
            stringBuilder.append(nowBeingRestored);
            stringBuilder.append(" = ");
            stringBuilder.append(currentPackage);
            printStream.println(stringBuilder.toString());
        }
        ...
        public void restoreFinished(int error) {
            PrintStream printStream = System.out;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("restoreFinished: ");
    ...
    class BackupObserver extends Observer {
        ...
        public void onUpdate(String currentPackage, BackupProgress backupProgress) {
            ...
            stringBuilder.append(currentPackage);
            stringBuilder.append(" with progress: ");
            stringBuilder.append(backupProgress.bytesTransferred);
            stringBuilder.append("/");
            stringBuilder.append(backupProgress.bytesExpected);
            printStream.println(stringBuilder.toString());
        }
        ...
        public void onResult(String currentPackage, int status) {
            ...
            stringBuilder.append(Bmgr.convertBackupStatusToString(status));
            printStream.println(stringBuilder.toString());
        }
        ...
        public void backupFinished(int status) {
            ...
            PrintStream printStream = System.out;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Backup finished with result: ");
            stringBuilder.append(Bmgr.convertBackupStatusToString(status));
            printStream.println(stringBuilder.toString());
            if (status == -2003) {
    ...
    private void doEnabled() {
        try {
            ...
            PrintStream printStream = System.out;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Backup Manager currently ");
            stringBuilder.append(enableToString(isEnabled));
            printStream.println(stringBuilder.toString());
    ...
    private void doEnable() {
        ...
        try {
            ...
            PrintStream printStream = System.out;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Backup Manager now ");
            stringBuilder.append(enableToString(enable));
            printStream.println(stringBuilder.toString());
    ...
    private void doBackupNow() {
        ...
        if (backupAll) {
            if (allPkgs.size() == 0) {
                ...
                stringBuilder.append(nonIncrementalBackup ? "non-" : "");
                stringBuilder.append("incremental backup for all packages.");
                printStream.println(stringBuilder.toString());
            ...
            stringBuilder.append("Running ");
            stringBuilder.append(nonIncrementalBackup ? "non-" : "");
            stringBuilder.append("incremental backup for ");
            stringBuilder.append(allPkgs.size());
            stringBuilder.append(" requested packages.");
            printStream.println(stringBuilder.toString());
        ...
        try {
            ...
            if (which == null) {
                ...
                if (old == null) {
                    printStream = System.out;
                    stringBuilder = new StringBuilder();
                    stringBuilder.append("Unknown transport '");
                    stringBuilder.append(which);
                    stringBuilder.append("' specified; no changes made.");
                    printStream.println(stringBuilder.toString());
                } else {
                    printStream = System.out;
                    stringBuilder = new StringBuilder();
                    stringBuilder.append("Selected transport ");
                    stringBuilder.append(which);
                    stringBuilder.append(" (formerly ");
        ...
        try {
            this.mBmgr.selectBackupTransportAsync(ComponentName.unflattenFromString(which), new ISelectBackupTransportCallback.Stub() {
                public void onSuccess(String transportName) {
                    PrintStream printStream = System.out;
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("Success. Selected transport: ");
                ...
                public void onFailure(int reason) {
                    ...
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("Failure. error=");
    ...
    private void doWipe() {
        ...
        try {
            ...
            PrintStream printStream = System.out;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Wiped backup data for ");
    ...
    private void doInit() {
        ...
        try {
            PrintStream printStream = System.out;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Initializing transports: ");
            ...
            printStream = System.out;
            stringBuilder = new StringBuilder();
            stringBuilder.append("Initialization result: ");
            stringBuilder.append(observer.result);
            printStream.println(stringBuilder.toString());
        } catch (RemoteException e) {
            System.err.println(e.toString());
            System.err.println(BMGR_NOT_RUNNING_ERR);
    ...
    private void printRestoreSets(RestoreSet[] sets) {
        ...
        for (RestoreSet s : sets) {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("  ");
            stringBuilder.append(Long.toHexString(s.token));
            stringBuilder.append(" : ");
    ...
    private void doRestorePackage(String pkg) {
        try {
            ...
            if (this.mRestore.restorePackage(pkg, observer, null) == 0) {
                ...
                PrintStream printStream = System.err;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("Unable to restore package ");
                stringBuilder.append(pkg);
                printStream.println(stringBuilder.toString());
            }
            this.mRestore.endRestoreSession();
                ...
                if (sets != null) {
                    ...
                    while (i < length) {
                        ...
                        if (s.token == j) {
                            PrintStream printStream = System.out;
                            StringBuilder stringBuilder = new StringBuilder();
                            stringBuilder.append("Scheduling restore: ");
                            stringBuilder.append(s.name);
                            printStream.println(stringBuilder.toString());
                            if (hashSet == null) {
