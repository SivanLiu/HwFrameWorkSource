    ...
    private static void dumpExBroadcast(PrintWriter pw, String[] args) {
        if ("disable_log".equals(args[1])) {
            ...
            if (radar != null) {
                ...
                String filterDetailData = radar.getDFTData(forBeta, clear, null);
                ...
                stringBuilder.append("  ");
                stringBuilder.append(filterDetailData);
                pw.println(stringBuilder.toString());
                stringBuilder = new StringBuilder();
                stringBuilder.append("  ");
                stringBuilder.append(brData);
                pw.println(stringBuilder.toString());
                return;
            }
            ...
            stringBuilder2.append("  bad command");
            stringBuilder2.append(args[1]);
