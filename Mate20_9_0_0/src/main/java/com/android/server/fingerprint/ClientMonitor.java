...
public abstract class ClientMonitor implements DeathRecipient {
    ...
    private static final long[] DEFAULT_SUCCESS_VIBRATION_PATTERN = new long[]{0, (long) SystemProperties.getInt("ro.config.enroll_vibrate_time", 30)};
    ...
    private static final AudioAttributes FINGERPRINT_SONFICATION_ATTRIBUTES = new Builder().setContentType(4).setUsage(13).build();
    ...
    public void destroy() {
        ...
        if (this.mToken != null) {
            try {
                ...
                Slog.e(str, stringBuilder.toString(), new Exception("here"));
            }
            this.mToken = null;
        }
        this.mReceiver = null;
    ...
    protected void finalize() throws Throwable {
        try {
            if (this.mToken != null) {
                String str = TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("removing leaked reference: ");
    ...
    private static VibrationEffect getSuccessVibrationEffect(Context ctx) {
        ...
        if (ENROLL_VIBRATE_TIME > 0) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("use enroll time with prop :");
            stringBuilder.append(ENROLL_VIBRATE_TIME);
