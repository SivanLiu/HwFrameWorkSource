...
public class WaterEffectRender implements Renderer {
    ...
    private static class ReverseInterpolator implements TimeInterpolator {
        ...
        ReverseInterpolator(long inDuration, long animDuration, long outDuration) {
            ...
            String str = WaterEffectRender.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("ReverseInterpolator: ");
            stringBuilder.append(this.mFirstPoint);
            stringBuilder.append("  ");
            stringBuilder.append(this.mFirstScale);
            stringBuilder.append("  ");
            stringBuilder.append(this.mSecondPoint);
            stringBuilder.append("  ");
            stringBuilder.append(this.mSecondScale);
    ...
    public void setDiffuseFactor(float value) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setDiffuseFactor: value = ");
    ...
    public void setSpecularFactor(float value) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setSpecularFactor: value = ");
        stringBuilder.append(value);
        Log.d(str, stringBuilder.toString());
        if (value < GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO) {
    ...
    public void setLightDegree(float value) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setLightDegree: value = ");
        stringBuilder.append(value);
        Log.d(str, stringBuilder.toString());
        if (value < -90.0f) {
    ...
    private synchronized void updateOffset() {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("updateOffset: xOffset = ");
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        ...
        if (width > height) {
            ...
            f = SPACE_SCALE * aspectRatio;
            x = SPACE_SCALE;
        }
        Matrix.orthoM(this.mProjectionMatrix, 0, -x, x, -f, f, -1.0f, 1.0f);
        this.mRectData = new float[]{-x, f, -x, -f, x, f, x, f, -x, -f, x, -f};
        this.mRectBuffer = ByteBuffer.allocateDirect(this.mRectData.length * 4).order(ByteOrder.nativeOrder()).asFloatBuffer().put(this.mRectData);
    ...
    void playAnim(float centerX, float centerY) {
        ...
        synchronized (this) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("playAnim: centerX = ");
