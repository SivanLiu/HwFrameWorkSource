...
public class EmergencyAffordanceService extends SystemService {
    ...
    private void updateEmergencyAffordanceNeeded() {
        synchronized (this.mLock) {
            boolean z = this.mVoiceCapable && (this.mSimNeedsEmergencyAffordance || this.mNetworkNeedsEmergencyAffordance);
            this.mEmergencyAffordanceNeeded = z;
            Global.putInt(this.mContext.getContentResolver(), "emergency_affordance_needed", this.mEmergencyAffordanceNeeded);
    ...
    private void setSimNeedsEmergencyAffordance(boolean simNeedsEmergencyAffordance) {
        if (simNeededAffordanceBefore() != simNeedsEmergencyAffordance) {
            Global.putInt(this.mContext.getContentResolver(), EMERGENCY_SIM_INSERTED_SETTING, simNeedsEmergencyAffordance);
        }
