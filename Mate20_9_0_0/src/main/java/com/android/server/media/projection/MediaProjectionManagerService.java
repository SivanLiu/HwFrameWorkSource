...
public final class MediaProjectionManagerService extends SystemService implements Monitor {
    ...
    private final class BinderService extends Stub {
        ...
        /* synthetic */ BinderService(MediaProjectionManagerService x0, AnonymousClass1 x1) {
            this();
        }
        ...
        public MediaProjectionInfo getActiveProjectionInfo() {
            if (MediaProjectionManagerService.this.mContext.checkCallingOrSelfPermission("android.permission.MANAGE_MEDIA_PROJECTION") == 0) {
                long token = Binder.clearCallingIdentity();
                try {
                    MediaProjectionInfo access$600 = MediaProjectionManagerService.this.getActiveProjectionInfo();
                    return access$600;
                } finally {
                    Binder.restoreCallingIdentity(token);
                }
    ...
    private final class MediaProjection extends IMediaProjection.Stub {
        ...
        public void stop() {
            synchronized (MediaProjectionManagerService.this.mLock) {
                ...
                String str = MediaProjectionManagerService.TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("Attempted to stop inactive MediaProjection (uid=");
        ...
        public void dump(PrintWriter pw) {
            ...
            stringBuilder.append("): ");
            stringBuilder.append(MediaProjectionManagerService.typeToString(this.mType));
    ...
    private class MediaRouterCallback extends SimpleCallback {
        ...
        /* synthetic */ MediaRouterCallback(MediaProjectionManagerService x0, AnonymousClass1 x1) {
            this();
        }
