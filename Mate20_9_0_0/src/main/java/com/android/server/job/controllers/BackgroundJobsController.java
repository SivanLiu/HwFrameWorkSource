...
public final class BackgroundJobsController extends StateController {
    ...
    public void dumpControllerStateLocked(IndentingPrintWriter pw, Predicate<JobStatus> predicate) {
        ...
        pw.println();
        this.mService.getJobStore().forEachJob((Predicate) predicate, new -$$Lambda$BackgroundJobsController$5YoufKSiImueGHv9obiMns19gXE(this, pw));
    }
    ...
    public void dumpControllerStateLocked(ProtoOutputStream proto, long fieldId, Predicate<JobStatus> predicate) {
        ...
        this.mService.getJobStore().forEachJob((Predicate) predicate, new -$$Lambda$BackgroundJobsController$ypgNv91qX_67RP8z3Z9CsC0SRRs(this, proto));
        proto.end(mToken);
        proto.end(token);
    }
    ...
    public static /* synthetic */ void lambda$dumpControllerStateLocked$1(BackgroundJobsController backgroundJobsController, ProtoOutputStream proto, JobStatus jobStatus) {
        ...
        boolean z = true;
        boolean z2 = backgroundJobsController.mAppStateTracker.isUidPowerSaveWhitelisted(sourceUid) || backgroundJobsController.mAppStateTracker.isUidTempPowerSaveWhitelisted(sourceUid);
        proto.write(1133871366149L, z2);
    ...
    boolean updateSingleJobRestrictionLocked(JobStatus jobStatus, int activeState) {
        int uid = jobStatus.getSourceUid();
        boolean canRun = this.mAppStateTracker.areJobsRestricted(uid, jobStatus.getSourcePackageName(), (jobStatus.getInternalFlags() & 1) != 0) ^ true;
