    ...
    private Intent getServiceIntent(UserHandle userHandle) throws Exception {
        ...
        if (installedServices.size() == 1) {
            ...
            if (appInfo == null) {
                ...
                stringBuilder.append("android.permission.BIND_PRINT_RECOMMENDATION_SERVICE");
                throw new Exception(stringBuilder.toString());
            }
        }
        StringBuilder stringBuilder2 = new StringBuilder();
        stringBuilder2.append(installedServices.size());
        stringBuilder2.append(" instead of exactly one service found");
