package com.android.server.pc.decision;
...
public final class DecisionUtil {
    private static final String AIRSHARING_DEVICE_LIST_CLASS = "com.huawei.android.airsharing.player.DeviceListActivity";
    private static final String AIRSHARING_PKG = "com.huawei.android.airsharing";
    private static final String CATEGORY_KEY = "category";
    private static String ENTER_PROJECTION_EVENT = "com.huawei.desktop.intent.action.PcScreen";
    private static String ENTER_PROJECTION_TYPE = "ENTER_PROJECTION_TYPE";
    private static final String ID_KEY = "id";
    private static final int OPER_SUCCESS = 0;
    private static String OP_TYPE_CANCEL = "cancel";
    private static String OP_TYPE_GOTO = "goto";
    ...
    private static String REPORT_EVENT = "com.huawei.tips.intent.action.UE_DATA_USER_OPERATION";
    private static String REPORT_TYPE = "REPORT_TYPE";
    ...
    private static ServiceConnection mDecisionConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            if (DecisionUtil.REPORT_TYPE.equals(DecisionUtil.mType)) {
                Map extras = new ArrayMap();
                extras.put("feature_id", DecisionUtil.RECOMMEND_FEATURE_ID);
                extras.put(HwSecDiagnoseConstant.ANTIMAL_APK_TYPE, "dlg");
    ...
    private static class NoUnderLineClickSpan extends ClickableSpan {
        private NoUnderLineClickSpan() {
        }

        /* synthetic */ NoUnderLineClickSpan(AnonymousClass1 x0) {
            this();
        }
    ...
    public static boolean executeEvent(String eventName, Map<String, Object> extras) {
        return executeEvent(eventName, null, (Map) extras, null);
    }

    public static boolean executeEvent(String eventName, DecisionCallback callback) {
        return executeEvent(eventName, null, null, callback);
    }
    ...
    public static boolean executeEvent(String eventName, Map<String, Object> extras, DecisionCallback callback) {
        return executeEvent(eventName, null, (Map) extras, callback);
    }
    ...
    public static boolean removeBusinessData(String category, String dataId) {
        ...
        try {
            if (mDecisionApi.removeBusinessData(category, dataId) == 0) {
                z = true;
            }
            return z;
        } catch (Exception e) {
    ...
    public static void showPCRecommendDialog(Context context) {
        ...
        setClickableSpanForTextView(tipTextView, new NoUnderLineClickSpan(), agreeInfo.toString(), start, agreeInfo.length());
        mRecommendDialog.getWindow().setType(HwArbitrationDEFS.MSG_MPLINK_BIND_FAIL);
    ...
    private static void gotoPlayingSkills() {
        if (mContext != null) {
            dismissPCRecommendDialog();
    ...
    public static void startSearch(Context context) {
        if (context != null) {
            if (Secure.getInt(context.getContentResolver(), WIRELESS_PROJECTION_STATE, 0) == 0) {
                Secure.putInt(context.getContentResolver(), WIRELESS_PROJECTION_STATE, 1);
            }
            try {
                Intent intent = new Intent("android.intent.action.MAIN");
                ComponentName componet = new ComponentName(AIRSHARING_PKG, AIRSHARING_DEVICE_LIST_CLASS);
    ...
    private static void executeReportEvent(final Context context, String type) {
        mOpType = type;
