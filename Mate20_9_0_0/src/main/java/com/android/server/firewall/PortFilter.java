...
class PortFilter implements Filter {
        ...
        public Filter newFilter(XmlPullParser parser) throws IOException, XmlPullParserException {
            ...
            if (equalsValue != null) {
                try {
                    ...
                    stringBuilder2.append("Invalid port value: ");
                    stringBuilder2.append(equalsValue);
                    throw new XmlPullParserException(stringBuilder2.toString(), parser, null);
                }
            }
                ...
                if (equalsValue == null) {
                    if (lowerBoundString != null) {
                        try {
                            ...
                            stringBuilder.append("Invalid minimum port value: ");
                            stringBuilder.append(lowerBoundString);
                    ...
                    if (upperBoundString != null) {
                        try {
                            ...
                            stringBuilder = new StringBuilder();
                            stringBuilder.append("Invalid maximum port value: ");
                            stringBuilder.append(upperBoundString);
                            throw new XmlPullParserException(stringBuilder.toString(), parser, null);
                        }
                    }
                }
    ...
    /* synthetic */ PortFilter(int x0, int x1, AnonymousClass1 x2) {
        this(x0, x1);
    }
