    ...
    public static final class ConnectStatistics extends MessageNano {
        ...
        public void writeTo(CodedOutputByteBufferNano output) throws IOException {
            ...
            if (this.nonBlockingLatenciesMs != null && this.nonBlockingLatenciesMs.length > 0) {
                while (true) {
                    i = i2;
                    if (i >= this.nonBlockingLatenciesMs.length) {
                        break;
                    }
        ...
        protected int computeSerializedSize() {
            ...
            if (this.errnosCounters != null && this.errnosCounters.length > 0) {
                ...
                for (Pair element2 : this.errnosCounters) {
                    if (element2 != null) {
                        i += CodedOutputByteBufferNano.computeMessageSize(4, element2);
                    }
                }
                size = i;
            }
            ...
            i = 0;
            while (i2 < this.nonBlockingLatenciesMs.length) {
                i += CodedOutputByteBufferNano.computeInt32SizeNoTag(this.nonBlockingLatenciesMs[i2]);
                i2++;
            }
            return (size + i) + (1 * this.nonBlockingLatenciesMs.length);
        }
        ...
        public ConnectStatistics mergeFrom(CodedInputByteBufferNano input) throws IOException {
            while (true) {
                ...
                if (tag == 8) {
                    ...
                    i2 = this.latenciesMs == null ? 0 : this.latenciesMs.length;
                    ...
                    input.rewindToPosition(startPos);
                    i2 = this.nonBlockingLatenciesMs == null ? 0 : this.nonBlockingLatenciesMs.length;
                    newArray2 = new int[(i2 + arrayLength2)];
                    if (i2 != 0) {
    ...
    public static final class DNSLookupBatch extends MessageNano {
        ...
        public void writeTo(CodedOutputByteBufferNano output) throws IOException {
            ...
            if (this.gethostbynameErrors != null && this.gethostbynameErrors.length > 0) {
                while (true) {
                    i = i2;
                    if (i >= this.gethostbynameErrors.length) {
                        break;
                    }
                    Pair element2 = this.gethostbynameErrors[i];
                    if (element2 != null) {
        ...
        protected int computeSerializedSize() {
            ...
            if (this.eventTypes != null && this.eventTypes.length > 0) {
                dataSize = 0;
                for (int element2 : this.eventTypes) {
            ...
            if (this.returnCodes != null && this.returnCodes.length > 0) {
                dataSize = 0;
                for (int element22 : this.returnCodes) {
            ...
            if (this.latenciesMs != null && this.latenciesMs.length > 0) {
                dataSize = 0;
                for (int element222 : this.latenciesMs) {
                    dataSize += CodedOutputByteBufferNano.computeInt32SizeNoTag(element222);
                }
                size = (size + dataSize) + (1 * this.latenciesMs.length);
            }
            if (this.getaddrinfoQueryCount != 0) {
            ...
            if (this.getaddrinfoErrors != null && this.getaddrinfoErrors.length > 0) {
                i = size;
                for (Pair element3 : this.getaddrinfoErrors) {
                    if (element3 != null) {
                        i += CodedOutputByteBufferNano.computeMessageSize(9, element3);
                    }
                }
                size = i;
            }
            if (this.gethostbynameErrors != null && this.gethostbynameErrors.length > 0) {
                while (true) {
                    ...
                    element3 = this.gethostbynameErrors[i];
                    if (element3 != null) {
            ...
            while (true) {
                ...
                switch (tag) {
                    ...
                    case 18:
                        ...
                        input.rewindToPosition(startPos);
                        i2 = this.eventTypes == null ? 0 : this.eventTypes.length;
                        newArray2 = new int[(i2 + arrayLength2)];
                        if (i2 != 0) {
                    ...
                    case 26:
                        ...
                        input.rewindToPosition(startPos);
                        i2 = this.returnCodes == null ? 0 : this.returnCodes.length;
                        newArray2 = new int[(i2 + arrayLength2)];
                        if (i2 != 0) {
                ...
                switch (tag) {
                    ...
                    case 80:
                        ...
                        switch (value) {
                            ...
                            case 8:
                            case 9:
                                this.previousDefaultNetworkLinkLayer = value;
                                break;
                            default:
                                break;
                        }
    ...
    public static final class NetworkStats extends MessageNano {
        ...
        public void writeTo(CodedOutputByteBufferNano output) throws IOException {
            ...
            if (this.validationStates != null && this.validationStates.length > 0) {
                while (true) {
                    i = i2;
                    if (i >= this.validationStates.length) {
                        break;
                    }
                    Pair element2 = this.validationStates[i];
                    if (element2 != null) {
        ...
        protected int computeSerializedSize() {
            ...
            if (this.durationMs != 0) {
                size2 += CodedOutputByteBufferNano.computeInt64Size(1, this.durationMs);
            }
            if (this.ipSupport != 0) {
                size2 += CodedOutputByteBufferNano.computeInt32Size(2, this.ipSupport);
            }
            if (this.everValidated) {
                size2 += CodedOutputByteBufferNano.computeBoolSize(3, this.everValidated);
            }
            if (this.portalFound) {
                size2 += CodedOutputByteBufferNano.computeBoolSize(4, this.portalFound);
            }
            if (this.noConnectivityReports != 0) {
                size2 += CodedOutputByteBufferNano.computeInt32Size(5, this.noConnectivityReports);
            }
            if (this.validationAttempts != 0) {
                size2 += CodedOutputByteBufferNano.computeInt32Size(6, this.validationAttempts);
            }
            int i = 0;
            if (this.validationEvents != null && this.validationEvents.length > 0) {
                size = size2;
            ...
            if (this.validationStates != null && this.validationStates.length > 0) {
                while (true) {
                    size = i;
                    if (size >= this.validationStates.length) {
                        break;
                    }
                    Pair element2 = this.validationStates[size];
                    if (element2 != null) {
                        size2 += CodedOutputByteBufferNano.computeMessageSize(8, element2);
                    }
                    i = size + 1;
                }
            }
    ...
    public static final class WakeupStats extends MessageNano {
        ...
        public void writeTo(CodedOutputByteBufferNano output) throws IOException {
            ...
            if (this.ipNextHeaderCounts != null && this.ipNextHeaderCounts.length > 0) {
                while (true) {
                    i = i2;
                    if (i >= this.ipNextHeaderCounts.length) {
                        break;
                    }
                    Pair element2 = this.ipNextHeaderCounts[i];
                    if (element2 != null) {
        ...
        protected int computeSerializedSize() {
            ...
            int size2 = super.computeSerializedSize();
            if (this.durationSec != 0) {
                size2 += CodedOutputByteBufferNano.computeInt64Size(1, this.durationSec);
            }
            if (this.totalWakeups != 0) {
                size2 += CodedOutputByteBufferNano.computeInt64Size(2, this.totalWakeups);
            }
            if (this.rootWakeups != 0) {
                size2 += CodedOutputByteBufferNano.computeInt64Size(3, this.rootWakeups);
            }
            if (this.systemWakeups != 0) {
                size2 += CodedOutputByteBufferNano.computeInt64Size(4, this.systemWakeups);
            }
            if (this.applicationWakeups != 0) {
                size2 += CodedOutputByteBufferNano.computeInt64Size(5, this.applicationWakeups);
            }
            if (this.nonApplicationWakeups != 0) {
                size2 += CodedOutputByteBufferNano.computeInt64Size(6, this.nonApplicationWakeups);
            }
            if (this.noUidWakeups != 0) {
                size2 += CodedOutputByteBufferNano.computeInt64Size(7, this.noUidWakeups);
            }
            int i = 0;
            if (this.ethertypeCounts != null && this.ethertypeCounts.length > 0) {
                size = size2;
            ...
            if (this.ipNextHeaderCounts != null && this.ipNextHeaderCounts.length > 0) {
                while (true) {
                    size = i;
                    if (size >= this.ipNextHeaderCounts.length) {
                        break;
                    }
                    Pair element2 = this.ipNextHeaderCounts[size];
                    if (element2 != null) {
                        size2 += CodedOutputByteBufferNano.computeMessageSize(9, element2);
                    }
                    i = size + 1;
                }
            }
            if (this.l2UnicastCount != 0) {
                size2 += CodedOutputByteBufferNano.computeInt64Size(10, this.l2UnicastCount);
            }
            if (this.l2MulticastCount != 0) {
                size2 += CodedOutputByteBufferNano.computeInt64Size(11, this.l2MulticastCount);
            }
            if (this.l2BroadcastCount != 0) {
                return size2 + CodedOutputByteBufferNano.computeInt64Size(12, this.l2BroadcastCount);
            }
            return size2;
        }
            ...
            while (true) {
                ...
                switch (tag) {
                    ...
                    case 66:
                        ...
                        i = this.ethertypeCounts == null ? 0 : this.ethertypeCounts.length;
                    ...
                    case 74:
                        arrayLength = WireFormatNano.getRepeatedFieldArrayLength(input, 74);
                        i = this.ipNextHeaderCounts == null ? 0 : this.ipNextHeaderCounts.length;
                        newArray = new Pair[(i + arrayLength)];
                        if (i != 0) {
