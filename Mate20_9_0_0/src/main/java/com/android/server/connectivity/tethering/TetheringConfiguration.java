...
public class TetheringConfiguration {
    ...
    public TetheringConfiguration(Context ctx, SharedLog log) {
        ...
        stringBuilder.append("DUN check returned: ");
        stringBuilder.append(dunCheckString(this.dunCheck));
        configLog.log(stringBuilder.toString());
    ...
    public boolean hasMobileHotspotProvisionApp() {
        return TextUtils.isEmpty(this.provisioningAppNoUi) ^ 1;
    }
    ...
    private static Collection<Integer> getUpstreamIfaceTypes(Context ctx, int dunCheck) {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("upstreamIfaceTypes ");
        stringBuilder.append(upstreamIfaceTypes);
        stringBuilder.append(", dunCheck is ");
        stringBuilder.append(dunCheck);
