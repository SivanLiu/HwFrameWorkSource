...
public class NetworkAgentInfo implements Comparable<NetworkAgentInfo> {
    ...
    /* renamed from: com.android.server.connectivity.NetworkAgentInfo$1 */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$android$net$NetworkRequest$Type = new int[Type.values().length];

        static {
            try {
                $SwitchMap$android$net$NetworkRequest$Type[Type.REQUEST.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$android$net$NetworkRequest$Type[Type.BACKGROUND_REQUEST.ordinal()] = 2;
            ...
            try {
                $SwitchMap$android$net$NetworkRequest$Type[Type.LISTEN.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                $SwitchMap$android$net$NetworkRequest$Type[Type.NONE.ordinal()] = 5;
    ...
    private void updateRequestCounts(boolean add, NetworkRequest request) {
        ...
        switch (AnonymousClass1.$SwitchMap$android$net$NetworkRequest$Type[request.type.ordinal()]) {
            ...
            default:
                ...
                stringBuilder.append("Unhandled request type ");
    ...
    public boolean isSuspended() {
        return this.networkInfo.getState() == State.SUSPENDED;
    }
    ...
    private int getCurrentScore(boolean pretendValidated) {
        if (this.currentScore == 35) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("AI device score:");
            stringBuilder.append(this.currentScore);
            Log.d(str, stringBuilder.toString());
            return this.currentScore;
        } else if (this.networkMisc != null && this.networkMisc.acceptUnvalidated) {
            return 100;
        } else {
    ...
    public void lingerRequest(NetworkRequest request, long now, long duration) {
        if (this.mLingerTimerForRequest.get(request.requestId) != null) {
            ...
            stringBuilder.append(" already lingered");
            Log.wtf(str, stringBuilder.toString());
        }
    ...
    public void updateLingerTimer() {
        ...
        if (newExpiry != this.mLingerExpiryMs) {
            ...
            if (newExpiry > 0) {
                ...
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("NETWORK_LINGER_COMPLETE.");
                stringBuilder.append(this.network.netId);
                this.mLingerMessage = connectivityService.makeWakeupMessage(context, handler, stringBuilder.toString(), EVENT_NETWORK_LINGER_COMPLETE, this);
    ...
    public String toString() {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("NetworkAgentInfo{ ni{");
        stringBuilder.append(this.networkInfo);
        stringBuilder.append("}  network{");
        stringBuilder.append(this.network);
        stringBuilder.append("}  nethandle{");
        stringBuilder.append(this.network.getNetworkHandle());
        stringBuilder.append("}  nc{");
        stringBuilder.append(this.networkCapabilities);
        stringBuilder.append("}  Score{");
        stringBuilder.append(getCurrentScore());
        stringBuilder.append("}  everValidated{");
        stringBuilder.append(this.everValidated);
        stringBuilder.append("}  lastValidated{");
        stringBuilder.append(this.lastValidated);
        stringBuilder.append("}  created{");
        stringBuilder.append(this.created);
        stringBuilder.append("} lingering{");
        stringBuilder.append(isLingering());
        stringBuilder.append("} explicitlySelected{");
        stringBuilder.append(this.networkMisc.explicitlySelected);
        stringBuilder.append("} acceptUnvalidated{");
        stringBuilder.append(this.networkMisc.acceptUnvalidated);
        stringBuilder.append("} everCaptivePortalDetected{");
        stringBuilder.append(this.everCaptivePortalDetected);
        stringBuilder.append("} lastCaptivePortalDetected{");
        stringBuilder.append(this.lastCaptivePortalDetected);
        stringBuilder.append("} clat{");
        stringBuilder.append(this.clatd);
    ...
    public String name() {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("NetworkAgentInfo [");
        stringBuilder.append(this.networkInfo.getTypeName());
        stringBuilder.append(" (");
        stringBuilder.append(this.networkInfo.getSubtypeName());
        stringBuilder.append(") - ");
        stringBuilder.append(Objects.toString(this.network));
        stringBuilder.append("]");
        return stringBuilder.toString();
    }
