        ...
        public void run() {
            ...
            if (!Uri.EMPTY.equals(pacUrl)) {
                ...
                try {
                    ...
                    file = e;
                    String str = PacManager.TAG;
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("Failed to load PAC file: ");
    ...
    private static String get(Uri pacUri) throws IOException {
        ...
        if (contentLength <= MAX_PAC_SIZE) {
            ...
            while (true) {
                ...
                if (((long) bytes.size()) > MAX_PAC_SIZE) {
                    throw new IOException("PAC too big");
                }
            }
        } else {
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("PAC too big: ");
                ...
                public void onServiceConnected(ComponentName component, IBinder binder) {
                    synchronized (PacManager.this.mProxyLock) {
                        try {
                            String str = PacManager.TAG;
                            StringBuilder stringBuilder = new StringBuilder();
                            stringBuilder.append("Adding service com.android.net.IProxyService ");
                            stringBuilder.append(binder.getInterfaceDescriptor());
                        ...
                        if (PacManager.this.mProxyService == null) {
                            ...
                            try {
                                ...
                                Log.e(PacManager.TAG, "Unable to reach ProxyService - PAC will not be started", e12);
                            }
                            PacManager.this.mNetThreadHandler.post(PacManager.this.mPacDownloader);
                        }
                    }
                            ...
                            callbackService.getProxyPort(new IProxyPortListener.Stub() {
                                public void setProxyPort(int port) throws RemoteException {
                                    ...
                                    if (port != -1) {
                                        String str = PacManager.TAG;
                                        StringBuilder stringBuilder = new StringBuilder();
                                        stringBuilder.append("Local proxy is bound on ");
