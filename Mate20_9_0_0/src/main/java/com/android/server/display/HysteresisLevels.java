...
public class HysteresisLevels {
    ...
    public void dump(PrintWriter pw) {
        ...
        stringBuilder.append("  mBrightLevels=");
        stringBuilder.append(Arrays.toString(this.mBrightLevels));
        pw.println(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append("  mDarkLevels=");
        stringBuilder.append(Arrays.toString(this.mDarkLevels));
        pw.println(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append("  mLuxLevels=");
        stringBuilder.append(Arrays.toString(this.mLuxLevels));
        pw.println(stringBuilder.toString());
    }
}
