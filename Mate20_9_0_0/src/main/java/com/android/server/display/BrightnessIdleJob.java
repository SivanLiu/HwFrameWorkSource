...
public class BrightnessIdleJob extends JobService {
    ...
    public static void scheduleJob(Context context) {
        ...
        JobInfo jobInfo = new Builder(JOB_ID, new ComponentName(context, BrightnessIdleJob.class)).setRequiresDeviceIdle(true).setRequiresCharging(true).setPeriodic(TimeUnit.HOURS.toMillis(24)).build();
