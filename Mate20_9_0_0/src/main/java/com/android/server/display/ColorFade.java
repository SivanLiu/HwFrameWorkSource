...
final class ColorFade {
    ...
    private String readFile(Context context, int resourceId) {
        try {
            ...
            stringBuilder.append("Unrecognized shader ");
            stringBuilder.append(Integer.toString(resourceId));
    ...
    public boolean draw(float level) {
        ...
        try {
            ...
            drawFaded(((float) (-Math.pow(one_minus_level, 2.0d))) + 1.0f, 1.0f / ((float) (0.1d + ((((0.5d * (cos < 0.0d ? -1.0d : 1.0d)) * Math.pow(cos, 2.0d)) + 0.5d) * 0.9d))));
            if (checkGlErrors("drawFrame")) {
                return z;
            }
            z = this.mEglDisplay;
            EGL14.eglSwapBuffers(z, this.mEglSurface);
            detachEglContext();
    ...
    private boolean createEglContext() {
        ...
        if (this.mEglConfig == null) {
            ...
            if (!EGL14.eglChooseConfig(this.mEglDisplay, new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 8, 12344}, 0, eglConfigs, 0, eglConfigs.length, version, 0)) {
    ...
    private boolean createSurface() {
        ...
        try {
            if (this.mSurfaceControl == null) {
                ...
                this.mSurfaceControl = new Builder(this.mSurfaceSession).setName(TAG).setSize(this.mDisplayWidth, this.mDisplayHeight).setFlags(flags).build();
    ...
    private static void logEglError(String func) {
        ...
        stringBuilder.append(" failed: error ");
    ...
    public void dump(PrintWriter pw) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("  mPrepared=");
        stringBuilder.append(this.mPrepared);
        ...
        pw.println(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append("  mDisplayLayerStack=");
        stringBuilder.append(this.mDisplayLayerStack);
        pw.println(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append("  mDisplayWidth=");
        stringBuilder.append(this.mDisplayWidth);
        pw.println(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append("  mDisplayHeight=");
        stringBuilder.append(this.mDisplayHeight);
        pw.println(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append("  mSurfaceVisible=");
        stringBuilder.append(this.mSurfaceVisible);
        pw.println(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append("  mSurfaceAlpha=");
        stringBuilder.append(this.mSurfaceAlpha);
        pw.println(stringBuilder.toString());
    }
}
