    ...
    public BackLightMonitorManager(DisplayEffectMonitor monitor) {
        if (monitor != null) {
            ...
            if (HWFLOW) {
                ...
                stringBuilder.append("new instance success, isCommercialVersion=");
                stringBuilder.append(isCommercialVersion);
    ...
    private void xmlConfig(ArrayMap<String, Object> params) {
        if (params.get(PARAM_ENABLE) instanceof Boolean) {
            ...
            if (HWFLOW) {
                String str = TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("xmlConfig() isProductEnable=");
                stringBuilder.append(isProductEnable);
                Slog.i(str, stringBuilder.toString());
            }
