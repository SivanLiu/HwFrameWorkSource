...
public class SyncManagerConstants extends ContentObserver {
    ...
    public void start() {
        BackgroundThread.getHandler().post(new -$$Lambda$SyncManagerConstants$qo5ldQVp10jCUY9aavBZDKP2k6Q(this));
    }

    public static /* synthetic */ void lambda$start$0(SyncManagerConstants syncManagerConstants) {
        syncManagerConstants.mContext.getContentResolver().registerContentObserver(Global.getUriFor("sync_manager_constants"), false, syncManagerConstants);
    ...
    private void refresh() {
        synchronized (this.mLock) {
            String newValue = Global.getString(this.mContext.getContentResolver(), "sync_manager_constants");
