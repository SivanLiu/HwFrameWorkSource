...
public class MmsServiceBroker extends SystemService {
    ...
    private final class BinderService extends Stub {
        ...
        /* synthetic */ BinderService(MmsServiceBroker x0, AnonymousClass1 x1) {
            this();
        }
        ...
        public void sendMessage(int subId, String callingPkg, Uri contentUri, String locationUrl, Bundle configOverrides, PendingIntent sentIntent) throws RemoteException {
            ...
            if (manager != null) {
                manager.sendBehavior(BehaviorId.MMSBROKER_SENDMESSAGE);
            }
            String str2 = MmsServiceBroker.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("sendMessage() by ");
        ...
        public void downloadMessage(int subId, String callingPkg, String locationUrl, Uri contentUri, Bundle configOverrides, PendingIntent downloadedIntent) throws RemoteException {
            String str = MmsServiceBroker.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("downloadMessage() by ");
        ...
        public Bundle getCarrierConfigValues(int subId) throws RemoteException {
            String str = MmsServiceBroker.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("getCarrierConfigValues() by ");
            stringBuilder.append(MmsServiceBroker.this.getCallingPackageName());
            Slog.d(str, stringBuilder.toString());
    ...
    private IMms getOrConnectService() {
        synchronized (this) {
            ...
            long shouldEnd = SystemClock.elapsedRealtime();
            long waitTime = SERVICE_CONNECTION_WAIT_TIME_MS;
            shouldEnd += SERVICE_CONNECTION_WAIT_TIME_MS;
            while (waitTime > 0) {
                try {
                    wait(waitTime);
