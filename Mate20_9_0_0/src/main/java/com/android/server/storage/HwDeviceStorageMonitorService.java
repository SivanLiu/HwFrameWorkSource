...
public class HwDeviceStorageMonitorService extends DeviceStorageMonitorService {
    ...
    public void sendNotificationHwSM(long freeMem, boolean isBootImageOnDisk, int notficationId, String tag) {
        ...
        stringBuilder.append("HW Sending low memory notification, freeMem = ");
        ...
        lowMemIntent.putExtra("memory", j);
        ...
        String str2 = tag;
        mNotificationMgr.notifyAsUser(str2, notficationId, notification, UserHandle.ALL);
    }
