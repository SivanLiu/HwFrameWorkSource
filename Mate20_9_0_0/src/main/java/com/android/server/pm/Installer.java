...
public class Installer extends SystemService {
    ...
    private void connect() {
        ...
        BackgroundThread.getHandler().postDelayed(new -$$Lambda$Installer$SebeftIfAJ7KsTmM0tju6PfW4Pc(this), 1000);
    }
    ...
    private boolean checkBeforeRemote() {
        if (this.mWarnIfHeld != null && Thread.holdsLock(this.mWarnIfHeld)) {
            ...
            stringBuilder.append(" is holding 0x");
            stringBuilder.append(Integer.toHexString(System.identityHashCode(this.mWarnIfHeld)));
    ...
    private static void assertValidInstructionSet(String instructionSet) throws InstallerException {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Invalid instruction set: ");
        stringBuilder.append(instructionSet);
        throw new InstallerException(stringBuilder.toString());
    }
    ...
    public int executeBackupTask(int sessionId, String taskCmd) throws InstallerException {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("bind call executeBackupTask on sessionId ");
