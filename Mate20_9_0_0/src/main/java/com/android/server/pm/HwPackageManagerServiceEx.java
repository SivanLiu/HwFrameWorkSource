...
public final class HwPackageManagerServiceEx implements IHwPackageManagerServiceEx {
    ...
    public boolean hwPerformDexOptMode(String packageName, boolean checkProfiles, String targetCompilerFilter, boolean force, boolean bootComplete, String splitName) {
        ...
        String targetCompilerFilter2 = "speed-profile";
        this.mIsOpting.set(true);
        while (true) {
            boolean ret = this.mIPmsInner.performDexOptMode(packageName2, checkProfiles, targetCompilerFilter2, force, bootComplete, splitName);
            str = TAG;
            stringBuilder = new StringBuilder();
            stringBuilder.append("finish performDexOptMode packageName ");
            stringBuilder.append(packageName2);
            ...
            synchronized (this.mSpeedOptLock) {
                ...
                packageName2 = (String) this.mSpeedOptPkgs.valueAt(0);
