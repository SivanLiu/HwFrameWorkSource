...
public class IntentFilterVerificationState {
    ...
    public boolean setVerifierResponse(int callerUid, int code) {
        ...
        stringBuilder.append("Cannot set verifier response with callerUid:");
        stringBuilder.append(callerUid);
        stringBuilder.append(" and code:");
        stringBuilder.append(code);
        stringBuilder.append(" as required verifierUid is:");
        stringBuilder.append(this.mRequiredVerifierUid);
