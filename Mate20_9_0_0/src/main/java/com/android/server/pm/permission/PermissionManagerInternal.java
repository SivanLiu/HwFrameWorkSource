...
public abstract class PermissionManagerInternal {
    ...
    public abstract void addAllPermissionGroups(Package packageR, boolean z);

    public abstract void addAllPermissions(Package packageR, boolean z);
    ...
    public abstract int checkUidPermission(String str, Package packageR, int i, int i2);
    ...
    public abstract void grantRequestedRuntimePermissions(Package packageR, int[] iArr, String[] strArr, int i, PermissionCallback permissionCallback);
    ...
    public abstract void grantRuntimePermissionsGrantedToDisabledPackage(Package packageR, int i, PermissionCallback permissionCallback);

    public abstract boolean isPermissionsReviewRequired(Package packageR, int i);

    public abstract void removeAllPermissions(Package packageR, boolean z);
    ...
    public abstract void revokeRuntimePermissionsIfGroupChanged(Package packageR, Package packageR2, ArrayList<String> arrayList, PermissionCallback permissionCallback);

    public abstract void systemReady();

    public abstract void updateAllPermissions(String str, boolean z, Collection<Package> collection, PermissionCallback permissionCallback);
    ...
    public abstract boolean updatePermissionFlagsForAllApps(int i, int i2, int i3, int i4, Collection<Package> collection, PermissionCallback permissionCallback);

    public abstract void updatePermissions(String str, Package packageR, boolean z, Collection<Package> collection, PermissionCallback permissionCallback);
}
