...
public class WifiStateMachineHisiExt {
    ...
    public void setWifiStateByManual(boolean enable) {
        ...
        stringBuilder.append(",previousWifiState:");
        stringBuilder.append(previousWifiState);
        ...
        try {
            ...
            stringBuilder2.append("setWifiStateByManual exception:");
    ...
    public void setWifiApStateByManual(boolean enable) {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setWifiApStateByManual: ");
        stringBuilder.append(enable);
        stringBuilder.append(",previousWifiApState:");
        stringBuilder.append(previousWifiApState);
        Slog.d(str, stringBuilder.toString());
        ...
        try {
            ...
            String str2 = TAG;
            StringBuilder stringBuilder2 = new StringBuilder();
            stringBuilder2.append("setWifiApStateByManual exception:");
            stringBuilder2.append(e);
            Slog.e(str2, stringBuilder2.toString());
        }
    }
    ...
    public void setWifiEnableForP2p(boolean enable) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setWifiEnableForP2p: ");
        stringBuilder.append(enable);
        Slog.d(str, stringBuilder.toString());
