...
public class IPAddressTypeAvailabilityElement extends ANQPElement {
    ...
    public static IPAddressTypeAvailabilityElement parse(ByteBuffer payload) throws ProtocolException {
        ...
        stringBuilder.append("Unexpected buffer length: ");
    ...
    public String toString() {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("IPAddressTypeAvailability{mV4Availability=");
        stringBuilder.append(this.mV4Availability);
        stringBuilder.append(", mV6Availability=");
        stringBuilder.append(this.mV6Availability);
