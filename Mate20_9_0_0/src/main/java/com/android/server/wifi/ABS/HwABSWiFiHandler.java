...
public class HwABSWiFiHandler {
    ...
    public void setAPCapability(int capability) {
        ...
        stringBuilder.append("setAPCapability, capability = ");
    ...
    public boolean isHandoverTimeout() {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("isHandoverTimeout handoverTime = ");
        stringBuilder.append(handoverTime);
        HwABSUtils.logD(stringBuilder.toString());
        if (handoverTime > 500) {
            return true;
        }
    ...
    public void setABSBlackList(String blackList) {
        int wifiState = this.mWifiStateMachine.syncGetWifiState();
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setAPCapability, wifiState =");
        stringBuilder.append(wifiState);
        HwABSUtils.logD(stringBuilder.toString());
        if (wifiState != 0 && wifiState != 1 && wifiState != 2) {
    ...
    public void setABSCurrentState(int state) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setABSCurrentState, state =");
