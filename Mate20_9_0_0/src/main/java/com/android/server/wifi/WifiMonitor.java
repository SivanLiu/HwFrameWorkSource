...
public class WifiMonitor {
    ...
    public synchronized void startMonitoring(String iface) {
        ...
        stringBuilder.append("startMonitoring(");
    ...
    public synchronized void stopMonitoring(String iface) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("stopMonitoring(");
        stringBuilder.append(iface);
        stringBuilder.append(")");
        Log.d(str, stringBuilder.toString());
        setMonitoring(iface, true);
    ...
    private void sendMessage(String iface, Message message) {
        ...
        if (iface == null || ifaceHandlers == null) {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Dropping event because (");
            stringBuilder.append(iface);
    ...
    public void broadcastAssociationRejectionEvent(String iface, int status, boolean timedOut, String bssid) {
        sendMessage(iface, ASSOCIATION_REJECTION_EVENT, timedOut, status, bssid);
