...
public class WifiProChrDataBaseManager {
    ...
    public WifiProChrDataBaseManager(Context context) {
        ...
        try {
            ...
            logd("WifiProChrDataBaseManager(), can't open database!");
        }
    }
    ...
    private boolean checkIfRcdExist() {
        ...
        try {
            ...
            while (c.moveToNext()) {
                ...
                lastStatUploadTime = c.getString(c.getColumnIndex("mLastStatUploadTime"));
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("checkIfRcdExist read record succ, lastStatUploadTime:");
                stringBuilder.append(lastStatUploadTime);
            ...
            stringBuilder2.append("checkIfRcdExist error:");
    ...
    private boolean updateChrStatRcd(WifiProStatisticsRecord dbr) {
        ...
        try {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("update error:");
        ...
        StringBuilder stringBuilder2 = new StringBuilder();
        stringBuilder2.append("updateChrStatRcd update succ, rowChg=");
        stringBuilder2.append(rowChg);
