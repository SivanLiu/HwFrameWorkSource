...
public class HwWifiDataTrafficTracking {
    ...
    private boolean checkDataTrafficLine() {
        ...
        stringBuilder.append(rxBytes);
        stringBuilder.append(" mLowDataTrafficLine:");
        stringBuilder.append(this.mLowDataTrafficLine);
        stringBuilder.append(" mUpdateMillis:");
        stringBuilder.append(this.mUpdateMillis);
    ...
    private void handleUpdataDateTraffic() {
        ...
        if (this.mIsStart) {
            if (checkDataTrafficLine()) {
                String str = TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("LOW_DATA_TAFFIC mCount:");
