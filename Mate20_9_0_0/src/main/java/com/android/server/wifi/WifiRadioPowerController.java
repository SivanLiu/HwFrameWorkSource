...
public class WifiRadioPowerController {
    ...
    private class BootCompleteReceiver extends BroadcastReceiver {
        ...
        /* synthetic */ BootCompleteReceiver(WifiRadioPowerController x0, AnonymousClass1 x1) {
            this();
        }
    ...
    private class RadioPowerHandler extends Handler {
        ...
        private void checkCurrentState() {
            ...
            String str = WifiRadioPowerController.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("isWifiEnable = ");
            stringBuilder.append(isWifiEnable);
            stringBuilder.append(" mIsReceiverMode = ");
            stringBuilder.append(WifiRadioPowerController.this.mIsReceiverMode);
            stringBuilder.append(" mIsPhone1Offhook = ");
            stringBuilder.append(WifiRadioPowerController.this.mIsPhone1Offhook);
            stringBuilder.append(" mIsPhone2Offhook = ");
            stringBuilder.append(WifiRadioPowerController.this.mIsPhone2Offhook);
            stringBuilder.append(" isWifiApEnabled = ");
            stringBuilder.append(isWifiApEnabled);
        ...
        private void sendCommand(int level) {
            String wifiPower = new StringBuilder();
            wifiPower.append("TX_POWER ");
            wifiPower.append(level);
            wifiPower = wifiPower.toString();
            String str;
            StringBuilder stringBuilder;
            if (!WifiRadioPowerController.this.mIsWifiHotspotRedecePower) {
                str = WifiRadioPowerController.TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append("WifiRadioPowerController setWifiPowerCommand wpa mode: ");
                stringBuilder.append(wifiPower);
                Log.d(str, stringBuilder.toString());
                WifiRadioPowerController.this.mWifiNative.sendWifiPowerCommand(level);
            } else if (this.mPrevPower == level) {
                str = WifiRadioPowerController.TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append("WifiRadioPowerController setWifiPowerCommand mPrevPower == level: ");
                stringBuilder.append(wifiPower);
                Log.d(str, stringBuilder.toString());
            } else {
                try {
                    str = WifiRadioPowerController.TAG;
                    stringBuilder = new StringBuilder();
                    stringBuilder.append("WifiRadioPowerController setWifiPowerCommand netd mode: ");
                    stringBuilder.append(wifiPower);
                    Log.d(str, stringBuilder.toString());
    ...
    private class WifiRadioPowerReceiver extends BroadcastReceiver {
        ...
        /* synthetic */ WifiRadioPowerReceiver(WifiRadioPowerController x0, AnonymousClass1 x1) {
            this();
        }
        ...
        if (wifiPowerLevels.length == 4) {
            ...
            while (i < 4) {
                try {
                    ...
                    String str = TAG;
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("WifiPowerLevels P");
                    stringBuilder.append(i);
                    stringBuilder.append(" value:");
                    stringBuilder.append(mWifiPowerLevels[i - 1]);
                    Log.d(str, stringBuilder.toString());
                    i++;
            ...
            while (i < 6) {
                try {
                    ...
                    stringBuilder2.append("WifiSta&APPowerLevels P");
                    stringBuilder2.append(i);
                    stringBuilder2.append(" value:");
                    stringBuilder2.append(mWifiPowerLevels[i - 1]);
