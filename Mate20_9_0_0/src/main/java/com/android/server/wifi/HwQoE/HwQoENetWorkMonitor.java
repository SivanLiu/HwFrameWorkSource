...
public class HwQoENetWorkMonitor {
    ...
    public void startMonitor() {
        ...
        stringBuilder.append("startMonitor isStartMonitor = ");
        stringBuilder.append(this.isStartMonitor);
    ...
    public void stopMonitor() {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("stopMonitor isStartMonitor = ");
        stringBuilder.append(this.isStartMonitor);
        HwQoEUtils.logE(stringBuilder.toString());
        if (this.isStartMonitor) {
    ...
    public int getDnsFaileCount() {
        ...
        try {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("currentDnsFailCount  parseInt err:");
    ...
    private void initHandlerThread() {
        ...
        this.mLocalHandler = new Handler(handlerThread.getLooper()) {
            public void handleMessage(Message msg) {
                int i = msg.what;
                if (i != HwQoEUtils.QOE_MSG_MONITOR_GET_QUALITY_INFO) {
                    switch (i) {
                        case 151573:
                ...
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("QOE_MSG_GET_QUALITY_INFO mPeriodTime = ");
                stringBuilder.append(HwQoENetWorkMonitor.this.mPeriodTime);
                HwQoEUtils.logE(stringBuilder.toString());
    ...
    private void reportNetworkInfo() {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("reportNetworkInfo isOTADataUpdate = ");
        stringBuilder.append(this.isOTADataUpdate);
        stringBuilder.append(" isTCPDataUpdate = ");
        stringBuilder.append(this.isTCPDataUpdate);
        stringBuilder.append(" isUDPDataUpdate = ");
        stringBuilder.append(this.isUDPDataUpdate);
        HwQoEUtils.logE(stringBuilder.toString());
