...
public class HwQoEGameCHRImpl {
    ...
    public void updateTencentTmgpGameRttChanged(long rtt) {
        ...
        stringBuilder.append("Game-rtt:");
        stringBuilder.append(rtt);
        stringBuilder.append(" ms, mLastGameNetworkLevel:");
        stringBuilder.append(this.mLastGameNetworkLevel);
    ...
    public void updateArpRttChanged(int rtt) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Arp-rtt:");
        stringBuilder.append(rtt);
        stringBuilder.append(" ms, mLastArpRttLevel:");
        stringBuilder.append(this.mLastArpRttLevel);
        logD(stringBuilder.toString());
        if (this.mTencentTmgpGameType != 1) {
    ...
    public void updateTencentTmgpGameStateChanged(int state, int network) {
        ...
        int i2 = network;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("updateTencentTmgpGameStateChanged new state: ");
        stringBuilder.append(i);
        stringBuilder.append(", network:");
        stringBuilder.append(i2);
        logD(stringBuilder.toString());
        this.mTencentTmgpGameType = i;
    ...
    public void updateWifiFrequency(boolean is5G) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("updateWifiFrequency: mApType:");
    ...
    public void updateWifiTcpRtt(long tcpRttSegs, long tcpRtt, long duration) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("updateWifiTcpRtt Tcp-rtt: ");
        stringBuilder.append(j);
        stringBuilder.append(" ms, duration: ");
        stringBuilder.append(duration);
        stringBuilder.append("ms, tcpRttSegs:");
        stringBuilder.append(tcpRttSegs);
        stringBuilder.append(" Segs , mLastTcpRttLevel:");
        stringBuilder.append(this.mLastTcpRttLevel);
        logD(stringBuilder.toString());
        if (j < 50) {
            ...
            if (this.mLastTcpRttLevel != 100 || this.mTcpRttGeneralStartTime == 0) {
                long j2 = 0;
                if (this.mLastTcpRttLevel == 200 && this.mTcpRttPoorStartTime != j2) {
                    this.mTcpRttPoorDuration += System.currentTimeMillis() - this.mTcpRttPoorStartTime;
                    this.mTcpRttPoorStartTime = j2;
            ...
            if (this.mLastTcpRttLevel != 200 || this.mTcpRttPoorStartTime == j3) {
