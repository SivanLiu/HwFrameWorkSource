...
import com.huawei.intelligent.main.common.mapservice.IDistanceCallback.Stub;
...
public class HomeAddressDataManager {
    ...
    private Stub mstub = new Stub() {
        public void onResult(String currentLocationInfo, int flag) {
            ...
            stringBuilder.append("IDistanceCallback onResult flag ");
            ...
            stringBuilder2.append("IDistanceCallback distance =  ");
            stringBuilder2.append(currentLocationInfo.substring(dstIndex + 11, currentLocationInfo.length() - 1));
    ...
    public LocationAddress getLastHomeAddress() {
        String defaultValue = "Location Null";
        ...
        try {
            ...
            String homeLocation = result.getString(GET_ADDRESS_RESULT, defaultValue);
            String str;
            if (homeLocation == null || homeLocation.equals(defaultValue)) {
                ...
                if (latIndex == -1 || lngIndex == -1 || overseaIndex == -1) {
                    ...
                    String str2 = MessageUtil.TAG;
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("getLastHomeAddress isOversea = ");
                    stringBuilder.append(this.isOversea);
                    stringBuilder.append(", isInvalid =  ");
                    stringBuilder.append(this.isInvalid);
                    Log.d(str2, stringBuilder.toString());
                    return new LocationAddress(this.latitude, this.longitude, 0.0d, this.isOversea.equals("true"), this.isInvalid.equals("true"), Long.valueOf(System.currentTimeMillis()));
                }
