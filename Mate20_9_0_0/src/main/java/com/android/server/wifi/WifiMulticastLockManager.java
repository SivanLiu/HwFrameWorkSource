...
public class WifiMulticastLockManager {
    ...
    private class Multicaster implements DeathRecipient {
        ...
        public String toString() {
            ...
            stringBuilder.append("Multicaster{");
    ...
    protected void dump(PrintWriter pw) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("mMulticastEnabled ");
        stringBuilder.append(this.mMulticastEnabled);
        pw.println(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append("mMulticastDisabled ");
        stringBuilder.append(this.mMulticastDisabled);
        pw.println(stringBuilder.toString());
    ...
    public void acquireLock(IBinder binder, String tag) {
        ...
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("RemoteException in noteWifiMulticastEnabled: ");
    ...
    private void removeMulticasterLocked(int i, int uid) {
        ...
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("RemoteException in noteWifiMulticastDisabled: ");
            stringBuilder.append(e.getMessage());
            Slog.e(str, stringBuilder.toString());
        } catch (Throwable th) {
            Binder.restoreCallingIdentity(ident);
