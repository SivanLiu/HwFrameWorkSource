    ...
    class DefaultState extends State {
        ...
        public boolean processMessage(Message msg) {
            if (SupplicantHeartBeat.DBG) {
                String str = SupplicantHeartBeat.TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("enter DefaultState: msg = ");
    ...
    class HeartAckState extends State {
        ...
        public boolean processMessage(Message msg) {
            if (SupplicantHeartBeat.DBG) {
                String str = SupplicantHeartBeat.TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("enter HeartAckState: msg = ");
                stringBuilder.append(msg.toString());
                stringBuilder.append("\n");
                Log.d(str, stringBuilder.toString());
            }
    ...
    class WaitingHeartAckState extends State {
        ...
        public boolean processMessage(Message msg) {
            if (SupplicantHeartBeat.DBG) {
                String str = SupplicantHeartBeat.TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("enter WaitingHeartAckState: msg = ");
                stringBuilder.append(msg.toString());
                stringBuilder.append("\n");
                Log.d(str, stringBuilder.toString());
            }
