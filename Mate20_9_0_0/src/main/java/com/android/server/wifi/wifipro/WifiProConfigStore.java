            ...
            switch (attribute) {
                case 1:
                    if (wificonfig.internetAccessType != value) {
                        ...
                        stringBuilder2.append(", internetAccessType  updateWifiConfig Succeed");
                ...
                case 2:
                    if (wificonfig.networkQosLevel != value) {
                        ...
                        stringBuilder.append(", networkQosLevel  updateWifiConfig Succeed");
                ...
                case 3:
                    if (wificonfig.networkQosScore != value) {
                        ...
                        stringBuilder = new StringBuilder();
                        stringBuilder.append(ssid);
                        stringBuilder.append("networkQosScore  updateWifiConfig Succeed");
                        Log.d(str, stringBuilder.toString());
                        break;
                    }
                    break;
    ...
    public static void updateScanDetailByWifiPro(ScanResult sc) {
        ...
        if (!WiFiProEvaluateController.isEvaluateRecordsEmpty()) {
            ...
            if (wiFiProScoreInfo != null) {
                if (wiFiProScoreInfo.internetAccessType != 1 || (wiFiProScoreInfo.failCounter >= 2 && HwFrameworkFactory.getHwInnerWifiManager().calculateSignalLevelHW(sc.frequency, sc.level) >= 2)) {
