    ...
    private class WifiBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("android.net.wifi.WIFI_STATE_CHANGED".equals(action)) {
                wifistatue = intent.getIntExtra("wifi_state", 4);
                if (wifistatue == 1) {
                ...
                wifistatue = intent.getIntExtra("wifi_network_property", WifiproUtils.NET_INET_QOS_LEVEL_UNKNOWN);
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("WifiBroadcastReceiver ACTION_NETWOR_PROPERTY_NOTIFICATION property = ");
                stringBuilder.append(wifistatue);
