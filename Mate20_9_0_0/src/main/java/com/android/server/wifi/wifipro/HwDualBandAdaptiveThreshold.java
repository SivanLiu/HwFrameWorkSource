...
public class HwDualBandAdaptiveThreshold {
    ...
    public void updateRSSIThreshold(String bssid2G, String bssid5G, int newRssi2G, int newRssi5G, int scanRssi2G, int targetRssi5G) {
        ...
        int i3 = scanRssi2G;
        int i4 = targetRssi5G;
        int x = BSSID_RSSI_RANGE_LOW_DBM;
        ...
        if (i2 < i4) {
            ...
            stringBuilder.append("updateRSSIThreshold handover failed, newRssi2G = ");
            stringBuilder.append(i);
            stringBuilder.append(" newRssi5G = ");
            stringBuilder.append(i2);
            stringBuilder.append(" targetRssi5G = ");
            stringBuilder.append(i4);
            stringBuilder.append("old scanRssi2G = ");
            stringBuilder.append(i3);
            stringBuilder.append("new scanRssi2G = ");
            stringBuilder.append(newScanRssi2G);
            Log.e(str, stringBuilder.toString());
        } else if (i2 > i4 + 10 && i < i3 + 10) {
            newScanRssi2G -= 5;
            str = HwDualBandMessageUtil.TAG;
            stringBuilder = new StringBuilder();
            stringBuilder.append("updateRSSIThreshold handover success, newRssi2G = ");
            stringBuilder.append(i);
            stringBuilder.append(" newRssi5G = ");
            stringBuilder.append(i2);
            stringBuilder.append(" targetRssi5G = ");
