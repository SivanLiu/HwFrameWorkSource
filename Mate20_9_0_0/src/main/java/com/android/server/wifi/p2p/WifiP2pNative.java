...
public class WifiP2pNative {
    ...
    private class InterfaceAvailableListenerInternal implements InterfaceAvailableForRequestListener {
        private final InterfaceAvailableForRequestListener mExternalListener;

        InterfaceAvailableListenerInternal(InterfaceAvailableForRequestListener externalListener) {
            this.mExternalListener = externalListener;
        }

        public void onAvailabilityChanged(boolean isAvailable) {
            String str = WifiP2pNative.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("P2P InterfaceAvailableListener ");
    ...
    private class InterfaceDestroyedListenerInternal implements InterfaceDestroyedListener {
        private final InterfaceDestroyedListener mExternalListener;
        private boolean mValid = true;

        InterfaceDestroyedListenerInternal(InterfaceDestroyedListener externalListener) {
            this.mExternalListener = externalListener;
        }
        ...
        public void onDestroyed(String ifaceName) {
            String str = WifiP2pNative.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("P2P InterfaceDestroyedListener ");
    ...
    public void registerInterfaceAvailableListener(InterfaceAvailableForRequestListener listener, Handler handler) {
        this.mInterfaceAvailableListener = new InterfaceAvailableListenerInternal(listener);
        this.mHalDeviceManager.registerStatusListener(new -$$Lambda$WifiP2pNative$OugPqsliuKv73AxYwflB8JKX3Gg(this, handler), handler);
    ...
    public String setupInterface(InterfaceDestroyedListener destroyedListener, Handler handler) {
