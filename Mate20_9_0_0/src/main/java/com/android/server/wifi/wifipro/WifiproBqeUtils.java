...
public class WifiproBqeUtils {
    ...
    public class WifiproBqeClientReceiver extends BroadcastReceiver {
        public void onReceive(Context context, Intent intent) {
            ...
            String str = WifiproBqeUtils.BQE_LOG_TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("receive broadcast action is ");
            ...
            if (WifiproBqeUtils.BQE_REQUEST_FINISHED.equals(action)) {
                ...
                if (bqeResult != 1) {
                    ...
                    if (WifiproBqeUtils.this.mBestSpeed == 0) {
                        ...
                        long speed2 = 0;
                        if (duration > 0) {
                            speed2 = ((currentRxByte - WifiproBqeUtils.this.mLastSecondLoadRxByte) * 1000) / duration;
                        }
                        speed = speed2;
                    ...
                    if (serviceBestSpeed > WifiproBqeUtils.this.mBestSpeed) {
                        ...
                        String str2 = WifiproBqeUtils.BQE_LOG_TAG;
                        StringBuilder stringBuilder2 = new StringBuilder();
                        stringBuilder2.append("get better service speed ");
                        stringBuilder2.append(WifiproBqeUtils.this.mBestSpeed);
                ...
                speed = currentTime - WifiproBqeUtils.this.mBqeStartedTime;
                if (speed < WifiHandover.HANDOVER_WAIT_SCAN_TIME_OUT) {
                ...
                stringBuilder.append("ACTION_RESP_WEBVIEW_CHECK_FROM_SERVICE, need resp = ");
                stringBuilder.append(WifiproBqeUtils.this.mNeedRecheckByWebView);
                Log.d("WifiproBqeUtils", stringBuilder.toString());
    ...
    public void startBqeService() {
        String str = BQE_LOG_TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("startBqeService, receiverRegistered = ");
        stringBuilder.append(this.mIsReceiverRegistered);
        Log.d(str, stringBuilder.toString());
    ...
    private void computeQos(int tcp_rtt, int tcp_rtt_pkts, int tcp_rtt_when) {
        ...
        String str = BQE_LOG_TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("bqeLevel ");
        stringBuilder.append(bqeLevel);
        stringBuilder.append(" rtt=");
        stringBuilder.append(tcp_rtt);
        stringBuilder.append(",rtt_pkts=");
        stringBuilder.append(tcp_rtt_pkts);
        stringBuilder.append(" speed=");
        stringBuilder.append(this.mBestSpeed);
        Log.d(str, stringBuilder.toString());
    ...
    private void recheckNetworkTypeByWebView(boolean oversea) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("recheckNetworkTypeByWebView:: oversea = ");
