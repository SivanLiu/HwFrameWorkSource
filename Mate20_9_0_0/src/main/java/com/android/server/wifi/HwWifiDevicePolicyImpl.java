...
public class HwWifiDevicePolicyImpl implements HwWifiDevicePolicy {
    ...
    private boolean getSecuritLevelPolicy() {
        ...
        stringBuilder.append("securitylevel ");
        stringBuilder.append(this.mSecurityLevel);
    ...
    private void initWhiteListPolicy() {
        ...
        if (bundle != null) {
            try {
                ...
                String str = TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("get mGlobalSsidWhitelist exception: ");
    ...
    private boolean isSSIDInWhiteList(String ssid, boolean isShowToast) {
        ...
        if (this.mGlobalSsidWhitelist != null && this.mGlobalSsidWhitelist.contains(ssid)) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("isSSIDInWhiteList(): ");
            stringBuilder.append(ssid);
            stringBuilder.append(" is in MDM WiFi WhiteList");
    ...
    private void initEnterpriseConfigPolicy() {
        ...
        if (bundle != null) {
            try {
                ...
                String str = TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("get mMDMsEnterpriseConfigList exception: ");
                stringBuilder.append(e.getMessage());
                HwLog.e(str, stringBuilder.toString());
            }
        }
    ...
    private void initSecurityLevelPolicy() {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("initSecurityLevelPolicy(): get mSecurityLevel = ");
        stringBuilder.append(this.mSecurityLevel);
        HwLog.d(str, stringBuilder.toString());
    ...
    private void showToast(int toastType) {
        ...
        switch (toastType) {
            ...
            default:
                String str = TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("showToast(): unknow toastType ");
    ...
    private boolean isWifiSecure(WifiConfiguration config, boolean isShowToast) {
        ...
        stringBuilder.append(" service level is ");
        stringBuilder.append(this.mSecurityLevel);
        HwLog.i(str, stringBuilder.toString());
    ...
    private boolean isSSIDInMDMEnterpriseConfigList(String ssid) {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("isSSIDInMDMEnterpriseConfigList(): ");
        stringBuilder.append(ssid);
        stringBuilder.append(" is in MDM enterprise list");
        HwLog.d(str, stringBuilder.toString());
        return true;
    }
    ...
    public boolean isWifiRestricted(WifiConfiguration config, boolean isShowToast) {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(" isWifiRestricted, mGlobalSsidWhitelist =");
        stringBuilder.append(this.mGlobalSsidWhitelist);
        HwLog.d(str, stringBuilder.toString());
    ...
    private void procConnectedWifi() {
        ...
        if (isWifiRestricted(currentNetwork, true)) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("RestrictedBySecurityPolicy, disconnect wifi -> ");
    ...
    private void procBroadCasts(Intent intent) {
        ...
        switch (intent.getIntExtra(KEY_WIFI_POLICY_CATEGORY, 0)) {
            case 0:
                level = intent.getIntExtra(KEY_SECURE_LEVEL, 1);
                str = TAG;
                stringBuilder = new StringBuilder();
                stringBuilder.append("old level is ");
                stringBuilder.append(this.mSecurityLevel);
                stringBuilder.append(" new level is ");
                stringBuilder.append(level);
                HwLog.i(str, stringBuilder.toString());
                this.mSecurityLevel = level;
                break;
            case 1:
                level = intent.getIntExtra(KEY_BLACK_LIST_CHANGE_MODE, 0);
                str = intent.getStringExtra(KEY_PACKAGE_NAME);
                ...
                stringBuilder2.append(", className is ");
                stringBuilder2.append(className);
                HwLog.i(str2, stringBuilder2.toString());
                procBlacklist(level, str, className, listFromIntent);
                printBlacklist();
                break;
            case 2:
                if (bundle == null) {
                ...
                if (changeMode == 0) {
                    mode = bundle.getBoolean(VALUE_DISABLE);
                }
                this.mRestrictNetwork = mode;
                break;
            case 3:
                if (mMDMsEnterpriseConfigList == null) {
                    mMDMsEnterpriseConfigList = new ArrayList();
                ...
                if (2 != changeMode) {
                    if (bundle != null) {
                        changeList = bundle.getStringArrayList(VALUE_STRING_LIST);
                        if (changeList != null) {
                            if (changeMode != 0) {
                                if (1 != changeMode) {
                                    str = TAG;
                                    stringBuilder = new StringBuilder();
                                    stringBuilder.append("procBroadCasts(): OP_ENTERPRISE_CONFIG_LIST, unknown changeMode=");
                                    stringBuilder.append(changeMode);
                                    HwLog.e(str, stringBuilder.toString());
                                    break;
                                }
            ...
            case 4:
                ...
                this.mAutoConnectDisabled = mode;
                break;
            case 5:
                if (bundle != null) {
                    if (changeMode == 0) {
                    ...
                    this.mOpenHotspotDisabled = mode;
            ...
            case 6:
                ...
                if (2 != changeMode) {
                    if (bundle != null) {
                        changeList = bundle.getStringArrayList(KEY_VALUE);
                        if (changeList != null) {
                            if (changeMode != 0) {
                                if (1 != changeMode) {
                                    str = TAG;
                                    stringBuilder = new StringBuilder();
                                    stringBuilder.append("procBroadCasts(): OP_WHITELISTE, unknown changeMode=");
                                    stringBuilder.append(changeMode);
                                    HwLog.e(str, stringBuilder.toString());
                                    break;
                                }
                                this.mGlobalSsidWhitelist.removeAll(changeList);
                                break;
                            }
                            this.mGlobalSsidWhitelist.addAll(changeList);
                            break;
                        }
            ...
            for (Entry<ComponentName, ArrayList<String>> entry : mGlobalSsidBlacklist.entrySet()) {
                ...
                if (list != null) {
                    ...
                    while (it.hasNext()) {
                        ...
                        HwLog.d(str3, stringBuilder2.toString());
                    }
                }
            }
        }
