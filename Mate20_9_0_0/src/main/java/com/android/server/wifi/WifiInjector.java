...
import com.android.server.wifi.ScanOnlyModeManager.Listener;
...
public class WifiInjector {
    ...
    public WifiInjector(Context context) {
        ...
        if (context2 == null) {
            ...
            this.mWifiConfigStoreLegacy = new WifiConfigStoreLegacy(this.mWifiNetworkHistory, this.mWifiNative, new IpConfigStoreWrapper(), new LegacyPasspointConfigParser());
            ...
            this.mWifiStateMachinePrime = new WifiStateMachinePrime(this, this.mContext, wifiStateMachineLooper, this.mWifiNative, new DefaultModeManager(this.mContext, wifiStateMachineLooper), this.mBatteryStats);
            ...
            this.mWifiLastResortWatchdog = new WifiLastResortWatchdog(this.mSelfRecovery, this.mClock, this.mWifiMetrics, this.mWifiStateMachine, wifiStateMachineLooper2);
    ...
    public SoftApManager makeSoftApManager(SoftApCallback callback, SoftApModeConfiguration config) {
    ...
    public ScanOnlyModeManager makeScanOnlyModeManager(Listener listener) {
