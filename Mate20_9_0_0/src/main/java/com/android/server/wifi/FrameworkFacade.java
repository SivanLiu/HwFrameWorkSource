...
public class FrameworkFacade {
    ...
    public int getSecureIntegerSetting(Context context, String name, int def) {
        return Secure.getInt(context.getContentResolver(), name, def);
    }
    ...
    public IpClient makeIpClient(Context context, String iface, Callback callback) {
    ...
    public Builder makeNotificationBuilder(Context context, String channelId) {
