...
public class HwCHRWifiPacketCnt {
    ...
    public String toString() {
        ...
        stringBuilder.append("HwCHRWifiPacketCnt [mTXGood=");
        stringBuilder.append(this.mTXGood);
        stringBuilder.append(", mTXbad=");
        stringBuilder.append(this.mTXbad);
        stringBuilder.append(", mRXGood=");
        stringBuilder.append(this.mRXGood);
