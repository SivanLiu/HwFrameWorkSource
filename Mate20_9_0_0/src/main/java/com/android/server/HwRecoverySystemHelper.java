...
public class HwRecoverySystemHelper {
    ...
    private static void rebootWipeUserDataFactoryLowlevel(Context context, boolean wipeEuicc) throws IOException {
        ...
        stringBuilder.append("--wipe_data_factory_lowlevel\n--locale=");
        stringBuilder.append(Locale.getDefault().toString());
        RecoverySystem.hwBootCommand(context, stringBuilder.toString());
    }
    ...
    public static void rebootWipeUserDataFactory(Context context) throws IOException {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("--wipe_data_factory_reset\n--locale=");
        stringBuilder.append(Locale.getDefault().toString());
        RecoverySystem.hwBootCommand(context, stringBuilder.toString());
    }
}
