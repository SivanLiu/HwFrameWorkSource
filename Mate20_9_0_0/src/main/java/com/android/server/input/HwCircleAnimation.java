...
public class HwCircleAnimation {
    ...
    public HwCircleAnimation(AnimationUpdateListener listener, Resources resources) {
        if (listener == null || resources == null) {
            ...
            stringBuilder.append("HwCircleAnimation update listener is null, animation need this to invalidate view, or resource is null: ");
    ...
    public void setViewSize(int width, int height) {
        ...
        if (this.mBgShader == null) {
            this.mBgShader = new RadialGradient(GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO, GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO, (float) BG_HEIGHT, BG_COLORS, BG_COLOR_POS, TileMode.CLAMP);
        }
    }
    ...
    public void startRingOutAnim(int cx, int cy, int type) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("startRingOutAnim ");
        stringBuilder.append(cx);
        stringBuilder.append(", ");
        stringBuilder.append(cy);
        stringBuilder.append("  mIsCircleAnimating = ");
        stringBuilder.append(this.mIsCircleAnimating);
    ...
    public void endRingOutAnim(boolean isLunched) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("endRingOutAnim = ");
        stringBuilder.append(isLunched);
        stringBuilder.append(", mIsCircleAnimating = ");
        stringBuilder.append(this.mIsCircleAnimating);
        Log.d(str, stringBuilder.toString());
        if (this.mIsCircleAnimating) {
            ...
            if (!(this.mAnimRing == null || isLunched)) {
                ...
                this.mPvhRing2.setFloatValues(new float[]{this.mRingAlpha, GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO});
                this.mPvhRing3.setFloatValues(new float[]{this.mSmallAlpha, GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO});
                this.mPvhRing4.setIntValues(new int[]{this.mSmallY, SMALL_Y_0});
                this.mPvhRing5.setFloatValues(new float[]{this.mBgAlpha, GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO});
                this.mPvhRing6.setIntValues(new int[]{this.mInnerRadius, 0});
                this.mPvhRing7.setFloatValues(new float[]{this.mInnerAlpha, GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO});
                this.mAnimRing.setDuration(200);
                this.mAnimRing.start();
            }
        }
