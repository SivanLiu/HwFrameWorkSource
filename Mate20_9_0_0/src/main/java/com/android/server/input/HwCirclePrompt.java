...
public class HwCirclePrompt {
    ...
    private static final float[] BG_COLOR_POS = new float[]{GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO, 0.3f, 1.0f};
    ...
    private void drawText(Canvas canvas, TextPaint paint) {
        ...
        if (str != null) {
            String str2 = str;
            res = 33685838;
            StaticLayout staticlayout = new StaticLayout(str, textPaint, this.mWidth - this.fontRightPadding, Alignment.ALIGN_NORMAL, 1.0f, GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO, 0);
            canvas2.translate((float) (this.mWidth / 2), ((float) (this.mHeight - bitmapheight2)) - (((float) getTextLines(textPaint, str2, Fontheight, this.mWidth - (this.fontRightPadding * 2))) * Fontheight));
    ...
    private int getTextLines(TextPaint paint, String content, float fontHeigh, int lineWidth) {
        ...
        if (DEBUG) {
            ...
            stringBuilder.append("getTextWidths count = ");
            stringBuilder.append(count);
            stringBuilder.append("fontHeigh = ");
            stringBuilder.append(fontHeigh);
        ...
        for (i = 0; i < count; i++) {
            ...
            if (DEBUG) {
                ...
                stringBuilder2.append("getTextWidths w = ");
                stringBuilder2.append(w);
                stringBuilder2.append(" widths   = ");
                stringBuilder2.append(widths[0]);
        ...
        if (DEBUG) {
            ...
            stringBuilder3.append("getTextWidths textLines = ");
    ...
    private void drawTextH(Canvas canvas, TextPaint paint) {
        ...
        String str2 = str;
        int res = 33685838;
        StaticLayout staticlayout = new StaticLayout(str, textPaint, this.mHeight - this.fontRightPadding, Alignment.ALIGN_NORMAL, 1.0f, GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO, 0);
        int lines = getTextLines(textPaint, str2, Fontheight, this.mHeight - (this.fontRightPadding * 2));
        canvas.save();
    ...
    private void drawImage(Canvas canvas, Paint paint) {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("drawImage bitmapwidth = ");
        stringBuilder.append(bitmapwidth);
        stringBuilder.append("  bitmapheight = ");
        stringBuilder.append(bitmapheight);
        Log.e(str, stringBuilder.toString());
        if (this.mIsPortrait) {
            Rect src = new Rect();
    ...
    public void setViewSize(int width, int height) {
        ...
        if (this.mIsPortrait) {
            this.mBgShader = new LinearGradient(GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO, (float) height, GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO, (float) (height - BG_HEIGHT), BG_COLORS, BG_COLOR_POS, TileMode.CLAMP);
