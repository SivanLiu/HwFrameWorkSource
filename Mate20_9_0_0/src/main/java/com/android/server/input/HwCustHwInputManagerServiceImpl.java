...
public class HwCustHwInputManagerServiceImpl extends HwCustHwInputManagerService {
    ...
    public boolean isFingerprintNavigationEnable() {
        ...
        if (Secure.getInt(this.mResolver, HwCustFingerprintNavigationImpl.FINGERPRINT_LAUNCHER_SLIDE, 0) == 0 && Secure.getInt(this.mResolver, HwCustFingerprintNavigationImpl.FINGERPRINT_GALLERY_SLIDE, 0) == 0) {
            return false;
        }
        return true;
    }
