...
public class QueryHistAppQoeService {
    ...
    public void saveRecordByApp(int appName) {
        ...
        stringBuilder.append("saveRecordByApp:");
        stringBuilder.append(this.currQoeInfo.toString());
    ...
    public HistAppQoeChrInfo queryRecordByApp(int AppType, int AppId, int ScenceId) {
        ...
        HistAppQoeChrInfo result = (HistAppQoeChrInfo) this.savedQoeRecords.get(Integer.valueOf(appName));
        if (result != null) {
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("queryRecordByApp:");
