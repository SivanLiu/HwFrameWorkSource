...
public class HwHistreamCHRStatisticsInfo {
    ...
    public void printCHRStatisticsInfo() {
        ...
        stringBuilder.append("printCHRStatisticsInfo mNum = ");
        stringBuilder.append(this.mNum);
        stringBuilder.append(" mScenario = ");
        stringBuilder.append(this.mScenario);
        stringBuilder.append(" mStartInWiFiCnt = ");
        stringBuilder.append(this.mStartInWiFiCnt);
        stringBuilder.append(" mStartInCellularCnt = ");
        stringBuilder.append(this.mStartInCellularCnt);
        stringBuilder.append(" mCallInCellularDur = ");
        stringBuilder.append(this.mCallInCellularDur);
        stringBuilder.append(" mCallInWiFiDur = ");
        stringBuilder.append(this.mCallInWiFiDur);
        stringBuilder.append(" mCellLv1Cnt = ");
        stringBuilder.append(this.mCellLv1Cnt);
        stringBuilder.append(" mCellLv2Cnt = ");
        stringBuilder.append(this.mCellLv2Cnt);
        stringBuilder.append(" mCellLv3Cnt = ");
        stringBuilder.append(this.mCellLv3Cnt);
        stringBuilder.append(" mWiFiLv1Cnt = ");
        stringBuilder.append(this.mWiFiLv1Cnt);
        stringBuilder.append(" mWiFiLv2Cnt = ");
        stringBuilder.append(this.mWiFiLv2Cnt);
        stringBuilder.append(" mWiFiLv3Cnt = ");
        stringBuilder.append(this.mWiFiLv3Cnt);
        stringBuilder.append(" mTrfficCell = ");
        stringBuilder.append(this.mTrfficCell);
        stringBuilder.append(" mVipSwitchCnt = ");
        stringBuilder.append(this.mVipSwitchCnt);
        stringBuilder.append(" mStallSwitchCnt = ");
        stringBuilder.append(this.mStallSwitchCnt);
        stringBuilder.append(" mStallSwitch0Cnt = ");
        stringBuilder.append(this.mStallSwitch0Cnt);
        stringBuilder.append(" mStallSwitch1Cnt = ");
        stringBuilder.append(this.mStallSwitch1Cnt);
        stringBuilder.append(" mStallSwitchAbove1Cnt = ");
        stringBuilder.append(this.mStallSwitchAbove1Cnt);
        stringBuilder.append(" mSwitch2CellCnt = ");
        stringBuilder.append(this.mSwitch2CellCnt);
        stringBuilder.append(" mSwitch2WifiCnt = ");
        stringBuilder.append(this.mSwitch2WifiCnt);
        stringBuilder.append(" mMplinkDur = ");
        stringBuilder.append(this.mMplinkDur);
        stringBuilder.append(" mMplinkEnCnt = ");
        stringBuilder.append(this.mMplinkEnCnt);
        stringBuilder.append(" mMplinkDisStallCnt = ");
        stringBuilder.append(this.mMplinkDisStallCnt);
        stringBuilder.append(" mMplinkDisWifiGoodCnt = ");
        stringBuilder.append(this.mMplinkDisWifiGoodCnt);
        stringBuilder.append(" mMplinkEnFailCnt = ");
        stringBuilder.append(this.mMplinkEnFailCnt);
        stringBuilder.append(" mMplinkDisFailCnt = ");
        stringBuilder.append(this.mMplinkDisFailCnt);
        stringBuilder.append(" mMplinkEnTraf = ");
        stringBuilder.append(this.mMplinkEnTraf);
        stringBuilder.append(" mMplinkEnFailEnvironCnt = ");
        stringBuilder.append(this.mMplinkEnFailEnvironCnt);
        stringBuilder.append(" mMplinkEnFailCoexistCnt = ");
        stringBuilder.append(this.mMplinkEnFailCoexistCnt);
        stringBuilder.append(" mMplinkEnFailPingPongCnt = ");
        stringBuilder.append(this.mMplinkEnFailPingPongCnt);
        stringBuilder.append(" mMplinkEnFailHistoryQoeCnt = ");
        stringBuilder.append(this.mMplinkEnFailHistoryQoeCnt);
        stringBuilder.append(" mMplinkEnFailChQoeCnt = ");
        stringBuilder.append(this.mMplinkEnFailChQoeCnt);
        stringBuilder.append(" mHicureEnCnt = ");
        stringBuilder.append(this.mHicureEnCnt);
        stringBuilder.append(" mHicureSucCnt = ");
        stringBuilder.append(this.mHicureSucCnt);
