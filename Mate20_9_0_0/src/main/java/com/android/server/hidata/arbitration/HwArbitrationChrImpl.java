...
public class HwArbitrationChrImpl {
    ...
    static class HiCureEvent {
        ...
        void setHiCureResult(int result, int diagnoseResult, int cureMethod) {
        ...
        void setHiDataResult(int isStall) {
        ...
        public String toString() {
            ...
            stringBuilder.append(this.mBlockType);
            stringBuilder.append(", currentNetwork = ");
            stringBuilder.append(this.mCurNetwork);
            stringBuilder.append(", dataSwitch = ");
            stringBuilder.append(this.mDataSwitch);
            stringBuilder.append(", dataRoamingSwitch = ");
            stringBuilder.append(this.mDataRoamingSwitch);
            stringBuilder.append(", DataLink = ");
            stringBuilder.append(this.mDataLink);
            stringBuilder.append(", wifiSwtich = ");
            stringBuilder.append(this.mWifiSwitch);
            stringBuilder.append(", wifiLink = ");
            stringBuilder.append(this.mWifiLink);
            stringBuilder.append(", cureSource = ");
            stringBuilder.append(this.mCureSrc);
            stringBuilder.append(", diagnoseResult = ");
            stringBuilder.append(this.mDiagnoseResult);
            stringBuilder.append(", cureMethod = ");
            stringBuilder.append(this.mCureMethod);
            stringBuilder.append(", hiCureResult = ");
            stringBuilder.append(this.mHiCureResult);
            stringBuilder.append(", hiDataResult = ");
            stringBuilder.append(this.mHiDataResult);
    ...
    public void updateHiCureResultChr(int reason, int diagnoseResult, int method) {
        ...
        if (this.mHiCureEventMap == null || this.mHiCureEventMap.get(Integer.valueOf(this.mRequestHiCureCnt)) == null) {
        ...
        } else if (-1 != ((HiCureEvent) this.mHiCureEventMap.get(Integer.valueOf(this.mRequestHiCureCnt))).getHiCureResult()) {
            ...
            if (1 == reason) {
                ...
                HiCureEvent hiCureEvent = (HiCureEvent) this.mHiCureEventMap.get(Integer.valueOf(this.mRequestHiCureCnt));
                if (hiCureEvent != null) {
    ...
    public void updateIsStallAfterCure(int hidataRst) {
        ...
        if (this.mHiCureEventMap == null || this.mHiCureEventMap.get(Integer.valueOf(this.mRequestHiCureCnt)) == null) {
            HwArbitrationCommonUtils.logD(TAG, "HiCureEvent not exist");
        } else if (-1 != ((HiCureEvent) this.mHiCureEventMap.get(Integer.valueOf(this.mRequestHiCureCnt))).getHiDataResult()) {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("HiCure EXCEPTION CHR ");
            stringBuilder.append(hiCureEvent.toString());
    ...
    public void uploadDFTEvent(int eventId, Bundle bundle) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("uploadHiCureCHREvent,eventId =");
    ...
    private void uploadHiCureStatisticsInfo() {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("CureCnt:");
        stringBuilder.append(this.mHiCureCnt);
        stringBuilder.append(", FailCnt: ");
        stringBuilder.append(this.mHiCureFailedCnt);
        stringBuilder.append(", SuccCnt: ");
        stringBuilder.append(this.mHiCureSuccessCnt);
        stringBuilder.append(", noCureCnt: ");
        stringBuilder.append(this.mHiCureNoNeedCnt);
        HwArbitrationCommonUtils.logD(str, stringBuilder.toString());
    ...
    public void updateMplinkActionChr(HwAPPStateInfo appInfo, int mplinkEvent, int failReason) {
        ...
        if (-1 != failReason) {
            ...
            stringBuilder.append("mplinkEventCnt:");
            stringBuilder.append(this.mplinkCnt);
            HwArbitrationCommonUtils.logD(str, stringBuilder.toString());
