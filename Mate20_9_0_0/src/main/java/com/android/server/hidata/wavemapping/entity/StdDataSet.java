...
public class StdDataSet {
    private List<BatchFp> batchFps = new ArrayList();
    private int filter2MobileApCnt = 0;
    private List<Integer> macIndexLst;
    private List<String> macLst;
    private Map<String, TMapList<Integer, StdRecord>> macRecords = new HashMap();
    ...
    public void setMacIndexLst(List<Integer> macIndexLst) {
        this.macIndexLst = macIndexLst;
    }
    ...
    public void setMacRecords(Map<String, TMapList<Integer, StdRecord>> macRecords) {
        this.macRecords = macRecords;
    }
    ...
    public void setMacLst(List<String> macLst) {
        this.macLst = macLst;
    }
    ...
    public void setFilter2MobileApCnt(int filter2MobileApCnt) {
        this.filter2MobileApCnt = filter2MobileApCnt;
    }
