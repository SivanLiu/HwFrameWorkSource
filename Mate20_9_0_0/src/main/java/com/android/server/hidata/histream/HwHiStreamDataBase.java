...
public class HwHiStreamDataBase extends SQLiteOpenHelper {
    ...
    public static void createTrafficTable(SQLiteDatabase db) {
        ...
        try {
            ...
            stringBuilder.append("createTrafficTable error:");
    ...
    public static void createApInfoTable(SQLiteDatabase db) {
        ...
        try {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("createApInfoTable error:");
            stringBuilder.append(e);
            HwHiStreamUtils.logE(stringBuilder.toString());
        }
    }
    ...
    public static void createAppStatisticsTable(SQLiteDatabase db) {
        HwHiStreamUtils.logE("createApInfoTable ENTER");
        StringBuffer sBuffer = new StringBuffer();
        ...
        try {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("createAppStatisticsTable error:");
            stringBuilder.append(e);
            HwHiStreamUtils.logE(stringBuilder.toString());
        }
    }
