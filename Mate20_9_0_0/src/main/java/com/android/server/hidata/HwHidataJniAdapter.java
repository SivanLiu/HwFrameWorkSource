...
public class HwHidataJniAdapter {
    ...
    static {
        try {
            ...
            stringBuilder.append("LoadLibrary is error ");
    ...
    public static void handleReportStallInfo(int stallTime, int appScene, int algo) {
        ...
        mHwHidataJniAdapter.mHiStreamJniCallback.onStallInfoReportCallback(stallTime, appScene, algo);
        logD("detect stall");
    }
