...
public final class TwilightState {
    ...
    public String toString() {
        ...
        stringBuilder.append("TwilightState { sunrise=");
        stringBuilder.append(DateFormat.format("MM-dd HH:mm", this.mSunriseTimeMillis));
        stringBuilder.append(" sunset=");
        stringBuilder.append(DateFormat.format("MM-dd HH:mm", this.mSunsetTimeMillis));
