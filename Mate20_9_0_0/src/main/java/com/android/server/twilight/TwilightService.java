...
public final class TwilightService extends SystemService implements OnAlarmListener, Callback, LocationListener {
        ...
        if (this.mTimeChangedReceiver == null) {
            this.mTimeChangedReceiver = new BroadcastReceiver() {
                public void onReceive(Context context, Intent intent) {
                    String str = TwilightService.TAG;
        ...
        synchronized (this.mListeners) {
            if (!Objects.equals(this.mLastTwilightState, state)) {
                ...
                for (int i = this.mListeners.size() - 1; i >= 0; i--) {
                    final TwilightListener listener = (TwilightListener) this.mListeners.keyAt(i);
    ...
    public void onLocationChanged(Location location) {
        ...
        if (location.getLongitude() != 0.0d || location.getLatitude() != 0.0d) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("onLocationChanged: provider=");
