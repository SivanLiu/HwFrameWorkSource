    ...
    private void CreateDrmErrorListener() {
        ...
        OnErrorListener errorListener = new OnErrorListener() {
            public void onError(DrmManagerClient client, DrmErrorEvent event) {
                ...
                String str = HWDrmDialogsService.TAG;
                ...
                if (2002 == event.getType()) {
                    ...
                    if (errStr.startsWith("showdialog#")) {
                        ...
                        str = HWDrmDialogsService.TAG;
                        stringBuilder = new StringBuilder();
                        stringBuilder.append("rightIssuer error : rightIssuer = ");
                        stringBuilder.append(HWDrmDialogsService.this.mRightsIssuer);
                        Slog.i(str, stringBuilder.toString());
                        HWDrmDialogsService.this.showDlg(1);
                    }
                } else if (HwArbitrationDEFS.MSG_MPLINK_BIND_CHECK_OK_NOTIFY == event.getType() && errStr.startsWith("showdialog#")) {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("HWDrmDialogsService  errorListener = ");
        stringBuilder.append(errorListener);
        Slog.i(str, stringBuilder.toString());
    }
