...
public class LocationManagerServiceUtils extends EasyInvokeUtils {
    ...
    MethodObject<Boolean> isAllowedByCurrentUserSettingsLocked;
    ...
    @InvokeMethod(methodObject = "isAllowedByCurrentUserSettingsLocked")
    public Boolean isAllowedByCurrentUserSettingsLocked(LocationManagerService service, String provider) {
        return (Boolean) invokeMethod(this.isAllowedByCurrentUserSettingsLocked, service, new Object[]{provider});
    }
