...
public class EventLogTags {
    ...
    public static void writeBatterySaverMode(int prevofforon, int nowofforon, int interactive, String features, int reason) {
        EventLog.writeEvent(BATTERY_SAVER_MODE, new Object[]{Integer.valueOf(prevofforon), Integer.valueOf(nowofforon), Integer.valueOf(interactive), features, Integer.valueOf(reason)});
    }
    ...
    public static void writeNotificationClicked(String key, int lifespan, int freshness, int exposure, int rank, int count) {
        EventLog.writeEvent(NOTIFICATION_CLICKED, new Object[]{key, Integer.valueOf(lifespan), Integer.valueOf(freshness), Integer.valueOf(exposure), Integer.valueOf(rank), Integer.valueOf(count)});
    }
    ...
    public static void writeNotificationActionClicked(String key, int actionIndex, int lifespan, int freshness, int exposure, int rank, int count) {
        EventLog.writeEvent(NOTIFICATION_ACTION_CLICKED, new Object[]{key, Integer.valueOf(actionIndex), Integer.valueOf(lifespan), Integer.valueOf(freshness), Integer.valueOf(exposure), Integer.valueOf(rank), Integer.valueOf(count)});
    }
    ...
    public static void writeNotificationCanceled(String key, int reason, int lifespan, int freshness, int exposure, int rank, int count, String listener) {
        EventLog.writeEvent(NOTIFICATION_CANCELED, new Object[]{key, Integer.valueOf(reason), Integer.valueOf(lifespan), Integer.valueOf(freshness), Integer.valueOf(exposure), Integer.valueOf(rank), Integer.valueOf(count), listener});
    }
    ...
    public static void writeBackupTransportConnection(String transport, int connected) {
        EventLog.writeEvent(BACKUP_TRANSPORT_CONNECTION, new Object[]{transport, Integer.valueOf(connected)});
    }
    ...
    public static void writeAutoBrightnessAdj(float oldLux, float oldBrightness, float newLux, float newBrightness) {
        EventLog.writeEvent(AUTO_BRIGHTNESS_ADJ, new Object[]{Float.valueOf(oldLux), Float.valueOf(oldBrightness), Float.valueOf(newLux), Float.valueOf(newBrightness)});
    }
    ...
    public static void writeJobDeferredExecution(long time) {
        EventLog.writeEvent(JOB_DEFERRED_EXECUTION, time);
    }
    ...
    public static void writeTimezoneTriggerCheck(String token) {
        EventLog.writeEvent(TIMEZONE_TRIGGER_CHECK, token);
    }

    public static void writeTimezoneRequestInstall(String token) {
        EventLog.writeEvent(TIMEZONE_REQUEST_INSTALL, token);
    }

    public static void writeTimezoneInstallStarted(String token) {
        EventLog.writeEvent(TIMEZONE_INSTALL_STARTED, token);
    }

    public static void writeTimezoneInstallComplete(String token, int result) {
        EventLog.writeEvent(TIMEZONE_INSTALL_COMPLETE, new Object[]{token, Integer.valueOf(result)});
    }

    public static void writeTimezoneRequestUninstall(String token) {
        EventLog.writeEvent(TIMEZONE_REQUEST_UNINSTALL, token);
    }

    public static void writeTimezoneUninstallStarted(String token) {
        EventLog.writeEvent(TIMEZONE_UNINSTALL_STARTED, token);
    }

    public static void writeTimezoneUninstallComplete(String token, int result) {
        EventLog.writeEvent(TIMEZONE_UNINSTALL_COMPLETE, new Object[]{token, Integer.valueOf(result)});
    }

    public static void writeTimezoneRequestNothing(String token) {
        EventLog.writeEvent(TIMEZONE_REQUEST_NOTHING, token);
    }

    public static void writeTimezoneNothingComplete(String token) {
        EventLog.writeEvent(TIMEZONE_NOTHING_COMPLETE, token);
    }
}
