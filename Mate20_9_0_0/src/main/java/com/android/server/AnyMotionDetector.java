...
public class AnyMotionDetector {
    ...
    private static class RunningSignalStats {
        ...
        public String toString() {
            String msg = BackupManagerConstants.DEFAULT_BACKUP_FINISHED_NOTIFICATION_RECEIVERS;
            ...
            stringBuilder.append("previousVector = ");
            stringBuilder.append(previousVectorString);
            msg = stringBuilder.toString();
            stringBuilder = new StringBuilder();
            stringBuilder.append(msg);
            stringBuilder.append(", currentVector = ");
            stringBuilder.append(currentVectorString);
            msg = stringBuilder.toString();
            stringBuilder = new StringBuilder();
            stringBuilder.append(msg);
            ...
            stringBuilder.append(this.energy);
    ...
    public static final class Vector3 {
        ...
        public float angleBetween(Vector3 other) {
            ...
            String str = AnyMotionDetector.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("angleBetween: this = ");
        ...
        public String toString() {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append(msg);
            stringBuilder.append("timeMillisSinceBoot=");
            stringBuilder.append(this.timeMillisSinceBoot);
            msg = stringBuilder.toString();
            stringBuilder = new StringBuilder();
            stringBuilder.append(msg);
