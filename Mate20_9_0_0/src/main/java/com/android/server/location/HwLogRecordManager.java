...
import com.android.server.location.HwLbsLogger.LocationEventRecord;
import com.android.server.location.HwLbsLogger.LocationResultRecord;
import com.android.server.location.HwLbsLogger.SessionRecord;
...
public class HwLogRecordManager {
    ...
    public void writePosition(LocationResultRecord locationResult) {
        if (locationResult != null) {
            ...
            if (location != null && receivers != null) {
                ...
                try {
                    ...
                    encryptedLong = AESLocalDbCrypto.encrypt(str, stringBuilder.toString());
                    str = MASTER_PASSWORD;
                    stringBuilder = new StringBuilder();
                    stringBuilder.append(location.getLatitude());
                    stringBuilder.append("");
                    encryptedLat = AESLocalDbCrypto.encrypt(str, stringBuilder.toString());
                } catch (Exception e) {
    ...
    public void writeEvent(LocationEventRecord eventRecord) {
        if (eventRecord == null) {
            Log.d(TAG, "invalid evenet datas.");
        }
    }

    public void writeSession(SessionRecord sessionRecord) {
