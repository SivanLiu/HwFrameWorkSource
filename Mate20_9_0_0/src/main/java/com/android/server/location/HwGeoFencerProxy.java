...
public class HwGeoFencerProxy extends HwGeoFencerBase {
    ...
    private final Stub mListener = new Stub() {
        public void geoFenceExpired(PendingIntent intent) throws RemoteException {
            ...
            stringBuilder.append("geoFenceExpired - ");
            stringBuilder.append(intent);
            hwGeoFencerProxy.logv(stringBuilder.toString());
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            String str = HwGeoFencerProxy.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("onServiceConnected: mGeoFencer - ");
            stringBuilder.append(HwGeoFencerProxy.this.mGeoFencer);
