...
public final class GeofenceProxy {
    ...
    private GeofenceProxy(Context context, int overlaySwitchResId, int defaultServicePackageNameResId, int initialPackageNamesResId, Handler handler, IGpsGeofenceHardware gpsGeofence, IFusedGeofenceHardware fusedGeofenceHardware) {
        ...
        this.mServiceWatcher = new ServiceWatcher(context2, TAG, SERVICE_ACTION, overlaySwitchResId, defaultServicePackageNameResId, initialPackageNamesResId, this.mRunnable, handler);
        ...
        this.mServiceWatcher.runOnBinder(new BinderRunner() {
            public void run(IBinder binder) {
                try {
                    ...
                    String str = GeofenceProxy.TAG;
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("Remote Exception: setGeofenceHardwareInProviderLocked: ");
