...
public class HwCmccGpsFeature implements IHwCmccGpsFeature {
    ...
    private void setAgpsServer() {
        ...
        stringBuilder.append("setAgpsServer SuplServerHost:");
        stringBuilder.append(strSuplServerHost);
        stringBuilder.append(" SuplServerPort:");
        stringBuilder.append(iSuplServerPort);
    ...
    private int setPostionMode() {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("setPostionMode positionMode:");
        stringBuilder.append(positionMode);
        Log.d(str, stringBuilder.toString());
        return positionMode;
    }
