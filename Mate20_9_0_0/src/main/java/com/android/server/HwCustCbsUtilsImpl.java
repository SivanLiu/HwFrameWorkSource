...
public class HwCustCbsUtilsImpl extends HwCustCbsUtils {
    ...
    public boolean allowVibrateWhenSlient(Context context, String currentVibrationPkg) {
        ...
        int vibrateInSilent = Global.getInt(context.getContentResolver(), KEY_VIBIRATE_WHEN_SILENT, 0);
        if (ringerMode != 0 || vibrateInSilent != 0 || DCM_LCSAPP_PACKAGE.equals(currentVibrationPkg) || DCM_AREAMAIL_PACKAGE.equals(currentVibrationPkg) || DCM_PHONEMOTION_PACKAGE.equals(currentVibrationPkg)) {
            return true;
        }
        return false;
    }
