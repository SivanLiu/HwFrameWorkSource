...
public class GcmHeartBeatFixer {
    ...
    public static void scheduleHeartbeatRequest(Context context, boolean fromNetworkStateChange, boolean adjust) {
        if (!FEATURE_GCM_FIXER) {
            ...
            stringBuilder.append("scheduleHeartbeatRequest, fromNetworkStateChange: ");
            stringBuilder.append(fromNetworkStateChange);
    ...
    private static void setNextHeartbeatRequest(Context context, int intervalMillis, boolean adjust) {
        ...
        if (adjust && i == INTERNAL_POWERGENIE) {
            ...
            stringBuilder.append(elapsedTime);
            stringBuilder.append(" t_elapsedTime:");
            stringBuilder.append(t_elapsedTime);
        ...
        stringBuilder2.append("setNextHeartbeatRequest at: ");
        stringBuilder2.append(DateFormat.format("yyyy-MM-dd hh:mm:ss", triggerAtMillis2));
                    ...
                    if (GcmHeartBeatFixer.ACTION_BACKGROUND_DATA_CHANGED.equals(intent.getAction())) {
                        ...
                        if (activeNetworkInfo != null && activeNetworkInfo.isConnected()) {
                            ...
                            if ("com.google.android.gms".equals(pkgName)) {
                                ...
                                String str = GcmHeartBeatFixer.TAG;
                                StringBuilder stringBuilder = new StringBuilder();
                                stringBuilder.append("com.huawei.systemmanager.changedata mobileAccess = ");
                                stringBuilder.append(mobileAccess);
                                Slog.i(str, stringBuilder.toString());
                                ...
                                String str2 = GcmHeartBeatFixer.TAG;
                                StringBuilder stringBuilder2 = new StringBuilder();
                                stringBuilder2.append("com.huawei.systemmanager.changedata  ignore pkgName ");
