...
public class ImmersiveModeConfirmation {
    ...
    private class ClingWindowView extends FrameLayout {
        ...
        public void onAttachedToWindow() {
            ...
            this.mClingLayout = (ViewGroup) View.inflate(getContext(), 17367156, null);
            ((Button) this.mClingLayout.findViewById(16909151)).setOnClickListener(new OnClickListener() {
    ...
    public ImmersiveModeConfirmation(Context context) {
        this.mPanicThresholdMs = (long) context.getResources().getInteger(17694791);
        this.mWindowManager = (WindowManager) this.mContext.getSystemService("window");
    }

    private long getNavBarExitDuration() {
        Animation exit = AnimationUtils.loadAnimation(this.mContext, 17432617);
    ...
    public void loadSetting(int currentUserId) {
        ...
        try {
            ...
            stringBuilder.append("Error loading confirmations, value=");
    ...
    private void saveSetting() {
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Error saving confirmations, mConfirmed=");
            stringBuilder.append(this.mConfirmed);
            Slog.w(str, stringBuilder.toString(), t);
        }
    }
    ...
    public void immersiveModeChangedLw(String pkg, boolean isImmersiveMode, boolean userSetupComplete, boolean navBarEmpty) {
        ...
        } else if (!PolicyControl.disableImmersiveConfirmation(pkg) && !this.mConfirmed && userSetupComplete && !this.mVrModeEnabled && !navBarEmpty && !UserManager.isDeviceInDemoMode(this.mContext) && this.mLockTaskState != 1) {
    ...
    public FrameLayout.LayoutParams getBubbleLayoutParams() {
        return new FrameLayout.LayoutParams(this.mContext.getResources().getDimensionPixelSize(17105087), -2, 49);
    }
