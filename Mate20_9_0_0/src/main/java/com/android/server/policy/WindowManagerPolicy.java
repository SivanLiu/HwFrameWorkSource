...
public interface WindowManagerPolicy extends WindowManagerPolicyConstants {
    ...
    void adjustWindowParamsLw(WindowState windowState, LayoutParams layoutParams, boolean z);
                                    ...
                                    default:
                                        switch (type) {
                                            ...
                                            default:
                                                ...
                                                stringBuilder.append("Unknown window type: ");
    ...
    int getSubWindowLayerFromTypeLw(int type) {
        switch (type) {
            ...
            default:
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("Unknown sub-window type: ");
                stringBuilder.append(type);
                Slog.e("WindowManager", stringBuilder.toString());
                return 0;
        }
    ...
    boolean getLayoutHintLw(LayoutParams attrs, Rect taskBounds, DisplayFrames displayFrames, Rect outFrame, Rect outContentInsets, Rect outStableInsets, Rect outOutsets, ParcelableWrapper outDisplayCutout) {
        return false;
    }
