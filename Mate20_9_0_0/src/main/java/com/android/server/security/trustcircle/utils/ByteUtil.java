...
public class ByteUtil {
    ...
    public static String byte2HexString(byte raw) {
        ...
        stringBuilder.append(HEX_TABLE.charAt((raw & 240) >> 4));
        stringBuilder.append(HEX_TABLE.charAt(raw & 15));
        return stringBuilder.toString();
    }

    public static String short2HexString(short raw) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(HEX_TABLE.charAt((ConstS32.HIGH_BITS_WCG_MARK & raw) >> 12));
        stringBuilder.append(HEX_TABLE.charAt((raw & ConstS32.HIGH_BITS_AL_MARK) >> 8));
        stringBuilder.append(HEX_TABLE.charAt((raw & 240) >> 4));
        stringBuilder.append(HEX_TABLE.charAt(raw & 15));
        return stringBuilder.toString();
    }
    ...
    public static boolean isLegalHexString(String input) {
        ...
        while (i < length) {
            ...
            if (CHECK_TABLE.contains(s)) {
                ...
                String str = TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("input string is not hex string, at position:");
    ...
    public static String byteArray2HexString(Byte[] raw) {
        ...
        for (byte b : raw) {
            hex.append(byte2HexString(b.byteValue()));
        }
        return hex.toString();
    }
    ...
    public static Integer byteArray2Int(Byte[] raw) {
        ...
        if (raw == null || raw.length == 0 || raw.length != 4) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("error: wrong int byte array size: ");
            stringBuilder.append(raw == null ? "0" : Integer.valueOf(raw.length));
            LogHelper.e(str, stringBuilder.toString());
    ...
    public static Short byteArray2Short(Byte[] raw) {
        ...
        if (raw == null || raw.length == 0 || raw.length != 2) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("error: wrong short byte array size ");
            stringBuilder.append(raw == null ? "0" : Integer.valueOf(raw.length));
            LogHelper.e(str, stringBuilder.toString());
    ...
    public static Long byteArray2Long(Byte[] raw) {
        ...
        if (raw == null || raw.length == 0 || raw.length != 8) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("error: wrong long byte array size ");
            stringBuilder.append(raw == null ? "0" : Integer.valueOf(raw.length));
            LogHelper.e(str, stringBuilder.toString());
    ...
    public static <T> Class getType(T t) {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("getType: unsupported type ");
    ...
    public static <T> String type2HexString(T t) {
        if (t == null) {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("type2HexString: unsupported type ");
            stringBuilder.append(t.getClass().getSimpleName());
            LogHelper.e(str, stringBuilder.toString());
            return null;
        }
    ...
    public static long byteArrayToLongDirect(Byte[] b) {
        ...
        long s = 0;
        long s0 = (long) (bArr[0].byteValue() & 255);
        long byteValue = s0 | (((long) (bArr[1].byteValue() & 255)) << 8);
        byteValue |= ((long) (bArr[2].byteValue() & 255)) << 16;
        byteValue |= ((long) (bArr[3].byteValue() & 255)) << 24;
        byteValue |= ((long) (bArr[4].byteValue() & 255)) << 32;
        byteValue |= ((long) (bArr[5].byteValue() & 255)) << 40;
        return (byteValue | (((long) (bArr[6].byteValue() & 255)) << 48)) | (((long) (bArr[7].byteValue() & 255)) << 56);
    }
}
