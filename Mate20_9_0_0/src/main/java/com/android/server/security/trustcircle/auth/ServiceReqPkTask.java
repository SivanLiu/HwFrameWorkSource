...
public class ServiceReqPkTask extends HwSecurityTaskBase {
    ...
    EventListener mRecPkListener = new EventListener() {
        public boolean onEvent(HwSecurityEvent ev) {
            ...
            String access$100 = ServiceReqPkTask.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("onReceivePkEvent, authID: ");
            stringBuilder.append(ServiceReqPkTask.this.mRespPkInfo.mAuthID);
            stringBuilder.append(", mAuthID: ");
            stringBuilder.append(ServiceReqPkTask.this.mAuthID);
            LogHelper.i(access$100, stringBuilder.toString());
