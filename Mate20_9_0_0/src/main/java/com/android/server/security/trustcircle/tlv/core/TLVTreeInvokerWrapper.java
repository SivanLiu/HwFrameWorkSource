...
public abstract class TLVTreeInvokerWrapper<T extends TLVTreeInvoker<TLVRootTree>> implements ICommand {
    ...
    public static class TLVRootTreeInvokerWrapper<TLVRootTreeInvoker> extends TLVTreeInvokerWrapper<TLVTreeInvoker<TLVRootTree>> {
        ...
        public Byte[] encapsulate() {
            ...
            if (this.wrappedInvoker == null) {
                ...
                stringBuilder.append("encapsulated cmd id: 0x");
                stringBuilder.append(ByteUtil.int2StrictHexString(cmdID));
                stringBuilder.append(", TLV:");
                stringBuilder.append(TLVTreeInvokerWrapper.getInvokerName(cmdID));
        ...
        private TLVTreeInvoker getLegalTLVRootTreeCmd(ByteBuffer buffer) {
            if (buffer == null || buffer.remaining() < 8) {
                String str = ICommand.TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("error_tlv:return cmd length invalid: ");
            ...
            stringBuilder2.append("parsed cmd id: 0x");
            stringBuilder2.append(ByteUtil.int2StrictHexString(cmdID));
            stringBuilder2.append(", TLV:");
            stringBuilder2.append(TLVTreeInvokerWrapper.getInvokerName(cmdID));
            LogHelper.i(str2, stringBuilder2.toString());
        ...
        private boolean isCmdLegal(ByteBuffer buffer, int cmdID) {
            if (buffer == null || buffer.remaining() < 4) {
                String str = ICommand.TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("error_tlv:cmd result description field length illegal:");
                stringBuilder.append(buffer == null ? "ByteBuffer is null" : Integer.valueOf(buffer.remaining()));
                LogHelper.e(str, stringBuilder.toString());
                return false;
            }
            ...
            if (buffer.remaining() >= 4) {
                ...
                String str2 = ICommand.TAG;
                StringBuilder stringBuilder2 = new StringBuilder();
                stringBuilder2.append("error_tlv: cmd tlv length claimed: ");
                stringBuilder2.append(claimedTLVLength);
                stringBuilder2.append(", actual:");
                stringBuilder2.append(realTLVLength);
                LogHelper.e(str2, stringBuilder2.toString());
                return false;
            }
            String str3 = ICommand.TAG;
            StringBuilder stringBuilder3 = new StringBuilder();
            stringBuilder3.append("error_tlv: cmd tlv length description field length illegal:");
            stringBuilder3.append(buffer.remaining());
        ...
        public boolean isInvokerExisted(int cmdID) {
            ...
            String str = ICommand.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("error_tlv: unknown TLV cmd id:");
            stringBuilder.append(ByteUtil.int2StrictHexString(cmdID));
            LogHelper.e(str, stringBuilder.toString());
            return false;
        }
    ...
    static {
        ...
        CMD_MAP.put(Integer.valueOf(CMD_KA.ID), new TLVRootTreeInvoker((int) CMD_KA.ID));
        CMD_MAP.put(Integer.valueOf(RET_KA.ID), new TLVRootTreeInvoker((int) RET_KA.ID));
    }
