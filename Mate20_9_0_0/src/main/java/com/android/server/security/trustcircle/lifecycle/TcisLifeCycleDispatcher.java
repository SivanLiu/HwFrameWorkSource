...
public class TcisLifeCycleDispatcher {
    ...
    public void loginServerRequest(long userID, int serverRegisterStatus, String sessionID) {
        ...
        stringBuilder.append("serverRegisterStatus: ");
        stringBuilder.append(serverRegisterStatus == 0 ? "not registered" : "registered");
    ...
    public void finalLogin(int updateResult, String updateIndexInfo, String updateIndexSignature) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("updateResult: ");
        stringBuilder.append(updateResult == 0 ? "no need update" : "need update");
