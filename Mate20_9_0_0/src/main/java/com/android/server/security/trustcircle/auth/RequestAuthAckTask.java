...
public class RequestAuthAckTask extends HwSecurityTaskBase {
    ...
    EventListener mIOTResListener = new EventListener() {
        public boolean onEvent(HwSecurityEvent ev) {
            ...
            String access$100 = RequestAuthAckTask.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("onAuthSyncAckEvent, authID: ");
            stringBuilder.append(RequestAuthAckTask.this.mRecAuthAckInfo.mAuthID);
            stringBuilder.append(", mAuthID: ");
            stringBuilder.append(RequestAuthAckTask.this.mOnAuthSyncInfo.mAuthID);
            LogHelper.i(access$100, stringBuilder.toString());
    ...
    public int doAction() {
        ...
        if (callback != null) {
            try {
                ...
                String str = TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("onAuthError, authID: ");
                stringBuilder.append(this.mOnAuthSyncInfo.mAuthID);
                stringBuilder.append("errorcode: ");
                stringBuilder.append(this.mOnAuthSyncInfo.mResult);
