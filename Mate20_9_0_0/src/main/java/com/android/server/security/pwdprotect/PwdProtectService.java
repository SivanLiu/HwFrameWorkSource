...
import huawei.android.security.IPwdProtectManager.Stub;

public class PwdProtectService extends Stub implements IHwSecurityPlugin {
    ...
    private boolean isPrivSpacePwdProtectOpened() {
        ...
        if (Global.getInt(this.mContext.getContentResolver(), "privacy_user_pwd_protect", 0) == 1) {
            z = true;
        }
        return z;
    }
