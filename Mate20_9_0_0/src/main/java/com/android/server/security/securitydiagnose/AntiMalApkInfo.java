...
public class AntiMalApkInfo implements Parcelable, Comparable<AntiMalApkInfo> {
    ...
    private String getFileLastModifiedTime(String fileName) {
        ...
        try {
            ...
            stringBuilder.append("getFileLastModifiedTime e:");
    ...
    private boolean stringEquals(String str1, String str2) {
        ...
        } else if (!str1.equalsIgnoreCase(str2) && (str1.length() >= 1 || str2 != null)) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        ...
        stringBuilder.append(" LastModifyTime : ");
        stringBuilder.append(this.mLastModifyTime);
