...
public class ActivationMonitor {
    ...
    private class SimReceiver extends BroadcastReceiver {
        ...
        /* synthetic */ SimReceiver(ActivationMonitor x0, AnonymousClass1 x1) {
            this();
        }
    ...
    public void reStart(long duration) {
        if (duration <= SIX_HOURS_MS && duration >= 0) {
            ...
            stringBuilder.append(this.ACTIVATION_DURATION_MS);
    ...
    private void countDownIfHasSim() {
        ...
        if (1 == tm.getSimState()) {
            ...
            alarmManager.set(2, this.ACTIVATION_DURATION_MS + SystemClock.elapsedRealtime(), "ACTIVATION_COUNTING", this.mAlarmListener, this.mHandler);
