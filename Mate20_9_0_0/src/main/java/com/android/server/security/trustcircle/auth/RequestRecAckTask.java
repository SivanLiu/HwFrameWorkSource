...
public class RequestRecAckTask extends HwSecurityTaskBase {
    ...
    EventListener mCancelListener = new EventListener() {
        public boolean onEvent(HwSecurityEvent ev) {
            ...
            stringBuilder.append("onCancelAuthEvent, authID: ");
            stringBuilder.append(authID);
            LogHelper.i(access$100, stringBuilder.toString());
    ...
    EventListener mRecAckListener = new EventListener() {
        public boolean onEvent(HwSecurityEvent ev) {
            ...
            String access$100 = RequestRecAckTask.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("receiveAcEvent, authID: ");
            stringBuilder.append(RequestRecAckTask.this.mRecAckInfo.mAuthID);
            stringBuilder.append(", mAuthID: ");
            stringBuilder.append(RequestRecAckTask.this.mOnAuthSyncAckInfo.mAuthID);
            LogHelper.i(access$100, stringBuilder.toString());
    ...
    public int doAction() {
        ...
        if (callback != null) {
            try {
                ...
                stringBuilder.append("onAuthSyncAck, result: ");
                stringBuilder.append(this.mOnAuthSyncAckInfo.mResult);
        ...
        stringBuilder = new StringBuilder();
        stringBuilder.append("authID: ");
        stringBuilder.append(this.mOnAuthSyncAckInfo.mAuthID);
        stringBuilder.append(", waiting for receiveAck... ");
        LogHelper.i(str, stringBuilder.toString());
        return -1;
    }
