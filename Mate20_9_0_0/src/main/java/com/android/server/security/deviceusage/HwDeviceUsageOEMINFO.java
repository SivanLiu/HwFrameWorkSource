    ...
    private void setDataBuffer() {
        ...
        if (this.mDataBuffer.remaining() >= 40) {
            ...
            if (HW_DEBUG) {
                String str = TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("setDataBuffer mOpenFlag = ");
                stringBuilder.append(this.mOEMINFOData.mOpenFlag);
                stringBuilder.append(" OEMINFOData.mScreenOnTime = ");
                stringBuilder.append(this.mOEMINFOData.mScreenOnTime);
                stringBuilder.append(" mChargeTime = ");
                stringBuilder.append(this.mOEMINFOData.mChargeTime);
                stringBuilder.append(" mTalkTime = ");
                stringBuilder.append(this.mOEMINFOData.mTalkTime);
                stringBuilder.append(" mFristUseTime = ");
                stringBuilder.append(this.mOEMINFOData.mFristUseTime);
                Slog.d(str, stringBuilder.toString());
            }
        }
    }
    ...
    private void getOEMINFOData() {
        ...
        if (this.mDataBuffer.remaining() >= 40) {
            ...
            if (HW_DEBUG) {
                String str = TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("getOEMINFOData mOpenFlag ");
                stringBuilder.append(this.mOEMINFOData.mOpenFlag);
                stringBuilder.append(" OEMINFOData.mScreenOnTime ");
                stringBuilder.append(this.mOEMINFOData.mScreenOnTime);
                stringBuilder.append(" mChargeTime ");
