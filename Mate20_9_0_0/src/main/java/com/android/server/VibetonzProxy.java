...
public class VibetonzProxy {
    ...
    public static void initVibetonzImpl() {
        ...
        stringBuilder.append("Never mkdir ");
        stringBuilder.append(dexOutputDir);
        stringBuilder.append(" before the storage is encrypted,it cause storage encryption failure!");
