...
final class PackageVersions {
    ...
    public String toString() {
        ...
        stringBuilder.append("PackageVersions{mUpdateAppVersion=");
        stringBuilder.append(this.mUpdateAppVersion);
        stringBuilder.append(", mDataAppVersion=");
        stringBuilder.append(this.mDataAppVersion);
