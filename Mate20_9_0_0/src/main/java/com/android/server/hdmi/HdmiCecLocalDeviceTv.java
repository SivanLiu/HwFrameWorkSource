...
final class HdmiCecLocalDeviceTv extends HdmiCecLocalDevice {
    ...
    protected boolean handleGetMenuLanguage(HdmiCecMessage message) {
        ...
        if (!broadcastMenuLanguage(this.mService.getLanguage())) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Failed to respond to <Get Menu Language>: ");
    ...
    protected boolean handleReportPhysicalAddress(HdmiCecMessage message) {
        ...
        if (hasAction(DeviceDiscoveryAction.class)) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Ignored while Device Discovery Action is in progress: ");
    ...
    protected boolean handleSetOsdName(HdmiCecMessage message) {
        ...
        if (deviceInfo == null) {
            str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("No source device info for <Set Osd Name>.");
            stringBuilder.append(message);
            Slog.e(str, stringBuilder.toString());
            return true;
        }
        try {
            str = new String(message.getParams(), "US-ASCII");
            if (deviceInfo.getDisplayName().equals(str)) {
                String str2 = TAG;
                StringBuilder stringBuilder2 = new StringBuilder();
                stringBuilder2.append("Ignore incoming <Set Osd Name> having same osd name:");
                stringBuilder2.append(message);
                Slog.i(str2, stringBuilder2.toString());
                return true;
            }
            addCecDevice(new HdmiDeviceInfo(deviceInfo.getLogicalAddress(), deviceInfo.getPhysicalAddress(), deviceInfo.getPortId(), deviceInfo.getDeviceType(), deviceInfo.getVendorId(), str));
            return true;
        } catch (UnsupportedEncodingException e) {
            String str3 = TAG;
            StringBuilder stringBuilder3 = new StringBuilder();
            stringBuilder3.append("Invalid <Set Osd Name> request:");
    ...
    protected boolean handleSetSystemAudioMode(HdmiCecMessage message) {
        ...
        if (!isMessageForSystemAudio(message)) {
            if (getAvrDeviceInfo() == null) {
                ...
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("Invalid <Set System Audio Mode> message:");
                stringBuilder.append(message);
    ...
    protected boolean handleSystemAudioModeStatus(HdmiCecMessage message) {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Invalid <System Audio Mode Status> message:");
        stringBuilder.append(message);
        HdmiLogger.warning(stringBuilder.toString(), new Object[0]);
        return true;
    }
    ...
    private static boolean isConnectedToCecSwitch(int path, Collection<Integer> switches) {
        for (Integer switchPath : switches) {
            if (isParentPath(switchPath.intValue(), path)) {
                return true;
            }
        }
        return false;
    ...
    void launchRoutingControl(boolean routingForBootup) {
        ...
        if (getActivePortId() == -1) {
            activePath = this.mService.getPhysicalAddress();
            ...
            activePath = this.mService.portIdToPath(getActivePortId());
            setActivePath(activePath);
            startRoutingControl(getActivePath(), activePath, routingForBootup, null);
        }
    }
    ...
    int startOneTouchRecord(int recorderAddress, byte[] recordSource) {
        ...
        if (!this.mService.isControlEnabled()) {
            ...
            str = TAG;
            StringBuilder stringBuilder2 = new StringBuilder();
            stringBuilder2.append("Invalid recorder address:");
            stringBuilder2.append(recorderAddress);
            ...
            stringBuilder.append("Start new [One Touch Record]-Target:");
            stringBuilder.append(recorderAddress);
            stringBuilder.append(", recordSource:");
            stringBuilder.append(Arrays.toString(recordSource));
            Slog.i(str, stringBuilder.toString());
            return -1;
        } else {
            str = TAG;
            stringBuilder = new StringBuilder();
            stringBuilder.append("Invalid record source.");
            stringBuilder.append(Arrays.toString(recordSource));
            Slog.w(str, stringBuilder.toString());
    ...
    void stopOneTouchRecord(int recorderAddress) {
        ...
        if (!this.mService.isControlEnabled()) {
            ...
            str = TAG;
            stringBuilder = new StringBuilder();
            stringBuilder.append("Stop [One Touch Record]-Target:");
            stringBuilder.append(recorderAddress);
            Slog.i(str, stringBuilder.toString());
        } else {
            str = TAG;
            stringBuilder = new StringBuilder();
            stringBuilder.append("Invalid recorder address:");
            stringBuilder.append(recorderAddress);
            Slog.w(str, stringBuilder.toString());
            announceOneTouchRecordResult(recorderAddress, 49);
        }
    ...
    void startTimerRecording(int recorderAddress, int sourceType, byte[] recordSource) {
        ...
        if (!this.mService.isControlEnabled()) {
            ...
            str = TAG;
            stringBuilder = new StringBuilder();
            stringBuilder.append("Start [Timer Recording]-Target:");
            stringBuilder.append(recorderAddress);
    ...
    void updateDevicePowerStatus(int logicalAddress, int newPowerStatus) {
        ...
        if (info == null) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Can not update power status of non-existing device:");
    ...
    protected void dump(IndentingPrintWriter pw) {
        super.dump(pw);
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("mArcEstablished: ");
        stringBuilder.append(this.mArcEstablished);
        pw.println(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append("mArcFeatureEnabled: ");
        stringBuilder.append(this.mArcFeatureEnabled);
        pw.println(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append("mSystemAudioActivated: ");
        stringBuilder.append(this.mSystemAudioActivated);
        pw.println(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append("mSystemAudioMute: ");
        stringBuilder.append(this.mSystemAudioMute);
        pw.println(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append("mSystemAudioControlFeatureEnabled: ");
        stringBuilder.append(this.mSystemAudioControlFeatureEnabled);
        pw.println(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append("mAutoDeviceOff: ");
        stringBuilder.append(this.mAutoDeviceOff);
        pw.println(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append("mAutoWakeup: ");
        stringBuilder.append(this.mAutoWakeup);
        pw.println(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append("mSkipRoutingControl: ");
        stringBuilder.append(this.mSkipRoutingControl);
        pw.println(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append("mPrevPortId: ");
        stringBuilder.append(this.mPrevPortId);
        pw.println(stringBuilder.toString());
