...
final class HdmiCecLocalDevicePlayback extends HdmiCecLocalDevice {
    ...
    protected boolean handleSetMenuLanguage(HdmiCecMessage message) {
        ...
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Can't handle <Set Menu Language> of ");
            stringBuilder.append(iso3Language);
    ...
    protected void dump(IndentingPrintWriter pw) {
        super.dump(pw);
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("mIsActiveSource: ");
        stringBuilder.append(this.mIsActiveSource);
        pw.println(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append("mAutoTvOff:");
        stringBuilder.append(this.mAutoTvOff);
        pw.println(stringBuilder.toString());
    }
}
