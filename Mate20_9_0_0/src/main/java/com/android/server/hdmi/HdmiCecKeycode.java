...
final class HdmiCecKeycode {
    ...
    private static final KeycodeEntry[] KEYCODE_ENTRIES = new KeycodeEntry[]{new KeycodeEntry(23, 0, null), new KeycodeEntry(19, 1, null), new KeycodeEntry(20, 2, null), new KeycodeEntry(21, 3, null), new KeycodeEntry(22, 4, null), new KeycodeEntry(-1, 5, null), new KeycodeEntry(-1, 6, null), new KeycodeEntry(-1, 7, null), new KeycodeEntry(-1, 8, null), new KeycodeEntry(3, 9, null), new KeycodeEntry(176, 10, null), new KeycodeEntry(256, 11, false, null), new KeycodeEntry(-1, 12, null), new KeycodeEntry(4, 13, null), new KeycodeEntry(111, 13, null), new KeycodeEntry(226, 16, null), new KeycodeEntry(257, 17, null), new KeycodeEntry(234, 29, null), new KeycodeEntry(227, 30, null), new KeycodeEntry(228, 31, null), new KeycodeEntry(7, 32, null), new KeycodeEntry(8, 33, null), new KeycodeEntry(9, 34, null), new KeycodeEntry(10, 35, null), new KeycodeEntry(11, 36, null), new KeycodeEntry(12, 37, null), new KeycodeEntry(13, 38, null), new KeycodeEntry(14, 39, null), new KeycodeEntry(15, 40, null), new KeycodeEntry(16, 41, null), new KeycodeEntry(56, 42, null), new KeycodeEntry(160, 43, null), new KeycodeEntry(28, 44, null), new KeycodeEntry(-1, 47, null), new KeycodeEntry(166, 48, null), new KeycodeEntry(167, 49, null), new KeycodeEntry(229, 50, null), new KeycodeEntry(-1, 51, null), new KeycodeEntry((int) UI_SOUND_PRESENTATION_BASS_NEUTRAL, 52, null), new KeycodeEntry(165, 53, null), new KeycodeEntry(-1, 54, null), new KeycodeEntry(92, 55, null), new KeycodeEntry(93, 56, null), new KeycodeEntry(26, 64, false, null), new KeycodeEntry(24, 65, null), new KeycodeEntry(25, 66, null), new KeycodeEntry(164, 67, false, null), new KeycodeEntry(126, 68, null), new KeycodeEntry(86, 69, null), new KeycodeEntry(127, 70, null), new KeycodeEntry(85, 70, null), new KeycodeEntry(130, 71, null), new KeycodeEntry(89, 72, null), new KeycodeEntry(90, 73, null), new KeycodeEntry((int) NetworkConstants.ICMPV6_ECHO_REPLY_TYPE, 74, null), new KeycodeEntry(87, 75, null), new KeycodeEntry(88, 76, null), new KeycodeEntry(-1, 77, null), new KeycodeEntry(-1, 78, null), new KeycodeEntry(-1, 79, null), new KeycodeEntry(-1, 80, null), new KeycodeEntry(175, 81, null), new KeycodeEntry(-1, 82, null), new KeycodeEntry(172, 83, null), new KeycodeEntry((int) LightsManager.LIGHT_ID_AUTOCUSTOMBACKLIGHT, 84, null), new KeycodeEntry(-1, 85, null), new KeycodeEntry(-1, 86, null), new KeycodeEntry(235, 86, true, intToSingleByteArray(16)), new KeycodeEntry(DhcpPacket.MIN_PACKET_LENGTH_BOOTP, 86, true, intToSingleByteArray(96)), new KeycodeEntry(238, 86, true, intToSingleByteArray(128)), new KeycodeEntry(UsbDescriptor.CLASSID_MISC, 86, true, intToSingleByteArray(144)), new KeycodeEntry(241, 86, true, intToSingleByteArray(1)), new KeycodeEntry(-1, 87, null), new KeycodeEntry(-1, 96, false, null), new KeycodeEntry(-1, 97, false, null), new KeycodeEntry(-1, 98, false, null), new KeycodeEntry(-1, 99, false, null), new KeycodeEntry(-1, 100, false, null), new KeycodeEntry(-1, 101, false, null), new KeycodeEntry(-1, 102, false, null), new KeycodeEntry(-1, 103, false, null), new KeycodeEntry(-1, 104, false, null), new KeycodeEntry(-1, 105, false, null), new KeycodeEntry(-1, 106, false, null), new KeycodeEntry(-1, 107, false, null), new KeycodeEntry(-1, 108, false, null), new KeycodeEntry(-1, 109, false, null), new KeycodeEntry(186, 113, null), new KeycodeEntry(183, 114, null), new KeycodeEntry(184, (int) CEC_KEYCODE_F3_GREEN, null), new KeycodeEntry(185, (int) CEC_KEYCODE_F4_YELLOW, null), new KeycodeEntry((int) NetworkConstants.ICMPV6_NEIGHBOR_SOLICITATION, (int) CEC_KEYCODE_F5, null), new KeycodeEntry(230, (int) CEC_KEYCODE_DATA, null)};
    ...
    static byte[] androidKeyToCecKey(int keycode) {
        for (byte[] cecKeycodeAndParams : KEYCODE_ENTRIES) {
            byte[] cecKeycodeAndParams2 = cecKeycodeAndParams2.toCecKeycodeAndParamIfMatched(keycode);
            if (cecKeycodeAndParams2 != null) {
                return cecKeycodeAndParams2;
            }
        }
        return null;
    }
    ...
    static int cecKeycodeAndParamsToAndroidKey(byte[] cecKeycodeAndParams) {
        for (int androidKey : KEYCODE_ENTRIES) {
            int androidKey2 = androidKey2.toAndroidKeycodeIfMatched(cecKeycodeAndParams);
            if (androidKey2 != -1) {
                return androidKey2;
            }
        }
    ...
    static boolean isRepeatableKey(int androidKeycode) {
        for (Boolean isRepeatable : KEYCODE_ENTRIES) {
            Boolean isRepeatable2 = isRepeatable2.isRepeatableIfMatched(androidKeycode);
            if (isRepeatable2 != null) {
                return isRepeatable2.booleanValue();
            }
        }
        return false;
    }
