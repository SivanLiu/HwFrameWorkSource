        ...
        if (info == null) {
            ...
            if (message.getDestination() == 15) {
                if ((info.addressType & 2) == 0) {
                    stringBuilder = new StringBuilder();
                    stringBuilder.append("Unexpected broadcast message: ");
                    stringBuilder.append(message);
                    HdmiLogger.warning(stringBuilder.toString(), new Object[0]);
                    return 2;
                }
                ...
                stringBuilder = new StringBuilder();
                stringBuilder.append("Unexpected direct message: ");
                stringBuilder.append(message);
                HdmiLogger.warning(stringBuilder.toString(), new Object[0]);
                return 2;
            }
            ...
            stringBuilder2.append("Unexpected parameters: ");
            stringBuilder2.append(message);
            HdmiLogger.warning(stringBuilder2.toString(), new Object[0]);
            return errorCode;
        }
    }
