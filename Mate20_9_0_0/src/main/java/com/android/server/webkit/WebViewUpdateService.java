...
public class WebViewUpdateService extends SystemService {
    ...
    private class BinderService extends Stub {
        ...
        /* synthetic */ BinderService(WebViewUpdateService x0, AnonymousClass1 x1) {
            this();
        }
        ...
        public String changeProviderAndSetting(String newProvider) {
            if (WebViewUpdateService.this.getContext().checkCallingPermission("android.permission.WRITE_SECURE_SETTINGS") == 0) {
                ...
                msg.append("Permission Denial: changeProviderAndSetting() from pid=");
                msg.append(Binder.getCallingPid());
                msg.append(", uid=");
                msg.append(Binder.getCallingUid());
                msg.append(" requires ");
                msg.append("android.permission.WRITE_SECURE_SETTINGS");
                msg = msg.toString();
        ...
        public void enableFallbackLogic(boolean enable) {
            if (WebViewUpdateService.this.getContext().checkCallingPermission("android.permission.WRITE_SECURE_SETTINGS") == 0) {
                ...
                String msg = new StringBuilder();
                msg.append("Permission Denial: enableFallbackLogic() from pid=");
                msg.append(Binder.getCallingPid());
                msg.append(", uid=");
                msg.append(Binder.getCallingUid());
                msg.append(" requires ");
        ...
        public void enableMultiProcess(boolean enable) {
            if (WebViewUpdateService.this.getContext().checkCallingPermission("android.permission.WRITE_SECURE_SETTINGS") == 0) {
                ...
                String msg = new StringBuilder();
                msg.append("Permission Denial: enableMultiProcess() from pid=");
                msg.append(Binder.getCallingPid());
                msg.append(", uid=");
                msg.append(Binder.getCallingUid());
                msg.append(" requires ");
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                switch (i) {
                    ...
                    case 2:
                        ...
                        access$100.packageStateChanged(access$000, i2, userId);
                        break;
                    case 3:
