...
public class NetworkStatsRecorder {
    ...
    private boolean nomarkeduid(int uid) {
        return (mWatchapp.contains(Integer.valueOf(uid)) || mSilentapp.contains(Integer.valueOf(uid)) || mMarkapp.contains(Integer.valueOf(uid))) ? false : true;
    }
        ...
        if (networkStats != null) {
            ...
            while (true) {
                ...
                if (i2 < delta.size()) {
                    ...
                    int i3;
                    NetworkStats delta2;
                    Entry entry3 = delta.getValues(i2, entry);
                    if (entry3.isNegative()) {
                        if (this.mObserver != null) {
                            this.mObserver.foundNonMonotonic(delta, i2, this.mCookie);
                        }
                    ...
                    NetworkIdentitySet ident = (NetworkIdentitySet) ifaceIdent.get(entry3.iface);
                    if (ident == null) {
                        ...
                        if (!entry3.isEmpty()) {
                            if ((entry3.tag == 0) != this.mOnlyTags) {
                                ...
                                if (complete != null) {
                                    ...
                                    i3 = i2;
                                    delta2 = delta;
                                    complete.recordData(ident, entry3.uid, entry3.set, entry3.tag, start, end, entry2);
                                    delta = delta2;
                                    i = i3 + 1;
                                    entry = entry2;
                                }
    ...
    public void removeUidsLocked(int[] uids) {
        ...
        if (this.mRotator != null) {
            try {
                ...
                stringBuilder.append("problem removing UIDs ");
