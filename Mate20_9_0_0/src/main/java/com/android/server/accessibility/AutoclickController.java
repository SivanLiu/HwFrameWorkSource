...
public class AutoclickController extends BaseEventStreamTransformation {
    ...
    private final class ClickScheduler implements Runnable {
        ...
        public void update(MotionEvent event, int policyFlags) {
            ...
            boolean z = this.mLastMotionEvent == null || moved;
            cacheLastEvent(event, policyFlags, z);
            if (moved) {
        ...
        private void sendClick() {
            if (this.mLastMotionEvent != null && AutoclickController.this.getNext() != null) {
                ...
                upEvent.setAction(1);
                super.onMotionEvent(downEvent, downEvent, this.mEventPolicyFlags);
                downEvent.recycle();
                super.onMotionEvent(upEvent, upEvent, this.mEventPolicyFlags);
                upEvent.recycle();
            }
        }
        ...
        public String toString() {
            ...
            builder.append("ClickScheduler: { active=");
            builder.append(this.mActive);
            builder.append(", delay=");
            builder.append(this.mDelay);
            builder.append(", scheduledClickTime=");
            builder.append(this.mScheduledClickTime);
            builder.append(", anchor={x:");
            builder.append(this.mAnchorCoords.x);
            builder.append(", y:");
            builder.append(this.mAnchorCoords.y);
            builder.append("}");
            builder.append(", metastate=");
            builder.append(this.mMetaState);
            builder.append(", policyFlags=");
            builder.append(this.mEventPolicyFlags);
            builder.append(", lastMotionEvent=");
            builder.append(this.mLastMotionEvent);
            builder.append(" }");
    ...
    public void clearEvents(int inputSource) {
        if (inputSource == UsbACInterface.FORMAT_III_IEC1937_MPEG1_Layer1 && this.mClickScheduler != null) {
            this.mClickScheduler.cancel();
        }
