...
public class Letterbox {
    ...
    private final Supplier<Builder> mFactory;
    ...
    private class LetterboxSurface {
        ...
        private void createSurface() {
            Builder builder = (Builder) Letterbox.this.mFactory.get();
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Letterbox - ");
            stringBuilder.append(this.mType);
            this.mSurface = builder.setName(stringBuilder.toString()).setFlags(4).setColorLayer(true).build();
        ...
        public void applySurfaceChanges(Transaction t) {
        ...
        public boolean needsApplySurfaceChanges() {
            return this.mSurfaceFrame.equals(this.mLayoutFrame) ^ 1;
        }
    }

    public Letterbox(Supplier<Builder> surfaceControlFactory) {
