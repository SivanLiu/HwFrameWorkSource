...
public abstract class ConfigurationContainer<E extends ConfigurationContainer> {
    ...
    public void onOverrideConfigurationChanged(Configuration overrideConfiguration) {
        this.mHasOverrideConfiguration = Configuration.EMPTY.equals(overrideConfiguration) ^ 1;
        ...
        for (int i = this.mChangeListeners.size() - 1; i >= 0; i--) {
            ((ConfigurationContainerListener) this.mChangeListeners.get(i)).onOverrideConfigurationChanged(this.mTmpConfig);
        }
    }
    ...
    public boolean hasOverrideBounds() {
        return getOverrideBounds().isEmpty() ^ 1;
    }
    ...
    public void setActivityType(int activityType) {
        ...
        if (currentActivityType != activityType) {
            ...
            stringBuilder.append(WindowConfiguration.activityTypeToString(activityType));
    ...
    public void dumpChildrenNames(PrintWriter pw, String prefix) {
        String childPrefix = new StringBuilder();
        childPrefix.append(prefix);
        childPrefix.append(" ");
        childPrefix = childPrefix.toString();
        StringBuilder stringBuilder = new StringBuilder();
        ...
        for (int i = getChildCount() - 1; i >= 0; i--) {
            ...
            stringBuilder2.append(childPrefix);
