...
public class DisplayFrames {
    ...
    public void onBeginLayout() {
        ...
        this.mDisplayCutoutSafe.set(Integer.MIN_VALUE, Integer.MIN_VALUE, HwBootFail.STAGE_BOOT_SUCCESS, HwBootFail.STAGE_BOOT_SUCCESS);
    ...
    public void dump(String prefix, PrintWriter pw) {
        ...
        stringBuilder.append("DisplayFrames w=");
        ...
        stringBuilder2.append(myPrefix);
        stringBuilder2.append("mDisplayCutout=");
        stringBuilder2.append(this.mDisplayCutout.getDisplayCutout());
