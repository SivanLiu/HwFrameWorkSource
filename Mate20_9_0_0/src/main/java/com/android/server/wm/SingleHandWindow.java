...
final class SingleHandWindow {
    ...
    private void createWindow() {
        ...
        RelativeLayout layout = (RelativeLayout) this.mWindowContent.findViewById(34603068);
    ...
    private void showHint(boolean visible) {
        ...
        this.overlay_guide_window = (TextView) this.mWindowContent.findViewById(34603235);
        ...
        this.singlehandmode_slide_hint_text_1 = (TextView) this.mWindowContent.findViewById(34603257);
        show(this.singlehandmode_slide_hint_text_1, visible);
        this.singlehandmode_slide_hint_text_2 = (TextView) this.mWindowContent.findViewById(34603258);
        ...
        ImageView imageView = (ImageView) this.mWindowContent.findViewById(34603259);
        if (imageView != null) {
        ...
        imageView = (ImageView) this.mWindowContent.findViewById(34603260);
        if (imageView != null) {
            params = (LinearLayout.LayoutParams) imageView.getLayoutParams();
            params.width = (this.mDefaultDisplayInfo.logicalWidth * 4) / 9;
            params.height = params.width;
    ...
    boolean singlehandRegionContainsPoint(int x, int y) {
        int top = (int) (((float) this.mDefaultDisplayInfo.logicalHeight) * 1048576000);
        int bottom = this.mDefaultDisplayInfo.logicalHeight;
        int left;
        int right;
        if (this.mLeft) {
            left = 0;
            right = (int) (((float) this.mDefaultDisplayInfo.logicalWidth) * 1061158912);
        } else {
    ...
    public void onBlurWallpaperChanged() {
        ...
        this.mRelateViewtop.setBackground(new BitmapDrawable(this.mRelateViewtop.getResources(), cropwallpaper(true)));
        this.mRelateViewbottom = (RelativeLayout) this.mWindowContent.findViewById(34603161);
        this.mRelateViewbottom.setBackground(new BitmapDrawable(this.mRelateViewbottom.getResources(), cropwallpaper(null)));
    }
}
