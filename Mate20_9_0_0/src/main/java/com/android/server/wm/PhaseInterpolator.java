...
public class PhaseInterpolator implements Interpolator {
    ...
    public PhaseInterpolator(float[] inValues, float[] deValues, TimeInterpolator[] interpolators) {
        ...
        stringBuilder.append("invalide param, inValues : ");
        stringBuilder.append(inValues == null);
        stringBuilder.append(", deValues : ");
        stringBuilder.append(deValues == null);
        stringBuilder.append(", interpolators : ");
