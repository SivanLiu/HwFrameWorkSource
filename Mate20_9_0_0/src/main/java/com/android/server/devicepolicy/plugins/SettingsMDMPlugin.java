...
public class SettingsMDMPlugin extends DevicePolicyPlugin {
    ...
    public boolean onSetPolicy(ComponentName who, String policyName, Bundle policyData, boolean globalPolicyChanged) {
        ...
        stringBuilder.append("onSetPolicy() begin. policyName: ");
        stringBuilder.append(policyName);
        stringBuilder.append(", globalPolicyChanged: ");
        stringBuilder.append(globalPolicyChanged);
        ...
        if (POLICY_FORBIDDEN_RESTORE_DEVICE.equals(policyName) && retVal) {
            ...
            stringBuilder2.append("property of disable factory reset is set to ");
            stringBuilder2.append(SystemProperties.get(RESTORE_PERSISTENT_CONFIG_PROPERTY, ""));
    ...
    public boolean onRemovePolicy(ComponentName who, String policyName, Bundle policyData, boolean globalPolicyChanged) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("onRemovePolicy() begin. policyName: ");
        stringBuilder.append(policyName);
        stringBuilder.append(", globalPolicyChanged: ");
        stringBuilder.append(globalPolicyChanged);
        HwLog.i(str, stringBuilder.toString());
    ...
    public boolean onGetPolicy(ComponentName who, String policyName, Bundle policyData) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("onGetPolicy() policyName: ");
        stringBuilder.append(policyName);
        HwLog.i(str, stringBuilder.toString());
        return true;
    }
    ...
    private boolean sendFixComponentBroadcast(ComponentName who, String action, String apkName, String policyName, Bundle policyData) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("sendFixComponentBroadcast() send broadcast action: ");
    ...
    private boolean checkPolicyValue(String policyName, Bundle policy) {
        if (-1 == getPolicyType(policyName) || policy == null) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("checkPolicyValue() get unknown policy: ");
            stringBuilder.append(policyName);
            stringBuilder.append("OR get null policy.");
        ...
        String str2 = TAG;
        StringBuilder stringBuilder2 = new StringBuilder();
        stringBuilder2.append("checkPolicyValue() get policy type: ");
        stringBuilder2.append(policyType);
