    ...
    private void printLockedThread() {
        ...
        for (int i = 0; i < checkerSize; i++) {
            ...
            if (hc.getCompletionStateLocked() == 2) {
                ...
                stringBuilder.append(lockedThread);
                stringBuilder.append(" is blocked for over 6 seconds");
                Slog.i(str, stringBuilder.toString());
                StringBuilder stringBuilder2 = new StringBuilder();
                stringBuilder2.append(lockedThread);
                stringBuilder2.append(" is blocked for over 6 seconds");
                Jlog.d(MemoryConstant.MSG_WORKINGSET_TOUCHEDFILES_ABORT, lockedThread, 6, stringBuilder2.toString());
            }
        }
    }
