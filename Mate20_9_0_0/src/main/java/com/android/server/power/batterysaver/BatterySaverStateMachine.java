...
public class BatterySaverStateMachine {
    ...
    private final Runnable mThresholdChangeLogger = new -$$Lambda$BatterySaverStateMachine$SSfmWJrD4RBoVg8A8loZrS-jhAo(this);
    ...
    public void onBootCompleted() {
        ...
        runOnBgThread(new -$$Lambda$BatterySaverStateMachine$fEidyt_9TXlXBpF6D2lhOOrfOC4(this));
    }
    ...
    public static /* synthetic */ void lambda$onBootCompleted$0(BatterySaverStateMachine batterySaverStateMachine) {
        ...
        cr.registerContentObserver(Global.getUriFor("low_power"), false, batterySaverStateMachine.mSettingsObserver, 0);
        cr.registerContentObserver(Global.getUriFor("low_power_sticky"), false, batterySaverStateMachine.mSettingsObserver, 0);
        cr.registerContentObserver(Global.getUriFor("low_power_trigger_level"), false, batterySaverStateMachine.mSettingsObserver, 0);
    ...
    protected int getGlobalSetting(String key, int defValue) {
        return Global.getInt(this.mContext.getContentResolver(), key, defValue);
    }
