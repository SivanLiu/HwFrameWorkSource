...
final class CarUserSwitchingDialog extends UserSwitchingDialog {
    ...
    void inflateContent() {
        ...
        if (bitmap != null) {
            ((ImageView) view.findViewById(16909506)).setImageDrawable(CircleFramedDrawable.getInstance(bitmap, res.getDimension(17104949)));
        }
        ((TextView) view.findViewById(16909505)).setText(res.getString(17039725));
        setView(view);
    }
}
