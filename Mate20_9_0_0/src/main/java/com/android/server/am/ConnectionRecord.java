...
final class ConnectionRecord {
    private static int[] BIND_ORIG_ENUMS = new int[]{1, 2, 4, DumpState.DUMP_VOLUMES, 8, 16, 32, 64, 128, DumpState.DUMP_HANDLE, 67108864, 134217728, 268435456, 536870912, 1073741824};
    ...
    void dump(PrintWriter pw, String prefix) {
        ...
        stringBuilder.append(this.binding);
        ...
        stringBuilder.append(this.conn.asBinder());
