...
class ActivityManagerDebugConfig {
    ...
    static {
        boolean z = true;
        boolean z2 = Log.HWINFO || (Log.HWModuleLog && Log.isLoggable("ActivityManager", 4));
        HWFLOW = z2;
        z2 = Log.HWLog || (Log.HWModuleLog && Log.isLoggable("ActivityManager", 3));
        DEBUG_ALL = z2;
        z2 = DEBUG_ALL_ACTIVITIES || DEBUG_HW_ACTIVITY;
        DEBUG_ADD_REMOVE = z2;
        z2 = DEBUG_ALL || DEBUG_HW_SERVICE;
        DEBUG_BACKGROUND_CHECK = z2;
        z2 = DEBUG_ALL || DEBUG_HW_BROADCAST;
        DEBUG_BROADCAST = z2;
        z2 = DEBUG_BROADCAST || DEBUG_HW_BROADCAST;
        DEBUG_BROADCAST_BACKGROUND = z2;
        z2 = DEBUG_BROADCAST || DEBUG_HW_BROADCAST;
        DEBUG_BROADCAST_LIGHT = z2;
        z2 = DEBUG_ALL || DEBUG_HW_ACTIVITY;
        DEBUG_CONFIGURATION = z2;
        z2 = DEBUG_ALL_ACTIVITIES || DEBUG_HW_ACTIVITY;
        DEBUG_IDLE = z2;
        z2 = DEBUG_ALL || DEBUG_HW_ACTIVITY;
        DEBUG_PAUSE = z2;
        z2 = DEBUG_ALL || DEBUG_HW_PROVIDER;
        DEBUG_PROVIDER = z2;
        z2 = DEBUG_ALL || DEBUG_HW_ACTIVITY;
        DEBUG_RESULTS = z2;
        z2 = DEBUG_ALL || DEBUG_HW_SERVICE;
        DEBUG_SERVICE = z2;
        z2 = DEBUG_ALL || DEBUG_HW_SERVICE;
        DEBUG_FOREGROUND_SERVICE = z2;
        z2 = DEBUG_ALL || DEBUG_HW_SERVICE;
        DEBUG_SERVICE_EXECUTING = z2;
        z2 = DEBUG_ALL || DEBUG_HW_ACTIVITY;
        DEBUG_STACK = z2;
        z2 = DEBUG_ALL_ACTIVITIES || DEBUG_HW_ACTIVITY;
        DEBUG_STATES = z2;
