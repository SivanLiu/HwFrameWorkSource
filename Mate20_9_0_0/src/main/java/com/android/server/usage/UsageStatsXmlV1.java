...
final class UsageStatsXmlV1 {
    ...
    private static void loadCountAndTime(XmlPullParser parser, EventTracker tracker) throws IOException, XmlPullParserException {
    ...
    public static void write(XmlSerializer xml, IntervalStats stats) throws IOException {
        ...
        i = stats.configurations.size();
        for (i2 = 0; i2 < i; i2++) {
            writeConfigStats(xml, stats, (ConfigurationStats) stats.configurations.valueAt(i2), stats.activeConfiguration.equals((Configuration) stats.configurations.keyAt(i2)));
        }
        xml.endTag(null, CONFIGURATIONS_TAG);
        xml.startTag(null, EVENT_LOG_TAG);
        i2 = stats.events != null ? stats.events.size() : 0;
        while (i3 < i2) {
