...
public class GestureBackTexture implements GLModel {
    ...
    public void prepare() {
        ...
        createTexture(this.mContext, 33751938);
    ...
    public void drawSelf() {
        if (this.mDraw) {
            ...
            if (this.mWidth < this.mHeight) {
                ...
                GLES30.glViewport(0, centerY - ((int) ((62.0f * viewRatio) / 2.0f)), this.mHeight, (int) (62.0f * viewRatio));
                refreshVertexLoc((float) this.mHeight, viewRatio);
            } else {
                viewRatio = ((float) this.mHeight) / 1080.0f;
                GLES30.glViewport(this.mWidth - this.mHeight, centerY - ((int) ((62.0f * viewRatio) / 2.0f)), this.mHeight, (int) (62.0f * viewRatio));
                refreshVertexLoc((float) this.mHeight, viewRatio);
            }
    ...
    private void refreshVertexLoc(float drawWidth, float viewRatio) {
        float startOffset = 2.0f * ((38.0f * viewRatio) / drawWidth);
