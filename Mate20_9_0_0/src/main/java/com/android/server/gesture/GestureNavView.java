...
public class GestureNavView extends SurfaceView {
    ...
    public static final class WindowConfig {
        ...
        public String toString() {
            ...
            stringBuilder.append("d.w:");
            stringBuilder.append(this.displayWidth);
            stringBuilder.append(", d.h:");
            stringBuilder.append(this.displayHeight);
            ...
            stringBuilder.append(this.usingNotch);
            stringBuilder.append(", l.x:");
            stringBuilder.append(this.locationOnScreenX);
            stringBuilder.append(", l.y:");
            stringBuilder.append(this.locationOnScreenY);
