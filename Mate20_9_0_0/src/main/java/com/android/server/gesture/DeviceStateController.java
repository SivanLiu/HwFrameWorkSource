...
public class DeviceStateController {
    ...
    private final BroadcastReceiver mUserSwitchedReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            String str = DeviceStateController.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("User swtiched receiver, userId=");
            stringBuilder.append(DeviceStateController.this.mCurrentUserId);
    ...
    public boolean isCurrentUserSetup() {
        return Secure.getIntForUser(this.mContentResolver, "user_setup_complete", 0, -2) != 0;
    }
    ...
    private void startListening(int userId) {
        ...
        filter = new IntentFilter(PackageManagerWrapper.ACTION_PREFERRED_ACTIVITY_CHANGED);
