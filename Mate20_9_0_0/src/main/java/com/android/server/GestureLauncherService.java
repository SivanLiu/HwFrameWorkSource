...
public class GestureLauncherService extends SystemService {
    ...
    private final class CameraLiftTriggerEventListener extends TriggerEventListener {
        ...
        /* synthetic */ CameraLiftTriggerEventListener(GestureLauncherService x0, AnonymousClass1 x1) {
            this();
        }
    ...
    private final class GestureEventListener implements SensorEventListener {
        ...
        /* synthetic */ GestureEventListener(GestureLauncherService x0, AnonymousClass1 x1) {
            this();
        }
    ...
    public static boolean isCameraLiftTriggerSettingEnabled(Context context, int userId) {
        if (!isCameraLiftTriggerEnabled(context.getResources()) || Secure.getIntForUser(context.getContentResolver(), "camera_lift_trigger_enabled", 1, userId) == 0) {
            return false;
        }
        return true;
    }
    ...
    public boolean interceptPowerKeyDown(KeyEvent event, boolean interactive, MutableBoolean outLaunched) {
        ...
        if (launched) {
            ...
            stringBuilder.append(powerTapInterval);
