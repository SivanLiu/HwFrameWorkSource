...
public final class AppHandler implements HwSysResHandler {
    ...
    public boolean execute(MultiTaskPolicy policy) {
        ...
        if (Utils.DEBUG || Log.HWINFO) {
            ...
            stringBuilder.append("execute: pkg ");
            stringBuilder.append(pkg);
            stringBuilder.append(" policy ");
            stringBuilder.append(policy.getPolicy());
    ...
    private boolean clearUserData(int callingUid, String pkg) {
        ...
        if (result) {
            ...
            stringBuilder.append("Successfully clearUserData of ");
            stringBuilder.append(pkg);
            ...
            str = TAG;
            stringBuilder = new StringBuilder();
            stringBuilder.append("Failed to clearUserData of ");
            stringBuilder.append(pkg);
            stringBuilder.append("/");
            stringBuilder.append(callingUid);
            Log.i(str, stringBuilder.toString());
    ...
    private boolean disableApp(int callingUid, String pkg) {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Successfully disableApp of ");
        stringBuilder.append(pkg);
        stringBuilder.append("/");
        stringBuilder.append(callingUid);
        Log.i(str, stringBuilder.toString());
