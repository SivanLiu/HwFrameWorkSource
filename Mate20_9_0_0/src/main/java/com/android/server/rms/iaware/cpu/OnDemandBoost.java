...
public class OnDemandBoost {
    ...
    public void setParams(Map<String, Integer> onDemandParaMap) {
        if (onDemandParaMap != null) {
            ...
            stringBuilder.append("setParms:");
            stringBuilder.append(this.mColdStartDuration);
            stringBuilder.append(" ");
            stringBuilder.append(this.mWindowSwitchDuration);
            stringBuilder.append(" ");
            stringBuilder.append(this.mColdStartOffDelay);
            stringBuilder.append(" ");
            stringBuilder.append(this.mWinSwitchoffDelay);
            AwareLog.d(str, stringBuilder.toString());
        }
    }

    private int getDurationTime(String durationType, Map<String, Integer> onDemandParaMap) {
        Integer time = (Integer) onDemandParaMap.get(durationType);
        if (time != null) {
    ...
    private int getOffDelayTime(String delayType, Map<String, Integer> onDemandParaMap) {
        Integer time = (Integer) onDemandParaMap.get(delayType);
        if (time != null) {
            int durationTime = time.intValue();
