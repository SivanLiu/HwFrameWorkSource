...
public class RuleAllow extends RuleBase {
    ...
    public boolean isMatch(Object... obj) {
        ...
        try {
            ...
            if (typeObj != null && (typeObj instanceof Integer) && this.mTypeList.contains(typeObj)) {
                return true;
            }
            return false;
            ...
            stringBuilder.append("ArrayIndexOutOfBoundsException, length is ");
    ...
    public String toString() {
        ...
        s.append("RuleAllow, mode : ");
        s.append(this.mMode);
        s.append("mTypeList : ");
        s.append(this.mTypeList.toString());
        return s.toString();
    }
}
