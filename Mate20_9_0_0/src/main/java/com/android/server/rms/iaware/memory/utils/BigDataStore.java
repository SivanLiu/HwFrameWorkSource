...
public final class BigDataStore {
    ...
    public void getMeminfoAllocCount() {
        ...
        try {
            ...
            while (temp2 < length) {
                try {
                    temp = totalAllocCount[temp2].split(":");
                    if (temp.length == 2) {
    ...
    public String getColdWarmLaunchData(boolean clear) {
        ...
        int size = i;
        for (i = 0; i < size; i++) {
            this.totalColdLaunch += ((Long) ((Pair) this.coldWarmLaunchSavedList.get(i)).first).longValue();
            this.totalWarmLaunch += ((Long) ((Pair) this.coldWarmLaunchSavedList.get(i)).second).longValue();
        }
        ...
        stringBuilder.append("getColdWarmLaunchData: ");
    ...
    public String getBgAppData(boolean clear) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("getBgAppData. clear: ");
        ...
        int size = i;
        for (i = 0; i < size; i++) {
            this.totalActivity += ((Long) ((Pair) this.bgProcessSavedList.get(i)).first).longValue();
            this.totalService += ((Long) ((Pair) this.bgProcessSavedList.get(i)).second).longValue();
        }
        sb.append("\"activity\":\"");
        ...
        stringBuilder2.append("getBgAppData: ");
    ...
    private void getBgAppDataInternal() {
        ...
        AwareAppMngSortPolicy policy = MemoryUtils.getAppMngSortPolicy(null, 3);
        if (policy != null) {
