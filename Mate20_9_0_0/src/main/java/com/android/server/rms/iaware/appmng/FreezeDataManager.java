...
public class FreezeDataManager {
    ...
    private List<String> updateHabitImEmail(int count) {
        ...
        List<String> freqTopIMList = AwareUserHabit.getInstance().getMostFreqAppByType(0, maxCount);
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("freqTopIMList is ");
        stringBuilder.append(freqTopIMList);
        AwareLog.d(str, stringBuilder.toString());
        return freqTopIMList == null ? new ArrayList() : freqTopIMList;
    }
}
