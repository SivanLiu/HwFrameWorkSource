...
public class IOExceptionHandle {
    ...
    public static final long BYTES_SIZE_1G = (Utils.DEBUG ? 10485760 : 1073741824);
    ...
    private static final long WRITTEN_BYTES_EXCEPTION_LIMIT = (12 * BYTES_SIZE_1G);
    ...
    public void handleIOException(ExceptionData exceptionData) {
        ...
        stringBuilder.append("handleIOException,the exception type:");
        stringBuilder.append(exceptionData.mExceptionType);
        Log.i(str, stringBuilder.toString());
        if (this.mInterrupt.checkInterruptAndReset()) {
            Log.e(TAG, "handleIOException,interrupted by user");
            return;
        }
        if (exceptionData.mExceptionType == 6) {
            uploadAppException(exceptionData.mData);
        }
    }

    private void uploadAppException(Object exceptionData) {
        List<AppExceptionData> appExceptionList = null;
        ...
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("uploadAppException,the exceptionData is invalid:");
