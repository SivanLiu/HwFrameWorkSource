...
public final class DumpHwConfigReader extends Assert {
    ...
    public static final void dumpConfigReader(PrintWriter pw, Context context) {
        ...
        try {
            ...
            stringBuilder.append("<I> getGroupNum --fail ");
        ...
        try {
            ...
            stringBuilder = new StringBuilder();
            stringBuilder.append("<I> getGroupName --fail ");
        ...
        try {
            ...
            stringBuilder = new StringBuilder();
            stringBuilder.append("<I> isCount --fail ");
        ...
        try {
            ...
            stringBuilder = new StringBuilder();
            stringBuilder.append("<I> getGroupSampleCycleNum --fail ");
        ...
        try {
            ...
            stringBuilder = new StringBuilder();
            stringBuilder.append("<I> getResConfig --fail ");
        ...
        try {
            ...
            stringBuilder = new StringBuilder();
            stringBuilder.append("<I> getSubTypeNum --fail ");
        ...
        try {
            ...
            stringBuilder = new StringBuilder();
            stringBuilder.append("<I> getSubTypeLevels --fail ");
        ...
        try {
            ...
            stringBuilder = new StringBuilder();
            stringBuilder.append("<I> getCountGroupID --fail ");
        ...
        try {
            ...
            stringBuilder = new StringBuilder();
            stringBuilder.append("<I> getSaveInterval --fail ");
        ...
        try {
            ...
            stringBuilder = new StringBuilder();
            stringBuilder.append("<I> getCountInterval --fail ");
        ...
        try {
            ...
            stringBuilder = new StringBuilder();
            stringBuilder.append("<I> getSampleBasePeriod --fail ");
            stringBuilder.append(e2222222222);
            pw.println(stringBuilder.toString());
        }
        try {
            dumpGetMaxKeepFiles();
            ...
            stringBuilder = new StringBuilder();
            stringBuilder.append("<I> getMaxKeepFiles --fail ");
        ...
        try {
            ...
            stringBuilder = new StringBuilder();
            stringBuilder.append("<I> getWhiteList --fail ");
            stringBuilder.append(e222222222222);
            pw.println(stringBuilder.toString());
        }
    }
    ...
    private static final void dumpGetResConfig() {
        ...
        for (int i3 = 0; i3 < 4; i3++) {
            assertResConfigEquals("dump NOTIFICATION", expect[i3], mConfig.getResConfig(groupIDs[0], i3));
            assertSubTypeAttrEquals("dump NOTIFICATION", expect[i3], groupIDs[0], i3);
        }
        ResourceConfig[] expect1 = new ResourceConfig[]{new ResourceConfig(0, 30, 2, 3, 1000, "APP_THIRDPARTY", 30, 40, 50, 0), new ResourceConfig(1, 500, 2, 3, 1000, "APP_HW", 30, 40, 50, 0), new ResourceConfig(2, 800, 1, 5, 1000, "APP_SYS", 30, 40, 50, 0), new ResourceConfig(3, 1000, 1, 5, 1000, "APP_TOTAL", 30, 40, 50, 0)};
        for (int i4 = 0; i4 < 4; i4++) {
            assertResConfigEquals("dump BROADCAST", expect1[i4], mConfig.getResConfig(groupIDs[1], i4));
            assertSubTypeAttrEquals("dump BROADCAST", expect1[i4], groupIDs[1], i4);
        }
        ResourceConfig[] expect2 = new ResourceConfig[]{new ResourceConfig(0, 200, 2, 0, 1000, "APP_THIRDPARTY", 30, 40, 50, 0), new ResourceConfig(1, 500, 2, 0, 1000, "APP_HW", 30, 40, 50, 0), new ResourceConfig(2, 1000, 1, 0, 0, "APP_SYS", 30, 40, 50, 0), new ResourceConfig(3, HwAPPQoEUtils.APP_TYPE_GENERAL_GAME, 2, 0, 0, "APP_TOTAL", 30, 40, 50, 0)};
        for (int i5 = 0; i5 < 4; i5++) {
            assertResConfigEquals("dump RECEIVER", expect2[i5], mConfig.getResConfig(groupIDs[2], i5));
            assertSubTypeAttrEquals("dump RECEIVER", expect2[i5], groupIDs[2], i5);
        }
        ...
        for (int i6 = 0; i6 < 4; i6++) {
            assertResConfigEquals("dump ALARM", expect3[i6], mConfig.getResConfig(groupIDs[3], i6));
            assertSubTypeAttrEquals("dump ALARM", expect3[i6], groupIDs[3], i6);
        }
        ResourceConfig[] expect4 = new ResourceConfig[]{new ResourceConfig(0, 200, 1, 0, 0, "APP_THIRDPARTY", -1, -1, -1, 0)};
        for (int i7 = 0; i7 < 1; i7++) {
            assertResConfigEquals("dump APPOPS", expect4[i7], mConfig.getResConfig(groupIDs[4], i7));
            assertSubTypeAttrEquals("dump APPOPS", expect4[i7], groupIDs[4], i7);
        }
        ResourceConfig[] expect6 = new ResourceConfig[]{new ResourceConfig(0, 300, 500, 0, 0, "APP_THIRDPARTY", 30, 40, 50, 0)};
        for (int i8 = 0; i8 < 1; i8++) {
            assertResConfigEquals("dump PIDS", expect6[i8], mConfig.getResConfig(groupIDs[6], i8));
            assertSubTypeAttrEquals("dump PIDS", expect6[i8], groupIDs[5], i8);
        }
        ResourceConfig[] expect7 = new ResourceConfig[]{new ResourceConfig(0, 50, 2, 0, 60000, "APP_THIRDPARTY", 30, 40, 50, 0), new ResourceConfig(1, 50, 2, 0, 60000, "APP_HW", 30, 40, 50, 0), new ResourceConfig(2, 200, 1, 0, 60000, "APP_SYS", 30, 40, 50, 0), new ResourceConfig(3, 1000, 1, 0, 60000, "APP_TOTAL", 30, 40, 50, 0)};
        for (int i9 = 0; i9 < 4; i9++) {
            assertResConfigEquals("dump CURSOR", expect7[i9], mConfig.getResConfig(groupIDs[7], i9));
            assertSubTypeAttrEquals("dump CURSOR", expect7[i9], groupIDs[6], i9);
        }
    ...
    private static final void assertSubTypeAttrEquals(String info, ResourceConfig expect, int groupID, int subType) {
        ...
        stringBuilder.append("dump getSubTypeName ");
        stringBuilder.append(info);
        assertEquals(stringBuilder.toString(), expect.getResouceName(), mConfig.getSubTypeName(groupID, subType));
        stringBuilder = new StringBuilder();
        stringBuilder.append("dump getResourceThreshold ");
        stringBuilder.append(info);
        assertEquals(stringBuilder.toString(), expect.getResourceThreshold(), mConfig.getResourceThreshold(groupID, subType));
        stringBuilder = new StringBuilder();
        stringBuilder.append("dump getResourceStrategy ");
        stringBuilder.append(info);
        assertEquals(stringBuilder.toString(), expect.getResourceStrategy(), mConfig.getResourceStrategy(groupID, subType));
        stringBuilder = new StringBuilder();
        stringBuilder.append("dump getResourceMaxPeroid ");
        stringBuilder.append(info);
        assertEquals(stringBuilder.toString(), expect.getResourceMaxPeroid(), mConfig.getResourceMaxPeroid(groupID, subType));
        stringBuilder = new StringBuilder();
        stringBuilder.append("dump getLoopInterval ");
        stringBuilder.append(info);
        assertEquals(stringBuilder.toString(), expect.getLoopInterval(), mConfig.getLoopInterval(groupID, subType));
        stringBuilder = new StringBuilder();
        stringBuilder.append("dump getNormalThreshold ");
        stringBuilder.append(info);
        assertEquals(stringBuilder.toString(), expect.getResouceNormalThreshold(), mConfig.getNormalThreshold(groupID, subType));
        stringBuilder = new StringBuilder();
        stringBuilder.append("dump getWarningThreshold ");
        stringBuilder.append(info);
        assertEquals(stringBuilder.toString(), expect.getResouceWarningThreshold(), mConfig.getWarningThreshold(groupID, subType));
        stringBuilder = new StringBuilder();
        stringBuilder.append("dump getUrgentThreshold ");
        stringBuilder.append(info);
        assertEquals(stringBuilder.toString(), expect.getResouceUrgentThreshold(), mConfig.getUrgentThreshold(groupID, subType));
    }
    ...
    private static final void dumpGetWhiteList() {
        ...
        for (int i = 0; i < groupIDs.length; i++) {
            ...
            assertEquals(stringBuilder.toString(), expect[i], mConfig.getWhiteList(groupIDs[i]));
        }
    }
}
