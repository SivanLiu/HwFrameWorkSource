...
class CPUGameScene {
    ...
    public void enterGameSceneMsg() {
        if (this.mIsFeatureEnable.get() && this.mCPUFeatureHandler != null) {
            ...
            this.mCPUFeatureHandler.sendEmptyMessageDelayed(CPUFeature.MSG_ENTER_GAME_SCENE, HwArbitrationDEFS.NotificationMonitorPeriodMillis);
        }
    }
    ...
    public void exitGameSceneMsg() {
        if (this.mIsFeatureEnable.get() && this.mCPUFeatureHandler != null) {
            ...
            if (this.mSetGameScene.get()) {
                ...
                this.mCPUFeatureHandler.sendEmptyMessageDelayed(CPUFeature.MSG_EXIT_GAME_SCENE, HwArbitrationDEFS.NotificationMonitorPeriodMillis);
            }
        }
    }
