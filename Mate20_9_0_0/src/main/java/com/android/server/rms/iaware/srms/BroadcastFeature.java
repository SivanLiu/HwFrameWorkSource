...
public class BroadcastFeature extends RFeature {
    ...
    /* renamed from: com.android.server.rms.iaware.srms.BroadcastFeature$1 */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                $SwitchMap$android$rms$iaware$AwareConstant$ResourceType[ResourceType.RESOURCE_INSTALLER_MANAGER.ordinal()] = 3;
    ...
    public boolean enableFeatureEx(int realVersion) {
        if (realVersion < 2) {
            ...
            stringBuilder.append(", BroadcastFeature baseVersion: ");
    ...
    public String getBigDataByVersion(int iawareVer, boolean forBeta, boolean clearData) {
        if (iawareVer < 2) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Feature based on IAware2.0, getBigDataByVersion return null. iawareVer: ");
