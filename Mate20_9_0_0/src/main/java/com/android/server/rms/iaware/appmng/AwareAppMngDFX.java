    ...
    private void addTrackeKillInfo(AwareProcessInfo processInfo, boolean cleanRes, int type) {
        if (processInfo != null) {
            synchronized (this.mAwareAppMngDfxData) {
                ...
                AwareAppMngDfxData awareAppMngDfxData = new AwareAppMngDfxData(processInfo.mProcInfo.mPackageName, processInfo.mProcInfo.mProcessName, processInfo.mSubClassRate, processInfo.mClassRate, processInfo.getRestartFlag(), cleanRes);
                awareAppMngDfxData = (AwareAppMngDfxData) this.mAwareAppMngDfxData.get(awareAppMngDfxData.getKey());
                if (awareAppMngDfxData == null) {
                    awareAppMngDfxData = awareAppMngDfxData;
                    this.mAwareAppMngDfxData.put(awareAppMngDfxData.getKey(), awareAppMngDfxData);
                }
                awareAppMngDfxData.addTrackeKillInfo(type);
            }
        }
    }
