...
public class MemoryReader {
    ...
    public static long getPssForPid(int pid) {
        ...
        String statmFile = new StringBuilder();
        statmFile.append("/proc/");
        statmFile.append(pid);
        statmFile.append("/statm");
        long[] statmData = new long[2];
        if (Process.readProcFile(statmFile.toString(), PROCESS_STATM_FORMAT, null, statmData, null)) {
    ...
    private static String parseMemData(long[] data) {
        ...
        stringBuilder.append("parseMemData: ");
