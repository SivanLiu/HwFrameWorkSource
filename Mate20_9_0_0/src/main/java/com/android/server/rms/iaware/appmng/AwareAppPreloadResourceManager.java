...
public final class AwareAppPreloadResourceManager {
    ...
    private void parseSwitchValue(Item item, String featureName) {
            ...
            for (Item item : itemList) {
                if (item != null) {
                    ...
                    if (configProperties != null) {
                        String featureName = (String) configProperties.get(FEATURE_ITEM);
                        if (featureName == null) {
                            break;
                        }
    ...
    public void enable() {
        SystemProperties.set("persist.sys.iaware.switch.BitmapDeocodeCache", Boolean.toString(this.mSwitchOfBitmapDeocodeCache));
        SystemProperties.set("persist.sys.iaware.size.BitmapDeocodeCache", Integer.toString(this.mSizeOfBitmapDeocodeCache));
    }

    public void disable() {
        SystemProperties.set("persist.sys.iaware.switch.BitmapDeocodeCache", Boolean.toString(false));
        SystemProperties.set("persist.sys.iaware.size.BitmapDeocodeCache", Integer.toString(0));
    }
}
