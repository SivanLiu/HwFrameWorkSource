...
public class APPFreezeFeature extends RFeature {
    ...
    /* renamed from: com.android.server.rms.iaware.feature.APPFreezeFeature$1 */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                $SwitchMap$android$rms$iaware$AwareConstant$ResourceType[ResourceType.RESOURCE_STATUS_BAR.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                $SwitchMap$android$rms$iaware$AwareConstant$ResourceType[ResourceType.RESOURCE_INSTALLER_MANAGER.ordinal()] = 4;
