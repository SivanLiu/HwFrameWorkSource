...
class SipSessionGroup implements SipListener {
        ...
        class SipKeepAlive extends SipSessionAdapter implements Runnable {
            ...
            void start(int interval, KeepAliveProcessCallback callback) {
                if (!this.mRunning) {
                    ...
                    stringBuilder.append("start keepalive:");
     ...
     */
                ...
                synchronized (SipSessionGroup.this) {
                    if (this.mRunning) {
                        try {
                            ...
                            stringBuilder.append(SipSessionGroup.this.mLocalProfile.getUriString());
                            sipSessionGroup.loge(stringBuilder.toString(), SipSessionGroup.this.getRootCause(t));
                            if (this.mRunning) {
            ...
            private boolean parseOptionsResult(EventObject evt) {
                ...
                if (rPort != -1) {
                    ...
                    if (this.mRPort != rPort) {
                        ...
                        StringBuilder stringBuilder = new StringBuilder();
                        stringBuilder.append("rport is the same: ");
                        stringBuilder.append(rPort);
                        log(stringBuilder.toString());
                    }
                } else {
        ...
        public void setListener(ISipSessionListener listener) {
            ISipSessionListener listener2;
            SipSessionListenerProxy sipSessionListenerProxy = this.mProxy;
            if (listener instanceof SipSessionListenerProxy) {
                listener2 = ((SipSessionListenerProxy) listener).getListener();
            } else {
                listener2 = listener;
            }
            sipSessionListenerProxy.setListener(listener2);
        }
            ...
            new Thread(new Runnable() {
                public void run() {
                    try {
                        ...
                        stringBuilder.append(SipSessionGroup.this.mLocalProfile.getUriString());
                        sipSessionGroup.loge(stringBuilder.toString(), SipSessionGroup.this.getRootCause(e));
        ...
        private void processCommand(EventObject command) throws SipException {
            ...
            if (!process(command)) {
                ...
                stringBuilder2.append("cannot initiate a new transaction to execute: ");
                stringBuilder2.append(command);
                onError(-9, stringBuilder2.toString());
            }
        }
        ...
        public String toString() {
            try {
                ...
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append(s.substring(s.indexOf("@")));
                stringBuilder.append(":");
                stringBuilder.append(State.toString(this.mState));
     ...
     */
        ...
        public boolean process(EventObject evt) throws SipException {
            if (SipSessionGroup.isLoggable(this, evt)) {
                ...
                stringBuilder.append(SipSessionGroup.logEvt(evt));
                log(stringBuilder.toString());
            }
            synchronized (SipSessionGroup.this) {
                boolean z = false;
        ...
        private void processDialogTerminated(DialogTerminatedEvent event) {
            ...
            stringBuilder.append(this.mDialog);
            stringBuilder.append(", terminated=");
            stringBuilder.append(event.getDialog());
            log(stringBuilder.toString());
        }
        ...
        private boolean isCurrentTransaction(TransactionTerminatedEvent event) {
            ...
            if (current != target && this.mState != 9) {
                ...
                stringBuilder.append(toString(current));
                stringBuilder.append(", target=");
                stringBuilder.append(toString(target));
                log(stringBuilder.toString());
                return false;
                ...
                StringBuilder stringBuilder2 = new StringBuilder();
                stringBuilder2.append("transaction terminated: ");
                stringBuilder2.append(toString(current));
        ...
        private void processTransactionTerminated(TransactionTerminatedEvent event) {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Transaction terminated early: ");
            stringBuilder.append(this);
            log(stringBuilder.toString());
        ...
        private int getExpiryTime(Response response) {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Expiry time = ");
        ...
        private boolean handleAuthentication(ResponseEvent event) throws SipException {
            ...
            if (getNonceFromResponse(response) == null) {
                ...
                if (SipSessionGroup.isLoggable(this, event)) {
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("   authentication retry count=");
                    stringBuilder.append(this.mAuthenticationRetryCount);
                    log(stringBuilder.toString());
                }
                return SSI_DBG;
            } else {
    ...
    synchronized void reset() throws SipException {
        ...
        if (TextUtils.isEmpty(server)) {
            ...
            properties.setProperty("javax.sip.OUTBOUND_PROXY", stringBuilder.toString());
        }
    ...
    private synchronized void process(EventObject event) {
        ...
        try {
            ...
            if (isLoggable && processed) {
                ...
                stringBuilder.append(State.toString(session.mState));
                log(stringBuilder.toString());
            }
        } catch (Throwable e) {
            StringBuilder stringBuilder2 = new StringBuilder();
            stringBuilder2.append("process: error event=");
            stringBuilder2.append(event);
            loge(stringBuilder2.toString(), getRootCause(e));
            session.onError(e);
        }
        return;
    }
