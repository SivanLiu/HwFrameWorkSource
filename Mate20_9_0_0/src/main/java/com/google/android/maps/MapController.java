...
public final class MapController implements OnKeyListener {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$google$android$maps$MapController$HorizPanState = new int[HorizPanState.values().length];
        static final /* synthetic */ int[] $SwitchMap$com$google$android$maps$MapController$VertPanState = new int[VertPanState.values().length];

        static {
            try {
                $SwitchMap$com$google$android$maps$MapController$VertPanState[VertPanState.UP.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$com$google$android$maps$MapController$VertPanState[VertPanState.DOWN.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$com$google$android$maps$MapController$VertPanState[VertPanState.NONE.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                $SwitchMap$com$google$android$maps$MapController$HorizPanState[HorizPanState.LEFT.ordinal()] = 1;
            } catch (NoSuchFieldError e4) {
            }
            try {
                $SwitchMap$com$google$android$maps$MapController$HorizPanState[HorizPanState.RIGHT.ordinal()] = 2;
            } catch (NoSuchFieldError e5) {
            }
            try {
                $SwitchMap$com$google$android$maps$MapController$HorizPanState[HorizPanState.NONE.ordinal()] = 3;
    ...
    public boolean onKey(View v, int keyCode, KeyEvent event) {
        switch (event.getAction()) {
            ...
            default:
                ...
                stringBuilder.append("Unknown key action: ");
