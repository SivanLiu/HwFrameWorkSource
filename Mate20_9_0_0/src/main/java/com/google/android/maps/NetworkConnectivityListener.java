...
class NetworkConnectivityListener {
    ...
    private class ConnectivityBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            stringBuilder.append("onReceived() called with ");
            stringBuilder.append(NetworkConnectivityListener.this.mState.toString());
            stringBuilder.append(" and ");
            stringBuilder.append(intent);
            Log.w("NetworkConnectivityListener", stringBuilder.toString());
        }
    }
