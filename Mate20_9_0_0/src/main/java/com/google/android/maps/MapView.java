...
public class MapView extends ViewGroup {
    private static final String KEY_CENTER_LATITUDE;
    private static final String KEY_CENTER_LONGITUDE;
    private static final String KEY_ZOOM_DISPLAYED;
    private static final String KEY_ZOOM_LEVEL;
    ...
    public static class LayoutParams extends android.view.ViewGroup.LayoutParams {
        ...
        public String debug(String output) {
            ...
            stringBuilder.append("MapView.LayoutParams={width=");
            ...
            stringBuilder.append(this.point.getLatitudeE6());
            stringBuilder.append(" lng=");
            stringBuilder.append(this.point.getLongitudeE6());
    ...
    static {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(MapView.class.getName());
        stringBuilder.append(".zoomDisplayed");
        KEY_ZOOM_DISPLAYED = stringBuilder.toString();
        stringBuilder = new StringBuilder();
        stringBuilder.append(MapView.class.getName());
        stringBuilder.append(".centerLatitude");
        KEY_CENTER_LATITUDE = stringBuilder.toString();
        stringBuilder = new StringBuilder();
        stringBuilder.append(MapView.class.getName());
        stringBuilder.append(".centerLongitude");
        KEY_CENTER_LONGITUDE = stringBuilder.toString();
        stringBuilder = new StringBuilder();
        stringBuilder.append(MapView.class.getName());
        stringBuilder.append(".zoomLevel");
        KEY_ZOOM_LEVEL = stringBuilder.toString();
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (this.mReticle != null) {
            ...
            this.mReticle.setBounds(left, top, this.mReticle.getIntrinsicWidth() + left, this.mReticle.getIntrinsicHeight() + top);
        }
    }
    ...
    protected final void onDraw(Canvas canvas) {
        ...
        boolean fetchTiles = null == null;
        if (this.mZoomHelper.shouldDrawMap(drawTime)) {
            drawAgain = false | (1 ^ drawMap(canvas, fetchTiles));
        }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                ...
                i2 = this.mPaddingLeft + x;
                int childTop = this.mPaddingTop + y;
                child.layout(i2, childTop, i2 + width, childTop + height);
            }
        }
