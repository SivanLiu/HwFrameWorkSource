...
public class PduHeaders {
        ...
        switch (field) {
            ...
            case 149:
                if (value < 128 || value > 135) {
                    ...
                    stringBuilder.append("Invalide status value ");
                    stringBuilder.append(value);
                    Log.e("PduHeaders", stringBuilder.toString());
                    break;
                }
            case 153:
    ...
    protected void setEncodedStringValue(EncodedStringValue value, int field) {
        if (value != null) {
            if (!(field == 137 || field == 147 || field == 150 || field == 154 || field == 160 || field == MM_FLAGS || field == STORE_STATUS_TEXT)) {
                switch (field) {
    ...
    protected void setLongInteger(long value, int field) {
        if (!(field == 133 || field == 142 || field == 157 || field == REPLY_CHARGING_SIZE || field == PREVIOUSLY_SENT_DATE || field == MESSAGE_COUNT || field == START || field == LIMIT)) {
            switch (field) {
                case 135:
                case 136:
                    break;
