...
public class GLImpl implements GL10, GL10Ext, GL11, GL11Ext, GL11ExtensionPack {
    ...
    public void glColorPointer(int size, int type, int stride, Buffer pointer) {
        ...
        if ((type == GL10.GL_FLOAT || type == GL10.GL_UNSIGNED_BYTE || type == GL10.GL_FIXED) && stride >= 0) {
    ...
    public void glNormalPointer(int type, int stride, Buffer pointer) {
        ...
        if ((type == GL10.GL_FLOAT || type == GL10.GL_BYTE || type == GL10.GL_SHORT || type == GL10.GL_FIXED) && stride >= 0) {
