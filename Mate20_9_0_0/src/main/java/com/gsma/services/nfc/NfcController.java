...
public class NfcController {
    ...
    NfcController(Context context) {
        ...
        if (pm.hasSystemFeature("android.hardware.nfc.hce") || pm.hasSystemFeature("android.hardware.nfc.hcef")) {
            z = true;
        }
    ...
    private String getRandomString() {
        int randomNum = 10000 + new SecureRandom().nextInt(10000);
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("service");
        stringBuilder.append(Integer.toString(randomNum));
    ...
    public OffHostService defineOffHostService(String description, String SEName) throws UnsupportedOperationException, IllegalArgumentException {
        if (this.mIsHceCapable) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("defineOffHostService description=");
            ...
            if (description == null) {
                ...
                List<String> secureElementList2 = this.mNxpHandset.getAvailableSecureElements(146);
                if (secureElementList2.size() > 0) {
                    int i = 0;
                    while (i < secureElementList2.size() && !((String) secureElementList2.get(i)).equals(sSEName)) {
                        i++;
                    }
                    if (i == secureElementList2.size()) {
                ...
                stringBuilder2.append("defineOffHostService, new offHostService is ");
                stringBuilder2.append(offHostService.toString());
    ...
    public OffHostService[] getOffHostServices() {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("getOffHostServices packageName=");
        ...
        Iterator it = mNxpOffhost.iterator();
        while (it.hasNext()) {
            mOffHostList.add(new OffHostService((NxpOffHostService) it.next()));
        }
