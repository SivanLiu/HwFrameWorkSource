...
public class OffscreenGraphicsContext {
    ...
    public static void init() {
        int[] confAttr = new int[]{12352, 64, 12339, 1, 12324, 8, 12323, 8, 12321, 8, 12322, 8, 12344};
        int[] ctxAttr = new int[]{12440, 3, 12344};
        int[] surfaceAttr = new int[]{12375, 1, 12374, 1, 12344};
        int[] eglMajVers = new int[]{0, 0};
        int[] eglMinVers = new int[]{0, 0};
        int[] numConfigs = new int[]{0, 0};
        ...
        EGL14.eglChooseConfig(eglDisp, confAttr, 0, conf, 0, 1, numConfigs, 0);
        eglConf = conf[0];
        eglCtx = EGL14.eglCreateContext(eglDisp, eglConf, EGL14.EGL_NO_CONTEXT, ctxAttr, 0);
        eglSurface = EGL14.eglCreatePbufferSurface(eglDisp, eglConf, surfaceAttr, 0);
