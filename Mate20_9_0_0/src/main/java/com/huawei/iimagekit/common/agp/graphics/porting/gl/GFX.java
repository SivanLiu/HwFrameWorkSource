...
public class GFX {
    ...
    public enum CommandBufferLevel {
        ...
        private CommandBufferLevel(int v) {
            this.v = v;
        }
    }
    ...
    public enum FramebufferTarget {
        ...
        private FramebufferTarget(int v) {
            this.v = v;
        }
    }
