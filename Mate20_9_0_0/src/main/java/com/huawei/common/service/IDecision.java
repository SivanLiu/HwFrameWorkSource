            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    case 1:
                        ...
                        executeEvent(data.readHashMap(getClass().getClassLoader()), com.huawei.common.service.IDecisionCallback.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        return true;
                    case 2:
                        data.enforceInterface(descriptor);
                        _result = insertBusinessData(data.readHashMap(getClass().getClassLoader()));
                        reply.writeNoException();
                        reply.writeInt(_result);
                        return true;
                    case 3:
                        data.enforceInterface(descriptor);
                        _result = removeBusinessData(data.readString(), data.readString());
                        reply.writeNoException();
                        reply.writeInt(_result);
                        return true;
                    case 4:
                    ...
                    case 5:
                        data.enforceInterface(descriptor);
                        _arg1 = unRegister(data.readString());
                        reply.writeNoException();
                        reply.writeInt(_arg1);
                        return true;
                    case 6:
                        data.enforceInterface(descriptor);
                        _result = update(data.readString(), data.readString());
                        reply.writeNoException();
                        reply.writeInt(_result);
                        return true;
                    case 7:
                        data.enforceInterface(descriptor);
                        int _result4 = log(data.readString(), data.readString(), data.readInt());
                        reply.writeNoException();
                    ...
                    case 8:
                        ...
                        _result2 = batchLog(_arg0, data.readArrayList(cl2), data.readArrayList(cl2));
                        reply.writeNoException();
                    ...
                    case 9:
                        ...
                        _result2 = infer(_arg0, _arg12, _arg2);
                        reply.writeNoException();
                        reply.writeInt(_result2);
