...
public class ReguExp extends Regexs {
    ...
    private static final String cit1;
    private static final String cit2;
    ...
    static {
        StringBuilder stringBuilder = new StringBuilder(",?\\s{0,4}(((?:(?<!\\d)\\d{5}(?!\\d))\\s{0,4},?\\s{0,4})|(?:(?:(?i)P\\.C\\.|CP|C\\.P\\.)?\\s{0,4}(?:(?<!\\d)\\d{5}(?!\\d))\\s{0,4}))");
        stringBuilder.append(KEY_CIT);
        stringBuilder.append("(?:");
        stringBuilder.append(con3);
        stringBuilder.append("(?:\\s{0,4},\\s{0,4}|\\s{0,4})");
        stringBuilder.append(")");
        stringBuilder.append("((");
        stringBuilder.append(tokenkey);
        stringBuilder.append(provincekey);
        stringBuilder.append(")?");
        stringBuilder.append(tokenkey);
        stringBuilder.append(countrykey);
        stringBuilder.append(")?");
        cit1 = stringBuilder.toString();
        stringBuilder = new StringBuilder(",?\\s{0,4}");
        stringBuilder.append(KEY_CIT);
        stringBuilder.append("(?:");
        stringBuilder.append(con3);
        stringBuilder.append("(?:\\s{0,4},\\s{0,4}|\\s{1,4})");
        stringBuilder.append("(?:\\s{0,4},?\\s{0,4}(?<!\\d)\\d{5}(?!\\d))?|");
        stringBuilder.append("(?:\\s{0,4}(?:(?i)P\\.C\\.|CP|C\\.P\\.)?\\s{0,4}(?:(?<!\\d)\\d{5})(?!\\d))");
        stringBuilder.append(")");
        stringBuilder.append("((");
        stringBuilder.append(tokenkey);
        stringBuilder.append(provincekey);
