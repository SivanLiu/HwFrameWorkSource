...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
    ...
    public int readUtf8CodePoint() throws EOFException {
        if (this.size != 0) {
            ...
            if ((b0 & AppOpsManagerEx.TYPE_MICROPHONE) == 0) {
                ...
                byteCount = 1;
                min = 0;
            } else if ((b0 & 224) == HwCarrierConfigManager.HD_ICON_MASK_DIALER) {
                codePoint = b0 & 31;
                byteCount = 2;
            ...
            if (this.size >= ((long) byteCount)) {
                ...
                while (i < byteCount) {
                    ...
                    if ((b & HwCarrierConfigManager.HD_ICON_MASK_DIALER) == AppOpsManagerEx.TYPE_MICROPHONE) {
    ...
    public Buffer writeUtf8(String string, int beginIndex, int endIndex) {
        ...
        if (string == null) {
            ...
            while (i < endIndex) {
                ...
                int segmentOffset;
                if (c < AppOpsManagerEx.TYPE_MICROPHONE) {
                    Segment tail = writableSegment(1);
                    byte[] data = tail.data;
                    ...
                    writeByte(AppOpsManagerEx.TYPE_MICROPHONE | (c & 63));
                    i++;
                    ...
                    if (c > 56319 || segmentOffset < 56320 || segmentOffset > 57343) {
                        ...
                        writeByte(AppOpsManagerEx.TYPE_MICROPHONE | (codePoint & 63));
                        i += 2;
                    }
                }
            }
    ...
    public Buffer writeUtf8CodePoint(int codePoint) {
        StringBuilder stringBuilder;
        if (codePoint < AppOpsManagerEx.TYPE_MICROPHONE) {
            writeByte(codePoint);
    ...
    /* JADX WARNING: Missing block: B:30:0x00a6, code skipped:
            r18 = r3;
            r21 = r4;
            r7 = r5;
                ...
                while (offset2 < resultLimit) {
                    ...
                    while (true) {
                        ...
                        if (data[pos2] == b0) {
                            ...
                            data2 = data;
                            s2 = s3;
                            if (rangeEquals(s3, pos2 + 1, byteString, 1, bytesSize)) {
                                return ((long) (pos3 - s2.pos)) + offset2;
                            }
                        } else {
                            pos3 = pos2;
                            segmentLimit2 = segmentLimit;
        ...
        if (fromIndex >= 0) {
            ...
            if (targetBytes.size() == 2) {
                ...
                while (offset < buffer.size) {
                    byte[] data = s.data;
                    limit = s.limit;
                    for (pos = (int) ((((long) s.pos) + fromIndex2) - offset); pos < limit; pos++) {
                        b = data[pos];
                        if (b == b0 || b == b1) {
                            return ((long) (pos - s.pos)) + offset;
                        }
