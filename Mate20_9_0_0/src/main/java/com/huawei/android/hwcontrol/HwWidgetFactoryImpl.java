...
public class HwWidgetFactoryImpl implements Factory {
        ...
        if (context instanceof Activity) {
            ...
            if (ac.getWindow() instanceof PhoneWindow) {
                ...
                if (pw.getIsForcedStatusBarColor()) {
                    ...
                    stringBuilder.append("getAppDefinedPrimaryColor has Color=0x");
                    stringBuilder.append(Integer.toHexString(forcedColor));
                    stringBuilder.append(" set by setStatusBarColor()");
    ...
    public int getSuggestionForgroundColorStyle(int colorBackground) {
        ...
        int i22 = Color.green(colorBackground);
        int b = Color.blue(colorBackground);
        int maxValue = i22 > b ? i22 : b;
        int minValue = i22 < b ? i22 : b;
    ...
    public AbsHwDecorCaptionView getHwDecorCaptionView(LayoutInflater inflater) {
        ...
        return (AbsHwDecorCaptionView) inflater.inflate(34013288, null);
    }
    ...
    public void autoTextSize(TextView textview, Context context, float originTextSize) {
        if (textview == null || context == null) {
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("autoTextSize, textview = ");
        ...
        if (maxSizeInPix <= 0 || minSizeInPix <= 0 || step <= 0.0f) {
            ...
            stringBuilder2.append("maxSizeInPix = ");
            stringBuilder2.append(maxSizeInPix);
            stringBuilder2.append(", minSizeInPix = ");
            stringBuilder2.append(minSizeInPix);
            stringBuilder2.append(", step = ");
            stringBuilder2.append(step);
        ...
        if (textview.getMaxLines() == 1 && maxSizeInPix > minSizeInPix) {
            ...
            autoSizeTextSizesInPx[autoSizeValuesLength - 1] = maxSizeInPix;
    ...
    public Drawable getDesireCompoundButtonDrawable(Context context, CompoundButton view, TypedArray ta, int defButtonArrayIndex) {
        ...
        } else if (!IS_EMUI_LITE || !isHwTheme(context)) {
            return buttonDrawable;
        } else {
