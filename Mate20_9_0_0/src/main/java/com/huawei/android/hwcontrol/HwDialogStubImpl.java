...
public class HwDialogStubImpl implements HwDialogStub {
            ...
            if (!(HwDialogStubImpl.this.mWindow == null || HwDialogStubImpl.this.mAnimator == null || HwDialogStubImpl.this.mAnimator.isRunning())) {
                ...
                if (view == null) {
                    ...
                    if (!ignoreChange) {
                        ...
                        boolean z = HwDialogStubImpl.this.mIsEverReset || isChangeY;
                        hwDialogStubImpl.mIsInputMethodOn = z;
                    }
     ...
     */
                    ...
                    stringBuilder.append("showDialogFactory sensor register fail, isRegister = ");
                    stringBuilder.append(isRegister);
