...
public abstract class j {
    public static Field[] cb(Class cls) {
        Object obj = null;
        if (cls.getSuperclass() != null) {
            obj = cb(cls.getSuperclass());
        }
    ...
    public static Class cd(Field field) {
    ...
    private static Class ce(Field field, int i) {
        int i2 = 0;
        ...
        try {
            ...
            c.eo("PushLog3413", "getType ClassNotFoundException");
            return null;
        } catch (Exception e2) {
            c.eo("PushLog3413", "getType Exception");
            return null;
        }
    }

    public static Field cc(Field field, boolean z) {
