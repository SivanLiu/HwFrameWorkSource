...
public class RDAManagerEx {
    ...
    public void registerDevModeMethod(int deviceId, IDeviceSettingCallbackEx callback, Bundle args) {
        HwSysResManager.getInstance().registerDevModeMethod(deviceId, callback != null ? callback.getDeviceSettingCallback() : null, args);
    }

    public void unregisterDevModeMethod(int deviceId, IDeviceSettingCallbackEx callback, Bundle args) {
        HwSysResManager.getInstance().unregisterDevModeMethod(deviceId, callback != null ? callback.getDeviceSettingCallback() : null, args);
    }
}
