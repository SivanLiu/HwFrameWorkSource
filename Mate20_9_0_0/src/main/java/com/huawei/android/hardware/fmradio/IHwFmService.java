        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 2:
                        data.enforceInterface(descriptor);
                        _result2 = audioControl(data.readInt(), data.readInt(), data.readInt());
                        reply.writeNoException();
                    ...
                    case 6:
                        data.enforceInterface(descriptor);
                        _result3 = setFreq(data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case 7:
                        data.enforceInterface(descriptor);
                        _result3 = getControl(data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case 8:
                        data.enforceInterface(descriptor);
                        _result2 = setControl(data.readInt(), data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result2);
                        return true;
                    case 9:
                        data.enforceInterface(descriptor);
                        _result3 = startSearch(data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case 10:
                        ...
                        _result4 = getBuffer(_arg0, _arg1, data.readInt());
                        reply.writeNoException();
                    ...
                    case 12:
                        data.enforceInterface(descriptor);
                        _result2 = setBand(data.readInt(), data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result2);
                        return true;
                    case 13:
                    ...
                    case 15:
                        data.enforceInterface(descriptor);
                        _result3 = setMonoStereo(data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case 16:
                        ...
                        _result4 = getRawRds(_arg0, _arg1, data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result4);
                        reply.writeByteArray(_arg1);
                        return true;
                    ...
                    case 18:
                        data.enforceInterface(descriptor);
                        _result3 = getAudioQuilty(data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case 19:
                        data.enforceInterface(descriptor);
                        _result3 = setFmSnrThresh(data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case 20:
                        data.enforceInterface(descriptor);
                        _result3 = setFmRssiThresh(data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case 21:
