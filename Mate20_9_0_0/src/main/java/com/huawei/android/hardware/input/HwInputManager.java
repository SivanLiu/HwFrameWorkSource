...
public class HwInputManager {
    private static final Singleton<IHwInputManager> IInputManagerSingleton = new Singleton<IHwInputManager>() {
        protected IHwInputManager create() {
            try {
                return Stub.asInterface(IInputManager.Stub.asInterface(ServiceManager.getService("input")).getHwInnerService());
    ...
    private class HwTHPEventListenerDelegate extends IHwTHPEventListener.Stub implements Callback {
    ...
    public void registerListener(HwTHPEventListener listener, Handler handler) {
        if (listener != null) {
            synchronized (this.mDelegates) {
                if (((HwTHPEventListenerDelegate) this.mDelegates.get(listener)) != null) {
    ...
    public void unregisterListener(HwTHPEventListener listener) {
        if (listener != null) {
            synchronized (this.mDelegates) {
                HwTHPEventListenerDelegate delegate = (HwTHPEventListenerDelegate) this.mDelegates.get(listener);
                if (delegate == null) {
