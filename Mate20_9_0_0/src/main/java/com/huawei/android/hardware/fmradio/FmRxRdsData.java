...
public class FmRxRdsData {
    ...
    public int rdsOn(boolean on) {
        ...
        stringBuilder.append("In rdsOn: RDS is ");
    ...
    public int rdsOptions(int rdsMask) {
        ...
        String str = LOGTAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("In rdsOptions: rdsMask: ");
        stringBuilder.append(rdsMask);
        Log.d(str, stringBuilder.toString());
    ...
    public int enableAFjump(boolean AFenable) {
        String str = LOGTAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("In enableAFjump: AFenable: ");
        stringBuilder.append(AFenable);
        Log.d(str, stringBuilder.toString());
        int rds_group_mask = FmReceiverWrapper.getControlNative(this.mFd, V4L2_CID_PRIVATE_TAVARUA_RDSGROUP_PROC);
        String str2 = LOGTAG;
        StringBuilder stringBuilder2 = new StringBuilder();
        stringBuilder2.append("In enableAFjump: rds_group_mask: ");
        stringBuilder2.append(rds_group_mask);
