        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                switch (code) {
                    ...
                    case 2:
                        data.enforceInterface(descriptor);
                        registerListener(com.huawei.android.hardware.input.IHwTHPEventListener.Stub.asInterface(data.readStrongBinder()), data.readStrongBinder());
                        reply.writeNoException();
                        return true;
                    case 3:
                        data.enforceInterface(descriptor);
                        unregisterListener(com.huawei.android.hardware.input.IHwTHPEventListener.Stub.asInterface(data.readStrongBinder()), data.readStrongBinder());
                        reply.writeNoException();
                        return true;
                    case 4:
                        data.enforceInterface(descriptor);
