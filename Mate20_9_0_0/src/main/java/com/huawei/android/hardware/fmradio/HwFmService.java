...
public class HwFmService extends Stub {
    ...
    public int acquireFd(String path) {
        ...
        stringBuilder.append("acquireFd uid = ");
    ...
    public void setFmDeviceConnectionState(int state) {
        ...
        if (state == 0 && this.mIsFmConnected) {
            AudioSystem.setDeviceConnectionState(HwHistoryItem.STATE_SCREEN_ON_FLAG, 0, "", "");
            this.mIsFmConnected = false;
        } else if (state == 1 && !this.mIsFmConnected) {
            AudioSystem.setDeviceConnectionState(HwHistoryItem.STATE_SCREEN_ON_FLAG, 1, "", "");
    ...
    public void startListner(final int fd, IFmEventCallback cb) {
        ...
        this.mThread = new Thread() {
            public void run() {
                ...
                String str = HwFmService.TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("Starting listener ");
                ...
                while (!Thread.currentThread().isInterrupted()) {
                    try {
                        ...
                        String str2 = HwFmService.TAG;
                        StringBuilder stringBuilder2 = new StringBuilder();
                        stringBuilder2.append("Received event. Count: ");
                        stringBuilder2.append(eventCount);
                        Log.d(str2, stringBuilder2.toString());
                        if (HwFmService.this.mCallback != null) {
                            for (int index = 0; index < eventCount; index++) {
                                str2 = HwFmService.TAG;
                                stringBuilder2 = new StringBuilder();
                                stringBuilder2.append("Received <");
                                stringBuilder2.append(buff[index]);
                        ...
                        String str3 = HwFmService.TAG;
                        StringBuilder stringBuilder3 = new StringBuilder();
                        stringBuilder3.append("RunningThread InterruptedException ex = ");
                        ...
                        try {
                            ...
                            String str4 = HwFmService.TAG;
                            StringBuilder stringBuilder4 = new StringBuilder();
                            stringBuilder4.append("RunningThread InterruptedException for callback = ");
                            stringBuilder4.append(rx);
