...
public class PowerManagerEx {
    ...
    public static List<String> getWakeLockPackageName() throws RemoteException {
        return Stub.asInterface(ServiceManagerEx.getService("power")).getWakeLockPackageName();
    }

    public static void setTemporaryScreenAutoBrightnessSetting(int brightness) throws RemoteException {
        Stub.asInterface(ServiceManagerEx.getService("power")).setTemporaryScreenAutoBrightnessSettingOverride(brightness);
    }

    public static void setTemporaryScreenAutoBrightnessAdjustmentSetting(float adj) throws RemoteException {
        Stub.asInterface(ServiceManagerEx.getService("power")).setTemporaryScreenAutoBrightnessAdjustmentSettingOverride(adj);
    }

    public static boolean isInteractive() throws RemoteException {
        return Stub.asInterface(ServiceManagerEx.getService("power")).isInteractive();
    }

    public static void setTemporaryScreenBrightnessSetting(int brightness) throws RemoteException {
        Stub.asInterface(ServiceManagerEx.getService("power")).setTemporaryScreenBrightnessSettingOverride(brightness);
    }

    public static int getCoverModeBrightnessFromLastScreenBrightness() throws RemoteException {
        return Stub.asInterface(ServiceManagerEx.getService("power")).getCoverModeBrightnessFromLastScreenBrightness();
    }
