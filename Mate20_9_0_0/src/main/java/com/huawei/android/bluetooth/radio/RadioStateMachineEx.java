...
public class RadioStateMachineEx extends StateMachine {
    ...
    private class OffState extends State {
        ...
        public boolean processMessage(Message msg) {
            if (msg.what != 200) {
                String str = RadioStateMachineEx.TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("ERROR: UNEXPECTED MESSAGE: CURRENT_STATE=OFF, MESSAGE = ");
    ...
    private class OnState extends State {
        ...
        public boolean processMessage(Message msg) {
            if (msg.what != RadioStateMachineEx.USER_TURN_OFF_RADIO) {
                String str = RadioStateMachineEx.TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("ERROR: UNEXPECTED MESSAGE: CURRENT_STATE=ON, MESSAGE = ");
                stringBuilder.append(msg.what);
                Log.d(str, stringBuilder.toString());
                return false;
            }
        ...
        public boolean processMessage(Message msg) {
            switch (msg.what) {
                ...
                default:
                    String str = RadioStateMachineEx.TAG;
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("ERROR: UNEXPECTED MESSAGE: CURRENT_STATE=PENDING, MESSAGE = ");
                    stringBuilder.append(msg.what);
                    Log.d(str, stringBuilder.toString());
                    return false;
            }
    ...
    private void notifyAdapterRadioStateChange(int newState) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Bluetooth adapter radio state changed: ");
