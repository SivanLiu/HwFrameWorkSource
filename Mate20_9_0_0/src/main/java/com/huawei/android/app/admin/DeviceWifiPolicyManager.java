...
public class DeviceWifiPolicyManager {
    ...
    public boolean setWifiProfile(ComponentName admin, WifiConfiguration config) {
        ...
        stringBuilder.append("setWifiProfile(): ");
        stringBuilder.append(config.SSID);
        stringBuilder.append(" had been added to MDMEnterpriseConfigList");
    ...
    public ArrayList<String> getWifiProfileList(ComponentName admin) {
        ...
        return bundle == null ? null : bundle.getStringArrayList(VALUE_STRING_LIST);
    }
