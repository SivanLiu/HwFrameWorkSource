...
public class DeviceBluetoothManager {
    ...
    public boolean setBluetoothDisabledProfiles(ComponentName admin, ArrayList<Integer> disabledProfiles) {
        ...
        Iterator it = disabledProfiles.iterator();
        while (it.hasNext()) {
            sProfiles.add(((Integer) it.next()).toString());
        }
        Bundle bundle = new Bundle();
    ...
    public ArrayList<Integer> getBluetoothDisabledProfiles(ComponentName admin) {
        ...
        if (bundle != null) {
            ...
            if (sProfiles != null) {
                ...
                while (it.hasNext()) {
                    profilesList.add(Integer.valueOf(Integer.parseInt((String) it.next())));
                }
            }
        }
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(" getBluetoothDisabledProfiles : ");
        stringBuilder.append(profilesList.toString());
