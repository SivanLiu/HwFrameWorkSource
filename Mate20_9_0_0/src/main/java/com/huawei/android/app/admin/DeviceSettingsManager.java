...
public class DeviceSettingsManager {
    ...
    private boolean getStateTypePolicyActiveStatus(ComponentName admin, String policyName) {
        ...
        stringBuilder.append("getStateTypePolicyActiveStatus() raw policyName: ");
    ...
    private boolean getStateTypeDataFromBundle(Bundle policyValue, boolean defaultValue) {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("getStateTypeDataFromBundle() get null data. will return default value: ");
    ...
    private String getConfigTypePolicyStatus(ComponentName admin, String policyName) {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("getConfigTypePolicyStatus() admin:");
    ...
    public boolean setNotificationDisabled(ComponentName who, boolean disable) {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("set Notification Disabled: ");
        stringBuilder.append(disable);
        stringBuilder.append(",by ComponentName is: ");
    ...
    public boolean setNavigationBarDisabled(ComponentName who, boolean disable) {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("set Navigation Bar Disabled: ");
        stringBuilder.append(disable);
        stringBuilder.append(",by ComponentName is: ");
        stringBuilder.append(who == null ? "null" : who.flattenToString());
        Log.w(str, stringBuilder.toString());
    ...
    public boolean setAndroidAnimationDisabled(ComponentName admin, boolean disabled) {
        Bundle bundle = new Bundle();
        bundle.putBoolean("value", disabled);
