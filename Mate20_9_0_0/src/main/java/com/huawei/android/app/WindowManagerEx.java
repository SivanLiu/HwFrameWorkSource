...
public class WindowManagerEx {
    ...
    public static boolean isTopFullscreen() {
        ...
        try {
            ...
            String str = LOG_TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("isTopIsFullscreen: ret: ");
            stringBuilder.append(ret);
    ...
    public static String getWindowCKInfo(String defaultValue) {
        ...
        if (windowManagerBinder != null) {
            ...
            try {
                ...
                windowCKInfo = new String(chars);
                String str = LOG_TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("getWindowCKInfo value is ");
                stringBuilder.append(windowCKInfo);
                Log.d(str, stringBuilder.toString());
                if (data != null) {
                    data.recycle();
                }
                ...
                stringBuilder2.append("getWindowCKInfo exception is ");
    ...
    public static void registerWindowObserver(IWindowLayoutObserver observer, long period) {
        ...
        if (windowManagerBinder != null) {
            ...
            try {
                ...
                String str = LOG_TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("registerWindowObserver exception is ");
    ...
    public static void unRegisterWindowObserver(IWindowLayoutObserver observer) {
        ...
        if (windowManagerBinder != null) {
            ...
            try {
                ...
                String str = LOG_TAG;
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("unRegisterWindowObserver exception is ");
                stringBuilder.append(e.getMessage());
                Log.e(str, stringBuilder.toString());
            } catch (Throwable th) {
                data.recycle();
