...
public class ActionBarEx {
    ...
    private static HwToolbar getToolbar(ActionBar actionBar) {
        ...
        View toolbar = ((Activity) ReflectUtil.getObject(actionBar, "mActivity", WindowDecorActionBar.class)).getWindow().getDecorView().findViewById(16908687);
    ...
    public static void setDisplySpinnerMode(ActionBar actionBar, int contentId, OnItemSelectedListener listener) {
        HwToolbar toolbar = getToolbar(actionBar);
        if (toolbar != null) {
    ...
    public static int getDropdownSelectedPosition(ActionBar actionBar) {
        HwToolbar toolbar = getToolbar(actionBar);
        return toolbar != null ? toolbar.getDropdownSelectedPosition() : 0;
    }

    public static int getDropdownItemCount(ActionBar actionBar) {
        HwToolbar toolbar = getToolbar(actionBar);
        return toolbar != null ? toolbar.getDropdownItemCount() : 0;
    }
