...
import com.huawei.android.provider.VoicemailContractEx.Voicemails;
...
public class HwMediaScanner extends MediaScanner {
    ...
    protected void updateValues(String path, ContentValues contentValues) {
        ...
        if (initValues != null) {
            String initPath = (String) initValues.get(Voicemails._DATA);
            if (initPath != null && initPath.equals(path)) {
