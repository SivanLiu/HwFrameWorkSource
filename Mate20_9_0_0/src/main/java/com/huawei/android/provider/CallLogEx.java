...
public final class CallLogEx {
    ...
    public static class Calls implements BaseColumns {
        ...
        public static final Uri SHADOW_CONTENT_URI = android.provider.CallLog.Calls.SHADOW_CONTENT_URI;
        public static final String SUB_ID = "sub_id";

        public static boolean shouldHaveSharedCallLogEntries(Context context, UserManager userManager, int userId) {
            return android.provider.CallLog.Calls.shouldHaveSharedCallLogEntries(context, userManager, userId);
        }
    }
}
