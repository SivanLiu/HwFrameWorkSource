...
public final class SettingsEx {
    ...
    public static final class System {
        ...
        public static String getScreenAutoBrightness() {
            return com.huawei.systemmanager.common.HwSystemManagerSettings.System.SCREEN_AUTO_BRIGHTNESS;
        }
    ...
    public static final class Systemex {
        ...
        public static synchronized String getString(ContentResolver resolver, String name) {
            ...
            synchronized (Systemex.class) {
                ...
                stringBuilder.append("SettingsEx.Systemex.getString deprecated use Settings.System.getString instead ;callers=");
                stringBuilder.append(Debug.getCallers(3));
                Slog.w(str, stringBuilder.toString());
                str = android.provider.Settings.System.getString(resolver, name);
            }
            return str;
        }

        public static boolean putString(ContentResolver resolver, String name, String value) {
            String str = SettingsEx.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("SettingsEx.Systemex.putString deprecated use Settings.System.putString instead ;callers=");
            stringBuilder.append(Debug.getCallers(3));
            Slog.w(str, stringBuilder.toString());
        ...
        public static Uri getUriFor(String name) {
            String str = SettingsEx.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("SettingsEx.Systemex.getUriFor deprecated use Settings.System.getUriFor instead ;callers=");
            stringBuilder.append(Debug.getCallers(3));
            Slog.w(str, stringBuilder.toString());
        ...
        public static int getInt(ContentResolver cr, String name, int def) {
            String str = SettingsEx.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("SettingsEx.Systemex.getInt deprecated use Settings.System.getInt instead ;callers=");
            stringBuilder.append(Debug.getCallers(3));
            Slog.w(str, stringBuilder.toString());
        ...
        public static boolean putInt(ContentResolver cr, String name, int value) {
            String str = SettingsEx.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("SettingsEx.Systemex.putInt deprecated use Settings.System.putInt instead ;callers=");
            stringBuilder.append(Debug.getCallers(3));
            Slog.w(str, stringBuilder.toString());
        ...
        public static long getLong(ContentResolver cr, String name, long def) {
            String str = SettingsEx.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("SettingsEx.Systemex.getLong deprecated use Settings.System.getLong instead ;callers=");
            stringBuilder.append(Debug.getCallers(3));
            Slog.w(str, stringBuilder.toString());
        ...
        public static boolean putLong(ContentResolver cr, String name, long value) {
            String str = SettingsEx.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("SettingsEx.Systemex.putLong deprecated use Settings.System.putLong instead ;callers=");
            stringBuilder.append(Debug.getCallers(3));
            Slog.w(str, stringBuilder.toString());
        ...
        public static float getFloat(ContentResolver cr, String name, float def) {
            String str = SettingsEx.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("SettingsEx.Systemex.getFloat deprecated use Settings.System.getFloat instead ;callers=");
            stringBuilder.append(Debug.getCallers(3));
            Slog.w(str, stringBuilder.toString());
        ...
        public static boolean putFloat(ContentResolver cr, String name, float value) {
            String str = SettingsEx.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("SettingsEx.Systemex.putFloat deprecated use Settings.System.putFloat instead ;callers=");
            stringBuilder.append(Debug.getCallers(3));
            Slog.w(str, stringBuilder.toString());
