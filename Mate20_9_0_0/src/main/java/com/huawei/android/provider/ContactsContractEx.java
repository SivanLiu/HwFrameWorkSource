...
public final class ContactsContractEx {
    public static final Uri CORP_CONTENT_URI = android.provider.ContactsContract.Contacts.CORP_CONTENT_URI;
    ...
    public static final class Directory implements BaseColumns {
        ...
        public static final Uri ENTERPRISE_FILE_URI = android.provider.ContactsContract.Directory.ENTERPRISE_FILE_URI;
    ...
    public static class Contacts implements BaseColumns, ContactOptionsColumns {
        public static final Uri CORP_CONTENT_URI = android.provider.ContactsContract.Contacts.CORP_CONTENT_URI;
        public static long ENTERPRISE_CONTACT_ID_BASE = android.provider.ContactsContract.Contacts.ENTERPRISE_CONTACT_ID_BASE;
        public static String ENTERPRISE_CONTACT_LOOKUP_PREFIX = android.provider.ContactsContract.Contacts.ENTERPRISE_CONTACT_LOOKUP_PREFIX;
    ...
    public static final class MetadataSync implements BaseColumns, MetadataSyncColumns {
        ...
        public static final Uri CONTENT_URI = android.provider.ContactsContract.MetadataSync.CONTENT_URI;
        public static final String METADATA_AUTHORITY = "com.android.contacts.metadata";
        public static final Uri METADATA_AUTHORITY_URI = android.provider.ContactsContract.MetadataSync.METADATA_AUTHORITY_URI;
    ...
    public static final class MetadataSyncState implements BaseColumns, MetadataSyncStateColumns {
        ...
        public static final Uri CONTENT_URI = android.provider.ContactsContract.MetadataSyncState.CONTENT_URI;
