...
public interface IRequestCallBack extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IRequestCallBack {
        private static final String DESCRIPTOR = "com.huawei.android.totemweather.aidl.IRequestCallBack";
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    if (data.readInt() != 0) {
                        _arg1 = (RequestData) RequestData.CREATOR.createFromParcel(data);
                    } else {
                        _arg1 = null;
                    }
                    onRequestResult(_arg0, _arg1);
