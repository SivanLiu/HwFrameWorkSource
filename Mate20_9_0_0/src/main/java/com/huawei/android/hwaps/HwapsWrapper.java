...
public class HwapsWrapper {
    ...
    public static IFpsRequest getFpsRequest() {
        ...
        return factory != null ? factory.getFpsRequest() : null;
    }

    public static IFpsController getFpsController() {
        IHwapsFactory factory = getHwapsFactoryImpl();
        return factory != null ? factory.getFpsController() : null;
    }
    ...
    public static ISmartLowpowerBrowser getSmartLowpowerBrowser() {
        IHwapsFactory factory = getHwapsFactoryImpl();
        return factory != null ? factory.getSmartLowpowerBrowser() : null;
    }

    public static IColorPlusController getColorPlusController() {
        IHwapsFactory factory = getHwapsFactoryImpl();
        return factory != null ? factory.getColorPlusController() : null;
    }
}
