...
public class HwapsFactoryImpl implements IHwapsFactory {
    private static volatile IColorPlusController mColorPlusController = null;
    ...
    public IColorPlusController getColorPlusController() {
        if (mColorPlusController == null) {
            synchronized (HwapsFactoryImpl.class) {
                if (mColorPlusController == null) {
                    mColorPlusController = new ColorPlusController();
                }
            }
        }
        return mColorPlusController;
    }
}
