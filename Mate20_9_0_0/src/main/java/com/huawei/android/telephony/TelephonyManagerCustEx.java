...
public class TelephonyManagerCustEx {
    ...
    /* renamed from: com.huawei.android.telephony.TelephonyManagerCustEx$1 */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            try {
                $SwitchMap$android$telephony$HwTelephonyManagerInner$DataSettingModeType[DataSettingModeType.MODE_LTE_OFF.ordinal()] = 1;
            ...
            try {
                $SwitchMap$android$telephony$HwTelephonyManagerInner$DataSettingModeType[DataSettingModeType.MODE_LTE_AND_AUTO.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                $SwitchMap$android$telephony$HwTelephonyManagerInner$DataSettingModeType[DataSettingModeType.MODE_ERROR.ordinal()] = 4;
