...
public class PGAction {
    ...
    public static final int ID_EXTEND1 = 1;
    public static final int ID_EXTEND2 = 2;
    ...
    protected static boolean isValid(int id) {
        return (id >= 10000 && id <= 10017) || ((id >= 20000 && id <= 20003) || ((id >= 30000 && id <= 30004) || (id >= PG_ID_LOG_EVENT && id <= PG_ID_LOG_EVENT)));
    }

    public static int checkActionFlag(int actionId) {
        if (actionId == 10007 || actionId == 10015 || actionId == PG_ID_INPUT_START || actionId == 10015) {
            return 1;
        }
        if (actionId == 10017 || actionId == 10016 || actionId == 10006 || actionId == 10016) {
            return 2;
        }
        return 3;
    }
    ...
    public static int checkActionType(int actionId) {
        ...
        if (actionId >= 20000 && actionId < 30000) {
            return 2;
        }
        if (actionId >= 30000 && actionId < PG_ID_LOG_EVENT) {
            return 3;
        }
    ...
    public String getActionExd(int id) {
        switch (id) {
            case 1:
                return this.extend1;
            case 2:
    ...
    public String toString() {
        ...
        builder.append(" pkg =");
        builder.append(this.pkgName);
        builder.append(" extend1 =");
        builder.append(this.extend1);
        builder.append(" extend2 =");
        builder.append(this.extend2);
        builder.append(" flag =");
