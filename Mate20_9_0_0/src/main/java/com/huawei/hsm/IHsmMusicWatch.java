...
public interface IHsmMusicWatch extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IHsmMusicWatch {
        ...
        private static class Proxy implements IHsmMusicWatch {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    case 1:
                        ...
                        _result = onMusicPlaying(data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result);
                        return true;
                    case 2:
                        data.enforceInterface(descriptor);
                        _result = onMusicPauseOrStop(data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result);
                        return true;
                    default:
