...
public class AudioAlgoClient {
    ...
    public int setParameter(String pathNameKeyValuePair) throws RemoteException {
        ...
        stringBuilder.append("SetParameter Permission Denied: ");
        stringBuilder.append(getPackageName(Process.myPid()));
    ...
    public String getParameter(String pathNameKey) throws RemoteException {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Getparameter Permission Denied");
        stringBuilder.append(getPackageName(Process.myPid()));
        Log.e(str, stringBuilder.toString());
        return null;
    }
