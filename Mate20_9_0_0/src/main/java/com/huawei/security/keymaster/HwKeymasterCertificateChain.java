...
public class HwKeymasterCertificateChain implements Parcelable {
    public static final Creator<HwKeymasterCertificateChain> CREATOR = new Creator<HwKeymasterCertificateChain>() {
        public HwKeymasterCertificateChain createFromParcel(Parcel in) {
            return new HwKeymasterCertificateChain(in, null);
        }
    ...
    /* synthetic */ HwKeymasterCertificateChain(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
    ...
    public HwKeymasterCertificateChain(List<byte[]> mCertificates) {
