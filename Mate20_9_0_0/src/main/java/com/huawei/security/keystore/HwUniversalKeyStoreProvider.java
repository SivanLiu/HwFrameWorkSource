...
import com.huawei.security.keystore.HwKeyProperties.KeyAlgorithm;
...
public class HwUniversalKeyStoreProvider extends Provider {
    ...
    public HwUniversalKeyStoreProvider() {
        ...
        putSignatureImpl("SHA256withRSA", "com.huawei.security.keystore.HwUniversalKeyStoreSignatureSpi$SHA256WithPKCS1Padding");
        ...
        putSignatureImpl("SHA384withRSA", "com.huawei.security.keystore.HwUniversalKeyStoreSignatureSpi$SHA384WithPKCS1Padding");
        put("Alg.Alias.Signature.SHA384WithRSAEncryption", "SHA384withRSA");
        put("Alg.Alias.Signature.1.2.840.113549.1.1.12", "SHA384withRSA");
        put("Alg.Alias.Signature.2.16.840.1.101.3.4.2.2with1.2.840.113549.1.1.1", "SHA384withRSA");
        putSignatureImpl("SHA512withRSA", "com.huawei.security.keystore.HwUniversalKeyStoreSignatureSpi$SHA512WithPKCS1Padding");
        put("Alg.Alias.Signature.SHA512WithRSAEncryption", "SHA512withRSA");
        put("Alg.Alias.Signature.1.2.840.113549.1.1.13", "SHA512withRSA");
        put("Alg.Alias.Signature.2.16.840.1.101.3.4.2.3with1.2.840.113549.1.1.1", "SHA512withRSA");
        putSignatureImpl("SHA256withRSA/PSS", "com.huawei.security.keystore.HwUniversalKeyStoreSignatureSpi$SHA256WithPSSPadding");
        putSignatureImpl("SHA384withRSA/PSS", "com.huawei.security.keystore.HwUniversalKeyStoreSignatureSpi$SHA384WithPSSPadding");
        putSignatureImpl("SHA512withRSA/PSS", "com.huawei.security.keystore.HwUniversalKeyStoreSignatureSpi$SHA512WithPSSPadding");
    ...
    @NonNull
    public static HwUniversalKeyStorePrivateKey loadAndroidKeyStorePrivateKeyFromKeystore(@NonNull HwKeystoreManager keyStore, @NonNull String privateKeyAlias, int uid) throws UnrecoverableKeyException {
        return (HwUniversalKeyStorePrivateKey) loadAndroidKeyStoreKeyPairFromKeystore(keyStore, privateKeyAlias, uid).getPrivate();
    }
    ...
    public static KeyPair loadAndroidKeyStoreKeyPairFromKeystore(@NonNull HwKeystoreManager keyStore, @NonNull String privateKeyAlias, int uid) throws UnrecoverableKeyException {
        HwUniversalKeyStorePublicKey publicKey = loadAndroidKeyStorePublicKeyFromKeystore(keyStore, privateKeyAlias, uid);
    ...
    @NonNull
    public static HwUniversalKeyStorePublicKey getAndroidKeyStorePublicKey(@NonNull String alias, int uid, @NonNull String keyAlgorithm, @NonNull byte[] x509EncodedForm) {
    ...
    @NonNull
    public static HwUniversalKeyStorePrivateKey getAndroidKeyStorePrivateKey(@NonNull HwUniversalKeyStorePublicKey publicKey) {
    ...
    @NonNull
    public static HwUniversalKeyStorePublicKey loadAndroidKeyStorePublicKeyFromKeystore(@NonNull HwKeystoreManager keyStore, @NonNull String privateKeyAlias, int uid) throws UnrecoverableKeyException {
    ...
    private void putSignatureImpl(String algorithm, String implClass) {
        ...
        put(stringBuilder.toString(), "com.huawei.security.keystore.HwUniversalKeyStorePrivateKey|com.huawei.security.keystore.HwUniversalKeyStorePublicKey");
    }
