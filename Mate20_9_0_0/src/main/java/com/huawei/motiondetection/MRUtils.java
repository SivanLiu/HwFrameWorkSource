...
public final class MRUtils {
    ...
    public static int getMotionEnableState(Context context, String motionitemkey, boolean isEx) {
        ...
        stringBuilder.append("getMotionEnableState enabled: ");
    ...
    public static int getMotionEnableStateAsUser(Context context, String motionitemkey, int userId) {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("getMotionEnableStateAsUser enabled: ");
        stringBuilder.append(enabled);
        MRLog.d(str, stringBuilder.toString());
        return enabled;
    }
            ...
            for (RunningServiceInfo service : serviceList) {
                if (service.process.equals(serviceProcess) && service.pid > 0) {
                    if (UserHandle.getUserId(service.uid) == userId) {
                        String str = TAG;
                        StringBuilder stringBuilder = new StringBuilder();
                        stringBuilder.append("service.process: ");
                        stringBuilder.append(service.process);
                        stringBuilder.append(" service.pid = ");
                        stringBuilder.append(service.pid);
                        stringBuilder.append(" serviceProcess: ");
                        stringBuilder.append(serviceProcess);
                        stringBuilder.append(" service.uid = ");
                        stringBuilder.append(service.uid);
                        stringBuilder.append(" user: ");
                        stringBuilder.append(UserHandle.getUserId(service.uid));
                        stringBuilder.append(" current user id: ");
                    ...
                    stringBuilder2.append("service.uid = ");
                    stringBuilder2.append(service.uid);
                    stringBuilder2.append(" user: ");
                    stringBuilder2.append(UserHandle.getUserId(service.uid));
                    stringBuilder2.append(" current user id: ");
