...
public class RelayBroadcast implements IRelay {
    ...
    private void doModtionRecoAsUser(int motionType, int operateType, int userId) {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("doModtionRecoAsUser sendBroadcast motionType: ");
        stringBuilder.append(motionType);
        stringBuilder.append("  operateType: ");
        stringBuilder.append(operateType);
        MRLog.d(str, stringBuilder.toString());
    ...
    private String getCurProcessName(Context context) {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("getCurProcessName pid: ");
