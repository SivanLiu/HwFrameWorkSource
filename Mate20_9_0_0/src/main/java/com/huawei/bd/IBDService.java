            ...
            if (code != 1598968902) {
                switch (code) {
                    case 1:
                        ...
                        int _result = sendAppActionData(data.readString(), data.readInt(), data.readString(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result);
                        return true;
                    case 2:
                        data.enforceInterface(DESCRIPTOR);
                        int _result2 = sendAccumulativeData(data.readString(), data.readInt(), data.readInt());
                        reply.writeNoException();
