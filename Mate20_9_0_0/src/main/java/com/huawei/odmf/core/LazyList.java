...
public class LazyList<E> implements List<E> {
    ...
    public LazyList(List<ObjectId> objectIDList, ObjectContext objectContext, String entityName) {
        this(objectIDList, objectContext, entityName, null);
    }

    public LazyList(List<ObjectId> objectIDList, ObjectContext objectContext, String entityName, ManagedObject baseObj) {
        ...
        if (objectContext == null || objectIDList == null || entityName == null) {
        ...
        this.listSize = objectIDList.size();
        if (baseObj != null) {
    ...
    public E get(int index) {
        if (index >= 0 && index < this.listSize) {
            return getObject((ObjectId) this.objectIDList.get(index));
        }
    ...
    public boolean addAll(@NonNull Collection<? extends E> c) {
        ...
        for (Object e : c) {
            checkValue(e);
            list1.add(((ManagedObject) e).getObjectId());
            list2.add(e);
        }
    ...
    public E remove(int index) {
        ...
        ObjectId remove = (ObjectId) this.objectIDList.remove(index);
        this.listSize--;
        this.modCount++;
        addUpdate();
        E object = getObject(remove);
        insertRemove(object);
        if (getRelationshipIndex() >= 0 && this.baseObj != null) {
            ((AManagedObject) this.baseObj).setRelationshipUpdateSignsTrue(getRelationshipIndex());
        }
    ...
    public void clear() {
        for (int i = 0; i < this.listSize; i++) {
            insertRemove(getObject((ObjectId) this.objectIDList.get(i)));
        }
    ...
    public E set(int index, E o) {
        ...
        checkValue(o);
        ObjectId id = (ObjectId) this.objectIDList.set(index, ((ManagedObject) o).getObjectId());
        addUpdate();
        E object = getObject(id);
        insertRemove(object);
        insertAdd((Object) o);
        return object;
    }
    ...
    public List<E> subList(int fromIndex, int toIndex) {
        ...
        for (int i = fromIndex; i < toIndex; i++) {
            list.add(getObject((ObjectId) this.objectIDList.get(i)));
        }
        return list;
    }
    ...
    public <T> T[] toArray(T[] a) {
        ...
        if (a.length >= this.listSize) {
            for (i = 0; i < this.listSize; i++) {
                a[i] = getObject((ObjectId) this.objectIDList.get(i));
            }
            return a;
            ...
            for (i = 0; i < this.listSize; i++) {
                newArray[i] = getObject((ObjectId) this.objectIDList.get(i));
            }
            return newArray;
        }
    }
