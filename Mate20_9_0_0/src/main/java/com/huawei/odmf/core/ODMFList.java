...
public class ODMFList<E> implements List<E> {
    ...
    public ODMFList(ObjectContext ctx, String entityName) {
        this(ctx, entityName, null);
    }

    public ODMFList(ObjectContext ctx, String entityName, ManagedObject baseObj) {
        this.listSize = 0;
        this.odmfModCount = 0;
        this.odmfBaseObj = null;
        this.arraySize = 500;
        this.relationshipIndex = -1;
        if (ctx == null || entityName == null) {
