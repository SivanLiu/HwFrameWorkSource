...
class TransactionImpl {
    ...
    void setTransactionInsertObjectList(List<ManagedObject> list) {
        if (!list.isEmpty()) {
    ...
    void setTransactionUpdateObjectList(List<ManagedObject> list) {
        if (!list.isEmpty()) {
    ...
    void setTransactionDeleteObjectList(List<ManagedObject> list) {
        if (!list.isEmpty()) {
    ...
    private void rollBackObjectList() {
        ...
        for (ManagedObject object22 : this.transactionDeleteObjectList) {
            object22.setState(4);
        }
    }
