...
public class AObjectContext implements ObjectContext {
    ...
    private AObjectContext(boolean openQueryCache) {
    ...
    public void setQueryCacheNumbers(int queryCacheNumbers) {
        this.queryCacheNumbers = queryCacheNumbers;
    }
    ...
    public boolean inTransaction() {
        return this.mTransactionImpl == null ? false : this.mTransactionImpl.inTransaction();
    }
    ...
    public void setPersistentStoreVersion(int persistentStoreVersion) {
        this.persistentStoreVersion = (long) persistentStoreVersion;
    }
    ...
    protected void putValuesIntoCache(String key, List<ManagedObject> manageObjects) {
    ...
    protected List<ManagedObject> getValuesFromCache(String key) {
        if (this.openQueryCache) {
            return (List) this.queryCache.get(key);
        }
        return null;
    }
