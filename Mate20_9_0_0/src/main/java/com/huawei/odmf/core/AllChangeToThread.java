...
class AllChangeToThread {
    ...
    public AllChangeToThread(List<ManagedObject> insert, List<ManagedObject> updated, List<ManagedObject> deleted, ObjectContext context, String uriString) {
    ...
    public AllChangeToThread(ObjectContext context, String entityName, String uriString) {
        this.changeContext = context;
    ...
    private void analysisDeleteList(List<ManagedObject> deletedObjectsList) {
        for (ManagedObject manageObject : deletedObjectsList) {
            ...
            AllChangeToTarget psAllChangeToTarget = (AllChangeToTarget) this.persistStoreMap.get(uriStr);
            ...
            AllChangeToTarget contextAllChangeToTarget = (AllChangeToTarget) this.objectContextMap.get(objContext);
            ...
            String entityName = manageObject.getEntityName();
            AllChangeToTarget entityAllChangeToTarget = (AllChangeToTarget) this.entityMap.get(entityName);
            if (entityAllChangeToTarget != null) {
                ...
                this.entityMap.put(entityName, subAllChangeEntityName);
            }
            ObjectId objID = manageObject.getObjectId();
            AllChangeToTarget objAllChangeToTarget = (AllChangeToTarget) this.manageObjectIDMap.get(objID);
