...
public class ODMFDatabaseHelper extends SQLiteOpenHelper implements DatabaseHelper {
    ...
    public ODMFDatabaseHelper(Context context, String databaseName, ObjectModel model, boolean throwException, boolean detectDelete) {
        super(context, databaseName, null, model != null ? model.getDatabaseVersionCode() : 1);
        this.model = model;
    ...
    public void alterTableName(DataBase odmfDb, String oldEntityName, String newEntityName) {
        ...
        if (entity != null) {
            DatabaseHelperTools.rebuildMidTable(odmfDb, oldEntityName, entity);
        }
    }
