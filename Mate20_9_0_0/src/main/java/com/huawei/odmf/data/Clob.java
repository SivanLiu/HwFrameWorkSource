...
public class Clob implements java.sql.Clob, Parcelable {
    ...
    public int setString(long pos, String str) throws SQLException {
        if (pos < 1) {
            ...
            charBuf.replace((int) pos, (int) (((long) strLength) + pos), str);
    ...
    public int setString(long pos, String str, int offset, int len) throws SQLException {
        if (pos < 1) {
            ...
            try {
                ...
                charBuf.replace((int) pos, (int) (((long) replaceString.length()) + pos), replaceString);
                this.charData = charBuf.toString();
                return len;
    ...
    public int hashCode() {
        return this.charData != null ? this.charData.hashCode() : 0;
    }
