...
import com.huawei.okhttp3.internal.cache.DiskLruCache.Editor;
import com.huawei.okhttp3.internal.cache.DiskLruCache.Snapshot;
...
public final class Cache implements Closeable, Flushable {
    ...
    private static final class Entry {
        ...
        public Entry(Source in) throws IOException {
            try {
                ...
                while (i < responseHeaderLineCount) {
    ...
    private final class CacheRequestImpl implements CacheRequest {
        ...
        /* JADX WARNING: Missing block: B:9:0x0014, code skipped:
            com.huawei.okhttp3.internal.Util.closeQuietly(r4.cacheOut);
     */
