        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 4:
                        data.enforceInterface(descriptor);
                        ISegment3D _result2 = getSegment3D(data.readInt());
                        reply.writeNoException();
                        if (_result2 != null) {
                            _arg02 = _result2.asBinder();
                        }
                        reply.writeStrongBinder(_arg02);
                        return true;
                    case 5:
                        data.enforceInterface(descriptor);
                    ...
                    case 8:
                        data.enforceInterface(descriptor);
                        ISegmentData _result3 = getSegmentData(data.readInt());
                        reply.writeNoException();
                        if (_result3 != null) {
                            _arg02 = _result3.asBinder();
                        }
                        reply.writeStrongBinder(_arg02);
                        return true;
