...
public interface IMtlFile extends IInterface {

    public static abstract class Stub extends Binder implements IMtlFile {
        private static final String DESCRIPTOR = "com.huawei.servicehost.d3d.IMtlFile";
        ...
        private static class Proxy implements IMtlFile {
        ...
        public static IMtlFile asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof IMtlFile)) {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 4:
                        data.enforceInterface(descriptor);
                        if (data.readInt() != 0) {
                            _result = (ImageWrap) ImageWrap.CREATOR.createFromParcel(data);
                        } else {
                            _result = null;
                        }
                        setContent(_result);
