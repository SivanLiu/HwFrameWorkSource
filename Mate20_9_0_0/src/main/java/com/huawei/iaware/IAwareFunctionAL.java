...
public class IAwareFunctionAL {
    ...
    public static String fetchDFTDataByVersionRDA(int iVer, int fId, boolean beta, boolean clear, boolean betaEncode) {
        return HwSysResManager.getInstance().fetchDFTDataByVersion(iVer, fId, beta, clear, betaEncode);
    }
    ...
    public static List<String> getMostFrequentUsedAppsRDA(int n, int minCount) {
    ...
    public static void reportHabitDataRDA(Bundle bdl) {
        HwSysResManager.getInstance().reportHabitData(bdl);
    }
    ...
    public static int getFeatureTypeIAware(int featureId) {
        return FeatureType.getFeatureType(featureId).ordinal();
    }

    public static int valuesFeatureIAware(int featureId) {
        return FeatureType.values()[featureId].ordinal();
    }

    public static String nameFeatureIAware(int featureId) {
        return FeatureType.getFeatureType(featureId).name();
    }
    ...
    public static String getPackageNameForPidAME(int pid) {
        try {
            return ActivityManagerEx.getPackageNameForPid(pid);
    ...
    public static PackageInfo getPackageInfoPM(PackageManager pm, String name, int uid) throws NameNotFoundException {
        if (pm == null) {
            return null;
        }
    ...
    public static ApplicationInfo getApplicationInfoPM(PackageManager pm, String packageName, int flags, int userId) throws NameNotFoundException {
        if (pm == null) {
            return null;
        }
    ...
    public static PackageInfo getPackageInfoAsUserPM(PackageManager pManager, String packageName, int flags, int userId) throws NameNotFoundException {
        if (pManager == null) {
            return null;
        }
    ...
    public static int getPackageUidAsUserPM(PackageManager pManager, String packageName, int userId) throws NameNotFoundException {
        if (pManager == null) {
            return 0;
        }
    ...
    public static Object asInterfaceIDESEx(IBinder displayBinder) {
        return Stub.asInterface(displayBinder);
    }
    ...
    public static Object getInstancePG() {
        return PGSdk.getInstance();
    }

    public static int getThermalInfoPG(Object obj, Context context, int type) throws RemoteException {
        if (obj == null || !(obj instanceof PGSdk)) {
            return INVALID_DATA;
        }
        return ((PGSdk) obj).getThermalInfo(context, type);
    }
    ...
    public static String getTopFrontAppPG(Object obj, Context context) throws RemoteException {
        ...
        return ((PGSdk) obj).getTopFrontApp(context);
    }
    ...
    public static int getPkgTypePG(Object obj, Context context, String pkg) throws RemoteException {
        ...
        return ((PGSdk) obj).getPkgType(context, pkg);
    }
    ...
    public static String getSchedData(Object object, String keys) throws RemoteException {
        ...
        if (object != null && (object instanceof ISched)) {
            keyValues = ((ISched) object).get_sched_data(keys);
        }
        return keyValues;
    }
    ...
    public static int getIntForUser(ContentResolver cr, String name, int userHandle) {
        ...
        try {
            int ret = System.getIntForUser(cr, name, userHandle);
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("getIntForUser : ");
