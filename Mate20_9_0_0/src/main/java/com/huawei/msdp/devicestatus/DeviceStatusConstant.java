...
public class DeviceStatusConstant {
    public static final String[] AR_SERVICE_ABILITY_NAME = new String[]{"android.activity_recognition.still", "android.activity_recognition.high_speed_rail", "android.activity_recognition.in_vehicle", "android.activity_recognition.on_bicycle", "android.activity_recognition.running", "android.activity_recognition.walking", "android.activity_recognition.fast_walking", "android.activity_recognition.relative_still"};
    ...
    public static final String[] MAP_MOTION_NAME = new String[]{TYPE_PICKUP_NAME, TYPE_FLIP_NAME, TYPE_PROXIMITY_EAR_NAME, TYPE_SHAKE_NAME, TYPE_TAP_BACK_NAME, TYPE_TILT_LR_NAME, TYPE_ROTATION_NAME, TYPE_POCKET_NAME, TYPE_ACTIVITY_NAME, TYPE_TAKE_OFF_NAME, TYPE_HW_STEP_COUNTER_NAME, TYPE_WAVE_LIGHT_NAME, TYPE_HEAD_DOWN_NAME, TYPE_TRIPLE_FINGER_NAME};
    public static final int[] MAP_MOTION_VALUE = new int[]{100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, TYPE_HW_STEP_COUNTER, TYPE_WAVE_LIGHT, TYPE_HEAD_DOWN, 1500};
