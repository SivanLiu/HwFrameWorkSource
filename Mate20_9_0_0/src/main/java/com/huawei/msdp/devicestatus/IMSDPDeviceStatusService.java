        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    ...
                    case 4:
                        parcel.enforceInterface(DESCRIPTOR);
                        boolean _result3 = enableDeviceStatusService(data.readString(), data.readString(), data.readInt(), data.readLong());
                        reply.writeNoException();
                        parcel2.writeInt(_result3);
                        return true;
                    case 5:
                        parcel.enforceInterface(DESCRIPTOR);
                        boolean _result4 = disableDeviceStatusService(data.readString(), data.readString(), data.readInt());
                        reply.writeNoException();
                        parcel2.writeInt(_result4);
                        return true;
                    case 6:
                        parcel.enforceInterface(DESCRIPTOR);
                        HwMSDPDeviceStatusChangeEvent _result5 = getCurrentDeviceStatus(data.readString());
                        reply.writeNoException();
                        if (_result5 != null) {
                            parcel2.writeInt(1);
