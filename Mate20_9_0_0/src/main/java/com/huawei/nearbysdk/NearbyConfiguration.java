...
public final class NearbyConfiguration implements Parcelable {
    ...
    public String toString() {
        ...
        stringBuilder.append("NearbyConfiguration:{ChannelId=");
        stringBuilder.append(this.mChannelId);
        stringBuilder.append(" WifiSsid=");
        stringBuilder.append(NearbyConfig.toFrontHalfString(this.mWifiSsid));
        stringBuilder.append(" WifiBand=");
        stringBuilder.append(this.mWifiBand);
