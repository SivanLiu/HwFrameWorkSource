...
public final class NearbyDevice implements Parcelable, Serializable {
    ...
    public String toString() {
        ...
        stringBuilder.append("NearbyDevice:{Summary:");
        stringBuilder.append(this.mSummary);
        stringBuilder.append(";BusinessId:");
        stringBuilder.append(this.mBusinessId);
        stringBuilder.append(";BusinessType:");
        stringBuilder.append(this.mBusinessType.toNumber());
    ...
    public void writeToParcel(Parcel dest, int flag) {
        ...
        dest.writeInt(this.mSameHwAccount);
        ...
        dest.writeInt(this.mIsNeedClose);
        ...
        dest.writeInt(this.mIsNeedUpdatePswd);
