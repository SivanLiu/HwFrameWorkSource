...
public class RSAUtils {
    public static byte[] encryptUsingPubKey(byte[] aesKey) {
        try {
            ...
            stringBuilder.append("encryptByPublicKey fail: ");
            stringBuilder.append(e);
            HwLog.e("RSAUtils", stringBuilder.toString());
            return null;
        }
    }
    ...
    public static RSAPublicKey getPublicKey(String modulus, String exponent) {
        try {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("getPublicKey fail: ");
            stringBuilder.append(e);
            HwLog.e("RSAUtils", stringBuilder.toString());
            return null;
        }
    ...
    public static byte[] encryptByPublicKey(byte[] data, Key publicKey) throws Exception {
        ...
        algp.init(new OAEPParameterSpec("SHA-1", "MGF1", MGF1ParameterSpec.SHA1, PSpecified.DEFAULT));
