...
public class FileShareInfo extends BaseShareInfo {
    ...
    public static class FileShareInfoItem implements Parcelable, Serializable, IDTCPSerialize {
        ...
        public String toString() {
            ...
            stringBuilder.append(String.valueOf(this.uri));
    ...
    public String toString() {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("{FileShareInfo:FileCount=");
        stringBuilder.append(getFileCount());
        stringBuilder.append(" Size=");
        stringBuilder.append(getFileSize() / PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID);
