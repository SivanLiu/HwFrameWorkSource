...
import com.huawei.nearbysdk.closeRange.ICloseRangeDeviceListener.Stub;

public class CloseRangeDeviceListenerTransport extends Stub {
    ...
    private class DeviceListenerHandler extends Handler implements CloseRangeDeviceListener {
        ...
        public void handleMessage(Message msg) {
            if (msg.what != 101) {
                String str = CloseRangeDeviceListenerTransport.TAG;
