...
public class IntelliAlgoResult implements Parcelable {
    ...
    public String toString() {
        ...
        r.append("result-regisiterProgess: ");
        r.append(this.regisiterProgess);
        r.append("presenceResult: ");
        r.append(this.presenceResult);
        r.append("rotation: ");
        r.append(this.rotation);
        r.append("verifyResult: ");
        r.append(this.verifyResult);
        return r.toString();
    }
}
