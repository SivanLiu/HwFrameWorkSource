...
public class LogCollectManager {
    ...
    public int setMetricStoargeHeader(int metricID, byte[] payloadBytes, int payloadLen) throws RemoteException {
        ...
        if ((this.iLogCollect != null || bindToServiceInternal(this.mContext)) && this.iLogCollect != null) {
    ...
    private boolean bindToServiceInternal(Context context) {
        ...
        stringBuilder.append("bind to LogCollectService from ");
        stringBuilder.append(logModlePkgName);
        ...
        stringBuilder2.append("bind result:");
        stringBuilder2.append(bRet);
    ...
    protected void finalize() {
        ...
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("finalize error: ");
    ...
    public int captureRemoteDebugLog(ICaptureLogCallback callback, String remarkPath, String patchFilespath) throws RemoteException {
        if ((this.iLogCollect != null || bindToServiceInternal(this.mContext)) && this.iLogCollect != null) {
            return this.iLogCollect.captureRemoteDebugLogWithRemark(callback, remarkPath, patchFilespath);
        }
        return -1;
    }
