...
import com.huawei.uifirst.fastview.systemui.StatusDecouplingPolicy.CallBack;
...
public class StatusDecouplingPolicyManager {
    ...
    public IStatusDecoupling getStatusDecouplingPolicy(int modelID) {
        ...
        return (IStatusDecoupling) this.mStatusDecouplingMap.get(Integer.valueOf(modelID));
    }
}
