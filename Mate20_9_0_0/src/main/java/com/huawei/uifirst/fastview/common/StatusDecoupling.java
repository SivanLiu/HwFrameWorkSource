...
public class StatusDecoupling {
    ...
    public void setTaskInProcessing(boolean isInProcessing) {
        ...
        stringBuilder.append("setTaskInProcessing isInProcessing = ");
        stringBuilder.append(isInProcessing);
    ...
    public void locolLog(int logLevel, String logInfo) {
        ...
        logString.append(this.mModelName);
        logString.append(" : ");
        logString.append(logInfo);
    ...
    public void checkTaskAdditionNeeded(int deviceActualState) {
        ...
        if (wasTaskInProcessing && !this.mIsTaskInProcessing) {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("checkTaskAdditionNeeded  mIsTaskNeeded=");
            stringBuilder.append(this.mIsTaskAdditionNeeded);
            stringBuilder.append(",deviceState=");
            stringBuilder.append(deviceActualState);
            stringBuilder.append(",ClickSkipped=");
            stringBuilder.append(this.mUserClickSkipped);
            stringBuilder.append(",UserEn=");
            stringBuilder.append(this.mUserClickEnable);
