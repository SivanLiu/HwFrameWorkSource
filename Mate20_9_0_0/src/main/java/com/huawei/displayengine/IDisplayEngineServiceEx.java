...
public interface IDisplayEngineServiceEx extends IInterface {
    ...
    public static final int DE_ACTION_MAX = 25;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 2:
                        data.enforceInterface(descriptor);
                        _result2 = setScene(data.readInt(), data.readInt());
                        reply.writeNoException();
                    ...
                    case 3:
                        ...
                        _result2 = setData(_result, _arg1);
                        reply.writeNoException();
                        reply.writeInt(_result2);
                        return true;
                    case 4:
                        ...
                        _result2 = sendMessage(_result, _arg12);
                        reply.writeNoException();
                        reply.writeInt(_result2);
                        return true;
                    case 5:
                        ...
                        int _result3 = getEffect(_arg0, _result, _arg2, data.readInt());
                        reply.writeNoException();
                    ...
                    case 6:
                        ...
                        int _result4 = setEffect(_result, _result2, _arg1);
                        reply.writeNoException();
                    ...
                    case 8:
                        ...
                        List<Bundle> _result5 = getAllRecords(_arg02, _arg12);
                        reply.writeNoException();
