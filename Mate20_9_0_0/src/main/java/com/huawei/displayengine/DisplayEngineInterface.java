...
public class DisplayEngineInterface {
    ...
    private int getID(String name) {
        ...
        if (mIDsMap == null) {
            synchronized (mLock) {
                if (mIDsMap == null) {
                    ...
                    map.put("FEATURE_READMODE", Integer.valueOf(26));
                    ...
                    map.put("SCENE_AOD", Integer.valueOf(33));
                    map.put("SCENE_READMODE", Integer.valueOf(37));
                    ...
                    map.put("ACTION_PG_DEFAULT_FRONT", Integer.valueOf(10000));
        ...
        if (mIDsMap.containsKey(str)) {
            return ((Integer) mIDsMap.get(str)).intValue();
        }
        return -1;
    }
