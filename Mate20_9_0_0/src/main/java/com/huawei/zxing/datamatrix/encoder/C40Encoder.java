...
class C40Encoder implements Encoder {
    ...
    private static String encodeToCodewords(CharSequence sb, int startPos) {
        char cw2 = (char) (((((Vibetonz.HAPTIC_EVENT_CONTACT_ALPHA_SWITCH * sb.charAt(startPos)) + (40 * sb.charAt(startPos + 1))) + sb.charAt(startPos + 2)) + 1) % 256);
        return new String(new char[]{(char) (((((Vibetonz.HAPTIC_EVENT_CONTACT_ALPHA_SWITCH * sb.charAt(startPos)) + (40 * sb.charAt(startPos + 1))) + sb.charAt(startPos + 2)) + 1) / 256), cw2});
    }
}
