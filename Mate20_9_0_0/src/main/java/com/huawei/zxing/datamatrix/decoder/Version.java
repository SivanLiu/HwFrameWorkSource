...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        r0[21] = new Version(22, JlogConstantsEx.JLID_DIALPAD_ONTOUCH_NOT_FIRST_DOWN, JlogConstantsEx.JLID_DIALPAD_ONTOUCH_NOT_FIRST_DOWN, 18, 18, new ECBlocks(68, new ECB(6, 175), null));
        r0[22] = new Version(23, JlogConstantsEx.JLID_EDIT_CONTACT_END, JlogConstantsEx.JLID_EDIT_CONTACT_END, 20, 20, new ECBlocks(62, new ECB(8, 163), null));
