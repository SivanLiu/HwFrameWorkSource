...
public final class WifiConfigManager extends AsyncTask<WifiParsedResult, Object, Object> {
    ...
    private static void updateNetwork(WifiManager wifiManager, WifiConfiguration config) {
        ...
        if (foundNetworkID != null) {
            ...
            stringBuilder.append("Removing old configuration for network ");
        ...
        if (networkId < 0) {
            ...
            stringBuilder2.append("Unable to add network ");
            stringBuilder2.append(config.SSID);
            Log.w(str2, stringBuilder2.toString());
        } else if (wifiManager.enableNetwork(networkId, true)) {
            str2 = TAG;
            stringBuilder2 = new StringBuilder();
            stringBuilder2.append("Associating to network ");
            stringBuilder2.append(config.SSID);
            ...
            str2 = TAG;
            stringBuilder2 = new StringBuilder();
            stringBuilder2.append("Failed to enable network ");
            stringBuilder2.append(config.SSID);
            Log.w(str2, stringBuilder2.toString());
        }
    }
