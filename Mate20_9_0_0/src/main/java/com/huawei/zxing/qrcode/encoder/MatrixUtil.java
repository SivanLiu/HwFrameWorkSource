...
final class MatrixUtil {
    ...
    private static final int[][] POSITION_ADJUSTMENT_PATTERN_COORDINATE_TABLE = new int[][]{new int[]{-1, -1, -1, -1, -1, -1, -1}, new int[]{6, 18, -1, -1, -1, -1, -1}, new int[]{6, 22, -1, -1, -1, -1, -1}, new int[]{6, 26, -1, -1, -1, -1, -1}, new int[]{6, 30, -1, -1, -1, -1, -1}, new int[]{6, 34, -1, -1, -1, -1, -1}, new int[]{6, 22, 38, -1, -1, -1, -1}, new int[]{6, 24, 42, -1, -1, -1, -1}, new int[]{6, 26, 46, -1, -1, -1, -1}, new int[]{6, 28, 50, -1, -1, -1, -1}, new int[]{6, 30, 54, -1, -1, -1, -1}, new int[]{6, 32, 58, -1, -1, -1, -1}, new int[]{6, 34, 62, -1, -1, -1, -1}, new int[]{6, 26, 46, 66, -1, -1, -1}, new int[]{6, 26, 48, 70, -1, -1, -1}, new int[]{6, 26, 50, 74, -1, -1, -1}, new int[]{6, 30, 54, 78, -1, -1, -1}, new int[]{6, 30, 56, 82, -1, -1, -1}, new int[]{6, 30, 58, 86, -1, -1, -1}, new int[]{6, 34, 62, 90, -1, -1, -1}, new int[]{6, 28, 50, 72, 94, -1, -1}, new int[]{6, 26, 50, 74, 98, -1, -1}, new int[]{6, 30, 54, 78, 102, -1, -1}, new int[]{6, 28, 54, 80, MetricConstant.WIFI_METRIC_ID_EX, -1, -1}, new int[]{6, 32, 58, 84, 110, -1, -1}, new int[]{6, 30, 58, 86, 114, -1, -1}, new int[]{6, 34, 62, 90, JlogConstantsEx.JLID_CONTACT_MULTISELECT_ACTIVITY_ONCREATE, -1, -1}, new int[]{6, 26, 50, 74, 98, JlogConstantsEx.JLID_DEF_CONTACT_ITEM_CLICK, -1}, new int[]{6, 30, 54, 78, 102, JlogConstantsEx.JLID_NEW_CONTACT_SELECT_ACCOUNT, -1}, new int[]{6, 26, 52, 78, 104, 130, -1}, new int[]{6, 30, 56, 82, MetricConstant.GPS_METRIC_ID_EX, SmsConstantsEx.MAX_USER_DATA_BYTES_WITH_HEADER, -1}, new int[]{6, 34, 60, 86, 112, JlogConstantsEx.JLID_MMS_MESSAGES_DELETE, -1}, new int[]{6, 30, 58, 86, 114, 142, -1}, new int[]{6, 34, 62, 90, JlogConstantsEx.JLID_CONTACT_MULTISELECT_ACTIVITY_ONCREATE, 146, -1}, new int[]{6, 30, 54, 78, 102, JlogConstantsEx.JLID_NEW_CONTACT_SELECT_ACCOUNT, 150}, new int[]{6, 24, 50, 76, 102, AppOpsManagerEx.TYPE_MICROPHONE, 154}, new int[]{6, 28, 54, 80, MetricConstant.WIFI_METRIC_ID_EX, JlogConstantsEx.JLID_EDIT_CONTACT_END, 158}, new int[]{6, 32, 58, 84, 110, 136, 162}, new int[]{6, 26, 54, 82, 110, JlogConstantsEx.JLID_MMS_MESSAGES_DELETE, 166}, new int[]{6, 30, 58, 86, 114, 142, 170}};
        ...
        if (version.getVersionNumber() >= 7) {
            ...
            while (i < 6) {
                ...
                for (bitIndex = 0; bitIndex < 3; bitIndex++) {
                    boolean bit = versionInfoBits.get(bitIndex2);
                    bitIndex2--;
                    matrix.set(i, (matrix.getHeight() - 11) + bitIndex, bit);
                    matrix.set((matrix.getHeight() - 11) + bitIndex, i, bit);
                }
                i++;
                bitIndex = bitIndex2;
            }
            ...
            while (y >= 0 && y < matrix.getHeight()) {
                ...
                for (bitIndex = 0; bitIndex < 2; bitIndex++) {
                    ...
                    if (isEmpty(matrix.get(xx, y))) {
                        boolean bit;
                        if (bitIndex2 < dataBits.getSize()) {
                            bit = dataBits.get(bitIndex2);
                            bitIndex2++;
                        } else {
                            bit = false;
                        }
