...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        iArr = new int[]{6, 30};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(26, new ECB(1, MetricConstant.GPS_METRIC_ID_EX));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(2, JlogConstantsEx.JLID_CONTACT_BIND_EDITOR_FOR_NEW));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(26, new ECB(4, MetricConstant.BLUETOOTH_METRIC_ID_EX));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(3, JlogConstantsEx.JLID_CONTACT_DETAIL_BIND_VIEW), new ECB(1, JlogConstantsEx.JLID_CONTACT_BIND_EDITOR_FOR_NEW));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(1, MetricConstant.BLUETOOTH_METRIC_ID_EX), new ECB(5, MetricConstant.GPS_METRIC_ID_EX));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(5, JlogConstantsEx.JLID_DIALPAD_ONTOUCH_NOT_FIRST_DOWN), new ECB(1, JlogConstantsEx.JLID_DIALPAD_ADAPTER_GET_VIEW));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(3, MetricConstant.BLUETOOTH_METRIC_ID_EX), new ECB(5, MetricConstant.GPS_METRIC_ID_EX));
        ...
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(28, new ECB(4, JlogConstantsEx.JLID_CONTACT_BIND_EDITOR_FOR_NEW), new ECB(4, JlogConstantsEx.JLID_DIALPAD_AFTER_TEXT_CHANGE));
        ...
        r6 = new ECBlocks[4];
        r6[0] = new ECBlocks(30, new ECB(4, JlogConstantsEx.JLID_DIALPAD_ADAPTER_GET_VIEW), new ECB(5, JlogConstantsEx.JLID_DEF_CONTACT_ITEM_CLICK));
        ...
        iArr2 = new int[]{6, 28, 54, 80, MetricConstant.WIFI_METRIC_ID_EX};
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(6, JlogConstantsEx.JLID_DIALPAD_AFTER_TEXT_CHANGE), new ECB(4, JlogConstantsEx.JLID_CONTACT_MULTISELECT_ACTIVITY_ONCREATE));
        ...
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(26, new ECB(8, MetricConstant.WIFI_METRIC_ID_EX), new ECB(4, MetricConstant.BLUETOOTH_METRIC_ID_EX));
        ...
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(28, new ECB(10, 114), new ECB(2, JlogConstantsEx.JLID_CONTACT_DETAIL_BIND_VIEW));
        ...
        iArr2 = new int[]{6, 34, 62, 90, JlogConstantsEx.JLID_CONTACT_MULTISELECT_ACTIVITY_ONCREATE};
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(8, JlogConstantsEx.JLID_DEF_CONTACT_ITEM_CLICK), new ECB(4, JlogConstantsEx.JLID_NEW_CONTACT_CLICK));
        ...
        iArr2 = new int[]{6, 26, 50, 74, 98, JlogConstantsEx.JLID_DEF_CONTACT_ITEM_CLICK};
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(3, JlogConstantsEx.JLID_DIALPAD_AFTER_TEXT_CHANGE), new ECB(10, JlogConstantsEx.JLID_CONTACT_MULTISELECT_ACTIVITY_ONCREATE));
        ...
        iArr2 = new int[]{6, 30, 54, 78, 102, JlogConstantsEx.JLID_NEW_CONTACT_SELECT_ACCOUNT};
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(7, JlogConstantsEx.JLID_CONTACT_BIND_EDITOR_FOR_NEW), new ECB(7, JlogConstantsEx.JLID_DIALPAD_AFTER_TEXT_CHANGE));
        ...
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(5, JlogConstantsEx.JLID_CONTACT_DETAIL_BIND_VIEW), new ECB(10, JlogConstantsEx.JLID_CONTACT_BIND_EDITOR_FOR_NEW));
        ...
        iArr2 = new int[]{6, 30, 56, 82, MetricConstant.GPS_METRIC_ID_EX, SmsConstantsEx.MAX_USER_DATA_BYTES_WITH_HEADER};
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(13, JlogConstantsEx.JLID_CONTACT_DETAIL_BIND_VIEW), new ECB(3, JlogConstantsEx.JLID_CONTACT_BIND_EDITOR_FOR_NEW));
        ...
        iArr2 = new int[]{6, 34, 60, 86, 112, JlogConstantsEx.JLID_MMS_MESSAGES_DELETE};
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(17, JlogConstantsEx.JLID_CONTACT_DETAIL_BIND_VIEW));
        ...
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(17, JlogConstantsEx.JLID_CONTACT_DETAIL_BIND_VIEW), new ECB(1, JlogConstantsEx.JLID_CONTACT_BIND_EDITOR_FOR_NEW));
        ...
        iArr2 = new int[]{6, 34, 62, 90, JlogConstantsEx.JLID_CONTACT_MULTISELECT_ACTIVITY_ONCREATE, 146};
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(13, JlogConstantsEx.JLID_CONTACT_DETAIL_BIND_VIEW), new ECB(6, JlogConstantsEx.JLID_CONTACT_BIND_EDITOR_FOR_NEW));
        ...
        iArr2 = new int[]{6, 30, 54, 78, 102, JlogConstantsEx.JLID_NEW_CONTACT_SELECT_ACCOUNT, 150};
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(12, JlogConstantsEx.JLID_DIALPAD_ADAPTER_GET_VIEW), new ECB(7, JlogConstantsEx.JLID_DEF_CONTACT_ITEM_CLICK));
        ...
        iArr2 = new int[]{6, 24, 50, 76, 102, AppOpsManagerEx.TYPE_MICROPHONE, 154};
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(6, JlogConstantsEx.JLID_DIALPAD_ADAPTER_GET_VIEW), new ECB(14, JlogConstantsEx.JLID_DEF_CONTACT_ITEM_CLICK));
        ...
        iArr2 = new int[]{6, 28, 54, 80, MetricConstant.WIFI_METRIC_ID_EX, JlogConstantsEx.JLID_EDIT_CONTACT_END, 158};
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(17, JlogConstantsEx.JLID_DEF_CONTACT_ITEM_CLICK), new ECB(4, JlogConstantsEx.JLID_NEW_CONTACT_CLICK));
        ...
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(4, JlogConstantsEx.JLID_DEF_CONTACT_ITEM_CLICK), new ECB(18, JlogConstantsEx.JLID_NEW_CONTACT_CLICK));
        ...
        iArr2 = new int[]{6, 26, 54, 82, 110, JlogConstantsEx.JLID_MMS_MESSAGES_DELETE, 166};
        r3 = new ECBlocks[4];
        r3[0] = new ECBlocks(30, new ECB(20, JlogConstantsEx.JLID_DIALPAD_AFTER_TEXT_CHANGE), new ECB(4, JlogConstantsEx.JLID_CONTACT_MULTISELECT_ACTIVITY_ONCREATE));
        ...
        r4 = new ECBlocks[4];
        r4[0] = new ECBlocks(30, new ECB(19, JlogConstantsEx.JLID_CONTACT_MULTISELECT_ACTIVITY_ONCREATE), new ECB(6, JlogConstantsEx.JLID_CONTACT_MULTISELECT_BIND_VIEW));
