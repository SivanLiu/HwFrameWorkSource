...
final class MECARDContactEncoder extends ContactEncoder {
    ...
    public String[] encode(Iterable<String> names, String organization, Iterable<String> addresses, Iterable<String> phones, Iterable<String> emails, Iterable<String> urls, String title, String note) {
        ...
        StringBuilder stringBuilder = newDisplayContents;
        appendUpToUnique(newContents, stringBuilder, "N", names, 1, new Formatter() {
            public String format(String source) {
        ...
        StringBuilder stringBuilder2 = newContents;
        appendUpToUnique(stringBuilder2, stringBuilder, "ADR", addresses, 1, null);
        appendUpToUnique(stringBuilder2, stringBuilder, "TEL", phones, Integer.MAX_VALUE, new Formatter() {
            public String format(String source) {
                return MECARDContactEncoder.keepOnlyDigits(PhoneNumberUtils.formatNumber(source));
            }
        });
        appendUpToUnique(stringBuilder2, stringBuilder, "EMAIL", emails, Integer.MAX_VALUE, null);
        appendUpToUnique(stringBuilder2, stringBuilder, "URL", urls, Integer.MAX_VALUE, null);
