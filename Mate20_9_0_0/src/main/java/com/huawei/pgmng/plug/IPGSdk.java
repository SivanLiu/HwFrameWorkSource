        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    ...
                    case 6:
                        parcel.enforceInterface(descriptor);
                        String _result5 = getTopFrontApp(data.readString());
                        reply.writeNoException();
                        parcel2.writeString(_result5);
                        return true;
                    case 7:
                        parcel.enforceInterface(descriptor);
                        int[] _result6 = getSupportedStates();
                        reply.writeNoException();
                        parcel2.writeIntArray(_result6);
                        return true;
                    case 8:
                        parcel.enforceInterface(descriptor);
                        _result3 = isStateSupported(data.readInt());
                        reply.writeNoException();
                        parcel2.writeInt(_result3);
                        return true;
                    case 9:
                        parcel.enforceInterface(descriptor);
                        _result3 = registerSink(com.huawei.pgmng.plug.IStateRecognitionSink.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        parcel2.writeInt(_result3);
                        return true;
                    case 10:
                        parcel.enforceInterface(descriptor);
                        _result3 = unregisterSink(com.huawei.pgmng.plug.IStateRecognitionSink.Stub.asInterface(data.readStrongBinder()));
                        reply.writeNoException();
                        parcel2.writeInt(_result3);
                        return true;
                    case 11:
                        parcel.enforceInterface(descriptor);
                        _result3 = enableStateEvent(data.readInt());
                        reply.writeNoException();
                        parcel2.writeInt(_result3);
                        return true;
                    case 12:
                        parcel.enforceInterface(descriptor);
                        _result3 = disableStateEvent(data.readInt());
                        reply.writeNoException();
                        parcel2.writeInt(_result3);
                        return true;
                    case 13:
                        parcel.enforceInterface(descriptor);
                        Map _result7 = getSensorInfoByUid(data.readString(), data.readInt());
                        reply.writeNoException();
                        parcel2.writeMap(_result7);
                        return true;
                    case 14:
                        parcel.enforceInterface(descriptor);
                    ...
                    case 15:
                        parcel.enforceInterface(descriptor);
                        boolean _result8 = fastHibernation(data.readString(), parcel.createTypedArrayList(AppInfo.CREATOR), data.readInt(), data.readString());
                        reply.writeNoException();
                        parcel2.writeInt(_result8);
                        return true;
                    case 16:
                        parcel.enforceInterface(descriptor);
                        List<DetailBatterySipper> _result9 = getBatteryStats(data.readString(), parcel.createTypedArrayList(UserHandle.CREATOR));
                        reply.writeNoException();
                        parcel2.writeTypedList(_result9);
                        return true;
                    case 17:
                        parcel.enforceInterface(descriptor);
                        boolean _result10 = applyForResourceUse(data.readString(), data.readInt() != 0, data.readString(), data.readInt(), data.readLong(), data.readString());
                        reply.writeNoException();
                        parcel2.writeInt(_result10);
                        return true;
                    case 18:
                        parcel.enforceInterface(descriptor);
                        _result = notifyCallingModules(data.readString(), data.readString(), data.createStringArrayList());
                        reply.writeNoException();
                        parcel2.writeInt(_result);
                        return true;
                    case 19:
                        parcel.enforceInterface(descriptor);
                        _result = isKeptAliveApp(data.readString(), data.readString(), data.readInt());
                        reply.writeNoException();
                        parcel2.writeInt(_result);
                        return true;
                    default:
