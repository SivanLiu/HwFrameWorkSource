...
public interface IUpdatePackageCallBack extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IUpdatePackageCallBack {
        ...
        private static class Proxy implements IUpdatePackageCallBack {
            ...
            public void onRefresh(int updateStatus, long totalSize, long downloadedSize, int totalPackages, int downloadedPackages, int errorCode, String errorMessage) throws RemoteException {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    onRefresh(data.readInt(), data.readLong(), data.readLong(), data.readInt(), data.readInt(), data.readInt(), data.readString());
    ...
    void onRefresh(int i, long j, long j2, int i2, int i3, int i4, String str) throws RemoteException;
}
