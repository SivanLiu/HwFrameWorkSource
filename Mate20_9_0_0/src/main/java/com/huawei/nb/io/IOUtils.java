...
import com.huawei.nb.io.output.ByteArrayOutputStream;
import com.huawei.nb.io.output.StringBuilderWriter;
...
public class IOUtils {
    ...
    public static long copyLarge(InputStream input, OutputStream output) throws IOException {
        return copy(input, output, (int) DEFAULT_BUFFER_SIZE);
    }
