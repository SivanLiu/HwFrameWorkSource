...
final class LoggerPrinter implements Printer {
    ...
    public void v(String msg, Object... args) {
        print(2, null, msg, args);
    }

    public void d(String msg, Object... args) {
        print(3, null, msg, args);
    }

    public void i(String msg, Object... args) {
        print(4, null, msg, args);
    }

    public void w(String msg, Object... args) {
        print(5, null, msg, args);
    }
    ...
    private synchronized void print(int level, Throwable throwable, String msg, Object... args) {
        print(level, this.logTag, buildMessage(msg, args), throwable);
    }

    private synchronized void print(int priority, String tag, String msg, Throwable throwable) {
        if (throwable != null) {
            if (msg == null) {
    ...
    private String getStackTraceString(Throwable throwable) {
        ...
        sb.append(IOUtils.LINE_SEPARATOR_UNIX).append(throwable.getMessage());
        for (StackTraceElement traceElement : traces) {
            sb.append(IOUtils.LINE_SEPARATOR_UNIX).append(traceElement.toString());
        }
        return sb.toString();
    }
}
