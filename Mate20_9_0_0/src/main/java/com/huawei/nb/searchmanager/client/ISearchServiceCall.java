    ...
    public static abstract class Stub extends Binder implements ISearchServiceCall {
        ...
        private static class Proxy implements ISearchServiceCall {
            ...
            public List<SearchIntentItem> executeIntentSearch(String pkgName, String queryString, List<String> fieldList, String type, String callingPkgName) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    List<SearchIntentItem> _result = _reply.createTypedArrayList(SearchIntentItem.CREATOR);
                    return _result;
                } finally {
                    _reply.recycle();
                    _data.recycle();
            ...
            public List<Word> executeAnalyzeText(String pkgName, String text, String callingPkgName) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    List<Word> _result = _reply.createTypedArrayList(Word.CREATOR);
                    return _result;
                } finally {
                    _reply.recycle();
                    _data.recycle();
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    BulkCursorDescriptor _result2 = executeSearch(data.readString(), data.readString(), data.createStringArrayList(), data.createTypedArrayList(Attributes.CREATOR), data.readString());
                    reply.writeNoException();
                    if (_result2 != null) {
                        reply.writeInt(1);
                ...
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    _result = executeInsertIndex(data.readString(), data.createTypedArrayList(SearchIndexData.CREATOR), data.createTypedArrayList(Attributes.CREATOR), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    _result = executeUpdateIndex(data.readString(), data.createTypedArrayList(SearchIndexData.CREATOR), data.createTypedArrayList(Attributes.CREATOR), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    _result = executeDeleteIndex(data.readString(), data.createStringArrayList(), data.createTypedArrayList(Attributes.CREATOR), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    List<SearchIntentItem> _result3 = executeIntentSearch(data.readString(), data.readString(), data.createStringArrayList(), data.readString(), data.readString());
                    reply.writeNoException();
                    reply.writeTypedList(_result3);
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    List<Word> _result4 = executeAnalyzeText(data.readString(), data.readString(), data.readString());
                    reply.writeNoException();
