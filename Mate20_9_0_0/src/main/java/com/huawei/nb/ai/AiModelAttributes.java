...
public class AiModelAttributes {
    ...
    public static List<String> getEncryptedAttributes() {
        ...
        synchronized (AiModelAttributes.class) {
            if (encryptedAttributes == null) {
                ...
                encryptedAttributes.add("file_path");
            }
            list = encryptedAttributes;
        }
        return list;
    }
    ...
    public static Map<String, Supplier<Object>> getPrimaryKeyAttributes(AiModel model) {
        ...
        model.getClass();
        keyAttrs.put("id", AiModelAttributes$$Lambda$43.get$Lambda(model));
        return keyAttrs;
    }
    ...
    public static Map<String, Supplier<Object>> getJsonAttributes(AiModel model) {
        ...
        model.getClass();
        jsonAttrs.put("encrypt_desc", AiModelAttributes$$Lambda$44.get$Lambda(model));
        model.getClass();
        jsonAttrs.put("compression_desc", AiModelAttributes$$Lambda$45.get$Lambda(model));
        model.getClass();
        jsonAttrs.put("reserved_attributes", AiModelAttributes$$Lambda$46.get$Lambda(model));
        model.getClass();
        jsonAttrs.put("cloud_update_policy", AiModelAttributes$$Lambda$47.get$Lambda(model));
        model.getClass();
        jsonAttrs.put("allowed_user", AiModelAttributes$$Lambda$48.get$Lambda(model));
        model.getClass();
        jsonAttrs.put("current_business", AiModelAttributes$$Lambda$49.get$Lambda(model));
        model.getClass();
        jsonAttrs.put("usable_condition", AiModelAttributes$$Lambda$50.get$Lambda(model));
        model.getClass();
        jsonAttrs.put("reserved_1", AiModelAttributes$$Lambda$51.get$Lambda(model));
        model.getClass();
        jsonAttrs.put("reserved_2", AiModelAttributes$$Lambda$52.get$Lambda(model));
        return jsonAttrs;
    }
    ...
    public static Map<String, Consumer<String>> setAttributes(AiModel model) {
        ...
        model.getClass();
        attributes.put("key", AiModelAttributes$$Lambda$53.get$Lambda(model));
        model.getClass();
        attributes.put("serial_number", AiModelAttributes$$Lambda$54.get$Lambda(model));
        model.getClass();
        attributes.put("name", AiModelAttributes$$Lambda$55.get$Lambda(model));
        model.getClass();
        attributes.put("description", AiModelAttributes$$Lambda$56.get$Lambda(model));
        model.getClass();
        attributes.put("file_path", AiModelAttributes$$Lambda$57.get$Lambda(model));
        model.getClass();
        attributes.put("platform", AiModelAttributes$$Lambda$58.get$Lambda(model));
        model.getClass();
        attributes.put("tech_domain", AiModelAttributes$$Lambda$59.get$Lambda(model));
        model.getClass();
        attributes.put("busi_domain", AiModelAttributes$$Lambda$60.get$Lambda(model));
        model.getClass();
        attributes.put("region", AiModelAttributes$$Lambda$61.get$Lambda(model));
        model.getClass();
        attributes.put("chip_type", AiModelAttributes$$Lambda$62.get$Lambda(model));
        model.getClass();
        attributes.put("format", AiModelAttributes$$Lambda$63.get$Lambda(model));
        model.getClass();
        attributes.put("storage_type", AiModelAttributes$$Lambda$64.get$Lambda(model));
        model.getClass();
        attributes.put("suffix", AiModelAttributes$$Lambda$65.get$Lambda(model));
        model.getClass();
        attributes.put("create_type", AiModelAttributes$$Lambda$66.get$Lambda(model));
        model.getClass();
        attributes.put("create_user", AiModelAttributes$$Lambda$67.get$Lambda(model));
        model.getClass();
        attributes.put("last_update_type", AiModelAttributes$$Lambda$68.get$Lambda(model));
        model.getClass();
        attributes.put("encrypt_desc", AiModelAttributes$$Lambda$69.get$Lambda(model));
        model.getClass();
        attributes.put("compression_desc", AiModelAttributes$$Lambda$70.get$Lambda(model));
        model.getClass();
        attributes.put("reserved_attributes", AiModelAttributes$$Lambda$71.get$Lambda(model));
        model.getClass();
        attributes.put("cloud_update_policy", AiModelAttributes$$Lambda$72.get$Lambda(model));
        model.getClass();
        attributes.put("allowed_user", AiModelAttributes$$Lambda$73.get$Lambda(model));
        model.getClass();
        attributes.put("current_business", AiModelAttributes$$Lambda$74.get$Lambda(model));
        model.getClass();
        attributes.put("usable_condition", AiModelAttributes$$Lambda$75.get$Lambda(model));
        model.getClass();
        attributes.put("check_code", AiModelAttributes$$Lambda$76.get$Lambda(model));
        model.getClass();
        attributes.put("reserved_1", AiModelAttributes$$Lambda$77.get$Lambda(model));
        model.getClass();
        attributes.put("reserved_2", AiModelAttributes$$Lambda$78.get$Lambda(model));
        return attributes;
    }
