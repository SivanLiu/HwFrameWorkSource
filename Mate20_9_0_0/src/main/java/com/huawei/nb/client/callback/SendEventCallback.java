...
import com.huawei.nb.callback.ISendEventCallback.Stub;
import com.huawei.nb.container.ObjectContainer;
import java.util.Collections;
import java.util.List;

public class SendEventCallback extends Stub implements WaitableCallback<List> {
    private final CallbackManager callbackManager;
    private final CallbackWaiter<List> callbackWaiter = new CallbackWaiter(Collections.EMPTY_LIST);

    SendEventCallback(CallbackManager callbackManager) {
