...
import com.huawei.nb.query.RelationshipQuery.RelationType;
...
public class AObjectContextAdapter implements ObjectContext {
    ...
    public AObjectContextAdapter(IClient client) {
        this.client = client;
    }
    ...
    public ManagedObject getToOneRelationshipValue(String fieldName, ManagedObject object) {
        ...
        List retObjects = this.client.executeQuery(new RelationshipQuery(object.getObjectId().getEntityName(), object.getObjectId().getId(), fieldName, RelationType.TO_ONE));
    ...
    public List<? extends ManagedObject> getToManyRelationshipValue(String fieldName, ManagedObject object) {
        ...
        return this.client.executeQuery(new RelationshipQuery(object.getObjectId().getEntityName(), object.getObjectId().getId(), fieldName, RelationType.TO_MANY));
    }
