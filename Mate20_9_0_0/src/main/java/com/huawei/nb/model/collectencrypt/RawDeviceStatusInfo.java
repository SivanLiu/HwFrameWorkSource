...
public class RawDeviceStatusInfo extends AManagedObject {
    public static final Creator<RawDeviceStatusInfo> CREATOR = new Creator<RawDeviceStatusInfo>() {
    ...
    private RawDeviceStatusInfo(Integer mId, Date mTimeStamp, String mMemoryInfo, String mCPUInfo, String mBatteryInfo, String mNetStat, Integer mBluetoohStat, Integer mReservedInt, String mReservedText) {
        this.mId = mId;
