...
public class ClusterLocCache extends AManagedObject {
    public static final Creator<ClusterLocCache> CREATOR = new Creator<ClusterLocCache>() {
        public ClusterLocCache createFromParcel(Parcel in) {
            return new ClusterLocCache(in);
        }

        public ClusterLocCache[] newArray(int size) {
            return new ClusterLocCache[size];
        }
    };
    ...
    public ClusterLocCache(Cursor cursor) {
        Long l = null;
    ...
    public ClusterLocCache(Parcel in) {
        String str = null;
        super(in);
    ...
    private ClusterLocCache(Integer id, Integer dataType, Long timestamp, String column0, String column1, String column2, String column3, String column4, String column5, String column6, String column7, String column8, String column9, String column10, String column11, String column12, String column13, String column14, String column15, String column16, String column17, String column18, String column19) {
        this.id = id;
    ...
    public AEntityHelper<ClusterLocCache> getHelper() {
        return ClusterLocCacheHelper.getInstance();
    }

    public String getEntityName() {
        return "com.huawei.nb.model.pengine.ClusterLocCache";
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ClusterLocCache { id: ").append(this.id);
