...
public class RawAppProbe extends AManagedObject {
    public static final Creator<RawAppProbe> CREATOR = new Creator<RawAppProbe>() {
        public RawAppProbe createFromParcel(Parcel in) {
            return new RawAppProbe(in);
        }

        public RawAppProbe[] newArray(int size) {
            return new RawAppProbe[size];
        }
    };
    ...
    public RawAppProbe(Cursor cursor) {
        Integer num = null;
    ...
    private RawAppProbe(Integer mId, Date mTimeStamp, Integer mEventID, String mPackageName, String mContent, String mAppVersion, Integer mReservedInt, String mReservedText) {
        this.mId = mId;
    ...
    public AEntityHelper<RawAppProbe> getHelper() {
        return RawAppProbeHelper.getInstance();
    }

    public String getEntityName() {
        return "com.huawei.nb.model.collectencrypt.RawAppProbe";
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("RawAppProbe { mId: ").append(this.mId);
