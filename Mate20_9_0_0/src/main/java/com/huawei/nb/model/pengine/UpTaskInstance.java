...
public class UpTaskInstance extends AManagedObject {
    public static final Creator<UpTaskInstance> CREATOR = new Creator<UpTaskInstance>() {
    ...
    private UpTaskInstance(Integer taskId, Long jobId, String taskName, String status, String result, String resultDesc, Long createTime, Long lastModifyTime, String attrs) {
        this.taskId = taskId;
        this.jobId = jobId;
