...
public class CapLocation extends AManagedObject {
    public static final Creator<CapLocation> CREATOR = new Creator<CapLocation>() {
        public CapLocation createFromParcel(Parcel in) {
            return new CapLocation(in);
        }

        public CapLocation[] newArray(int size) {
            return new CapLocation[size];
        }
    };
    ...
    public CapLocation(Cursor cursor) {
        Long l = null;
    ...
    public AEntityHelper<CapLocation> getHelper() {
        return CapLocationHelper.getInstance();
    }

    public String getEntityName() {
        return "com.huawei.nb.model.pengine.CapLocation";
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("CapLocation { id: ").append(this.id);
