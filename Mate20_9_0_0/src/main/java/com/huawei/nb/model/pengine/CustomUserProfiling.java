...
public class CustomUserProfiling extends AManagedObject {
    public static final Creator<CustomUserProfiling> CREATOR = new Creator<CustomUserProfiling>() {
    ...
    private CustomUserProfiling(Integer id, String parent, Integer level, String uriKey, String uriValue, Long timestamp) {
        this.id = id;
        this.parent = parent;
        this.level = level;
        this.uriKey = uriKey;
