...
public class ClusterEnterExitCache extends AManagedObject {
    public static final Creator<ClusterEnterExitCache> CREATOR = new Creator<ClusterEnterExitCache>() {
        public ClusterEnterExitCache createFromParcel(Parcel in) {
            return new ClusterEnterExitCache(in);
        }

        public ClusterEnterExitCache[] newArray(int size) {
            return new ClusterEnterExitCache[size];
        }
    };
    ...
    public ClusterEnterExitCache(Cursor cursor) {
        Long l = null;
    ...
    public ClusterEnterExitCache(Parcel in) {
        String str = null;
        super(in);
    ...
    private ClusterEnterExitCache(Integer id, Integer dataType, Long timestamp, String column0, String column1, String column2, String column3, String column4, String column5, String column6, String column7, String column8, String column9, String column10, String column11, String column12, String column13, String column14, String column15, String column16, String column17, String column18, String column19) {
        this.id = id;
    ...
    public AEntityHelper<ClusterEnterExitCache> getHelper() {
        return ClusterEnterExitCacheHelper.getInstance();
    }

    public String getEntityName() {
        return "com.huawei.nb.model.pengine.ClusterEnterExitCache";
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("ClusterEnterExitCache { id: ").append(this.id);
