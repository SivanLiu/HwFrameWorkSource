...
public class CapMediaApp extends AManagedObject {
    public static final Creator<CapMediaApp> CREATOR = new Creator<CapMediaApp>() {
        public CapMediaApp createFromParcel(Parcel in) {
            return new CapMediaApp(in);
        }

        public CapMediaApp[] newArray(int size) {
            return new CapMediaApp[size];
        }
    };
    ...
    public CapMediaApp(Cursor cursor) {
        Long l = null;
    ...
    private CapMediaApp(Integer id, Integer dataType, Long timestamp, String column0, String column1, String column2, String column3, String column4, String column5, String column6, String column7, String column8, String column9, String column10, String column11, String column12, String column13, String column14, String column15, String column16, String column17, String column18, String column19) {
        this.id = id;
    ...
    public AEntityHelper<CapMediaApp> getHelper() {
        return CapMediaAppHelper.getInstance();
    }

    public String getEntityName() {
        return "com.huawei.nb.model.pengine.CapMediaApp";
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("CapMediaApp { id: ").append(this.id);
