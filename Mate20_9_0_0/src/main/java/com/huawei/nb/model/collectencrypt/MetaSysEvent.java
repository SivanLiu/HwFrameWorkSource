...
public class MetaSysEvent extends AManagedObject {
    public static final Creator<MetaSysEvent> CREATOR = new Creator<MetaSysEvent>() {
    ...
    private MetaSysEvent(Integer mId, Date mTimeStamp, String mEventName, String mEventParam, Integer mReservedInt, String mReservedText) {
        this.mId = mId;
