...
public class MidUserProfiling extends AManagedObject {
    public static final Creator<MidUserProfiling> CREATOR = new Creator<MidUserProfiling>() {
        public MidUserProfiling createFromParcel(Parcel in) {
            return new MidUserProfiling(in);
        }

        public MidUserProfiling[] newArray(int size) {
            return new MidUserProfiling[size];
        }
    };
    ...
    public MidUserProfiling(Cursor cursor) {
        Long l = null;
    ...
    public MidUserProfiling(Parcel in) {
        String str = null;
        super(in);
    ...
    private MidUserProfiling(Integer id, Integer dataType, Long timestamp, String column0, String column1, String column2, String column3, String column4, String column5, String column6, String column7, String column8, String column9, String column10, String column11, String column12, String column13, String column14, String column15, String column16, String column17, String column18, String column19) {
        this.id = id;
    ...
    public AEntityHelper<MidUserProfiling> getHelper() {
        return MidUserProfilingHelper.getInstance();
    }

    public String getEntityName() {
        return "com.huawei.nb.model.pengine.MidUserProfiling";
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("MidUserProfiling { id: ").append(this.id);
