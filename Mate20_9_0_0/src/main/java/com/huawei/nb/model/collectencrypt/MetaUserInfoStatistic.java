...
public class MetaUserInfoStatistic extends AManagedObject {
    public static final Creator<MetaUserInfoStatistic> CREATOR = new Creator<MetaUserInfoStatistic>() {
