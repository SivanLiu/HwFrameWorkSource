...
public class UpOnceTaskHistory extends AManagedObject {
    public static final Creator<UpOnceTaskHistory> CREATOR = new Creator<UpOnceTaskHistory>() {
    ...
    private UpOnceTaskHistory(Integer hisId, String taskName, Integer version, String taskType, Long executeTime) {
        this.hisId = hisId;
