...
public class CapCellInfo extends AManagedObject {
    public static final Creator<CapCellInfo> CREATOR = new Creator<CapCellInfo>() {
        public CapCellInfo createFromParcel(Parcel in) {
            return new CapCellInfo(in);
        }

        public CapCellInfo[] newArray(int size) {
            return new CapCellInfo[size];
        }
    };
    ...
    private CapCellInfo(Integer id, Integer dataType, Long timestamp, String column0, String column1, String column2, String column3, String column4, String column5, String column6, String column7, String column8, String column9, String column10, String column11, String column12, String column13, String column14, String column15, String column16, String column17, String column18, String column19) {
        this.id = id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("CapCellInfo { id: ").append(this.id);
