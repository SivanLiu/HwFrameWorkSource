...
public class UpJobInstance extends AManagedObject {
    public static final Creator<UpJobInstance> CREATOR = new Creator<UpJobInstance>() {
    ...
    private UpJobInstance(Integer id, String type, String status, String tasks, String result, String resultDesc, Long analyzeTime, Long createTime, Long lastModifyTime) {
        this.id = id;
        this.type = type;
        this.status = status;
        this.tasks = tasks;
