...
public class CapCarInfo extends AManagedObject {
    public static final Creator<CapCarInfo> CREATOR = new Creator<CapCarInfo>() {
        public CapCarInfo createFromParcel(Parcel in) {
            return new CapCarInfo(in);
        }

        public CapCarInfo[] newArray(int size) {
            return new CapCarInfo[size];
        }
    };
    ...
    public CapCarInfo(Cursor cursor) {
        Long l = null;
    ...
    private CapCarInfo(Integer id, Integer dataType, Long timestamp, String column0, String column1, String column2, String column3, String column4, String column5, String column6, String column7, String column8, String column9, String column10, String column11, String column12, String column13, String column14, String column15, String column16, String column17, String column18, String column19) {
        this.id = id;
    ...
    public AEntityHelper<CapCarInfo> getHelper() {
        return CapCarInfoHelper.getInstance();
    }

    public String getEntityName() {
        return "com.huawei.nb.model.pengine.CapCarInfo";
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("CapCarInfo { id: ").append(this.id);
