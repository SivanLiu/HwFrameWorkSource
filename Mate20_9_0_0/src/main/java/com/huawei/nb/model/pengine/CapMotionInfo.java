...
public class CapMotionInfo extends AManagedObject {
    public static final Creator<CapMotionInfo> CREATOR = new Creator<CapMotionInfo>() {
        public CapMotionInfo createFromParcel(Parcel in) {
            return new CapMotionInfo(in);
        }

        public CapMotionInfo[] newArray(int size) {
            return new CapMotionInfo[size];
        }
    };
    ...
    public CapMotionInfo(Cursor cursor) {
        Long l = null;
    ...
    public CapMotionInfo(Parcel in) {
        String str = null;
        super(in);
    ...
    public AEntityHelper<CapMotionInfo> getHelper() {
        return CapMotionInfoHelper.getInstance();
    }

    public String getEntityName() {
        return "com.huawei.nb.model.pengine.CapMotionInfo";
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("CapMotionInfo { id: ").append(this.id);
