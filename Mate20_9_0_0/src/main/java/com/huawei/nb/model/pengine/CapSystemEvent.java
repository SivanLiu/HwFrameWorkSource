...
public class CapSystemEvent extends AManagedObject {
    public static final Creator<CapSystemEvent> CREATOR = new Creator<CapSystemEvent>() {
        public CapSystemEvent createFromParcel(Parcel in) {
            return new CapSystemEvent(in);
        }

        public CapSystemEvent[] newArray(int size) {
            return new CapSystemEvent[size];
        }
    };
    ...
    public CapSystemEvent(Cursor cursor) {
        Long l = null;
    ...
    public CapSystemEvent(Parcel in) {
        String str = null;
        super(in);
    ...
    private CapSystemEvent(Integer id, Integer dataType, Long timestamp, String column0, String column1, String column2, String column3, String column4, String column5, String column6, String column7, String column8, String column9, String column10, String column11, String column12, String column13, String column14, String column15, String column16, String column17, String column18, String column19) {
        this.id = id;
    ...
    public AEntityHelper<CapSystemEvent> getHelper() {
        return CapSystemEventHelper.getInstance();
    }

    public String getEntityName() {
        return "com.huawei.nb.model.pengine.CapSystemEvent";
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("CapSystemEvent { id: ").append(this.id);
