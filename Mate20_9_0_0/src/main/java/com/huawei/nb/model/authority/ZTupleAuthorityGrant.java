...
public class ZTupleAuthorityGrant extends AManagedObject {
    public static final Creator<ZTupleAuthorityGrant> CREATOR = new Creator<ZTupleAuthorityGrant>() {
    ...
    private ZTupleAuthorityGrant(Long id, Long tableId, String tableName, Long tupleId, String tupleName, Long packageUid, String packageName, Integer authority, Boolean supportGroupAuthority, String reserved) {
        this.id = id;
