...
public class RawMediaAppStastic extends AManagedObject {
    public static final Creator<RawMediaAppStastic> CREATOR = new Creator<RawMediaAppStastic>() {
    ...
    private RawMediaAppStastic(Integer mId, Date mTimeStamp, String mPhotoTagInfo, String mTopCameraMode, Integer mTourismPhotoNum, Integer mFrontPhotoNum, String mAppInstalled, String mAppUsageTime, String mMusicGenres, String mMusicArtist, String mMusicYear, Integer mReservedInt, String mReservedText) {
        this.mId = mId;
