...
public class MetaDeviceInfo extends AManagedObject {
    public static final Creator<MetaDeviceInfo> CREATOR = new Creator<MetaDeviceInfo>() {
        public MetaDeviceInfo createFromParcel(Parcel in) {
            return new MetaDeviceInfo(in);
        }

        public MetaDeviceInfo[] newArray(int size) {
            return new MetaDeviceInfo[size];
        }
    };
    ...
    public MetaDeviceInfo(Parcel in) {
        String str = null;
        super(in);
    ...
    private MetaDeviceInfo(Integer mId, Date mTimeStamp, String mDeviceName, String mHardwareVer, String mSoftwareVer, String mIMEI1, String mIMEI2, String mIMSI1, String mIMSI2, String mSN, String mLanguageRegion, Integer mReservedInt, String mReservedText) {
        this.mId = mId;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("MetaDeviceInfo { mId: ").append(this.mId);
