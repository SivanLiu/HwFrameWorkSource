...
public class CapSemanticAnalysis extends AManagedObject {
    public static final Creator<CapSemanticAnalysis> CREATOR = new Creator<CapSemanticAnalysis>() {
        public CapSemanticAnalysis createFromParcel(Parcel in) {
            return new CapSemanticAnalysis(in);
        }

        public CapSemanticAnalysis[] newArray(int size) {
            return new CapSemanticAnalysis[size];
        }
    };
    ...
    public CapSemanticAnalysis(Cursor cursor) {
        Long l = null;
    ...
    public CapSemanticAnalysis(Parcel in) {
        String str = null;
        super(in);
    ...
    private CapSemanticAnalysis(Integer id, Integer dataType, Long timestamp, String column0, String column1, String column2, String column3, String column4, String column5, String column6, String column7, String column8, String column9, String column10, String column11, String column12, String column13, String column14, String column15, String column16, String column17, String column18, String column19) {
        this.id = id;
    ...
    public AEntityHelper<CapSemanticAnalysis> getHelper() {
        return CapSemanticAnalysisHelper.getInstance();
    }

    public String getEntityName() {
        return "com.huawei.nb.model.pengine.CapSemanticAnalysis";
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("CapSemanticAnalysis { id: ").append(this.id);
