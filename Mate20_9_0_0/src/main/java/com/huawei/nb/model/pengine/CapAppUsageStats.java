...
public class CapAppUsageStats extends AManagedObject {
    public static final Creator<CapAppUsageStats> CREATOR = new Creator<CapAppUsageStats>() {
        public CapAppUsageStats createFromParcel(Parcel in) {
            return new CapAppUsageStats(in);
        }

        public CapAppUsageStats[] newArray(int size) {
            return new CapAppUsageStats[size];
        }
    };
    ...
    public CapAppUsageStats(Cursor cursor) {
        Long l = null;
    ...
    public CapAppUsageStats(Parcel in) {
        String str = null;
        super(in);
    ...
    private CapAppUsageStats(Integer id, Integer dataType, Long timestamp, String column0, String column1, String column2, String column3, String column4, String column5, String column6, String column7, String column8, String column9, String column10, String column11, String column12, String column13, String column14, String column15, String column16, String column17, String column18, String column19) {
        this.id = id;
    ...
    public AEntityHelper<CapAppUsageStats> getHelper() {
        return CapAppUsageStatsHelper.getInstance();
    }

    public String getEntityName() {
        return "com.huawei.nb.model.pengine.CapAppUsageStats";
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("CapAppUsageStats { id: ").append(this.id);
