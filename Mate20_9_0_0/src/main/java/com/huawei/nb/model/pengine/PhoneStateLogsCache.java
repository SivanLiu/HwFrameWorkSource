...
public class PhoneStateLogsCache extends AManagedObject {
    public static final Creator<PhoneStateLogsCache> CREATOR = new Creator<PhoneStateLogsCache>() {
        public PhoneStateLogsCache createFromParcel(Parcel in) {
            return new PhoneStateLogsCache(in);
        }

        public PhoneStateLogsCache[] newArray(int size) {
            return new PhoneStateLogsCache[size];
        }
    };
    ...
    public PhoneStateLogsCache(Cursor cursor) {
        Long l = null;
    ...
    public PhoneStateLogsCache(Parcel in) {
        String str = null;
        super(in);
    ...
    private PhoneStateLogsCache(Integer id, Integer dataType, Long timestamp, String column0, String column1, String column2, String column3, String column4, String column5, String column6, String column7, String column8, String column9, String column10, String column11, String column12, String column13, String column14, String column15, String column16, String column17, String column18, String column19) {
        this.id = id;
    ...
    public AEntityHelper<PhoneStateLogsCache> getHelper() {
        return PhoneStateLogsCacheHelper.getInstance();
    }

    public String getEntityName() {
        return "com.huawei.nb.model.pengine.PhoneStateLogsCache";
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("PhoneStateLogsCache { id: ").append(this.id);
