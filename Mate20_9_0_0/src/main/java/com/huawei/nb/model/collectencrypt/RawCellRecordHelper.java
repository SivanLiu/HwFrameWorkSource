...
public class RawCellRecordHelper extends AEntityHelper<RawCellRecord> {
    private static final RawCellRecordHelper INSTANCE = new RawCellRecordHelper();

    private RawCellRecordHelper() {
    }

    public static RawCellRecordHelper getInstance() {
        return INSTANCE;
    }

    public void bindValue(Statement statement, RawCellRecord object) {
    ...
    public RawCellRecord readObject(Cursor cursor, int offset) {
        return new RawCellRecord(cursor);
    }

    public void setPrimaryKeyValue(RawCellRecord object, long value) {
        object.setMId(Integer.valueOf((int) value));
    }

    public Object getRelationshipObject(String field, RawCellRecord object) {
        return null;
    }
