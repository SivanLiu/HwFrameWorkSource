...
public class RawUserInfoStatisticHelper extends AEntityHelper<RawUserInfoStatistic> {
    private static final RawUserInfoStatisticHelper INSTANCE = new RawUserInfoStatisticHelper();

    private RawUserInfoStatisticHelper() {
    }

    public static RawUserInfoStatisticHelper getInstance() {
        return INSTANCE;
    }

    public void bindValue(Statement statement, RawUserInfoStatistic object) {
    ...
    public RawUserInfoStatistic readObject(Cursor cursor, int offset) {
        return new RawUserInfoStatistic(cursor);
    }

    public void setPrimaryKeyValue(RawUserInfoStatistic object, long value) {
        object.setMId(Integer.valueOf((int) value));
    }

    public Object getRelationshipObject(String field, RawUserInfoStatistic object) {
        return null;
    }
