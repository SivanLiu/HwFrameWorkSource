...
public class WifiAggClusterCache extends AManagedObject {
    public static final Creator<WifiAggClusterCache> CREATOR = new Creator<WifiAggClusterCache>() {
        public WifiAggClusterCache createFromParcel(Parcel in) {
            return new WifiAggClusterCache(in);
        }

        public WifiAggClusterCache[] newArray(int size) {
            return new WifiAggClusterCache[size];
        }
    };
    ...
    public WifiAggClusterCache(Cursor cursor) {
        Long l = null;
    ...
    public WifiAggClusterCache(Parcel in) {
        String str = null;
        super(in);
    ...
    private WifiAggClusterCache(Integer id, Integer dataType, Long timestamp, String column0, String column1, String column2, String column3, String column4, String column5, String column6, String column7, String column8, String column9, String column10, String column11, String column12, String column13, String column14, String column15, String column16, String column17, String column18, String column19) {
        this.id = id;
    ...
    public AEntityHelper<WifiAggClusterCache> getHelper() {
        return WifiAggClusterCacheHelper.getInstance();
    }

    public String getEntityName() {
        return "com.huawei.nb.model.pengine.WifiAggClusterCache";
    }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("WifiAggClusterCache { id: ").append(this.id);
