...
public class VerifySigature implements IVerify {
    ...
    public boolean generateAuthorization(Context context, Builder builder, String appID) {
        ...
        builder.addRequestHeader(IVerifyVar.DEVICETOKE, deviceToken);
        builder.addRequestHeader("SN", serialNumber);
    ...
    private String getEncryptedCode(Context context, String originCode) {
        return new VerifyViaHWMember().getSignature(originCode, context.getPackageName()).replace(IOUtils.LINE_SEPARATOR_UNIX, "");
    }
}
