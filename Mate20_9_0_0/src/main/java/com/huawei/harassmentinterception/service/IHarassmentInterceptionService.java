            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    case 1:
                        ...
                        _result = setPhoneNumberBlockList(_arg0, data.readInt(), data.readInt());
                    ...
                    case 2:
                        ...
                        _result = addPhoneNumberBlockItem(_arg0, data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result);
                        return true;
                    case 3:
                        ...
                        _result = removePhoneNumberBlockItem(_arg0, data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result);
                        return true;
                    case 4:
                    ...
                    case 5:
                        ...
                        _result3 = checkPhoneNumberFromBlockItem(_arg0, data.readInt());
                        reply.writeNoException();
                    ...
                    case 7:
                        ...
                        _result4 = handleSmsDeliverAction(_arg0);
                        reply.writeNoException();
                    ...
                    case 8:
                        ...
                        _result4 = handleIncomingCallAction(_arg0);
                        reply.writeNoException();
                        reply.writeInt(_result4);
                        return true;
                    case 9:
                        ...
                        _result3 = checkPhoneNumberFromWhiteItem(_arg0, data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case 10:
                        ...
                        _result = removePhoneNumberFromWhiteItem(_arg0, data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result);
                        return true;
                    case 11:
                        ...
                        _result = addPhoneNumberWhiteItem(_arg0, data.readInt(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result);
                        return true;
                    case 12:
                    ...
                    case 13:
                        ...
                        Bundle _result5 = callHarassmentInterceptionService(_arg02, _arg0);
                        reply.writeNoException();
                        if (_result5 != null) {
                            reply.writeInt(1);
                    ...
                    case 14:
                        ...
                        boolean _result6 = sendGoogleNBRecord(_arg0);
                        reply.writeNoException();
                    ...
                    case 15:
                        ...
                        Bundle _result7 = handleInComingCallAndGetNumberMark(_arg0);
                        reply.writeNoException();
                        if (_result7 != null) {
                            reply.writeInt(1);
