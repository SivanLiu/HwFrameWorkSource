...
public final class RILDataCallProfileInfo {
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.profileId))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.priority)))});
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<RILDataCallProfileInfo> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((RILDataCallProfileInfo) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 8));
            _hidl_index_0++;
        }
