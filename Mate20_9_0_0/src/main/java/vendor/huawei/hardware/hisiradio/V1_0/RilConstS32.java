...
public final class RilConstS32 {
    ...
    public static final String toString(int o) {
        ...
        if (o == RIL_UNSOL_HW_REC_PSE_BASESTATION_REPORT) {
    ...
    public static final String dumpBitfield(int o) {
        ...
        if ((o & RIL_UNSOL_HW_REC_PSE_BASESTATION_REPORT) == RIL_UNSOL_HW_REC_PSE_BASESTATION_REPORT) {
            list.add("RIL_UNSOL_HW_REC_PSE_BASESTATION_REPORT");
            flipped |= RIL_UNSOL_HW_REC_PSE_BASESTATION_REPORT;
        }
        if (o != flipped) {
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("0x");
