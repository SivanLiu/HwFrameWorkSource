...
public final class RILUICCAUTHPARAMS {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.randLen = hwBlob.getInt32(_hidl_offset + 0);
        this.rand = hwBlob.getString(_hidl_offset + 8);
        parcel.readEmbeddedBuffer((long) (this.rand.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 8) + 0, false);
        this.authLen = hwBlob.getInt32(_hidl_offset + 24);
        this.auth = hwBlob.getString(_hidl_offset + 32);
        parcel.readEmbeddedBuffer((long) (this.auth.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 32) + 0, false);
    }
