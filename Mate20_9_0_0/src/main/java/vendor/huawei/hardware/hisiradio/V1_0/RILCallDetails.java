...
public final class RILCallDetails {
    ...
    public final String toString() {
        ...
        builder.append(RILCallType.toString(this.callType));
        builder.append(", .callDomain = ");
        builder.append(RILCallDomain.toString(this.callDomain));
        builder.append(", .extrasLength = ");
        builder.append(this.extrasLength);
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<RILCallDetails> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((RILCallDetails) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 16));
            _hidl_index_0++;
        }
