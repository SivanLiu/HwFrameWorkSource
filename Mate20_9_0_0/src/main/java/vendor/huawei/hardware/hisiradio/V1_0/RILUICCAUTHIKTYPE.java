...
public final class RILUICCAUTHIKTYPE {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.ikPresent == other.ikPresent && this.ikLen == other.ikLen && HidlSupport.deepEquals(this.ik, other.ik)) {
            return true;
        }
        return false;
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.ikPresent = hwBlob.getInt32(_hidl_offset + 0);
        this.ikLen = hwBlob.getInt32(_hidl_offset + 4);
        this.ik = hwBlob.getString(_hidl_offset + 8);
        parcel.readEmbeddedBuffer((long) (this.ik.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 8) + 0, false);
    }
