...
public final class RILImsMtStatusReport {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.failCause = hwBlob.getInt32(_hidl_offset + 0);
        this.callStatus = hwBlob.getInt32(_hidl_offset + 4);
        this.pNumber = hwBlob.getString(_hidl_offset + 8);
        parcel.readEmbeddedBuffer((long) (this.pNumber.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 8) + 0, false);
    }
