...
public final class RILImsHandover {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.hoType == other.hoType && this.srcTech == other.srcTech && this.dstTech == other.dstTech && HidlSupport.deepEquals(this.hoExtra, other.hoExtra) && this.errorCode == other.errorCode) {
            return true;
        }
        return false;
    }
