...
public final class CellInfo {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size * 64), _hidl_blob.handle(), (_hidl_offset + 24) + 0, 1);
        this.gsm.clear();
        ...
        for (_hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size2; _hidl_index_0++) {
            ...
            _hidl_vec_element.readEmbeddedFromParcel(hwParcel, childBlob, (long) (_hidl_index_0 * 64));
            this.gsm.add(_hidl_vec_element);
        }
        _hidl_vec_size2 = hwBlob.getInt32((_hidl_offset + 40) + 8);
        childBlob = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size2 * 40), _hidl_blob.handle(), (_hidl_offset + 40) + 0, true);
        this.cdma.clear();
        for (_hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size2; _hidl_index_0++) {
            CellInfoCdma _hidl_vec_element2 = new CellInfoCdma();
            _hidl_vec_element2.readEmbeddedFromParcel(hwParcel, childBlob, (long) (_hidl_index_0 * 40));
            this.cdma.add(_hidl_vec_element2);
        }
        _hidl_vec_size2 = hwBlob.getInt32((_hidl_offset + 56) + 8);
        childBlob = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size2 * 72), _hidl_blob.handle(), (_hidl_offset + 56) + 0, true);
        this.lte.clear();
        for (_hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size2; _hidl_index_0++) {
            CellInfoLte _hidl_vec_element3 = new CellInfoLte();
            _hidl_vec_element3.readEmbeddedFromParcel(hwParcel, childBlob, (long) (_hidl_index_0 * 72));
            this.lte.add(_hidl_vec_element3);
        }
        _hidl_vec_size2 = hwBlob.getInt32((_hidl_offset + 72) + 8);
        childBlob = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size2 * 56), _hidl_blob.handle(), (_hidl_offset + 72) + 0, true);
        this.wcdma.clear();
        for (_hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size2; _hidl_index_0++) {
            CellInfoWcdma _hidl_vec_element4 = new CellInfoWcdma();
            _hidl_vec_element4.readEmbeddedFromParcel(hwParcel, childBlob, (long) (_hidl_index_0 * 56));
            this.wcdma.add(_hidl_vec_element4);
        }
        _hidl_vec_size2 = hwBlob.getInt32((_hidl_offset + 88) + 8);
        childBlob = hwParcel.readEmbeddedBuffer((long) (_hidl_vec_size2 * 56), _hidl_blob.handle(), 0 + (_hidl_offset + 88), true);
        this.tdscdma.clear();
        while (true) {
            _hidl_index_0 = _hidl_index_02;
            if (_hidl_index_0 < _hidl_vec_size2) {
                CellInfoTdscdma _hidl_vec_element5 = new CellInfoTdscdma();
                _hidl_vec_element5.readEmbeddedFromParcel(hwParcel, childBlob, (long) (_hidl_index_0 * 56));
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob2 = new HwBlob(_hidl_vec_size * 56);
        while (true) {
            int _hidl_index_03 = _hidl_index_02;
            if (_hidl_index_03 < _hidl_vec_size) {
                ((CellInfoTdscdma) this.tdscdma.get(_hidl_index_03)).writeEmbeddedToBlob(childBlob2, (long) (_hidl_index_03 * 56));
