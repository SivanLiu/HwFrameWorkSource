...
public final class RILImsDataConnectInd {
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.domain))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.addrType))), Integer.valueOf(HidlSupport.deepHashCode(this.ipAddress))});
    }
    ...
    public final String toString() {
        ...
        builder.append(RILIpAddrType.toString(this.addrType));
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<RILImsDataConnectInd> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((RILImsDataConnectInd) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 128));
            _hidl_index_0++;
        }
