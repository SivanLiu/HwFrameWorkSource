...
public final class HwCall_V1_2 {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.call.readEmbeddedFromParcel(hwParcel, hwBlob, _hidl_offset + 0);
        this.redirectNumber = hwBlob.getString(_hidl_offset + 88);
        hwParcel.readEmbeddedBuffer((long) (this.redirectNumber.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 88) + 0, false);
        this.redirectNumberToa = hwBlob.getInt32(_hidl_offset + 104);
        this.redirectNumberPresentation = hwBlob.getInt32(_hidl_offset + 108);
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<HwCall_V1_2> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((HwCall_V1_2) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 112));
            _hidl_index_0++;
        }
