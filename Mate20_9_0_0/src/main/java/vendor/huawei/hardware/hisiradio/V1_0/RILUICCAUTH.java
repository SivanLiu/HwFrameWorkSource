...
public final class RILUICCAUTH {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (otherObject == null || otherObject.getClass() != RILUICCAUTH.class) {
            return false;
        }
        RILUICCAUTH other = (RILUICCAUTH) otherObject;
        if (this.authType == other.authType && HidlSupport.deepEquals(this.authParams, other.authParams)) {
            return true;
        }
        return false;
    }
    ...
    public static final ArrayList<RILUICCAUTH> readVectorFromParcel(HwParcel parcel) {
        ArrayList<RILUICCAUTH> _hidl_vec = new ArrayList();
        HwBlob _hidl_blob = parcel.readBuffer(16);
        int _hidl_vec_size = _hidl_blob.getInt32(8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 56), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            RILUICCAUTH _hidl_vec_element = new RILUICCAUTH();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<RILUICCAUTH> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((RILUICCAUTH) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 56));
            _hidl_index_0++;
        }
