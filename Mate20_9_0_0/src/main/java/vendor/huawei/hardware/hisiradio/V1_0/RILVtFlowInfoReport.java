...
public final class RILVtFlowInfoReport {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.currVtTime = hwBlob.getString(_hidl_offset + 0);
        parcel.readEmbeddedBuffer((long) (this.currVtTime.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 0) + 0, false);
        this.currTxFlow = hwBlob.getString(_hidl_offset + 16);
        parcel.readEmbeddedBuffer((long) (this.currTxFlow.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 16) + 0, false);
        this.currRxFlow = hwBlob.getString(_hidl_offset + 32);
        parcel.readEmbeddedBuffer((long) (this.currRxFlow.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 32) + 0, false);
    }
