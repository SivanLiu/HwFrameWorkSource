...
public final class RILVsimContentResponse {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.cardCap = hwBlob.getInt32(_hidl_offset + 4);
        this.cardType = hwBlob.getInt32(_hidl_offset + 8);
        this.imsi = hwBlob.getString(_hidl_offset + 16);
        parcel.readEmbeddedBuffer((long) (this.imsi.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 16) + 0, false);
        this.hplmn = hwBlob.getString(_hidl_offset + 32);
        parcel.readEmbeddedBuffer((long) (this.hplmn.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 32) + 0, false);
    }
