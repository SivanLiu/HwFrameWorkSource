...
public final class RILDsFlowInfoReport {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.currDsTime = hwBlob.getString(_hidl_offset + 0);
        parcel.readEmbeddedBuffer((long) (this.currDsTime.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 0) + 0, false);
        this.txRate = hwBlob.getString(_hidl_offset + 16);
        parcel.readEmbeddedBuffer((long) (this.txRate.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 16) + 0, false);
        this.rxRate = hwBlob.getString(_hidl_offset + 32);
        parcel.readEmbeddedBuffer((long) (this.rxRate.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 32) + 0, false);
        this.currTxFlow = hwBlob.getString(_hidl_offset + 48);
        parcel.readEmbeddedBuffer((long) (this.currTxFlow.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 48) + 0, false);
        this.currRxFlow = hwBlob.getString(_hidl_offset + 64);
        parcel.readEmbeddedBuffer((long) (this.currRxFlow.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 64) + 0, false);
        this.qosTxRate = hwBlob.getString(_hidl_offset + 80);
        parcel.readEmbeddedBuffer((long) (this.qosTxRate.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 80) + 0, false);
        this.qosRxRate = hwBlob.getString(_hidl_offset + 96);
        parcel.readEmbeddedBuffer((long) (this.qosRxRate.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 96) + 0, false);
    }
