...
public final class RILUICCKSNAFAUTHPARAMS {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.nafLen = hwBlob.getInt32(_hidl_offset + 0);
        this.nafId = hwBlob.getString(_hidl_offset + 8);
        parcel.readEmbeddedBuffer((long) (this.nafId.getBytes().length + 1), _hidl_blob.handle(), (_hidl_offset + 8) + 0, false);
        this.impiLen = hwBlob.getInt32(_hidl_offset + 24);
        this.impi = hwBlob.getString(_hidl_offset + 32);
