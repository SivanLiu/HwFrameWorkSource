...
public final class RILUICCKSNAFAUTHRESPONSE {
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.authStatus))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.ksLen))), Integer.valueOf(HidlSupport.deepHashCode(this.ksNaf))});
    }
    ...
    public final String toString() {
        ...
        builder.append(", .ksLen = ");
        builder.append(this.ksLen);
        builder.append(", .ksNaf = ");
        builder.append(this.ksNaf);
        builder.append("}");
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.authStatus = hwBlob.getInt32(_hidl_offset + 0);
        this.ksLen = hwBlob.getInt32(_hidl_offset + 4);
        this.ksNaf = hwBlob.getString(_hidl_offset + 8);
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<RILUICCKSNAFAUTHRESPONSE> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((RILUICCKSNAFAUTHRESPONSE) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 24));
            _hidl_index_0++;
        }
