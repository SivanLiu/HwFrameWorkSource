...
public final class RILImsExtra {
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.extraType))), Integer.valueOf(HidlSupport.deepHashCode(this.extraInfo))});
    }
    ...
    public final String toString() {
        ...
        builder.append(RILImsExtraType.toString(this.extraType));
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<RILImsExtra> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((RILImsExtra) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 32));
            _hidl_index_0++;
        }
