...
public final class RILUICCAUTHRESPONSE {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.authStatus == other.authStatus && HidlSupport.deepEquals(this.authChallenge, other.authChallenge) && HidlSupport.deepEquals(this.authSyncfail, other.authSyncfail)) {
            return true;
        }
        return false;
    }
