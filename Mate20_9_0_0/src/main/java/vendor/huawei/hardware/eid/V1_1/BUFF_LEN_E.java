...
public final class BUFF_LEN_E {
    ...
    public static final int MAX_CMDLIST_CNT = 32;
    public static final int MAX_LOGO_SIZE = 24576;
    public static final int MAX_TA_PATH_LEN = 512;
    public static final int MAX_UUID_BYTE = 16;
    ...
    public static final String toString(int o) {
        ...
        if (o == 16) {
            return "MAX_UUID_BYTE";
        }
        if (o == 512) {
            return "MAX_TA_PATH_LEN";
        }
        if (o == 32) {
            return "MAX_CMDLIST_CNT";
        }
    ...
    public static final String dumpBitfield(int o) {
        ...
        if ((o & 16) == 16) {
            list.add("MAX_UUID_BYTE");
            flipped |= 16;
        }
        if ((o & 512) == 512) {
            list.add("MAX_TA_PATH_LEN");
            flipped |= 512;
        }
        if ((o & 32) == 32) {
            list.add("MAX_CMDLIST_CNT");
            flipped |= 32;
        }
        if (o != flipped) {
            StringBuilder stringBuilder = new StringBuilder();
