...
public final class CUT_COORDINATE_S {
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.up))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.down))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.left))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.right)))});
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<CUT_COORDINATE_S> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((CUT_COORDINATE_S) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 16));
            _hidl_index_0++;
        }
