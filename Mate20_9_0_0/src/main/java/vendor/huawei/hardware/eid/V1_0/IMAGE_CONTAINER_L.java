...
public final class IMAGE_CONTAINER_L {
    public final byte[] image = new byte[BUFF_LEN_E.IMAGE_NV21_SIZE];
    public int len;
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.copyToInt8Array(4 + _hidl_offset, this.image, BUFF_LEN_E.IMAGE_NV21_SIZE);
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<IMAGE_CONTAINER_L> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((IMAGE_CONTAINER_L) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 460804));
            _hidl_index_0++;
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putInt8Array(4 + _hidl_offset, this.image);
    }
}
