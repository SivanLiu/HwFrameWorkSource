...
public final class IMAGE_ZIP_CONTAINER_S {
    public final byte[] hash = new byte[32];
    public int hash_len;
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.hash_len))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.image_len))), Integer.valueOf(HidlSupport.deepHashCode(this.hash)), Integer.valueOf(HidlSupport.deepHashCode(this.image))});
    }

    public final String toString() {
        StringBuilder builder = new StringBuilder();
        builder.append("{");
        builder.append(".hash_len = ");
        builder.append(this.hash_len);
        builder.append(", .image_len = ");
        builder.append(this.image_len);
        builder.append(", .hash = ");
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<IMAGE_ZIP_CONTAINER_S> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((IMAGE_ZIP_CONTAINER_S) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 131112));
            _hidl_index_0++;
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putInt8Array(8 + _hidl_offset, this.hash);
        _hidl_blob.putInt8Array(40 + _hidl_offset, this.image);
    }
}
