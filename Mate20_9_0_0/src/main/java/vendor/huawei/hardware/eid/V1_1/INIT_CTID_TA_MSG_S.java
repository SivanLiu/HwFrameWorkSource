...
public final class INIT_CTID_TA_MSG_S {
    ...
    public final String toString() {
        ...
        builder.append("{");
        builder.append(".uuid = ");
        builder.append(Arrays.toString(this.uuid));
        builder.append(", .uuid_len = ");
        builder.append(this.uuid_len);
        builder.append(", .ta_path = ");
        builder.append(Arrays.toString(this.ta_path));
        builder.append(", .ta_path_len = ");
        builder.append(this.ta_path_len);
        builder.append(", .cmd_list = ");
        builder.append(Arrays.toString(this.cmd_list));
        builder.append(", .cmdlist_cnt = ");
        builder.append(this.cmdlist_cnt);
        builder.append("}");
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<INIT_CTID_TA_MSG_S> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((INIT_CTID_TA_MSG_S) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 668));
            _hidl_index_0++;
        }
