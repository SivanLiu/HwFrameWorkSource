...
public final class IccIoResultEx {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.isValid = hwBlob.getBool(_hidl_offset + 0);
        this.fileId = hwBlob.getInt32(_hidl_offset + 4);
        this.sw1 = hwBlob.getInt32(_hidl_offset + 8);
        this.sw2 = hwBlob.getInt32(_hidl_offset + 12);
        this.simResponse = hwBlob.getString(_hidl_offset + 16);
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<IccIoResultEx> _hidl_vec) {
        ...
        while (_hidl_index_0 < _hidl_vec_size) {
            ((IccIoResultEx) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 32));
            _hidl_index_0++;
        }
