        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 42:
                    ...
                    _hidl_out_status = registerCallback_1_1(android.hardware.wifi.supplicant.V1_1.ISupplicantStaIfaceCallback.asInterface(_hidl_request.readStrongBinder()));
                    _hidl_reply.writeStatus(0);
                    _hidl_out_status.writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    return;
                ...
                case 48:
                    ...
                    _hidl_request.enforceInterface(ISupplicantStaIface.kInterfaceName);
                    _hidl_out_status3 = enableHiLinkHandshake(_hidl_request.readBool(), _hidl_request.readString());
                    _hidl_reply.writeStatus(0);
                    _hidl_out_status3.writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    return;
