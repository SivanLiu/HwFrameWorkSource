...
public class FingerprintCalibrarionView {
    ...
    public void showHighlightviewCali(int value) {
        ...
        stringBuilder.append("showHighlightviewCali>>> value = ");
    ...
    private void showCaliView() {
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("showCaliView>>> mAlphaValue = ");
        stringBuilder.append(this.mAlphaValue);
        stringBuilder.append(" mIsViewAdded = ");
        stringBuilder.append(this.mIsViewAdded);
        Log.d(str, stringBuilder.toString());
