...
public class RecSysClient {
    ...
    private Stub mHwRecSysCallBack = new Stub() {
        public void onRecResult(HwObjectContainer hwObjectContainer) throws RemoteException {
            ...
            stringBuilder.append("shutdown recommend request result: ");
            stringBuilder.append(RecSysClient.this.mRequestResult);
            HwLog.i(access$100, stringBuilder.toString());
        }

        public void onConfigResult(int resCode, String message) throws RemoteException {
            String access$100 = RecSysClient.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("onConfigResult resCode:");
            stringBuilder.append(resCode);
            stringBuilder.append("  message:");
            stringBuilder.append(message);
            HwLog.e(access$100, stringBuilder.toString());
        }
    };
    ...
    static {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("[ShutdownRecommend]");
        stringBuilder.append(RecSysClient.class.getSimpleName());
