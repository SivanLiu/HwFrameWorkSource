...
public class HwGlobalActionsView extends RelativeLayout implements IBlurWallpaperCallback {
    ...
    public class SearchItemOnCheckedChangeListener implements OnCheckedChangeListener {
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            String str = HwGlobalActionsView.TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("-----SearchItemOnCheckedChangeListener---");
            ...
            str = HwGlobalActionsView.TAG;
            StringBuilder stringBuilder2 = new StringBuilder();
            stringBuilder2.append("SearchItemOnCheckedChangeListener,,mListviewState = ");
            stringBuilder2.append(HwGlobalActionsView.this.mListviewState);
            stringBuilder2.append(",mIsBootOnTimeClose =");
            stringBuilder2.append(HwGlobalActionsView.this.mIsBootOnTimeClose);
            stringBuilder2.append(",mIsDeskClockClose = ");
            stringBuilder2.append(HwGlobalActionsView.this.mIsDeskClockClose);
    ...
    private int initAdapterDate() {
        ...
        String str = TAG;
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("initAdapterDate---,mListviewState = ");
        stringBuilder.append(this.mListviewState);
        stringBuilder.append(",mIsBootOnTimeClose =");
        stringBuilder.append(this.mIsBootOnTimeClose);
        stringBuilder.append(",mIsDeskClockClose = ");
        stringBuilder.append(this.mIsDeskClockClose);
        Log.d(str, stringBuilder.toString());
    ...
    private void tryToAddLockdownAction() {
        if (Secure.getInt(getContext().getContentResolver(), "lockdown_in_power_menu", 0) != 0 && shouldDisplayLockdown()) {
            ...
            LayoutParams lp = new LayoutParams(getContext().getResources().getDimensionPixelSize(34472254), -2);
                ...
                if (actionTextView != null) {
                    ...
                    if (actionImageView != null) {
                        ...
                        if (idImage != ID_IC_SHUTDOWN) {
                            ...
                            stringBuilder.append("updateActionUI mSilentModeButtonTouched = ");
                            stringBuilder.append(this.mSilentModeButtonTouched);
                            Log.d(str, stringBuilder.toString());
            ...
            case 2:
                if (Math.abs(MathUtils.dist(event.getX(0), event.getY(0), this.mFirstPointerDownX, this.mFirstPointerDownY)) <= this.mTouchSlop) {
                    if (this.mHandler != null && this.mEventAfterActionDown) {
                        this.mHandler.sendEmptyMessageDelayed(7, HwArbitrationDEFS.NotificationMonitorPeriodMillis);
                        break;
                    }
                }
                cancelDisableAccssibility();
    ...
    private void disableTalkBackService() {
        if (this.mContext != null) {
            ...
            Secure.putIntForUser(this.mContext.getContentResolver(), "accessibility_enabled", accessibilityEnabled ? 1 : 0, -2);
            if (this.mAccessibilityTip != null) {
                this.mAccessibilityTip.setVisibility(8);
            }
        }
