...
public class BreathImageDrawable extends BitmapDrawable {
    ...
    public void draw(Canvas canvas) {
        if (this.mImageDrawable != null || this.mCircleDrawable != null) {
            ...
            drawLayer(canvas2, this.mImageDrawable, this.mBreathImageScale, intrinsicWidth, intrinsicHeight);
            drawLayer(canvas2, this.mCircleDrawable, this.mBreathCircleScale, intrinsicWidth, intrinsicHeight);
            if (this.mStatus == 2) {
                startBreathAnimImpl();
            }
