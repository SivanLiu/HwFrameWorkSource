...
public class HwFragmentContainer {
    ...
    private static class TranslateAnimatorListener implements AnimatorListener {
        ...
        /* synthetic */ TranslateAnimatorListener(AnonymousClass1 x0) {
            this();
        }
    ...
    private void openRightClearStack(Fragment fragment, boolean isInitial) {
        if (fragment != null) {
            setSelectedAndAnimation(isInitial ^ 1);
            popPrepare();
    ...
    public void logBackStacksInfo() {
        ...
        for (int i = 0; i < backStackCount; i++) {
            ...
            stringBuilder.append(backstatck.getId());
            stringBuilder.append(", name = ");
            stringBuilder.append(backstatck.getName());
            Log.d(str, stringBuilder.toString());
        }
        String str2 = TAG;
        StringBuilder stringBuilder2 = new StringBuilder();
        stringBuilder2.append("BackStackCount = ");
        stringBuilder2.append(backStackCount);
        stringBuilder2.append(", leftStackCount = ");
        stringBuilder2.append(leftStackCount);
        stringBuilder2.append(", rightStackCount = ");
        stringBuilder2.append(rightStackCount);
        stringBuilder2.append(", rightOpenStackCount = ");
        stringBuilder2.append(rightOpenStackCount);
    ...
    private AnimatorSet createAnimator(View view, int type) {
        ...
        ObjectAnimator translateAnimator2;
        if (type == 0) {
            ...
            view.setTranslationZ(-1.0f);
            translateAnimator2 = ObjectAnimator.ofFloat(view, "translationX", new float[]{BLUR_LAYER_TRANSPARENT, ((float) (-this.mAnimatorWidth)) / 2.0f});
            translateAnimator2.setInterpolator(INTERPOLATOR_33_33);
            translateAnimator2.setDuration(300);
            createBlurLayerAnimator(view, BLUR_LAYER_TRANSPARENT, 0.4f);
            animatorSet = new AnimatorSet();
            animatorSet.playTogether(new Animator[]{translateAnimator2, this.mBlurLayerAnimator});
            return animatorSet;
        } else if (type == 2) {
            view.setTranslationZ(-1.0f);
            translateAnimator2 = ObjectAnimator.ofFloat(view, "translationX", new float[]{((float) (-this.mAnimatorWidth)) / 2.0f, BLUR_LAYER_TRANSPARENT});
            translateAnimator2.setInterpolator(INTERPOLATOR_20_90);
            translateAnimator2.setDuration(300);
