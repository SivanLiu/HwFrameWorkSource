...
public class HwFragmentLayout extends RelativeLayout implements OnTouchListener, HwFragmentFrameLayoutCallback {
    ...
    private class FadeAnimationListener implements AnimationListener {
        ...
        /* synthetic */ FadeAnimationListener(HwFragmentLayout x0, AnonymousClass1 x1) {
            this();
        }
    ...
    private void init(Context context, float displayRate, boolean canMove) {
        ...
        if (this.mFadeInAnimation == null) {
            ...
            this.mFadeInAnimation.setAnimationListener(new FadeAnimationListener(this, null));
        }
        if (this.mFadeOutAnimation == null) {
            ...
            this.mFadeOutAnimation.setAnimationListener(new FadeAnimationListener(this, null));
        }
    }
