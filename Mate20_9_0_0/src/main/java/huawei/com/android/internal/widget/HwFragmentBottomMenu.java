...
public class HwFragmentBottomMenu extends LinearLayout implements OnClickListener {
    ...
    public static class HwFragmentMenu implements Menu {
        ...
        public MenuItem add(int groupId, int itemId, int order, CharSequence title) {
            ...
            HwFragmentMenuItem item2 = new HwFragmentMenuItem(this.mContext, itemId, title);
    ...
    private int measureHeight(int measureSpec, View view) {
        ...
        if (specMode != AppTypeInfo.APP_ATTRIBUTE_OVERSEA) {
            return result;
        }
        ...
        if (getChildCount() != 0) {
            ...
            if (this.mMenuBarWidth + dip2px(0.0f) > sizeWidth) {
                ...
                if (this.mMenuBarWidth + dip2px(0.0f) <= sizeWidth) {
                    ...
                    maxcount = (sizeWidth - dip2px(40.0f)) / dip2px(54.0f);
                    if (maxcount == 0) {
            ...
            if (this.mMenuTitleVisible) {
                ...
                for (maxcount = 0; maxcount < displayMenuCount; maxcount++) {
                    View childView = getChildAt(maxcount);
        ...
        if (this.mDisplayMenuCount != 0) {
                ...
                for (i = 0; i < childCount; i++) {
                    if (getChildAt(i).getVisibility() != 0) {
                        ...
                        if (view instanceof HwFragmentMenuItemView) {
                            HwFragmentMenuItem item2 = (HwFragmentMenuItem) this.mFragmentMenu.findItem(view.getId());
            ...
            if (1 != getLayoutDirection()) {
                while (true) {
                    ...
                    childView = getChildAt(i3);
                    if (childView.getVisibility() == 0 && (childView instanceof HwFragmentMenuItemView)) {
                        childView.layout((dip2px(20.0f) + ((i % this.mDisplayMenuCount) * this.mMenuItemWidth)) + ((((i % this.mDisplayMenuCount) * 2) + 1) * dip2px(4.0f)), getPaddingTop(), (dip2px(20.0f) + (((i % this.mDisplayMenuCount) + 1) * this.mMenuItemWidth)) + ((((i % this.mDisplayMenuCount) * 2) + 1) * dip2px(4.0f)), getHeight() + getPaddingTop());
                        i++;
                    }
                    i2 = i3 + 1;
                }
                ...
                while (true) {
                    ...
                    childView = getChildAt(i3);
                    if (childView.getVisibility() == 0 && (childView instanceof HwFragmentMenuItemView)) {
                        childView.layout((dip2px(20.0f) + ((((this.mDisplayMenuCount - 1) - i) % this.mDisplayMenuCount) * this.mMenuItemWidth)) + ((((((this.mDisplayMenuCount - 1) - i) % this.mDisplayMenuCount) * 2) + 1) * dip2px(4.0f)), getPaddingTop(), (dip2px(20.0f) + (((((this.mDisplayMenuCount - 1) - i) % this.mDisplayMenuCount) + 1) * this.mMenuItemWidth)) + ((((((this.mDisplayMenuCount - 1) - i) % this.mDisplayMenuCount) * 2) + 1) * dip2px(4.0f)), getHeight() + getPaddingTop());
                        i++;
                    }
                    i2 = i3 + 1;
                }
    ...
    public void showPopup(View view) {
        if (this.mFragmentMenu != null && this.mMoreMenuList.size() != 0) {
            ...
            stringBuilder.append("popupWidth = ");
            stringBuilder.append(popupWidth);
            stringBuilder.append(", ");
            stringBuilder.append(dip2px(136.0f));
            stringBuilder.append(", ");
            stringBuilder.append(dip2px(240.0f));
            ...
            stringBuilder2.append(location[0]);
            stringBuilder2.append(", ");
            stringBuilder2.append(getLayoutDirection());
