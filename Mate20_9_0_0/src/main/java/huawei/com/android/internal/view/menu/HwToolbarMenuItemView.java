...
public class HwToolbarMenuItemView extends ActionMenuItemView {
    ...
    public HwToolbarMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (theme != null) {
            ...
            TypedArray menuStyleTa = theme.obtainStyledAttributes(attrs, hwToolbarMenuStyleable, this.mResLoader.getIdentifier(context, "attr", "hwToolbarMenuItemStyle"), null);
    ...
    public void updateTextButtonVisibility() {
        ...
        if (getParent() != null) {
            ...
            setText((visible & i) | showHwTextWithAction() ? this.mTitle : null);
        }
    }
