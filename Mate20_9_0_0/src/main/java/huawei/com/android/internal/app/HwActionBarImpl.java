...
public class HwActionBarImpl extends WindowDecorActionBar implements ActionModeCallback {
    ...
    protected void initActionBarOverlayLayout(View decor) {
        HwActionBarOverlayLayout hwOverlayLayout = (HwActionBarOverlayLayout) decor.findViewById(16908849);
    ...
    public void setSmartColor(ColorStateList iconColor, ColorStateList titleColor) {
        DecorToolbar view = getDecorToolbar();
        HwActionBarView actionBarView = null;
        if (view instanceof HwActionBarView) {
            actionBarView = (HwActionBarView) view;
        }
        if (actionBarView != null) {
            actionBarView.setSmartColor(iconColor, titleColor);
        }
    }
}
