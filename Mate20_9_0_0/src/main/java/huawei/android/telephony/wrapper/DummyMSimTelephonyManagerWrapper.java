...
public class DummyMSimTelephonyManagerWrapper implements MSimTelephonyManagerWrapper {
    ...
    public static DummyMSimTelephonyManagerWrapper getInstance() {
        try {
            ...
            stringBuilder.append("METHOD_STATIC_getDefault cause exception!");
    ...
    public boolean isMultiSimEnabled() {
        try {
            ...
            String str = LOG_TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("METHOD_isMultiSimEnabled cause exception!");
            stringBuilder.append(e.toString());
            Rlog.e(str, stringBuilder.toString());
            return false;
        }
    ...
    public int getDefaultSubscription() {
        try {
            ...
            String str = LOG_TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("METHOD_getDefaultSubscription cause exception!");
            stringBuilder.append(e.toString());
            Rlog.e(str, stringBuilder.toString());
            return 0;
        }
    ...
    public int getPhoneCount() {
        try {
            ...
            String str = LOG_TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("METHOD_getPhoneCount cause exception!");
            stringBuilder.append(e.toString());
            Rlog.e(str, stringBuilder.toString());
            return 1;
        }
    ...
    public boolean hasIccCard(int subscription) {
        try {
            ...
            String str = LOG_TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("METHOD_hasIccCard cause exception!");
            stringBuilder.append(e.toString());
            Rlog.e(str, stringBuilder.toString());
            return false;
        }
    ...
    public boolean setMmsAutoSetDataSubscription(int subscription) {
        try {
            ...
            String str = LOG_TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("METHOD_setMmsAutoSetDataSubscription cause exception!");
            stringBuilder.append(e.toString());
            Rlog.e(str, stringBuilder.toString());
            return false;
        }
    ...
    public boolean setPreferredDataSubscription(int subscription) {
        try {
            ...
            String str = LOG_TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("METHOD_setPreferredDataSubscription cause exception!");
            stringBuilder.append(e.toString());
            Rlog.e(str, stringBuilder.toString());
            return false;
        }
    ...
    public int getPreferredDataSubscription() {
        try {
            ...
            String str = LOG_TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("METHOD_getPreferredDataSubscription cause exception!");
            stringBuilder.append(e.toString());
            Rlog.e(str, stringBuilder.toString());
            return 0;
        }
    ...
    public int getMmsAutoSetDataSubscription() {
        try {
            ...
            String str = LOG_TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("METHOD_getMmsAutoSetDataSubscription cause exception!");
            stringBuilder.append(e.toString());
            Rlog.e(str, stringBuilder.toString());
            return 0;
        }
    ...
    public boolean isNetworkRoaming(int subscription) {
        try {
            ...
            String str = LOG_TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("METHOD_isNetworkRoaming cause exception!");
            stringBuilder.append(e.toString());
            Rlog.e(str, stringBuilder.toString());
            return false;
        }
    ...
    public int getNetworkType(int subscription) {
        try {
            ...
            String str = LOG_TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("METHOD_getNetworkType cause exception!");
            stringBuilder.append(e.toString());
            Rlog.e(str, stringBuilder.toString());
            return 0;
        }
    ...
    public String getVoiceMailNumber(int subsription) {
        try {
            ...
            String str = LOG_TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("METHOD_getVoiceMailNumber cause exception!");
            stringBuilder.append(e.toString());
            Rlog.e(str, stringBuilder.toString());
            return null;
        }
    ...
    public int getCurrentPhoneType(int subscription) {
        try {
            ...
            String str = LOG_TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("METHOD_getCurrentPhoneType cause exception!");
            stringBuilder.append(e.toString());
            Rlog.e(str, stringBuilder.toString());
            return 0;
        }
