...
public class DummyHuaweiTelephonyManagerWrapper implements HuaweiTelephonyManagerWrapper {
    ...
    public int getSubidFromSlotId(int slotId) {
        try {
            ...
            String str = LOG_TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("METHOD_getSubidFromSlotId cause exception!");
            stringBuilder.append(e.toString());
            Rlog.e(str, stringBuilder.toString());
            return slotId;
        }
    ...
    public int getDualCardMode() {
        try {
            ...
            String str = LOG_TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("METHOD_getDualCardMode cause exception!");
            stringBuilder.append(e.toString());
            Rlog.e(str, stringBuilder.toString());
            return -1;
        }
    ...
    public int getCardType(int i) {
        try {
            ...
            String str = LOG_TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("METHOD_getCardType cause exception!");
            stringBuilder.append(e.toString());
            Rlog.e(str, stringBuilder.toString());
            return -1;
        }
