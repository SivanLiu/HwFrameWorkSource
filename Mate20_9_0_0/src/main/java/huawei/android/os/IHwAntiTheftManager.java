            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    case 1:
                        ...
                        byte[] _result4 = readAntiTheftData();
                    ...
                    case 3:
                        data.enforceInterface(descriptor);
                        _result2 = writeAntiTheftData(data.createByteArray());
                        reply.writeNoException();
                    ...
                    case 5:
                        data.enforceInterface(descriptor);
                        _result2 = setAntiTheftEnabled(data.readInt() != 0);
                        reply.writeNoException();
                        reply.writeInt(_result2);
                        return true;
                    case 6:
                        data.enforceInterface(descriptor);
                        _result3 = getAntiTheftEnabled();
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case 7:
                        data.enforceInterface(descriptor);
                        _result3 = checkRootState();
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case 8:
                        data.enforceInterface(descriptor);
                        _result3 = isAntiTheftSupported();
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    default:
