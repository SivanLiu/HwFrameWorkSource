...
public class HwCard {
    ...
    public static class Builder {
        ...
        private int getHeaderLayoutByType(int type) {
            if (HEADER_TYPE_NO_HEADER == type) {
                return 0;
            }
            if (HEADER_TYPE_NO_BUTTON == type) {
            ...
            if (HEADER_TYPE_TOW_BUTTON == type) {
        ...
        private HwCard build(boolean template) {
            HwCard card = new HwCard(this.mContext, null);
        ...
        private View inflaterHeaderWithOneButton() {
            ...
            if (this.mActionMoreListener != null) {
                actionMore.setOnClickListener(new OnClickListener() {
        ...
        private View inflaterHeaderWithTowButton() {
            ...
            if (this.mActionInfoListener != null) {
                actionInfo.setOnClickListener(new OnClickListener() {
                    public void onClick(View v) {
        ...
        private static void setButtonClickEffect(View button) {
            if (button != null) {
    ...
    /* synthetic */ HwCard(Context x0, AnonymousClass1 x1) {
        this(x0);
    }
    ...
    private void adjustContentViewTopMargin() {
        if (this.mContentView != null && this.mHeaderView == null) {
            MarginLayoutParams lp = (MarginLayoutParams) this.mContentView.getLayoutParams();
    ...
    private void replaceStubWithView(View view, ViewStub stub) {
        ...
        LayoutParams layoutParams = stub.getLayoutParams();
        ...
        if (this.mHeaderView != null) {
            ...
            if (expandView != null) {
                ...
                expandView.setOnClickListener(new OnClickListener() {
                    public void onClick(View v) {
                        HwCard.this.mExpandState = HwCard.this.mExpandState ^ 1;
