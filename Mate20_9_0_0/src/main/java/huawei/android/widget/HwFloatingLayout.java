...
public class HwFloatingLayout extends FrameLayout {
    ...
    private ContentObserver mContentObserver = new ContentObserver(new Handler()) {
        public void onChange(boolean selfChange) {
            ...
            if (exist != HwFloatingLayout.this.mIsNavigationBarExist) {
                HwFloatingLayout.this.mIsNavigationBarExist = exist;
    ...
    private OnLayoutChangeListener mSplitViewOnLayoutChangeListener = new OnLayoutChangeListener() {
    ...
    class MoveViewAnimationListener implements AnimationListener {
        private MarginLayoutParams mParams;
        private int mToYDelta;
        private View mView;

        public MoveViewAnimationListener(View view, MarginLayoutParams params, int toYDelta) {
            this.mView = view;
            this.mParams = params;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mHwFloatingView != null) {
            ...
            if (rootView != null) {
                this.mSplitView = rootView.findViewById(16909357);
            }
        }
        ...
        int linearLayoutMeasureSpec = MeasureSpec.makeSafeMeasureSpec(((MeasureSpec.getSize(heightMeasureSpec) - hwToolbarHeight) - getStatusBarHeight()) + this.mViewHolderHeight, MeasureSpec.getMode(heightMeasureSpec));
        this.mContentLayout.getLayoutParams().height = (MeasureSpec.getSize(heightMeasureSpec) - hwToolbarHeight) - getStatusBarHeight();
    ...
    private boolean isNavigationBarExist() {
        boolean z = false;
        if (Global.getInt(this.mContext.getContentResolver(), KEY_NAVIGATION_BAR_STATUS, 0) == 0) {
            z = true;
        }
        return z;
    }
