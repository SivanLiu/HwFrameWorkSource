...
public class HwAlphaIndexResourceManager {
    ...
    static {
        ...
        languageIndexerMap.put("SWAHILI_ALPHA_INDEX", ROOT_ALPHA_INDEX);
        languageIndexerMap.put("AMHARIC_ALPHA_INDEX", "ሀ ለ ሐ መ ሠ ረ ሰ ሸ ቀ በ ተ ቸ ኀ ነ(1) ኘ(1) አ ከ(1) ኸ(1) ወ ዐ(1) ዘ(1) ዠ(1) የ ደ ጀ ገ ጠ(1) ጨ(1) ጰ ጸ(1) ፀ(1) ፈ ፐ");
        languageIndexerMap.put("MAORI_ALPHA_INDEX", ROOT_ALPHA_INDEX);
        languageIndexerMap.put("TELUGR_ALPHA_INDEX", "అ ఆ ఇ ఈ ఉ(1) ఊ(1) ఎ(1) ఏ(1) ఐ ఒ ఓ ఔ(1) అం(1) క(1) ఖ(1) గ ఘ చ ఛ జ ఝ(1) ట(1) ఠ(1) డ(1) ఢ(1) ణ త థ ద ధ న ప ఫ(1) బ(1) భ(1) మ(1) య ర ల వ(1) శ(1) ష(1) స(1) హ");
        languageIndexerMap.put("MALAYALAM_ALPHA_INDEX", "അ ആ ഇ(1) ഈ(1) ഉ(1) ഊ ഋ എ ഏ(1) ഐ(1) ഒ(1) ഓ ഔ ക ൿ(1) ഖ(1) ഗ(1) ഘ(1) ങ ച ഛ ജ(1) ഝ(1) ഞ(1) ട ഠ ഡ ഢ(1) ണ(1) ത(1) ഥ ദ ധ ന(1) പ(1) ഫ(1) ബ ഭ മ യ(1) ര(1) ല(1) വ ശ ഷ സ(1) ഹ(1) ള(1) ഴ റ");
        languageIndexerMap.put("ODIA_ALPHA_INDEX", "ଅ ଆ ଇ(1) ଈ(1) ଉ(1) ଊ ଋ ଏ ଐ(1) ଓ(1) ଔ(1) କ ଖ ଗ ଘ(1) ଙ(1) ଚ(1) ଛ ଜ ଝ ଞ(1) ଟ(1) ଠ(1) ଡ ଢ ଣ ତ(1) ଥ(1) ଦ(1) ଧ ନ ପ ଫ(1) ବ(1) ଭ(1) ମ ଯ ର ଲ(1) ଶ(1) ଷ(1) ସ ହ");
        languageIndexerMap.put("ASSAMESE_ALPHA_INDEX", "অ আ ই(1) ঈ(1) উ(1) ঊ ঋ এ ঐ(1) ও(1) ঔ(1) ক খ গ ঘ(1) ঙ(1) চ(1) ছ জ ঝ ঞ(1) ট(1) ঠ(1) ড ঢ ণ ত(1) থ(1) দ(1) ধ ন প ফ(1) ব(1) ভ(1) ম য ৰ ল(1) ৱ(1) শ(1) ষ স হ");
        languageIndexerMap.put("MAITHILI_ALPHA_INDEX", "अ आ इ(1) ई(1) उ(1) ऊ ए ऐ ओ(1) औ(1) क(1) ख ग घ ङ(1) च(1) छ(1) ज झ ञ ट(1) ठ(1) ड(1) ढ ण त थ(1) द(1) ध(1) न प फ ब(1) भ(1) म(1) य र ल व(1) श(1) ष(1) स ह");
        languageIndexerMap.put("MONGOLIAN_ALPHA_INDEX", "А Б В Г(1) Д(1) Е(1) Ж З И Й(1) К(1) Л(1) М(1) Н О Ө П(1) Р(1) С(1) Т У Ү Ф(1) Х(1) Ц(1) Ч Ш Щ Ъ(1) Ы(1) Ь(1) Э Ю Я");
    ...
    private HwAlphaIndexResourceManager(Locale locale) {
        ...
        if ("zh".equals(validLocale)) {
            ...
            if ("TW".equals(region)) {
                validLocale = Collator.getInstance(locale).compare("坝", "七") == -1 ? "zh_TW" : "zh_Hant";
        ...
        if ("zh_Hant".equals(validLocale)) {
            ...
            region = locale.getDisplayLanguage(Locale.US).split(" ")[0].toUpperCase(Locale.US);
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append(region);
            stringBuilder.append("_ALPHA_INDEX");
            this.labelList = getLabelList(stringBuilder.toString());
        }
    ...
    private Map<String, String> parseLanguageIndexerFile(InputStream file) {
        ...
        try {
            ...
            buffReader = new BufferedReader(reader, 2048);
            String line = null;
            int lineNum = 0;
            while (true) {
    ...
    public static List<String> populateBulletAlphaIndex(int M, List<String> alphaList) {
        ...
        while (n1 > 0) {
            ...
            int pos2 = pos;
            pos = 0;
            while (pos < bulletCount) {
                bulletContent.append((String) alphaList.get(pos2));
                bulletContent.append(' ');
                pos++;
                pos2++;
            }
            bulletContent.setLength(bulletContent.length() - 1);
            ret.add(bulletContent.toString());
            ret.add((String) alphaList.get(pos2));
            pos = pos2 + 1;
        }
        for (int i2 = pos; i2 < N; i2++) {
            ret.add((String) alphaList.get(i2));
        }
        return ret;
    }
}
