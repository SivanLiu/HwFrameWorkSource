...
public class DownloadBar extends LinearLayout {
    ...
    private boolean hasText(TextView view) {
        return TextUtils.isEmpty(view.getText()) ^ 1;
    }
    ...
    public void setStartItemClickListener(OnClickListener l) {
    ...
    public void setEndItemClickListener(OnClickListener l) {
    ...
    public void setApplyButtonClickListener(OnClickListener l) {
    ...
    public void setUpdateButtonClickListener(OnClickListener l) {
