...
public class HwTextView extends TextView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        autoText(MeasureSpec.getSize(widthMeasureSpec), MeasureSpec.getSize(heightMeasureSpec));
    ...
    private void measureHeight(int parentHeight, int parentWidth) {
        ...
        if (maxLines > 1) {
            ...
            if (availedHeight > 0) {
                this.mStaticLayout = new StaticLayout(getText(), getPaint(), viewWidth, Alignment.ALIGN_NORMAL, getLineSpacingMultiplier(), getLineSpacingExtra(), false);
