...
public class HwProgressDialog extends AlertDialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (this.mProgressStyle == 1) {
            ...
            view = inflater.inflate(a.getResourceId(HwWidgetUtils.getResourceDeclareStyleableIndex("com.android.internal", "AlertDialog_progressLayout"), resources.getIdentifier("progress_dialog", ResLoaderUtil.LAYOUT, "android")), null);
            this.mProgress = (ProgressBar) view.findViewById(resources.getIdentifier("progress", ResLoaderUtil.ID, "android"));
            this.mMessageView = (TextView) view.findViewById(resources.getIdentifier("message", ResLoaderUtil.ID, "android"));
            setView(view);
        }
        a.recycle();
        if (this.mMax > 0) {
