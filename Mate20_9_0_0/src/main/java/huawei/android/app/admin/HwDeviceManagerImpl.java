...
public class HwDeviceManagerImpl implements IHwDeviceManager {
    ...
    public boolean isSuperWhiteListApp(String pkgName) {
        ...
        try {
            ...
            stringBuilder.append("getInstallPackageWhiteList error : ");
    ...
    public boolean isDisallowedUninstallPackage(String pkgName) {
        ...
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("getDisallowedUninstallPackageList error : ");
            stringBuilder.append(e.getMessage());
            Log.e(str, stringBuilder.toString());
        }
        if (packagelist == null || packagelist.isEmpty() || !packagelist.contains(pkgName)) {
        ...
        stringBuilder2.append(" is in the notuninstallpackage_blacklist ");
    ...
    public boolean isDisabledDeactivateMdmPackage(String pkgName) {
        ...
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("getDisabledDeactivateMdmPackageList error : ");
            stringBuilder.append(e.getMessage());
            Log.e(str, stringBuilder.toString());
        }
        if (packagelist == null || packagelist.isEmpty() || !packagelist.contains(pkgName)) {
        ...
        StringBuilder stringBuilder2 = new StringBuilder();
        stringBuilder2.append(pkgName);
        stringBuilder2.append(" is in the disabled deactivate Mdm package list ");
        Log.i(str2, stringBuilder2.toString());
        return true;
    }
    ...
    public List<String> getNetworkAccessWhitelist() {
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("getNetworkAccessWhitelist error : ");
            stringBuilder.append(e.getMessage());
            Log.e(str, stringBuilder.toString());
            return null;
        }
    ...
    public boolean isDisallowedInstallPackage(String pkgName) {
        ...
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("getInstallPackageBlackList error : ");
            stringBuilder.append(e.getMessage());
            Log.e(str, stringBuilder.toString());
        }
        if (packagelist == null || !packagelist.contains(pkgName)) {
    ...
    public boolean isApplicationDisabled(Intent intent) {
        ...
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("getIsDisableApplication error : ");
            stringBuilder.append(e.getMessage());
            Log.e(str, stringBuilder.toString());
        }
        return false;
    ...
    private boolean isAccessibilityServicesMDMWhiteList(String pkg) {
        ...
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("isAccessibilityServicesWhiteList getAllowaccessibility services error : ");
            stringBuilder.append(e.getMessage());
            Log.e(str, stringBuilder.toString());
        }
        ...
        for (int i = 0; i < size; i++) {
            if (((ComponentName) componeNameWhiteList.get(i)).getPackageName().equals(pkg)) {
                String str2 = TAG;
                StringBuilder stringBuilder2 = new StringBuilder();
                stringBuilder2.append("isAccessibilityServicesWhiteList pkg=");
                stringBuilder2.append(pkg);
                stringBuilder2.append(" in white list block!");
    ...
    public boolean isFileShareDisabled() {
        String POLICY_FILE_SHARE = "policy-file-share-disabled";
    ...
    public boolean isAndroidAnimationDisabled() {
        String DISABLED_ANDROID_ANIMATION = "disabled-android-animation";
        Bundle bundle = this.mHwDPM.getCachedPolicyForFwk(null, "disabled-android-animation", null);
        return bundle == null ? false : bundle.getBoolean("value");
    }
}
