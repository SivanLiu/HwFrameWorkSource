...
public class HwDevicePolicyManagerEx {
    ...
    public void setWifiDisabled(ComponentName who, boolean disabled) {
        this.mSponsor.transactTo_setFunctionDisabled(1004, "setWifiDisabled", who, disabled, UserHandle.myUserId());
    }

    public boolean isWifiDisabled(ComponentName who) {
        return this.mSponsor.transactTo_isFunctionDisabled(1005, "isWifiDisabled", who, 0);
    }
    ...
    public void setWifiApDisabled(ComponentName admin, boolean disabled) {
        this.mSponsor.transactTo_setFunctionDisabled(1006, "setWifiApDisabled", admin, disabled, UserHandle.myUserId());
    }
    ...
    public boolean isUSBDataDisabled(ComponentName admin) {
        return this.mSponsor.transactTo_isFunctionDisabled(1011, "isUSBDataDisabled", admin, 0);
    }
    ...
    public void setDataConnectivityDisabled(ComponentName admin, boolean disabled) {
        this.mSponsor.transactTo_setFunctionDisabled(1016, "setDataConnectivityDisabled", admin, disabled, UserHandle.myUserId());
    }

    public boolean isDataConnectivityDisabled(ComponentName admin) {
        return this.mSponsor.transactTo_isFunctionDisabled(1017, "isDataConnectivityDisabled", admin, 0);
    }

    public void setVoiceDisabled(ComponentName admin, boolean disabled) {
        this.mSponsor.transactTo_setFunctionDisabled(1018, "setSMSDisabled", admin, disabled, UserHandle.myUserId());
    }

    public boolean isVoiceDisabled(ComponentName admin) {
        return this.mSponsor.transactTo_isFunctionDisabled(1019, "isVoiceDisabled", admin, 0);
    }

    public void setSMSDisabled(ComponentName admin, boolean disabled) {
        this.mSponsor.transactTo_setFunctionDisabled(1020, "setSMSDisabled", admin, disabled, UserHandle.myUserId());
    }

    public boolean isSMSDisabled(ComponentName admin) {
        return this.mSponsor.transactTo_isFunctionDisabled(1021, "isSMSDisabled", admin, 0);
    }
    ...
    public void setStatusBarExpandPanelDisabled(ComponentName who, boolean disabled) {
        this.mSponsor.transactTo_setFunctionDisabled(1022, "setStatusBarExpandPanelDisabled", who, disabled, UserHandle.myUserId());
    }

    public boolean isStatusBarExpandPanelDisabled(ComponentName who) {
        return this.mSponsor.transactTo_isFunctionDisabled(1023, "isStatusBarExpandPanelDisabled", who, 0);
    }
    ...
    public void setSafeModeDisabled(ComponentName who, boolean disabled) {
        this.mSponsor.transactTo_setFunctionDisabled(1032, "setSafeModeDisabled", who, disabled, UserHandle.myUserId());
    }

    public boolean isSafeModeDisabled(ComponentName who) {
        return this.mSponsor.transactTo_isFunctionDisabled(1033, "isSafeModeDisabled", who, 0);
    }

    public void setAdbDisabled(ComponentName who, boolean disabled) {
        this.mSponsor.transactTo_setFunctionDisabled(1028, "setAdbDisabled", who, disabled, UserHandle.myUserId());
    }

    public boolean isAdbDisabled(ComponentName who) {
        return this.mSponsor.transactTo_isFunctionDisabled(1029, "isAdbDisabled", who, 0);
    }

    public void setUSBOtgDisabled(ComponentName who, boolean disabled) {
        this.mSponsor.transactTo_setFunctionDisabled(1030, "setUSBOtgDisabled", who, disabled, UserHandle.myUserId());
    }

    public boolean isUSBOtgDisabled(ComponentName who) {
        return this.mSponsor.transactTo_isFunctionDisabled(1031, "isUSBOtgDisabled", who, 0);
    }

    public void setGPSDisabled(ComponentName who, boolean disabled) {
        this.mSponsor.transactTo_setFunctionDisabled(1026, "setGPSDisabled", who, disabled, UserHandle.myUserId());
    }

    public boolean isGPSDisabled(ComponentName who) {
        return this.mSponsor.transactTo_isFunctionDisabled(1027, "isGPSDisabled", who, 0);
    }
    ...
    public void setTaskButtonDisabled(ComponentName who, boolean disabled) {
        this.mSponsor.transactTo_setFunctionDisabled(1034, "setTaskButtonDisabled", who, disabled, UserHandle.myUserId());
    }

    public boolean isTaskButtonDisabled(ComponentName who) {
        return this.mSponsor.transactTo_isFunctionDisabled(1035, "isTaskButtonDisabled", who, 0);
    }

    public void setHomeButtonDisabled(ComponentName who, boolean disabled) {
        this.mSponsor.transactTo_setFunctionDisabled(1036, "setHomeButtonDisabled", who, disabled, UserHandle.myUserId());
    }
