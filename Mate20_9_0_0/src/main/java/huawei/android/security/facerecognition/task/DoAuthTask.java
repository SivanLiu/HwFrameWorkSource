...
public class DoAuthTask extends FaceRecognizeTask implements EventListener {
        ...
        if (type == 1) {
            ...
            switch (type) {
                case 10:
                    ...
                    stringBuilder.append("auth result : ");
                    stringBuilder.append(this.mRetErrorCode);
                    LogUtil.d("do auth", stringBuilder.toString());
                ...
                case 11:
                    ...
                    CallbackHolder.getInstance().onCallbackEvent((int) this.mTaskRequest.getReqId(), 2, 3, (int) ev.getArgs()[0]);
                    break;
                default:
                    return false;
            }
    ...
    public DoAuthTask(HwSecurityTaskBase parent, RetCallback callback, FaceRecognizeRequest request, int flags, long opId) {
    ...
    public int doAction() {
        ...
        if (ServiceHolder.getInstance().authenticate(this.mOpId, this.mFlags) != 0) {
            return 5;
        }
