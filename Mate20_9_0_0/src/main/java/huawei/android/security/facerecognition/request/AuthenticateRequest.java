...
public class AuthenticateRequest extends FaceRecognizeRequest {
    ...
    public boolean onReqStart() {
        ...
        HwSecurityTaskThread.staticPushTask(new AuthenticateTask(null, this.mRetCallback, this, this.mContext, getReqId()), 0);
        return true;
    }
    ...
    public void sendCancelOK() {
        CallbackHolder.getInstance().onCallbackEvent((int) getReqId(), 2, 2, 0);
    }
}
