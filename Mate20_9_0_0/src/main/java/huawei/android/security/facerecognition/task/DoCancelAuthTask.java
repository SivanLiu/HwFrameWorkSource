        ...
        switch (ev.getType()) {
            case 10:
                ...
                if (!this.mTaskRequest.isCameraCanceled()) {
                    CallbackHolder.getInstance().onCallbackEvent((int) this.mTaskRequest.getReqId(), 2, 1, this.mRetErrorCode);
                    break;
                }
                CallbackHolder.getInstance().onCallbackEvent((int) this.mTaskRequest.getReqId(), 2, 1, 1);
                break;
            case 11:
