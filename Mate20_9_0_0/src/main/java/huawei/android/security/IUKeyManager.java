            ...
            if (code != 1598968902) {
                ...
                switch (code) {
                    ...
                    case 2:
                        ...
                        int _result2 = setUKeySwitchDisabled(_arg0, _arg1);
                        reply.writeNoException();
                        reply.writeInt(_result2);
                        return true;
                    case 3:
                        data.enforceInterface(descriptor);
                        int _result3 = isUKeySwitchDisabled(data.readString());
                        reply.writeNoException();
                        reply.writeInt(_result3);
                        return true;
                    case 4:
                        data.enforceInterface(descriptor);
                        Bundle _result4 = getUKeyApkInfo(data.readString());
                        reply.writeNoException();
                        if (_result4 != null) {
                            reply.writeInt(1);
