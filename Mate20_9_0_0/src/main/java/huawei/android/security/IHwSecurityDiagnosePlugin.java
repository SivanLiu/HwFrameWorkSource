            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    case 1:
                        ...
                        int _result2 = report(_arg02, _arg0);
                    ...
                    case 6:
                        parcel.enforceInterface(descriptor);
                        _result = getRootStatusSync();
                        reply.writeNoException();
                        parcel2.writeInt(_result);
                        return true;
                    case 7:
                        parcel.enforceInterface(descriptor);
                        _result = getSystemStatusSync();
                        reply.writeNoException();
                        parcel2.writeInt(_result);
                        return true;
                    case 8:
                        parcel.enforceInterface(descriptor);
                        _result = sendThreatenInfo(data.readInt(), data.readByte(), data.readByte(), data.readByte(), data.readString(), data.readString());
                        reply.writeNoException();
                        parcel2.writeInt(_result);
                        return true;
                    default:
