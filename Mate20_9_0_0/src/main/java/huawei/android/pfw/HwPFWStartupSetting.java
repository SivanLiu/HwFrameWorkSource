...
public class HwPFWStartupSetting implements Parcelable, Cloneable {
    public static final Creator<HwPFWStartupSetting> CREATOR = new Creator<HwPFWStartupSetting>() {
        public HwPFWStartupSetting createFromParcel(Parcel source) {
            return new HwPFWStartupSetting(source, null);
        }
    ...
    public String toString() {
        ...
        stringBuilder.append("HwPFWStartupSetting {");
        stringBuilder.append(this.mPackageName);
        stringBuilder.append(", type: ");
        stringBuilder.append(this.mType);
        stringBuilder.append(", allow: ");
        stringBuilder.append(this.mAllow);
