...
public class HwPFWStartupControlScope implements Parcelable {
    public static final Creator<HwPFWStartupControlScope> CREATOR = new Creator<HwPFWStartupControlScope>() {
        public HwPFWStartupControlScope createFromParcel(Parcel source) {
            return new HwPFWStartupControlScope(source, null);
        }
    ...
    /* synthetic */ HwPFWStartupControlScope(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
