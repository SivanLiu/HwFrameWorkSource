...
public final class HwSettings {
    ...
    private static final String[] MDM_POLICY_RELATED_SET_ITEMS = new String[]{"location_mode", "screen_off_timeout", "location_providers_allowed"};
     ...
     */
        ...
        public String getString(ContentResolver cr, String name) {
            ...
            if (c == null) {
                String str3 = HwSettings.TAG;
                StringBuilder stringBuilder2 = new StringBuilder();
                stringBuilder2.append("Can't get key ");
            ...
            e2 = c.moveToNext() ? c.getString(0) : null;
            synchronized (this) {
                this.mValues.put(name, e2);
            }
            if (c != null) {
                c.close();
            }
    ...
    private static String checkLocationPolicyForProviders(ContentResolver cr, String name, String origValue) {
        ...
        int isToEnableNetwork2 = 0;
        while (isToEnableNetwork2 < length) {
            String provider = providerUpdates[isToEnableNetwork2];
        ...
        isToEnableNetwork2 = newString.length();
        if (isToEnableNetwork2 < 1) {
            inputError = true;
        } else {
            newString.setLength(isToEnableNetwork2 - 1);
        }
        if (inputError) {
            return origValue;
        }
    ...
    private static String checkNetworkLocationPolicy(ContentResolver cr, String name, String origValue) {
        try {
            ...
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("HwSettings :: checkAndFixMDMPolicyValue() get invalid value: ");
