...
public interface IHwSmartDisplayService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IHwSmartDisplayService {
        ...
        private static class Proxy implements IHwSmartDisplayService {
            ...
            if (code != 1598968902) {
                switch (code) {
                    case 1:
                        ...
                        boolean _result = isFeatureSupported(data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result);
                        return true;
                    case 2:
                        data.enforceInterface(descriptor);
                        int _result2 = setDisplayEffectParam(data.readInt(), data.createIntArray(), data.readInt());
                        reply.writeNoException();
                        reply.writeInt(_result2);
                        return true;
                    case 3:
                        data.enforceInterface(descriptor);
                        int _result3 = getDisplayEffectSupported(data.readInt());
                        reply.writeNoException();
