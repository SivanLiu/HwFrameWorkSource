...
public class Sockets {
    ...
    private static void initOptionSets() {
        ...
        set2 = new HashSet();
        set2.add(StandardSocketOptions.SO_SNDBUF);
        set2.add(StandardSocketOptions.SO_RCVBUF);
        set2.add(StandardSocketOptions.SO_REUSEADDR);
        set2.add(StandardSocketOptions.IP_TOS);
        if (flowsupported) {
            set2.add(ExtendedSocketOptions.SO_FLOW_SLA);
        }
        options.put(DatagramSocket.class, Collections.unmodifiableSet(set2));
        set2 = new HashSet();
        set2.add(StandardSocketOptions.SO_SNDBUF);
        set2.add(StandardSocketOptions.SO_RCVBUF);
        set2.add(StandardSocketOptions.SO_REUSEADDR);
        set2.add(StandardSocketOptions.IP_TOS);
        set2.add(StandardSocketOptions.IP_MULTICAST_IF);
        set2.add(StandardSocketOptions.IP_MULTICAST_TTL);
        set2.add(StandardSocketOptions.IP_MULTICAST_LOOP);
        if (flowsupported) {
            set2.add(ExtendedSocketOptions.SO_FLOW_SLA);
        }
        options.put(MulticastSocket.class, Collections.unmodifiableSet(set2));
    }
}
