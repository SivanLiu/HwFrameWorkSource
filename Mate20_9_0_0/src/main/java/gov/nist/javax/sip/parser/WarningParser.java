        ...
        try {
            ...
            while (this.lexer.lookAhead(0) != 10) {
                ...
                if (this.lexer.lookAhead(0) == ':') {
                    ...
                    stringBuilder.append(token.getTokenValue());
                    stringBuilder.append(Separators.COLON);
                    stringBuilder.append(token2.getTokenValue());
                    warning.setAgent(stringBuilder.toString());
                } else {
                ...
                while (this.lexer.lookAhead(0) == ',') {
                    ...
                    if (this.lexer.lookAhead(0) == ':') {
                        ...
                        stringBuilder2.append(tok.getTokenValue());
                        stringBuilder2.append(Separators.COLON);
                        stringBuilder2.append(token22.getTokenValue());
                        warning.setAgent(stringBuilder2.toString());
                    } else {
