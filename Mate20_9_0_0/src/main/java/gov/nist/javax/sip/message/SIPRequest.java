...
public final class SIPRequest extends SIPMessage implements Request, RequestExt {
                ...
                if (getContactHeader() == null && getToTag() == null) {
                    ...
                    if ("sips".equalsIgnoreCase(((SipUri) this.requestLine.getUri()).getScheme())) {
                        ...
                        if (!sipUri.getScheme().equals("sips")) {
                            ...
                            stringBuilder2.append("Scheme for contact should be sips:");
                            stringBuilder2.append(sipUri);
    ...
    public String encode() {
        if (this.requestLine != null) {
            ...
            retval.append(this.requestLine.encode());
            retval.append(super.encode());
    ...
    public String encodeMessage() {
        if (this.requestLine != null) {
            ...
            String retval = new StringBuilder();
            retval.append(this.requestLine.encode());
            retval.append(super.encodeSIPHeaders());
            return retval.toString();
        } else if (isNullRequest()) {
            return "\r\n\r\n";
        } else {
                ...
                if (!(nextHeader instanceof ProxyAuthorization)) {
                    if (nextHeader instanceof ContentLength) {
                        ...
                        if (nextHeader instanceof CSeq) {
                            ...
                            if (!(nextHeader instanceof Expires)) {
    ...
    public SIPRequest createSIPRequest(RequestLine requestLine, boolean switchHeaders) {
        ...
        while (headerIterator.hasNext()) {
            ...
            if (nextHeader instanceof CSeq) {
                ...
                newCseq = (Via) ((ViaList) nextHeader).getFirst().clone();
                newCseq.removeParameter("branch");
                nextHeader = newCseq;
            } else if (nextHeader instanceof To) {
                To to = (To) nextHeader;
                if (switchHeaders) {
                ...
                newCseq = (ContentLength) nextHeader.clone();
                try {
                    newCseq.setContentLength(0);
