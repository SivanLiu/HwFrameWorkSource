...
public class HeaderParser extends Parser {
    protected int wkday() throws ParseException {
        ...
        try {
            ...
            int equalsIgnoreCase = "Mon".equalsIgnoreCase(id);
            if (equalsIgnoreCase == true) {
                equalsIgnoreCase = 2;
                return equalsIgnoreCase;
            }
            equalsIgnoreCase = "Tue".equalsIgnoreCase(id);
            if (equalsIgnoreCase == true) {
                dbg_leave("wkday");
                return 3;
            }
            equalsIgnoreCase = "Wed".equalsIgnoreCase(id);
            if (equalsIgnoreCase == true) {
                dbg_leave("wkday");
                return 4;
            }
            equalsIgnoreCase = "Thu".equalsIgnoreCase(id);
            if (equalsIgnoreCase == true) {
                dbg_leave("wkday");
                return 5;
            }
            equalsIgnoreCase = "Fri".equalsIgnoreCase(id);
            if (equalsIgnoreCase == true) {
                dbg_leave("wkday");
                return 6;
            }
            equalsIgnoreCase = "Sat".equalsIgnoreCase(id);
            if (equalsIgnoreCase == true) {
                dbg_leave("wkday");
                return 7;
            }
            equalsIgnoreCase = "Sun".equalsIgnoreCase(id);
            if (equalsIgnoreCase == true) {
                dbg_leave("wkday");
                return 1;
            }
