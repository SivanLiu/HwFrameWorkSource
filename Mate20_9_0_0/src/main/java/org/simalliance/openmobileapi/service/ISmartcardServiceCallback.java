...
public interface ISmartcardServiceCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISmartcardServiceCallback {
        ...
        private static class Proxy implements ISmartcardServiceCallback {
        ...
        public static ISmartcardServiceCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin == null || !(iin instanceof ISmartcardServiceCallback)) {
                return new Proxy(obj);
            }
            return (ISmartcardServiceCallback) iin;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code == 1) {
                ...
                notifyEvent(data.readInt(), data.readString());
