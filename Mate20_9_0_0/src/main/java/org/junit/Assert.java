...
public class Assert {
    ...
    private static void failSame(String message) {
        ...
        stringBuilder = new StringBuilder();
        stringBuilder.append(formatted);
        stringBuilder.append("expected not same");
        fail(stringBuilder.toString());
    }
    ...
    private static void failNotSame(String message, Object expected, Object actual) {
        ...
        stringBuilder = new StringBuilder();
        stringBuilder.append(formatted);
        stringBuilder.append("expected same:<");
    ...
    static String format(String message, Object expected, Object actual) {
        ...
        if (expectedString.equals(actualString)) {
            ...
            stringBuilder2.append(formatClassAndValue(expected, expectedString));
            stringBuilder2.append(" but was: ");
            stringBuilder2.append(formatClassAndValue(actual, actualString));
            return stringBuilder2.toString();
        }
        stringBuilder2 = new StringBuilder();
        stringBuilder2.append(formatted);
        stringBuilder2.append("expected:<");
        stringBuilder2.append(expectedString);
        stringBuilder2.append("> but was:<");
        stringBuilder2.append(actualString);
