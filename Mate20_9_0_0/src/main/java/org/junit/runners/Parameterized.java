...
public class Parameterized extends Suite {
    ...
    private FrameworkMethod getParametersMethod() throws Exception {
        ...
        stringBuilder.append("No public static parameters method on class ");
    ...
    private static TestWithParameters createTestWithParameters(TestClass testClass, String pattern, int index, Object[] parameters) {
        ...
        stringBuilder.append("]");
        return new TestWithParameters(stringBuilder.toString(), testClass, Arrays.asList(parameters));
    }
}
