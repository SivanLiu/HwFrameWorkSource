    ...
    protected void runTestMethod() {
        try {
            ...
            if (this.testMethod.expectsException()) {
                ...
                stringBuilder.append(this.testMethod.getExpectedException().getName());
                addFailure(new AssertionError(stringBuilder.toString()));
            }
            ...
            if (!(actual instanceof AssumptionViolatedException)) {
                if (!this.testMethod.expectsException()) {
                    ...
                    message.append(this.testMethod.getExpectedException().getName());
                    message.append("> but was<");
                    message.append(actual.getClass().getName());
                    message.append(">");
                    addFailure(new Exception(message.toString(), actual));
                }
            }
        } catch (Throwable e2) {
            addFailure(e2);
