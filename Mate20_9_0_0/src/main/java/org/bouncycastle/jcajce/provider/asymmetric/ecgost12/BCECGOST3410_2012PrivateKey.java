...
public class BCECGOST3410_2012PrivateKey implements ECPrivateKey, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: BlockProcessor
        ...
        */
    public BCECGOST3410_2012PrivateKey(org.bouncycastle.jce.spec.ECPrivateKeySpec r3) {
        /*
        r2 = this;
        r2.<init>();
        r0 = "ECGOST3410-2012";
    ...
    L_0x0039:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.jcajce.provider.asymmetric.ecgost12.BCECGOST3410_2012PrivateKey.<init>(org.bouncycastle.jce.spec.ECPrivateKeySpec):void");
    }
        ...
        if ((toASN1Primitive instanceof ASN1Sequence) && (ASN1Sequence.getInstance(toASN1Primitive).size() == 2 || ASN1Sequence.getInstance(toASN1Primitive).size() == 3)) {
            ...
            if (instance.isNamedCurve()) {
                ...
                if (namedCurveByOid == null) {
                    ...
                    eCNamedCurveSpec = new ECNamedCurveSpec(ECGOST3410NamedCurves.getName(instance2), EC5Util.convertCurve(byOID.getCurve(), byOID.getSeed()), EC5Util.convertPoint(byOID.getG()), byOID.getN(), byOID.getH());
                } else {
                    eCNamedCurveSpec = new ECNamedCurveSpec(ECUtil.getCurveName(instance2), EC5Util.convertCurve(namedCurveByOid.getCurve(), namedCurveByOid.getSeed()), EC5Util.convertPoint(namedCurveByOid.getG()), namedCurveByOid.getN(), namedCurveByOid.getH());
                }
    ...
    public byte[] getEncoded() {
        int i = this.d.bitLength() > 256 ? 1 : 0;
        ASN1ObjectIdentifier aSN1ObjectIdentifier = i != 0 ? RosstandartObjectIdentifiers.id_tc26_gost_3410_12_512 : RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256;
        i = i != 0 ? 64 : 32;
        ...
        if (this.ecSpec instanceof ECNamedCurveSpec) {
            ...
            return new PrivateKeyInfo(new AlgorithmIdentifier(aSN1ObjectIdentifier, x962Parameters.toASN1Primitive()), (this.publicKey == null ? new org.bouncycastle.asn1.sec.ECPrivateKey(i, getS(), this.publicKey, x962Parameters) : new org.bouncycastle.asn1.sec.ECPrivateKey(i, getS(), x962Parameters)).toASN1Primitive()).getEncoded(ASN1Encoding.DER);
        } else {
