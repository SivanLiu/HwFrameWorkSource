...
public class GOST3411 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider.addAlgorithm("MessageDigest.GOST3411", stringBuilder.toString());
            ...
            stringBuilder2.append(CryptoProObjectIdentifiers.gostR3411);
            configurableProvider.addAlgorithm(stringBuilder2.toString(), "GOST3411");
            ...
            addHMACAlgorithm(configurableProvider, "GOST3411", stringBuilder3, stringBuilder4.toString());
            addHMACAlias(configurableProvider, "GOST3411", CryptoProObjectIdentifiers.gostR3411);
            stringBuilder = new StringBuilder();
            stringBuilder.append(PREFIX);
            stringBuilder.append("$Digest2012_256");
            configurableProvider.addAlgorithm("MessageDigest.GOST3411-2012-256", stringBuilder.toString());
            ...
            stringBuilder2.append("Alg.Alias.MessageDigest.");
            stringBuilder2.append(RosstandartObjectIdentifiers.id_tc26_gost_3411_12_256);
            configurableProvider.addAlgorithm(stringBuilder2.toString(), "GOST3411-2012-256");
            stringBuilder = new StringBuilder();
            stringBuilder.append(PREFIX);
            stringBuilder.append("$HashMac2012_256");
            stringBuilder3 = stringBuilder.toString();
            stringBuilder4 = new StringBuilder();
            stringBuilder4.append(PREFIX);
            stringBuilder4.append("$KeyGenerator2012_256");
            addHMACAlgorithm(configurableProvider, "GOST3411-2012-256", stringBuilder3, stringBuilder4.toString());
            addHMACAlias(configurableProvider, "GOST3411-2012-256", RosstandartObjectIdentifiers.id_tc26_hmac_gost_3411_12_256);
            stringBuilder = new StringBuilder();
            stringBuilder.append(PREFIX);
            stringBuilder.append("$Digest2012_512");
            configurableProvider.addAlgorithm("MessageDigest.GOST3411-2012-512", stringBuilder.toString());
            ...
            stringBuilder2 = new StringBuilder();
            stringBuilder2.append("Alg.Alias.MessageDigest.");
            stringBuilder2.append(RosstandartObjectIdentifiers.id_tc26_gost_3411_12_512);
            configurableProvider.addAlgorithm(stringBuilder2.toString(), "GOST3411-2012-512");
            stringBuilder = new StringBuilder();
            stringBuilder.append(PREFIX);
            stringBuilder.append("$HashMac2012_512");
            stringBuilder3 = stringBuilder.toString();
            stringBuilder4 = new StringBuilder();
            stringBuilder4.append(PREFIX);
            stringBuilder4.append("$KeyGenerator2012_512");
            addHMACAlgorithm(configurableProvider, "GOST3411-2012-512", stringBuilder3, stringBuilder4.toString());
            ...
            configurableProvider.addAlgorithm("SecretKeyFactory.PBEWITHHMACGOST3411", stringBuilder.toString());
            stringBuilder2 = new StringBuilder();
            stringBuilder2.append("Alg.Alias.SecretKeyFactory.");
            stringBuilder2.append(CryptoProObjectIdentifiers.gostR3411);
            configurableProvider.addAlgorithm(stringBuilder2.toString(), "PBEWITHHMACGOST3411");
        }
    }
