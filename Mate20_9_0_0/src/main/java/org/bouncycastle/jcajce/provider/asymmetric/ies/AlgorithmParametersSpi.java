    ...
    protected void engineInit(byte[] bArr) throws IOException {
        try {
            ...
            if (aSN1Sequence.size() == 1) {
                ...
                instance = ASN1TaggedObject.getInstance(aSN1Sequence.getObjectAt(0));
                ...
                if (aSN1Sequence.size() == 4) {
                    ...
                    ASN1Sequence instance3 = ASN1Sequence.getInstance(aSN1Sequence.getObjectAt(3));
                    this.currentSpec = new IESParameterSpec(ASN1OctetString.getInstance(instance, false).getOctets(), ASN1OctetString.getInstance(instance2, false).getOctets(), ASN1Integer.getInstance(aSN1Sequence.getObjectAt(2)).getValue().intValue(), ASN1Integer.getInstance(instance3.getObjectAt(0)).getValue().intValue(), ASN1OctetString.getInstance(instance3.getObjectAt(1)).getOctets());
                }
            }
