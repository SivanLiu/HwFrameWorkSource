...
public class SHA384 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider.addAlgorithm(stringBuilder2.toString(), McElieceCCA2KeyGenParameterSpec.SHA384);
            stringBuilder = new StringBuilder();
            stringBuilder.append(PREFIX);
            stringBuilder.append("$OldSHA384");
            configurableProvider.addAlgorithm("Mac.OLDHMACSHA384", stringBuilder.toString());
            stringBuilder = new StringBuilder();
            stringBuilder.append(PREFIX);
            ...
            addHMACAlgorithm(configurableProvider, "SHA384", stringBuilder3, stringBuilder4.toString());
