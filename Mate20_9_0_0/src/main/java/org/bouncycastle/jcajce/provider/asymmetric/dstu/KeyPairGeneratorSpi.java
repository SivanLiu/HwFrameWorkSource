...
public class KeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: BlockProcessor
        jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:33:0x0130 in {2, 3, 5, 8, 9, 14, 18, 23, 25, 27, 29, 32, 35} preds:[]
    ...
    public void initialize(java.security.spec.AlgorithmParameterSpec r11, java.security.SecureRandom r12) throws java.security.InvalidAlgorithmParameterException {
        ...
        r11 = r11.getName();
        goto L_0x00d3;
        r11 = new org.bouncycastle.asn1.ASN1ObjectIdentifier;
        r11.<init>(r4);
        r11 = org.bouncycastle.asn1.ua.DSTU4145NamedCurves.getByOID(r11);
        ...
        throw r11;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.jcajce.provider.asymmetric.dstu.KeyPairGeneratorSpi.initialize(java.security.spec.AlgorithmParameterSpec, java.security.SecureRandom):void");
    }
}
