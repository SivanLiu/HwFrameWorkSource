...
public class ECGOST {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            stringBuilder.append("Alg.Alias.KeyAgreement.");
            stringBuilder.append(CryptoProObjectIdentifiers.gostR3410_2001);
            configurableProvider.addAlgorithm(stringBuilder.toString(), "ECGOST3410");
            configurableProvider.addAlgorithm("Alg.Alias.KeyAgreement.GOST-3410-2001", "ECGOST3410");
            stringBuilder = new StringBuilder();
            stringBuilder.append("Alg.Alias.KeyAgreement.");
            stringBuilder.append(CryptoProObjectIdentifiers.gostR3410_2001_CryptoPro_ESDH);
            configurableProvider.addAlgorithm(stringBuilder.toString(), "ECGOST3410");
            ...
            addSignatureAlgorithm(configurableProvider2, "GOST3411-2012-512", "ECGOST3410-2012-512", "org.bouncycastle.jcajce.provider.asymmetric.ecgost12.ECGOST2012SignatureSpi512", RosstandartObjectIdentifiers.id_tc26_signwithdigest_gost_3410_12_512);
            ...
            stringBuilder = new StringBuilder();
            stringBuilder.append("Alg.Alias.KeyAgreement.");
            stringBuilder.append(RosstandartObjectIdentifiers.id_tc26_agreement_gost_3410_12_256);
            configurableProvider.addAlgorithm(stringBuilder.toString(), "ECGOST3410-2012-256");
            stringBuilder = new StringBuilder();
            stringBuilder.append("Alg.Alias.KeyAgreement.");
            stringBuilder.append(RosstandartObjectIdentifiers.id_tc26_agreement_gost_3410_12_512);
            configurableProvider.addAlgorithm(stringBuilder.toString(), "ECGOST3410-2012-512");
            stringBuilder = new StringBuilder();
            stringBuilder.append("Alg.Alias.KeyAgreement.");
            stringBuilder.append(RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256);
            configurableProvider.addAlgorithm(stringBuilder.toString(), "ECGOST3410-2012-256");
            stringBuilder = new StringBuilder();
            stringBuilder.append("Alg.Alias.KeyAgreement.");
            stringBuilder.append(RosstandartObjectIdentifiers.id_tc26_gost_3410_12_512);
            configurableProvider.addAlgorithm(stringBuilder.toString(), "ECGOST3410-2012-512");
        }
    }
}
