...
public class EC {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            stringBuilder.append(X9ObjectIdentifiers.dhSinglePass_stdDH_sha1kdf_scheme);
            configurableProvider.addAlgorithm(stringBuilder.toString(), "org.bouncycastle.jcajce.provider.asymmetric.ec.KeyAgreementSpi$DHwithSHA1KDFAndSharedInfo");
            stringBuilder = new StringBuilder();
            stringBuilder.append("KeyAgreement.");
            stringBuilder.append(X9ObjectIdentifiers.dhSinglePass_cofactorDH_sha1kdf_scheme);
            configurableProvider.addAlgorithm(stringBuilder.toString(), "org.bouncycastle.jcajce.provider.asymmetric.ec.KeyAgreementSpi$CDHwithSHA1KDFAndSharedInfo");
            stringBuilder = new StringBuilder();
            stringBuilder.append("KeyAgreement.");
            stringBuilder.append(SECObjectIdentifiers.dhSinglePass_stdDH_sha224kdf_scheme);
            configurableProvider.addAlgorithm(stringBuilder.toString(), "org.bouncycastle.jcajce.provider.asymmetric.ec.KeyAgreementSpi$DHwithSHA224KDFAndSharedInfo");
            stringBuilder = new StringBuilder();
            stringBuilder.append("KeyAgreement.");
            stringBuilder.append(SECObjectIdentifiers.dhSinglePass_cofactorDH_sha224kdf_scheme);
            configurableProvider.addAlgorithm(stringBuilder.toString(), "org.bouncycastle.jcajce.provider.asymmetric.ec.KeyAgreementSpi$CDHwithSHA224KDFAndSharedInfo");
            stringBuilder = new StringBuilder();
            stringBuilder.append("KeyAgreement.");
            stringBuilder.append(SECObjectIdentifiers.dhSinglePass_stdDH_sha256kdf_scheme);
            configurableProvider.addAlgorithm(stringBuilder.toString(), "org.bouncycastle.jcajce.provider.asymmetric.ec.KeyAgreementSpi$DHwithSHA256KDFAndSharedInfo");
            stringBuilder = new StringBuilder();
            stringBuilder.append("KeyAgreement.");
            stringBuilder.append(SECObjectIdentifiers.dhSinglePass_cofactorDH_sha256kdf_scheme);
            configurableProvider.addAlgorithm(stringBuilder.toString(), "org.bouncycastle.jcajce.provider.asymmetric.ec.KeyAgreementSpi$CDHwithSHA256KDFAndSharedInfo");
            stringBuilder = new StringBuilder();
            stringBuilder.append("KeyAgreement.");
            stringBuilder.append(SECObjectIdentifiers.dhSinglePass_stdDH_sha384kdf_scheme);
            configurableProvider.addAlgorithm(stringBuilder.toString(), "org.bouncycastle.jcajce.provider.asymmetric.ec.KeyAgreementSpi$DHwithSHA384KDFAndSharedInfo");
            stringBuilder = new StringBuilder();
            stringBuilder.append("KeyAgreement.");
            stringBuilder.append(SECObjectIdentifiers.dhSinglePass_cofactorDH_sha384kdf_scheme);
            configurableProvider.addAlgorithm(stringBuilder.toString(), "org.bouncycastle.jcajce.provider.asymmetric.ec.KeyAgreementSpi$CDHwithSHA384KDFAndSharedInfo");
            stringBuilder = new StringBuilder();
            stringBuilder.append("KeyAgreement.");
            stringBuilder.append(SECObjectIdentifiers.dhSinglePass_stdDH_sha512kdf_scheme);
            configurableProvider.addAlgorithm(stringBuilder.toString(), "org.bouncycastle.jcajce.provider.asymmetric.ec.KeyAgreementSpi$DHwithSHA512KDFAndSharedInfo");
            stringBuilder = new StringBuilder();
            stringBuilder.append("KeyAgreement.");
            stringBuilder.append(SECObjectIdentifiers.dhSinglePass_cofactorDH_sha512kdf_scheme);
            configurableProvider.addAlgorithm(stringBuilder.toString(), "org.bouncycastle.jcajce.provider.asymmetric.ec.KeyAgreementSpi$CDHwithSHA512KDFAndSharedInfo");
            ...
            if (!Properties.isOverrideSet("org.bouncycastle.ec.disable_mqv")) {
                ...
                stringBuilder = new StringBuilder();
                stringBuilder.append("KeyAgreement.");
                stringBuilder.append(X9ObjectIdentifiers.mqvSinglePass_sha1kdf_scheme);
                configurableProvider.addAlgorithm(stringBuilder.toString(), "org.bouncycastle.jcajce.provider.asymmetric.ec.KeyAgreementSpi$MQVwithSHA1KDFAndSharedInfo");
                stringBuilder = new StringBuilder();
                stringBuilder.append("KeyAgreement.");
                stringBuilder.append(SECObjectIdentifiers.mqvSinglePass_sha224kdf_scheme);
                configurableProvider.addAlgorithm(stringBuilder.toString(), "org.bouncycastle.jcajce.provider.asymmetric.ec.KeyAgreementSpi$MQVwithSHA224KDFAndSharedInfo");
                stringBuilder = new StringBuilder();
                stringBuilder.append("KeyAgreement.");
                stringBuilder.append(SECObjectIdentifiers.mqvSinglePass_sha256kdf_scheme);
                configurableProvider.addAlgorithm(stringBuilder.toString(), "org.bouncycastle.jcajce.provider.asymmetric.ec.KeyAgreementSpi$MQVwithSHA256KDFAndSharedInfo");
                stringBuilder = new StringBuilder();
                stringBuilder.append("KeyAgreement.");
                stringBuilder.append(SECObjectIdentifiers.mqvSinglePass_sha384kdf_scheme);
                configurableProvider.addAlgorithm(stringBuilder.toString(), "org.bouncycastle.jcajce.provider.asymmetric.ec.KeyAgreementSpi$MQVwithSHA384KDFAndSharedInfo");
                stringBuilder = new StringBuilder();
                stringBuilder.append("KeyAgreement.");
                stringBuilder.append(SECObjectIdentifiers.mqvSinglePass_sha512kdf_scheme);
                configurableProvider.addAlgorithm(stringBuilder.toString(), "org.bouncycastle.jcajce.provider.asymmetric.ec.KeyAgreementSpi$MQVwithSHA512KDFAndSharedInfo");
            ...
            stringBuilder.append(TeleTrusTObjectIdentifiers.ecSignWithSha1);
            configurableProvider.addAlgorithm(stringBuilder.toString(), "ECDSA");
            ...
            addSignatureAlgorithm(configurableProvider2, "SHA256", "CVC-ECDSA", "org.bouncycastle.jcajce.provider.asymmetric.ec.SignatureSpi$ecCVCDSA256", EACObjectIdentifiers.id_TA_ECDSA_SHA_256);
            configurableProvider3 = configurableProvider;
            addSignatureAlgorithm(configurableProvider3, "SHA384", "CVC-ECDSA", "org.bouncycastle.jcajce.provider.asymmetric.ec.SignatureSpi$ecCVCDSA384", EACObjectIdentifiers.id_TA_ECDSA_SHA_384);
            addSignatureAlgorithm(configurableProvider2, "SHA512", "CVC-ECDSA", "org.bouncycastle.jcajce.provider.asymmetric.ec.SignatureSpi$ecCVCDSA512", EACObjectIdentifiers.id_TA_ECDSA_SHA_512);
            addSignatureAlgorithm(configurableProvider3, "SHA1", "PLAIN-ECDSA", "org.bouncycastle.jcajce.provider.asymmetric.ec.SignatureSpi$ecCVCDSA", BSIObjectIdentifiers.ecdsa_plain_SHA1);
            addSignatureAlgorithm(configurableProvider2, "SHA224", "PLAIN-ECDSA", "org.bouncycastle.jcajce.provider.asymmetric.ec.SignatureSpi$ecCVCDSA224", BSIObjectIdentifiers.ecdsa_plain_SHA224);
            addSignatureAlgorithm(configurableProvider3, "SHA256", "PLAIN-ECDSA", "org.bouncycastle.jcajce.provider.asymmetric.ec.SignatureSpi$ecCVCDSA256", BSIObjectIdentifiers.ecdsa_plain_SHA256);
            addSignatureAlgorithm(configurableProvider2, "SHA384", "PLAIN-ECDSA", "org.bouncycastle.jcajce.provider.asymmetric.ec.SignatureSpi$ecCVCDSA384", BSIObjectIdentifiers.ecdsa_plain_SHA384);
            addSignatureAlgorithm(configurableProvider3, "SHA512", "PLAIN-ECDSA", "org.bouncycastle.jcajce.provider.asymmetric.ec.SignatureSpi$ecCVCDSA512", BSIObjectIdentifiers.ecdsa_plain_SHA512);
            addSignatureAlgorithm(configurableProvider2, "RIPEMD160", "PLAIN-ECDSA", "org.bouncycastle.jcajce.provider.asymmetric.ec.SignatureSpi$ecPlainDSARP160", BSIObjectIdentifiers.ecdsa_plain_RIPEMD160);
        }
    }
