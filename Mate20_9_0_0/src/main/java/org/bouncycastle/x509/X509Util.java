...
class X509Util {
    ...
    static ASN1ObjectIdentifier getAlgorithmOID(String str) {
        ...
        return algorithms.containsKey(str) ? (ASN1ObjectIdentifier) algorithms.get(str) : new ASN1ObjectIdentifier(str);
    }
    ...
    static Implementation getImplementation(String str, String str2) throws NoSuchAlgorithmException {
        ...
        stringBuilder.append("cannot find implementation ");
    ...
    static Implementation getImplementation(String str, String str2, Provider provider) throws NoSuchAlgorithmException {
        ...
        stringBuilder.append(".");
        stringBuilder.append(str2);
        str = provider.getProperty(stringBuilder.toString());
        if (str != null) {
            try {
                ClassLoader classLoader = provider.getClass().getClassLoader();
                return new Implementation((classLoader != null ? classLoader.loadClass(str) : Class.forName(str)).newInstance(), provider);
            } catch (ClassNotFoundException e) {
                stringBuilder2 = new StringBuilder();
                stringBuilder2.append("algorithm ");
                stringBuilder2.append(str2);
                stringBuilder2.append(" in provider ");
                stringBuilder2.append(provider.getName());
                stringBuilder2.append(" but no class \"");
                ...
                stringBuilder2.append(" in provider ");
                stringBuilder2.append(provider.getName());
                stringBuilder2.append(" but class \"");
                stringBuilder2.append(str);
                stringBuilder2.append("\" inaccessible!");
                throw new IllegalStateException(stringBuilder2.toString());
            }
        }
        stringBuilder = new StringBuilder();
    ...
    static AlgorithmIdentifier getSigAlgID(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        ...
        str = Strings.toUpperCase(str);
        return params.containsKey(str) ? new AlgorithmIdentifier(aSN1ObjectIdentifier, (ASN1Encodable) params.get(str)) : new AlgorithmIdentifier(aSN1ObjectIdentifier, DERNull.INSTANCE);
    }
