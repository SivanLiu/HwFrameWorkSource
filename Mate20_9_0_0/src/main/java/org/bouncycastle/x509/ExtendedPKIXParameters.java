...
public class ExtendedPKIXParameters extends PKIXParameters {
    ...
    public void setAttrCertCheckers(Set set) {
        ...
        for (Object obj : set) {
            if (!(obj instanceof PKIXAttrCertChecker)) {
                ...
                stringBuilder.append("All elements of set must be of type ");
                stringBuilder.append(PKIXAttrCertChecker.class.getName());
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: BlockProcessor
        jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:6:0x0010 in {2, 4, 5} preds:[]
    ...
    public void setTargetCertConstraints(java.security.cert.CertSelector r1) {
        ...
        r1 = (java.security.cert.X509CertSelector) r1;
        r1 = org.bouncycastle.x509.X509CertStoreSelector.getInstance(r1);
        r0.selector = r1;
        return;
        r1 = 0;
        goto L_0x000b;
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.x509.ExtendedPKIXParameters.setTargetCertConstraints(java.security.cert.CertSelector):void");
    }

    /*  JADX ERROR: JadxRuntimeException in pass: BlockProcessor
        jadx.core.utils.exceptions.JadxRuntimeException: Can't find immediate dominator for block B:5:0x000d in {1, 3, 4} preds:[]
        	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.computeDominators(BlockProcessor.java:242)
        	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.processBlocksTree(BlockProcessor.java:52)
        	at jadx.core.dex.visitors.blocksmaker.BlockProcessor.visit(BlockProcessor.java:42)
        	at jadx.core.dex.visitors.DepthTraversal.visit(DepthTraversal.java:27)
    ...
    public void setTargetConstraints(org.bouncycastle.util.Selector r1) {
        ...
        r1 = r1.clone();
        r1 = (org.bouncycastle.util.Selector) r1;
        r0.selector = r1;
        return;
        r1 = 0;
        goto L_0x0008;
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.x509.ExtendedPKIXParameters.setTargetConstraints(org.bouncycastle.util.Selector):void");
    }
    ...
    public void setTrustedACIssuers(Set set) {
        ...
        for (Object obj : set) {
            if (!(obj instanceof TrustAnchor)) {
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("All elements of set must be of type ");
                stringBuilder.append(TrustAnchor.class.getName());
                stringBuilder.append(".");
                throw new ClassCastException(stringBuilder.toString());
            }
        }
