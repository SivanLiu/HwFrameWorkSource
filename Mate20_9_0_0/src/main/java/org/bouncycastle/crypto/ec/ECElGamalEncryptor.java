...
public class ECElGamalEncryptor implements ECEncryptor {
    ...
    public ECPair encrypt(ECPoint eCPoint) {
        if (this.key != null) {
            ...
            ECPoint[] eCPointArr = new ECPoint[]{createBasePointMultiplier().multiply(parameters.getG(), generateK), this.key.getQ().multiply(generateK).add(eCPoint)};
    ...
    L_0x001d:
        ...
        r0 = "ECPublicKeyParameters are required for encryption.";
        r2.<init>(r0);
        throw r2;
    L_0x0025:
    ...
    L_0x0034:
        ...
        throw r2;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.crypto.ec.ECElGamalEncryptor.init(org.bouncycastle.crypto.CipherParameters):void");
    }
}
