...
public class ECNewRandomnessTransform implements ECPairFactorTransform {
    ...
    L_0x001d:
        ...
        r0 = "ECPublicKeyParameters are required for new randomness transform.";
        r2.<init>(r0);
        throw r2;
    L_0x0025:
    ...
    L_0x0034:
        ...
        throw r2;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.crypto.ec.ECNewRandomnessTransform.init(org.bouncycastle.crypto.CipherParameters):void");
    }
