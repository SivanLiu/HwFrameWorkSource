    ...
    protected void processBlock() {
        ...
        while (i <= 10) {
            ...
            while (i3 < 8) {
                ...
                long[] jArr4 = this._L;
                i2 = i;
                jArr4[i3] = C0[((int) (this._K[(i3 + 0) & 7] >>> 56)) & 255] ^ jArr4[i3];
                jArr = this._L;
                jArr[i3] = jArr[i3] ^ C1[((int) (this._K[(i3 - 1) & 7] >>> 48)) & 255];
                jArr = this._L;
                jArr[i3] = jArr[i3] ^ C2[((int) (this._K[(i3 - 2) & 7] >>> 40)) & 255];
                jArr = this._L;
                jArr[i3] = jArr[i3] ^ C3[((int) (this._K[(i3 - 3) & 7] >>> 32)) & 255];
                jArr = this._L;
                jArr[i3] = jArr[i3] ^ C4[((int) (this._K[(i3 - 4) & 7] >>> 24)) & 255];
                jArr = this._L;
                jArr[i3] = jArr[i3] ^ C5[((int) (this._K[(i3 - 5) & 7] >>> 16)) & 255];
                jArr = this._L;
                jArr[i3] = jArr[i3] ^ C6[((int) (this._K[(i3 - 6) & 7] >>> 8)) & 255];
                jArr = this._L;
                jArr[i3] = jArr[i3] ^ C7[((int) this._K[(i3 - 7) & 7]) & 255];
                i3++;
                i = i2;
            }
            i2 = i;
            ...
            jArr = this._K;
            jArr[0] = jArr[0] ^ this._rc[i2];
            for (int i4 = 0; i4 < 8; i4++) {
                this._L[i4] = this._K[i4];
                long[] jArr5 = this._L;
                jArr5[i4] = jArr5[i4] ^ C0[((int) (this._state[(i4 + 0) & 7] >>> 56)) & 255];
                jArr5 = this._L;
                jArr5[i4] = jArr5[i4] ^ C1[((int) (this._state[(i4 - 1) & 7] >>> 48)) & 255];
                jArr5 = this._L;
                jArr5[i4] = jArr5[i4] ^ C2[((int) (this._state[(i4 - 2) & 7] >>> 40)) & 255];
                jArr5 = this._L;
                jArr5[i4] = jArr5[i4] ^ C3[((int) (this._state[(i4 - 3) & 7] >>> 32)) & 255];
                jArr5 = this._L;
                jArr5[i4] = jArr5[i4] ^ C4[((int) (this._state[(i4 - 4) & 7] >>> 24)) & 255];
                jArr5 = this._L;
                jArr5[i4] = jArr5[i4] ^ C5[((int) (this._state[(i4 - 5) & 7] >>> 16)) & 255];
                jArr5 = this._L;
                jArr5[i4] = jArr5[i4] ^ C6[((int) (this._state[(i4 - 6) & 7] >>> 8)) & 255];
                jArr5 = this._L;
                jArr5[i4] = jArr5[i4] ^ C7[((int) this._state[(i4 - 7) & 7]) & 255];
            }
        ...
        for (int i5 = 0; i5 < 8; i5++) {
            jArr = this._hash;
            jArr[i5] = jArr[i5] ^ (this._state[i5] ^ this._block[i5]);
        }
    }
