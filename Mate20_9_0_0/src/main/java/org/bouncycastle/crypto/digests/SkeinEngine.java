...
public class SkeinEngine implements Memoable {
    ...
    private static class UbiTweak {
        ...
        public void advancePosition(int i) {
            ...
            if (this.extendedPosition) {
                long[] jArr = new long[]{this.tweak[0] & BodyPartID.bodyIdMax, (this.tweak[0] >>> 32) & BodyPartID.bodyIdMax, this.tweak[1] & BodyPartID.bodyIdMax};
                j = (long) i;
    ...
    private static Parameter[] clone(Parameter[] parameterArr, Parameter[] parameterArr2) {
        ...
        Object parameterArr22;
        if (parameterArr22 == null || parameterArr22.length != parameterArr.length) {
            parameterArr22 = new Parameter[parameterArr.length];
        }
        System.arraycopy(parameterArr, 0, parameterArr22, 0, parameterArr22.length);
        return parameterArr22;
    }
    ...
    private void createInitialState() {
        ...
        if (this.preMessageParameters != null) {
            while (i < this.preMessageParameters.length) {
    ...
    public int doFinal(byte[] bArr, int i) {
        ...
        if (bArr.length >= this.outputSizeBytes + i) {
            ...
            while (i2 < i3) {
                int i4 = i2 * blockSize;
                output((long) i2, bArr, i + i4, Math.min(blockSize, this.outputSizeBytes - i4));
                i2++;
            }
            reset();
