    ...
    public void init(TlsContext tlsContext) {
        ...
        if (TlsUtils.isSignatureAlgorithmsExtensionAllowed(clientVersion)) {
            if (this.supportedSignatureAlgorithms == null) {
                Vector defaultECDSASignatureAlgorithms;
                ...
                if (i != 1) {
                            ...
                            if (i != 7) {
                                if (i != 9) {
                                    switch (i) {
                                        ...
                                        case 16:
                                        case 17:
                                            defaultECDSASignatureAlgorithms = TlsUtils.getDefaultECDSASignatureAlgorithms();
                                            break;
                                        default:
                                            switch (i) {
                                                case 21:
                    ...
                    defaultECDSASignatureAlgorithms = TlsUtils.getDefaultDSSSignatureAlgorithms();
                    this.supportedSignatureAlgorithms = defaultECDSASignatureAlgorithms;
                }
                defaultECDSASignatureAlgorithms = TlsUtils.getDefaultRSASignatureAlgorithms();
                this.supportedSignatureAlgorithms = defaultECDSASignatureAlgorithms;
            }
