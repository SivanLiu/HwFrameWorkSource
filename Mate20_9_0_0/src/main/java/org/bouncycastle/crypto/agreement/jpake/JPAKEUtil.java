...
public class JPAKEUtil {
    ...
    public static BigInteger[] calculateZeroKnowledgeProof(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4, BigInteger bigInteger5, String str, Digest digest, SecureRandom secureRandom) {
        ...
        bigInteger = bigInteger3.modPow(createRandomInRange, bigInteger);
        bigInteger3 = calculateHashForZeroKnowledgeProof(bigInteger3, bigInteger, bigInteger4, str, digest);
        bigIntegerArr[0] = bigInteger;
        bigIntegerArr[1] = createRandomInRange.subtract(bigInteger5.multiply(bigInteger3)).mod(bigInteger2);
    ...
    public static void validateParticipantIdsDiffer(String str, String str2) throws CryptoException {
        if (str.equals(str2)) {
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Both participants are using the same participantId (");
            stringBuilder.append(str);
            stringBuilder.append("). This is not allowed. Each participant must use a unique participantId.");
            throw new CryptoException(stringBuilder.toString());
        }
    }
    ...
    public static void validateParticipantIdsEqual(String str, String str2) throws CryptoException {
        if (!str.equals(str2)) {
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Received payload from incorrect partner (");
            stringBuilder.append(str2);
            stringBuilder.append("). Expected to receive payload from ");
            stringBuilder.append(str);
