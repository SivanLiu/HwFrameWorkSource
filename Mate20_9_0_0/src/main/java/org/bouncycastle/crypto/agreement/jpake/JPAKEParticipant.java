...
public class JPAKEParticipant {
    ...
    public BigInteger calculateKeyingMaterial() {
        ...
        if (this.state >= 50) {
            ...
            stringBuilder.append("Key already calculated for ");
            stringBuilder.append(this.participantId);
            ...
            stringBuilder = new StringBuilder();
            stringBuilder.append("Round2 payload must be validated prior to creating key for ");
            stringBuilder.append(this.participantId);
            throw new IllegalStateException(stringBuilder.toString());
        }
    }
    ...
    public JPAKERound1Payload createRound1PayloadToSend() {
        ...
        stringBuilder.append("Round1 payload already created for ");
        stringBuilder.append(this.participantId);
        throw new IllegalStateException(stringBuilder.toString());
    }
    ...
    public JPAKERound2Payload createRound2PayloadToSend() {
        ...
        if (this.state >= 30) {
            stringBuilder = new StringBuilder();
            stringBuilder.append("Round2 payload already created for ");
            stringBuilder.append(this.participantId);
            throw new IllegalStateException(stringBuilder.toString());
            ...
            stringBuilder = new StringBuilder();
            stringBuilder.append("Round1 payload must be validated prior to creating Round2 payload for ");
            stringBuilder.append(this.participantId);
            throw new IllegalStateException(stringBuilder.toString());
        }
    }
    ...
    public JPAKERound3Payload createRound3PayloadToSend(BigInteger bigInteger) {
        ...
        if (this.state >= 60) {
            stringBuilder = new StringBuilder();
            stringBuilder.append("Round3 payload already created for ");
            stringBuilder.append(this.participantId);
            throw new IllegalStateException(stringBuilder.toString());
        } else if (this.state >= 50) {
            bigInteger = JPAKEUtil.calculateMacTag(this.participantId, this.partnerParticipantId, this.gx1, this.gx2, this.gx3, this.gx4, bigInteger, this.digest);
            this.state = 60;
            return new JPAKERound3Payload(this.participantId, bigInteger);
        } else {
            stringBuilder = new StringBuilder();
            stringBuilder.append("Keying material must be calculated prior to creating Round3 payload for ");
            stringBuilder.append(this.participantId);
            throw new IllegalStateException(stringBuilder.toString());
        }
    }
    ...
    public void validateRound1PayloadReceived(JPAKERound1Payload jPAKERound1Payload) throws CryptoException {
        ...
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Validation already attempted for round1 payload for");
        stringBuilder.append(this.participantId);
        throw new IllegalStateException(stringBuilder.toString());
    }
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) throws CryptoException {
        ...
        if (this.state >= 40) {
            stringBuilder = new StringBuilder();
            stringBuilder.append("Validation already attempted for round2 payload for");
            stringBuilder.append(this.participantId);
            throw new IllegalStateException(stringBuilder.toString());
        } else if (this.state >= 20) {
            ...
            stringBuilder = new StringBuilder();
            stringBuilder.append("Round1 payload must be validated prior to validating Round2 payload for ");
            stringBuilder.append(this.participantId);
            throw new IllegalStateException(stringBuilder.toString());
        }
    }
    ...
    public void validateRound3PayloadReceived(JPAKERound3Payload jPAKERound3Payload, BigInteger bigInteger) throws CryptoException {
        ...
        if (this.state >= 70) {
            stringBuilder = new StringBuilder();
            stringBuilder.append("Validation already attempted for round3 payload for");
            stringBuilder.append(this.participantId);
            throw new IllegalStateException(stringBuilder.toString());
        } else if (this.state >= 50) {
            ...
            stringBuilder = new StringBuilder();
            stringBuilder.append("Keying material must be calculated validated prior to validating Round3 payload for ");
            stringBuilder.append(this.participantId);
            throw new IllegalStateException(stringBuilder.toString());
        }
    }
