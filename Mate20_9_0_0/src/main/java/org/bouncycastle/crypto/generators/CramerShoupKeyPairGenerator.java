...
public class CramerShoupKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    public AsymmetricCipherKeyPair generateKeyPair() {
        ...
        AsymmetricKeyParameter generatePrivateKey = generatePrivateKey(this.param.getRandom(), parameters);
        AsymmetricKeyParameter calculatePublicKey = calculatePublicKey(parameters, generatePrivateKey);
