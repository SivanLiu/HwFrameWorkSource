...
public class Grainv1Engine implements StreamCipher {
    ...
    private int getOutput() {
        ...
        i9 &= i11;
        i12 &= i9;
        return (((((((i ^ ((((i9 & i8) ^ (i12 ^ (((i13 ^ i14) ^ (i12 & i8)) ^ ((i9 & i10) & i11)))) ^ ((i10 & i11) & i8)) ^ (i14 & i8))) ^ i2) ^ i3) ^ i4) ^ i5) ^ i6) ^ i7) & 65535;
    }
    ...
    private int getOutputNFSR() {
        ...
        int i12 = (this.nfsr[4] << 2) | (this.nfsr[3] >>> 14);
        int i13 = (this.nfsr[4] << 1) | (this.nfsr[3] >>> 15);
        i ^= (i3 ^ (((((((i12 ^ i11) ^ i10) ^ i9) ^ i8) ^ i7) ^ i6) ^ i5)) ^ i2;
        i3 = i13 & i11;
        i11 &= i10;
        i12 = (i7 & i6) & i5;
        return (((((((((i13 & i9) & i6) & i2) ^ (((((i ^ i3) ^ (i8 & i7)) ^ (i4 & i2)) ^ (i11 & i9)) ^ i12)) ^ ((i11 & i8) & i7)) ^ ((i3 & i5) & i4)) ^ (((i3 & i10) & i9) & i8)) ^ ((i12 & i4) & i2)) ^ (((((i10 & i9) & i8) & i7) & i6) & i5)) & 65535;
    }
    ...
    private void setKey(byte[] bArr, byte[] bArr2) {
        ...
        while (i < this.nfsr.length) {
            int i3 = i2 + 1;
            this.nfsr[i] = ((this.workingKey[i3] << 8) | (this.workingKey[i2] & 255)) & 65535;
            this.lfsr[i] = ((this.workingIV[i3] << 8) | (this.workingIV[i2] & 255)) & 65535;
            i2 += 2;
            i++;
        }
    }
