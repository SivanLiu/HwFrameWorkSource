...
public class CamelliaEngine implements BlockCipher {
    ...
    private void camelliaF2(int[] iArr, int[] iArr2, int i) {
        ...
        i3 = (SBOX2_0222[(i3 >>> 24) & 255] ^ ((SBOX1_1110[i3 & 255] ^ SBOX4_4404[(i3 >>> 8) & 255]) ^ SBOX3_3033[(i3 >>> 16) & 255])) ^ i2;
        iArr[2] = iArr[2] ^ i3;
        iArr[3] = (rightRotate(i2, 8) ^ i3) ^ iArr[3];
        i2 = iArr[2] ^ iArr2[2 + i];
        i2 = SBOX1_1110[(i2 >>> 24) & 255] ^ ((SBOX4_4404[i2 & 255] ^ SBOX3_3033[(i2 >>> 8) & 255]) ^ SBOX2_0222[(i2 >>> 16) & 255]);
        int i4 = iArr2[3 + i] ^ iArr[3];
        i4 = (SBOX2_0222[(i4 >>> 24) & 255] ^ ((SBOX1_1110[i4 & 255] ^ SBOX4_4404[(i4 >>> 8) & 255]) ^ SBOX3_3033[(i4 >>> 16) & 255])) ^ i2;
        iArr[0] = iArr[0] ^ i4;
        iArr[1] = (i4 ^ rightRotate(i2, 8)) ^ iArr[1];
    }
