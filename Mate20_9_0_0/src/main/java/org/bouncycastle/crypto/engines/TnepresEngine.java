...
public final class TnepresEngine extends SerpentEngineBase {
    ...
    protected int[] makeWorkingKey(byte[] bArr) throws IllegalArgumentException {
        ...
        while (length > 0) {
            int i2 = i + 1;
            obj[i] = Pack.bigEndianToInt(bArr, length);
            length -= 4;
            i = i2;
        }
        if (length == 0) {
            length = i + 1;
            obj[i] = Pack.bigEndianToInt(bArr, 0);
            if (length < 8) {
                obj[length] = 1;
            }
            ...
            for (int i3 = 8; i3 < 16; i3++) {
                int i4 = i3 - 8;
                obj[i3] = SerpentEngineBase.rotateLeft((-1640531527 ^ (((obj[i4] ^ obj[i3 - 5]) ^ obj[i3 - 3]) ^ obj[i3 - 1])) ^ i4, 11);
            }
            System.arraycopy(obj, 8, obj2, 0, 8);
            for (int i5 = 8; i5 < CipherSuite.TLS_RSA_WITH_CAMELLIA_256_CBC_SHA; i5++) {
                obj2[i5] = SerpentEngineBase.rotateLeft(((((obj2[i5 - 8] ^ obj2[i5 - 5]) ^ obj2[i5 - 3]) ^ obj2[i5 - 1]) ^ -1640531527) ^ i5, 11);
            }
