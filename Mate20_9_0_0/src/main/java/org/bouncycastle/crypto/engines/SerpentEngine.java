...
public final class SerpentEngine extends SerpentEngineBase {
    ...
    protected int[] makeWorkingKey(byte[] bArr) throws IllegalArgumentException {
        ...
        while (true) {
            ...
            i2 = i4 + 1;
            iArr[i4] = Pack.littleEndianToInt(bArr, i3);
            i3 = i;
            i4 = i2;
        }
        if (i3 % 4 == 0) {
            ...
            for (i2 = 8; i2 < 16; i2++) {
                int i5 = i2 - 8;
                iArr[i2] = SerpentEngineBase.rotateLeft((-1640531527 ^ (((iArr[i5] ^ iArr[i2 - 5]) ^ iArr[i2 - 3]) ^ iArr[i2 - 1])) ^ i5, 11);
            }
            System.arraycopy(iArr, 8, iArr2, 0, 8);
            for (int i6 = 8; i6 < CipherSuite.TLS_RSA_WITH_CAMELLIA_256_CBC_SHA; i6++) {
                iArr2[i6] = SerpentEngineBase.rotateLeft(((((iArr2[i6 - 8] ^ iArr2[i6 - 5]) ^ iArr2[i6 - 3]) ^ iArr2[i6 - 1]) ^ -1640531527) ^ i6, 11);
            }
            ...
            iArr2[98] = this.X2;
            iArr2[99] = this.X3;
            sb2(iArr2[100], iArr2[ExtensionType.negotiated_ff_dhe_groups], iArr2[102], iArr2[103]);
            iArr2[100] = this.X0;
            iArr2[ExtensionType.negotiated_ff_dhe_groups] = this.X1;
            iArr2[102] = this.X2;
            iArr2[103] = this.X3;
            sb1(iArr2[104], iArr2[CipherSuite.TLS_DH_RSA_WITH_AES_256_CBC_SHA256], iArr2[CipherSuite.TLS_DHE_DSS_WITH_AES_256_CBC_SHA256], iArr2[CipherSuite.TLS_DHE_RSA_WITH_AES_256_CBC_SHA256]);
            iArr2[104] = this.X0;
            iArr2[CipherSuite.TLS_DH_RSA_WITH_AES_256_CBC_SHA256] = this.X1;
            iArr2[CipherSuite.TLS_DHE_DSS_WITH_AES_256_CBC_SHA256] = this.X2;
            iArr2[CipherSuite.TLS_DHE_RSA_WITH_AES_256_CBC_SHA256] = this.X3;
            sb0(iArr2[CipherSuite.TLS_DH_anon_WITH_AES_128_CBC_SHA256], iArr2[CipherSuite.TLS_DH_anon_WITH_AES_256_CBC_SHA256], iArr2[110], iArr2[111]);
            iArr2[CipherSuite.TLS_DH_anon_WITH_AES_128_CBC_SHA256] = this.X0;
            iArr2[CipherSuite.TLS_DH_anon_WITH_AES_256_CBC_SHA256] = this.X1;
            iArr2[110] = this.X2;
            iArr2[111] = this.X3;
            ...
            iArr2[122] = this.X2;
            iArr2[123] = this.X3;
            sb4(iArr2[124], iArr2[125], iArr2[126], iArr2[CertificateBody.profileType]);
            iArr2[124] = this.X0;
            iArr2[125] = this.X1;
            iArr2[126] = this.X2;
            iArr2[CertificateBody.profileType] = this.X3;
