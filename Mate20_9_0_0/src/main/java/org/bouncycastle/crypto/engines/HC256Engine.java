    ...
    private void init() {
        ...
        if (this.key.length != 32 && this.key.length != 16) {
            ...
            if (this.iv.length < 32) {
                ...
                System.arraycopy(this.iv, 0, bArr, this.iv.length, bArr.length - this.iv.length);
                this.iv = bArr;
            }
            this.idx = 0;
            this.cnt = 0;
            ...
            for (i2 = 0; i2 < 32; i2++) {
                i3 = i2 >> 2;
                iArr[i3] = ((this.key[i2] & 255) << (8 * (i2 & 3))) | iArr[i3];
            }
            for (i2 = 0; i2 < 32; i2++) {
                i3 = (i2 >> 2) + 8;
                iArr[i3] = iArr[i3] | ((this.iv[i2] & 255) << ((i2 & 3) * 8));
            }
            while (i < 2560) {
                int i4 = iArr[i - 2];
                i2 = iArr[i - 15];
                iArr[i] = (((((i4 >>> 10) ^ (rotateRight(i4, 17) ^ rotateRight(i4, 19))) + iArr[i - 7]) + ((i2 >>> 3) ^ (rotateRight(i2, 7) ^ rotateRight(i2, 18)))) + iArr[i - 16]) + i;
                i++;
            }
