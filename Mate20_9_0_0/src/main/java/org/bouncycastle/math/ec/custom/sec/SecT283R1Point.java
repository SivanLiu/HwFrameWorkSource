...
public class SecT283R1Point extends AbstractF2m {
        ...
        if (eCFieldElement.isZero()) {
            ...
            if (eCFieldElement4.isZero()) {
                ...
                if (rawXCoord.isZero()) {
                    ...
                    if (eCFieldElement.isZero()) {
                        return new SecT283R1Point(curve, eCFieldElement, curve.getB().sqrt(), this.withCompression);
                    }
                ...
                return new SecT283R1Point(curve, eCFieldElement5, eCFieldElement6, new ECFieldElement[]{zCoord}, this.withCompression);
            }
        }
    }
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElement2.isZero()) {
            return new SecT283R1Point(curve, eCFieldElement2, curve.getB().sqrt(), this.withCompression);
        }
        ...
        return new SecT283R1Point(curve, square2, eCFieldElement.squarePlusProduct(eCFieldElement2, multiply).add(square2).add(square), new ECFieldElement[]{square}, this.withCompression);
    }
