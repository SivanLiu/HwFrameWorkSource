...
public class SecP224R1FieldElement extends ECFieldElement {
    ...
    private static boolean trySqrt(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        iArr2[0] = 1;
        int[] create2 = Nat224.create();
        RP(iArr, create, iArr2, create2, iArr3);
        iArr = Nat224.create();
        int[] create3 = Nat224.create();
        for (int i = 1; i < 96; i++) {
            Nat224.copy(create, iArr);
            Nat224.copy(iArr2, create3);
            RS(create, iArr2, create2, iArr3);
            if (Nat224.isZero(create)) {
                Mod.invert(SecP224R1Field.P, create3, iArr3);
