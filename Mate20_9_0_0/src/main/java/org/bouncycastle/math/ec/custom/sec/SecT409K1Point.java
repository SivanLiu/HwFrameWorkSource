...
public class SecT409K1Point extends AbstractF2m {
        ...
        if (eCFieldElement.isZero()) {
            ...
            if (eCFieldElement4.isZero()) {
                ...
                if (rawXCoord.isZero()) {
                    ...
                    if (eCFieldElement.isZero()) {
                        return new SecT409K1Point(curve, eCFieldElement, curve.getB(), this.withCompression);
                    }
                ...
                return new SecT409K1Point(curve, eCFieldElement5, eCFieldElement6, new ECFieldElement[]{zCoord}, this.withCompression);
            }
        }
    }
    ...
    public ECPoint twice() {
        ...
        return new SecT409K1Point(curve, square2, eCFieldElement.add(add).add(square).multiply(eCFieldElement).add(eCFieldElement3).add(square2).add(multiply), new ECFieldElement[]{multiply}, this.withCompression);
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (rawYCoord.isZero()) {
            ...
            return new SecT409K1Point(curve, eCFieldElement.square().multiply(rawXCoord), eCFieldElement.add(rawYCoord).square().multiplyPlusProduct(zCoord, eCFieldElement2, eCFieldElement.multiply(rawYCoord).multiply(square2)), new ECFieldElement[]{eCFieldElement.multiply(rawYCoord).multiply(square2)}, this.withCompression);
        }
    }
}
