...
public class SecT113R2Point extends AbstractF2m {
        ...
        if (eCFieldElement.isZero()) {
            ...
            if (eCFieldElement4.isZero()) {
                ...
                if (rawXCoord.isZero()) {
                    ...
                    if (eCFieldElement.isZero()) {
                        return new SecT113R2Point(curve, eCFieldElement, curve.getB().sqrt(), this.withCompression);
                    }
                ...
                return new SecT113R2Point(curve, eCFieldElement5, eCFieldElement6, new ECFieldElement[]{zCoord}, this.withCompression);
            }
        }
    }
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElement2.isZero()) {
            return new SecT113R2Point(curve, eCFieldElement2, curve.getB().sqrt(), this.withCompression);
        }
        ...
        return new SecT113R2Point(curve, a, eCFieldElement.squarePlusProduct(eCFieldElement2, multiply).add(a).add(square), new ECFieldElement[]{square}, this.withCompression);
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (rawYCoord.isZero()) {
            ...
            return new SecT113R2Point(curve, eCFieldElement.square().multiply(rawXCoord), eCFieldElement.add(rawYCoord).square().multiplyPlusProduct(zCoord, eCFieldElement2, eCFieldElement.multiply(rawYCoord).multiply(square2)), new ECFieldElement[]{eCFieldElement.multiply(rawYCoord).multiply(square2)}, this.withCompression);
        }
    }
}
