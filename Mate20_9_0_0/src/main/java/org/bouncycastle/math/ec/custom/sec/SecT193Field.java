...
public class SecT193Field {
    ...
    public static void reduce(long[] jArr, long[] jArr2) {
        ...
        long j7 = jArr[6];
        j5 ^= j7 >>> 50;
        j4 = (j4 ^ ((j7 >>> M01) ^ (j7 << 14))) ^ (j6 >>> 50);
        j ^= j5 << 63;
        j2 = (j2 ^ (j6 << 63)) ^ ((j5 >>> M01) ^ (j5 << 14));
        j3 = ((j3 ^ (j7 << 63)) ^ ((j6 >>> M01) ^ (j6 << 14))) ^ (j5 >>> 50);
        j5 = j4 >>> M01;
        jArr2[0] = (j ^ j5) ^ (j5 << 15);
        jArr2[1] = (j5 >>> 49) ^ j2;
        jArr2[2] = j3;
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        long j2 = (unshuffle3 & BodyPartID.bodyIdMax) ^ (jArr[3] << 32);
        long j3 = unshuffle3 >>> 32;
        jArr2[0] = j ^ (unshuffle << 8);
        jArr2[1] = ((j2 ^ (j3 << 8)) ^ (unshuffle >>> 56)) ^ (unshuffle << 33);
        jArr2[2] = (unshuffle >>> 31) ^ ((j3 >>> 56) ^ (j3 << 33));
        jArr2[3] = j3 >>> 31;
    }
