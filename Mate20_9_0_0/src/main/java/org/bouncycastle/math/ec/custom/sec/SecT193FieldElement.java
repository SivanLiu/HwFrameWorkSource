...
public class SecT193FieldElement extends ECFieldElement {
    ...
    public SecT193FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.bitLength() > CipherSuite.TLS_DH_DSS_WITH_CAMELLIA_256_CBC_SHA256) {
    ...
    public ECFieldElement multiplyPlusProduct(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement eCFieldElement3) {
        ...
        jArr2 = Nat256.create64();
        SecT193Field.reduce(createExt64, jArr2);
        return new SecT193FieldElement(jArr2);
    }
