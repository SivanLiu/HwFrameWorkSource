...
public abstract class X448 {
    ...
    private static final int[] S_x = new int[]{268435454, 268435455, 268435455, 268435455, 268435455, 268435455, 268435455, 268435455, 268435454, 268435455, 268435455, 268435455, 268435455, 268435455, 268435455, 268435455};
    ...
    public static void scalarMult(byte[] bArr, int i, byte[] bArr2, int i2, byte[] bArr3, int i3) {
        ...
        while (true) {
            ...
            i6 ^= i7;
            X448Field.cswap(i6, create2, create4);
            X448Field.cswap(i6, create3, create5);
            if (i5 < 2) {
                break;
            }
            i6 = i7;
    ...
    public static void scalarMultBase(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int i6 = 2;
        while (true) {
            X448Field.copy(precompBase, i4, create, 0);
            i4 += 16;
            int i7 = (iArr[i6 >>> 5] >>> (i6 & 31)) & 1;
            i5 ^= i7;
            X448Field.cswap(i5, create2, create4);
            X448Field.cswap(i5, create3, create5);
