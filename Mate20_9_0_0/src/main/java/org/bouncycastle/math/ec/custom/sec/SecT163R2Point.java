...
public class SecT163R2Point extends AbstractF2m {
            ...
            if (eCFieldElement4.isZero()) {
                ...
                if (rawXCoord.isZero()) {
                    ...
                    if (eCFieldElement5.isZero()) {
                        return new SecT163R2Point(curve, eCFieldElement5, curve.getB().sqrt(), this.withCompression);
                    }
                    ...
                    if (eCFieldElement.isZero()) {
                        return new SecT163R2Point(curve, eCFieldElement, curve.getB().sqrt(), this.withCompression);
                    }
                ...
                return new SecT163R2Point(curve, eCFieldElement5, eCFieldElement6, new ECFieldElement[]{zCoord}, this.withCompression);
            }
        }
    }
    ...
    public ECPoint twice() {
        ...
        eCFieldElement2 = eCFieldElement2.square().add(multiply).add(square);
        if (eCFieldElement2.isZero()) {
            return new SecT163R2Point(curve, eCFieldElement2, curve.getB().sqrt(), this.withCompression);
        }
        ...
        return new SecT163R2Point(curve, square2, eCFieldElement.squarePlusProduct(eCFieldElement2, multiply).add(square2).add(square), new ECFieldElement[]{square}, this.withCompression);
    }
