...
public class SecP521R1Point extends AbstractFp {
    ...
    public ECPoint twice() {
        ...
        secP521R1FieldElement2 = new SecP521R1FieldElement(create2);
        SecP521R1Field.twice(secP521R1FieldElement.x, secP521R1FieldElement2.x);
        if (!isOne) {
            SecP521R1Field.multiply(secP521R1FieldElement2.x, secP521R1FieldElement3.x, secP521R1FieldElement2.x);
        }
        return new SecP521R1Point(curve, secP521R1FieldElement4, secP521R1FieldElement5, new ECFieldElement[]{secP521R1FieldElement2}, this.withCompression);
    }
