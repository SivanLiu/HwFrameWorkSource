...
public class SecT163R1Point extends AbstractF2m {
            ...
            if (eCFieldElement4.isZero()) {
                ...
                if (rawXCoord.isZero()) {
                    ...
                    if (eCFieldElement5.isZero()) {
                        return new SecT163R1Point(curve, eCFieldElement5, curve.getB().sqrt(), this.withCompression);
                    }
                    ...
                    if (eCFieldElement.isZero()) {
                        return new SecT163R1Point(curve, eCFieldElement, curve.getB().sqrt(), this.withCompression);
                    }
                ...
                return new SecT163R1Point(curve, eCFieldElement5, eCFieldElement6, new ECFieldElement[]{zCoord}, this.withCompression);
            }
        }
    }
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElement2.isZero()) {
            return new SecT163R1Point(curve, eCFieldElement2, curve.getB().sqrt(), this.withCompression);
        }
        ...
        return new SecT163R1Point(curve, a, eCFieldElement.squarePlusProduct(eCFieldElement2, multiply).add(a).add(square), new ECFieldElement[]{square}, this.withCompression);
    }
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        if (rawYCoord.isZero()) {
            ...
            return new SecT163R1Point(curve, eCFieldElement.square().multiply(rawXCoord), eCFieldElement.add(rawYCoord).square().multiplyPlusProduct(zCoord, eCFieldElement2, eCFieldElement.multiply(rawYCoord).multiply(square2)), new ECFieldElement[]{eCFieldElement.multiply(rawYCoord).multiply(square2)}, this.withCompression);
        }
    }
}
