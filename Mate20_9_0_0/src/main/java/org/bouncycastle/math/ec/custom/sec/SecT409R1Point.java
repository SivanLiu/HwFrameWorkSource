...
public class SecT409R1Point extends AbstractF2m {
        ...
        if (eCFieldElement.isZero()) {
            ...
            if (eCFieldElement4.isZero()) {
                ...
                if (rawXCoord.isZero()) {
                    ...
                    if (eCFieldElement.isZero()) {
                        return new SecT409R1Point(curve, eCFieldElement, curve.getB().sqrt(), this.withCompression);
                    }
                ...
                return new SecT409R1Point(curve, eCFieldElement5, eCFieldElement6, new ECFieldElement[]{zCoord}, this.withCompression);
            }
        }
    }
    ...
    public ECPoint twice() {
        ...
        return new SecT409R1Point(curve, square2, eCFieldElement.squarePlusProduct(eCFieldElement2, multiply).add(square2).add(square), new ECFieldElement[]{square}, this.withCompression);
    }
