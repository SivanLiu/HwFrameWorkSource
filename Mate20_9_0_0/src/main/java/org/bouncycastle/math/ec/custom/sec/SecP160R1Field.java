...
public class SecP160R1Field {
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        j = 0 + (((((long) iArr[0]) & 4294967295L) + j) + (j << 31));
        iArr3[0] = (int) j;
        long j6 = j5;
        j = (j >>> 32) + (((((long) iArr[1]) & 4294967295L) + j2) + (j2 << 31));
        iArr3[1] = (int) j;
        j = (j >>> 32) + (((((long) iArr[2]) & 4294967295L) + j3) + (j3 << 31));
        iArr3[2] = (int) j;
        j = (j >>> 32) + (((((long) iArr[3]) & 4294967295L) + j4) + (j4 << 31));
        iArr3[3] = (int) j;
        j = (j >>> 32) + (((4294967295L & ((long) iArr[4])) + j6) + (j6 << 31));
        iArr3[4] = (int) j;
        reduce32((int) (j >>> 32), iArr3);
    }
