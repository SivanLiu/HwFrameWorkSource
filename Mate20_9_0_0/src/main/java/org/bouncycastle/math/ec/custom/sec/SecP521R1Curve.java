...
public class SecP521R1Curve extends AbstractFp {
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        while (i3 < i2) {
            ...
            Nat.copy(17, ((SecP521R1FieldElement) eCPoint.getRawXCoord()).x, 0, iArr, i4);
            i4 += 17;
            Nat.copy(17, ((SecP521R1FieldElement) eCPoint.getRawYCoord()).x, 0, iArr, i4);
            i4 += 17;
            i3++;
        }
            ...
            public ECPoint lookup(int i) {
                ...
                while (i2 < i2) {
                    ...
                    for (int i5 = 0; i5 < 17; i5++) {
                        ...
                        create2[i5] = create2[i5] ^ (iArr[(i3 + 17) + i5] & i4);
                    }
                    i3 += 34;
                    i2++;
                }
