...
public class Curve25519Field {
    ...
    static final int[] P = new int[]{-19, -1, -1, -1, -1, -1, -1, P7};
    ...
    private static int addPExtTo(int[] iArr) {
        ...
        j >>= 32;
        if (j != 0) {
            j = (long) Nat.incAt(8, iArr, 1);
        }
        j += (((long) iArr[8]) & 4294967295L) - 19;
        iArr[8] = (int) j;
        j >>= 32;
        if (j != 0) {
            j = (long) Nat.decAt(15, iArr, 9);
        }
        j += (((long) iArr[15]) & 4294967295L) + (4294967295L & ((long) (PExt[15] + 1)));
        iArr[15] = (int) j;
        return (int) (j >> 32);
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        int i2 = iArr2[7];
        iArr2[7] = (i2 & P7) + Nat.addWordTo(7, (mulByWordAddTo + ((i2 >>> 31) - (i >>> 31))) * 19, iArr2);
        if (Nat256.gte(iArr2, P)) {
            subPFrom(iArr2);
        }
    }
    ...
    private static int subPExtFrom(int[] iArr) {
        ...
        j >>= 32;
        if (j != 0) {
            j = (long) Nat.decAt(8, iArr, 1);
        }
        j += (((long) iArr[8]) & 4294967295L) + 19;
        iArr[8] = (int) j;
        j >>= 32;
        if (j != 0) {
            j = (long) Nat.incAt(15, iArr, 9);
        }
        j += (((long) iArr[15]) & 4294967295L) - (4294967295L & ((long) (PExt[15] + 1)));
        iArr[15] = (int) j;
        return (int) (j >> 32);
