...
public class SecT571R1Point extends AbstractF2m {
        ...
        if (secT571FieldElement.isZero()) {
            ...
            if (Nat576.isZero64(create644)) {
                ...
                if (secT571FieldElement2.isZero()) {
                    ...
                    eCFieldElement = (SecT571FieldElement) divide.square().add(divide).add(secT571FieldElement).addOne();
                    ...
                    if (secT571FieldElement7.isZero()) {
                        return new SecT571R1Point(curve, secT571FieldElement7, SecT571R1Curve.SecT571R1_B_SQRT, this.withCompression);
                    }
                ...
                return new SecT571R1Point(curve, eCFieldElement, eCFieldElement2, new ECFieldElement[]{secT571FieldElement}, this.withCompression);
            }
        }
    }
    ...
    public ECPoint twice() {
        ...
        ECFieldElement secT571FieldElement4 = new SecT571FieldElement(create64);
    ...
    public ECPoint twicePlus(ECPoint eCPoint) {
        ...
        secT571FieldElement3 = (SecT571FieldElement) this.y;
        SecT571FieldElement secT571FieldElement4 = (SecT571FieldElement) this.zs[0];
        SecT571FieldElement secT571FieldElement5 = (SecT571FieldElement) eCPoint.getRawYCoord();
        long[] create64 = Nat576.create64();
        long[] create642 = Nat576.create64();
        ...
        SecT571Field.square(secT571FieldElement3.x, create642);
        SecT571Field.square(secT571FieldElement4.x, create643);
        SecT571Field.multiply(secT571FieldElement3.x, secT571FieldElement4.x, create644);
        SecT571Field.addBothTo(create643, create642, create644);
        long[] precompMultiplicand = SecT571Field.precompMultiplicand(create643);
        SecT571Field.multiplyPrecomp(secT571FieldElement5.x, precompMultiplicand, create643);
