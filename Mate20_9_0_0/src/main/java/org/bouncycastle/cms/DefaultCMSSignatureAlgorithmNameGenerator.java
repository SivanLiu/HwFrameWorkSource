...
public class DefaultCMSSignatureAlgorithmNameGenerator implements CMSSignatureAlgorithmNameGenerator {
    ...
    public String getSignatureName(AlgorithmIdentifier algorithmIdentifier, AlgorithmIdentifier algorithmIdentifier2) {
        ...
        if (digestAlgName.equals(algorithmIdentifier2.getAlgorithm().getId())) {
            ...
            stringBuilder.append(getDigestAlgName(algorithmIdentifier.getAlgorithm()));
            stringBuilder.append("with");
            stringBuilder.append(getEncryptionAlgName(algorithmIdentifier2.getAlgorithm()));
            return stringBuilder.toString();
        }
        StringBuilder stringBuilder2 = new StringBuilder();
        stringBuilder2.append(digestAlgName);
        stringBuilder2.append("with");
        stringBuilder2.append(getEncryptionAlgName(algorithmIdentifier2.getAlgorithm()));
