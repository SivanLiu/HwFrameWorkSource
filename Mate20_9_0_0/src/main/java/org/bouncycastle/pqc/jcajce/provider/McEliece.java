...
public class McEliece {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            stringBuilder.append(PQCObjectIdentifiers.mcElieceCca2);
            configurableProvider.addAlgorithm(stringBuilder.toString(), "org.bouncycastle.pqc.jcajce.provider.mceliece.McElieceCCA2KeyFactorySpi");
            stringBuilder = new StringBuilder();
            stringBuilder.append("KeyFactory.");
            stringBuilder.append(PQCObjectIdentifiers.mcEliece);
            configurableProvider.addAlgorithm(stringBuilder.toString(), "org.bouncycastle.pqc.jcajce.provider.mceliece.McElieceKeyFactorySpi");
