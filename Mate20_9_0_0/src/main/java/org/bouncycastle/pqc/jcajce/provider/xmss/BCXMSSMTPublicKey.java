...
import org.bouncycastle.pqc.crypto.xmss.XMSSMTPublicKeyParameters.Builder;
...
public class BCXMSSMTPublicKey implements PublicKey, XMSSMTKey {
    ...
    public BCXMSSMTPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) throws IOException {
        ...
        this.keyParams = new Builder(new XMSSMTParameters(instance.getHeight(), instance.getLayers(), DigestUtil.getDigest(this.treeDigest))).withPublicSeed(instance2.getPublicSeed()).withRoot(instance2.getRoot()).build();
    }
