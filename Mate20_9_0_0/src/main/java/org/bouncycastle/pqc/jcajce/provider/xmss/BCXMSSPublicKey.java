...
import org.bouncycastle.pqc.crypto.xmss.XMSSPublicKeyParameters.Builder;
...
public class BCXMSSPublicKey implements PublicKey, XMSSKey {
    ...
    public BCXMSSPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) throws IOException {
        ...
        this.keyParams = new Builder(new XMSSParameters(instance.getHeight(), DigestUtil.getDigest(this.treeDigest))).withPublicSeed(instance2.getPublicSeed()).withRoot(instance2.getRoot()).build();
    }
