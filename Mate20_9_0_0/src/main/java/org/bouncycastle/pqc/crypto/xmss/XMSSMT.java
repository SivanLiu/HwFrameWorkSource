...
public final class XMSSMT {
    ...
    public XMSSMT(XMSSMTParameters xMSSMTParameters, SecureRandom secureRandom) {
        if (xMSSMTParameters != null) {
            ...
            this.privateKey = new Builder(xMSSMTParameters).build();
    ...
    public void importState(byte[] bArr, byte[] bArr2) {
        if (bArr == null) {
            ...
            XMSSMTPrivateKeyParameters build = new Builder(this.params).withPrivateKey(bArr, this.xmssParams).build();
    ...
    public byte[] sign(byte[] bArr) {
        if (bArr != null) {
            ...
            bArr = xMSSMTSigner.generateSignature(bArr);
