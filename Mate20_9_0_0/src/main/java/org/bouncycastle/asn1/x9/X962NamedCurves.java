...
public class X962NamedCurves {
    static X9ECParametersHolder c2pnb163v1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            ECCurve f2m = new F2m((int) CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384, 1, 2, 8, new BigInteger("072546B5435234A422E0789675F432C89435DE5242", 16), new BigInteger("00C9517D06D5240D3CFF38C74B20B6CD4D6F9DD4D9", 16), bigInteger, valueOf);
    ...
    static X9ECParametersHolder c2pnb163v2 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(2);
            ECCurve f2m = new F2m((int) CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384, 1, 2, 8, new BigInteger("0108B39E77C4B108BED981ED0E890E117C511CF072", 16), new BigInteger("0667ACEB38AF4E488C407433FFAE4F1C811638DF20", 16), bigInteger, valueOf);
            return new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("030024266E4EB5106D0A964D92C4860E2671DB9B6CC5")), bigInteger, valueOf, null);
        }
    };
    static X9ECParametersHolder c2pnb163v3 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(2);
            ECCurve f2m = new F2m((int) CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384, 1, 2, 8, new BigInteger("07A526C63D3E25A256A007699F5447E32AE456B50E", 16), new BigInteger("03F7061798EB99E238FD6F1BF95B48FEEB4854252B", 16), bigInteger, valueOf);
            return new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("0202F9F87B7C574D0BDECF8A22E6524775F98CDEBDCB")), bigInteger, valueOf, null);
        }
    };
    static X9ECParametersHolder c2pnb176w1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            ECCurve f2m = new F2m((int) CipherSuite.TLS_PSK_WITH_NULL_SHA256, 1, 2, 43, new BigInteger("00E4E6DB2995065C407D9D39B8D0967B96704BA8E9C90B", 16), new BigInteger("005DDA470ABE6414DE8EC133AE28E9BBD7FCEC0AE0FFF2", 16), bigInteger, valueOf);
            return new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("038D16C2866798B600F9F08BB4A8E860F3298CE04A5798")), bigInteger, valueOf, null);
        }
    };
    static X9ECParametersHolder c2pnb208w1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("0289FDFBE4ABE193DF9559ECF07AC0CE78554E2784EB8C1ED1A57A")), bigInteger, valueOf, null);
        }
    };
    static X9ECParametersHolder c2pnb272w1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("026108BABB2CEEBCF787058A056CBE0CFE622D7723A289E08A07AE13EF0D10D171DD8D")), bigInteger, valueOf, null);
        }
    };
    static X9ECParametersHolder c2pnb304w1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("02197B07845E9BE2D96ADB0F5F3C7F2CFFBD7A3EB8B6FEC35C7FD67F26DDF6285A644F740A2614")), bigInteger, valueOf, null);
        }
    };
    static X9ECParametersHolder c2pnb368w1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("021085E2755381DCCCE3C1557AFA10C2F0C0C2825646C5B34A394CBCFA8BC16B22E7E789E927BE216F02E1FB136A5F")), bigInteger, valueOf, null);
        }
    };
    static X9ECParametersHolder c2tnb191v1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(2);
            ECCurve f2m = new F2m((int) CipherSuite.TLS_DH_anon_WITH_CAMELLIA_128_CBC_SHA256, 9, new BigInteger("2866537B676752636A68F56554E12640276B649EF7526267", 16), new BigInteger("2E45EF571F00786F67B0081B9495A3D95462F5DE0AA185EC", 16), bigInteger, valueOf);
    ...
    static X9ECParametersHolder c2tnb191v2 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            ECCurve f2m = new F2m((int) CipherSuite.TLS_DH_anon_WITH_CAMELLIA_128_CBC_SHA256, 9, new BigInteger("401028774D7777C7B7666D1366EA432071274F89FF01E718", 16), new BigInteger("0620048D28BCBD03B6249C99182B7C8CD19700C362C46A01", 16), bigInteger, valueOf);
            return new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("023809B2B7CC1B28CC5A87926AAD83FD28789E81E2C9E3BF10")), bigInteger, valueOf, null);
        }
    };
    static X9ECParametersHolder c2tnb191v3 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            ECCurve f2m = new F2m((int) CipherSuite.TLS_DH_anon_WITH_CAMELLIA_128_CBC_SHA256, 9, new BigInteger("6C01074756099122221056911C77D77E77A777E7E7E77FCB", 16), new BigInteger("71FE1AF926CF847989EFEF8DB459F66394D90F32AD3F15E8", 16), bigInteger, valueOf);
            return new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("03375D4CE24FDE434489DE8746E71786015009E66E38A926DD")), bigInteger, valueOf, null);
        }
    };
    static X9ECParametersHolder c2tnb239v1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("0257927098FA932E7C0A96D3FD5B706EF7E5F5C156E16B7E7C86038552E91D")), bigInteger, valueOf, null);
        }
    };
    static X9ECParametersHolder c2tnb239v2 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("0228F9D04E900069C8DC47A08534FE76D2B900B7D7EF31F5709F200C4CA205")), bigInteger, valueOf, null);
        }
    };
    static X9ECParametersHolder c2tnb239v3 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("0370F6E9D04D289C4E89913CE3530BFDE903977D42B146D539BF1BDE4E9C92")), bigInteger, valueOf, null);
        }
    };
    static X9ECParametersHolder c2tnb359v1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("033C258EF3047767E7EDE0F1FDAA79DAEE3841366A132E163ACED4ED2401DF9C6BDCDE98E8E707C07A2239B1B097")), bigInteger, valueOf, null);
        }
    };
    static X9ECParametersHolder c2tnb431r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            return new X9ECParameters(f2m, new X9ECPoint(f2m, Hex.decode("02120FC05D3C67A99DE161D2F4092622FECA701BE4F50F4758714E8A87BBF2A658EF8C21E7C5EFE965361F6C2999C0C247B0DBD70CE6B7")), bigInteger, valueOf, null);
        }
    };
