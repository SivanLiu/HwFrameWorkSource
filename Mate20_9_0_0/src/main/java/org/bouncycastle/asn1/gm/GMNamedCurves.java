...
public class GMNamedCurves {
    ...
    static X9ECParametersHolder sm2p256v1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            ECCurve access$100 = GMNamedCurves.configureCurve(new Fp(access$000, access$0002, access$0003, access$0004, valueOf));
            return new X9ECParameters(access$100, new X9ECPoint(access$100, Hex.decode("0432C4AE2C1F1981195F9904466A39C9948FE30BBFF2660BE1715A4589334C74C7BC3736A2F4F6779C59BDCEE36B692153D0A9877CC62A474002DF32E52139F0A0")), access$0004, valueOf, null);
        }
    };
    static X9ECParametersHolder wapip192v1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(1);
            ECCurve access$100 = GMNamedCurves.configureCurve(new Fp(access$000, access$0002, access$0003, access$0004, valueOf));
            return new X9ECParameters(access$100, new X9ECPoint(access$100, Hex.decode("044AD5F7048DE709AD51236DE65E4D4B482C836DC6E410664002BB3A02D4AAADACAE24817A4CA3A1B014B5270432DB27D2")), access$0004, valueOf, null);
        }
    };
