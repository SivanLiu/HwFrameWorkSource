...
public class SECNamedCurves {
    ...
    static X9ECParametersHolder secp112r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            ECCurve access$100 = SECNamedCurves.configureCurve(new Fp(access$000, access$0002, access$0003, access$0004, valueOf));
    ...
    static X9ECParametersHolder secp192k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf2 = BigInteger.valueOf(1);
            ECCurve access$200 = SECNamedCurves.configureCurveGLV(new Fp(access$000, bigInteger, valueOf, access$0002, valueOf2), new GLVTypeBParameters(new BigInteger("bb85691939b869c1d087f601554b96b80cb4f55b35f433c2", 16), new BigInteger("3d84f26c12238d7b4f3d516613c1759033b1a5800175d0b1", 16), new BigInteger[]{new BigInteger("71169be7330b3038edb025f1", 16), new BigInteger("-b3fb3400dec5c4adceb8655c", 16)}, new BigInteger[]{new BigInteger("12511cfe811d0f4e6bc688b4d", 16), new BigInteger("71169be7330b3038edb025f1", 16)}, new BigInteger("71169be7330b3038edb025f1d0f9", 16), new BigInteger("b3fb3400dec5c4adceb8655d4c94", 16), 208));
            return new X9ECParameters(access$200, new X9ECPoint(access$200, Hex.decode("04DB4FF10EC057E9AE26B07D0280B7F4341DA5D1B1EAE06C7D9B2F2F6D9C5628A7844163D015BE86344082AA88D95E2F9D")), access$0002, valueOf2, null);
        }
    };
    ...
    static X9ECParametersHolder secp224k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf2 = BigInteger.valueOf(1);
            ECCurve access$200 = SECNamedCurves.configureCurveGLV(new Fp(access$000, bigInteger, valueOf, access$0002, valueOf2), new GLVTypeBParameters(new BigInteger("fe0e87005b4e83761908c5131d552a850b3f58b749c37cf5b84d6768", 16), new BigInteger("60dcd2104c4cbc0be6eeefc2bdd610739ec34e317f9b33046c9e4788", 16), new BigInteger[]{new BigInteger("6b8cf07d4ca75c88957d9d670591", 16), new BigInteger("-b8adf1378a6eb73409fa6c9c637d", 16)}, new BigInteger[]{new BigInteger("1243ae1b4d71613bc9f780a03690e", 16), new BigInteger("6b8cf07d4ca75c88957d9d670591", 16)}, new BigInteger("6b8cf07d4ca75c88957d9d67059037a4", 16), new BigInteger("b8adf1378a6eb73409fa6c9c637ba7f5", 16), 240));
            return new X9ECParameters(access$200, new X9ECPoint(access$200, Hex.decode("04A1455B334DF099DF30FC28A169A467E9E47075A90F7E650EB6B7A45C7E089FED7FBA344282CAFBD6F7E319F7C0B0BD59E2CA4BDB556D61A5")), access$0002, valueOf2, null);
        }
    };
    ...
    static X9ECParametersHolder secp256k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf2 = BigInteger.valueOf(1);
            ECCurve access$200 = SECNamedCurves.configureCurveGLV(new Fp(access$000, bigInteger, valueOf, access$0002, valueOf2), new GLVTypeBParameters(new BigInteger("7ae96a2b657c07106e64479eac3434e99cf0497512f58995c1396c28719501ee", 16), new BigInteger("5363ad4cc05c30e0a5261c028812645a122e22ea20816678df02967c1b23bd72", 16), new BigInteger[]{new BigInteger("3086d221a7d46bcde86c90e49284eb15", 16), new BigInteger("-e4437ed6010e88286f547fa90abfe4c3", 16)}, new BigInteger[]{new BigInteger("114ca50f7a8e2f3f657c1108d9d44cfd8", 16), new BigInteger("3086d221a7d46bcde86c90e49284eb15", 16)}, new BigInteger("3086d221a7d46bcde86c90e49284eb153dab", 16), new BigInteger("e4437ed6010e88286f547fa90abfe4c42212", 16), 272));
            return new X9ECParameters(access$200, new X9ECPoint(access$200, Hex.decode("0479BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798483ADA7726A3C4655DA4FBFC0E1108A8FD17B448A68554199C47D08FFB10D4B8")), access$0002, valueOf2, null);
        }
    };
    ...
    static X9ECParametersHolder sect113r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            ECCurve access$100 = SECNamedCurves.configureCurve(new F2m(113, 9, access$000, access$0002, access$0003, valueOf));
    ...
    static X9ECParametersHolder sect131r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(2);
            ECCurve access$100 = SECNamedCurves.configureCurve(new F2m(131, 2, 3, 8, access$000, access$0002, access$0003, valueOf));
    ...
    static X9ECParametersHolder sect163k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            ECCurve access$100 = SECNamedCurves.configureCurve(new F2m((int) CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384, 3, 6, 7, valueOf, valueOf2, access$000, valueOf3));
            return new X9ECParameters(access$100, new X9ECPoint(access$100, Hex.decode("0402FE13C0537BBC11ACAA07D793DE4E6D5E5C94EEE80289070FB05D38FF58321F2E800536D538CCDAA3D9")), access$000, valueOf3, null);
        }
    };
    static X9ECParametersHolder sect163r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(2);
            ECCurve access$100 = SECNamedCurves.configureCurve(new F2m((int) CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384, 3, 6, 7, access$000, access$0002, access$0003, valueOf));
    ...
    static X9ECParametersHolder sect163r2 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            ECCurve access$100 = SECNamedCurves.configureCurve(new F2m((int) CipherSuite.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384, 3, 6, 7, valueOf, access$000, access$0002, valueOf2));
    ...
    static X9ECParametersHolder sect193r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(2);
            ECCurve access$100 = SECNamedCurves.configureCurve(new F2m((int) CipherSuite.TLS_DH_DSS_WITH_CAMELLIA_256_CBC_SHA256, 15, access$000, access$0002, access$0003, valueOf));
    ...
    static X9ECParametersHolder sect233k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            ECCurve access$100 = SECNamedCurves.configureCurve(new F2m(233, 74, bigInteger, valueOf, access$000, valueOf2));
            return new X9ECParameters(access$100, new X9ECPoint(access$100, Hex.decode("04017232BA853A7E731AF129F22FF4149563A419C26BF50A4C9D6EEFAD612601DB537DECE819B7F70F555A67C427A8CD9BF18AEB9B56E0C11056FAE6A3")), access$000, valueOf2, null);
        }
    };
    static X9ECParametersHolder sect233r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf2 = BigInteger.valueOf(2);
            ECCurve access$100 = SECNamedCurves.configureCurve(new F2m(233, 74, valueOf, access$000, access$0002, valueOf2));
    ...
    static X9ECParametersHolder sect239k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf2 = BigInteger.valueOf(4);
            ECCurve access$100 = SECNamedCurves.configureCurve(new F2m(239, (int) CipherSuite.TLS_DHE_RSA_WITH_AES_128_GCM_SHA256, bigInteger, valueOf, access$000, valueOf2));
            return new X9ECParameters(access$100, new X9ECPoint(access$100, Hex.decode("0429A0B6A887A983E9730988A68727A8B2D126C44CC2CC7B2A6555193035DC76310804F12E549BDB011C103089E73510ACB275FC312A5DC6B76553F0CA")), access$000, valueOf2, null);
        }
    };
    static X9ECParametersHolder sect283k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf2 = BigInteger.valueOf(4);
            ECCurve access$100 = SECNamedCurves.configureCurve(new F2m(283, 5, 7, 12, bigInteger, valueOf, access$000, valueOf2));
            return new X9ECParameters(access$100, new X9ECPoint(access$100, Hex.decode("040503213F78CA44883F1A3B8162F188E553CD265F23C1567A16876913B0C2AC245849283601CCDA380F1C9E318D90F95D07E5426FE87E45C0E8184698E45962364E34116177DD2259")), access$000, valueOf2, null);
        }
    };
    static X9ECParametersHolder sect283r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf2 = BigInteger.valueOf(2);
            ECCurve access$100 = SECNamedCurves.configureCurve(new F2m(283, 5, 7, 12, valueOf, access$000, access$0002, valueOf2));
    ...
    static X9ECParametersHolder sect409k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf2 = BigInteger.valueOf(4);
            ECCurve access$100 = SECNamedCurves.configureCurve(new F2m(409, 87, bigInteger, valueOf, access$000, valueOf2));
    ...
    static X9ECParametersHolder sect409r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf2 = BigInteger.valueOf(2);
            ECCurve access$100 = SECNamedCurves.configureCurve(new F2m(409, 87, valueOf, access$000, access$0002, valueOf2));
    ...
    static X9ECParametersHolder sect571k1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf2 = BigInteger.valueOf(4);
            ECCurve access$100 = SECNamedCurves.configureCurve(new F2m(571, 2, 5, 10, bigInteger, valueOf, access$000, valueOf2));
    ...
    static X9ECParametersHolder sect571r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger valueOf2 = BigInteger.valueOf(2);
            ECCurve access$100 = SECNamedCurves.configureCurve(new F2m(571, 2, 5, 10, valueOf, access$000, access$0002, valueOf2));
