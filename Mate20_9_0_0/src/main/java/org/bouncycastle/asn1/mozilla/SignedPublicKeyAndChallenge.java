...
public class SignedPublicKeyAndChallenge extends ASN1Object {
    ...
    public static SignedPublicKeyAndChallenge getInstance(Object obj) {
        return obj instanceof SignedPublicKeyAndChallenge ? (SignedPublicKeyAndChallenge) obj : obj != null ? new SignedPublicKeyAndChallenge(ASN1Sequence.getInstance(obj)) : null;
    }
