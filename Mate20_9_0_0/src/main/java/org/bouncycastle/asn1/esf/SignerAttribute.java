...
public class SignerAttribute extends ASN1Object {
    ...
    private SignerAttribute(ASN1Sequence aSN1Sequence) {
        ...
        while (objects.hasMoreElements()) {
            ...
            if (instance.getTagNo() == 0) {
                ...
                stringBuilder.append("illegal tag: ");
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        for (int i = 0; i != this.values.length; i++) {
            aSN1EncodableVector.add(this.values[i] instanceof Attribute[] ? new DERTaggedObject(0, new DERSequence((Attribute[]) this.values[i])) : new DERTaggedObject(1, (AttributeCertificate) this.values[i]));
        }
