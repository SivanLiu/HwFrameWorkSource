...
public class TeleTrusTNamedCurves {
    static X9ECParametersHolder brainpoolP160r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            ECCurve access$000 = TeleTrusTNamedCurves.configureCurve(new Fp(new BigInteger("E95E4A5F737059DC60DFC7AD95B3D8139515620F", 16), new BigInteger("340E7BE2A280EB74E2BE61BADA745D97E8F7C300", 16), new BigInteger("1E589A8595423412134FAA2DBDEC95C8D8675E58", 16), bigInteger, bigInteger2));
    ...
    static X9ECParametersHolder brainpoolP160t1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            BigInteger bigInteger = new BigInteger("E95E4A5F737059DC60DF5991D45029409E60FC09", 16);
            BigInteger bigInteger2 = new BigInteger("01", 16);
            ECCurve access$000 = TeleTrusTNamedCurves.configureCurve(new Fp(new BigInteger("E95E4A5F737059DC60DFC7AD95B3D8139515620F", 16), new BigInteger("E95E4A5F737059DC60DFC7AD95B3D8139515620C", 16), new BigInteger("7A556B6DAE535B7B51ED2C4D7DAA7A0B5C55F380", 16), bigInteger, bigInteger2));
    ...
    static X9ECParametersHolder brainpoolP192r1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            ...
            BigInteger bigInteger2 = new BigInteger("01", 16);
            ECCurve access$000 = TeleTrusTNamedCurves.configureCurve(new Fp(new BigInteger("C302F41D932A36CDA7A3463093D18DB78FCE476DE1A86297", 16), new BigInteger("6A91174076B1E0E19C39C031FE8685C1CAE040E5C69A28EF", 16), new BigInteger("469A28EF7C28CCA3DC721D044F4496BCCA7EF4146FBF25C9", 16), bigInteger, bigInteger2));
    ...
    static X9ECParametersHolder brainpoolP192t1 = new X9ECParametersHolder() {
        protected X9ECParameters createParameters() {
            BigInteger bigInteger = new BigInteger("C302F41D932A36CDA7A3462F9E9E916B5BE8F1029AC4ACC1", 16);
            BigInteger bigInteger2 = new BigInteger("01", 16);
            ECCurve access$000 = TeleTrusTNamedCurves.configureCurve(new Fp(new BigInteger("C302F41D932A36CDA7A3463093D18DB78FCE476DE1A86297", 16), new BigInteger("C302F41D932A36CDA7A3463093D18DB78FCE476DE1A86294", 16), new BigInteger("13D56FFAEC78681E68F9DEB43B35BEC2FB68542E27897B79", 16), bigInteger, bigInteger2));
    ...
    public static ASN1ObjectIdentifier getOID(short s, boolean z) {
        ...
        stringBuilder.append("brainpoolP");
        stringBuilder.append(s);
        stringBuilder.append(z ? "t" : "r");
        stringBuilder.append("1");
        return getOID(stringBuilder.toString());
    }
}
