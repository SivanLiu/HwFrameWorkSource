...
public class GostR3410TransportParameters extends ASN1Object {
    ...
    private GostR3410TransportParameters(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() == 2) {
            ...
            stringBuilder.append("unknown sequence length: ");
    ...
    public static GostR3410TransportParameters getInstance(Object obj) {
        return obj instanceof GostR3410TransportParameters ? (GostR3410TransportParameters) obj : obj != null ? new GostR3410TransportParameters(ASN1Sequence.getInstance(obj)) : null;
    }
