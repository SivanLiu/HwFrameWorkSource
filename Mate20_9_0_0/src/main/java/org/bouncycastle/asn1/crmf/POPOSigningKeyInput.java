...
public class POPOSigningKeyInput extends ASN1Object {
    ...
    private POPOSigningKeyInput(ASN1Sequence aSN1Sequence) {
        ...
        if (objectAt instanceof ASN1TaggedObject) {
            ...
            if (aSN1TaggedObject.getTagNo() == 0) {
                ...
                stringBuilder.append("Unknown authInfo tag: ");
    ...
    public static POPOSigningKeyInput getInstance(Object obj) {
        return obj instanceof POPOSigningKeyInput ? (POPOSigningKeyInput) obj : obj != null ? new POPOSigningKeyInput(ASN1Sequence.getInstance(obj)) : null;
    }
