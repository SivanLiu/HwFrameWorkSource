...
public class EncKeyWithID extends ASN1Object {
    ...
    private EncKeyWithID(ASN1Sequence aSN1Sequence) {
        ...
        ASN1Encodable instance = aSN1Sequence.size() > 1 ? !(aSN1Sequence.getObjectAt(1) instanceof DERUTF8String) ? GeneralName.getInstance(aSN1Sequence.getObjectAt(1)) : aSN1Sequence.getObjectAt(1) : null;
