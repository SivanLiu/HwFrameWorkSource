...
public class POPOSigningKey extends ASN1Object {
    ...
    private POPOSigningKey(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.getObjectAt(0) instanceof ASN1TaggedObject) {
            ...
            if (aSN1TaggedObject.getTagNo() == 0) {
                ...
                stringBuilder.append("Unknown POPOSigningKeyInput tag: ");
        ...
        this.signature = DERBitString.getInstance(aSN1Sequence.getObjectAt(i2));
    }
    ...
    public static POPOSigningKey getInstance(Object obj) {
        return obj instanceof POPOSigningKey ? (POPOSigningKey) obj : obj != null ? new POPOSigningKey(ASN1Sequence.getInstance(obj)) : null;
    }
