...
public class GeneralName extends ASN1Object implements ASN1Choice {
    ...
    private byte[] toGeneralNameEncoding(String str) {
        ...
        if (IPAddress.isValidIPv6WithNetmask(str) || IPAddress.isValidIPv6(str)) {
            ...
            copyInts(str.indexOf(58) > 0 ? parseIPv6(str) : parseMask(str), bArr2, 16);
            return bArr2;
            ...
            str = str.substring(indexOf + 1);
            if (str.indexOf(46) > 0) {
                parseIPv4(str, bArr2, 4);
                return bArr2;
            }
            parseIPv4Mask(str, bArr2, 4);
            return bArr2;
        }
    }
    ...
    public String toString() {
        ...
        if (i != 4) {
            ...
            obj = DERIA5String.getInstance(this.obj).getString();
        } else {
            obj = X500Name.getInstance(this.obj).toString();
        }
