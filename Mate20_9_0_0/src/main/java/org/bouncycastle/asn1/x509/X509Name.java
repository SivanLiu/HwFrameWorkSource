...
public class X509Name extends ASN1Object {
    ...
    public X509Name(Vector vector, Hashtable hashtable, X509NameEntryConverter x509NameEntryConverter) {
        ...
        while (i != this.ordering.size()) {
            ...
            if (hashtable.get(aSN1ObjectIdentifier) != null) {
                ...
                stringBuilder.append("No attribute for object id - ");
                ...
                if (instance2.size() == 2) {
                    ...
                    if (!(objectAt instanceof ASN1String) || (objectAt instanceof DERUniversalString)) {
                        try {
                            ...
                            stringBuilder.append(bytesToString(Hex.encode(objectAt.toASN1Primitive().getEncoded(ASN1Encoding.DER))));
                            vector.addElement(stringBuilder.toString());
                        } catch (IOException e) {
                            throw new IllegalArgumentException("cannot encode value");
                        }
                    }
                    Object string = ((ASN1String) objectAt).getString();
    ...
    public X509Name(boolean z, Hashtable hashtable, String str, X509NameEntryConverter x509NameEntryConverter) {
        ...
        while (x509NameTokenizer.hasMoreTokens()) {
            str = x509NameTokenizer.nextToken();
            if (str.indexOf(43) > 0) {
                X509NameTokenizer x509NameTokenizer2 = new X509NameTokenizer(str, '+');
                str = x509NameTokenizer2.nextToken();
                Boolean bool = FALSE;
                while (true) {
                    addEntry(hashtable, str, bool);
    ...
    private void addEntry(Hashtable hashtable, String str, Boolean bool) {
        ...
        if (x509NameTokenizer.hasMoreTokens()) {
            ...
            this.ordering.addElement(decodeOID(str, hashtable));
            this.values.addElement(unescape(nextToken));
    ...
    private String canonicalize(String str) {
        str = Strings.toLowerCase(str.trim());
        if (str.length() <= 0 || str.charAt(0) != '#') {
            return str;
        }
        ASN1Primitive decodeObject = decodeObject(str);
        return decodeObject instanceof ASN1String ? Strings.toLowerCase(((ASN1String) decodeObject).getString().trim()) : str;
    }
    ...
    private boolean equivalentStrings(String str, String str2) {
        ...
        return str.equals(str2) || stripInternalSpaces(str).equals(stripInternalSpaces(str2));
    }
    ...
    private String unescape(String str) {
        ...
        for (i = 
/*
Method generation error in method: org.bouncycastle.asn1.x509.X509Name.unescape(java.lang.String):java.lang.String, dex: 
jadx.core.utils.exceptions.CodegenException: Error generate insn: PHI: (r4_4 'i' int) = (r4_2 'i' int), (r4_3 'i' int) binds: {(r4_2 'i' int)=B:10:0x0031, (r4_3 'i' int)=B:11:0x0038} in method: org.bouncycastle.asn1.x509.X509Name.unescape(java.lang.String):java.lang.String, dex: 
    ...
    public Vector getValues(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        ...
        for (int i = 0; i != this.values.size(); i++) {
            if (this.ordering.elementAt(i).equals(aSN1ObjectIdentifier)) {
                Object obj = (String) this.values.elementAt(i);
