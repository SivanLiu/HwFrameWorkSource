...
public class X509CertificateHolderSelector implements Selector {
    ...
    public boolean match(Object obj) {
        ...
        if (obj instanceof X509CertificateHolder) {
            ...
            if (this.subjectKeyId != null) {
                ...
                if (extension == null) {
                    ...
                    calculateKeyId = MSOutlookKeyIdCalculator.calculateKeyId(x509CertificateHolder.getSubjectPublicKeyInfo());
                } else {
                    calculateKeyId = ASN1OctetString.getInstance(extension.getParsedValue()).getOctets();
                    bArr = this.subjectKeyId;
                }
            }
            return false;
        ...
        if (obj instanceof byte[]) {
            bArr = this.subjectKeyId;
            calculateKeyId = (byte[]) obj;
        }
        return false;
        return Arrays.areEqual(bArr, calculateKeyId);
    }
}
