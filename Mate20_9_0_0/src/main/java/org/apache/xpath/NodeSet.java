...
public class NodeSet implements NodeList, NodeIterator, Cloneable, ContextNodeList {
        ...
        if (this.m_mutable) {
            ...
            while (true) {
                ...
                if (child == node) {
                    ...
                    int testIndex2 = i - 1;
                    if (testIndex2 > 0 && !addNodesInDocOrder(0, i2, testIndex2, nodeList, support)) {
    ...
    public Node getCurrentNode() {
        ...
        if (this.m_cacheNodes) {
            ...
            if (this.m_next < this.m_firstFree) {
                n = elementAt(this.m_next);
            }
            this.m_next = saved;
            return n;
        }
    ...
    public final Node peepOrNull() {
        return (this.m_map == null || this.m_firstFree <= 0) ? null : this.m_map[this.m_firstFree - 1];
    }
    ...
    public void removeElementAt(int i) {
        if (this.m_map != null) {
            if (i >= this.m_firstFree) {
                ...
                stringBuilder.append(this.m_firstFree);
