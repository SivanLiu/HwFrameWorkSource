...
public class NodeTest extends Expression {
    ...
    protected void calcScore() {
        ...
        boolean z = this.m_namespace == null && this.m_name == "*";
    ...
    public static void debugWhatToShow(int whatToShow) {
        ...
        if (n == 0) {
            ...
            stringBuilder.append(whatToShow);
    ...
    private static final boolean subPartMatchNS(String p, String t) {
        return p == t || (p != null && (p.length() <= 0 ? t != null : !(t == "*" || p.equals(t))));
    }
    ...
    public XObject execute(XPathContext xctxt, int context) throws TransformerException {
        ...
        if (nodeBit == 64) {
            ...
            if (nodeBit == DTMFilter.SHOW_DOCUMENT || nodeBit == 1024) {
                return SCORE_OTHER;
            }
            if (nodeBit != 4096) {
                switch (nodeBit) {
