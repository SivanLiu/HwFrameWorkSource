...
public class XStringForFSB extends XString {
    ...
    public boolean equals(String anotherString) {
        ...
        while (true) {
            ...
            if (fsb.charAt(i) != anotherString.charAt(n)) {
                return false;
            }
            i++;
            n++;
    ...
    public XMLString fixWhiteSpace(boolean trimHead, boolean trimTail, boolean doublePunctuationSpaces) {
        ...
        for (s = this.m_start; s < end; s++) {
            ...
            if (!isSpace(c)) {
                ...
                int d3 = d + 1;
                buf[d] = ' ';
                if (!doublePunctuationSpaces || d3 == 0) {
                    pres = true;
                } else {
                    char prevChar = buf[d3 - 1];
        ...
        return edit ? XMLStringFactoryImpl.getFactory().newstr(buf, s, d - s) : this;
    }
