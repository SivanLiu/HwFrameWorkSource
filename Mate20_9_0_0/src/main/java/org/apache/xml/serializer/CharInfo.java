...
final class CharInfo {
    ...
    /* synthetic */ CharInfo(String x0, String x1, boolean x2, AnonymousClass1 x3) {
        this(x0, x1, x2);
    }
    ...
    private CharInfo(String entitiesResource, String method, boolean internal) {
        ...
        if (entities != null) {
            ...
            if (internal) {
                try {
                    is = CharInfo.class.getResourceAsStream(str);
                } catch (Exception e2) {
                            ...
                            if (line.charAt(0) != '#') {
                                ...
                                if (index > i) {
                                    ...
                                    if (index < line.length()) {
                                        ...
                                        if (defineEntity(name2, (char) Integer.parseInt(value))) {
                                            noExtraEntities = false;
                                        }
                                    }
                                }
