        ...
        try {
            ...
            if (method != null) {
                ...
                if (obj instanceof SerializationHandler) {
                    ...
                    SerializationHandler className2 = (SerializationHandler) ObjectFactory.findProviderClass(SerializerConstants.DEFAULT_SAX_SERIALIZER, loader, true).newInstance();
                    className2.setContentHandler((ContentHandler) obj);
                    className2.setOutputFormat(format);
                    ser = className2;
                } else {
