...
public abstract class SerializerBase implements SerializationHandler, SerializerConstants {
    ...
    protected String patchName(String qname) {
        ...
        if (lastColon > 0) {
            ...
            String prefix = qname.substring(null, firstColon);
    ...
    public void addAttribute(String name, String value) {
        if (this.m_elemContext.m_startTagOpen) {
            ...
            addAttributeAlways(getNamespaceURI(patchedName, false), localName, patchedName, "CDATA", value, false);
        }
    }
