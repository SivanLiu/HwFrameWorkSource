...
public class DTMNodeProxy implements Node, Document, Text, Element, Attr, ProcessingInstruction, Comment, DocumentFragment {
    ...
    public final NodeList getElementsByTagNameNS(String namespaceURI, String localName) {
        ...
        while (true) {
            ...
            nodeSet.addNode((Node) listVector.elementAt(i5));
            i2 = i5 + 1;
        }
    }
    ...
    private final void traverseChildren(Vector listVector, Node tempNode, String namespaceURI, String localname, boolean isNamespaceURIWildCard, boolean isLocalNameWildCard) {
        ...
        if (tempNode != null) {
            String str2;
            if (tempNode.getNodeType() == (short) 1) {
                ...
                if ((str == null && nsURI == null) || isNamespaceURIWildCard || (str != null && str.equals(nsURI))) {
                    listVector.add(tempNode);
                }
            } else {
                str2 = localname;
            ...
            if (tempNode.hasChildNodes()) {
                ...
                while (true) {
                    ...
                    traverseChildren(listVector, nl.item(i2), str, str2, isNamespaceURIWildCard, isLocalNameWildCard);
                    i = i2 + 1;
                }
            }
        }
    ...
    public String lookupPrefix(String namespaceURI) {
        ...
        if (type != (short) 2) {
            ...
            return null;
        } else if (getOwnerElement().getNodeType() == (short) 1) {
