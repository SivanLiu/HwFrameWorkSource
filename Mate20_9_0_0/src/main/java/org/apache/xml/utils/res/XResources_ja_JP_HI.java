...
public class XResources_ja_JP_HI extends XResourceBundle {
    public Object[][] getContents() {
        ...
        r0[3] = new Object[]{XResourceBundle.LANG_ALPHABET, new CharArrayWrapper(new char[]{12356, 12429, 12399, 12395, 12411, 12408, 12392, 12385, 12426, 12396, 12427, 12434, 12431, 12363, 12424, 12383, 12428, 12381, 12388, 12397, 12394, 12425, 12416, 12358, 12432, 12398, 12362, 12367, 12420, 12414, 12369, 12405, 12371, 12360, 12390, 12354, 12373, 12365, 12422, 12417, 12415, 12375, 12433, 12402, 12418, 12379, 12377})};
        ...
        r0[10] = new Object[]{XResourceBundle.LANG_MULTIPLIER_CHAR, new CharArrayWrapper(new char[]{20140, 20806, 20740, 19975, 21315, 30334, 21313})};
        r0[11] = new Object[]{"zero", new CharArrayWrapper(new char[0])};
        r0[12] = new Object[]{"digits", new CharArrayWrapper(new char[]{19968, 20108, 19977, 22235, 20116, 20845, 19971, 20843, 20061})};
        r0[13] = new Object[]{XResourceBundle.LANG_NUM_TABLES, new StringArrayWrapper(new String[]{"digits"})};
        return r0;
    }
}
