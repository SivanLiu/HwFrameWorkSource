...
public class DoubleMetaphone implements StringEncoder {
    ...
    private int handleG(String value, DoubleMetaphoneResult result, int index, boolean slavoGermanic) {
        ...
        if (charAt(str, i + 1) == 'N') {
            if (i == 1 && isVowel(charAt(str, 0)) && !slavoGermanic) {
                doubleMetaphoneResult.append("KN", "N");
            } else if (contains(str, i + 2, 2, "EY") || charAt(str, i + 1) == 'Y' || slavoGermanic) {
                doubleMetaphoneResult.append("KN");
            } else {
                doubleMetaphoneResult.append("N", "KN");
            }
            return i + 2;
        } else if (contains(str, i + 1, 2, "LI") && !slavoGermanic) {
            ...
            if (contains(str, i + 1, 2, "ER") || charAt(str, i + 1) == 'Y') {
                i2 = 3;
                if (!(contains(str, 0, 6, "DANGER", "RANGER", "MANGER") || contains(str, i - 1, 1, "E", "I") || contains(str, i - 1, i2, "RGY", "OGY"))) {
                    doubleMetaphoneResult.append('K', 'J');
                    return i + 2;
                }
            }
            ...
            if (contains(str, i + 1, 1, "E", "I", "Y") || contains(str, i - 1, 4, "AGGI", "OGGI")) {
                if (contains(str, 0, 4, "VAN ", "VON ") || contains(str, 0, i2, "SCH") || contains(str, i + 1, 2, "ET")) {
                    doubleMetaphoneResult.append('K');
                } else if (contains(str, i + 1, 4, "IER")) {
