...
public class SimpleLog implements Log, Serializable {
    ...
    public SimpleLog(String name) {
        ...
        stringBuilder.append("org.apache.commons.logging.simplelog.log.");
        stringBuilder.append(this.logName);
        String lvl = getStringProperty(stringBuilder.toString());
        int i = String.valueOf(name).lastIndexOf(".");
        while (lvl == null && i > -1) {
            name = name.substring(0, i);
            StringBuilder stringBuilder2 = new StringBuilder();
            stringBuilder2.append("org.apache.commons.logging.simplelog.log.");
            stringBuilder2.append(name);
            lvl = getStringProperty(stringBuilder2.toString());
