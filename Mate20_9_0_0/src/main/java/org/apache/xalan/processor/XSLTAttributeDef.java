...
public class XSLTAttributeDef {
    ...
    Object processENUM_OR_PQNAME(StylesheetHandler handler, String uri, String name, String rawName, String value, ElemTemplateElement owner) throws SAXException {
        PrefixResolver prefixResolver = handler;
        String str = value;
        Object objToReturn = null;
        if (getSupportsAVT()) {
            try {
                AVT avt = new AVT(prefixResolver, uri, name, rawName, str, owner);
                if (!avt.isSimple()) {
                    return avt;
                }
                objToReturn = avt;
        ...
        if (key == -10000) {
            try {
                QName qname = new QName(str, prefixResolver, true);
                if (objToReturn == null) {
                    objToReturn = qname;
                }
                if (qname.getPrefix() == null) {
                    getListOfEnums().append(" <qname-but-not-ncname>");
                    handleError(prefixResolver, XSLTErrorResources.INVALID_ENUM, new Object[]{name, str, enumNamesList.toString()}, null);
                    return null;
                }
            } catch (IllegalArgumentException ie) {
                getListOfEnums().append(" <qname-but-not-ncname>");
                handleError(prefixResolver, XSLTErrorResources.INVALID_ENUM, new Object[]{name, str, enumNamesList.toString()}, ie);
                return null;
            } catch (RuntimeException re) {
                getListOfEnums().append(" <qname-but-not-ncname>");
                handleError(prefixResolver, XSLTErrorResources.INVALID_ENUM, new Object[]{name, str, enumNamesList.toString()}, re);
                return null;
            }
    ...
    Object processNUMBER(StylesheetHandler handler, String uri, String name, String rawName, String value, ElemTemplateElement owner) throws SAXException {
        ...
        if (getSupportsAVT()) {
            AVT avt = null;
            try {
                AVT avt2 = new AVT(stylesheetHandler, uri, name, rawName, value, owner);
                try {
                    if (avt2.isSimple()) {
        ...
        try {
            ...
            NumberFormatException numberFormatException = nfe2;
            handleError(stylesheetHandler, XSLTErrorResources.INVALID_NUMBER, new Object[]{name, value}, nfe2);
            return null;
        }
    }
    ...
    Object processAVT_QNAME(StylesheetHandler handler, String uri, String name, String rawName, String value, ElemTemplateElement owner) throws SAXException {
        ...
        AVT avt = null;
        try {
            avt = new AVT(stylesheetHandler, uri, name, rawName, str, owner);
            if (avt.isSimple()) {
    ...
    Object processNCNAME(StylesheetHandler handler, String uri, String name, String rawName, String value, ElemTemplateElement owner) throws SAXException {
        ...
        if (getSupportsAVT()) {
            AVT avt;
            try {
                avt = new AVT(stylesheetHandler, uri, name, rawName, value, owner);
                try {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:28:0x0091 A:{ExcHandler: IllegalAccessException (r2_2 'iae' java.lang.IllegalAccessException), Splitter:B:7:0x001b} */
    /* JADX WARNING: Removed duplicated region for block: B:25:0x007e A:{ExcHandler: InvocationTargetException (r4_8 'nsme' java.lang.reflect.InvocationTargetException), Splitter:B:7:0x001b} */
