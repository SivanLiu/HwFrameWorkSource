        ...
        if (this.m_namespace != null && this.m_namespace.length() > 0) {
            ...
            if (nsa != null) {
                ...
                if (resultPrefix == null || resultPrefix.length() <= 0) {
                    ...
                    stringBuilder.append(":");
                    stringBuilder.append(this.m_localName);
                    this.m_rawName = stringBuilder.toString();
                }
            }
        }
        if (this.m_avts != null) {
                ...
                if (ns != null && ns.length() > 0) {
                    ...
                    if (nsa2 != null) {
                        ...
                        if (resultPrefix2 != null && resultPrefix2.length() > 0) {
                            ...
                            stringBuilder2.append(resultPrefix2);
                            stringBuilder2.append(":");
                            stringBuilder2.append(rawName);
                            rawName = stringBuilder2.toString();
                        }
