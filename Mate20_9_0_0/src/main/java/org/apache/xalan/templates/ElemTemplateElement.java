...
public class ElemTemplateElement extends UnImplNode implements PrefixResolver, Serializable, ExpressionNode, WhitespaceStrippingElementMatcher, XSLTVisitable {
    ...
    public void compose(StylesheetRoot sroot) throws TransformerException {
        ...
        boolean z = t != null && t.getXSLToken() == 78 && t.getNextSiblingElem() == null;
    ...
    public void resolvePrefixTables() throws TransformerException {
        ...
        if (this.m_declaredPrefixes != null) {
            ...
            for (i = 0; i < n; i++) {
                ...
                if (nsAlias != null) {
                    xMLNSDecl = new XMLNSDecl(nsAlias.getStylesheetPrefix(), nsAlias.getResultNamespace(), shouldExclude);
                } else {
                    xMLNSDecl = new XMLNSDecl(prefix, uri, shouldExclude);
                }
        ...
        if (parent != null) {
            ...
            if (this.m_prefixTable != null || needToCheckExclude()) {
                i = prefixes.size();
                while (i2 < i) {
                    decl = (XMLNSDecl) prefixes.get(i2);
                    boolean shouldExclude2 = excludeResultNSDecl(decl.getPrefix(), decl.getURI());
                    if (shouldExclude2 != decl.getIsExcluded()) {
                        decl = new XMLNSDecl(decl.getPrefix(), decl.getURI(), shouldExclude2);
                    }
