...
public class OutputProperties extends ElemTemplateElement implements Cloneable {
    ...
    public void setProperty(String key, String value) {
        ...
        if (key2.startsWith(OutputPropertiesFactory.S_BUILTIN_OLD_EXTENSIONS_UNIVERSAL)) {
            ...
            stringBuilder.append(OutputPropertiesFactory.S_BUILTIN_EXTENSIONS_UNIVERSAL);
            stringBuilder.append(key2.substring(OutputPropertiesFactory.S_BUILTIN_OLD_EXTENSIONS_UNIVERSAL_LEN));
            key2 = stringBuilder.toString();
        }
    ...
    public String getProperty(String key) {
        if (key.startsWith(OutputPropertiesFactory.S_BUILTIN_OLD_EXTENSIONS_UNIVERSAL)) {
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append(OutputPropertiesFactory.S_BUILTIN_EXTENSIONS_UNIVERSAL);
            stringBuilder.append(key.substring(OutputPropertiesFactory.S_BUILTIN_OLD_EXTENSIONS_UNIVERSAL_LEN));
    ...
    public void setMethodDefaults(String method) {
        ...
        if (defaultMethod == null || !defaultMethod.equals(method) || defaultMethod.equals("xml")) {
        ...
        while (keys.hasMoreElements()) {
            ...
            if (isLegalPropertyKey(key)) {
                ...
                if (oldValue == null) {
                    ...
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append((String) oldValue);
                    stringBuilder.append(" ");
                    stringBuilder.append((String) src.get(key));
    ...
    public static boolean isLegalPropertyKey(String key) {
        return key.equals(Constants.ATTRNAME_OUTPUT_CDATA_SECTION_ELEMENTS) || key.equals(Constants.ATTRNAME_OUTPUT_DOCTYPE_PUBLIC) || key.equals(Constants.ATTRNAME_OUTPUT_DOCTYPE_SYSTEM) || key.equals("encoding") || key.equals("indent") || key.equals(Constants.ATTRNAME_OUTPUT_MEDIATYPE) || key.equals(Constants.ATTRNAME_OUTPUT_METHOD) || key.equals("omit-xml-declaration") || key.equals(Constants.ATTRNAME_OUTPUT_STANDALONE) || key.equals("version") || (key.length() > 0 && key.charAt(0) == '{' && key.lastIndexOf(123) == 0 && key.indexOf(125) > 0 && key.lastIndexOf(125) == key.indexOf(125));
    }
