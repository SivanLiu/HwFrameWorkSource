...
public class TransformerHandlerImpl implements EntityResolver, DTDHandler, ContentHandler, ErrorHandler, LexicalHandler, TransformerHandler, DeclHandler {
    ...
    public void setDocumentLocator(Locator locator) {
        if (DEBUG) {
            ...
            stringBuilder.append("TransformerHandlerImpl#setDocumentLocator: ");
    ...
    public void startElement(String uri, String localName, String qName, Attributes atts) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("TransformerHandlerImpl#startElement: ");
    ...
    public void processingInstruction(String target, String data) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("TransformerHandlerImpl#processingInstruction: ");
    ...
    public void startEntity(String name) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("TransformerHandlerImpl#startEntity: ");
            stringBuilder.append(name);
            printStream.println(stringBuilder.toString());
        }
        if (this.m_lexicalHandler != null) {
    ...
    public void endEntity(String name) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("TransformerHandlerImpl#endEntity: ");
            stringBuilder.append(name);
            printStream.println(stringBuilder.toString());
        }
        if (this.m_lexicalHandler != null) {
    ...
    public void comment(char[] ch, int start, int length) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("TransformerHandlerImpl#comment: ");
            stringBuilder.append(start);
            stringBuilder.append(", ");
            stringBuilder.append(length);
            printStream.println(stringBuilder.toString());
    ...
    public void elementDecl(String name, String model) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("TransformerHandlerImpl#elementDecl: ");
            stringBuilder.append(name);
            stringBuilder.append(", ");
    ...
    public void internalEntityDecl(String name, String value) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("TransformerHandlerImpl#internalEntityDecl: ");
            stringBuilder.append(name);
            stringBuilder.append(", ");
    ...
    public void externalEntityDecl(String name, String publicId, String systemId) throws SAXException {
        if (DEBUG) {
            PrintStream printStream = System.out;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("TransformerHandlerImpl#externalEntityDecl: ");
            stringBuilder.append(name);
            stringBuilder.append(", ");
            stringBuilder.append(publicId);
            stringBuilder.append(", ");
