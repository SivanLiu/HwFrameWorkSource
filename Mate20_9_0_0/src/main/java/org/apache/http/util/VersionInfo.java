...
public class VersionInfo {
    ...
    public static final VersionInfo[] loadVersionInfo(String[] pckgs, ClassLoader clsldr) {
        if (pckgs != null) {
            ...
            for (String vi : pckgs) {
                VersionInfo vi2 = loadVersionInfo(vi, clsldr);
                if (vi2 != null) {
                    vil.add(vi2);
                }
            }
    ...
    public static final VersionInfo loadVersionInfo(String pckg, ClassLoader clsldr) {
        if (pckg != null) {
            ...
            try {
                ...
                stringBuilder.append(pckg.replace('.', '/'));
                stringBuilder.append("/");
                stringBuilder.append(VERSION_PROPERTY_FILE);
                is = clsldr.getResourceAsStream(stringBuilder.toString());
                if (is != null) {
