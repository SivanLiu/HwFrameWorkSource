        ...
        if (start != end) {
            ...
            if (start < this.size) {
                ...
                while (start < index) {
                    ...
                    as = (AttributedString) this.attributedStrings.get(asIndex);
            ...
            if (this.size < end) {
                as = new AttributedString(buffer.substring(Math.max(start, this.size), end));
                as.addAttribute(attr, value);
                this.attributedStrings.add(as);
                this.size = end;
            }
        }
    }
