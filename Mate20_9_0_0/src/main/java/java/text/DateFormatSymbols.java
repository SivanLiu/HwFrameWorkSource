...
public class DateFormatSymbols implements Serializable, Cloneable {
    ...
    private static DateFormatSymbols getCachedInstance(Locale locale) {
        ...
        if (ref != null) {
            DateFormatSymbols dateFormatSymbols = (DateFormatSymbols) ref.get();
    ...
    public int hashCode() {
        ...
        hashCode = (11 * ((11 * ((11 * ((11 * ((11 * ((11 * ((11 * 5) + Arrays.hashCode(this.eras))) + Arrays.hashCode(this.months))) + Arrays.hashCode(this.shortMonths))) + Arrays.hashCode(this.weekdays))) + Arrays.hashCode(this.shortWeekdays))) + Arrays.hashCode(this.ampms))) + Objects.hashCode(this.localPatternChars);
