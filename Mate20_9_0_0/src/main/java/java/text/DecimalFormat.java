...
public class DecimalFormat extends NumberFormat {
    ...
    public DecimalFormat(String pattern) {
        this.symbols = null;
        this.roundingMode = RoundingMode.HALF_EVEN;
        this.symbols = DecimalFormatSymbols.getInstance(Locale.getDefault(Category.FORMAT));
        initPattern(pattern);
    }
    ...
    private static FieldPosition getIcuFieldPosition(FieldPosition fp) {
        Field fieldAttribute = fp.getFieldAttribute();
    ...
    private static NumberFormat.Field toJavaFieldAttribute(Attribute icuAttribute) {
        ...
        stringBuilder.append("Unrecognized attribute: ");
    ...
    private void writeObject(ObjectOutputStream stream) throws IOException, ClassNotFoundException {
        ...
        fields.put("posPrefixPattern", obj);
        fields.put("posSuffixPattern", obj);
        fields.put("negPrefixPattern", obj);
        fields.put("negSuffixPattern", obj);
    ...
    private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
        ...
        String negativePrefix = (String) fields.get("negativePrefix", LanguageTag.SEP);
        ...
        updateFieldsFromIcu();
        if (fields.get("serialVersionOnStream", (int) false) < 3) {
