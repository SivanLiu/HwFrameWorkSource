...
public abstract class NumberFormat extends Format {
    ...
    public Number parse(String source) throws ParseException {
        ...
        throw new ParseException(stringBuilder.toString(), parsePosition.errorIndex);
    }
    ...
    private static NumberFormat getInstance(Locale desiredLocale, int choice) {
        ...
        DecimalFormat numberFormat = new DecimalFormat(numberPatterns[choice == 3 ? 0 : choice], DecimalFormatSymbols.getInstance(desiredLocale));
        if (choice == 3) {
