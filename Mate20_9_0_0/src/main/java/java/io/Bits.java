...
class Bits {
    ...
    static long getLong(byte[] b, int off) {
        return (((((((((long) b[off + 7]) & 255) + ((((long) b[off + 6]) & 255) << 8)) + ((((long) b[off + 5]) & 255) << 16)) + ((((long) b[off + 4]) & 255) << 24)) + ((((long) b[off + 3]) & 255) << 32)) + ((((long) b[off + 2]) & 255) << 40)) + ((255 & ((long) b[off + 1])) << 48)) + (((long) b[off]) << 56);
    }
