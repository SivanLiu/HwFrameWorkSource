...
public final class System {
    ...
    static {
        ...
        boolean z = (val == null || "false".equals(val)) ? false : true;
        DEBUG = z;
    }
    ...
    private static Properties initUnchangeableSystemProperties() {
        ...
        try {
            ...
            if (!(p.get("os.name") == null || p.get("os.name").equals(info.sysname))) {
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("Wrong compile-time assumption for os.name: ");
                stringBuilder.append(p.get("os.name"));
                stringBuilder.append(" vs ");
                stringBuilder.append(info.sysname);
            ...
            for (String[] pair : AndroidHardcodedSystemProperties.STATIC_PROPERTIES) {
                if (p.containsKey(pair[0])) {
                    ...
                    stringBuilder2.append("Ignoring command line argument: -D");
                    stringBuilder2.append(pair[0]);
