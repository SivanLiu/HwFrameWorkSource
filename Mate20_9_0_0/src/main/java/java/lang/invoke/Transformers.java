...
public class Transformers {
    ...
    public static class Constant extends Transformer {
        ...
        public Constant(Class<?> type, Object value) {
            ...
            if (!type.isPrimitive()) {
                ...
                this.asInt = ((Boolean) value).booleanValue();
                this.typeChar = 'Z';
                ...
                stringBuilder.append(this.typeChar);
                ...
                switch (c) {
                    ...
                    default:
                        switch (c) {
                            ...
                            default:
                                StringBuilder stringBuilder = new StringBuilder();
                                stringBuilder.append("Unexpected typeChar: ");
                                stringBuilder.append(this.typeChar);
                                throw new AssertionError(stringBuilder.toString());
                        }
                }
    ...
    static class Construct extends Transformer {
        ...
        private static void checkInstantiable(Class<?> klass) throws InstantiationException {
            if (isAbstract(klass)) {
                ...
                stringBuilder.append((Object) klass);
    ...
    public static class ExplicitCastArguments extends Transformer {
        ...
        private static void throwUnexpectedType(Class<?> unexpectedType) {
            ...
            stringBuilder.append((Object) unexpectedType);
                ...
                default:
                    switch (basicComponentType) {
                        ...
                        default:
                            StringBuilder stringBuilder = new StringBuilder();
                            stringBuilder.append("Unexpected type: ");
                            stringBuilder.append(basicComponentType);
                            throw new InternalError(stringBuilder.toString());
                    }
            }
        }
                    ...
                    default:
                        switch (basicTypeChar) {
                            ...
                            default:
                                StringBuilder stringBuilder = new StringBuilder();
                                stringBuilder.append("Unexpected type: ");
                                stringBuilder.append((Object) ptype);
                                throw new InternalError(stringBuilder.toString());
                        }
                }
            } else {
