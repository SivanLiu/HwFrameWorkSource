...
public class MethodHandles {
    ...
    public static final class Lookup {
        ...
        private static void checkUnprivilegedlookupClass(Class<?> lookupClass, int allowedModes) {
            ...
            if (name.startsWith("java.lang.invoke.")) {
                ...
                stringBuilder.append("illegal lookupClass: ");
                stringBuilder.append((Object) lookupClass);
        ...
        private MethodHandle findVirtualForVH(String name, MethodType type) {
            try {
                return MethodHandles.varHandleInvoker(AccessMode.valueFromMethodName(name), type);
        ...
        public MethodHandle findVirtual(Class<?> refc, String name, MethodType type) throws NoSuchMethodException, IllegalAccessException {
            ...
            if (refc == MethodHandle.class) {
                mh = findVirtualForMH(name, type);
                if (mh != null) {
                    return mh;
                }
            } else if (refc == VarHandle.class) {
                mh = findVirtualForVH(name, type);
                if (mh != null) {
                    return mh;
                }
            }
            ...
            if (method == null) {
                ...
                stringBuilder2.append(Arrays.toString(type.ptypes()));
                throw new NoSuchMethodException(stringBuilder2.toString());
            }
            checkReturnType(method, type);
        ...
        public MethodHandle findConstructor(Class<?> refc, MethodType type) throws NoSuchMethodException, IllegalAccessException {
            if (refc.isArray()) {
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("no constructor for array class: ");
                stringBuilder.append(refc.getName());
            ...
            StringBuilder stringBuilder2 = new StringBuilder();
            stringBuilder2.append("No constructor for ");
            stringBuilder2.append(constructor.getDeclaringClass());
            stringBuilder2.append(" matching ");
            stringBuilder2.append((Object) type);
            throw new NoSuchMethodException(stringBuilder2.toString());
        }
        ...
        public MethodHandle findSpecial(Class<?> refc, String name, MethodType type, Class<?> specialCaller) throws NoSuchMethodException, IllegalAccessException {
            if (specialCaller == null) {
                ...
                if (name.startsWith("<")) {
                    ...
                    stringBuilder.append(" is not a valid method name.");
                    throw new NoSuchMethodException(stringBuilder.toString());
                }
        ...
        private MethodHandle findSpecial(Method method, MethodType type, Class<?> refc, Class<?> specialCaller) throws IllegalAccessException {
            ...
            if (Modifier.isStatic(method.getModifiers())) {
                stringBuilder = new StringBuilder();
                stringBuilder.append("expected a non-static method:");
                ...
                stringBuilder.append((Object) refc);
                ...
                stringBuilder.append((Object) specialCaller);
                throw new IllegalAccessException(stringBuilder.toString());
            }
        }
        ...
        private MethodHandle findAccessor(Field field, Class<?> refc, Class<?> type, int kind, boolean performAccessChecks) throws IllegalAccessException {
            ...
            int i = kind;
            boolean z = i == 10 || i == 12;
            boolean isSetterKind = z;
            boolean isStaticKind = (i == 11 || i == 12) ? true : $assertionsDisabled;
            commonFieldChecks(field, cls, cls2, isStaticKind, performAccessChecks);
            ...
            switch (i) {
                ...
                default:
                    StringBuilder stringBuilder2 = new StringBuilder();
                    stringBuilder2.append("Invalid kind ");
        ...
        private void commonFieldChecks(Field field, Class<?> refc, Class<?> cls, boolean isStatic, boolean performAccessChecks) throws IllegalAccessException {
            ...
            if (Modifier.isStatic(modifiers) != isStatic) {
                ...
                reason.append("Field ");
                reason.append((Object) field);
                reason.append(" is ");
                reason.append(isStatic ? "not " : "");
                reason.append("static");
                throw new IllegalAccessException(reason.toString());
            }
        }
        ...
        public MethodHandle unreflectGetter(Field f) throws IllegalAccessException {
            return findAccessor(f, f.getDeclaringClass(), f.getType(), Modifier.isStatic(f.getModifiers()) ? 11 : 9, f.isAccessible() ^ 1);
        }

        public MethodHandle unreflectSetter(Field f) throws IllegalAccessException {
            return findAccessor(f, f.getDeclaringClass(), f.getType(), Modifier.isStatic(f.getModifiers()) ? 12 : 10, f.isAccessible() ^ 1);
        }
        ...
        String accessFailedMessage(Class<?> refc, Class<?> defc, int mods) {
            ...
            isPublic = (isPublic && (defc == refc || Modifier.isPublic(refc.getModifiers()))) ? true : $assertionsDisabled;
            if (!(isPublic || (this.allowedModes & 8) == 0)) {
        ...
        private void checkReturnType(Method method, MethodType methodType) throws NoSuchMethodException {
            if (method.getReturnType() != methodType.rtype()) {
                ...
                stringBuilder.append((Object) methodType);
                throw new NoSuchMethodException(stringBuilder.toString());
            }
        }
    }
    ...
    private static MethodHandleImpl getMethodHandleImpl(MethodHandle target) {
        ...
        stringBuilder.append(" is not a direct handle");
    ...
    private static void checkTypeIsViewable(Class<?> componentType) {
        if (componentType != Short.TYPE && componentType != Character.TYPE && componentType != Integer.TYPE && componentType != Long.TYPE && componentType != Float.TYPE && componentType != Double.TYPE) {
            ...
            stringBuilder.append((Object) componentType);
    ...
    private static MethodHandle methodHandleForVarHandleAccessor(AccessMode accessMode, MethodType type, boolean isExactInvoker) {
        Class<?> refc = VarHandle.class;
        try {
            int kind;
            Method method = refc.getDeclaredMethod(accessMode.methodName(), Object[].class);
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("No method for AccessMode ");
            stringBuilder.append((Object) accessMode);
    ...
    private static void explicitCastArgumentsChecks(MethodHandle target, MethodType newType) {
        if (target.type().parameterCount() != newType.parameterCount()) {
            ...
            stringBuilder.append((Object) newType);
    ...
    private static boolean permuteArgumentChecks(int[] reorder, MethodType newType, MethodType oldType) {
        if (newType.returnType() == oldType.returnType()) {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("bad reorder array: ");
            stringBuilder.append(Arrays.toString(reorder));
            throw MethodHandleStatics.newIllegalArgumentException(stringBuilder.toString());
        }
    ...
    private static int dropArgumentChecks(MethodType oldType, int pos, List<Class<?>> valueTypes) {
        ...
        stringBuilder.append(Arrays.asList(oldType, Integer.valueOf(pos), valueTypes, Integer.valueOf(inargs), Integer.valueOf(outargs)));
        throw MethodHandleStatics.newIllegalArgumentException(stringBuilder.toString());
    }
    ...
    public static MethodHandle guardWithTest(MethodHandle test, MethodHandle target, MethodHandle fallback) {
        ...
        if (!ttype.equals(ftype)) {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("guard type is not a predicate ");
            stringBuilder.append(gtype);
            throw MethodHandleStatics.newIllegalArgumentException(stringBuilder.toString());
        }
    }
    ...
    static RuntimeException misMatchedTypes(String what, MethodType t1, MethodType t2) {
        ...
        stringBuilder.append((Object) t1);
        stringBuilder.append(" != ");
    ...
    public static MethodHandle catchException(MethodHandle target, Class<? extends Throwable> exType, MethodHandle handler) {
        ...
        if (htype.parameterCount() < 1 || !htype.parameterType(0).isAssignableFrom(exType)) {
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("handler does not accept exception type ");
            stringBuilder.append((Object) exType);
            throw MethodHandleStatics.newIllegalArgumentException(stringBuilder.toString());
