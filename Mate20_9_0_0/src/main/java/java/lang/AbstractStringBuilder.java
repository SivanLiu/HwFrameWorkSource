...
abstract class AbstractStringBuilder implements Appendable, CharSequence {
    ...
    public void getChars(int srcBegin, int srcEnd, char[] dst, int dstBegin) {
        if (srcBegin < 0) {
            ...
            System.arraycopy(this.value, srcBegin, (Object) dst, dstBegin, srcEnd - srcBegin);
        } else {
    ...
    public AbstractStringBuilder append(char[] str) {
        int len = str.length;
        ensureCapacityInternal(this.count + len);
        System.arraycopy((Object) str, 0, this.value, this.count, len);
        this.count += len;
        return this;
    }
    ...
    public AbstractStringBuilder append(char[] str, int offset, int len) {
        ...
        System.arraycopy((Object) str, offset, this.value, this.count, len);
        this.count += len;
        return this;
    }
    ...
    public AbstractStringBuilder insert(int index, char[] str, int offset, int len) {
        if (index < 0 || index > length()) {
            ...
            System.arraycopy((Object) str, offset, this.value, index, len);
            this.count += len;
            return this;
        }
    }
    ...
    public AbstractStringBuilder insert(int offset, char[] str) {
        ...
        ensureCapacityInternal(this.count + len);
        System.arraycopy(this.value, offset, this.value, offset + len, this.count - offset);
        System.arraycopy((Object) str, 0, this.value, offset, len);
        this.count += len;
        return this;
    }
    ...
    public AbstractStringBuilder insert(int dstOffset, CharSequence s, int start, int end) {
        ...
        if (dstOffset < 0 || dstOffset > length()) {
            ...
            stringBuilder.append("dstOffset ");
            stringBuilder.append(dstOffset);
            throw new IndexOutOfBoundsException(stringBuilder.toString());
            ...
            while (dstOffset < end) {
                ...
                this.value[dstOffset2] = s.charAt(dstOffset);
                dstOffset++;
                dstOffset2 = dstOffset3;
            }
            this.count += len;
            return this;
        }
