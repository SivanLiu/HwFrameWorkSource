...
public class EnumMap<K extends Enum<K>, V> extends AbstractMap<K, V> implements Serializable, Cloneable {
    ...
    private abstract class EnumMapIterator<T> implements Iterator<T> {
        ...
        /* synthetic */ EnumMapIterator(EnumMap x0, AnonymousClass1 x1) {
            this();
        }
        ...
        public void remove() {
            ...
            if (EnumMap.this.vals[this.lastReturnedIndex] != null) {
                ...
                EnumMap.this.size = EnumMap.this.size - 1;
            }
            this.lastReturnedIndex = -1;
        }
    ...
    private class EntryIterator extends EnumMapIterator<java.util.Map.Entry<K, V>> {
        ...
        private class Entry implements java.util.Map.Entry<K, V> {
            ...
            /* synthetic */ Entry(EntryIterator x0, int x1, AnonymousClass1 x2) {
                this(x1);
            }
        ...
        /* synthetic */ EntryIterator(EnumMap x0, AnonymousClass1 x1) {
            this();
        }
    ...
    private class KeyIterator extends EnumMapIterator<K> {
        ...
        /* synthetic */ KeyIterator(EnumMap x0, AnonymousClass1 x1) {
            this();
        }
    ...
    private class ValueIterator extends EnumMapIterator<V> {
        ...
        /* synthetic */ ValueIterator(EnumMap x0, AnonymousClass1 x1) {
            this();
        }
    ...
    private class Values extends AbstractCollection<V> {
        ...
        /* synthetic */ Values(EnumMap x0, AnonymousClass1 x1) {
            this();
        }
    ...
    private class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        /* synthetic */ EntrySet(EnumMap x0, AnonymousClass1 x1) {
            this();
        }
    ...
    private class KeySet extends AbstractSet<K> {
        ...
        /* synthetic */ KeySet(EnumMap x0, AnonymousClass1 x1) {
            this();
        }
    ...
    public void putAll(Map<? extends K, ? extends V> m) {
        if (m instanceof EnumMap) {
            ...
            if (em.keyType == this.keyType) {
                ...
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append(em.keyType);
                stringBuilder.append(" != ");
    ...
    public Set<K> keySet() {
        ...
        KeySet ks2 = new KeySet(this, null);
        this.keySet = ks2;
        return ks2;
    }
    ...
    public Collection<V> values() {
        ...
        Values vs2 = new Values(this, null);
        this.values = vs2;
        return vs2;
    }
    ...
    private static <K extends Enum<K>> K[] getKeyUniverse(Class<K> keyType) {
        return (Enum[]) keyType.getEnumConstantsShared();
    }
