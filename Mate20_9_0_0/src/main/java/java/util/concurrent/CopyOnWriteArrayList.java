    ...
    private static class COWSubList<E> extends AbstractList<E> implements RandomAccess {
        ...
        public E get(int index) {
            ...
            synchronized (this.l.lock) {
                rangeCheck(index);
                checkForComodification();
                obj = this.l.get(this.offset + index);
            }
            return obj;
        }
    ...
    public void add(int index, E element) {
        synchronized (this.lock) {
            ...
            if (numMoved == 0) {
                ...
                System.arraycopy(elements, 0, (Object) newElements, 0, index);
                System.arraycopy(elements, index, (Object) newElements, index + 1, numMoved);
            }
            newElements[index] = element;
            setArray(newElements);
        }
