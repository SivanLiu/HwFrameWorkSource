...
public class ZipOutputStream extends DeflaterOutputStream implements ZipConstants {
    ...
    public void finish() throws IOException {
        ...
        if (!this.finished) {
            ...
            Iterator it = this.xentries.iterator();
            while (it.hasNext()) {
                writeCEN((XEntry) it.next());
            }
    ...
    private void writeCEN(XEntry xentry) throws IOException {
        ...
        if (e.comment != null) {
            ...
            byte[] commentBytes2 = commentBytes;
            writeShort(Math.min(commentBytes.length, (int) 65535));
