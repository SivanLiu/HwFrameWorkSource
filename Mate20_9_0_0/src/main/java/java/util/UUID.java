...
public final class UUID implements Serializable, Comparable<UUID> {
    ...
    public static UUID fromString(String name) {
        ...
        stringBuilder2.append("Invalid UUID string: ");
    ...
    public String toString() {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(digits(this.mostSigBits >> 32, 8));
        stringBuilder.append(LanguageTag.SEP);
        stringBuilder.append(digits(this.mostSigBits >> 16, 4));
        stringBuilder.append(LanguageTag.SEP);
        stringBuilder.append(digits(this.mostSigBits, 4));
        stringBuilder.append(LanguageTag.SEP);
        stringBuilder.append(digits(this.leastSigBits >> 48, 4));
        stringBuilder.append(LanguageTag.SEP);
        stringBuilder.append(digits(this.leastSigBits, 12));
