...
final class MatchOps {
    ...
    public static <T> TerminalOp<T, Boolean> makeRef(Predicate<? super T> predicate, MatchKind matchKind) {
        ...
        return new MatchOp(StreamShape.REFERENCE, matchKind, new -$$Lambda$MatchOps$_LtFSpSMfVwoPv-8p_1cMGGcaHA(matchKind, predicate));
    }

    public static TerminalOp<Integer, Boolean> makeInt(IntPredicate predicate, MatchKind matchKind) {
        Objects.requireNonNull(predicate);
        Objects.requireNonNull(matchKind);
        return new MatchOp(StreamShape.INT_VALUE, matchKind, new -$$Lambda$MatchOps$emK14UX33I4-nqH2o5l7hLEVAy8(matchKind, predicate));
    }

    public static TerminalOp<Long, Boolean> makeLong(LongPredicate predicate, MatchKind matchKind) {
        Objects.requireNonNull(predicate);
        Objects.requireNonNull(matchKind);
        return new MatchOp(StreamShape.LONG_VALUE, matchKind, new -$$Lambda$MatchOps$kCrOdGmndcbZklBaJ6Z4blQ1F5M(matchKind, predicate));
    }

    public static TerminalOp<Double, Boolean> makeDouble(DoublePredicate predicate, MatchKind matchKind) {
        Objects.requireNonNull(predicate);
        Objects.requireNonNull(matchKind);
        return new MatchOp(StreamShape.DOUBLE_VALUE, matchKind, new -$$Lambda$MatchOps$VXR1J72V6WzQCN-3NkesXDVJ1uc(matchKind, predicate));
    }
}
