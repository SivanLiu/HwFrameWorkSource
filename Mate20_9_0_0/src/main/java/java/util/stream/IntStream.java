...
public interface IntStream extends BaseStream<Integer, IntStream> {
    ...
    static IntStream concat(IntStream a, IntStream b) {
        ...
        Spliterator.OfInt split = new OfInt(a.spliterator(), b.spliterator());
        IntStream stream = (a.isParallel() || b.isParallel()) ? true : null;
        return (IntStream) StreamSupport.intStream(split, stream).onClose(Streams.composedClose(a, b));
    }
}
