...
public interface LongStream extends BaseStream<Long, LongStream> {
    ...
    static LongStream concat(LongStream a, LongStream b) {
        ...
        Spliterator.OfLong split = new OfLong(a.spliterator(), b.spliterator());
        LongStream stream = (a.isParallel() || b.isParallel()) ? true : null;
        return (LongStream) StreamSupport.longStream(split, stream).onClose(Streams.composedClose(a, b));
    }
}
