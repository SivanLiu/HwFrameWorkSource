...
final class FindOps {
    ...
    public static <T> TerminalOp<T, Optional<T>> makeRef(boolean mustFindFirst) {
        return new FindOp(mustFindFirst, StreamShape.REFERENCE, Optional.empty(), -$$Lambda$bjSXRjZ5UYwAzkW-XPKwqbJ9BRQ.INSTANCE, -$$Lambda$opQ7JxjVCJzqzgTxGU3LVtqC7is.INSTANCE);
    }
