...
public abstract class AbstractPipeline<E_IN, E_OUT, S extends BaseStream<E_OUT, S>> extends PipelineHelper<E_OUT> implements BaseStream<E_OUT, S> {
    ...
    public Spliterator<E_OUT> spliterator() {
        ...
        this.linkedOrConsumed = true;
        if (this != this.sourceStage) {
            return wrap(this, new -$$Lambda$AbstractPipeline$ImXhRLJT29W8lJFXpTT_PieAotg(this), isParallel());
        }
        if (this.sourceStage.sourceSpliterator != null) {
    ...
    final <P_IN> Spliterator<E_OUT> wrapSpliterator(Spliterator<P_IN> sourceSpliterator) {
        ...
        return wrap(this, new -$$Lambda$AbstractPipeline$i18ybop3uEZwLQyKh7zmnuTXiFw(sourceSpliterator), isParallel());
    }

    static /* synthetic */ Spliterator lambda$wrapSpliterator$1(Spliterator sourceSpliterator) {
        return sourceSpliterator;
    }
