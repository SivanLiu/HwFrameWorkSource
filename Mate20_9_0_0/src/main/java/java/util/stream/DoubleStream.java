...
public interface DoubleStream extends BaseStream<Double, DoubleStream> {
    ...
    static DoubleStream concat(DoubleStream a, DoubleStream b) {
        ...
        Spliterator.OfDouble split = new OfDouble(a.spliterator(), b.spliterator());
        DoubleStream stream = (a.isParallel() || b.isParallel()) ? true : null;
        return (DoubleStream) StreamSupport.doubleStream(split, stream).onClose(Streams.composedClose(a, b));
    }
}
