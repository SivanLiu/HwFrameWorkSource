...
public class Collections {
    ...
    private static class CheckedMap<K, V> implements Map<K, V>, Serializable {
        ...
        static class CheckedEntrySet<K, V> implements Set<Entry<K, V>> {
            ...
            public boolean contains(Object o) {
                ...
                if (e instanceof CheckedEntry) {
                    ...
                    obj = checkedEntry(e, this.valueType);
                }
        ...
        private BiFunction<? super K, ? super V, ? extends V> typeCheck(BiFunction<? super K, ? super V, ? extends V> func) {
            ...
            return new -$$Lambda$Collections$CheckedMap$5MCuh91_pd5SsNapFva5jp8gVs8(this, func);
        }
        ...
        public V computeIfAbsent(K key, Function<? super K, ? extends V> mappingFunction) {
            ...
            return this.m.computeIfAbsent(key, new -$$Lambda$Collections$CheckedMap$hvicTzt8soLX23klS8sBMiCuEvk(this, mappingFunction));
        }
        ...
        public V merge(K key, V value, BiFunction<? super V, ? super V, ? extends V> remappingFunction) {
            ...
            return this.m.merge(key, value, new -$$Lambda$Collections$CheckedMap$UHd_dm3NjSdMnE1bZpQe0MXp_Gk(this, remappingFunction));
        }
    ...
    private static class EmptyIterator<E> implements Iterator<E> {
        ...
        /* synthetic */ EmptyIterator(AnonymousClass1 x0) {
            this();
        }
    ...
    private static class ReverseComparator2<T> implements Comparator<T>, Serializable {
        ...
        public boolean equals(Object o) {
            return (o == this || ((o instanceof ReverseComparator2) && this.cmp.equals(((ReverseComparator2) o).cmp))) ? true : $assertionsDisabled;
        }
    ...
    private static class UnmodifiableMap<K, V> implements Map<K, V>, Serializable {
        ...
        static class UnmodifiableEntrySet<K, V> extends UnmodifiableSet<Entry<K, V>> {
            ...
            static <K, V> Consumer<Entry<K, V>> entryConsumer(Consumer<? super Entry<K, V>> action) {
                return new -$$Lambda$Collections$UnmodifiableMap$UnmodifiableEntrySet$W5VhpDb0JlKqrRuOSf_2RiCnSgo(action);
            }
    ...
    static class CheckedCollection<E> implements Collection<E>, Serializable {
        ...
        private E[] zeroLengthElementArray() {
            ...
            Object[] zeroLengthArray = Collections.zeroLengthArray(this.type);
    ...
    static class CheckedList<E> extends CheckedCollection<E> implements List<E> {
        ...
        public void replaceAll(UnaryOperator<E> operator) {
            ...
            this.list.replaceAll(new -$$Lambda$Collections$CheckedList$gXIP1Db1_l1aVeW3UfOh4dLyESo(this, operator));
        }
    ...
    static class SynchronizedList<E> extends SynchronizedCollection<E> implements List<E> {
        ...
        public E set(int index, E element) {
            Object obj;
            synchronized (this.mutex) {
                obj = this.list.set(index, element);
            }
            return obj;
        }
    ...
    private static class CopiesList<E> extends AbstractList<E> implements RandomAccess, Serializable {
        ...
        public boolean contains(Object obj) {
            return (this.n == 0 || !Collections.eq(obj, this.element)) ? $assertionsDisabled : true;
        }
        ...
        public Stream<E> stream() {
            return IntStream.range(0, this.n).mapToObj(new -$$Lambda$Collections$CopiesList$uHL7LkfEBowvpXOMQGFkZqUGxm4(this));
        }

        public Stream<E> parallelStream() {
            return IntStream.range(0, this.n).parallel().mapToObj(new -$$Lambda$Collections$CopiesList$JkPuGMNhrKbnEHjebm8AvHc2xHw(this));
        }
            ...
            if (distance != 0) {
                ...
                while (nMoved != size) {
                    ...
                    do {
                        ...
                        displaced = list.set(nMoved, displaced);
                        nMoved2++;
                    } while (nMoved != cycleStart);
                    cycleStart++;
                    nMoved = nMoved2;
                }
            }
