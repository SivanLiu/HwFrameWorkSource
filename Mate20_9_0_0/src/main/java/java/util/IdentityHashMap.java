...
public class IdentityHashMap<K, V> extends AbstractMap<K, V> implements Map<K, V>, Serializable, Cloneable {
                        ...
                        if (i >= 0) {
                            ...
                            if (i <= a.length) {
                                for (int i2 = i; i2 < hi; i2 += 2) {
                                    Object key = a[i2];
                                    if (key != null) {
                                        action.accept(new SimpleImmutableEntry(IdentityHashMap.unmaskNull(key), a[i2 + 1]));
                                    }
                                }
    ...
    public IdentityHashMap(int expectedMaxSize) {
        ...
        stringBuilder.append(expectedMaxSize);
    ...
    /* JADX WARNING: Missing block: B:11:0x002d, code skipped:
            if (resize(r2) == false) goto L_0x0030;
     */
