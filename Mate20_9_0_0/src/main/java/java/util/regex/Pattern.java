...
public final class Pattern implements Serializable {
    ...
    public static String[] fastSplit(String re, String input, int limit) {
        ...
        while (separatorCount + 1 != limit) {
            indexOf = input.indexOf(ch, begin);
            end = indexOf;
            if (indexOf == -1) {
                break;
            }
        ...
        if (limit == 0 && begin == indexOf) {
            if (separatorCount == indexOf) {
        ...
        result[separatorCount] = input.substring(begin, indexOf);
        return result;
    }
    ...
    private Pattern(String p, int f) {
        if ((f & 128) != 0) {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Unsupported flags: ");
            stringBuilder.append((~127) & f);
    ...
    public Predicate<String> asPredicate() {
        return new -$$Lambda$Pattern$2enjXc1GhR-FNtcTfhbg9qy2smk(this);
    }
