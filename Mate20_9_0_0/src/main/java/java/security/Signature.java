...
public abstract class Signature extends SignatureSpi {
    ...
    private static class Delegate extends Signature {
        ...
        private static SignatureSpi newInstance(Service s) throws NoSuchAlgorithmException {
            ...
            stringBuilder.append("Not a SignatureSpi: ");
    ...
    public static Signature getInstance(String algorithm) throws NoSuchAlgorithmException {
        ...
        if (t.hasNext()) {
            ...
            stringBuilder.append(" Signature not available");
            throw new NoSuchAlgorithmException(stringBuilder.toString());
        }
    }
    ...
    private static Signature getInstanceRSA(Provider p) throws NoSuchAlgorithmException {
        ...
        try {
            ...
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("no such algorithm: NONEwithRSA for provider ");
            stringBuilder.append(p.getName());
            throw new NoSuchAlgorithmException(stringBuilder.toString(), e);
        }
    }
    ...
    public String toString() {
        ...
        stringBuilder.append(getAlgorithm());
        stringBuilder.append(initState);
