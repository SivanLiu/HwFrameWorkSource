...
public final class Inet6Address extends InetAddress {
    ...
    private class Inet6AddressHolder {
        ...
        boolean isLoopbackAddress() {
            ...
            return test == (byte) 0 && this.ipaddress[15] == (byte) 1;
        }
    ...
    private void initstr(String hostName, byte[] addr, String ifname) throws UnknownHostException {
        ...
        try {
            ...
            stringBuilder.append("no such interface ");
    ...
    private int deriveNumericScope(String ifname) throws UnknownHostException {
        try {
            ...
            stringBuilder.append("No matching address found for interface : ");
            stringBuilder.append(ifname);
            throw new UnknownHostException(stringBuilder.toString());
        } catch (SocketException e) {
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        if (getClass().getClassLoader() == Class.class.getClassLoader()) {
            ...
            if (ipaddress2.length != 16) {
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("invalid address length: ");
                stringBuilder.append(ipaddress2.length);
