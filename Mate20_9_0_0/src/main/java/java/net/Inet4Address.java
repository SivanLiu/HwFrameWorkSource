...
public final class Inet4Address extends InetAddress {
    ...
    public boolean isMCGlobal() {
        ...
        return ((byteAddr[0] & 255) == 224 && byteAddr[1] == (byte) 0 && byteAddr[2] == (byte) 0) ? false : true;
    }
    ...
    static String numericToTextFormat(byte[] src) {
        ...
        stringBuilder.append(src[0] & 255);
        stringBuilder.append(".");
        stringBuilder.append(src[1] & 255);
        stringBuilder.append(".");
        stringBuilder.append(src[2] & 255);
        stringBuilder.append(".");
        stringBuilder.append(src[3] & 255);
