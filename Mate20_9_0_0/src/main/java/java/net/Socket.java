...
public class Socket implements Closeable {
    ...
    private void checkAddress(InetAddress addr, String op) {
        if (addr != null && !(addr instanceof Inet4Address) && !(addr instanceof Inet6Address)) {
            ...
            stringBuilder.append(": invalid address type");
    ...
    public String toString() {
        try {
            if (isConnected()) {
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("Socket[address=");
                stringBuilder.append(getImpl().getInetAddress());
                stringBuilder.append(",port=");
                stringBuilder.append(getImpl().getPort());
                stringBuilder.append(",localPort=");
                stringBuilder.append(getImpl().getLocalPort());
