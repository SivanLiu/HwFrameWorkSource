...
public abstract class URLConnection {
    ...
    private ContentHandler lookupContentHandlerClassFor(String contentType) throws InstantiationException, IllegalAccessException, ClassNotFoundException {
        ...
        while (packagePrefixIter.hasMoreTokens()) {
            ...
            try {
                ...
                clsName.append(".");
                clsName.append(contentHandlerClassName);
    ...
    private String getContentHandlerPkgPrefixes() {
        ...
        if (packagePrefixList != "") {
            ...
            stringBuilder.append(packagePrefixList);
            stringBuilder.append("|");
            packagePrefixList = stringBuilder.toString();
        }
        stringBuilder = new StringBuilder();
        stringBuilder.append(packagePrefixList);
        stringBuilder.append(contentClassPrefix);
        return stringBuilder.toString();
    }
    ...
    public static String guessContentTypeFromStream(InputStream is) throws IOException {
        ...
        is.reset();
        int c162 = c16;
        if (c1 == HttpURLConnection.HTTP_ACCEPTED && c2 == 254 && c3 == 186 && c4 == 190) {
        ...
        int c163;
        if (c1 == 0 && c2 == 0 && c3 == 254 && c4 == 255 && c5 == 0 && c6 == 0 && c7 == 0 && c8 == 60 && c9 == 0 && c10 == 0 && c11 == 0 && c12 == 63 && c13 == 0 && c14 == 0 && c15 == 0) {
            c163 = c162;
            if (c163 == 120) {
                return "application/xml";
            }
        ...
        c163 = c162;
        if (c1 == 255 && c2 == 254 && c3 == 0 && c4 == 0 && c5 == 60 && c6 == 0 && c7 == 0 && c8 == 0 && c9 == 63 && c10 == 0 && c11 == 0 && c12 == 0 && c13 == 120 && c14 == 0 && c15 == 0 && c163 == 0) {
            return "application/xml";
        }
    ...
    private static boolean checkfpx(InputStream is) throws IOException {
        ...
        long posn = skipForward;
        if (skipForward < 28) {
            is.reset();
            return false;
        }
        int[] c = new int[16];
        if (readBytes(c, 2, inputStream) < 0) {
            is.reset();
            return false;
        }
        int byteOrder = c[0];
        ...
        posn += 2;
        long toSkip = 48 - posn;
        long skipForward2 = skipForward(inputStream, toSkip);
        long skipped = skipForward2;
        if (skipForward2 < toSkip) {
            is.reset();
            return false;
        }
        posn += skipped;
        if (readBytes(c, 4, inputStream) < 0) {
            is.reset();
            return false;
        }
        int sectDirStart;
        ...
        int sectDirStart2 = sectDirStart;
        posn += 4;
        is.reset();
        int byteOrder2 = byteOrder;
        long toSkip2 = (512 + (((long) (1 << uSectorShift)) * ((long) sectDirStart2))) + 80;
        if (toSkip2 < 0) {
            return false;
        }
        inputStream.mark(((int) toSkip2) + 48);
        if (skipForward(inputStream, toSkip2) < toSkip2) {
            is.reset();
            return false;
        } else if (readBytes(c, 16, inputStream) < 0) {
            is.reset();
            return false;
        } else if (byteOrder2 == 254 && c[0] == 0 && c[2] == 97 && c[3] == 86 && c[4] == 84 && c[5] == 193 && c[6] == HttpURLConnection.HTTP_PARTIAL && c[7] == 17 && c[8] == 133 && c[9] == 83 && c[10] == 0 && c[11] == 170 && c[12] == 0 && c[13] == 161 && c[14] == 249 && c[15] == 91) {
            is.reset();
            return true;
