...
public final class HttpCookie implements Cloneable {
    ...
    /* JADX WARNING: Missing block: B:16:0x0044, code skipped:
            if (r10.equalsIgnoreCase(r7.toString()) != false) goto L_0x0046;
     */
    ...
    public static boolean domainMatches(String domain, String host) {
        ...
        if (lengthDiff > 0) {
            ...
            if (host.substring(lengthDiff).equalsIgnoreCase(domain) && ((domain.startsWith(".") && isFullyQualifiedDomainName(domain, 1)) || isLocalDomain)) {
                z = true;
            }
            return z;
