    ...
    private static TemporalAccessor adjust(final TemporalAccessor temporal, DateTimeFormatter formatter) {
        ...
        if (overrideZone != null) {
            if (temporal.isSupported(ChronoField.INSTANT_SECONDS)) {
                ...
                stringBuilder.append((Object) overrideZone);
            ...
            if (!(overrideChrono == IsoChronology.INSTANCE && temporalChrono == null)) {
                for (ChronoField f : ChronoField.values()) {
                    if (f.isDateBased() && temporal.isSupported(f)) {
                        ...
                        stringBuilder2.append("Unable to apply override chronology '");
                        stringBuilder2.append(overrideChrono);
                        stringBuilder2.append("' because the temporal object being formatted contains date fields but does not represent a whole date: ");
                        stringBuilder2.append((Object) temporal);
