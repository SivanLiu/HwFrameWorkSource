...
public final class LocalDateTime implements Temporal, TemporalAdjuster, ChronoLocalDateTime<LocalDate>, Serializable {
    ...
    private LocalDateTime plusWithOverflow(LocalDate newDate, long hours, long minutes, long seconds, long nanos, int sign) {
        ...
        long totDays = ((((nanos / 86400000000000L) + (seconds / 86400)) + (minutes / 1440)) + (hours / 24)) * ((long) i);
        ...
        long totNanos2 = (((long) i) * totNanos) + curNoD;
        totDays += Math.floorDiv(totNanos2, 86400000000000L);
