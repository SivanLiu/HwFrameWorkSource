...
public class SipFactory {
    ...
    public synchronized SipStack createSipStack(Properties properties) throws PeerUnavailableException {
        ...
        if (sipStack == null) {
            String implClassName = new StringBuilder();
            implClassName.append("gov.nist.");
            implClassName.append(SipStack.class.getCanonicalName());
            implClassName.append("Impl");
            implClassName = implClassName.toString();
            try {
                ...
                stringBuilder.append("Failed to initiate ");
                stringBuilder.append(implClassName);
                throw new PeerUnavailableException(stringBuilder.toString(), e);
            }
        }
        return sipStack;
    }
