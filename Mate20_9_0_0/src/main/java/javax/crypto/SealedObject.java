...
public class SealedObject implements Serializable {
    ...
    private Object unseal(Key key, String provider) throws IOException, ClassNotFoundException, NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
            ...
            if (provider != null) {
                try {
                    ...
                    if (provider == null) {
                        ...
                        stringBuilder.append(this.paramsAlg);
        ...
        if (provider != null) {
            try {
                nspe = Cipher.getInstance(this.sealAlg, provider);
            } catch (NoSuchPaddingException e) {
                throw new NoSuchAlgorithmException("Padding that was used in sealing operation not available");
            } catch (NoSuchProviderException nspe3) {
                if (provider == null) {
                    stringBuilder = new StringBuilder();
                    stringBuilder.append(this.sealAlg);
                    stringBuilder.append(" not found");
                    throw new NoSuchAlgorithmException(stringBuilder.toString());
                }
                throw new NoSuchProviderException(nspe3.getMessage());
            }
        }
        nspe3 = Cipher.getInstance(this.sealAlg);
        if (params != null) {
            try {
                nspe3.init(2, key, params);
            } catch (InvalidAlgorithmParameterException iape) {
                throw new RuntimeException(iape.getMessage());
            }
        }
        nspe3.init(2, key);
        ObjectInput a = new extObjectInputStream(new ByteArrayInputStream(nspe3.doFinal(this.encryptedContent)));
        try {
            Object obj = a.readObject();
            return obj;
        } finally {
