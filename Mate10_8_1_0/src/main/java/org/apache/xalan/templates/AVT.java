    ...
    public AVT(StylesheetHandler handler, String uri, String name, String rawName, String stringedValue, ElemTemplateElement owner) throws TransformerException {
        ...
        if (nTokens < 2) {
            ...
            while (tokenizer.hasMoreTokens()) {
                    ...
                    switch (t.charAt(0)) {
                        ...
                        case '{':
                            try {
                                        ...
                                        if (lookahead.length() == 1) {
                                            switch (lookahead.charAt(0)) {
                                                ...
                                                case '\'':
                                                    ...
                                                    break;
                                                case '{':
                                                    str = XSLMessages.createMessage(XSLTErrorResources.ER_NO_CURLYBRACE, null);
                                                    lookahead = null;
                                                    break;
                                                case '}':
                                                    buffer.setLength(0);
                                ...
                                str = XSLMessages.createMessage(XSLTErrorResources.ER_ILLEGAL_ATTRIBUTE_VALUE, new Object[]{name, stringedValue});
                                continue;
                            } catch (Throwable th) {
                            }
                        case '}':
                ...
                if (str != null) {
                    handler.warn(XSLTErrorResources.WG_ATTR_TEMPLATE, new Object[]{str});
                }
            }
            if (buffer.length() > 0) {
                this.m_parts.addElement(new AVTPartSimple(buffer.toString()));
