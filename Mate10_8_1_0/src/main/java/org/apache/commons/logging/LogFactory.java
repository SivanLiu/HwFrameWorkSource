        ...
        try {
                ...
                if (newProps != null) {
                    if (properties == null) {
                        ...
                        if (newPriority > priority) {
                            if (isDiagnosticsEnabled()) {
                                logDiagnostic("[LOOKUP] Properties file at '" + url + "'" + " with priority " + newPriority + " overrides file at '" + obj + "'" + " with priority " + priority);
                            }
                            obj = url;
                            properties = newProps;
                            priority = newPriority;
                        } else if (isDiagnosticsEnabled()) {
                            logDiagnostic("[LOOKUP] Properties file at '" + url + "'" + " with priority " + newPriority + " does not override file at '" + obj + "'" + " with priority " + priority);
                        }
                    }
                }
            }
            if (isDiagnosticsEnabled()) {
                if (properties == null) {
                    ...
                    logDiagnostic("[LOOKUP] Properties file of name '" + fileName + "' found at '" + obj + '\"');
                }
            }
            return properties;
        } catch (SecurityException e) {
