...
*/
    ...
    protected void serializeAttList(Element node) throws SAXException {
        ...
        for (int i = 0; i < nAttrs; i++) {
            ...
            int startsWith = !attrName.equals("xmlns") ? attrName.startsWith(Constants.ATTRNAME_XMLNS) : 1;
            if ((this.fFeatures & 16384) != 0) {
                        ...
                        if ("".equals(attrPrefix) || "".equals(declAttrPrefix) || (attrPrefix.equals(declAttrPrefix) ^ 1) != 0) {
                            if (declAttrPrefix != null && ("".equals(declAttrPrefix) ^ 1) != 0) {
                                ...
                                if ((this.fFeatures & 512) != 0) {
                                    this.fSerializer.addAttribute("http://www.w3.org/2000/xmlns/", attrPrefix, Constants.ATTRNAME_XMLNS + attrPrefix, "CDATA", namespaceURI);
            ...
            if (applyFilter && this.fFilter != null && (this.fFilter.getWhatToShow() & 2) != 0 && startsWith == 0) {
            ...
            if (!addAttr || startsWith == 0) {
                if (addAttr && (startsWith ^ 1) != 0) {
            ...
            if (!(startsWith == 0 || (this.fFeatures & 512) == 0)) {
                String prefix;
