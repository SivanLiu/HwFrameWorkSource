...
public class StylesheetPIHandler extends DefaultHandler {
    ...
    public void processingInstruction(String target, String data) throws SAXException {
        if (target.equals("xml-stylesheet")) {
            ...
            if (type != null && ((type.equals("text/xsl") || type.equals("text/xml") || type.equals("application/xml+xslt")) && r3 != null && (this.m_media == null || (r5 != null && r5.equals(this.m_media))))) {
                if (this.m_charset != null && (r2 == null || !r2.equals(this.m_charset))) {
                    return;
                }
                if (this.m_title == null || (r9 != null && r9.equals(this.m_title))) {
