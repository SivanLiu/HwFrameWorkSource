...
public class SAX2DTM2 extends SAX2DTM {
        ...
        public DTMAxisIterator setStartNode(int node) {
            ...
            if (nodeType >= 14) {
                ...
                while (nodeID != -1) {
                    ...
                    if (eType >= 14 || eType != nodeType) {
                        if (eType >= 14 && SAX2DTM2.this.m_extendedTypes[eType].getNodeType() == nodeType) {
                        }
                        nodeID = SAX2DTM2.this._parent2(nodeID);
                    }
                    if (this.m_size >= this.m_ancestors.length) {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
        ...
        if (this.m_wsfilter != null) {
            ...
            boolean shouldStripWhitespace = (short) 3 == wsv ? getShouldStripWhitespace() : (short) 2 == wsv;
    ...
    protected final String copyElement(int nodeID, int exptype, SerializationHandler handler) throws SAXException {
        ...
        if (prefixIndex > 0) {
            substring = qName.substring(0, prefixIndex);
        } else {
            substring = null;
        }
        handler.namespaceAfterStartElement(substring, uri);
        return qName;
    }
    ...
    protected final void copyAttribute(int nodeID, int exptype, SerializationHandler handler) throws SAXException {
        ...
        if (dataIndex <= 0) {
            ...
            str = this.m_valuesOrPrefixes.indexToString(prefixIndex);
        ...
        handler.addAttribute(prefix != null ? str : localName, (String) this.m_values.elementAt(valueIndex));
    }
}
