...
public final class RILImsCallV1_2 {
    ...
    public final String toString() {
        ...
        builder.append(", .imsDomain = ");
        builder.append(this.imsDomain);
        ...
        builder.append(this.redirectNumberPresentation);
        builder.append("}");
    ...
    public static final ArrayList<RILImsCallV1_2> readVectorFromParcel(HwParcel parcel) {
        ArrayList<RILImsCallV1_2> _hidl_vec = new ArrayList();
        HwBlob _hidl_blob = parcel.readBuffer(16);
        int _hidl_vec_size = _hidl_blob.getInt32(8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 112), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            RILImsCallV1_2 _hidl_vec_element = new RILImsCallV1_2();
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.imsDomain = _hidl_blob.getInt32(84 + _hidl_offset);
        this.redirectNumber = _hidl_blob.getString(88 + _hidl_offset);
        parcel.readEmbeddedBuffer((long) (this.redirectNumber.getBytes().length + 1), _hidl_blob.handle(), 0 + (88 + _hidl_offset), false);
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<RILImsCallV1_2> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((RILImsCallV1_2) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 112));
        }
