...
public final class RilConstS32 {
    ...
    public static final int RIL_REQUEST_HW_ACTIVE_NCFG_BIN = 359;
    ...
    public static final int RIL_REQUEST_HW_GET_CSGIDSRCH_INFO = 356;
    public static final int RIL_REQUEST_HW_GET_CTROAMINFO = 299;
    public static final int RIL_REQUEST_HW_GET_CURRENT_CALLS_V1_2 = 361;
    ...
    public static final int RIL_REQUEST_HW_GET_IMS_SMS_CONFIG = 355;
    ...
    public static final int RIL_REQUEST_HW_IMS_GET_CURRENT_CALLS_V1_2 = 360;
    ...
    public static final int RIL_REQUEST_HW_SET_DATA_ROAM_SWITCH = 353;
    public static final int RIL_REQUEST_HW_SET_DATA_SUBSCRIPTION = 145;
    public static final int RIL_REQUEST_HW_SET_DATA_SWITCH = 352;
    public static final int RIL_REQUEST_HW_SET_DEEP_NO_DISTURB_SWITCH = 358;
    ...
    public static final int RIL_REQUEST_HW_SET_IMS_SMS_CONFIG = 354;
    ...
    public static final int RIL_REQUEST_HW_SET_REATTACH_REQUIRED_UNSOL = 357;
    ...
    public static final int RIL_UNSOL_HW_DSDS_MODE_STATE_IND = 1134;
    ...
    public static final int RIL_UNSOL_HW_HPLMN_IND = 1133;
    public static final int RIL_UNSOL_HW_ICCID_CHANGED_IND = 1130;
    ...
    public static final int RIL_UNSOL_HW_IMS_REG_TYPE_IND = 1131;
    ...
    public static final int RIL_UNSOL_HW_LOW_TEMPRATURE = 1135;
    ...
    public static final int RIL_UNSOL_HW_MIMO_STATE_IND = 1136;
    ...
    public static final int RIL_UNSOL_HW_SYS_INFO_IND = 1132;
...
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: vendor.huawei.hardware.radio.V1_2.RilConstS32.dumpBitfield(int):java.lang.String
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: vendor.huawei.hardware.radio.V1_2.RilConstS32.dumpBitfield(int):java.lang.String");
    }
    ...
    public static final String toString(int o) {
        ...
        if (o == RIL_REQUEST_HW_SET_DATA_SWITCH) {
            return "RIL_REQUEST_HW_SET_DATA_SWITCH";
        }
        if (o == RIL_REQUEST_HW_SET_DATA_ROAM_SWITCH) {
            return "RIL_REQUEST_HW_SET_DATA_ROAM_SWITCH";
        }
        if (o == RIL_REQUEST_HW_SET_IMS_SMS_CONFIG) {
            return "RIL_REQUEST_HW_SET_IMS_SMS_CONFIG";
        }
        if (o == RIL_REQUEST_HW_GET_IMS_SMS_CONFIG) {
            return "RIL_REQUEST_HW_GET_IMS_SMS_CONFIG";
        }
        if (o == RIL_REQUEST_HW_GET_CSGIDSRCH_INFO) {
            return "RIL_REQUEST_HW_GET_CSGIDSRCH_INFO";
        }
        if (o == RIL_REQUEST_HW_SET_REATTACH_REQUIRED_UNSOL) {
            return "RIL_REQUEST_HW_SET_REATTACH_REQUIRED_UNSOL";
        }
        if (o == RIL_REQUEST_HW_SET_DEEP_NO_DISTURB_SWITCH) {
            return "RIL_REQUEST_HW_SET_DEEP_NO_DISTURB_SWITCH";
        }
        if (o == RIL_REQUEST_HW_ACTIVE_NCFG_BIN) {
            return "RIL_REQUEST_HW_ACTIVE_NCFG_BIN";
        }
        if (o == RIL_REQUEST_HW_IMS_GET_CURRENT_CALLS_V1_2) {
            return "RIL_REQUEST_HW_IMS_GET_CURRENT_CALLS_V1_2";
        }
        if (o == RIL_REQUEST_HW_GET_CURRENT_CALLS_V1_2) {
            return "RIL_REQUEST_HW_GET_CURRENT_CALLS_V1_2";
        }
        if (o == RIL_UNSOL_HW_ICCID_CHANGED_IND) {
            return "RIL_UNSOL_HW_ICCID_CHANGED_IND";
        }
        if (o == RIL_UNSOL_HW_IMS_REG_TYPE_IND) {
            return "RIL_UNSOL_HW_IMS_REG_TYPE_IND";
        }
        if (o == RIL_UNSOL_HW_SYS_INFO_IND) {
            return "RIL_UNSOL_HW_SYS_INFO_IND";
        }
        if (o == RIL_UNSOL_HW_HPLMN_IND) {
            return "RIL_UNSOL_HW_HPLMN_IND";
        }
        if (o == RIL_UNSOL_HW_DSDS_MODE_STATE_IND) {
            return "RIL_UNSOL_HW_DSDS_MODE_STATE_IND";
        }
        if (o == RIL_UNSOL_HW_LOW_TEMPRATURE) {
            return "RIL_UNSOL_HW_LOW_TEMPRATURE";
        }
        if (o == RIL_UNSOL_HW_MIMO_STATE_IND) {
