...
public interface IRadioIndication extends vendor.huawei.hardware.radio.V1_0.IRadioIndication {
    public static final String kInterfaceName = "vendor.huawei.hardware.radio@1.2::IRadioIndication";
    ...
    public static abstract class Stub extends HwBinder implements IRadioIndication {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList(Arrays.asList(new String[]{IRadioIndication.kInterfaceName, vendor.huawei.hardware.radio.V1_0.IRadioIndication.kInterfaceName, android.hardware.radio.V1_0.IRadioIndication.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 45:
                    ...
                    return;
                case 46:
                    _hidl_request.enforceInterface(vendor.huawei.hardware.radio.V1_0.IRadioIndication.kInterfaceName);
                    type = _hidl_request.readInt32();
    ...
    public static final class Proxy implements IRadioIndication {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.radio@1.2::IRadioIndication]@Proxy";
            }
        }
        ...
        public void UnsolMsg(int type, int MsgId, RILUnsolMsgPayload payload) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.huawei.hardware.radio.V1_0.IRadioIndication.kInterfaceName);
            _hidl_request.writeInt32(type);
