package vendor.huawei.hardware.wifi.supplicant.V1_1;
...
public interface ISupplicantStaNetwork extends vendor.huawei.hardware.wifi.supplicant.V1_0.ISupplicantStaNetwork {
    public static final String kInterfaceName = "vendor.huawei.hardware.wifi.supplicant@1.1::ISupplicantStaNetwork";
    ...
    public static final class Proxy implements ISupplicantStaNetwork {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.huawei.hardware.wifi.supplicant@1.1::ISupplicantStaNetwork]@Proxy";
            }
        }
        ...
        public SupplicantStatus setWAPIASCert(String path) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.huawei.hardware.wifi.supplicant.V1_0.ISupplicantStaNetwork.kInterfaceName);
            _hidl_request.writeString(path);
            HwParcel _hidl_reply = new HwParcel();
            try {
    ...
    public static abstract class Stub extends HwBinder implements ISupplicantStaNetwork {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList(Arrays.asList(new String[]{ISupplicantStaNetwork.kInterfaceName, vendor.huawei.hardware.wifi.supplicant.V1_0.ISupplicantStaNetwork.kInterfaceName, android.hardware.wifi.supplicant.V1_0.ISupplicantStaNetwork.kInterfaceName, ISupplicantNetwork.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case StatusCode.U_APSD_COEX_NOT_SUPPORTED /*73*/:
                    _hidl_request.enforceInterface(vendor.huawei.hardware.wifi.supplicant.V1_0.ISupplicantStaNetwork.kInterfaceName);
                ...
                case StatusCode.ANTI_CLOGGING_TOKEN_REQ /*76*/:
                    ...
                    _hidl_out_status = hwStaNetworkRegisterCallback(ISupplicantStaNetworkCallback.asInterface(_hidl_request.readStrongBinder()));
                    _hidl_reply.writeStatus(0);
                    _hidl_out_status.writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    return;
