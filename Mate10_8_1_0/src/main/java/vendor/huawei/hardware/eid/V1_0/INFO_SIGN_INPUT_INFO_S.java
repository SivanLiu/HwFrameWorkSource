...
public final class INFO_SIGN_INPUT_INFO_S {
    ...
    public final byte[] info = new byte[2048];
    public int infoLen;
    ...
    public final boolean equals(Object otherObject) {
        ...
        return this.encryptionMethod == other.encryptionMethod && this.infoLen == other.infoLen && this.splitTimes == other.splitTimes && HidlSupport.deepEquals(this.info, other.info);
    }

    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.encryptionMethod))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.infoLen))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.splitTimes))), Integer.valueOf(HidlSupport.deepHashCode(this.info))});
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_0_0 = 0; _hidl_index_0_0 < 2048; _hidl_index_0_0++) {
            this.info[_hidl_index_0_0] = _hidl_blob.getInt8(_hidl_array_offset_0);
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<INFO_SIGN_INPUT_INFO_S> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((INFO_SIGN_INPUT_INFO_S) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 2060));
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        long _hidl_array_offset_0 = _hidl_offset + 12;
        for (int _hidl_index_0_0 = 0; _hidl_index_0_0 < 2048; _hidl_index_0_0++) {
            _hidl_blob.putInt8(_hidl_array_offset_0, this.info[_hidl_index_0_0]);
            _hidl_array_offset_0++;
        }
    }
}
