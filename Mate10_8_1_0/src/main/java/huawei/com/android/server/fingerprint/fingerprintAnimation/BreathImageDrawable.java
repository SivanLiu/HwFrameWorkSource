...
public class BreathImageDrawable extends BitmapDrawable {
    ...
    private AnimatorSet mBreathAnim;
    ...
    private void resetBreathAnim() {
        if (this.mBreathAnim != null && this.mBreathAnim.isRunning()) {
    ...
    public void startTouchDownBreathAnim() {
        ...
        if (this.mBreathTouchAnim == null || this.mBreathCircleAnim == null) {
            Log.e(TAG, "mBreathTouchAnim or mBreathCircleAnim is null");
            return;
        }
    ...
    public int getIntrinsicWidth() {
        ...
        int secondWidth = this.mCircleDrawable == null ? 0 : this.mCircleDrawable.getIntrinsicWidth();
    ...
    public int getIntrinsicHeight() {
        ...
        int secondHeight = this.mCircleDrawable == null ? 0 : this.mCircleDrawable.getIntrinsicHeight();
        if (maxHeight > secondHeight) {
            return maxHeight;
        }
        return secondHeight;
    }
