...
public class HwScreenOnProximityLock {
    ...
    public static final int LOCK_GOAWAY = 5;
    ...
    private class ProximitySensorListener implements SensorEventListener {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            if (d >= GestureNavConst.BOTTOM_WINDOW_SINGLE_HAND_RATIO && d < HwScreenOnProximityLock.this.mProximityThreshold) {
                z = true;
            }
            this.mIsProximity = z;
            handleSensorChanges();
    ...
    private void showHintView() {
        synchronized (this.mLock) {
            ...
            if (hintView == null) {
            } else if (hintView.getVisibility() != 0 && this.mViewAttached) {
