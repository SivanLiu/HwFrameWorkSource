...
public interface IAodCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAodCallback {
        private static final String DESCRIPTOR = "huawei.android.aod.IAodCallback";
        static final int TRANSACTION_onAodStateChange = 1;
        ...
        private static class Proxy implements IAodCallback {
            ...
            public void onAodStateChange(int state) throws RemoteException {
    ...
    void onAodStateChange(int i) throws RemoteException;
}
