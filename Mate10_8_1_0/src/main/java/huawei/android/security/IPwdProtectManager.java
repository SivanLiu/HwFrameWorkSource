    ...
    public static abstract class Stub extends Binder implements IPwdProtectManager {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    _result = modifyPrivPwd(data.readString());
                    reply.writeNoException();
                    if (_result) {
                        i = 1;
                    }
                ...
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    _result = modifyMainPwd(data.readString(), data.readString());
                    reply.writeNoException();
                    if (_result) {
                        i = 1;
                    }
                ...
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = decodeCurrentPwd(data.readString(), data.readString());
                    reply.writeNoException();
                    reply.writeString(_result2);
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    _result = startPwdProtect(data.readString(), data.readString(), data.readString(), data.readString());
                    reply.writeNoException();
                    if (_result) {
                        i = 1;
                    }
                ...
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    _result = pwdQAnswerVertify(data.createByteArray());
                    reply.writeNoException();
                    if (_result) {
                        i = 1;
                    }
