...
public class FaceRecognizeManagerImpl {
    ...
    public static class CallbackHolder {
        ...
        public void onCallbackEvent(int reqId, int type, int code, int errorCode) {
            LogUtil.i(FaceRecognizeManagerImpl.TAG, "reqId(" + reqId + "), type(" + FaceRecognizeManagerImpl.getTypeString(type) + "), code(" + FaceRecognizeManagerImpl.getCodeString(code) + "), result(" + FaceRecognizeManagerImpl.getErrorCodeString(code, errorCode) + ")");
            ...
            if (this.mService == null) {
                ...
                if (this.mService == null) {
                    ...
                    try {
                        ...
                        LogUtil.w(FaceRecognizeManagerImpl.TAG, "failed to linkToDeath" + e.getMessage());
                    }
                }
            }
