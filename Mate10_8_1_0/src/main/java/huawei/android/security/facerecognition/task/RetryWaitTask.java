...
public class RetryWaitTask extends FaceRecognizeTask implements EventListener {
    ...
    public RetryWaitTask(HwSecurityTaskBase parent, RetCallback callback, FaceRecognizeRequest request) {
