...
public class DynamicAddItemListView extends ListView {
    ...
    public DynamicAddItemListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mDynamicAddItemLayout = LayoutInflater.from(context).inflate(50790400, null);
        this.mTextView = (TextView) this.mDynamicAddItemLayout.findViewById(50659346);
        this.mEditText = (EditText) this.mDynamicAddItemLayout.findViewById(50659334);
        this.mEditText.setBackground(null);
        this.mCancelButton = (Button) this.mDynamicAddItemLayout.findViewById(50659331);
        this.mConfirmButton = (Button) this.mDynamicAddItemLayout.findViewById(50659332);
        this.mCustomPanel = (ViewGroup) this.mDynamicAddItemLayout.findViewById(50659333);
        this.mErrorTipTextLayout = (ErrorTipTextLayout) this.mDynamicAddItemLayout.findViewById(50659335);
        this.mOriPaddingStart = this.mEditText.getPaddingStart();
        this.mOriPaddingEnd = this.mEditText.getPaddingEnd();
        this.mPaddingHorizontal = context.getResources().getDimensionPixelOffset(50593794);
        this.mPaddingVertical = context.getResources().getDimensionPixelOffset(50593795);
        this.mTipPadding = context.getResources().getDimensionPixelOffset(50593793);
