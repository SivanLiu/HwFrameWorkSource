...
public interface ISurfaceFlingerConfigs extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements ISurfaceFlingerConfigs {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList(Arrays.asList(new String[]{ISurfaceFlingerConfigs.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList(Arrays.asList(new byte[][]{new byte[]{Byte.MAX_VALUE, (byte) 95, (byte) -24, (byte) -12, (byte) -8, (byte) -94, (byte) 64, (byte) 55, (byte) 21, (byte) 60, (byte) 80, (byte) 77, (byte) -117, (byte) 77, (byte) 51, (byte) 19, (byte) -62, (byte) -50, (byte) 51, (byte) -40, (byte) 28, (byte) -116, (byte) 105, (byte) -2, (byte) 81, (byte) -108, (byte) -35, (byte) -46, (byte) -44, (byte) 8, UsbDescriptor.CLASSID_VIDEO, (byte) 114}, new byte[]{(byte) -67, (byte) -38, (byte) -74, (byte) 24, (byte) 77, (byte) 122, (byte) 52, (byte) 109, (byte) -90, (byte) -96, (byte) 125, (byte) -64, UsbASFormat.EXT_FORMAT_TYPE_II, (byte) -116, (byte) -15, (byte) -102, (byte) 105, (byte) 111, (byte) 76, (byte) -86, (byte) 54, UsbDescriptor.CLASSID_BILLBOARD, (byte) -59, (byte) 31, (byte) 46, (byte) 20, (byte) 86, (byte) 90, (byte) 20, (byte) -76, (byte) 15, (byte) -39}}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            OptionalInt64 _hidl_out_value;
            OptionalBool _hidl_out_value2;
            switch (_hidl_code) {
                case 1:
                    _hidl_request.enforceInterface(ISurfaceFlingerConfigs.kInterfaceName);
                    _hidl_out_value = vsyncEventPhaseOffsetNs();
                ...
                case 2:
                    _hidl_request.enforceInterface(ISurfaceFlingerConfigs.kInterfaceName);
                    _hidl_out_value = vsyncSfEventPhaseOffsetNs();
                    _hidl_reply.writeStatus(0);
                    _hidl_out_value.writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    return;
                case 3:
                    _hidl_request.enforceInterface(ISurfaceFlingerConfigs.kInterfaceName);
                    _hidl_out_value2 = useContextPriority();
                    _hidl_reply.writeStatus(0);
                ...
                case 4:
                    _hidl_request.enforceInterface(ISurfaceFlingerConfigs.kInterfaceName);
                    _hidl_out_value2 = hasWideColorDisplay();
                    _hidl_reply.writeStatus(0);
                    _hidl_out_value2.writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    return;
                case 5:
                    _hidl_request.enforceInterface(ISurfaceFlingerConfigs.kInterfaceName);
                    _hidl_out_value2 = hasHDRDisplay();
                    _hidl_reply.writeStatus(0);
                    _hidl_out_value2.writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    return;
                case 6:
                    _hidl_request.enforceInterface(ISurfaceFlingerConfigs.kInterfaceName);
                    _hidl_out_value = presentTimeOffsetFromVSyncNs();
                    _hidl_reply.writeStatus(0);
                    _hidl_out_value.writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    return;
                case 7:
                    _hidl_request.enforceInterface(ISurfaceFlingerConfigs.kInterfaceName);
                    _hidl_out_value2 = useHwcForRGBtoYUV();
                    _hidl_reply.writeStatus(0);
                    _hidl_out_value2.writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    return;
                case 8:
                    _hidl_request.enforceInterface(ISurfaceFlingerConfigs.kInterfaceName);
                    OptionalUInt64 _hidl_out_value3 = maxVirtualDisplaySize();
                    _hidl_reply.writeStatus(0);
                ...
                case 9:
                    _hidl_request.enforceInterface(ISurfaceFlingerConfigs.kInterfaceName);
                    _hidl_out_value2 = hasSyncFramework();
                    _hidl_reply.writeStatus(0);
                    _hidl_out_value2.writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    return;
                ...
                case 11:
                    _hidl_request.enforceInterface(ISurfaceFlingerConfigs.kInterfaceName);
                    _hidl_out_value = maxFrameBufferAcquiredBuffers();
                    _hidl_reply.writeStatus(0);
                    _hidl_out_value.writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    return;
                case 12:
                    _hidl_request.enforceInterface(ISurfaceFlingerConfigs.kInterfaceName);
                    _hidl_out_value2 = startGraphicsAllocatorService();
                    _hidl_reply.writeStatus(0);
                    _hidl_out_value2.writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    return;
