...
public interface IDisplayManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IDisplayManager {
        ...
        static final int TRANSACTION_getLowPowerDisplayLevel = 19;
        ...
        static final int TRANSACTION_setLowPowerDisplayLevel = 20;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 14:
                    ...
                    _result = createVirtualDisplay(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, surface, data.readInt(), data.readString());
                    reply.writeNoException();
