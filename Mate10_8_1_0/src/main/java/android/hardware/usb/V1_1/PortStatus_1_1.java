...
public final class PortStatus_1_1 {
    ...
    public final boolean equals(Object otherObject) {
        ...
        return HidlSupport.deepEquals(this.status, other.status) && HidlSupport.deepEquals(Integer.valueOf(this.supportedModes), Integer.valueOf(other.supportedModes)) && this.currentMode == other.currentMode;
    }
    ...
    public final String toString() {
        ...
        builder.append(PortMode_1_1.dumpBitfield(this.supportedModes));
        builder.append(", .currentMode = ");
        builder.append(PortMode_1_1.toString(this.currentMode));
        builder.append("}");
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<PortStatus_1_1> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((PortStatus_1_1) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 48));
        }
