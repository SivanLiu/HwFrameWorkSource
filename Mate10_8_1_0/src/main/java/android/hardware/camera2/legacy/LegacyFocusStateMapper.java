...
public class LegacyFocusStateMapper {
    ...
    public void processRequestTriggers(CaptureRequest captureRequest, Parameters parameters) {
        ...
        if (!(afMode.equals("auto") || afMode.equals(Parameters.FOCUS_MODE_MACRO) || afMode.equals(Parameters.FOCUS_MODE_CONTINUOUS_PICTURE))) {
            ...
            case 1:
                if (afMode.equals("auto")) {
                    if (afMode.equals(Parameters.FOCUS_MODE_CONTINUOUS_PICTURE)) {
                        ...
                        if (afStateAfterStart == 0) {
                            this.mCamera.autoFocus(/* anonymous class already generated */);
                            return;
                        }
                        return;
                    }
