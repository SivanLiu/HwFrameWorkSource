...
public class GeomagneticField {
    ...
    static {
        ...
        r0[12] = new float[]{-2.2f, -0.2f, 0.3f, 1.0f, -0.6f, 0.9f, -0.1f, 0.5f, -0.4f, -0.4f, 0.2f, -0.8f, 0.0f};
        G_COEFF = r0;
        r0 = new float[13][];
        r0[0] = new float[]{0.0f};
        ...
        r0[8] = new float[]{0.0f, 11.0f, -20.0f, 11.9f, -17.4f, 16.7f, 7.0f, -10.8f, 1.7f};
        r0[9] = new float[]{0.0f, -20.5f, 11.5f, 12.8f, -7.2f, -7.4f, 8.0f, 2.1f, -6.1f, 7.0f};
        r0[10] = new float[]{0.0f, 2.8f, -0.1f, 4.7f, 4.4f, -7.2f, -1.0f, -3.9f, -2.0f, -2.0f, -8.3f};
        r0[11] = new float[]{0.0f, 0.2f, 1.7f, -0.6f, -1.8f, 0.9f, -0.4f, -2.5f, -1.3f, -2.1f, -1.9f, -1.8f};
        r0[12] = new float[]{0.0f, -0.9f, 0.3f, 2.1f, -2.5f, 0.5f, 0.6f, 0.0f, 0.1f, 0.3f, -0.9f, -0.2f, 0.9f};
        H_COEFF = r0;
        r0 = new float[13][];
        r0[0] = new float[]{0.0f};
        ...
        r0[5] = new float[]{0.0f, 0.4f, 1.8f, 1.2f, 4.0f, -0.6f};
        r0[6] = new float[]{0.0f, -0.2f, -2.1f, -0.4f, -0.6f, 0.5f, 0.9f};
        r0[7] = new float[]{0.0f, 0.7f, 0.3f, -0.1f, -0.1f, -0.8f, -0.3f, 0.3f};
        r0[8] = new float[]{0.0f, -0.1f, 0.2f, 0.4f, 0.4f, 0.1f, -0.1f, 0.4f, 0.3f};
