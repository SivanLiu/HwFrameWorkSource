...
public class FingerprintManager {
    ...
    private IFingerprintServiceReceiver mServiceReceiver = new Stub() {
        ...
        public void onAcquired(long deviceId, int acquireInfo, int vendorCode) {
            Log.e(FingerprintManager.TAG, "onAcquired,acquireInfo = " + acquireInfo + "vendorCode =" + vendorCode);
        ...
        private void sendAcquiredResult(long deviceId, int acquireInfo, int vendorCode) {
            ...
            if (msg != null) {
                ...
                if (FingerprintManager.this.mEnrollmentCallback != null) {
                    ...
                    Log.e(FingerprintManager.TAG, "sendAcquiredResult,clientInfo = " + clientInfo);
        ...
        if (this.mService != null) {
            try {
                ...
                this.mService.addLockoutResetCallback(new IFingerprintServiceLockoutResetCallback.Stub() {
                    ...
                    static /* synthetic */ void lambda$-android_hardware_fingerprint_FingerprintManager$2_33085(WakeLock wakeLock, LockoutResetCallback callback) {
                        try {
    ...
    private String getErrorString(int errMsg, int vendorCode) {
        switch (errMsg) {
            case 1:
                return this.mContext.getString(17040027);
            case 2:
                return this.mContext.getString(17040032);
            case 3:
                return this.mContext.getString(17040031);
            case 4:
                return this.mContext.getString(17040030);
            case 5:
                return this.mContext.getString(17040026);
            case 7:
                return this.mContext.getString(17040028);
            case 8:
                String[] msgArray = this.mContext.getResources().getStringArray(17236048);
                if (vendorCode < msgArray.length) {
                    return msgArray[vendorCode];
                }
                break;
            case 9:
                return this.mContext.getString(17040029);
        }
    ...
    private String getAcquiredString(int acquireInfo, int vendorCode) {
        switch (acquireInfo) {
            ...
            case 6:
                ...
                if (this.mAuthenticationCallback == null || !(vendorCode + 1000 == HW_UD_FINGERPRINT_HELP_PAUSE_VENDORCODE || vendorCode + 1000 == HW_UD_FINGERPRINT_HELP_RESUME_VENDORCODE)) {
                    String[] msgArray = this.mContext.getResources().getStringArray(17236047);
                    if (vendorCode < msgArray.length) {
                        return msgArray[vendorCode];
                    }
                }
