...
public final class KeepaliveStatus {
    ...
    public final boolean equals(Object otherObject) {
        ...
        return this.sessionHandle == other.sessionHandle && this.code == other.code;
    }
    ...
    public final String toString() {
        ...
        builder.append(", .code = ");
        builder.append(KeepaliveStatusCode.toString(this.code));
        builder.append("}");
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<KeepaliveStatus> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((KeepaliveStatus) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 8));
        }
