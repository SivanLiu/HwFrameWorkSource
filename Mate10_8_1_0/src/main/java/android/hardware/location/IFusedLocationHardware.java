        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    ...
                    _arg0 = data.readInt();
                    if (data.readInt() != 0) {
                        fusedBatchOptions = (FusedBatchOptions) FusedBatchOptions.CREATOR.createFromParcel(data);
                    } else {
                        fusedBatchOptions = null;
                    }
                    startBatching(_arg0, fusedBatchOptions);
                    reply.writeNoException();
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 6:
                    ...
                    updateBatchingOptions(_arg0, fusedBatchOptions);
                    reply.writeNoException();
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
