...
public interface IGrabNodeReceiver extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGrabNodeReceiver {
        private static final String DESCRIPTOR = "android.contentsensor.IGrabNodeReceiver";
        static final int TRANSACTION_onNodeCallBack = 1;

        private static class Proxy implements IGrabNodeReceiver {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    onNodeCallBack(_arg0, bundle, data.readInt());
                    return true;
                case 1598968902:
