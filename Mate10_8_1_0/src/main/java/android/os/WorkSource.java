...
public class WorkSource implements Parcelable {
    ...
    private boolean updateUidsAndNamesLocked(WorkSource other, boolean set, boolean returnNewbs) {
        ...
        while (true) {
            ...
            changed = true;
            Log.d(TAG, "i1=" + i1 + " i2=" + i2 + " N1=" + this.mNum + ": insert " + uids2[i2] + " " + names2[i2]);
    ...
    private void insert(int index, int uid, String name) {
        Log.d(TAG, "Insert in " + this + " @ " + index + " uid " + uid + " name " + name);
        if (this.mUids == null) {
            this.mUids = new int[4];
            this.mUids[0] = uid;
    ...
    public void writeToProto(ProtoOutputStream proto, long fieldId) {
        ...
        for (int i = 0; i < this.mNum; i++) {
            ...
            proto.write(1112396529665L, this.mUids[i]);
            if (this.mNames != null) {
