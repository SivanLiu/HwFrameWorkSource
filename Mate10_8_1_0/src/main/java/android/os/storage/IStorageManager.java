    ...
    public static abstract class Stub extends Binder implements IStorageManager {
        ...
        private static class Proxy implements IStorageManager {
            ...
            public String getKeyDesc(int userId, int serialNumber, int sdpClass) throws RemoteException {
                ...
                try {
                    ...
                    this.mRemote.transact(507, _data, _reply, 0);
                    _reply.readException();
                    String _result = _reply.readString();
                    return _result;
                } finally {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 78:
                    data.enforceInterface(DESCRIPTOR);
                    _result4 = getAllocatableBytes(data.readString(), data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeLong(_result4);
                    return true;
                case 79:
                ...
                case 505:
                    data.enforceInterface(DESCRIPTOR);
                    _result2 = getPreLoadPolicyFlag(data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 506:
                    data.enforceInterface(DESCRIPTOR);
                    _result = setScreenStateFlag(data.readInt(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 507:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getKeyDesc(data.readInt(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeString(_result3);
                    return true;
                case 601:
                    data.enforceInterface(DESCRIPTOR);
                    createUserKeyISec(data.readInt(), data.readInt(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 602:
                    data.enforceInterface(DESCRIPTOR);
