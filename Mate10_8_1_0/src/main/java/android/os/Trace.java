...
public final class Trace {
    ...
    static {
        SystemProperties.addChangeCallback(-$Lambda$BcGBlsGjMZMF6Ej78rWJ608MYSM.$INST$1);
    }

    static /* synthetic */ void lambda$-android_os_Trace_5120() {
        cacheEnabledTags();
        if ((sZygoteDebugFlags & 256) != 0) {
            traceCounter(1, "java_debuggable", 1);
        }
    }
