        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    if (data.readInt() != 0) {
                        incidentReportArgs = (IncidentReportArgs) IncidentReportArgs.CREATOR.createFromParcel(data);
                    } else {
                        incidentReportArgs = null;
                    }
                ...
                case 2:
                    ...
                    reportIncidentToStream(incidentReportArgs, android.os.IIncidentReportStatusListener.Stub.asInterface(data.readStrongBinder()), data.readRawFileDescriptor());
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    systemRunning();
