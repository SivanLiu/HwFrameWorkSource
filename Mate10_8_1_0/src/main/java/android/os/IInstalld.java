...
public interface IInstalld extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IInstalld {
        ...
        static final int TRANSACTION_executeBackupTask = 36;
        static final int TRANSACTION_finishBackupSession = 37;
        ...
        static final int TRANSACTION_restoreCloneAppData = 34;
        ...
        static final int TRANSACTION_setFileXattr = 38;
        static final int TRANSACTION_startBackupSession = 35;
