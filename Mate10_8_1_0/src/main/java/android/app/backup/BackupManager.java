...
public class BackupManager {
        ...
        if (sService != null) {
            ...
            try {
                ...
                if (binder != null) {
                    ...
                    try {
                        result = session.restorePackage(this.mContext.getPackageName(), observer, monitor);
    ...
    public int requestBackup(String[] packages, BackupObserver observer, BackupManagerMonitor monitor, int flags) {
        ...
        if (sService != null) {
            ...
            try {
                return sService.requestBackup(packages, iBackupObserver, iBackupManagerMonitor, flags);
            } catch (RemoteException e) {
