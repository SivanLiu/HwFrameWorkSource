        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 5:
                    ...
                    enqueueNotificationWithTag(_arg0, _arg1, _arg2, _arg3, notification, data.readInt());
                    reply.writeNoException();
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 13:
                    ...
                    createNotificationChannelGroups(_arg0, parceledListSlice);
                    reply.writeNoException();
                    return true;
                case 14:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    createNotificationChannels(_arg0, parceledListSlice);
                    reply.writeNoException();
                    return true;
                case 15:
                    ...
                    _arg12 = data.readInt();
                    if (data.readInt() != 0) {
                        parceledListSlice2 = (ParceledListSlice) ParceledListSlice.CREATOR.createFromParcel(data);
                    } else {
                        parceledListSlice2 = null;
                    }
                    createNotificationChannelsForPackage(_arg0, _arg12, parceledListSlice2);
                    reply.writeNoException();
                    return true;
                case 16:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 18:
                    ...
                    updateNotificationChannelForPackage(_arg0, _arg12, notificationChannel);
                    reply.writeNoException();
                    return true;
                case 19:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 39:
                    ...
                    requestBindProvider(componentName);
                    reply.writeNoException();
                    return true;
                case 40:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 50:
                    ...
                    if (data.readInt() != 0) {
                        notificationChannel2 = (NotificationChannel) NotificationChannel.CREATOR.createFromParcel(data);
                    } else {
                        notificationChannel2 = null;
                    }
                    updateNotificationChannelFromPrivilegedListener(_arg02, _arg1, userHandle, notificationChannel2);
                    reply.writeNoException();
                    return true;
                case 51:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    _result3 = getNotificationChannelsFromPrivilegedListener(_arg02, _arg1, userHandle);
                    reply.writeNoException();
                    if (_result3 != null) {
                        reply.writeInt(1);
                        _result3.writeToParcel(reply, 1);
                ...
                case 52:
                    ...
                    _result3 = getNotificationChannelGroupsFromPrivilegedListener(_arg02, _arg1, userHandle);
                    reply.writeNoException();
                    if (_result3 != null) {
                        reply.writeInt(1);
                        _result3.writeToParcel(reply, 1);
                ...
                case 53:
                    ...
                    applyEnqueuedAdjustmentFromAssistant(_arg02, adjustment);
                    reply.writeNoException();
                    return true;
                case 54:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    applyAdjustmentFromAssistant(_arg02, adjustment);
                    reply.writeNoException();
                    return true;
                case 55:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 60:
                    ...
                    _result = isNotificationListenerAccessGranted(componentName);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 61:
                    ...
                    _result = isNotificationListenerAccessGrantedForUser(componentName, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 62:
                    ...
                    _result = isNotificationAssistantAccessGranted(componentName);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 63:
                    ...
                    setNotificationListenerAccessGranted(componentName, data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 64:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setNotificationAssistantAccessGranted(componentName, data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 65:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setNotificationListenerAccessGrantedForUser(componentName, data.readInt(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 66:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setNotificationAssistantAccessGrantedForUser(componentName, data.readInt(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 67:
                    data.enforceInterface(DESCRIPTOR);
                    List<String> _result8 = getEnabledNotificationListenerPackages();
                    reply.writeNoException();
                    reply.writeStringList(_result8);
                    return true;
                case 68:
                    data.enforceInterface(DESCRIPTOR);
                    List<ComponentName> _result9 = getEnabledNotificationListeners(data.readInt());
                    reply.writeNoException();
                ...
                case 70:
                    data.enforceInterface(DESCRIPTOR);
                    ZenModeConfig _result10 = getZenModeConfig();
                    reply.writeNoException();
                    if (_result10 != null) {
                        reply.writeInt(1);
                ...
                case 74:
                    data.enforceInterface(DESCRIPTOR);
                    Policy _result11 = getNotificationPolicy(data.readString());
                    reply.writeNoException();
                    if (_result11 != null) {
                        reply.writeInt(1);
                ...
                case 78:
                    data.enforceInterface(DESCRIPTOR);
                    setNotificationPolicyAccessGrantedForUser(data.readString(), data.readInt(), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 79:
                    data.enforceInterface(DESCRIPTOR);
                    AutomaticZenRule _result12 = getAutomaticZenRule(data.readString());
                    reply.writeNoException();
                    if (_result12 != null) {
                        reply.writeInt(1);
                ...
                case 80:
                    data.enforceInterface(DESCRIPTOR);
                    List<ZenRule> _result13 = getZenRules();
                    reply.writeNoException();
                ...
                case 81:
                    ...
                    String _result14 = addAutomaticZenRule(automaticZenRule);
                    reply.writeNoException();
                ...
                case 86:
                    data.enforceInterface(DESCRIPTOR);
                    byte[] _result15 = getBackupPayload(data.readInt());
                    reply.writeNoException();
