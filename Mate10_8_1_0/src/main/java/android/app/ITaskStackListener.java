...
public interface ITaskStackListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITaskStackListener {
        ...
        private static class Proxy implements ITaskStackListener {
            ...
            public void onActivityPinned(String packageName, int userId, int taskId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    onActivityPinned(data.readString(), data.readInt(), data.readInt());
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    onActivityUnpinned();
                ...
                case 10:
                    ...
                    onTaskCreated(_arg0, componentName);
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 13:
                    ...
                    onTaskDescriptionChanged(_arg0, taskDescription);
                    return true;
                case 14:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 17:
                    ...
                    _arg0 = data.readInt();
                    if (data.readInt() != 0) {
                        taskSnapshot = (TaskSnapshot) TaskSnapshot.CREATOR.createFromParcel(data);
                    } else {
                        taskSnapshot = null;
                    }
                    onTaskSnapshotChanged(_arg0, taskSnapshot);
                    return true;
    ...
    void onActivityPinned(String str, int i, int i2) throws RemoteException;
