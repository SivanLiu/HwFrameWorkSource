...
public interface IWallpaperManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWallpaperManager {
        ...
        static final int TRANSACTION_getCurrOffsets = 23;
        ...
        static final int TRANSACTION_getWallpaperUserId = 26;
        ...
        static final int TRANSACTION_scaleWallpaperBitmapToScreenSize = 27;
        static final int TRANSACTION_setCurrOffsets = 24;
        ...
        static final int TRANSACTION_setNextOffsets = 25;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    _result = setWallpaper(_arg0, _arg1, rect, _arg3, _arg4, data.readInt(), android.app.IWallpaperManagerCallback.Stub.asInterface(data.readStrongBinder()), data.readInt());
                ...
                case 2:
                    ...
                    setWallpaperComponentChecked(componentName, data.readString(), data.readInt());
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 4:
                    ...
                    _result = getWallpaper(_arg0, _arg12, _arg2, _arg32, data.readInt());
                    reply.writeNoException();
                    if (_result != null) {
                        reply.writeInt(1);
                        _result.writeToParcel(reply, 1);
                ...
                case 27:
                    ...
                    Bitmap _result8 = scaleWallpaperBitmapToScreenSize(bitmap);
                    reply.writeNoException();
                    if (_result8 != null) {
                        reply.writeInt(1);
