        ...
        int writeSelfToParcel(Parcel out, PooledStringWriter pwriter, boolean sanitizeOnWrite, float[] tmpMatrix) {
            ...
            if ((this.mX & -32768) == 0 && (this.mY & -32768) == 0) {
                ...
                if ((flags & Integer.MIN_VALUE) != 0) {
                    z2 = this.mSanitized ? sanitizeOnWrite ^ 1 : true;
                    if (this.mSanitized) {
                        i = 0;
                    } else {
                        i = 1;
                    ...
                    if (z2) {
                        parcelable = this.mAutofillValue;
                    } else if (this.mAutofillOverlay != null || this.mAutofillOverlay.value == null) {
                        parcelable = null;
                    } else {
                        parcelable = this.mAutofillOverlay.value;
                    }
                ...
                if ((16777216 & flags) != 0) {
                    ...
                    viewNodeText.writeToParcel(out, z, z2);
                }
                if ((262144 & flags) != 0) {
            ...
            if ((16777216 & flags) != 0) {
                ...
                viewNodeText2.writeToParcel(out, z, z2);
            }
            if ((262144 & flags) != 0) {
                out.writeInt(this.mInputType);
            }
