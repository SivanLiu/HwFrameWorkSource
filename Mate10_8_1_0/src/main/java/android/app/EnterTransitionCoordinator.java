...
class EnterTransitionCoordinator extends ActivityTransitionCoordinator {
    ...
    private void triggerViewsReady(ArrayMap<String, View> sharedElements) {
        if (!this.mAreViewsReady) {
            ...
            if (decor == null || (decor.isAttachedToWindow() && (sharedElements.isEmpty() || (((View) sharedElements.valueAt(0)).isLayoutRequested() ^ 1) != 0))) {
                ...
                this.mViewsReadyListener = OneShotPreDrawListener.add(decor, new -$Lambda$Pcw-0289sroTvc5U7X-pS90OouM((byte) 4, this, sharedElements));
                decor.invalidate();
            }
        }
    }
    ...
    private void sendSharedElementDestination() {
        ...
        if (allowOverlappingTransitions() && getEnterViewsTransition() != null) {
            ...
            z = decorView.isLayoutRequested() ^ 1;
            if (z) {
        ...
        if (z) {
            ...
            OneShotPreDrawListener.add(decorView, new -$Lambda$aS31cHIhRx41653CMnd4gZqshIQ((byte) 1, this));
        }
    ...
    private void startSharedElementTransition(Bundle sharedElementState) {
        ...
        if (decorView != null) {
            ...
            boolean z = allowOverlappingTransitions() ? this.mIsReturning ^ 1 : false;
            setGhostVisibility(4);
            scheduleGhostVisibilityChange(4);
            pauseInput();
            Transition transition = beginTransition(decorView, z, true);
        ...
        if (this.mIsReadyForTransition && this.mSharedElementsBundle != null) {
            ...
            OnSharedElementsReadyListener listener = new OnSharedElementsReadyListener() {
                public void onSharedElementsReady() {
                    View decorView = EnterTransitionCoordinator.this.getDecor();
                    if (decorView != null) {
                        OneShotPreDrawListener.add(decorView, false, new -$Lambda$Pcw-0289sroTvc5U7X-pS90OouM((byte) 3, this, sharedElementState));
                        decorView.invalidate();
                    }
                }

                /* synthetic */ void lambda$-android_app_EnterTransitionCoordinator$3_18123(Bundle sharedElementState) {
                    EnterTransitionCoordinator.this.startTransition(new -$Lambda$Pcw-0289sroTvc5U7X-pS90OouM((byte) 2, this, sharedElementState));
                }
