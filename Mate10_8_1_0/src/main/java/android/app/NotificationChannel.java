...
public final class NotificationChannel implements Parcelable {
    ...
    public void unlockFields(int r1) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.app.NotificationChannel.unlockFields(int):void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.app.NotificationChannel.unlockFields(int):void");
    }
    ...
    private void populateFromXml(XmlPullParser parser, boolean forRestore, Context context) {
        ...
        if (forRestore) {
            sound = restoreSoundUri(context, sound);
        }
        setSound(sound, safeAudioAttributes(parser));
