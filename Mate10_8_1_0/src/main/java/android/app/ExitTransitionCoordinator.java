...
class ExitTransitionCoordinator extends ActivityTransitionCoordinator {
    ...
    private void startSharedElementExit(ViewGroup decorView) {
        ...
        OneShotPreDrawListener.add(decorView, new -$Lambda$Pcw-0289sroTvc5U7X-pS90OouM((byte) 5, this, sharedElementSnapshots));
    ...
    private Transition getExitTransition() {
        ...
        if (!(this.mTransitioningViews == null || (this.mTransitioningViews.isEmpty() ^ 1) == 0)) {
            ...
            ActivityTransitionCoordinator.removeExcludedViews(transition, this.mTransitioningViews);
        ...
        if (transition == null) {
            ...
            transition.addListener(new ContinueTransitionListener(this) {
                public void onTransitionEnd(Transition transition) {
