...
public final class ActivityThread {
    ...
    private static final boolean DEBUG_ORDER = DEBUG_HW_ACTIVITY;
    ...
    static final class ActivityClientRecord {
        ...
        /* synthetic */ void lambda$-android_app_ActivityThread$ActivityClientRecord_20376(Configuration overrideConfig, int newDisplayId) {
    ...
    private class ApplicationThread extends Stub {
        ...
        public final void scheduleResumeActivity(IBinder token, int processState, boolean isForward, Bundle resumeArgs) {
            ...
            ActivityThread activityThread = ActivityThread.this;
            if (resumeArgs != null) {
                i = resumeArgs.getInt("activity.canboost", 1);
            } else {
                i = 1;
            }
            activityThread.resumeCanBoost = i;
            ...
            activityThread2.sendMessage(107, (Object) token, i2, 0, seq);
        }
        ...
        String codeToString(int code) {
            if (ActivityThread.DEBUG_MESSAGES) {
                switch (code) {
                    ...
                    case 158:
                        return "REQUEST_NODEGROUP_CONTENT";
                    case 159:
                        return "REQUEST_OTHER_CONTENT";
                }
            }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 107:
                    ...
                    if (ActivityThread.this.resumeCanBoost > 0) {
    ...
    private android.content.res.Configuration performActivityConfigurationChanged(android.app.Activity r1, android.content.res.Configuration r2, android.content.res.Configuration r3, int r4, boolean r5) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.app.ActivityThread.performActivityConfigurationChanged(android.app.Activity, android.content.res.Configuration, android.content.res.Configuration, int, boolean):android.content.res.Configuration
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.app.ActivityThread.performActivityConfigurationChanged(android.app.Activity, android.content.res.Configuration, android.content.res.Configuration, int, boolean):android.content.res.Configuration");
    }

    static {
        boolean z = true;
        boolean z2 = (DEBUG_HW_ACTIVITY || DEBUG_HW_BROADCAST) ? true : DEBUG_HW_SERVICE;
        DEBUG_MESSAGES = z2;
    ...
    public final LoadedApk getPackageInfo(String packageName, CompatibilityInfo compatInfo, int flags, int userId) {
        ...
        synchronized (this.mResourcesManager) {
            ...
            LoadedApk loadedApk = weakReference != null ? (LoadedApk) weakReference.get() : null;
            if (loadedApk == null || !(loadedApk.mResources == null || loadedApk.mResources.getAssets().isUpToDate())) {
            } else if (loadedApk.isSecurityViolation() && (flags & 2) == 0) {
    ...
    private LoadedApk getPackageInfo(ApplicationInfo aInfo, CompatibilityInfo compatInfo, ClassLoader baseLoader, boolean securityViolation, boolean includeCode, boolean registerPackage) {
        ...
        synchronized (this.mResourcesManager) {
            ...
            if (!(!"com.android.systemui".equals(currentPackageName()) || loadedApk == null || loadedApk.getApplicationInfo() == null || aInfo.sourceDir == null || (aInfo.sourceDir.equals(loadedApk.getApplicationInfo().sourceDir) ^ 1) == 0)) {
                loadedApk = null;
            }
            if (loadedApk == null || !(loadedApk.mResources == null || (loadedApk.mResources.getAssets().isUpToDate() ^ 1) == 0)) {
                if (localLOGV) {
                    String str;
                    String str2 = TAG;
                    StringBuilder stringBuilder = new StringBuilder();
            ...
            if (!(compatInfo == null || (compatInfo.supportsScreen() ^ 1) == 0 || (loadedApk.getCompatibilityInfo().equals(compatInfo) ^ 1) == 0)) {
                loadedApk.setCompatibilityInfo(compatInfo);
            }
        }
        return loadedApk;
    }
    ...
    private Activity performLaunchActivity(ActivityClientRecord r, Intent customIntent) {
        ...
        try {
            ...
            context = this.mInstrumentation.newActivity(cl, component.getClassName(), r.intent);
            StrictMode.incrementExpectedActivityCount(context.getClass());
        ...
        try {
            ...
            if (context != null) {
                ...
                appContext.setOuterContext(context);
                context.attach(appContext, this, getInstrumentation(), r.token, r.ident, app, r.intent, r.activityInfo, title, r.parent, r.embeddedID, r.lastNonConfigurationInstances, config, r.referrer, r.voiceInteractor, window, r.configCallback);
                if (customIntent != null) {
                    context.mIntent = customIntent;
                }
                r.lastNonConfigurationInstances = null;
                checkAndBlockForNetworkAccess();
                context.mStartedActivity = false;
                int theme = r.activityInfo.getThemeResource();
                if (theme != 0) {
                    context.setTheme(theme);
                }
                context.mCalled = false;
                Slog.v(TAG, "callActivityOnCreate");
                if (r.isPersistable()) {
                    this.mInstrumentation.callActivityOnCreate(context, r.state, r.persistentState);
                } else {
                    this.mInstrumentation.callActivityOnCreate(context, r.state);
                }
                if (context.mCalled) {
                    r.activity = context;
                    r.stopped = true;
                    ...
                    if (!r.activity.mFinished) {
                        if (r.isPersistable()) {
                            if (!(r.state == null && r.persistentState == null)) {
                                this.mInstrumentation.callActivityOnRestoreInstanceState(context, r.state, r.persistentState);
                            }
                        } else if (r.state != null) {
                            this.mInstrumentation.callActivityOnRestoreInstanceState(context, r.state);
                        }
                    }
                    if (!r.activity.mFinished) {
                        context.mCalled = false;
                        if (r.isPersistable()) {
                            this.mInstrumentation.callActivityOnPostCreate(context, r.state, r.persistentState);
                        } else {
                            this.mInstrumentation.callActivityOnPostCreate(context, r.state);
                        }
                        if (!context.mCalled) {
            ...
            if (!this.mInstrumentation.onException(context, e3)) {
    ...
    private void handleLaunchActivity(ActivityClientRecord r, Intent customIntent, String reason) {
        ...
        if (!(r == null || r.intent == null || r.intent.getComponent() == null)) {
            Jlog.d(336, r.intent.getComponent().getPackageName(), "");
        }
        unscheduleGcIdler();
        ...
        if (localLOGV) {
            Slog.v(TAG, "Handling launch of " + r + " for reason:" + reason);
        }
    ...
    public void handleRequestAssistContextExtras(RequestAssistContextExtras cmd) {
        ...
        structure = null;
        AssistContent assistContent = forAutofill ? null : new AssistContent();
        ...
        if (r != null) {
            ...
            if (cmd.requestType == 1 || forAutofill) {
                ...
                if (!forAutofill) {
                    r.activity.onProvideAssistContent(assistContent);
                }
            }
        }
        if (structure == null) {
        ...
        try {
            ActivityManager.getService().reportAssistContextExtras(cmd.requestToken, data, structure, assistContent, uri);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    private void handleReceiver(android.app.ActivityThread.ReceiverData r14, int r15) {
        /* JADX: method processing error */
/*
...
*/
        ...
        r9 = r14.compatInfo;
        r6 = r13.getPackageInfoNoCheck(r8, r9);
        r5 = android.app.ActivityManager.getService();
        r8 = r13.mInstrumentation;	 Catch:{ Exception -> 0x012c }
        r9 = 0;	 Catch:{ Exception -> 0x012c }
        r0 = r6.makeApplication(r9, r8);	 Catch:{ Exception -> 0x012c }
        r3 = r0.getBaseContext();	 Catch:{ Exception -> 0x012c }
        r3 = (android.app.ContextImpl) r3;	 Catch:{ Exception -> 0x012c }
        r8 = r14.info;	 Catch:{ Exception -> 0x012c }
        r8 = r8.splitName;	 Catch:{ Exception -> 0x012c }
        if (r8 == 0) goto L_0x0039;	 Catch:{ Exception -> 0x012c }
    L_0x002f:
        r8 = r14.info;	 Catch:{ Exception -> 0x012c }
        r8 = r8.splitName;	 Catch:{ Exception -> 0x012c }
        r3 = r3.createContextForSplit(r8);	 Catch:{ Exception -> 0x012c }
        r3 = (android.app.ContextImpl) r3;	 Catch:{ Exception -> 0x012c }
    L_0x0039:
        r1 = r3.getClassLoader();	 Catch:{ Exception -> 0x012c }
        r8 = r14.intent;	 Catch:{ Exception -> 0x012c }
        r8.setExtrasClassLoader(r1);	 Catch:{ Exception -> 0x012c }
        r8 = r14.intent;	 Catch:{ Exception -> 0x012c }
        r8.prepareToEnterProcess();	 Catch:{ Exception -> 0x012c }
        r14.setExtrasClassLoader(r1);	 Catch:{ Exception -> 0x012c }
        r8 = r1.loadClass(r2);	 Catch:{ Exception -> 0x012c }
        r7 = r8.newInstance();	 Catch:{ Exception -> 0x012c }
        r7 = (android.content.BroadcastReceiver) r7;	 Catch:{ Exception -> 0x012c }
        r8 = DEBUG_BROADCAST;	 Catch:{ Exception -> 0x017d }
        if (r8 == 0) goto L_0x00c1;	 Catch:{ Exception -> 0x017d }
    L_0x0058:
        r8 = "ActivityThread";	 Catch:{ Exception -> 0x017d }
        r9 = new java.lang.StringBuilder;	 Catch:{ Exception -> 0x017d }
        r9.<init>();	 Catch:{ Exception -> 0x017d }
        r10 = "Performing receive of ";	 Catch:{ Exception -> 0x017d }
        r9 = r9.append(r10);	 Catch:{ Exception -> 0x017d }
        r10 = r14.intent;	 Catch:{ Exception -> 0x017d }
        r9 = r9.append(r10);	 Catch:{ Exception -> 0x017d }
        r10 = ": app=";	 Catch:{ Exception -> 0x017d }
        r9 = r9.append(r10);	 Catch:{ Exception -> 0x017d }
        r9 = r9.append(r0);	 Catch:{ Exception -> 0x017d }
        r10 = ", appName=";	 Catch:{ Exception -> 0x017d }
        r9 = r9.append(r10);	 Catch:{ Exception -> 0x017d }
        r10 = r0.getPackageName();	 Catch:{ Exception -> 0x017d }
        r9 = r9.append(r10);	 Catch:{ Exception -> 0x017d }
        r10 = ", pkg=";	 Catch:{ Exception -> 0x017d }
        r9 = r9.append(r10);	 Catch:{ Exception -> 0x017d }
        r10 = r6.getPackageName();	 Catch:{ Exception -> 0x017d }
        r9 = r9.append(r10);	 Catch:{ Exception -> 0x017d }
        r10 = ", comp=";	 Catch:{ Exception -> 0x017d }
        r9 = r9.append(r10);	 Catch:{ Exception -> 0x017d }
        r10 = r14.intent;	 Catch:{ Exception -> 0x017d }
        r10 = r10.getComponent();	 Catch:{ Exception -> 0x017d }
        r10 = r10.toShortString();	 Catch:{ Exception -> 0x017d }
        r9 = r9.append(r10);	 Catch:{ Exception -> 0x017d }
        r10 = ", dir=";	 Catch:{ Exception -> 0x017d }
        r9 = r9.append(r10);	 Catch:{ Exception -> 0x017d }
        r10 = r6.getAppDir();	 Catch:{ Exception -> 0x017d }
        r9 = r9.append(r10);	 Catch:{ Exception -> 0x017d }
        r9 = r9.toString();	 Catch:{ Exception -> 0x017d }
        android.util.Slog.v(r8, r9);	 Catch:{ Exception -> 0x017d }
    L_0x00c1:
        r8 = sCurrentBroadcastIntent;	 Catch:{ Exception -> 0x017d }
        r9 = r14.intent;	 Catch:{ Exception -> 0x017d }
        r8.set(r9);	 Catch:{ Exception -> 0x017d }
        r7.setPendingResult(r14);	 Catch:{ Exception -> 0x017d }
        r8 = android.util.Log.HWINFO;	 Catch:{ Exception -> 0x017d }
        if (r8 == 0) goto L_0x010b;	 Catch:{ Exception -> 0x017d }
    L_0x00cf:
        r8 = new java.lang.StringBuilder;	 Catch:{ Exception -> 0x017d }
        r8.<init>();	 Catch:{ Exception -> 0x017d }
        r9 = "staticBroadcast[";	 Catch:{ Exception -> 0x017d }
        r8 = r8.append(r9);	 Catch:{ Exception -> 0x017d }
        r9 = r14.intent;	 Catch:{ Exception -> 0x017d }
        r9 = r9.getAction();	 Catch:{ Exception -> 0x017d }
        r8 = r8.append(r9);	 Catch:{ Exception -> 0x017d }
        r9 = "](";	 Catch:{ Exception -> 0x017d }
        r8 = r8.append(r9);	 Catch:{ Exception -> 0x017d }
        r8 = r8.append(r15);	 Catch:{ Exception -> 0x017d }
        r9 = "), call onReceive [";	 Catch:{ Exception -> 0x017d }
        r8 = r8.append(r9);	 Catch:{ Exception -> 0x017d }
        r8 = r8.append(r2);	 Catch:{ Exception -> 0x017d }
        r9 = "]";	 Catch:{ Exception -> 0x017d }
        r8 = r8.append(r9);	 Catch:{ Exception -> 0x017d }
        r8 = r8.toString();	 Catch:{ Exception -> 0x017d }
        r10 = 64;	 Catch:{ Exception -> 0x017d }
        android.os.Trace.traceBegin(r10, r8);	 Catch:{ Exception -> 0x017d }
    L_0x010b:
        r8 = r3.getReceiverRestrictedContext();	 Catch:{ Exception -> 0x017d }
        r9 = r14.intent;	 Catch:{ Exception -> 0x017d }
        r7.onReceive(r8, r9);	 Catch:{ Exception -> 0x017d }
        r8 = android.util.Log.HWINFO;	 Catch:{ Exception -> 0x017d }
        if (r8 == 0) goto L_0x011d;	 Catch:{ Exception -> 0x017d }
    L_0x0118:
        r8 = 64;	 Catch:{ Exception -> 0x017d }
        android.os.Trace.traceEnd(r8);	 Catch:{ Exception -> 0x017d }
    L_0x011d:
        r8 = sCurrentBroadcastIntent;
        r8.set(r12);
    L_0x0122:
        r8 = r7.getPendingResult();
    ...
    L_0x0131:
        ...
        r9.<init>();
        r10 = "Finishing failed broadcast to ";
        r9 = r9.append(r10);
        r10 = r14.intent;
        r10 = r10.getComponent();
        r9 = r9.append(r10);
        r9 = r9.toString();
    ...
    L_0x0151:
        ...
        r9 = new java.lang.StringBuilder;
        r9.<init>();
        r10 = "Unable to instantiate receiver ";
        r9 = r9.append(r10);
        r9 = r9.append(r2);
        r10 = ": ";
        r9 = r9.append(r10);
    ...
    L_0x017d:
        r4 = move-exception;
        r8 = DEBUG_BROADCAST;	 Catch:{ all -> 0x01d6 }
        if (r8 == 0) goto L_0x01a2;	 Catch:{ all -> 0x01d6 }
    L_0x0182:
        r8 = "ActivityThread";	 Catch:{ all -> 0x01d6 }
        r9 = new java.lang.StringBuilder;	 Catch:{ all -> 0x01d6 }
        r9.<init>();	 Catch:{ all -> 0x01d6 }
        r10 = "Finishing failed broadcast to ";	 Catch:{ all -> 0x01d6 }
        r9 = r9.append(r10);	 Catch:{ all -> 0x01d6 }
        r10 = r14.intent;	 Catch:{ all -> 0x01d6 }
        r10 = r10.getComponent();	 Catch:{ all -> 0x01d6 }
        r9 = r9.append(r10);	 Catch:{ all -> 0x01d6 }
        r9 = r9.toString();	 Catch:{ all -> 0x01d6 }
        android.util.Slog.i(r8, r9);	 Catch:{ all -> 0x01d6 }
    L_0x01a2:
        r14.sendFinished(r5);	 Catch:{ all -> 0x01d6 }
        r8 = r13.mInstrumentation;	 Catch:{ all -> 0x01d6 }
        r8 = r8.onException(r7, r4);	 Catch:{ all -> 0x01d6 }
        if (r8 != 0) goto L_0x01dd;	 Catch:{ all -> 0x01d6 }
    L_0x01ad:
        r8 = new java.lang.RuntimeException;	 Catch:{ all -> 0x01d6 }
        r9 = new java.lang.StringBuilder;	 Catch:{ all -> 0x01d6 }
        r9.<init>();	 Catch:{ all -> 0x01d6 }
        r10 = "Unable to start receiver ";	 Catch:{ all -> 0x01d6 }
        r9 = r9.append(r10);	 Catch:{ all -> 0x01d6 }
        r9 = r9.append(r2);	 Catch:{ all -> 0x01d6 }
        r10 = ": ";	 Catch:{ all -> 0x01d6 }
        r9 = r9.append(r10);	 Catch:{ all -> 0x01d6 }
        r10 = r4.toString();	 Catch:{ all -> 0x01d6 }
        r9 = r9.append(r10);	 Catch:{ all -> 0x01d6 }
        r9 = r9.toString();	 Catch:{ all -> 0x01d6 }
        r8.<init>(r9, r4);	 Catch:{ all -> 0x01d6 }
        throw r8;	 Catch:{ all -> 0x01d6 }
    L_0x01d6:
        r8 = move-exception;
        r9 = sCurrentBroadcastIntent;
        r9.set(r12);
        throw r8;
    L_0x01dd:
        r8 = sCurrentBroadcastIntent;
        ...
        goto L_0x0122;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.app.ActivityThread.handleReceiver(android.app.ActivityThread$ReceiverData, int):void");
    }
    ...
    private void handleCreateBackupAgent(CreateBackupAgentData data) {
        try {
            ...
            ActivityManager.getService().backupAgentCreated(packageName, iBinder);
    ...
    final void handleResumeActivity(IBinder token, boolean clearHide, boolean isForward, boolean reallyResume, int seq, String reason) {
        ...
        if (checkAndUpdateLifecycleSeq(seq, r, "resumeActivity")) {
            ...
            this.mSomeActivitiesChanged = true;
            if (localLOGV) {
                Slog.v(TAG, "Handling resume of " + r + " isForward:" + isForward + " reallyResume:" + reallyResume + " for reason:" + reason);
            }
    ...
    private void handleStopActivity(IBinder token, boolean show, int configChanges, int seq) {
        ...
        if (localLOGV) {
            Slog.v(TAG, "Handling stop of " + r + " show:" + show);
        }
        Activity activity = r.activity;
        activity.mConfigChangeFlags |= configChanges;
    ...
    void handleApplicationInfoChanged(ApplicationInfo ai) {
        synchronized (this.mResourcesManager) {
            ...
            LoadedApk loadedApk2 = ref != null ? (LoadedApk) ref.get() : null;
        }
        if (loadedApk != null) {
            ArrayList<String> oldPaths = new ArrayList();
            LoadedApk.makePaths(this, loadedApk.getApplicationInfo(), oldPaths);
            loadedApk.updateApplicationInfo(ai, oldPaths);
        }
        if (loadedApk2 != null) {
            oldPaths = new ArrayList();
            LoadedApk.makePaths(this, loadedApk2.getApplicationInfo(), oldPaths);
            loadedApk2.updateApplicationInfo(ai, oldPaths);
        }
        synchronized (this.mResourcesManager) {
    ...
    void handleActivityConfigurationChanged(ActivityConfigChangeData data, int displayId) {
        ...
        ViewRootImpl viewRootImpl = r.activity.mDecor != null ? r.activity.mDecor.getViewRootImpl() : null;
        if (movedToDifferentDisplay) {
            ...
            if (viewRootImpl != null) {
                viewRootImpl.onMovedToDisplay(displayId, reportedConfig);
            }
        } else {
            if (DEBUG_CONFIGURATION) {
        ...
        if (viewRootImpl != null) {
            viewRootImpl.updateConfiguration(displayId);
        }
        this.mSomeActivitiesChanged = true;
    }
    ...
    private void handleBindApplication(AppBindData data) {
        ...
        try {
            ...
            Log.e(TAG, "handleBindApplication()");
        }
    ...
    private ProviderClientRecord installProviderAuthoritiesLocked(IContentProvider provider, ContentProvider localProvider, ContentProviderHolder holder) {
        ...
        if (provider != null) {
            for (String auth : auths) {
                if (!(auth.equals("com.android.contacts") || auth.equals("call_log") || auth.equals("call_log_shadow") || auth.equals("com.android.blockednumber") || auth.equals("com.android.calendar") || auth.equals("downloads"))) {
    ...
    private ContentProviderHolder installProvider(Context context, ContentProviderHolder holder, ProviderInfo info, boolean noisy, boolean noReleaseNeeded, boolean stable) {
        ...
        if (info.applicationInfo.uid > 10000 && (context.getPackageName().equals(info.applicationInfo.packageName) ^ 1) != 0) {
            Utils.handleTimeOut("acquire_provider", info.applicationInfo.packageName, "");
        }
        synchronized (this.mProviderMap) {
            try {
                if (DEBUG_PROVIDER) {
    ...
    /* synthetic */ void lambda$-android_app_ActivityThread_325319(Configuration globalConfig) {
        synchronized (this.mResourcesManager) {
        ...
        if (!(thread == null || args == null || args.length != 3)) {
            try {
                ...
                if (HwVRUtils.isVRDisplay(displayId, Integer.parseInt(args[1]), Integer.parseInt(args[2]))) {
                    HwVRUtils.log(TAG, "initVRArgs displayid = " + displayId);
