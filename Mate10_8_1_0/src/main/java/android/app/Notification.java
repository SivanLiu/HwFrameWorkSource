    ...
    public static class Action implements Parcelable {
        ...
        public static final class Builder {
            ...
            public Action build() {
                ...
                return new Action(this.mIcon, this.mTitle, this.mIntent, this.mExtras, textInputs.isEmpty() ? null : (RemoteInput[]) textInputs.toArray(new RemoteInput[textInputs.size()]), this.mAllowGeneratedReplies);
            }
        }
...
*/
    ...
    public static abstract class Style {
        ...
        protected RemoteViews getStandardView(int layoutId) {
            ...
            if (this.mBigContentTitle == null || !this.mBigContentTitle.equals("")) {
                contentView.setViewVisibility(16909022, 0);
            } else {
                contentView.setViewVisibility(16909022, 8);
            }
            return contentView;
        }
    ...
    public static class BigPictureStyle extends Style {
        ...
        public void reduceImageSizes(Context context) {
            ...
            if (this.mPicture != null) {
                ...
                int maxPictureWidth = resources.getDimensionPixelSize(i);
                if (isLowRam) {
                    i = 17105159;
                } else {
                    i = 17105158;
                }
                this.mPicture = Icon.scaleDownIfNecessary(this.mPicture, maxPictureWidth, resources.getDimensionPixelSize(i));
            }
            if (this.mBigLargeIcon != null) {
                if (isLowRam) {
                    i = 17105198;
        ...
        public RemoteViews makeBigContentView() {
            ...
            if (this.mSummaryTextSet) {
                contentView.setTextViewText(16909351, this.mBuilder.processTextSpans(this.mBuilder.processLegacyText(this.mSummaryText)));
                this.mBuilder.setTextViewColorSecondary(contentView, 16909351);
                contentView.setViewVisibility(16909351, 0);
            }
            ...
            contentView.setImageViewBitmap(16908751, this.mPicture);
            return contentView;
        }
    ...
    public static class BigTextStyle extends Style {
        ...
        static void applyBigTextContentView(Builder builder, RemoteViews contentView, CharSequence bigTextText) {
            contentView.setTextViewText(16908752, builder.processTextSpans(bigTextText));
            builder.setTextViewColorSecondary(contentView, 16908752);
            contentView.setViewVisibility(16908752, TextUtils.isEmpty(bigTextText) ? 8 : 0);
            contentView.setBoolean(16908752, "setHasImage", builder.mN.hasLargeIcon());
        }
    }
...
*/
        ...
        public Builder(Context context, Notification toAdopt) {
            ...
            this.mTintActionButtons = res.getBoolean(17957045);
            if (res.getBoolean(17956963)) {
                boolean z;
                if ((res.getConfiguration().uiMode & 48) == 32) {
                    z = true;
                } else {
                    z = false;
                }
        ...
        private Bitmap getProfileBadge() {
            ...
            int size = this.mContext.getResources().getDimensionPixelSize(17105155);
        ...
        private void bindProfileBadge(RemoteViews contentView) {
            ...
            if (profileBadge != null) {
                contentView.setImageViewBitmap(16909187, profileBadge);
                contentView.setViewVisibility(16909187, 0);
                if (isColorized()) {
                    contentView.setDrawableParameters(16909187, false, -1, getPrimaryTextColor(), Mode.SRC_ATOP, -1);
                }
            }
        }
        ...
        private void resetStandardTemplate(RemoteViews contentView) {
            ...
            contentView.setViewVisibility(16909220, 8);
            contentView.setViewVisibility(R.id.title, 8);
            contentView.setTextViewText(R.id.title, null);
            contentView.setViewVisibility(16909351, 8);
            contentView.setTextViewText(16909351, null);
            contentView.setViewVisibility(16909378, 8);
            contentView.setTextViewText(16909378, null);
        }

        private void resetNotificationHeader(RemoteViews contentView) {
            contentView.setBoolean(16909106, "setExpanded", false);
            contentView.setTextViewText(16908727, null);
            contentView.setViewVisibility(16908795, 8);
            ...
            contentView.setViewVisibility(16909384, 8);
            contentView.setViewVisibility(16909380, 8);
            contentView.setImageViewIcon(16909187, null);
            contentView.setViewVisibility(16909187, 8);
        }

        private void resetContentMargins(RemoteViews contentView) {
            contentView.setViewLayoutMarginEndDimen(16909022, 0);
            contentView.setViewLayoutMarginEndDimen(16909351, 0);
        }
        ...
        private void ensureColors() {
            ...
            if (!(this.mPrimaryTextColor == 1 || this.mSecondaryTextColor == 1 || this.mActionBarColor == 1)) {
                if (this.mTextColorsAreForBackground == backgroundColor) {
                    return;
                }
            }
            this.mTextColorsAreForBackground = backgroundColor;
            if (hasForegroundColor() && (isColorized() ^ 1) == 0) {
        ...
        private void updateBackgroundColor(RemoteViews contentView) {
            if (isColorized()) {
                contentView.setInt(16909332, "setBackgroundColor", getBackgroundColor());
            } else {
                contentView.setInt(16909332, "setBackgroundResource", 0);
            }
        }
        ...
        void setContentMinHeight(RemoteViews remoteView, boolean hasMinHeight) {
            int minHeight = 0;
            if (hasMinHeight) {
                minHeight = this.mContext.getResources().getDimensionPixelSize(17105193);
            }
            remoteView.setInt(16909107, "setMinimumHeight", minHeight);
        }
        ...
        private boolean handleProgressBar(boolean hasProgress, RemoteViews contentView, Bundle ex) {
            ...
            contentView.setProgressBackgroundTintList(R.id.progress, ColorStateList.valueOf(this.mContext.getColor(17170677)));
            if (this.mN.color != 0) {
        ...
        private void bindLargeIcon(RemoteViews contentView) {
            ...
            if (this.mN.mLargeIcon != null) {
                contentView.setViewVisibility(16909220, 0);
                contentView.setImageViewIcon(16909220, this.mN.mLargeIcon);
                processLargeLegacyIcon(this.mN.mLargeIcon, contentView);
                contentView.setViewLayoutMarginEndDimen(16909022, 17105166);
                contentView.setViewLayoutMarginEndDimen(16909351, 17105166);
                contentView.setViewLayoutMarginEndDimen(R.id.progress, 17105166);
                ...
                contentView.setViewVisibility(16909209, i);
                if (action != null) {
                    int contrastColor = resolveContrastColor();
                    contentView.setDrawableParameters(16909209, true, -1, contrastColor, Mode.SRC_ATOP, -1);
                    contentView.setDrawableParameters(16909209, false, -1, NotificationColorUtil.isColorLight(contrastColor) ? -16777216 : -1, Mode.SRC_ATOP, -1);
                    contentView.setOnClickPendingIntent(16909220, action.actionIntent);
                    contentView.setOnClickPendingIntent(16909209, action.actionIntent);
                    contentView.setRemoteInputs(16909220, action.mRemoteInputs);
                    contentView.setRemoteInputs(16909209, action.mRemoteInputs);
                }
            }
            if (this.mN.mLargeIcon != null) {
                i = 0;
            ...
            contentView.setViewVisibility(16909221, i);
        }
        ...
        private void bindHeaderChronometerAndTime(RemoteViews contentView) {
            if (showsTimeOrChronometer()) {
                contentView.setViewVisibility(16909384, 0);
                setTextViewColorSecondary(contentView, 16909384);
                if (this.mN.extras.getBoolean(Notification.EXTRA_SHOW_CHRONOMETER)) {
                    contentView.setViewVisibility(16908795, 0);
                    contentView.setLong(16908795, "setBase", this.mN.when + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                    contentView.setBoolean(16908795, "setStarted", true);
                    contentView.setChronometerCountDown(16908795, this.mN.extras.getBoolean(Notification.EXTRA_CHRONOMETER_COUNT_DOWN));
                    setTextViewColorSecondary(contentView, 16908795);
                    return;
                }
                contentView.setViewVisibility(16909380, 0);
                contentView.setLong(16909380, "setTime", this.mN.creationTime);
                setTextViewColorSecondary(contentView, 16909380);
                return;
            }
            contentView.setLong(16909380, "setTime", this.mN.creationTime);
        }
        ...
        private void bindHeaderText(RemoteViews contentView) {
            ...
            if (headerText != null) {
                contentView.setTextViewText(16908935, processTextSpans(processLegacyText(headerText)));
        ...
        private void bindHeaderAppName(RemoteViews contentView, boolean ambient) {
            contentView.setTextViewText(16908727, loadHeaderAppName());
            if (!isColorized() || (ambient ^ 1) == 0) {
                contentView.setTextColor(16908727, ambient ? resolveAmbientColor() : resolveContrastColor());
            } else {
                setTextViewColorPrimary(contentView, 16908727);
            }
            String style = this.mN.extras.getString(Notification.EXTRA_TEMPLATE);
            if (!(style != null ? style.contains("MediaStyle") : false) && (isColorized() ^ 1) != 0 && (IS_DOCOMO ^ 1) != 0) {
                contentView.setTextColor(16908727, -1291845632);
            }
        }
        ...
        private void resetStandardTemplateWithActions(RemoteViews big) {
            ...
            big.setViewVisibility(16909111, 8);
            big.setTextViewText(16909111, null);
            big.setViewLayoutMarginBottomDimen(16909104, 0);
        }
        ...
        private RemoteViews applyStandardTemplateWithActions(int layoutId, StandardTemplateParams p) {
            ...
            boolean z = this.mN.fullScreenIntent != null ? p.ambient ^ 1 : false;
            big.setBoolean(16908693, "setEmphasizedMode", z);
            if (N > 0) {
                big.setViewVisibility(16908694, 0);
                big.setViewVisibility(16908693, 0);
                if (p.ambient) {
                    big.setInt(16908693, "setBackgroundColor", 0);
                } else if (isColorized()) {
                    big.setInt(16908693, "setBackgroundColor", getActionBarColor());
                } else {
                    big.setInt(16908693, "setBackgroundColor", this.mContext.getColor(17170668));
                }
                big.setViewLayoutMarginBottomDimen(16909104, 17105154);
                if (N > 3) {
                    N = 3;
                }
                for (int i = 0; i < N; i++) {
                    ...
                    if (action != null) {
                        ...
                        big.addView(16908693, generateActionButton(action, z, i % 2 != 0, p.ambient));
                    }
                }
            } else {
                big.setViewVisibility(16908694, 8);
            }
            CharSequence[] replyText = this.mN.extras.getCharSequenceArray(Notification.EXTRA_REMOTE_INPUT_HISTORY);
            if (!(p.ambient || !r7 || replyText == null || replyText.length <= 0 || (TextUtils.isEmpty(replyText[0]) ^ 1) == 0)) {
                big.setViewVisibility(16909108, 0);
                big.setTextViewText(16909109, processTextSpans(replyText[0]));
                ...
                if (replyText.length > 1 && (TextUtils.isEmpty(replyText[1]) ^ 1) != 0) {
                    ...
                    big.setTextViewText(16909110, processTextSpans(replyText[1]));
                    setTextViewColorSecondary(big, 16909110);
                    if (replyText.length > 2 && (TextUtils.isEmpty(replyText[2]) ^ 1) != 0) {
                        big.setViewVisibility(16909111, 0);
                        big.setTextViewText(16909111, processTextSpans(replyText[2]));
                        setTextViewColorSecondary(big, 16909111);
                    }
                }
            }
            return big;
        ...
        public RemoteViews createLineView() {
            RemoteViews contentView = new BuilderRemoteViews(this.mContext.getApplicationInfo(), 34013290);
            contentView.setOnClickPendingIntent(34603058, this.mN.contentIntent != null ? this.mN.contentIntent : this.mN.fullScreenIntent);
            contentView.setTextViewText(R.id.title, null);
            contentView.setTextViewText(16909351, null);
            contentView.setTextViewText(16908727, null);
            ...
            contentView.setTextViewText(16909351, text);
            return contentView;
        }
        ...
        private void hideLine1Text(RemoteViews result) {
            if (result != null) {
                result.setViewVisibility(16909378, 8);
            }
        }

        public static void makeHeaderExpanded(RemoteViews result) {
            if (result != null) {
                result.setBoolean(16909106, "setExpanded", true);
            }
        }
        ...
        private RemoteViews makePublicView(boolean ambient) {
            ...
            if (ambient) {
                publicExtras.putCharSequence(Notification.EXTRA_TITLE, this.mContext.getString(17040517));
                view = makeAmbientNotification();
            } else {
                view = makeNotificationHeader(false);
                view.setBoolean(16909106, "setExpandOnlyOnButton", true);
            }
        ...
        public RemoteViews makeLowPriorityContentView(boolean useRegularSubtext) {
            ...
            header.setBoolean(16909106, "setAcceptAllTouches", true);
            if (summary != null) {
        ...
        private CharSequence createSummaryText() {
            ...
            if (!(titleText == null || contentText == null)) {
                summary.append(bidi.unicodeWrap(this.mContext.getText(17040515)));
            }
            if (contentText != null) {
        ...
        private RemoteViews generateActionButton(Action action, boolean emphazisedMode, boolean oddAction, boolean ambient) {
            ...
            if (this.mN.extras.getBoolean(Notification.EXTRA_SHOW_ACTION_ICON)) {
                ...
                button.setTextViewCompoundDrawablesWithBounds(16908670, action.getIcon(), null, null, null, actionIconLength, actionIconLength, this.mContext.getResources().getDimensionPixelSize(34472165));
            }
            if (IS_HONOR_PRODUCT) {
                button.setTextColor(16908670, this.mContext.getResources().getColorStateList(33882454, null));
            } else if (IS_NOVA_PRODUCT) {
                button.setTextColor(16908670, this.mContext.getResources().getColorStateList(33882495, null));
            }
            if (!tombstone) {
                button.setOnClickPendingIntent(16908670, action.actionIntent);
            }
            button.setContentDescription(16908670, action.title);
            if (action.mRemoteInputs != null) {
                button.setRemoteInputs(16908670, action.mRemoteInputs);
            }
            if (emphazisedMode) {
                int bgColor;
                if (isColorized()) {
                    ...
                    if (oddAction) {
                        emphasizedActionLayoutResource = 17170668;
                    } else {
                        emphasizedActionLayoutResource = 17170669;
                    }
                    bgColor = context.getColor(emphasizedActionLayoutResource);
                }
                button.setDrawableParameters(16908770, true, -1, bgColor, Mode.SRC_ATOP, -1);
                ...
                button.setTextViewText(16908670, processTextSpans(title));
                setTextViewColorPrimary(button, 16908670);
                if (outResultColor != null && outResultColor[0] != null) {
                    button.setTextColor(16908670, outResultColor[0]);
                } else if (!(this.mN.color == 0 || (isColorized() ^ 1) == 0 || !this.mTintActionButtons)) {
                    button.setTextColor(16908670, resolveContrastColor());
                }
            } else {
                button.setTextViewText(16908670, processTextSpans(processLegacyText(action.title)));
                if (isColorized() && (ambient ^ 1) != 0) {
                    setTextViewColorPrimary(button, 16908670);
                } else if (this.mN.color != 0 && this.mTintActionButtons) {
                    button.setTextColor(16908670, ambient ? resolveAmbientColor() : resolveContrastColor());
                }
            }
            return button;
        }
                ...
                if (resultSpan2 instanceof TextAppearanceSpan) {
                    ...
                    if (textColor != null) {
                        ...
                        for (int i = 0; i < newColors.length; i++) {
                            newColors[i] = NotificationColorUtil.ensureLargeTextContrast(colors[i], background, this.mInNightMode);
                        }
                    ...
                    int foregroundColor = NotificationColorUtil.ensureLargeTextContrast(resultSpan2.getForegroundColor(), background, this.mInNightMode);
        ...
        private void processSmallIconColor(Icon smallIcon, RemoteViews contentView, boolean ambient) {
            ...
            if (colorable) {
                if (this.mN.color == 0) {
                    ...
                    contentView.setInt(16909106, "setOriginalIconColor", 1);
                    return;
                }
                contentView.setDrawableParameters(R.id.icon, false, -1, color, Mode.SRC_ATOP, -1);
            }
            if (this.mN.extras.getInt(HW_SMALL_ICON_TINT_FOR_SYSTEMUI, 0) == 1 && isColorized()) {
                contentView.setDrawableParameters(R.id.icon, false, -1, color, Mode.SRC_ATOP, -1);
            }
            ...
            contentView.setInt(16909106, str, color);
        }
        ...
        private void processLargeLegacyIcon(Icon largeIcon, RemoteViews contentView) {
            if (largeIcon != null && isLegacy() && isPureColorIcon(largeIcon)) {
                contentView.setDrawableParameters(16909220, false, -1, resolveContrastColor(), Mode.SRC_ATOP, -1);
            }
        }
        ...
        int resolveContrastColor() {
            ...
            if (this.mBackgroundColorHint == 1) {
                background = this.mContext.getColor(17170673);
            }
            if (this.mN.color == 0) {
                ensureColors();
        ...
        public static Notification maybeCloneStrippedForDelivery(Notification n, boolean isLowRam) {
            ...
            if (!isLowRam && (TextUtils.isEmpty(templateClass) ^ 1) != 0 && Notification.getNotificationStyleClass(templateClass) == null) {
                return n;
            }
            ...
            if (!isLowRam && (stripContentView ^ 1) != 0 && (stripBigContentView ^ 1) != 0 && (stripHeadsUpContentView ^ 1) != 0) {
                return n;
            }
    ...
    public static final class CarExtender implements Extender {
        ...
        public CarExtender(Notification notif) {
            Bundle bundle = notif.extras == null ? null : notif.extras.getBundle(EXTRA_CAR_EXTENDER);
            if (bundle != null) {
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private void buildIntoRemoteViewContent(RemoteViews remoteViews, RemoteViews customContent) {
            if (customContent != null) {
                ...
                remoteViews.removeAllViewsExceptId(16909107, R.id.progress);
                remoteViews.addView(16909107, customContent, 0);
                remoteViews.setReapplyDisallowed();
            }
            int endMargin = 17105163;
            if (this.mBuilder.mN.hasLargeIcon()) {
                endMargin = 17105167;
            }
            remoteViews.setViewLayoutMarginEndDimen(16909107, endMargin);
            remoteViews.setViewLayoutMarginBottomDimen(16909107, 34472122);
            remoteViews.setViewLayoutMarginTopDimen(16909107, 34472217);
            remoteViews.setUseAppContext(true);
        }
    }
    ...
    public static class MediaStyle extends Style {
        ...
        private RemoteViews generateMediaActionButton(Action action, int color) {
            ...
            button.setImageViewIcon(16908670, action.getIcon());
            ...
            button.setDrawableParameters(16908670, false, -1, tintColor, Mode.SRC_ATOP, -1);
            if (!tombstone) {
                button.setOnClickPendingIntent(16908670, action.actionIntent);
            }
            button.setContentDescription(16908670, action.title);
        ...
        private RemoteViews makeMediaContentView() {
            ...
            if (N > 0) {
                ...
                for (int i = 0; i < N; i++) {
                    ...
                    view.addView(16909047, generateMediaActionButton((Action) this.mBuilder.mActions.get(this.mActionsToShowInCompact[i]), getPrimaryHighlightColor()));
                }
            }
            handleImage(view);
            int endMargin = 17105163;
            ...
            view.setViewLayoutMarginEndDimen(16909107, endMargin);
            return view;
        }
        ...
        private RemoteViews makeMediaBigContentView() {
            ...
            if (actionCount > 0) {
                big.removeAllViews(16909047);
                for (int i = 0; i < actionCount; i++) {
                    big.addView(16909047, generateMediaActionButton((Action) this.mBuilder.mActions.get(i), getPrimaryHighlightColor()));
                }
            }
            handleImage(big);
            return big;
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        public RemoteViews makeContentView(boolean increasedHeight) {
            return buildIntoRemoteView(super.makeContentView(false), 16909105, this.mBuilder.mN.contentView);
        }
        ...
        private RemoteViews makeBigContentViewWithCustomContent(RemoteViews customRemoteView) {
            ...
            if (remoteViews != null) {
                return buildIntoRemoteView(remoteViews, 16909107, customRemoteView);
            }
            if (customRemoteView != this.mBuilder.mN.contentView) {
                return buildIntoRemoteView(super.makeContentView(false), 16909105, customRemoteView);
            }
            return null;
        }
    ...
    public static class InboxStyle extends Style {
        ...
        public RemoteViews makeBigContentView() {
            ...
            int i = 0;
            int topPadding = this.mBuilder.mContext.getResources().getDimensionPixelSize(17105186);
            boolean first = true;
            int onlyViewId = 0;
            ...
            if (onlyViewId != 0) {
                contentView.setViewPadding(onlyViewId, 0, this.mBuilder.mContext.getResources().getDimensionPixelSize(17105200), 0, 0);
            }
            return contentView;
        }
        ...
        private void handleInboxImageMargin(RemoteViews contentView, int id, boolean first) {
            int endMargin = 0;
            if (first) {
                int i = this.mBuilder.mN.extras.getInt(Notification.EXTRA_PROGRESS_MAX, 0) == 0 ? this.mBuilder.mN.extras.getBoolean(Notification.EXTRA_PROGRESS_INDETERMINATE) : 1;
                if (this.mBuilder.mN.hasLargeIcon() && (i ^ 1) != 0) {
                    endMargin = 17105166;
                }
            }
    ...
    public static class MessagingStyle extends Style {
        ...
        private void fixTitleAndTextExtras(Bundle extras) {
            ...
            if (TextUtils.isEmpty(this.mConversationTitle)) {
                ...
                BidiFormatter bidi = BidiFormatter.getInstance();
                title = this.mBuilder.mContext.getString(17040520, bidi.unicodeWrap(this.mConversationTitle), bidi.unicodeWrap(m.mSender));
            }
            if (title != null) {
        ...
        public RemoteViews makeContentView(boolean increasedHeight) {
            ...
            CharSequence makeMessageLine = m == null ? null : this.mConversationTitle != null ? makeMessageLine(m, this.mBuilder) : m.mText;
            return this.mBuilder.applyStandardTemplate(this.mBuilder.getBaseLayoutResource(), this.mBuilder.mParams.reset().hasProgress(false).title(-get0).text(makeMessageLine));
        }
        ...
        public RemoteViews makeBigContentView() {
            ...
            int i = 0;
            contentView.setViewLayoutMarginBottomDimen(16909022, hasTitle ? 17105192 : 0);
            String str = "setNumIndentLines";
            int i2 = !this.mBuilder.mN.hasLargeIcon() ? 0 : hasTitle ? 1 : 2;
            contentView.setInt(16909112, str, i2);
            ...
            while (firstHistoricMessage + i < this.mHistoricMessages.size() && i < rowIds.length) {
                Message m = (Message) this.mHistoricMessages.get(firstHistoricMessage + i);
                rowId2 = rowIds[i];
            ...
            for (int currentMessage = Math.max(0, this.mMessages.size() - rowIds.length); currentMessage < this.mMessages.size() && i < rowIds.length; currentMessage++) {
                ...
                contentView.setTextViewText(rowId2, this.mBuilder.processTextSpans(makeMessageLine(m, this.mBuilder)));
            ...
            contentView.setInt(16909112, "setContractedChildId", contractedChildId);
            return contentView;
        }
        ...
        private CharSequence makeMessageLine(Message m, Builder builder) {
            ...
            if (TextUtils.isEmpty(m.mSender)) {
                unicodeWrap = bidi.unicodeWrap(this.mUserDisplayName == null ? "" : this.mUserDisplayName);
                if (colorize) {
            ...
            sb.append("  ").append(bidi.unicodeWrap(m.mText == null ? "" : m.mText));
            return sb;
        }
        ...
        public RemoteViews makeHeadsUpContentView(boolean increasedHeight) {
            ...
            CharSequence -get0 = this.mConversationTitle != null ? this.mConversationTitle : m == null ? null : m.mSender;
            CharSequence makeMessageLine = m == null ? null : this.mConversationTitle != null ? makeMessageLine(m, this.mBuilder) : m.mText;
            return this.mBuilder.applyStandardTemplateWithActions(this.mBuilder.getBigBaseLayoutResource(), this.mBuilder.mParams.reset().hasProgress(false).title(-get0).text(makeMessageLine));
        }
...
*/
    ...
    /* synthetic */ void lambda$-android_app_Notification_86388(Parcel parcel, PendingIntent intent, Parcel out, int outFlags) {
    ...
    public boolean hasCompletedProgress() {
        boolean z = false;
        if (!this.extras.containsKey(EXTRA_PROGRESS) || (this.extras.containsKey(EXTRA_PROGRESS_MAX) ^ 1) != 0 || this.extras.getInt(EXTRA_PROGRESS_MAX) == 0) {
            return false;
        }
    ...
    private void reduceImageSizesForRemoteView(RemoteViews remoteView, Context context, boolean isLowRam) {
        if (remoteView != null) {
            ...
            remoteView.reduceImageSizes(maxWidth, resources.getDimensionPixelSize(i));
        }
    }
    ...
    public boolean isColorized() {
        ...
        if (!this.extras.getBoolean(EXTRA_COLORIZED)) {
            z = false;
        } else if (!hasColorizedPermission()) {
