    ...
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
        ...
        if (parentMatches(startParent, endParent)) {
            ...
            if (startWidth == 0 || startHeight == 0) {
                ...
                if (!(startClip == null || (startClip.equals(endClip2) ^ 1) == 0) || (startClip == null && endClip2 != null)) {
                    numChanges++;
                }
                if (numChanges > 0) {
                    if (this.mResizeClip) {
            ...
            if (numChanges > 0) {
                if (this.mResizeClip) {
                    ...
                    if (startClip.equals(endClip)) {
                        view.setClipBounds(startClip);
                        animator = ObjectAnimator.ofObject(view, "clipBounds", sRectEvaluator, new Object[]{startClip, endClip});
                        animator.addListener(/* anonymous class already generated */);
                    }
                    anim = TransitionUtils.mergeAnimators(positionAnimator, animator);
                    endClip2 = endClip;
                } else {
