...
public final class AnimatorSet extends Animator implements AnimationFrameCallback {
    ...
    private ValueAnimator mDelayAnim = ValueAnimator.ofFloat(0.0f, 1.0f).setDuration(0);
    ...
    void animateBasedOnPlayTime(long currentPlayTime, long lastPlayTime, boolean inReverse) {
        ...
        for (i = 0; i < this.mEvents.size(); i++) {
            ...
            if (event.getTime() > currentPlayTime || event.getTime() == -1) {
                break;
            }
            ...
            if (index >= 0) {
                ...
                if (child.mStartTime != -1) {
                    if (parent.mEndTime == -1) {
                        ...
                        if (child.mTotalDuration == -1) {
                            j2 = -1;
                        } else {
                            j2 = child.mStartTime + child.mTotalDuration;
                        }
                        child.mEndTime = j2;
                    }
                }
