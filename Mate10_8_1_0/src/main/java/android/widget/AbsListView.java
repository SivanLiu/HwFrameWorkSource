...
public abstract class AbsListView extends AdapterView<ListAdapter> implements TextWatcher, OnGlobalLayoutListener, FilterListener, OnTouchModeChangeListener, RemoteAdapterConnectionCallback {
    ...
    private static final boolean SMART_SLIDE_PROPERTIES = SystemProperties.getBoolean("ro.config.uifirst_listview_optimization_enable", true);
    ...
    public class FlingRunnable implements Runnable {
        ...
        FlingRunnable() {
            ...
            if (AbsListView.SMART_SLIDE_PROPERTIES) {
                AbsListView.this.mFlingThreshold = this.mScroller.getScreenPPI() * 1.53f;
        ...
        void start(int initialVelocity) {
            ...
            if (AbsListView.SMART_SLIDE_PROPERTIES) {
                ...
                this.mScroller.fling(0, initialY, 0, initialVelocity, 0, Integer.MAX_VALUE, 0, Integer.MAX_VALUE, AbsListView.this.mMotionEventUpPosition - AbsListView.this.mMotionEventDownPosition);
            } else {
        ...
        int dealWith2DSDR(int delta, OverScroller scroller) {
            ...
            if (!(!HwFrameworkFactory.getHwNsdImpl().checkIs2DSDRCase(AbsListView.this.getContext(), viewRoot) || viewRoot.getView() == null || AbsListView.this.getChildAt(0) == null)) {
                ...
                if (0.0f < ratioToSet && ratioToSet <= 1.0f) {
                    ...
                    if (delta >= 0 || AbsListView.this.mItemCount - (AbsListView.this.mFirstPosition + AbsListView.this.getChildCount()) >= 2) {
                        if (delta >= 0 && AbsListView.this.mFirstPosition < 2) {
                        }
                        if (!isNearEdge) {
    ...
    class ListItemAccessibilityDelegate extends AccessibilityDelegate {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            if (lp instanceof LayoutParams) {
                i = ((LayoutParams) lp).isEnabled;
            } else {
                i = 0;
            }
            if (!AbsListView.this.isEnabled() || (r2 ^ 1) != 0) {
                return false;
            }
            switch (action) {
                case 4:
    ...
    public void setItemChecked(int position, boolean value) {
        if (this.mChoiceMode != 0) {
            ...
            if (this.mChoiceMode == 2 || this.mChoiceMode == 3) {
                ...
                boolean hasStableIds = this.mCheckedIdStates != null ? this.mAdapter.hasStableIds() : false;
