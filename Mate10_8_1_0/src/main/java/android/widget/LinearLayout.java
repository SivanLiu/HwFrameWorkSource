...
public class LinearLayout extends ViewGroup {
    ...
    void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (maxAscent[1] == -1 && maxAscent[0] == -1 && maxAscent[2] == -1) {
            ...
            widthSizeAndState = View.resolveSizeAndState(Math.max(this.mTotalLength, getSuggestedMinimumWidth()), widthMeasureSpec, 0);
            ...
            setMeasuredDimension((-16777216 & childState) | widthSizeAndState, View.resolveSizeAndState(Math.max(maxHeight + (this.mPaddingTop + this.mPaddingBottom), getSuggestedMinimumHeight()), heightMeasureSpec, childState << 16));
            if (matchHeight) {
