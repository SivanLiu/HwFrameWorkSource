...
public class DatePicker extends FrameLayout {
    ...
    static abstract class AbstractDatePickerDelegate implements DatePickerDelegate {
        ...
        public final void autofill(AutofillValue value) {
            if (value == null || (value.isDate() ^ 1) != 0) {
                Log.w(DatePicker.LOG_TAG, value + " could not be autofilled into " + this);
                return;
            }
    ...
    /* synthetic */ void lambda$-android_widget_DatePicker_6892(Context context, DatePicker v, int y, int m, int d) {
