    ...
    public static abstract class Stub extends Binder implements IEmcomManager {
        ...
        private static class Proxy implements IEmcomManager {
            ...
            public XEngineAppInfo getAppInfo(String packageName) throws RemoteException {
                ...
                Parcel _reply = Parcel.obtain();
                try {
                    XEngineAppInfo xEngineAppInfo;
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(packageName);
                    this.mRemote.transact(3, _data, _reply, 0);
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        xEngineAppInfo = (XEngineAppInfo) XEngineAppInfo.CREATOR.createFromParcel(_reply);
                    } else {
                        xEngineAppInfo = null;
                    }
                    _reply.recycle();
                    _data.recycle();
                    return xEngineAppInfo;
                } catch (Throwable th) {
                    _reply.recycle();
                    _data.recycle();
                }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    if (data.readInt() != 0) {
                        videoInfo = (VideoInfo) VideoInfo.CREATOR.createFromParcel(data);
                    } else {
                        videoInfo = null;
                    }
                ...
                case 2:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        emailInfo = (EmailInfo) EmailInfo.CREATOR.createFromParcel(data);
                    } else {
                        emailInfo = null;
                    }
