        ...
        if (inputMethod != null || msg.what == 1) {
            ...
            switch (msg.what) {
                ...
                case 32:
                    ...
                    InputConnection inputConnectionWrapper = inputContext != null ? new InputConnectionWrapper(this.mTarget, inputContext, missingMethods) : null;
                    info.makeCompatible(this.mTargetSdkVersion);
                    inputMethod.dispatchStartInputWithToken(inputConnectionWrapper, info, restarting, startInputToken);
                    args.recycle();
                    return;
                case 40:
                    args = (SomeArgs) msg.obj;
