...
public abstract class CollationIterator {
    ...
    private final void appendNumericSegmentCEs(CharSequence digits) {
        ...
        if (!-assertionsDisabled && (1 > length || length > 254)) {
            throw new AssertionError();
        } else if (-assertionsDisabled || length == 1 || digits.charAt(0) != '\u0000') {
...
jadx.core.utils.exceptions.CodegenException: Error generate insn: PHI: (r10_1 'pos' int) = (r10_0 'pos' int), (r10_4 'pos' int) binds: {(r10_4 'pos' int)=B:53:0x0142, (r10_0 'pos' int)=B:47:0x0102} in method: android.icu.impl.coll.CollationIterator.appendNumericSegmentCEs(java.lang.CharSequence):void
