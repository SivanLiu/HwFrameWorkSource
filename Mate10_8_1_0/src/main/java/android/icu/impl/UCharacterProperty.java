...
public final class UCharacterProperty {
    ...
    private UCharacterProperty() throws IOException {
        ...
        r18[5] = new IntProperty(this, 1) {
            int getValue(int c) {
                return uCharacterProperty.getType(c);
            }
        ...
        r18[9] = new IntProperty(this, 1) {
            int getValue(int c) {
                return UCharacterProperty.ntvGetType(UCharacterProperty.getNumericTypeValue(uCharacterProperty.getProperty(c)));
            }
        ...
        final UCharacterProperty uCharacterProperty2 = this;
        ...
        r18[11] = new IntProperty(this, 2) {
            int getValue(int c) {
                int gcb = (uCharacterProperty.getAdditional(c, 2) & UCharacterProperty.GCB_MASK) >>> 5;
