                ...
                if (this.transitionCount > 0) {
                    ...
                    if (iArr3 != null) {
                        ...
                        while (i < iArr3.length / 2) {
                            this.transitionTimes64[i2] = ((((long) iArr3[i * 2]) & 4294967295L) << 32) | (((long) iArr3[(i * 2) + 1]) & 4294967295L);
                            i++;
                            i2++;
                        }
                    }
                    ...
                    if (iArr != null) {
                        ...
                        while (i < iArr.length / 2) {
                            this.transitionTimes64[i2] = ((((long) iArr[i * 2]) & 4294967295L) << 32) | (((long) iArr[(i * 2) + 1]) & 4294967295L);
                            i++;
                            i2++;
                        }
                    }
            ...
            if (local || sec >= this.transitionTimes64[0]) {
                ...
                while (transIdx >= 0) {
                    ...
                    if (local && sec >= transition - 86400) {
                        ...
                        int i = dstBefore ? dstAfter ^ 1 : 0;
                        boolean z = !dstBefore ? dstAfter : false;
                        transition = offsetAfter - offsetBefore >= 0 ? (((NonExistingTimeOpt & 3) != 1 || i == 0) && !((NonExistingTimeOpt & 3) == 3 && z)) ? (!((NonExistingTimeOpt & 3) == 1 && z) && ((NonExistingTimeOpt & 3) != 3 || i == 0)) ? (NonExistingTimeOpt & 12) == 12 ? transition + ((long) offsetBefore) : transition + ((long) offsetAfter) : transition + ((long) offsetAfter) : transition + ((long) offsetBefore) : (((DuplicatedTimeOpt & 3) != 1 || i == 0) && !((DuplicatedTimeOpt & 3) == 3 && z)) ? (!((DuplicatedTimeOpt & 3) == 1 && z) && ((DuplicatedTimeOpt & 3) != 3 || i == 0)) ? (DuplicatedTimeOpt & 12) == 4 ? transition + ((long) offsetBefore) : transition + ((long) offsetAfter) : transition + ((long) offsetBefore) : transition + ((long) offsetAfter);
                    }
                    if (sec >= transition) {
                        break;
                    }
    ...
    public TimeZoneRule[] getTimeZoneRules() {
        ...
        if (this.finalZone != null) {
            if (this.finalZone.useDaylightTime()) {
                ...
                idx = i2 + 1;
                rules[i2] = new TimeArrayTimeZoneRule(getID() + "(STD)", this.finalZone.getRawOffset(), 0, new long[]{(long) this.finalStartMillis}, 2);
                i2 = idx;
            }
        }
        return rules;
