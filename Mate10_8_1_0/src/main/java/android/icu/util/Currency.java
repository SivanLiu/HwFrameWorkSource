...
public class Currency extends MeasureUnit {
    ...
    public int getNumericCode() {
        int result = 0;
        try {
            result = UResourceBundle.getBundleInstance(ICUData.ICU_BASE_NAME, "currencyNumericCodes", ICUResourceBundle.ICU_DATA_CLASS_LOADER).get("codeMap").get(this.subType).getInt();
