...
class TransliteratorParser {
    ...
    private int parseRule(String rule, int pos, int limit) {
        ...
        if (right.ante < 0 && right.post < 0 && left.cursor < 0 && ((right.cursorOffset == 0 || right.cursor >= 0) && !right.anchorStart && !right.anchorEnd && (left.isValidInput(this) ^ 1) == 0 && (right.isValidOutput(this) ^ 1) == 0)) {
