...
jadx.core.utils.exceptions.CodegenException: Error generate insn: PHI: (r17_3 'zeroCount' int) = (r17_0 'zeroCount' int), (r17_1 'zeroCount' int) binds: {(r17_1 'zeroCount' int)=B:9:0x0035, (r17_0 'zeroCount' int)=B:1:0x0006} in method: android.icu.text.NumeratorSubstitution.doParse(java.lang.String, java.text.ParsePosition, double, double, boolean):java.lang.Number
