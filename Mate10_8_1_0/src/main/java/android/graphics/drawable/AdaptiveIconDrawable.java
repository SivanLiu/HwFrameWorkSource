...
public class AdaptiveIconDrawable extends Drawable implements Callback {
    ...
    AdaptiveIconDrawable(LayerState state, Resources res) {
        ...
        if (sMask == null) {
            sMask = PathParser.createPathFromPathData(Resources.getSystem().getString(17039800));
        }
        this.mMask = PathParser.createPathFromPathData(Resources.getSystem().getString(17039800));
    ...
    private void updateMaskBoundsInternal(Rect b) {
        ...
        if (this.mMaskBitmap != null && this.mMaskBitmap.getWidth() == b.width()) {
            if (this.mMaskBitmap.getHeight() != b.height()) {
            }
