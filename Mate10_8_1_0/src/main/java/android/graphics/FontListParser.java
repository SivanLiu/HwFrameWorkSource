...
public class FontListParser {
    ...
    private static Font readFont(XmlPullParser parser) throws XmlPullParserException, IOException {
        ...
        return new Font(FILENAME_WHITESPACE_PATTERN.matcher(filename).replaceAll(""), index, (FontVariationAxis[]) axes.toArray(new FontVariationAxis[axes.size()]), weight, isItalic);
    }
