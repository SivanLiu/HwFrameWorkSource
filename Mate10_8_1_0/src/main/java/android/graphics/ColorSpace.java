...
import android.graphics.-$Lambda$ZrP-zejiEXAqfwV-MyP5lE9mYC8.AnonymousClass1;
...
public abstract class ColorSpace {
    ...
    public static class Rgb extends ColorSpace {
        ...
        private Rgb(String name, float[] primaries, float[] whitePoint, TransferParameters function, int id) {
            DoubleUnaryOperator anonymousClass1;
            DoubleUnaryOperator anonymousClass12;
            if (function.e == 0.0d && function.f == 0.0d) {
                anonymousClass1 = new AnonymousClass1((byte) 0, function);
            } else {
                anonymousClass1 = new AnonymousClass1((byte) 1, function);
            }
            if (function.e == 0.0d && function.f == 0.0d) {
                anonymousClass12 = new AnonymousClass1((byte) 2, function);
            } else {
                anonymousClass12 = new AnonymousClass1((byte) 3, function);
            }
            this(name, primaries, whitePoint, anonymousClass1, anonymousClass12, 0.0f, 1.0f, id);
        ...
        private Rgb(String name, float[] primaries, float[] whitePoint, double gamma, float min, float max, int id) {
            ...
            if (gamma == 1.0d) {
                ...
                identity = new AnonymousClass2((byte) 0, gamma);
            }
            if (gamma == 1.0d) {
                identity2 = DoubleUnaryOperator.identity();
            } else {
                identity2 = new AnonymousClass2((byte) 1, gamma);
            }
        ...
        private Rgb(String name, float[] primaries, float[] whitePoint, DoubleUnaryOperator oetf, DoubleUnaryOperator eotf, float min, float max, int id) {
            ...
            if (primaries == null || !(primaries.length == 6 || primaries.length == 9)) {
                ...
                this.mMin = min;
                this.mMax = max;
                DoubleUnaryOperator clamp = new AnonymousClass1((byte) 4, this);
        ...
        /* synthetic */ double -android_graphics_ColorSpace$Rgb-mthref-0(double d) {
            return clamp(d);
        }
        ...
        public int hashCode() {
            int floatToIntBits;
            int i = 0;
            int hashCode = ((((((super.hashCode() * 31) + Arrays.hashCode(this.mWhitePoint)) * 31) + Arrays.hashCode(this.mPrimaries)) * 31) + (this.mMin != 0.0f ? Float.floatToIntBits(this.mMin) : 0)) * 31;
            if (this.mMax != 0.0f) {
    ...
    static {
        ...
        colorSpaceArr[ordinal] = new Rgb("sRGB IEC61966-2.1", fArr, fArr2, new TransferParameters(0.9478672985781991d, 0.05213270142180095d, 0.07739938080495357d, 0.04045d, 2.4d), Named.SRGB.ordinal());
        ...
        sNamedColorSpaces[Named.EXTENDED_SRGB.ordinal()] = new Rgb("scRGB-nl IEC 61966-2-2:2003", SRGB_PRIMARIES, ILLUMINANT_D65, -$Lambda$ZrP-zejiEXAqfwV-MyP5lE9mYC8.$INST$0, -$Lambda$ZrP-zejiEXAqfwV-MyP5lE9mYC8.$INST$1, -0.799f, 2.399f, Named.EXTENDED_SRGB.ordinal());
        ...
        colorSpaceArr[ordinal] = new Rgb("Rec. ITU-R BT.709-5", fArr, fArr2, new TransferParameters(0.9099181073703367d, 0.09008189262966333d, 0.2222222222222222d, 0.081d, 2.2222222222222223d), Named.BT709.ordinal());
        colorSpaceArr = sNamedColorSpaces;
        ordinal = Named.BT2020.ordinal();
        fArr = new float[]{0.708f, 0.292f, 0.17f, 0.797f, 0.131f, 0.046f};
        fArr2 = ILLUMINANT_D65;
        colorSpaceArr[ordinal] = new Rgb("Rec. ITU-R BT.2020-1", fArr, fArr2, new TransferParameters(0.9096697898662786d, 0.09033021013372146d, 0.2222222222222222d, 0.08145d, 2.2222222222222223d), Named.BT2020.ordinal());
        ...
        fArr2 = ILLUMINANT_D65;
        colorSpaceArr[ordinal] = new Rgb("Display P3", fArr, fArr2, new TransferParameters(0.9478672985781991d, 0.05213270142180095d, 0.07739938080495357d, 0.039d, 2.4d), Named.DISPLAY_P3.ordinal());
        colorSpaceArr = sNamedColorSpaces;
        ordinal = Named.NTSC_1953.ordinal();
        fArr = NTSC_1953_PRIMARIES;
        fArr2 = ILLUMINANT_C;
        colorSpaceArr[ordinal] = new Rgb("NTSC (1953)", fArr, fArr2, new TransferParameters(0.9099181073703367d, 0.09008189262966333d, 0.2222222222222222d, 0.081d, 2.2222222222222223d), Named.NTSC_1953.ordinal());
        colorSpaceArr = sNamedColorSpaces;
        ordinal = Named.SMPTE_C.ordinal();
        fArr = new float[]{0.63f, 0.34f, 0.31f, 0.595f, 0.155f, 0.07f};
        fArr2 = ILLUMINANT_D65;
        colorSpaceArr[ordinal] = new Rgb("SMPTE-C RGB", fArr, fArr2, new TransferParameters(0.9099181073703367d, 0.09008189262966333d, 0.2222222222222222d, 0.081d, 2.2222222222222223d), Named.SMPTE_C.ordinal());
        ...
        colorSpaceArr[ordinal] = new Rgb("ROMM RGB ISO 22028-2:2013", fArr, fArr2, new TransferParameters(1.0d, 0.0d, 0.0625d, 0.031248d, 1.8d), Named.PRO_PHOTO_RGB.ordinal());
