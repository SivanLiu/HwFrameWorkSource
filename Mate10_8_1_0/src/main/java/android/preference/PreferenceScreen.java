...
public final class PreferenceScreen extends PreferenceGroup implements OnItemClickListener, OnDismissListener {
    ...
    public PreferenceScreen(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, R.styleable.PreferenceScreen, R.attr.preferenceScreenStyle, 0);
    ...
    private void showDialog(Bundle state) {
        ...
        View childPrefScreen = ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(this.mLayoutResId, null);
