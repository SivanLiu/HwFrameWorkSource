...
public abstract class Connection extends Conferenceable {
    ...
    public static abstract class VideoProvider {
        ...
        public static final int SESSION_MODIFY_REQUEST_CANCEL = 6;
        public static final int SESSION_MODIFY_REQUEST_FAIL = 2;
        public static final int SESSION_MODIFY_REQUEST_INVALID = 3;
        public static final int SESSION_MODIFY_REQUEST_REJECTED_BY_REMOTE = 5;
        public static final int SESSION_MODIFY_REQUEST_SUCCESS = 1;
...
*/
    ...
    public final void sendRttInitiationSuccess() {
        setRttProperty();
        this.mListeners.forEach(new -$Lambda$4SVh5muPQdDUeBsBoEG9OejHF-s((byte) 1, this));
    }

    /* synthetic */ void lambda$-android_telecom_Connection_107194(Listener l) {
        l.onRttInitiationSuccess(this);
    }

    public final void sendRttInitiationFailure(int reason) {
        unsetRttProperty();
        this.mListeners.forEach(new android.telecom.-$Lambda$4SVh5muPQdDUeBsBoEG9OejHF-s.AnonymousClass1(reason, this));
    }

    /* synthetic */ void lambda$-android_telecom_Connection_107803(int reason, Listener l) {
        l.onRttInitiationFailure(this, reason);
    }

    /* synthetic */ void lambda$-android_telecom_Connection_108117(Listener l) {
        l.onRttSessionRemotelyTerminated(this);
    }

    public final void sendRttSessionRemotelyTerminated() {
        this.mListeners.forEach(new -$Lambda$4SVh5muPQdDUeBsBoEG9OejHF-s((byte) 2, this));
    }

    /* synthetic */ void lambda$-android_telecom_Connection_108428(Listener l) {
        l.onRemoteRttRequest(this);
    }

    public final void sendRemoteRttRequest() {
        this.mListeners.forEach(new -$Lambda$4SVh5muPQdDUeBsBoEG9OejHF-s((byte) 0, this));
    }
    ...
    void setRttProperty() {
        setConnectionProperties(getConnectionProperties() | 256);
    }

    void unsetRttProperty() {
        setConnectionProperties(getConnectionProperties() & -257);
    }
