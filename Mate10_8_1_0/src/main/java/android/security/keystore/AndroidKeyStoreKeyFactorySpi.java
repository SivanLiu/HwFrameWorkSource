...
public class AndroidKeyStoreKeyFactorySpi extends KeyFactorySpi {
    ...
    protected <T extends KeySpec> T engineGetKeySpec(Key key, Class<T> keySpecClass) throws InvalidKeySpecException {
        if (key == null) {
            ...
            throw new InvalidKeySpecException("Obtaining RSAPublicKeySpec not supported for " + key.getAlgorithm() + " " + (key instanceof AndroidKeyStorePrivateKey ? VolumeInfo.ID_PRIVATE_INTERNAL : "public") + " key");
            ...
            throw new InvalidKeySpecException("Obtaining ECPublicKeySpec not supported for " + key.getAlgorithm() + " " + (key instanceof AndroidKeyStorePrivateKey ? VolumeInfo.ID_PRIVATE_INTERNAL : "public") + " key");
        }
    }
