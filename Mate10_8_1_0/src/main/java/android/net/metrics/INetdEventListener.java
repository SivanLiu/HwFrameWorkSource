...
public interface INetdEventListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements INetdEventListener {
        ...
        static final int TRANSACTION_onWakeupEvent = 3;
        ...
        private static class Proxy implements INetdEventListener {
            ...
            public void onWakeupEvent(String prefix, int uid, int gid, long timestampNs) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    ...
                    _arg1 = data.readInt();
                    onWakeupEvent(_arg02, _arg1, data.readInt(), data.readLong());
                    return true;
                case 1598968902:
    ...
    void onWakeupEvent(String str, int i, int i2, long j) throws RemoteException;
}
