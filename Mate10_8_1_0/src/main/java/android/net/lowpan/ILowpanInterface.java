...
public interface ILowpanInterface extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ILowpanInterface {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            byte[] _result3;
            boolean _result4;
            LowpanProvision lowpanProvision;
            IpPrefix ipPrefix;
            switch (code) {
                case 1:
                ...
                case 20:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        lowpanProvision = (LowpanProvision) LowpanProvision.CREATOR.createFromParcel(data);
                    } else {
                        lowpanProvision = null;
                    }
                ...
                case 24:
                    ...
                    return true;
                case 25:
                    LowpanBeaconInfo lowpanBeaconInfo;
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        lowpanBeaconInfo = (LowpanBeaconInfo) LowpanBeaconInfo.CREATOR.createFromParcel(data);
                    } else {
                        lowpanBeaconInfo = null;
                    }
                    startCommissioningSession(lowpanBeaconInfo);
                    reply.writeNoException();
                    return true;
                case 26:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 37:
                    ...
                    addOnMeshPrefix(ipPrefix, data.readInt());
                    reply.writeNoException();
                    return true;
                case 38:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 39:
                    ...
                    addExternalRoute(ipPrefix, data.readInt());
                    reply.writeNoException();
                    return true;
                case 40:
                    data.enforceInterface(DESCRIPTOR);
