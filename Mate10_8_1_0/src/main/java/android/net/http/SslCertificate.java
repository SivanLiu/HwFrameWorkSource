...
public class SslCertificate {
    ...
    public View inflateCertificateView(Context context) {
        View certificateView = LayoutInflater.from(context).inflate(17367277, null);
        DName issuedTo = getIssuedTo();
        if (issuedTo != null) {
            ((TextView) certificateView.findViewById(16909394)).setText(issuedTo.getCName());
            ((TextView) certificateView.findViewById(16909396)).setText(issuedTo.getOName());
            ((TextView) certificateView.findViewById(16909398)).setText(issuedTo.getUName());
        }
        ((TextView) certificateView.findViewById(16909267)).setText(getSerialNumber(this.mX509Certificate));
        DName issuedBy = getIssuedBy();
        if (issuedBy != null) {
            ((TextView) certificateView.findViewById(16908772)).setText(issuedBy.getCName());
            ((TextView) certificateView.findViewById(16908774)).setText(issuedBy.getOName());
            ((TextView) certificateView.findViewById(16908776)).setText(issuedBy.getUName());
        }
        ((TextView) certificateView.findViewById(16908995)).setText(formatCertificateDate(context, getValidNotBeforeDate()));
        ((TextView) certificateView.findViewById(16908863)).setText(formatCertificateDate(context, getValidNotAfterDate()));
        ((TextView) certificateView.findViewById(16909274)).setText(getDigest(this.mX509Certificate, "SHA256"));
        ((TextView) certificateView.findViewById(16909272)).setText(getDigest(this.mX509Certificate, "SHA1"));
