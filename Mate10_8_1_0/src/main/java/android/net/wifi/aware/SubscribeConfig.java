...
public final class SubscribeConfig implements Parcelable {
    ...
    public String toString() {
        ...
        int i;
        int i2 = 0;
        StringBuilder append = new StringBuilder().append("SubscribeConfig [mServiceName='");
        if (this.mServiceName == null) {
            str = "<null>";
        } else {
            str = String.valueOf(HexEncoding.encode(this.mServiceName));
        }
        append = append.append(str).append(", mServiceName.length=").append(this.mServiceName == null ? 0 : this.mServiceName.length).append(", mServiceSpecificInfo='").append(this.mServiceSpecificInfo == null ? "<null>" : String.valueOf(HexEncoding.encode(this.mServiceSpecificInfo))).append(", mServiceSpecificInfo.length=");
        ...
        return append2.append(i2).append(", mSubscribeType=").append(this.mSubscribeType).append(", mTtlSec=").append(this.mTtlSec).append(", mEnableTerminateNotification=").append(this.mEnableTerminateNotification).append("]").toString();
    }
