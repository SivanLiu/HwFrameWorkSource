...
public final class PublishConfig implements Parcelable {
    ...
    public String toString() {
        int i;
        int i2 = 0;
        StringBuilder append = new StringBuilder().append("PublishConfig [mServiceName='").append(this.mServiceName == null ? "<null>" : String.valueOf(HexEncoding.encode(this.mServiceName))).append(", mServiceName.length=").append(this.mServiceName == null ? 0 : this.mServiceName.length).append(", mServiceSpecificInfo='").append(this.mServiceSpecificInfo == null ? "<null>" : String.valueOf(HexEncoding.encode(this.mServiceSpecificInfo))).append(", mServiceSpecificInfo.length=");
        if (this.mServiceSpecificInfo == null) {
            i = 0;
        } else {
            i = this.mServiceSpecificInfo.length;
        }
        StringBuilder append2 = append.append(i).append(", mMatchFilter=").append(new TlvIterable(0, 1, this.mMatchFilter).toString()).append(", mMatchFilter.length=");
        if (this.mMatchFilter != null) {
            i2 = this.mMatchFilter.length;
        }
        return append2.append(i2).append(", mPublishType=").append(this.mPublishType).append(", mTtlSec=").append(this.mTtlSec).append(", mEnableTerminateNotification=").append(this.mEnableTerminateNotification).append("]").toString();
    }
