...
public interface IWifiScannerImpl extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWifiScannerImpl {
        ...
        static final int TRANSACTION_abortScan = 13;
        ...
        static final int TRANSACTION_startPnoScan = 11;
        static final int TRANSACTION_stopPnoScan = 12;
        static final int TRANSACTION_subscribePnoScanEvents = 9;
        static final int TRANSACTION_subscribeScanEvents = 7;
        static final int TRANSACTION_unsubscribePnoScanEvents = 10;
        static final int TRANSACTION_unsubscribeScanEvents = 8;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 6:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        singleScanSettings = (SingleScanSettings) SingleScanSettings.CREATOR.createFromParcel(data);
                    } else {
                        singleScanSettings = null;
                    }
                    _result3 = scan(singleScanSettings);
                    reply.writeNoException();
                    if (_result3) {
                        i = 1;
                    }
                ...
                case 11:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        pnoSettings = (PnoSettings) PnoSettings.CREATOR.createFromParcel(data);
                    } else {
                        pnoSettings = null;
                    }
                    _result3 = startPnoScan(pnoSettings);
                    reply.writeNoException();
                    if (_result3) {
                        i = 1;
                    }
