...
public final class HomeSp implements Parcelable {
    ...
    public boolean equals(Object thatObject) {
        ...
        if (TextUtils.equals(this.mFqdn, that.mFqdn) && TextUtils.equals(this.mFriendlyName, that.mFriendlyName) && TextUtils.equals(this.mIconUrl, that.mIconUrl)) {
            if (this.mHomeNetworkIds != null) {
                if (this.mHomeNetworkIds.equals(that.mHomeNetworkIds)) {
                }
            }
            if (Arrays.equals(this.mMatchAllOis, that.mMatchAllOis) && Arrays.equals(this.mMatchAnyOis, that.mMatchAnyOis) && Arrays.equals(this.mOtherHomePartners, that.mOtherHomePartners)) {
