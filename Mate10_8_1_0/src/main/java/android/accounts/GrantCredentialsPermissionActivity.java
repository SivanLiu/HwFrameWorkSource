...
public class GrantCredentialsPermissionActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            final TextView authTokenTypeView = (TextView) findViewById(16908734);
            ...
            findViewById(16908715).setOnClickListener(this);
            findViewById(16908841).setOnClickListener(this);
            LinearLayout packagesListView = (LinearLayout) findViewById(16909144);
            ...
            ((TextView) findViewById(16908666)).setText(this.mAccount.name);
            ((TextView) findViewById(16908669)).setText(accountTypeLabel);
    ...
    private View newPackageView(String packageLabel) {
        ...
        ((TextView) view.findViewById(16909143)).setText(packageLabel);
        return view;
    }
