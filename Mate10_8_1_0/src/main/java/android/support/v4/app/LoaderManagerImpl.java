...
class LoaderManagerImpl extends LoaderManager {
    ...
    final class LoaderInfo implements OnLoadCompleteListener<Object>, OnLoadCanceledListener<Object> {
        ...
        void start() {
            if (this.mRetaining && this.mRetainingStarted) {
                ...
                if (this.mLoader != null) {
                    if (!this.mLoader.getClass().isMemberClass() || (Modifier.isStatic(this.mLoader.getClass().getModifiers()) ^ 1) == 0) {
        ...
        void finishRetain() {
            ...
            if (this.mStarted && this.mHaveData && (this.mReportNextStart ^ 1) != 0) {
        ...
        void reportStart() {
            if (this.mStarted && this.mReportNextStart) {
                ...
                if (this.mHaveData && (this.mRetaining ^ 1) != 0) {
                    callOnLoadFinished(this.mLoader, this.mData);
                }
            }
        }
        ...
        public void onLoadComplete(Loader<Object> loader, Object data) {
            ...
            if (this.mDestroyed) {
                ...
                if (!(this.mData == data && (this.mHaveData ^ 1) == 0)) {
                    this.mData = data;
                    this.mHaveData = true;
                    if (this.mStarted) {
                ...
                if (!(LoaderManagerImpl.this.mHost == null || (LoaderManagerImpl.this.hasRunningLoaders() ^ 1) == 0)) {
    ...
    public void destroyLoader(int id) {
        ...
        if (this.mHost != null && (hasRunningLoaders() ^ 1) != 0) {
    ...
    public boolean hasRunningLoaders() {
        ...
        for (int i = 0; i < this.mLoaders.size(); i++) {
            LoaderInfo li = (LoaderInfo) this.mLoaders.valueAt(i);
            loadersRunning |= li.mStarted ? li.mDeliveredData ^ 1 : 0;
        }
