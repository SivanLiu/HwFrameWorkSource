...
public class SlidingPaneLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mDragHelper.getViewDragState() != 0 && (canSlide ^ 1) != 0) {
    ...
    public void requestChildFocus(View child, View focused) {
        ...
        if (!isInTouchMode() && (this.mCanSlide ^ 1) != 0) {
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (!(!this.mCanSlide || (lp.slideable ^ 1) == 0 || this.mSlideableView == null)) {
    ...
    public void draw(Canvas c) {
        ...
        if (childAt != null && shadowDrawable != null) {
            int left;
            int right;
    ...
    protected boolean canScroll(View v, boolean checkV, int dx, int x, int y) {
        ...
        if (checkV) {
            ...
            canScrollHorizontally = v.canScrollHorizontally(dx);
        } else {
