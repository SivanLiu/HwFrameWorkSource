...
class MediaSessionCompatApi21 {
    ...
    public static void setQueue(Object sessionObj, List<Object> queueObjs) {
        ...
        Iterator itemObj$iterator = queueObjs.iterator();
        while (itemObj$iterator.hasNext()) {
            queue.add((android.media.session.MediaSession.QueueItem) itemObj$iterator.next());
        }
