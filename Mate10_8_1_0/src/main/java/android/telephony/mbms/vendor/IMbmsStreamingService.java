    ...
    public static abstract class Stub extends Binder implements IMbmsStreamingService {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    _result = startStreaming(data.readInt(), data.readString(), android.telephony.mbms.IStreamingServiceCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    Uri _result2 = getPlaybackUri(data.readInt(), data.readString());
                    reply.writeNoException();
                    if (_result2 != null) {
                        reply.writeInt(1);
