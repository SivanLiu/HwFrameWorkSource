...
public class ServiceState implements Parcelable {
    ...
    public String toString() {
        String str;
        StringBuilder append = new StringBuilder().append("{mVoiceRegState=").append(this.mVoiceRegState).append("(").append(rilServiceStateToString(this.mVoiceRegState)).append(")").append(", mDataRegState=").append(this.mDataRegState).append("(").append(rilServiceStateToString(this.mDataRegState)).append(")").append(", mVoiceRoamingType=").append(getRoamingLogString(this.mVoiceRoamingType)).append(", mDataRoamingType=").append(getRoamingLogString(this.mDataRoamingType)).append(", mVoiceOperatorAlphaLong=").append(this.mVoiceOperatorAlphaLong).append(", mVoiceOperatorAlphaShort=").append(this.mVoiceOperatorAlphaShort).append(", mDataOperatorAlphaLong=").append(this.mDataOperatorAlphaLong).append(", mDataOperatorAlphaShort=").append(this.mDataOperatorAlphaShort).append(", isManualNetworkSelection=").append(this.mIsManualNetworkSelection);
        if (this.mIsManualNetworkSelection) {
            str = "(manual)";
        } else {
            str = "(automatic)";
        }
        append = append.append(str).append(", mRilVoiceRadioTechnology=").append(this.mRilVoiceRadioTechnology).append("(").append(rilRadioTechnologyToString(this.mRilVoiceRadioTechnology)).append(")").append(", mRilDataRadioTechnology=").append(this.mRilDataRadioTechnology).append("(").append(rilRadioTechnologyToString(this.mRilDataRadioTechnology)).append(")").append(", mCssIndicator=");
        if (this.mCssIndicator) {
            str = "supported";
        } else {
            str = "unsupported";
        }
        return append.append(str).append(", mNetworkId=").append(this.mNetworkId).append(", mSystemId=").append(this.mSystemId).append(", mCdmaRoamingIndicator=").append(this.mCdmaRoamingIndicator).append(", mCdmaDefaultRoamingIndicator=").append(this.mCdmaDefaultRoamingIndicator).append(", mIsEmergencyOnly=").append(this.mIsEmergencyOnly).append(", mIsDataRoamingFromRegistration=").append(this.mIsDataRoamingFromRegistration).append(", mIsUsingCarrierAggregation=").append(this.mIsUsingCarrierAggregation).append(", mLteEarfcnRsrpBoost=").append(this.mLteEarfcnRsrpBoost).append("}").toString();
    }
