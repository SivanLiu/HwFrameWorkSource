...
public class CarrierConfigManager {
    ...
    public static final String KEY_CARRIER_VIWIFI_AVAILABLE_BOOL = "carrier_viwifi_available_bool";
    ...
    static {
        ...
        sDefaults.putBoolean(KEY_CARRIER_VIWIFI_AVAILABLE_BOOL, false);
        ...
        sDefaults.putStringArray(KEY_CARRIER_METERED_IWLAN_APN_TYPES_STRINGS, new String[0]);
        ...
        sDefaults.putBoolean("smsDeliveryReportSettingOnByDefault", false);
        sDefaults.putBoolean("enableWapPushSI", true);
        sDefaults.putBoolean("allowEnablingWapPushSI", true);
