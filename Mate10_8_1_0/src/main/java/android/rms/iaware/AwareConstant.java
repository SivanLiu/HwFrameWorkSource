...
public class AwareConstant {
    ...
    public static class AppUsageDatabase {
        ...
        private static final String[] USAGE_TABLES = new String[]{UsageTables.APPUSAGE};
        ...
        public static int getTableCount() {
            return USAGE_TABLES.length;
        }

        public static String getTableNameByIdx(int idx) {
            if (idx < 0 || idx >= USAGE_TABLES.length) {
                return "Unknown";
            }
            return USAGE_TABLES[idx];
        }
