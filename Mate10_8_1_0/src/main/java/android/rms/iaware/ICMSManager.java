...
public interface ICMSManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICMSManager {
        ...
        private static class Proxy implements ICMSManager {
            ...
            public boolean deleteAppCmpTypeInfo(int uid, String pkgName) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 14:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        cmpTypeInfo = (CmpTypeInfo) CmpTypeInfo.CREATOR.createFromParcel(data);
                    } else {
                        cmpTypeInfo = null;
                    }
                    _result = insertCmpTypeInfo(cmpTypeInfo);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 15:
                    ...
                    _result = deleteCmpTypeInfo(cmpTypeInfo);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 16:
                ...
                case 17:
                    data.enforceInterface(DESCRIPTOR);
                    _result = deleteAppCmpTypeInfo(data.readInt(), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 18:
    ...
    boolean deleteAppCmpTypeInfo(int i, String str) throws RemoteException;
