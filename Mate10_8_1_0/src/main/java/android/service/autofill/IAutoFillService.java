        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 2:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        fillRequest = (FillRequest) FillRequest.CREATOR.createFromParcel(data);
                    } else {
                        fillRequest = null;
                    }
                    onFillRequest(fillRequest, android.service.autofill.IFillCallback.Stub.asInterface(data.readStrongBinder()));
                    return true;
                case 3:
                    ...
                    onSaveRequest(saveRequest, android.service.autofill.ISaveCallback.Stub.asInterface(data.readStrongBinder()));
                    return true;
                case 1598968902:
