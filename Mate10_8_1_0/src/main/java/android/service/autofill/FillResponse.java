...
public final class FillResponse implements Parcelable {
    public static final Creator<FillResponse> CREATOR = new Creator<FillResponse>() {
        public FillResponse createFromParcel(Parcel parcel) {
            ...
            List list = datasetSlice != null ? datasetSlice.getList() : null;
            int datasetCount = list != null ? list.size() : 0;
    ...
    private FillResponse(Builder builder) {
        ...
        if (builder.mDatasets != null) {
            parceledListSlice = new ParceledListSlice(builder.mDatasets);
        }
    ...
    public String toString() {
        ...
        boolean z2;
        StringBuilder append = new StringBuilder("FillResponse : [mRequestId=" + this.mRequestId).append(", datasets=").append(this.mDatasets == null ? "N/A" : this.mDatasets.getList()).append(", saveInfo=").append(this.mSaveInfo).append(", clientState=");
