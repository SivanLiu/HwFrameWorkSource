        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    if (data.readInt() != 0) {
                        getDownloadableSubscriptionMetadataResult = (GetDownloadableSubscriptionMetadataResult) GetDownloadableSubscriptionMetadataResult.CREATOR.createFromParcel(data);
                    } else {
                        getDownloadableSubscriptionMetadataResult = null;
                    }
                    onComplete(getDownloadableSubscriptionMetadataResult);
                    return true;
                case 1598968902:
