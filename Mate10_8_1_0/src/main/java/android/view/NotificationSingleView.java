...
public class NotificationSingleView extends NotificationHeaderView {
    ...
    public NotificationSingleView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mChildMinWidth = getResources().getDimensionPixelSize(17105185);
    }

    protected void onFinishInflate() {
        super.onFinishInflate();
        this.mAppName = findViewById(16908727);
        this.mIcon = (CachingIconView) findViewById(16908294);
        this.mText = (ImageFloatingTextView) findViewById(16909351);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (totalWidth < givenWidth) {
            ...
            if (overFlow > 0 && this.mAppName.getVisibility() != 8 && appWidth > this.mChildMinWidth) {
                newSize = appWidth - (appWidth - this.mChildMinWidth > overFlow ? overFlow : appWidth - this.mChildMinWidth);
            ...
            if (overFlow > 0 && this.mText.getVisibility() != 8) {
                textWidth = this.mText.getMeasuredWidth();
                newSize = textWidth - (textWidth - this.mChildMinWidth > overFlow ? overFlow : textWidth - this.mChildMinWidth);
            ...
            if (overFlow > 0 && this.mTitle.getVisibility() != 8) {
                ...
                newSize = titleWidth - (titleWidth - this.mChildMinWidth > overFlow ? overFlow : titleWidth - this.mChildMinWidth);
