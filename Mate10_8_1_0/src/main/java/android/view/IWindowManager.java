...
public interface IWindowManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWindowManager {
        ...
        static final int TRANSACTION_disableSurfaceTrace = 56;
        static final int TRANSACTION_dismissKeyguard = 42;
        static final int TRANSACTION_enableScreenIfNeeded = 75;
        static final int TRANSACTION_enableSurfaceTrace = 55;
        ...
        static final int TRANSACTION_freezeRotation = 62;
        static final int TRANSACTION_getAccelPackages = 87;
        ...
        static final int TRANSACTION_getDefaultDisplayRotation = 58;
        static final int TRANSACTION_getDockedStackSide = 78;
        static final int TRANSACTION_getFocusedAppComponentName = 94;
        static final int TRANSACTION_getHwInnerService = 93;
        static final int TRANSACTION_getInitialDisplayDensity = 10;
        static final int TRANSACTION_getInitialDisplaySize = 6;
        static final int TRANSACTION_getLayerIndex = 92;
        static final int TRANSACTION_getPendingAppTransition = 21;
        static final int TRANSACTION_getPreferredOptionsPanelGravity = 61;
        ...
        static final int TRANSACTION_isRotationFrozen = 64;
        ...
        static final int TRANSACTION_removeRotationWatcher = 60;
        ...
        static final int TRANSACTION_screenshotWallpaper = 65;
        ...
        static final int TRANSACTION_setDockedStackResizing = 79;
        ...
        static final int TRANSACTION_setForcedDisplayDensityAndSize = 88;
        ...
        static final int TRANSACTION_setPipVisibility = 71;
        ...
        static final int TRANSACTION_thawRotation = 63;
        ...
        static final int TRANSACTION_watchRotation = 59;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 25:
                    ...
                    overridePendingAppTransitionThumb(graphicBuffer, data.readInt(), data.readInt(), android.os.IRemoteCallback.Stub.asInterface(data.readStrongBinder()), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 26:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    overridePendingAppTransitionAspectScaledThumb(graphicBuffer, data.readInt(), data.readInt(), data.readInt(), data.readInt(), android.os.IRemoteCallback.Stub.asInterface(data.readStrongBinder()), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 27:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 32:
                    ...
                    Configuration _result5 = updateOrientationFromAppTokens(configuration, data.readStrongBinder(), data.readInt());
                    reply.writeNoException();
                    if (_result5 != null) {
                        reply.writeInt(1);
                ...
                case 33:
                    ...
                    int[] _result6 = setNewDisplayOverrideConfiguration(configuration, data.readInt());
                    reply.writeNoException();
                ...
                case 55:
                    ...
                    enableSurfaceTrace(parcelFileDescriptor);
                    reply.writeNoException();
                    return true;
                case 56:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 89:
                    ...
                    createInputConsumer(_arg02, _arg13);
                    reply.writeNoException();
                    if (_arg13 != null) {
                        reply.writeInt(1);
                ...
                case 94:
                    data.enforceInterface(DESCRIPTOR);
                    String _result12 = getFocusedAppComponentName();
                    reply.writeNoException();
