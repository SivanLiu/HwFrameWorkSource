...
public class SurfaceControl {
    ...
    private static native void nativeSetWindowClipFlag(long j, int i);

    private static native void nativeSetWindowClipIcon(long j, int i, int i2, byte[] bArr, int i3, int i4, int i5);

    private static native void nativeSetWindowClipRound(long j, float f, float f2);
    ...
    public void setWindowClipFlag(int flag) {
        checkNotReleased();
        nativeSetWindowClipFlag(this.mNativeObject, flag);
    }

    public void setWindowClipRound(float rx, float ry) {
        checkNotReleased();
        nativeSetWindowClipRound(this.mNativeObject, rx, ry);
    }

    public void setWindowClipIcon(int iconViewWidth, int iconViewHeight, byte[] iconPixels, int byteCount, int width, int height) {
        checkNotReleased();
        nativeSetWindowClipIcon(this.mNativeObject, iconViewWidth, iconViewHeight, iconPixels, byteCount, width, height);
    }
