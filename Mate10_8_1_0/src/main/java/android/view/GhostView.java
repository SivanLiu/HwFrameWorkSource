...
public class GhostView extends View {
    ...
    private static boolean isOnTop(View view, View comparedWith) {
        ...
        if (preorderedList == null) {
            isChildrenDrawingOrderEnabled = parent.isChildrenDrawingOrderEnabled();
        } else {
        ...
        while (i < childrenCount) {
            int childIndex = isChildrenDrawingOrderEnabled ? parent.getChildDrawingOrder(childrenCount, i) : i;
