...
public class KeyCharacterMap implements Parcelable {
    ...
    static {
        ...
        addCombining(MetricsEvent.APP_SPECIAL_PERMISSION_DND_DENY, 180);
        addCombining(MetricsEvent.APP_SPECIAL_PERMISSION_APPDRAW_ALLOW, 710);
        addCombining(MetricsEvent.APP_SPECIAL_PERMISSION_APPDRAW_DENY, 732);
        addCombining(MetricsEvent.APP_SPECIAL_PERMISSION_VRHELPER_ALLOW, 175);
        addCombining(MetricsEvent.APP_SPECIAL_PERMISSION_SETTINGS_CHANGE_ALLOW, 728);
        addCombining(MetricsEvent.APP_SPECIAL_PERMISSION_SETTINGS_CHANGE_DENY, 729);
        addCombining(MetricsEvent.APP_SPECIAL_PERMISSION_NOTIVIEW_ALLOW, 168);
        ...
        sAccentToCombining.append(94, MetricsEvent.APP_SPECIAL_PERMISSION_APPDRAW_ALLOW);
        sAccentToCombining.append(126, MetricsEvent.APP_SPECIAL_PERMISSION_APPDRAW_DENY);
