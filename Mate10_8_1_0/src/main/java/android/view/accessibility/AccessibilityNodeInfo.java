...
public class AccessibilityNodeInfo implements Parcelable {
    ...
    public static final class AccessibilityAction {
        ...
        public static final AccessibilityAction ACTION_CONTEXT_CLICK = new AccessibilityAction(R.id.accessibilityActionContextClick);
        ...
        public static final AccessibilityAction ACTION_MOVE_WINDOW = new AccessibilityAction(R.id.accessibilityActionMoveWindow);
        ...
        public static final AccessibilityAction ACTION_SCROLL_DOWN = new AccessibilityAction(R.id.accessibilityActionScrollDown);
        public static final AccessibilityAction ACTION_SCROLL_FORWARD = new AccessibilityAction(4096);
        public static final AccessibilityAction ACTION_SCROLL_LEFT = new AccessibilityAction(R.id.accessibilityActionScrollLeft);
        public static final AccessibilityAction ACTION_SCROLL_RIGHT = new AccessibilityAction(R.id.accessibilityActionScrollRight);
        public static final AccessibilityAction ACTION_SCROLL_TO_POSITION = new AccessibilityAction(R.id.accessibilityActionScrollToPosition);
        public static final AccessibilityAction ACTION_SCROLL_UP = new AccessibilityAction(R.id.accessibilityActionScrollUp);
        public static final AccessibilityAction ACTION_SELECT = new AccessibilityAction(4);
        public static final AccessibilityAction ACTION_SET_PROGRESS = new AccessibilityAction(R.id.accessibilityActionSetProgress);
        ...
        public static final AccessibilityAction ACTION_SHOW_ON_SCREEN = new AccessibilityAction(R.id.accessibilityActionShowOnScreen);
        ...
        private AccessibilityAction(int standardActionId) {
            ...
            this.mSerializationFlag = (int) BitUtils.bitAt(sStandardActions.size());
    ...
    private void addStandardActions(int r1) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: android.view.accessibility.AccessibilityNodeInfo.addStandardActions(int):void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.view.accessibility.AccessibilityNodeInfo.addStandardActions(int):void");
    }
...
*/
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        if (this.mSourceNodeId != DEFAULT.mSourceNodeId) {
            nonDefaultFields |= BitUtils.bitAt(1);
        }
        int fieldIndex = 1 + 1;
        ...
        fieldIndex++;
        if (!Objects.equals(this.mChildNodeIds, DEFAULT.mChildNodeIds)) {
            nonDefaultFields |= BitUtils.bitAt(fieldIndex);
        }
        fieldIndex++;
        ...
        int fieldIndex2 = 1 + 1;
        if (BitUtils.isBitSet(nonDefaultFields, 1)) {
        ...
        if (BitUtils.isBitSet(nonDefaultFields, fieldIndex2)) {
            if (this.mActions == null || (this.mActions.isEmpty() ^ 1) == 0) {
                ...
                for (i = 0; i < actionCount; i++) {
                    action = (AccessibilityAction) this.mActions.get(i);
    ...
    private void initFromParcel(Parcel parcel) {
        ...
        RangeInfo obtain;
        CollectionInfo obtain2;
        CollectionItemInfo obtain3;
        long nonDefaultFields = parcel.readLong();
        boolean z = BitUtils.isBitSet(nonDefaultFields, 0) ? parcel.readInt() == 1 : DEFAULT.mSealed;
        int i2 = 1 + 1;
        if (BitUtils.isBitSet(nonDefaultFields, 1)) {
            this.mSourceNodeId = parcel.readLong();
        }
        int i3 = i2 + 1;
        if (BitUtils.isBitSet(nonDefaultFields, i2)) {
            this.mWindowId = parcel.readInt();
        }
        i2 = i3 + 1;
        if (BitUtils.isBitSet(nonDefaultFields, i3)) {
        ...
        if (BitUtils.isBitSet(nonDefaultFields, i2)) {
            ...
            for (i = 0; i < nonStandardActionCount; i++) {
        ...
        if (BitUtils.isBitSet(nonDefaultFields, i2)) {
            ...
            obtain3 = CollectionItemInfo.obtain(readInt, readInt2, readInt3, readInt4, z3, z2);
        } else {
            obtain3 = null;
        }
        this.mCollectionItemInfo = obtain3;
        this.mSealed = z;
    }
    ...
    private static boolean isDefaultStandardAction(AccessibilityAction action) {
        return action.mSerializationFlag != -1 ? TextUtils.isEmpty(action.getLabel()) : false;
    }
