        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    ...
                    if (data.readInt() != 0) {
                        mergedConfiguration = (MergedConfiguration) MergedConfiguration.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    resized(rect, rect2, rect3, rect4, rect5, rect6, _arg6, mergedConfiguration, rect7, data.readInt() != 0, data.readInt() != 0, data.readInt());
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
