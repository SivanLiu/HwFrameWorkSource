        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 35:
                    ...
                    _result2 = requestAudioFocus(audioAttributes2, data.readInt(), data.readStrongBinder(), android.media.IAudioFocusDispatcher.Stub.asInterface(data.readStrongBinder()), data.readString(), data.readString(), data.readInt(), android.media.audiopolicy.IAudioPolicyCallback.Stub.asInterface(data.readStrongBinder()), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 36:
                    ...
                    if (data.readInt() != 0) {
                        audioAttributes3 = (AudioAttributes) AudioAttributes.CREATOR.createFromParcel(data);
                    } else {
                        audioAttributes3 = null;
                    }
                    _result2 = abandonAudioFocus(_arg02, _arg1, audioAttributes3, data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 37:
                ...
                case 48:
                    ...
                    handleBluetoothA2dpDeviceConfigChange(bluetoothDevice);
                    reply.writeNoException();
                    return true;
                case 49:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 58:
                    ...
                    String _result5 = registerAudioPolicy(audioPolicyConfig, android.media.audiopolicy.IAudioPolicyCallback.Stub.asInterface(data.readStrongBinder()), data.readInt() != 0, data.readInt() != 0);
                    reply.writeNoException();
                ...
                case 68:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        playerIdCard = (PlayerIdCard) PlayerIdCard.CREATOR.createFromParcel(data);
                    } else {
                        playerIdCard = null;
                    }
                    _result2 = trackPlayer(playerIdCard);
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 69:
                    ...
                    playerAttributes(_arg0, audioAttributes);
                    return true;
                case 70:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 73:
                    ...
                    _result2 = getFocusRampTimeMs(_arg0, audioAttributes);
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 74:
                    ...
                    _result2 = dispatchFocusChange(audioFocusInfo, data.readInt(), android.media.audiopolicy.IAudioPolicyCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    reply.writeInt(_result2);
                    return true;
                case 75:
                    data.enforceInterface(DESCRIPTOR);
                    playerHasOpPlayAudio(data.readInt(), data.readInt() != 0);
                    return true;
