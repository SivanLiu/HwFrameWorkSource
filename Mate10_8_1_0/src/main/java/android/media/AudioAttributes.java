...
public final class AudioAttributes implements Parcelable {
    ...
    public static class Builder {
        ...
        public Builder setInternalCapturePreset(int preset) {
            ...
            if (preset == 1999 || preset == 8 || preset == AudioSource.RADIO_TUNER || (isRideModeEnabled && preset == 3)) {
                this.mSource = preset;
            } else {
    ...
    public String toString() {
        String str;
        StringBuilder append = new StringBuilder().append("AudioAttributes: usage=").append(usageToString()).append(" content=").append(contentTypeToString()).append(" flags=0x").append(Integer.toHexString(this.mFlags).toUpperCase()).append(" tags=").append(this.mFormattedTags).append(" bundle=");
        if (this.mBundle == null) {
            str = "null";
        } else {
