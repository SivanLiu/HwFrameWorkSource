...
public final class MediaSession {
                    ...
                    switch (ke.getKeyCode()) {
                        ...
                        case 85:
                            if (ke.getRepeatCount() > 0) {
                                ...
                                this.mHandler.sendEmptyMessageDelayed(23, (long) ViewConfiguration.getDoubleTapTimeout());
                            }
                            return true;
                        default:
                            handleMediaPlayPauseKeySingleTapIfPending();
    ...
    public MediaSession(Context context, String tag, int userId) {
        ...
        this.mMaxBitmapSize = context.getResources().getDimensionPixelSize(17104952);
