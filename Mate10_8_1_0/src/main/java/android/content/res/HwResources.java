    ...
    public Bitmap getThemeBitmap(TypedValue value, int id, Rect padding) throws NotFoundException {
        ...
        if (!((!isFramework && !isHwFramework) || this.mPackageName == null || (this.mPackageName.isEmpty() ^ 1) == 0)) {
            ...
            if (frameworkZipFileCache != null) {
                bitmap = frameworkZipFileCache.getBitmapEntry(this, value, key, padding);
                if (bitmap == null && (file.contains(DRAWABLE_FHD) ^ 1) != 0) {
                    ...
                    if (!(themeDensity == -1 || dir == null)) {
                        bitmap = frameworkZipFileCache.getBitmapEntry(this, value, dir + File.separator + file.substring(file.lastIndexOf(File.separator) + 1), padding);
                    }
                }
                if (bitmap != null) {
                    return bitmap;
            ...
            if (!TextUtils.isEmpty(deepThemeType) && r18 == null && frameworkZipFileCache == null) {
                bitmap = getFwkBitmapFromAsset(value, this, packageName, file, key, deepThemeType, padding);
            }
            if (bitmap != null) {
                return bitmap;
            }
        ...
        if (packageZipFileCache != null) {
            bitmap = packageZipFileCache.getBitmapEntry(this, value, file, padding);
        }
        if (!(bitmap != null || packageZipFileCache == null || (file.contains(DRAWABLE_FHD) ^ 1) == 0)) {
            ...
            if (!(themeDensity == -1 || dir == null)) {
                bitmap = packageZipFileCache.getBitmapEntry(this, value, dir + File.separator + file.substring(file.lastIndexOf(File.separator) + 1), padding);
            }
        }
        if (!TextUtils.isEmpty(deepThemeType) && r18 == null && packageZipFileCache == null) {
            if (isFramework) {
                isHwFramework = true;
            }
            if ((isHwFramework ^ 1) != 0) {
                bitmap = getAppBitmapFromAsset(value, this, file, deepThemeType, padding);
            }
        }
        return bitmap;
    }
