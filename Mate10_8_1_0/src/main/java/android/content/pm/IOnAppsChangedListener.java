        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    ...
                    onPackagesAvailable(userHandle, data.createStringArray(), data.readInt() != 0);
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    onPackagesUnavailable(userHandle, data.createStringArray(), data.readInt() != 0);
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                ...
                case 8:
                    ...
                    onShortcutChanged(userHandle, _arg1, parceledListSlice);
                    return true;
