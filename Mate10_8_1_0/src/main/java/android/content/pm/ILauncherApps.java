...
public interface ILauncherApps extends IInterface {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    ...
                    _result = getLauncherActivities(_arg0, _arg1, userHandle);
                    reply.writeNoException();
                    if (_result != null) {
                        reply.writeInt(1);
                ...
                case 4:
                    ...
                    ActivityInfo _result3 = resolveActivity(_arg0, componentName, userHandle);
                    reply.writeNoException();
                    if (_result3 != null) {
                        reply.writeInt(1);
                ...
                case 5:
                    ...
                    ResolveInfo _result4 = resolveActivityByIntent(intent, userHandle4);
                    reply.writeNoException();
                    if (_result4 != null) {
                        reply.writeInt(1);
                ...
                case 6:
                    ...
                    startActivityAsUser(_arg0, componentName, rect, bundle, userHandle2);
                    reply.writeNoException();
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    showAppDetailsAsUser(_arg0, componentName, rect, bundle, userHandle2);
                    reply.writeNoException();
                    return true;
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    _result2 = isPackageEnabled(_arg0, _arg1, userHandle);
                    reply.writeNoException();
                ...
                case 9:
                    ...
                    _result2 = isActivityEnabled(_arg0, componentName, userHandle);
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 10:
                    ...
                    ApplicationInfo _result5 = getApplicationInfo(_arg0, _arg1, _arg22, userHandle3);
                    reply.writeNoException();
                    if (_result5 != null) {
                        reply.writeInt(1);
                ...
                case 11:
                    ...
                    if (data.readInt() != 0) {
                        userHandle5 = (UserHandle) UserHandle.CREATOR.createFromParcel(data);
                    } else {
                        userHandle5 = null;
                    }
                    _result = getShortcuts(_arg0, _arg12, _arg2, _arg3, componentName2, _arg5, userHandle5);
                    reply.writeNoException();
                    if (_result != null) {
                        reply.writeInt(1);
                        _result.writeToParcel(reply, 1);
                ...
                case 12:
                    ...
                    pinShortcuts(_arg0, _arg1, _arg23, userHandle3);
                    reply.writeNoException();
                    return true;
                case 13:
                    Rect rect2;
                ...
                case 17:
                    ...
                    _result = getShortcutConfigActivities(_arg0, _arg1, userHandle);
                    reply.writeNoException();
                    if (_result != null) {
                        reply.writeInt(1);
                        _result.writeToParcel(reply, 1);
                ...
                case 18:
                    ...
                    IntentSender _result8 = getShortcutConfigActivityIntent(_arg0, componentName, userHandle);
                    reply.writeNoException();
                    if (_result8 != null) {
                        reply.writeInt(1);
    ...
    void showAppDetailsAsUser(String str, ComponentName componentName, Rect rect, Bundle bundle, UserHandle userHandle) throws RemoteException;

    void startActivityAsUser(String str, ComponentName componentName, Rect rect, Bundle bundle, UserHandle userHandle) throws RemoteException;
