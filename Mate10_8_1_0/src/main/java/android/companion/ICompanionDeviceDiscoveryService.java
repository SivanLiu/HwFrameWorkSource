        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    startDiscovery(associationRequest, data.readString(), android.companion.IFindDeviceCallback.Stub.asInterface(data.readStrongBinder()), android.companion.ICompanionDeviceDiscoveryServiceCallback.Stub.asInterface(data.readStrongBinder()));
