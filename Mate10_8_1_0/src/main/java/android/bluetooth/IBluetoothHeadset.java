...
public interface IBluetoothHeadset extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBluetoothHeadset {
        ...
        static final int TRANSACTION_bindResponse = 29;
        ...
        static final int TRANSACTION_disableWBS = 28;
        static final int TRANSACTION_disconnect = 2;
        static final int TRANSACTION_disconnectAudio = 19;
        static final int TRANSACTION_enableWBS = 27;
        ...
        static final int TRANSACTION_isScoAvailableOffCall = 30;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 22:
                    data.enforceInterface(DESCRIPTOR);
                    setForceScoAudio(data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 23:
                    data.enforceInterface(DESCRIPTOR);
