                ...
                try {
                    ...
                    switch (fieldType) {
                        ...
                        case 33:
                            ...
                            serviceData.put(BluetoothUuid.parseUuidFrom(extractBytes(scanRecord, currentPos, serviceUuidLength)), extractBytes(scanRecord, currentPos + serviceUuidLength, dataLength - serviceUuidLength));
                            break;
                        case 255:
                            manufacturerData.put(((scanRecord[currentPos + 1] & 255) << 8) + (scanRecord[currentPos] & 255), extractBytes(scanRecord, currentPos + 2, dataLength - 2));
                            break;
                        default:
                            break;
                    }
