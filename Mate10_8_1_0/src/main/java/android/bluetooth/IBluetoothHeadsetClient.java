        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 10:
                    ...
                    List<BluetoothHeadsetClientCall> _result5 = getCurrentCalls(bluetoothDevice);
                    reply.writeNoException();
                ...
                case 11:
                    ...
                    _result4 = getCurrentAgEvents(bluetoothDevice);
                    reply.writeNoException();
                    if (_result4 != null) {
                        reply.writeInt(1);
                ...
                case 12:
                    ...
                    _result = acceptCall(bluetoothDevice, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 13:
                    ...
                    _result = holdCall(bluetoothDevice);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 14:
                    ...
                    _result = rejectCall(bluetoothDevice);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 15:
                    ...
                    if (data.readInt() != 0) {
                        bluetoothHeadsetClientCall = (BluetoothHeadsetClientCall) BluetoothHeadsetClientCall.CREATOR.createFromParcel(data);
                    } else {
                        bluetoothHeadsetClientCall = null;
                    }
                    _result = terminateCall(bluetoothDevice, bluetoothHeadsetClientCall);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 16:
                    ...
                    _result = enterPrivateMode(bluetoothDevice, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 17:
                    ...
                    _result = explicitCallTransfer(bluetoothDevice);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 18:
                    ...
                    BluetoothHeadsetClientCall _result6 = dial(bluetoothDevice, data.readString());
                    reply.writeNoException();
                    if (_result6 != null) {
                        reply.writeInt(1);
                ...
                case 19:
                    ...
                    _result = sendDTMF(bluetoothDevice, data.readByte());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 20:
                    ...
                    _result = getLastVoiceTagNumber(bluetoothDevice);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 21:
                ...
                case 22:
                    ...
                    _result = connectAudio(bluetoothDevice);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 23:
                    ...
                    _result = disconnectAudio(bluetoothDevice);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 24:
                    ...
                    setAudioRouteAllowed(bluetoothDevice, data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 25:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    _result = getAudioRouteAllowed(bluetoothDevice);
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 26:
                    ...
                    _result4 = getCurrentAgFeatures(bluetoothDevice);
                    reply.writeNoException();
                    if (_result4 != null) {
                        reply.writeInt(1);
                        _result4.writeToParcel(reply, 1);
