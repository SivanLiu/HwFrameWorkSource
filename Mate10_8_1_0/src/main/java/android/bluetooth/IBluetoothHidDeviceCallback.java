        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    onAppStatusChanged(bluetoothDevice, bluetoothHidDeviceAppConfiguration, data.readInt() != 0);
                ...
                case 2:
                    ...
                    onConnectionStateChanged(bluetoothDevice, data.readInt());
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    onGetReport(bluetoothDevice, data.readByte(), data.readByte(), data.readInt());
                    reply.writeNoException();
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    onSetReport(bluetoothDevice, data.readByte(), data.readByte(), data.createByteArray());
                    reply.writeNoException();
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    onSetProtocol(bluetoothDevice, data.readByte());
                    reply.writeNoException();
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    onIntrData(bluetoothDevice, data.readByte(), data.createByteArray());
                    reply.writeNoException();
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
