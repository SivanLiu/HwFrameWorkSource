...
public interface IBluetoothA2dp extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBluetoothA2dp {
        ...
        static final int TRANSACTION_getDeviceCodecInfo = 19;
        ...
        private static class Proxy implements IBluetoothA2dp {
            ...
            public int getDeviceCodecInfo(String deviceMac) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 13:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        bluetoothCodecConfig = (BluetoothCodecConfig) BluetoothCodecConfig.CREATOR.createFromParcel(data);
                    } else {
                        bluetoothCodecConfig = null;
                    }
                    setCodecConfigPreference(bluetoothCodecConfig);
                    return true;
                case 14:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 16:
                    ...
                    _result3 = supportsOptionalCodecs(bluetoothDevice);
                    reply.writeNoException();
                    reply.writeInt(_result3);
                    return true;
                case 17:
                    ...
                    _result3 = getOptionalCodecsEnabled(bluetoothDevice);
                    reply.writeNoException();
                    reply.writeInt(_result3);
                    return true;
                case 18:
                    ...
                    setOptionalCodecsEnabled(bluetoothDevice, data.readInt());
                    return true;
                case 19:
                    data.enforceInterface(DESCRIPTOR);
                    _result3 = getDeviceCodecInfo(data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result3);
                    return true;
                case 20:
    ...
    int getDeviceCodecInfo(String str) throws RemoteException;
