...
public interface IMSDPDeviceStatusChangedCallBack extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMSDPDeviceStatusChangedCallBack {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    HwMSDPDeviceStatusChangeEvent hwMSDPDeviceStatusChangeEvent;
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() == 0) {
                        hwMSDPDeviceStatusChangeEvent = null;
                    } else {
                        hwMSDPDeviceStatusChangeEvent = (HwMSDPDeviceStatusChangeEvent) HwMSDPDeviceStatusChangeEvent.CREATOR.createFromParcel(data);
                    }
                    onDeviceStatusChanged(hwMSDPDeviceStatusChangeEvent);
