...
public class HwKeyCharacteristics implements Parcelable {
    public static final Creator<HwKeyCharacteristics> CREATOR = new Creator<HwKeyCharacteristics>() {
    ...
    public void readFromParcel(Parcel in) {
        this.swEnforced = (HwKeymasterArguments) HwKeymasterArguments.CREATOR.createFromParcel(in);
        this.hwEnforced = (HwKeymasterArguments) HwKeymasterArguments.CREATOR.createFromParcel(in);
    }
