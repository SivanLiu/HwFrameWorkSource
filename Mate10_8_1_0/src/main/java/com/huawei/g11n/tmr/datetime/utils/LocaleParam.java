...
import com.huawei.g11n.tmr.datetime.data.LocaleParamGet_am;
import com.huawei.g11n.tmr.datetime.data.LocaleParamGet_ar;
import com.huawei.g11n.tmr.datetime.data.LocaleParamGet_as;
...
import com.huawei.g11n.tmr.datetime.data.LocaleParamGet_gu;
...
import com.huawei.g11n.tmr.datetime.data.LocaleParamGet_kn;
...
import com.huawei.g11n.tmr.datetime.data.LocaleParamGet_mai;
import com.huawei.g11n.tmr.datetime.data.LocaleParamGet_mi;
import com.huawei.g11n.tmr.datetime.data.LocaleParamGet_mk;
import com.huawei.g11n.tmr.datetime.data.LocaleParamGet_ml;
import com.huawei.g11n.tmr.datetime.data.LocaleParamGet_mn;
import com.huawei.g11n.tmr.datetime.data.LocaleParamGet_mr;
...
import com.huawei.g11n.tmr.datetime.data.LocaleParamGet_or;
import com.huawei.g11n.tmr.datetime.data.LocaleParamGet_pa;
...
import com.huawei.g11n.tmr.datetime.data.LocaleParamGet_sw;
import com.huawei.g11n.tmr.datetime.data.LocaleParamGet_ta;
import com.huawei.g11n.tmr.datetime.data.LocaleParamGet_te;
...
public class LocaleParam {
    ...
    private static List<String> support = Arrays.asList(new String[]{"en", "de", "fr", "it", "pt", "es", "es_MX", "ca", "ru", "uk", "pl", "cs", "el", "hu", "hr", "ro", "da", "fi", "nl", "nb", "sv", "sk", "tr", "ar", "he", "th", "ja", "zh_hans", "ko", "ms", "hi", "id", "vi", "az", "et", "eu", "bg", "bs", "fa", "km", "ka", "gl", "lv", "lt", "mk", "sr", "sl", "ur", "uz", "bo", "si", "my", "be", "kk", "bn", "lo", "fil", "ne", "jv", "am", "as", "or", "gu", "kn", "mr", "ml", "mai", "mi", "mn", "pa", "sw", "te", "ta"});
    ...
    private HashMap<String, String> param_b = new HashMap<String, String>() {
        {
            put("en", "\\b");
            put("zh_hans", "");
            put("ko", "");
    ...
    public LocaleParam(String locale) {
        if (isSupport(locale)) {
            this.locale = locale;
            ...
            } else if (this.locale.equals("am")) {
                this.param = new LocaleParamGet_am().date;
            } else if (this.locale.equals("as")) {
                this.param = new LocaleParamGet_as().date;
            } else if (this.locale.equals("or")) {
                this.param = new LocaleParamGet_or().date;
            } else if (this.locale.equals("gu")) {
                this.param = new LocaleParamGet_gu().date;
            } else if (this.locale.equals("kn")) {
                this.param = new LocaleParamGet_kn().date;
            } else if (this.locale.equals("mr")) {
                this.param = new LocaleParamGet_mr().date;
            } else if (this.locale.equals("ml")) {
                this.param = new LocaleParamGet_ml().date;
            } else if (this.locale.equals("mai")) {
                this.param = new LocaleParamGet_mai().date;
            } else if (this.locale.equals("mi")) {
                this.param = new LocaleParamGet_mi().date;
            } else if (this.locale.equals("mn")) {
                this.param = new LocaleParamGet_mn().date;
            } else if (this.locale.equals("pa")) {
                this.param = new LocaleParamGet_pa().date;
            } else if (this.locale.equals("sw")) {
                this.param = new LocaleParamGet_sw().date;
            } else if (this.locale.equals("te")) {
                this.param = new LocaleParamGet_te().date;
            } else if (this.locale.equals("ta")) {
                this.param = new LocaleParamGet_ta().date;
            }
        }
        if (this.param == null) {
            this.param = new LocaleParamGet_en().date;
    ...
    public static boolean isSupport(String locale) {
        return support.contains(locale);
    }
    ...
    public String get(String pName) {
        ...
        String result;
        if (this.param.get(pName) == null) {
            result = "";
        } else {
            result = (String) this.param.get(pName);
        }
        if (result.trim().isEmpty() && this.defaultParam.containsKey(pName)) {
            result = (String) this.defaultParam.get(pName);
        }
        if (!(result == null || result.trim().isEmpty())) {
            String mark;
            Object temp = result.split("\\|");
            StringBuffer sb = new StringBuffer();
            Map map2 = this.param_b;
            if (map2.containsKey(this.locale)) {
                mark = (String) map2.get(this.locale);
            } else {
                mark = "\\b";
            }
            Object -l_10_R = temp;
    ...
    public String getWithoutB(String pName) {
        if (this.param == null) {
            return null;
        }
        String result = this.param.get(pName) == null ? "" : (String) this.param.get(pName);
        if (result.indexOf(WITHNOT_B) != -1) {
            Object temp = result.split("\\|");
            StringBuffer sb = new StringBuffer();
            Object -l_8_R = temp;
            for (String t : temp) {
                if (!(t.trim().isEmpty() || t.equals(SAVE_OR) || t.equals(WITHNOT_B))) {
                    sb.append(t).append("|");
                }
            }
            result = sb.toString();
    ...
    public static boolean isRelDates(String s, String locale) {
        if (s.trim().isEmpty()) {
            return true;
        }
        if (s.trim().equals(",")) {
            if (locale.equalsIgnoreCase("zh_hans") || locale.equalsIgnoreCase("ja") || locale.equalsIgnoreCase("ko")) {
                return false;
            }
            return true;
        } else if (s.trim().equals("،") && locale.equalsIgnoreCase("ur")) {
            return true;
        } else {
            return false;
        }
