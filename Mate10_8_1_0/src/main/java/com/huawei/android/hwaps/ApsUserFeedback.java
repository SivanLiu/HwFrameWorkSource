...
public class ApsUserFeedback {
    ...
    private void operateBasedOnResult(int apsState, int resultByFps, int resultByRoundDuration, int resultByGameDuration, int resultByGamesInterval) {
        if (!(resultByGameDuration == 0 || resultByGamesInterval == 0 || resultByRoundDuration == 0 || resultByFps == 0 || 1 == resultByGameDuration || 1 == resultByGamesInterval || 1 == resultByRoundDuration)) {
            if (1 == resultByFps) {
            }
            if (resultByFps != 0) {
                if (2 != apsState) {
