...
public class SoundTriggerManagerEx {
    ...
    public static class Model {
        private android.media.soundtrigger.SoundTriggerManager.Model mModel;

        private Model(UUID uid, UUID vid, byte[] data) {
            this.mModel = android.media.soundtrigger.SoundTriggerManager.Model.create(uid, vid, data);
        }

        private Model(android.media.soundtrigger.SoundTriggerManager.Model model) {
            this.mModel = model;
        }
