...
public class LowBatteryAction extends Action {
    ...
    public void enable() {
        ...
        if (this.mReceiver == null && this.mContext != null) {
            ...
            this.mContext.registerReceiver(this.mReceiver, new IntentFilter("android.intent.action.BATTERY_LOW"), OPCollectUtils.OPCOLLECT_PERMISSION, OdmfCollectScheduler.getInstance().getCtrlHandler());
