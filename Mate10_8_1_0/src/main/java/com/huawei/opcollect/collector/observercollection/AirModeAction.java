...
public class AirModeAction extends Action {
    ...
    public void enable() {
        ...
        if (this.mObserver == null) {
            ...
            try {
                this.mContext.getContentResolver().registerContentObserver(Global.getUriFor("airplane_mode_on"), true, this.mObserver);
    ...
    protected boolean execute() {
        ...
        try {
            if (Global.getInt(this.mContext.getContentResolver(), "airplane_mode_on") == 0) {
