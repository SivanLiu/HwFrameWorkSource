...
public class EyeComfortStateAction extends Action {
    ...
    public void enable() {
        ...
        if (this.mObserver == null) {
            ...
            try {
                this.mContext.getContentResolver().registerContentObserver(System.getUriFor(EYES_PROTECTION_SWITCH), true, this.mObserver);
    ...
    protected boolean execute() {
        ...
        try {
            if (System.getInt(this.mContext.getContentResolver(), EYES_PROTECTION_SWITCH) == 0) {
