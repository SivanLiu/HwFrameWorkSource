...
public class ScreenOffAction extends Action {
    ...
    private static class MyHandler extends Handler {
        ...
        MyHandler(ScreenOffAction service) {
    ...
    public void enable() {
        ...
        if (this.mReceiver == null && this.mContext != null) {
            ...
            this.mContext.registerReceiver(this.mReceiver, new IntentFilter("android.intent.action.SCREEN_OFF"), OPCollectUtils.OPCOLLECT_PERMISSION, OdmfCollectScheduler.getInstance().getRecvHandler());
