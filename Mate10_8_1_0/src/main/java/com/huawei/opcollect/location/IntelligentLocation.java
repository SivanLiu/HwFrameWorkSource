...
public class IntelligentLocation {
    ...
    private static class IntelligentHandler extends Handler {
        ...
        IntelligentHandler(IntelligentLocation service) {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1) {
                ...
                if (intelligentLocation != null) {
                    intelligentLocation.collectIntelligentData(Uri.parse(msg.obj));
                }
            }
        }
    }
    ...
    private static final class MyContentObserver extends ContentObserver {
        ...
        MyContentObserver(Handler handler, IntelligentLocation service) {
            super(handler);
            this.service = new WeakReference(service);
        }
    ...
    private void collectIntelligentData(Uri uri) {
        if (uri == null) {
