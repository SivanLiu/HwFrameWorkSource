                ...
                if (timeStr == null) {
                    ...
                    try {
                        ...
                        if ("Year".equals(period)) {
                            ...
                            trigger2 = new OneShotTimerTrigger(month, dayOfMonth, date.getHours(), date.getMinutes(), date.getSeconds());
                            ...
                            trigger2 = new OneShotTimerTrigger(dayOfWeek, date.getHours(), date.getMinutes(), date.getSeconds());
                        } else {
                            date = new SimpleDateFormat("HH:mm:ss").parse(timeStr);
                            trigger2 = new OneShotTimerTrigger(date.getHours(), date.getMinutes(), date.getSeconds());
                        }
                        list_trigger.add(trigger2);
