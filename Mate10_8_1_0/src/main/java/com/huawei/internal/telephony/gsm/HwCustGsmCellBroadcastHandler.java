...
public class HwCustGsmCellBroadcastHandler {
    ...
    public boolean isDiscardStrangeChar(Phone phone) {
        ...
        Context context = phone != null ? phone.getContext() : null;
        CarrierConfigManager carrierConfigManager = context != null ? (CarrierConfigManager) context.getSystemService("carrier_config") : null;
        ...
        if (configForSubId != null) {
            allowDiscardInt = configForSubId.getInt(CBS_DISCARD_STRANGCHAR_INT, -1);
        }
