        ...
        synchronized (mNearbyLock) {
            if (!mNearbyBound.booleanValue()) {
                ...
                try {
                    ...
                    HwLog.e(TAG, "bindAidlService bindService NearbyServiceConnection ERROR:" + e.getLocalizedMessage());
                }
            }
        }
        synchronized (mAuthLock) {
            if (!mAuthBound.booleanValue()) {
                ...
                try {
                    ...
                    HwLog.e(TAG, "bindAidlService bindService NearbyAuthServiceConnection ERROR:" + e2.getLocalizedMessage());
                }
            }
        }
    }
    ...
    public boolean unRegisterAuthentification(AuthListener listener) {
        ...
        if (listener == null) {
            ...
            try {
                ...
                z = mAuthService.unRegisterAuthentification((IAuthListener) this.mAuthListeners.get(listener));
