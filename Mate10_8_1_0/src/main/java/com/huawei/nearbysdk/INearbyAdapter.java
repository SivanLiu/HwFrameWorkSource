        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 5:
                    ...
                    if (data.readInt() != 0) {
                        nearbyDevice2 = (NearbyDevice) NearbyDevice.CREATOR.createFromParcel(data);
                    } else {
                        nearbyDevice2 = null;
                    }
                    _result = openNearbySocket(_arg0, _arg1, _arg2, _arg3, nearbyDevice2, data.readInt(), com.huawei.nearbysdk.ICreateSocketListener.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 6:
                ...
                case 7:
                    ...
                    return true;
                case 8:
                    NearbyConfiguration nearbyConfiguration;
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt();
                    _arg1 = data.readInt();
                    if (data.readInt() != 0) {
                        nearbyConfiguration = (NearbyConfiguration) NearbyConfiguration.CREATOR.createFromParcel(data);
                    } else {
                        nearbyConfiguration = null;
                    }
                    _result = registerConnectionListener(_arg0, _arg1, nearbyConfiguration, com.huawei.nearbysdk.IInternalConnectionListener.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 9:
                ...
                case 10:
                    ...
                    _arg2 = data.readInt();
                    if (data.readInt() != 0) {
                        nearbyDevice3 = (NearbyDevice) NearbyDevice.CREATOR.createFromParcel(data);
                    } else {
                        nearbyDevice3 = null;
                    }
                    _result = open(_arg0, _arg1, _arg2, nearbyDevice3, data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result ? 1 : 0);
                    return true;
                case 11:
                    ...
                    _arg1 = data.readInt();
                    if (data.readInt() != 0) {
                        nearbyDevice = (NearbyDevice) NearbyDevice.CREATOR.createFromParcel(data);
                    } else {
                        nearbyDevice = null;
                    }
                    int _result2 = write(_arg0, _arg1, nearbyDevice, data.createByteArray());
                    reply.writeNoException();
                ...
                case 12:
                    ...
                    close(_arg0, _arg1, nearbyDevice);
                    reply.writeNoException();
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);
