...
public final class NearbyConfiguration implements Parcelable {
    public static final Creator<NearbyConfiguration> CREATOR = new Creator<NearbyConfiguration>() {
        public NearbyConfiguration createFromParcel(Parcel source) {
            return new NearbyConfiguration(source.readInt(), source.readString(), source.readString(), source.readInt(), source.readString(), source.readInt(), source.readInt());
        }
    ...
    public boolean equals(Object anObject) {
        ...
        if (this.mChannelId != anDevice.mChannelId || !this.mWifiSsid.equals(anDevice.mWifiSsid) || !this.mWifiPwd.equals(anDevice.mWifiPwd) || this.mWifiBand != anDevice.mWifiBand || !this.mWifiIp.equals(anDevice.mWifiIp)) {
            z = false;
        } else if (this.mWifiPort != anDevice.mWifiPort) {
            z = false;
        }
        return z;
    }
    ...
    public String toString() {
        return "NearbyConfiguration:{ChannelId=" + this.mChannelId + " " + this.mWifiSsid + this.mWifiBand + "}";
    }
