...
public final class DTCPAdapter {
    ...
    private static class DTCPServiceConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName arg0, IBinder service) {
            ...
            DTCPAdapter.msInstance = new DTCPAdapter(this, Stub.asInterface(service));
    ...
    public int unPublish(PublishListener listener) {
        ...
        synchronized (this.mPublishListenerMap) {
            DTCPPublishListenerTransport publishListener = (DTCPPublishListenerTransport) this.mPublishListenerMap.remove(listener);
        }
    ...
    public int unRegisterReceivelistener(DTCPReceiveListener listener) {
        ...
        synchronized (this.mReceiveListenerMap) {
            DTCPReceiveListenerTransport recvListener = (DTCPReceiveListenerTransport) this.mReceiveListenerMap.remove(listener);
        }
