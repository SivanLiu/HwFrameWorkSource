...
public final class Encoder {
    private static final /* synthetic */ int[] -com-huawei-zxing-qrcode-decoder-ModeSwitchesValues = null;
    ...
    private static /* synthetic */ int[] -getcom-huawei-zxing-qrcode-decoder-ModeSwitchesValues() {
        if (-com-huawei-zxing-qrcode-decoder-ModeSwitchesValues != null) {
            return -com-huawei-zxing-qrcode-decoder-ModeSwitchesValues;
        }
        int[] iArr = new int[Mode.values().length];
        try {
            iArr[Mode.ALPHANUMERIC.ordinal()] = 1;
        } catch (NoSuchFieldError e) {
        }
        try {
            iArr[Mode.BYTE.ordinal()] = 2;
        } catch (NoSuchFieldError e2) {
        }
        try {
            iArr[Mode.ECI.ordinal()] = 5;
        } catch (NoSuchFieldError e3) {
        }
        try {
            iArr[Mode.FNC1_FIRST_POSITION.ordinal()] = 6;
        } catch (NoSuchFieldError e4) {
        }
        try {
            iArr[Mode.FNC1_SECOND_POSITION.ordinal()] = 7;
        } catch (NoSuchFieldError e5) {
        }
        try {
            iArr[Mode.HANZI.ordinal()] = 8;
        } catch (NoSuchFieldError e6) {
        }
        try {
            iArr[Mode.KANJI.ordinal()] = 3;
        } catch (NoSuchFieldError e7) {
        }
        try {
            iArr[Mode.NUMERIC.ordinal()] = 4;
        } catch (NoSuchFieldError e8) {
        }
        try {
            iArr[Mode.STRUCTURED_APPEND.ordinal()] = 9;
        } catch (NoSuchFieldError e9) {
        }
        try {
            iArr[Mode.TERMINATOR.ordinal()] = 10;
        } catch (NoSuchFieldError e10) {
        }
        -com-huawei-zxing-qrcode-decoder-ModeSwitchesValues = iArr;
        return iArr;
    }
    ...
    public static QRCode encode(String content, ErrorCorrectionLevel ecLevel, Map<EncodeHintType, ?> hints) throws WriterException {
        ...
        if (mode == Mode.BYTE && (DEFAULT_BYTE_MODE_ENCODING.equals(str) ^ 1) != 0) {
            CharacterSetECI eci = CharacterSetECI.getCharacterSetECIByName(str);
            if (eci != null) {
        ...
        appendBytes(content, mode, dataBits, str);
    ...
    static void appendBytes(String content, Mode mode, BitArray bits, String encoding) throws WriterException {
        switch (-getcom-huawei-zxing-qrcode-decoder-ModeSwitchesValues()[mode.ordinal()]) {
            case 1:
