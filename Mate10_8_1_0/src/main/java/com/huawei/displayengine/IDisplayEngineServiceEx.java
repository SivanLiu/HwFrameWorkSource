...
public interface IDisplayEngineServiceEx extends IInterface {
    ...
    public static final int DE_EFFECT_MAX = 2;
    ...
    public static final int DE_FEATURE_MAX = 26;
    ...
    public static final int DE_SCENE_GAME = 33;
    ...
    public static final int DE_SCENE_MAX = 34;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    ...
                    _result = setData(_arg0, persistableBundle);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 4:
                    ...
                    _result = sendMessage(_arg0, bundle);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 5:
                ...
                case 6:
                    ...
                    _result = setEffect(_arg0, _arg1, persistableBundle2);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 7:
