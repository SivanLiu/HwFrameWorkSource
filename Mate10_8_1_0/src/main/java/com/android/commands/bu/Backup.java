    ...
    private void doBackup(int socketFd) {
        ...
        if (doEverything || (saveShared ^ 1) == 0 || packages.size() != 0) {
            ...
            try {
                ...
                this.mBackupManager.adbBackup(parcelFileDescriptor, saveApks, saveObbs, saveShared, doWidgets, doEverything, allIncludesSystem, doCompress, doKeyValue, (String[]) packages.toArray(new String[packages.size()]));
                ...
                if (parcelFileDescriptor != null) {
                    try {
                        ...
                        Log.e(TAG, "IO error closing output for backup: " + e32.getMessage());
                    }
                }
            }
            return;
