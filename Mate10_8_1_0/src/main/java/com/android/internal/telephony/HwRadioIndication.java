...
import vendor.huawei.hardware.radio.V1_2.RilSysInfor;
...
public class HwRadioIndication extends RadioIndication {
    ...
    public static SignalStrength convertHwHalSignalStrength(int[] payload) {
        if (payload.length >= 15) {
            return new SignalStrength(payload[0], payload[1], payload[2], payload[3], payload[4], payload[5], payload[6], payload[7], payload[8], payload[9], payload[10], payload[11], payload[12], payload[13], payload[14], payload[15], true);
        }
