...
import vendor.huawei.hardware.radio.V1_2.IRadioIndication.Stub;
...
public abstract class RadioIndication extends Stub {
    ...
    public void callRing(int indicationType, boolean isGsm, CdmaSignalInfoRecord record) {
        ...
        if (!isGsm) {
            ...
            obj[0] = (char) i;
            obj[1] = (char) record.signalType;
            obj[2] = (char) record.alertPitch;
            obj[3] = (char) record.signal;
            this.mRil.writeMetricsCallRing(obj);
        }
        this.mRil.unsljLogRet(1018, obj);
        if (this.mRil.mRingRegistrant != null) {
            this.mRil.mRingRegistrant.notifyRegistrant(new AsyncResult(null, obj, null));
        }
    }
