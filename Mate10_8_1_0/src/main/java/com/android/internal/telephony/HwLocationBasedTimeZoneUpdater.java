...
public class HwLocationBasedTimeZoneUpdater extends StateMachine {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 4:
                    ...
                    Phone phone = PhoneFactory.getPhone(slotId.intValue());
                    ServiceState serviceState = phone != null ? phone.getServiceState() : null;
                    if (serviceState == null || (!(serviceState.getVoiceRegState() == 0 || serviceState.getDataRegState() == 0) || (TextUtils.isEmpty(HwLocationBasedTimeZoneUpdater.this.mLastValidNetIso) ^ 1) == 0)) {
                        ...
                        if (!("".equals(mcc) || (mcc.equals(oldMcc) ^ 1) == 0)) {
                            ...
                            try {
                                ...
                                HwLocationBasedTimeZoneUpdater.this.loge("countryCodeForMcc got NumberFormatException");
                            }
                    ...
                    HwLocationBasedTimeZoneUpdater.this.log("[SLOT" + slotId + "]ignore EVENT_RPLMNS_STATE_CHANGED");
                    return;
                    break;
                case 5:
    ...
    private final NotUpdateState mNotUpdateState = new NotUpdateState();
