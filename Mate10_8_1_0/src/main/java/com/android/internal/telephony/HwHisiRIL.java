...
public class HwHisiRIL extends RIL {
    ...
    public void setTEEDataReady(int apn, int dh, int sim, Message response) {
        RILRequestReference rr = RILRequestReference.obtain(2093, response, this.mRILDefaultWorkSource);
    ...
    public void setTime(final String date, final String time, final String timezone, Message result) {
        ...
        invokeIRadio(2130, result, /* anonymous class already generated */);
    }
    ...
    public void getAvailableCSGNetworks(Message result) {
        if (isVZW) {
            invokeIRadio(2167, result, new RILCommand() {
                public void excute(IRadio radio, int serial) throws RemoteException, RuntimeException {
                    vendor.huawei.hardware.radio.V1_2.IRadio radio1_2 = vendor.huawei.hardware.radio.V1_2.IRadio.castFrom(radio);
                    if (radio1_2 != null) {
                        radio1_2.getAvailableCsgIds_1_1(serial);
                    } else {
                        HwHisiRIL.this.riljLog("not support below radio 1.2");
                    }
                }
            });
        } else {
    ...
    public void setMobileDataEnable(final int state, Message response) {
        invokeIRadio(2165, response, new RILCommand() {
            public void excute(IRadio radio, int serial) throws RemoteException, RuntimeException {
                vendor.huawei.hardware.radio.V1_2.IRadio radio1_2 = vendor.huawei.hardware.radio.V1_2.IRadio.castFrom(radio);
                if (radio1_2 != null) {
                    radio1_2.setMobileDataEnable(serial, state);
                } else {
                    HwHisiRIL.this.riljLog("not support below radio 1.2");
                }
            }
    ...
    public void setRoamingDataEnable(final int state, Message response) {
        invokeIRadio(2166, response, new RILCommand() {
            public void excute(IRadio radio, int serial) throws RemoteException, RuntimeException {
                vendor.huawei.hardware.radio.V1_2.IRadio radio1_2 = vendor.huawei.hardware.radio.V1_2.IRadio.castFrom(radio);
                if (radio1_2 != null) {
                    radio1_2.setRoamingDataEnable(serial, state);
                } else {
                    HwHisiRIL.this.riljLog("not support below radio 1.2");
                }
            }
    ...
    public void informModemTetherStatusToChangeGRO(final int enable, final String faceName, Message result) {
        invokeIRadio(538, result, new RILCommand() {
            public void excute(IRadio radio, int serial) throws RemoteException, RuntimeException {
                Rlog.d(HwHisiRIL.RILJ_LOG_TAG, "enable = " + enable + " faceName = " + faceName);
                vendor.huawei.hardware.radio.V1_1.IRadio radio1_1 = vendor.huawei.hardware.radio.V1_1.IRadio.castFrom(radio);
                if (radio1_1 != null) {
                    radio1_1.informModemTetherStatusToChangeGRO(serial, enable, faceName);
                } else {
                    HwHisiRIL.this.riljLog("not support below radio 1.1");
                }
            }
    ...
    public void setDeepNoDisturbState(final int state, Message result) {
        ...
        invokeIRadio(2175, result, new RILCommand() {
            public void excute(IRadio radio, int serial) throws RemoteException, RuntimeException {
                vendor.huawei.hardware.radio.V1_2.IRadio radio1_2 = vendor.huawei.hardware.radio.V1_2.IRadio.castFrom(radio);
                if (radio1_2 != null) {
                    radio1_2.setDeepNoDisturbState(serial, state);
                } else {
                    HwHisiRIL.this.riljLog("not support below radio 1.2");
                }
            }
    ...
    public void getCurrentCallsEx(Message result) {
        invokeIRadio(2176, result, new RILCommand() {
            public void excute(IRadio radio, int serial) throws RemoteException, RuntimeException {
                vendor.huawei.hardware.radio.V1_2.IRadio radio1_2 = vendor.huawei.hardware.radio.V1_2.IRadio.castFrom(radio);
                if (radio1_2 != null) {
                    radio1_2.getCurrentCallsV1_2(serial);
                } else {
                    HwHisiRIL.this.riljLog("getCurrentCallsEx not support below radio 1.2");
                }
            }
        });
    }
