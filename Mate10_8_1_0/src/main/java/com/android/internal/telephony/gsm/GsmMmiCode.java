...
public final class GsmMmiCode extends Handler implements MmiCode {
    ...
    private static final String SERVICE_NOT_SUBSCRIBED = "service_not_subscribed";
    ...
    private static boolean isTwoDigitShortCode(Context context, String dialString) {
        ...
        if (sTwoDigitNumberPattern == null) {
            sTwoDigitNumberPattern = context.getResources().getStringArray(17236042);
        }
    ...
    public void processCode() throws CallStateException {
        try {
            ...
            this.mMessage = this.mContext.getText(17040455);
    ...
    public void onUssdFinished(String ussdMessage, boolean isUssdRequest) {
        if (this.mState == State.PENDING) {
            if (TextUtils.isEmpty(ussdMessage)) {
                this.mMessage = this.mContext.getText(HwTelephonyFactory.getHwPhoneManager().showMmiError(17040454));
    ...
    private CharSequence getErrorMessage(AsyncResult ar) {
        if (ar.exception instanceof CommandException) {
            ...
            if (err == Error.FDN_CHECK_FAILURE) {
                ...
                return this.mContext.getText(17041091);
            } else if (err == Error.SS_MODIFIED_TO_USSD) {
                Rlog.i(this.LOG_TAG, "SS_MODIFIED_TO_USSD");
                return this.mContext.getText(17041093);
            } else if (err == Error.SS_MODIFIED_TO_SS) {
                Rlog.i(this.LOG_TAG, "SS_MODIFIED_TO_SS");
                return this.mContext.getText(17041092);
            }
        }
        return this.mContext.getText(17040455);
    }
    ...
    private void onSetComplete(Message msg, AsyncResult ar) {
        ...
        if (ar.exception != null) {
                ...
                if (err == Error.PASSWORD_INCORRECT) {
                    if (isPinPukCommand()) {
                        if (!this.mSc.equals(SC_PUK) && !this.mSc.equals(SC_PUK2)) {
                            ...
                            sb.append(this.mContext.getText(17039681));
                        } else {
                        ...
                        sb.append(this.mContext.getText(17040546));
                    }
                } else if (err == Error.SIM_PUK2) {
                    sb.append(HwTelephonyFactory.getHwPhoneManager().processBadPinString(this.mContext, this.mSc));
                    sb.append("\n");
                    sb.append(this.mContext.getText(17040468));
                } else if (err == Error.REQUEST_NOT_SUPPORTED) {
                    if (this.mSc.equals(SC_PIN)) {
                        sb.append(this.mContext.getText(17039947));
                    }
                } else if (err == Error.FDN_CHECK_FAILURE) {
                    Rlog.i(this.LOG_TAG, "FDN_CHECK_FAILURE");
                    sb.append(this.mContext.getText(17040457));
                } else if (isDocomo && err == Error.SERVICE_NOT_SUBSCRIBED) {
                    Rlog.i(this.LOG_TAG, "SERVICE_NOT_SUBSCRIBED");
                    sb.append(this.mContext.getText(17040455));
                    ...
                    if (isServiceCodeCallForwarding(this.mSc) && this.mPhone.getServiceState().getVoiceRoaming() && (this.mPhone.supports3gppCallForwardingWhileRoaming() ^ 1) != 0) {
                        sb.append(this.mContext.getText(17040456));
                    } else {
                        sb.append(getErrorMessage(ar));
                    }
                } else if (SC_PIN.equals(this.mSc)) {
                    sb.append(this.mContext.getText(17040977));
                } else {
                    sb.append(getErrorMessage(ar));
                }
            } else {
            ...
            if (this.mIsCallFwdReg) {
                sb.append(this.mContext.getText(17040976));
            } else if (mToastSwitch) {
                sb.append(this.mContext.getText(17041050));
            } else {
                sb.append(this.mContext.getText(17040972));
            }
            if (this.mSc.equals(SC_CLIR)) {
            ...
            this.mState = State.COMPLETE;
            if (mToastSwitch) {
                sb.append(this.mContext.getText(17041049));
            } else {
                sb.append(this.mContext.getText(17040971));
            }
            if (this.mSc.equals(SC_CLIR)) {
            ...
            this.mState = State.COMPLETE;
            sb.append(this.mContext.getText(17040974));
        } else {
            this.mState = State.FAILED;
            sb.append(this.mContext.getText(17040455));
        }
    ...
    private void onGetClirComplete(AsyncResult ar) {
        ...
        if (ar.exception == null) {
            ...
            switch (clirArgs[1]) {
                case 0:
                    sb.append(this.mContext.getText(17040975));
                    this.mState = State.COMPLETE;
                    break;
                case 1:
    ...
    private CharSequence serviceClassToCFString(int serviceClass) {
        switch (serviceClass) {
            case 1:
                return this.mContext.getText(17040970);
            case 2:
                return this.mContext.getText(17040963);
            case 4:
                return this.mContext.getText(17040966);
            case 8:
                return this.mContext.getText(17040969);
            case 16:
                return this.mContext.getText(17040965);
            case 32:
                return this.mContext.getText(17040964);
            case 64:
                return this.mContext.getText(17040968);
            case 128:
                return this.mContext.getText(17040967);
            default:
                return null;
        }
    }
    ...
    private CharSequence makeCFQueryResultMessage(CallForwardInfo info, int serviceClassMask) {
        ...
        if (info.status == 1) {
            ...
            template = this.mContext.getText(17039727);
        } else {
            template = this.mContext.getText(17039726);
        }
    ...
    private void onQueryComplete(AsyncResult ar) {
        ...
        if (ar.exception != null) {
            ...
            if (ints.length == 0) {
                ...
                if (mToastSwitch) {
                    sb.append(this.mContext.getText(17040858));
                } else {
                    sb.append(this.mContext.getText(17040971));
                }
                ...
                sb.append(this.mContext.getText(17040859));
            } else {
                sb.append(this.mContext.getText(17040972));
            }
            this.mState = State.COMPLETE;
    ...
    private CharSequence createQueryCallWaitingResultMessage(int serviceClass) {
        StringBuilder sb = new StringBuilder(this.mContext.getText(17040973));
