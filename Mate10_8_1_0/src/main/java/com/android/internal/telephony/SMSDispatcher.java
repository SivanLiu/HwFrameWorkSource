...
public abstract class SMSDispatcher extends AbstractSMSDispatcher {
    ...
    protected final class ConfirmDialogListener implements OnClickListener, OnCancelListener, OnCheckedChangeListener {
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            ...
            if (isChecked) {
                this.mPositiveButton.setText(17041018);
                this.mNegativeButton.setText(17041021);
                if (this.mRememberUndoInstruction != null) {
                    this.mRememberUndoInstruction.setText(17041024);
                    this.mRememberUndoInstruction.setPadding(0, 0, 0, 32);
                    return;
                }
                return;
            }
            this.mPositiveButton.setText(17041017);
            this.mNegativeButton.setText(17041019);
            if (this.mRememberUndoInstruction != null) {
    ...
    public static class SmsTracker {
        ...
        private Uri persistSentMessageIfRequired(Context context, int messageType, int errorCode) {
            ...
            Object obj = this.mAppInfo != null ? this.mAppInfo.packageName : null;
            if (!TextUtils.isEmpty(obj)) {
                values.put("creator", obj);
            }
    ...
    protected SMSDispatcher(Phone phone, SmsUsageMonitor usageMonitor, ImsSMSDispatcher imsSMSDispatcher) {
        ...
        this.mSmsCapable = this.mContext.getResources().getBoolean(17957020);
    ...
    public void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case 16:
                ...
                this.mToast = Toast.makeText(this.mContext, 17041144, 1);
                this.mToast.show();
                return;
            case 20:
    ...
    protected void handleReachSentLimit(SmsTracker tracker) {
        if (!denyIfQueueLimitReached(tracker)) {
            ...
            Spanned messageText = Html.fromHtml(r.getString(17041012, new Object[]{appLabel}));
            ConfirmDialogListener listener = new ConfirmDialogListener(tracker, null, 1);
            AlertDialog d = new Builder(this.mContext, 33947691).setTitle(17041014).setIcon(17301642).setMessage(messageText).setPositiveButton(r.getString(17041015), listener).setNegativeButton(r.getString(17041013), listener).setOnCancelListener(listener).create();
    ...
    protected void handleConfirmShortCode(boolean isPremium, SmsTracker tracker) {
        if (!denyIfQueueLimitReached(tracker)) {
            ...
            Resources r = Resources.getSystem();
            Spanned messageText = Html.fromHtml(r.getString(17041020, new Object[]{appLabel, tracker.mDestAddress}));
            View layout = ((LayoutInflater) new ContextThemeWrapper(this.mContext, r.getIdentifier("androidhwext:style/Theme.Emui", null, null)).getSystemService("layout_inflater")).inflate(17367276, null);
            ConfirmDialogListener listener = new ConfirmDialogListener(tracker, (TextView) layout.findViewById(16909307), 0);
            ((TextView) layout.findViewById(16909302)).setText(messageText);
            ((TextView) ((ViewGroup) layout.findViewById(16909303)).findViewById(16909304)).setText(detailsId);
            ((CheckBox) layout.findViewById(16909305)).setOnCheckedChangeListener(listener);
            AlertDialog d = new Builder(this.mContext, 33947691).setView(layout).setPositiveButton(r.getString(17041017), listener).setNegativeButton(r.getString(17041019), listener).setOnCancelListener(listener).create();
            d.getWindow().setType(2003);
            d.show();
    ...
    protected SmsTracker getSmsTracker(HashMap<String, Object> data, PendingIntent sentIntent, PendingIntent deliveryIntent, String format, AtomicInteger unsentPartCount, AtomicBoolean anyPartFailed, Uri messageUri, SmsHeader smsHeader, boolean isExpectMore, String fullMessageText, boolean isText, boolean persistMessage) {
        ...
        if (packageNames != null && packageNames.length > 0) {
            try {
                ...
                packageInfo = pm.getPackageInfoAsUser(packageNames[index], 64, userId);
        ...
        return new SmsTracker(data, sentIntent, deliveryIntent, packageInfo, PhoneNumberUtils.extractNetworkPortion((String) data.get("destAddr")), format, unsentPartCount, anyPartFailed, messageUri, smsHeader, isExpectMore, fullMessageText, getSubId(), isText, persistMessage, userId);
    }
