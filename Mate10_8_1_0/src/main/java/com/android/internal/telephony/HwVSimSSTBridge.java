...
abstract class HwVSimSSTBridge extends ServiceStateTracker {
    ...
    private static final String VSIM_BUSSINESS_PERMISSION = "com.huawei.skytone.permission.VSIM_BUSSINESS";
    ...
    public void updateSpnDisplay() {
        ...
        if (showPlmn == this.mCurShowPlmn && showSpn == this.mCurShowSpn && (TextUtils.equals(serviceProviderName, this.mCurSpn) ^ 1) == 0 && (TextUtils.equals(dataSpn, this.mCurDataSpn) ^ 1) == 0) {
        ...
        this.mPhone.getContext().sendBroadcast(intent, "com.huawei.skytone.permission.VSIM_BUSSINESS");
        this.mCurShowSpn = showSpn;
        this.mCurShowPlmn = showPlmn;
        this.mCurSpn = serviceProviderName;
        this.mCurDataSpn = dataSpn;
    ...
    private void pollStateDoneGsm() {
        ...
        boolean hasLacChanged = ((GsmCellLocation) this.mNewCellLoc).isNotLacEquals((GsmCellLocation) this.mCellLoc);
                    ...
                    if (prevOperatorNumeric == null || prevOperatorNumeric.equals("")) {
                        ...
                        if (!(this.mNitzUpdatedTime || (mcc.equals("000") ^ 1) == 0 || (TextUtils.isEmpty(iso) ^ 1) == 0 || !getAutoTimeZone() || (mcc.equals(prevMcc) ^ 1) == 0)) {
                            ...
                            if (uniqueZoneIds.size() == 1 && !testOneUniqueOffsetPath && defaultZones == null) {
                                ...
                                HwTelephonyFactory.getHwReportManager().reportSetTimeZoneByIso(this.mPhone, zoneId, this.mNitzUpdatedTime, "VSimIso");
                            }
                        }
