...
public final class MccTable {
    ...
    static {
        ...
        sTable.add(new MccEntry(RilConstS32.RIL_REQUEST_HW_SET_DATA_SWITCH, "gd", 2));
        sTable.add(new MccEntry(RilConstS32.RIL_REQUEST_HW_SET_IMS_SMS_CONFIG, "ms", 2));
        sTable.add(new MccEntry(RilConstS32.RIL_REQUEST_HW_GET_CSGIDSRCH_INFO, "kn", 2));
        sTable.add(new MccEntry(RilConstS32.RIL_REQUEST_HW_SET_DEEP_NO_DISTURB_SWITCH, "lc", 2));
        sTable.add(new MccEntry(RilConstS32.RIL_REQUEST_HW_IMS_GET_CURRENT_CALLS_V1_2, "vc", 2));
