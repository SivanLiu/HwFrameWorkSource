...
public interface ITelephony extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITelephony {
        ...
        static final int TRANSACTION_canChangeDtmfToneLength = 129;
        ...
        static final int TRANSACTION_checkCarrierPrivilegesForPackage = 113;
        static final int TRANSACTION_checkCarrierPrivilegesForPackageAnyPhone = 114;
        ...
        static final int TRANSACTION_enableVideoCalling = 127;
        ...
        static final int TRANSACTION_getCarrierPackageNamesForIntentAndPhone = 115;
        static final int TRANSACTION_getCarrierPrivilegeStatus = 112;
        ...
        static final int TRANSACTION_getCdmaMdn = 110;
        static final int TRANSACTION_getCdmaMin = 111;
        static final int TRANSACTION_getCdmaPrlVersion = 153;
        static final int TRANSACTION_getCellLocation = 41;
        static final int TRANSACTION_getCellNetworkScanResults = 101;
        ...
        static final int TRANSACTION_getDataEnabled = 107;
        ...
        static final int TRANSACTION_getEmergencyCallbackMode = 166;
        static final int TRANSACTION_getEsn = 152;
        static final int TRANSACTION_getForbiddenPlmns = 165;
        static final int TRANSACTION_getImeiForSlot = 138;
        static final int TRANSACTION_getImsServiceControllerAndListen = 99;
        static final int TRANSACTION_getLine1AlphaTagForDisplay = 118;
        static final int TRANSACTION_getLine1NumberForDisplay = 117;
        ...
        static final int TRANSACTION_getMergedSubscriberIds = 119;
        ...
        static final int TRANSACTION_getPcscfAddress = 108;
        static final int TRANSACTION_getPreferredNetworkType = 97;
        static final int TRANSACTION_getRadioAccessFamily = 126;
        ...
        static final int TRANSACTION_invokeOemRilRequestRaw = 122;
        ...
        static final int TRANSACTION_isHearingAidCompatibilitySupported = 132;
        static final int TRANSACTION_isIdle = 12;
        static final int TRANSACTION_isIdleForSubscriber = 13;
        static final int TRANSACTION_isImsRegistered = 133;
        ...
        static final int TRANSACTION_isTtyModeSupported = 131;
        static final int TRANSACTION_isVideoCallingEnabled = 128;
        ...
        static final int TRANSACTION_isWorldPhone = 130;
        static final int TRANSACTION_needMobileRadioShutdown = 123;
        ...
        static final int TRANSACTION_requestNetworkScan = 102;
        ...
        static final int TRANSACTION_setDataEnabled = 106;
        static final int TRANSACTION_setDataEnabledProperties = 163;
        static final int TRANSACTION_setImsRegistrationState = 109;
        static final int TRANSACTION_setLine1NumberForDisplayForSubscriber = 116;
        static final int TRANSACTION_setNetworkSelectionModeAutomatic = 100;
        static final int TRANSACTION_setNetworkSelectionModeManual = 104;
        static final int TRANSACTION_setOperatorBrandOverride = 120;
        ...
        static final int TRANSACTION_setRadioCapability = 125;
        static final int TRANSACTION_setRadioForSubscriber = 30;
        static final int TRANSACTION_setRadioPower = 31;
        static final int TRANSACTION_setRoamingOverride = 121;
        ...
        static final int TRANSACTION_shutdownMobileRadios = 124;
        static final int TRANSACTION_silenceRinger = 7;
        static final int TRANSACTION_stopNetworkScan = 103;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 25:
                    ...
                    handleUssdRequest(_arg0, _arg12, resultReceiver);
                    reply.writeNoException();
                    return true;
                case 26:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 67:
                    ...
                    _arg1 = data.readInt();
                    if (data.readInt() != 0) {
                        visualVoicemailSmsFilterSettings = (VisualVoicemailSmsFilterSettings) VisualVoicemailSmsFilterSettings.CREATOR.createFromParcel(data);
                    } else {
                        visualVoicemailSmsFilterSettings = null;
                    }
                    enableVisualVoicemailSmsFilter(_arg02, _arg1, visualVoicemailSmsFilterSettings);
                    reply.writeNoException();
                    return true;
                case 68:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 71:
                    ...
                    sendVisualVoicemailSmsForSubscriber(_arg02, _arg1, _arg2, _arg3, _arg4, pendingIntent);
                    reply.writeNoException();
                    return true;
                case 72:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 85:
                    data.enforceInterface(DESCRIPTOR);
                    _result7 = iccOpenLogicalChannel(data.readInt(), data.readString(), data.readString(), data.readInt());
                    reply.writeNoException();
                    if (_result7 != null) {
                        reply.writeInt(1);
                ...
                case 102:
                    ...
                    _arg0 = data.readInt();
                    if (data.readInt() != 0) {
                        networkScanRequest = (NetworkScanRequest) NetworkScanRequest.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    _result5 = requestNetworkScan(_arg0, networkScanRequest, messenger, data.readStrongBinder());
                    reply.writeNoException();
                    reply.writeInt(_result5);
                    return true;
                case 103:
                ...
                case 115:
                    ...
                    _result9 = getCarrierPackageNamesForIntentAndPhone(intent, data.readInt());
                    reply.writeNoException();
                ...
                case 122:
                    ...
                    _result5 = invokeOemRilRequestRaw(_arg03, bArr);
                    reply.writeNoException();
                    reply.writeInt(_result5);
                ...
                case 141:
                    ...
                    _result5 = getSubIdForPhoneAccount(phoneAccount);
                    reply.writeNoException();
                    reply.writeInt(_result5);
                    return true;
                case 142:
                ...
                case 144:
                    ...
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        resultReceiver2 = (ResultReceiver) ResultReceiver.CREATOR.createFromParcel(data);
                    } else {
                        resultReceiver2 = null;
                    }
                    requestModemActivityInfo(resultReceiver2);
                    return true;
                case 145:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 146:
                    ...
                    Uri _result16 = getVoicemailRingtoneUri(phoneAccountHandle);
                    reply.writeNoException();
                    if (_result16 != null) {
                        reply.writeInt(1);
                ...
                case 147:
                    ...
                    _arg02 = data.readString();
                    if (data.readInt() != 0) {
                        phoneAccountHandle2 = (PhoneAccountHandle) PhoneAccountHandle.CREATOR.createFromParcel(data);
                    } else {
                    ...
                    setVoicemailRingtoneUri(_arg02, phoneAccountHandle2, uri);
                    reply.writeNoException();
                    return true;
                case 148:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 149:
                    ...
                    setVoicemailVibrationEnabled(_arg02, phoneAccountHandle2, data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 150:
                    data.enforceInterface(DESCRIPTOR);
