...
/*
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find block by offset: 0x0049 in list [B:15:0x0046]
...
*/
        ...
        r6 = this;
        r5 = 0;
        r2 = r6.mMenuCallbackSet;
        if (r2 != 0) goto L_0x0017;
    L_0x0005:
        r2 = r6.mDecorToolbar;
        r3 = new com.android.internal.app.ToolbarActionBar$ActionMenuPresenterCallback;
        r3.<init>();
        r4 = new com.android.internal.app.ToolbarActionBar$MenuBuilderCallback;
        r4.<init>();
        r2.setMenuCallbacks(r3, r4);
        r2 = 1;
        r6.mMenuCallbackSet = r2;
    L_0x0017:
        r2 = r6.mDecorToolbar;
        r1 = r2.getMenu();
        r2 = r1 instanceof com.android.internal.view.menu.MenuBuilder;
        if (r2 == 0) goto L_0x004a;
    L_0x0021:
        r0 = r1;
        r0 = (com.android.internal.view.menu.MenuBuilder) r0;
    L_0x0024:
    ...
    L_0x0029:
        ...
        r2 = r6.mWindowCallback;	 Catch:{ all -> 0x004c }
        r3 = 0;	 Catch:{ all -> 0x004c }
        r2 = r2.onCreatePanelMenu(r3, r1);	 Catch:{ all -> 0x004c }
        if (r2 == 0) goto L_0x0041;	 Catch:{ all -> 0x004c }
    L_0x0035:
        r2 = r6.mWindowCallback;	 Catch:{ all -> 0x004c }
        r3 = 0;	 Catch:{ all -> 0x004c }
        r4 = 0;	 Catch:{ all -> 0x004c }
        r2 = r2.onPreparePanel(r3, r4, r1);	 Catch:{ all -> 0x004c }
        r2 = r2 ^ 1;	 Catch:{ all -> 0x004c }
        if (r2 == 0) goto L_0x0044;	 Catch:{ all -> 0x004c }
    L_0x0041:
        r1.clear();	 Catch:{ all -> 0x004c }
    L_0x0044:
