...
public interface IShellCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IShellCallback {
        ...
        private static class Proxy implements IShellCallback {
            ...
            public ParcelFileDescriptor openOutputFile(String path, String seLinuxContext) throws RemoteException {
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    ParcelFileDescriptor _result = openOutputFile(data.readString(), data.readString());
    ...
    ParcelFileDescriptor openOutputFile(String str, String str2) throws RemoteException;
}
