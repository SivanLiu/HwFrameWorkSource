        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    ...
                    IInputContext _arg1 = com.android.internal.view.IInputContext.Stub.asInterface(data.readStrongBinder());
                    ...
                    startInput(_arg02, _arg1, _arg2, editorInfo, data.readInt() != 0);
                    return true;
                case 5:
                ...
                case 8:
                    ...
                    showSoftInput(_arg0, resultReceiver);
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt();
                    ...
                    hideSoftInput(_arg0, resultReceiver);
                    return true;
                case 10:
