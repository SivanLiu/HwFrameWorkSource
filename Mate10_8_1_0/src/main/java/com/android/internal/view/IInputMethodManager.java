...
public interface IInputMethodManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IInputMethodManager {
        ...
        static final int TRANSACTION_getHwInnerService = 34;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 11:
                    ...
                    InputBindResult _result6 = startInputOrWindowGainedFocus(_arg03, _arg12, _arg2, _arg3, _arg4, _arg5, editorInfo, com.android.internal.view.IInputContext.Stub.asInterface(data.readStrongBinder()), data.readInt());
                    reply.writeNoException();
                    if (_result6 != null) {
                        reply.writeInt(1);
                ...
                case 15:
                    ...
                    setInputMethodAndSubtype(_arg02, _arg13, inputMethodSubtype);
                    reply.writeNoException();
                    return true;
                case 16:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 31:
                    ...
                    IInputContentUriToken _result8 = createInputContentUriToken(_arg02, uri, data.readString());
                    reply.writeNoException();
