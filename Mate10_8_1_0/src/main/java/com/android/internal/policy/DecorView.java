...
public class DecorView extends FrameLayout implements RootViewSurfaceTaker, WindowCallbacks {
    ...
    public static final ColorViewAttributes NAVIGATION_BAR_COLOR_VIEW_ATTRIBUTES = new ColorViewAttributes(2, 134217728, 80, 5, 3, Window.NAVIGATION_BAR_BACKGROUND_TRANSITION_NAME, R.id.navigationBarBackground, 0);
    ...
    public static final ColorViewAttributes STATUS_BAR_COLOR_VIEW_ATTRIBUTES = new ColorViewAttributes(4, 67108864, 48, 3, 5, Window.STATUS_BAR_BACKGROUND_TRANSITION_NAME, R.id.statusBarBackground, 1024);
    ...
    private boolean showContextMenuForChildInternal(View originalView, float x, float y) {
        ...
        int isNaN = !Float.isNaN(x) ? Float.isNaN(y) ^ 1 : 0;
        if (isNaN != 0) {
        ...
        if (helper != null) {
            callback.setShowDialogForSubmenu(isNaN ^ 1);
    ...
    WindowInsets updateColorViews(WindowInsets insets, boolean animate) {
        ...
        if (!this.mWindow.mIsFloating) {
            ...
            if (navBarToRightEdge) {
                z2 = this.mNavigationColorViewState.present;
            } else {
                z2 = false;
            }
            if (navBarToLeftEdge) {
            ...
            int statusBarSideInset = z2 ? this.mLastRightInset : statusBarNeedsLeftInset ? this.mLastLeftInset : 0;
        ...
        int consumedLeft = z ? this.mLastLeftInset : 0;
