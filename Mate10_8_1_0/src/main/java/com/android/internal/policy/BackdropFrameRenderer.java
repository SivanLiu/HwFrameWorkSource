...
public class BackdropFrameRenderer extends Thread implements FrameCallback {
    ...
    private void doFrameUncheckedLocked() {
        ...
        if (this.mNewTargetRect.equals(this.mOldTargetRect) && this.mOldFullscreen == this.mFullscreen && (this.mStableInsets.equals(this.mOldStableInsets) ^ 1) == 0 && (this.mSystemInsets.equals(this.mOldSystemInsets) ^ 1) == 0) {
