...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    public static abstract class Callback {
        ...
        public static int convertToRelativeDirection(int r1, int r2) {
            /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.internal.widget.helper.ItemTouchHelper.Callback.convertToRelativeDirection(int, int):int
...
*/
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.internal.widget.helper.ItemTouchHelper.Callback.convertToRelativeDirection(int, int):int");
        }

        public int convertToAbsoluteDirection(int r1, int r2) {
            /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.internal.widget.helper.ItemTouchHelper.Callback.convertToAbsoluteDirection(int, int):int
	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:116)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:249)
	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:256)
	at jadx.core.ProcessClass.process(ProcessClass.java:31)
...
*/
            ...
            // Can't load method instructions.
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.internal.widget.helper.ItemTouchHelper.Callback.convertToAbsoluteDirection(int, int):int");
        }
        ...
        if (selected != this.mSelected || actionState != this.mActionState) {
            ...
            if (this.mSelected != null) {
                ...
                if (prevSelected.itemView.getParent() != null) {
                    ...
                    final ItemTouchHelper itemTouchHelper = this;
                        ...
                        public void onAnimationEnd(Animator animation) {
                            ...
                            if (!this.mOverridden) {
                                if (swipeDir <= 0) {
                                    ...
                                    if (swipeDir > 0) {
                                        itemTouchHelper.postDispatchSwipe(this, swipeDir);
                                    }
                                }
                                if (itemTouchHelper.mOverdrawChild == viewHolder.itemView) {
                                    itemTouchHelper.removeChildDrawingOrderCallbackIfNecessary(viewHolder.itemView);
                                }
                            }
                        }
                    };
