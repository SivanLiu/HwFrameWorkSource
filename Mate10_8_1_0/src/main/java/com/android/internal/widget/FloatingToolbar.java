...
public final class FloatingToolbar {
    ...
    private static final class FloatingToolbarPopup {
        ...
        /* synthetic */ void lambda$-com_android_internal_widget_FloatingToolbar$FloatingToolbarPopup_17043(InternalInsetsInfo info) {
        ...
        /* synthetic */ void lambda$-com_android_internal_widget_FloatingToolbar$FloatingToolbarPopup_72630(ImageButton overflowButton, View v) {
            if (this.mIsOverflowOpen) {
        ...
        /* synthetic */ void lambda$-com_android_internal_widget_FloatingToolbar$FloatingToolbarPopup_73995(OverflowPanel overflowPanel, AdapterView adapterView, View view, int position, long id) {
        ...
        private boolean isOverflowAnimating() {
            ...
            if (this.mOpenOverflowAnimation.hasStarted()) {
                hasEnded = this.mOpenOverflowAnimation.hasEnded() ^ 1;
            } else {
                hasEnded = 0;
            }
            if (this.mCloseOverflowAnimation.hasStarted()) {
                hasEnded2 = this.mCloseOverflowAnimation.hasEnded() ^ 1;
            } else {
                hasEnded2 = false;
            }
            return hasEnded == 0 ? hasEnded2 : true;
        }
        ...
        private AnimationListener createOverflowAnimationListener() {
            return new AnimationListener() {
                ...
                /* synthetic */ void lambda$-com_android_internal_widget_FloatingToolbar$FloatingToolbarPopup$13_75721() {
                    FloatingToolbarPopup.this.setPanelsStatesAtRestingPosition();
                    FloatingToolbarPopup.this.setContentAreaAsTouchableSurface();
                }
