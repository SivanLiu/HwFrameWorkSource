    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (recalculateVisibility) {
            ...
            for (i = count - 1; i >= 0 && totalHeight < targetHeight; i--) {
                if (getChildAt(i).getVisibility() != 8) {
                    ...
                    imageFloatingTextView = null;
                    if (child instanceof ImageFloatingTextView) {
                        imageFloatingTextView = (ImageFloatingTextView) child;
                    ...
                    if (imageFloatingTextView != null) {
                        measuredTooSmall = childHeight < (imageFloatingTextView.getLayoutHeight() + imageFloatingTextView.getPaddingTop()) + imageFloatingTextView.getPaddingBottom();
                    }
        ...
        for (i = 0; i < count; i++) {
            ...
            if (!(child.getVisibility() == 8 || lp.hide)) {
                if (child instanceof ImageFloatingTextView) {
                    imageFloatingTextView = (ImageFloatingTextView) child;
                    if (imageLines == 2 && imageFloatingTextView.getLineCount() > 2) {
                        imageLines = 3;
                    }
                    if (imageFloatingTextView.setNumIndentLines(Math.max(0, imageLines)) || (recalculateVisibility ^ 1) != 0) {
                    ...
                    imageLines -= imageFloatingTextView.getLineCount();
                }
