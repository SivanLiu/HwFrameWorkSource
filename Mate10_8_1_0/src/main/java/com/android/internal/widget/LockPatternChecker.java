        ...
        AsyncTask<Void, Void, Boolean> task = new AsyncTask<Void, Void, Boolean>() {
            ...
            protected Boolean doInBackground(Void... args) {
                try {
                    ...
                    return Boolean.valueOf(lockPatternUtils.checkPattern(list, i, new -$Lambda$E2sSlgjiM2w1MdavtCJi6YeQRgk((byte) 0, onCheckCallback)));
                } catch (RequestThrottledException ex) {
                    this.mThrottleTimeout = ex.getTimeoutMs();
        ...
        AsyncTask<Void, Void, Boolean> task = new AsyncTask<Void, Void, Boolean>() {
            ...
            protected Boolean doInBackground(Void... args) {
                try {
                    ...
                    OnCheckCallback onCheckCallback = callback;
                    onCheckCallback.getClass();
                    return Boolean.valueOf(lockPatternUtils.checkPassword(str, i, new -$Lambda$E2sSlgjiM2w1MdavtCJi6YeQRgk((byte) 1, onCheckCallback)));
                } catch (RequestThrottledException ex) {
                    this.mThrottleTimeout = ex.getTimeoutMs();
                    return Boolean.valueOf(false);
                }
