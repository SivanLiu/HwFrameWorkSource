...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public final class Recycler {
        ...
        private boolean tryBindViewHolderByDeadline(ViewHolder holder, int offsetPosition, int position, long deadlineNs) {
            ...
            if (deadlineNs != Long.MAX_VALUE && (this.mRecyclerPool.willBindInTime(viewType, startBindNs, deadlineNs) ^ 1) != 0) {
                return false;
            }
        ...
        ViewHolder tryGetViewHolderForPositionByDeadline(int position, boolean dryRun, long deadlineNs) {
            ...
            if (RecyclerView.this.mState.isPreLayout()) {
                ...
                fromScrapOrHiddenOrCache = viewHolder != null;
            }
            if (viewHolder == null) {
            ...
            if (viewHolder == null) {
                ...
                if (RecyclerView.this.mAdapter.hasStableIds()) {
                    viewHolder = getScrapOrCachedViewForId(RecyclerView.this.mAdapter.getItemId(offsetPosition), type, dryRun);
                    if (viewHolder != null) {
                ...
                if (viewHolder == null) {
                    ...
                    if (deadlineNs != Long.MAX_VALUE && (this.mRecyclerPool.willCreateInTime(type, start, deadlineNs) ^ 1) != 0) {
                        return null;
                    }
                    viewHolder = RecyclerView.this.mAdapter.createViewHolder(RecyclerView.this, type);
                    if (RecyclerView.ALLOW_THREAD_GAP_WORK) {
                        RecyclerView innerView = RecyclerView.findNestedRecyclerView(viewHolder.itemView);
                        if (innerView != null) {
                            viewHolder.mNestedRecyclerView = new WeakReference(innerView);
                        }
                    }
                    this.mRecyclerPool.factorInCreateTime(type, RecyclerView.this.getNanoTime() - start);
                }
            }
            if (fromScrapOrHiddenOrCache && (RecyclerView.this.mState.isPreLayout() ^ 1) != 0 && viewHolder.hasAnyOfTheFlags(8192)) {
            ...
            if (RecyclerView.this.mState.isPreLayout() && viewHolder.isBound()) {
                ...
                bound = tryBindViewHolderByDeadline(viewHolder, RecyclerView.this.mAdapterHelper.findPositionOffset(position), position, deadlineNs);
            }
            ...
            if (lp == null) {
                ...
                viewHolder.itemView.setLayoutParams(rvLayoutParams2);
            }
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if ((dx == 0 && dy == 0) || fullyConsumedHorizontal) {
                    ...
                    boolean fullyConsumedAny = fullyConsumedVertical;
                }
                if (scroller.isFinished() || (r6 ^ 1) != 0) {
...
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.internal.widget.RecyclerView.ViewHolder.setFlags(int, int):void
...
*/
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.internal.widget.RecyclerView.ViewHolder.setFlags(int, int):void");
        }
    ...
    private void processAdapterUpdatesAndSetAnimationFlags() {
        ...
        if (this.mState.mRunSimpleAnimations && z2 && (this.mDataSetHasChangedAfterLayout ^ 1) != 0) {
