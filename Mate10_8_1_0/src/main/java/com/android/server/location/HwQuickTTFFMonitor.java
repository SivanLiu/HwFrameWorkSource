...
public class HwQuickTTFFMonitor {
    ...
    private static final String TAG = "HwQuickTTFFMonitor-V2018.2.2";
    private static final String VERSION = "V2018.2.2";
    ...
    private String configPath() {
        if (isBetaUser()) {
            ...
            this.DEBUG_PROPERTIES_FILE = "/cust_spec/xml/higeo_beta.conf";
            if (!new File(this.DEBUG_PROPERTIES_FILE).exists()) {
            ...
            this.DEBUG_PROPERTIES_FILE = "/cust_spec/xml/higeo.conf";
            if (!new File(this.DEBUG_PROPERTIES_FILE).exists()) {
                Log.d(TAG, "configPath is not /cust_spec/xml/  ");
