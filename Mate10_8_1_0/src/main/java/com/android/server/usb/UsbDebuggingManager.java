...
public class UsbDebuggingManager {
            ...
            switch (msg.what) {
                ...
                case 5:
                    if ("trigger_restart_min_framework".equals(SystemProperties.get("vold.decrypt"))) {
                        ...
                        return;
                    } else if (UsbDebuggingManager.this.mContext == null || (UsbDebuggingManager.isDeviceProvisioned(UsbDebuggingManager.this.mContext) ^ 1) == 0) {
                        key = (String) msg.obj;
                        fingerprints = UsbDebuggingManager.this.getFingerprints(key);
    ...
    class UsbDebuggingThread extends Thread {
        ...
        private void listenToSocket() throws IOException {
            ...
            while (true) {
                ...
                try {
                    if (buffer[0] != (byte) 80 || buffer[1] != (byte) 75) {
                        break;
                    }
    ...
    private void startConfirmation(String key, String fingerprints) {
        ...
        if (userInfo.isAdmin() || userInfo.isRepairMode()) {
            ...
            componentString = Resources.getSystem().getString(17039761);
        }
