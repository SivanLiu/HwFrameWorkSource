...
class MtpNotificationManager {
    ...
    void showNotification(UsbDevice device) {
        ...
        String title = resources.getString(17041165, new Object[]{device.getProductName()});
        Builder builder = new Builder(this.mContext, SystemNotificationChannels.USB).setContentTitle(title).setContentText(resources.getString(17041164)).setSmallIcon(17303489).setCategory("sys");
