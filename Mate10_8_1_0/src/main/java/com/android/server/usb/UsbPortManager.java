...
import android.hardware.usb.V1_1.IUsbCallback.Stub;
...
public class UsbPortManager {
    ...
    private static class HALCallback extends Stub {
        ...
        public void notifyPortStatusChange_1_1(ArrayList<PortStatus_1_1> currentPortStatus, int retval) {
            ...
            for (PortStatus_1_1 current : currentPortStatus) {
                ...
                UsbPortManager.logAndPrint(4, this.pw, "ClientCallback: " + current.status.portName);
            }
            Message message = this.portManager.mHandler.obtainMessage();
            Bundle bundle = new Bundle();
            bundle.putParcelableArrayList(UsbPortManager.PORT_INFO, newPortInfo);
    ...
    private void sendPortChangedBroadcastLocked(PortInfo portInfo) {
        ...
        this.mHandler.post(new -$Lambda$A9zkc-u4LaET6cVKd0uc6IuE4_s(this, intent));
    }

    /* synthetic */ void lambda$-com_android_server_usb_UsbPortManager_30586(Intent intent) {
