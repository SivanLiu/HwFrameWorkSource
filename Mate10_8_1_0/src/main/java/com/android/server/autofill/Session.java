...
final class Session implements FillServiceCallbacks, Listener, AutoFillUiCallback {
        ...
        public void send(int resultCode, Bundle resultData) throws RemoteException {
            ...
            synchronized (Session.this.mLock) {
                ...
                if (!Session.this.mComponentName.equals(componentNameFromApp)) {
                    ...
                    MetricsLogger -get4 = Session.this.mMetricsLogger;
                    LogMaker -wrap0 = Session.this.newLogMaker(948);
                    if (componentNameFromApp == null) {
                        obj = "null";
                    } else {
                        obj = componentNameFromApp.flattenToShortString();
                    }
                    -get4.write(-wrap0.addTaggedData(949, obj));
                }
    ...
    Session(AutofillManagerServiceImpl service, AutoFillUI ui, Context context, HandlerCaller handlerCaller, int userId, Object lock, int sessionId, int uid, IBinder activityToken, IBinder client, boolean hasCallback, LocalLog uiLatencyHistory, ComponentName serviceComponentName, ComponentName appComponentName) {
        this.id = sessionId;
        this.uid = uid;
    ...
    /* synthetic */ void lambda$-com_android_server_autofill_Session_23958(int authenticationId, IntentSender intent, Intent fillInIntent) {
    ...
    /* synthetic */ void lambda$-com_android_server_autofill_Session_24580(int requestId, int datasetIndex, Dataset dataset) {
    ...
    /* synthetic */ void lambda$-com_android_server_autofill_Session_25476() {
        removeSelf();
    }
    ...
    /* synthetic */ void lambda$-com_android_server_autofill_Session_27469(IntentSender intentSender) {
        try {
            synchronized (this.mLock) {
    ...
    public boolean showSaveLocked() {
        ...
        if (allRequiredAreNotEmpty) {
            ...
            if (atLeastOneChanged) {
                ...
                getUiForShowing().showSaveUi(this.mService.getServiceLabel(), this.mService.getServiceIcon(), this.mService.getServicePackageName(), saveInfo, valueFinder, this.mComponentName.getPackageName(), this, this.mPendingSaveUi);
                if (client != null) {
                    try {
    ...
    /* synthetic */ String lambda$-com_android_server_autofill_Session_37701(AutofillId id) {
    ...
    private void processNullResponseLocked(int flags) {
        ...
        if ((flags & 1) != 0) {
            getUiForShowing().showError(17039632, (AutoFillUiCallback) this);
        }
        this.mService.resetLastResponse();
    ...
    private LogMaker newLogMaker(int category, String servicePackageName) {
        return Helper.newLogMaker(category, this.mComponentName.getPackageName(), servicePackageName);
    }
