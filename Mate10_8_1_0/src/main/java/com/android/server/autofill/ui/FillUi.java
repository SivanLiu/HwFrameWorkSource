...
final class FillUi {
    ...
    final class AnchoredWindow implements OnTouchListener {
        ...
        public void show(LayoutParams params) {
            ...
            try {
                ...
                params.accessibilityTitle = this.mContentView.getContext().getString(17039652);
    ...
    private final class AnnounceFilterResult implements Runnable {
        ...
        public void run() {
            ...
            if (count <= 0) {
                text = FillUi.this.mContext.getString(17039653);
            } else {
    ...
    private final class AutofillWindowPresenter extends Stub {
        ...
        public void show(LayoutParams p, Rect transitionEpicenter, boolean fitsSystemWindows, int layoutDirection) {
            ...
            UiThread.getHandler().post(new -$Lambda$TTOM-vgvIOJotO3pKgpKhg7oNlE((byte) 4, this, p));
        }

        /* synthetic */ void lambda$-com_android_server_autofill_ui_FillUi$AutofillWindowPresenter_13643(LayoutParams p) {
    ...
    FillUi(Context context, FillResponse response, AutofillId focusedViewId, String filterText, OverlayControl overlayControl, Callback callback) {
        ...
        if (response.getAuthentication() != null) {
            ...
            try {
                ...
                decor.setOnClickListener(new -$Lambda$At7ghLP7ePb8IjX4T-3J791grHE((byte) 0, this, response));
        ...
        this.mListView = (ListView) decor.findViewById(16908737);
    ...
    private void applyNewFilterText() {
        this.mAdapter.getFilter().filter(this.mFilterText, new AnonymousClass2(this.mAdapter.getCount(), this));
    }
