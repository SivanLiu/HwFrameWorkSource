...
final class RemoteFillService implements DeathRecipient {
    ...
    private static abstract class PendingRequest implements Runnable {
        ...
        /* synthetic */ void lambda$-com_android_server_autofill_RemoteFillService$PendingRequest_16211() {
                ...
                public void onCancellable(ICancellationSignal cancellation) {
                    synchronized (PendingFillRequest.this.mLock) {
                        synchronized (PendingFillRequest.this.mLock) {
                            ...
                            boolean cancelled = PendingFillRequest.this.isCancelledLocked();
                        }
                        if (cancelled) {
                            try {
                                cancellation.cancel();
    ...
    /* synthetic */ void lambda$-com_android_server_autofill_RemoteFillService_10952(PendingRequest pendingRequest, CharSequence message) {
        if (handleResponseCallbackCommon(pendingRequest)) {
    ...
    static /* synthetic */ void lambda$-com_android_server_autofill_RemoteFillService_11273(ICancellationSignal cancellationSignal) {
        try {
    ...
    /* synthetic */ void lambda$-com_android_server_autofill_RemoteFillService_11609(PendingRequest pendingRequest) {
        if (handleResponseCallbackCommon(pendingRequest)) {
    ...
    /* synthetic */ void lambda$-com_android_server_autofill_RemoteFillService_11954(PendingRequest pendingRequest, CharSequence message) {
        if (handleResponseCallbackCommon(pendingRequest)) {
