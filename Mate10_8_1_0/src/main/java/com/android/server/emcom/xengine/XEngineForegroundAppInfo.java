...
public class XEngineForegroundAppInfo {
    ...
    public static class HiParam {
        ...
        private int mMultiPathType;
        private int mObjectiveDelay;
        private String mPackageName;
        private int mWifiMode;

        public HiParam(String packName, int mp, int mpType, int wifiMode, int objDelay, int maxGrade, int minGrade) {
            this.mMultiPath = mp;
            this.mMultiPathType = mpType;
        ...
        public int getMultiPathType() {
            return this.mMultiPathType;
        }
        ...
        public String toString() {
            ...
            buffer.append("MultiPath=").append(this.mMultiPath).append(", ").append("MultiPathType=").append(this.mMultiPathType).append(", ").append("mWifiMode=").append(this.mWifiMode).append(", ").append("ObjectiveDelay=").append(this.mObjectiveDelay).append(", ").append("mMaxGrade=").append(this.mMaxGrade).append(", ").append("mMinGrade=").append(this.mMinGrade).append("}");
