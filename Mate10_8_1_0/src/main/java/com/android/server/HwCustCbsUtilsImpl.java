...
public class HwCustCbsUtilsImpl extends HwCustCbsUtils {
    ...
    private static final String DCM_PHONEMOTION_PACKAGE = "com.nttdocomo.android.phonemotion";
    ...
    public boolean allowVibrateWhenSlient(Context context, String currentVibrationPkg) {
        ...
        return ((AudioManager) context.getSystemService("audio")).getRingerModeInternal() != 0 || Global.getInt(context.getContentResolver(), KEY_VIBIRATE_WHEN_SILENT, 0) != 0 || DCM_LCSAPP_PACKAGE.equals(currentVibrationPkg) || DCM_AREAMAIL_PACKAGE.equals(currentVibrationPkg) || DCM_PHONEMOTION_PACKAGE.equals(currentVibrationPkg);
    }
}
