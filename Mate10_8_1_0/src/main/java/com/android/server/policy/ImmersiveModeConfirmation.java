...
public class ImmersiveModeConfirmation {
    ...
    private class ClingWindowView extends FrameLayout {
        ...
        public void onAttachedToWindow() {
            ...
            ((Button) this.mClingLayout.findViewById(16909120)).setOnClickListener(new OnClickListener() {
    ...
    private long getNavBarExitDuration() {
        Animation exit = AnimationUtils.loadAnimation(this.mContext, 17432614);
    ...
    public FrameLayout.LayoutParams getBubbleLayoutParams() {
        return new FrameLayout.LayoutParams(this.mContext.getResources().getDimensionPixelSize(17105059), -2, 49);
    }
