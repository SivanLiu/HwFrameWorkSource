...
public final class FingerprintNavigation {
    ...
    final class CameraInspector extends FingerprintNavigationInspector {
        ...
        public boolean probe(InputEvent event) {
            ...
            if ((!FingerprintNavigation.this.isCamera() && (pkgName.startsWith(pkg_gallery) ^ 1) != 0) || (FingerprintNavigation.this.mInjectCamera ^ 1) != 0) {
    ...
    final class CollapsePanelsInspector extends FingerprintNavigationInspector {
        ...
        public boolean probe(InputEvent event) {
            ...
            if (FingerprintNavigation.this.isScreenOff() || (FingerprintNavigation.this.isVRMode() ^ 1) == 0 || !FingerprintNavigation.this.isSpecialKey(event, 511)) {
                return false;
            }
            return true;
        }
            ...
            if (((KeyEvent) event).getAction() != 0) {
                ...
                if (hwStatusBarService != null) {
                    ...
                    if (!FingerprintNavigation.this.mShowNotification || (FingerprintNavigation.this.mRecentApp && !hwStatusBarService.statusBarExpanded())) {
                        if (!FingerprintNavigation.this.mRecentApp || (FingerprintNavigation.this.isAlarm() ^ 1) == 0 || (FingerprintNavigation.this.isInCallUIAndRinging() ^ 1) == 0 || (FingerprintNavigation.this.isLandscape() ^ 1) == 0) {
                    ...
                    } else if (!(FingerprintNavigation.this.isScenseExcluded() || ((FingerprintNavigation.this.isAlarm() && (FingerprintNavigation.this.topIsFullScreen() ^ 1) == 0) || (FingerprintNavigation.this.isLandscape() ^ 1) == 0))) {
    ...
    final class DefaultInspector extends FingerprintNavigationInspector {
        ...
        public boolean probe(InputEvent event) {
            if (FingerprintNavigation.this.isScreenOff() || (FingerprintNavigation.this.isKeyguardLocked() ^ 1) == 0 || !FingerprintNavigation.this.mInjectSlide) {
                return false;
            }
            return true;
        }
    ...
    final class DoubleTapInspector extends FingerprintNavigationInspector {
        ...
        public boolean probe(InputEvent event) {
            if (!FingerprintNavigation.this.mLockDevice || (FingerprintNavigation.this.isScreenOff() ^ 1) == 0 || (FingerprintNavigation.this.isInCallUI() ^ 1) == 0 || (FingerprintNavigation.this.isCamera() ^ 1) == 0 || (FingerprintNavigation.this.isAlarm() ^ 1) == 0 || !FingerprintNavigation.this.isSpecialKey(event, 26)) {
                return false;
            }
            return true;
        }
    ...
    final class FingerprintDemoInspector extends FingerprintNavigationInspector {
        ...
        public boolean probe(InputEvent event) {
            if (FingerprintNavigation.this.isScreenOff() || (FingerprintNavigation.this.isKeyguardLocked() ^ 1) == 0 || !FingerprintNavigation.this.mFingerprintMarketDemoSwitch || !FingerprintNavigation.this.isFingerprintDemo()) {
                return false;
            }
            if (FingerprintNavigation.DEBUG) {
    ...
    final class GalleryInspector extends FingerprintNavigationInspector {
        ...
        public boolean probe(InputEvent event) {
            ...
            if (!FingerprintNavigation.this.mGallerySlide || !FingerprintNavigation.this.isGallery() || (FingerprintNavigation.this.isScreenOff() ^ 1) == 0 || (FingerprintNavigation.this.isVRMode() ^ 1) == 0 || (!FingerprintNavigation.this.isSpecialKey(event, 513) && !FingerprintNavigation.this.isSpecialKey(event, CommandsInterface.EMCOM_DS_HTTP_INFO))) {
                return false;
            }
            if (FingerprintNavigation.DEBUG) {
    ...
    final class LauncherInspector extends FingerprintNavigationInspector {
        ...
        public boolean probe(InputEvent event) {
            ...
            if (FingerprintNavigation.this.isScreenOff() || !FingerprintNavigation.this.isSpecialKey(event, 512) || (FingerprintNavigation.this.isScenseExcluded() ^ 1) == 0 || ((FingerprintNavigation.this.isAlarm() && (FingerprintNavigation.this.topIsFullScreen() ^ 1) == 0) || (FingerprintNavigation.this.isLandscape() ^ 1) == 0)) {
                return false;
            }
    ...
    final class StartHomeInspector extends FingerprintNavigationInspector {
        ...
        public boolean probe(InputEvent event, boolean unHandledKey) {
            ...
            if (!(!FingerprintNavigation.this.mBackToHome || (FingerprintNavigation.this.isScreenOff() ^ 1) == 0 || (FingerprintNavigation.this.isKeyguardLocked() ^ 1) == 0)) {
                FingerprintNavigation fingerprintNavigation = FingerprintNavigation.this;
                if (unHandledKey) {
                    i = 502;
                }
                if (!(!fingerprintNavigation.isSpecialKey(event, i) || (FingerprintNavigation.this.isAlarm() ^ 1) == 0 || (FingerprintNavigation.this.isInCallUIAndRinging() ^ 1) == 0)) {
                    return true;
                }
            }
            return false;
    ...
    final class StopAlarmInspector extends FingerprintNavigationInspector {
        ...
        public boolean probe(InputEvent event) {
            ...
            if (FingerprintNavigation.this.mStopAlarm && (FingerprintNavigation.this.isScreenOff() ^ 1) != 0 && FingerprintNavigation.this.isAlarm() && (FingerprintNavigation.this.isSpecialKey(event, 66) || FingerprintNavigation.this.isSpecialKey(event, 502))) {
                return true;
            }
            return false;
        }
        ...
        if (kv != null) {
            ...
            switch (keyCode) {
                case 66:
                    ...
                    if (compName == null || !compName.startsWith("com.android.gallery3d") || (isAlarm() ^ 1) == 0) {
                        if (isInCallUI()) {
    ...
    private void handleCustFingerEvent(InputEvent event) {
        if (!(this.mHwCust != null ? this.mHwCust.handleFingerprintEvent(event) : false)) {
    ...
    public boolean filterInputEvent(InputEvent event, int policyFlags) {
        ...
        if (FRONT_FINGERPRINT_NAVIGATION && kv != null && (isVRMode() ^ 1) != 0 && this.mFrontFingerprintNav != null && this.mFrontFingerprintNav.handleFingerprintEvent(event)) {
            return true;
        }
        if (kv != null && (FrontFingerPrintSettings.FRONT_FINGERPRINT_NAVIGATION ^ 1) != 0 && interceptSystemNavigationKeyAsGoogle(kv)) {
            return true;
        }
    ...
    private boolean isCamera() {
        ...
        String pkg_camera = MemoryConstant.CAMERA_PACKAGE_NAME;
        if (pkgName != null) {
    ...
    private void sendKeyEvent(int keycode) {
        ...
        for (int keyEvent : actions) {
            long curTime = SystemClock.uptimeMillis();
            InputManager.getInstance().injectInputEvent(new KeyEvent(curTime, curTime, keyEvent, keycode, 0, 0, 6, 0, 2056, CommandsInterface.EMCOM_SD_XENGINE_START_ACC), 0);
        }
    }
    ...
    private String getTopApp() {
        ...
        if (DEBUG && pkgName != null) {
            Log.d(TAG_FP, "TopApp is " + pkgName.split("/")[0]);
        }
        return pkgName;
    }
    ...
    private boolean focusedWinOverStatusBar() {
        ...
        if (focusedWin != null) {
            windowLayerFromTypeLw = policy.getWindowLayerFromTypeLw(focusedWin.getBaseType());
        } else {
            windowLayerFromTypeLw = 0;
        }
        Log.d(str, append.append(windowLayerFromTypeLw).append(", statusbarLayer=").append(policy.getWindowLayerFromTypeLw(2000)).toString());
    ...
    private void updateFingerNaviSwitchValue(boolean careReadDb) {
        ...
        boolean z2 = true;
        int defaultValue = 1;
        if (FRONT_FINGERPRINT_NAVIGATION && (careReadDb ^ 1) != 0) {
            defaultValue = 0;
        }
        ...
        if (Secure.getIntForUser(this.mResolver, FINGERPRINT_CAMERA_SWITCH, defaultValue, ActivityManager.getCurrentUser()) != 0) {
            z = true;
        } else {
            z = false;
        }
        this.mInjectCamera = z;
