...
public class SyncOperation {
    ...
    String dump(PackageManager pm, boolean shorter) {
        StringBuilder sb = new StringBuilder();
        sb.append("JobId: ").append(this.jobId).append(", ").append("XXXXXXXXX").append(" u").append(this.target.userId).append(" (").append(this.target.account.type).append(" u").append(this.target.userId).append(" [").append(this.target.provider).append("] ");
