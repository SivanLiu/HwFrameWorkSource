...
public class HwCCModePlugin extends Stub implements IHwSecurityPlugin {
    ...
    private void waitForConfirm() {
        ...
        AlertDialog dialog = new Builder(this.mContext).setTitle(this.mContext.getString(33686069)).setMessage(this.mContext.getString(33686072)).setNeutralButton(this.mContext.getString(33685528), new OnClickListener() {
