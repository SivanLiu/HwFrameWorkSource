...
public interface IpConnectivityLogClass {
    ...
    public static final class DNSLookupBatch extends MessageNano {
        ...
        public void writeTo(CodedOutputByteBufferNano output) throws IOException {
            ...
            if (this.gethostbynameErrors != null && this.gethostbynameErrors.length > 0) {
                for (Pair element2 : this.gethostbynameErrors) {
                    if (element2 != null) {
        ...
        protected int computeSerializedSize() {
            ...
            if (this.gethostbynameErrors != null && this.gethostbynameErrors.length > 0) {
                for (Pair element32 : this.gethostbynameErrors) {
                    if (element32 != null) {
                        size += CodedOutputByteBufferNano.computeMessageSize(10, element32);
                    }
                }
            }
            return size;
            ...
            while (true) {
                ...
                switch (tag) {
                    ...
                    case 74:
                        ...
                        newArray2 = new Pair[(i + arrayLength)];
                        if (i != 0) {
                            System.arraycopy(this.getaddrinfoErrors, 0, newArray2, 0, i);
                        }
                        while (i < newArray2.length - 1) {
                            newArray2[i] = new Pair();
                            input.readMessage(newArray2[i]);
                        ...
                        newArray2[i] = new Pair();
                        input.readMessage(newArray2[i]);
                        this.getaddrinfoErrors = newArray2;
                        break;
                    case 82:
                        ...
                        newArray2 = new Pair[(i + arrayLength)];
                        if (i != 0) {
                            System.arraycopy(this.gethostbynameErrors, 0, newArray2, 0, i);
                        }
                        while (i < newArray2.length - 1) {
                            newArray2[i] = new Pair();
                            input.readMessage(newArray2[i]);
                        ...
                        newArray2[i] = new Pair();
                        input.readMessage(newArray2[i]);
                        this.gethostbynameErrors = newArray2;
                        break;
                    default:
                        if (WireFormatNano.parseUnknownField(input, tag)) {
                            break;
    ...
    public static final class DefaultNetworkEvent extends MessageNano {
        ...
        protected int computeSerializedSize() {
            ...
            if (this.ipSupport != 0) {
                return size + CodedOutputByteBufferNano.computeInt32Size(9, this.ipSupport);
            }
            return size;
        }
    ...
    public static final class NetworkStats extends MessageNano {
        ...
        public void writeTo(CodedOutputByteBufferNano output) throws IOException {
            ...
            if (this.validationStates != null && this.validationStates.length > 0) {
                for (Pair element2 : this.validationStates) {
                    if (element2 != null) {
    ...
    public static final class WakeupStats extends MessageNano {
        ...
        protected int computeSerializedSize() {
            ...
            if (this.noUidWakeups != 0) {
                return size + CodedOutputByteBufferNano.computeInt64Size(7, this.noUidWakeups);
            }
            return size;
        }
