...
public class LocationManagerService extends AbsLocationManagerService {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 4:
                    ...
                    String pkg = msg.obj;
                    -get8 = LocationManagerService.this.mLock;
                    synchronized (-get8) {
                        ...
                        for (Entry<IGnssMeasurementsListener, Identity> entry : LocationManagerService.this.mGnssMeasurementsListeners.entrySet()) {
                            if (((Identity) entry.getValue()).mPackageName.equals(pkg)) {
                                ...
                                Log.d(str, "gnss measurements listener from package " + ((Identity) entry.getValue()).mPackageName + " is freeze = " + isFreeze);
                                if (isFreeze) {
                                    LocationManagerService.this.mGnssMeasurementsProvider.removeListener((IGnssMeasurementsListener) entry.getKey());
                                } else {
                                    LocationManagerService.this.mGnssMeasurementsProvider.addListener((IGnssMeasurementsListener) entry.getKey());
                                }
                            }
                        }
                    }
                ...
                if (allow) {
                    for (UpdateRecord updateRecord : this.mUpdateRecords.values()) {
                        if (LocationManagerService.this.isAllowedByCurrentUserSettingsLocked(updateRecord.mProvider)) {
                            ...
                            if (properties != null && properties.mPowerRequirement == 3 && updateRecord.mRealRequest.getInterval() < 300000) {
            ...
            if (this.mListener != null) {
                try {
                    synchronized (this) {
                        ...
                        Log.i("LocationManagerService", "key of receiver: " + Integer.toHexString(System.identityHashCode(this)) + " mPendingBroadcasts=" + this.mPendingBroadcasts);
    ...
    private void loadProvidersLocked() {
        ...
        LocationProviderProxy networkProvider = HwServiceFactory.locationProviderProxyCreateAndBind(this.mContext, "network", NETWORK_LOCATION_SERVICE_ACTION, 17956962, 17039809, 17236013, this.mLocationHandler);
        ...
        LocationProviderProxy fusedLocationProvider = LocationProviderProxy.createAndBind(this.mContext, "fused", FUSED_LOCATION_SERVICE_ACTION, 17956953, 17039788, 17236013, this.mLocationHandler);
        ...
        this.mGeocodeProvider = HwServiceFactory.geocoderProxyCreateAndBind(this.mContext, 17956954, 17039789, 17236013, this.mLocationHandler);
        ...
        if (FlpHardwareProvider.isSupported()) {
            ...
            if (FusedProxy.createAndBind(this.mContext, this.mLocationHandler, flpHardwareProvider.getLocationHardware(), 17956957, 17039791, 17236013) == null) {
        ...
        if (GeofenceProxy.createAndBind(context, 17956955, 17039790, 17236013, handler, iGpsGeofenceHardware, geofenceHardware) == null) {
        ...
        if (ActivityRecognitionProxy.createAndBind(this.mContext, this.mLocationHandler, activityRecognitionHardwareIsSupported, activityRecognitionHardware, 17956943, 17039753, 17236013) == null) {
            Slog.d("LocationManagerService", "Unable to bind ActivityRecognitionProxy.");
        }
        for (String split : resources.getStringArray(17236034)) {
    ...
    private void requestLocationUpdatesLocked(LocationRequest request, Receiver receiver, int pid, int uid, String packageName) {
        ...
        this.mHwLocationGpsLogServices.updateApkName(name, Integer.toHexString(System.identityHashCode(receiver)), packageName, APKSTART, String.valueOf(System.currentTimeMillis()));
        ...
        if (isAllowedByUserSettingsLocked(name, uid)) {
            ...
            this.mHwLocationGpsLogServices.LocationSettingsOffErr(name);
    ...
    private void removeUpdatesLocked(Receiver receiver) {
        ...
        String apkStopTime = String.valueOf(System.currentTimeMillis());
        this.mHwLocationGpsLogServices.updateApkName("APKSTOPPROVIDER", hashCode, "", APKSTOP, apkStopTime);
            ...
            if (this.mBlacklist.isBlacklisted(packageName)) {
                ...
                synchronized (this.mLock) {
                    ...
                    if (((LocationProviderInterface) this.mProvidersByName.get(name)) == null) {
                        Binder.restoreCallingIdentity(identity);
                        return null;
                    } else if (isAllowedByUserSettingsLocked(name, uid) || (isExceptionAppForUserSettingsLocked(packageName) ^ 1) == 0) {
                        Location location;
                        if (allowedResolutionLevel < 2) {
        ...
        synchronized (this.mLock) {
            ...
            try {
                if ((isThrottlingExemptLocked(callerIdentity) || isImportanceForeground(this.mActivityManager.getPackageImportance(packageName))) && !isFreeze(packageName)) {
                    Log.i("LocationManagerService", "addGnssMeasurementsListener " + Integer.toHexString(System.identityHashCode(listener)) + " packageName " + packageName);
    ...
    public void removeGnssMeasurementsListener(IGnssMeasurementsListener listener) {
        if (this.mGnssMeasurementsProvider != null) {
            Log.i("LocationManagerService", "removeGnssMeasurementsListener " + Integer.toHexString(System.identityHashCode(listener)));
            synchronized (this.mLock) {
