...
public class WifiAwareRttStateManager {
    ...
    private class AwareRttHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 69632:
                    if (msg.arg1 == 0) {
                        WifiAwareRttStateManager.this.mAsyncChannel.sendMessage(69633, new RttClient(WifiAwareRttStateManager.this.mContext.getPackageName()));
                    } else {
    ...
    public void startWithRttService(Context context, Looper looper, IRttManager service) {
        try {
            Messenger messenger = service.getMessenger(null, new int[1]);
