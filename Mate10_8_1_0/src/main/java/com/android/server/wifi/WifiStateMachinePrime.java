    ...
    private class ModeStateMachine extends StateMachine {
        ...
        class SoftAPModeActiveState extends ModeActiveState {
            ...
            public void enter() {
                ...
                this.mActiveModeManager = WifiStateMachinePrime.this.mWifiInjector.makeSoftApManager(WifiStateMachinePrime.this.mNMService, new SoftApListener(), ((SoftAPModeState) ModeStateMachine.this.mSoftAPModeState).getInterface(), config);
