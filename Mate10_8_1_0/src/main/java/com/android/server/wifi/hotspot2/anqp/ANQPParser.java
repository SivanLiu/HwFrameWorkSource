...
public class ANQPParser {
    ...
    private static /* synthetic */ int[] -getcom-android-server-wifi-hotspot2-anqp-Constants$ANQPElementTypeSwitchesValues() {
        ...
        try {
            iArr[ANQPElementType.HSIconFile.ordinal()] = 13;
        } catch (NoSuchFieldError e11) {
        }
        try {
            iArr[ANQPElementType.HSIconRequest.ordinal()] = 14;
        } catch (NoSuchFieldError e12) {
        }
        try {
            iArr[ANQPElementType.HSNAIHomeRealmQuery.ordinal()] = 15;
        ...
        try {
            iArr[ANQPElementType.HSQueryList.ordinal()] = 16;
