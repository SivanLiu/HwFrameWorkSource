...
public class WiFiProScoreInfo implements Comparable {
    ...
    public static int calculateWiFiScore(WiFiProScoreInfo properties) {
        ...
        int newSignalLevel = HwFrameworkFactory.getHwInnerWifiManager().calculateSignalLevelHW(properties.is5GHz ? 5180 : WifiScanGenieController.CHANNEL_1_FREQ, properties.rssi);
        int boost_5G = 0;
