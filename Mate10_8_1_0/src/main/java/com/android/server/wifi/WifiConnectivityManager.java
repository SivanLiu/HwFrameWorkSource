...
public class WifiConnectivityManager extends AbsWifiConnectivityManager {
    ...
    private static final int LOW_RSSI_NETWORK_RETRY_MAX_DELAY_EX_MS = 300000;
    ...
    private class PnoScanListener implements android.net.wifi.WifiScanner.PnoScanListener {
        ...
        public void onFailure(int reason, String description) {
            ...
            int -get9 = wifiConnectivityManager.mScanRestartCount;
            wifiConnectivityManager.mScanRestartCount = -get9 + 1;
            if (-get9 < 5) {
        ...
        public void onPnoNetworkFound(ScanResult[] results) {
            ...
            if (wasConnectAttempted) {
                ...
                WifiConnectivityManager wifiConnectivityManager = WifiConnectivityManager.this;
                -get6 = wifiConnectivityManager.mPnoScanRestartCount;
                wifiConnectivityManager.mPnoScanRestartCount = -get6 + 1;
                if (-get6 < 2) {
                    ...
                    WifiConnectivityManager.this.mAlarmManager.set(3, WifiConnectivityManager.this.mClock.getElapsedSinceBootMillis() + 300000, WifiConnectivityManager.RESTART_CONNECTIVITY_SCAN_TIMER_TAG, WifiConnectivityManager.this.mRestartScanListener, WifiConnectivityManager.this.mEventHandler);
                    Log.d(WifiConnectivityManager.TAG, "PnoScanRestartCount over allowed, retry delay time : 300000");
                }
    ...
    private class SingleScanListener implements ScanListener {
        ...
        public void onFailure(int reason, String description) {
            ...
            WifiConnectivityManager wifiConnectivityManager = WifiConnectivityManager.this;
            int -get12 = wifiConnectivityManager.mSingleScanRestartCount;
            wifiConnectivityManager.mSingleScanRestartCount = -get12 + 1;
            if (-get12 < 5) {
    ...
    static {
        boolean equals;
        if (SystemProperties.get("ro.config.hw_opta", HwWifiCHRStateManager.TYPE_AP_VENDOR).equals("389")) {
            equals = SystemProperties.get("ro.config.hw_optb", HwWifiCHRStateManager.TYPE_AP_VENDOR).equals("840");
        } else {
            equals = false;
        }
        R1 = equals;
    ...
    WifiConnectivityManager(Context context, WifiStateMachine stateMachine, WifiScanner scanner, WifiConfigManager configManager, WifiInfo wifiInfo, WifiNetworkSelector networkSelector, WifiConnectivityHelper connectivityHelper, WifiLastResortWatchdog wifiLastResortWatchdog, OpenNetworkNotifier openNetworkNotifier, WifiMetrics wifiMetrics, Looper looper, Clock clock, LocalLog localLog, boolean enable, FrameworkFacade frameworkFacade, SavedNetworkEvaluator savedNetworkEvaluator, ScoredNetworkEvaluator scoredNetworkEvaluator, PasspointNetworkEvaluator passpointNetworkEvaluator) {
        ...
        if (R1) {
            this.mWifiNetworkNotifier = new WifiNetworkNotifier(context, looper, frameworkFacade);
        }
        ...
        this.mMin5GHzRssi = context.getResources().getInteger(17694904);
        this.mMin24GHzRssi = context.getResources().getInteger(17694903);
        this.mBand5GHzBonus = context.getResources().getInteger(17694872);
        this.mCurrentConnectionBonus = context.getResources().getInteger(17694889);
        this.mSameNetworkBonus = context.getResources().getInteger(17694879);
        this.mSecureBonus = context.getResources().getInteger(17694880);
        int thresholdSaturatedRssi24 = context.getResources().getInteger(17694907);
        this.mEnableAutoJoinWhenAssociated = context.getResources().getBoolean(17957071);
        this.mInitialScoreMax = (context.getResources().getInteger(17694907) + context.getResources().getInteger(17694877)) * context.getResources().getInteger(17694878);
        this.mFullScanMaxTxRate = context.getResources().getInteger(17694892);
        this.mFullScanMaxRxRate = context.getResources().getInteger(17694891);
    ...
    private void startScan(boolean isFullBandScan, WorkSource workSource) {
        ...
        scanSettings.hiddenNetworks = (HiddenNetwork[]) hiddenNetworkList.toArray(new HiddenNetwork[hiddenNetworkList.size()]);
        ...
        this.mScanner.startScan(scanSettings, singleScanListener, workSource);
    }
