...
public class WifiAwareServiceImpl extends Stub {
    ...
    public void start(HandlerThread handlerThread, WifiAwareStateManager awareStateManager, WifiAwareShellCommand awareShellCommand, WifiAwareMetrics awareMetrics, WifiPermissionsWrapper permissionsWrapper) {
        Log.i(TAG, "Starting Wi-Fi Aware service");
        this.mStateManager = awareStateManager;
        this.mShellCommand = awareShellCommand;
        this.mStateManager.start(this.mContext, handlerThread.getLooper(), awareMetrics, permissionsWrapper);
    }
