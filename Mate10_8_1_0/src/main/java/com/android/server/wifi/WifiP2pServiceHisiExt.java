...
public class WifiP2pServiceHisiExt {
    ...
    public void showP2pEanbleDialog() {
        if (this.mHiSiWifiComm.getSettingsGlobalIntValue("show_p2p_dialog_flag") == 1) {
            ...
            AlertDialog dialog = new Builder(this.mContext, 33947691).setCancelable(false).setTitle(r.getString(17041275)).setMessage(r.getString(17041286)).setView(checkBox).setNegativeButton(r.getString(17039360), new OnClickListener() {
