...
public class HwWifiP2pService extends WifiP2pServiceImpl {
    ...
    private boolean checkP2pDataTrafficLine() {
        ...
        Slog.d(TAG, " txBytes:" + txBytes + " rxBytes:" + rxBytes + " txSpeed:" + txSpeed + " rxSpeed:" + rxSpeed + " mLowDataTrafficLine:" + 204800 + " DELAY_IDLE_MS:" + DELAY_IDLE_MS);
    ...
    protected boolean startWifiRepeater(WifiP2pGroup group) {
        ...
        if (hwWifiCHRStateManagerImpl != null) {
            hwWifiCHRStateManagerImpl.updateRepeaterOpenOrCloseError(127, 1, "REPEATER_OPEN_OR_CLOSE_FAILED_UNKNOWN");
        }
        return false;
    }
    ...
    protected void stopWifiRepeater(WifiP2pGroup group) {
        ...
        if (this.mIsWifiRepeaterTetherStarted) {
            ...
            if (hwWifiCHRStateManagerImpl != null) {
                hwWifiCHRStateManagerImpl.updateRepeaterOpenOrCloseError(127, 0, "REPEATER_OPEN_OR_CLOSE_FAILED_UNKNOWN");
                return;
            }
            return;
        }
