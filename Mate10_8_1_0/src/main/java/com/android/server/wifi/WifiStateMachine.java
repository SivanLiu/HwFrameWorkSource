...
public class WifiStateMachine extends AbsWifiStateMachine implements WifiRssiEventHandler, FilterController {
    ...
    private static final long DEBOUNCE_AP_KICK_OFF_INTERVAL = 60000;
    private static final long DEBOUNCE_AP_KICK_OFF_RESET = 900000;
    private static final long DEBOUNCE_CONNECTION_DURATION = 30000;
    private static final int DEBOUNCE_MAX_AP_KICK_OFF_TIMES = 5;
    ...
    private static final int LINK_FLAPPING_DEBOUNCE_MSEC_SHORT = 2000;
    ...
    private boolean mApKickOff = false;
    private int mApKickOffFrequentlyCounter = 0;
    ...
    private long mLastApKickOffTimestamp = -60000;
    ...
    class ConnectModeState extends State {
        ...
        public boolean processMessage(Message message) {
            ...
            WifiConnectionStatistics -get90;
            ...
            switch (message.what) {
                ...
                case WifiStateMachine.CMD_START_CONNECT /*131215*/:
                    if (!WifiStateMachine.this.isHiLinkActive()) {
                        ...
                        bssid = bundle.getString(WifiStateMachine.BSSID_TO_CONNECT);
                        synchronized (WifiStateMachine.this.mWifiReqCountLock) {
                            if (!WifiStateMachine.this.hasConnectionRequests()) {
                                ...
                                } else if (!connectFromUser) {
                                    if ((WifiStateMachine.this.mWifiPermissionsUtil.checkNetworkSettingsPermission(uid) ^ 1) != 0) {
                ...
                case WifiMonitor.EAP_ERRORCODE_REPORT_EVENT /*147956*/:
                    if (WifiStateMachine.this.targetWificonfiguration != null && WifiStateMachine.this.targetWificonfiguration.networkId == WifiStateMachine.this.lookupFrameworkNetworkId(message.arg1)) {
                        WifiStateMachine.this.handleEapErrorcodeReport(message.arg1, (String) message.obj, message.arg2);
                        break;
                    }
                case 151553:
                    netId = message.arg1;
                    config = (WifiConfiguration) message.obj;
                    -get90 = WifiStateMachine.this.mWifiConnectionStatistics;
                    -get90.numWifiManagerJoinAttempt++;
                    String strConfigCRC = "*";
                    boolean z = false;
                ...
                case 151559:
                    ...
                    if (result.isSuccess() && WifiStateMachine.this.mWifiInfo.getNetworkId() == netId) {
                        ...
                        WifiStateMachine.this.logi("SAVE_NETWORK credential changed for config=" + ((WifiConfiguration) message.obj).configKey() + ", Reconnecting.");
    ...
    class ConnectedState extends State {
        ...
        public void enter() {
            ...
            WifiStateMachine.this.mIsAutoRoaming = false;
            WifiStateMachine.this.mLastConnectedTimestamp = WifiStateMachine.this.mClock.getElapsedSinceBootMillis();
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case WifiMonitor.NETWORK_DISCONNECTION_EVENT /*147460*/:
                    ...
                    long lastConnectionDuration = WifiStateMachine.this.mClock.getElapsedSinceBootMillis() - WifiStateMachine.this.mLastConnectedTimestamp;
                    WifiStateMachine wifiStateMachine = WifiStateMachine.this;
                    boolean z = (!WifiStateMachine.this.kickedOffReasonByAp(message.arg2) || WifiStateMachine.this.mWifiInfo.getSupplicantState() != SupplicantState.COMPLETED || config == null || (config.noInternetAccess ^ 1) == 0 || lastConnectionDuration <= WifiStateMachine.DEBOUNCE_CONNECTION_DURATION) ? false : lastRoam == 0 || lastRoam > WifiStateMachine.DEBOUNCE_CONNECTION_DURATION;
                    wifiStateMachine.mApKickOff = z;
                    if (WifiStateMachine.this.mApKickOff) {
                        WifiStateMachine.this.mApKickOff = WifiStateMachine.this.updateApKickOffStatus();
                    }
                    if (!WifiStateMachine.this.mEnableLinkDebouncing || ((!WifiStateMachine.this.mScreenOn && !WifiStateMachine.this.isWifiRepeaterStarted()) || (WifiStateMachine.this.isLinkDebouncing() ^ 1) == 0 || config == null || !config.getNetworkSelectionStatus().isNetworkEnabled() || ((config.networkId == WifiStateMachine.this.mWifiConfigManager.getLastSelectedNetwork() && !WifiStateMachine.this.mApKickOff) || ((Math.abs(message.arg2) == 3 && (lastRoam <= 0 || lastRoam >= 2000)) || ((!ScanResult.is24GHz(WifiStateMachine.this.mWifiInfo.getFrequency()) || WifiStateMachine.this.mWifiInfo.getRssi() <= WifiStateMachine.this.mThresholdQualifiedRssi5) && (!ScanResult.is5GHz(WifiStateMachine.this.mWifiInfo.getFrequency()) || WifiStateMachine.this.mWifiInfo.getRssi() <= WifiStateMachine.this.mThresholdQualifiedRssi5)))))) {
                        if (WifiStateMachine.this.mVerboseLoggingEnabled) {
                            wifiStateMachine = WifiStateMachine.this;
                    ...
                    WifiStateMachine.this.log("LinkDebounce: config.networkId=" + config.networkId + " LastSelectedId=" + WifiStateMachine.this.mWifiConfigManager.getLastSelectedNetwork() + " mApKickOff=" + WifiStateMachine.this.mApKickOff + " lastConnectionDuration=" + lastConnectionDuration + " lastRoam=" + lastRoam);
                    ...
                    WifiStateMachine.this.sendMessageDelayed(WifiStateMachine.this.obtainMessage(WifiStateMachine.CMD_DELAYED_NETWORK_DISCONNECT, 0, WifiStateMachine.this.mLastNetworkId), (long) (WifiStateMachine.this.mApKickOff ? 2000 : WifiStateMachine.LINK_FLAPPING_DEBOUNCE_MSEC));
                    if (WifiStateMachine.this.mVerboseLoggingEnabled) {
    ...
    class InitialState extends State {
        ...
        public void enter() {
            ...
            if (WifiStateMachine.this.mIsFactoryFirstEnter && !"factory".equals(SystemProperties.get("ro.runmode", "normal"))) {
                WifiStateMachine.this.mIsFactoryFirstEnter = false;
                Log.d(WifiStateMachine.TAG, "not in factory mode");
            }
            if (WifiStateMachine.this.mIsFactoryFirstEnter) {
                WifiStateMachine.this.mIsFactoryFirstEnter = false;
                Log.d(WifiStateMachine.TAG, "factory mode first enter not clean up");
            } else {
                cleanup();
            }
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                case WifiStateMachine.CMD_SET_OPERATIONAL_MODE /*131144*/:
                    ...
                    if (message.arg1 == 1 && WifiStateMachine.this.hasDeferredMessagesForArg1(WifiStateMachine.CMD_SET_OPERATIONAL_MODE, 4)) {
                        WifiStateMachine.this.log("Has deferred DISABLED_MODE, deffer CONNECT_MODE");
                        WifiStateMachine.this.deferMessage(message);
                        break;
                    }
    ...
    class SoftApState extends State {
        ...
        public void enter() {
            ...
            Pair<Integer, IApInterface> statusAndInterface = WifiStateMachine.this.mWifiNative.setupForSoftApMode();
            if (((Integer) statusAndInterface.first).intValue() == 0) {
            ...
            this.mSoftApManager = WifiStateMachine.this.mWifiInjector.makeSoftApManager(WifiStateMachine.this.mNwService, new SoftApListener(), iApInterface, config.getWifiConfiguration());
                    ...
                    if (13 == WifiStateMachine.this.mWifiApState.get()) {
                        ...
                        if (obj != null && obj.length > 0) {
                            for (int i = 0; i < obj.length; i++) {
                                obj[i] = WifiCommonUtils.convertFrequencyToChannelNumber(obj[i]);
                            }
                        }
                    }
            ...
            switch (message.what) {
                ...
                case WifiMonitor.SCAN_FAILED_EVENT /*147473*/:
                    ...
                    if (WifiStateMachine.this.mIsFullScanOngoing || WifiStateMachine.this.mSendScanResultsBroadcast || WifiStateMachine.this.mAllowSendHiLinkScanResultsBroadcast || WifiStateMachine.this.isWifiProEvaluatingAP()) {
                        ...
                        WifiStateMachine.this.notifyWifiScanResultsAvailable(message.what == 147461);
                    }
                    if (WifiStateMachine.NOTIFY_OPEN_NETWORKS_VALUE) {
                        WifiStateMachine.this.sendScanResultsAvailableBroadcast(message.what == 147461);
                    }
...
*/
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiStateMachine_15152() {
    ...
    public WifiStateMachine(Context context, FrameworkFacade facade, Looper looper, UserManager userManager, WifiInjector wifiInjector, BackupManagerProxy backupManagerProxy, WifiCountryCode countryCode, WifiNative wifiNative, WrongPasswordNotifier wrongPasswordNotifier) {
        ...
        this.mNoNetworksPeriodicScan = this.mContext.getResources().getInteger(17694915);
        this.mPrimaryDeviceType = this.mContext.getResources().getString(17039823);
        ...
        this.mContext.getContentResolver().registerContentObserver(Global.getUriFor("wifi_suspend_optimizations_enabled"), false, new ContentObserver(getHandler()) {
            public void onChange(boolean selfChange) {
                boolean z = true;
                AtomicBoolean -get82 = WifiStateMachine.this.mUserWantsSuspendOpt;
        ...
        this.mTcpBufferSizes = this.mContext.getResources().getString(17039825);
        ...
        this.mEnableVoiceCallSarTxPowerLimit = this.mContext.getResources().getBoolean(17957072);
    ...
    public void enableVerboseLogging(int verbose) {
        if (verbose > 0) {
            ...
            setLogRecSize(ActivityManager.isLowRamDeviceStatic() ? 200 : DEFAULT_POLL_RSSI_INTERVAL_MSECS);
        } else {
    ...
    public boolean setRandomMacOui() {
        String oui = this.mContext.getResources().getString(17039824);
    ...
    private boolean connectToUserSelectNetwork(int netId, int uid, boolean forceReconnect) {
        ...
        if (forceReconnect || this.mWifiInfo.getNetworkId() != netId) {
            ...
            if (config.hiddenSSID && TextUtils.isEmpty(config.oriSsid)) {
                Log.d(TAG, "INTERCEPT the connect request since hidden and null oriSsid.");
                if (getCurrentState() == this.mDisconnectedState && (attemptAutoConnect() ^ 1) == 0) {
                    Log.d(TAG, "wifi disconnected, add null ScanListener.");
                    ApConfigUtil.startScanForHiddenNetwork(this.mWifiScanner, null, config);
                } else {
                    Log.d(TAG, "wifi connected, add HiddenScanListener.");
                    ApConfigUtil.startScanForHiddenNetwork(this.mWifiScanner, new HiddenScanListener(config, uid), config);
                }
            } else {
    ...
    private void handleScanRequest(Message message) {
        ...
        if (startScanNative(set, this.mWifiConfigManager.retrieveHiddenNetworkList(), parcelable)) {
            if (set == null) {
    ...
    public WifiInfo syncRequestConnectionInfo(String callingPackage) {
        ...
        try {
            ...
            if (!apiLevel23App || this.mWifiPermissionsUtil.canAccessFullConnectionInfo(currentWifiConfiguration, callingPackage, uid, 26)) {
                hideBssidAndSsid = false;
            }
        } catch (RemoteException e2) {
            Log.e(TAG, "Error checking receiver permission", e2);
        } catch (SecurityException e3) {
            Log.e(TAG, "Security exception checking receiver permission", e3);
        }
        if (hideBssidAndSsid) {
    ...
    private void reportConnectionAttemptStart(WifiConfiguration config, String targetBSSID, int roamType) {
        ...
        sendMessageDelayed(CMD_DIAGS_CONNECT_TIMEOUT, lDiagsConnectionStartMillis, AnqpCache.CACHE_SWEEP_INTERVAL_MILLISECONDS);
    }
    ...
    boolean startScanForConfiguration(WifiConfiguration config) {
        ...
        ScanDetailCache scanDetailCache = this.mWifiConfigManager.getScanDetailCacheForNetwork(config.networkId);
        if (!this.mApKickOff && (scanDetailCache == null || (config.allowedKeyManagement.get(1) ^ 1) != 0 || scanDetailCache.size() > 6)) {
            return true;
        }
        if (scanDetailCache == null) {
            logd("LinkDebounce: scanDetailCache is NULL");
        } else if (scanDetailCache.size() > 6) {
            logd("LinkDebounce: scanDetailCache size is more than 6");
        }
        int homeChannelFreq = this.mWifiInfo.getFrequency();
        Set<Integer> freqs = this.mWifiConfigManager.fetchChannelSetForNetworkForPartialScan(config.networkId, 3600000, homeChannelFreq);
        if (this.mApKickOff && freqs == null && homeChannelFreq > 0) {
            logd("LinkDebounce: freqs are NULL, add current channel" + homeChannelFreq);
            freqs = new HashSet();
            freqs.add(Integer.valueOf(homeChannelFreq));
        }
    ...
    public boolean shouldEvaluateWhetherToSendExplicitlySelected(WifiConfiguration currentConfig) {
        ...
        if (this.mWifiConfigManager.getLastSelectedNetwork() == currentConfig.networkId && currentTimeMillis - this.mWifiConfigManager.getLastSelectedTimeStamp() < DEBOUNCE_CONNECTION_DURATION) {
            z = true;
        }
        return z;
    }
    ...
    private boolean kickedOffReasonByAp(int reason) {
        if (reason == 2 || reason == 6 || reason == 7 || reason == 16) {
            return true;
        }
        return false;
    }

    private boolean updateApKickOffStatus() {
        long currentTime = this.mClock.getElapsedSinceBootMillis();
        if (currentTime - this.mLastApKickOffTimestamp < AnqpCache.CACHE_SWEEP_INTERVAL_MILLISECONDS) {
            this.mApKickOffFrequentlyCounter++;
            Log.d(TAG, "LinkDebounce: This is the " + this.mApKickOffFrequentlyCounter + "time we kicked off by ap in 1 minute.");
        } else if (currentTime - this.mLastApKickOffTimestamp > DEBOUNCE_AP_KICK_OFF_RESET) {
            this.mApKickOffFrequentlyCounter = 0;
            Log.d(TAG, "LinkDebounce: Ap doesn't kick us off more than 15 minutes, reset the counter.");
        }
        this.mLastApKickOffTimestamp = currentTime;
        if (this.mApKickOffFrequentlyCounter < 5) {
            return true;
        }
        return false;
    }
