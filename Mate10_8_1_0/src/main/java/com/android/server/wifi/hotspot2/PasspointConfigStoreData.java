    ...
    private PasspointProvider deserializeProvider(XmlPullParser in, int outerTagDepth) throws XmlPullParserException, IOException {
        ...
        while (XmlUtils.nextElementWithin(in, outerTagDepth)) {
            if (in.getAttributeValue(null, "name") != null) {
                ...
                } else if (str.equals("HasEverConnected")) {
                ...
                passpointConfiguration = PasspointXmlUtils.deserializePasspointConfiguration(in, outerTagDepth + 1);
            } else {
        ...
        if (providerId == Long.MIN_VALUE) {
            ...
            return new PasspointProvider(passpointConfiguration, this.mKeyStore, this.mSimAccessor, providerId, creatorUid, caCertificateAlias, clientCertificateAlias, clientPrivateKeyAlias, hasEverConnected);
        } else {
