...
public class WifiVendorHal {
    ...
    private static final int[][] sStaFeatureCapabilityTranslation = new int[][]{new int[]{2, 128}, new int[]{4, 256}, new int[]{32, 2}, new int[]{1024, 512}, new int[]{4096, 1024}, new int[]{8192, StaIfaceCapabilityMask.TDLS_OFFCHANNEL}, new int[]{65536, 4}, new int[]{524288, 8}, new int[]{1048576, 8192}, new int[]{2097152, 4096}, new int[]{8388608, 16}, new int[]{16777216, 32}, new int[]{33554432, 64}};
    ...
    private class ChipEventCallback extends Stub {
        ...
        public void onDebugRingBufferDataAvailable(WifiDebugRingBufferStatus status, ArrayList<Byte> data) {
            WifiVendorHal.this.mHalEventHandler.post(new AnonymousClass17(this, status, data));
        }

        /* JADX WARNING: inconsistent code. */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal$ChipEventCallback_100661(WifiDebugRingBufferStatus status, ArrayList data) {
        ...
        public void onDebugErrorAlert(int errorCode, ArrayList<Byte> debugData) {
            ...
            WifiVendorHal.this.mHalEventHandler.post(new -$Lambda$ajG-TMshB5D_BrXpSiGRWlXJ7-M((byte) 1, errorCode, this, debugData));
        }

        /* JADX WARNING: inconsistent code. */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal$ChipEventCallback_102324(ArrayList debugData, int errorCode) {
            synchronized (WifiVendorHal.sLock) {
    ...
    public boolean getBgScanCapabilities(ScanCapabilities capabilities) {
        synchronized (sLock) {
            ...
            try {
                ...
                this.mIWifiStaIface.getBackgroundScanCapabilities(new AnonymousClass13(this, capabilities, ans));
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_16053(ScanCapabilities out, MutableBoolean ans, WifiStatus status, StaBackgroundScanCapabilities cap) {
        if (ok(status)) {
    ...
    public WifiLinkLayerStats getWifiLinkLayerStats() {
        ...
        synchronized (sLock) {
            try {
                ...
                this.mIWifiStaIface.getLinkLayerStats(new AnonymousClass11(this, answer));
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_25616(AnonymousClass1AnswerBox answer, WifiStatus status, StaLinkLayerStats stats) {
        if (ok(status)) {
            answer.value = stats;
        }
    }
    ...
    public int getSupportedFeatureSet() {
        ...
        try {
            ...
            synchronized (sLock) {
                if (this.mIWifiChip != null) {
                    this.mIWifiChip.getCapabilities(new AnonymousClass2(this, feat));
                }
                if (this.mIWifiStaIface != null) {
                    this.mIWifiStaIface.getCapabilities(new AnonymousClass10(this, feat));
                }
            }
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_33409(MutableInt feat, WifiStatus status, int capabilities) {
        if (ok(status)) {
            feat.value = wifiFeatureMaskFromChipCapabilities(capabilities);
        }
    }

    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_33713(MutableInt feat, WifiStatus status, int capabilities) {
        if (ok(status)) {
    ...
    public RttCapabilities getRttCapabilities() {
        synchronized (sLock) {
            ...
            try {
                ...
                this.mIWifiRttController.getCapabilities(new AnonymousClass7(this, box));
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_35205(AnonymousClass2AnswerBox box, WifiStatus status, android.hardware.wifi.V1_0.RttCapabilities capabilities) {
        if (ok(status)) {
    ...
    private RttResponder getRttResponder() {
        synchronized (sLock) {
            ...
            try {
                this.mIWifiRttController.getResponderInfo(new AnonymousClass8(this, answer));
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_51587(AnonymousClass3AnswerBox answer, WifiStatus status, RttResponder info) {
        if (ok(status)) {
            answer.value = info;
        }
    }
            ...
            if (this.mIWifiRttController == null) {
                ...
                try {
                    if (ok(this.mIWifiRttController.enableResponder(id, null, timeoutSeconds, info))) {
                        ...
                        responderConfig = frameworkResponderConfigFromHalRttResponder(info);
    ...
    public int[] getChannelsForBand(int band) {
        ...
        synchronized (sLock) {
            try {
                ...
                if (this.mIWifiStaIface != null) {
                    this.mIWifiStaIface.getValidFrequenciesForBand(hb, new AnonymousClass12(this, box));
                } else if (this.mIWifiApIface != null) {
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_56341(AnonymousClass4AnswerBox box, WifiStatus status, ArrayList frequencies) {
        if (status.code == 4) {
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_56854(AnonymousClass4AnswerBox box, WifiStatus status, ArrayList frequencies) {
        if (status.code == 4) {
            this.mChannelsForBandSupport = Boolean.valueOf(false);
        }
        if (ok(status)) {
    ...
    public ApfCapabilities getApfCapabilities() {
        synchronized (sLock) {
            try {
                ...
                this.mIWifiStaIface.getApfPacketFilterCapabilities(new AnonymousClass9(this, box));
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_58864(AnonymousClass5AnswerBox box, WifiStatus status, StaApfPacketFilterCapabilities capabilities) {
        if (ok(status)) {
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_66126(WifiStatus status, ChipDebugInfo chipDebugInfo) {
        if (ok(status)) {
    ...
    public RingBufferStatus[] getRingBufferStatus() {
        ...
        synchronized (sLock) {
            ...
            try {
                this.mIWifiChip.getDebugRingBuffersStatus(new AnonymousClass4(this, ans));
                return ans.value;
            } catch (RemoteException e) {
                handleRemoteException(e);
                return null;
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_69069(AnonymousClass6AnswerBox ans, WifiStatus status, ArrayList ringBuffers) {
        if (ok(status)) {
    ...
    public byte[] getFwMemoryDump() {
        ...
        synchronized (sLock) {
            ...
            try {
                this.mIWifiChip.requestFirmwareDebugDump(new AnonymousClass6(this, ans));
                return ans.value;
            } catch (RemoteException e) {
                handleRemoteException(e);
                return null;
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_70340(AnonymousClass7AnswerBox ans, WifiStatus status, ArrayList blob) {
        if (ok(status)) {
    ...
    public byte[] getDriverStateDump() {
        ...
        synchronized (sLock) {
            ...
            try {
                this.mIWifiChip.requestDriverDebugDump(new AnonymousClass5(this, ans));
                return ans.value;
            } catch (RemoteException e) {
                handleRemoteException(e);
                return null;
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_71034(AnonymousClass8AnswerBox ans, WifiStatus status, ArrayList blob) {
        if (ok(status)) {
            ans.value = NativeUtil.byteArrayFromArrayList(blob);
        }
    }
    ...
    public boolean getTxPktFates(TxFateReport[] reportBufs) {
        ...
        synchronized (sLock) {
            ...
            try {
                ...
                this.mIWifiStaIface.getDebugTxPacketFates(new AnonymousClass15(this, reportBufs, ok));
                boolResult = ok.value;
                return boolResult;
            } catch (RemoteException e) {
                handleRemoteException(e);
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_75901(TxFateReport[] reportBufs, MutableBoolean ok, WifiStatus status, ArrayList fates) {
        if (ok(status)) {
            int i = 0;
    ...
    public boolean getRxPktFates(RxFateReport[] reportBufs) {
        ...
        synchronized (sLock) {
            ...
            try {
                MutableBoolean ok = new MutableBoolean(false);
                this.mIWifiStaIface.getDebugRxPacketFates(new AnonymousClass14(this, reportBufs, ok));
                boolResult = ok.value;
                return boolResult;
            } catch (RemoteException e) {
                handleRemoteException(e);
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_77688(RxFateReport[] reportBufs, MutableBoolean ok, WifiStatus status, ArrayList fates) {
        if (ok(status)) {
            int i = 0;
    ...
    public WifiWakeReasonAndCounts getWlanWakeReasonCount() {
        ...
        synchronized (sLock) {
            ...
            try {
                this.mIWifiChip.getDebugHostWakeReasonStats(new AnonymousClass3(this, ans));
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_85129(AnonymousClass9AnswerBox ans, WifiStatus status, WifiDebugHostWakeReasonStats stats) {
        if (ok(status)) {
            ans.value = stats;
        }
    }
    ...
    public boolean getRoamingCapabilities(RoamingCapabilities capabilities) {
        synchronized (sLock) {
            ...
            try {
                ...
                this.mIWifiStaIface.getRoamingCapabilities(new AnonymousClass16(this, capabilities, ok));
                boolResult = ok.value;
                return boolResult;
            } catch (RemoteException e) {
                handleRemoteException(e);
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_WifiVendorHal_86756(RoamingCapabilities out, MutableBoolean ok, WifiStatus status, StaRoamingCapabilities cap) {
        if (ok(status)) {
