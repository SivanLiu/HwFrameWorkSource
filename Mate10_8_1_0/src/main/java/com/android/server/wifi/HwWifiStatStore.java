...
public interface HwWifiStatStore {
    ...
    public static final int HW_WIFI_HIGH_PERFORMANCE = 2;
    public static final int HW_WIFI_LOW_POWER = 1;
    public static final int HW_WIFI_NORMAL = 0;
    ...
    void updateMSSAntstate(String str);
