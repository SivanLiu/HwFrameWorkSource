...
public class HalDeviceManager {
    ...
    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_13579(Mutable nameResp, WifiStatus status, String name) {
        if (status.code == 0) {
            nameResp.value = name;
        } else {
    ...
    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_16055(Mutable rttResp, WifiStatus status, IWifiRttController rtt) {
        if (status.code == 0) {
            rttResp.value = rtt;
        } else {
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_20938(long cookie) {
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_24266(long cookie) {
    ...
    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_27133(MutableBoolean statusOk, Mutable chipIdsResp, WifiStatus status, ArrayList chipIds) {
        boolean z = false;
        if (status.code == 0) {
            z = true;
        }
    ...
    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_28048(MutableBoolean statusOk, Mutable chipResp, WifiStatus status, IWifiChip chip) {
        boolean z = false;
        if (status.code == 0) {
            z = true;
        }
    ...
    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_32182(MutableBoolean statusOk, Mutable chipIdsResp, WifiStatus status, ArrayList chipIds) {
        boolean z = false;
        if (status.code == 0) {
            z = true;
        }
    ...
    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_33181(MutableBoolean statusOk, Mutable chipResp, WifiStatus status, IWifiChip chip) {
        boolean z = false;
        if (status.code == 0) {
            z = true;
        }
    ...
    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_33847(MutableBoolean statusOk, Mutable availableModesResp, WifiStatus status, ArrayList modes) {
        boolean z = false;
        if (status.code == 0) {
            z = true;
        }
    ...
    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_34628(MutableBoolean statusOk, MutableBoolean currentModeValidResp, MutableInt currentModeResp, WifiStatus status, int modeId) {
        boolean z = false;
        if (status.code == 0) {
            z = true;
        }
    ...
    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_35566(MutableBoolean statusOk, Mutable ifaceNamesResp, WifiStatus status, ArrayList ifnames) {
        boolean z = false;
        if (status.code == 0) {
            z = true;
        }
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_36395(MutableBoolean statusOk, String ifaceName, WifiIfaceInfo[] staIfaces, MutableInt ifaceIndex, WifiStatus status, IWifiStaIface iface) {
        boolean z = false;
        if (status.code == 0) {
            z = true;
        }
    ...
    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_37371(MutableBoolean statusOk, Mutable ifaceNamesResp, WifiStatus status, ArrayList ifnames) {
        boolean z = false;
        if (status.code == 0) {
            z = true;
        }
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_38197(MutableBoolean statusOk, String ifaceName, WifiIfaceInfo[] apIfaces, MutableInt ifaceIndex, WifiStatus status, IWifiApIface iface) {
        boolean z = false;
        if (status.code == 0) {
            z = true;
        }
    ...
    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_39171(MutableBoolean statusOk, Mutable ifaceNamesResp, WifiStatus status, ArrayList ifnames) {
        boolean z = false;
        if (status.code == 0) {
            z = true;
        }
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_40000(MutableBoolean statusOk, String ifaceName, WifiIfaceInfo[] p2pIfaces, MutableInt ifaceIndex, WifiStatus status, IWifiP2pIface iface) {
        boolean z = false;
        if (status.code == 0) {
            z = true;
        }
    ...
    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_40977(MutableBoolean statusOk, Mutable ifaceNamesResp, WifiStatus status, ArrayList ifnames) {
        boolean z = false;
        if (status.code == 0) {
            z = true;
        }
    ...
    /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_41806(MutableBoolean statusOk, String ifaceName, WifiIfaceInfo[] nanIfaces, MutableInt ifaceIndex, WifiStatus status, IWifiNanIface iface) {
        boolean z = false;
        if (status.code == 0) {
            z = true;
        }
    ...
    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_51821(MutableInt chipIdIfProvided, MutableBoolean statusOk, WifiStatus status, int id) {
        if (status.code == 0) {
    ...
    private IfaceCreationData canIfaceComboSupportRequest(WifiChipInfo chipInfo, ChipMode chipMode, int[] chipIfaceCombo, int ifaceType) {
        ...
        ifaceCreationData = new IfaceCreationData();
        ifaceCreationData.chipInfo = chipInfo;
        ifaceCreationData.chipModeId = chipMode.id;
    ...
    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_69779(Mutable statusResp, Mutable ifaceResp, WifiStatus status, IWifiStaIface iface) {
        statusResp.value = status;
        ifaceResp.value = iface;
    }

    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_70158(Mutable statusResp, Mutable ifaceResp, WifiStatus status, IWifiApIface iface) {
        statusResp.value = status;
        ifaceResp.value = iface;
    }

    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_70538(Mutable statusResp, Mutable ifaceResp, WifiStatus status, IWifiP2pIface iface) {
        statusResp.value = status;
        ifaceResp.value = iface;
    }

    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_70919(Mutable statusResp, Mutable ifaceResp, WifiStatus status, IWifiNanIface iface) {
        statusResp.value = status;
        ifaceResp.value = iface;
    }
    ...
    static /* synthetic */ void lambda$-com_android_server_wifi_HalDeviceManager_80272(MutableInt typeResp, WifiStatus status, int type) {
        if (status.code == 0) {
            typeResp.value = type;
        } else {
