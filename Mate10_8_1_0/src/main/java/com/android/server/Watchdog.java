...
public class Watchdog extends Thread {
    static final /* synthetic */ boolean -assertionsDisabled = (Watchdog.class.desiredAssertionStatus() ^ 1);
    ...
    public void run() {
        ...
        while (true) {
            ...
            synchronized (this) {
                ...
                if (fdLimitTriggered) {
                    ...
                    if (waitState == 0) {
                        ...
                        if (waitState != 2) {
                            ...
                            ActivityManagerService.dumpStackTraces(true, (ArrayList) pids, null, null, getInterestingNativePids());
                            waitedHalf = true;
                            if (this.mIpcChecker != null) {
                ...
                File stack = ActivityManagerService.dumpStackTraces(waitedHalf ^ 1, (ArrayList) pids, null, null, getInterestingNativePids());
                ...
                synchronized (this) {
                    IActivityController controller = this.mController;
                }
                if (controller != null) {
    ...
    private void writeHungtask(String cmd) {
        ...
        try {
            OutputStreamWriter fw = new OutputStreamWriter(new FileOutputStream(HUNGTASK_FILE), "UTF-8");
            try {
                fw.write(cmd);
            ...
            e222 = e4;
            Slog.e(TAG, "Failed to write to /sys/kernel/hungtask/vm_heart", e222);
            if (outputStreamWriter != null) {
                outputStreamWriter.close();
            }
        }
