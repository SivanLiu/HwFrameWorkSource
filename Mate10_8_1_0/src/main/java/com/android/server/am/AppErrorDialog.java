...
final class AppErrorDialog extends BaseErrorDialog implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView restart = (TextView) findViewById(16908705);
        ...
        TextView close = (TextView) findViewById(16908702);
        if (this.mRepeating) {
            i = 0;
        } else {
            i = 8;
        ...
        boolean showMute = (Build.IS_USER || Global.getInt(context.getContentResolver(), "development_settings_enabled", 0) == 0) ? false : true;
        TextView mute = (TextView) findViewById(16908703);
