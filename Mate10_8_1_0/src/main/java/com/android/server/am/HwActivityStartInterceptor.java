...
public final class HwActivityStartInterceptor extends ActivityStartInterceptor {
    ...
    public boolean interceptStartActivityIfNeed(Intent intent) {
        ...
        if (!"com.huawei.android.launcher".equals(this.mCallingPackage) && (this.mIntent.getHwFlags() & 4096) == 0) {
            if (!(this.mService.getFocusedStack() == null || this.mService.getFocusedStack().mResumedActivity == null || !"com.huawei.android.launcher".equals(this.mService.getFocusedStack().mResumedActivity.packageName))) {
            }
