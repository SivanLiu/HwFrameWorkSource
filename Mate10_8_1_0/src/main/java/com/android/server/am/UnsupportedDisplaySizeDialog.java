...
public class UnsupportedDisplaySizeDialog {
    ...
    public UnsupportedDisplaySizeDialog(ActivityManagerService service, Context context, ApplicationInfo appInfo) {
        ...
        this.mDialog = new Builder(context).setPositiveButton(17039370, null).setMessage(context.getString(17041155, new Object[]{appInfo.loadSafeLabel(context.getPackageManager())})).setView(17367309).create();
        this.mDialog.create();
        Window window = this.mDialog.getWindow();
        window.setType(2002);
        window.getAttributes().setTitle("UnsupportedDisplaySizeDialog");
        CheckBox alwaysShow = (CheckBox) this.mDialog.findViewById(16908730);
