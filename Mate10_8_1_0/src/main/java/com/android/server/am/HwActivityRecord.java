...
public class HwActivityRecord extends ActivityRecord {
    ...
    void scheduleMultiWindowModeChanged(Configuration overrideConfig) {
        ...
        if (this.task != null) {
            this.service.onMultiWindowModeChanged(this.mLastReportedMultiWindowMode);
        }
    }
    ...
    void setRequestedOrientation(int requestedOrientation) {
        ...
        if (this.task != null && HwPCUtils.isExtDynamicStack(this.task.getStackId()) && this.task.getTopActivity() == this && (this.service instanceof HwActivityManagerService)) {
