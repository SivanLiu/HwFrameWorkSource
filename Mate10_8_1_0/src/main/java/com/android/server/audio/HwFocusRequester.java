...
public class HwFocusRequester extends FocusRequester {
    ...
    public HwFocusRequester(AudioAttributes aa, int focusRequest, int grantFlags, IAudioFocusDispatcher afl, IBinder source, String id, AudioFocusDeathHandler hdlr, String pn, int uid, MediaFocusControl ctlr, int sdk, boolean isInExternal) {
        super(aa, focusRequest, grantFlags, afl, source, id, hdlr, pn, uid, ctlr, sdk);
        this.mIsInExternal = isInExternal;
    }

    public HwFocusRequester(AudioFocusInfo afi, IAudioFocusDispatcher afl, IBinder source, AudioFocusDeathHandler hdlr, MediaFocusControl ctlr, boolean isInExternal) {
