...
public class GestureBackMetaball implements GLModel {
    ...
    private final float[] mRectData = new float[]{-1.0f, 1.0f, 1.0f, 1.0f, -1.0f, -1.0f, 1.0f, -1.0f};
    ...
    public void prepare() {
        ...
        this.mAttrVertexLoc = GLES20.glGetAttribLocation(this.mProgram, "a_Position");
        this.mEnergyRLoc = GLES20.glGetUniformLocation(this.mProgram, "energyR");
        this.mWallOffsetLoc = GLES20.glGetUniformLocation(this.mProgram, "wallOffset");
        this.mEnergyThresholdLoc = GLES20.glGetUniformLocation(this.mProgram, "energyThreshold");
        this.mBallCenterMaxDisLoc = GLES20.glGetUniformLocation(this.mProgram, "ballCenterMaxDis");
        this.mProcessOffsetLoc = GLES20.glGetUniformLocation(this.mProgram, "processOffset");
        this.mAntiAliasingDeltaLoc = GLES20.glGetUniformLocation(this.mProgram, "uAntiAliasingDelta");
        this.mIsLeftLoc = GLES20.glGetUniformLocation(this.mProgram, "isLeft");
        this.mAnimProcessLoc = GLES20.glGetUniformLocation(this.mProgram, "animProcess");
        this.mBallCenterYLoc = GLES20.glGetUniformLocation(this.mProgram, "uBallCenterY");
        this.mHWRatioLoc = GLES20.glGetUniformLocation(this.mProgram, "uHWRatio");
    }
    ...
    public void drawSelf() {
        if (this.mDraw) {
            ...
            if (this.mWidth < this.mHeight) {
                ...
                GLES20.glViewport(0, 0, this.mHeight, this.mHeight);
                hwRatio = 1.0f;
            } else {
                GLES20.glViewport(this.mWidth - this.mHeight, 0, this.mHeight, this.mHeight);
                hwRatio = 1.0f;
            }
            GLES20.glUseProgram(this.mProgram);
            GLES20.glUniform1f(this.mEnergyRLoc, this.mEnergyR);
            GLES20.glUniform1f(this.mWallOffsetLoc, this.mWallOffset);
            GLES20.glUniform1f(this.mEnergyThresholdLoc, this.mEnergyThreshold);
            GLES20.glUniform1f(this.mBallCenterMaxDisLoc, this.mBallCenterMaxDis);
            GLES20.glUniform1f(this.mProcessOffsetLoc, this.mProcessOffset);
            GLES20.glUniform1f(this.mAntiAliasingDeltaLoc, this.mAntiAliasingDelta);
            GLES20.glUniform1i(this.mIsLeftLoc, this.mIsLeft ? 1 : 0);
            GLES20.glUniform1f(this.mAnimProcessLoc, this.mAnimProcess);
            GLES20.glUniform1f(this.mBallCenterYLoc, changeBallCenterToGL(this.mBallCenter, hwRatio));
            GLES20.glUniform1f(this.mHWRatioLoc, hwRatio);
            this.mRectBuffer.flip();
            GLES20.glEnableVertexAttribArray(this.mAttrVertexLoc);
            GLES20.glVertexAttribPointer(this.mAttrVertexLoc, 2, 5126, false, 8, this.mRectBuffer);
            GLES20.glDrawArrays(5, 0, this.mRectData.length / 2);
        }
    }
