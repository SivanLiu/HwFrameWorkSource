    ...
    private final class LocalDisplayDevice extends DisplayDevice {
        ...
        public DisplayDeviceInfo getDisplayDeviceInfoLocked() {
            if (this.mInfo == null) {
                ...
                if (this.mBuiltInDisplayId == 0) {
                    this.mInfo.name = res.getString(17039904);
                    displayDeviceInfo = this.mInfo;
                    displayDeviceInfo.flags |= 3;
                    if (res.getBoolean(17956988) || (Build.IS_EMULATOR && SystemProperties.getBoolean(LocalDisplayAdapter.PROPERTY_EMULATOR_CIRCULAR, false))) {
                        displayDeviceInfo = this.mInfo;
                    ...
                    this.mInfo.name = LocalDisplayAdapter.this.getContext().getResources().getString(17039905);
                    displayDeviceInfo = this.mInfo;
