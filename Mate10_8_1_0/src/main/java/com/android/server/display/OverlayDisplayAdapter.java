            ...
            for (String part : value.split(";")) {
                ...
                if (displayMatcher.matches()) {
                    ...
                    if (!modes.isEmpty()) {
                        count++;
                        int number = count;
                        String name = getContext().getResources().getString(17039906, new Object[]{Integer.valueOf(count)});
                        int gravity = chooseOverlayGravity(count);
                        boolean contains = flagString != null ? flagString.contains(",secure") : false;
