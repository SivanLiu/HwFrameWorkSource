...
final class OverlayDisplayWindow implements Dump {
    ...
    private void resize(int width, int height, int densityDpi, boolean doLayout) {
        ...
        this.mTitle = this.mContext.getResources().getString(17039908, new Object[]{this.mName, Integer.valueOf(this.mWidth), Integer.valueOf(this.mHeight), Integer.valueOf(this.mDensityDpi)});
        if (this.mSecure) {
            this.mTitle += this.mContext.getResources().getString(17039907);
        }
        if (doLayout) {
            relayout();
        }
    ...
    private void createWindow() {
        ...
        this.mTextureView = (TextureView) this.mWindowContent.findViewById(16909140);
        ...
        this.mTitleTextView = (TextView) this.mWindowContent.findViewById(16909141);
