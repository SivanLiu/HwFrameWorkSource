...
class AmbientLightMonitor implements MonitorModule {
    ...
    private static class AmbientLightCollectionData {
        ...
        public String toString() {
            return "AmbientLightCollectionData " + this.mMode + ", lux <50:" + (this.luxBelow50TimeInMs / 1000) + StylusGestureSettings.STYLUS_GESTURE_S_SUFFIX + ", 50~200:" + (this.lux50To200TimeInMs / 1000) + StylusGestureSettings.STYLUS_GESTURE_S_SUFFIX + ", 200~500:" + (this.lux200To500TimeInMs / 1000) + StylusGestureSettings.STYLUS_GESTURE_S_SUFFIX + ", 500~1000:" + (this.lux500To1000TimeInMs / 1000) + StylusGestureSettings.STYLUS_GESTURE_S_SUFFIX + ", 1000~5000:" + (this.lux1000To5000TimeInMs / 1000) + StylusGestureSettings.STYLUS_GESTURE_S_SUFFIX + ", >5000:" + (this.luxAbove5000TimeInMs / 1000) + StylusGestureSettings.STYLUS_GESTURE_S_SUFFIX;
        }
    }
    ...
    private void powerOnBrightnessChanged(ArrayMap<String, Object> params) {
        if (this.mCommonData.isProductEnable() && !this.mCommonData.isCommercialVersion() && powerOnBrightnessChangedCheckParamValid(params)) {
