...
class EthernetNetworkFactory {
    ...
    private class InterfaceObserver extends BaseNetworkObserver {
        ...
        public void interfaceLinkStateChanged(String iface, boolean up) {
            EthernetNetworkFactory.this.mHandler.post(new AnonymousClass3(up, this, iface));
        }
        ...
        public void interfaceAdded(String iface) {
            EthernetNetworkFactory.this.mHandler.post(new com.android.server.ethernet.-$Lambda$eRAo6Nl9jtYC3igbtEDMyHdAcyk.AnonymousClass1((byte) 3, this, iface));
        }
        ...
        public void interfaceRemoved(String iface) {
            EthernetNetworkFactory.this.mHandler.post(new com.android.server.ethernet.-$Lambda$eRAo6Nl9jtYC3igbtEDMyHdAcyk.AnonymousClass1((byte) 4, this, iface));
        }
        ...
        /* synthetic */ void lambda$-com_android_server_ethernet_EthernetNetworkFactory$InterfaceObserver_6800(String iface) {
            if (EthernetNetworkFactory.this.stopTrackingInterface(iface)) {
                EthernetNetworkFactory.this.trackFirstAvailableInterface();
            }
        }
    }
    ...
    private void setInterfaceUp(String iface) {
        try {
            ...
            Log.e(TAG, "Error upping interface " + this.mIface + ": " + e);
        }
    }
        ...
        if (config.getIpAssignment() != IpAssignment.STATIC) {
            ...
            Callback ipmCallback = new Callback() {
                ...
                public void onProvisioningSuccess(LinkProperties newLp) {
                    EthernetNetworkFactory.this.mHandler.post(new com.android.server.ethernet.-$Lambda$eRAo6Nl9jtYC3igbtEDMyHdAcyk.AnonymousClass1((byte) 2, this, newLp));
                }
                ...
                public void onProvisioningFailure(LinkProperties newLp) {
                    EthernetNetworkFactory.this.mHandler.post(new com.android.server.ethernet.-$Lambda$eRAo6Nl9jtYC3igbtEDMyHdAcyk.AnonymousClass1((byte) 1, this, newLp));
                }
                ...
                public void onLinkPropertiesChange(LinkProperties newLp) {
                    EthernetNetworkFactory.this.mHandler.post(new com.android.server.ethernet.-$Lambda$eRAo6Nl9jtYC3igbtEDMyHdAcyk.AnonymousClass1((byte) 0, this, newLp));
                }
            };
            stopIpManager();
            ...
            String tcpBufferSizes = this.mContext.getResources().getString(17039784);
    ...
    public void start(Context context, Handler handler) {
        ...
        mIfaceMatch = context.getResources().getString(17039783);
    ...
    /* synthetic */ void lambda$-com_android_server_ethernet_EthernetNetworkFactory_15568() {
    ...
    private void postAndWaitForRunnable(Runnable r) throws InterruptedException {
        ...
        this.mHandler.post(new com.android.server.ethernet.-$Lambda$eRAo6Nl9jtYC3igbtEDMyHdAcyk.AnonymousClass1((byte) 5, latch, r));
        latch.await();
    }
    ...
    void dump(FileDescriptor fd, IndentingPrintWriter pw, String[] args) {
        try {
            postAndWaitForRunnable(new com.android.server.ethernet.-$Lambda$eRAo6Nl9jtYC3igbtEDMyHdAcyk.AnonymousClass2(this, pw, fd, args));
