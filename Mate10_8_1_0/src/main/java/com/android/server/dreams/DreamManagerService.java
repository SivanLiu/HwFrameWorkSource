...
public final class DreamManagerService extends SystemService {
    ...
    /* synthetic */ void lambda$-com_android_server_dreams_DreamManagerService_15652(Binder newToken, ComponentName name, boolean isTest, int userId, boolean canDoze, WakeLock wakeLock) {
        if (this.mCust == null || !this.mCust.isChargingAlbumEnabled()) {
