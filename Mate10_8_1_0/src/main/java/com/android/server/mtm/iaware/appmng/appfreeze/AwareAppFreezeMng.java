...
public class AwareAppFreezeMng {
            ...
            if (AwareAppFreezeMng.mEnabled) {
                ...
                switch (msg.what) {
                    ...
                    case 2:
                        ...
                        AwareAppFreezeMng.this.handleToFreeze(AwareAppFreezeMng.this.mDelay, AwareAppFreezeMng.REASON_START_ACTIVITY);
                        break;
                    case 3:
                        AwareAppFreezeMng.this.handleToUnFreeze(AwareAppFreezeMng.REASON_TIMEOUT);
                        break;
                    case 4:
                        AwareAppFreezeMng.this.handleToFreeze(AwareAppFreezeMng.this.mDelay, AwareAppFreezeMng.REASON_START_CAMERA_SHOT);
                        break;
                    case 6:
                        AwareAppFreezeMng.this.mCurPkgName = InnerUtils.getPackageNameByUid(msg.getData().getInt("uid"));
                        break;
                    case 7:
                        AwareAppFreezeMng.this.handleToFreeze(AwareAppFreezeMng.this.mDelay, AwareAppFreezeMng.REASON_PROXIMITY_SCREEN_OFF);
                        break;
                    case 8:
                        AwareAppFreezeMng.this.handleSkippedFrameFreeze(AwareAppFreezeMng.this.mDelay, AwareAppFreezeMng.REASON_SKIPPED_FRAME);
                        break;
                    case 9:
                    ...
                    case 10:
                        ...
                        break;
                    case 11:
                        AwareAppFreezeMng.this.handleToFreeze(AwareAppFreezeMng.this.mDelay, AwareAppFreezeMng.REASON_GALLERY_SCALE);
                        break;
                }
                return;
            }
    ...
    private static /* synthetic */ int[] -getandroid-rms-iaware-AwareConstant$ResourceTypeSwitchesValues() {
        ...
        try {
            iArr[ResourceType.RESOURCE_BOOT_COMPLETED.ordinal()] = 3;
        } catch (NoSuchFieldError e2) {
        }
        try {
            iArr[ResourceType.RESOURCE_GAME_BOOST.ordinal()] = 4;
        } catch (NoSuchFieldError e3) {
        }
        try {
            iArr[ResourceType.RESOURCE_HOME.ordinal()] = 5;
        ...
        try {
            iArr[ResourceType.RESOURCE_INVALIDE_TYPE.ordinal()] = 6;
        } catch (NoSuchFieldError e6) {
        }
        try {
            iArr[ResourceType.RESOURCE_MEDIA_BTN.ordinal()] = 7;
        } catch (NoSuchFieldError e7) {
        }
        try {
            iArr[ResourceType.RESOURCE_NET_MANAGE.ordinal()] = 8;
        } catch (NoSuchFieldError e8) {
        }
        try {
            iArr[ResourceType.RESOURCE_SCENE_REC.ordinal()] = 9;
        } catch (NoSuchFieldError e9) {
        }
        try {
            iArr[ResourceType.RESOURCE_SCREEN_OFF.ordinal()] = 10;
        } catch (NoSuchFieldError e10) {
        }
        try {
            iArr[ResourceType.RESOURCE_SCREEN_ON.ordinal()] = 11;
    ...
    private AwareAppFreezeMng() {
        ...
        this.mDelay = SystemProperties.getInt(PROPERTIES_FREEZE_DELAY, 1500);
    ...
    private boolean isEvilControlEnable() {
        return mEnabled ? mIsEvilEnable : false;
    }
    ...
    private void handleSkippedFrameFreeze(int duration, String reason) {
        if (this.isSilde.get()) {
            handleToFreeze(this.mDelay, REASON_SKIPPED_FRAME);
        }
    }
        ...
        if (!this.mIsScreenOn.get()) {
            ...
            if (!this.isFreeze.get()) {
                ...
                if (curTime - this.lastFreezeTime >= this.mInterval * MILLI_TO_NANO) {
                    ...
                    this.mHandler.sendEmptyMessageDelayed(3, (long) this.mDelay);
                }
            }
        }
    }
