...
public class HwSecureInputMethodManagerService extends AbsInputMethodManagerService implements ServiceConnection, Callback {
    ...
    static final int MSG_SYSTEM_SWITCH_USER = 3050;
    ...
    public static final class MyLifecycle extends SystemService {
        ...
        public void onSwitchUser(int userHandle) {
            this.mService.mHandler.sendMessage(this.mService.mHandler.obtainMessage(HwSecureInputMethodManagerService.MSG_SYSTEM_SWITCH_USER, userHandle, 0));
        }
    ...
    public boolean handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case MSG_SET_USER_ACTION_NOTIFICATION_SEQUENCE_NUMBER /*3040*/:
                ...
                return true;
            case MSG_SYSTEM_SWITCH_USER /*3050*/:
