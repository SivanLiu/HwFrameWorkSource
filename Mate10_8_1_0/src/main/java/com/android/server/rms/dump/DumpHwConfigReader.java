...
public final class DumpHwConfigReader extends Assert {
    ...
    private static final void dumpGetResConfig() {
        ...
        ResourceConfig[] expect2 = new ResourceConfig[]{new ResourceConfig(0, 200, 2, 0, 1000, "APP_THIRDPARTY", 30, 40, 50, 0), new ResourceConfig(1, 500, 2, 0, 1000, "APP_HW", 30, 40, 50, 0), new ResourceConfig(2, 1000, 1, 0, 0, "APP_SYS", 30, 40, 50, 0), new ResourceConfig(3, 3000, 2, 0, 0, "APP_TOTAL", 30, 40, 50, 0)};
        for (i = 0; i < 4; i++) {
