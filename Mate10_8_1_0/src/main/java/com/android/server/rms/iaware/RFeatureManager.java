...
public class RFeatureManager implements IRDataRegister {
    ...
    private class IAwareDeviceStateReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("android.intent.action.SCREEN_ON".equals(action)) {
                ...
                int resIDAssoc = ResourceType.getReousrceId(ResourceType.RESOURCE_APPASSOC);
                curtime = System.currentTimeMillis();
    ...
    public String fetchBigDataByVersion(int iawareVer, int featureId, boolean beta, boolean clear) {
        ...
        RFeature featureInstance = featureWrapper != null ? featureWrapper.getFeatureInstance() : null;
        if (featureInstance != null) {
            return featureInstance.getBigDataByVersion(iawareVer, beta, clear);
        }
        return null;
    }
