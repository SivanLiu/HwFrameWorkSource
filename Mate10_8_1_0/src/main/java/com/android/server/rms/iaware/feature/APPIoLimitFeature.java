...
public class APPIoLimitFeature extends RFeature {
    ...
    private static /* synthetic */ int[] -getandroid-rms-iaware-AwareConstant$ResourceTypeSwitchesValues() {
        ...
        try {
            iArr[ResourceType.RESOURCE_MEDIA_BTN.ordinal()] = 2;
        ...
        try {
            iArr[ResourceType.RESOURCE_SCREEN_OFF.ordinal()] = 3;
        } catch (NoSuchFieldError e10) {
        }
        try {
            iArr[ResourceType.RESOURCE_SCREEN_ON.ordinal()] = 4;
        } catch (NoSuchFieldError e11) {
        }
        try {
            iArr[ResourceType.RESOURCE_STATUS_BAR.ordinal()] = 5;
