...
public class LCDSchedFeatureRT extends DevSchedFeatureBase {
    ...
    static {
        ...
        sPgSceneToPreRecongMap.put(Integer.valueOf(MemoryConstant.MSG_PROTECTLRU_SET_FILENODE), Integer.valueOf(19));
        sPgSceneToPreRecongMap.put(Integer.valueOf(MemoryConstant.MSG_PROTECTLRU_SET_PROTECTZONE), Integer.valueOf(9));
