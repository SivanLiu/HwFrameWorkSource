...
public class PackageManagerServiceCompilerMapping {
    ...
    static final String[] REASON_STRINGS = new String[]{"first-boot", "boot", "install", "bg-dexopt", "ab-ota", "inactive", "shared", "bg-speed-dexopt"};
    ...
    private static boolean isFilterAllowedForReason(int reason, String filter) {
        return reason == 6 ? DexFile.isProfileGuidedCompilerFilter(filter) ^ 1 : true;
    }
