...
public class PackageInstallerService extends Stub {
    ...
    static class PackageDeleteObserverAdapter extends PackageDeleteObserver {
        ...
        public PackageDeleteObserverAdapter(Context context, IntentSender target, String packageName, boolean showNotification, int userId) {
            ...
            if (showNotification) {
                this.mNotification = PackageInstallerService.buildSuccessNotification(this.mContext, this.mContext.getResources().getString(17040543), packageName, userId);
            } else {
    ...
    private static Notification buildSuccessNotification(Context context, String contentText, String basePackageName, int userId) {
        ...
        return new Builder(context, SystemNotificationChannels.DEVICE_ADMIN).setSmallIcon(17302298).setColor(context.getResources().getColor(17170772)).setContentTitle(packageInfo.applicationInfo.loadLabel(pm)).setContentText(contentText).setStyle(new BigTextStyle().bigText(contentText)).setLargeIcon(ImageUtils.buildScaledBitmap(packageInfo.applicationInfo.loadIcon(pm), context.getResources().getDimensionPixelSize(17104901), context.getResources().getDimensionPixelSize(17104902))).build();
    }
