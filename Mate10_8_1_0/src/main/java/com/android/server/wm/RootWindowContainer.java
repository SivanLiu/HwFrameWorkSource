...
class RootWindowContainer extends WindowContainer<DisplayContent> {
    ...
    private static final Consumer<WindowState> sRemoveReplacedWindowsConsumer = -$Lambda$SZTLEwEbh2VkY-Dt8NUcOZe2XY0.$INST$2;
    ...
    private final Consumer<WindowState> mCloseSystemDialogsConsumer = new -$Lambda$YIZfR4m-B8z_tYbP2x4OJ3o7OYE((byte) 15, this);
    ...
    /* synthetic */ void lambda$-com_android_server_wm_RootWindowContainer_8867(WindowState w) {
        if (w.mHasSurface) {
            try {
    ...
    static /* synthetic */ void lambda$-com_android_server_wm_RootWindowContainer_9148(WindowState w) {
    ...
    WindowState computeFocusedWindow() {
        DisplayContent dc;
        WindowState win;
        boolean forceDefaultDisplay = this.mService.mPolicy.isKeyguardShowingAndNotOccluded();
        ...
        for (int i = this.mChildren.size() - 1; i >= 0; i--) {
            dc = (DisplayContent) this.mChildren.get(i);
            win = dc.findFocusedWindow();
            if (win != null) {
                if (!forceDefaultDisplay || (dc.isDefaultDisplay ^ 1) == 0) {
                    return win;
                }
                EventLog.writeEvent(1397638484, new Object[]{"71786287", Integer.valueOf(win.mOwnerUid), ""});
            }
        }
        return null;
    }
    ...
    private DisplayContent createDisplayContent(Display display) {
        ...
        if (this.mService.mDisplayManagerInternal != null) {
            ...
            if (HwPCUtils.enabled() && displayId != -1 && displayId != 0 && ((displayInfo.type == 2 || ((displayInfo.type == 5 || displayInfo.type == 4) && SystemProperties.getBoolean("hw_pc_support_overlay", false))) && this.mService.canDispatchExternalPointerEvents())) {
                dc.mTapDetector = new TaskTapPointerEventListener(this.mService, dc);
    ...
    static /* synthetic */ void lambda$-com_android_server_wm_RootWindowContainer_19432(String name, ArrayList output, int objectId, WindowState w) {
        if (name != null) {
    ...
    static /* synthetic */ void lambda$-com_android_server_wm_RootWindowContainer_24496(int userId, boolean disabled, WindowState w) {
    ...
    void updateAppOpsState() {
        forAllWindows((Consumer) new -$Lambda$YIZfR4m-B8z_tYbP2x4OJ3o7OYE((byte) 16, this), false);
    }

    /* synthetic */ void lambda$-com_android_server_wm_RootWindowContainer_24761(WindowState w) {
        if (w.mAppOp != -1) {
            this.mService.setAppOpVisibilityLwHook(w, this.mService.mAppOps.checkOpNoThrow(w.mAppOp, w.getOwningUid(), w.getOwningPackage()));
        }
    }

    static /* synthetic */ boolean lambda$-com_android_server_wm_RootWindowContainer_25402(int pid, WindowState w) {
        return w.mSession.mPid == pid ? w.isVisibleLw() : false;
    }

    boolean canShowStrictModeViolation(int pid) {
        return getWindow(new -$Lambda$tS7nL17Ous75692M4rHLEZu640I((byte) 2, pid)) != null;
    }
    ...
    boolean reclaimSomeSurfaceMemory(WindowStateAnimator winAnimator, String operation, boolean secure) {
        ...
        try {
            ...
            if (leakedSurface == 0) {
                ...
                for (displayNdx = 0; displayNdx < numDisplays; displayNdx++) {
                    ((DisplayContent) this.mChildren.get(displayNdx)).forAllWindows((Consumer) new -$Lambda$qRW_P-TWddDPPnAT8S1SNpM72ho((byte) 2, this, pidCandidates), false);
    ...
    /* synthetic */ void lambda$-com_android_server_wm_RootWindowContainer_28065(SparseIntArray pidCandidates, WindowState w) {
    ...
    void performSurfacePlacement(boolean recoveringMemory) {
        ...
        if (this.mUpdateRotation) {
            ...
            if (displayContent2 != null && displayContent2.updateRotationUnchecked(false)) {
        ...
        if (touchExcludeRegionUpdateDisplays != null) {
            DisplayContent displayContent3 = this.mService.mFocusedApp != null ? this.mService.mFocusedApp.getDisplayContent() : null;
            for (DisplayContent dc : touchExcludeRegionUpdateDisplays) {
                if (displayContent3 != dc) {
    ...
    boolean handleNotObscuredLocked(WindowState w, boolean obscured, boolean syswin) {
        ...
        boolean isDisplayedLw = w.isDisplayedLw();
        int privateflags = attrs.privateFlags;
        boolean displayHasContent = false;
        if (w.mAttrs.type == IHwShutdownThread.SHUTDOWN_ANIMATION_WAIT_TIME && (isDisplayedLw ^ 1) != 0) {
            isDisplayedLw = w.mHasSurface ? this.mService.mPolicy.isKeyguardShowingOrOccluded() : false;
            if (isDisplayedLw) {
    ...
    static /* synthetic */ void lambda$-com_android_server_wm_RootWindowContainer_57163(ArrayList windows, PrintWriter pw, int[] index, boolean dumpAll, WindowState w) {
        boolean z = true;
