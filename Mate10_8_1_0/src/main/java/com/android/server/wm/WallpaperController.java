...
public class WallpaperController {
    ...
    /* synthetic */ boolean lambda$-com_android_server_wm_WallpaperController_4838(WindowState w) {
        ...
        if (keyguardGoingAwayWithWallpaper || r2) {
            this.mFindResults.setUseTopWallpaperAsTarget(true);
        }
    ...
    private void updateWallpaperWindowsTarget(DisplayContent dc, FindWallpaperTargetResult result) {
        ...
        if (wallpaperTarget != null && prevWallpaperTarget != null) {
            ...
            if (wallpaperTarget.isAnimatingLw() && (oldAnim ^ 1) == 0 && dc.getWindow(new AnonymousClass1((byte) 2, prevWallpaperTarget)) != null) {
                boolean z;
                boolean oldTargetHidden;
                if (wallpaperTarget.mAppToken != null) {
                    z = wallpaperTarget.mAppToken.hiddenRequested;
                } else {
                    z = false;
                }
                ...
                if (z && (oldTargetHidden ^ 1) != 0) {
                    this.mWallpaperTarget = prevWallpaperTarget;
                } else if (z == oldTargetHidden && (this.mService.mOpeningApps.contains(wallpaperTarget.mAppToken) ^ 1) != 0 && (this.mService.mOpeningApps.contains(prevWallpaperTarget.mAppToken) || this.mService.mClosingApps.contains(prevWallpaperTarget.mAppToken))) {
                    this.mWallpaperTarget = prevWallpaperTarget;
                }
    ...
    void adjustWallpaperWindows(DisplayContent dc) {
        ...
        boolean isWallpaperVisible = this.mWallpaperTarget != null ? isWallpaperVisible(this.mWallpaperTarget) : false;
        ...
        updateWallpaperTokens(isWallpaperVisible);
    }
