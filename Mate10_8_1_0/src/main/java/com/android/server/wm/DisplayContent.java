...
import com.android.server.wm.-$Lambda$OzPvdnGprtQoLZLCvw2GU8IaGyI.AnonymousClass6;
...
public class DisplayContent extends AbsDisplayContent {
    ...
    private final Consumer<WindowState> mApplyPostLayoutPolicy = new -$Lambda$YIZfR4m-B8z_tYbP2x4OJ3o7OYE((byte) 9, this);
    private final Consumer<WindowState> mApplySurfaceChangesTransaction = new -$Lambda$YIZfR4m-B8z_tYbP2x4OJ3o7OYE((byte) 10, this);
    ...
    private final Predicate<WindowState> mComputeImeTargetPredicate = new AnonymousClass1((byte) 0, this);
    ...
    private final Consumer<WindowState> mPerformLayout = new -$Lambda$YIZfR4m-B8z_tYbP2x4OJ3o7OYE((byte) 7, this);
    private final Consumer<WindowState> mPerformLayoutAttached = new -$Lambda$YIZfR4m-B8z_tYbP2x4OJ3o7OYE((byte) 8, this);
    final PinnedStackController mPinnedStackControllerLocked;
    private final Consumer<WindowState> mPrepareWindowSurfaces = new -$Lambda$YIZfR4m-B8z_tYbP2x4OJ3o7OYE((byte) 6, this);
    ...
    protected final class NonAppWindowContainers extends DisplayChildWindowContainer<WindowToken> {
        private final Predicate<WindowState> mGetOrientingWindow = -$Lambda$OzPvdnGprtQoLZLCvw2GU8IaGyI.AnonymousClass1.$INST$0;
        private final String mName;
        private final Comparator<WindowToken> mWindowComparator = new -$Lambda$LEqle-ue9vesHjZva-SwvAvwBx8((byte) 0, this);

        /* synthetic */ int lambda$-com_android_server_wm_DisplayContent$NonAppWindowContainers_179921(WindowToken token1, WindowToken token2) {
        ...
        static /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent$NonAppWindowContainers_180360(WindowState w) {
    ...
    static /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_138856(int r1, int r2, com.android.server.wm.WindowState r3) {
        /* JADX: method processing error */
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.server.wm.DisplayContent.lambda$-com_android_server_wm_DisplayContent_138856(int, int, com.android.server.wm.WindowState):void
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.wm.DisplayContent.lambda$-com_android_server_wm_DisplayContent_138856(int, int, com.android.server.wm.WindowState):void");
    }
    ...
    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_19596(WindowState w) {
    ...
    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_21909(WindowState w) {
        WindowStateAnimator winAnimator = w.mWinAnimator;
    ...
    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_23858(WindowState w) {
    ...
    /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent_24354(WindowState w) {
        AppWindowToken focusedApp = this.mService.mFocusedApp;
        if (!w.canReceiveKeys()) {
            return false;
        }
        if (HwPCUtils.isPcCastModeInServer() && (this.isDefaultDisplay ^ 1) != 0 && this.mService.getPCLauncherFocused() && w.mAttrs != null && w.mAttrs.type != 2103 && w.mAppToken != null) {
            return false;
        }
    ...
    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_26906(WindowState w) {
    ...
    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_27326(WindowState w) {
        boolean isGoneForLayoutLw;
        boolean gone;
        int isScreenOn = IS_TABLET ? !isCoverOpen() ? this.mService.mPowerManager.isScreenOn() : 1 : isCoverOpen();
        ...
        if (this.mTmpWindow == null || !this.mService.mPolicy.canBeHiddenByKeyguardLw(w)) {
            isGoneForLayoutLw = w.isGoneForLayoutLw();
        } else {
            isGoneForLayoutLw = true;
        }
        if ((!isGoneForLayoutLw && (r3 ^ 1) == 0) || w.mAttrs.type == IHwShutdownThread.SHUTDOWN_ANIMATION_WAIT_TIME || w.mAttrs.type == 2101) {
            gone = false;
    ...
    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_32287(WindowState w) {
        if (w.mLayoutAttached) {
            if (this.mTmpWindow != null && this.mService.mPolicy.canBeHiddenByKeyguardLw(w)) {
                return;
            }
    ...
    /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent_34026(WindowState w) {
        return w.canBeImeTarget();
    }

    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_34311(WindowState w) {
        this.mService.mPolicy.applyPostLayoutPolicyLw(w, w.mAttrs, w.getParentWindow(), this.mService.mInputMethodTarget);
    }

    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_34516(WindowState w) {
        ...
        if (!this.mTmpApplySurfaceChangesTransactionState.obscured) {
            ...
            if (w.mHasSurface && isDisplayed) {
                ...
                if (!(type == 2008 || type == 2010)) {
                    if ((w.mAttrs.privateFlags & 1024) != 0) {
                    }
    ...
    protected boolean updateRotationUnchecked(boolean inTransaction) {
        ...
        if (WindowManagerService.IS_NOTCH_PROP && rotation == 2 && Secure.getIntForUser(this.mService.mContext.getContentResolver(), "display_notch_status", 0, -2) == 1) {
            Slog.i(TAG, "Do not rotate when rotation is 180 in norch mode");
            return false;
        }
        int i;
        boolean shouldRotateSeamlessly = this.mService.mPolicy.shouldRotateSeamlessly(oldRotation, rotation);
        if (shouldRotateSeamlessly) {
            if (getWindow(-$Lambda$OzPvdnGprtQoLZLCvw2GU8IaGyI.AnonymousClass1.$INST$3) != null) {
                return false;
            }
        ...
        boolean rotateSeamlessly = shouldRotateSeamlessly;
        ...
        if (rotateSeamlessly) {
            forAllWindows((Consumer) new AnonymousClass4((byte) 0, oldRotation, rotation), true);
        }
        this.mService.mDisplayManagerInternal.performTraversalInTransactionFromWindowManager();
        if (!inTransaction) {
            this.mService.closeSurfaceTransaction();
        }
        forAllWindows((Consumer) new AnonymousClass6(rotateSeamlessly, this), true);
        if (rotateSeamlessly) {
    ...
    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_58602(boolean rotateSeamlessly, WindowState w) {
        if (w.mAppToken != null) {
    ...
    private void computeSizeRangesAndScreenLayout(DisplayInfo displayInfo, int displayId, boolean rotated, int uiMode, int dw, int dh, float density, Configuration outConfig) {
        ...
        int sl = reduceConfigLayout(reduceConfigLayout(reduceConfigLayout(reduceConfigLayout(Configuration.resetScreenLayout(outConfig.screenLayout), 0, density, unrotDw, unrotDh, uiMode, displayId), 1, density, unrotDh, unrotDw, uiMode, displayId), 2, density, unrotDw, unrotDh, uiMode, displayId), 3, density, unrotDh, unrotDw, uiMode, displayId);
    ...
    Task findTaskForResizePoint(int x, int y) {
        ...
        for (int stackNdx = this.mTaskStackContainers.size() - 1; stackNdx >= 0; stackNdx--) {
            try {
                ...
                if (stack == null) {
                    continue;
                } else if (!StackId.isTaskResizeAllowed(stack.mStackId)) {
                    return null;
                } else {
                ...
                Slog.e(TAG, "findTaskForResizePoint IndexOutOfBoundsException");
            }
        }
        return null;
    }
    ...
    void adjustForImeIfNeeded() {
        ...
        if (imeWin != null && imeWin.isVisibleLw() && imeWin.isDisplayedLw()) {
            isImeHideRequested = this.mDividerControllerLocked.isImeHideRequested() ^ 1;
        } else {
            isImeHideRequested = false;
        }
        ...
        boolean imeHeightChanged = isImeHideRequested ? imeHeight != this.mDividerControllerLocked.getImeHeightAdjustedFor() : false;
        boolean rotated = this.mRotation != 1 ? this.mRotation == 3 : true;
        int i;
        if (isImeHideRequested && dockVisible && ((imeOnTop || imeOnBottom) && (dockMinimized ^ 1) != 0)) {
            ...
            boolean z2 = (isImeHideRequested && dockVisible) ? rotated : false;
            dockedStackDividerController.setAdjustedForIme(false, z2, dockVisible, imeWin, imeHeight);
        }
        this.mPinnedStackControllerLocked.setAdjustedForIme(isImeHideRequested, imeHeight);
    }
    ...
    int getLayerForAnimationBackground(WindowStateAnimator winAnimator) {
        WindowState visibleWallpaper = this.mBelowAppWindowsContainers.getWindow(-$Lambda$OzPvdnGprtQoLZLCvw2GU8IaGyI.AnonymousClass1.$INST$1);
    ...
    static /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent_109645(WindowState w) {
    ...
    public void dump(String prefix, PrintWriter pw) {
        ...
        if (this.mInitialDisplayWidth == this.mBaseDisplayWidth && this.mInitialDisplayHeight == this.mBaseDisplayHeight) {
            ...
            for (stackNdx = this.mTaskStackContainers.size() - 1; stackNdx >= 0; stackNdx--) {
    ...
    WindowState getTouchableWinAtPointLocked(float xf, float yf) {
        return getWindow(new AnonymousClass5((int) xf, (int) yf, this));
    }

    /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent_116175(int x, int y, WindowState w) {
        boolean z = true;
        int flags = w.mAttrs.flags;
    ...
    boolean canAddToastWindowForUid(int uid) {
        ...
        if (getWindow(new -$Lambda$tS7nL17Ous75692M4rHLEZu640I((byte) 1, uid)) != null) {
            z = false;
        }
        return z;
    }

    static /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent_117079(int uid, WindowState w) {
        return w.mOwnerUid == uid ? w.isFocused() : false;
    }

    static /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent_117258(int uid, WindowState w) {
    ...
    boolean destroyLeakedSurfaces() {
        this.mTmpWindow = null;
        forAllWindows((Consumer) new -$Lambda$YIZfR4m-B8z_tYbP2x4OJ3o7OYE((byte) 11, this), false);
        if (this.mTmpWindow != null) {
            return true;
        }
        return false;
    ...
    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_119877(WindowState w) {
    ...
    WindowState computeImeTarget(boolean updateImeTarget) {
        ...
        boolean contains = curTarget != null ? (curTarget.mAnimatingExit && curTarget.mWinAnimator.getShown()) ? true : curTarget.mService.mClosingApps.contains(curTarget.mAppToken) : false;
        if (curTarget != null && curTarget.isDisplayedLw() && r4 && (target == null || curTarget.mWinAnimator.mAnimLayer > target.mWinAnimator.mAnimLayer)) {
            return curTarget;
        }
        if (target == null) {
            if (updateImeTarget) {
    ...
    boolean getNeedsMenu(WindowState top, WindowState bottom) {
        ...
        this.mTmpWindow = null;
        WindowState candidate = getWindow(new AnonymousClass3(this, top, bottom));
    ...
    /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent_130314(WindowState top, WindowState bottom, WindowState w) {
        if (w == top) {
            this.mTmpWindow = w;
        }
        if (this.mTmpWindow == null) {
    ...
    void dumpWindowAnimators(PrintWriter pw, String subPrefix) {
        forAllWindows((Consumer) new AnonymousClass2(pw, subPrefix, new int[1]), false);
    }

    static /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_132081(PrintWriter pw, String subPrefix, int[] index, WindowState w) {
    ...
    void enableSurfaceTrace(FileDescriptor fd) {
        forAllWindows((Consumer) new -$Lambda$YIZfR4m-B8z_tYbP2x4OJ3o7OYE((byte) 12, fd), true);
    }

    void disableSurfaceTrace() {
        forAllWindows((Consumer) -$Lambda$SZTLEwEbh2VkY-Dt8NUcOZe2XY0.$INST$0, true);
    }

    void startKeyguardExitOnNonAppWindows(boolean onWallpaper, boolean goingToShade) {
        forAllWindows((Consumer) new -$Lambda$AUkchKtIxrbCkLkg2ILGagAqXvc((byte) 0, onWallpaper, goingToShade, this.mService.mPolicy), true);
    }

    static /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_133153(WindowManagerPolicy policy, boolean onWallpaper, boolean goingToShade, WindowState w) {
    ...
    boolean checkWaitingForWindows() {
        ...
        WindowState visibleWindow = getWindow(new AnonymousClass1((byte) 1, this));
        ...
        boolean z;
        if (this.mService.mContext.getResources().getBoolean(17956968)) {
            z = this.mService.mOnlyCore ^ 1;
        } else {
            z = false;
        }
        if (WindowManagerDebugConfig.DEBUG_BOOT) {
            Slog.i(TAG, " wallEnabled=" + z);
        }
        if (this.mService.mSystemBooted || (this.mHaveBootMsg ^ 1) == 0) {
            return this.mService.mSystemBooted && (!(this.mHaveApp || (this.mHaveKeyguard ^ 1) == 0) || (z && (this.mHaveWallpaper ^ 1) != 0));
        } else {
            return true;
        }
    }

    /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent_133828(WindowState w) {
    ...
    boolean hasSecureWindowOnScreen() {
        return getWindow(-$Lambda$OzPvdnGprtQoLZLCvw2GU8IaGyI.AnonymousClass1.$INST$2) != null;
    }

    static /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent_138670(WindowState w) {
        return w.isOnScreen() && (w.mAttrs.flags & 8192) != 0;
    }

    void updateSystemUiVisibility(int visibility, int globalDiff) {
        forAllWindows((Consumer) new AnonymousClass4((byte) 1, visibility, globalDiff), true);
    }

    void onWindowFreezeTimeout() {
        Slog.w(TAG, "Window freeze timeout expired.");
        this.mService.mWindowsFreezingScreen = 2;
        forAllWindows((Consumer) new -$Lambda$YIZfR4m-B8z_tYbP2x4OJ3o7OYE(UsbDescriptor.CLASSID_VIDEO, this), true);
        this.mService.mWindowPlacerLocked.performSurfacePlacement();
    }

    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_139788(WindowState w) {
    ...
    void waitForAllWindowsDrawn() {
        ...
        if (!this.isDefaultDisplay || (isCoverOpen() ^ 1) == 0) {
            forAllWindows((Consumer) new -$Lambda$qRW_P-TWddDPPnAT8S1SNpM72ho((byte) 1, this, policy), true);
            return;
        }
        Slog.w(TAG, "waitForAllWindowsDrawn cover is closed on default Display");
        forAllWindows((Consumer) new -$Lambda$qRW_P-TWddDPPnAT8S1SNpM72ho((byte) 0, this, policy), true);
    }

    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_140556(WindowManagerPolicy policy, WindowState w) {
    ...
    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_141225(WindowManagerPolicy policy, WindowState w) {
        boolean keyguard = policy.isKeyguardHostWindow(w.mAttrs);
        if (!w.isVisibleLw()) {
            return;
        }
        ...
        synchronized (this.mService.mWindowMap) {
            try {
                ...
                if (this.mService.mPolicy.isScreenOn()) {
                    ...
                    forAllWindows(new AnonymousClass7(wallpaperOnly, includeDecor, aboveAppLayer, this, appToken, mutableIncludeFullDisplay, frame, stackBounds), true);
                    ...
                    if (appToken != null && appWin == null) {
                        ...
                        E bitmap = screenshoter.screenshot(crop, width, height, minLayer, maxLayer, isAnimating, rot);
                        if (bitmap == null) {
    ...
    /* synthetic */ boolean lambda$-com_android_server_wm_DisplayContent_152943(int aboveAppLayer, boolean wallpaperOnly, IBinder appToken, MutableBoolean mutableIncludeFullDisplay, boolean includeDecor, Rect frame, Rect stackBounds, WindowState w) {
        if (!w.mHasSurface) {
            return false;
        }
        ...
        if (foundTargetWs && winAnim.getShown() && winAnim.mLastAlpha > 0.0f) {
    ...
    /* synthetic */ void lambda$-com_android_server_wm_DisplayContent_166045(WindowState w) {
