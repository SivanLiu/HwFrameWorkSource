...
public final class SystemServer {
    ...
    private static final int DEFAULT_SYSTEM_THEME = 16974794;
    ...
    static /* synthetic */ void lambda$-com_android_server_SystemServer_38598() {
    ...
    private void startOtherServices() {
        ...
        try {
            ...
            if (!disableConsumerIr) {
                ...
                try {
                    ...
                    try {
                        ...
                        reportWtf("starting StorageManagerService", e32222);
                    }
                    traceEnd();
                    ...
                    try {
                        ...
                        reportWtf("starting StorageStatsService", e322222);
                    }
                    traceEnd();
                    ...
                    if (!this.mOnlyCore) {
                        ...
                        try {
                            ...
                            reportWtf("update packages", e3222222);
                        }
                        traceEnd();
                    }
                    ...
                    if (this.mFactoryTestMode != 1) {
                        ...
                        if (!disableNonCoreServices) {
                            ...
                            try {
                                ...
                                reportWtf("starting LockSettingsService service", e32222222);
                            }
                            traceEnd();
                            hasPdb = SystemProperties.get(PERSISTENT_DATA_BLOCK_PROP).equals("") ^ 1;
                            if (hasPdb) {
                        ...
                        if (!disableSystemUI) {
                            ...
                            try {
                                ...
                                reportWtf("starting StatusBarManagerService", e322222222);
                            }
                            traceEnd();
                        }
                        if (!disableNonCoreServices) {
                        ...
                        if (!disableNetwork) {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    iStorageManager.waitForAsecScan();
                                    traceEnd();
                                                        ...
                                                        try {
                                                            ...
                                                            try {
                                                                ...
                                                                try {
                                                                    ...
                                                                    traceEnd();
                                                                    if (this.mOnlyCore ? false : context.getResources().getBoolean(17956967)) {
                                                                    ...
                                                                    if (!disableNetwork) {
                                                                        ...
                                                                        try {
                                                                            ...
                                                                            reportWtf("starting CertBlacklister", e322222222222222);
                                                                        }
                                                                        traceEnd();
                                                                    }
                                                                    ...
                                                                    if (!disableNonCoreServices) {
                                                                        ...
                                                                        try {
                                                                            ...
                                                                            try {
                                                                                ...
                                                                                e322222222222222 = th5;
                                                                                mediaRouterService = mediaRouterService2;
                                                                                reportWtf("starting MediaRouterService", e322222222222222);
                                                                                traceEnd();
                                                                                ...
                                                                                if (iLockSettings != null) {
                                                                                    try {
                                                                                        ...
                                                                                        reportWtf("making Lock Settings Service ready", e3222222222222222);
                                                                                    }
                                                                                }
                                                                                traceEnd();
                                                                                ...
                                                                                config = windowManagerService.computeNewConfiguration(0);
                                                                                ...
                                                                                windowManagerF = windowManagerService;
                                                                                this.mActivityManagerService.systemReady(new com.android.server.-$Lambda$T7cKu_OKm_Fk2kBNthmo_uUJTSo.AnonymousClass2(enableIaware, this, context, windowManagerF, networkScoreService2, networkManagement, networkPolicy, networkStats, connectivity, location, countryDetectorService, networkTimeUpdateService2, commonTimeManagementService2, inputManager, telephonyRegistry, mediaRouterService, mmsService), BOOT_TIMINGS_TRACE_LOG);
                                                                            }
                                                                        } catch (Throwable th6) {
                                                                        ...
                                                                        try {
                                                                            ...
                                                                            reportWtf("starting StartBackgroundDexOptService", e32222222222222222);
                                                                        }
                                                                        traceEnd();
                                                                        traceBeginAndSlog("StartPruneInstantAppsJobService");
                                                                        try {
                                                                            ...
                                                                            reportWtf("StartPruneInstantAppsJobService", e322222222222222222);
                                                                        }
                                                                        traceEnd();
                                                                    }
                                                                    traceBeginAndSlog("StartShortcutServiceLifecycle");
                        ...
                        try {
                            ...
                            e32222222222222222222222222 = th13;
                        ...
                        try {
                            ...
                            e32222222222222222222222222 = th14;
            ...
            try {
                ...
                windowManagerService = WindowManagerService.main(context, inputManager, this.mFactoryTestMode != 1, this.mFirstBoot ^ 1, this.mOnlyCore, HwPolicyFactory.getHwPhoneWindowManager());
                initRogMode(windowManagerService, context);
                ...
                if (dpi > 0) {
                    windowManagerService.setForcedDisplayDensityForUser(0, dpi, UserHandle.myUserId());
                }
        ...
        if (this.mFactoryTestMode != 1) {
            ...
            if (!(iStorageManager == null || (this.mOnlyCore ^ 1) == 0)) {
                traceBeginAndSlog("WaitForAsecScan");
                iStorageManager.waitForAsecScan();
                traceEnd();
            }
            ...
            if (!disableNonCoreServices && context.getResources().getBoolean(17956968)) {
                traceBeginAndSlog("StartWallpaperManagerService");
                this.mSystemServiceManager.startService(HwServiceFactory.getWallpaperManagerServiceClassName());
                traceEnd();
            }
            ...
            if (disableNonCoreServices) {
                ...
                if (this.mPackageManager.hasSystemFeature("android.software.app_widgets") || context.getResources().getBoolean(17956944)) {
                    traceBeginAndSlog("StartAppWidgerService");
                    this.mSystemServiceManager.startService(APPWIDGET_SERVICE_CLASS);
                    traceEnd();
                }
    ...
    static /* synthetic */ void lambda$-com_android_server_SystemServer_46412() {
        try {
    ...
    static /* synthetic */ void lambda$-com_android_server_SystemServer_55020() {
        TimingsTraceLog traceLog = new TimingsTraceLog(SYSTEM_SERVER_TIMING_ASYNC_TAG, 524288);
    ...
    /* synthetic */ void lambda$-com_android_server_SystemServer_99834(Context context, WindowManagerService windowManagerF, NetworkScoreService networkScoreF, NetworkManagementService networkManagementF, NetworkPolicyManagerService networkPolicyF, NetworkStatsService networkStatsF, ConnectivityService connectivityF, LocationManagerService locationF, CountryDetectorService countryDetectorF, NetworkTimeUpdateService networkTimeUpdaterF, CommonTimeManagementService commonTimeMgmtServiceF, InputManagerService inputManagerF, TelephonyRegistry telephonyRegistryF, MediaRouterService mediaRouterF, MmsServiceBroker mmsServiceF, boolean enableIaware) {
        ...
        if (!this.mOnlyCore) {
            webviewPrep = SystemServerInitThreadPool.get().submit(new com.android.server.-$Lambda$T7cKu_OKm_Fk2kBNthmo_uUJTSo.AnonymousClass1(this), "WebViewFactoryPreparation");
        }
        ...
        if (commonTimeMgmtServiceF != null) {
            try {
                ...
                reportWtf("Notifying CommonTimeManagementService running", e2222222222);
            }
        }
        traceEnd();
        ...
        if (inputManagerF != null) {
            try {
                ...
                reportWtf("Notifying InputManagerService running", e22222222222);
            }
        }
        traceEnd();
        ...
        if (telephonyRegistryF != null) {
            try {
                ...
                reportWtf("Notifying TelephonyRegistry running", e222222222222);
            }
        }
        traceEnd();
        ...
        if (mediaRouterF != null) {
            try {
                ...
                reportWtf("Notifying MediaRouterService running", e2222222222222);
            }
        }
        traceEnd();
        ...
        if (mmsServiceF != null) {
            try {
                ...
                reportWtf("Notifying MmsService running", e22222222222222);
            }
        }
        traceEnd();
        ...
        if (networkScoreF != null) {
            try {
                ...
                reportWtf("Notifying NetworkScoreService running", e222222222222222);
            }
        }
        traceEnd();
        ...
        try {
            ...
            reportWtf("Notifying incident daemon running", e2222222222222222);
        }
        traceEnd();
        if (enableIaware) {
            try {
                ...
                reportWtf("starting MultiTaskManagerService", e22222222222222222);
            }
        } else {
    ...
    /* synthetic */ void lambda$-com_android_server_SystemServer_100739() {
