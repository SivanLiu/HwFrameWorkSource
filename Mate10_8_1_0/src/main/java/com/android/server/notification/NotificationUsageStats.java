...
public class NotificationUsageStats {
    ...
    private static class AggregatedStats {
        ...
        public void countApiUse(NotificationRecord record) {
            ...
            if ((n.defaults & 1) == 0 && (n.defaults & 2) == 0 && n.sound == null) {
                if (n.vibrate != null) {
                }
                switch (n.visibility) {
                    case -1:
    ...
    public synchronized void registerPeopleAffinity(com.android.server.notification.NotificationRecord r6, boolean r7, boolean r8, boolean r9) {
...
*/
        ...
        r5 = this;
        monitor-enter(r5);
        r0 = r5.getAggregatedStatsLocked(r6);	 Catch:{ all -> 0x002d }
        r2 = 0;	 Catch:{ all -> 0x002d }
        r3 = r0.length;	 Catch:{ all -> 0x002d }
    L_0x0007:
        if (r2 >= r3) goto L_0x0030;	 Catch:{ all -> 0x002d }
    L_0x0009:
        r1 = r0[r2];	 Catch:{ all -> 0x002d }
        if (r7 == 0) goto L_0x0013;	 Catch:{ all -> 0x002d }
    L_0x000d:
        r4 = r1.numWithValidPeople;	 Catch:{ all -> 0x002d }
        r4 = r4 + 1;	 Catch:{ all -> 0x002d }
        r1.numWithValidPeople = r4;	 Catch:{ all -> 0x002d }
    L_0x0013:
        if (r8 == 0) goto L_0x001b;	 Catch:{ all -> 0x002d }
    L_0x0015:
        r4 = r1.numWithStaredPeople;	 Catch:{ all -> 0x002d }
        r4 = r4 + 1;	 Catch:{ all -> 0x002d }
        r1.numWithStaredPeople = r4;	 Catch:{ all -> 0x002d }
    L_0x001b:
        if (r9 == 0) goto L_0x0026;	 Catch:{ all -> 0x002d }
    L_0x001d:
        r4 = r1.numPeopleCacheHit;	 Catch:{ all -> 0x002d }
        r4 = r4 + 1;	 Catch:{ all -> 0x002d }
        r1.numPeopleCacheHit = r4;	 Catch:{ all -> 0x002d }
    L_0x0023:
        r2 = r2 + 1;	 Catch:{ all -> 0x002d }
        goto L_0x0007;	 Catch:{ all -> 0x002d }
    L_0x0026:
        r4 = r1.numPeopleCacheMiss;	 Catch:{ all -> 0x002d }
        r4 = r4 + 1;	 Catch:{ all -> 0x002d }
        r1.numPeopleCacheMiss = r4;	 Catch:{ all -> 0x002d }
        goto L_0x0023;
    L_0x002d:
        r2 = move-exception;
        monitor-exit(r5);
        throw r2;
    L_0x0030:
        r5.releaseAggregatedStatsLocked(r0);	 Catch:{ all -> 0x002d }
        monitor-exit(r5);
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.server.notification.NotificationUsageStats.registerPeopleAffinity(com.android.server.notification.NotificationRecord, boolean, boolean, boolean):void");
    }
