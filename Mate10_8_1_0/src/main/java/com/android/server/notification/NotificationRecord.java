...
public final class NotificationRecord {
    ...
    private Light calculateLights() {
        ...
        int defaultLightOn = this.mContext.getResources().getInteger(17694771);
        int defaultLightOff = this.mContext.getResources().getInteger(17694770);
    ...
    private long[] calculateVibration() {
        ...
        long[] vibrationPattern = getChannel().shouldVibrate() ? getChannel().getVibrationPattern() == null ? defaultVibration : getChannel().getVibrationPattern() : null;
    ...
    private String getUserExplanation() {
        if (this.mUserExplanation == null) {
            this.mUserExplanation = this.mContext.getResources().getString(17040158);
        }
    ...
    private String getPeopleExplanation() {
        if (this.mPeopleExplanation == null) {
            this.mPeopleExplanation = this.mContext.getResources().getString(17040157);
        }
