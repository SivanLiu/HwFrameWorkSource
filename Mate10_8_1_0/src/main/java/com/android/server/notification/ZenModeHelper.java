...
public class ZenModeHelper {
    ...
    public ZenModeHelper(Context context, Looper looper, ConditionProviders conditionProviders) {
        ...
        this.mDefaultRuleWeeknightsName = this.mContext.getResources().getString(17041306);
        this.mDefaultRuleWeekendsName = this.mContext.getResources().getString(17041305);
        this.mDefaultRuleEventsName = this.mContext.getResources().getString(17041304);
    ...
    private void applyRestrictions() {
        ...
        for (int usage : AudioAttributes.SDK_USAGES) {
            ...
            if (suppressionBehavior == 3) {
                ...
                boolean z = muteCalls || this.mZenMode == 2;
