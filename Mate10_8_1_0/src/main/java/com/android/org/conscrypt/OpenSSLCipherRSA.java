...
abstract class OpenSSLCipherRSA extends CipherSpi {
    ...
    static class OAEP extends OpenSSLCipherRSA {
        ...
        void doCryptoInit(AlgorithmParameterSpec spec) throws InvalidAlgorithmParameterException {
        ...
        private void readOAEPParameters(OAEPParameterSpec spec) throws InvalidAlgorithmParameterException {
            ...
            if (("MGF1".equals(mgfAlgUpper) || ("1.2.840.113549.1.1.8".equals(mgfAlgUpper) ^ 1) == 0) && ((mgfSpec instanceof MGF1ParameterSpec) ^ 1) == 0) {
