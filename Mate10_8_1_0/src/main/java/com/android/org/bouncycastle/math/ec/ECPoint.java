...
public abstract class ECPoint {
    ...
    public static class Fp extends AbstractFp {
        ...
        protected Fp twiceJacobianModified(boolean calculateW) {
            ...
            ECFieldElement two = calculateW ? two(_8T.multiply(W1)) : null;
            ECFieldElement Z3 = Z1.isOne() ? _2Y1 : _2Y1.multiply(Z1);
            return new Fp(getCurve(), X3, Y3, new ECFieldElement[]{Z3, two}, this.withCompression);
        }
    }
...
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.org.bouncycastle.math.ec.ECPoint.hashCode():int
