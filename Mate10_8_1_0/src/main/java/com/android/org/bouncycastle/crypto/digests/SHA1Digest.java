...
/*
Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.android.org.bouncycastle.crypto.digests.SHA1Digest.f(int, int, int):int
...
*/
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.org.bouncycastle.crypto.digests.SHA1Digest.f(int, int, int):int");
    }
