...
public interface IImsConfig extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IImsConfig {
        ...
        static final int TRANSACTION_getImsSmsConfig = 11;
        ...
        static final int TRANSACTION_setImsSmsConfig = 10;
        ...
        private static class Proxy implements IImsConfig {
            ...
            public void setImsSmsConfig(int isImsSmsEnabled) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(isImsSmsEnabled);
    ...
    void getImsSmsConfig() throws RemoteException;
    ...
    void setImsSmsConfig(int i) throws RemoteException;
