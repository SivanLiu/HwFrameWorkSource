        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    ...
                    _result = startSession(_arg0, _arg1, pendingIntent, com.android.ims.internal.IImsRegistrationListener.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                ...
                case 11:
                    ...
                    _result3 = createCallSession(_arg0, _arg1, _arg2, imsCallProfile, com.android.ims.internal.IImsCallSessionListener.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                ...
                case 18:
                    ...
                    setUiTTYMode(_arg0, _arg1, _arg2, message);
                    reply.writeNoException();
                    return true;
                case 19:
                    data.enforceInterface(DESCRIPTOR);
