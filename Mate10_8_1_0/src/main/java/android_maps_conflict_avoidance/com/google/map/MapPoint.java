...
public class MapPoint implements Geometry {
    ...
    public boolean equals(Object o) {
        ...
        if (!(this.latitudeE6 == mapPoint.latitudeE6 && this.longitudeE6 == mapPoint.longitudeE6)) {
            if (this.pixelCoordX == mapPoint.pixelCoordX) {
                if (this.pixelCoordY != mapPoint.pixelCoordY) {
                }
            }
            return z;
        }
