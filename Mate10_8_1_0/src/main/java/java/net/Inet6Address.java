...
public final class Inet6Address extends InetAddress {
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        boolean z = gf.get("scope_id_set", false);
        boolean z2 = gf.get("scope_ifname_set", false);
        String ifname = (String) gf.get("ifname", null);
        if (!(ifname == null || ("".equals(ifname) ^ 1) == 0)) {
            try {
                networkInterface = NetworkInterface.getByName(ifname);
                if (networkInterface == null) {
                    ...
                    z2 = true;
                    try {
                        scope_id = deriveNumericScope(ipaddress, networkInterface);
                    } catch (UnknownHostException e) {
                    }
                }
        ...
        if (ipaddress.length != 16) {
            ...
            UNSAFE.putObject(this, FIELDS_OFFSET, new Inet6AddressHolder(ipaddress, scope_id, z, networkInterface, z2));
        }
    }
    ...
    private synchronized void writeObject(ObjectOutputStream s) throws IOException {
        ...
        if (this.holder6.scope_ifname != null) {
            obj = this.holder6.scope_ifname.getName();
