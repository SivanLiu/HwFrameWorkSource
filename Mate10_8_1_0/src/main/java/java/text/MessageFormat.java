                ...
                switch (type) {
                    ...
                    case 1:
                        switch (findKeyword(segments[3], NUMBER_MODIFIER_KEYWORDS)) {
                            ...
                            default:
                                try {
                                    decimalFormat = new DecimalFormat(segments[3], DecimalFormatSymbols.getInstance(this.locale));
                                    break;
                    ...
                    case 3:
                        ...
                        try {
                            decimalFormat = new SimpleDateFormat(segments[3], this.locale);
                            break;
                    ...
                    case 4:
                        try {
                            decimalFormat = new ChoiceFormat(segments[3]);
                            break;
                        } catch (Exception e3) {
                            this.maxOffset = oldMaxOffset;
