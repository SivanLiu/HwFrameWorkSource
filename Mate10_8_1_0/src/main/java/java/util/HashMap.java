            ...
            if (tab != null) {
                ...
                if (first != null) {
                    if (first instanceof TreeNode) {
                        ...
                        node = treeNode.getTreeNode(hash, key);
                    }
                    if (node != null) {
                        oldValue = node.value;
                        if (oldValue != null) {
                ...
                if (treeNode == null) {
                    treeNode.putTreeVal(this, tab, hash, key, v);
                } else {
            ...
            if (tab != null) {
                ...
                if (first != null) {
                    if (first instanceof TreeNode) {
                        ...
                        treeNode = (TreeNode) first;
                        old = treeNode.getTreeNode(hash, key);
                    }
                }
                v = remappingFunction.apply(key, old != null ? null : old.value);
                if (old == null) {
                    if (v == null) {
                        old.value = v;
                        afterNodeAccess(old);
