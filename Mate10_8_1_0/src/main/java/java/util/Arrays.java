...
public class Arrays {
    ...
    public static <T> void parallelSetAll(T[] array, IntFunction<? extends T> generator) {
        Objects.requireNonNull(generator);
        IntStream.range(0, array.length).parallel().forEach(new -$Lambda$aUGKT4ItCOku5-JSG-x8Aqj2pJw((byte) 3, array, generator));
    }
    ...
    public static void parallelSetAll(int[] array, IntUnaryOperator generator) {
        Objects.requireNonNull(generator);
        IntStream.range(0, array.length).parallel().forEach(new -$Lambda$aUGKT4ItCOku5-JSG-x8Aqj2pJw((byte) 1, array, generator));
    }
    ...
    public static void parallelSetAll(long[] array, IntToLongFunction generator) {
        Objects.requireNonNull(generator);
        IntStream.range(0, array.length).parallel().forEach(new -$Lambda$aUGKT4ItCOku5-JSG-x8Aqj2pJw((byte) 2, array, generator));
    }
    ...
    public static void parallelSetAll(double[] array, IntToDoubleFunction generator) {
        Objects.requireNonNull(generator);
        IntStream.range(0, array.length).parallel().forEach(new -$Lambda$aUGKT4ItCOku5-JSG-x8Aqj2pJw((byte) 0, array, generator));
    }
