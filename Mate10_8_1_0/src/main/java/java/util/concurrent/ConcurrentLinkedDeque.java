                            ...
                            if (q != null) {
                                if (p.prev == p) {
                                    ...
                                    if (hops < 2 || (isFirst | isLast) == 0) {
                                        ...
                                        if ((isFirst | isLast) != 0 && activePred.next == activeSucc && activeSucc.prev == activePred) {
                                            if (!isFirst) {
                                                if (activePred.item != null) {
                                                }
                                            }
                                            if (!isLast) {
                                                if (activeSucc.item != null) {
                                                }
                                            }
                                            updateHead();
                                            updateTail();
                                            if (isFirst) {
                                                ...
                                                prevTerminator = prevTerminator();
                                            }
                                            x.lazySetPrev(prevTerminator);
                                            if (isLast) {
                                                node = x;
                                            } else {
                                                prevTerminator = nextTerminator();
                                            }
                                            x.lazySetNext(prevTerminator);
                                        }
                                    } else {
                                        return;
                                    }
