...
public final class Spliterators {
    ...
    /* renamed from: java.util.Spliterators$1Adapter */
    ...
    /* renamed from: java.util.Spliterators$2Adapter */
    class AnonymousClass2Adapter implements PrimitiveIterator.OfInt, IntConsumer {
        int nextElement;
        final /* synthetic */ OfInt val$spliterator;
        boolean valueReady = false;
        ...
        AnonymousClass2Adapter(OfInt ofInt) {
    ...
    /* renamed from: java.util.Spliterators$3Adapter */
    class AnonymousClass3Adapter implements PrimitiveIterator.OfLong, LongConsumer {
        long nextElement;
        final /* synthetic */ OfLong val$spliterator;
        boolean valueReady = false;
        ...
        AnonymousClass3Adapter(OfLong ofLong) {
    ...
    /* renamed from: java.util.Spliterators$4Adapter */
    class AnonymousClass4Adapter implements PrimitiveIterator.OfDouble, DoubleConsumer {
        double nextElement;
        final /* synthetic */ OfDouble val$spliterator;
        boolean valueReady = false;
        ...
        AnonymousClass4Adapter(OfDouble ofDouble) {
    ...
    public static PrimitiveIterator.OfInt iterator(OfInt spliterator) {
        Objects.requireNonNull(spliterator);
        return new AnonymousClass2Adapter(spliterator);
    }

    public static PrimitiveIterator.OfLong iterator(OfLong spliterator) {
        Objects.requireNonNull(spliterator);
        return new AnonymousClass3Adapter(spliterator);
    }

    public static PrimitiveIterator.OfDouble iterator(OfDouble spliterator) {
        Objects.requireNonNull(spliterator);
        return new AnonymousClass4Adapter(spliterator);
    }
}
