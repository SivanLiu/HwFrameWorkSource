...
public class TreeMap<K, V> extends AbstractMap<K, V> implements NavigableMap<K, V>, Cloneable, Serializable {
    ...
    static final class DescendingKeySpliterator<K, V> extends TreeMapSpliterator<K, V> implements Spliterator<K> {
        ...
        public DescendingKeySpliterator<K, V> trySplit() {
            ...
            if (treeMapEntry == null || treeMapEntry == e || treeMapEntry == f || this.tree.compare(e.key, treeMapEntry.key) <= 0) {
                return null;
            }
            this.side = 1;
            ...
            int i = this.est >>> 1;
            this.est = i;
            return new DescendingKeySpliterator(treeMap, e, treeMapEntry, -1, i, this.expectedModCount);
        }
    ...
    static final class EntrySpliterator<K, V> extends TreeMapSpliterator<K, V> implements Spliterator<Entry<K, V>> {
        ...
        public EntrySpliterator<K, V> trySplit() {
            ...
            int i = this.est >>> 1;
            this.est = i;
            return new EntrySpliterator(treeMap, e, treeMapEntry, -1, i, this.expectedModCount);
        }
        ...
        public Comparator<Entry<K, V>> getComparator() {
            ...
            return -$Lambda$mgsD_SQg4eUJB-7NqkY6phgRxHI.$INST$2;
        }
    }
    ...
    static final class KeySpliterator<K, V> extends TreeMapSpliterator<K, V> implements Spliterator<K> {
        ...
        public KeySpliterator<K, V> trySplit() {
            ...
            int i = this.est >>> 1;
            this.est = i;
            return new KeySpliterator(treeMap, e, treeMapEntry, -1, i, this.expectedModCount);
        }
    ...
    static final class ValueSpliterator<K, V> extends TreeMapSpliterator<K, V> implements Spliterator<V> {
        ...
        public ValueSpliterator<K, V> trySplit() {
            ...
            int i = this.est >>> 1;
            this.est = i;
            return new ValueSpliterator(treeMap, e, treeMapEntry, -1, i, this.expectedModCount);
        }
