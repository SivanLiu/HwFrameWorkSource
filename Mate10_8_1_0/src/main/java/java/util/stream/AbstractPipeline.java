...
*/
    ...
    public Spliterator<E_OUT> spliterator() {
        ...
        this.linkedOrConsumed = true;
        if (this != this.sourceStage) {
            return wrap(this, new -$Lambda$F2FxWS-_sj37qqP78wv60F_s_Zw((byte) 0, this), isParallel());
        }
        if (this.sourceStage.sourceSpliterator != null) {
    ...
    final <P_IN> Spliterator<E_OUT> wrapSpliterator(Spliterator<P_IN> sourceSpliterator) {
        ...
        return wrap(this, new -$Lambda$F2FxWS-_sj37qqP78wv60F_s_Zw((byte) 1, sourceSpliterator), isParallel());
    }
    ...
    public <P_IN> Spliterator<E_OUT> opEvaluateParallelLazy(PipelineHelper<E_OUT> helper, Spliterator<P_IN> spliterator) {
        return opEvaluateParallel(helper, spliterator, -$Lambda$Lw2Alu2LEcypd4PXrfG0QIAAKKo.$INST$0).spliterator();
    }
}
