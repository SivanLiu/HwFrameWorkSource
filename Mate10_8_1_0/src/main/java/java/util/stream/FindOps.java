...
final class FindOps {
    ...
    public static <T> TerminalOp<T, Optional<T>> makeRef(boolean mustFindFirst) {
        return new FindOp(mustFindFirst, StreamShape.REFERENCE, Optional.empty(), -$Lambda$ioGbka_-VkWTFjRjTt8T4zzsxgk.$INST$3, -$Lambda$PVrT5KMXWM352lNCiKPCMdt2xL8.$INST$26);
    }

    public static TerminalOp<Integer, OptionalInt> makeInt(boolean mustFindFirst) {
        return new FindOp(mustFindFirst, StreamShape.INT_VALUE, OptionalInt.empty(), -$Lambda$ioGbka_-VkWTFjRjTt8T4zzsxgk.$INST$1, -$Lambda$PVrT5KMXWM352lNCiKPCMdt2xL8.$INST$24);
    }

    public static TerminalOp<Long, OptionalLong> makeLong(boolean mustFindFirst) {
        return new FindOp(mustFindFirst, StreamShape.LONG_VALUE, OptionalLong.empty(), -$Lambda$ioGbka_-VkWTFjRjTt8T4zzsxgk.$INST$2, -$Lambda$PVrT5KMXWM352lNCiKPCMdt2xL8.$INST$25);
    }

    public static TerminalOp<Double, OptionalDouble> makeDouble(boolean mustFindFirst) {
        return new FindOp(mustFindFirst, StreamShape.DOUBLE_VALUE, OptionalDouble.empty(), -$Lambda$ioGbka_-VkWTFjRjTt8T4zzsxgk.$INST$0, -$Lambda$PVrT5KMXWM352lNCiKPCMdt2xL8.$INST$23);
    }
}
