...
public abstract class DoublePipeline<E_IN> extends AbstractPipeline<E_IN, Double, DoubleStream> implements DoubleStream {
    ...
    private static DoubleConsumer adapt(Sink<Double> sink) {
        ...
        sink.getClass();
        return new -$Lambda$zwpF4y4y1FQ3Bs1BvYfnaXR_rdE((byte) 1, sink);
    }
    ...
    public final Stream<Double> boxed() {
        return mapToObj(java.util.stream.-$Lambda$15cJOyg3Zha5J4OQxNOU52CozsU.AnonymousClass1.$INST$0);
    }
                    ...
                    public void accept(double t) {
                        ...
                        try {
                            ...
                            if (doubleStream != null) {
                                doubleStream.sequential().forEach(new -$Lambda$zwpF4y4y1FQ3Bs1BvYfnaXR_rdE((byte) 0, this));
                            }
                            if (doubleStream != null) {
                                try {
                                    doubleStream.close();
    ...
    public final DoubleStream distinct() {
        return boxed().distinct().mapToDouble(java.util.stream.-$Lambda$15cJOyg3Zha5J4OQxNOU52CozsU.AnonymousClass4.$INST$0);
    }
    ...
    public final double sum() {
        return Collectors.computeFinalSum((double[]) collect(-$Lambda$PVrT5KMXWM352lNCiKPCMdt2xL8.$INST$21, java.util.stream.-$Lambda$15cJOyg3Zha5J4OQxNOU52CozsU.AnonymousClass3.$INST$1, -$Lambda$Y1nWb7oHyESmWtTUR-RlHqf5IfU.$INST$9));
    }
    ...
    public final OptionalDouble min() {
        return reduce(-$Lambda$15cJOyg3Zha5J4OQxNOU52CozsU.$INST$1);
    }

    public final OptionalDouble max() {
        return reduce(-$Lambda$15cJOyg3Zha5J4OQxNOU52CozsU.$INST$0);
    }

    public final OptionalDouble average() {
        double[] avg = (double[]) collect(-$Lambda$PVrT5KMXWM352lNCiKPCMdt2xL8.$INST$20, java.util.stream.-$Lambda$15cJOyg3Zha5J4OQxNOU52CozsU.AnonymousClass3.$INST$0, -$Lambda$Y1nWb7oHyESmWtTUR-RlHqf5IfU.$INST$8);
        if (avg[2] > 0.0d) {
    ...
    public final long count() {
        return mapToLong(java.util.stream.-$Lambda$15cJOyg3Zha5J4OQxNOU52CozsU.AnonymousClass2.$INST$0).sum();
    }

    public final DoubleSummaryStatistics summaryStatistics() {
        return (DoubleSummaryStatistics) collect(-$Lambda$PVrT5KMXWM352lNCiKPCMdt2xL8.$INST$22, java.util.stream.-$Lambda$15cJOyg3Zha5J4OQxNOU52CozsU.AnonymousClass3.$INST$2, -$Lambda$Y1nWb7oHyESmWtTUR-RlHqf5IfU.$INST$10);
    }
    ...
    public final <R> R collect(Supplier<R> supplier, ObjDoubleConsumer<R> accumulator, BiConsumer<R, R> combiner) {
        return evaluate(ReduceOps.makeDouble(supplier, accumulator, new -$Lambda$s-muF8cTY6kf2DcLR-Ys2NMV7bA((byte) 4, combiner)));
    }
    ...
    public final double[] toArray() {
        return (double[]) Nodes.flattenDouble((Node.OfDouble) evaluateToArrayNode(-$Lambda$Lw2Alu2LEcypd4PXrfG0QIAAKKo.$INST$1)).asPrimitiveArray();
    }
}
