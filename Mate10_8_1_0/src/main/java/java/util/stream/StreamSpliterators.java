...
import java.util.stream.-$Lambda$pjwaaeJ_eHmC5XAnmHPMW0IKfyc.AnonymousClass1;
import java.util.stream.-$Lambda$pjwaaeJ_eHmC5XAnmHPMW0IKfyc.AnonymousClass2;
import java.util.stream.-$Lambda$pjwaaeJ_eHmC5XAnmHPMW0IKfyc.AnonymousClass3;
import java.util.stream.-$Lambda$pjwaaeJ_eHmC5XAnmHPMW0IKfyc.AnonymousClass4;
...
class StreamSpliterators {
    ...
    static final class DistinctSpliterator<T> implements Spliterator<T>, Consumer<T> {
        ...
        public void forEachRemaining(Consumer<? super T> action) {
            this.s.forEachRemaining(new -$Lambda$mQqUMfzvvH-Pb34PmbAP692jlD4((byte) 2, this, action));
        }
    ...
    static final class DoubleWrappingSpliterator<P_IN> extends AbstractWrappingSpliterator<P_IN, Double, OfDouble> implements Spliterator.OfDouble {
        ...
        void initPartialTraversalState() {
            ...
            b.getClass();
            this.bufferSink = pipelineHelper.wrapSink(new AnonymousClass1((byte) 1, b));
            this.pusher = new -$Lambda$pjwaaeJ_eHmC5XAnmHPMW0IKfyc((byte) 0, this);
        }
        ...
        public void forEachRemaining(DoubleConsumer consumer) {
            ...
            PipelineHelper pipelineHelper = this.ph;
            consumer.getClass();
            pipelineHelper.wrapAndCopyInto(new AnonymousClass1((byte) 0, consumer), this.spliterator);
            this.finished = true;
        }
    }
    ...
    static final class IntWrappingSpliterator<P_IN> extends AbstractWrappingSpliterator<P_IN, Integer, OfInt> implements Spliterator.OfInt {
        ...
        void initPartialTraversalState() {
            ...
            PipelineHelper pipelineHelper = this.ph;
            b.getClass();
            this.bufferSink = pipelineHelper.wrapSink(new AnonymousClass2((byte) 1, b));
            this.pusher = new -$Lambda$pjwaaeJ_eHmC5XAnmHPMW0IKfyc((byte) 1, this);
        }
        ...
        public void forEachRemaining(IntConsumer consumer) {
            ...
            PipelineHelper pipelineHelper = this.ph;
            consumer.getClass();
            pipelineHelper.wrapAndCopyInto(new AnonymousClass2((byte) 0, consumer), this.spliterator);
            this.finished = true;
        }
    }
    ...
    static final class LongWrappingSpliterator<P_IN> extends AbstractWrappingSpliterator<P_IN, Long, OfLong> implements Spliterator.OfLong {
        ...
        void initPartialTraversalState() {
            ...
            PipelineHelper pipelineHelper = this.ph;
            b.getClass();
            this.bufferSink = pipelineHelper.wrapSink(new AnonymousClass3((byte) 1, b));
            this.pusher = new -$Lambda$pjwaaeJ_eHmC5XAnmHPMW0IKfyc((byte) 2, this);
        }
        ...
        public void forEachRemaining(LongConsumer consumer) {
            ...
            PipelineHelper pipelineHelper = this.ph;
            consumer.getClass();
            pipelineHelper.wrapAndCopyInto(new AnonymousClass3((byte) 0, consumer), this.spliterator);
            this.finished = true;
        }
    }
    ...
    static abstract class SliceSpliterator<T, T_SPLITR extends Spliterator<T>> {
        ...
        static final class OfDouble extends OfPrimitive<Double, java.util.Spliterator.OfDouble, DoubleConsumer> implements java.util.Spliterator.OfDouble {
            ...
            protected DoubleConsumer emptyConsumer() {
                return -$Lambda$UMgkLPOadvYHXl2uzl_OZxGJCZk.AnonymousClass1.$INST$1;
            }
        }
        ...
        static final class OfInt extends OfPrimitive<Integer, java.util.Spliterator.OfInt, IntConsumer> implements java.util.Spliterator.OfInt {
            ...
            protected IntConsumer emptyConsumer() {
                return -$Lambda$UMgkLPOadvYHXl2uzl_OZxGJCZk.AnonymousClass2.$INST$1;
            }
        }
        ...
        static final class OfLong extends OfPrimitive<Long, java.util.Spliterator.OfLong, LongConsumer> implements java.util.Spliterator.OfLong {
            ...
            protected LongConsumer emptyConsumer() {
                return -$Lambda$UMgkLPOadvYHXl2uzl_OZxGJCZk.AnonymousClass3.$INST$1;
            }
        }
        ...
        static final class OfRef<T> extends SliceSpliterator<T, Spliterator<T>> implements Spliterator<T> {
            ...
            public boolean tryAdvance(Consumer<? super T> action) {
                ...
                while (this.sliceOrigin > this.index) {
                    this.s.tryAdvance(-$Lambda$UMgkLPOadvYHXl2uzl_OZxGJCZk.$INST$2);
                    this.index++;
                }
                if (this.index >= this.fence) {
                    return false;
            ...
            public void forEachRemaining(Consumer<? super T> action) {
                ...
                if (this.sliceOrigin < this.fence && this.index < this.fence) {
                    if (this.index < this.sliceOrigin || this.index + this.s.estimateSize() > this.sliceFence) {
                        while (this.sliceOrigin > this.index) {
                            this.s.tryAdvance(-$Lambda$UMgkLPOadvYHXl2uzl_OZxGJCZk.$INST$1);
                            this.index++;
                        }
                        while (this.index < this.fence) {
    ...
    static final class WrappingSpliterator<P_IN, P_OUT> extends AbstractWrappingSpliterator<P_IN, P_OUT, SpinedBuffer<P_OUT>> {
        ...
        void initPartialTraversalState() {
            ...
            PipelineHelper pipelineHelper = this.ph;
            b.getClass();
            this.bufferSink = pipelineHelper.wrapSink(new AnonymousClass4((byte) 1, b));
            this.pusher = new -$Lambda$pjwaaeJ_eHmC5XAnmHPMW0IKfyc((byte) 3, this);
        }
        ...
        public void forEachRemaining(Consumer<? super P_OUT> consumer) {
            ...
            PipelineHelper pipelineHelper = this.ph;
            consumer.getClass();
            pipelineHelper.wrapAndCopyInto(new AnonymousClass4((byte) 0, consumer), this.spliterator);
            this.finished = true;
        }
    }
