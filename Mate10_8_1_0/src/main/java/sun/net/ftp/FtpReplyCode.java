...
public enum FtpReplyCode {
    ...
    public boolean isPositiveCompletion() {
        return this.value >= HttpURLConnection.HTTP_OK && this.value < HttpURLConnection.HTTP_MULT_CHOICE;
    }

    public boolean isPositiveIntermediate() {
        return this.value >= HttpURLConnection.HTTP_MULT_CHOICE && this.value < HttpURLConnection.HTTP_BAD_REQUEST;
    }

    public boolean isTransientNegative() {
        return this.value >= HttpURLConnection.HTTP_BAD_REQUEST && this.value < 500;
    }
